...
> **Бібліотека:** [Чтиво](https://chtyvo.org.ua/) — безкоштовна електронна бібліотека української літератури
> **Аудіокниги:** [Слухай](https://slukhai.com.ua/) — українська література в аудіоформаті
> **Словник:** [Словник української мови](https://sum.in.ua/) — тлумачний словник із позначками стилю
...
|-------|----------|----------|
| автор | author | творець художнього твору |
| письменник | writer | той, хто пише художні твори |
| поет | poet | автор поезії |
| твір | work, literary work | художній текст |
| роман | novel | великий прозовий твір |
| повість | novella | середній прозовий твір |
| оповідання | short story | малий прозовий твір |
| вірш | poem | поетичний твір |
| поема | epic poem | великий поетичний твір |
| драма | drama | п'єса |
| сюжет | plot | послідовність подій у творі |
| герой | hero | головний персонаж |
| персонаж | character | дійова особа твору |
| образ | image, literary image | художнє втілення ідеї |
| тема | theme | те, про що твір |
| ідея | idea | головна думка твору |
| стиль | style | спосіб вираження думки |
| метафора | metaphor | приховане порівняння |
| порівняння | simile | явне зіставлення (як, наче) |
| епітет | epithet | художнє означення |
| символ | symbol | образ із прихованим значенням |
| алегорія | allegory | розгорнута метафора |
| гіпербола | hyperbole | перебільшення |
| іронія | irony | прихована насмішка |
| сатира | satire | гостра критика через сміх |
| ліризм | lyricism | емоційність, суб'єктивність |
| драматизм | dramatic quality | напруга, конфлікт |
| конфлікт | conflict | зіткнення сил у творі |
| кульмінація | climax | найвища точка напруги |
| розв'язка | resolution | завершення конфлікту |
