...
|-------|----------|----------|
| тут | here | статичне, нейтральне |
| тутечки | here | розмовне, пестливе |
| ось тут | right here | вказівне, близьке |
| на цьому місці | at this place | урочисте / офіційне |
| там | there | статичне, нейтральне |
| он там | over there | вказівне, далеке |
| туди | to there | напрямок від мовця |
| звідти | from there | джерело руху |
| сюди | to here | напрямок до мовця |
| звідси | from here | джерело руху (поруч) |
| далеко | far | велика відстань |
| близько | near / close | мала відстань |
| поруч | beside / near | безпосередня близькість |
| поблизу | nearby | територіально поруч |
| навколо | around | оточення |
| всюди | everywhere | повсюдність |
| ніде | nowhere | відсутність місця |
| десь | somewhere | невизначене місце |
| кудись | somewhere (to) | невизначений напрямок |
| звідкись | from somewhere | невизначене джерело |
| місце | place | локальний простір |
| простір | space | обсяг |
| територія | territory | обмежений простір |
| район | district / area | частина міста / області |
| зона | zone | специфічний простір |
| точка | point | конкретна локація |
| локація | location | сучасний термін |
| обрій | horizon | межа зору |
| межа | border / limit | край простору |
| околиця | outskirts | межа міста |
| гористий | mountainous | про рельєф |
| рівнинний | flat / plain | про рельєф |
| інклюзивний | inclusive | доступний для всіх |
| сакральний | sacred | духовне місце |
| меморіальний | memorial | про пам'ять |

> [!resources] Додаткові ресурси
> - [Географічний словник України](https://geography.ua/) — лексика простору.
> - [Карти та навігація українською](https://maps.ua/) — практика вживання.
> - [Культура мови: Де чи Куди?](https://shron1.chtyvo.org.ua/) — розбір типових помилок.

# Підсумок

Сьогодні ми дослідили світ українських просторових синонімів.
- **Вказівка:** Ми навчилися розрізняти «тут», «тутечки» та «на цьому місці».
- **Дистанція:** Ми побачили різницю між «поруч», «близько» та «далеко».
- **Масштаби:** Ми вивчили слова для опису точки, зони та цілої території.

Пам'ятайте: мова — це ваш внутрішній компас. Використовуйте ці синоніми, щоб ніколи не губитися у просторі думок та життєвих шляхів. Ваша майстерність росте з кожним подоланим кілометром у світі слів!
