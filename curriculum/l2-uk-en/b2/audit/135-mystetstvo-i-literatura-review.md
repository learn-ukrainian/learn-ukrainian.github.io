# Audit Report: 135-mystetstvo-i-literatura.md
...
- **[COMPLEXITY_WORD_COUNT]** quiz 'Тест: українська культура' Q12 prompt length 6 (target: 10-25)
  - FIX: Adjust prompt length to 10-25 words.
- **[COMPLEXITY]** group-sort 'Розподіліть за категоріями' has 2 groups (target: 3-5)
...
| **Вступ** | ⚪️ | 364 | Skipped |
| **Українська література** | ⚪️ | 397 | Skipped |
