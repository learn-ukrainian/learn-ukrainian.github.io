...
| **Безособові конструкції на -но/-то** | ✅ | 91 | Included in Core |
| **Вступ: Поняття безособовості** | ✅ | 464 | Included in Core |
| **Творення та граматичні особливості** | ✅ | 724 | Included in Core |
| **Синтаксис та керування об'єктом** | ✅ | 943 | Included in Core |
| **Офіційно-діловий та юридичний стиль** | ✅ | 954 | Included in Core |
| **Практика та запобігання помилкам** | ✅ | 630 | Included in Core |
