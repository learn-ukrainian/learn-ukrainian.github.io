...
| **Контрольна точка: B2.1 Завершення** | ✅ | 52 | Included in Core |
| **Огляд та вступ** | ✅ | 448 | Included in Core |
| **Навичка 1: Пасивний стан** | ✅ | 824 | Included in Core |
| **Навичка 2: Дієприкметники** | ✅ | 937 | Included in Core |
| **Навичка 3: Регістри та Стилі** | ✅ | 990 | Included in Core |
| **Навичка 4: Доменна лексика** | ✅ | 716 | Included in Core |
| **Підсумок та результати** | ✅ | 455 | Included in Core |