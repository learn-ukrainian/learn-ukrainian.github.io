...
| **Пасив у контексті — вибір за регістром** | ✅ | 70 | Included in Core |
| **Вступ — Регістр і пасив** | ✅ | 595 | Included in Core |
| **Система форм за реєстрами** | ✅ | 685 | Included in Core |
| **Офіційно-діловий та юридичний контексти** | ✅ | 823 | Included in Core |
| **Науковий та академічний контексти** | ✅ | 753 | Included in Core |
| **Літературний, журналістичний та розмовний контексти** | ✅ | 612 | Included in Core |
| **Підсумок та інтегрована практика** | ✅ | 368 | Included in Core |
