...
| **Відмінювання числівників ІІ: Складені числівники** | ✅ | 49 | Included in Core |
| **Вступ та повторення складних числівників** | ✅ | 722 | Included in Core |
| **Складені кількісні числівники — Правило повної зміни** | ✅ | 902 | Included in Core |
| **Складені порядкові числівники та історичні дати** | ✅ | 829 | Included in Core |
| **Числівники в статистиці та географії** | ✅ | 854 | Included in Core |
| **Практикум та синтез** | ✅ | 624 | Included in Core |
