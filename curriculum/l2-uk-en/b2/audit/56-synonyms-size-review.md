...
| 2 | quiz | Оберіть точний синонім | 10 | 8 | ✅ |
...
| 9 | true-false | Нюанси розміру | 10 | 8 | ✅ |
| 10 | select | Всі варіанти великого | 8 | 6 | ✅ |
| 11 | match-up | Регістри та розміри | 12 | 8 | ✅ |
| 12 | match-up | Параметри та об'єкти | 12 | 8 | ✅ |
| 13 | quiz | Ранжування інтенсивності | 10 | 8 | ✅ |
| 14 | essay-response | Творче завдання: Світ масштабів | 1 | 1 | ✅ |
| 15 | select | Переносне значення | 8 | 6 | ✅ |
...
- **[COMPLEXITY_WORD_COUNT]** quiz 'Оберіть точний синонім' Q9 prompt length 3 (target: 5-25)
  - FIX: Adjust prompt length to 5-25 words.
- **[COMPLEXITY_WORD_COUNT]** quiz 'Оберіть точний синонім' Q10 prompt length 3 (target: 5-25)
  - FIX: Adjust prompt length to 5-25 words.
- **[COMPLEXITY_WORD_COUNT]** quiz 'Ранжування інтенсивності' Q9 prompt length 3 (target: 5-25)
  - FIX: Adjust prompt length to 5-25 words.
- **[COMPLEXITY_WORD_COUNT]** quiz 'Ранжування інтенсивності' Q10 prompt length 3 (target: 5-25)
  - FIX: Adjust prompt length to 5-25 words.
