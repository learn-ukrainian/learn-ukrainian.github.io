...
- **[MALFORMED_ERROR_CORRECTION]** Error-correction activity 'Виправте помилки в історичних реченнях' uses placeholder syntax instead of real errors
  - FIX: Convert to proper error-correction format with real error words in sentences, or change to fill-in activity. Found 5/16 items with placeholders/missing errors.
...
| **Вступ** | ⚪️ | 170 | Skipped |
| **Відкриття Трипілля** | ⚪️ | 651 | Skipped |
