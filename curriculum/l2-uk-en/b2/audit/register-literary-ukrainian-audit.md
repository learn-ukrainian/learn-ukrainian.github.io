...
| **Регістр — Літературна українська** | ✅ | 53 | Included in Core |
| **Вступ: Поняття художнього стилю** | ✅ | 732 | Included in Core |
| **Історичні витоки та зачинателі** | ✅ | 846 | Included in Core |
| **Лексичні засоби та конотації** | ✅ | 924 | Included in Core |
| **Тропи, фігури та персоніфікація** | ✅ | 931 | Included in Core |
| **Синтаксис та запобігання помилкам** | ✅ | 754 | Included in Core |
