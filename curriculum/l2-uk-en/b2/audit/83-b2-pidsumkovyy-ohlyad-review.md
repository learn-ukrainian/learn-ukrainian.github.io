...
| **Про цей модуль** | ⚪️ | 72 | Skipped |
| **Навички** | ⚪️ | 21 | Skipped |
| **Skill 1: Пасивний стан та Дієприкметники (Граматичний арсенал)** | ⚪️ | 254 | Skipped |
| **Skill 2: Функціональні стилі (Стилістичний діапазон)** | ⚪️ | 237 | Skipped |
| **Skill 3: Фразеологія та Синонімія (Багатство мови)** | ⚪️ | 223 | Skipped |
| **Skill 4: Культурно-історичний контекст (Код нації)** | ✅ | 225 | Included in Core |
| **Інтеграційне завдання** | ⚪️ | 411 | Skipped |
