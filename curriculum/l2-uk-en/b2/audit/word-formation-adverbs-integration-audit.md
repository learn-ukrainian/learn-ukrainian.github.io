...
| **Словотворення: прислівники та інтеграція** | ✅ | 105 | Included in Core |
| **Вступ: Світ українського словотворення** | ✅ | 812 | Included in Core |
| **Від прикметника до прислівника: моделі та акцентологія** | ✅ | 1485 | Included in Core |
| **Пестливість та звеличення: прагматика суфіксів** | ✅ | 1187 | Included in Core |
| **Словотворення в академічному та науковому контексті** | ✅ | 1099 | Included in Core |
| **Практикум та корекція помилок** | ✅ | 1219 | Included in Core |
| **Підсумок** | ✅ | 419 | Included in Core |