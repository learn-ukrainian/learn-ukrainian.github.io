...
| **Односкладні речення** | ✅ | 73 | Included in Core |
| **Природа односкладних речень** | ✅ | 804 | Included in Core |
| **Дієслівні типи: Означено-особові та неозначено-особові речення** | ✅ | 933 | Included in Core |
| **Безособові речення та категорія стану** | ✅ | 935 | Included in Core |
| **Номінативні речення та динаміка тексту** | ✅ | 510 | Included in Core |
| **Практичний синтез та трансформація** | ✅ | 649 | Included in Core |
