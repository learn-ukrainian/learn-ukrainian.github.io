...
| **Співвідносні конструкції** | ✅ | 58 | Included in Core |
| **Вступ** | ✅ | 704 | Included in Core |
| **Граматичний фундамент: Основні пари** | ✅ | 1028 | Included in Core |
| **Просторові, часові та кількісні зв'язки** | ✅ | 847 | Included in Core |
| **Стилістика та запобігання калькам** | ✅ | 995 | Included in Core |
| **Практичне застосування та синтез** | ✅ | 952 | Included in Core |
