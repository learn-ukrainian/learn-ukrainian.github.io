...
| **Емфаза та інверсія** | ✅ | 90 | Included in Core |
| **Вступ: Порядок слів в українській мові** | ✅ | 785 | Included in Core |
| **Актуальне членування речення: Тема та Рема** | ✅ | 896 | Included in Core |
| **Емфатичний порядок та логічний наголос** | ✅ | 684 | Included in Core |
| **Інверсія та стилістичні ефекти** | ✅ | 738 | Included in Core |
| **Лексичні та граматичні засоби виділення** | ✅ | 831 | Included in Core |
| **Практика: Корекція та Синтез** | ✅ | 667 | Included in Core |
