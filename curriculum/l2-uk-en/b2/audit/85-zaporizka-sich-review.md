...
| **Контекст** | ✅ | 218 | Included in Core |
| **Острів Хортиця — серце козацтва** | ⚪️ | 579 | Skipped |
| **Читання** | ✅ | 142 | Included in Core |
| **Демократичний устрій Січі** | ⚪️ | 173 | Skipped |
| **Первинні джерела** | ⚪️ | 239 | Skipped |
| **Деколонізаційний погляд** | ⚪️ | 168 | Skipped |
| **Есе** | ⚪️ | 373 | Skipped |
| **Підсумок** | ✅ | 82 | Included in Core |
| **Потрібно більше практики?** | ⚪️ | 100 | Skipped |