...
| **Стилістичні сполучники** | ✅ | 53 | Included in Core |
| **Вступ: Зв'язність та історичне коріння** | ✅ | 533 | Included in Core |
| **Сполучники протиставлення та компенсації** | ✅ | 1024 | Included in Core |
| **Приєднання та наслідок у різних реєстрах** | ✅ | 957 | Included in Core |
| **Допустові відношення та пунктуаційні пастки** | ✅ | 970 | Included in Core |
| **Типові помилки та стилістична елегантність** | ✅ | 1028 | Included in Core |
| **Підсумок** | ✅ | 317 | Included in Core |