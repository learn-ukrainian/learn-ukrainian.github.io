...
| **Складний синтаксис: еліпсис і парцеляція** | ✅ | 67 | Included in Core |
| **Вступ: Експресивний синтаксис** | ✅ | 689 | Included in Core |
| **Еліпсис: Мистецтво пропуску** | ✅ | 945 | Included in Core |
| **Парцеляція: Ритм і фрагментація** | ✅ | 854 | Included in Core |
| **Корекція типових помилок та стилістика** | ✅ | 831 | Included in Core |
| **Творчий синтез та підсумок** | ✅ | 496 | Included in Core |
