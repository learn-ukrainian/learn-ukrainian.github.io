...
| **Пасив третьою особою множини** | ✅ | 75 | Included in Core |
| **Вступ** | ✅ | 517 | Included in Core |
| **Граматична база та термінологія** | ✅ | 808 | Included in Core |
| **Соціокультурний аспект пліток** | ✅ | 956 | Included in Core |
| **Порівняння регістрів та аналіз помилок** | ✅ | 818 | Included in Core |
| **Практичне застосування та підсумок** | ✅ | 832 | Included in Core |
