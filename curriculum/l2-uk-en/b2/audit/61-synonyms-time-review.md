...
| 9 | true-false | Нюанси тривалості | 10 | 8 | ✅ |
| 10 | select | Теперішній час | 8 | 6 | ✅ |
| 11 | match-up | Регістри та Час | 12 | 8 | ✅ |
| 12 | match-up | Час та Події | 12 | 8 | ✅ |
| 13 | quiz | Час у мистецтві | 10 | 8 | ✅ |
| 14 | select | Масштаби часу | 8 | 6 | ✅ |
...
- **[COMPLEXITY_WORD_COUNT]** quiz 'Точність моменту' Q9 prompt length 3 (target: 5-25)
  - FIX: Adjust prompt length to 5-25 words.
- **[COMPLEXITY_WORD_COUNT]** quiz 'Точність моменту' Q10 prompt length 3 (target: 5-25)
  - FIX: Adjust prompt length to 5-25 words.
- **[COMPLEXITY_WORD_COUNT]** quiz 'Час у мистецтві' Q9 prompt length 3 (target: 5-25)
  - FIX: Adjust prompt length to 5-25 words.
- **[COMPLEXITY_WORD_COUNT]** quiz 'Час у мистецтві' Q10 prompt length 3 (target: 5-25)
  - FIX: Adjust prompt length to 5-25 words.
...
| **Практика — часові вирази в контексті** | ✅ | 768 | Included in Core |
