...
| **Видові нюанси I: Вторинна імперфективація** | ✅ | 77 | Included in Core |
| **Вступ: Метафора Палімпсесту** | ✅ | 1065 | Included in Core |
| **Механіка творення: Суфікси та чергування** | ✅ | 1220 | Included in Core |
| **Наголос як змістовий маркер** | ✅ | 930 | Included in Core |
| **Контексти вживання: Деколонізація та процеси** | ✅ | 968 | Included in Core |
| **Практика та закріплення** | ✅ | 603 | Included in Core |
