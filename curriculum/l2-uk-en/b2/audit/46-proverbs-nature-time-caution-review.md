...
| 7 | cloze | Прислів'я у контексті | 17 | 14 | ✅ |
| 8 | error-correction | Виправте помилки в прислів'ях | 8 | 6 | ✅ |
| 9 | mark-the-words | Знайдіть прислів'я в тексті | 18 | 6 | ✅ |
...
- **[CONTENT_REDUNDANCY]** Redundant information detected in lesson (71% overlap): "«Краще синиця в руках, ніж журавель у небі», — порадив батько.". Shares significant keywords with sentence at index 100.
  - FIX: Remove redundant paragraphs. Ensure each section adds new unique value.
- **[CONTENT_REDUNDANCY]** Redundant information detected in lesson (80% overlap): "**Міжмовна паралель:** Прислів'я латинського походження, відоме в усіх європейських мовах.". Shares significant keywords with sentence at index 60.
  - FIX: Remove redundant paragraphs. Ensure each section adds new unique value.
- **[CONTENT_REDUNDANCY]** Redundant information detected in lesson (83% overlap): "**Батько:** **Сім разів відміряй, один раз відріж**.". Shares significant keywords with sentence at index 81.
  - FIX: Remove redundant paragraphs. Ensure each section adds new unique value.
- **[CONTENT_REDUNDANCY]** Redundant information detected in lesson (83% overlap): "**Надія:** **Краще синиця в руках, ніж журавель у небі**.". Shares significant keywords with sentence at index 100.
  - FIX: Remove redundant paragraphs. Ensure each section adds new unique value.
...
| **Вступ** | ✅ | 171 | Included in Core |
| **Фразеологізми** | ⚪️ | 765 | Skipped |
| **Прислів'я про обережність і ризик** | ⚪️ | 774 | Skipped |
| **Вживання у контексті** | ✅ | 325 | Included in Core |
| **Тематична класифікація прислів'їв** | ⚪️ | 0 | Skipped |
| **Міні-діалоги для практики** | ✅ | 150 | Included in Core |
| **Історичний контекст українських прислів'їв про природу і час** | ✅ | 385 | Included in Core |
