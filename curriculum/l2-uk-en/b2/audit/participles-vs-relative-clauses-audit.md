...
| **Дієприкметники проти підрядних речень** | ✅ | 72 | Included in Core |
| **Вступ: Два способи вираження ознаки за дією** | ✅ | 1198 | Included in Core |
| **Морфологічний та синтаксичний еквівалент** | ✅ | 1425 | Included in Core |
| **Стилістичний вибір та культура мовлення** | ✅ | 1370 | Included in Core |
| **Аналіз та виправлення типових помилок** | ✅ | 1231 | Included in Core |
| **Трансформаційна практика та редагування** | ✅ | 1396 | Included in Core |
| **Підсумок** | ✅ | 321 | Included in Core |