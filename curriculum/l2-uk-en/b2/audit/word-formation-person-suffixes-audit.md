...
| **Словотворення: суфікси на позначення осіб** | ✅ | 81 | Included in Core |
| **Вступ: Словотвір як інструмент концептуалізації** | ✅ | 693 | Included in Core |
| **Суфікс -ар/-яр: Від професії до національного символу** | ✅ | 1005 | Included in Core |
| **Суфікс -ач: Виконавець дії та активний діяч** | ✅ | 896 | Included in Core |
| **Суфікс -ник: Рід занять, ролі та соціальні групи** | ✅ | 908 | Included in Core |
| **Практика та синтез: Рекрутинг та аналіз текстів** | ✅ | 865 | Included in Core |
