...
| **Дієприкметники минулого часу на -ний/-тий** | ✅ | 82 | Included in Core |
| **Вступ — Що таке дієприкметник?** | ✅ | 595 | Included in Core |
| **Утворення дієприкметників на -ний** | ✅ | 1111 | Included in Core |
| **Утворення дієприкметників на -тий** | ✅ | 724 | Included in Core |
| **Узгодження дієприкметників** | ✅ | 615 | Included in Core |
| **Пасив із допоміжним дієсловом бути** | ✅ | 681 | Included in Core |
| **Регістрова специфіка** | ✅ | 371 | Included in Core |
| **Підсумок** | ✅ | 417 | Included in Core |