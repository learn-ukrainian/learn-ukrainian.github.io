# Audit Report: M90 — news-analysis-advanced.md
**Level:** B2 | **Module:** M90 | **Phase:** B2.4 | **Pedagogy:** CBI | **Target:** 5000
**Overall Status:** ❌ FAIL
**Generated:** 2026-02-25 17:51:50
...
- **[EUPHONY]** Line 116: «з часом» — з перед з/с/ш/ч; має бути «із часом»
  - FIX: Replace «з» with «із» (before sibilant)
- **[EUPHONY]** Line 133: «у європейській» — у перед голосним; має бути «в європейській»
  - FIX: Replace «у» with «в» (before vowel)
- **[LLM_FINGERPRINT_REPETITION]** Repetitive LLM rhetorical patterns (9 total): 'не просто X, а Y' x6, 'не лише X, а й Y' x3 — robotic prose
...
| **Аналіз новин: Поглиблено** | ✅ | 48 | Included in Core |
| **Розминка та критичний вступ** | ✅ | 495 | Included in Core |
| **Упередженість та редакційна політика** | ✅ | 550 | Included in Core |
| **Пропаганда та емоційні маніпуляції** | ✅ | 556 | Included in Core |
| **Верифікація та фактчекінг** | ✅ | 476 | Included in Core |
| **Мовний аналіз та типові помилки** | ✅ | 490 | Included in Core |
