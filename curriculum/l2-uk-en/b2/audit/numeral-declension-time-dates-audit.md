...
| **Відмінювання числівників І: Час і дати** | ✅ | 57 | Included in Core |
| **Вступ: Культурний код і циклічність часу** | ✅ | 639 | Included in Core |
| **Час: від теорії до живого мовлення** | ✅ | 1069 | Included in Core |
| **Датування: точність у днях та роках** | ✅ | 897 | Included in Core |
| **Офіційно-діловий контекст: терміни та строки** | ✅ | 880 | Included in Core |
| **Практичний практикум та синтез** | ✅ | 641 | Included in Core |
