...
| **Формальне та неформальне спілкування** | ✅ | 64 | Included in Core |
| **Вступ — Формальність у спілкуванні** | ✅ | 687 | Included in Core |
| **Займенники та граматичне узгодження** | ✅ | 916 | Included in Core |
| **Етикетні форми звертання** | ✅ | 993 | Included in Core |
| **Формальна та неформальна лексика** | ✅ | 850 | Included in Core |
| **Соціальні сценарії та перехід між регістрами** | ✅ | 713 | Included in Core |
| **Практика, корекція та підсумок** | ✅ | 516 | Included in Core |
