...
| **Функціональні стилі мови** | ✅ | 54 | Included in Core |
| **Вступ: Що таке функціональний регістр?** | ✅ | 567 | Included in Core |
| **Розмовна та художня сфери** | ✅ | 1001 | Included in Core |
| **Науковий виклад** | ✅ | 667 | Included in Core |
| **Офіційно-ділова комунікація** | ✅ | 759 | Included in Core |
| **Публіцистика та порівняльний аналіз** | ✅ | 730 | Included in Core |
