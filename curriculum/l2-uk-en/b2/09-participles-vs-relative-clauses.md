...
**Ключові пари з тексту:**

| Дієприкметник у тексті | Еквівалент із підрядним реченням | Відмінок «який» |
|------------------------|----------------------------------|-----------------|
| прийнятий Верховною Радою | який прийняла Верховна Рада | знахідний |
| написані українськими авторами | які написали українські автори | знахідний |
| розроблені Міністерством | які розробило Міністерство | знахідний |
| зібрані за п'ять років | які зібрали за п'ять років | знахідний |
| запрошені для оцінки | яких запросили для оцінки | знахідний |

Зверніть увагу, що в кожному випадку займенник «який» стоїть у знахідному відмінку, оскільки позначає прямий об'єкт дії. Це найпоширеніша модель трансформації пасивного дієприкметника в підрядне речення. Суб'єкт дії (хто виконав дію) переходить з орудного відмінка в називний, а об'єкт дії стає займенником «який» у відповідному відмінку.

> [!tip] **Стратегія читання**
>
> Коли ви читаєте український академічний текст, звертайте увагу на дієприкметники — вони часто містять ключову інформацію в компактній формі. Навчіться «розгортати» їх у підрядні речення для кращого розуміння: *прийнятий парламентом* → *який прийняв парламент*. Ця навичка особливо корисна під час читання юридичних та наукових текстів, де дієприкметники створюють щільну інформаційну структуру.
...
Зауважимо: ❌ Неправильно: Проблема, яку досліджуючи...
Зазначимо, що ✅ Правильно: Проблема, яку досліджують...
...
Варто підкреслити, ❌ Неправильно: Книга, яка я читаю...
Варто підкреслити: ✅ Правильно: Книга, яку я читаю...
...
Помітимо: ❌ Неправильно: Особа, яка діє в інтересах компанії...
Зверніть увагу: ✅ Правильно: Діюча особа в інтересах компанії...
...
Стиль тексту визначає не лише зміст, а й граматичні засоби. Дієприкметники та підрядні речення мають різне стилістичне забарвлення, і вміння керувати ними дозволяє автору створювати тексти потрібного тону.

**Порівняйте стилістичний ефект:**

| Стиль | Приклад із дієприкметником | Приклад із підрядним реченням | Ефект |
|-------|---------------------------|------------------------------|-------|
| Офіційний | Наказ, підписаний міністром | Наказ, який підписав міністр | дієприкметник → формальність |
| Науковий | Дані, отримані в ході експерименту | Дані, які отримали в ході експерименту | обидва варіанти прийнятні |
| Розмовний | ❌ Фільм, переглянутий мною | Фільм, який я подивився | дієприкметник звучить неприродно |
| Публіцистичний | Угода, підписана президентами | Угода, яку підписали президенти | підрядне речення — динамічніше |

> [!note] **Щільність тексту**
>
> Дієприкметники «ущільнюють» текст: одне слово замінює ціле підрядне речення. У наукових статтях це дозволяє вмістити більше інформації на сторінку. Проте надмірна щільність ускладнює сприйняття для широкого читача.

Зверніть увагу на важливу закономірність: чим формальніший текст, тим більше дієприкметників; чим розмовніший — тим більше підрядних речень. Цей принцип допоможе вам визначити стилістичну стратегію для будь-якого тексту.

**Стилістичний ефект у літературі:**

Українські письменники свідомо обирають між дієприкметниками та підрядними реченнями для створення потрібної атмосфери. У офіційних промовах персонажів — дієприкметники; у побутових діалогах — підрядні речення. Порівняйте:

- **Канцелярист:** «Документ, поданий вами, відхилено через невідповідність вимогам, затвердженим комітетом.»
- **Та сама інформація від друга:** «Документ, який ти подав, відхилили, бо він не відповідає вимогам, які затвердив комітет.»

Перше речення — холодне, дистанційоване; друге — живе, людяне. Стилістичний вибір передає ставлення мовця до ситуації.

**Ланцюг дієприкметників:**

Іноді в офіційних текстах можна побачити кілька дієприкметників поспіль. Це ускладнює сприйняття:

- ❌ Звіт, підготовлений комісією, затверджений директором, поданий до міністерства... *(занадто щільно)*
- ✅ Звіт, підготовлений комісією та затверджений директором, подано до міністерства. *(компактніше з «та»)*
- ✅ Звіт, який підготувала комісія і затвердив директор, подали до міністерства. *(розмовний варіант)*
...
Дієприкметники — це потужний інструмент офіційного та наукового стилю. Вони надають тексту компактності та формальності. Основні правила вибору:

- **Офіційні документи:** дієприкметники є стандартом (наказ, підписаний директором; звіт, поданий комісією)
- **Наукові тексти:** дієприкметники економлять місце (методи, використані в дослідженні)
- **Усталені вирази:** деякі конструкції існують тільки з дієприкметниками (діюча особа, чинний закон)
- **Компактність:** коли потрібно скоротити довге речення

> [!warning] **Обмеження дієприкметників**
>
> Не всі дієприкметники звучать природно! Активні дієприкметники теперішнього часу (працюючий, читаючий, знаючий) — це русизми у більшості контекстів. Вживайте лише пасивні дієприкметники доконаного виду: написаний, прийнятий, затверджений, підготовлений.
...
Підрядні означальні речення — це універсальний засіб, який підходить для будь-якого стилю. Вони особливо важливі в розмовному та публіцистичному мовленні, де дієприкметники звучать штучно.

**Головні переваги підрядних речень:**

| Перевага | Пояснення | Приклад |
|----------|-----------|---------|
| Зрозумілість | Легше сприймаються на слух | Людина, яка мені допомогла |
| Гнучкість | Передають різні часові відтінки | який допомагав / який допоможе |
| Природність | Відповідають розмовній нормі | Хлопець, що прийшов учора |
| Динамічність | Створюють відчуття дії | Науковець, який досліджує проблему |

> [!cultural] **Жива українська мова**
>
> Сучасні українські блогери, журналісти та ведучі майже не використовують дієприкметники в усному мовленні. Якщо ви хочете говорити природно — обирайте підрядні речення. Дієприкметники залишайте для письмових офіційних текстів.

**Коли підрядне речення — єдиний правильний вибір:**

1. **В усному мовленні** — дієприкметники звучать штучно: «Скажи мені, хто той хлопець, який щойно вийшов?» (не «хлопець, що вийшовший»)
2. **З активним суб'єктом** — коли важливо підкреслити, хто саме виконує дію: «Вчитель, який вже 30 років працює в цій школі, знає кожну дитину.»
3. **З часовими відтінками** — дієприкметники не передають усіх часових нюансів: «Колега, який допоможе вам завтра» (майбутній час неможливий із дієприкметником)
4. **Із запереченням** — підрядне речення передає заперечення природніше: «Студент, який не здав іспит» (не «нездавший студент»)
5. **У питаннях** — «Де та жінка, яка щойно тут стояла?»
...
Ця секція допоможе вам систематизувати все вивчене і відпрацювати навички трансформації на практиці.
...
### Вправа 1: Комплексна трансформація

Перетворіть кожне речення двічі: спочатку в офіційний стиль (із дієприкметником), потім у розмовний (із підрядним реченням).

**Нейтральне речення → Офіційний стиль → Розмовний стиль:**

1. Комісія перевірила звіт. Звіт подали до міністерства.
   - Офіційний: Звіт, перевірений комісією, подано до міністерства.
   - Розмовний: Звіт, який перевірила комісія, подали до міністерства.

2. Студенти написали дипломні роботи. Роботи захистили у червні.
   - Офіційний: Дипломні роботи, написані студентами, захищено у червні.
   - Розмовний: Дипломні роботи, які написали студенти, захистили у червні.

3. Архітектор спроєктував будівлю. Будівлю відкрили минулого року.
   - Офіційний: Будівля, спроєктована архітектором, відкрита минулого року.
   - Розмовний: Будівля, яку спроєктував архітектор, була відкрита минулого року.

4. Журналісти зібрали факти. Факти опублікували в газеті.
   - Офіційний: Факти, зібрані журналістами, опубліковано в газеті.
   - Розмовний: Факти, які зібрали журналісти, опублікували в газеті.

### Вправа 2: Визначте регістр

Прочитайте речення та визначте його стилістичний регістр (офіційний, науковий, розмовний, публіцистичний). Поясніть свій вибір.

1. «Документація, подана заявником, відповідає встановленим вимогам.» → **Офіційний** (дієприкметник + канцелярська лексика)
2. «Той хлопець, що допоміг мені з валізою, був дуже ввічливий.» → **Розмовний** (підрядне речення + побутова ситуація)
3. «Метод, запропонований у цій статті, показав високу ефективність.» → **Науковий** (дієприкметник + термінологія)
4. «Політик, який учора виступив на мітингу, вже встиг змінити свою позицію.» → **Публіцистичний** (підрядне речення + іронічний тон)
5. «Рішення, ухвалене на засіданні ради, набуває чинності з 1 січня.» → **Офіційний** (дієприкметник + юридична формула)

### Вправа 3: Виправте помилки

Знайдіть і виправте стилістичні помилки в кожному реченні:

1. ❌ Друг, запрошений мною на вечерю, прийшов із квітами.
   ✅ Друг, якого я запросив на вечерю, прийшов із квітами. *(Розмовна ситуація — дієприкметник недоречний)*

2. ❌ У наказі зазначено: працівники, які працюють у відділі...
   ✅ У наказі зазначено: працівники відділу... *(В офіційному документі — уникайте зайвого підрядного речення)*

3. ❌ Студенти, навчаючіся в університеті, отримали стипендію.
   ✅ Студенти, які навчаються в університеті, отримали стипендію. *(Активний дієприкметник — русизм)*

4. ❌ Лист, яка я отримав учора, був від мами.
   ✅ Лист, який я отримав учора, був від мами. *(«Лист» — чоловічий рід → «який», не «яка»)*

### Вправа 4: Створіть пари

Для кожного дієприкметника напишіть еквівалентне підрядне речення, і навпаки:

1. Рішення, запропоноване делегацією → Рішення, яке запропонувала делегація
2. Проєкт, який фінансує уряд → Проєкт, фінансований урядом
3. Стаття, опублікована вчора → Стаття, яку опублікували вчора
4. Вчений, який відкрив нову речовину → Вчений, що відкрив нову речовину *(дієприкметник «відкривший» — не рекомендується)*
5. Будинок, збудований у XIX столітті → Будинок, який збудували у XIX столітті
6. Програма, яку створили студенти → Програма, створена студентами

> [!note] **Зверніть увагу**
>
> Не кожне підрядне речення можна легко замінити дієприкметником. Якщо дієприкметник звучить неприродно або є активним дієприкметником теперішнього часу — залишайте підрядне речення.

### Вправа 5: Редагування тексту

Перепишіть цей офіційний текст у розмовному стилі, замінюючи дієприкметники на підрядні речення:

**Офіційний текст:**

«Заходи, заплановані організаційним комітетом та затверджені ректором, передбачають проведення конференції. Доповіді, підготовлені учасниками, будуть опубліковані в збірнику. Запрошення, надіслані партнерським університетам, підтверджено.»

**Зразок розмовного варіанту:**

«Заходи, які запланував оргкомітет і затвердив ректор, передбачають конференцію. Доповіді, які підготують учасники, опублікують у збірнику. Запрошення, які надіслали партнерським університетам, уже підтвердили.»

Зверніть увагу, як змінюється тон тексту: він стає динамічнішим, живішим, ближчим до усного мовлення. Суб'єкт дії з'являється в називному відмінку, що робить речення прозорішим для читача. Порівняйте також ритм обох варіантів: офіційний текст звучить монотонно через однакову структуру «іменник + дієприкметник», а розмовний — більш мелодійно завдяки різноманітності конструкцій.

Пам'ятайте: немає «правильної» чи «неправильної» форми — є доречна чи недоречна для конкретної комунікативної ситуації.
...
|----------|-------------|---------|
| Офіційний документ | Дієприкметник | Наказ, підписаний директором |
| Розмова з друзями | Підрядне речення | Хлопець, який мені допоміг |
| Наукова стаття | Обидві форми | Метод, використаний / який використали |
| Газетна стаття | Підрядне речення | Депутат, який заявив |
| Усталений вираз | Тільки дієприкметник | Діюча особа, чинний закон |
| Резюме / CV | Дієприкметник | Проєкти, реалізовані мною |

> [!tip] **Порада для щоденної практики**
>
> Читаючи будь-який український текст — новини, статті, книги — звертайте увагу на дієприкметники та підрядні речення. Спробуйте трансформувати їх у протилежну форму. Це найкращий спосіб автоматизувати навичку вибору правильної конструкції.

**Головний принцип модуля:** Дієприкметники та підрядні речення — це не «правильно чи неправильно», а питання стилістичного вибору. Навчіться відчувати регістр ситуації, і ваша українська мова стане по-справжньому автентичною.
