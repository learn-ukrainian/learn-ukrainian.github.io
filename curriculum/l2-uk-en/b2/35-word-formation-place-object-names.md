...
|-------|----------|----------|
| читальня | reading room | від «читати» + -альня |
| спальня | bedroom | від «спати» + -альня |
| їдальня | canteen, dining hall | від «їсти» + -альня |
| вітальня | living room | від «вітати» + -альня; кімната для гостей |
| пральня | laundry | від «прати» + -альня |
| кладовище | cemetery | від «клад» + -ище |
| сховище | storage, shelter | від «ховати» + -ище |
| пасовище | pasture | від «пасти» + -ище |
| звалище | dump, landfill | від «звалювати» + -ище |
| городище | ancient settlement | від «город» + -ище; археологічний термін |
| лікарня | hospital | від «лікар» + -ня |
| друкарня | printing house | від «друкар» + -ня |
| пекарня | bakery | від «пекар» + -ня |
| перукарня | hair salon, barbershop | від «перукар» + -ня |
| аптека | pharmacy | грецьке запозичення |
| бібліотека | library | грецьке запозичення |
| крамниця | shop, store | від «крам» (товар) |
| майстерня | workshop | від «майстер» + -ня |
| фабрика | factory | латинське запозичення |
| завод | plant, factory | від «заводити» |
| офіс | office | англійське запозичення |
| кабінет | office, cabinet | французьке запозичення |
| кімната | room | від «комін» (камін) |
| приміщення | premises, building | від «помістити» |
| будівля | building | від «будувати» |
