...
## Розминка — Як утворюються назви місць
...
У центрі містечка розкинувся парк. Колись тут було **городище** — стародавнє слов'янське поселення. Дослідники виявили руїни фортеці та **зерносховище** давніх часів. Тепер на цьому місці — **бібліотека** імені Лесі Українки.
...
**Відмінювання іменників на -ня/-альня:**
...
| Місцевий | у читальні | у читальнях |
...
Зауважимо: цей суфікс утворює назви місць, територій або великих просторів. Твірною основою може бути іменник або дієслово.
...
**Додаткові приклади із суфіксом -ище:**

| Базове слово | Назва місця | Значення |
|---|---|---|
| торг | торговище | місце, де торгують |
| стояти | стоянка / стійбище | місце для стоянки |
| зело (зілля) | зелище (застар.) | місце, де росте зілля |
| вогонь | вогнище | місце для вогню |
| жити | житлище | місце, де живуть |
...
Варто підкреслити, цей суфікс утворює назви закладів, майстерень та виробництв. Твірною основою зазвичай є назва професії або діяльності.
...
Зауважимо: ❌ Неправильно: пекальня (за аналогією до «читальня»)
Зауважимо: ✅ Правильно: пекарня (від «пекар»)

**Чому?** Якщо є усталена назва професії (пекар), використовується суфікс -арня.

**Помилка 3: Неправильний рід**

Варто підкреслити, ❌ Неправильно: цей кладовище
Варто підкреслити, ✅ Правильно: це кладовище
...
Суфікс -арня утворює назви закладів, майстерень та виробництв від назв професій або предметів діяльності. Це один із найпродуктивніших суфіксів для позначення місць, де працюють певні фахівці або виконується певна діяльність. Іменники з цим суфіксом належать до жіночого роду.

Семантика суфікса -арня безпосередньо пов'язана з суфіксом -ар/-яр для назв осіб: лікар працює в лікарні, пекар працює в пекарні, друкар працює в друкарні. Ця логічна паралель допомагає легко запам'ятовувати та утворювати нові слова за цією моделлю.

У повсякденному житті українці регулярно вживають слова з цим суфіксом: «перукарня» де стрижуть волосся, «книгарня» де продають книги, «пекарня» де випікають хліб. Слова з суфіксом -арня охоплюють різні сфери діяльності від медицини до торгівлі та виробництва. Вони є невід'ємною частиною міського та сільського мовного пейзажу. Цікаво, що деякі давні слова з цим суфіксом набули переносного значення: «бойня» від «бити» спочатку означало місце забою худоби, а тепер також вживається у значенні «масове вбивство». Суфікс -арня зберігає свою продуктивність і в сучасних новоутвореннях.
...
## Практика — утворення назв місць

### Практичне завдання 1: Визначте суфікс та базове слово

Для кожної назви місця визначте суфікс та базове слово:

1. **коптильня** → коптити + -ильня (місце, де коптять)
2. **лікарня** → лікар + -ня (заклад, де лікують)
3. **сховище** → ховати + -ище (місце, де ховають)
4. **книгарня** → книга + -арня (магазин книг)
5. **пасовище** → пасти + -ище (місце, де пасуть худобу)

### Практичне завдання 2: Утворіть назви місць

Від поданих слів утворіть назви місць, використовуючи правильний суфікс:

| Базове слово | Суфікс | Назва місця |
|---|---|---|
| варити | -ильня | варильня |
| токар | -ня | токарня |
| вогонь | -ище | вогнище |
| сушити | -ильня | сушильня |
| перукар | -ня | перукарня |
| звалювати | -ище | звалище |

### Практичне завдання 3: Зведена порівняльна таблиця

| Суфікс | Від чого | Рід | Значення | Приклад |
|---|---|---|---|---|
| -ня (-альня, -ильня) | дієслово | ж.р. | місце діяльності | читальня, сушильня |
| -ище | іменник / дієслово | с.р. | територія, простір | кладовище, пасовище |
| -арня | назва професії | ж.р. | заклад, майстерня | лікарня, пекарня |

### Практичне завдання 4: Заповніть пропуски

Вставте правильну назву місця у речення:

1. Діти обідають у шкільній _____ (їсти → ?). — **їдальні**
2. Археологи знайшли стародавнє _____ (город → ?). — **городище**
3. Бабуся відвезла одяг до _____ (прати → ?). — **пральні**
4. Нові ліки можна купити в _____ (лікар → ?) навпроти парку. — **лікарні** (аптеці)
5. Свіжий хліб завжди є у нашій _____ (пекар → ?). — **пекарні**
6. На літньому _____ (пасти → ?) паслися корови. — **пасовищі**
