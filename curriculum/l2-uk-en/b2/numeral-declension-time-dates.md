...
**Коли це використовувати**
Застосовуйте це правило завжди, коли відповідаєте на питання «Коли відбудеться подія?» або «О котрій годині ми зустрінемося?». Запам'ятайте: ми ніколи не кажемо «в дві години» — це помилка. Лише «о другій годині».
...
**Як це працює в мові**
Коли ми відповідаємо на запитання «У якому році?», ми ставимо числівник у місцевий відмінок із прийменником «у» або «в». Змінюється лише останнє слово: двадцятий -> двадцятому, п'ятий -> п'ятому. Частина, що позначає тисячі та сотні, не відмінюється: дві тисячі, дев'ятсот.
...
* ❌ — Давай зустрінемося **в дві години**. 
  ✅ — Давай зустрінемося **о другій годині**. (Помилка: використання прийменника «в» замість «о» та кількісного числівника замість порядкового).
* ❌ — Мій автобус відправляється **без десяти сім**.
  ✅ — Мій автобус відправляється **за десять сьома**. (Помилка: русизм «без десяти». Норма вимагає конструкції з прийменниками «за» або «до»).
* ❌ — Скільки зараз годин?
  ✅ — **Котра година?** (Помилка: питання про тривалість замість питання про точку в часі).
...
**Приклади вживання:**
* Диктор каже: «Новий закон набуває чинності **з першого січня дві тисячі двадцять шостого року**». Ви фіксуєте: Початок дії — 01.01.2026. Увага на родовий відмінок місяця та місцевий відмінок останнього слова в році.
* Оголошення на вокзалі: «Поїзд до Львова відправляється **о дев'ятнадцятій годині двадцять хвилин**». Ви фіксуєте: Відправлення — 19:20.
* Керівник на нараді: «Нам потрібно ολοнчити цей етап **до двадцять восьмого лютого**». Ви фіксуєте: Дедлайн (термін) — 28.02.
