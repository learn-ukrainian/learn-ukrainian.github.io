...
> **Граматика:** [Словотвір української мови](https://r2u.org.ua/) — онлайн-словник з етимологією
> **Корпус:** [Український національний лінгвістичний корпус](https://www.unlc.org.ua/) — пошук словотвірних моделей
> **Відео:** [Словотворення прикметників](https://www.youtube.com/results?search_query=словотворення+прикметників+українська) — відеоуроки
...
|-------|----------|----------|
| український | Ukrainian (adj.) | від "Україна" + -ський |
| німецький | German (adj.) | від "Німеччина" + -цький (чергування) |
| міський | urban, city (adj.) | від "місто" + -ський |
| сільський | rural, village (adj.) | від "село" + -ський |
| національний | national | від "нація" + -альний |
| музикальний | musical (formal) | книжний варіант; нейтр.: музичний |
| центральний | central | від "центр" + -альний |
| професійний | professional | від "професія" + -ний |
| синьо-жовтий | blue-yellow | кольори державного прапора |
| білолиций | white-faced | зовнішність; разом |
| темноволосий | dark-haired | від "темний" + "волосся" |
| добросердечний | kind-hearted | якість характеру |
| різноманітний | diverse, various | від "різний" + "манітний" |
| самобутній | original, unique | буквально: "сам собою" |
| своєрідний | peculiar, distinctive | від "свій" + "рід" |
| первісний | original, primary | від "первіс(ток)" |
| вторинний | secondary | антонім до "первісний" |
| основний | main, basic | від "основа" |
| додатковий | additional | від "додаток" |
| головний | main, chief | від "голова" |
| допоміжний | auxiliary | від "допомога" |
| складний | complex | антонім до "простий" |
| простий | simple | антонім до "складний" |
| комплексний | comprehensive | "що охоплює всі аспекти" |
| системний | systematic | "що утворює систему" |
