...
> **Термінологія:** [Термінологічний портал СУМ](https://sum.in.ua/) — академічний словник української мови
> **Наукові журнали:** [Наукова періодика України](http://journals.uran.ua/) — доступ до українських наукових публікацій
> **Технічні стандарти:** [ДСТУ онлайн](https://dstu.ua/) — державні стандарти України
...
|-------|----------|----------|
| технологія | technology | загальний термін |
| система | system | комп'ютерна/технічна система |
| пристрій | device | технічний пристрій |
| механізм | mechanism | механічний пристрій |
| прилад | instrument, apparatus | вимірювальний прилад |
| обладнання | equipment | загальна назва |
| програма | program, software | комп'ютерна програма |
| алгоритм | algorithm | послідовність дій |
| функція | function | у програмуванні/математиці |
| параметр | parameter | налаштування системи |
| характеристика | characteristic, specification | технічна характеристика |
| специфікація | specification | технічний документ |
| інструкція | instruction, manual | керівництво користувача |
| керівництво | manual, guide | посібник з експлуатації |
| налаштування | settings, configuration | процес або результат |
| встановлення | installation | інсталяція програми |
| експлуатація | operation, use | використання пристрою |
| технічне обслуговування | maintenance | сервісне обслуговування |
| ремонт | repair | відновлення працездатності |
| несправність | malfunction, fault | технічна проблема |
| помилка | error | системна помилка |
| збій | failure, crash | раптова несправність |
| відмова | failure | повна зупинка роботи |
| безпека | safety, security | захист користувача/даних |
| захист | protection | технічний захист |
| контроль | control, monitoring | моніторинг системи |
| вимірювання | measurement | процес або результат |
| калібрування | calibration | налаштування точності |
| тестування | testing | перевірка працездатності |
| сертифікація | certification | підтвердження відповідності |
