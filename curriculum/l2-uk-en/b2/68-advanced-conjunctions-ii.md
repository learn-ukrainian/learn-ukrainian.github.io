...
subtitle: "Advanced Conjunctions II - Temporal and Conditional"
version: "1.0"
...
tags:
  ...
  - conditional
grammar:
  - "Temporal conjunctions (щойно, поки, доки)"
  - "Conditional conjunctions (якщо vs якби)"
objectives:
  - "Учень може будувати складні часові ланцюжки для опису послідовних та паралельних подій"
  - "Учень вміє розрізняти реальні та гіпотетичні умови, використовуючи відповідні сполучники"
  - "Учень розуміє використання сполучників щойно та відколи в історичних та особистих розповідях"
vocabulary_count: 36
...
|-------------------|----------|----------|
| коли | when | універсальне |
| щойно | as soon as, just | миттєва послідовність |
| після того як | after | хронологія |
| перед тим як | before | хронологія |
| поки | while, until | тривалість |
| доки | until | межа часу |
| відколи | since | точка відліку |
| відтоді як | since that time | точка відліку (офіційно) |
| в той час як | while, whereas | паралельність / контраст |
| тим часом | meanwhile | вставна конструкція |
| якщо | if | реальна умова |
| якби | if (counterfactual) | нереальна умова |
| коли б | if only, were | гіпотетична умова |
| у випадку якщо | in case that | офіційне |
| за умови що | on condition that | офіційне |
| при умові що | provided that | офіційне |
| аби | so that, if only | мета / умова |
| щоб / щоби | in order to | мета |
| час | time | іменник |
| умова | condition | іменник |
| можливість | possibility | іменник |
| ймовірність | probability | іменник |
| послідовність | sequence | іменник |
| термін | term, deadline | іменник |
| нагода | opportunity | іменник |
| графік | schedule | іменник |
| сценарій | scenario | іменник |
| гіпотетичний | hypothetical | прикметник |
| реальний | real | прикметник |
| майбутнє | future | іменник |
| минуле | past | іменник |
| тривалість | duration | іменник |
| межа | limit | іменник |
| зв'язок | connection | іменник |
| логіка | logic | іменник |
| етап | stage | частина процесу |
| підготовка | preparation | процес перед дією |
| результат | result | завершення дії |
| координація | coordination | злагодження дій |
| альтернатива | alternative | інший варіант |
| ймовірність | probability | шанс на подію |
| обставина | circumstance | супутній факт |
| ланцюжок | chain | послідовність |
| ретроспектива | retrospection | погляд у минуле |
| графік | schedule | іменник |
| сценарій | scenario | іменник |
| гіпотетичний | hypothetical | прикметник |
| реальний | real | прикметник |
...
> - [Електронний підручник з граматики](https://ukr-mova.in.ua/) — вправи на сполучники.
> - [Історія Полтавщини та Сумщини](https://history.ua/) — приклади часових описів.
> - [Культура мови: Якби чи Коли б?](https://shron1.chtyvo.org.ua/) — розбір нюансів.

# Підсумок

Сьогодні ми навчилися керувати часом та умовами в реченні.
- **Час:** Ми освоїли динаміку «щойно», тривалість «поки» та ретроспективу «відколи».
- **Умова:** Ми відчули різницю між реальним «якщо» та мрійливим «якби».
- **Логіка:** Ми навчилися будувати складні сценарії розвитку подій у часі.

Пам'ятайте: умови життя постійно змінюються, але ваша здатність їх грамотно описати залишається з вами. Використовуйте ці сполучники влучно, і ваша мова завжди буде структурованою, логічною та переконливою. Ваша подорож українським світом стає дедалі впевненішою!