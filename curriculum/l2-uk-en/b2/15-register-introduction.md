...
subtitle: "П'ять голосів української"
version: "1.0"
phase: "B2"
pedagogy: "TTT"
duration: 90
...
objectives:
  - "Учень може розпізнавати п'ять функціональних стилів української мови"
  - "Учень може визначати стильові маркери в тексті"
  - "Учень може обирати відповідний стиль залежно від комунікативної ситуації"
vocabulary_count: 25
---
...
|-------|----------|----------|
| стиль | style | функціональний різновид мови |
| функціональний | functional | пов'язаний з функцією, призначенням |
| офіційно-діловий | official/business | стиль документів і ділового спілкування |
| науковий | scientific/academic | стиль наукових праць |
| публіцистичний | journalistic/publicistic | стиль ЗМІ, публіцистики |
| художній | literary/artistic | стиль літератури, мистецтва |
| розмовний | colloquial/conversational | стиль щоденного спілкування |
| формальний | formal | офіційний, дотримується норм |
| неформальний | informal | неофіційний, вільний |
| нейтральний | neutral | без емоційного забарвлення |
| книжний | bookish/literary | характерний для писемної мови |
| усний | oral | характерний для усного мовлення |
| письмовий | written | пов'язаний з писемною формою |
| термін | term | спеціальне слово певної галузі |
| кліше | cliche | усталений вираз |
| штамп | stamp/stock phrase | заяложений, надуживаний вираз |
| експресія | expression/expressiveness | виразність, емоційність |
| образність | imagery/figurativeness | використання образних засобів |
| точність | precision/accuracy | однозначність формулювань |
| лаконічність | conciseness/brevity | стислість викладу |
| емоційність | emotionality | вираження емоцій |
| об'єктивність | objectivity | неупередженість |
| суб'єктивність | subjectivity | особиста позиція, оцінка |
| стандартність | standardness | дотримання усталених норм |
| індивідуальність | individuality | авторський стиль |
