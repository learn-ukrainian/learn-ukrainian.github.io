...
> **Словник:** [Медичний словник української мови](https://slovnyk.ua/) — пошук медичних термінів
> **МОЗ:** [Офіційний сайт МОЗ України](https://moz.gov.ua/) — офіційна медична інформація
> **Довідник:** [Медичний довідник](https://compendium.com.ua/) — довідник лікарських засобів
...
|-------|----------|----------|
| лікар | doctor | пане лікарю (кличний) |
| пацієнт | patient | хворий |
| медсестра | nurse | медична сестра |
| поліклініка | outpatient clinic | де приймають амбулаторно |
| лікарня | hospital | де лежать хворі |
| діагноз | diagnosis | висновок лікаря |
| симптом | symptom | ознака хвороби |
| скарга | complaint | На що скаржитесь? |
| огляд | examination | медичний огляд |
| аналіз | test | здати аналізи |
| рецепт | prescription | виписати рецепт |
| ліки | medicine | лікарські засоби |
| таблетка | pill, tablet | пігулка |
| укол | injection | ін'єкція |
| процедура | procedure | медична маніпуляція |
| операція | surgery | хірургічне втручання |
| лікування | treatment | курс лікування |
| одужання | recovery | повне одужання |
| біль | pain | головний біль |
| температура | fever, temperature | висока температура |
| тиск | blood pressure | виміряти тиск |
| кашель | cough | сухий/вологий кашель |
| нежить | runny nose | закладений ніс |
| алергія | allergy | алергічна реакція |
| інфекція | infection | вірусна інфекція |
| запалення | inflammation | запалення легень |
| хронічний | chronic | хронічна хвороба |
| гострий | acute | гострий біль |
| профілактика | prevention | профілактичний огляд |
| імунітет | immunity | підтримувати імунітет |
