...
subtitle: "Коли на «ти», а коли на «Ви»"
version: "1.0"
...
tags:
  ...
  - address-forms
grammar:
  - "Ти/Ви-distinction in address"
  - "Formal/informal lexical pairs"
  - "Forms of address (Пан/Пані, Шановний)"
  - "Register-appropriate vocabulary selection"
objectives:
  - "Учень може правильно обирати між формами «ти» та «Ви» залежно від ситуації"
  - "Учень може трансформувати неформальний текст у формальний і навпаки"
  - "Учень може використовувати відповідні форми звертання у діловому спілкуванні"
vocabulary_count: 25
---
...
> **Відео:** [Ти чи Ви? Українська мова](https://www.youtube.com/results?search_query=ти+чи+ви+українська+мова) — пояснення від носіїв мови
> **Етикет:** [Український мовний етикет](https://uk.wikipedia.org/wiki/Український_мовний_етикет) — правила ввічливого спілкування
> **Словник:** [Словник синонімів української мови](https://slovnyk.ua/) — пошук формальних/неформальних відповідників
...
|-------|----------|----------|
| звертання | form of address | спосіб називати співрозмовника |
| ти | you (informal sg.) | неформальне звертання |
| ви | you (plural/formal) | Ви — формальне до однієї особи |
| пан | Mr., sir | офіційне звертання до чоловіка |
| пані | Mrs., Ms., madam | офіційне звертання до жінки |
| шановний | dear, respected | у листуванні |
| вельмишановний | most respected | дуже формальне звертання |
| ввічливий | polite | той, хто дотримується етикету |
| неввічливий | impolite, rude | той, хто порушує норми |
| офіційний | official, formal | офіційно-діловий стиль |
| неофіційний | unofficial, informal | неформальний стиль |
| дружній | friendly | характеристика відносин |
| формальний | formal | характеристика стилю |
| етикет | etiquette | правила поведінки |
| норма | norm, standard | загальноприйняте правило |
| тон | tone | характер спілкування |
| регістр | register | мовний стиль |
| субординація | subordination | підпорядкування за статусом |
| рівність | equality | однаковий статус |
| повага | respect | шанобливе ставлення |
| фамільярність | familiarity | надмірна близькість |
| дистанція | distance | соціальна відстань |
| близькість | closeness | близькі відносини |
| ввічливість | politeness | дотримання етикету |
| чемність | courtesy | ввічлива поведінка |
