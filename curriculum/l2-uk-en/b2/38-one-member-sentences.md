...
В українській мові не кожне речення потребує і підмета, і присудка. Односкладні речення — це конструкції, в яких граматична основа складається лише з одного головного члена. Такі речення — не помилка, не скорочення, а повноцінні синтаксичні одиниці з чітким значенням. Українська мова активно використовує їх у різних стилях: від розмовного до художнього та наукового.

Розрізняють чотири основні типи: означено-особові, неозначено-особові, безособові та номінативні. Кожен тип має свою структуру, семантику та стилістичну роль.

**Завдання до тексту:**

1. Знайдіть речення, де немає підмета, але зрозуміло, хто виконує дію.
2. Визначте безособові речення, де відсутня особа-діяч.
...
**2. Трансформація у неозначено-особове (Усунення виконавця)**
- **Люди кажуть**, що... → **Кажуть**, що...
- **Будівельники звели** будинок → **Звели** будинок.

**3. Перехід до безособового (Стан, незалежний від особи)**
...
У неозначено-особових реченнях виконавець дії невідомий, неважливий або навмисно не називається. Присудок стоїть у формі третьої особи множини теперішнього чи минулого часу:

- **Тут не курять.** — хтось невизначений, загальне правило
- **Нам принесли квитки.** — хтось приніс, не важливо хто
- **У газеті пишуть...** — автор невідомий або несуттєвий
- **Про нього кажуть різне.** — невизначена група людей

Неозначено-особові речення дуже продуктивні в офіційному та науковому стилях: «Заяву подають у двох примірниках», «У цьому дослідженні використовують метод спостереження». Вони створюють ефект узагальнення та об'єктивності.

> [!tip]
> Порівняйте з англійською: «They say...», «People believe...», «One should...» — все це відповідає українським неозначено-особовим реченням. Але в українській мові форма дієслова однозначно вказує на цей тип (третя особа множини без підмета).
...
Номінативні речення — це особливий тип односкладних речень, де присудок відсутній, а головний член виражений іменником у називному відмінку. Вони лише констатують існування або наявність чогось:

**Структура:**

- **Ніч. Тиша. Спокій.** — називання стану, обстановки
- **Київ! Древня столиця!** — емоційна характеристика
- **Осінь. Дощ. Пожовклі листки.** — картина, образ

**Розширені номінативні:**

Номінативні речення можуть мати означення: «Тиха ніч. Зоряне небо. Срібний місяць.» Це створює ефект імпресіоністичної замальовки.

**Стилістичні функції:**

- **Емоційність** — посилення почуттів: «Пожежа! На допомогу!»
- **Лаконічність** — економія слів для динамічності: «Вечір. Тиша. Темрява.»
- **Імпресіонізм** — фрагментарність образу, як у живописі: «Запах хліба. Біла скатертина. Тепло.»
- **Динаміка** — швидкий ритм оповіді: «Дорога. Поле. Ліс. Село.»

> [!tip]
> Номінативні речення часто використовуються в ремарках п'єс, на початку глав у романах та в поетичних текстах. Тарас Шевченко, Павло Тичина, Ліна Костенко майстерно вживають цей тип речень.

**Порівняйте:**

| Двоскладне | Номінативне |
|---|---|
| Надворі панує тиша. | Тиша. |
| Настав вечір. | Вечір. |
| Це було село. | Село. |

Номінативні речення можуть бути лише стверджувальними — заперечних номінативних речень не існує.

## Практика — односкладні речення

### Завдання: Трансформація

Перетворіть двоскладні речення на односкладні різних типів:

1. «Ми сидимо біля вогню» → означено-особове: «Сидимо біля вогню.»
2. «Хтось постукав у двері» → неозначено-особове: «Постукали в двері.»
3. «Мені стало сумно» → безособове: «Сумно.»
4. «Це було літо» → номінативне: «Літо.»
