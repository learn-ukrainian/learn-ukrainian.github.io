...
objectives:
  ...
  - "Learner understands the expressive functions of one-member sentences"
vocabulary_count: 25
---
...
> **Довідник:** [Синтаксис української мови](https://uk.wikipedia.org/wiki/Односкладне_речення) — базові поняття
> **Підручник:** [Український правопис](https://pravopys.net/) — офіційні правила
> **Література:** Твори Михайла Коцюбинського — майстра односкладних речень
...
|-------|----------|----------|
| односкладний | one-member | про структуру речення |
| двоскладний | two-member | має підмет і присудок |
| означено-особовий | definite-personal | тип односкладного речення |
| неозначено-особовий | indefinite-personal | тип односкладного речення |
| безособовий | impersonal | без підмета |
| номінативний | nominative | називний відмінок |
| підмет | subject | головний член речення |
| присудок | predicate | головний член речення |
| головний | main | про член речення |
| другорядний | secondary | про член речення |
| члени речення | sentence members | підмет, присудок, додаток |
| структура | structure | будова |
| синтаксис | syntax | розділ граматики |
| конструкція | construction | мовна побудова |
| вираз | expression | словосполучення |
| форма | form | граматична форма |
| модель | model | зразок |
| зразок | example | приклад для наслідування |
| вживання | usage | використання |
| стилістика | stylistics | наука про стилі |
| емоційність | emotionality | вираження емоцій |
| лаконічність | brevity | стислість |
| імпресіонізм | impressionism | мистецька течія |
| мінімалізм | minimalism | принцип простоти |
| експресивність | expressiveness | виразність |
