...
> Перед покупкою квартири родина переглянула десятки варіантів, перевірила документи, проконсультувалася з юристом. «Обережному й Бог помагає», — навчав батько змалку.
...
Зауважимо також: варто зазначити: **Регістр:** Нейтральний, часто вживається в бізнес-контексті.
...
> Програміст отримав непогану пропозицію роботи, але чекав на «ідеальну» вакансію. «Не ганяйся за журавлем — лови синицю!», — порадив батько. Він прийняв пропозицію і не пошкодував.
...
Варто зазначити: **Міжмовна паралель:** Прислів'я латинського походження, відоме в усіх європейських мовах.
...
**Надія:** Краща стабільна посада з гарантією, ніж ілюзорна мрія про ідеальну роботу.
...
## Практика — прислів'я у контексті
