...
subtitle: "Модальність, джерело інформації та логічні зв'язки"
version: "1.0"
...
objectives:
  - "Learner can use parenthetical expressions to indicate certainty and uncertainty"
  - "Learner can employ parenthetical expressions for attitude and source attribution"
  - "Learner can organize discourse using sequence markers"
  - "Learner can correctly punctuate sentences with parenthetical expressions"
vocabulary_count: 30
---
...
> **Довідник:** [Синтаксис української мови](https://uk.wikipedia.org/wiki/Вставні_слова) — теорія вставних конструкцій
> **Підручник:** [Український правопис](https://pravopys.net/) — правила пунктуації
> **Корпус:** [ГРАК](https://uacorpus.org/) — приклади вживання в реальних текстах
...
|-------|----------|----------|
| безумовно | undoubtedly | максимальна впевненість |
| безперечно | unquestionably | офіційний регістр |
| звичайно | of course | нейтральний регістр |
| справді | indeed | підтвердження |
| очевидно | obviously | висновок із фактів |
| зрозуміло | understandably | логічний наслідок |
| можливо | possibly | припущення |
| мабуть | probably | ймовірність ~70% |
| здається | it seems | суб'єктивне враження |
| напевно | presumably | ймовірність ~85% |
| імовірно | probably | офіційний регістр |
| на жаль | unfortunately | негативна емоція |
| на щастя | fortunately | позитивна емоція |
| на диво | surprisingly | здивування |
| як відомо | as is known | загальне знання |
| як кажуть | as they say | народна мудрість |
| як правило | as a rule | типовість |
| за даними | according to | статистика |
| на думку | in the opinion of | думка експерта |
| по-перше | firstly | початок переліку |
| по-друге | secondly | продовження переліку |
| нарешті | finally | завершення |
| отже | therefore | висновок |
| таким чином | thus | підсумок |
| до речі | by the way | додаткова інформація |
| між іншим | incidentally | побічне зауваження |
| власне кажучи | strictly speaking | уточнення |
| іншими словами | in other words | перефразування |
| одним словом | in a word | короткий підсумок |
| у будь-якому разі | in any case | незалежно від обставин |
