...
|-------------|---------------|-----------|---------|--------|
Окрім того, варто зазначити: | безумовно, звичайно | можливо, здається, імовірно | на жаль, на щастя | за даними, як відомо | по-перше, отже, до речі |
...
Варто зазначити: 2. **Пунктуація:** вставні слова ЗАВЖДИ виділяються комами.
