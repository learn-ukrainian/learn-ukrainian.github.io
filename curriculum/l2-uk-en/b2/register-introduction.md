...
## Вступ — Що таке функціональний стиль?

Функціональний стиль — це різновид літературної мови, який використовується в певній сфері людської діяльності. Кожен стиль має свої мовні засоби, правила побудови тексту та комунікативну мету. В українській мові виділяють п'ять основних функціональних стилів: офіційно-діловий, науковий, публіцистичний, художній та розмовний. Уміння розрізняти ці стилі та вільно переходити між ними — це ключова компетенція рівня B2, яка відрізняє просунутого мовця від початківця. Адже носій мови автоматично обирає відповідний стиль залежно від ситуації: інакше ви говорите з другом, інакше пишете заяву, і зовсім по-іншому виступаєте на конференції.
...
Зауважимо: цей стиль використовується в науці та освіті для передачі об'єктивного знання.
...
Варто підкреслити, цей стиль обслуговує сферу масової комунікації: журналістику, рекламу, публічні виступи.
...
Помітимо: цей стиль — найбільш вільний і індивідуальний. Він служить естетичній функції мови.
...
Слід зазначити, цей стиль обслуговує повсякденне неофіційне спілкування.
...
Варто зазначити: **Правило:** Вживайте **й** після голосного, **і** — після приголосного або на початку речення.
...
Художній стиль — це стиль літературних творів: поезії, прози, драматургії. Його головна функція — естетична: вплинути на почуття та уяву читача через образність мовлення. На відміну від інших стилів, художній стиль використовує всі багатства мови — від найвишуканіших метафор до діалектизмів та жаргонізмів, якщо цього вимагає художній задум.

**Ознаки художнього стилю:**
- **Образність:** метафори, порівняння, епітети (*«Місяць плив крізь хмари»*)
- **Емоційність:** авторське ставлення до зображуваного
- **Індивідуальність:** неповторний авторський стиль
- **Естетична функція:** мова як засіб створення прекрасного

> [!quote] Тарас Шевченко
> «Ревуть, стогнуть гори, високії, / Дуби похилились, / І хмароньки накрили / Козацькії могили.»

Цей уривок демонструє типові риси художнього стилю: персоніфікацію (гори стогнуть), епітети (високії), зменшувально-пестливі форми (хмароньки). Саме ці засоби відрізняють художній стиль від усіх інших.

У сучасній українській літературі художній стиль поєднує класичні образні засоби з новаторськими прийомами: потік свідомості, фрагментарність оповіді, змішування реєстрів. Письменники, такі як Сергій Жадан та Юрій Андрухович, демонструють, як художній стиль може вбирати елементи розмовного та публіцистичного мовлення, зберігаючи при цьому свою естетичну функцію.

**Основні жанри художнього стилю:**

**Поезія** відрізняється ритмічною організацією, рифмою та особливою конденсацією образів. Порівняйте прозовий опис «Сонце заходить, небо стає червоним» із поетичним: *«Западає за обрій кривавий диск, / І небо палає, як рана.»* Поетичний варіант створює набагато сильніше емоційне враження.

**Проза** — оповідання, повісті, романи — дає автору більше простору для розгортання сюжету та характерів. Прозовий художній стиль часто наслідує живе мовлення персонажів, включаючи діалекти, просторіччя та індивідуальні мовленнєві особливості.

**Драматургія** будується переважно на діалогах, тому художній стиль у п'єсах має особливий характер: кожен персонаж говорить своєю мовою, і через це мовлення розкривається його характер та соціальне походження.

> [!cultural] **Українська літературна мова**
>
> Українська літературна мова сформувалася на основі живої народної мови завдяки творчості Івана Котляревського, Тараса Шевченка та інших класиків. Саме художній стиль був тим середовищем, де українська мова розвивалася та збагачувалася новими виразовими засобами.
...
1. **Офіційно-діловий** (наказ міської ради)
2. **Публіцистичний** (новина для сайту міста)
3. **Розмовний** (розповідь другові)
...
> 1. Визначте ключові ідеї (вони не змінюються)
> 2. Виберіть лексику відповідного стилю
> 3. Змініть синтаксис (прості/складні речення)
> 4. Додайте/приберіть емоційність
> 5. Перечитайте вголос — чи звучить природно?
...
Публіцистичний стиль — це стиль засобів масової інформації, публічних виступів, блогів та соціальних мереж. Його головна мета — інформувати та водночас впливати на громадську думку. Цей стиль поєднує логічність наукового стилю з емоційністю художнього.

**Характерні ознаки:**
- **Суспільно-політична лексика:** демократія, реформа, громадянське суспільство
- **Оцінна лексика:** вражаючий, безпрецедентний, критичний
- **Риторичні прийоми:** питання, вигуки, звернення до читача
- **Кліше та штампи:** «на порядку денному», «піднімати питання», «викликати резонанс»

> *«Українська мова переживає справжній ренесанс. За останні роки кількість україномовних медіа зросла вдвічі, а запит суспільства на якісний контент українською досяг безпрецедентного рівня. Чи готові ми відповісти на цей виклик?»*

Цей приклад ілюструє типові риси публіцистичного стилю: оцінні прикметники («справжній», «безпрецедентний»), конкретні факти для переконливості («зросла вдвічі»), риторичне запитання наприкінці для залучення читача. Публіцистичний стиль є чи не найважливішим для повсякденного життя: саме ним написані новини, які ви читаєте щодня.

**Підстилі публіцистичного стилю:**

**Інформаційний** — новини, репортажі, хроніки. Головне — точність і оперативність: *«Сьогодні о 14:00 у Києві відбулося відкриття виставки сучасного українського мистецтва. На церемонії були присутні представники Міністерства культури.»*

**Аналітичний** — статті, огляди, рецензії. Поєднує факти з авторською оцінкою: *«Реформа освіти, розпочата три роки тому, нарешті починає давати результати. Однак залишається відкритим питання фінансування.»*

**Художньо-публіцистичний** — есеї, нариси, фейлетони. Найближчий до художнього стилю: *«Місто прокидалося. Перші промені сонця торкалися золотих куполів Софії, і здавалося, що столиця посміхається новому дню.»*

Уміння розрізняти ці підстилі та працювати з ними — важлива навичка для тих, хто хоче розуміти українські медіа на рівні носія мови. Зверніть увагу, як один і той самий журналіст може писати стислу новину та розлогий аналітичний матеріал, змінюючи при цьому не лише обсяг, а й мовні засоби.
...
Тепер, коли ви ознайомилися з п'ятьма функціональними стилями, спробуйте застосувати ці знання на практиці.

**Вправа 1: Трансформація тексту.** Візьміть одну й ту саму подію та опишіть її п'ятьма різними стилями. Наприклад, подію «Україна виграла чемпіонат Європи з шахів»:

- **Офіційно-діловий:** *«Повідомляємо, що збірна команда України посіла перше місце на чемпіонаті Європи з шахів, який відбувся 15-25 вересня поточного року.»*
- **Науковий:** *«Аналіз результатів чемпіонату Європи з шахів демонструє високий рівень підготовки українських гросмейстерів, що корелює з розвитком шахової освіти в країні.»*
- **Публіцистичний:** *«Сенсаційна перемога! Українські шахісти здобули золото чемпіонату Європи, довівши всьому світу силу української інтелектуальної еліти.»*
- **Художній:** *«Тиша зали розсипалася на тисячу осколків оплесків, коли останній хід розчертив шахівницю перемогою.»*
- **Розмовний:** *«Ти чув? Наші виграли! Шахісти, кажу, на Європі перших місць набрали!»*

**Вправа 2: Визначення стилю в реальних текстах.** Протягом тижня збирайте тексти з різних джерел — листи, новини, наукові статті, художні фрагменти, переписку з друзями. Для кожного тексту визначте домінуючий стиль та назвіть три мовні ознаки, які допомогли вам це зробити. Зверніть увагу на тексти, де змішуються кілька стилів, — це цілком природне явище в сучасній комунікації.
...
> «Мова — це душа народу. Без мови немає народу.»
> — Іван Франко

> «Кожна людина мусить працювати задля збереження рідної мови.»
> — Леся Українка

# Підсумок

У цьому модулі ви опанували систему п'яти функціональних стилів української мови та навчилися розрізняти їх за лексичними, синтаксичними та стилістичними ознаками. Продовжуйте практикувати визначення стилів у текстах, які зустрічаєте щодня.
