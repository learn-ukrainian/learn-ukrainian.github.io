...
subtitle: "Synonyms - Action and Transformation"
version: "1.0"
...
tags:
  ...
  - action
grammar:
  - "Nuances in verbs of action"
  - "Aspectual pairs and intensity"
objectives:
  - "Учень може розрізняти відтінки значень дієслів на позначення дії (робити, чинити, діяти)"
  - "Учень вміє обирати точне слово для опису професійних та творчих процесів"
  - "Учень розуміє концепцію вчинку та результату в українському культурному контексті"
vocabulary_count: 35
...
|-------|----------|----------|
| робити | to do / make | нейтральне |
| чинити | to do / act | формально-правовий |
| діяти | to act | активна позиція |
| виконувати | to perform / fulfill | про обов'язки |
| здійснювати | to carry out / realize | про плани |
| реалізовувати | to implement | про проєкти |
| втілювати | to embody / realize | про ідеї/мрії |
| творити | to create | про мистецтво/нове |
| брати | to take | нейтральне |
| взяти | to take (perfective) | результат |
| хапати | to grab / snatch | швидко, різко |
| вихоплювати | to snatch out | раптово |
| отримувати | to receive / get | нейтральне/офіційне |
| приймати | to accept / take in | свідома згода |
| давати | to give | нейтральне |
| віддавати | to give back / away | завершення володіння |
| передавати | to pass / transmit | посередництво |
| вручати | to hand over | урочисто |
| дія | action | загальний термін |
| вчинок | deed / act | моральне значення |
| акція | action / campaign | організована подія |
| активність | activity | стан дії |
| процес | process | тривалість |
| результат | result | завершення |
| наслідок | consequence | ефект дії |
| ефект | effect | вплив |
| вплив | influence | сила дії на інше |
| зміна | change | перетворення |
| перетворення | transformation | глибока зміна |
| удосконалення | improvement | покращення якості |
| створювати | to create | нейтральний синонім |
| будувати | to build | про споруди або плани |
| руйнувати | to destroy | антонім дії |
| допомагати | to help | дія на користь іншого |
| заважати | to hinder | дія на шкоду іншому |

> [!resources] Додаткові ресурси
> - [Словник української мови (СУМ)](http://sum.in.ua/) — перевірка відтінків дієслів.
> - [Іван Франко: Каменярі](https://ukrlit.org/franko_ivan_yakovych/kameniari) — текст про філософію чину.
> - [Культура ділового мовлення](https://youtube.com/...) — як правильно вживати дієслова дії в документах.

# Підсумок

Сьогодні ми відкрили для себе динамічний світ української дії.
- **Праця:** Ми навчилися розрізняти нейтральне «робити», офіційне «здійснювати» та творче «творити».
- **Взаємодія:** Ми побачили різницю між ввічливим «отримувати» та різким «хапати».
- **Аналіз:** Ми вивчили терміни, що описують вчинок, процес та його наслідок.

Пам'ятайте: дієслово — це мотор речення. Обирайте потужні та точні дієслова, щоб ваше життя та мова завжди були сповнені енергії та змісту!