...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/reflexive-passive-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/reflexive-passive.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/reflexive-passive.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Зворотний пасив із -ся** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Поняття зворотності та пасиву | 600 | 900 |
| Морфологія та правила утворення | 800 | 1200 |
| Семантика процесу та роль Агента | 900 | 1350 |
| Культура: Українські винаходи крізь призму пасиву | 1000 | 1500 |
| Стилістика та запобігання помилкам | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/reflexive-passive.yaml`. Go through EVERY `points:` item in EVERY section:
