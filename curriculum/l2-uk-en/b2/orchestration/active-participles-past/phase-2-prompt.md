...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/active-participles-past-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/active-participles-past.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/active-participles-past.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Активні дієприкметники минулого часу (-лий)** (b2 track).
...
|---------|--------|---------------------|
| Вступ та теоретичний контекст | 500 | 750 |
| Нормативні форми на -лий | 800 | 1200 |
| Боротьба з русизмами та канцеляритом | 1000 | 1500 |
| Лексикалізація та статус 'колишнього' | 600 | 900 |
| Синтетичний майбутній час | 800 | 1200 |
| Підсумок та практичні поради | 300 | 450 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/active-participles-past.yaml`. Go through EVERY `points:` item in EVERY section:
