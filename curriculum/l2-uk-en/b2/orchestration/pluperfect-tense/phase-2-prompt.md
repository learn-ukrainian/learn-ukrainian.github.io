...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/pluperfect-tense-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/pluperfect-tense.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/pluperfect-tense.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Давноминулий час** (b2 track).
...
|---------|--------|---------------------|
| Вступ та культурний контекст | 600 | 900 |
| Граматичне утворення та узгодження | 800 | 1200 |
| Значення та вживання: часова лінія | 900 | 1350 |
| Типові помилки та контрастивний аналіз | 800 | 1200 |
| Практика та стилістичне моделювання | 600 | 900 |
| Підсумок та вибір стилю | 300 | 450 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/pluperfect-tense.yaml`. Go through EVERY `points:` item in EVERY section:
