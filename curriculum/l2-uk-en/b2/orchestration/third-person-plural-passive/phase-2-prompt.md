...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/third-person-plural-passive-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/third-person-plural-passive.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/third-person-plural-passive.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Пасив третьою особою множини** (b2 track).
...
|---------|--------|---------------------|
| Вступ | 500 | 750 |
| Граматична база та термінологія | 800 | 1200 |
| Соціокультурний аспект пліток | 900 | 1350 |
| Порівняння регістрів та аналіз помилок | 900 | 1350 |
| Практичне застосування та підсумок | 900 | 1350 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/third-person-plural-passive.yaml`. Go through EVERY `points:` item in EVERY section:
