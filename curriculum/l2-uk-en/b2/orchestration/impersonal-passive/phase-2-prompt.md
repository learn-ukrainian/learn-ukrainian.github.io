...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/impersonal-passive-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/impersonal-passive.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/impersonal-passive.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Безособові конструкції на -но/-то** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Поняття безособовості | 500 | 750 |
| Творення та граматичні особливості | 800 | 1200 |
| Синтаксис та керування об'єктом | 900 | 1350 |
| Офіційно-діловий та юридичний стиль | 1000 | 1500 |
| Практика та запобігання помилкам | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/impersonal-passive.yaml`. Go through EVERY `points:` item in EVERY section:
