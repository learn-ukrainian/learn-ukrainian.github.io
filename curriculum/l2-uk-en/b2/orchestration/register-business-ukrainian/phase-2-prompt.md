...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/register-business-ukrainian-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/register-business-ukrainian.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/register-business-ukrainian.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Ділова українська мова** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Поняття ділового стилю | 500 | 750 |
| Ділове та електронне листування | 900 | 1350 |
| Переговори та укладання угод | 900 | 1350 |
| Корпоративна комунікація та етика | 700 | 1050 |
| Типові помилки та мовна норма | 600 | 900 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/register-business-ukrainian.yaml`. Go through EVERY `points:` item in EVERY section:
