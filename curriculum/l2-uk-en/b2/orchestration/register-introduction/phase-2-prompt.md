...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/register-introduction-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/register-introduction.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/register-introduction.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Функціональні стилі мови** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Що таке функціональний регістр? | 600 | 900 |
| Розмовна та художня сфери | 1000 | 1500 |
| Науковий виклад | 800 | 1200 |
| Офіційно-ділова комунікація | 800 | 1200 |
| Публіцистика та порівняльний аналіз | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/register-introduction.yaml`. Go through EVERY `points:` item in EVERY section:
