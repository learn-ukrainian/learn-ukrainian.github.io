...
3. Verify with Grep: `Grep pattern="first 5-6 words" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/passive-voice-system.md"`
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/passive-voice-system-research.md`
...
1. Вступ — Що таке пасивний стан?
2. Форма 1 — Дієприкметники на -ний/-тий
3. Форма 2 — Безособові конструкції на -но/-то
4. Форма 3 — Зворотний пасив із -ся
5. Форма 4 — Третя особа множини
6. Вибір форми пасиву за контекстом
