...
> **Your #1 job: Write 948 words for the section "Форма 3 — Зворотний пасив із -ся".**
...
Write the section prose for **Форма 3 — Зворотний пасив із -ся** within the module **Пасивний стан: повна система**.

- **WORD BUDGET**: 948 words minimum, 948 × 2 maximum. Stay in this range.
...
Previously used callout types in this module: warning, myth-buster, culture, tip, history-bite, observe
...
- Target: 948 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Форма 3 — Зворотний пасив із -ся": {count} words (budget: 948-948×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Форма 3 — Зворотний пасив із -ся)
