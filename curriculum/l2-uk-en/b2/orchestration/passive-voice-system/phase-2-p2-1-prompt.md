...
> **Your #1 job: Write 789 words for the section "Вступ — Що таке пасивний стан?".**
...
Write the section prose for **Вступ — Що таке пасивний стан?** within the module **Пасивний стан: повна система**.
...
```
===WORD_COUNTS===
Section "Вступ — Що таке пасивний стан?": {count} words (budget: 789-789×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Вступ — Що таке пасивний стан?)
