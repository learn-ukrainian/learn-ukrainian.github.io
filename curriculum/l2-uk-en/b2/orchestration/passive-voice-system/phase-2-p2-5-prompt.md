...
> **Your #1 job: Write 948 words for the section "Форма 4 — Третя особа множини".**
...
Write the section prose for **Форма 4 — Третя особа множини** within the module **Пасивний стан: повна система**.
...
```
===WORD_COUNTS===
Section "Форма 4 — Третя особа множини": {count} words (budget: 948-948×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Форма 4 — Третя особа множини)
