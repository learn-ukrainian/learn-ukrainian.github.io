...
1. **Content** (the lesson you're reviewing): `curriculum/l2-uk-en/b2/passive-voice-system.md`
2. **Activities**: `curriculum/l2-uk-en/b2/activities/passive-voice-system.yaml`
3. **Vocabulary**: `curriculum/l2-uk-en/b2/vocabulary/passive-voice-system.yaml`
4. **Plan** (source of truth for scope): `curriculum/l2-uk-en/plans/b2/passive-voice-system.yaml`
5. **Meta** (build config): `curriculum/l2-uk-en/b2/meta/passive-voice-system.yaml`
6. **Research notes** (if exists): `curriculum/l2-uk-en/b2/research/passive-voice-system-research.md`
...
At module 1, students know ONLY modules 1-B1 Completion. Any grammar from later modules is scope creep.
