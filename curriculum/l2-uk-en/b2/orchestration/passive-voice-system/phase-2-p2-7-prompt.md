...
> **Your #1 job: Write 315 words for the section "Підсумок і практика".**
...
Write the section prose for **Підсумок і практика** within the module **Пасивний стан: повна система**.
...
```
===WORD_COUNTS===
Section "Підсумок і практика": {count} words (budget: 315-315×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Підсумок і практика)
