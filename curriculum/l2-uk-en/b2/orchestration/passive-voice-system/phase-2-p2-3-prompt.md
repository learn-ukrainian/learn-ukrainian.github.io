...
> **Persona reminder:** You are Senior Ukrainian Language & Culture Specialist. Write in the voice of Ethnographer: Professional Language Coach. Maintain this persona throughout — do not drift into generic AI tone.

> **Your #1 job: Write 1105 words for the section "Форма 2 — Безособові конструкції на -но/-то".**
...
| File | Purpose |
|------|---------|
| `curriculum/l2-uk-en/b2/research/passive-voice-system-research.md` | Factual foundation — use exhaustively |
| `curriculum/l2-uk-en/b2/meta/passive-voice-system.yaml` | Content outline with section word allocations |
| `curriculum/l2-uk-en/plans/b2/passive-voice-system.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
| `claude_extensions/quick-ref/B2.md` | Level constraints, immersion %, engagement minimums |

Read ALL four files before writing anything.

## Your Task

Write the section prose for **Форма 2 — Безособові конструкції на -но/-то** within the module **Пасивний стан: повна система**.

- **WORD BUDGET**: 1105 words minimum, 1105 × 2 maximum. Stay in this range.
...
GRAMMAR RULES: - Max 35 words per Ukrainian sentence - Max 6 clauses - Full grammar including adverbial participles
...
Previously used callout types in this module: warning, myth-buster, culture, tip, observe
...
- Target: 1105 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Форма 2 — Безособові конструкції на -но/-то": {count} words (budget: 1105-1105×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Форма 2 — Безособові конструкції на -но/-то)
