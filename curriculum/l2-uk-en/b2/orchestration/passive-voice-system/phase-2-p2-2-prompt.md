...
> **Your #1 job: Write 1105 words for the section "Форма 1 — Дієприкметники на -ний/-тий".**
...
Write the section prose for **Форма 1 — Дієприкметники на -ний/-тий** within the module **Пасивний стан: повна система**.
...
Previously used callout types in this module: myth-buster, tip, observe
...
```
===WORD_COUNTS===
Section "Форма 1 — Дієприкметники на -ний/-тий": {count} words (budget: 1105-1105×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Форма 1 — Дієприкметники на -ний/-тий)
