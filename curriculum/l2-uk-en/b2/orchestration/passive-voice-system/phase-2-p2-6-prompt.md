...
> **Your #1 job: Write 789 words for the section "Вибір форми пасиву за контекстом".**
...
Write the section prose for **Вибір форми пасиву за контекстом** within the module **Пасивний стан: повна система**.

- **WORD BUDGET**: 789 words minimum, 789 × 2 maximum. Stay in this range.
...
- Target: 789 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Вибір форми пасиву за контекстом": {count} words (budget: 789-789×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Вибір форми пасиву за контекстом)
