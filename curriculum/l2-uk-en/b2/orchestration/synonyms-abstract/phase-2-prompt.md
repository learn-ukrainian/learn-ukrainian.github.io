...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/synonyms-abstract-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/synonyms-abstract.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/synonyms-abstract.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Синоніми: Абстрактні Поняття та Ідеї** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Світ абстракцій | 600 | 900 |
| Одиниці мислення: Думка, ідея, погляд | 1000 | 1500 |
| Системне знання: Концепція, теорія, гіпотеза | 1000 | 1500 |
| Культура мовлення: Регістри та помилки | 800 | 1200 |
| Практикум: Академічне письмо | 600 | 900 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/synonyms-abstract.yaml`. Go through EVERY `points:` item in EVERY section:
