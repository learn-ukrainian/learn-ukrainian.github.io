...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/idioms-nature-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/idioms-nature.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/idioms-nature.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Фразеологізми: Природа (Вода, Вогонь, Земля, Вітер)** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Чотири стихії в українському світогляді | 600 | 900 |
| Вода та вогонь: Випробування та терпіння | 900 | 1350 |
| Земля та вітер: Сором, дух та відповідальність | 900 | 1350 |
| Лінгвістичний аналіз та типові пастки | 800 | 1200 |
| Практика: Карпатський провідник та публіцистика | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/idioms-nature.yaml`. Go through EVERY `points:` item in EVERY section:
