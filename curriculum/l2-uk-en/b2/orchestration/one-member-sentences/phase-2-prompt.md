...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/one-member-sentences-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/one-member-sentences.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/one-member-sentences.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Односкладні речення** (b2 track).
...
|---------|--------|---------------------|
| Природа односкладних речень | 800 | 1200 |
| Дієслівні типи: Означено-особові та неозначено-особові речення | 900 | 1350 |
| Безособові речення та категорія стану | 900 | 1350 |
| Номінативні речення та динаміка тексту | 700 | 1050 |
| Практичний синтез та трансформація | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/one-member-sentences.yaml`. Go through EVERY `points:` item in EVERY section:
