...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/synonyms-state-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/synonyms-state.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/synonyms-state.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Синоніми: Стан та Буття** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Філософія буття та стану | 600 | 900 |
| Бути чи існувати? Тонкощі синонімії | 900 | 1350 |
| Сприйняття проти реальності | 900 | 1350 |
| Рятувальна операція: виправлення кальок | 1000 | 1500 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/synonyms-state.yaml`. Go through EVERY `points:` item in EVERY section:
