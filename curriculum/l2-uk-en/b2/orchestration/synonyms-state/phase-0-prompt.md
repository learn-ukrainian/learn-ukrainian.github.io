...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/synonyms-state.yaml
```

Read the meta file:

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/synonyms-state.yaml
```
...
Research **Синоніми: Стан та Буття** for the **B2** core track. Core tracks need lighter research than seminar tracks — focus on accuracy and State Standard alignment.
