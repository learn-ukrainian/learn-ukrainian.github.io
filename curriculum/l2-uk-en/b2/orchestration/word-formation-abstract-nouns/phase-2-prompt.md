...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/word-formation-abstract-nouns-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/word-formation-abstract-nouns.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/word-formation-abstract-nouns.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Словотворення: абстрактні іменники** (b2 track).
...
| Дія та процес: Утворення на -ння | 1000 | 1500 |
| Якість та властивість: Суфікс -ість | 900 | 1350 |
| Результат та сфера: Форманти -ок, -ка, -ство | 800 | 1200 |
| Практикум: Культура вживання та запобігання помилкам | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/word-formation-abstract-nouns.yaml`. Go through EVERY `points:` item in EVERY section:
