...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/register-media-journalistic-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/register-media-journalistic.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/register-media-journalistic.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Медійний та журналістський регістр** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Публіцистичний стиль та свобода слова | 600 | 900 |
| Структура новинного тексту: принцип перевернутої піраміди | 900 | 1350 |
| Мова заголовків та стилістичні засоби | 800 | 1200 |
| Цитати, атрибуція та подолання типових помилок | 900 | 1350 |
| Медіа-етика: джерела, факти та маркери упередженості | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/register-media-journalistic.yaml`. Go through EVERY `points:` item in EVERY section:
