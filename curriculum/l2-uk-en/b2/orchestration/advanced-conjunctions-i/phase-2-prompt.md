...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/advanced-conjunctions-i-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/advanced-conjunctions-i.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/advanced-conjunctions-i.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Складні Сполучники I: Причина та Допуск** (b2 track).
...
|---------|--------|---------------------|
| Вступ та причинові зв'язки в мовленні | 600 | 900 |
| Поглиблений аналіз причинових сполучників | 950 | 1425 |
| Допустові конструкції та культурний код | 950 | 1425 |
| Юридична логіка та пунктуація | 750 | 1125 |
| Практикум та синтез | 750 | 1125 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/advanced-conjunctions-i.yaml`. Go through EVERY `points:` item in EVERY section:
