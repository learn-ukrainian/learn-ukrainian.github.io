...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/register-colloquial-style-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/register-colloquial-style.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/register-colloquial-style.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Розмовний стиль** (b2 track).
...
|---------|--------|---------------------|
| Розминка: Світ стендапу та живого спілкування | 800 | 1200 |
| Лексика: Від скорочень до сленгу воєнного часу | 850 | 1275 |
| Граматика: Частки, наповнювачі та правописні пастки | 850 | 1275 |
| Синтаксис: Еліпсис та структура живої мови | 800 | 1200 |
| Практикум: Від месенджера до мікрофона | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/register-colloquial-style.yaml`. Go through EVERY `points:` item in EVERY section:
