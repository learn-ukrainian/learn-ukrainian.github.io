...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/numeral-declension-time-dates-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/numeral-declension-time-dates.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/numeral-declension-time-dates.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Відмінювання числівників І: Час і дати** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Культурний код і циклічність часу | 600 | 900 |
| Час: від теорії до живого мовлення | 1000 | 1500 |
| Датування: точність у днях та роках | 900 | 1350 |
| Офіційно-діловий контекст: терміни та строки | 900 | 1350 |
| Практичний практикум та синтез | 600 | 900 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/numeral-declension-time-dates.yaml`. Go through EVERY `points:` item in EVERY section:
