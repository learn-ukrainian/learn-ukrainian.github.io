...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/aspect-nuances-secondary-imperfectivization-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/aspect-nuances-secondary-imperfectivization.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/aspect-nuances-secondary-imperfectivization.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Видові нюанси I: Вторинна імперфективація** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Метафора Палімпсесту | 600 | 900 |
| Механіка творення: Суфікси та чергування | 1000 | 1500 |
| Наголос як змістовий маркер | 700 | 1050 |
| Контексти вживання: Деколонізація та процеси | 1000 | 1500 |
| Практика та закріплення | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/aspect-nuances-secondary-imperfectivization.yaml`. Go through EVERY `points:` item in EVERY section:
