...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/idioms-body-head-face-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/idioms-body-head-face.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/idioms-body-head-face.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Соматичні фразеологізми: Голова та обличчя** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Семантичний центр мислення | 600 | 900 |
| Культурний код та етимологія | 850 | 1275 |
| Майстерня фразеології: Голова та очі | 950 | 1425 |
| Аналіз помилок: Носи, вуха й прийменники | 800 | 1200 |
| Практичний синтез і творча продукція | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/idioms-body-head-face.yaml`. Go through EVERY `points:` item in EVERY section:
