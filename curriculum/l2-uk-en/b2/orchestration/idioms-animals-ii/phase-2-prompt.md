...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/idioms-animals-ii-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/idioms-animals-ii.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/idioms-animals-ii.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Фразеологізми: Тварини II (Птахи, Риби, Комахи)** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Метафоричний світ природи (Introduction: The Metaphorical World of Nature) | 600 | 900 |
| Птахи: Від досвіду до винятковості (Birds: From Experience to Uniqueness) | 1000 | 1500 |
| Риби та комахи: Символи мовчання та праці (Fish and Insects: Symbols of Silence and Labor) | 950 | 1425 |
| Практикум: Стилістичні відтінки (Practice: Stylistic Shades) | 750 | 1125 |
| Творче застосування та підсумок (Creative Application and Summary) | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/idioms-animals-ii.yaml`. Go through EVERY `points:` item in EVERY section:
