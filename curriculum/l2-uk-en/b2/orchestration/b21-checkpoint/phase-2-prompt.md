...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/b21-checkpoint-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/b21-checkpoint.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/b21-checkpoint.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Контрольна точка: B2.1 Завершення** (b2 track).
...
|---------|--------|---------------------|
| Огляд та вступ | 400 | 600 |
| Навичка 1: Пасивний стан | 800 | 1200 |
| Навичка 2: Дієприкметники | 800 | 1200 |
| Навичка 3: Регістри та Стилі | 1000 | 1500 |
| Навичка 4: Доменна лексика | 600 | 900 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/b21-checkpoint.yaml`. Go through EVERY `points:` item in EVERY section:
