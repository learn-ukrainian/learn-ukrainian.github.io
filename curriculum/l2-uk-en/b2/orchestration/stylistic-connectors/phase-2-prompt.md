...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/stylistic-connectors-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/stylistic-connectors.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/stylistic-connectors.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Стилістичні сполучники** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Зв'язність та історичне коріння | 500 | 750 |
| Сполучники протиставлення та компенсації | 1000 | 1500 |
| Приєднання та наслідок у різних реєстрах | 900 | 1350 |
| Допустові відношення та пунктуаційні пастки | 800 | 1200 |
| Типові помилки та стилістична елегантність | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/stylistic-connectors.yaml`. Go through EVERY `points:` item in EVERY section:
