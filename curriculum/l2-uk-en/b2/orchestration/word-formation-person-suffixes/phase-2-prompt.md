...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/word-formation-person-suffixes-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/word-formation-person-suffixes.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/word-formation-person-suffixes.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Словотворення: суфікси на позначення осіб** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Словотвір як інструмент концептуалізації | 600 | 900 |
| Суфікс -ар/-яр: Від професії до національного символу | 1000 | 1500 |
| Суфікс -ач: Виконавець дії та активний діяч | 800 | 1200 |
| Суфікс -ник: Рід занять, ролі та соціальні групи | 800 | 1200 |
| Практика та синтез: Рекрутинг та аналіз текстів | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/word-formation-person-suffixes.yaml`. Go through EVERY `points:` item in EVERY section:
