...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/discussion-debate-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/discussion-debate.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/discussion-debate.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Дискусії та дебати** (b2 track).
...
|---------|--------|---------------------|
| Мистецтво дискусії та історія риторики | 700 | 1050 |
| Висловлення та обґрунтування погляду | 800 | 1200 |
| Етикет незгоди та культура дебатування | 800 | 1200 |
| Аргументація та контраргументація | 900 | 1350 |
| Формальні дебати та практичне моделювання | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/discussion-debate.yaml`. Go through EVERY `points:` item in EVERY section:
