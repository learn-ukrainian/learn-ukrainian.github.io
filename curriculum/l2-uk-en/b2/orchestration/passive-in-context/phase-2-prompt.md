...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/passive-in-context-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/passive-in-context.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/passive-in-context.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Пасив у контексті — вибір за регістром** (b2 track).
...
|---------|--------|---------------------|
| Вступ — Регістр і пасив | 600 | 900 |
| Система форм за реєстрами | 800 | 1200 |
| Офіційно-діловий та юридичний контексти | 900 | 1350 |
| Науковий та академічний контексти | 800 | 1200 |
| Літературний, журналістичний та розмовний контексти | 600 | 900 |
| Підсумок та інтегрована практика | 300 | 450 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/passive-in-context.yaml`. Go through EVERY `points:` item in EVERY section:
