...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/integration-practice-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/integration-practice.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/integration-practice.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Практика інтеграції B2.2** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Мова як цілісна система | 600 | 900 |
| Стилістичні засоби лексики за стандартом §4.4.1.2 | 900 | 1350 |
| Синтаксичний синтез та складні речення §4.3.4 | 1000 | 1500 |
| Лабораторія відлагодження: Типові помилки | 800 | 1200 |
| Комплексне застосування та підготовка до M70 | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/integration-practice.yaml`. Go through EVERY `points:` item in EVERY section:
