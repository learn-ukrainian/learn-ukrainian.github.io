...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/religion-in-ukraine-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/religion-in-ukraine.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/religion-in-ukraine.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Релігія в Україні** (b2 track).
...
|---------|--------|---------------------|
| Розминка: Релігійний ландшафт України | 600 | 900 |
| Православ'я та Церква в історичному контексті | 800 | 1200 |
| Релігійні свята, традиції та мовна норма | 1000 | 1500 |
| Міжконфесійний діалог та толерантність | 800 | 1200 |
| Підсумок та лексична практика | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/religion-in-ukraine.yaml`. Go through EVERY `points:` item in EVERY section:
