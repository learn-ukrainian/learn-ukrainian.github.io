...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/politics-government-vocabulary-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/politics-government-vocabulary.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/politics-government-vocabulary.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Політика та державне управління** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Політична система та історичне коріння | 700 | 1050 |
| Державні інституції та органи влади | 900 | 1350 |
| Виборчий процес та демократичні механізми | 800 | 1200 |
| Лексичні тонкощі та типові помилки | 800 | 1200 |
| Практика: Медіа та політичний дискурс | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/politics-government-vocabulary.yaml`. Go through EVERY `points:` item in EVERY section:
