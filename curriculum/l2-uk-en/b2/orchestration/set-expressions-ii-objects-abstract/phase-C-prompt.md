...
| Module persona | Professional Language Coach, acting as Cultural Anthropologist (Культуролог) |
...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/set-expressions-ii-objects-abstract.md
```

**Plan file** (vocabulary_hints — vocabulary list to follow):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/set-expressions-ii-objects-abstract.yaml
```

**Meta file** (activity count targets, pedagogy):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/set-expressions-ii-objects-abstract.yaml
```
