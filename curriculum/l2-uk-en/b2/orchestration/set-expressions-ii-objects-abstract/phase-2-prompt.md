...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/set-expressions-ii-objects-abstract-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/set-expressions-ii-objects-abstract.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/set-expressions-ii-objects-abstract.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Сталі вирази II: Предмети та абстракції** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Предмети як символи та давній світогляд | 600 | 900 |
| Магія побуту — сталі вирази з предметами | 1000 | 1500 |
| Від серця до неба — абстракції у фразеології | 900 | 1350 |
| Робота над помилками — культура мовлення | 800 | 1200 |
| Практика та творче застосування | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/set-expressions-ii-objects-abstract.yaml`. Go through EVERY `points:` item in EVERY section:
