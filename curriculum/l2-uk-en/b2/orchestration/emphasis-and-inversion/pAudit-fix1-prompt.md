...
────────────────────────────────────────────────────────────
  ...
  failing gates:
    lesson: 4837/4000 (raw: 5317) | engagement: 0/6 | richness: 72% < 95% min (grammar)
...
─── Audit output (last 15 lines) ───
  📚 PEDAGOGICAL VIOLATIONS FOUND:
    [TEMPLATE_EXAMPLE_RUN] Found run of 3 template-identical examples (>70% word overlap). Sample: «Завтра наша команда презентує важливий проект». | «Важливий проект наша команда презентує завтра». | «Завтра важливий проект презентує наша команда».
