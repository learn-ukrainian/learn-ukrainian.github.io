...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/emphasis-and-inversion-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/emphasis-and-inversion.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/emphasis-and-inversion.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Емфаза та інверсія** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Порядок слів в українській мові | 500 | 750 |
| Актуальне членування речення: Тема та Рема | 700 | 1050 |
| Емфатичний порядок та логічний наголос | 800 | 1200 |
| Інверсія та стилістичні ефекти | 700 | 1050 |
| Лексичні та граматичні засоби виділення | 700 | 1050 |
| Практика: Корекція та Синтез | 600 | 900 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/emphasis-and-inversion.yaml`. Go through EVERY `points:` item in EVERY section:
