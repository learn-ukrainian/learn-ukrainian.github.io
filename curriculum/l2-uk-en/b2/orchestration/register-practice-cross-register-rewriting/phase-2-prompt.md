...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/register-practice-cross-register-rewriting-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/register-practice-cross-register-rewriting.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/register-practice-cross-register-rewriting.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Регістрова практика: Перенесення тексту між стилями** (b2 track).
...
|---------|--------|---------------------|
| Огляд: Один зміст — п'ять голосів | 500 | 750 |
| Трансформація в науковий та офіційний стилі | 900 | 1350 |
| Трансформація в публіцистичний та художній стилі | 900 | 1350 |
| Трансформація в розмовний стиль | 800 | 1200 |
| Практикум: Редагування та плеоназми | 900 | 1350 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/register-practice-cross-register-rewriting.yaml`. Go through EVERY `points:` item in EVERY section:
