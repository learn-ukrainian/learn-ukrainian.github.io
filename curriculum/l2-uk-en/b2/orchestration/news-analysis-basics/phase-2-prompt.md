...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/news-analysis-basics-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/news-analysis-basics.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/news-analysis-basics.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Аналіз новин: Основи** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Влада інформації | 600 | 900 |
| Імерсивна розповідь: Анатомія новин | 1000 | 1500 |
| Аналіз та критичне мислення | 1000 | 1500 |
| Граматика та стилістика | 1000 | 1500 |
| Підсумок та синтез | 400 | 600 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/news-analysis-basics.yaml`. Go through EVERY `points:` item in EVERY section:
