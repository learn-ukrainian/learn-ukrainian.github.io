...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/synonyms-action-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/synonyms-action.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/synonyms-action.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Синоніми: Дія та Перетворення** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Природа дії та синонімії | 600 | 900 |
| Тонкощі «робити», «чинити» та «діяти» | 1000 | 1500 |
| Офіційність та творчість: «виконувати» та «здійснювати» | 900 | 1350 |
| Багатогранність «брати», «хапати» та «здобувати» | 1000 | 1500 |
| Практика: Точність у контексті | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/synonyms-action.yaml`. Go through EVERY `points:` item in EVERY section:
