...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/active-participles-present-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/active-participles-present.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/active-participles-present.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Активні дієприкметники теперішнього часу (-учий/-ючий)** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Спадщина та статус «зомбі» | 600 | 900 |
| Морфологічне творення та розпізнавання | 800 | 1200 |
| Сила дієслова: Трансформація в підрядні речення | 900 | 1350 |
| Лакмусовий папірець грамотности: чинний vs діючий | 800 | 1200 |
| Лексикалізовані форми та подолання кальок | 900 | 1350 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/active-participles-present.yaml`. Go through EVERY `points:` item in EVERY section:
