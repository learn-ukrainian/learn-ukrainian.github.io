...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/b2-pidsumkovyy-ohlyad-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/b2-pidsumkovyy-ohlyad.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/b2-pidsumkovyy-ohlyad.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **B2 Підсумковий огляд** (b2 track).
...
|---------|--------|---------------------|
| Ретроспектива B2 та культурний контекст | 800 | 1200 |
| Синтез граматики: Складний синтаксис та пасив | 1000 | 1500 |
| Лексичний синтез: Термінологія та регістри | 1000 | 1500 |
| Академічні навички: Метафора «Захисту дисертації» | 800 | 1200 |
| Діагностика та перехід до C1 | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/b2-pidsumkovyy-ohlyad.yaml`. Go through EVERY `points:` item in EVERY section:
