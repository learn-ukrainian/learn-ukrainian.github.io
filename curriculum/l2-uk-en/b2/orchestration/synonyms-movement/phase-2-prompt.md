...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/synonyms-movement-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/synonyms-movement.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/synonyms-movement.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Синоніми: Рух і Пересування** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Мистецтво синонімії в русі | 600 | 900 |
| Тонкощі ходи: від урочистості до втоми | 1000 | 1500 |
| Енергія швидкості: біг, мчання та нестримність | 1000 | 1500 |
| Культурний код та фразеологізми руху | 700 | 1050 |
| Практика та стилістичний синтез | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/synonyms-movement.yaml`. Go through EVERY `points:` item in EVERY section:
