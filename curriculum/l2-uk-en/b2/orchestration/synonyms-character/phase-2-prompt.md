...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/synonyms-character-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/synonyms-character.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/synonyms-character.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Синоніми: Характер та Особистість** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Психологія та мова | 600 | 900 |
| Інтелект: Від кмітливості до мудрості | 1000 | 1500 |
| Доброта та емпатія: Відтінки серця | 1000 | 1500 |
| Лабораторія помилок: Чистота мовлення | 700 | 1050 |
| Практикум: Психологічний портрет | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/synonyms-character.yaml`. Go through EVERY `points:` item in EVERY section:
