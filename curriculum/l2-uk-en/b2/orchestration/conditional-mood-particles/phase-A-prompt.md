...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/conditional-mood-particles.yaml
```

Read the meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/conditional-mood-particles.yaml
```
...
Research **Умовний спосіб, частки та вигуки** for the **B2** core track. Core tracks need lighter research than seminar tracks — focus on accuracy and State Standard alignment.
...
# Дослідження: Умовний спосіб, частки та вигуки
