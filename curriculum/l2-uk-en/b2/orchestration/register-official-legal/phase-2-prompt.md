...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/register-official-legal-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/register-official-legal.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/register-official-legal.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Офіційно-діловий стиль: документи, закони, заяви** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Офіційно-діловий стиль | 500 | 750 |
| Граматичні та лексичні засоби стилю | 800 | 1200 |
| Типи та структура документів | 900 | 1350 |
| Історичний контекст та мова законів | 800 | 1200 |
| Культура ділового мовлення та помилки | 600 | 900 |
| Практика та підсумок модуля | 400 | 600 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/register-official-legal.yaml`. Go through EVERY `points:` item in EVERY section:
