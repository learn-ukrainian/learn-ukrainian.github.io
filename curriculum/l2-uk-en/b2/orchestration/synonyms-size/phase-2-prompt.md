...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/synonyms-size-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/synonyms-size.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/synonyms-size.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Синоніми: Розмір і Масштаб** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Масштаб як категорія (Introduction: Scale as a Category) | 600 | 900 |
| Велич та гігантизм: Від «великого» до «грандіозного» (Grandeur and Gigantism: From 'Big' to 'Grand') | 1000 | 1500 |
| Світ малого: Мікросвіти та мізерія (The World of the Small: Micro-worlds and Negligibility) | 800 | 1200 |
| Типові помилки та стилістичні нюанси (Common Errors and Stylistic Nuances) | 1000 | 1500 |
| Практичне застосування: Українські рекорди (Practical Application: Ukrainian Records) | 600 | 900 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/synonyms-size.yaml`. Go through EVERY `points:` item in EVERY section:
