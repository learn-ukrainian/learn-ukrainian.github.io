...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/idioms-body-hands-legs-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/idioms-body-hands-legs.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/idioms-body-hands-legs.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Соматичні фразеологізми: Руки та ноги** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Мова тіла та фразеологічна точність | 600 | 900 |
| Майстерність та дія: Фразеологізми з компонентом «рука» | 1000 | 1500 |
| Рух та незалежність: Фразеологізми з компонентом «нога» | 1000 | 1500 |
| Лабораторія помилок та стилістичний тюнінг | 800 | 1200 |
| Практика та синтез: Створення наративу | 600 | 900 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/idioms-body-hands-legs.yaml`. Go through EVERY `points:` item in EVERY section:
