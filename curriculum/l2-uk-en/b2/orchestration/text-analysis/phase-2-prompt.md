...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/text-analysis-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/text-analysis.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/text-analysis.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Аналіз тексту** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Навіщо аналізувати тексти | 500 | 750 |
| Факт проти думки | 700 | 1050 |
| Виявлення упередженості та маніпуляцій | 800 | 1200 |
| Риторичні прийоми та стилістичні засоби | 800 | 1200 |
| Структура та логіка аргументації | 700 | 1050 |
| Підсумок: Практика критичного аналізу | 500 | 750 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/text-analysis.yaml`. Go through EVERY `points:` item in EVERY section:
