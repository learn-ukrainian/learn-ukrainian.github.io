...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/set-expressions-i-body-animals-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/set-expressions-i-body-animals.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/set-expressions-i-body-animals.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Сталі вирази I: Частини тіла та тварини** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Роль фразеологізмів у мовній компетенції | 500 | 750 |
| Соматизми: Коли тіло стає метафорою | 1000 | 1500 |
| Зоофразеологія та культурні коди | 1000 | 1500 |
| Аналіз типових помилок та інтерференції | 800 | 1200 |
| Практичне застосування та синтез | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/set-expressions-i-body-animals.yaml`. Go through EVERY `points:` item in EVERY section:
