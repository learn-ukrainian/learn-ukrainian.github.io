...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/register-literary-ukrainian-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/register-literary-ukrainian.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/register-literary-ukrainian.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Регістр — Літературна українська** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Поняття художнього стилю | 600 | 900 |
| Історичні витоки та зачинателі | 800 | 1200 |
| Лексичні засоби та конотації | 900 | 1350 |
| Тропи, фігури та персоніфікація | 900 | 1350 |
| Синтаксис та запобігання помилкам | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/register-literary-ukrainian.yaml`. Go through EVERY `points:` item in EVERY section:
