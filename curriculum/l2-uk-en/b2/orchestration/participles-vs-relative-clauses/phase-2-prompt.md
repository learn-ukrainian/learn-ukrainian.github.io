...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/participles-vs-relative-clauses-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/participles-vs-relative-clauses.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/participles-vs-relative-clauses.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Дієприкметники проти підрядних речень** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Два способи вираження ознаки за дією | 500 | 750 |
| Морфологічний та синтаксичний еквівалент | 800 | 1200 |
| Стилістичний вибір та культура мовлення | 900 | 1350 |
| Аналіз та виправлення типових помилок | 900 | 1350 |
| Трансформаційна практика та редагування | 900 | 1350 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/participles-vs-relative-clauses.yaml`. Go through EVERY `points:` item in EVERY section:
