...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/advanced-conjunctions-ii-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/advanced-conjunctions-ii.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/advanced-conjunctions-ii.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Складні Сполучники II: Час та Умова** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Світ умов та часових ланцюжків | 500 | 750 |
| Часові сполучники: Від одночасності до межі | 1000 | 1500 |
| Умовні сполучники: Реальність, гіпотеза та офіційність | 1000 | 1500 |
| Культура мовлення та запобігання типовим помилкам | 800 | 1200 |
| Практика: Синтез і трансформація зв'язків | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/advanced-conjunctions-ii.yaml`. Go through EVERY `points:` item in EVERY section:
