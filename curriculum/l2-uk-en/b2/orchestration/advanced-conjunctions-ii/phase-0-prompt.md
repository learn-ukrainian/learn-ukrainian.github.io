...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/advanced-conjunctions-ii.yaml
```

Read the meta file:

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/advanced-conjunctions-ii.yaml
```
...
Research **Складні Сполучники II: Час та Умова** for the **B2** core track. Core tracks need lighter research than seminar tracks — focus on accuracy and State Standard alignment.
