...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/proverbs-work-wisdom-character-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/proverbs-work-wisdom-character.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/proverbs-work-wisdom-character.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Прислів'я I: Праця, мудрість і характер** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Народна мудрість як алгоритм успіху | 600 | 900 |
| Філософія праці та «Сродна праця» | 1000 | 1500 |
| Мудрість: Відміряй сім разів | 800 | 1200 |
| Характер та слово: Не горобець | 800 | 1200 |
| Типові помилки та стилістичний регістр | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/proverbs-work-wisdom-character.yaml`. Go through EVERY `points:` item in EVERY section:
