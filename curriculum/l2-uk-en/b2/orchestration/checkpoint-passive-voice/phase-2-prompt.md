...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/checkpoint-passive-voice-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/checkpoint-passive-voice.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/checkpoint-passive-voice.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Контрольний модуль B2.1a — Система пасивного стану** (b2 track).
...
|---------|--------|---------------------|
| Вступ — Що ми вивчили | 400 | 600 |
| Огляд — Чотири форми пасиву | 800 | 1200 |
| Огляд — Вибір форми за регістром | 800 | 1200 |
| Огляд — Активні дієприкметники та русизми | 800 | 1200 |
| Діагностичні завдання | 400 | 600 |
| Самооцінка і план | 400 | 600 |
| Підсумок | 400 | 600 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/checkpoint-passive-voice.yaml`. Go through EVERY `points:` item in EVERY section:
