...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/checkpoint-register-synthesis-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/checkpoint-register-synthesis.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/checkpoint-register-synthesis.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Checkpoint: Register Synthesis (Синтез регістрів)** (b2 track).
...
|---------|--------|---------------------|
| Вступ та огляд | 400 | 600 |
| Офіційно-діловий стиль: Від «Руської Правди» до сьогодні | 800 | 1200 |
| Публіцистичний стиль: Сила переконання | 800 | 1200 |
| Науковий стиль: Об'єктивність та аналіз | 800 | 1200 |
| Синтез та трансформація: Практичний аудит | 800 | 1200 |
| Підсумок та результати | 400 | 600 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/checkpoint-register-synthesis.yaml`. Go through EVERY `points:` item in EVERY section:
