...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/b2-checkpoint-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/b2-checkpoint.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/b2-checkpoint.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Контрольна точка B2.2** (b2 track).
...
|---------|--------|---------------------|
| Вступ та організація | 400 | 600 |
| Лексична точність та стилістика | 900 | 1350 |
| Наука та медицина: кейс Івана Пулюя | 1100 | 1650 |
| Суспільство та культура: Українська діаспора | 900 | 1350 |
| Підсумок та рефлексія | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/b2-checkpoint.yaml`. Go through EVERY `points:` item in EVERY section:
