...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/register-medical-ukrainian-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/register-medical-ukrainian.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/register-medical-ukrainian.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Медична українська: спілкування у сфері охорони здоров'я** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Медичний регістр та культура аптеки | 500 | 750 |
| Опис симптомів та відчуттів | 800 | 1200 |
| Консультація: Діалог лікар-пацієнт | 900 | 1350 |
| Медичні інструкції та філософія Амосова | 700 | 1050 |
| Медична документація та цифровізація | 600 | 900 |
| Культура мовлення та корекція русизмів | 500 | 750 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/register-medical-ukrainian.yaml`. Go through EVERY `points:` item in EVERY section:
