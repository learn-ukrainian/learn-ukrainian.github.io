...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/b2-final-exam-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/b2-final-exam.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/b2-final-exam.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **B2 Підсумковий іспит** (b2 track).
...
|---------|--------|---------------------|
| Огляд — Фінальний іспит B2 | 600 | 900 |
| Частина 1: Читання та академічна ідентичність | 1000 | 1500 |
| Частина 2: Письмо та стилістична вправність | 800 | 1200 |
| Частина 3: Слухання та лексична точність | 800 | 1200 |
| Частина 4: Говоріння та підсумок рівня | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/b2-final-exam.yaml`. Go through EVERY `points:` item in EVERY section:
