...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/aspect-nuances-imperative-infinitive-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/aspect-nuances-imperative-infinitive.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/aspect-nuances-imperative-infinitive.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Відтінки виду II: наказовий спосіб та інфінітив** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Культура спонукання та етикет | 800 | 1200 |
| Граматика та морфологія наказу | 1000 | 1500 |
| Заборони, застереження та забобони | 800 | 1200 |
| Модальність інфінітива: Правила vs Можливість | 800 | 1200 |
| Професійне застосування: Накази та інструкції | 600 | 900 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/aspect-nuances-imperative-infinitive.yaml`. Go through EVERY `points:` item in EVERY section:
