...
| Module persona | Professional Language Coach, acting as Military Instructor (Військовий інструктор) |
...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/aspect-nuances-imperative-infinitive.md
```

**Plan file** (vocabulary_hints — vocabulary list to follow):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/aspect-nuances-imperative-infinitive.yaml
```

**Meta file** (activity count targets, pedagogy):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/aspect-nuances-imperative-infinitive.yaml
```
