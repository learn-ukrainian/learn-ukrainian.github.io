...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/synonyms-communication-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/synonyms-communication.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/synonyms-communication.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Синоніми: Комунікація та Мовлення** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Вага слова | 500 | 750 |
| Мистецтво вибору: Дієслова «Say» | 950 | 1425 |
| Градація запиту: Дієслова «Ask» | 950 | 1425 |
| Граматичний двигун: Пряма та непряма мова | 850 | 1275 |
| Практика та синтез: Переговори | 750 | 1125 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/synonyms-communication.yaml`. Go through EVERY `points:` item in EVERY section:
