...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/idioms-body-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/idioms-body.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/idioms-body.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Фразеологізми: Душа і Серце** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Кордоцентризм — українська філософія серця | 700 | 1050 |
| Фразеологізми з компонентом «душа» | 1000 | 1500 |
| Фразеологізми з компонентом «серце» | 1000 | 1500 |
| Типові помилки та стилістичні нюанси | 700 | 1050 |
| Практика: Емоційні стани та діалоги | 600 | 900 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/idioms-body.yaml`. Go through EVERY `points:` item in EVERY section:
