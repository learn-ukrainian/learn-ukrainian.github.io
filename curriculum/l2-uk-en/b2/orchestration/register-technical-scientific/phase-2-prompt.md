...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/register-technical-scientific-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/register-technical-scientific.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/register-technical-scientific.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Регістр: науково-технічний стиль** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Науково-технічний стиль та його історія | 600 | 900 |
| Лексика та термінологія | 1000 | 1500 |
| Граматика об'єктивності | 1000 | 1500 |
| Типологія та структура технічних текстів | 800 | 1200 |
| Практика: Трансформація та редагування | 600 | 900 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/register-technical-scientific.yaml`. Go through EVERY `points:` item in EVERY section:
