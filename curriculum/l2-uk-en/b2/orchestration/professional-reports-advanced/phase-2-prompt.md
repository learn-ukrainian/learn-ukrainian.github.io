...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/professional-reports-advanced-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/professional-reports-advanced.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/professional-reports-advanced.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Професійні звіти: Поглиблення** (b2 track).
...
|---------|--------|---------------------|
| Вступ | 500 | 750 |
| Імерсивна розповідь: Сучасна аналітика | 1200 | 1800 |
| Критичний аналіз та етика | 900 | 1350 |
| Граматика та офіційно-діловий стиль | 900 | 1350 |
| Підсумок | 500 | 750 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/professional-reports-advanced.yaml`. Go through EVERY `points:` item in EVERY section:
