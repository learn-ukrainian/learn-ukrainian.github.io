...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/professional-reports-basics-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/professional-reports-basics.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/professional-reports-basics.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Професійні звіти: Основи** (b2 track).
...
|---------|--------|---------------------|
| Вступ | 600 | 900 |
| Імерсивна розповідь: Структура та компоненти | 1000 | 1500 |
| Аналіз та візуалізація даних | 1000 | 1500 |
| Граматика: Безособовість та стиль | 800 | 1200 |
| Підсумок та усунення помилок | 600 | 900 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/professional-reports-basics.yaml`. Go through EVERY `points:` item in EVERY section:
