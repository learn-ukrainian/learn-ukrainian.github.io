...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/presentation-skills-advanced-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/presentation-skills-advanced.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/presentation-skills-advanced.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Презентації: Поглиблено** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Від базових навичок до майстерності | 600 | 900 |
| Аналіз та адаптація до аудиторії | 800 | 1200 |
| Сторітелінг та риторика переконання | 1000 | 1500 |
| Мистецтво візуалізації та технічна досконалість | 600 | 900 |
| Сесія питань та відповідей: Стратегії захисту | 700 | 1050 |
| Практикум та зворотний зв'язок | 300 | 450 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/presentation-skills-advanced.yaml`. Go through EVERY `points:` item in EVERY section:
