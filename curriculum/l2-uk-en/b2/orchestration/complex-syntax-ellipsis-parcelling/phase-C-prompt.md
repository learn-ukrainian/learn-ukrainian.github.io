...
| Module persona | Professional Language Coach, acting as Creative Writer (Письменник-креативник) |
...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/complex-syntax-ellipsis-parcelling.md
```

**Plan file** (vocabulary_hints — vocabulary list to follow):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/complex-syntax-ellipsis-parcelling.yaml
```

**Meta file** (activity count targets, pedagogy):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/complex-syntax-ellipsis-parcelling.yaml
```
