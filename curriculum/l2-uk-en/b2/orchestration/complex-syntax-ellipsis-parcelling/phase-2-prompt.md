...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/complex-syntax-ellipsis-parcelling-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/complex-syntax-ellipsis-parcelling.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/complex-syntax-ellipsis-parcelling.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Складний синтаксис: еліпсис і парцеляція** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Експресивний синтаксис | 700 | 1050 |
| Еліпсис: Мистецтво пропуску | 1000 | 1500 |
| Парцеляція: Ритм і фрагментація | 1000 | 1500 |
| Корекція типових помилок та стилістика | 800 | 1200 |
| Творчий синтез та підсумок | 600 | 900 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/complex-syntax-ellipsis-parcelling.yaml`. Go through EVERY `points:` item in EVERY section:
