...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/synonyms-place-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/synonyms-place.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/synonyms-place.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Синоніми: Місце та Простір** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Світ як простір | 600 | 900 |
| Тут чи сюди? Статика та рух | 900 | 1350 |
| Тутечки та ось тут: Близькість і стиль | 800 | 1200 |
| Там, туди, онде: Далечінь та орієнтири | 900 | 1350 |
| Поріг як межа: Від магії до урбаністики | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/synonyms-place.yaml`. Go through EVERY `points:` item in EVERY section:
