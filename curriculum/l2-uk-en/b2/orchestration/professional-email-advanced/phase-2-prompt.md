...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/professional-email-advanced-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/professional-email-advanced.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/professional-email-advanced.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Ділова пошта: Поглиблено** (b2 track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Імерсивна розповідь | 1200 | 1800 |
| Аналіз та культурний контекст | 800 | 1200 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/professional-email-advanced.yaml`. Go through EVERY `points:` item in EVERY section:
