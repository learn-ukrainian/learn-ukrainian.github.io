...
────────────────────────────────────────────────────────────
  ...
  failing gates:
    lesson: 3621/5000 (raw: 4061) | engagement: 0/5 | richness: 62% < 95% min (grammar) - REWRITE needed
...
─── Audit output (last 15 lines) ───
    ...
    [INLINE_ENGLISH_IN_PROSE] Inline English translations in B1+ prose (3 occurrences): (Subject line), (Vocative case), (Passive voice) — breaks immersion target
