...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/capstone-prezentatsiya-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/capstone-prezentatsiya.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/capstone-prezentatsiya.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Capstone: Презентація** (b2 track).
...
|---------|--------|---------------------|
| Риторична спадщина та сучасність | 600 | 900 |
| Структура та логіка виступу | 800 | 1200 |
| Візуалізація та дизайн слайдів | 700 | 1050 |
| Майстерність публічного виступу | 800 | 1200 |
| Взаємодія та Q&A сесія | 700 | 1050 |
| Репетиція та фінальний проєкт | 400 | 600 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/capstone-prezentatsiya.yaml`. Go through EVERY `points:` item in EVERY section:
