...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/b21-integration-practice-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/b21-integration-practice.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/b21-integration-practice.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Інтеграційна практика B2.1** (b2 track).
...
|---------|--------|---------------------|
| Огляд та стилістичний контекст | 600 | 900 |
| Офіційний регістр та пасивні конструкції | 900 | 1350 |
| Публіцистичний стиль та новини | 800 | 1200 |
| Науковий опис та термінологія | 900 | 1350 |
| Інтеграційний практикум та самооцінка | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/b21-integration-practice.yaml`. Go through EVERY `points:` item in EVERY section:
