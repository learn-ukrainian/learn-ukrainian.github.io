...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/word-formation-adverbs-integration-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/word-formation-adverbs-integration.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/word-formation-adverbs-integration.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Словотворення: прислівники та інтеграція** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Світ українського словотворення | 500 | 750 |
| Від прикметника до прислівника: моделі та акцентологія | 1000 | 1500 |
| Пестливість та звеличення: прагматика суфіксів | 900 | 1350 |
| Словотворення в академічному та науковому контексті | 800 | 1200 |
| Практикум та корекція помилок | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/word-formation-adverbs-integration.yaml`. Go through EVERY `points:` item in EVERY section:
