...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/word-formation-adjective-formation-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/word-formation-adjective-formation.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/word-formation-adjective-formation.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Словотворення: прикметники** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Культурний код прикметника «київський» | 700 | 1050 |
| Суфікси -ський та -цький: приналежність та походження | 900 | 1350 |
| Суфікси -ний та -альний: якість та професійне відношення | 800 | 1200 |
| Складні прикметники: кольори, числівники та фольклор | 1000 | 1500 |
| Практикум: аналіз текстів та запобігання інтерференції | 600 | 900 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/word-formation-adjective-formation.yaml`. Go through EVERY `points:` item in EVERY section:
