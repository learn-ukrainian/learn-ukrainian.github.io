...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/correlative-constructions-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/correlative-constructions.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/correlative-constructions.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Співвідносні конструкції** (b2 track).
...
|---------|--------|---------------------|
| Вступ | 500 | 750 |
| Граматичний фундамент: Основні пари | 1000 | 1500 |
| Просторові, часові та кількісні зв'язки | 800 | 1200 |
| Стилістика та запобігання калькам | 900 | 1350 |
| Практичне застосування та синтез | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/correlative-constructions.yaml`. Go through EVERY `points:` item in EVERY section:
