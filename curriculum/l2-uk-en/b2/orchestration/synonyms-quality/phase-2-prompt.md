...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/synonyms-quality-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/synonyms-quality.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/synonyms-quality.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Синоніми: Якість та Оцінка** (b2 track).
...
|---------|--------|---------------------|
| Вступ та сфери оцінювання | 800 | 1200 |
| Позитивна оцінка: Відтінки досконалості | 1200 | 1800 |
| Негативна оцінка та стилістичне забарвлення | 1000 | 1500 |
| Аналіз типових помилок та стилістика | 1000 | 1500 |
| Практика: QA-рецензування та оцінка | 1000 | 1500 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/synonyms-quality.yaml`. Go through EVERY `points:` item in EVERY section:
