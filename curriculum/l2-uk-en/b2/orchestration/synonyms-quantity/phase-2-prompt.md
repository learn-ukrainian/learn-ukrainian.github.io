...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/synonyms-quantity-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/synonyms-quantity.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/synonyms-quantity.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Синоніми: Кількість та Міра** (b2 track).
...
|---------|--------|---------------------|
| Розминка та історичний контекст | 700 | 1050 |
| Синоніми великої кількості та міри | 1000 | 1500 |
| Синоніми малої кількості та обмеженості | 800 | 1200 |
| Стилістичні регістри та культура мовлення | 800 | 1200 |
| Практика: Статистика та опис масштабів | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/synonyms-quantity.yaml`. Go through EVERY `points:` item in EVERY section:
