...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/proverbs-nature-time-caution-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/proverbs-nature-time-caution.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/proverbs-nature-time-caution.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Прислів'я II: Природа, час і обережність** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Природа як джерело мудрості | 600 | 900 |
| Прислів'я про стихії та цикли природи | 1000 | 1500 |
| Час і планування в народній філософії | 800 | 1200 |
| Обережність та оцінка ризиків | 800 | 1200 |
| Практика: Уникнення кальок та суржику | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/proverbs-nature-time-caution.yaml`. Go through EVERY `points:` item in EVERY section:
