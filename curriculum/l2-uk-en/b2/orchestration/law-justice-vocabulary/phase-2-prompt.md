...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/law-justice-vocabulary-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/law-justice-vocabulary.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/law-justice-vocabulary.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Право та юстиція** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Історія права та Державні стандарти | 700 | 1050 |
| Судова система та європейська традиція | 800 | 1200 |
| Учасники процесу та мовленнєва культура | 800 | 1200 |
| Класифікація справ та офіційний регістр | 800 | 1200 |
| Судочинство: від позову до вироку | 900 | 1350 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/law-justice-vocabulary.yaml`. Go through EVERY `points:` item in EVERY section:
