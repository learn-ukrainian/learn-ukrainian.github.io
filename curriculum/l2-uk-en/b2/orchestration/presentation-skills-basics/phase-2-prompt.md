...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/presentation-skills-basics-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/presentation-skills-basics.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/presentation-skills-basics.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Презентації: Основи** (b2 track).
...
|---------|--------|---------------------|
| Вступ та психологія | 600 | 900 |
| Риторична спадщина та структура | 800 | 1200 |
| Мовна навігація: Signposting | 1000 | 1500 |
| Візуальна культура та ідентичність | 800 | 1200 |
| Техніка виступу та робота над помилками | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/presentation-skills-basics.yaml`. Go through EVERY `points:` item in EVERY section:
