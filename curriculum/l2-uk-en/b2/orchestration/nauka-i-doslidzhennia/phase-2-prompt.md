...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/nauka-i-doslidzhennia-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/nauka-i-doslidzhennia.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/nauka-i-doslidzhennia.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Наука і дослідження** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Українська наука та видатні вчені | 600 | 900 |
| Структура наукового дослідження та академічна етика | 700 | 1050 |
| Наукова термінологія та академічний регістр | 700 | 1050 |
| Критичне читання наукових текстів | 700 | 1050 |
| Обговорення наукових тем та представлення результатів | 700 | 1050 |
| Підсумок та практика | 600 | 900 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/nauka-i-doslidzhennia.yaml`. Go through EVERY `points:` item in EVERY section:
