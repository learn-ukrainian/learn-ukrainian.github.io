...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/analiz-tekstu-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/analiz-tekstu.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/analiz-tekstu.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
|---------|--------|---------------------|
| Вступ та термінологічні засади | 700 | 1050 |
| Стилістичні засоби та синтаксис | 1000 | 1500 |
| Авторська позиція та культурні архетипи | 800 | 1200 |
| Контекстуальний аналіз та деколонізація | 800 | 1200 |
| Логіка аргументації та запобігання помилкам | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/analiz-tekstu.yaml`. Go through EVERY `points:` item in EVERY section:
