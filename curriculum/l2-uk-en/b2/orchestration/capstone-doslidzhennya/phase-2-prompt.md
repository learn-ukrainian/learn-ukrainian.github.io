...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/capstone-doslidzhennya-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/capstone-doslidzhennya.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/capstone-doslidzhennya.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Capstone: Дослідження** (b2 track).
...
|---------|--------|---------------------|
| Огляд: Етап написання | 600 | 900 |
| Написання вступу | 600 | 900 |
| Основна частина | 1000 | 1500 |
| Висновки | 600 | 900 |
| Редагування та оформлення | 800 | 1200 |
| Підготовка до здачі | 400 | 600 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/capstone-doslidzhennya.yaml`. Go through EVERY `points:` item in EVERY section:
