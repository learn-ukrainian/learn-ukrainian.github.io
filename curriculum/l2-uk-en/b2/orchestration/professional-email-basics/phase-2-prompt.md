...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/professional-email-basics-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/professional-email-basics.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/professional-email-basics.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Ділова пошта: Основи** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Етика та культура ділового листування | 600 | 900 |
| Структура та оформлення листа | 800 | 1200 |
| Мовні особливості та професійна лексика | 1000 | 1500 |
| Робота над помилками та типові кальки | 800 | 1200 |
| Типологія та практичне застосування | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/professional-email-basics.yaml`. Go through EVERY `points:` item in EVERY section:
