...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/numeral-declension-compound-numbers-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/numeral-declension-compound-numbers.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/numeral-declension-compound-numbers.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Відмінювання числівників ІІ: Складені числівники** (b2 track).
...
|---------|--------|---------------------|
| Вступ та повторення складних числівників | 600 | 900 |
| Складені кількісні числівники — Правило повної зміни | 1000 | 1500 |
| Складені порядкові числівники та історичні дати | 900 | 1350 |
| Числівники в статистиці та географії | 900 | 1350 |
| Практикум та синтез | 600 | 900 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/numeral-declension-compound-numbers.yaml`. Go through EVERY `points:` item in EVERY section:
