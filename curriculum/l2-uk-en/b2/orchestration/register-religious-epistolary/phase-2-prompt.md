...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/register-religious-epistolary-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/register-religious-epistolary.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/register-religious-epistolary.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Регістр — Релігійний та епістолярний стилі** (b2 track).
...
|---------|--------|---------------------|
| Вступ — Регістри високого стилю | 600 | 900 |
| Релігійний стиль — Мова духовності | 900 | 1350 |
| Епістолярний стиль — Від класики до цифрової доби | 900 | 1350 |
| Граматика — Мистецтво звертання | 800 | 1200 |
| Практика та трансформація | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/register-religious-epistolary.yaml`. Go through EVERY `points:` item in EVERY section:
