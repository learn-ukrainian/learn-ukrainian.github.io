...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/economics-business-vocabulary-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/economics-business-vocabulary.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/economics-business-vocabulary.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Економічна лексика: говоримо про бізнес** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Економічний ландшафт України | 700 | 1050 |
| Макроекономічні показники та державна політика | 900 | 1350 |
| Бізнес-структури та цифровізація | 900 | 1350 |
| Фінансові операції та податкова система | 900 | 1350 |
| Ділова комунікація та корекція помилок | 600 | 900 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/economics-business-vocabulary.yaml`. Go through EVERY `points:` item in EVERY section:
