...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/multi-clause-sentences-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/multi-clause-sentences.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/multi-clause-sentences.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Багатоскладні речення** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Багатоскладні речення | 500 | 750 |
| Складносурядні речення та їхні нюанси | 700 | 1050 |
| Складнопідрядні речення та «пастка який» | 800 | 1200 |
| Багатоскладні речення з кількома підрядними | 800 | 1200 |
| Вкладені конструкції та стилістична майстерність | 700 | 1050 |
| Пунктуація, типові помилки та підсумок | 500 | 750 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/multi-clause-sentences.yaml`. Go through EVERY `points:` item in EVERY section:
