...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/parenthetical-expressions-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/parenthetical-expressions.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/parenthetical-expressions.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Вставні слова та вирази** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Природа вставних конструкцій | 600 | 900 |
| Впевненість та емоційне ставлення | 1000 | 1500 |
| Джерела інформації та логіка викладу | 1000 | 1500 |
| Пунктуація та пастки гомонімії | 800 | 1200 |
| Практика в ролі ведучого ток-шоу | 600 | 900 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/parenthetical-expressions.yaml`. Go through EVERY `points:` item in EVERY section:
