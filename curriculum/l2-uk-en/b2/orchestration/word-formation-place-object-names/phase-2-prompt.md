...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/word-formation-place-object-names-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/word-formation-place-object-names.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/word-formation-place-object-names.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Словотворення: назви місць та об'єктів** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Логіка назв місць в українській мові | 500 | 750 |
| Суфікс -ня: Від кімнати до хати-читальні | 950 | 1425 |
| Суфікс -ище: Ландшафт, простір та питання роду | 850 | 1275 |
| Суфікс -арня: Майстерні та культура кавування | 900 | 1350 |
| Практичний практикум та корекція | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/word-formation-place-object-names.yaml`. Go through EVERY `points:` item in EVERY section:
