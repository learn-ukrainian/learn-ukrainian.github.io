...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/word-formation-place-object-names.yaml
```

Read the meta file:

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/word-formation-place-object-names.yaml
```
...
Research **Словотворення: назви місць та об'єктів** for the **B2** core track. Core tracks need lighter research than seminar tracks — focus on accuracy and State Standard alignment.
