...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/register-academic-ukrainian-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/register-academic-ukrainian.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/register-academic-ukrainian.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Науковий стиль української мови** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Науковий стиль та його історія | 600 | 900 |
| Лексичні особливості та термінологія | 900 | 1350 |
| Граматика та типові помилки | 1000 | 1500 |
| Мовне хеджування та етика | 800 | 1200 |
| Структура наукового тексту та цитування | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/register-academic-ukrainian.yaml`. Go through EVERY `points:` item in EVERY section:
