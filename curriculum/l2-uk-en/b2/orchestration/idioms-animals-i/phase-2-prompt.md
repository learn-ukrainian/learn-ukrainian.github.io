...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/idioms-animals-i-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/idioms-animals-i.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/idioms-animals-i.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Фразеологізми: Тварини I (Вовк, Собака, Кінь)** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Тваринний код української культури | 600 | 900 |
| Вовк — між демоном та захисником | 900 | 1350 |
| Собака: відданість, майстерність та щоденний побут | 800 | 1200 |
| Кінь — вірний побратим та символ долі | 900 | 1350 |
| Практикум: Труднощі перекладу та тваринні метафори | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/idioms-animals-i.yaml`. Go through EVERY `points:` item in EVERY section:
