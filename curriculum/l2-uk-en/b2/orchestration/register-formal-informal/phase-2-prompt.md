...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/register-formal-informal-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/register-formal-informal.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/register-formal-informal.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Формальне та неформальне спілкування** (b2 track).
...
|---------|--------|---------------------|
| Вступ — Формальність у спілкуванні | 500 | 750 |
| Займенники та граматичне узгодження | 800 | 1200 |
| Етикетні форми звертання | 900 | 1350 |
| Формальна та неформальна лексика | 700 | 1050 |
| Соціальні сценарії та перехід між регістрами | 700 | 1050 |
| Практика, корекція та підсумок | 400 | 600 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/register-formal-informal.yaml`. Go through EVERY `points:` item in EVERY section:
