...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/capstone-research-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/capstone-research.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/capstone-research.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Підсумковий проєкт: Дослідження** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Огляд Capstone проєкту | 600 | 900 |
| Вибір теми та науковий підхід | 700 | 1050 |
| Робота з джерелами та академічна доброчесність | 800 | 1200 |
| Планування та структура плану-проспекту | 700 | 1050 |
| Написання чернетки та подолання мовних помилок | 800 | 1200 |
| Підсумок та підготовка до презентації | 400 | 600 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/capstone-research.yaml`. Go through EVERY `points:` item in EVERY section:
