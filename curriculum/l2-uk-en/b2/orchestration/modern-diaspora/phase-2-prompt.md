...
> **Persona reminder:** You are Senior Ukrainian Language & Culture Specialist. Write in the voice of Professional Language Coach. Maintain this persona throughout — do not drift into generic AI tone.
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/modern-diaspora-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/modern-diaspora.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/modern-diaspora.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
| `/Users/krisztiankoos/projects/learn-ukrainian/claude_extensions/quick-ref/B2.md` | Level constraints, immersion %, engagement minimums |

Read ALL four files before writing anything.

## Your Task

Write the full lesson prose for **Сучасна діаспора** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Глобальне українство (Introduction: Global Ukrainedom) | 500 | 750 |
| Історія та чотири хвилі еміграції (History and Four Waves of Emigration) | 900 | 1350 |
| Організації та інституційна мережа (Organizations and Institutional Network) | 800 | 1200 |
| М’яка сила та культурна дипломатія (Soft Power and Cultural Diplomacy) | 700 | 1050 |
| Мова діаспори та типові помилки (Language of Diaspora and Common Errors) | 700 | 1050 |
| Практика: Аналіз та рефлексія (Practice: Analysis and Reflection) | 400 | 600 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/modern-diaspora.yaml`. Go through EVERY `points:` item in EVERY section:
