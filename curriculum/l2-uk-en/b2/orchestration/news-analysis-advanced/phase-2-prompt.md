...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/news-analysis-advanced-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/news-analysis-advanced.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/news-analysis-advanced.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Аналіз новин: Поглиблено** (b2 track).
...
|---------|--------|---------------------|
| Розминка та критичний вступ | 800 | 1200 |
| Упередженість та редакційна політика | 900 | 1350 |
| Пропаганда та емоційні маніпуляції | 900 | 1350 |
| Верифікація та фактчекінг | 800 | 1200 |
| Мовний аналіз та типові помилки | 600 | 900 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/news-analysis-advanced.yaml`. Go through EVERY `points:` item in EVERY section:
