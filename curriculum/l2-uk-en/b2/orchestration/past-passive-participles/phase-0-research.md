...
- **Persona Integration**: The "Museum Restorer" persona is perfect for this. Use verbs like *відреставрований* (restored), *збережений* (preserved), *знайдений* (found), *втрачений* (lost), *пошкоджений* (damaged).
