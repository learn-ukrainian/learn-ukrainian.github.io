...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/past-passive-participles-research.md
```

Read the **plan file** (SOURCE OF TRUTH for structure, objectives, vocabulary):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/past-passive-participles.yaml
```

Read the **old meta file** (for reference only — you are REPLACING the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/past-passive-participles.yaml
```
...
2. Word allocations sum to approximately **4000** (the level's word target, provided by the build system)
...
- Allocations should sum to approximately 4000 words (±10% is acceptable)
