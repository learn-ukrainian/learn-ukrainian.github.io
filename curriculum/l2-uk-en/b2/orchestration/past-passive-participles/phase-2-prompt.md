...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/past-passive-participles-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/past-passive-participles.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/past-passive-participles.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Дієприкметники минулого часу на -ний/-тий** (b2 track).
...
|---------|--------|---------------------|
| Вступ — Що таке дієприкметник? | 500 | 750 |
| Утворення дієприкметників на -ний | 800 | 1200 |
| Утворення дієприкметників на -тий | 700 | 1050 |
| Узгодження дієприкметників | 600 | 900 |
| Пасив із допоміжним дієсловом бути | 600 | 900 |
| Регістрова специфіка | 400 | 600 |
| Практика і підсумок | 400 | 600 |
| **Total** | **4000** | **6000** |
