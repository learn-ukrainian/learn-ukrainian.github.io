...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/mystetstvo-i-literatura-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/mystetstvo-i-literatura.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/mystetstvo-i-literatura.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Мистецтво і література** (b2 track).
...
|---------|--------|---------------------|
| Розминка та вступ: Культурний ландшафт України | 600 | 900 |
| Мистецька спадщина та авангард: Від Малевича до Бойчука | 800 | 1200 |
| Народне мистецтво: Символіка та традиції | 700 | 1050 |
| Літературні обрії: Від класики до сучасності | 800 | 1200 |
| Мистецька критика: Лексика та стилістика | 600 | 900 |
| Практика та підсумок: Рецензія як жанр | 500 | 750 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/mystetstvo-i-literatura.yaml`. Go through EVERY `points:` item in EVERY section:
