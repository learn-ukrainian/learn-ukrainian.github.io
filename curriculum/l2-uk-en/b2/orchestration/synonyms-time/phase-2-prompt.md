...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/synonyms-time-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/synonyms-time.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/synonyms-time.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Синоніми: Час та Періоди** (b2 track).
...
|---------|--------|---------------------|
| Вступ: Філософія та духовна цінність часу | 600 | 900 |
| Мить чи епоха: Диференціація «зараз» та «тепер» | 900 | 1350 |
| Офіційний та публіцистичний регістр: «наразі» та «нині» | 900 | 1350 |
| Погляд Археолога: Від «щойно» до «колись давно» | 800 | 1200 |
| Синтез: Часові вирази в історичному та діловому контекстах | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/synonyms-time.yaml`. Go through EVERY `points:` item in EVERY section:
