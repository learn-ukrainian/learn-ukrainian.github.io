...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/b21c-checkpoint-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/b21c-checkpoint.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/b21c-checkpoint.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Контрольна точка B2.1c: Числівники, словотвір та синтаксис** (b2 track).
...
|---------|--------|---------------------|
| Вступ та огляд: Контрольна точка B2.1c | 400 | 600 |
| Числівники та математична спадщина | 1000 | 1500 |
| Словотвір та наукова термінологія | 900 | 1350 |
| Синтаксис односкладних речень | 900 | 1350 |
| Практикум: Аналіз помилок та регістрів | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/b21c-checkpoint.yaml`. Go through EVERY `points:` item in EVERY section:
