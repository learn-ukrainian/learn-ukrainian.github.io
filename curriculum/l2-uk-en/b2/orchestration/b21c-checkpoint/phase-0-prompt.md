...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/b21c-checkpoint.yaml
```

Read the meta file:

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/b21c-checkpoint.yaml
```
...
Research **Контрольна точка B2.1c: Числівники, словотвір та синтаксис** for the **B2** core track. Core tracks need lighter research than seminar tracks — focus on accuracy and State Standard alignment.
