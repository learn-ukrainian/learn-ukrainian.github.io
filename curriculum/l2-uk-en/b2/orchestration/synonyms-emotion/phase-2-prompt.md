...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/research/synonyms-emotion-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/synonyms-emotion.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2/synonyms-emotion.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Синоніми: Емоції та почуття** (b2 track).
...
|---------|--------|---------------------|
| Розминка: Психологія та лексика емоцій | 600 | 900 |
| Спектр світлих почуттів | 1000 | 1500 |
| Глибини смутку та культурний контекст | 1100 | 1650 |
| Практика: Мистецтво вибору точного слова | 800 | 1200 |
| Підсумок та рефлексія | 500 | 750 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2/meta/synonyms-emotion.yaml`. Go through EVERY `points:` item in EVERY section:
