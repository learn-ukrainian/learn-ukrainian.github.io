...
> **Відео:** [Творення прислівників](https://www.youtube.com/results?search_query=творення+прислівників+українська) — відеоуроки
...
|-------|----------|----------|
| швидко | quickly | від "швидкий" + -о |
| повільно | slowly | від "повільний" + -о |
| добре | well | від "добрий" + -е |
| погано | badly | від "поганий" + -о |
| гарно | nicely, well | від "гарний" + -о |
| далеко | far | прислівник місця |
| близько | near, close | прислівник місця |
| тут | here | прислівник місця |
| там | there | прислівник місця |
| завжди | always | прислівник частоти |
| інколи | sometimes | прислівник частоти |
| рідко | rarely | від "рідкий" + -о |
| часто | often | від "частий" + -о |
| по-українськи | in Ukrainian | по- + українськ- + -и |
| по-новому | in a new way | по- + нов- + -ому |
| по-іншому | differently | по- + інш- + -ому |
| хлопчик | little boy | демінутив від "хлопець" |
| донечка | dear daughter | демінутив від "донька" |
| сонечко | dear sun/sweetheart | демінутив від "сонце" |
| ніженька | little foot/leg | демінутив від "нога" |
| вітрище | strong wind | аугментатив від "вітер" |
| холодище | severe cold | аугментатив від "холод" |
| морозище | severe frost | аугментатив від "мороз" |
| словотвір | word formation | термін: творення слів |
