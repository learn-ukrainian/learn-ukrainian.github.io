...
|-------|----------|----------|
| привіт | hi, hello | неформальне привітання |
| бувай | bye | неформальне прощання |
| як справи | how are you | неформальне запитання |
| нормально | fine, okay | розмовна відповідь |
| класно | cool, great | позитивна оцінка |
| круто | cool | позитивна оцінка |
| фігня | nonsense | негативна оцінка |
| прикольно | fun, amusing | позитивна реакція |
| кльово | cool | молодіжний сленг |
| жесть | awful, intense | сильна емоційна реакція |
| капець | disaster | негативна реакція |
| офігенно | awesome | сленг (позитивно) |
| чувак | dude, guy | неформальне звертання |
| типу | like | наповнювач |
| коротше | basically | наповнювач |
| ну | well | частка/наповнювач |
| от | well, so | частка |
| та | and, well | частка |
| ж | emphasis particle | підсилення |
| бо | because/or else | причина/попередження |
| таки | after all | частка |
| ой | oh | вигук здивування |
| ого | wow | вигук здивування |
| комп | computer (informal) | скорочення від «комп'ютер» |
| інфа | info (informal) | скорочення від «інформація» |
| тіпа | like, kind of | варіант «типу» |
| зашибісь | amazing | сленг (позитивно, грубувато) |
