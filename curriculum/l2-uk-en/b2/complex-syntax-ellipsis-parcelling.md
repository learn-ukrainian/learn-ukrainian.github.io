<!-- SCOPE
Covers: Стилістичні синтаксичні засоби (еліпсис та парцеляція) для створення ритму та емоційної напруги
Not covered: 
  - Базові типи неповних речень (опрацьовано у B1)
Related: b2.1-passive-voice, b1-complex-sentences
-->
...
> [!culture] Народна магія мовчання
...
> [!history-bite] Шістдесятники і свобода форми
...
> [!warning] Типова помилка парцеляції
...
> [!reflection] Рефлексія для автора-початківця
