...
subtitle: "Synonyms - Time and Periods"
version: "1.0"
...
grammar:
  - "Adverbs of time"
  - "Temporal nouns and intensity"
objectives:
  - "Учень може розрізняти відтінки значень синонімів на позначення поточного моменту (зараз, тепер, наразі)"
  - "Учень вміє використовувати лексику часових періодів для опису історичних та особистих подій"
  - "Учень розуміє концепцію вічності та миті в українській мові"
vocabulary_count: 35
...
|-------|----------|----------|
| зараз | now | миттєво |
| тепер | now | сучасний етап |
| нині | nowadays | офіційно/поетично |
| сьогодні | today | дата або епоха |
| наразі | at present | офіційно-діловий |
| нинішній | current | прикметник |
| теперішній | present | прикметник |
| сучасний | modern | актуальний |
| раніше | earlier | про минуле |
| колись | once / sometime | далеке минуле |
| давно | long ago | великий термін |
| недавно | recently | близьке минуле |
| щойно | just now | щойно завершене |
| вчора | yesterday | конкретна дата |
| позавчора | the day before yesterday | конкретна дата |
| завтра | tomorrow | конкретна дата |
| післязавтра | the day after tomorrow | конкретна дата |
| потім | then / later | послідовність |
| пізніше | later | порівняння часу |
| згодом | eventually / later | через деякий час |
| час | time | загальне поняття |
| період | period | часовий відрізок |
| епоха | epoch | великий проміжок |
| ера | era | найбільший масштаб |
| момент | moment | коротка мить |
| мить | instant / blink | поетично коротко |
| хвилина | minute | 60 секунд |
| година | hour | 60 хвилин |
| доба | day / 24 hours | астрономічна одиниця |
| вічність | eternity | нескінченність |
| вчасно | on time | у потрібний момент |
| дедлайн | deadline | крайній термін |
| тривалість | duration | обсяг часу |
| щохвилини | every minute | частота |
| постійно | constantly | безперервно |

> [!resources] Додаткові ресурси
> - [Словник української мови онлайн](http://sum.in.ua/) — класичне джерело.
> - [Історія України в датах та періодах](https://history.ua/) — для тренування часової лексики.
> - [Культура мови: Зараз чи Тепер?](https://shron1.chtyvo.org.ua/) — роз'яснення нюансів.

# Підсумок

Сьогодні ми відкрили для себе багатство української часової лексики.
- **Теперішнє:** Ми навчилися розрізняти миттєве «зараз» та офіційне «наразі».
- **Минуле:** Ми побачили різницю між близьким «щойно» та ностальгійним «колись».
- **Масштаби:** Ми вивчили слова для опису миті, періоду та цілої епохи.

Пам'ятайте: час — це тканина життя. Використовуйте ці синоніми, щоб ваша мова була точною та вчасною. Ваша майстерність росте з кожною секундою!
