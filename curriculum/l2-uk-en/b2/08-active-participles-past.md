...
subtitle: "Розпізнавання архаїчних форм та легітимні альтернативи"
version: "1.0"
...
grammar:
  ...
  - "Розрізнення русизмів та автентичних форм"
  - "Синтетичний майбутній час (-иму/-тиму)"
objectives:
  - "Учень може розпізнавати активні дієприкметники минулого часу в текстах"
  - "Учень може розрізняти русизми та легітимні українські форми"
  - "Учень може трансформувати дієприкметники в підрядні означальні речення"
  - "Учень може використовувати синтетичний майбутній час у формальному мовленні"
vocabulary_count: 25
---
...
### Активні дієприкметники минулого часу: теорія
...
|-------|----------|----------|
| колишній | former | прикметник, узгоджується з іменником |
| минулий | past, last | прикметник, "минулий рік" = last year |
| майбутній | future | прикметник, "майбутнє покоління" |
| теперішній | present, current | прикметник, "теперішній стан" |
| давній | ancient, old | прикметник, "давні часи" |
| недавній | recent | прикметник, "недавні події" |
| попередній | previous | прикметник, "попередній етап" |
| наступний | next | прикметник, "наступний крок" |
| останній | last, final | прикметник, "останній шанс" |
| перший | first | числівник-прикметник |
| новоприбулий | newly arrived | складений прикметник |
| новопризначений | newly appointed | складений прикметник, офіційний стиль |
| новообраний | newly elected | складений прикметник, офіційний стиль |
| новостворений | newly created | складений прикметник |
| вищезгаданий | above-mentioned | складений прикметник, офіційний стиль |
| нижчепідписаний | undersigned | складений прикметник, офіційний стиль |
| так званий | so-called | сполучення слів |
| добре відомий | well-known | сполучення слів |
| широко вживаний | widely used | сполучення слів |
| мало досліджений | little researched | сполучення слів |
| чинний | valid, effective | прикметник, "чинний закон" |
| діючий | acting, current | прикметник, офіційний стиль |
| підрядний | subordinate | граматичний термін |
| означальний | attributive | граматичний термін, "означальне речення" |
| узгоджуватися | to agree (grammatically) | дієслово, граматичний термін |
