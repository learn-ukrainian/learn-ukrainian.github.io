...
> **Практика:** [Словник-онлайн](https://slovnyk.ua/) — перевірка стилістичних позначок слів
> **Корпус:** [ГРАК](https://grammarly.ua/) — приклади слів у контексті
> **Посібник:** [Практична стилістика](https://shron1.chtyvo.org.ua/) — вправи на стильову трансформацію
...
|-------|----------|----------|
| адаптація | adaptation | пристосування до нових умов |
| переформулювання | rephrasing | виклад іншими словами |
| парафраз | paraphrase | переказ своїми словами |
| варіант | variant/version | один із можливих способів |
| версія | version | варіант тексту |
| трансформація | transformation | перетворення, зміна форми |
| переклад | translation | (тут) передача в іншій формі |
| стиль | style | функціональний різновид мови |
| регістр | register | ситуативний різновид мови |
| контекст | context | умови використання |
| аудиторія | audience | читачі, слухачі тексту |
| мета | purpose/goal | цільове призначення тексту |
| ефект | effect | вплив на читача |
| доречність | appropriateness | відповідність ситуації |
| гнучкість | flexibility | вміння адаптуватись |
| канцеляризм | officialese/bureaucratic language | штамп ділового стилю |
| кліше | cliche | усталений вираз |
| термінологія | terminology | система термінів |
| образність | imagery | використання образних засобів |
| персоніфікація | personification | надання неживому рис живого |
| метафора | metaphor | приховане порівняння |
| епітет | epithet | художнє означення |
| риторичне питання | rhetorical question | питання без очікування відповіді |
| безособова конструкція | impersonal construction | речення без підмета |
| пасивний стан | passive voice | дія спрямована на підмет |
| експресивність | expressiveness | виразність, емоційність |
| нейтральна лексика | neutral vocabulary | слова без емоційного забарвлення |
| оцінна лексика | evaluative vocabulary | слова з оцінкою (добре/погано) |
| функціональний стиль | functional style | різновид мови за сферою вживання |
| тональність | tone | емоційне забарвлення тексту |
