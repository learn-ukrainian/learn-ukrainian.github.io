...
> **Словник:** [Словник ділової української мови](https://slovnyk.ua/) — термінологія та вирази
> **Шаблони:** [Зразки ділових листів](https://uk.wikipedia.org/wiki/Діловодство) — типові форми документів
> **Етикет:** [Бізнес-етикет в Україні](https://www.youtube.com/results?search_query=бізнес+етикет+україна) — відео про культуру ділового спілкування
...
### Завдання 3: Написання ділового листа (Model Answer)
...
| підприємство | enterprise | виробнича одиниця |
| фірма | firm | комерційна організація |
| корпорація | corporation | велика компанія |
| директор | director | керівник компанії |
| менеджер | manager | управлінець |
| керівник | head, manager | той, хто керує |
| колега | colleague | співробітник |
| партнер | partner | діловий співучасник |
| клієнт | client | замовник послуг |
| замовник | customer | той, хто замовляє |
| контракт | contract | юридична угода |
| угода | agreement | домовленість |
| договір | contract, agreement | офіційний документ |
| переговори | negotiations | ділові обговорення |
| нарада | meeting | внутрішня зустріч |
| презентація | presentation | представлення матеріалу |
| звіт | report | документ з результатами |
| пропозиція | proposal, offer | ділова ініціатива |
| умови | terms, conditions | правила угоди |
| терміни | deadlines | часові рамки |
| вимоги | requirements | необхідні умови |
| зобов'язання | obligations | обов'язки за угодою |
| відповідальність | responsibility | обов'язок відповідати |
| співпраця | cooperation | спільна робота |
| прибуток | profit | дохід |
| збиток | loss | фінансова втрата |
