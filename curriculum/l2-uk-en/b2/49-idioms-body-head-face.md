...
> - **Подкаст:** [Ukrainian Lessons - Idioms](https://ukrainianlessons.com/category/idioms/) — пояснення українських ідіом
> - **Відео:** [Speak Ukrainian - Body Idioms](https://www.youtube.com/results?search_query=ukrainian+idioms+body) — відеоуроки з соматичними фразеологізмами
> - **Словник:** [Goroh - Фразеологічний словник](https://goroh.pp.ua/) — онлайн-словник фразеологізмів
> - **YouTube:** [Learn Ukrainian with Anna - Idioms](https://www.youtube.com/c/LearnUkrainianWithAnna) — популярний канал з поясненням ідіом
...
|---------------|----------|----------|
| **голова йде обертом** | be overwhelmed | соматичний; стан приголомшення |
| **тримати язик за зубами** | keep a secret | соматичний; мовчати |
| **набивати гудзі** | brag, boast | соматичний; хвалитися |
| **клювати носом** | nod off, doze | соматичний; дрімати |
| **довгий язик** | loose lips | соматичний; балакучість |
| **гострий язик** | sharp tongue | соматичний; дошкульність |
| **ламати голову** | rack one's brains | соматичний; напружено думати |
| **втратити голову** | lose one's head | соматичний; втрата контролю / закоханість |
| голова | head | анатомія; символ розуму |
| оберт | rotation, turn | від «обертатися» |
| язик | tongue | анатомія; символ мовлення |
| зуби | teeth | анатомія; множина від «зуб» |
| тримати | keep, hold | дієслово |
| гудзик | button | деталь одягу |
| набивати | stuff, hammer | дієслово |
| ніс | nose | анатомія |
| клювати | peck | дієслово; рух птаха |
| довгий | long | прикметник |
| гострий | sharp | прикметник |
| ламати | break | дієслово |
| втратити | lose | дієслово доконаного виду |
| обличчя | face | анатомія |
| рот | mouth | анатомія |
| губи | lips | анатомія; множина від «губа» |
| вуха | ears | анатомія; множина від «вухо» |
| очі | eyes | анатомія; множина від «око» |
| брови | eyebrows | анатомія |
| чоло | forehead | анатомія |
| щоки | cheeks | анатомія |
| підборіддя | chin | анатомія |
| ідіома | idiom | лінгвістичний термін |
| значення | meaning | лінгвістичний термін |
| переносний | figurative | про метафоричне значення |
| буквальний | literal | про пряме значення |
| соматичний | somatic | пов'язаний з тілом |
