...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-hist/zhinky-v-revoiuutsiiakh.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-hist/meta/zhinky-v-revoiuutsiiakh.yaml
```
...
Research **Жінки в революціях: Прихована історія** for the **c1-hist** track. Produce structured research notes that will drive content writing in Phase B.
