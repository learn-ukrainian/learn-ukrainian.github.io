...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-hist/continuity-of-cultural-genocide.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-hist/meta/continuity-of-cultural-genocide.yaml
```
...
Research **Тяглість культурного геноциду: 1937 vs 2022** for the **c1-hist** track. Produce structured research notes that will drive content writing in Phase B.
