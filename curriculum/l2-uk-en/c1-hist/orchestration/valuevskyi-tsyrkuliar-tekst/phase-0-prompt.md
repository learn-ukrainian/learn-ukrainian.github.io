...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-hist/valuevskyi-tsyrkuliar-tekst.yaml
```

Read the current meta file for content_outline structure:

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-hist/meta/valuevskyi-tsyrkuliar-tekst.yaml
```

## Your Task

Research **Валуєвський циркуляр: Повний текст** for the **c1-hist** track. Produce structured research notes that will drive content writing in later phases.
