...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-hist/1918-1920-viina-i-soiuz.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-hist/meta/1918-1920-viina-i-soiuz.yaml
```
...
Research **1918-1920: Війна і союз одночасно** for the **c1-hist** track. Produce structured research notes that will drive content writing in Phase B.
