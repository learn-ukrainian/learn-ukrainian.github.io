...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-hist/diaspora-naukovtsi.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-hist/meta/diaspora-naukovtsi.yaml
```
...
Research **Діаспорні науковці: Збереження спадщини** for the **c1-hist** track. Produce structured research notes that will drive content writing in Phase B.
