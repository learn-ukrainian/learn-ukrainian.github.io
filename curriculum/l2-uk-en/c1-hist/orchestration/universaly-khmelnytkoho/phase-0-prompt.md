...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-hist/universaly-khmelnytkoho.yaml
```

Read the current meta file for content_outline structure:

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-hist/meta/universaly-khmelnytkoho.yaml
```

## Your Task

Research **Універсали Хмельницького** for the **c1-hist** track. Produce structured research notes that will drive content writing in later phases.
