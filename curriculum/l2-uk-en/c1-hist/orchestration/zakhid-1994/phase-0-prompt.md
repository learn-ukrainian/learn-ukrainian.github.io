...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-hist/zakhid-1994.yaml
```

Read the current meta file for content_outline structure:

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-hist/meta/zakhid-1994.yaml
```

## Your Task

Research **Будапештський меморандум: Гарантії без гарантій** for the **c1-hist** track. Produce structured research notes that will drive content writing in later phases.
