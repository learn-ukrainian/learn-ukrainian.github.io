...
П'ятий шар — джерельний. Ми читаємо не "сам фольклор" у чистому повітрі, а конкретний запис або публічний текст. Для цього модуля повні тексти подано на публічних сторінках ukrlib.com.ua; у learner-facing матеріалах ми посилаємося саме на ці сторінки. Внутрішні службові позначки корпусу не є частиною уроку і не мають з'являтися перед учнем. Якщо джерело не можна безпечно показати, воно не повинно ставати авторитетною цитатою. Якщо ми цитуємо тільки уривок, треба пам'ятати, що повний текст ширший за наш аналіз.

Шостий шар — перехід до писемної культури. Записувач, упорядник, шкільна хрестоматія, композитор і письменник не скасовують усну традицію, але змінюють режим її існування. Текст, який колись жив у голосі, на сторінці стає доступним для школи, порівняння і літературного переосмислення. Леонтович не просто "взяв фольклор" у повсякденному сенсі; його хоровий "Щедрик" показує, як коротка народна формула може перейти в професійну музичну форму. Шевченкова думова інтонація не робить його поезію думою, але показує, що писемна література чує народний епос. Саме такі переходи нам треба називати точно.
...
Порівняймо дві короткі сезонні пісні. В обох текстах важать повтор, звертання, образ і гуртовість. Але вони не виконують ту саму роботу. Щедрівка зосереджує побажання навколо дому: сад, тереми, господар, господиня, діти. Веснянка звертається до весни і розгортає питання-відповідь: що принесено громаді, як це пов'язано з літечком, житечком, квітами, дівочим співом.
...
:::note
Сильна відповідь не починається зі слова "народ" як готового пояснення. Вона починається з конкретного публічного тексту, потім називає жанр, форму, ситуацію виконання і межу доказу.
:::
...
Пісня про Байду дає учневі добрий тест на жанрову уважність. Тут є Царгород, турецький цар, спокуса владою, відповідь героя і готовність до страждання. Але текст працює не як думова оповідь із довгим речитативним розгортанням. Він стискає конфлікт до гострої сцени: пропозиція, відповідь, покарання, незламність. Урок не має перетворювати Байду на документальну біографію без застережень. Ми читаємо пісенний образ і питаємо, яку моральну форму він дає спільноті.

Саме тут потрібна джерельна критика. Публічна сторінка ukrlib.com.ua дає повний текст, з яким може працювати учень. Урок цитує тільки фрагмент, бо нам потрібна жанрова межа. Але фрагмент не має відриватися від повного тексту: у повному тексті видно і початкове пиття Байди, і спокусу, і страту, і фінальну дію героя. Якщо учень робить висновок лише з уривка, він має назвати його межу. Якщо робить висновок про весь твір, він має прочитати весь твір.
...
У цьому модулі всі learner-facing посилання мають бути публічними: ukrlib.com.ua або інше реальне джерело, яке учень може відкрити. Це не технічна формальність, а частина педагогіки. Коли учень бачить URL повного тексту, він може перевірити уривок, дочитати контекст, поставити питання про назву, розділ, жанр, повноту й публікацію. Коли учень бачить службову внутрішню позначку, він не отримує джерела; він отримує технічний шум, який не належить до навчання.
...
Деколонізація також вимагає не перебільшувати. Якщо ми відповідаємо на імперське зниження романтичним туманом, ми знову втрачаємо точність. Сильна відповідь звучить інакше: "Ось публічний текст; ось жанр; ось виконавська ситуація; ось що цей фрагмент дозволяє стверджувати; ось межа висновку". Така відповідь не слабша за пафосну. Вона сильніша, бо її можна перевірити.
...
Народна культура входить у писемну літературу не як склад сировини, з якого автор бере "колорит". Вона входить як інтонація, структура пам'яті, сюжетний конфлікт, образний код, ритм і форма звертання. Коли Шевченко використовує думову інтонацію, він не стає народним співцем у простому сенсі, але його поезія чує речитативну оповідність, моральний простір і голос пригнобленої спільноти. Коли Леонтович перетворює короткий "Щедрик" на хорову композицію, народна формула переходить у професійну музичну форму, не втрачаючи впізнаваного ядра.
...
Після вступного модуля відповідь учня має бути побудована не як переказ "про фольклор узагалі", а як доказова міні-розвідка. Її можна складати за сімома кроками. Перший крок — назвати повний публічний текст. Не "у народній пісні сказано", а "у публічному тексті «Ой весна, весна, ти красна» на ukrlib.com.ua бачимо..." Така фраза одразу прив'язує відповідь до перевірюваної сторінки. Другий крок — назвати жанр. Веснянка, щедрівка, дума й історична пісня не є взаємозамінними прикладами "народної поезії"; вони мають різні форми й ситуації.
...
Сторінка читання також дисциплінує цитування. Учень бачить, що джерело має назву, жанр, публічну адресу і примітку про суспільне надбання. Це привчає не вирізати рядки з пам'яті й не посилатися на технічні службові мітки. У подальших модулях ця звичка буде особливо потрібна: деякі тексти матимуть кілька варіантів, деякі будуть відомі через збірник або автора обробки, деякі треба буде зіставляти з пізнішим літературним твором. Якщо учень уже розуміє, що повний текст, уроковий уривок і пізніше переосмислення мають різний доказовий статус, він не сплутає ці рівні.
...
Після цього уроку сильна відповідь починається з джерела: "Я читаю повний публічний текст..." або "У модулі наведено уривок з..." Далі вона називає жанр, виконавську ситуацію, формулу або повтор, межу доказу і зв'язок із писемною культурою. Так українська народна культура перестає бути прикрасою чужого опису і постає як власний спосіб пам'ятати, судити, співати, передавати й творити літературу.
