...
claim_source: "спрощене читання побутових дум як антикозацьких сюжетів"
truth_source: "класифікація побутово-моралістичних дум і кобзарська репертуарна традиція"
:::
...
:::high-culture-bridge
nodes:
  - "Кобзарська дума: родинна провина звучить у речитативі, формулі й виконавській пам'яті."
  - "Літературна обробка: мотив вдови, сироти або покинутого роду переходить у авторський сюжет."
  - "Семінарна відповідь: учень називає, де первинний текст, де репертуарний доказ, а де пізніша рецепція."
