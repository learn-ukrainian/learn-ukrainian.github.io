...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/lit-juvenile/zavadovych-adventures.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/lit-juvenile/meta/zavadovych-adventures.yaml
```
...
Research **Zavadovych Adventures** for the **lit-juvenile** track. Produce structured research notes that will drive content writing in Phase B.
