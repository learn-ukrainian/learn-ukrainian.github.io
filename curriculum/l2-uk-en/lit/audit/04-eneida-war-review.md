...
|---|------|-------|-------|-----|--------|
| 1 | reading | Первинне джерело: Батальні сцени «Енеїди» (Частини IV-VI) | 4 | 1 | ✅ |
| 2 | reading | Джерело: Подвиг Низа та Евріала | 3 | 1 | ✅ |
| 3 | essay-response | Есе: Естетика смішної смерті — етика чи мистецтво? | 1 | 1 | ✅ |
| 4 | critical-analysis | Аналіз тексту: Щит Вулкана — український фольклор замість римського | 1 | 1 | ✅ |
| 5 | critical-analysis | Аналіз тексту: Фінальний поєдинок — милість проти помсти | 1 | 1 | ✅ |
