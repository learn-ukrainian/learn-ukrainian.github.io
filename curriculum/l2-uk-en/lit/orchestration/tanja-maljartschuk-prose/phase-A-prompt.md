...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/lit/tanja-maljartschuk-prose.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/lit/meta/tanja-maljartschuk-prose.yaml
```
...
Research **Tanja Maljartschuk Prose** for the **lit** track. Produce structured research notes that will drive content writing in Phase B.
...
```yaml
subject: "Tanja Maljartschuk Prose"
