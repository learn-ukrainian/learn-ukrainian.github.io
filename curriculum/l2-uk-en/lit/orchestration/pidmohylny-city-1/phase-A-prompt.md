...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/lit/pidmohylny-city-1.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/lit/meta/pidmohylny-city-1.yaml
```
...
Research **Валер'ян Підмогильний: «Місто» — урбаністичний роман** for the **lit** track. Produce structured research notes that will drive content writing in Phase B.
