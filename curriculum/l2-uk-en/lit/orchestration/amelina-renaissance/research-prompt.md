...
subtitle: Amelina Renaissance
focus: literature
pedagogy: Seminar
phase: LIT.5 Independence Era 1991-Present
word_target: 5000
objectives:
- 'Проаналізувати твір Вікторія Амеліна: Нове Відродження у контексті епохи'
- Дослідити стилістичні особливості тексту
- Зрозуміти деколонізаційне значення автора
sources:
- name: 'Вікторія Амеліна: Нове Відродження — тексти та аналіз'
...
activity_hints:
- type: reading
  focus: Аналіз ключових уривків amelina-renaissance
  source: UkrLib
  items: 5+
- type: essay-response
...
Research **Вікторія Амеліна: Нове Відродження** for the **lit** track. Produce structured research notes that will drive content writing in Phase B.
