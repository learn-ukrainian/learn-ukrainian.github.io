...
activity_hints:
- type: reading
  focus: Аналіз ключових уривків koval-storinky
  source: UkrLib
  items: 5+
- type: essay-response
...
Research **Koval Storinky** for the **lit** track. Produce structured research notes that will drive content writing in Phase B.
...
- `query_wikipedia(query="Koval Storinky", mode="extract")` — factual backbone
- `search_literary(query="Koval Storinky")` — primary source excerpts
