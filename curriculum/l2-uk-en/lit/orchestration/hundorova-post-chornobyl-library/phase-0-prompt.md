...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/lit/hundorova-post-chornobyl-library.yaml
```

Read the current meta file for content_outline structure:

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/lit/meta/hundorova-post-chornobyl-library.yaml
```

## Your Task

Research **Hundorova Post Chornobyl Library** for the **lit** track. Produce structured research notes that will drive content writing in later phases.
