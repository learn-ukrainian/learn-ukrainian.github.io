...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/lit/kaidash-family-conflict.yaml
```

Read the current meta file for content_outline structure:

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/lit/meta/kaidash-family-conflict.yaml
```

## Your Task

Research **Кайдашева сім'я: Анатомія Конфлікту** for the **lit** track. Produce structured research notes that will drive content writing in later phases.
