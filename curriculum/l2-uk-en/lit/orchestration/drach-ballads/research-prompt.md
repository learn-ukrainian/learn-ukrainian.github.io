...
activity_hints:
- type: reading
  focus: Аналіз ключових уривків drach-ballads
  source: UkrLib
  items: 5+
- type: essay-response
