...
subtitle: New York Group Poets
focus: literature
pedagogy: Seminar
phase: LIT.4 Diaspora and Dissidence 1933-1991
word_target: 5000
objectives:
- Проаналізувати Нью-Йоркську групу як авангардний феномен діаспори
- Дослідити стилістичні особливості тексту
- Зрозуміти деколонізаційне значення авторів
sources:
- name: New York Group Poets — тексти та аналіз
...
- section: Вступ та культурний контекст
  points:
  - Нью-Йоркська група як авангардний феномен діаспори 1950-70-х рр.
  - Місце в літературному каноні
  - Чому цей текст важливий сьогодні
  words: 850
- section: 'Аналіз твору: Сюжет та структура'
  points:
  - Ключові поети — Тарнавський, Андієвська, Рубчак, Бойчук
  - Впливи та джерела
  - Авангард як реакція на МУРівський традиціоналізм
  words: 850
- section: Герменевтика та ключові образи
  points:
  - Детальний розбір символіки
  - Система образів і їхня еволюція
  - Архетипи та сюрреалістичні підтексти
  words: 850
- section: Мова, стиль та поетика
  points:
  - Стилістичні інновації авангардної поетики
  - Контакт з американською та европейською поезією
  - Особливості ритміки та синтаксису
  words: 850
- section: Деколонізаційний вимір
  points:
  - Який імперський міф руйнує цей текст?
  - Діаспора як місце свободи і творчості
  - Опір асиміляції та культурне самоствердження
  words: 850
- section: Підсумок та рецепція
  points:
  - Вплив на сучасну українську поезію
  - Світовий контекст групи
...
activity_hints:
- type: reading
  focus: Аналіз ключових уривків new-york-group-poets
  source: UkrLib
  items: 5+
- type: essay-response
...
persona:
  ...
  role: Avant-Garde Diaspora Poet
...
Research **New York Group Poets** for the **lit** track. Produce structured research notes that will drive content writing in Phase B.
