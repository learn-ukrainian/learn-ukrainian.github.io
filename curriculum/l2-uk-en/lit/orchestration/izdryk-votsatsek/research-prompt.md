...
activity_hints:
- type: reading
  focus: Аналіз ключових уривків izdryk-votsatsek
  source: UkrLib
  items: 5+
- type: essay-response
