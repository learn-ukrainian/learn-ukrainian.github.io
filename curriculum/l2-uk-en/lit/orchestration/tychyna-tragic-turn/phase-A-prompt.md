...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/lit/tychyna-tragic-turn.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/lit/meta/tychyna-tragic-turn.yaml
```
...
Research **Павло Тичина: Трагічний поворот до соцреалізму** for the **lit** track. Produce structured research notes that will drive content writing in Phase B.
