...
subtitle: Vinhranovskyi Prose
focus: literature
pedagogy: Seminar
phase: LIT.4 Resistance 1933-1991
word_target: 5000
objectives:
- Проаналізувати твір Vinhranovskyi Prose у контексті епохи
- Дослідити стилістичні особливості тексту
- Зрозуміти деколонізаційне значення автора
sources:
- name: Vinhranovskyi Prose — тексти та аналіз
...
activity_hints:
- type: reading
  focus: Аналіз ключових уривків vinhranovskyi-prose
  source: UkrLib
  items: 5+
- type: essay-response
...
- `query_wikipedia(query="Vinhranovskyi Prose", mode="extract")` — factual backbone
- `search_literary(query="Vinhranovskyi Prose")` — primary source excerpts
