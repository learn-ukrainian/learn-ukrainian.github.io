...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/lit/vynnychenko-solar-machine.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/lit/meta/vynnychenko-solar-machine.yaml
```
...
Research **Володимир Винниченко: «Сонячна машина» — перша утопія** for the **lit** track. Produce structured research notes that will drive content writing in Phase B.
