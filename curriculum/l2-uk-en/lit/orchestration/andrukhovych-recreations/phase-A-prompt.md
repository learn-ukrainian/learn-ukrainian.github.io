...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/lit/andrukhovych-recreations.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/lit/meta/andrukhovych-recreations.yaml
```
...
Research **Юрій Андрухович: «Рекреації»** for the **lit** track. Produce structured research notes that will drive content writing in Phase B.
