...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/lit/semenko-futurism-manifesto.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/lit/meta/semenko-futurism-manifesto.yaml
```
...
Research **Михайль Семенко: Маніфест футуризму** for the **lit** track. Produce structured research notes that will drive content writing in Phase B.
