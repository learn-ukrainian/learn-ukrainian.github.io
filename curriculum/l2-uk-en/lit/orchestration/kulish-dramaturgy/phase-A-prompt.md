...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/lit/kulish-dramaturgy.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/lit/meta/kulish-dramaturgy.yaml
```
...
Research **Kulish Dramaturgy** for the **lit** track. Produce structured research notes that will drive content writing in Phase B.
...
# Дослідження: Kulish Dramaturgy

## Key Facts Ledger
<!-- IMMUTABLE TRUTH ANCHOR — Phase D verifies prose against this -->
```yaml
subject: "Kulish Dramaturgy"
