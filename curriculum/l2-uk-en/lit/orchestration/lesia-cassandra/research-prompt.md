...
activity_hints:
- type: reading
  focus: Аналіз ключових уривків lesia-cassandra
  source: UkrLib
  items: 5+
- type: essay-response
