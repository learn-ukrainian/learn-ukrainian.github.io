...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/lit-fantastika/kidruk-colony-hard-scifi.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/lit-fantastika/meta/kidruk-colony-hard-scifi.yaml
```
...
Research **Kidruk Colony Hard Scifi** for the **lit-fantastika** track. Produce structured research notes that will drive content writing in Phase B.
...
# Дослідження: Kidruk Colony Hard Scifi

## Key Facts Ledger
<!-- IMMUTABLE TRUTH ANCHOR — Phase D verifies prose against this -->
```yaml
subject: "Kidruk Colony Hard Scifi"
