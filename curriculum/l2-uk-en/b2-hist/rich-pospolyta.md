...
> [!resources]
> **Завдання 1: Аналіз універсалу Богдана Хмельницького**
> **Ресурс:** [Універсал Богдана Хмельницького до козаків та всього народу](https://chtyvo.org.ua/authors/Khmelnytskyi_Bohdan/Universal_do_ukrainskoho_narodu/)
> **Завдання:**
> - Прочитайте текст універсалу та знайдіть у ньому звернення гетьмана до народу.
> - Які терміни використовує Хмельницький для опису гніту Речі Посполитої?
> - Проаналізуйте використання пасивних конструкцій у тексті документа.
>
> **Завдання 2: Сучасний історичний погляд на Люблінську унію**
> **Ресурс:** [Відеолекція Ярослава Грицака про формування української ідентичності](https://www.youtube.com/watch?v=dQw4w9WgXcQ) *(Примітка: посилання є прикладом)*
> **Завдання:**
> - Як історик пояснює причини асиміляції української еліти?
> - Знайдіть приклади академічного регістру в промові лектора.
> - Порівняйте аргументацію історика з тезами, викладеними в модулі.
...
### Тема
Напишіть есе (400+ слів) на тему: **«Полонізація та соціальний гніт у Речі Посполитій: трагедія чи неминучість?»**

**Вимоги:**
- Використайте лексику та граматику модуля (історичний наратив, пасивний стан).
- Застосуйте деколонізаційний підхід до аналізу (критика імперського бачення).
- Обов'язково використайте цитати з первинних джерел, наведених у модулі.
- Дотримуйтеся структури: вступ, основна частина (аргументи), висновок.

### Критерії оцінювання
| Критерій | Вага | Опис |
| :--- | :--- | :--- |
| **Мовна якість** | 40% | Використання складного синтаксису, пасивних конструкцій та історичної термінології. |
| **Використання матеріалу** | 30% | Наявність цитат та посилань на первинні джерела. |
| **Структура та логіка** | 20% | Чітка аргументація та використання дискурсивних маркерів. |
| **Деколонізаційний аналіз** | 10% | Критичне осмислення ролі Речі Посполитої в історії України. |

### Зразок відповіді

> [!model-answer]
> Люблінська унія 1569 року стала поворотною точкою в історії України, визначивши вектор її розвитку на століття вперед. Створення Речі Посполитої часто ідеалізується як народження демократичної «республіки шляхти», проте для українського народу цей період став часом глибокої соціальної та національної трагедії. Аналізуючи процеси полонізації та кріпацтва через деколонізаційну призму, стає очевидним, що польське панування було не «цивілізаційним прогресом», а жорсткою колоніальною експлуатацією.
>
> Основною причиною занепаду української суб'єктності стало «обезголовлення» нації — добровільна або вимушена асиміляція еліти. Сучасники, як-от львівський міщанин Рогатинець, фіксували цей процес у своїх творах: руські князі прагнули чужої слави, полишивши свій народ напризволяще. Втрата природних лідерів залишила українців без захисту перед обличчям агресивної католицької експансії та єзуїтського впливу. Полонізація шляхти була не просто зміною мови, а зміною ідентичності, що призвело до повної відчуженості панів від свого народу.
>
> Соціально-економічний вимір цієї трагедії втілився у фільварково-панщинній системі. Родючі українські землі були перетворені на джерело збагачення польських магнатів, тоді як селянство було фактично перетворене на рабів. Універсали того часу, як-от документ з Немирова, прямо стверджували: «Воля пана є законом для хлопа». Кріпацтво було не просто економічною моделлю, а інструментом дегуманізації, де селянин втрачав право навіть на власну віру. Берестейська унія 1596 року лише поглибила цей розкол, перетворивши релігію на маркер «свій-чужий» і маргіналізувавши православних як «схизматиків».
>
> Проте цей тиск породив і небачений спротив. Братства, Острозька академія та, зрештою, козацтво стали тими інституціями, які не дали українській культурі зникнути. Запорозька Січ постала як альтернативна соціальна модель — територія волі, куди тікали ті, хто не бажав бути «бидлом». Саме цей внутрішній конфлікт між польською «золотою вольністю» для обраних та українською жадобою свободи для всіх став рушієм майбутніх революцій.
>
> Отже, період Речі Посполитої був часом великого випробування. Полонізація та гніт були не неминучістю, а свідомою політикою колонізації. Хоча українська еліта значною мірою була асимільована, сам народ зберіг свою ідентичність через мову, віру та козацьку традицію. Це доводить, що справжня стійкість нації гартується саме в часи найважчих випробувань, а спадщина Речі Посполитої нагадує нам про ціну свободи та небезпеку втрати власної еліти.
