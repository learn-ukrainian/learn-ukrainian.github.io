<!-- SCOPE
Covers: Люблінська унія 1569 року, утворення Речі Посполитої, наслідки інкорпорації українських земель, процеси полонізації та втрати національної еліти, запровадження фільваркової системи та кріпацтва, Берестейська унія 1596 року, культурний спротив через братський рух, розвиток полемічної літератури, передумови формування Запорозької Січі як нової еліти.
Not covered:
  - Детальний перебіг Національно-визвольної війни (Хмельниччини) → b2-hist-033
  - Внутрішній устрій Війська Запорозького → b2-hist-034
Related: b2-hist-031, b2-hist-033
-->
