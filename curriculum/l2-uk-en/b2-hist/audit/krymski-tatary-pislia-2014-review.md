...
|---|------|-------|-------|-----|--------|
| 1 | reading | Звіт: Права людини в Криму | 4 | 1 | ✅ |
| 2 | critical-analysis | Аналіз: Чи є це геноцидом? | 1 | 1 | ✅ |
| 3 | essay-response | Есе: Історія повторюється | 1 | 1 | ✅ |
| 4 | comparative-study | Порівняння: Методи тиску | 1 | 1 | ✅ |
| 5 | true-false | Міфи та факти про окупацію | 10 | 8 | ✅ |
