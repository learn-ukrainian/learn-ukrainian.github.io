...
| **Читання: Князь Володимир: від язичника до святого** | ✅ | 419 | Included in Core |
| **Корсунський похід і шлюб із Анною** | ⚪️ | 263 | Skipped |
| **Первинні джерела** | ⚪️ | 251 | Skipped |
| **Деколонізаційний погляд** | ⚪️ | 355 | Skipped |
| **Значення хрещення для культури** | ✅ | 303 | Included in Core |
| **Підсумок** | ✅ | 2080 | Included in Core |
