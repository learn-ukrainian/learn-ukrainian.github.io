...
| 3 | match-up | Поєднайте видатних діячів шістдесятництва з їхньою діяльністю або долею. | 12 | 8 | ✅ |
| 4 | error-correction | Виправте помилки у вживанні пасивного стану та безособових конструкцій. | 6 | 6 | ✅ |
| 5 | true-false | Проаналізуйте уривок з виступу Василя Стуса та виберіть правильні твердження. | 8 | 8 | ✅ |
| 6 | mark-the-words | Знайдіть дієслова у тексті | 6 | 6 | ✅ |
| 7 | essay-response | Ваша думка | 1 | 1 | ✅ |
| 8 | comparative-study | Порівняння епох | 1 | 1 | ✅ |
| 9 | group-sort | Розподіліть за групами | 16 | 1 | ✅ |
| 10 | cloze | Заповніть пропуски у тексті про феномен шістдесятництва (17 пропусків). | 16 | 1 | ✅ |
| 11 | unjumble | Складіть речення з розсипаних слів. | 6 | 6 | ✅ |
| 12 | true-false | Визначте, чи є твердження правдивими. | 8 | 8 | ✅ |
| 13 | match-up | Доберіть синоніми до слів. | 12 | 8 | ✅ |
| 14 | fill-in | Вставте пропущені прийменники. | 8 | 8 | ✅ |
| 15 | true-false | Виберіть ознаки "шароварщини" | 8 | 8 | ✅ |
| 16 | translate | Перекладіть історичні терміни українською мовою. | 8 | 6 | ✅ |
