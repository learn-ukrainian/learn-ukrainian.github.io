...
**Level:** B2 | **Module:** M111 | **Phase:** B2.3c | **Pedagogy:** CBI | **Target:** 4000
**Naturalness:** 9/10 (PASS)
**Overall Status:** ❌ FAIL
**Generated:** 2026-01-25 22:23:34
...
| 2 | fill-in | Лексика: Заповніть пропуски | 8 | 8 | ✅ |
| 3 | error-correction | Граматика: Виправте помилки | 6 | 6 | ✅ |
| 4 | match-up | Встановіть відповідність між терміном та його історичним значенням. | 14 | 8 | ✅ |
| 5 | essay-response | Ваша думка | 1 | 1 | ✅ |
| 6 | comparative-study | Порівняння політики | 1 | 1 | ✅ |
| 7 | true-false | Виберіть правильні твердження | 8 | 8 | ✅ |
| 8 | mark-the-words | Знайдіть факти | 6 | 6 | ✅ |
| 9 | unjumble | Складіть речення | 6 | 6 | ✅ |
| 10 | true-false | Правда чи неправда | 8 | 8 | ✅ |
| 11 | group-sort | Розподіліть поняття за відповідними історичними категоріями. | 20 | 1 | ✅ |
| 12 | cloze | Текст із пропусками | 19 | 1 | ✅ |
| 13 | translate | Оберіть правильний український переклад для історичних термінів. | 8 | 6 | ✅ |
| 14 | match-up | Знайдіть синоніми до слів з тексту модуля. | 14 | 8 | ✅ |
| 15 | true-false | Мовні особливості тексту | 8 | 8 | ✅ |
| 16 | quiz | Перевірка розуміння | 8 | 8 | ✅ |
