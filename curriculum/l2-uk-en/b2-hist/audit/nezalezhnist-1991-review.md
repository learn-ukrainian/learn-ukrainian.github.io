...
**Level:** B2 | **Module:** M121 | **Phase:** B2.3d | **Pedagogy:** CBI | **Target:** 4000
**Naturalness:** 9/10 (PASS)
**Overall Status:** ❌ FAIL
**Generated:** 2026-01-25 22:23:40
...
| 2 | fill-in | Заповніть пропуски відповідними словами про економічні та політичні реалії. | 10 | 8 | ✅ |
| 3 | match-up | Поєднайте дати з відповідними історичними подіями. | 12 | 8 | ✅ |
| 4 | error-correction | Виправте граматичні помилки у реченнях про політичну історію. | 6 | 6 | ✅ |
| 5 | true-false | Визначте правдивість тверджень про Будапештський меморандум. | 10 | 8 | ✅ |
| 6 | mark-the-words | Знайдіть дієслова минулого часу | 6 | 6 | ✅ |
| 7 | group-sort | Розподіліть за групами | 20 | 1 | ✅ |
| 8 | cloze | Заповніть пропуски у тексті про становлення України (17 пропусків). | 19 | 1 | ✅ |
| 9 | unjumble | Складіть речення про державне будівництво України. | 6 | 6 | ✅ |
| 10 | true-false | Визначте правдивість тверджень про період 1991-2004 років. | 8 | 8 | ✅ |
| 11 | match-up | Доберіть синоніми до термінів політичного дискурсу. | 12 | 8 | ✅ |
| 12 | fill-in | Вставте правильні прийменники у речення про історію. | 8 | 8 | ✅ |
| 13 | true-false | Визначте правдивість лінгвістичних тенденцій періоду. | 8 | 8 | ✅ |
| 14 | translate | Оберіть правильний переклад для термінів епохи становлення. | 8 | 6 | ✅ |
| 15 | essay-response | Труднощі становлення нації | 1 | 1 | ✅ |
| 16 | comparative-study | Порівняння президенств | 1 | 1 | ✅ |
