...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/destalinizatsiia-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/destalinizatsiia.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/destalinizatsiia.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Десталінізація в Україні** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Смерть Сталіна — Кінець епохи | 400 | 600 |
| Вступ: Смерть Сталіна — Повстання в ГУЛАГу | 500 | 750 |
| XX з'їзд та його наслідки (1956): Таємна доповідь | 600 | 900 |
| XX з'їзд та його наслідки (1956): Межі реабілітації | 600 | 900 |
| Відлига в культурі: Повернення пам'яті | 600 | 900 |
| Відлига в культурі: Шістдесятники | 600 | 900 |
| Первинні джерела | 500 | 750 |
| Деколонізаційний погляд: Ілюзія змін | 550 | 825 |
| Деколонізаційний погляд: Крим і кінець відлиги | 550 | 825 |
| Підсумок: Незавершена справа | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/destalinizatsiia.yaml`. Go through EVERY `points:` item in EVERY section:
