...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/kost-hordiyenko-sich-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/kost-hordiyenko-sich.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/kost-hordiyenko-sich.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Кость Гордієнко та Січ** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Непримиренний кошовий | 600 | 900 |
| Запорозька Січ: Острів свободи в морі імперій | 800 | 1200 |
| Великий союз: Гордієнко, Мазепа та Карл XII | 800 | 1200 |
| Трагедія 1709: Зруйнування Чортомлицької Січі | 900 | 1350 |
| Читання: Козацький дух у документах | 600 | 900 |
| Первинні джерела: Свідчення очевидців | 600 | 900 |
| Деколонізаційний погляд: Січ як анти-імперський проект | 700 | 1050 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/kost-hordiyenko-sich.yaml`. Go through EVERY `points:` item in EVERY section:
