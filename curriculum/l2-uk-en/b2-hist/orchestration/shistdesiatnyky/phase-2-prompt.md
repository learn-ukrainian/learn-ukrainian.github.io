...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/shistdesiatnyky-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/shistdesiatnyky.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/shistdesiatnyky.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Шістдесятники: Бунт проти сірості** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ — Хрущовська відлига: I — Ілюзія свободи | 450 | 675 |
| Вступ — Хрущовська відлига: II — Клуб творчої молоді | 450 | 675 |
| Культурний вибух: I — Слово правди | 450 | 675 |
| Культурний вибух: II — Тіні забутих предків | 600 | 900 |
| Культурний вибух: III — Розбите відродження | 500 | 750 |
| Первинні джерела: I — Окрайці думок | 450 | 675 |
| Первинні джерела: II — Інтернаціоналізм чи русифікація? | 600 | 900 |
| Деколонізаційний погляд: I — Мова як зброя | 500 | 750 |
| Деколонізаційний погляд: II — Від культури до політики | 550 | 825 |
| Деколонізаційний погляд: III — Спадщина та тяглість | 450 | 675 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/shistdesiatnyky.yaml`. Go through EVERY `points:` item in EVERY section:
