...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/hromadske-suspilstvo-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/hromadske-suspilstvo.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/hromadske-suspilstvo.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Громадянське суспільство у війні** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Нація, яка згуртувалася | 600 | 900 |
| Волонтерський рух: Мілітарна та цифрова міць | 1000 | 1500 |
| Волонтерський рух: Гуманітарний та медичний вимір | 800 | 1200 |
| Громадські організації: Правозахист і культура | 800 | 1200 |
| Громадські організації: Соціальна підтримка та відбудова | 600 | 900 |
| Первинні джерела | 500 | 750 |
| Держава і суспільство | 400 | 600 |
| Підсумок: Сила спільноти | 300 | 450 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/hromadske-suspilstvo.yaml`. Go through EVERY `points:` item in EVERY section:
