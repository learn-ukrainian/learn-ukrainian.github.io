...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/yurii-nemyrych-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/yurii-nemyrych.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/yurii-nemyrych.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Юрій Немирич: Гадяцька угода** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ | 300 | 450 |
| Юрій Немирич: Портрет інтелектуала | 600 | 900 |
| Гадяцька угода 1658: Проект трьох народів | 800 | 1200 |
| Освіта і культура в проекті Немирича | 400 | 600 |
| Конотопська битва: Тріумф зброї | 600 | 900 |
| Крах великої ідеї: Чому не вийшло? | 600 | 900 |
| Читання | 500 | 750 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/yurii-nemyrych.yaml`. Go through EVERY `points:` item in EVERY section:
