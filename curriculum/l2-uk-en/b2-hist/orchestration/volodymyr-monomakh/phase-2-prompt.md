...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/volodymyr-monomakh-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/volodymyr-monomakh.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/volodymyr-monomakh.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Володимир Мономах** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ | 300 | 450 |
| Читання: Момент істини в Києві | 400 | 600 |
| Хронологія: Шлях до великого княжіння | 400 | 600 |
| Глибоке занурення: Династична криза 1093-1113 років: Шлях крізь темряву | 500 | 750 |
| Аналіз: Любецький з'їзд 1097 року: Мистецтво компромісу | 450 | 675 |
| Внутрішня політика: Великий реформатор та Законодавець | 450 | 675 |
| Культура: Культурний ренесанс епохи Мономаха | 400 | 600 |
| Глибоке занурення: «Повчання дітям»: Літературний шедевр епохи | 500 | 750 |
| Розмова: Родина Мономаха: Династія великих справ та європейські зв'язки | 400 | 600 |
| Сьогодення: Економічне життя та Побут Русі | 400 | 600 |
| Погляд: Військове мистецтво та Озброєння | 400 | 600 |
| Первинні джерела: Голоси вічності | 400 | 600 |
| Деколонізаційний погляд: Мономах — наш, а не їхній | 400 | 600 |
| Підсумкове есе | 50 | 75 |
| Оцінювання есе | 50 | 75 |
| Погляд: Потрібно більше практики? | 50 | 75 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/volodymyr-monomakh.yaml`. Go through EVERY `points:` item in EVERY section:
