...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/ukrainska-helsinska-hrupa-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/ukrainska-helsinska-hrupa.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/ukrainska-helsinska-hrupa.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Українська Гельсінська група** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Гельсінські угоди | 500 | 750 |
| Створення УГГ (1976): I — Засновники та ідея | 500 | 750 |
| Створення УГГ (1976): II — Меморандум і методи | 500 | 750 |
| Діяльність та репресії: I — Інформаційний спротив | 600 | 900 |
| Діяльність та репресії: II — Хвиля арештів | 600 | 900 |
| Діяльність та репресії: III — Табори та мартиролог | 700 | 1050 |
| Первинні джерела | 500 | 750 |
| Деколонізаційний погляд | 500 | 750 |
| Підсумок: Від УГГ до Руху | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/ukrainska-helsinska-hrupa.yaml`. Go through EVERY `points:` item in EVERY section:
