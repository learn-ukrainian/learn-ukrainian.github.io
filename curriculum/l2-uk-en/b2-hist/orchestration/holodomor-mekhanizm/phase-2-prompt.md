...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/holodomor-mekhanizm-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/holodomor-mekhanizm.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/holodomor-mekhanizm.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Голодомор I: Механізм** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Сталінська модернізація та загроза втрати України | 400 | 600 |
| Читання: Мова насильства та дегуманізація | 400 | 600 |
| Колективізація та опір селянства: I — Традиційне село і «бабські бунти» | 500 | 750 |
| Колективізація та опір селянства: II — Розкуркулення як знищення еліти | 500 | 750 |
| Закон про п'ять колосків та Чорні дошки: I — Юридичне вбивство | 500 | 750 |
| Закон про п'ять колосків та Чорні дошки: II — Режим блокади сіл | 500 | 750 |
| Терор голодом як інструмент упокорення: I — Натуральні штрафи та буксирні бригади | 500 | 750 |
| Терор голодом як інструмент упокорення: II — Ізоляція та паспортна система | 500 | 750 |
| Первинні джерела: Щоденники очевидців | 400 | 600 |
| Деколонізаційний погляд: Імперський злочин та русифікація | 400 | 600 |
| Спадщина: Трансгенераційна травма та відновлення пам'яті | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/holodomor-mekhanizm.yaml`. Go through EVERY `points:` item in EVERY section:
