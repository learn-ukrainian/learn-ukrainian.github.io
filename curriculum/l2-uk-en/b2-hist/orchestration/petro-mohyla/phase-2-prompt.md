...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/petro-mohyla-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/petro-mohyla.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/petro-mohyla.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Петро Могила: Реформатор церкви** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ | 600 | 900 |
| Шлях до митри | 550 | 825 |
| Заснування Академії | 550 | 825 |
| Реформатор церкви | 550 | 825 |
| Спадщина Могили | 550 | 825 |
| Читання | 550 | 825 |
| Первинні джерела | 550 | 825 |
| Деколонізаційний погляд | 550 | 825 |
| Потрібно більше практики? | 550 | 825 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/petro-mohyla.yaml`. Go through EVERY `points:` item in EVERY section:
