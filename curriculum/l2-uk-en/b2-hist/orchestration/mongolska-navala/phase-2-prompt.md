...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/mongolska-navala-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/mongolska-navala.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/mongolska-navala.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Монгольська навала 1240** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ | 300 | 450 |
| Читання: I — Передвісники бурі | 400 | 600 |
| Читання: II — Облога Києва | 800 | 1200 |
| Читання: III — Останній бій і руїна | 800 | 1200 |
| Читання: IV — Життя після: Ординський порядок | 800 | 1200 |
| Первинні джерела: I — Погляд зсередини та ззовні | 600 | 900 |
| Первинні джерела: II — Політичний контекст у джерелах | 500 | 750 |
| Деколонізаційний погляд: I — Розвінчання імперських міфів | 400 | 600 |
| Деколонізаційний погляд: II — Цивілізаційний вибір | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/mongolska-navala.yaml`. Go through EVERY `points:` item in EVERY section:
