...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/syntez-dvokniazivstvo-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/syntez-dvokniazivstvo.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/syntez-dvokniazivstvo.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Синтез: Від монгольської навали до кримської державності** (b2-hist track).
...
|---------|--------|---------------------|
| Огляд періоду: І — Цивілізаційний злам 1240 року | 600 | 900 |
| Огляд періоду: ІІ — Нові центри тяжіння | 600 | 900 |
| Ключові теми: І — Битва за легітимність | 700 | 1050 |
| Ключові теми: ІІ — Магдебурзьке право | 600 | 900 |
| Ключові теми: ІІІ — Народження шляхетської демократії | 600 | 900 |
| Аналіз: І — Деколонізація історичних наративів | 600 | 900 |
| Аналіз: ІІ — Тяглість боротьби та джерела | 500 | 750 |
| Хронологія | 400 | 600 |
| Завдання для есе | 200 | 300 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/syntez-dvokniazivstvo.yaml`. Go through EVERY `points:` item in EVERY section:
