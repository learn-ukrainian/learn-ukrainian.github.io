...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/hromady-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/hromady.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/hromady.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Громадівський рух** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Нелегальна культура | 500 | 750 |
| Перші громади (1860-ті): I — Центри руху | 600 | 900 |
| Перші громади (1860-ті): II — Ідеологія та символи | 600 | 900 |
| Діяльність громад: I — Просвіта та видавництво | 800 | 1200 |
| Діяльність громад: II — Науковий тріумф | 800 | 1200 |
| Первинні джерела | 500 | 750 |
| Деколонізаційний погляд | 600 | 900 |
| Підсумок: Від громад до партій | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/hromady.yaml`. Go through EVERY `points:` item in EVERY section:
