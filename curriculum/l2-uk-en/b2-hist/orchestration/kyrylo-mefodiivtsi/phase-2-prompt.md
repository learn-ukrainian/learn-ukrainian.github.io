...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/kyrylo-mefodiivtsi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/kyrylo-mefodiivtsi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/kyrylo-mefodiivtsi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Кирило-Мефодіївське братство** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Таємне товариство | 600 | 900 |
| Засновники та учасники: I — Інтелектуальне ядро | 600 | 900 |
| Засновники та учасники: II — Роль Тараса Шевченка | 600 | 900 |
| Ідеологія та програма: I — Книги буття українського народу | 600 | 900 |
| Ідеологія та програма: II — Політичний устрій та соціальна рівність | 600 | 900 |
| Первинні джерела | 800 | 1200 |
| Деколонізаційний погляд | 600 | 900 |
| Підсумок: Розгром та спадщина: I — Арешти та вироки | 500 | 750 |
| Підсумок: Розгром та спадщина: II — Історичне значення | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/kyrylo-mefodiivtsi.yaml`. Go through EVERY `points:` item in EVERY section:
