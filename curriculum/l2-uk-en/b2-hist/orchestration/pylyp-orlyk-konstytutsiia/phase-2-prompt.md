...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/pylyp-orlyk-konstytutsiia-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/pylyp-orlyk-konstytutsiia.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/pylyp-orlyk-konstytutsiia.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Пилип Орлик і перша Конституція** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: I — Шлях до гетьманства | 400 | 600 |
| Вступ: II — Бендерська рада | 400 | 600 |
| Бендерська Конституція 1710 року: I — Структура та преамбула | 500 | 750 |
| Бендерська Конституція 1710 року: II — Три гілки влади та соціальний захист | 500 | 750 |
| Демократичні ідеї: Україна vs Європа — Суспільний договір | 450 | 675 |
| Демократичні ідеї: Україна vs Європа — Механізми проти тиранії | 450 | 675 |
| Дипломатична боротьба Орлика: I — Антимосковська коаліція та похід 1711 року | 500 | 750 |
| Дипломатична боротьба Орлика: II — «Одіссея» Європою | 450 | 675 |
| Читання: Текст Конституції | 500 | 750 |
| Первинні джерела: Листи та діаріуш | 450 | 675 |
| Деколонізаційний погляд: Правова культура | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/pylyp-orlyk-konstytutsiia.yaml`. Go through EVERY `points:` item in EVERY section:
