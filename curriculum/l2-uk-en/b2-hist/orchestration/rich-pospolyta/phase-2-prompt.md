...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/rich-pospolyta-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/rich-pospolyta.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/rich-pospolyta.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Річ Посполита — полонізація та кріпацтво** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Формування Речі Посполитої та інкорпорація земель | 600 | 900 |
| Процеси асиміляції та культурного спротиву | 600 | 900 |
| Полонізація та ополячення | 600 | 900 |
| Шляхетська демократія: Свобода чи анархія? | 500 | 750 |
| Читання | 600 | 900 |
| Первинні джерела | 500 | 750 |
| Деколонізаційний погляд | 500 | 750 |
| Наслідки для козацтва | 600 | 900 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/rich-pospolyta.yaml`. Go through EVERY `points:` item in EVERY section:
