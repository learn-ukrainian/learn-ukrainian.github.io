...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/kinets-hetmanshchyny-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/kinets-hetmanshchyny.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/kinets-hetmanshchyny.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Кінець Гетьманщини** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ | 600 | 900 |
| Читання: I — Ліквідація інститутів Гетьманщини | 900 | 1350 |
| Читання: II — Трагедія Запорозької Січі | 900 | 1350 |
| Читання: III — Соціальна трансформація: від козаків до кріпаків | 900 | 1350 |
| Деколонізаційний погляд | 700 | 1050 |
| Первинні джерела | 600 | 900 |
| Підсумок | 400 | 600 |
| Потрібно більше практики? | 625 | 937 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/kinets-hetmanshchyny.yaml`. Go through EVERY `points:` item in EVERY section:
