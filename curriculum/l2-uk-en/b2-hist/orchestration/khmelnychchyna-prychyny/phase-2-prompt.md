...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/khmelnychchyna-prychyny-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/khmelnychchyna-prychyny.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/khmelnychchyna-prychyny.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Хмельниччина I: причини та початок** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: На порозі великих змін | 400 | 600 |
| Соціально-економічні причини: I — Тягар панщини та експлуатація | 500 | 750 |
| Соціально-економічні причини: II — Обмеження козацьких прав та Ординація 1638 року | 500 | 750 |
| Релігійні та національне гноблення: I — Берестейська унія та дискримінація | 450 | 675 |
| Релігійні та національне гноблення: II — Полонізація еліти та криза ідентичності | 450 | 675 |
| Політична криза Речі Посполитої: I — Король проти магнатів | 450 | 675 |
| Політична криза Речі Посполитої: II — Таємні переговори та «ілюзорний спокій» | 450 | 675 |
| Первинні джерела: I — Особиста трагедія Хмельницького (Суботів) | 500 | 750 |
| Первинні джерела: II — Від скарг до Універсалів: легітимізація повстання | 450 | 675 |
| Деколонізаційний погляд: Не бунт, а революція | 500 | 750 |
| Читання: Аналіз джерел | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/khmelnychchyna-prychyny.yaml`. Go through EVERY `points:` item in EVERY section:
