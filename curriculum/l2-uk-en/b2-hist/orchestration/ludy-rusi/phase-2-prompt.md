...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/ludy-rusi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/ludy-rusi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/ludy-rusi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Люди Русі: Суспільство та побут** (b2-hist track).
...
|---------|--------|---------------------|
| Розминка: Демографія та соціальна структура | 300 | 450 |
| Читання: I — Владна верхівка: Князь і бояри | 450 | 675 |
| Читання: II — Духовний стан і міщани | 450 | 675 |
| Читання: III — Селянство та невільні люди | 550 | 825 |
| Читання: IV — Економічний пульс: Торгівля та гроші | 400 | 600 |
| Читання: V — Жіноцтво та освіта: Міфи про «темні віки» | 450 | 675 |
| Читання: VI — Побут: Від житла до розваг | 500 | 750 |
| Первинні джерела: I — Руська Правда як дзеркало суспільства | 500 | 750 |
| Первинні джерела: II — Голоси на бересті | 450 | 675 |
| Деколонізаційний погляд: I — Матеріальна культура та автохтонність | 450 | 675 |
| Деколонізаційний погляд: II — Політична культура: Віче проти деспотії | 450 | 675 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/ludy-rusi.yaml`. Go through EVERY `points:` item in EVERY section:
