...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/yanukovych-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/yanukovych.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/yanukovych.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Епоха Януковича: Реванш** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Повернення | 400 | 600 |
| Політика режиму: I — Харківські угоди | 600 | 900 |
| Політика режиму: II — Наступ на мову та ідентичність | 600 | 900 |
| Політика режиму: III — Правосуддя як інструмент | 600 | 900 |
| «Сім'я» та корупція: I — Концентрація капіталу | 600 | 900 |
| «Сім'я» та корупція: II — Межигір'я як феномен | 500 | 750 |
| Первинні джерела: YanukovychLeaks | 500 | 750 |
| Деколонізаційний погляд: Інфільтрація | 600 | 900 |
| Підсумок: Листопад 2013 | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/yanukovych.yaml`. Go through EVERY `points:` item in EVERY section:
