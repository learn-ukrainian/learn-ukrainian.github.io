...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/kholodnyi-yar-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/kholodnyi-yar.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/kholodnyi-yar.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Холодний Яр: Останній опір** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Республіка в лісах | 600 | 900 |
| Витоки повстання | 700 | 1050 |
| Повстанська республіка: I — Організація та лідери | 700 | 1050 |
| Повстанська республіка: II — Тактика і боротьба | 700 | 1050 |
| Повстанська республіка: III — Трагічний фінал | 700 | 1050 |
| Первинні джерела | 500 | 750 |
| Деколонізаційний погляд | 500 | 750 |
| Підсумок: Пам'ять та відродження | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/kholodnyi-yar.yaml`. Go through EVERY `points:` item in EVERY section:
