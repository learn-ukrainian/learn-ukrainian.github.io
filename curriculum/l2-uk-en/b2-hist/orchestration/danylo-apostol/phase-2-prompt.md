...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/danylo-apostol-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/danylo-apostol.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/danylo-apostol.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Данило Апостол та Кирило Розумовський** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Між молотом і ковадлом | 500 | 750 |
| Читання: Епоха Данила Апостола — Відновлення гетьманства | 550 | 825 |
| Читання: Епоха Данила Апостола — Генеральне слідство | 550 | 825 |
| Економіка та суспільство: Стабільність і криза | 600 | 900 |
| Епоха Розумовського: Європейська мрія — Глухівський двір | 550 | 825 |
| Епоха Розумовського: Європейська мрія — Державотворення | 550 | 825 |
| Первинні джерела: Голоси епохи | 550 | 825 |
| Деколонізаційний погляд: Дві стратегії виживання | 600 | 900 |
| Підсумок: Захід сонця | 550 | 825 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/danylo-apostol.yaml`. Go through EVERY `points:` item in EVERY section:
