...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/bohdan-khmelnytskyi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/bohdan-khmelnytskyi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/bohdan-khmelnytskyi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Богдан Хмельницький: Постать в історії** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Батько нації чи суперечлива фігура? | 400 | 600 |
| Ранні роки: Освіта і служба | 500 | 750 |
| Особиста драма як іскра повстання | 600 | 900 |
| Геній дипломатії та війни: Перемоги 1648 року | 600 | 900 |
| Геній дипломатії та війни: Київський тріумф і Зборів | 500 | 750 |
| Будівничий держави: Внутрішній устрій | 600 | 900 |
| Будівничий держави: Зовнішня політика | 500 | 750 |
| Первинні джерела: Листи та промови | 500 | 750 |
| Деколонізаційний погляд: Лідер, а не васал | 500 | 750 |
| Читання: Історичні джерела та оцінки | 300 | 450 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/bohdan-khmelnytskyi.yaml`. Go through EVERY `points:` item in EVERY section:
