...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/bitva-pid-zhovtymy-vodamy-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/bitva-pid-zhovtymy-vodamy.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/bitva-pid-zhovtymy-vodamy.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Битва під Жовтими Водами** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Перший грім | 400 | 600 |
| Сили сторін: Давид проти Голіафа? | 700 | 1050 |
| Початок битви: Блокада табору | 700 | 1050 |
| Переломний момент: Бунт на Дніпрі | 700 | 1050 |
| Розгром: Княжі Байраки | 800 | 1200 |
| Читання: Опис битви в літописі | 400 | 600 |
| Первинні джерела: Листи про поразку | 400 | 600 |
| Деколонізаційний погляд | 450 | 675 |
| Європа у 1648 році | 450 | 675 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/bitva-pid-zhovtymy-vodamy.yaml`. Go through EVERY `points:` item in EVERY section:
