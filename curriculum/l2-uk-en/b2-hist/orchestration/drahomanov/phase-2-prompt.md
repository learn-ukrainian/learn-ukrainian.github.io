...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/drahomanov-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/drahomanov.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/drahomanov.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Михайло Драгоманов** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Голос української політичної думки | 400 | 600 |
| Біографія та становлення: Ранні роки та громадівський рух | 600 | 900 |
| Біографія та становлення: Конфлікт з імперією та еміграція | 600 | 900 |
| Політичні ідеї: Громадівство та федералізм | 700 | 1050 |
| Політичні ідеї: Етичний соціалізм та національне питання | 700 | 1050 |
| Політичні ідеї: Вплив на нове покоління | 500 | 750 |
| Первинні джерела: «Чиста справа» в листах і памфлетах | 600 | 900 |
| Первинні джерела: Діалог поколінь та європейський вибір | 500 | 750 |
| Деколонізаційний погляд | 500 | 750 |
| Підсумок: Спадщина Драгоманова | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/drahomanov.yaml`. Go through EVERY `points:` item in EVERY section:
