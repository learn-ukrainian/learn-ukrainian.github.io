...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/olha-sviatoslav-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/olha-sviatoslav.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/olha-sviatoslav.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Ольга та Святослав** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ | 300 | 450 |
| Читання: I — Помста та народження держави | 800 | 1200 |
| Читання: II — Дипломатія рівних | 500 | 750 |
| Читання: III — Святослав і ціна війни | 800 | 1200 |
| Первинні джерела | 400 | 600 |
| Деколонізаційний погляд: I — Ідентичність та гендер | 600 | 900 |
| Деколонізаційний погляд: II — Геополітика Русі | 600 | 900 |
| Деколонізаційний погляд: III — Спадщина двох шляхів | 400 | 600 |
| Потрібно більше практики?: I — Економіка та побут | 300 | 450 |
| Потрібно більше практики?: II — Спадщина та пам'ять | 300 | 450 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/olha-sviatoslav.yaml`. Go through EVERY `points:` item in EVERY section:
