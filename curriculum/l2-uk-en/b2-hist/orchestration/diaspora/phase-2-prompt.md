...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/diaspora-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/diaspora.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/diaspora.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Діаспора: Ковчег держави** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Чому українці покидали батьківщину | 400 | 600 |
| Перша хвиля (1880-1914) | 600 | 900 |
| Друга хвиля (1920-1939): Політична еміграція та Уряд УНР | 600 | 900 |
| Друга хвиля (1920-1939): Наукові та культурні інституції | 400 | 600 |
| Третя хвиля (ДіПі, 1945-1950): Феномен «переміщених осіб» та таборове життя | 600 | 900 |
| Третя хвиля (ДіПі, 1945-1950): Розселення та консолідація | 500 | 750 |
| Первинні джерела | 400 | 600 |
| Внесок діаспори: Збереження культури та історичної пам'яті | 500 | 750 |
| Внесок діаспори: Від відновлення незалежності до сучасної війни | 600 | 900 |
| Підсумок: Діаспора сьогодні | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/diaspora.yaml`. Go through EVERY `points:` item in EVERY section:
