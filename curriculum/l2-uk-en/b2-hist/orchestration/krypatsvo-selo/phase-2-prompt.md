...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/krypatsvo-selo-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/krypatsvo-selo.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/krypatsvo-selo.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Кріпацтво на Півдні** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Рабство під іншою назвою | 500 | 750 |
| Запровадження кріпацтва: I — Прелюдія неволі | 500 | 750 |
| Запровадження кріпацтва: II — Юридичний зашморг | 600 | 900 |
| Життя кріпаків: I — Тягар панщини | 700 | 1050 |
| Життя кріпаків: II — Соціальний вимір | 600 | 900 |
| Первинні джерела | 500 | 750 |
| Деколонізаційний погляд: I — Міф про цивілізацію | 500 | 750 |
| Деколонізаційний погляд: II — Реальність експлуатації | 500 | 750 |
| Підсумок: До скасування 1861 | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/krypatsvo-selo.yaml`. Go through EVERY `points:` item in EVERY section:
