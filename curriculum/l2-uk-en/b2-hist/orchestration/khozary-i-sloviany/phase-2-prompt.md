...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/khozary-i-sloviany-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/khozary-i-sloviany.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/khozary-i-sloviany.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Хозарський каганат і слов'яни** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Велетень на Сході | 600 | 900 |
| Читання: I — Політична система двовладдя | 700 | 1050 |
| Читання: II — Релігійний вибір | 700 | 1050 |
| Читання: III — Салтівська культура та економіка | 700 | 1050 |
| Первинні джерела: I — Хозарська кореспонденція | 600 | 900 |
| Первинні джерела: II — Слов'янський погляд | 600 | 900 |
| Деколонізаційний погляд: I — Міф про «хозарське ярмо» | 500 | 750 |
| Деколонізаційний погляд: II — Імперська спадщина | 500 | 750 |
| Підсумкове есе | 300 | 450 |
| Підсумок | 400 | 600 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/khozary-i-sloviany.yaml`. Go through EVERY `points:` item in EVERY section:
