...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/tsentralna-rada-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/tsentralna-rada.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/tsentralna-rada.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Центральна Рада: Від автономії до незалежності** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: I — Революційний вибух у Києві | 350 | 525 |
| Вступ: II — Створення та структура Центральної Ради | 350 | 525 |
| Чотири Універсали: I — Перший Універсал та автономія | 450 | 675 |
| Чотири Універсали: II — Компроміс Другого Універсалу | 400 | 600 |
| Чотири Універсали: III — Третій Універсал і проголошення УНР | 450 | 675 |
| Чотири Універсали: IV — Четвертий Універсал і незалежність | 500 | 750 |
| Політика та виклики: I — Соціальні реформи та земельні комітети | 400 | 600 |
| Політика та виклики: II — Війна з більшовиками та Брестський мир | 500 | 750 |
| Політика та виклики: III — Останні дні та Конституція УНР | 400 | 600 |
| Первинні джерела: Мова революції | 400 | 600 |
| Деколонізаційний погляд: Міфи та реальність | 400 | 600 |
| Підсумок: Спадщина Центральної Ради | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/tsentralna-rada.yaml`. Go through EVERY `points:` item in EVERY section:
