...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/tsentralna-rada.yaml
```

Read the current meta file for content_outline structure:

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/tsentralna-rada.yaml
```

## Your Task

Research **Центральна Рада: Від автономії до незалежності** for the **b2-hist** track. Produce structured research notes that will drive content writing in later phases.
