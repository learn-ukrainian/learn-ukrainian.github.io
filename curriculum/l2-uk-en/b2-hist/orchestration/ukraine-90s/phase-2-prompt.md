...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/ukraine-90s-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/ukraine-90s.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/ukraine-90s.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Україна 1990-х: Кучма та олігархи** (b2-hist track).
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/ukraine-90s.yaml`. Go through EVERY `points:` item in EVERY section:
