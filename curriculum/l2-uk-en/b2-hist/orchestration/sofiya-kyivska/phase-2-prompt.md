...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/sofiya-kyivska-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/sofiya-kyivska.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/sofiya-kyivska.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Софія Київська та культурний розквіт** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Архітектура собору: Візантійський канон та київська сміливість | 800 | 1200 |
| Мозаїки та фрески: Біблія у кольорі | 800 | 1200 |
| Графіті Софії: Голоси киян XI-XIII століть | 600 | 900 |
| Культурний розквіт: "Афіни Сходу" | 500 | 750 |
| Читання | 400 | 600 |
| Первинні джерела | 400 | 600 |
| Таємниця саркофага Ярослава Мудрого | 500 | 750 |
| Дзвіниця: Голос Києва | 400 | 600 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/sofiya-kyivska.yaml`. Go through EVERY `points:` item in EVERY section:
