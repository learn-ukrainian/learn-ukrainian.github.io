...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/zunr-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/zunr.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/zunr.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **ЗУНР та Акт Злуки** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Листопадовий зрив | 700 | 1050 |
| ЗУНР: Держава — I. Політичний устрій та територія | 600 | 900 |
| ЗУНР: Держава — II. Уряд, армія та реформи | 600 | 900 |
| Акт Злуки: I — Урочиста церемонія та ідеал Соборності | 700 | 1050 |
| Акт Злуки: II — Реальність війни та геополітика | 700 | 1050 |
| Первинні джерела | 600 | 900 |
| Деколонізаційний погляд | 700 | 1050 |
| Підсумок: Поразка та спадщина | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/zunr.yaml`. Go through EVERY `points:` item in EVERY section:
