...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/bucha-irpin-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/bucha-irpin.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/bucha-irpin.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Буча та Ірпінь: Злочини** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Лютий-березень 2022 — I. Контекст і географія | 400 | 600 |
| Вступ: Лютий-березень 2022 — II. Стратегічний щит Києва | 400 | 600 |
| Хроніка окупації — I. Вторгнення та виживання | 450 | 675 |
| Хроніка окупації — II. Терор і відступ | 500 | 750 |
| Виявлення злочинів — I. Світ бачить правду | 400 | 600 |
| Виявлення злочинів — II. Докази та ексгумація | 450 | 675 |
| Первинні джерела — I. Голоси свідків | 400 | 600 |
| Первинні джерела — II. Документальні докази | 400 | 600 |
| Міжнародне правосуддя — I. Роль МКС | 400 | 600 |
| Міжнародне правосуддя — II. Трибунал та історичний контекст | 400 | 600 |
| Пам'ять і спротив — I. Міста-Герої | 400 | 600 |
| Пам'ять і спротив — II. Відродження | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/bucha-irpin.yaml`. Go through EVERY `points:` item in EVERY section:
