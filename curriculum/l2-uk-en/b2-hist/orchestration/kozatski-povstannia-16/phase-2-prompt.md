...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/kozatski-povstannia-16-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/kozatski-povstannia-16.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/kozatski-povstannia-16.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Козацькі повстання XVI століття** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ | 500 | 750 |
| Повстання Криштофа Косинського (1591–1593) | 900 | 1350 |
| Повстання Северина Наливайка: Розмах і союзники | 700 | 1050 |
| Повстання Северина Наливайка: Солоницька трагедія та програма | 800 | 1200 |
| Читання: Закони проти козацтва та свідчення Жолкевського | 600 | 900 |
| Соціальний та Релігійний Вимір боротьби | 700 | 1050 |
| Первинні джерела та свідчення очевидців | 500 | 750 |
| Деколонізаційний погляд на історію повстань | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/kozatski-povstannia-16.yaml`. Go through EVERY `points:` item in EVERY section:
