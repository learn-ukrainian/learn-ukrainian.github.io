...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/aneksiia-krymu-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/aneksiia-krymu.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/aneksiia-krymu.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Анексія Криму: Початок війни** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ | 600 | 900 |
| Читання: I — Підготовка та інформаційна агресія | 800 | 1200 |
| Читання: II — Спротив та військова блокада | 800 | 1200 |
| Читання: III — Легітимізація окупації та наслідки | 1000 | 1500 |
| Первинні джерела: I — Правовий вимір та риторика | 600 | 900 |
| Первинні джерела: II — Свідчення опору та міжнародна позиція | 600 | 900 |
| Деколонізаційний погляд: Руйнування міфів | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/aneksiia-krymu.yaml`. Go through EVERY `points:` item in EVERY section:
