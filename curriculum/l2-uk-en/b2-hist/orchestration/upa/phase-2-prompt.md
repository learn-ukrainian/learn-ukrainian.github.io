...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/upa-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/upa.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/upa.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **УПА: Збройний опір** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Війна на два фронти | 600 | 900 |
| Створення та організація: Об'єднання сил | 600 | 900 |
| Створення та організація: Структура і тил | 800 | 1200 |
| Бойовий шлях: Антинімецький фронт | 700 | 1050 |
| Бойовий шлях: Волинська трагедія | 700 | 1050 |
| Бойовий шлях: Протистояння з СРСР та Польщею | 800 | 1200 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/upa.yaml`. Go through EVERY `points:` item in EVERY section:
