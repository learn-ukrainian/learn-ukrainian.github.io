...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/bratstva-i-osvita-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/bratstva-i-osvita.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/bratstva-i-osvita.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Братства та освіта: Острозька академія** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Реформація та Контрреформація | 600 | 900 |
| Феномен братств: Організація та структура | 500 | 750 |
| Феномен братств: Роль у суспільстві | 500 | 750 |
| Освітня діяльність братств: Школи нового типу | 500 | 750 |
| Освітня діяльність братств: Видавнича справа та мова | 500 | 750 |
| Острозька академія: Заснування та програма | 500 | 750 |
| Острозька академія: Спадщина та випускники | 500 | 750 |
| Читання | 500 | 750 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/bratstva-i-osvita.yaml`. Go through EVERY `points:` item in EVERY section:
