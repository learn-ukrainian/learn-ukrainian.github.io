...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/hryhorii-skovoroda-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/hryhorii-skovoroda.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/hryhorii-skovoroda.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Григорій Сковорода: Мандрівний філософ** (b2-hist track).
...
| Життєвий шлях: Від академії до дороги | 900 | 1350 |
| Філософія серця: Сродна праця | 900 | 1350 |
| Літературна спадщина: Сад божественних пісень | 700 | 1050 |
| Читання: Байки та афоризми | 800 | 1200 |
| Первинні джерела: Листи до Михайла Ковалинського | 600 | 900 |
| Деколонізаційний погляд: Не «русский философ» | 700 | 1050 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/hryhorii-skovoroda.yaml`. Go through EVERY `points:` item in EVERY section:
