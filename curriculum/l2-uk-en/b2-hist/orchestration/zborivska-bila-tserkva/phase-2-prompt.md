...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/zborivska-bila-tserkva-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/zborivska-bila-tserkva.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/zborivska-bila-tserkva.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Зборівська та Білоцерківська угоди** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Між перемогами та миром | 450 | 675 |
| Зборівський договір (1649): Перше визнання | 700 | 1050 |
| Берестечко та поворот подій | 650 | 975 |
| Білоцерківський договір (1651): Гіркий компроміс | 700 | 1050 |
| Читання: Тексти угод | 500 | 750 |
| Первинні джерела | 400 | 600 |
| Аналіз: Дипломатія як мистецтво можливого | 600 | 900 |
| Деколонізаційний погляд: Вихід з-під польського права | 600 | 900 |
| Спадщина угод та історична пам'ять | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/zborivska-bila-tserkva.yaml`. Go through EVERY `points:` item in EVERY section:
