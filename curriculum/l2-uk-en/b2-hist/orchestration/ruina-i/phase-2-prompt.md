...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/ruina-i-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/ruina-i.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/ruina-i.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Руїна I: Виговщина і розкол** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Епоха великих надій і розчарувань | 400 | 600 |
| Гетьман Іван Виговський: Курс на Європу | 700 | 1050 |
| Гадяцька унія і війна з Москвою | 700 | 1050 |
| Конотопська битва 1659: Втрачена перемога | 900 | 1350 |
| Падіння Виговського і початок хаосу | 600 | 900 |
| Чорна рада 1663: Тріумф охлократії | 900 | 1350 |
| Первинні джерела: Літопис Самовидця | 400 | 600 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/ruina-i.yaml`. Go through EVERY `points:` item in EVERY section:
