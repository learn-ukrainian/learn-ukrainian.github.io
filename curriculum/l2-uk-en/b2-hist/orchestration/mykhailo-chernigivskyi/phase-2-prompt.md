...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/mykhailo-chernigivskyi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/mykhailo-chernigivskyi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/mykhailo-chernigivskyi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Михайло Чернігівський: Опір Орді** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Читання: I — Політична боротьба і княжіння | 900 | 1350 |
| Читання: II — Виклик Орди і подорож до Батия | 900 | 1350 |
| Читання: III — Мучеництво і канонізація | 900 | 1350 |
| Первинні джерела | 800 | 1200 |
| Деколонізаційний погляд | 800 | 1200 |
| Потрібно більше практики? | 300 | 450 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/mykhailo-chernigivskyi.yaml`. Go through EVERY `points:` item in EVERY section:
