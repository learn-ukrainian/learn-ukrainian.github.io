...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/syntez-nezalezhnist-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/syntez-nezalezhnist.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/syntez-nezalezhnist.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Синтез: Незалежна Україна** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Від імперії до нації | 600 | 900 |
| Періодизація: I — Становлення держави (1991–2004) | 800 | 1200 |
| Періодизація: II — Епоха Майданів (2004–2014) | 800 | 1200 |
| Ключові теми: I — Влада і геополітика | 700 | 1050 |
| Ключові теми: II — Суспільство і ворог | 700 | 1050 |
| Первинні джерела в синтезі | 600 | 900 |
| Деколонізаційний погляд | 600 | 900 |
| Підсумок: До війни | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/syntez-nezalezhnist.yaml`. Go through EVERY `points:` item in EVERY section:
