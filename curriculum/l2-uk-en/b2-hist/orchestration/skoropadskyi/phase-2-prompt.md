...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/skoropadskyi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/skoropadskyi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/skoropadskyi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Павло Скоропадський: Гетьманат** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Консервативна альтернатива | 600 | 900 |
| Прихід до влади | 800 | 1200 |
| Політика Гетьманату: I — Консервативний курс та земельне питання | 900 | 1350 |
| Політика Гетьманату: II — Культурний прорив та падіння | 900 | 1350 |
| Первинні джерела | 600 | 900 |
| Деколонізаційний погляд | 600 | 900 |
| Підсумок: Доля Скоропадського | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/skoropadskyi.yaml`. Go through EVERY `points:` item in EVERY section:
