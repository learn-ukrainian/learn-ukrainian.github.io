...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/syntez-kozatstvo-vytoky-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/syntez-kozatstvo-vytoky.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/syntez-kozatstvo-vytoky.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Синтез: Становлення козацтва** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Козацтво як точка збірки нації | 600 | 900 |
| Огляд періоду: Хронологія та генеза | 800 | 1200 |
| Ключові теми: I — Військова революція | 700 | 1050 |
| Ключові теми: II — Віра та Воля | 700 | 1050 |
| Аналіз: I — Культурна матриця | 600 | 900 |
| Аналіз: II — Геополітика та європейський баланс | 600 | 900 |
| Читання: Узагальнюючий огляд доби | 600 | 900 |
| Первинні джерела: Голоси фундаторів | 500 | 750 |
| Деколонізаційний погляд: Козацька правда | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/syntez-kozatstvo-vytoky.yaml`. Go through EVERY `points:` item in EVERY section:
