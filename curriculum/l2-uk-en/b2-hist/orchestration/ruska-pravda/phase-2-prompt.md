...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/ruska-pravda-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/ruska-pravda.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/ruska-pravda.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Руська Правда: Перший законодавчий кодекс** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ | 300 | 450 |
| Правда Ярослава (1016–1036) | 450 | 675 |
| Правда Ярославичів та соціальна структура | 550 | 825 |
| Первинні джерела | 400 | 600 |
| Деколонізаційний погляд | 450 | 675 |
| Читання: Ярослав Мудрий — законодавець | 450 | 675 |
| Соціальні ліфти та Економіка | 450 | 675 |
| Порівняльний аналіз правових систем | 450 | 675 |
| Жінки, Суд та Мова | 450 | 675 |
| Спадщина та Сучасність | 400 | 600 |
| Повсякденне правосуддя: Казуси | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/ruska-pravda.yaml`. Go through EVERY `points:` item in EVERY section:
