        ...
        The following audit errors must be fixed for module `babyn-yar`:

        ## Audit Output (last 60 lines)

        ```
        ============================================================
  OTAMAN VERIFY: babyn-yar
============================================================
...
─── Audit output (last 15 lines) ───
  ...
  ❌ AUDIT FAILED (see curriculum/l2-uk-en/krisztiankoos/audit/babyn-yar-audit.log for details)
        ...
        - Content: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/babyn-yar.md`
