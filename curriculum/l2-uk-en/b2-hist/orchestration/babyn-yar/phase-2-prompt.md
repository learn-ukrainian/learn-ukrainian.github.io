...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/babyn-yar-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/babyn-yar.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/babyn-yar.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Бабин Яр та Голокост в Україні** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Україна напередодні трагедії — I. Контекст | 450 | 675 |
| Вступ: Україна напередодні трагедії — II. Окупація | 450 | 675 |
| Бабин Яр: 29-30 вересня 1941 — I. Хронологія | 500 | 750 |
| Бабин Яр: 29-30 вересня 1941 — II. Свідчення | 500 | 750 |
| Голокост на території України — I. Феномен «від куль» | 450 | 675 |
| Голокост на території України — II. Географія смерті | 450 | 675 |
| Первинні джерела: Документи та література | 400 | 600 |
| Праведники народів світу — I. Українські рятівники | 450 | 675 |
| Праведники народів світу — II. Місія Шептицького | 450 | 675 |
| Замовчування та пам'ять — I. Радянська політика | 450 | 675 |
| Замовчування та пам'ять — II. Сучасна меморіалізація | 450 | 675 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/babyn-yar.yaml`. Go through EVERY `points:` item in EVERY section:
