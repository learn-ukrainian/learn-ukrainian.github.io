...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/dyrektoriia-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/dyrektoriia.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/dyrektoriia.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Директорія УНР** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Падіння Гетьманату | 500 | 750 |
| Структура та лідери: I — Політичний склад | 500 | 750 |
| Структура та лідери: II — Криза влади | 500 | 750 |
| Боротьба на кілька фронтів: I — Війна з більшовиками та Акт Злуки | 600 | 900 |
| Боротьба на кілька фронтів: II — Київська катастрофа | 600 | 900 |
| Боротьба на кілька фронтів: III — Трикутник смерті та Зимовий похід | 600 | 900 |
| Первинні джерела | 600 | 900 |
| Деколонізаційний погляд: I — Міф про «петлюрівщину» | 500 | 750 |
| Деколонізаційний погляд: II — Питання погромів | 500 | 750 |
| Підсумок: Спадщина Директорії | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/dyrektoriia.yaml`. Go through EVERY `points:` item in EVERY section:
