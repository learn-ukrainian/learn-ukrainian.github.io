...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/mekhanizm-teroru-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/mekhanizm-teroru.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/mekhanizm-teroru.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Розстріляне відродження II: Механізм терору** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Система знищення | 600 | 900 |
| Механізм репресій: I — Інструменти зламу | 700 | 1050 |
| Механізм репресій: II — Фабрикація та вирок | 600 | 900 |
| Географія смерті: I — Соловки та Сандармох | 800 | 1200 |
| Географія смерті: II — Биківнянська трагедія | 700 | 1050 |
| Первинні джерела: Голоси з безодні | 500 | 750 |
| Деколонізаційний погляд: Культурний геноцид | 600 | 900 |
| Підсумок: Пам'ять та правда | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/mekhanizm-teroru.yaml`. Go through EVERY `points:` item in EVERY section:
