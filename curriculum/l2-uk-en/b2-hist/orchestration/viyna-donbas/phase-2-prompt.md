...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/viyna-donbas-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/viyna-donbas.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/viyna-donbas.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Війна на Донбасі 2014-2022** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: «Русская весна» — Початок вторгнення | 300 | 450 |
| Вступ: «Русская весна» — Окупаційні адміністрації | 300 | 450 |
| Війна 2014-2015: I — Слов'янськ та MH17 | 400 | 600 |
| Війна 2014-2015: II — Іловайська трагедія | 600 | 900 |
| Війна 2014-2015: III — Оборона Донецького аеропорту | 600 | 900 |
| Війна 2014-2015: IV — Битва за Дебальцеве | 400 | 600 |
| Мінські угоди: I — Дипломатія під тиском | 400 | 600 |
| Мінські угоди: II — «Заморожений конфлікт» | 400 | 600 |
| Первинні джерела: Голоси війни | 500 | 750 |
| Деколонізаційний погляд: Природа конфлікту | 500 | 750 |
| Підсумок: Напередодні повномасштабного вторгнення | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/viyna-donbas.yaml`. Go through EVERY `points:` item in EVERY section:
