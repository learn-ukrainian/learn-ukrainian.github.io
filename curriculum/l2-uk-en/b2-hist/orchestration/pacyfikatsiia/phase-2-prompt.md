...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/pacyfikatsiia-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/pacyfikatsiia.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/pacyfikatsiia.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Пацифікація: Поляки в Галичині** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: «Мирне» насильство | 400 | 600 |
| Причини та контекст: I — Українці в Другій Речі Посполитій | 600 | 900 |
| Причини та контекст: II — Саботажна акція ОУН | 600 | 900 |
| Хід пацифікації: I — Військова операція та насильство | 700 | 1050 |
| Хід пацифікації: II — Культурний та економічний погром | 700 | 1050 |
| Первинні джерела: I — Голоси жертв | 500 | 750 |
| Первинні джерела: II — Офіційна реакція та світ | 500 | 750 |
| Деколонізаційний погляд | 600 | 900 |
| Підсумок: Наслідки | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/pacyfikatsiia.yaml`. Go through EVERY `points:` item in EVERY section:
