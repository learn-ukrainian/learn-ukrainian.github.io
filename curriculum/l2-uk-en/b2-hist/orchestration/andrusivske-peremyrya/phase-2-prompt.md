...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/andrusivske-peremyrya-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/andrusivske-peremyrya.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/andrusivske-peremyrya.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Андрусівське перемир'я: Поділ України** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Ніч дипломатії в Андрусові | 500 | 750 |
| Архітектор поділу: Афанасій Ордин-Нащокін | 500 | 750 |
| Умови договору: Геополітична ампутація — Кордони і Київ | 600 | 900 |
| Умови договору: Статус Запорожжя і термінологія | 500 | 750 |
| Реакція України: Політичний шок | 600 | 900 |
| Реакція України: Крах промосковської політики | 500 | 750 |
| Соціальні наслідки: Економіка та міграція | 600 | 900 |
| Соціальні наслідки: Релігійний розкол | 400 | 600 |
| Чому світ промовчав? | 500 | 750 |
| Деколонізаційний погляд: Спростування міфів | 800 | 1200 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/andrusivske-peremyrya.yaml`. Go through EVERY `points:` item in EVERY section:
