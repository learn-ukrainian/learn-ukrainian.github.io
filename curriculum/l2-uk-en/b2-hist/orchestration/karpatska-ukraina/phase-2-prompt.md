...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/karpatska-ukraina-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/karpatska-ukraina.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/karpatska-ukraina.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Карпатська Україна 1938-1939** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Один день незалежності | 400 | 600 |
| Передісторія та автономія: І — Втрачені надії | 600 | 900 |
| Передісторія та автономія: ІІ — Уряд Волошина | 600 | 900 |
| Незалежність та оборона: І — Проголошення | 600 | 900 |
| Незалежність та оборона: ІІ — Карпатська Січ | 600 | 900 |
| Незалежність та оборона: ІІІ — Початок агресії | 400 | 600 |
| Незалежність та оборона: IV — Бій на Красному полі | 600 | 900 |
| Первинні джерела | 400 | 600 |
| Деколонізаційний погляд | 400 | 600 |
| Підсумок: Спадщина та пам'ять | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/karpatska-ukraina.yaml`. Go through EVERY `points:` item in EVERY section:
