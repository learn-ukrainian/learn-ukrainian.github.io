...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/petro-kalnyshevskyi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/petro-kalnyshevskyi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/petro-kalnyshevskyi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Петро Калнишевський: Останній кошовий** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Трагічна велич останнього отамана та епоха великих надій | 400 | 600 |
| Шлях до булави: Від козака до стратега вільної республіки | 500 | 750 |
| Чорна рада 1775 року: Кінець Війська Запорозького та тріумф підступності | 600 | 900 |
| Соловецька в'язниця: Чверть століття у темряві та холоді Білого моря | 500 | 750 |
| Духовна медицина Соловків: Як вижити у пеклі та зберегти душу | 500 | 750 |
| Деколонізаційний погляд: Калнишевський проти імперського міфу забуття | 500 | 750 |
| Спадщина та канонізація: Повернення святого отамана додому | 400 | 600 |
| Читання: Останнє слово отамана та голос вічності крізь століття | 600 | 900 |
| Первинні джерела: Свідчення незламності та трагедії вільного Війська | 500 | 750 |
| Підсумок: Вічний отаман нашої пам'яті | 300 | 450 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/petro-kalnyshevskyi.yaml`. Go through EVERY `points:` item in EVERY section:
