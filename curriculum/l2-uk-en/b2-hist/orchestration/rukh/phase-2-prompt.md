...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/rukh-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/rukh.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/rukh.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Рух: Народний рух України** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Перебудова в Україні — I — Епоха гласності та екологічний імпульс | 500 | 750 |
| Вступ: Перебудова в Україні — II — Від культурного до політичного | 500 | 750 |
| Створення Руху (1989): I — Установчий з'їзд та атмосфера ейфорії | 600 | 900 |
| Створення Руху (1989): II — Лідери, поети та програма | 600 | 900 |
| Діяльність Руху (1989-1991): I — Живий ланцюг і перші перемоги | 700 | 1050 |
| Діяльність Руху (1989-1991): II — Від Декларації до Незалежності | 700 | 1050 |
| Первинні джерела | 500 | 750 |
| Деколонізаційний погляд | 500 | 750 |
| Підсумок: Спадщина Руху | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/rukh.yaml`. Go through EVERY `points:` item in EVERY section:
