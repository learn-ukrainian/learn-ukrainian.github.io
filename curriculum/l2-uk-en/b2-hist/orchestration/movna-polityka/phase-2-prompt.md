...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/movna-polityka-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/movna-polityka.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/movna-polityka.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Мовна політика незалежної України** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Мова як поле битви — Історичний спадок | 450 | 675 |
| Вступ: Мова як поле битви — Маркер ідентичності | 450 | 675 |
| Мовна політика 1991-2012 — Конституційний статус | 500 | 750 |
| Мовна політика 1991-2012 — Соціальна реальність | 550 | 825 |
| Закон Колесніченка-Ківалова та його наслідки — Реванш і протест | 600 | 900 |
| Закон Колесніченка-Ківалова та його наслідки — Шлях до закону 2019 року | 600 | 900 |
| Первинні джерела — Еволюція законодавства та соціологія | 500 | 750 |
| Деколонізаційний погляд — Спростування імперських міфів | 500 | 750 |
| Деколонізаційний погляд — Мова як інструмент безпеки | 450 | 675 |
| Підсумок: Після 2022 року — Війна та мовна стійкість | 500 | 750 |
| Підсумок: Після 2022 року — Незворотність змін | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/movna-polityka.yaml`. Go through EVERY `points:` item in EVERY section:
