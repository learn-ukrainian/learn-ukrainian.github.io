...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/surgunlik-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/surgunlik.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/surgunlik.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Sürgünlik: Депортації кримських татар та інших народів** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Радянська політика депортацій | 500 | 750 |
| Сургунлік: I — Механізм злочину | 900 | 1350 |
| Сургунлік: II — Життя у вигнанні | 1100 | 1650 |
| Інші жертви: I — Греки та болгари | 600 | 900 |
| Інші жертви: II — Німці України | 500 | 750 |
| Первинні джерела | 400 | 600 |
| Деколонізаційний погляд | 500 | 750 |
| Підсумок: Пам'ять та боротьба | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/surgunlik.yaml`. Go through EVERY `points:` item in EVERY section:
