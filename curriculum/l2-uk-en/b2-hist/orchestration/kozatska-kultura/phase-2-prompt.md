...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/kozatska-kultura-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/kozatska-kultura.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/kozatska-kultura.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Козацька культура — кобзарі, думи та бароко** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ та Контекст | 350 | 525 |
| Кобзарі та лірники: голос народу — Цехова організація | 450 | 675 |
| Кобзарі та лірники: голос народу — Таємна мова та місія | 450 | 675 |
| Українські Думи: Духовний хребет нації — Жанр і виконання | 450 | 675 |
| Українські Думи: Духовний хребет нації — Теми та значення | 450 | 675 |
| Козацьке бароко: Тріумф національного стилю — Архітектура | 500 | 750 |
| Козацьке бароко: Тріумф національного стилю — Впливи | 400 | 600 |
| Мистецтво: Феномен козацького бароко — Портрет і графіка | 500 | 750 |
| Меценатство як державна стратегія | 500 | 750 |
| Інтелектуальний центр: Києво-Могилянська академія — Фундація | 450 | 675 |
| Інтелектуальний центр: Києво-Могилянська академія — Система і випускники | 450 | 675 |
| Первинні джерела та Читання | 250 | 375 |
| Деколонізаційний погляд | 350 | 525 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/kozatska-kultura.yaml`. Go through EVERY `points:` item in EVERY section:
