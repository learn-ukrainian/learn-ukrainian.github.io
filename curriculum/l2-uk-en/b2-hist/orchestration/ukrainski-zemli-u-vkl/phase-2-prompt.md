...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/ukrainski-zemli-u-vkl-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/ukrainski-zemli-u-vkl.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/ukrainski-zemli-u-vkl.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Українські землі у ВКЛ** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Читання: I — Київське князівство: Останній відблиск Русі | 700 | 1050 |
| Читання: II — Волинь: Колиска руської аристократії | 700 | 1050 |
| Читання: III — Магнатські роди: «Королев'ята» і нова еліта | 700 | 1050 |
| Первинні джерела | 600 | 900 |
| Деколонізаційний погляд | 600 | 900 |
| Критерії оцінювання | 200 | 300 |
| Зразок відповіді | 400 | 600 |
| Підсумок — Напередодні Люблінської унії | 500 | 750 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/ukrainski-zemli-u-vkl.yaml`. Go through EVERY `points:` item in EVERY section:
