...
> **Persona reminder:** You are Professor of Ukrainian Arts (history). Write in the voice of The Decolonial Lecturer: Senior Professor of History. Maintain this persona throughout — do not drift into generic AI tone.

> **Your #1 job: Write 754 words for the section "Історія відкриття".**
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/trypillian-civilization-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/trypillian-civilization.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/trypillian-civilization.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the section prose for **Історія відкриття** within the module **Трипільська цивілізація**.

- **WORD BUDGET**: 754 words minimum, 754 × 2 maximum. Stay in this range.
...
- ### Голос із минулого: Звіт Вікентія Хвойки
  → Але як ми про це дізналися? Історія повернення цієї цивілізації із забуття починається не з гучних теорій, а з уважного...
- ### Мальована кераміка: Технологічний код
  → У звітах Хвойки часто фігурує термін «мальована кераміка». Це поняття стало візитівкою **Трипільської культури** (Trypil...
- ### Лексика відкриттів: Археологічний словник
  → Читаючи тексти про відкриття Трипілля, ми стикаємося зі специфічною лексикою. Розуміння цих термінів є ключем до декодув...
- ### Спіраль як світогляд: Читання орнаменту
  → Але повернімося до тексту орнаментів. Трипільський посуд — це не просто кухонне начиння, це зашифрована книга буття. Най...
- ### Від черепка до цивілізації: Зміна парадигми
  → Відкриття Хвойки стало інтелектуальним вибухом. До того моменту історія Європи писалася з погляду класичних імперій: Рим...
---
...
Previously used callout types in this module: biography, context
...
- Target: 754 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Історія відкриття": {count} words (budget: 754-754×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Історія відкриття)
