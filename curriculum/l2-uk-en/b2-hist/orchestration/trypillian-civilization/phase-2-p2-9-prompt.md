...
> **Your #1 job: Write 619 words for the section "Деколонізаційний погляд".**
...
Write the section prose for **Деколонізаційний погляд** within the module **Трипільська цивілізація**.

- **WORD BUDGET**: 619 words minimum, 619 × 2 maximum. Stay in this range.
...
- ### Культ Великої Богині-Матері
  → У центрі духовного життя стояла фігура жінки. Археологи знайшли тисячі глиняних **статуеток** (figurines), які зображуют...
- ### Символіка життя: Змія та Бик
  → Трипільський орнамент — це не просто декор, а зашифрована мова символів. Два ключові образи, що постійно повторюються, —...
- ### Соціальна загадка: Егалітарне суспільство
  → Найбільшою таємницею трипільців залишається їхній соціальний устрій. У той час як у Шумері чи Єгипті царі будували велич...
- ### Сакральний простір житла
  → Для трипільця його дім був моделлю Всесвіту. Житло ділилося на зони: «чисту» (сакральну) з вівтарем та «господарську». П...
---
...
- Target: 619 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Деколонізаційний погляд": {count} words (budget: 619-619×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Деколонізаційний погляд)
