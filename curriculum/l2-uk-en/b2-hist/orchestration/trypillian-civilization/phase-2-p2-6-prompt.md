...
> **Your #1 job: Write 961 words for the section "Господарство та економіка".**
...
Write the section prose for **Господарство та економіка** within the module **Трипільська цивілізація**.

- **WORD BUDGET**: 961 words minimum, 961 × 2 maximum. Stay in this range.
...
- ### Феномен гігантизму: Більше за Шумер
  → Імперська та згодом радянська історіографія довго опиралися вживанню слова «місто» щодо поселень на території України, в...
- ### Урбаністика: Геометрія космосу
  → Трипільські протоміста не росли хаотично, як середньовічні європейські міста. Вони будувалися за **єдиним генеральним пл...
- ### Архітектура: Життя у глині
  → Трипільська архітектура — це тріумф екологічного будівництва. Тривалий час вважалося, що це були примітивні землянки (ще...
- ### Загадка «горизонту спалених хат»
  → Найбільшою таємницею Трипілля залишається так званий «горизонт спалених хат». Археологи помітили дивну закономірність: к...
---
...
Previously used callout types in this module: biography, context, decolonization, history-bite, myth-buster
...
- Target: 961 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Господарство та економіка": {count} words (budget: 961-961×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Господарство та економіка)
