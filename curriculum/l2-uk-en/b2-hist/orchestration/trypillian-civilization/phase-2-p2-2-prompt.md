...
> **Your #1 job: Write 733 words for the section "Читання".**
...
Write the section prose for **Читання** within the module **Трипільська цивілізація**.
...
- ### Феномен Кукутені-Трипілля
  → **Трипільська цивілізація** (або культурна спільнота Кукутені-Трипілля) — це унікальне явище в історії давньої Європи, я...
- ### Географія цивілізації
  → Простір Трипілля охоплював величезну територію від передгір'їв Карпат на заході до річки Дніпро на сході. Сьогодні ці зе...
- ### Протоміста і піраміди
  → Унікальність Трипілля полягає в тому, що це була **аграрна цивілізація**, яка створила гігантські поселення — протоміста...
- ### Автохтонний розвиток
  → Головна теза, яку ми маємо засвоїти: Трипільська цивілізація — це результат **автохтонного** (місцевого) розвитку, а не...
---
...
Previously used callout types in this module: context
...
```
===WORD_COUNTS===
Section "Читання": {count} words (budget: 733-733×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Читання)
