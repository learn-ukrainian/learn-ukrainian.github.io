...
> **Your #1 job: Write 1204 words for the section "Потрібно більше практики?".**
...
Write the section prose for **Потрібно більше практики?** within the module **Трипільська цивілізація**.

- **WORD BUDGET**: 1204 words minimum, 1204 × 2 maximum. Stay in this range.
...
- ### Імперський страх перед словом «цивілізація»
  → Радянська історична наука (і російська імперська до неї) працювала за чіткою схемою: історія України не могла бути самод...
- ### Боротьба за статус: Протоміста проти «селищ»
  → Ключовим полем битви стала урбаністика. Імперські історики відмовлялися визнавати трипільські поселення містами, аргумен...
- ### Міф про чужинців та автохтонний синтез
  → Ще один поширений імперський наратив: «Усе хороше в Україну прийшло ззовні». Трипільців намагалися представити виключно...
- ### Трипільський спадок у ментальності
  → Найважливіший аспект деколонізації — це повернення собі спадку. Ми не є прямими генетичними копіями трипільців (народи з...
---
...
Previously used callout types in this module: biography, context, decolonization, fact, history-bite, myth-buster, observe, quote, warning
...
- Target: 1204 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Потрібно більше практики?": {count} words (budget: 1204-1204×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Потрібно більше практики?)
