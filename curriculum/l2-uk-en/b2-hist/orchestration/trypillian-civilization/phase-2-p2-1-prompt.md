...
> **Your #1 job: Write 733 words for the section "Вступ".**
...
Write the section prose for **Вступ** within the module **Трипільська цивілізація**.

- **WORD BUDGET**: 733 words minimum, 733 × 2 maximum. Stay in this range.
...
- Target: 733 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Вступ": {count} words (budget: 733-733×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Вступ)
