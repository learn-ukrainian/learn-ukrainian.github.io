...
> **Your #1 job: Write 873 words for the section "Духовний світ та суспільний устрій".**
...
Write the section prose for **Духовний світ та суспільний устрій** within the module **Трипільська цивілізація**.

- **WORD BUDGET**: 873 words minimum, 873 × 2 maximum. Stay in this range.
...
- ### Керамічний феномен
  → Трипільську цивілізацію часто називають «культурою мальованої кераміки» (**painted pottery culture**), і це не перебільш...
- ### Інженерія без гончарного кола
  → Найбільше дивує сучасну людину той факт, що трипільці не знали **гончарного кола** (potter's wheel). Усі ці ідеально сим...
- ### Код предків: Триколірний світ
  → Але форма була лише полотном. Головний зміст трипільської кераміки — у її розписі. Трипільці використовували три сакраль...
- ### Високі технології: Гончарні горни
  → Якість кераміки напряму залежить від температури випалу. Багаття дає максимум 600–700 градусів, причому нерівномірно. Тр...
- ### Загадка «біноклів»
  → Серед тисяч горщиків є категорія виробів, яка ставить у глухий кут дослідників уже понад століття. Це так звані **«бінок...
- ### Мідний світанок
  → Хоча ми називаємо цей час енеолітом (мідно-кам'яним віком), метал був для трипільців радше дорогоцінністю, ніж робочим м...
---
...
Previously used callout types in this module: biography, context, decolonization, fact, history-bite, myth-buster, observe
...
- Target: 873 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Духовний світ та суспільний устрій": {count} words (budget: 873-873×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Духовний світ та суспільний устрій)
