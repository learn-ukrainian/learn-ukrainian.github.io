...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/sichovi-striltsi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/sichovi-striltsi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/sichovi-striltsi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Українські січові стрільці** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Патріоти, воїни, просвітники | 500 | 750 |
| Створення легіону: І — Від «Пласту» до війська | 450 | 675 |
| Створення легіону: ІІ — Символи та присяга | 450 | 675 |
| Бойовий шлях: І — Карпатська зима та Маківка | 700 | 1050 |
| Бойовий шлях: ІІ — Лисоня та народження УГА | 700 | 1050 |
| Первинні джерела: І — Спогади та пісні | 500 | 750 |
| Первинні джерела: ІІ — Пресова кватира | 500 | 750 |
| Деколонізаційний погляд: Місія на Сході | 600 | 900 |
| Підсумок: Культурна спадщина | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/sichovi-striltsi.yaml`. Go through EVERY `points:` item in EVERY section:
