...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/rosiiska-imperiia-ukraina-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/rosiiska-imperiia-ukraina.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/rosiiska-imperiia-ukraina.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Південь України: Колонізація та міфи** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: "Дике поле" чи Великий Луг? | 400 | 600 |
| Козацький Південь: Зимівники, паланки та слободи | 500 | 750 |
| Міф про "Новоросію": Анатомія імперської брехні | 500 | 750 |
| Етнічна палітра: Південь як плавильний казан чи мозаїка? | 450 | 675 |
| Містобудування та архітектура Півдня: Європейський фасад українського степу | 400 | 600 |
| Вплив українського хліба на економіку Російської імперії | 400 | 600 |
| Культура та освіта Півдня: Університети та театри | 400 | 600 |
| Наслідки колонізації для української ідентичності | 400 | 600 |
| Деколонізаційний погляд: Повернення імен | 450 | 675 |
| Читання: Український голос у степовому вітрі | 400 | 600 |
| Первинні джерела: Сліди, які не стерти | 400 | 600 |
| Підсумок: Південь — це українське море | 300 | 450 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/rosiiska-imperiia-ukraina.yaml`. Go through EVERY `points:` item in EVERY section:
