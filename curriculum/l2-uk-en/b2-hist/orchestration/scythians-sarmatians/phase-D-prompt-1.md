...
2. For EVERY Ukrainian sentence you plan to cite, run:
   ```bash
   grep -c "first 5-6 words of the sentence" /Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/scythians-sarmatians.md
   ```
...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/scythians-sarmatians.md`
...
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/scythians-sarmatians.yaml`
5. **Meta** (build config): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/scythians-sarmatians.yaml`
