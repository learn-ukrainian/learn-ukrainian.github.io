...
The prefix "Читання:" is a language-textbook convention. In a B2-HIST seminar module narrated in the voice of a university professor, it is register-breaking and out of place. Green Team flagged it; was not applied.
...
===FIX_START===
FILE: curriculum/l2-uk-en/b2-hist/activities/scythians-sarmatians.yaml
---OLD---
...
===FIX_START===
FILE: curriculum/l2-uk-en/b2-hist/scythians-sarmatians.md
---OLD---
