...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/syntez-lytva-polska-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/syntez-lytva-polska.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/syntez-lytva-polska.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Синтез: Литовсько-польська доба** (b2-hist track).
...
| Читання | 400 | 600 |
| Хронологія: Литовсько-польська доба — Частина І: Литовська доба (1340–1569) | 450 | 675 |
| Хронологія: Литовсько-польська доба — Частина ІІ: Річ Посполита (1569–1648) | 450 | 675 |
| Огляд термінів: Литовсько-польська доба — Політична та соціальна структура | 450 | 675 |
| Огляд термінів: Литовсько-польська доба — Релігія та економіка | 450 | 675 |
| Зв'язок із сьогоденням | 500 | 750 |
| Підсумок | 250 | 375 |
| Модулі цієї епохи | 250 | 375 |
| Що далі? | 250 | 375 |
| Потрібно більше практики? | 250 | 375 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/syntez-lytva-polska.yaml`. Go through EVERY `points:` item in EVERY section:
