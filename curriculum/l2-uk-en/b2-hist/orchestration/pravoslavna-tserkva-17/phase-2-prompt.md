...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/pravoslavna-tserkva-17-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/pravoslavna-tserkva-17.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/pravoslavna-tserkva-17.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Православна церква XVII століття** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Боротьба за віру та ідентичність | 400 | 600 |
| Відновлення ієрархії: I — Братства і меч Сагайдачного | 700 | 1050 |
| Відновлення ієрархії: II — Таємна місія патріарха Теофана | 700 | 1050 |
| Легалізація: I — Шлях до визнання | 600 | 900 |
| Легалізація: II — Пункти заспокоєння | 600 | 900 |
| Читання: Голоси епохи | 700 | 1050 |
| Первинні джерела: Протестація та аргументи | 600 | 900 |
| Деколонізаційний погляд: Міфи та реальність | 500 | 750 |
| Підсумок | 200 | 300 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/pravoslavna-tserkva-17.yaml`. Go through EVERY `points:` item in EVERY section:
