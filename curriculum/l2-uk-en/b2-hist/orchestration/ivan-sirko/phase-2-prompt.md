...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/ivan-sirko-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/ivan-sirko.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/ivan-sirko.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Іван Сірко: Легендарний кошовий** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: «Характерник» української історії | 600 | 900 |
| Ранні роки та становлення: Від невідомості до легенди | 700 | 1050 |
| На чолі Січі: Походи та політичне лавірування | 800 | 1200 |
| Особистість отамана: Побут, етика та віра | 700 | 1050 |
| Первинні джерела: Епістолярна спадщина та літописи | 700 | 1050 |
| Деколонізаційний погляд: Сірко як державник | 800 | 1200 |
| Останні роки та спадщина: Життя після смерті | 700 | 1050 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/ivan-sirko.yaml`. Go through EVERY `points:` item in EVERY section:
