...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/nova-serbiya-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/nova-serbiya.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/nova-serbiya.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Нова Сербія та Слов'яносербія** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Чужинці на українській землі | 600 | 900 |
| Створення військових поселень: I — Нова Сербія | 550 | 825 |
| Створення військових поселень: II — Слов'яносербія | 550 | 825 |
| Життя в колоніях: I — Військовий устрій та побут | 550 | 825 |
| Життя в колоніях: II — Конфлікти та асиміляція | 550 | 825 |
| Життя в колоніях: III — Адміністративний крах | 450 | 675 |
| Первинні джерела: I — Закон імперії | 350 | 525 |
| Первинні джерела: II — Опір землі | 350 | 525 |
| Деколонізаційний погляд | 600 | 900 |
| Підсумок: Наслідки для Півдня | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/nova-serbiya.yaml`. Go through EVERY `points:` item in EVERY section:
