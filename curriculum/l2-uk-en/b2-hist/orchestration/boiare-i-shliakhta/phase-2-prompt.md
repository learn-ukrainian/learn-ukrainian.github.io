...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/boiare-i-shliakhta-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/boiare-i-shliakhta.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/boiare-i-shliakhta.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Бояри та шляхта: Соціальна еліта** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Читання: I — Генеза еліти: Галицька олігархія та правове оформлення станів | 1000 | 1500 |
| Читання: II — Золота доба: «Золота вольність» і влада магнатів | 1000 | 1500 |
| Читання: III — Ціна могутності: Фільваркове господарство та виклик полонізації | 1000 | 1500 |
| Первинні джерела | 600 | 900 |
| Деколонізаційний погляд | 600 | 900 |
| Підсумок — Еліта вільної України | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/boiare-i-shliakhta.yaml`. Go through EVERY `points:` item in EVERY section:
