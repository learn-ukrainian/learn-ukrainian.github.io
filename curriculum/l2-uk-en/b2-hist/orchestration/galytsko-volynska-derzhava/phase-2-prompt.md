...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/galytsko-volynska-derzhava-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/galytsko-volynska-derzhava.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/galytsko-volynska-derzhava.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Галицько-Волинська держава: Розквіт** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ — Друга Русь на заході | 400 | 600 |
| Основні події | 500 | 750 |
| Роман Мстиславич — об'єднувач земель: І — Шлях до влади | 600 | 900 |
| Роман Мстиславич — об'єднувач земель: ІІ — Самодержець та його кінець | 600 | 900 |
| Золота доба Романовичів: І — Дуумвірат і перемога | 600 | 900 |
| Золота доба Романовичів: ІІ — Корона і міста | 600 | 900 |
| Культура і мистецтво | 500 | 750 |
| Первинні джерела — Слово о полку Ігоревім | 400 | 600 |
| Деколонізаційний погляд — Забута держава | 500 | 750 |
| Підсумок — Спадщина для нащадків | 300 | 450 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/galytsko-volynska-derzhava.yaml`. Go through EVERY `points:` item in EVERY section:
