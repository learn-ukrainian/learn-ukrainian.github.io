...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/zasnuvannia-kyieva-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/zasnuvannia-kyieva.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/zasnuvannia-kyieva.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Заснування Києва** (b2-hist track).
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/zasnuvannia-kyieva.yaml`. Go through EVERY `points:` item in EVERY section:
