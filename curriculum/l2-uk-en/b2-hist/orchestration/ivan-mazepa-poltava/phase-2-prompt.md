...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/ivan-mazepa-poltava-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/ivan-mazepa-poltava.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/ivan-mazepa-poltava.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Іван Мазепа III: Полтава і вигнання** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Читання: I — Таємна дипломатія | 500 | 750 |
| Читання: II — Розрив з Москвою | 500 | 750 |
| Батуринська трагедія: Ціна спротиву | 600 | 900 |
| Полтавська битва: I — Напередодні | 400 | 600 |
| Полтавська битва: II — Фатальний день | 500 | 750 |
| Полтавська битва: III — Переволочна | 300 | 450 |
| Вигнання, Смерть і Початок нової боротьби | 500 | 750 |
| Мазепа в культурі: Між прокляттям і романтизмом | 400 | 600 |
| Первинні джерела | 400 | 600 |
| Деколонізаційний погляд: Руйнування імперських міфів | 500 | 750 |
| Підсумок | 300 | 450 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/ivan-mazepa-poltava.yaml`. Go through EVERY `points:` item in EVERY section:
