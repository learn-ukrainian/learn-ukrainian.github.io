...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/syntez-revoliutsiia-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/syntez-revoliutsiia.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/syntez-revoliutsiia.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Синтез: Українська революція** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Втрачена незалежність | 400 | 600 |
| Етапи революції: I — Центральна Рада та Гетьманат | 800 | 1200 |
| Етапи революції: II — Директорія та ЗУНР | 800 | 1200 |
| Причини поразки: I — Внутрішні чвари та соціальний хаос | 700 | 1050 |
| Причини поразки: II — Зовнішня агресія та військовий фактори | 700 | 1050 |
| Первинні джерела в синтезі | 600 | 900 |
| Деколонізаційний погляд | 600 | 900 |
| Підсумок: Спадщина | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/syntez-revoliutsiia.yaml`. Go through EVERY `points:` item in EVERY section:
