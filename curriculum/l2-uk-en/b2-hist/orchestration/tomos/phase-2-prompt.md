...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/tomos-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/tomos.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/tomos.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Томос: Духовна незалежність** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Церква та держава — Концепція незалежності | 350 | 525 |
| Вступ: Церква та держава — Історичне коріння (1686-1991) | 400 | 600 |
| Історія українського православ'я: I — Київська митрополія та анексія | 500 | 750 |
| Історія українського православ'я: II — Розкол та політична боротьба (1991-2018) | 500 | 750 |
| Здобуття Томосу: I — Шлях до Собору | 450 | 675 |
| Здобуття Томосу: II — Об'єднавчий собор та обрання Предстоятеля | 500 | 750 |
| Здобуття Томосу: III — Вручення та міжнародна реакція | 450 | 675 |
| Первинні джерела | 600 | 900 |
| Деколонізаційний погляд | 500 | 750 |
| Підсумок: Після Томосу — Перехід парафій та війна | 400 | 600 |
| Підсумок: Після Томосу — Нова ідентичність та календар | 350 | 525 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/tomos.yaml`. Go through EVERY `points:` item in EVERY section:
