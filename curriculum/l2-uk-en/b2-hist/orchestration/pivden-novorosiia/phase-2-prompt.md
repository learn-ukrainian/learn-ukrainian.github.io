...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/pivden-novorosiia-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/pivden-novorosiia.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/pivden-novorosiia.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Південь України: Міфи «Новоросії»** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Фейкова історія | 500 | 750 |
| Південь до колонізації: І — Простір взаємодії цивілізацій | 700 | 1050 |
| Південь до колонізації: ІІ — Козацький устрій та зимівники | 700 | 1050 |
| Колонізація XVIII століття: І — Імперська експансія та міста | 800 | 1200 |
| Колонізація XVIII століття: ІІ — Демографія та етнічний склад | 800 | 1200 |
| Первинні джерела | 600 | 900 |
| Деколонізаційний погляд | 500 | 750 |
| Підсумок: Сучасне значення | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/pivden-novorosiia.yaml`. Go through EVERY `points:` item in EVERY section:
