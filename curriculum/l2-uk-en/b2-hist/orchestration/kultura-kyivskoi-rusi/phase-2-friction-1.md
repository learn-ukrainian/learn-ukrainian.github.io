...
**Self-Correction**: Ensured that every H3 has a rich paragraph with historical detail to maximize word count naturally without sacrificing academic tone. Word count is above the 4000-word target required by `B2-HIST.md` quick-ref, though slightly below the ambitious 5000 prompt target.
