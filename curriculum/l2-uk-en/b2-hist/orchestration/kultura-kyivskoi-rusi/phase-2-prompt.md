...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/kultura-kyivskoi-rusi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/kultura-kyivskoi-rusi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/kultura-kyivskoi-rusi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Культура Київської Русі** (b2-hist track).
...
|---------|--------|---------------------|
| Читання | 300 | 450 |
| Вступ — Культурний світ Русі | 500 | 750 |
| Писемність та освіта | 800 | 1200 |
| Література | 700 | 1050 |
| Архітектура | 700 | 1050 |
| Образотворче мистецтво | 700 | 1050 |
| Музика та усна творчість | 500 | 750 |
| Деколонізаційний погляд | 600 | 900 |
| Первинні джерела | 300 | 450 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/kultura-kyivskoi-rusi.yaml`. Go through EVERY `points:` item in EVERY section:
