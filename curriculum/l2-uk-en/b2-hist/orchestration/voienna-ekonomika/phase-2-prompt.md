...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/voienna-ekonomika-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/voienna-ekonomika.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/voienna-ekonomika.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Воєнна економіка України** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Економіка на війні | 700 | 1050 |
| Виклики та руйнування: Втрата територій та промисловості | 600 | 900 |
| Виклики та руйнування: Енергетичний терор та логістика | 600 | 900 |
| Адаптація та мобілізація: Релокація бізнесу та ОПК | 700 | 1050 |
| Адаптація та мобілізація: Феномен волонтерської економіки | 600 | 900 |
| Адаптація та мобілізація: Зерновий коридор та міжнародна допомога | 600 | 900 |
| Первинні джерела | 500 | 750 |
| Деколонізаційний погляд | 600 | 900 |
| Підсумок: Відбудова майбутнього | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/voienna-ekonomika.yaml`. Go through EVERY `points:` item in EVERY section:
