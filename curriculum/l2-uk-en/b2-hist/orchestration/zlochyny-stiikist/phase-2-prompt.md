...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/zlochyny-stiikist-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/zlochyny-stiikist.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/zlochyny-stiikist.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Злочини і стійкість** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Злочин та відплата | 500 | 750 |
| Воєнні злочини: I — Буча та Маріуполь | 800 | 1200 |
| Воєнні злочини: II — Системний терор | 700 | 1050 |
| Стійкість: I — Енергетичний фронт | 600 | 900 |
| Стійкість: II — Суспільна мобілізація | 600 | 900 |
| Первинні джерела | 600 | 900 |
| Деколонізаційний погляд | 600 | 900 |
| Підсумок: Звільнення | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/zlochyny-stiikist.yaml`. Go through EVERY `points:` item in EVERY section:
