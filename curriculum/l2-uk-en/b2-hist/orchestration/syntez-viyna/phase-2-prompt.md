...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/syntez-viyna-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/syntez-viyna.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/syntez-viyna.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Синтез: Війна за існування** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Війна за майбутнє | 400 | 600 |
| Етапи війни: I — Гібридна агресія (2014–2022) | 600 | 900 |
| Етапи війни: II — Повномасштабне протистояння | 600 | 900 |
| Причини та мотиви: I — Ідеологія «рашизму» | 500 | 750 |
| Причини та мотиви: II — Геополітика страху | 500 | 750 |
| Чинники спротиву: I — Ідентичність та Армія | 600 | 900 |
| Чинники спротиву: II — Суспільство та Світ | 600 | 900 |
| Деколонізаційний погляд: I — Природа війни | 500 | 750 |
| Деколонізаційний погляд: II — Геноцидна практика | 500 | 750 |
| Підсумок: Глобальне значення | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/syntez-viyna.yaml`. Go through EVERY `points:` item in EVERY section:
