...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/hrushevskyi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/hrushevskyi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/hrushevskyi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Михайло Грушевський** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Людина-епоха | 850 | 1275 |
| Біографія та наукова кар'єра | 850 | 1275 |
| Політична діяльність | 850 | 1275 |
| Первинні джерела | 850 | 1275 |
| Деколонізаційний погляд | 850 | 1275 |
| Підсумок: Незнищенна спадщина | 850 | 1275 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/hrushevskyi.yaml`. Go through EVERY `points:` item in EVERY section:
