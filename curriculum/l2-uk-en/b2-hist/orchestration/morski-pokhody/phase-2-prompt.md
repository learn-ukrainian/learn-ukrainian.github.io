...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/morski-pokhody-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/morski-pokhody.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/morski-pokhody.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Морські походи козаків** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Чорне море як арена боротьби | 400 | 600 |
| Козацька Чайка: Шедевр суднобудування | 800 | 1200 |
| Стратегія та Тактика: Раптовість та зухвалість | 800 | 1200 |
| Героїчна доба: Походи Петра Сагайдачного — I: Реформа війська | 600 | 900 |
| Героїчна доба: Походи Петра Сагайдачного — II: Спалення Синопа та Кафи | 800 | 1200 |
| Героїчна доба: Походи Петра Сагайдачного — III: Хотинський тріумф | 400 | 600 |
| Життя на морі: Побут та випробування | 400 | 600 |
| Читання: Свідчення про козацький десант | 600 | 900 |
| Первинні джерела: Листи та хроніки | 400 | 600 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/morski-pokhody.yaml`. Go through EVERY `points:` item in EVERY section:
