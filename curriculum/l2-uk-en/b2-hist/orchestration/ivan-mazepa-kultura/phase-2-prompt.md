...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/ivan-mazepa-kultura-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/ivan-mazepa-kultura.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/ivan-mazepa-kultura.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Іван Мазепа II: освіта і культура** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Золота доба українського духу | 400 | 600 |
| Києво-Могилянська академія: Афіни на Дніпрі | 700 | 1050 |
| Мазепинське бароко: Архітектура національної величі | 900 | 1350 |
| Література і друк: Мазепинське слово як національна зброя | 500 | 750 |
| Мистецтво гравюри та символіка влади | 400 | 600 |
| Українська барокова музика та хоровий спів | 300 | 450 |
| Театральне мистецтво та шкільна драма | 300 | 450 |
| Первинні джерела: Свідчення величі та щедрості | 400 | 600 |
| Деколонізаційний погляд: Відновлення правди про мецената | 600 | 900 |
| Підсумок | 200 | 300 |
| Читання | 300 | 450 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/ivan-mazepa-kultura.yaml`. Go through EVERY `points:` item in EVERY section:
