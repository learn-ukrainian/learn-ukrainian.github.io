...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/pavlo-polubotok-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/pavlo-polubotok.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/pavlo-polubotok.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Павло Полуботок: Останній наказний** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Тінь великого Петра | 500 | 750 |
| Читання: Конфлікт із Вельяміновим | 800 | 1200 |
| Первинні джерела: Промова перед Петром | 600 | 900 |
| В'язниця і смерть: Мучеництво за право | 700 | 1050 |
| Господарник-олігарх: Економічна база незалежності | 800 | 1200 |
| Легенда про скарби: Міф і реальність | 700 | 1050 |
| Деколонізаційний погляд: Руйнування імперських міфів | 600 | 900 |
| Підсумок | 300 | 450 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/pavlo-polubotok.yaml`. Go through EVERY `points:` item in EVERY section:
