...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/druha-svitova-pochatok-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/druha-svitova-pochatok.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/druha-svitova-pochatok.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Друга світова: Початок** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Напередодні катастрофи | 600 | 900 |
| Радянська окупація: Вторгнення та міфи | 700 | 1050 |
| Радянська окупація: Терор і депортації | 800 | 1200 |
| Початок німецько-радянської війни | 700 | 1050 |
| Трагедія в'язниць та зміна окупантів | 700 | 1050 |
| Первинні джерела | 600 | 900 |
| Деколонізаційний погляд | 500 | 750 |
| Підсумок: Початок апокаліпсису | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/druha-svitova-pochatok.yaml`. Go through EVERY `points:` item in EVERY section:
