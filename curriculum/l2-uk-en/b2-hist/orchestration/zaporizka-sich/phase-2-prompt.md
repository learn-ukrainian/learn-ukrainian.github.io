...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/zaporizka-sich-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/zaporizka-sich.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/zaporizka-sich.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Запорозька Січ — козацька республіка** (b2-hist track).
...
|---------|--------|---------------------|
| Контекст: Географія та Дике Поле | 400 | 600 |
| Контекст: Соціальні передумови появи козацтва | 400 | 600 |
| Острів Хортиця — серце козацтва: Замок Байди Вишневецького | 400 | 600 |
| Острів Хортиця — серце козацтва: Побут та військове мистецтво | 500 | 750 |
| Читання: Козацькі літописи як джерело | 300 | 450 |
| Демократичний устрій Січі: Пряма демократія та Козацька Рада | 450 | 675 |
| Демократичний устрій Січі: Судочинство і звичаєве право | 350 | 525 |
| Вплив на європейську політику: Участь у Тридцятилітній війні | 350 | 525 |
| Вплив на європейську політику: Битва під Хотином та Віднем | 400 | 600 |
| Первинні джерела: Гійом де Боплан про Україну | 450 | 675 |
| Первинні джерела: Козацькі клейноди та символіка | 300 | 450 |
| Первинні джерела: Дипломатія та Лист султану | 300 | 450 |
| Деколонізаційний погляд: Спростування імперських міфів | 400 | 600 |
| Деколонізаційний погляд: Сучасна спадщина у ЗСУ | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/zaporizka-sich.yaml`. Go through EVERY `points:` item in EVERY section:
