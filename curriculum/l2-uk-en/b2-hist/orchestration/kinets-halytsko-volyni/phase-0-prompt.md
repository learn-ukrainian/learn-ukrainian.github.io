...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/kinets-halytsko-volyni.yaml
```

Read the current meta file for content_outline structure:

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/kinets-halytsko-volyni.yaml
```

## Your Task

Research **Занепад Галицько-Волинської держави** for the **b2-hist** track. Produce structured research notes that will drive content writing in later phases.
