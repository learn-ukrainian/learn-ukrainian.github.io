...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/kinets-halytsko-volyni-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/kinets-halytsko-volyni.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/kinets-halytsko-volyni.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Занепад Галицько-Волинської держави** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Читання: I — Останні з роду Романовичів | 900 | 1350 |
| Читання: II — Юрій ІІ Болеслав: Князь-західник | 1000 | 1500 |
| Читання: III — Трагедія 1340 року та війна за спадщину | 1100 | 1650 |
| Первинні джерела | 600 | 900 |
| Деколонізаційний погляд | 600 | 900 |
| Підсумок — Уроки державності | 400 | 600 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/kinets-halytsko-volyni.yaml`. Go through EVERY `points:` item in EVERY section:
