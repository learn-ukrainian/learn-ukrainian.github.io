...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/liublinska-uniia-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/liublinska-uniia.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/liublinska-uniia.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Люблінська унія 1569: Народження Речі Посполитої** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Шлях до унії: I — Криза та зовнішні загрози | 500 | 750 |
| Шлях до унії: II — Позиції сторін та «Волинський фактор» | 500 | 750 |
| Люблінський сейм 1569 року: I — Початок та демарш Литви | 500 | 750 |
| Люблінський сейм 1569 року: II — Жорстка відповідь короля та повернення українців | 600 | 900 |
| Нова карта Європи: I — Адміністративні зміни та нові воєводства | 500 | 750 |
| Нова карта Європи: II — Політичні наслідки та права шляхти | 500 | 750 |
| Читання: I — Правовий дуалізм і мовне питання | 500 | 750 |
| Читання: II — Релігія та економіка | 500 | 750 |
| Первинні джерела | 400 | 600 |
| Деколонізаційний погляд | 400 | 600 |
| Підсумок | 200 | 300 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/liublinska-uniia.yaml`. Go through EVERY `points:` item in EVERY section:
