...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/pomarancheva-revoliutsiia-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/pomarancheva-revoliutsiia.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/pomarancheva-revoliutsiia.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Помаранчева революція** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: I — Вибори та кандидати | 500 | 750 |
| Вступ: II — Отруєння та політичний трилер | 500 | 750 |
| Медіа: I — Цензура та «5 канал» | 500 | 750 |
| Медіа: II — Інтернет та самоорганізація | 450 | 675 |
| Майдан: I — Символи та атмосфера | 500 | 750 |
| Майдан: II — Ненасильницький спротив | 500 | 750 |
| Суд: I — Юридична битва | 500 | 750 |
| Суд: II — Рішення та перемога | 500 | 750 |
| Деколонізаційний погляд: Цивілізаційний вибір | 500 | 750 |
| Первинні джерела: Голоси епохи | 300 | 450 |
| Підсумок: Спадщина та уроки | 300 | 450 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/pomarancheva-revoliutsiia.yaml`. Go through EVERY `points:` item in EVERY section:
