...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/pereyaslavska-uhoda-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/pereyaslavska-uhoda.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/pereyaslavska-uhoda.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Переяславська угода 1654: Міфи та реальність** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ | 350 | 525 |
| Дипломатична гра: Спроби знайти союзника | 550 | 825 |
| Переяславська рада: Зіткнення політичних світів | 700 | 1050 |
| Березневі статті: Суверенітет під прицілом | 800 | 1200 |
| Глас вопіющого: Опозиція та незгодні | 600 | 900 |
| Віленська зрада та пошук нової стратегії | 600 | 900 |
| Читання: Аналіз історичних документів | 600 | 900 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/pereyaslavska-uhoda.yaml`. Go through EVERY `points:` item in EVERY section:
