...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/bukovyna-zakarpattia-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/bukovyna-zakarpattia.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/bukovyna-zakarpattia.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Буковина та Закарпаття під сусідами** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ | 350 | 525 |
| Буковина: I — Від Молдавії до Габсбургів | 500 | 750 |
| Буковина: II — «Золота доба» та Чернівці | 500 | 750 |
| Повсякденне життя: Мульткультурний Вавилон | 550 | 825 |
| Закарпаття: I — Під угорською короною | 550 | 825 |
| Закарпаття: II — Релігія як щит | 550 | 825 |
| Культурний опір та збереження ідентичності: I — Збройна боротьба | 550 | 825 |
| Культурний опір та збереження ідентичності: II — Інтелектуальне пробудження | 500 | 750 |
| Читання: Свідчення епохи | 400 | 600 |
| Первинні джерела: Голоси історії | 350 | 525 |
| Деколонізаційний погляд | 450 | 675 |
| Потрібно більше практики? | 416 | 624 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/bukovyna-zakarpattia.yaml`. Go through EVERY `points:` item in EVERY section:
