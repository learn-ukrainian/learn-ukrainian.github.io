...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/krymske-khanstvo-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/krymske-khanstvo.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/krymske-khanstvo.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Кримське ханство: Золотоординська спадщина** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Читання: I — Народження держави Ґераїв | 600 | 900 |
| Читання: II — Владний устрій та еліти | 600 | 900 |
| Читання: III — Ясир і економіка війни | 500 | 750 |
| Економіка: Сади, сіль та каравани | 600 | 900 |
| Первинні джерела: I — Погляд Боплана | 400 | 600 |
| Первинні джерела: II — Розкіш Бахчисарая | 400 | 600 |
| Деколонізаційний погляд: I — Військові союзи | 500 | 750 |
| Деколонізаційний погляд: II — Культурний симбіоз | 400 | 600 |
| Підсумок — Спадщина для сучасності: I — Імперська травма | 500 | 750 |
| Підсумок — Спадщина для сучасності: II — Відродження | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/krymske-khanstvo.yaml`. Go through EVERY `points:` item in EVERY section:
