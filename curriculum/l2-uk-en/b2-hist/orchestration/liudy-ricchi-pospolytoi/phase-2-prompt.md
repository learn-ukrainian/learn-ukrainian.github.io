...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/liudy-ricchi-pospolytoi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/liudy-ricchi-pospolytoi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/liudy-ricchi-pospolytoi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Люди Речі Посполитої: Суспільство** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Шляхта і магнати: I — Привілеї та «золота вольність» | 550 | 825 |
| Шляхта і магнати: II — Руські роди та полонізація | 550 | 825 |
| Міщани і ремісники: I — Магдебурзьке право та самоврядування | 500 | 750 |
| Міщани і ремісники: II — Національно-релігійне життя міста | 500 | 750 |
| Селяни і кріпацтво: I — Фільваркова система та панщина | 550 | 825 |
| Селяни і кріпацтво: II — Юридичне закріпачення та спротив | 550 | 825 |
| Первинні джерела | 450 | 675 |
| Деколонізаційний погляд: I — Міф про «золотий вік» | 500 | 750 |
| Деколонізаційний погляд: II — Спадщина та сучасна дискусія | 450 | 675 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/liudy-ricchi-pospolytoi.yaml`. Go through EVERY `points:` item in EVERY section:
