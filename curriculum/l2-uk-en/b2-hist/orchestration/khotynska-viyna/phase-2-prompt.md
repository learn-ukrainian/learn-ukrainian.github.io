...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/khotynska-viyna-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/khotynska-viyna.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/khotynska-viyna.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Хотинська війна 1621: Козацький щит Європи** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Напередодні бурі | 400 | 600 |
| Мобілізація сил: Асиметрія загрози | 500 | 750 |
| Козацький чинник: Рада в Сухій Діброві | 500 | 750 |
| Тактика: Інженерне диво козацького табору | 500 | 750 |
| Бойові дії: Вогняний вал і нічні рейди | 500 | 750 |
| Читання: Свідчення очевидця (Яків Собеський) | 500 | 750 |
| Герої та Жертви: Останній бій Сагайдачного | 400 | 600 |
| Злам імперії: Психологічна перемога | 400 | 600 |
| Геополітичні наслідки: Вкрадена перемога | 500 | 750 |
| Первинні джерела: Голос епохи | 400 | 600 |
| Деколонізаційний погляд: Суб'єктність Гетьманщини | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/khotynska-viyna.yaml`. Go through EVERY `points:` item in EVERY section:
