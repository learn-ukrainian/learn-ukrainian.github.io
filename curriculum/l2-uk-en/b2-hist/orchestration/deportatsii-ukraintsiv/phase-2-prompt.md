...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/deportatsii-ukraintsiv-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/deportatsii-ukraintsiv.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/deportatsii-ukraintsiv.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Депортації українців 1944-1951** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Післявоєнні переселення | 400 | 600 |
| Депортації до СРСР (1944-1946): I — Етапи та методи | 600 | 900 |
| Депортації до СРСР (1944-1946): II — Нове життя та втрати | 600 | 900 |
| Операція «Вісла» (1947): I — Привід та початок | 650 | 975 |
| Операція «Вісла» (1947): II — Асиміляція та репресії | 650 | 975 |
| Первинні джерела | 600 | 900 |
| Деколонізаційний погляд: I — Міфи та реальність | 500 | 750 |
| Деколонізаційний погляд: II — Історичні паралелі | 500 | 750 |
| Підсумок: Спадщина травми | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/deportatsii-ukraintsiv.yaml`. Go through EVERY `points:` item in EVERY section:
