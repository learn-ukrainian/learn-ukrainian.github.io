...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/kniazivski-usobiytsi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/kniazivski-usobiytsi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/kniazivski-usobiytsi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Княжі усобиці та роздроблення** (b2-hist track).
...
|---------|--------|---------------------|
| Розминка | 300 | 450 |
| Читання: Тріумвірат Ярославичів | 600 | 900 |
| Любецький з'їзд (1097) | 700 | 1050 |
| Володимир Мономах | 800 | 1200 |
| Соціальна структура та Економіка | 700 | 1050 |
| Культура та Церква | 600 | 900 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/kniazivski-usobiytsi.yaml`. Go through EVERY `points:` item in EVERY section:
