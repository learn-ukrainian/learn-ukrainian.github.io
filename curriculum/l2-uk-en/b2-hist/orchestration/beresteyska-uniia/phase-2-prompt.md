...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/beresteyska-uniia-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/beresteyska-uniia.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/beresteyska-uniia.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Берестейська унія: Церковний розкол** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ | 800 | 1200 |
| Передумови унії та криза православ'я | 700 | 1050 |
| Берестейський собор 1596 року та створення УГКЦ | 700 | 1050 |
| Соціально-політичні наслідки та релігійна боротьба | 700 | 1050 |
| Читання | 700 | 1050 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/beresteyska-uniia.yaml`. Go through EVERY `points:` item in EVERY section:
