...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/revoliutsiia-hidnosti-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/revoliutsiia-hidnosti.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/revoliutsiia-hidnosti.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Революція Гідності: Євромайдан** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Чому «Гідність»? | 600 | 900 |
| Хронологія подій: І — Від мирного протесту до ескалації | 700 | 1050 |
| Хронологія подій: ІІ — Диктаторські закони та Вогнехреща | 700 | 1050 |
| Хронологія подій: ІІІ — Кривавий лютий та повалення режиму | 800 | 1200 |
| Небесна Сотня | 600 | 900 |
| Первинні джерела | 500 | 750 |
| Деколонізаційний погляд | 600 | 900 |
| Підсумок: Наслідки революції | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/revoliutsiia-hidnosti.yaml`. Go through EVERY `points:` item in EVERY section:
