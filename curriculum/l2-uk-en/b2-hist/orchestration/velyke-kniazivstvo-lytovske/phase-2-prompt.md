...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/velyke-kniazivstvo-lytovske-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/velyke-kniazivstvo-lytovske.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/velyke-kniazivstvo-lytovske.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Велике князівство Литовське — Руська держава** (b2-hist track).
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/velyke-kniazivstvo-lytovske.yaml`. Go through EVERY `points:` item in EVERY section:
