...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/syntez-imperska-doba-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/syntez-imperska-doba.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/syntez-imperska-doba.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Синтез: Імперська доба** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Два імперії | 700 | 1050 |
| Механізми панування: I — Мовний та культурний лінгвоцид | 700 | 1050 |
| Механізми панування: II — Економічна експлуатація та соціальний устрій | 700 | 1050 |
| Форми спротиву: I — Культурницький етап і Громади | 700 | 1050 |
| Форми спротиву: II — Галицький П'ємонт та політизація | 700 | 1050 |
| Первинні джерела в синтезі | 600 | 900 |
| Деколонізаційний погляд | 500 | 750 |
| Підсумок: До революції | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/syntez-imperska-doba.yaml`. Go through EVERY `points:` item in EVERY section:
