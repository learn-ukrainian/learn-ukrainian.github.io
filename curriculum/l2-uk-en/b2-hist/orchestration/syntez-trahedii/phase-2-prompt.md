...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/research/syntez-trahedii-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/syntez-trahedii.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-hist/syntez-trahedii.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Синтез: Трагедії XX століття** (b2-hist track).
...
|---------|--------|---------------------|
| Вступ: Століття травми — Демографічна катастрофа | 500 | 750 |
| Вступ: Століття травми — Психологія втрат | 400 | 600 |
| Зв'язки між трагедіями: Від Розстріляного відродження до Голодомору | 600 | 900 |
| Зв'язки між трагедіями: Друга світова та повоєнний терор | 600 | 900 |
| Механізми виживання: Культурний та збройний спротив | 500 | 750 |
| Механізми виживання: Дисидентство та подвійна свідомість | 500 | 750 |
| Первинні джерела в синтезі | 600 | 900 |
| Деколонізаційний погляд: Руйнування радянських міфів | 400 | 600 |
| Деколонізаційний погляд: Повернення суб'єктності | 400 | 600 |
| Підсумок: Уроки для сьогодення | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-hist/meta/syntez-trahedii.yaml`. Go through EVERY `points:` item in EVERY section:
