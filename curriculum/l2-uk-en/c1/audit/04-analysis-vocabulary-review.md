...
|---|---|---|---|
| **Intro/Narrative** | ✅ | 135 | Included in Core |
| **Презентація: Мистецтво наукового сумніву** | ⚪️ | 813 | Skipped |
| **Академічне письмо: Побудова аргументації** | ⚪️ | 205 | Skipped |
| **Порівняльний аналіз абстрактів** | ✅ | 331 | Included in Core |
| **Типові помилки в аналітичних текстах** | ✅ | 157 | Included in Core |
| **Чек-лист: Чи готовий ваш аналіз?** | ✅ | 150 | Included in Core |
