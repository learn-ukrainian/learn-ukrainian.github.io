...
| **Біографічний контекст: Полтавський інтелектуал та гуманіст** | ✅ | 308 | Included in Core |
| **Текст** | ✅ | 289 | Included in Core |
| **Літературний аналіз: Світ «Енеїди» як етнографічний та політичний феномен** | ✅ | 481 | Included in Core |
| **Порівняльний аналіз: Вергілій vs Котляревський** | ✅ | 209 | Included in Core |
| **Критичне есе** | ⚪️ | 411 | Skipped |
