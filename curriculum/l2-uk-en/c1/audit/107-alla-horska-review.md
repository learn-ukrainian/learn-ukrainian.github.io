# Audit Report: 107-alla-horska.md
...
- **[COMPLEXITY_WORD_COUNT]** quiz 'Розуміння біографії' Q5 prompt length 9 (target: 12-30)
  - FIX: Adjust prompt length to 12-30 words.
- **[COMPLEXITY_WORD_COUNT]** quiz 'Критичне мислення' Q1 prompt length 10 (target: 12-30)
  - FIX: Adjust prompt length to 12-30 words.
- **[COMPLEXITY_WORD_COUNT]** quiz 'Критичне мислення' Q2 prompt length 10 (target: 12-30)
  - FIX: Adjust prompt length to 12-30 words.
- **[COMPLEXITY_WORD_COUNT]** quiz 'Критичне мислення' Q3 prompt length 10 (target: 12-30)
  - FIX: Adjust prompt length to 12-30 words.
- **[COMPLEXITY_WORD_COUNT]** quiz 'Критичне мислення' Q5 prompt length 11 (target: 12-30)
  - FIX: Adjust prompt length to 12-30 words.
