# Audit Report: 40-knyazhna-anna-yaroslavna.md
...
- **[YAML_SCHEMA_VIOLATION]** Schema error in 40-knyazhna-anna-yaroslavna.yaml: YAML parse error: mapping values are not allowed here
  in "curriculum/l2-uk-en/c1/activities/40-knyazhna-anna-yaroslavna.yaml", line 540, column 72
...
| **Вступ** | ⚪️ | 153 | Skipped |
| **Біографія** | ⚪️ | 1120 | Skipped |
| **Історичний контекст** | ✅ | 251 | Included in Core |
| **Порівняльний аналіз** | ✅ | 149 | Included in Core |
| **Критичне мислення** | ⚪️ | 97 | Skipped |
