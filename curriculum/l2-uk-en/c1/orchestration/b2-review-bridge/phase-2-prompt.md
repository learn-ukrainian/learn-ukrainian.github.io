...
> **Persona reminder:** You are Senior Ukrainian Language & Culture Specialist. Write in the voice of Senior Specialist. Maintain this persona throughout — do not drift into generic AI tone.
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1/research/b2-review-bridge-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1/meta/b2-review-bridge.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1/b2-review-bridge.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
| `/Users/krisztiankoos/projects/learn-ukrainian/claude_extensions/quick-ref/C1.md` | Level constraints, immersion %, engagement minimums |

Read ALL four files before writing anything.

## Your Task

Write the full lesson prose for **Огляд B2 та міст до C1** (c1 track).
...
|---------|--------|---------------------|
| Вступ — Від B2 до C1 | 400 | 600 |
| Пасивний стан — повна система | 700 | 1050 |
| Дієприкметники — активні та пасивні | 700 | 1050 |
| Складнопідрядні речення | 600 | 900 |
| П'ять функціональних стилів | 800 | 1200 |
| Фразеологія в контексті | 500 | 750 |
| Підсумок і шлях уперед | 300 | 450 |
| **Total** | **4000** | **6000** |
