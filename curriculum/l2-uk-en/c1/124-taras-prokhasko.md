# Тарас Прохасько: Філософія буття і «непрості»
...
1. **Створення унікального стилю:** Розробив мову «ботанічного екзистенціалізму», яка не має аналогів.
...
> [!myth-buster] **Деколонізація: Провінція — це не периферія**
>
...
> [!reflection] **Мистецтво маленьких кроків**
>
...
> [!resources]
> - **Книга:** Тарас Прохасько. «Непрості» — головний роман.
> - **Книга:** «Так, але...» — збірка есеїв.
> - **Інтерв'ю:** [Розмови з Тарасом Прохаськом](https://www.youtube.com/results?search_query=Тарас+Прохасько) — відеоматеріали.
