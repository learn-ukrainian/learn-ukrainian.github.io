# Катерина Калитко: Поезія тілесності та війни
...
> [!cultural] **Intermezzo: Фестиваль короткої прози**
>
> Фестиваль «Intermezzo» у Вінниці став унікальним явищем. Він названий на честь новели Михайла Коцюбинського і присвячений малим літературним формам. Калитко, як кураторка, перетворила провінційне місто на центр європейського інтелектуального життя, запрошуючи авторів з усієї Європи. Це приклад того, як одна людина може змінити культурний ландшафт цілого регіону.
...
> [!myth-buster] **Деколонізація: «Жіноча поезія» — це не про квіти**
>
...
> [!myth-buster] **Деколонізація: Ми не жертви, ми — ті, хто вижив**
>
...
> [!resources]
> - **Книга:** Катерина Калитко. «Земля Загублених».
> - **Книга:** «Орден мовчальниць».
> - **Відео:** [Виступи Катерини Калитко](https://www.youtube.com/results?search_query=Катерина+Калитко) — читання поезії.
