...
version: '2.0'
title: Drahomanov Shevchenko
subtitle: Drahomanov Shevchenko
content_outline:
...
phase: LIT Expansion
objectives:
- Проаналізувати творчість Drahomanov Shevchenko у контексті української літератури
- Дослідити вплив автора на формування національної ідентичності
persona:
  voice: Senior Specialist
  role: Federalist Socialist
word_target: 5000
