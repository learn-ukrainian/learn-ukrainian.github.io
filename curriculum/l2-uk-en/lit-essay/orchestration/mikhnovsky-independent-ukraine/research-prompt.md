...
version: '2.0'
title: Mikhnovsky Independent Ukraine
subtitle: Mikhnovsky Independent Ukraine
content_outline:
...
phase: LIT Expansion
objectives:
- Проаналізувати творчість Mikhnovsky Independent Ukraine у контексті української
  літератури
- Дослідити вплив автора на формування національної ідентичності
persona:
  voice: Senior Specialist
  role: Independence Radical
word_target: 5000
...
```yaml
subject: "Mikhnovsky Independent Ukraine"
