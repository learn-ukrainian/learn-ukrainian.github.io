...
version: '2.0'
title: Hrytsak History Ukraine
subtitle: Hrytsak History Ukraine
content_outline:
...
phase: LIT Expansion
objectives:
- Проаналізувати творчість Hrytsak History Ukraine у контексті української літератури
...
```yaml
subject: "Hrytsak History Ukraine"
