...
version: '2.0'
title: Sherekh Fifth Kharkiv
subtitle: Sherekh Fifth Kharkiv
content_outline:
...
phase: LIT Expansion
objectives:
- Проаналізувати творчість Sherekh Fifth Kharkiv у контексті української літератури
- Дослідити вплив автора на формування національної ідентичності
persona:
  voice: Senior Specialist
  role: Urban Intellectual
word_target: 5000
...
Research **Sherekh Fifth Kharkiv** for the **lit-essay** track. Produce structured research notes that will drive content writing in Phase B.
