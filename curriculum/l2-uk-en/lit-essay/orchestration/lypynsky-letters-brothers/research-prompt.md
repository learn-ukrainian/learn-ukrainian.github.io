...
version: '2.0'
title: Lypynsky Letters Brothers
subtitle: Lypynsky Letters Brothers
content_outline:
...
phase: LIT Expansion
objectives:
- Проаналізувати творчість Lypynsky Letters Brothers у контексті української літератури
- Дослідити вплив автора на формування національної ідентичності
persona:
  voice: Senior Specialist
  role: Conservative Theorist
word_target: 5000
...
Research **Lypynsky Letters Brothers** for the **lit-essay** track. Produce structured research notes that will drive content writing in Phase B.
...
- `query_wikipedia(query="Lypynsky Letters Brothers", mode="extract")` — factual backbone
- `search_literary(query="Lypynsky Letters Brothers")` — primary source excerpts
