...
version: '2.0'
title: Grabowicz Myth Shevchenko
subtitle: Grabowicz Myth Shevchenko
content_outline:
...
phase: LIT Expansion
objectives:
- Проаналізувати творчість Grabowicz Myth Shevchenko у контексті української літератури
...
Research **Grabowicz Myth Shevchenko** for the **lit-essay** track. Produce structured research notes that will drive content writing in Phase B.
...
```yaml
subject: "Grabowicz Myth Shevchenko"
