...
version: '2.0'
title: Yefremov Literary Criticism
subtitle: Yefremov Literary Criticism
content_outline:
...
phase: LIT Expansion
objectives:
- Проаналізувати літературну критику Єфремова у контексті канонізації
- Дослідити вплив автора на формування національної ідентичності
persona:
  voice: Senior Specialist
  role: Literary Critic Under Sentence
word_target: 5000
...
Research **Yefremov Literary Criticism** for the **lit-essay** track. Produce structured research notes that will drive content writing in Phase B.
