...
version: '2.0'
title: Chyzhevsky Baroque History
subtitle: Chyzhevsky Baroque History
content_outline:
...
phase: LIT Expansion
objectives:
- Проаналізувати творчість Chyzhevsky Baroque History у контексті української літератури
- Дослідити вплив автора на формування національної ідентичності
persona:
  voice: Senior Specialist
  role: Baroque Scholar
word_target: 5000
...
Research **Chyzhevsky Baroque History** for the **lit-essay** track. Produce structured research notes that will drive content writing in Phase B.
...
```yaml
subject: "Chyzhevsky Baroque History"
