...
version: '2.0'
title: Zabuzhko Notre Dame
subtitle: Zabuzhko Notre Dame
content_outline:
...
phase: LIT Expansion
objectives:
- Проаналізувати творчість Zabuzhko Notre Dame у контексті української літератури
- Дослідити вплив автора на формування національної ідентичності
persona:
  voice: Senior Specialist
  role: Cultural Exorcist
word_target: 5000
...
Research **Zabuzhko Notre Dame** for the **lit-essay** track. Produce structured research notes that will drive content writing in Phase B.
