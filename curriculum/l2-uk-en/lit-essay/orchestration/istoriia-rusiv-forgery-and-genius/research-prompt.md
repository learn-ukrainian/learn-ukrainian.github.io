...
version: '2.0'
title: Istoriia Rusiv Forgery And Genius
subtitle: Istoriia Rusiv Forgery And Genius
content_outline:
...
phase: LIT Expansion
objectives:
- Проаналізувати творчість Istoriia Rusiv Forgery And Genius у контексті української літератури
- Дослідити вплив автора на формування національної ідентичності
persona:
  voice: Senior Specialist
  role: Phantom Chronicler
word_target: 5000
...
Research **Istoriia Rusiv Forgery And Genius** for the **lit-essay** track. Produce structured research notes that will drive content writing in Phase B.
...
```yaml
subject: "Istoriia Rusiv Forgery And Genius"
