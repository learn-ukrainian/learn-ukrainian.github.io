...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/leonid-kadenyuk-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/leonid-kadenyuk.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/leonid-kadenyuk.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Леонід Каденюк: Перший космонавт незалежної України** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Український прапор у космосі | 400 | 600 |
| Юність та мрія про небо (1951-1971) | 600 | 900 |
| Підготовка космонавта: I — Радянський гарт (1971-1991) | 800 | 1200 |
| Підготовка космонавта: II — Шлях до зірок незалежної України (1991-1996) | 800 | 1200 |
| Політ на «Колумбії»: I — Місія STS-87 та життя на орбіті | 900 | 1350 |
| Політ на «Колумбії»: II — Наукова вахта «зоряного гречкосія» | 900 | 1350 |
| Після польоту (1997-2018) | 400 | 600 |
| Спадщина — Зірка України | 200 | 300 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/leonid-kadenyuk.yaml`. Go through EVERY `points:` item in EVERY section:
