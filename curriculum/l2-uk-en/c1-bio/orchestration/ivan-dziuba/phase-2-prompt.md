...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/ivan-dziuba-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/ivan-dziuba.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/ivan-dziuba.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Іван Дзюба: Інтернаціоналізм чи русифікація?** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Інтелектуальний бунтар | 500 | 750 |
| Донеччина та формування (1931-1957) | 600 | 900 |
| Шістдесятники: Коло опору (1957-1965) | 800 | 1200 |
| «Інтернаціоналізм чи русифікація?»: Анатомія тексту | 700 | 1050 |
| «Інтернаціоналізм чи русифікація?»: Глобальний резонанс | 600 | 900 |
| Від в'язниці до міністерства: Драма вибору (1972-1991) | 900 | 1350 |
| Спадщина: Архітектор незалежної культури (1991-2022) | 900 | 1350 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/ivan-dziuba.yaml`. Go through EVERY `points:` item in EVERY section:
