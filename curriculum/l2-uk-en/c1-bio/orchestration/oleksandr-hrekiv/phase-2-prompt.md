...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/oleksandr-hrekiv-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/oleksandr-hrekiv.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/oleksandr-hrekiv.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Олександр Греків: Полководець УНР** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ: Генерал української незалежності | 400 | 600 |
| Ранні роки: Формування військового інтелектуала (1875–1914) | 600 | 900 |
| Перша світова війна: Досвід великої стратегії (1914–1917) | 600 | 900 |
| Українська революція: Вибір на користь нації (1917–1918) | 800 | 1200 |
| Військовий міністр УНР: Боротьба з хаосом (Зима-Весна 1919) | 800 | 1200 |
| Чортківська офензива: Останній злет Галицької Армії (Літо 1919) | 800 | 1200 |
| Еміграція: Життя та діяльність у Відні (1920–1948) | 500 | 750 |
| У пазурах СМЕРШу: ГУЛАГ і вічна пам'ять (1948–1959) | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/oleksandr-hrekiv.yaml`. Go through EVERY `points:` item in EVERY section:
