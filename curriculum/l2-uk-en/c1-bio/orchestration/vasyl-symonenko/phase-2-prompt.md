...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/vasyl-symonenko-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/vasyl-symonenko.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/vasyl-symonenko.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Василь Симоненко: Ніжний бунтар** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Поет, який не встиг постаріти | 600 | 900 |
| Полтавське дитинство: Витоки характеру | 700 | 1050 |
| Студентські роки: Інтелектуальне становлення | 700 | 1050 |
| Журналіст і громадянин: Час дій | 800 | 1200 |
| Поезія як сповідь: «Тиша і грім» | 800 | 1200 |
| Загадкова смерть: Вбивство поета | 700 | 1050 |
| Дискусія — Чому молоді поети стають символами? | 700 | 1050 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/vasyl-symonenko.yaml`. Go through EVERY `points:` item in EVERY section:
