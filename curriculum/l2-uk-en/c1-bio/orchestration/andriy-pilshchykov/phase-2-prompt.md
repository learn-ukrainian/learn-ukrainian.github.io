...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/andriy-pilshchykov-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/andriy-pilshchykov.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/andriy-pilshchykov.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Андрій «Juice» Пільщиков: Захисник неба та голос авіації** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Лицар неба | 500 | 750 |
| Життєпис: I — Витоки та гартування | 500 | 750 |
| Життєпис: II — Між небом та землею | 500 | 750 |
| Історичний контекст: I — Оборона столиці | 500 | 750 |
| Історичний контекст: II — Феномен «Привида Києва» | 500 | 750 |
| Внесок: I — Місія у Вашингтоні | 500 | 750 |
| Внесок: II — Технічна аргументація | 500 | 750 |
| Останні роки: Трагедія в небі | 500 | 750 |
| Спадщина: I — Здійснення мрії | 500 | 750 |
| Спадщина: II — Вічна присутність | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/andriy-pilshchykov.yaml`. Go through EVERY `points:` item in EVERY section:
