...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/severyn-nalyvaiko-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/severyn-nalyvaiko.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/severyn-nalyvaiko.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Северин Наливайко: Лідер козацького повстання** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Перший бунтар | 400 | 600 |
| Життєпис: I — Ранні роки та формування | 600 | 900 |
| Життєпис: II — Від найманця до повстанця | 700 | 1050 |
| Життєпис: III — Війна та дипломатія | 700 | 1050 |
| Життєпис: IV — Солоницька трагедія | 700 | 1050 |
| Історичний контекст: I — Криза Речі Посполитої | 500 | 750 |
| Історичний контекст: II — Релігійний вимір | 500 | 750 |
| Внесок та Спадщина: I — Політичний та військовий спадок | 500 | 750 |
| Внесок та Спадщина: II — Культурна пам'ять | 500 | 750 |
| Порівняльний аналіз | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/severyn-nalyvaiko.yaml`. Go through EVERY `points:` item in EVERY section:
