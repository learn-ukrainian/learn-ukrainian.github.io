...
1. **Content** (the lesson you're reviewing): `# Северин Наливайко: Лідер козацького повстання
...
> [!source] **Свідчення польського хроніста Марціна Бельського (XVI ст.)**
...
2. **Activities**: `---
- type: reading
  id: reading-solonytsia
  title: "Трагедія на Солониці (1596)"
  source: "Реконструкція на основі хроніки Йоахима Бельського"
  text: "Козацький табір на Солониці був оточений зусібіч. Вісім рядів возів, зчеплених ланцюгами, тримали оборону. Всередині було понад десять тисяч людей: козаки з сім'ями, жінки, діти. Гетман Жолкевський перекрив доступ до води і пасовищ. Почався великий голод, коні гризли землю, а люди пили власну кров. Наливайко закликав стояти до кінця, але реєстрові козаки, налякані обіцянками амністії, змовилися. Вони схопили Наливайка і видали його Жолкевському. Але тільки-но ворота табору відчинилися, поляки забули про обіцянки. Почалася кривава різанина, де не щадили ні старого, ні малого. Солониця стала могилою козацької надії на довгі роки."
  instruction: "Прочитайте опис останньої облоги повстання Наливайка та проаналізуйте причини поразки."

- type: critical-analysis
  title: "Аналіз факторів поразки та ціни зради"
  source_reading: reading-solonytsia
  target_text: "Реєстрові козаки, налякані обіцянками амністії, змовилися. Вони схопили Наливайка і видали його Жолкевському. Але тільки-но ворота табору відчинилися, поляки забули про обіцянки."
  questions:
  ...
  model_answers:
    - "Фатальним став розкол між реєстровцями (елітою, що шукала компромісу) та наливайківцями (радикалами). Брак єдиної мети призвів до зради."
    - "Жолкевський використав тактику виснаження (блокада води та їжі) та психологічну війну (обіцянки помилування в обмін на видачу ватажків)."
    - "Це означало не лише військову поразку, а й глибоку психологічну травму: усвідомлення того, що без внутрішньої єдності будь-яка боротьба приречена на трагедію."
  focus_points:
    - "Military blockade terminology"
    - "Social conflict within the army"
    - "Historical trauma"

- type: authorial-intent
  title: "Аналіз наративу про 'бунтівника'"
  source_reading: reading-solonytsia
  prompt: "Польські хроністи того часу називали Наливайка 'злочинцем' і 'тираном'. Як автор цього тексту намагається змінити це сприйняття, на чому він робить акцент у описі Солоницької трагедії?"
  techniques_to_identify:
    - "Гуманізація жертв (згадка про жінок і дітей)"
    - "Акцент на віроломстві ворога (порушення обіцянки амністії)"
    - "Створення образу трагічного героя, зрадженого своїми"
  model_answer: "Автор зміщує акцент з 'бунту' на 'трагедію народу'. Наливайко постає не як злочинець, а як лідер, чия поразка зумовлена не браком мужності, а підступністю ворога та зрадою соратників."

- type: comparative-study
  title: "Порівняння повстань: Наливайко vs Хмельницький"
  source_reading: reading-solonytsia
  items_to_compare:
  ...
  model_answer: "Хмельницький врахував помилку Солониці: він зумів об'єднати всі верстви населення та знайти зовнішніх союзників."

- type: essay-response
  title: "Есе: Северин Наливайко — герой чи розбійник?"
  source_reading: reading-solonytsia
  instruction: "Напишіть аналітичне есе про оцінку постаті Наливайка."
  prompt: "Оцініть постать Северина Наливайка в контексті українського державотворення. Чи був він лише ватажком бунту, чи мав візію майбутньої козацької території? Чому його образ став таким важливим для української літератури XIX століття? Використовуйте терміни: 'харизма', 'жертовність', 'репресії', 'легітимація'."
  min_words: 300
  model_answer: "Северин Наливайко був першим, хто перетворив козацьке невдоволення на масштабний політичний виклик..."`
3. **Vocabulary**: `---
- lemma: повстання
  ipa: /pou̯ˈstɑnnʲɐ/
  translation: uprising / rebellion
  pos: noun
  gender: n
  note: масовий збройний виступ
- lemma: бунт
  ipa: /bunt/
  translation: mutiny / riot
  pos: noun
  gender: m
  note: стихійний опір владі
- lemma: ватажок
  ipa: /ʋɐtɐˈʒɔk/
  translation: leader (of a group)
  pos: noun
  gender: m
  note: керівник загону чи повстання
- lemma: табір
  ipa: /ˈtɑbʲir/
  translation: camp
  pos: noun
  gender: m
  note: місце дислокації війська
- lemma: облога
  ipa: /obˈlɔɦɐ/
  translation: siege
  pos: noun
  gender: f
  note: оточення міста чи фортеці
- lemma: страта
  ipa: /ˈstrɑtɐ/
  translation: execution
  pos: noun
  gender: f
  note: публічне позбавлення життя за вироком
- lemma: зрада
  ipa: /ˈzrɑdɐ/
  translation: betrayal / treason
  pos: noun
  gender: f
  note: порушення вірності чи присяги
- lemma: найманець
  ipa: /ˈnɑjmanet͡sʲ/
  translation: mercenary
  pos: noun
  gender: m
  note: воїн, що служить за плату
- lemma: поразка
  ipa: /poˈrɑzkɐ/
  translation: defeat
  pos: noun
  gender: f
  note: невдача у битві чи війні
- lemma: артилерія
  ipa: /ɐrtɪˈlɛrʲijɐ/
  translation: artillery
  pos: noun
  gender: f
  note: вогнепальна зброя великого калібру
- lemma: мушкет
  ipa: /muʃˈkɛt/
  translation: musket
  pos: noun
  gender: m
  note: ручна вогнепальна зброя
- lemma: розправа
  ipa: /rozˈprɑʋɐ/
  translation: reprisal / crack down
  pos: noun
  gender: f
  note: жорстоке покарання ворога
- lemma: шляхтич
  ipa: /ˈʃlʲɑxtɪt͡ʃ/
...
- lemma: вольниця
  ipa: /ˈʋɔlʲnɪt͡sʲɐ/
  translation: free company / freedom-loving group
  pos: noun
  gender: f
  note: спільнота вільних людей
- lemma: соратник
  ipa: /soˈrɑtnɪk/
  translation: comrade-in-arms
  pos: noun
  gender: m
  note: товариш по зброї чи ідеї
- lemma: децимація
  ipa: /det͡sɪmˈɑt͡sʲijɐ/
  translation: decimation
  pos: noun
  gender: f
  note: страта кожного десятого
- lemma: четвертування
  ipa: /t͡ʃetʋertˈuʋɐnnʲɐ/
  translation: quartering
  pos: noun
  gender: n
  note: вид жорстокої страти
- lemma: маніфест
  ipa: /mɐnʲiˈfɛst/
...
- lemma: пасіонарність
  ipa: /pɐsʲionˈɑrnʲisʲtʲ/
  translation: passionarity / extreme drive
  pos: noun
  gender: f
  note: надлишкова енергія лідера
- lemma: фронтир
  ipa: /fronˈtɪr/
  translation: frontier
  pos: noun
  gender: m
  note: межа між цивілізаціями
- lemma: козакування
  ipa: /kozɐˈkuʋɐnnʲɐ/
  translation: leading a Cossack life
  pos: noun
  gender: n
  note: спосіб життя козака
- lemma: ультиматум
  ipa: /ulʲtɪˈmɑtum/
  translation: ultimatum
  pos: noun
  gender: m
  note: категорична вимога
- lemma: легітимність
...
activity_hints:
- type: reading
  focus: Analysis of the Solonytsia tragedy
  source: Хроніка Йоахима Бельського
- type: critical-analysis
  focus: Social conflict within the Cossack army
- type: essay-response
  focus: Nalyvaiko as a hero vs rebel in national memory
  word_target: 300
- type: comparative-study
  focus: Nalyvaiko vs Khmelnytskyi uprisings
build:
  last_modified: '2026-02-06'
`
6. **Research notes** (if exists): `# Research Notes: Северин Наливайко
...
At module 18, students know ONLY modules 1-17. Any grammar from later modules is scope creep.
