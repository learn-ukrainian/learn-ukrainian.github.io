...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/yurii-lypa-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/yurii-lypa.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/yurii-lypa.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Юрій Липа: Геополітик Чорного моря** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Пророк Чорноморської доктрини | 600 | 900 |
| Одеса та еміграція: Гартування волі (1900-1920) | 800 | 1200 |
| Варшавський період: Скальпель і перо (1920-1939) | 1200 | 1800 |
| Чорноморська доктрина та крах імперії | 1000 | 1500 |
| Друга світова війна: Вибір шляху (1939-1944) | 800 | 1200 |
| Спадщина: Актуальність у XXI столітті | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/yurii-lypa.yaml`. Go through EVERY `points:` item in EVERY section:
