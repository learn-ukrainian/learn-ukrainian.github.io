...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/maik-yohansen-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/maik-yohansen.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/maik-yohansen.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Майк Йогансен: <!-- Title -->** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ: Людина Відродження у кепці | 600 | 900 |
| Ранні роки: Харківський фундамент | 800 | 1200 |
| Творчий шлях: I — Поезія та маніфести | 800 | 1200 |
| Творчий шлях: II — Проза та мета-література | 1000 | 1500 |
| Роль у Розстріляному відродженні: ВАПЛІТЕ і «Слово» | 800 | 1200 |
| Трагічна доля: Арешт і страта | 600 | 900 |
| Спадщина: Повернення Майка | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/maik-yohansen.yaml`. Go through EVERY `points:` item in EVERY section:
