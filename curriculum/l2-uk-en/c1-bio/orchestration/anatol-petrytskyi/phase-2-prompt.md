...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/anatol-petrytskyi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/anatol-petrytskyi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/anatol-petrytskyi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Анатоль Петрицький: <!-- Title -->** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ: Архітектор українського авангарду | 600 | 900 |
| Ранні роки: Від сиротинця до «Молодого театру» | 800 | 1200 |
| Сценографія та «Нова ґенерація»: Революція форми | 900 | 1350 |
| «Портрети сучасників»: Документування епохи | 1000 | 1500 |
| Між виживанням і конформізмом: 1930-ті роки | 900 | 1350 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/anatol-petrytskyi.yaml`. Go through EVERY `points:` item in EVERY section:
