...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/mykhailo-chernihivskyi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/mykhailo-chernihivskyi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/mykhailo-chernihivskyi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Михайло Чернігівський: Князь-мученик** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Вибір між життям і вірою | 400 | 600 |
| Життєпис: І — Династія і перша кров | 600 | 900 |
| Життєпис: ІІ — Київський стіл і втеча | 600 | 900 |
| Внесок: І — Шлях до Сарай-Бату | 500 | 750 |
| Внесок: ІІ — Випробування вірою | 600 | 900 |
| Останні роки: І — Страта князя і боярина | 600 | 900 |
| Останні роки: ІІ — Свідчення і резонанс | 500 | 750 |
| Спадщина: І — Церковне шанування | 500 | 750 |
| Спадщина: ІІ — Імперська апропріація | 400 | 600 |
| Підсумок — Віра вища за життя | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/mykhailo-chernihivskyi.yaml`. Go through EVERY `points:` item in EVERY section:
