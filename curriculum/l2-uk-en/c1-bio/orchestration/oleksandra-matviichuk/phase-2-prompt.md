...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/oleksandra-matviichuk-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/oleksandra-matviichuk.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/oleksandra-matviichuk.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Олександра Матвійчук: Право на справедливість та Нобелівський голос** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Обличчя українського правосуддя у світі | 600 | 900 |
| Життєпис: І — Становлення та вибір шляху | 600 | 900 |
| Життєпис: ІІ — Виклики історії | 600 | 900 |
| Історичний контекст: Революція Гідності та феномен «Євромайдан SOS» | 800 | 1200 |
| Правозахисна архітектура: Системна боротьба з безкарністю (2014–2021) | 800 | 1200 |
| Сучасний етап: «Трибунал для Путіна» та глобальна адвокація | 800 | 1200 |
| Вплив: Нова архітектура глобальної безпеки | 800 | 1200 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/oleksandra-matviichuk.yaml`. Go through EVERY `points:` item in EVERY section:
