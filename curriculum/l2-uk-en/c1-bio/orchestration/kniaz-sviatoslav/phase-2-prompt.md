...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/kniaz-sviatoslav-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/kniaz-sviatoslav.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/kniaz-sviatoslav.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Князь Святослав: Воїн-завойовник** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Воїн на троні | 400 | 600 |
| Життєпис | 300 | 450 |
| Біографія: Ранні роки та становлення | 500 | 750 |
| Східний похід та крах Хазарії | 600 | 900 |
| Балканська мрія та облога Доростола | 800 | 1200 |
| Останні роки: Загибель на порогах | 500 | 750 |
| Внесок у розбудову держави | 500 | 750 |
| Історичний контекст: Русь у X столітті | 400 | 600 |
| Порівняльний аналіз: Творець (Ольга) vs Завойовник (Святослав) | 500 | 750 |
| Спадщина: Від Князя до ЗСУ | 300 | 450 |
| Підсумок | 200 | 300 |
| **Total** | **5000** | **7500** |
