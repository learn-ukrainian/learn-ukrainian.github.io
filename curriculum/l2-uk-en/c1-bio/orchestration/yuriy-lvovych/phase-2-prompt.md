...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/yuriy-lvovych-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/yuriy-lvovych.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/yuriy-lvovych.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Юрій I Львович: Останній Король Русі** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Король Русі | 500 | 750 |
| Походження та молодість | 500 | 750 |
| Об'єднання королівства: I — Спадкоємність влади | 400 | 600 |
| Об'єднання королівства: II — Економічний розквіт | 400 | 600 |
| Королівський титул | 600 | 900 |
| Галицька митрополія: I — Передумови розколу | 450 | 675 |
| Галицька митрополія: II — Духовний суверенітет | 550 | 825 |
| Зовнішня політика та кінець правління: I — Дипломатія | 550 | 825 |
| Зовнішня політика та кінець правління: II — Династія | 450 | 675 |
| Підсумок — Завершення королівської епохи | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/yuriy-lvovych.yaml`. Go through EVERY `points:` item in EVERY section:
