...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/yevhen-sverstiuk-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/yevhen-sverstiuk.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/yevhen-sverstiuk.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Євген Сверстюк: Моральний авторитет нації** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ: Філософ свободи | 400 | 600 |
| Волинь та юність: Коріння характеру | 600 | 900 |
| Шістдесятники: Інтелектуальний фронт | 700 | 1050 |
| Шістдесятники: Собор у риштованні | 700 | 1050 |
| Ув'язнення: Арешт і вирок | 600 | 900 |
| Ув'язнення: Мордовія та заслання | 600 | 900 |
| Повернення: Столяр і мислитель | 600 | 900 |
| Незалежність: Голос совісті | 500 | 750 |
| Спадщина: Уроки правди | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/yevhen-sverstiuk.yaml`. Go through EVERY `points:` item in EVERY section:
