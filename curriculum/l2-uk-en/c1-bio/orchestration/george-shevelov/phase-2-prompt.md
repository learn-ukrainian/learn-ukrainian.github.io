...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/george-shevelov-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/george-shevelov.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/george-shevelov.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Юрій Шевельов: Архітектор української лінгвістики** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Голос української мови у світі | 400 | 600 |
| Молодість у Харкові: I — Походження та освіта | 600 | 900 |
| Молодість у Харкові: II — Війна та еміграція | 600 | 900 |
| Діаспорне життя: I — Табори переміщених осіб та МУР | 600 | 900 |
| Діаспорне життя: II — Академічна кар'єра в США | 600 | 900 |
| "Історична фонологія української мови" (1979) | 900 | 1350 |
| Інші наукові праці: Есеїстика та критика | 600 | 900 |
| Спадщина та повернення в Україну | 700 | 1050 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/george-shevelov.yaml`. Go through EVERY `points:` item in EVERY section:
