...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/ivan-mazepa-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/ivan-mazepa.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/ivan-mazepa.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Іван Мазепа: Меценат і трагічний герой** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Між зрадою та героїзмом | 300 | 450 |
| Молодість та шлях до влади | 400 | 600 |
| Гетьманування: I — Державне будівництво | 500 | 750 |
| Гетьманування: II — Мазепинське бароко | 600 | 900 |
| Шлях до розриву з Москвою: I — Тягар війни | 450 | 675 |
| Шлях до розриву з Москвою: II — Дипломатичний злам | 450 | 675 |
| Полтава та вигнання: I — Батуринська трагедія | 600 | 900 |
| Полтава та вигнання: II — Катастрофа і смерть | 500 | 750 |
| Спадщина та реабілітація: I — Європейський міф | 400 | 600 |
| Спадщина та реабілітація: II — Національна пам'ять | 400 | 600 |
| Підсумок — Трагічний вибір | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/ivan-mazepa.yaml`. Go through EVERY `points:` item in EVERY section:
