...
1. **Content** (the lesson you're reviewing): `---
module: c1-bio-027
...
2. **Activities**: `---
- type: reading
  id: reading-mazepa-manifesto
  title: 'Маніфест Івана Мазепи до війська та народу (1708)'
  source: 'Іван Мазепа (1708)'
  text: |
    «Браття, прийшла пора, якої ми давно чекали, щоб звільнити нашу Вітчизну від московського ярма. Московський цар хоче нас, вільний народ козацький, перетворити на своїх невільників, забрати наші права, вольності та маєтності. Він уже знищив права донців, а тепер черга дійшла до нас. Ми не зраджуємо царя, бо він перший порушив свою присягу захищати нас. 

    Ми переходимо під протекцію шведського короля, який не має наміру завойовувати нашу землю, а хоче лише допомогти нам відновити наші давні права. Король Карл XII — це чесний і могутній монарх, який обіцяє нам свою підтримку та захист. Ми будемо вільними у своїй державі, зі своїм гетьманом, своїми судами та своєю вірою. 

    Не вірте московській брехні, що ми хочемо повернути вас під польську владу або змінити віру. Ми боремося за Україну, за нашу православну церкву, за право жити на своїй землі господарями. Кожен, хто любить свою Вітчизну, має стати сьогодні разом із нами під прапори свободи. Бог бачить нашу правду і допоможе нам у цій справедливій боротьбі!»

- type: essay-response
  id: essay-mazepa-dilemma
  source_reading: reading-mazepa-manifesto
  title: 'Есе: Геополітична дилема Івана Мазепи'
  instruction: Напишіть аналітичне есе (400-600 слів), фокусуючись на цивілізаційному виборі.
  prompt: |
    **Проблема для роздумів:**
    Іван Мазепа опинився перед неможливим вибором між модернізацією через східний деспотизм Петра I та європейською договірною моделлю Карла XII. Його поразка під Полтавою зазвичай трактується як воєнна катастрофа, проте деякі історики вважають її моральною перемогою української ідеї.

    **Завдання:**
    Проаналізуйте, як меценатська діяльність Мазепи (розбудова храмів, підтримка Києво-Могилянської академії) підготувала ґрунт для його політичного вибору 1708 року. Чи можна вважати «мазепинство» першим кроком до модерного українського націогенезу? Обґрунтуйте свою відповідь, використовуючи поняття «м'яка сила», «суб'єктність» та «цивілізаційний розрив».
  min_words: 300
  model_answer: |
    Вибір Івана Мазепи у 1708 році був логічним завершенням його багаторічної стратегії побудови української суб'єктності через культуру та освіту. Його меценатство, що втілилося в унікальному стилі мазепинського бароко, було не лише естетичним жестом, а інструментом маркування України як невід'ємної частини європейської християнської цивілізації. Будуючи храми та зміцнюючи Києво-Могилянську академію, гетьман створював «м'яку силу», яка мала легітимізувати окремішність Гетьманщини в очах Заходу.

    Цивілізаційний розрив із Москвою став неминучим, коли Петро I почав руйнувати цю договірну, «шляхетську» модель автономії, замінюючи її уніфікованим імперським деспотизмом. Хоча Полтавська битва закінчилася військовою поразкою, «мазепинство» вижило як інтелектуальна традиція. Воно заклало фундамент для модерного націогенезу, перетворивши Україну з об'єкта імперських маніпуляцій на суб'єкт політичної волі. Таким чином, Мазепа переміг у цивілізаційному вимірі, назавжди визначивши європейський вектор українського руху.
  rubric:
    - criteria: Аргументація
      description: Глибина аналізу зв'язку культури та політики
      points: 40
    - criteria: Термінологія
      description: Влучне використання С1 лексики
      points: 30
    - criteria: Структура
      description: Логіка побудови академічного тексту
      points: 30

- type: critical-analysis
  id: analysis-mazepa-historiography
  source_reading: reading-mazepa-manifesto
  title: 'Критичний розбір: Мазепа в лещатах історіографій'
  target_text: |
  ...
  questions:
    - Чому «елітарність» Мазепи стала його вразливим місцем у 1708-1709 роках?
    - Як терор у Батурині вплинув на психологічний стан українського суспільства того часу?
  model_answers:
    - Елітарність призвела до розриву між амбіціями старшини та інтересами селянства, що дозволило Петру I використати соціальні гасла для дезорієнтації народу.
    - Батуринська трагедія була актом цілеспрямованого залякування, який паралізував волю до спротиву і продемонстрував неспроможність гетьмана захистити своїх прихильників.
  focus_points:
    - Історіографічні наративи
    - Соціальна психологія мас
    - Політичне лідерство

- type: comparative-study
  id: comparison-mazepa-khmelnytsky
  source_reading: reading-mazepa-manifesto
  title: 'Компаративний аналіз: Моделі лідерства Хмельницького та Мазепи'
  items_to_compare:
  ...
  model_answer: |
    Хмельницький спирався на широкі козацькі та селянські маси, діючи як революційний лідер, що ламає старий порядок. Мазепа натомість будував державу через інституції, культуру та зміцнення старшинської еліти. Якщо Хмельницький створив державну оболонку, то Мазепа наповнив її європейським змістом. У зовнішній політиці Хмельницький шукав ситуативних союзів, тоді як Мазепа прагнув системної інтеграції в західну правову систему.

- type: quiz
  id: quiz-mazepa-era
  title: Перевірка знань про Мазепинську епоху
  items:
    - question: Яку головну мету переслідував Іван Мазепа, надаючи масштабну фінансову підтримку Києво-Могилянській академії?
      options:
        - text: Підготовка кваліфікованих кадрів для російської імперської адміністрації
          correct: false
        - text: Формування національної інтелектуальної еліти для розбудови власної держави
          correct: true
        - text: Задобрення київського духовенства для зміцнення особистої влади
          correct: false
        - text: Створення конкуренції єзуїтським колегіумам у Варшаві
          correct: false
    - question: Яке значення мала Жовківська військова рада 1707 року для остаточного рішення Мазепи про зміну альянсу?
      options:
        - text: На раді було прийнято рішення про негайний наступ на Москву
          correct: false
        - text: Петро I відмовив у захисті України, що фактично порушувало Переяславські угоди
          correct: true
        - text: Мазепа отримав титул князя Священної Римської імперії від царя
          correct: false
        - text: Було підписано нову торговельну угоду зі Шведським королівством
          correct: false
    - question: У чому полягала особливість архітектурного стилю «мазепинського бароко»?
      options:
        - text: Повна відмова від візантійських традицій на користь італійського класицизму
          correct: false
        - text: Синтез європейських барокових форм із традиціями українського дерев'яного зодчества
          correct: true
        - text: Використання виключно червоної цегли без зовнішнього декорування
          correct: false
        - text: Будівництво лише оборонних споруд без релігійного призначення
          correct: false
    - question: Хто з соратників Мазепи став автором першої української Конституції в еміграції у 1710 році?
      options:
        - text: Кость Гордієнко
          correct: false
        - text: Пилип Орлик
          correct: true
        - text: Андрій Войнаровський
          correct: false
        - text: Стефан Яворський
          correct: false
    - question: Яким був результат Батуринської трагедії 2 листопада 1708 року в контексті стратегії Петра I?
      options:
        - text: Встановлення демократичного правління в гетьманській столиці
          correct: false
        - text: Деморалізація українського населення через акт тотального державного терору
          correct: true
        - text: Підписання мирної угоди між козаками та російськими військами
          correct: false
        - text: Перетворення Батурина на головну базу шведської армії
          correct: false

- type: true-false
  id: tf-mazepa-myths
  title: Деконструкція міфів та фактів про Івана Мазепу
  items:
    - statement: Церковна анатема Мазепі була проголошена через його відхід від православного віровчення та перехід у католицизм.
      correct: false
      explanation: Анатема була політичним інструментом Петра I і не мала жодних релігійних підстав, оскільки Мазепа залишався православним.
    - statement: Іван Мазепа був не лише політиком, а й талановитим поетом, автором знаменитої «Думи».
      correct: true
      explanation: Його літературний спадок свідчить про глибоку освіченість та вболівання за долю нації.
    - statement: Союз Мазепи з Карлом XII передбачав повне приєднання України до складу Шведського королівства.
      correct: false
      explanation: Угода передбачала статус незалежного князівства під міжнародним протекторатом Швеції.
    - statement: Києво-Могилянська академія отримала свій офіційний статус саме за часів гетьманування Мазепи.
      correct: true
      explanation: Завдяки його зусиллям колегіум отримав царський указ про статус академії у 1701 році.
    - statement: Битва під Полтавою відбулася взимку 1709 року під час «Великого морозу».
      correct: false
      explanation: Битва відбулася влітку, 27 червня 1709 року, хоча зима напередодні дійсно була дуже суворою.
`
3. **Vocabulary**: `---
items:
- id: hetman
...
- id: klejnody
  text: клейноди
  translation: regalia (insignia)
  ipa: "klɛi̯ˈnɔdɪ"
  pos: noun
- id: starshyna
  text: старшина
  translation: officer class (seniority)
  ipa: "stɑrˈʃɪnɑ"
  pos: noun
- id: hetmanshchyna
  text: гетьманщина
...
- id: kapituliatsiia
  ...
  ipa: "kɑp⁽ʲ⁾itulʲˈjɑt͡sʲijɑ"
  pos: noun
- id: fundatsiia
  text: фундація
  translation: foundation / donation
  ipa: "funˈdɑt͡sʲijɑ"
  pos: noun
- id: spudei
  text: спудеї
  translation: students (archaic/academic)
  ipa: "spuˈdɛji"
  pos: noun
- id: mazepynstvo
  text: мазепинство
  translation: Mazepinism (pro-independence movement)
  ipa: "mɑzɛˈpɪnstʋɔ"
  pos: noun
- id: vasalitet
  text: васалітет
...
- id: natsiogenez
  text: націогенез
  translation: nation-building / ethnogenesis
  ipa: "nɑt͡sʲiɔɦɛˈnɛz"
  pos: noun
- id: subiektnist
  text: суб'єктність
...
- id: soratnyk
  text: соратник
  translation: ally / brother-in-arms
  ipa: "sɔˈrɑtnɪk"
  pos: noun
- id: poshana
  text: пошана
...
- id: postat
  text: постать
  translation: figure / personage
  ipa: "ˈpɔstɑtʲ"
  pos: noun
- id: prosvitnytstvo
  text: просвітництво
  translation: enlightenment / education
  ipa: "prɔs⁽ʲ⁾ʋʲitˈnɪt͡stʋɔ"
  pos: noun`
...
content_outline:
- section: "Вступ — Між зрадою та героїзмом"
  words: 400
  points:
  - Суперечливість постаті Мазепи
  - Його місце в українській та російській історіографії
  - Значення його вибору 1708 року
- section: Молодість та шлях до влади
  words: 600
  points:
  - Шляхетське походження
  - Освіта та служба при дворах
  - Козацька кар'єра
  - Обрання гетьманом 1687 року
- section: 'Гетьманування: успіхи'
  words: 700
  points:
  - Внутрішня політика та реформи
  - Військові походи з Петром I
  - Культурний розквіт — мазепинське бароко
  - Меценатство та будівництво
- section: Шлях до розриву з Москвою
  words: 800
  points:
  - Наростання суперечностей
  - Обмеження автономії
  - Північна війна та її тягар
  - Переговори з Карлом XII
- section: Полтава та вигнання
  words: 800
  points:
  - Відкритий виступ 1708 року
  - Руйнування Батурина
...
- section: Спадщина та реабілітація
  ...
  - Байрон, Пушкін, Словацький
  - Реабілітація в незалежній Україні
  - Мазепа на банкноті
- section: "Підсумок — Трагічний вибір"
  words: 300
  points:
  - Мазепа як символ боротьби за незалежність
  - Уроки його історії
...
vocabulary_hints:
  ...
  - бароко (baroque)
  - анафема (anathema)
  - зрада (treason - in Russian narrative)
  - автономія (autonomy)
  - союз (alliance)
  - вигнання (exile)
  - універсал (decree)
...
activity_hints:
- type: reading
  focus: Mazepa's manifesto and correspondence
  source: Primary sources (adapted)
  items: 3 passages
- type: essay-response
  focus: Was Mazepa a traitor or a patriot?
  word_target: 300
  output: Analysis of competing narratives
- type: critical-analysis
  focus: Analyze Mazepa in Ukrainian vs. Russian historiography
  output: Comparative historiography
focus: biography
prerequisites:
- c1-bio-10 (Bohdan Khmelnytskyi - earlier hetman)
- c1-bio-11 (Yuriy Nemyrych - European orientation)
connects_to:
- c1-bio-13 (Kost Hordiyenko - ally)
- c1-bio-14 (Pylyp Orlyk - successor)
- c1-bio-15 (Petro Kalnyshevskyy - end of autonomy)
module_type: biography
sources:
- name: Іван Мазепа (Wikipedia UA)
  url: "https://uk.wikipedia.org/wiki/Іван_Мазепа"
  type: primary
  notes: Biography, hetmanate, Poltava
- name: Полтавська битва (Wikipedia UA)
  url: "https://uk.wikipedia.org/wiki/Полтавська_битва"
  type: reference
  notes: Military context and consequences
- name: Мазепинське бароко
  url: "https://uk.wikipedia.org/wiki/Мазепинське_бароко"
  type: reference
  notes: Cultural patronage
immersion: 100% Ukrainian
phase: C1-BIO
objectives:
- 'Analyze the life and legacy of іван мазепа: меценат і трагічний герой'
- Evaluate the contributions of між зрадою та героїзмом
`
5. **Meta** (build config): `---
module: c1-bio-027
level: C1-BIO
...
content_outline:
  - section: Вступ — Між зрадою та героїзмом
    words: 300
  - section: Життєпис — Молодість та шлях до влади
    words: 700
  - section: Внесок — Гетьманування та культурний розквіт
    words: 1000
  - section: Шлях до розриву з Москвою
    words: 800
  - section: Полтава та вигнання
    words: 600
  - section: Останні роки — Бендери та смерть
    words: 200
  - section: Спадщина та реабілітація
    words: 250
  - section: Підсумок — Трагічний вибір
...
word_target: 4000
`
6. **Research notes** (if exists): `# Research Notes: Іван Мазепа
