I will generate the critical review for module `c1-bio-027` (Ivan Mazepa), analyzing the provided content against the project standards, specifically checking for plan alignment, vocabulary usage, and strict adherence to the markdown callout syntax required by the audit pipeline.
