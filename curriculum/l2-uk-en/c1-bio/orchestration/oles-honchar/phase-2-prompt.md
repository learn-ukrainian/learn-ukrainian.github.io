...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/oles-honchar-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/oles-honchar.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/oles-honchar.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Олесь Гончар: Собор непокори** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ: Між системою та сумлінням | 600 | 900 |
| Полтавщина та гартування (1918-1941) | 700 | 1050 |
| Війна та ціна визнання: «Прапороносці» | 900 | 1350 |
| «Собор»: Архітектура непокори (I — Задум і символи) | 800 | 1200 |
| «Собор»: Архітектура непокори (II — Скандал і заборона) | 800 | 1200 |
| Захисник культури та пророк (1968-1995) | 800 | 1200 |
| Спадщина: Совість нації | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/oles-honchar.yaml`. Go through EVERY `points:` item in EVERY section:
