...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/hryhoriy-kvitka-osnovianenko-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/hryhoriy-kvitka-osnovianenko.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/hryhoriy-kvitka-osnovianenko.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Григорій Квітка-Основ'яненко: Батько української прози** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Перший прозаїк | 800 | 1200 |
| Походження та молодість | 700 | 1050 |
| Звернення до української мови | 700 | 1050 |
| Сентиментальна проза | 700 | 1050 |
| Сатирична проза | 700 | 1050 |
| Етнографічна спадщина | 700 | 1050 |
| Останні роки та значення | 700 | 1050 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/hryhoriy-kvitka-osnovianenko.yaml`. Go through EVERY `points:` item in EVERY section:
