...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/yuriy-kondratiuk-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/yuriy-kondratiuk.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/yuriy-kondratiuk.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Юрій Кондратюк: Пророк космічних трас** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Забутий геній космонавтики | 300 | 450 |
| Життєпис: I — Походження та освіта | 500 | 750 |
| Життєпис: II — Війна та нове ім'я | 500 | 750 |
| Життєпис: III — Втеча та елеватори | 500 | 750 |
| Історичний контекст: I — Терор і виживання | 400 | 600 |
| Історичний контекст: II — Ізоляція науки | 300 | 450 |
| Внесок: I — Книга пророцтв | 600 | 900 |
| Внесок: II — Траса Кондратюка | 600 | 900 |
| Останні роки: I — Від вітру до війни | 500 | 750 |
| Останні роки: II — Загибель | 300 | 450 |
| Спадщина | 400 | 600 |
| Підсумок | 200 | 300 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/yuriy-kondratiuk.yaml`. Go through EVERY `points:` item in EVERY section:
