...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/oleksander-potebnya-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/oleksander-potebnya.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/oleksander-potebnya.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Олександр Потебня: Філософ мови** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Український Гумбольдт | 400 | 600 |
| Походження та освіта: I — Козацьке коріння | 400 | 600 |
| Походження та освіта: II — Університет та Європа | 500 | 750 |
| "Думка і мова" (1862): I — Мова і мислення | 600 | 900 |
| "Думка і мова" (1862): II — Внутрішня форма слова | 600 | 900 |
| Харківська філологічна школа: I — Заснування та методологія | 500 | 750 |
| Харківська філологічна школа: II — Вплив та послідовники | 400 | 600 |
| Дослідження української мови: I — Граматика та фонетика | 600 | 900 |
| Дослідження української мови: II — Захист ідентичності | 600 | 900 |
| Спадщина та визнання | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/oleksander-potebnya.yaml`. Go through EVERY `points:` item in EVERY section:
