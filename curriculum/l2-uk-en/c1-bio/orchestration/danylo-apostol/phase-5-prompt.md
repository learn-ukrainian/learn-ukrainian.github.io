...
1. **Content** (the lesson you're reviewing): `# Данило Апостол: Останній обраний гетьман
...
2. **Activities**: `---
- type: reading
  id: reading-apostol-01
  title: 'Аналіз первинного джерела: "Рішительні пункти" (1728)'
  source: 'Рішительні пункти (витяг), 1728'
  text: |
  ...
  tasks:
    - 'Який офіційний стиль використовується в документі? Наведіть приклади архаїзмів.'
    - 'Як формулювання пунктів відображає підлегле становище Гетьманщини?'
    - 'Порівняйте тон цього документа з Гадяцьким договором або Конституцією Орлика.'

- type: essay-response
  id: essay-apostol-01
  title: 'Есе: Гетьман компромісу чи борець?'
  instruction: |
    Напишіть есе (250-400 слів) на тему:
    "Данило Апостол: стратегія виживання української автономії в умовах імперського тиску".
  prompt: |
    Вимоги:
    - Проаналізуйте "Рішительні пункти" як політичний компроміс.
    - Оцініть успішність його адміністративних та економічних реформ.
    - Використайте лексику: автономія, централізація, кодифікація, компроміс.
  min_words: 250

- type: critical-analysis
  id: analysis-apostol-01
  title: 'Аналіз реформаторської діяльності'
  target_text: |
    Апостол проводив реформи в умовах тотального контролю з боку імперського резидента.
    Він ініціював Генеральне слідство про маєтності, реформував суди і захищав торгівлю.
    Його підхід демонструє «політику можливого» — максимум досягнень у мінімумі свободи.
  questions:
    - 'Чому кодифікація права була критично важливою для збереження автономії?'
    - 'Як Апостол намагався захистити українську економіку від російської експансії?'

- type: quiz
  id: quiz-apostol-01
  title: 'Реформи Данила Апостола'
  items:
    - question: 'Згідно з текстом, яка головна мета Генерального слідства про маєтності?'
      options:
        - text: 'Повернути незаконно захоплені землі до державного фонду'
          correct: true
        - text: 'Розподілити землі між російськими дворянами'
          correct: false
        - text: 'Створити нові маєтки для козацької старшини'
          correct: false
        - text: 'Провести перепис населення для нових податків'
          correct: false
      explanation: 'Слідство мало на меті ревізію землеволодіння і повернення рангових маєтностей.'

    - question: 'У чому полягала суть судової реформи Апостола і яке її значення для автономії?'
      options:
        - text: 'Створення власного кодексу та чітка процедура апеляцій'
          correct: true
        - text: 'Повне запровадження російського законодавства'
          correct: false
        - text: 'Скасування всіх судів, крім гетьманського'
          correct: false
        - text: 'Запровадження суду присяжних за англійським зразком'
          correct: false
      explanation: 'Він ініціював створення власного кодексу законів і впорядкував апеляції.'

    - question: 'Який статус визначали Рішительні пункти для зовнішньої політики Гетьманщини?'
      options:
        - text: 'Заборона вести самостійні переговори (крім прикордонних)'
          correct: true
        - text: 'Повна свобода укладати союзи'
          correct: false
        - text: "Обов'язковий союз із Польщею"
          correct: false
        - text: 'Нейтральний статус під європейським наглядом'
          correct: false
      explanation: 'Гетьман не мав права на дипломатію, крім технічних питань кордону.'

    - question: 'Як Апостол підтримував українських купців і чому це мало державне значення?'
      options:
        - text: 'Домігся скасування ембарго на експорт товарів до Європи'
          correct: true
        - text: 'Заборонив іноземну торгівлю'
          correct: false
        - text: 'Ввів державну монополію на всі товари'
          correct: false
        - text: 'Змусив торгувати тільки через Архангельськ'
          correct: false
      explanation: 'Він відкрив кордони для традиційного експорту зерна і худоби.'

    - question: 'Що сталося з Кодексом законів 1743 року після його завершення?'
      options:
        - text: 'Він не був затверджений Російським сенатом'
          correct: true
        - text: 'Він став основою законодавства Російської імперії'
          correct: false
        - text: 'Він був спалений гетьманом'
          correct: false
        - text: 'Він діяв в Україні до 1917 року офіційно'
          correct: false
      explanation: 'Імперія відхилила кодекс через його республіканський дух.'

- type: comparative-study
  id: compare-apostol-01
  title: 'Порівняння: Конституція Орлика vs Рішительні пункти'
  items_to_compare:
  ...
  prompt: 'Зіставте два основоположні документи XVIII століття. Який із них був більш реалістичним для свого часу, а який — більш прогресивним для майбутнього?'
  model_answer: |
    > [!model-answer]
    > **Конституція Пилипа Орлика** була надзвичайно прогресивною візією майбутнього, пропонуючи розподіл влади та республіканські засади в часи абсолютизму. Проте вона залишилася «паперовим» документом еміграції, не маючи механізмів реалізації на окупованій території.
    >
    > **Рішительні пункти Данила Апостола** були вимушеним компромісом, царським указом, що суттєво обмежував суверенітет. Проте вони були реалістичним правовим фундаментом, який дозволив зберегти автономію де-факто, впорядкувати суди та фінанси в межах Російської імперії. Вибір Апостола — це «політика можливого», яка врятувала Гетьманщину від повної анігіляції після терору Петра I.
`
3. **Vocabulary**: `---
- lemma: гетьман
  ipa: /ˈɦɛtʲmɐn/
...
- lemma: пункти
  ipa: /ˈpunktɪ/
  translation: points / articles
  pos: noun
  gender: m
  note: Рішительні пункти
- lemma: петиція
  ipa: /petˈɪt͡sʲijɐ/
  translation: petition
  pos: noun
  gender: f
  note: колективне прохання
- lemma: реформа
  ipa: /reˈfɔrmɐ/
  translation: reform
  pos: noun
...
- lemma: бюджет
  ...
  pos: noun
  gender: m
  note: державний кошторис
- lemma: суд
  ipa: /sud/
  translation: court
  pos: noun
  gender: m
  note: орган правосуддя
- lemma: кодекс
  ipa: /ˈkɔdeks/
  translation: code (of laws)
  pos: noun
  gender: m
  note: збірка законів
- lemma: автономія
...
- lemma: колегія
  ipa: /koˈlɛɦʲijɐ/
  translation: collegium / board
  pos: noun
  gender: f
  note: Малоросійська колегія
- lemma: стабільність
...
- lemma: дипломатія
  ...
  pos: noun
  gender: f
  note: зовнішня політика
- lemma: маєток
  ipa: /mɐˈjɛtɔk/
  translation: estate
  pos: noun
  gender: m
  note: земельна власність
- lemma: полковник
  ipa: /pɔlˈkɔu̯nɪk/
  translation: colonel
  pos: noun
...
- lemma: вибори
  ...
  note: процес обрання
- lemma: конституція
  ipa: /konstɪˈtut͡sʲijɐ/
  translation: constitution
  pos: noun
  gender: f
  note: основний закон
- lemma: стабілізація
  ipa: /stɐbʲilʲizˈɑt͡sʲijɐ/
  translation: stabilization
  pos: noun
  gender: f
  note: приведення до ладу
- lemma: чолобитна
  ipa: /t͡ʃolɔˈbɪtnɐ/
  translation: humble petition
  pos: noun
  gender: f
  note: архаїчне звернення
- lemma: казначейство
  ipa: /kɐznɐˈt͡ʃɛi̯stʋɔ/
  translation: treasury
  pos: noun
  gender: n
  note: державна скарбниця
- lemma: реорганізація
  ipa: /reɔrɦɐnʲizˈɑt͡sʲijɐ/
  translation: reorganization
  pos: noun
  gender: f
  note: перебудова структури
`
...
pedagogy: seminar
prerequisites:
  - c1-bio-29 (Павло Полуботок)
  - Знання про Першу Малоросійську колегію
connects_to:
  - c1-bio-31 (Кирило Розумовський)
  - b2-hist danylo-apostol module
objectives:
...
At module 29, students know ONLY modules 1-28. Any grammar from later modules is scope creep.
