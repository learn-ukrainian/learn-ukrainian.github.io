...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/vasyl-shkliar-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/vasyl-shkliar.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/vasyl-shkliar.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Василь Шкляр: Майстер історичного роману** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Бестселер як національний феномен | 500 | 750 |
| Журналістські роки та формування | 500 | 750 |
| Шлях до літератури | 600 | 900 |
| Чорний Ворон та історична пам'ять: I — Епос Холодного Яру | 700 | 1050 |
| Чорний Ворон та історична пам'ять: II — Битва за визнання | 700 | 1050 |
| Залишенець та продовження циклу: I — Тема антирадянського спротиву | 500 | 750 |
| Залишенець та продовження циклу: II — Художні особливості прози | 500 | 750 |
| Вплив на українську культуру | 500 | 750 |
| Дискусія — Історична правда vs художня вигадка | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/vasyl-shkliar.yaml`. Go through EVERY `points:` item in EVERY section:
