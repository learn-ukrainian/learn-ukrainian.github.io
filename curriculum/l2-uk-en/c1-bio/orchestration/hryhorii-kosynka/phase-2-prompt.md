...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/hryhorii-kosynka-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/hryhorii-kosynka.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/hryhorii-kosynka.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Григорій Косинка: <!-- Title -->** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ: Майстер новели та «міліціонер душ» | 600 | 900 |
| Ранні роки: Від Щербаківки до Києва | 800 | 1200 |
| Творчий злет: «На золотих богів» та поетика села | 1000 | 1500 |
| У колі однодумців: «Ланка» і МАРС | 900 | 1350 |
| Хроніка репресій: Від критики до розстрілу | 1000 | 1500 |
| Спадщина: Повернення із забуття | 700 | 1050 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/hryhorii-kosynka.yaml`. Go through EVERY `points:` item in EVERY section:
