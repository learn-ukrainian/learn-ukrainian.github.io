...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/olena-stepaniv-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/olena-stepaniv.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/olena-stepaniv.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Олена Степанів: Перша жінка-офіцер** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ: Жінка, що зламала стереотипи | 300 | 450 |
| Ранні роки: Формування характеру (1892-1914) | 400 | 600 |
| Велика війна: Народження офіцера | 500 | 750 |
| Маківка: Бойова слава (1915) | 700 | 1050 |
| Російський полон: Ташкентський етап (1915-1917) | 400 | 600 |
| Листопадовий чин: Битва за Львів (1918) | 500 | 750 |
| Відень: Наука та дипломатія (1919-1921) | 400 | 600 |
| Наукова праця: Географія та просвіта (1921-1939) | 500 | 750 |
| Радянські репресії: Арешт і Мордовія (1949-1956) | 600 | 900 |
| Повернення: Останні роки (1956-1963) | 300 | 450 |
| Спадщина: Пам'ять і значення | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/olena-stepaniv.yaml`. Go through EVERY `points:` item in EVERY section:
