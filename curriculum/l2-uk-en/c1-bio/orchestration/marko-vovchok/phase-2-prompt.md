...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/marko-vovchok-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/marko-vovchok.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/marko-vovchok.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Марко Вовчок: Голос пригноблених** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Росіянка, що стала українською письменницею | 600 | 900 |
| Ранні роки та шлюб (1833-1851) | 800 | 1200 |
| «Народні оповідання» (1851-1860) | 1000 | 1500 |
| Європейський період (1860-1878) | 900 | 1350 |
| Повернення та пізня творчість (1878-1907) | 800 | 1200 |
| Спадщина та значення | 900 | 1350 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/marko-vovchok.yaml`. Go through EVERY `points:` item in EVERY section:
