...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/taras-prokhasko-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/taras-prokhasko.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/taras-prokhasko.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Тарас Прохасько: Станіславівський феномен** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ: Письменник як ботанік і філософ | 400 | 600 |
| Івано-Франківське дитинство: Географія долі | 450 | 675 |
| Ботанічна освіта: Наука як фундамент світогляду | 450 | 675 |
| Станіславівський феномен: Контекст і середовище | 500 | 750 |
| Роман «НепрОсті»: Альтернативна міфологія Карпат | 600 | 900 |
| Філософія місця: Топографія пам'яті в «НепрОстих» | 550 | 825 |
| Есеїстика: Мислення як процес | 500 | 750 |
| Медитативна проза: Стиль та мова | 450 | 675 |
| Громадська позиція та діалог з епохою | 400 | 600 |
| Сучасний етап: Вплив та визнання | 350 | 525 |
| Дискусія: Література як спосіб творення світу | 350 | 525 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/taras-prokhasko.yaml`. Go through EVERY `points:` item in EVERY section:
