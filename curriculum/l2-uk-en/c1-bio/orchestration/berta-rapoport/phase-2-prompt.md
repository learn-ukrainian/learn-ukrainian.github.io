...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/berta-rapoport-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/berta-rapoport.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/berta-rapoport.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Берта Рапопорт: Лікарка і громадська діячка** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Легендарна Берта | 600 | 900 |
| Походження та морська освіта (1914–1931) | 800 | 1200 |
| Сходження на місток: Довоєнна кар'єра (1932–1940) | 1000 | 1500 |
| Капітан у вогні: Друга світова війна (1941–1945) | 1000 | 1500 |
| Злам кар'єри: «Боротьба з космополітизмом» (1948–1967) | 800 | 1200 |
| Спадщина — Повернення пам'яті | 800 | 1200 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/berta-rapoport.yaml`. Go through EVERY `points:` item in EVERY section:
