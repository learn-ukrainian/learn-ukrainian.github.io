...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/mykola-kulish-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/mykola-kulish.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/mykola-kulish.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Микола Куліш: Геній українського театру** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Найбільший драматург XX століття | 400 | 600 |
| Ранні роки та освіта | 600 | 900 |
| Становлення драматурга | 600 | 900 |
| Великі п'єси: I — Сатира на радянську дійсність | 900 | 1350 |
| Великі п'єси: II — Екзистенційна драма | 800 | 1200 |
| Художній світ Куліша | 600 | 900 |
| Переслідування та загибель | 600 | 900 |
| Спадщина та реабілітація | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/mykola-kulish.yaml`. Go through EVERY `points:` item in EVERY section:
