...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/roman-mstyslavych-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/roman-mstyslavych.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/roman-mstyslavych.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Роман Мстиславич: Засновник Галицько-Волинської держави** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Самодержець усієї Русі | 400 | 600 |
| Походження та молодість | 500 | 750 |
| Боротьба за Галич | 600 | 900 |
| Створення Галицько-Волинської держави: I — Об'єднання та централізація | 500 | 750 |
| Створення Галицько-Волинської держави: II — Гегемонія в Києві | 500 | 750 |
| Зовнішня політика: I — Половецький вектор та Візантія | 600 | 900 |
| Зовнішня політика: II — Відносини з Римом та Заходом | 600 | 900 |
| Загибель та спадщина: I — Битва під Завихостом | 400 | 600 |
| Загибель та спадщина: II — Велика смута та повернення | 500 | 750 |
| Підсумок — Будівничий держави | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/roman-mstyslavych.yaml`. Go through EVERY `points:` item in EVERY section:
