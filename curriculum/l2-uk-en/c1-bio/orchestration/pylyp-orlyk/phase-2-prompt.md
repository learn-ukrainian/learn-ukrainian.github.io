...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/pylyp-orlyk-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/pylyp-orlyk.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/pylyp-orlyk.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Пилип Орлик: Автор першої конституції** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Батько українського конституціоналізму | 400 | 600 |
| Молодість та служба при Мазепі | 600 | 900 |
| Обрання гетьманом в еміграції | 700 | 1050 |
| Конституція Пилипа Орлика: І — Політичний устрій | 600 | 900 |
| Конституція Пилипа Орлика: ІІ — Соціальні гарантії та контекст | 600 | 900 |
| Дипломатична діяльність | 800 | 1200 |
| Останні роки та спадщина | 800 | 1200 |
| Підсумок — Візія, що випередила час | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/pylyp-orlyk.yaml`. Go through EVERY `points:` item in EVERY section:
