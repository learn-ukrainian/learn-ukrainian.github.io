...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/yulian-bachynskyi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/yulian-bachynskyi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/yulian-bachynskyi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Юліан Бачинський: Теоретик незалежності** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Пророк незалежності | 500 | 750 |
| Галицьке походження: I — Формування поглядів | 500 | 750 |
| Галицьке походження: II — Соціалістичний бунт | 400 | 600 |
| Україна irredenta: I — Економічний детермінізм | 600 | 900 |
| Україна irredenta: II — Рецепція та критика | 600 | 900 |
| Соціалізм і національне питання: I — Теоретичний синтез | 500 | 750 |
| Соціалізм і національне питання: II — Полеміка | 400 | 600 |
| Політична діяльність | 600 | 900 |
| Еміграція та останні роки: I — Ілюзії радянофільства | 500 | 750 |
| Еміграція та останні роки: II — ГУЛАГ та смерть | 500 | 750 |
| Дискусія — Ідеї, що випереджають час | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/yulian-bachynskyi.yaml`. Go through EVERY `points:` item in EVERY section:
