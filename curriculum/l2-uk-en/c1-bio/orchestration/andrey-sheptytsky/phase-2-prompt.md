...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/andrey-sheptytsky-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/andrey-sheptytsky.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/andrey-sheptytsky.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Митрополит Андрей Шептицький: Пастир і рятівник** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Найвеличніший українець XX століття | 850 | 1275 |
| Від польського аристократа до українського митрополита | 850 | 1275 |
| Будівничий української церкви | 850 | 1275 |
| Політичні бурі | 850 | 1275 |
| Рятівник євреїв | 850 | 1275 |
| Смерть і спадщина | 850 | 1275 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/andrey-sheptytsky.yaml`. Go through EVERY `points:` item in EVERY section:
