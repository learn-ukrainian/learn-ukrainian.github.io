...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/roman-shukhevych-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/roman-shukhevych.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/roman-shukhevych.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Роман Шухевич: Головний командир УПА** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Легенда УПА | 850 | 1275 |
| Молодість і формування | 850 | 1275 |
| Друга світова війна | 850 | 1275 |
| Головний командир УПА | 850 | 1275 |
| Післявоєнний опір | 850 | 1275 |
| Спадщина та визнання | 850 | 1275 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/roman-shukhevych.yaml`. Go through EVERY `points:` item in EVERY section:
