...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/lina-kostenko-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/lina-kostenko.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/lina-kostenko.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Ліна Костенко: Королева поезії** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Голос, що не змовкає | 600 | 900 |
| Ранні роки та формування світогляду (1930-1956) | 800 | 1200 |
| Шістдесятництво: Епоха пробудження (1956-1965) | 800 | 1200 |
| Період великого мовчання (1965-1977) | 800 | 1200 |
| Тріумфальне повернення: «Маруся Чурай» (1979-1989) | 900 | 1350 |
| Голос незалежної України (1990-сьогодні) | 800 | 1200 |
| Поетика та філософські домінанти | 800 | 1200 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/lina-kostenko.yaml`. Go through EVERY `points:` item in EVERY section:
