...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/mykola-zerov-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/mykola-zerov.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/mykola-zerov.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Микола Зеров: <!-- Title -->** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ: Лідер київських неокласиків | 300 | 450 |
| Становлення інтелектуала: Від Зінькова до Києва | 400 | 600 |
| «Камена»: Поетичний маніфест строгої форми | 600 | 900 |
| Ad Fontes: Зеров як перекладач і критик | 600 | 900 |
| Літературна дискусія 1925–1928: Європа чи Просвітянство? | 600 | 900 |
| Професор КІНО: Легендарні лекції | 500 | 750 |
| Полювання на «бібліофагів»: Арешт і слідство | 500 | 750 |
| Соловки: Останній переклад Вергілія | 500 | 750 |
| Сандармох: Розстріляний геній | 500 | 750 |
| Спадщина та значення: Повернення Ad Fontes | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/mykola-zerov.yaml`. Go through EVERY `points:` item in EVERY section:
