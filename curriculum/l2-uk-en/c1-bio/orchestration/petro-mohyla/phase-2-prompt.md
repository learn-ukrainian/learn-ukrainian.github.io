...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/petro-mohyla-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/petro-mohyla.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/petro-mohyla.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Петро Могила: Засновник академії та реформатор церкви** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Архітектор українського бароко | 400 | 600 |
| Життєпис: I — Походження та освіта | 600 | 900 |
| Життєпис: II — Від воїна до митрополита | 600 | 900 |
| Історичний контекст | 600 | 900 |
| Внесок: I — Освітня реформа | 800 | 1200 |
| Внесок: II — Богословська спадщина | 800 | 1200 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/petro-mohyla.yaml`. Go through EVERY `points:` item in EVERY section:
