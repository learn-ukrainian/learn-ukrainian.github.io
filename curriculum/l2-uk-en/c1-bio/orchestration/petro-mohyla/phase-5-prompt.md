...
1. **Content** (the lesson you're reviewing): `# Петро Могила: Засновник академії та реформатор церкви
...
- type: select
  title: 'Аналіз стратегії Могили'
  instruction: 'Оберіть правильні інтерпретації історичних рішень.'
  items:
  - question: 'Чому Могила наполягав на вивченні латини?'
    options:
    - text: 'Вона була мовою міжнародної науки та дипломатії'
      correct: true
    - text: 'Він хотів перевести церкву в унію'
      correct: false
    - text: 'Він зневажав слов’янську мову як примітивну'
      correct: false
    - text: 'Це було вимогою польського короля'
      correct: false
  - question: 'У чому полягав конфлікт з консервативним козацтвом?'
    options:
    - text: 'Козаки ототожнювали латинську освіту з католицькою вірою'
      correct: true
    - text: 'Козаки хотіли військовий вишкіл замість риторики'
      correct: false
    - text: 'Могила відмовився святити зброю'
      correct: false
    - text: 'Козаки підтримували протестантів'
      correct: false
  - question: 'Який символічний зміст мали розкопки Десятинної церкви?'
    options:
    - text: 'Демонстрація безперервності київської традиції від Володимира'
      correct: true
    - text: 'Пошук скарбів для фінансування академії'
      correct: false
    - text: 'Бажання перебудувати церкву в бароковому стилі'
      correct: false
    - text: 'Виконання заповіту батька'
      correct: false
  - question: 'Чому "Православне сповідання віри" було написане латиною?'
    options:
    - text: 'Щоб його могли прочитати західні богослови та опоненти'
      correct: true
    - text: 'Могила не знав грецької достатньо добре'
      correct: false
    - text: 'Це була мода того часу'
      correct: false
    - text: 'Щоб приховати зміст від простих людей'
      correct: false
  - question: 'Яка роль відводилась "панегірикам" у навчанні?'
    options:
    - text: 'Це був засіб політичної комунікації та здобуття патронажу'
      correct: true
    - text: 'Це була просто розвага для студентів'
      correct: false
    - text: 'Це була форма молитви'
      correct: false
    - text: 'Це був спосіб вивчення географії'
      correct: false
  - question: 'У чому суть компромісу між Лаврою та Братством у 1632 році?'
    options:
    - text: 'Об’єднання ресурсів: гроші Лаври + легітимність Братства'
      correct: true
    - text: 'Створення нової церкви'
      correct: false
    - text: 'Розподіл сфер впливу в Києві'
      correct: false
    - text: 'Спільна боротьба проти уніатів'
      correct: false
  - question: 'Яке твердження найкраще описує "могилянський гуманізм"?'
    options:
    - text: 'Синтез античної спадщини, західної форми та східної духовності'
      correct: true
    - text: 'Повне заперечення релігії на користь науки'
      correct: false
    - text: 'Повернення до візантійського аскетизму'
      correct: false
    - text: 'Наслідування протестантської етики'
      correct: false
  - question: 'Чому Требник 1646 року важливий для етнографії?'
    options:
    - text: 'Він зафіксував народні обряди, надавши їм церковного статусу'
      correct: true
    - text: 'Він містив описи одягу та їжі'
      correct: false
    - text: 'Він заборонив усі народні звичаї як язичницькі'
      correct: false
    - text: 'Він був написаний розмовною мовою'
      correct: false
  - question: 'Як Могила ставився до унії?'
    options:
    - text: 'Він шукав порозуміння, але вимагав рівноправності церков'
      correct: true
    - text: 'Він був її фанатичним прихильником'
      correct: false
    - text: 'Він закликав до фізичного знищення уніатів'
      correct: false
    - text: 'Він ігнорував її існування'
      correct: false
  - question: 'Яке значення має термін "Київські Атени" (Атенеум)?'
    options:
    - text: 'Образ Києва як центру мудрості та наук'
      correct: true
    - text: 'Назва нового язичницького храму'
      correct: false
    - text: 'Назва театру при академії'
      correct: false
    - text: 'Гурток поетів-романтиків'
      correct: false

- type: translate
  title: 'Переклад термінів та понять'
  instruction: 'Оберіть правильний сучасний еквівалент для історичних/латинських термінів.'
  items:
  - source: 'Ratio Studiorum'
    options:
    - text: 'Система освіти'
      correct: true
    - text: 'Розум студента'
      correct: false
    - text: 'Студентський білет'
      correct: false
  - source: 'Infima'
    options:
    - text: 'Початковий клас'
      correct: true
    - text: 'Інфінітив дієслова'
      correct: false
    - text: 'Хворий студент'
      correct: false
  - source: 'Pauper'
  ...
  - source: 'Collegium'
    options:
    - text: 'Навчальний заклад'
      correct: true
    - text: 'Колекція книг'
      correct: false
    - text: 'Колега по роботі'
      correct: false
  - source: 'Unia'
    options:
    - text: 'Церковний союз'
  ...
  - source: 'Metropolita'
    options:
    - text: 'Глава церковної провінції'
      correct: true
    - text: 'Житель метрополії'
      correct: false
    - text: 'Метрополітен'
      correct: false
  - source: 'Euchologion'
    options:
    - text: 'Требник (книга молитов)'
      correct: true
    - text: 'Екологія'
      correct: false
    - text: 'Похвала'
...
- type: authorial-intent
  title: 'Аналіз заповіту Могили'
  source_reading: reading-01
  prompt: |
    Прочитайте уривок із заповіту Петра Могили:
    "Бачачи, що упадок святого благочестя... походить від відсутності освіти... я дав обітницю Богові... все своє майно... призначати на заснування шкіл".
    Яка головна інтенція автора? Як він пов'язує віру, освіту і меценатство? Які риторичні фігури він використовує для переконання нащадків?
  model_answer: |
    Інтенція Могили — забезпечити майбутнє свого "дітища" (колегіуму) через сакралізацію освіти. Він пов'язує занепад віри з невіглаством, роблячи освіту релігійним обов'язком, а меценатство — формою служіння Богу. Він використовує фігуру "обітниці" (клятви), щоб надати своєму рішенню незворотності та священного статусу.

- type: error-correction
  title: 'Виправлення історичних помилок'
  instruction: 'Знайдіть історичну неточність у твердженні та виправте її.'
  items:
  - sentence: 'Петро Могила заснував Києво-Могилянську академію у 1615 році.'
    error: '1615 році'
    answer: '1632 році'
    options:
    - '1632 році'
    ...
    - '1654 році'
    - '1701 році'
    explanation: 'У 1615 виникла Київська братська школа, а Могила створив колегіум у 1632 через злиття.'
  - sentence: 'Могила навчався у Краківському університеті та отримав ступінь доктора.'
    error: 'Краківському університеті'
    answer: 'західних університетах (ймовірно)'
    options:
    - 'західних університетах (ймовірно)'
    - 'Острозькій академії'
    - 'Московській академії'
    - 'Константинополі'
    explanation: 'Найімовірніше він навчався у Захочі та, можливо, у Парижі, але точних даних немає.'
  - sentence: 'Головною мовою викладання в академії була грецька.'
    error: 'грецька'
    answer: 'латина'
    options:
    - 'латина'
    ...
    - 'українська'
    - 'польська'
    explanation: 'Латина була мовою науки. Грецьку вивчали, але вона не була основною.'
  - sentence: 'Могила підтримував повстання Хмельницького проти Польщі.'
    error: 'підтримував повстання'
    answer: 'помер до його початку'
    options:
    - 'помер до його початку'
    - 'засуджував повстання'
    - 'очолив повстання'
    - 'фінансував козаків'
    explanation: 'Могила помер 1 січня 1647 року, а повстання почалося у 1648.'
  - sentence: 'Требник Могили був надрукований у Львові.'
    error: 'Львові'
    answer: 'Києві (Лаврі)'
    options:
    - 'Києві (Лаврі)'
    ...
    - 'Венеції'
    - 'Вільнюсі'
    explanation: 'Він був виданий у друкарні Києво-Печерської лаври, яку відновив Могила.'
  - sentence: 'Могила був першим українським патріархом.'
    error: 'патріархом'
    answer: 'митрополитом'
    options:
    - 'митрополитом'
    ...
    - 'гетьманом'
    - 'королем'
    explanation: 'Він мав титул Митрополита Київського, Галицького і всієї Русі.'
  - sentence: 'Собор 1642 року в Яссах засудив "Православне сповідання віри".'
    error: 'засудив'
    answer: 'затвердив (з правками)'
    options:
    - 'затвердив (з правками)'
    - 'спалив'
    - 'проігнорував'
    - 'переклав'
    explanation: 'Собор затвердив книгу як канонічну після богословських дискусій.'
  - sentence: 'Могила походив з простого козацького роду.'
    error: 'козацького'
    answer: 'молдавського княжого'
    options:
    - 'молдавського княжого'
    - 'шляхетського польського'
    - 'священичого'
    - 'міщанського'
    explanation: 'Він був сином господаря Молдови.'
  - sentence: 'Він заборонив використовувати народні традиції в церкві.'
    error: 'заборонив'
    answer: 'інтегрував'
    options:
    - 'інтегрував'
    ...
    - 'висміював'
    - 'знищив'
    explanation: 'Требник Могили включав багато народних обрядів.'
  - sentence: 'Могила був противником реставрації Святої Софії.'
    error: 'противником'
    answer: 'ініціатором'
    options:
    - 'ініціатором'
    ...
    - 'жертвою'
    - 'критиком'
    explanation: 'Він особисто ініціював і фінансував відновлення собору.'

- type: comparative-study
  title: 'Дві моделі освіти: Єзуїтська vs Могилянська'
  items_to_compare:
  - Єзуїтський колегіум
  ...
  prompt: |
    Порівняйте освітню модель єзуїтів та модель Петра Могили.
    У чому полягала подібність (форма), а в чому — принципова різниця (зміст)?
  model_answer: |
    Подібність полягала у використанні системи "Ratio Studiorum": поділ на класи, вивчення латини, риторики та філософії Арістотеля, використання шкільного театру та диспутів. Могила повністю запозичив форму.
...
- type: essay-response
  id: essay-01
  source_reading: reading-01
  title: 'Есе: Ідентичність через освіту'
  prompt: |
    Напишіть есе (300 слів) на тему:
  ...
  model_answer: |
    Петро Могила був "західником" за інструментами, але "східняком" за суттю. Його реформи — це класичний приклад культурного синтезу, характерного для українського бароко. Він не відмовлявся від православної ідентичності, а лише "переодягнув" її в сучасні європейські шати. Це дозволило українцям почуватися рівними в діалозі з Європою, не втрачаючи свого "Я".

- type: critical-analysis
  id: analysis-01
  source_reading: reading-01
  title: 'Аналіз тексту: Риторика Могили'
  target_text: 'Як воїн без зброї не може захистити вітчизну, так і пастир без освіти не може оборонити паству.'
  questions:
  - 'Яку метафору використовує автор для опису освіти? Чому вона була актуальною в XVII столітті?'
  - 'Як Могила обґрунтовує необхідність вивчення латини ("латинської вченості")?'
  - 'У чому полягає аргумент "істина одна"?'
  model_answers:
  - 'Освіта порівнюється зі зброєю. Це військова метафора, яка резонувала з тодішнім станом релігійної війни.'
  - 'Він стверджує, що знання мов необхідне для "вільного плавання в морі премудрості", тобто для доступу до світової науки.'
  - 'Це гуманістична ідея: знання є універсальним даром Божим, і неважливо, хто його відкрив — греки чи латиняни, головне — використати його на благо істини.'
  items:
  - prompt: 'Проаналізуйте стиль уривку. Які риси барокової риторики ви помітили?'
    model_answer: 'Текст насичений метафорами ("море премудрості", "вовки єресі"), антитезами (греки/латиняни, сліпа віра/наука). Це емоційний, переконливий стиль, спрямований на вплив.'
`
3. **Vocabulary**: `---
- lemma: академія
  ipa: /ɐkɐˈdɛmʲijɐ/
...
- lemma: требник
  ipa: /ˈtrɛbnɪk/
  translation: trebnyk (book of needs)
  pos: noun
  gender: m
  note: книга церковних обрядів
- lemma: катехизм
  ipa: /kɐteˈxɪzm/
  translation: catechism
  pos: noun
  gender: m
  note: виклад основ віри
- lemma: реформа
  ipa: /reˈfɔrmɐ/
  translation: reform
  pos: noun
  ...
  note: перетворення
- lemma: латинізація
  ipa: /lɐtɪnʲiˈzɑt͡sʲijɐ/
  translation: latinization
  pos: noun
  gender: f
  note: вплив латинської культури
- lemma: бароко
  ipa: /bɐˈrɔko/
  translation: baroque
  pos: noun
  gender: n
  note: стиль в мистецтві
- lemma: спудей
  ipa: /spuˈdɛi̯/
  translation: spudei (student)
  pos: noun
  gender: m
  note: студент академії
- lemma: друкарня
  ipa: /druˈkɑrnʲɐ/
  translation: printing house
  pos: noun
  gender: f
  note: місце виготовлення книг
- lemma: архімандрит
  ipa: /ɐrxʲimɐnˈdrɪt/
  translation: archimandrite
  pos: noun
  gender: m
  note: настоятель монастиря
- lemma: печера
  ipa: /peˈt͡ʃɛrɐ/
  translation: cave
  pos: noun
...
- lemma: святитель
  ipa: /sʲʋʲɐˈtɪtelʲ/
  translation: saint / hierarch
  pos: noun
  gender: m
  note: канонізований єпископ
- lemma: уніфікація
  ipa: /unʲifʲiˈkɑt͡sʲijɐ/
  translation: unification
  pos: noun
  gender: f
  note: приведення до одноманітності
- lemma: дискурс
  ipa: /dɪsˈkurs/
...
- lemma: легітимація
  ipa: /leɦitɪˈmɑt͡sʲijɐ/
  translation: legitimation
  pos: noun
  gender: f
  note: визнання законності
- lemma: реставрація
  ipa: /restɐu̯ˈrɑt͡sʲijɐ/
  translation: restoration
  pos: noun
  gender: f
  note: відновлення пам'ятки
- lemma: книгодрукування
  ipa: /knɪɦodruˈkuʋɐnʲnʲɐ/
  translation: book printing
  pos: noun
  gender: n
  note: виготовлення друкованих книг`
...
- b2-hist mohylianska-doba module
objectives:
...
build:
  last_modified: '2026-02-05'
`
6. **Research notes** (if exists): `# Research Notes: Петро Могила
