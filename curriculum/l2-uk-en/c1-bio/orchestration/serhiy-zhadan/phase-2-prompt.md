...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/serhiy-zhadan-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/serhiy-zhadan.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/serhiy-zhadan.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Сергій Жадан: Голос Донбасу** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Голос українського Сходу | 600 | 900 |
| Луганська юність — Старобільський фронтир | 700 | 1050 |
| Харківський андеграунд та бунт 90-х | 900 | 1350 |
| «Ворошиловград» та Революція Гідності | 900 | 1350 |
| Війна та «Інтернат» — Література «сірої зони» | 1000 | 1500 |
| Повномасштабне вторгнення та «Хартія» (2022–) | 900 | 1350 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/serhiy-zhadan.yaml`. Go through EVERY `points:` item in EVERY section:
