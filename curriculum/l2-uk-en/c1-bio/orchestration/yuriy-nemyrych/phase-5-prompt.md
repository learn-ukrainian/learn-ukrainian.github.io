...
1. **Content** (the lesson you're reviewing): `# Юрій Немирич: Дипломат і мислитель
...
> [!history-bite] **Немирич і «Роздуми про війну з московитами»**
...
> [!quote] **З Гадяцького трактату (1658)**
...
2. **Activities**: `---
- type: reading
  id: reading-nemyrych-01
  title: 'Аналіз первинного джерела: Фрагмент Гадяцького трактату'
  source: 'Гадяцький трактат (1658), переклад з латини'
  text: |
  ...
  tasks:
    - 'Які ключові атрибути суверенітету передбачав Гадяцький трактат для Великого Князівства Руського?'
    - 'Чому автори трактату наголошували на рівності релігій?'
    - 'Яку роль мали відігравати освітні установи в цьому проекті?'

- type: essay-response
  title: 'Есе: Гадяцька унія як альтернативна доля України'
  instruction: Напишіть аналітичне есе (400+ слів) про проект Немирича та його значення.
  prompt: Проаналізуйте Гадяцьку унію як спробу інтеграції України у європейський правовий простір. Чому цей проект зазнав
    невдачі і які уроки ми можемо винести з нього сьогодні?
  min_words: 400
  model_answer: 'Гадяцька унія 1658 року, розроблена Юрієм Немиричем, є однією з найцікавіших та водночас найтрагічніших сторінок
    української дипломатії. Це був проект, що пропонував альтернативу Переяславському вектору, намагаючись перетворити Україну
    на Велике Князівство Руське — повноправний суб''єкт триєдиної конфедерації.


    Інтелектуальна новизна проекту полягала у його правовому характері. Немирич, як людина європейської освіти, розумів, що
    суб''єктність нації забезпечується не лише силою зброї, а й міжнародним визнанням інституцій. Гадяч гарантував Україні
    власну армію, фінанси, суди та повну автономію в релігійних питаннях. Це була спроба легалізувати козацький стан як нову
    аристократію, інтегровану в європейську систему шляхетських свобод.


    Причини невдачі проекту були комплексними. З одного боку, польська еліта виявилася не готовою до реальної рівності з українцями,
    зволікаючи з ратифікацією та намагаючись обмежити права козацтва. З іншого боку, українське суспільство, виснажене війною,
    було вразливим до московської пропаганди, яка майстерно використовувала релігійні почуття та соціальний популізм для дискредитації
    «шляхетського» проекту Немирича.


    Сьогодні спадщина Немирича вчить нас важливості стратегічного візіонерства. Гадяцька унія доводить, що Україна завжди
    мала інтелектуальну альтернативу східній деспотії. Урок Немирича полягає в тому, що для успіху державницького проекту
    необхідна не лише геніальність лідерів, а й консолідація суспільства навколо спільних цінностей та розуміння довгострокових
    національних інтересів.

    '
  rubric:
  - criteria: Глибина аналізу
    description: Розуміння суті Гадяцької угоди та причин її краху
    points: 40
  - criteria: Академічний стиль
    description: Використання термінології C1 (федерація, ратифікація, легітимність)
    points: 30
  - criteria: Аргументація
    description: Логіка побудови доказів та висновків
    points: 30
- type: comparative-study
  title: 'Порівняльний аналіз: Переяслав vs Гадяч'
  instruction: Зіставте дві ключові угоди XVII століття за критеріями суверенітету.
  items_to_compare:
  ...
  prompt: «Оцініть ці документи за наведеними критеріями. Яка модель була більш модерною для того часу?»
  model_answer: Гадяцька унія була незрівнянно більш модерним та європейським документом, оскільки вона апелювала до права,
    а не до милості монарха. Переяславська модель базувалася на середньовічному принципі підданства, де права васала залежали
    від волі сюзерена. Гадяч же пропонував договірну основу, де права України були чітко зафіксовані та захищені інституційно.
    Трагедія полягає в тому, що менш досконала, але агресивніша московська модель виявилася сильнішою у воєнно-політичному
    протистоянні того періоду.
- type: true-false
  title: Аналіз історичних реалій та деконструкція маніпуляцій
  instruction: Визначте істинність тверджень про епоху Юрія Немирича.
  items:
  - statement: Гадяцька унія була спробою повернути Україну до стану безправної провінції Польщі.
    correct: false
    explanation: Навпаки, вона проголошувала Україну рівноправним Великим Князівством Руським у союзі з Польщею та Литвою.
  - statement: Юрій Немирич загинув під час битви під Конотопом, захищаючи гетьманську булаву.
    correct: false
    explanation: Він загинув пізніше від рук козацького натовпу, спровокованого московськими маніпуляціями.
  - statement: Маніфест Немирича до європейських володарів був однією з перших спроб системної інформаційної політики України.
    correct: true
    explanation: Так, він обґрунтовував право нації на свободу перед обличчям всього освіченого світу.
  - statement: Ідеї Немирича щодо триєдиної держави були надто прогресивними для свого часу і не знайшли повної підтримки
      еліт.
    correct: true
    explanation: І польська, і українська сторони мали значні внутрішні суперечності, що завадило реалізації проекту.
  - statement: Немирич вважав, що релігійна єдність із Москвою є важливішою за політичні свободи України.
    correct: false
    explanation: Він був прихильником свободи совісті та вважав московську модель деспотичною і ворожою українським вольностям.
  - statement: Гадяцька угода гарантувала збереження козацького війська чисельністю до 30 тисяч осіб.
    correct: true
    explanation: Це була одна з ключових воєнних умов угоди, що забезпечувала силовий суверенітет.
  - statement: Немирич пропонував скасувати всі козацькі вольності заради шляхетських привілеїв.
    correct: false
    explanation: Він прагнув поєднати козацькі права зі шляхетськими, створивши нову еліту.
  - statement: Угода була ратифікована польським Сеймом, але так і не почала діяти в повну силу.
    correct: true
    explanation: Ратифікація відбулася, але війна та внутрішній спротив завадили імплементації.
  - statement: Юрій Немирич був автором Конституції Пилипа Орлика.
    correct: false
    explanation: Це різні історичні діячі, хоча їхні ідеї перегукуються.
- type: true-false
  title: Перевірка знань про Гадяцьку унію
  instruction: Визначте правильність деталей договору 1658 року.
  items:
  - statement: Велике Князівство Руське мало мати власного канцлера та окремий трибунал.
    correct: true
    explanation: Це були ключові вимоги для забезпечення адміністративної та судової незалежності.
  - statement: Угода передбачала повне скасування Берестейської церковної унії на українських землях.
    correct: true
    explanation: Однією з умов була ліквідація унії та повернення прав православній церкві.
  - statement: Немирич пропонував зробити Київ столицею всієї Речі Посполитої замість Варшави.
    correct: false
    explanation: Київ мав стати столицею Великого Князівства Руського, а не всієї конфедерації.
  - statement: Гадяцький договір дозволяв Україні укладати самостійні союзи з іноземними державами без згоди Сейму.
    correct: false
    explanation: Зовнішня політика мала бути узгодженою в межах триєдиної держави, що було компромісом.
  - statement: Проект передбачав створення окремої грошової системи та карбування монети в Україні.
    correct: true
    explanation: Це було важливим атрибутом економічного суверенітету Великого Князівства Руського.
  - statement: Немирич був єдиним автором тексту Гадяцької угоди і не радився з жодним іншим дипломатом.
    correct: false
    explanation: Хоча він був ідеологом, над текстом працювала група дипломатів, включаючи Виговського.
  - statement: Ідея Великого Князівства Руського передбачала повну відмову від власних збройних сил.
    correct: false
    explanation: Навпаки, утверджувалося право на власну 30-тисячну козацьку армію.
  - statement: Соціальна база підтримки Гадяча була вузькою через недовіру рядового козацтва до шляхетських ідей.
    correct: true
    explanation: Елітарний характер проекту не був зрозумілий широким масам, що використала Москва.
- type: authorial-intent
  title: Аналіз стратегічних намірів Немирича
  instruction: Розкрийте приховані цілі дипломата у його проектах.
  text_excerpt: «Немирич наполягав на створенні університетів, вимагав права на власне карбування монети та писав маніфести
    латиною до європейських монархів.»
  prompt: Проаналізуйте наведені факти та визначте стратегічні цілі (intent) Немирича у кожному випадку.
  model_answer: «Створення університетів мало на меті формування незалежної інтелектуальної еліти. Карбування монети було
    атрибутом економічного суверенітету. Маніфести латиною легітимізували українську боротьбу в очах Європи.»
  techniques_to_identify:
  - «Інституційна розбудова»
  - «Економічний суверенітет»
  - «Культурна дипломатія»
- type: critical-analysis
  title: 'Критичний аналіз: Чому Гадяч не став реальністю?'
  instruction: Проаналізуйте комплекс причин провалу конфедеративного проекту.
  target_text: 'Гадяцький проект зазнав невдачі через комплекс причин: егоїзм польської шляхти, яка не змогла подолати колоніальне
    мислення; активне втручання Москви, що використовувала соціальний популізм; та брак часу для інституціоналізації в умовах
    війни.'
  questions:
  - «Проаналізуйте комплекс причин провалу конфедеративного проекту на основі наведеного тексту.»
  - «Як внутрішній розкол еліт вплинув на реалізацію Гадяцької угоди?»
  model_answers:
  - «Провал був зумовлений поєднанням внутрішньої неготовності суспільства (розкол еліт) та зовнішньої агресії. Польща не
    встигла змінити своє ставлення до українців як до рівних партнерів, а Москва вдало зіграла на соціальних протиріччях.»
  - «Внутрішній розкол послабив позиції гетьмана, дозволивши Москві використати опозицію для дестабілізації.»
`
3. **Vocabulary**: `---
- lemma: канцлер
  ipa: /kɐnˈt͡slɛr/
...
- lemma: протестантизм
  ...
  pos: noun
  gender: m
  note: напрям у християнстві
- lemma: аріанин
  ipa: /ɐrʲiˈɑnɪn/
  translation: Arian
  pos: noun
  gender: m
  note: послідовник аріанства
- lemma: федерація
  ipa: /fedeˈrɑt͡sʲijɐ/
...
- lemma: університет
  ...
  pos: noun
  gender: m
  note: вищий навчальний заклад
- lemma: толерантність
  ipa: /toleˈrɑntnʲisʲtʲ/
...
- lemma: конфедерація
  ipa: /kɔnfederˈɑt͡sʲijɐ/
  translation: confederation
  pos: noun
  gender: f
  note: союз рівних держав
- lemma: еліта
  ipa: /eˈlʲitɐ/
  translation: elite
  pos: noun
  gender: f
  note: вища верства суспільства
- lemma: інтелектуал
  ipa: /intɛlektuˈɑl/
  translation: intellectual
  pos: noun
  gender: m
  note: людина розумової праці`
...
- section: Вступ — Архітектор нездійсненної держави
  words: 600
  points:
  - Немирич як європейський інтелектуал
  - Роль у Гадяцькій унії
- section: Життєпис
  words: 1600
  points:
  - Європейська освіта
  - Перехід на бік козаків 1655 р.
  - Канцлер при Виговському
- section: Історичний контекст
  words: 600
  points:
  - Шляхетська vs козацька культура
...
- section: Підсумок
  words: 300
  points:
  - Немирич як пророк європейського шляху
word_target: 4300
vital_status: deceased
build:
  last_modified: '2026-02-05'`
6. **Research notes** (if exists): `# Research Notes: Юрій Немирич
