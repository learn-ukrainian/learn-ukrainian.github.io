...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/yuriy-nemyrych-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/yuriy-nemyrych.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/yuriy-nemyrych.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Юрій Немирич: Дипломат і мислитель** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Архітектор нездійсненної держави | 400 | 600 |
| Життєпис: I — Європейська освіта та ранні погляди | 500 | 750 |
| Життєпис: II — Від шляхтича до козацького канцлера | 500 | 750 |
| Історичний контекст: I — Криза Речі Посполитої | 400 | 600 |
| Історичний контекст: II — Протестантська етика та «Кепська реформація» | 400 | 600 |
| Внесок: I — Архітектура Гадяцької унії | 600 | 900 |
| Внесок: II — Дипломатичний фронт | 600 | 900 |
| Останні роки: I — Тріумф під Конотопом | 500 | 750 |
| Останні роки: II — Загибель візіонера | 500 | 750 |
| Спадщина: Проект «Сполучених Штатів Східної Європи» | 600 | 900 |
| Підсумок | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/yuriy-nemyrych.yaml`. Go through EVERY `points:` item in EVERY section:
