...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/kvitka-tsisyk-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/kvitka-tsisyk.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/kvitka-tsisyk.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Квітка Цісик: Голос української діаспори** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ: Голос двох світів | 400 | 600 |
| Дитинство і становлення: Між Нью-Йорком і Львовом | 800 | 1200 |
| Американська кар'єра: Голос на мільярд | 800 | 1200 |
| Альбом «Kvitka» (1980): Родинний проєкт | 800 | 1200 |
| Альбом «Two Colors» (1989): Духовний заповіт | 800 | 1200 |
| Боротьба і прощання: Останні роки | 500 | 750 |
| Спадщина: Повернення додому | 900 | 1350 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/kvitka-tsisyk.yaml`. Go through EVERY `points:` item in EVERY section:
