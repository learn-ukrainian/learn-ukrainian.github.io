...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/kazimir-malevich-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/kazimir-malevich.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/kazimir-malevich.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Казимир Малевич: Революція в мистецтві** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Чорний квадрат і нуль форми | 600 | 900 |
| Юність в Україні (1879-1904) | 800 | 1200 |
| Пошуки стилю та коріння (1904-1913) | 700 | 1050 |
| Супрематизм: Архітектура всесвіту (1913-1920) | 800 | 1200 |
| Радянський період: I — Київський ренесанс (1927-1930) | 900 | 1350 |
| Радянський період: II — Репресії та спектр Голодомору (1930-1935) | 800 | 1200 |
| Спадщина — Українець у світовому мистецтві | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/kazimir-malevich.yaml`. Go through EVERY `points:` item in EVERY section:
