...
1. **Content** (the lesson you're reviewing): `# Костянтин-Василь Острозький: Князь-Просвітник
...
> [!history-bite] **Титули і вага: Чому "некоронований король"?**
...
> [!source] **Свідоцтво сучасника про характер князя**
...
> [!source] **Лист Острозького до короля Сигізмунда II (1569)**
...
> [!myth-buster] **Чи був Острозький противником прогресу?**
...
> [!context] **"Волинські Афіни" проти "Римського універсалізму"**
...
> [!legacy] **Відроджена Академія: Тяглість крізь віки та стратегічна пам'ять**
...
2. **Activities**: `---
- type: reading
  id: reading-ostroh-bible
  title: "Передмова до Острозької Біблії"
  source: "Василь-Костянтин Острозький (1581)"
  text: "Я, Костянтин, Божою милістю князь Острозький, воєвода Київський, бачачи занепад віри православної через невігластво і відсутність книг святих, вирішив зібрати мужів вчених і друкарів майстерних. З багатьох країн далеких рукописи ми отримали, порівняли їх і очистили від помилок. І видали ми цю книгу для просвіти народу нашого, щоб кожна людина могла пізнати істину мовою слов'янською, яка є нам зрозумілою. Бо знання — це зброя проти темряви, а слово Боже — це щит для душі нашої."
  instruction: "Прочитайте уривок з передмови та зверніть увагу на мотиви меценатства князя."

- type: critical-analysis
  title: "Аналіз культурної стратегії Острозького"
  source_reading: reading-ostroh-bible
  target_text: "Бо знання — це зброя проти темряви, а слово Боже — це щит для душі нашої."
  questions:
  ...
  model_answers:
    - "Князь бачить у знаннях стратегічний інструмент ('зброя'), який ефективніший за фізичну силу в умовах інтелектуальної конкуренції з іншими конфесіями."
    - "Це свідчить про високий науковий рівень проекту; князь прагнув створити канонічний, бездоганний текст, який мав би незаперечний авторитет."
    - "Затвердження власної мови в релігійній сфері робило культуру самодостатньою, усуваючи потребу звертатися до латини чи польської як до єдиних мов 'високої' культури."
  focus_points:
    - "Academic register"
    - "Philological rigor"
...
- type: authorial-intent
  title: "Аналіз ідеології 'Волинських Афін'"
  source_reading: reading-ostroh-bible
  prompt: "Як створення Острозької академії та видання Біблії легітимізувало претензії князя Острозького на роль лідера православного світу Речі Посполитої?"
  techniques_to_identify:
    - "Використання патронату як джерела політичної ваги"
    - "Створення інтелектуального центру як альтернативи єзуїтським колегіумам"
    - "Апеляція до візантійської традиції в новому ренесансному контексті"
  model_answer: "Острозький створював 'державу в державі', де джерелом легітимності було не лише золото, а й духовне лідерство. Острог став альтернативним центром влади, де інтелектуали працювали на укріплення руської суб'єктності."

- type: comparative-study
  title: "Порівняння освітніх моделей: Острозька академія vs Єзуїти"
  source_reading: reading-ostroh-bible
  items_to_compare:
  ...
  model_answer: "Обидві моделі використовували сучасні методи, але Острозький намагався зберегти національний корінь через грецьку та слов'янську мови."

- type: essay-response
  title: "Есе: Чому книга сильніша за меч?"
  source_reading: reading-ostroh-bible
  instruction: "Напишіть роздум (300+ слів) про спадщину Острозького."
  prompt: "Оцініть твердження: 'Василь-Костянтин Острозький врятував українську націю від зникнення у XVII столітті'. Яку роль у цьому відіграли саме його культурні, а не політичні проекти? Використовуйте терміни: 'ідентичність', 'асиміляція', 'фундамент', 'еліта'."
  min_words: 300
  model_answer: "Культурний проект князя Острозького став тим фундаментом, на якому встояла українська ідентичність..."`
3. **Vocabulary**: `---
- lemma: академія
  ipa: /ɐkɐˈdɛmʲijɐ/
  translation: academy
...
- lemma: друкарня
  ...
  pos: noun
  gender: f
  note: підприємство для друку книг
- lemma: освіта
  ipa: /osˈʋʲitɐ/
  translation: education
  pos: noun
  gender: f
  note: знання, здобуті в школі чи академії
- lemma: полеміка
  ipa: /poˈlɛmʲikɐ/
  translation: polemics / debate
  pos: noun
  gender: f
  note: публічна дискусія
- lemma: унія
  ipa: /ˈunʲijɐ/
  translation: union
  pos: noun
...
- lemma: воєвода
  ipa: /ʋojeˈʋɔdɐ/
  translation: voivode / governor
  pos: noun
  gender: m
  note: голова воєводства
- lemma: меценат
  ipa: /met͡sɛˈnɑt/
  translation: philanthropist / patron of arts
  pos: noun
  gender: m
  note: покровитель культури
- lemma: реформація
  ipa: /reformˈɑt͡sʲijɐ/
  translation: Reformation
  pos: noun
  gender: f
  note: релігійний рух за оновлення церкви
- lemma: контрреформація
  ipa: /kontrreformˈɑt͡sʲijɐ/
  translation: Counter-Reformation
  pos: noun
  gender: f
  note: католицький рух проти реформації
- lemma: магнат
  ipa: /mɐɦˈnɑt/
  translation: magnate
  pos: noun
  gender: m
  note: багатий і впливовий аристократ
- lemma: просвітник
  ipa: /prosˈʋʲitnɪk/
  translation: enlightener
  pos: noun
  gender: m
  note: той, хто поширює знання
- lemma: конфесія
  ipa: /konfesʲˈijɐ/
  translation: confession / denomination
  pos: noun
  gender: f
  note: віросповідання
- lemma: маршалок
  ...
  pos: noun
  gender: m
  note: голова дворянства або сойму
- lemma: статут
  ipa: /stɐˈtut/
  translation: statute / charter
  pos: noun
  gender: m
  note: звід законів
- lemma: латинізація
  ...
  pos: noun
  gender: f
  note: перехід на латинську мову чи обряд
- lemma: ієрархія
  ipa: /ijerˈɑrxʲijɐ/
...
- lemma: гуманізм
  ...
  pos: noun
  gender: m
  note: течія, що цінує людську особистість
- lemma: схоластика
  ipa: /sxolˈɑstɪkɐ/
  translation: scholasticism
  pos: noun
  gender: f
  note: середньовічна релігійна філософія
- lemma: канон
  ipa: /kɐˈnɔn/
  translation: canon
  pos: noun
  gender: m
  note: сукупність правил чи священних книг
- lemma: тримовність
  ipa: /trɪˈmɔu̯nʲisʲtʲ/
  translation: trilingualism
  pos: noun
  gender: f
  note: володіння трьома мовами (грецька, латина, слов'янська)
- lemma: друкар
  ipa: /druˈkɑr/
  translation: printer
  pos: noun
  gender: m
  note: фахівець із друкарської справи
- lemma: резиденція
  ipa: /rezɪdˈɛnt͡sʲijɐ/
  translation: residence
  pos: noun
  gender: f
  note: місце проживання високої особи
- lemma: суб'єктність
  ipa: /subjekˈtnʲisʲtʲ/
  translation: agency / subjectivity
  pos: noun
  gender: f
  note: здатність бути суб'єктом дій
`
...
- section: Спадщина
  words: 317
- section: Підсумок — Урок національної суб'єктності та гідності
  words: 300
word_target: 4000
vital_status: deceased
build:
  last_modified: '2026-02-04'`
6. **Research notes** (if exists): `# Research Notes: Костянтин-Василь Острозький
