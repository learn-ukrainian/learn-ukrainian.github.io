...
> **Persona reminder:** You are Professor of Ukrainian Arts (biography). Write in the voice of TV Historian. Maintain this persona throughout — do not drift into generic AI tone.
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/petro-veskliaov-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/petro-veskliaov.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/petro-veskliaov.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Дід Панас: Казкар нації** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Дідусь усіх українських дітей | 600 | 900 |
| Театральний шлях: Від Пінхаса до Петра | 800 | 1200 |
| Народження легенди: Шлях до ефіру | 800 | 1200 |
| Українська мова в ефірі: Тихий спротив | 800 | 1200 |
| Легенди та міфи: «Отака... малята» | 600 | 900 |
| Самотність і пам'ять: Останні роки | 600 | 900 |
| Дискусія — Роль казки у вихованні | 800 | 1200 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/petro-veskliaov.yaml`. Go through EVERY `points:` item in EVERY section:
