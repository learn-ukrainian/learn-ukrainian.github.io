...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/hanna-barvinok-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/hanna-barvinok.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/hanna-barvinok.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Ганна Барвінок: Письменниця і етнографка** (c1-bio track).
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/hanna-barvinok.yaml`. Go through EVERY `points:` item in EVERY section:
