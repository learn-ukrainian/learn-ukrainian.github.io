...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/dmytro-vyshnevetsky-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/dmytro-vyshnevetsky.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/dmytro-vyshnevetsky.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Дмитро Вишневецький: Байда — Перший Гетьман** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Князь і Козак | 600 | 900 |
| Життєпис: I — Будівничий Хортиці (1550–1557) | 700 | 1050 |
| Життєпис: II — Московський маневр (1558–1561) | 600 | 900 |
| Життєпис: III — Молдовський похід і Загибель (1563–1564) | 700 | 1050 |
| Історичний контекст | 900 | 1350 |
| Внесок та Спадщина | 900 | 1350 |
| Порівняльний аналіз | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/dmytro-vyshnevetsky.yaml`. Go through EVERY `points:` item in EVERY section:
