...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/ivan-puliui-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/ivan-puliui.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/ivan-puliui.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Іван Пулюй: Першовідкривач X-променів** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Світовий геній української науки | 400 | 600 |
| Життєпис: I — Коріння та становлення | 500 | 750 |
| Життєпис: II — Від фізики до астрофізики | 500 | 750 |
| Історичний контекст: Епоха пари та електрики | 400 | 600 |
| Внесок: I — Таємниця невидимих променів | 800 | 1200 |
| Внесок: II — Електротехнічна революція | 500 | 750 |
| Духовна місія: Слово Боже живою мовою | 700 | 1050 |
| Останні роки: Громадський діяч і патріот | 500 | 750 |
| Спадщина: Повернення із забуття | 500 | 750 |
| Підсумок: Феномен Івана Пулюя | 300 | 450 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/ivan-puliui.yaml`. Go through EVERY `points:` item in EVERY section:
