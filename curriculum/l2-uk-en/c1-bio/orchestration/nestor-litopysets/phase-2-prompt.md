...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/nestor-litopysets-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/nestor-litopysets.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/nestor-litopysets.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Нестор Літописець: Батько української історіографії** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Життєпис: І — Шлях до Печерської обителі | 450 | 675 |
| Життєпис: ІІ — Духовне становлення | 450 | 675 |
| Внесок: І — Повість минулих літ | 600 | 900 |
| Внесок: ІІ — Агіографічна спадщина | 500 | 750 |
| Внесок: ІІІ — Методологія та джерела | 500 | 750 |
| Останні роки: І — Політичні бурі | 400 | 600 |
| Останні роки: ІІ — Проблема редакцій | 400 | 600 |
| Спадщина: І — Від козаків до сучасності | 500 | 750 |
| Спадщина: ІІ — Деколонізація пам'яті | 500 | 750 |
| Підсумок | 300 | 450 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/nestor-litopysets.yaml`. Go through EVERY `points:` item in EVERY section:
