...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/yuriy-ruf-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/yuriy-ruf.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/yuriy-ruf.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Юрій Руф** (c1-bio track).
...
| Націоналістичний інтелектуал та воїн: I — Феномен «Духу Нації» | 1000 | 1500 |
| Націоналістичний інтелектуал та воїн: II — Ідеологія в дії | 800 | 1200 |
| Формування патріотичного світогляду: I — Поезія як зброя | 1000 | 1500 |
| Формування патріотичного світогляду: II — Світоглядні імперативи | 800 | 1200 |
| Деколонізаційна перспектива: I — Ментальна деокупація | 800 | 1200 |
| Деколонізаційна перспектива: II — Розстріляне Відродження 2.0 | 800 | 1200 |
| Підсумок та спадщина | 800 | 1200 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/yuriy-ruf.yaml`. Go through EVERY `points:` item in EVERY section:
