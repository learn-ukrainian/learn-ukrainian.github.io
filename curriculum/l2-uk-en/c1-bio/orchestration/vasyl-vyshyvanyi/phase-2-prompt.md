...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/vasyl-vyshyvanyi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/vasyl-vyshyvanyi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/vasyl-vyshyvanyi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Василь Вишиваний: Князь-українець** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Ерцгерцог, що обрав Україну | 350 | 525 |
| Імперське дитинство: Між Віднем і Пулою | 400 | 600 |
| Українське пробудження: Гуцульщина і Грушевський | 400 | 600 |
| Народження Василя Вишиваного: Легіон УСС | 500 | 750 |
| Операція «Король України»: 1918 рік | 450 | 675 |
| Полковник Армії УНР: Вірність присязі | 400 | 600 |
| Літературний фронт: Збірка «Минають дні» | 350 | 525 |
| Міжвоєнна одіссея: Париж, афери та політика | 450 | 675 |
| Тіні війни: Контакти з ОУН та Рухом Опору | 450 | 675 |
| Викрадення у Відні: Операція СМЕРШу | 400 | 600 |
| Голгофа у Києві: Допити та загибель | 450 | 675 |
| Дискусія — Національний вибір проти крові | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/vasyl-vyshyvanyi.yaml`. Go through EVERY `points:` item in EVERY section:
