...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/hryhoriy-skovoroda-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/hryhoriy-skovoroda.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/hryhoriy-skovoroda.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Григорій Сковорода: Мандрівний філософ** (c1-bio track).
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/hryhoriy-skovoroda.yaml`. Go through EVERY `points:` item in EVERY section:
