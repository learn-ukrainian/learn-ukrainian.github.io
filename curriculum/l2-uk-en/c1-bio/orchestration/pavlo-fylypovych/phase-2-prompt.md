...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/pavlo-fylypovych-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/pavlo-fylypovych.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/pavlo-fylypovych.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Павло Филипович: <!-- Title -->** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Poet, Neoclassicist | 850 | 1275 |
| Ранні роки та становлення | 850 | 1275 |
| Творчий шлях та основні здобутки | 850 | 1275 |
| Роль у Розстріляному відродженні | 850 | 1275 |
| Переслідування та трагічна доля | 850 | 1275 |
| Спадщина та значення | 850 | 1275 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/pavlo-fylypovych.yaml`. Go through EVERY `points:` item in EVERY section:
