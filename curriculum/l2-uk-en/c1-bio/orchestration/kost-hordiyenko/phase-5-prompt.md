...
1. **Content** (the lesson you're reviewing): `# Кость Гордієнко: Запорозький кошовий
...
> [!source] **Запорозькі статті Конституції 1710 року**
...
> [!analysis] **Демократія проти Абсолютизму**
...
> [!history-bite] **Чортомлицька трагедія**
...
> [!context] **Трагічна доля Січі після Гордієнка**
...
> [!myth-buster] **Чи був Гордієнко «зрадником» царя?**
...
> [!legacy] **Хранитель вічної волі над сивим Дніпром**
...
2. **Activities**: `---
- type: essay-response
  title: 'Есе: Кость Гордієнко та генезис української демократії'
  instruction: Напишіть глибокий аналітичний нарис (400+ слів) про внесок Гордієнка у формування правової культури України.
  prompt: Проаналізуйте роль Костя Гордієнка у трансформації Запорозької Січі з військового осередку в політичний суб'єкт. Яким чином його республіканські ідеї відобразилися в Конституції Пилипа Орлика?
  min_words: 400
  model_answer: |
  ...
  rubric:
    - criteria: Аргументація
      description: Глибина аналізу республіканських ідей Гордієнка
      points: 40
    - criteria: Стилістика
      description: Використання академічного регістру та термінології C1
      points: 30
    - criteria: Контекстуалізація
      description: Зв'язок із Конституцією Орлика та сучасністю
      points: 30

- type: comparative-study
  title: 'Порівняльний аналіз: Сірко vs Гордієнко'
  items_to_compare:
    - Іван Сірко (XVII ст.)
...
- type: true-false
  title: Деконструкція міфів про запорозький спротив
  instruction: Визначте істинність тверджень, спираючись на аналіз реальної політики XVIII ст.
  items:
    - statement: Кость Гордієнко перейшов на бік Мазепи виключно через особисту образу на Петра I.
      correct: false
      explanation: Це був свідомий політичний вибір на користь збереження суверенітету України, а не приватна помста.
    - statement: Знищення Чортомлицької Січі у 1709 році було актом терору, спрямованим на залякування прихильників Гордієнка.
      correct: true
      explanation: Москва використовувала брутальну силу для ліквідації осередку українського вільнодумства.
    - statement: Гордієнко вважав, що союз із мусульманським Кримом є неможливим для православного козака.
      correct: false
      explanation: Отаман був реальним політиком і успішно укладав альянси з Кримом проти московської експансії.
    - statement: У Бендерах Гордієнко був одним із співавторів фундаментальних статей Конституції 1710 року.
      correct: true
      explanation: Його вплив забезпечив документу сильний республіканський та демократичний характер.
    - statement: Олешківська Січ під проводом Гордієнка повністю відмовилася від козацьких традицій на користь турецьких.
      correct: false
      explanation: Навпаки, саме там були збережені та законсервовані автентичні запорозькі звичаї та устрій.
    - statement: Гордієнко вільно володів латиною і міг вести переговори з європейцями без перекладачів.
      correct: true
      explanation: Його освіта дозволяла йому бути повноцінним учасником європейського дипломатичного процесу.
    - statement: Гордієнко заборонив будь-яку торгівлю з Гетьманщиною через особисту неприязнь до Мазепи.
      correct: false
      explanation: До 1709 року відносини були складними, але прагматичними, а пізніше - союзними.
    - statement: Січ під його керівництвом перетворилася на центр міжнародних інтриг проти Московського царства.
      correct: true
      explanation: Гордієнко активно формував антимосковські коаліції, використовуючи всі дипломатичні канали.
    - statement: Кость Гордієнко ніколи не визнавав влади російських царів над Запорожжям як легітимної.
      correct: true
      explanation: Він послідовно обстоював тезу про те, що Січ є вільною республікою, підвладною лише Богу і праву.

- type: true-false
  title: Деталі запорозької дипломатії
  instruction: Перевірка знань про міжнародні контакти Костя Гордієнка.
  items:
    - statement: Гордієнко наполягав на тому, щоб шведський король гарантував права Січі окремим пунктом договору.
      correct: true
      explanation: Отаман діяв як професійний дипломат, забезпечуючи правовий захист своїй громаді.
    - statement: Після 1709 року Гордієнко прийняв пропозицію царя повернутися в Україну за умови амністії.
      correct: false
      explanation: Він ніколи не довіряв обіцянкам Москви і продовжував боротьбу до кінця життя.
    - statement: Костя Гордієнка кілька разів переобирали кошовим, що свідчило про його колосальну підтримку.
      correct: true
      explanation: Його авторитет на Січі базувався на вірності традиціям та особистій мудрості.
    - statement: Отаман виступав проти будь-яких союзів із кримськими татарами через релігійні причини.
      correct: false
      explanation: Він успішно співпрацював із Кримом у межах антимосковської стратегії.
    - statement: Гордієнко вважав, що Гетьманщина має бути повністю підпорядкована Запорозькій Січі.
      correct: false
      explanation: Він боровся за рівноправне партнерство та союз двох гілок української влади.
    - statement: Гордієнко використовував Кримське ханство як ситуативного союзника проти Москви.
      correct: true
      explanation: Це була вимушена, але ефективна стратегія для збереження Січі в умовах оточення.
    - statement: Олешківська Січ мала статус незалежної держави, визнаної всіма європейськими країнами.
      correct: false
      explanation: Вона перебувала під протекцією Криму і мала автономію, але не повну державну незалежність.
    - statement: Козаки під проводом Гордієнка брали участь у Прутському поході 1711 року.
      correct: true
      explanation: Запорожці були важливою частиною антимосковської коаліції у цій війні.

- type: authorial-intent
  title: Аналіз стратегічних намірів отамана
  instruction: Розкрийте приховані цілі Гордієнка у його політичних маневрах.
  text_excerpt: |
    Отаман затягував переговори з московськими послами, посилаючись на рішення Ради. Він наполягав на включенні Січі до тексту Конституції Пилипа Орлика. Також він заснував Олешківську Січ саме на кордоні з Кримським ханством, зберігаючи мобільність війська.
  prompt: Які стратегічні наміри приховувались за цими діями?
  model_answer: |
    Гордієнко прагнув виграти час для підготовки союзу з Мазепою, юридично закріпити статус Запорожжя як невід'ємної частини незалежної України та створити плацдарм для майбутнього визволення українських земель. Дипломатичне зволікання дозволяло йому уникати передчасного конфлікту, поки сили союзу ще формувалися. Заснування Січі в Олешках було стратегічним рішенням для збереження військової бази поза межами досяжності московської армії, але в межах досяжності українського Правобережжя.

- type: critical-analysis
  title: 'Критичний аналіз: Гордієнко як контр-еліта'
  instruction: Проаналізуйте роль отамана у стримуванні московської експансії.
  target_text: |
    Гордієнко виступав як альтернативний центр сили, що не дозволяв Москві повністю контролювати південь України. Його опозиція до Петра I була не просто бунтом, а боротьбою за збереження демократичної моделі суспільства. Він зумів зберегти запорозьку ідентичність навіть в умовах територіальної втрати Січі та вигнання. Його діяльність заклала традицію політичної опозиції, яка базується на правових засадах, а не на особистій лояльності.
  questions:
  ...
  model_answers:
    - Він створив альтернативний політичний центр, який кидав виклик монополії Москви на владу, використовуючи легітимність козацького звичаю.
    - Завдяки йому козацька демократія та правова традиція вижили в еміграції, ставши основою для майбутнього відродження та не дозволивши запорожцям асимілюватися.
    - Це заклало фундамент для розуміння України як республіки, де влада обмежена законом, що стало ключовим елементом сучасної національної свідомості.

- type: reading
  id: reading-constitution-1710
  title: 'Конституція Пилипа Орлика: Аналіз Першоджерела'
  source: Пилип Орлик, Кость Гордієнко (1710)
  text: |
...
- type: critical-analysis
  source_reading: reading-constitution-1710
  title: 'Текстуальний аналіз Конституції'
  instruction: 'Проаналізуйте уривок з Конституції 1710 року.'
  target_text: 'Оскільки народ, що колись звався хозарським... має бути відновлене у своїх стародавніх правах та привілеях...'
  questions:
  ...
  model_answers:
    - Документ виводить походження козаків від войовничих хозар та гетів, створюючи міф про давню державність та неперервність прав.
    - Вимагається повне очищення запорозьких земель від московських гарнізонів та виключне право власності на весь Дніпро від Переволочної до гирла.
    - Пункт про невтручання урядів Гетьманщини у вибори кошового отамана та внутрішній устрій Війська Низового забезпечує його автономію.
    - Цей термін апелює до «природного права» та історичної справедливості, роблячи повстання не заколотом, а актом відновлення законного ладу.`
3. **Vocabulary**: `---
- lemma: отаман
  ipa: /otɐˈmɑn/
...
- lemma: протекторат
  ...
  pos: noun
  gender: m
  note: заступництво держави
- lemma: вигнання
  ipa: /vɪɦˈnɑnnʲɐ/
  translation: exile
  pos: noun
  gender: n
  note: життя поза Батьківщиною
- lemma: курінь
  ipa: /kuˈrʲinʲ/
  translation: kurin (barracks)
  pos: noun
  gender: m
  note: козацька житлова одиниця
- lemma: булава
  ipa: /bulɐˈʋɑ/
  translation: mace
  pos: noun
...
- lemma: поріг
  ipa: /poˈrʲiɦ/
  translation: rapid (on river)
  pos: noun
  gender: m
  note: Дніпрові пороги
- lemma: візіонер
  ipa: /ʋʲizʲiɔˈnɛr/
  translation: visionary
  pos: noun
  gender: m
  note: людина з баченням майбутнього
- lemma: суб'єктність
  ipa: /suˈbjɛktnʲisʲtʲ/
  translation: agency / subjectivity
  pos: noun
  gender: f
  note: здатність до самостійної дії
- lemma: меморіал
  ipa: /mɛmɔrʲiˈɑl/
...
- lemma: курган
  ipa: /kurˈɦɑn/
  translation: kurgan / barrow
  pos: noun
  gender: m
  note: високий насип над могилою
- lemma: непохитність
  ipa: /nɛpɔˈxɪtnʲisʲtʲ/
  translation: steadfastness
  pos: noun
  gender: f
  note: твердість у переконаннях
- lemma: кон'юнктура
  ipa: /kɔnjunkˈturɐ/
  translation: conjuncture / situation
  pos: noun
  gender: f
  note: обставини, що склалися
- lemma: аскетизм
  ipa: /ɐskɛˈtɪzm/
...
- b2-hist mazepa-war module
connects_to:
- c1-bio-28 (Пилип Орлик)
...
- section: Останні роки
  words: 400
  points:
  - Олешківська та Кам'янська Січі
  - Смерть 1733 р.
- section: Спадщина
  words: 400
  points:
...
`
6. **Research notes** (if exists): `# Research Notes: Кость Гордієнко
...
At module 28, students know ONLY modules 1-27. Any grammar from later modules is scope creep.
