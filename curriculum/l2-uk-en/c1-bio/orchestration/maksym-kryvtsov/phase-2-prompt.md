...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/maksym-kryvtsov-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/maksym-kryvtsov.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/maksym-kryvtsov.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Максим Кривцов** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ: Поет, що став воїном | 400 | 600 |
| Історичний контекст: Покоління вибору | 400 | 600 |
| Поет у камуфляжі: Творчий метод | 500 | 750 |
| «Вірші з бійниці»: Поетика фронтового побуту | 700 | 1050 |
| Символізм природи і тіла у ліриці | 500 | 750 |
| Рудий кіт: Метафора людяності | 400 | 600 |
| Деколонізаційна перспектива: Нове Розстріляне Відродження | 500 | 750 |
| Суб'єктність воїна-митця | 400 | 600 |
| Загибель і безсмертя: 7 січня 2024 року | 400 | 600 |
| Спадщина: Голос, що переміг смерть | 400 | 600 |
| Висновки та рефлексія | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/maksym-kryvtsov.yaml`. Go through EVERY `points:` item in EVERY section:
