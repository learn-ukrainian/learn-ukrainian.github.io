...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/volodymyr-vakulenko-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/volodymyr-vakulenko.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/volodymyr-vakulenko.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Володимир Вакуленко** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ та контекст | 800 | 1200 |
| Життя та мучеництво в Ізюмі: Хроніка окупації | 700 | 1050 |
| Життя та мучеництво в Ізюмі: Могила №319 | 700 | 1050 |
| Щоденник окупації: Голос з-під землі — Рукопис | 600 | 900 |
| Щоденник окупації: Голос з-під землі — Знахідка | 600 | 900 |
| Деколонізаційна перспектива: Зв'язок з Розстріляним Відродженням 1930-х | 800 | 1200 |
| Деколонізаційна перспектива: Українська суб'єктність та опір | 700 | 1050 |
| Підсумок та спадщина | 700 | 1050 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/volodymyr-vakulenko.yaml`. Go through EVERY `points:` item in EVERY section:
