...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/mykhailo-boichuk.yaml
```

Read the current meta file for content_outline structure:

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/mykhailo-boichuk.yaml
```

## Your Task

Research **Михайло Бойчук: <!-- Title -->** for the **c1-bio** track. Produce structured research notes that will drive content writing in later phases.
