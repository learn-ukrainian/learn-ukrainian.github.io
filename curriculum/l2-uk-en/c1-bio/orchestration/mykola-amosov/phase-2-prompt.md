...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/mykola-amosov-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/mykola-amosov.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/mykola-amosov.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Микола Амосов: Хірург і філософ здоров'я** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Лікар, який лікував Україну | 400 | 600 |
| Молодість і війна: Інженерна логіка в медицині | 500 | 750 |
| Хірургія під вогнем: Тисячі врятованих життів | 500 | 750 |
| Становлення кардіохірурга: Київський прорив | 600 | 900 |
| Наукові досягнення: Від скальпеля до кібернетики | 600 | 900 |
| Філософ здоров'я: «Роздуми про здоров'я» | 600 | 900 |
| Експеримент над собою: Межі людських можливостей | 500 | 750 |
| Громадянська позиція: Українець за вибором | 500 | 750 |
| Спадщина лікаря-мислителя: Інститут і пам'ять | 400 | 600 |
| Висновки: Людина, яка випередила час | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/mykola-amosov.yaml`. Go through EVERY `points:` item in EVERY section:
