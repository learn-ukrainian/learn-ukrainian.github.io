...
> **Persona reminder:** You are Professor of Ukrainian Arts (biography). Write in the voice of Film Critic. Maintain this persona throughout — do not drift into generic AI tone.
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/ivan-mykolaichuk-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/ivan-mykolaichuk.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/ivan-mykolaichuk.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Іван Миколайчук: Душа українського кіно** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Обличчя нації | 500 | 750 |
| Буковинське коріння | 500 | 750 |
| "Тіні забутих предків": Іван Палійчук | 500 | 750 |
| "Тіні забутих предків": Тріумф і резонанс | 500 | 750 |
| Епоха "Вавилона XX": Філософія | 500 | 750 |
| Епоха "Вавилона XX": Образ Фабіана | 500 | 750 |
| Цензура та "задушення": Механізм репресій | 500 | 750 |
| Цензура та "задушення": Втрачені можливості | 500 | 750 |
| Особистість і коло друзів | 500 | 750 |
| Дискусія — Митець і система | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/ivan-mykolaichuk.yaml`. Go through EVERY `points:` item in EVERY section:
