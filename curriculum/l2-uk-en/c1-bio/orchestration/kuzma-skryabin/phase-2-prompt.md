...
> **Persona reminder:** You are Professor of Ukrainian Arts (biography). Write in the voice of Music Journalist. Maintain this persona throughout — do not drift into generic AI tone.
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/kuzma-skryabin-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/kuzma-skryabin.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/kuzma-skryabin.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Кузьма Скрябін: Голос народу** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Свій хлопець | 300 | 450 |
| Ранні роки та «Скрябін»: I — Галицький фундамент | 400 | 600 |
| Ранні роки та «Скрябін»: II — Еволюція стилю | 400 | 600 |
| Телебачення і гумор: I — Епоха «Шансу» | 400 | 600 |
| Телебачення і гумор: II — Естетика суржику | 400 | 600 |
| Літературна творчість: I — «Я, Побєда і Берлін» | 400 | 600 |
| Літературна творчість: II — «Я, Паштєт і Армія» | 350 | 525 |
| Громадянська позиція та війна: I — Від аполітичності до протесту | 400 | 600 |
| Громадянська позиція та війна: II — Невидимий фронт волонтерства | 500 | 750 |
| Громадянська позиція та війна: III — Останні інтерв'ю | 400 | 600 |
| Загибель і пам'ять: I — Трагічний фінал | 300 | 450 |
| Загибель і пам'ять: II — Герой України | 350 | 525 |
| Дискусія — Роль митця в час війни | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/kuzma-skryabin.yaml`. Go through EVERY `points:` item in EVERY section:
