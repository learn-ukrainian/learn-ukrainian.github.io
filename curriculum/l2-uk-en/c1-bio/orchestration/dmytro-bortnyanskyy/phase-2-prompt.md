...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/dmytro-bortnyanskyy-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/dmytro-bortnyanskyy.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/dmytro-bortnyanskyy.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Дмитро Бортнянський: Придворний маестро** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Між Україною та імперією | 500 | 750 |
| Глухівське походження | 600 | 900 |
| Італійські роки | 600 | 900 |
| Придворна кар'єра: I — Шлях до вершини | 500 | 750 |
| Придворна кар'єра: II — Реформатор | 500 | 750 |
| Музична спадщина: I — Духовний всесвіт | 600 | 900 |
| Музична спадщина: II — Світські горизонти | 500 | 750 |
| Спірне питання ідентичності | 700 | 1050 |
| Підсумок — Між світами | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/dmytro-bortnyanskyy.yaml`. Go through EVERY `points:` item in EVERY section:
