...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/vasyl-stefanyk-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/vasyl-stefanyk.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/vasyl-stefanyk.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Василь Стефаник: Слово як крик душі** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Найсильніший новеліст | 600 | 900 |
| Покутське дитинство: Русів і родина | 800 | 1200 |
| Краківський студент: Інтелектуальний прорив | 1000 | 1500 |
| Період «мовчання» та політична трибуна | 1000 | 1500 |
| Повернення до слова і останні роки | 800 | 1200 |
| Поетика болю: Аналіз стилю | 800 | 1200 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/vasyl-stefanyk.yaml`. Go through EVERY `points:` item in EVERY section:
