...
1. **Content** (the lesson you're reviewing): `# Йов Борецький: Захисник православ'я
...
> [!history-bite] **1620: Рік духовного спецназу та козацького захисту**
...
> [!analysis] **Школа як бастіон ідентичності**
...
> [!context] **Унія як цивілізаційний виклик та шлях до ідентичності**
...
> [!source] **«Протестація» Йова Борецького (1621)**
...
> [!legacy] **Етнарх без держави: Роль у формуванні нації**
...
2. **Activities**: `---
- type: reading
  id: reading-protestatio-boretskyi
  title: "«Протестація» Іова Борецького (1621)"
  source: "Адаптація маніфесту XVII століття"
  text: >
    «Ми — нащадки того славетного народу руського, що хрестився за Володимира Великого. Наша віра — це не просто сукупність обрядів, це наше природне право на існування як вільних людей у своїй Богом даній державі. Ми не просимо ласки, ми вимагаємо справедливості. Козацтво наше — це не розбійники, як ви кажете, а прямі спадкоємці воїнства давніх київських князів, що захищали цю землю від поган. 
  ...
  instruction: "Прочитайте уривок із знаменитої «Протестації» та проаналізуйте її політичний пафос."

- type: critical-analysis
  title: "Аналіз політичного маніфесту"
  source_reading: reading-protestatio-boretskyi
  target_text: "Ми не просимо ласки, ми вимагаємо справедливості."
  questions:
  ...
  model_answers:
    - "Борецький апелює до тяглості від часів Володимира Великого, стверджуючи, що православна церква є корінною інституцією, а не новотвором. Це робить претензії влади Речі Посполитої історично безпідставними."
    - "Це була революційна ідея 'козацького міфу'. Вона надавала козакам високого соціального та історичного статусу, перетворюючи їх з найманців на захисників національної честі та віри."
    - "Протиставляються 'ласка' (милість монарха) та 'справедливість' (природне право). Борецький переходить від прохальної позиції до вимоги визнання суб'єктності народу."
  focus_points:
    - "Historical continuity"
    - "Social status of Cossacks"
    - "Rhetoric of defiance"

- type: authorial-intent
  title: "Задум Іова Борецького як етнарха"
  text_excerpt: >
    «Ми відновили свою ієрархію не для бунту, а для того, щоб не бути вівцями без пастиря».
  prompt: "Чому Борецький використовує біблійну метафору 'вівці без пастиря' у документі, адресованому світській владі (Сейму)?"
  model_answer: "Ця метафора має подвійний зміст. З одного боку, вона знімає звинувачення у політичному бунті, подаючи відновлення ієрархії як суто релігійну потребу. З іншого боку, для XVII століття відсутність ієрархії означала дезорганізацію всього суспільного життя православних. Борецький натякає, що лише легітимна церковна влада може гарантувати соціальний спокій та лояльність народу."

- type: reading
  id: reading-brotherhood-education
  title: "Братства та освітній штурм"
  source: "Нарис з історії української освіти"
  text: >
  ...
  instruction: "Вивчіть роль братського руху у створенні українського освітнього фундаменту."

- type: comparative-study
  title: "Іов Борецький та Петро Могила"
  items_to_compare:
  ...
  model_answer: "Борецький діяв як 'революціонер', відновивши ієрархію таємно і всупереч волі короля, спираючись на збройну силу козацтва. Могила діяв як 'дипломат-реформатор', легалізуючи церкву через Сейм та системно перебудовуючи її за західним зразком. Без радикального прориву Борецького системні реформи Могили не мали б фундаменту."

- type: essay-response
  title: "Есе: Освіта як зброя національного виживання"
  instruction: "Напишіть аналітичне есе (400-500 слів)."
  prompt: "Проаналізуйте вислів: 'Київська братська школа була фортецею, де замість гармат була книга'. Як стратегія Іова Борецького щодо розвитку освіти допомогла українцям зберегти ідентичність в умовах відсутності власної держави?"
  min_words: 400
  model_answer: >
    Стратегія Іова Борецького базувалася на глибокому розумінні того, що в умовах бездержавності головним полем битви за майбутнє є свідомість еліти. Його вислів про школу як фортецю не є простою метафорою — це була реальна політична доктрина. 
...
- type: critical-analysis
  title: "Аналіз церковно-козацького союзу"
  target_text: "Митрополит Іов Борецький зумів переконати гетьмана Петра Сагайдачного вступити до Київського братства разом із усім Військом Запорозьким."
  questions:
    - "Які політичні наслідки мав цей крок для православної церкви?"
    - "Як цей союз змінив характер самого козацтва?"
  model_answers:
    - "Церква отримала реальну воєнну силу, що зробило її суб'єктом, з яким польський уряд мусив рахуватися. Це унеможливило повну ліквідацію православ'я силовими методами."
    - "Козацтво перестало бути просто станом професійних воїнів і здобуло високу ідеологічну місію — захист віри та нації. Це перетворило козаків на політичну еліту України."
  focus_points:
    - "Military-spiritual synergy"
    - "Political evolution of Cossacks"

- type: reading
  id: reading-polemics-style
  title: "Стилістика українського бароко"
  source: "Літературознавчий аналіз"
  text: >
    Тексти Іова Борецького є вершиною полемічного стилю. Вони характеризуються надзвичайною емоційною напругою, використанням риторичних запитань та складних метафор. Він поєднує церковнослов'янську лексику (для надання сакральності) з латинською юридичною термінологією (для точності в дебатах). Це мова 'інтелектуального штурму', яка мала на меті не лише переконати, а й приголомшити опонента силою аргументів та красою складу.
  instruction: "Проаналізуйте, як мовні засоби Борецького допомагали йому у веденні великої міжконфесійної дискусії."`
3. **Vocabulary**: `---
- lemma: митрополит
  ipa: /mɪtroˈpɔlɪt/
...
- lemma: ієрархія
  ...
  pos: noun
  gender: f
  note: система підпорядкування в церкві
- lemma: унія
  ipa: /ˈunʲijɐ/
  translation: union
  pos: noun
  gender: f
  note: об'єднання церков (Берестейська 1596 р.)
- lemma: православ'я
  ipa: /prɐʋoˈslɑu̯jɐ/
...
- lemma: братство
  ...
  pos: noun
  gender: n
  note: релігійно-громадська організація міщан
- lemma: висвячення
  ipa: /ʋɪˈsʲʋʲɐt͡ʃennʲɐ/
  translation: ordination / consecration
  pos: noun
  gender: n
  note: обряд надання духовного сану
- lemma: полеміка
  ipa: /poˈlɛmʲikɐ/
  translation: polemics / debate
  pos: noun
  gender: f
  note: публічна дискусія на релігійні теми
- lemma: чернецтво
  ipa: /t͡ʃerˈnɛt͡stʋo/
...
- lemma: патріарх
  ...
  pos: noun
  gender: m
  note: глава православної церкви
- lemma: ректор
  ipa: /ˈrɛktɔr/
  translation: rector
  pos: noun
  gender: m
  note: керівник навчального закладу
- lemma: собор
  ipa: /soˈbɔr/
  translation: council / cathedral
  pos: noun
  gender: m
  note: з'їзд вищого духовенства або головний храм
- lemma: єпархія
  ipa: /jeˈpɑrxʲijɐ/
  translation: eparchy / diocese
  pos: noun
  gender: f
  note: церковний адміністративний округ
- lemma: канон
  ipa: /kɐˈnɔn/
  translation: canon
  pos: noun
  gender: m
  note: сукупність церковних правил
- lemma: схима
  ipa: /ˈsxɪmɐ/
  translation: schema (monastic vow)
  pos: noun
  gender: f
  note: вищий ступінь чернецтва
- lemma: протестація
  ipa: /protestˈɑt͡sʲijɐ/
  translation: protestation / formal protest
  pos: noun
  gender: f
  note: офіційна заява проти несправедливості
- lemma: етнарх
  ipa: /etˈnɐrx/
  translation: ethnarch
  pos: noun
  gender: m
  note: духовний лідер нації без власної держави
- lemma: латинізація
  ipa: /lɐtɪnʲizˈɑt͡sʲijɐ/
  translation: Latinization
  pos: noun
  gender: f
  note: перехід на латинський обряд чи культуру
- lemma: просвітництво
  ipa: /prosˈʋʲitnɪt͡stʋo/
  translation: enlightenment
  pos: noun
  gender: n
  note: поширення знань та освіти
- lemma: легітимність
  ipa: /leɦʲitˈɪmnʲisʲtʲ/
...
- lemma: канонізація
  ...
  pos: noun
  gender: f
  note: зарахування до лику святих
- lemma: меценатство
  ipa: /met͡sɛˈnɑtstʋo/
  translation: philanthropy / patronage of arts
  pos: noun
  gender: n
  note: підтримка культури та освіти
- lemma: асиміляція
  ipa: /ɐsɪmʲilʲˈɑt͡sʲijɐ/
  translation: assimilation
  pos: noun
  gender: f
  note: розчинення в іншому народі
- lemma: конфесійний
  ipa: /konfesʲˈijɪj/
  translation: confessional / denominational
  pos: adj
  note: пов'язаний з віросповіданням
- lemma: пасіонарій
  ipa: /pɐsʲionˈɑrʲij/
  translation: passionary
  pos: noun
  gender: m
  note: людина великої духовної енергії
`
...
pedagogy: CBI
prerequisites:
- c1-bio-03 (Volodymyr Velykyi - original Christianization)
- c1-bio-06 (Mykhailo Chernihivskyi - faith defense)
- Understanding of Reformation/Counter-Reformation context
connects_to:
- c1-bio-09 (Sylvestr Kosiv - successor)
- c1-bio-10 (Bohdan Khmelnytskyi - religious dimension of uprising)
- c1-bio-98 (Ivan Ohienko - later Orthodox defender)
objectives:
...
6. **Research notes** (if exists): `# Research Notes: Іов Борецький
...
At module 17, students know ONLY modules 1-16. Any grammar from later modules is scope creep.
