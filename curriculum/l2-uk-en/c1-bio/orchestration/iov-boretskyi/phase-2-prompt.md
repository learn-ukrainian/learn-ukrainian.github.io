...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/iov-boretskyi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/iov-boretskyi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/iov-boretskyi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Йов Борецький: Захисник православ'я** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Відновлення православної ієрархії | 400 | 600 |
| Життєпис: Галицьке коріння та освіта | 450 | 675 |
| Життєпис: Київський період та чернецтво | 450 | 675 |
| Берестейська унія та її наслідки: Правовий колапс | 500 | 750 |
| Берестейська унія та її наслідки: Братська альтернатива | 500 | 750 |
| Відновлення ієрархії 1620 року: Таємна хіротонія | 550 | 825 |
| Відновлення ієрархії 1620 року: Політичний вибух | 550 | 825 |
| Митрополитство та спадщина: «Протестація» | 600 | 900 |
| Митрополитство та спадщина: Освітній заповіт | 550 | 825 |
| Підсумок — Віра як опір | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/iov-boretskyi.yaml`. Go through EVERY `points:` item in EVERY section:
