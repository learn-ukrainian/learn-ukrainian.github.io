...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/viacheslav-chornovil-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/viacheslav-chornovil.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/viacheslav-chornovil.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **В'ячеслав Чорновіл: Незламний правозахисник** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Людина, яка не схилялася | 350 | 525 |
| Черкащина та формування характеру | 600 | 900 |
| Журналіст-бунтар | 700 | 1050 |
| Лихо з розуму та перший арешт | 900 | 1350 |
| Гельсінська група та другий арешт | 950 | 1425 |
| Незалежність та політика | 850 | 1275 |
| Загибель та спадщина | 650 | 975 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/viacheslav-chornovil.yaml`. Go through EVERY `points:` item in EVERY section:
