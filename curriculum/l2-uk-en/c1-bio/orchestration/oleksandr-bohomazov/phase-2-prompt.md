...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/oleksandr-bohomazov-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/oleksandr-bohomazov.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/oleksandr-bohomazov.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Олександр Богомазов: Український футурист** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Український Пікассо | 600 | 900 |
| Ранні роки та освіта: Шлях бунтівника (1880–1908) | 800 | 1200 |
| Московський досвід та фінський злам (1908–1914) | 900 | 1350 |
| Київський розквіт: «Кільце» та революція форми (1914–1922) | 900 | 1350 |
| Теорія спектралізму: «Живопис та елементи» | 900 | 1350 |
| Останні роки та спадщина: Педагог і Майстер (1922–1930) | 900 | 1350 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/oleksandr-bohomazov.yaml`. Go through EVERY `points:` item in EVERY section:
