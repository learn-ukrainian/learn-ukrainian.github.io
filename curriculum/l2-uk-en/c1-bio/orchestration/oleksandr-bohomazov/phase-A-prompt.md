...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/oleksandr-bohomazov.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/oleksandr-bohomazov.yaml
```
...
Research **Олександр Богомазов: Український футурист** for the **c1-bio** track. Produce structured research notes that will drive content writing in Phase B.
