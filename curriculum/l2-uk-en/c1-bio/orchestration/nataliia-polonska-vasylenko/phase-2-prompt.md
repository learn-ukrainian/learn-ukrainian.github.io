...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/nataliia-polonska-vasylenko-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/nataliia-polonska-vasylenko.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/nataliia-polonska-vasylenko.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Наталія Полонська-Василенко: Історикиня** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Жінка, яка написала історію України | 400 | 600 |
| Ранні роки та освіта: Шлях до науки (1884-1917) | 600 | 900 |
| Наукова кар'єра I: Відкриття Запорожжя (1917-1929) | 800 | 1200 |
| Наукова кар'єра II: Виживання в епоху терору (1930-1943) | 800 | 1200 |
| Еміграція: Місія збереження (1943-1947) | 500 | 750 |
| Життя на Заході I: Архітекторка діаспорної науки (1947-1955) | 600 | 900 |
| Життя на Заході II: Magnum Opus (1955-1973) | 800 | 1200 |
| Наукова спадщина: Повернення додому | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/nataliia-polonska-vasylenko.yaml`. Go through EVERY `points:` item in EVERY section:
