...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/ivan-vyhovskyi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/ivan-vyhovskyi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/ivan-vyhovskyi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Іван Виговський: Гетьман-дипломат** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Архітектор Гадяцької унії | 400 | 600 |
| Життєпис: I — Походження та шлях до булави | 400 | 600 |
| Життєпис: II — Від писаря до гетьмана | 500 | 750 |
| Історичний контекст: I — Криза та московська експансія | 500 | 750 |
| Історичний контекст: II — Гадяцький проект | 700 | 1050 |
| Внесок: I — Багатовекторна дипломатія | 400 | 600 |
| Внесок: II — Тріумф під Конотопом | 600 | 900 |
| Останні роки: I — Внутрішній розкол та зречення | 400 | 600 |
| Останні роки: II — Трагічна загибель | 400 | 600 |
| Спадщина: Від зрадника до європейського візіонера | 400 | 600 |
| Підсумок | 300 | 450 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/ivan-vyhovskyi.yaml`. Go through EVERY `points:` item in EVERY section:
