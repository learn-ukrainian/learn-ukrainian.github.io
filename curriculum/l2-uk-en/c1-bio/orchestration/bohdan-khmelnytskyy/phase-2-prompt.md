...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/bohdan-khmelnytskyy-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/bohdan-khmelnytskyy.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/bohdan-khmelnytskyy.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Богдан Хмельницький: Гетьман-державотворець** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Творець козацької держави | 400 | 600 |
| Життєпис: I — Становлення та особиста драма | 600 | 900 |
| Життєпис: II — Від бунту до тріумфу | 600 | 900 |
| Життєпис: III — Дипломатичні гойдалки | 600 | 900 |
| Історичний контекст | 500 | 750 |
| Внесок | 600 | 900 |
| Останні роки: I — Переяславський вузол | 600 | 900 |
| Останні роки: II — Зрада і нові горизонти | 500 | 750 |
| Спадщина | 400 | 600 |
| Підсумок | 200 | 300 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/bohdan-khmelnytskyy.yaml`. Go through EVERY `points:` item in EVERY section:
