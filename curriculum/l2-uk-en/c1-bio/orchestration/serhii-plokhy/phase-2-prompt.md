...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/serhii-plokhy-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/serhii-plokhy.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/serhii-plokhy.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Сергій Плохій: Історик, який пояснив Україну світові** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Голос України в Гарварді | 300 | 450 |
| Молодість і радянська освіта: Від Горлівки до Києва | 600 | 900 |
| Еміграція та Гарвард: Шлях до світового визнання | 600 | 900 |
| Наукові праці: «Брама Європи» та новий наратив | 700 | 1050 |
| Наукові праці: Анатомія імперського колапсу | 700 | 1050 |
| Наукові праці: Ядерна історія та Чорнобиль | 600 | 900 |
| Наукові праці: Війна та сучасність | 600 | 900 |
| Популяризатор історії: Глобальний голос | 400 | 600 |
| Значення для України: Деколонізація та майбутнє | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/serhii-plokhy.yaml`. Go through EVERY `points:` item in EVERY section:
