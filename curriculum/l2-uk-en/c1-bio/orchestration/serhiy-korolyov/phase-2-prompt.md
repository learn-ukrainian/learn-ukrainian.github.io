...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/serhiy-korolyov-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/serhiy-korolyov.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/serhiy-korolyov.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Сергій Корольов: Батько космічної ери** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Українець, який відкрив космос | 600 | 900 |
| Українське коріння | 800 | 1200 |
| Ракетна мрія | 800 | 1200 |
| ГУЛАГ і виживання | 1000 | 1500 |
| Творець космічної ери | 1000 | 1500 |
| Спадщина та повернення в Україну | 800 | 1200 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/serhiy-korolyov.yaml`. Go through EVERY `points:` item in EVERY section:
