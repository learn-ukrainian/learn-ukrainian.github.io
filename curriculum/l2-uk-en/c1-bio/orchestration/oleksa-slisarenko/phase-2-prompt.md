...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/oleksa-slisarenko-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/oleksa-slisarenko.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/oleksa-slisarenko.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Олекса Слісаренко: <!-- Title -->** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ: Поет, футурист, бунтар | 400 | 600 |
| Ранні роки: Від землі до зброї | 600 | 900 |
| Еволюція митця: Від 'Білої студії' до футуризму | 800 | 1200 |
| Король українського бестселера: Пригодницька проза | 1000 | 1500 |
| На вістрі боротьби: ВАПЛІТЕ і 'казус Горького' | 800 | 1200 |
| У лещатах терору: Арешт і Соловки | 800 | 1200 |
| Спадщина: Повернення із забуття | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/oleksa-slisarenko.yaml`. Go through EVERY `points:` item in EVERY section:
