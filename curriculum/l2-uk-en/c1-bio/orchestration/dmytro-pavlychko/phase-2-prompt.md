...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/research/dmytro-pavlychko-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/dmytro-pavlychko.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c1-bio/dmytro-pavlychko.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Дмитро Павличко: Поет і дипломат** (c1-bio track).
...
|---------|--------|---------------------|
| Вступ — Два кольори однієї душі | 400 | 600 |
| Юність і формування: I — Коріння та війна | 450 | 675 |
| Юність і формування: II — Університет і компроміси | 400 | 600 |
| Поетичний шлях: I — Виклик системі («Правда кличе») | 500 | 750 |
| Поетичний шлях: II — Народження легенди («Два кольори») | 500 | 750 |
| Поетичний шлях: III — Шістдесятництво і літературний процес | 400 | 600 |
| Перекладацька діяльність: I — Шекспір і світовий контекст | 450 | 675 |
| Перекладацька діяльність: II — «Всесвіт» як вікно у світ | 400 | 600 |
| Політик і дипломат: I — Архітектор Незалежності | 600 | 900 |
| Політик і дипломат: II — На дипломатичній службі | 450 | 675 |
| Спадщина — Голос України | 450 | 675 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c1-bio/meta/dmytro-pavlychko.yaml`. Go through EVERY `points:` item in EVERY section:
