...
|---|------|-------|-------|-----|--------|
| 1 | quiz | Розуміння тексту: Героїзм Ольги Басараб | 5 | 5 | ✅ |
| 2 | fill-in | Лексика: Підпілля, Розвідка та Незламність | 6 | 6 | ✅ |
| 3 | error-correction | Граматика: Опис спротиву та мучеництва | 5 | 5 | ✅ |
| 4 | match-up | Словник визвольної боротьби | 8 | 6 | ✅ |
| 5 | select | Лінгвістичний аналіз джерела спротиву | 5 | 5 | ✅ |
| 6 | group-sort | Класифікація героїчного чину | 12 | 1 | ✅ |
| 7 | true-false | Факти про Ольгу Басараб | 5 | 5 | ✅ |
| 8 | authorial-intent | Намір автора: Мучеництво як акт | 1 | 1 | ✅ |
| 9 | essay-response | Аналіз незламності: Ольга Басараб | 1 | 1 | ✅ |
| 10 | comparative-study | Порівняння: Басараб та Теліга | 1 | 1 | ✅ |
| 11 | critical-analysis | Аналіз міжнародного скандалу | 1 | 1 | ✅ |
| 12 | translate | Переклад термінів: Спротив та Справедливість | 5 | 5 | ✅ |
| 13 | reading | Спогади про Ольгу Басараб | 3 | 1 | ✅ |
