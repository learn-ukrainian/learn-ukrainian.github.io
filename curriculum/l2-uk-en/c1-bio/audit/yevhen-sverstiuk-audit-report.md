# Audit Report: M130 — yevhen-sverstiuk.md
**Level:** C1-BIO | **Module:** M130 | **Phase:** C1 | **Pedagogy:** Not Specified | **Target:** 3600
**Naturalness:** 0/10 (PENDING)
**Overall Status:** ❌ FAIL
**Generated:** 2026-02-09 23:25:08

## Configuration
**Type:** C1-biography
**Word Target:** 3600 words
...
- **[MISSING_RESEARCH]** No research file found for seminar module. Expected: research/yevhen-sverstiuk-research.md
...
- **[STATE_STANDARD_LOW_IMMERSION]** Module 130 has 0.0% immersion (target: 90.0%+)
...
| **Вступ: Філософ свободи** | ✅ | 0 | Included in Core |
| **Волинь та юність (1928-1954)** | ⚪️ | 0 | Skipped |
| **Шістдесятники: Совість покоління (1954-1972)** | ⚪️ | 0 | Skipped |
| **Ув'язнення та заслання (1972-1983)** | ⚪️ | 0 | Skipped |
| **Повернення та незалежна Україна (1983-2014)** | ⚪️ | 0 | Skipped |
| **Зразок відповіді** | ⚪️ | 0 | Skipped |
| **Підсумок: Совість у часи безсовісності** | ✅ | 0 | Included in Core |