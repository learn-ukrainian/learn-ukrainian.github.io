...
|---|------|-------|-------|-----|--------|
| 1 | comparative-study | «Болбочан vs Омелянович-Павленко» | 1 | 1 | ✅ |
| 2 | true-false | «Герой чи Заколотник?» | 8 | 5 | ✅ |
| 3 | reading | «Первинне джерело: Спогади про Кримський похід» | 3 | 1 | ✅ |
| 4 | reading | «Військовий аналіз операції» | 3 | 1 | ✅ |
| 5 | essay-response | «Болбочан: Тріумф стратегії та Трагедія політики» | 1 | 1 | ✅ |
...
- **[MISSING_RESEARCH]** No research file found for seminar module. Expected: research/petro-bolbochan-research.md
  - FIX: Run /full-rebuild c1-bio or /research to create research notes before content generation.
- **[YAML_SCHEMA_VIOLATION]** Schema error in petro-bolbochan.yaml: Schema validation error at key 'id': 'c1-88-reading-2' does not match '^reading-[a-z0-9-]+$'
