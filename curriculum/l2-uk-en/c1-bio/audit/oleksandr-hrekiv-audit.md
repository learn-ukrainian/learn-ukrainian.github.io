...
|---|------|-------|-------|-----|--------|
| 1 | true-false | «Факти про генерала» | 12 | 5 | ✅ |
| 2 | reading | «Спогади про Чортківську офензиву» | 3 | 1 | ✅ |
| 3 | reading | «Арешт у Відні: Документи СМЕРШ» | 3 | 1 | ✅ |
| 4 | essay-response | «Трагедія українського офіцера» | 1 | 1 | ✅ |
| 5 | comparative-study | «Стратег і Практик: Греків та Омелянович-Павленко» | 1 | 1 | ✅ |
| 6 | critical-analysis | «Аналіз спогадів генерала» | 1 | 1 | ✅ |
| 7 | true-false | «Принципи генерала Грекова» | 12 | 5 | ✅ |
...
- **[MISSING_RESEARCH]** No research file found for seminar module. Expected: research/oleksandr-hrekiv-research.md
  - FIX: Run /full-rebuild c1-bio or /research to create research notes before content generation.
- **[YAML_SCHEMA_VIOLATION]** Schema error in oleksandr-hrekiv.yaml: Schema validation error at key 'id': 'c1-84-reading-2' does not match '^reading-[a-z0-9-]+$'
