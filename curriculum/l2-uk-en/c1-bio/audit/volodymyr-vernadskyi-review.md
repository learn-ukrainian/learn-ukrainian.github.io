# Audit Report: M48 — volodymyr-vernadskyi.md
...
|---|------|-------|-------|-----|--------|
| 1 | quiz | Розуміння біографії Вернадського | 5 | 5 | ✅ |
| 2 | match-up | Терміни та визначення | 8 | 6 | ✅ |
| 3 | cloze | Життя та діяльність Вернадського | 12 | 1 | ✅ |
| 4 | true-false | Факти про Вернадського | 5 | 5 | ✅ |
| 5 | fill-in | Заповніть пропуски | 6 | 6 | ✅ |
| 6 | select | Виберіть правильні твердження | 5 | 5 | ✅ |
| 7 | error-correction | Виправте помилки | 5 | 5 | ✅ |
| 8 | unjumble | Складіть речення про Вернадського | 5 | 5 | ✅ |
| 9 | group-sort | Класифікація понять | 12 | 1 | ✅ |
| 10 | comparative-study | Порівняння Вернадського та Кримського | 1 | 1 | ✅ |
| 11 | essay-response | Письмове завдання | 1 | 1 | ✅ |
| 12 | mark-the-words | Знайдіть наукові терміни | 7 | 5 | ✅ |
...
- **[YAML_SCHEMA_VIOLATION]** Schema error in volodymyr-vernadskyi.yaml: Schema validation error at key 'words': ['Вернадський', 'став', 'першим', 'президентом', 'Української', 'академії', 'наук', 'у', '1918', 'році', 'під', 'час', 'гетьманату', '.'] is too short
...
| **Життєпис** | ⚪️ | 1096 | Skipped |
| **Внесок** | ⚪️ | 417 | Skipped |
| **Порівняльний аналіз** | ✅ | 284 | Included in Core |
