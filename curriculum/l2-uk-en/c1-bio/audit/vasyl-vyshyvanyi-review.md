...
|---|------|-------|-------|-----|--------|
| 1 | quiz | Розуміння тексту: Доля Василя Вишиваного | 5 | 5 | ✅ |
| 2 | fill-in | Лексика: Аристократія, Військо та Вибір | 6 | 6 | ✅ |
| 3 | error-correction | Граматика: Опис історичних випробувань | 5 | 5 | ✅ |
| 4 | match-up | Поняття та реалії епохи | 8 | 6 | ✅ |
| 5 | select | Аналіз політичного та етичного вибору | 5 | 5 | ✅ |
| 6 | group-sort | Географія життя Габсбурга | 12 | 1 | ✅ |
| 7 | true-false | Факти про «українського принца» | 5 | 5 | ✅ |
| 8 | authorial-intent | Намір автора: Лист до Шептицького | 1 | 1 | ✅ |
| 9 | essay-response | Аналіз феномену: Ідентичність за вибором | 1 | 1 | ✅ |
| 10 | comparative-study | Порівняння: Вишиваний та Скоропадський | 1 | 1 | ✅ |
| 11 | critical-analysis | Аналіз шпигунської справи | 1 | 1 | ✅ |
| 12 | translate | Переклад термінів: Військо та Ідентичність | 5 | 5 | ✅ |
| 13 | reading | Поезія Василя Вишиваного | 3 | 1 | ✅ |
