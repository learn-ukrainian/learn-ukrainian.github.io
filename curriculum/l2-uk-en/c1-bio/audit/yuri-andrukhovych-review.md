# Audit Report: M147 — yuri-andrukhovych.md
**Level:** C1-BIO | **Module:** M147 | **Phase:** C1 | **Pedagogy:** Not Specified | **Target:** 3600
**Naturalness:** 0/10 (PENDING)
**Overall Status:** ❌ FAIL
**Generated:** 2026-02-07 16:38:42
...
- **[MISSING_RESEARCH]** No research file found for seminar module. Expected: research/yuri-andrukhovych-research.md
...
- **[STATE_STANDARD_LOW_IMMERSION]** Module 147 has 0.0% immersion (target: 90.0%+)
...
- **Richness:** ❌ 14% < 95% min (biography) - REWRITE needed
...
| **Вступ: Enfant terrible української літератури** | ✅ | 0 | Included in Core |
| **Станіславів та юність (1960-1982)** | ⚪️ | 0 | Skipped |
| **Бу-Ба-Бу: Карнавальна революція (1985-1991)** | ⚪️ | 0 | Skipped |
| **Романи: «Рекреації», «Московіада», «Перверзія» (1992-1999)** | ⚪️ | 0 | Skipped |
| **Громадянська позиція та сучасність (2000-)** | ⚪️ | 0 | Skipped |
| **Зразок відповіді** | ⚪️ | 0 | Skipped |
| **Підсумок: Постмодерніст як деколонізатор** | ✅ | 0 | Included in Core |