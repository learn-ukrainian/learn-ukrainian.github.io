...
- **[MISSING_RESEARCH]** No research file found for seminar module. Expected: research/dmytro-pavlychko-research.md
...
| **Вступ** | ✅ | 208 | Included in Core |
| **Біографія** | ⚪️ | 644 | Skipped |
| **Історичний контекст** | ✅ | 334 | Included in Core |
| **Порівняльний аналіз** | ✅ | 166 | Included in Core |
| **Есе** | ⚪️ | 0 | Skipped |
| **Тема** | ⚪️ | 63 | Skipped |
| **Критерії оцінювання** | ⚪️ | 0 | Skipped |
| **Зразок відповіді** | ⚪️ | 349 | Skipped |
| **Підсумок** | ✅ | 52 | Included in Core |
| **Практикум рефлексії** | ⚪️ | 125 | Skipped |
