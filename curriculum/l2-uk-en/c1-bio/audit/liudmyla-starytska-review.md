# Audit Report: M60 — liudmyla-starytska.md
...
|---|------|-------|-------|-----|--------|
| 1 | true-false | «Факти про процес СВУ» | 5 | 5 | ✅ |
| 2 | essay-response | «Трагедія роду Старицьких» | 1 | 1 | ✅ |
| 3 | critical-analysis | Процес СВУ: Театр абсурду | 1 | 1 | ✅ |
| 4 | comparative-study | «Дві поетеси, дві долі» | 1 | 1 | ✅ |
