...
- **[MISSING_RESEARCH]** No research file found for seminar module. Expected: research/yurii-lypa-research.md
...
- **Richness:** ❌ 21% < 95% min (biography) - REWRITE needed
...
| **Вступ: Пророк Чорноморської доктрини** | ✅ | 0 | Included in Core |
| **Одеса та еміграція: Становлення (1900-1920)** | ⚪️ | 0 | Skipped |
| **Варшавсько-львівський період: Поет і лікар (1920-1939)** | ⚪️ | 0 | Skipped |
| **Друга світова війна: Лікар на передовій (1939-1944)** | ⚪️ | 0 | Skipped |
| **Геополітична спадщина: Липа сьогодні** | ⚪️ | 0 | Skipped |
| **Зразок відповіді** | ⚪️ | 0 | Skipped |
| **Підсумок: Лікар, поет, стратег** | ✅ | 0 | Included in Core |