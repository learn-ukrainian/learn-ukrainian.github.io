...
- **[YAML_SCHEMA_VIOLATION]** Schema error in ivan-nechuy-levytskyi.yaml: Insufficient activities: 0 found, minimum 3 required for C1-BIO
...
- **[STATE_STANDARD_LOW_IMMERSION]** Module 44 has 4.3% immersion (target: 90.0%+)
