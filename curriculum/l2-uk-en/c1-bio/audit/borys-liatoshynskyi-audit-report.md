...
|---|------|-------|-------|-----|--------|
| 1 | true-false | Факти про композитора | 5 | 5 | ✅ |
| 2 | authorial-intent | Намір автора: Лист про музику | 1 | 1 | ✅ |
| 3 | essay-response | Аналіз конфлікту: Митець і Влада | 1 | 1 | ✅ |
| 4 | comparative-study | Порівняння: Лятошинський та Шостакович | 1 | 1 | ✅ |
| 5 | critical-analysis | Аналіз музичного модернізму | 1 | 1 | ✅ |
| 6 | reading | Лятошинський про музику | 3 | 1 | ✅ |
