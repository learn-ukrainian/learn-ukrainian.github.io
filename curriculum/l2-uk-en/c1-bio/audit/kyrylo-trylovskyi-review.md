...
|---|------|-------|-------|-----|--------|
| 1 | true-false | «Діяльність, вплив та спадщина» | 5 | 5 | ✅ |
| 2 | essay-response | «Феномен 'легальної армії' Трильовського» | 1 | 1 | ✅ |
| 3 | critical-analysis | «Аналіз ідеологічного перелому» | 1 | 1 | ✅ |
| 4 | comparative-study | «Дві стратегії одного визволення» | 1 | 1 | ✅ |
...
- ❌ **[DUPLICATE_SYNONYMOUS_HEADERS]** Multiple headers contain 'Спадщина': Спадщина в діаспорі: Січовий вогонь за океаном, Вплив на сучасників: Харизма лідера
