...
|---|------|-------|-------|-----|--------|
| 1 | true-false | «Правда про батька театру» | 12 | 5 | ✅ |
| 2 | reading | «Рецензії на вистави корифеїв» | 3 | 1 | ✅ |
| 3 | reading | «Аналіз драми «Дай серцю волю...»» | 3 | 1 | ✅ |
| 4 | essay-response | «Театр як націотворення» | 1 | 1 | ✅ |
| 5 | comparative-study | «Кропивницький та Станіславський» | 1 | 1 | ✅ |
| 6 | critical-analysis | «Відмова імператору» | 1 | 1 | ✅ |
...
- **[YAML_SCHEMA_VIOLATION]** Schema error in marko-kropyvnytskyi.yaml: Schema validation error at key 'id': 'c1-83-reading-2' does not match '^reading-[a-z0-9-]+$'
