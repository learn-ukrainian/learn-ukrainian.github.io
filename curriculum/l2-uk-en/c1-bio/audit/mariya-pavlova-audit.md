...
| **Марія Павлова: Видатний палеонтолог** | ✅ | 89 | Included in Core |
| **Вступ — Жінка, що читала кістки** | ✅ | 776 | Included in Core |
| **Ранні роки: Козелець і Київ (1854-1880)** | ✅ | 819 | Included in Core |
| **Паризький університет: Народження науковця (1880-1886)** | ✅ | 898 | Included in Core |
| **Московський період: Будівництво музею (1886-1920)** | ✅ | 833 | Included in Core |
| **Еволюція коней та хоботних: Головні відкриття** | ✅ | 813 | Included in Core |
| **Останні роки та спадщина (1920-1938)** | ✅ | 830 | Included in Core |
| **Підсумок** | ✅ | 359 | Included in Core |