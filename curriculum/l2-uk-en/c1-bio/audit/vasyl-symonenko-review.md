...
| 4 | fill-in | Біографічна лексика | 6 | 6 | ✅ |
| 5 | select | Лінгвістичний аналіз джерела | 5 | 5 | ✅ |
| 6 | error-correction | Граматика в біографічному тексті | 5 | 5 | ✅ |
| 7 | match-up | Словник шістдесятника | 8 | 6 | ✅ |
| 8 | true-false | Факти про Симоненка | 5 | 5 | ✅ |
| 9 | unjumble | Аналіз цитат | 5 | 5 | ✅ |
| 10 | group-sort | Постаті та поняття | 12 | 1 | ✅ |
| 11 | cloze | Біографічний нарис | 12 | 1 | ✅ |
| 12 | group-sort | Лексичні пласти | 12 | 1 | ✅ |
| 13 | essay-response | Творча робота: Сила слова | 1 | 1 | ✅ |
| 14 | comparative-study | Симоненко та Стус: Порівняння | 1 | 1 | ✅ |
...
- **[YAML_SCHEMA_VIOLATION]** Schema error in vasyl-symonenko.yaml: Schema validation error at key 'options': ['Полтавщині', 'Київщині', 'Львівщині'] is too short
