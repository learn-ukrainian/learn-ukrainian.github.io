...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/istoriohrafiia/nova-ukrainska-istoriohrafiia.yaml
```

Read the current meta file for content_outline structure:

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/istoriohrafiia/meta/nova-ukrainska-istoriohrafiia.yaml
```

## Your Task

Research **Нова українська історіографія після 1991** for the **istoriohrafiia** track. Produce structured research notes that will drive content writing in later phases.
