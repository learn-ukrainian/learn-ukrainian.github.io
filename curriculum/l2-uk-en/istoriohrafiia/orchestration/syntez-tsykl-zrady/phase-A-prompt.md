...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/istoriohrafiia/syntez-tsykl-zrady.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/istoriohrafiia/meta/syntez-tsykl-zrady.yaml
```
...
Research **Синтез: Чому цикл повторюється?** for the **istoriohrafiia** track. Produce structured research notes that will drive content writing in Phase B.
