...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/istoriohrafiia/ukrainska-istoriohrafichna-tradytsiia.md
```
...
```
schemas/activities-istoriohrafiia.schema.json
```
...
- **Schema violations**: `additionalProperties: false` means ANY unlisted field = instant fail. Read `schemas/activities-istoriohrafiia.schema.json` before writing.
...
3. **Seminar style** (istoriohrafiia): Reading Input → Analytical Output. Focus on comprehension, analysis, and critical thinking — NOT drill exercises.
...
### CRITICAL: Activity Type Constraints for istoriohrafiia
