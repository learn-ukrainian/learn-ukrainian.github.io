...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/istoriohrafiia/syntez-informatsiina-viina.yaml
```

Read the current meta file for content_outline structure:

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/istoriohrafiia/meta/syntez-informatsiina-viina.yaml
```

## Your Task

Research **Синтез: Хто виграє війну наративів?** for the **istoriohrafiia** track. Produce structured research notes that will drive content writing in later phases.
