...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/istoriohrafiia/syntez-rozstriliane.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/istoriohrafiia/meta/syntez-rozstriliane.yaml
```
...
Research **Синтез: Культурний геноцид** for the **istoriohrafiia** track. Produce structured research notes that will drive content writing in Phase B.
