...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/istoriohrafiia/tsykl-kulturnykh-vidrodzhen.yaml
```

Read the current meta file for content_outline structure:

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/istoriohrafiia/meta/tsykl-kulturnykh-vidrodzhen.yaml
```

## Your Task

Research **Цикл культурних відроджень: Теорія** for the **istoriohrafiia** track. Produce structured research notes that will drive content writing in later phases.
