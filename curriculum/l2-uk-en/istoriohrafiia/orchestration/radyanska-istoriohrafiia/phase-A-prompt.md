...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/istoriohrafiia/radyanska-istoriohrafiia.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/istoriohrafiia/meta/radyanska-istoriohrafiia.yaml
```
...
Research **Радянська історіографія: Деформації** for the **istoriohrafiia** track. Produce structured research notes that will drive content writing in Phase B.
