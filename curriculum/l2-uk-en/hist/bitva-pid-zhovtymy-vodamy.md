<!-- SCOPE
Covers: Передумови, хід та наслідки битви під Жовтими Водами (квітень-травень 1648 року), тактика сторін, роль союзників, деколонізаційний погляд на Хмельниччину.
Not covered:
  - Корсунська битва → bitva-pid-korsunem
Related: povstannia-khmelnytskoho, zaporozhian-sich-structure
-->
