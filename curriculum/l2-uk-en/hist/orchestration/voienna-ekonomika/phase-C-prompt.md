...
| Module persona | Senior Professor of History, acting as Logistics Strategist |
...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/voienna-ekonomika.md
```

**Plan file** (vocabulary_hints — vocabulary list to follow):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/voienna-ekonomika.yaml
```

**Meta file** (activity count targets, pedagogy):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/voienna-ekonomika.yaml
```
