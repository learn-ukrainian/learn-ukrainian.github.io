...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/kozatske-viisko-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/kozatske-viisko.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/kozatske-viisko.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Козацьке військо та озброєння** (hist track).
...
|---------|--------|---------------------|
| Вступ: Феномен козацького війська | 500 | 750 |
| Структура та Ієрархія: Від коша до полку | 800 | 1200 |
| Озброєння: Шабля, самопал та гармата | 800 | 1200 |
| Тактика бою: Козацький табір та розвідка | 800 | 1200 |
| Символіка та Клейноди: Знаки влади | 600 | 900 |
| Читання: Опис козацького вишколу | 400 | 600 |
| Первинні джерела: Голоси епохи | 400 | 600 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/kozatske-viisko.yaml`. Go through EVERY `points:` item in EVERY section:
