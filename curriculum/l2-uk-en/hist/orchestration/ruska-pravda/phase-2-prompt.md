...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/ruska-pravda-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/ruska-pravda.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/ruska-pravda.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Руська Правда: Перший законодавчий кодекс** (hist track).
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/ruska-pravda.yaml`. Go through EVERY `points:` item in EVERY section:
