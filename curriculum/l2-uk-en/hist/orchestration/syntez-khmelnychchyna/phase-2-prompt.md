...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/syntez-khmelnychchyna-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/syntez-khmelnychchyna.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/syntez-khmelnychchyna.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Синтез: Козацька революція** (hist track).
...
|---------|--------|---------------------|
| Вступ: Вибух, що змінив усе | 400 | 600 |
| Причини революції: I — Соціальний та релігійний гніт | 500 | 750 |
| Причини революції: II — Політичне безправ'я та іскра | 500 | 750 |
| Етапи боротьби: I — Тріумф 1648 року та Зборівська автономія | 600 | 900 |
| Етапи боротьби: II — Катастрофа під Берестечком і пошук союзника | 600 | 900 |
| Етапи боротьби: III — Переяславська рада і останні роки | 600 | 900 |
| Соціальні трансформації: Народження нації | 600 | 900 |
| Читання: I — Зборівський договір як фундамент державності | 400 | 600 |
| Читання: II — Березневі статті: Військовий союз чи підданство? | 400 | 600 |
| Первинні джерела | 400 | 600 |
| Деколонізаційний погляд | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/syntez-khmelnychchyna.yaml`. Go through EVERY `points:` item in EVERY section:
