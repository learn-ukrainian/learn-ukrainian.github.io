...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/nezalezhnist-1991-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/nezalezhnist-1991.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/nezalezhnist-1991.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Україна 1991-2004: Становлення** (hist track).
...
| Перші роки (1991-1994): I — Леонід Кравчук та ядерне питання | 700 | 1050 |
| Перші роки (1991-1994): II — Економічна криза та гіперінфляція | 600 | 900 |
| Ера Кучми (1994-2004): I — Державотворення та реформи | 700 | 1050 |
| Ера Кучми (1994-2004): II — Тіньова сторона: Олігархія та авторитаризм | 600 | 900 |
| Ера Кучми (1994-2004): III — Криза легітимності: «Касетний скандал» | 600 | 900 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/nezalezhnist-1991.yaml`. Go through EVERY `points:` item in EVERY section:
