...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/ukraine-90s-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/ukraine-90s.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/ukraine-90s.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Україна 1990-х: Кучма та олігархи** (hist track).
...
|---------|--------|---------------------|
| Вступ: Народження держави | 600 | 900 |
| Економічна криза: I — Гіперінфляція та виживання | 600 | 900 |
| Економічна криза: II — Велика приватизація та олігархат | 800 | 1200 |
| Президентство Кучми: I — Багатовекторність і Конституція | 700 | 1050 |
| Президентство Кучми: II — Касетний скандал і справа Гонгадзе | 700 | 1050 |
| Президентство Кучми: III — Акція «Україна без Кучми» | 600 | 900 |
| Первинні джерела: Свідчення епохи | 500 | 750 |
| Деколонізаційний погляд: Імперський спадок | 600 | 900 |
| Підсумок: До Помаранчевої революції | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/ukraine-90s.yaml`. Go through EVERY `points:` item in EVERY section:
