...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/mizhnarodna-pidtrymka-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/mizhnarodna-pidtrymka.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/mizhnarodna-pidtrymka.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Міжнародна підтримка** (hist track).
...
|---------|--------|---------------------|
| Вступ: Україна не сама | 400 | 600 |
| Військова допомога: I — Стратегічні партнери | 900 | 1350 |
| Військова допомога: II — Еволюція озброєння | 900 | 1350 |
| Санкції та економічний тиск: I — Фінансова ізоляція | 800 | 1200 |
| Санкції та економічний тиск: II — Ефективність та обхід | 600 | 900 |
| Первинні джерела | 500 | 750 |
| Деколонізаційний погляд | 500 | 750 |
| Підсумок: Довга перспектива | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/mizhnarodna-pidtrymka.yaml`. Go through EVERY `points:` item in EVERY section:
