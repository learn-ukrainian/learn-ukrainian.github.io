...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/oun-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/oun.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/oun.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **ОУН: Формування** (hist track).
...
|---------|--------|---------------------|
| Вступ: Народження націоналізму | 600 | 900 |
| Витоки та ідеологія: I — Військове коріння | 600 | 900 |
| Витоки та ідеологія: II — «Націоналізм» Донцова | 600 | 900 |
| Діяльність у 1930-х: I — Радикалізація і терор | 700 | 1050 |
| Діяльність у 1930-х: II — Судові процеси та символи | 600 | 900 |
| Діяльність у 1930-х: III — Втрата Провідника і розкол | 700 | 1050 |
| Первинні джерела | 400 | 600 |
| Деколонізаційний погляд | 400 | 600 |
| Підсумок: До Другої світової | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/oun.yaml`. Go through EVERY `points:` item in EVERY section:
