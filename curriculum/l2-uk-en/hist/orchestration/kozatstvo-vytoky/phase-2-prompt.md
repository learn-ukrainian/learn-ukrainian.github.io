...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/kozatstvo-vytoky-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/kozatstvo-vytoky.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/kozatstvo-vytoky.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Козацтво: витоки** (hist track).
...
|---------|--------|---------------------|
| Вступ: Дике поле як колиска свободи | 600 | 900 |
| Читання: Етимологія та перші згадки | 500 | 750 |
| Читання: Феномен уходництва | 600 | 900 |
| Козацький побут: Побратимство та звичаї | 500 | 750 |
| Військове мистецтво: Стратегія виживання | 600 | 900 |
| Первинні джерела: Погляд Гійома де Боплана | 500 | 750 |
| Геополітика: Відносини з Кримом | 500 | 750 |
| Геополітика: Козацтво і Річ Посполита | 600 | 900 |
| Деколонізаційний погляд: Суб'єктність | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/kozatstvo-vytoky.yaml`. Go through EVERY `points:` item in EVERY section:
