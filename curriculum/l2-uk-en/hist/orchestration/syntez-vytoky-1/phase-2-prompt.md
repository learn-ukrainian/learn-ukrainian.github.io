...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/syntez-vytoky-1-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/syntez-vytoky-1.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/syntez-vytoky-1.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Синтез: Від Трипілля до Києва** (hist track).
...
|---------|--------|---------------------|
| Огляд періоду | 900 | 1350 |
| Ключові теми | 900 | 1350 |
| Первинні джерела | 800 | 1200 |
| Текст: Тяглість у сьогодення | 900 | 1350 |
| Підсумкове есе | 600 | 900 |
| Словник епохи: Витоки | 500 | 750 |
| Підсумок | 200 | 300 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/syntez-vytoky-1.yaml`. Go through EVERY `points:` item in EVERY section:
