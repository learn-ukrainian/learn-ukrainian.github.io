...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/chornobyl-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/chornobyl.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/chornobyl.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Чорнобиль: Трагедія і Попередження** (hist track).
...
|---------|--------|---------------------|
| Вступ — Мирний атом?: I — Прип'ять як вітрина соціалізму | 400 | 600 |
| Вступ — Мирний атом?: II — Міф безпеки та роль України | 500 | 750 |
| Аварія 1986 року: I — Ніч вибуху та перші пожежні | 700 | 1050 |
| Аварія 1986 року: II — Евакуація та мовчання | 600 | 900 |
| Аварія 1986 року: III — Подвиг ліквідаторів та Саркофаг | 600 | 900 |
| Первинні джерела: Голоси катастрофи | 600 | 900 |
| Деколонізаційний погляд: I — Злочин Першотравня та імперська байдужість | 600 | 900 |
| Деколонізаційний погляд: II — Екологічний рух як шлях до незалежності | 500 | 750 |
| Деколонізаційний погляд: III — Культурний код та сучасне переосмислення | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/chornobyl.yaml`. Go through EVERY `points:` item in EVERY section:
