...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/afhanistan-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/afhanistan.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/afhanistan.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Українці в Афганістані** (hist track).
...
|---------|--------|---------------------|
| Вступ — Чужа війна: Геополітичний контекст | 500 | 750 |
| Вступ — Чужа війна: Український вимір | 500 | 750 |
| Війна в Афганістані: Хід бойових дій | 600 | 900 |
| Війна в Афганістані: Повсякденність та виживання | 600 | 900 |
| Війна в Афганістані: Людський вимір втрат | 500 | 750 |
| Первинні джерела: Листування та цензура | 400 | 600 |
| Первинні джерела: Спогади ветеранів | 400 | 600 |
| Деколонізаційний погляд: Імперський механізм | 750 | 1125 |
| Деколонізаційний погляд: Суспільні наслідки | 750 | 1125 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/afhanistan.yaml`. Go through EVERY `points:` item in EVERY section:
