...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/zborivska-bila-tserkva-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/zborivska-bila-tserkva.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/zborivska-bila-tserkva.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Зборівська та Білоцерківська угоди** (hist track).
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/zborivska-bila-tserkva.yaml`. Go through EVERY `points:` item in EVERY section:
