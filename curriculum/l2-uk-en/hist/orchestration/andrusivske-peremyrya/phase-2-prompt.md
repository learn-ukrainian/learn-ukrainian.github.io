...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/andrusivske-peremyrya-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/andrusivske-peremyrya.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/andrusivske-peremyrya.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Андрусівське перемир'я: Поділ України** (hist track).
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/andrusivske-peremyrya.yaml`. Go through EVERY `points:` item in EVERY section:
