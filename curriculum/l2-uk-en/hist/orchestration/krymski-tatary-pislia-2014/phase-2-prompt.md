...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/krymski-tatary-pislia-2014-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/krymski-tatary-pislia-2014.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/krymski-tatary-pislia-2014.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Кримські татари після 2014** (hist track).
...
|---------|--------|---------------------|
| Вступ: Подвійні жертви | 700 | 1050 |
| Російська окупація та репресії: I — Інституційний терор | 800 | 1200 |
| Російська окупація та репресії: II — Фізичне знищення | 800 | 1200 |
| Спротив та еміграція: I — Боротьба з материка | 700 | 1050 |
| Спротив та еміграція: II — Внутрішній фронт | 700 | 1050 |
| Первинні джерела | 600 | 900 |
| Деколонізаційний погляд | 600 | 900 |
| Підсумок: Боротьба триває | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/krymski-tatary-pislia-2014.yaml`. Go through EVERY `points:` item in EVERY section:
