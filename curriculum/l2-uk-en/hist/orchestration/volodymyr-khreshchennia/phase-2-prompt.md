...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/volodymyr-khreshchennia-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/volodymyr-khreshchennia.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/volodymyr-khreshchennia.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Володимир і Хрещення Русі** (hist track).
...
|---------|--------|---------------------|
| Розминка | 250 | 375 |
| Читання: Князь Володимир: від язичника до святого | 800 | 1200 |
| Корсунська кампанія і шлюб із Анною | 800 | 1200 |
| Первинні джерела | 600 | 900 |
| Деколонізаційний погляд | 600 | 900 |
| Значення хрещення: I — Цивілізаційний вибір | 700 | 1050 |
| Значення хрещення: II — Церковна організація та етика | 600 | 900 |
| Значення хрещення: III — Розквіт культури | 600 | 900 |
| Потрібно більше практики? | 200 | 300 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/volodymyr-khreshchennia.yaml`. Go through EVERY `points:` item in EVERY section:
