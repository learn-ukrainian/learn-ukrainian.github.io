...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/syntez-kozatstvo-vytoky.yaml
```

Read the current meta file for content_outline structure:

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/syntez-kozatstvo-vytoky.yaml
```

## Your Task

Research **Синтез: Становлення козацтва** for the **hist** track. Produce structured research notes that will drive content writing in later phases.
