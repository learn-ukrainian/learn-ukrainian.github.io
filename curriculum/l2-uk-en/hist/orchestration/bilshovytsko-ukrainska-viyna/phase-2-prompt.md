...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/bilshovytsko-ukrainska-viyna-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/bilshovytsko-ukrainska-viyna.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/bilshovytsko-ukrainska-viyna.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Більшовицько-українська війна** (hist track).
...
|---------|--------|---------------------|
| Вступ: Боротьба за незалежність | 400 | 600 |
| Перша більшовицька агресія: I — Ультиматум і початок вторгнення | 500 | 750 |
| Перша більшовицька агресія: II — Бій під Крутами та терор у Києві | 600 | 900 |
| Перша більшовицька агресія: III — Брестський мир і звільнення | 400 | 600 |
| Друга хвиля: I — Хаос 1919 року та «Трикутник смерті» | 500 | 750 |
| Друга хвиля: II — Легендарний Зимовий похід | 600 | 900 |
| Друга хвиля: III — Варшавський союз і Ризький мир | 500 | 750 |
| Первинні джерела: Голоси епохи | 500 | 750 |
| Деколонізаційний погляд: Гібридна війна століття тому | 500 | 750 |
| Підсумок: Уроки поразки і пам'ять | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/bilshovytsko-ukrainska-viyna.yaml`. Go through EVERY `points:` item in EVERY section:
