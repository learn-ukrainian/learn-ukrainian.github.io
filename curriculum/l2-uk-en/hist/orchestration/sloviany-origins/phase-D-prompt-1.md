...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/sloviany-origins.md"
   ```
...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/sloviany-origins.md`
...
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/sloviany-origins.yaml`
5. **Meta** (build config): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/sloviany-origins.yaml`
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/sloviany-origins-research.md`
...
Module persona:   Senior Professor of History, acting as Paleolinguist
Word count:       5120 / 5000 (102.4%)
Activities:       5
Vocabulary items: 25
Engagement boxes: 10
...
1. Вступ: Етимологія та ідентичність
2. Читання: I — Археологія та географія розселення
3. Читання: II — Антський союз: Хроніки боротьби
4. Читання: III — Матеріальний світ та суспільний устрій
5. Первинні джерела: Свідчення сучасників
6. Деколонізаційний погляд: Руйнування імперських міфів
7. Підсумок: Спадщина тисячоліть
