...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/shistdesiatnyky.yaml
```

Read the current meta file for content_outline structure:

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/shistdesiatnyky.yaml
```

## Your Task

Research **Шістдесятники: Бунт проти сірості** for the **hist** track. Produce structured research notes that will drive content writing in later phases.
