...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/rus-ta-susidy-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/rus-ta-susidy.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/rus-ta-susidy.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Русь та сусіди: Візантія, Польща, Угорщина** (hist track).
...
|---------|--------|---------------------|
| Вступ — Русь у міжнародному контексті | 400 | 600 |
| Русь і Візантія: I — Від ворожнечі до союзу | 800 | 1200 |
| Русь і Візантія: II — Цивілізаційний вибір | 600 | 900 |
| Русь і Польща | 600 | 900 |
| Русь і Угорщина | 500 | 750 |
| Степові сусіди | 700 | 1050 |
| Скандинавія та Захід: I — Північний вектор | 600 | 900 |
| Скандинавія та Захід: II — Русь у європейській родині | 800 | 1200 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/rus-ta-susidy.yaml`. Go through EVERY `points:` item in EVERY section:
