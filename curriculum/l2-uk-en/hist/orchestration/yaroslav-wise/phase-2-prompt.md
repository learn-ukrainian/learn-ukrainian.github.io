...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/yaroslav-wise-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/yaroslav-wise.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/yaroslav-wise.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Ярослав Мудрий: Золота доба** (hist track).
...
|---------|--------|---------------------|
| Розминка | 300 | 450 |
| Читання: Руська Правда — Перший правовий кодекс | 600 | 900 |
| Софія Київська — Символ могутності | 600 | 900 |
| "Тесть Європи" — Династична дипломатія | 600 | 900 |
| Культурна революція | 600 | 900 |
| Первинні джерела | 500 | 750 |
| Деколонізаційний погляд: I — Історична правда проти міфів | 600 | 900 |
| Деколонізаційний погляд: II — Правова та церковна спадщина | 600 | 900 |
| Деколонізаційний погляд: III — Таємниці та сучасність | 400 | 600 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/yaroslav-wise.yaml`. Go through EVERY `points:` item in EVERY section:
