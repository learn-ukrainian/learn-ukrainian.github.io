...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/kozatska-derzhava-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/kozatska-derzhava.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/kozatska-derzhava.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Хмельниччина: Козацька держава** (hist track).
...
|---------|--------|---------------------|
| Вступ: Народилася Гетьманщина | 500 | 750 |
| Структура влади: Гетьман та Генеральна старшина | 800 | 1200 |
| Адміністративний устрій: Полково-сотенна система | 700 | 1050 |
| Чигирин: Серце козацької держави | 600 | 900 |
| Економіка та право: Скарбниця та суди | 700 | 1050 |
| Читання: Універсали Богдана Хмельницького | 600 | 900 |
| Первинні джерела: Альберто Віміна про козаків | 600 | 900 |
| Деколонізаційний погляд: Державність проти анархії | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/kozatska-derzhava.yaml`. Go through EVERY `points:` item in EVERY section:
