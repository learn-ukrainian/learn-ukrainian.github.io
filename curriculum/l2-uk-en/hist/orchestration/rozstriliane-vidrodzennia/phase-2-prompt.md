...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/rozstriliane-vidrodzennia-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/rozstriliane-vidrodzennia.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/rozstriliane-vidrodzennia.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Розстріляне відродження: Постаті** (hist track).
...
|---------|--------|---------------------|
| Вступ: Покоління мрійників | 500 | 750 |
| Ключові постаті: I — Микола Хвильовий | 600 | 900 |
| Ключові постаті: II — Лесь Курбас і театр | 600 | 900 |
| Ключові постаті: III — Михайло Бойчук і мистецтво | 500 | 750 |
| Ключові постаті: IV — Неокласики та різноманіття голосів | 500 | 750 |
| Будинок «Слово»: I — Архітектура пастки | 400 | 600 |
| Будинок «Слово»: II — Хроніка терору | 400 | 600 |
| Первинні джерела | 400 | 600 |
| Деколонізаційний погляд | 500 | 750 |
| Підсумок: Сандармох і пам'ять | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/rozstriliane-vidrodzennia.yaml`. Go through EVERY `points:` item in EVERY section:
