...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/kozatska-kultura-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/kozatska-kultura.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/kozatska-kultura.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Козацька культура — кобзарі, думи та бароко** (hist track).
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/kozatska-kultura.yaml`. Go through EVERY `points:` item in EVERY section:
