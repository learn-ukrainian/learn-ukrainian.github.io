...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/pravoslavna-tserkva-17-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/pravoslavna-tserkva-17.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/pravoslavna-tserkva-17.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Православна церква XVII століття** (hist track).
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/pravoslavna-tserkva-17.yaml`. Go through EVERY `points:` item in EVERY section:
