...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/zasnuvannia-kyieva-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/zasnuvannia-kyieva.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/zasnuvannia-kyieva.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Заснування Києва** (hist track).
...
|---------|--------|---------------------|
| Вступ | 300 | 450 |
| Читання: I — Легенда про засновників | 450 | 675 |
| Читання: II — Постать Кия: Князь чи перевізник? | 450 | 675 |
| Варяги та хозари: I — Транзитний хаб «із варягів у греки» | 500 | 750 |
| Варяги та хозари: II — Хозарський вплив та загадка Самбатаса | 500 | 750 |
| Первинні джерела | 500 | 750 |
| Деколонізаційний погляд: I — Міф про «три братні народи» | 450 | 675 |
| Деколонізаційний погляд: II — Радянська арифметика: Чому 482 рік? | 450 | 675 |
| Археологічні свідчення: I — Старокиївська гора та Дитинець | 450 | 675 |
| Археологічні свідчення: II — Торгівля та еволюція міста | 450 | 675 |
| Хронологія: Легенди та археологія | 400 | 600 |
| Підсумок | 200 | 300 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/zasnuvannia-kyieva.yaml`. Go through EVERY `points:` item in EVERY section:
