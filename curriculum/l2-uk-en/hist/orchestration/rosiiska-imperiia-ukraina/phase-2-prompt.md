...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/rosiiska-imperiia-ukraina-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/rosiiska-imperiia-ukraina.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/rosiiska-imperiia-ukraina.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Південь України: Колонізація та міфи** (hist track).
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/rosiiska-imperiia-ukraina.yaml`. Go through EVERY `points:` item in EVERY section:
