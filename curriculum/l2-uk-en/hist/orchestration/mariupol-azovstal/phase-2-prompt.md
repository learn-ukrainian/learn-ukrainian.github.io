...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/mariupol-azovstal-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/mariupol-azovstal.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/mariupol-azovstal.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Маріуполь та Азовсталь** (hist track).
...
|---------|--------|---------------------|
| Вступ: Місто-герой | 500 | 750 |
| Облога міста: Хроніка гуманітарної катастрофи | 600 | 900 |
| Облога міста: Злочини проти цивільних | 600 | 900 |
| Оборона Азовсталі: Фортеця та гарнізон | 550 | 825 |
| Оборона Азовсталі: Життя в підземеллі | 650 | 975 |
| Оборона Азовсталі: Наказ зберегти життя | 550 | 825 |
| Первинні джерела: Голоси з пекла | 550 | 825 |
| Деколонізаційний погляд: Урбіцид замість звільнення | 600 | 900 |
| Підсумок: Ціна свободи та майбутнє | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/mariupol-azovstal.yaml`. Go through EVERY `points:` item in EVERY section:
