...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/holodomor-pamiat-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/holodomor-pamiat.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/holodomor-pamiat.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Голодомор: Пам'ять та визнання** (hist track).
...
|---------|--------|---------------------|
| Вступ: Злочин без кари | 600 | 900 |
| Свідки та журналісти: І — Гарет Джонс | 600 | 900 |
| Свідки та журналісти: ІІ — Інформаційна війна | 600 | 900 |
| Боротьба за визнання: І — Роль діаспори та Комісія Мейса | 700 | 1050 |
| Боротьба за визнання: ІІ — Відкриття правди в Незалежній Україні | 600 | 900 |
| Первинні джерела: Доказова база | 600 | 900 |
| Деколонізаційний погляд: І — Юридична природа геноциду | 600 | 900 |
| Деколонізаційний погляд: ІІ — Травма постгеноцидного суспільства | 500 | 750 |
| Підсумок: Чому це важливо | 300 | 450 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/holodomor-pamiat.yaml`. Go through EVERY `points:` item in EVERY section:
