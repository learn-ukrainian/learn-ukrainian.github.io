...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/slobozhanshchyna-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/slobozhanshchyna.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/slobozhanshchyna.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Слобожанщина: Заселення і розвиток** (hist track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Заселення Слобожанщини: I — Хвилі міграції | 700 | 1050 |
| Заселення Слобожанщини: II — Слободи та політика | 700 | 1050 |
| П'ять слобідських козацьких полків: I — Адміністративний устрій | 700 | 1050 |
| П'ять слобідських козацьких полків: II — Міста та функції | 700 | 1050 |
| Суспільство Слобожанщини | 600 | 900 |
| Первинні джерела | 500 | 750 |
| Деколонізаційний погляд: I — Міфи імперії | 600 | 900 |
| Деколонізаційний погляд: II — Спадщина та сучасність | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/slobozhanshchyna.yaml`. Go through EVERY `points:` item in EVERY section:
