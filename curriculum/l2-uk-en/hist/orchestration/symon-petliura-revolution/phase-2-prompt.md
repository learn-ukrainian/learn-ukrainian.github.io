...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/symon-petliura-revolution-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/symon-petliura-revolution.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/symon-petliura-revolution.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Симон Петлюра: Головний отаман** (hist track).
...
|---------|--------|---------------------|
| Вступ: Символ боротьби | 400 | 600 |
| Шлях до влади: I — Публіцист і політик | 500 | 750 |
| Шлях до влади: II — Будівничий армії | 600 | 900 |
| Війна за незалежність: I — У колі ворогів | 700 | 1050 |
| Війна за незалежність: II — Відступ і підпілля | 600 | 900 |
| Первинні джерела | 600 | 900 |
| Деколонізаційний погляд: I — Фабрикація ворога | 500 | 750 |
| Деколонізаційний погляд: II — Єврейське питання | 500 | 750 |
| Підсумок: Париж, 1926 | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/symon-petliura-revolution.yaml`. Go through EVERY `points:` item in EVERY section:
