...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/dmytro-vyshnevetskyi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/dmytro-vyshnevetskyi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/dmytro-vyshnevetskyi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Дмитро Вишневецький: Перший кошовий** (hist track).
...
|---------|--------|---------------------|
| Вступ | 300 | 450 |
| Шлях князя: Від Волині до Степу — Походження і статус | 550 | 825 |
| Шлях князя: Від Волині до Степу — Виклик Дикого Поля | 550 | 825 |
| Заснування Малої Хортиці — Перша Січ | 600 | 900 |
| Заснування Малої Хортиці — Героїчна оборона | 600 | 900 |
| Читання — 'Пісня про Байду' | 600 | 900 |
| Геополітика і Дипломатія — Московський епізод | 550 | 825 |
| Геополітика і Дипломатія — Розрив і повернення | 550 | 825 |
| Первинні джерела — Свідчення про страту | 400 | 600 |
| Деколонізаційний погляд | 300 | 450 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/dmytro-vyshnevetskyi.yaml`. Go through EVERY `points:` item in EVERY section:
