...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/syntez-kyivska-rus-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/syntez-kyivska-rus.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/syntez-kyivska-rus.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Синтез: Київська Русь — спадщина** (hist track).
...
|---------|--------|---------------------|
| Вступ — Три століття Русі | 500 | 750 |
| Політичний розвиток: I — Динаміка влади | 400 | 600 |
| Політичний розвиток: II — Устрій та децентралізація | 400 | 600 |
| Культурні досягнення: I — Архітектура та мистецтво | 400 | 600 |
| Культурні досягнення: II — Слово і Закон | 400 | 600 |
| Суспільство та економіка: I — Соціальна ієрархія | 400 | 600 |
| Суспільство та економіка: II — Країна міст і торгівлі | 400 | 600 |
| Русь у Європі | 600 | 900 |
| Спадщина Русі — хто спадкоємець?: I — Історична тяглість | 450 | 675 |
| Спадщина Русі — хто спадкоємець?: II — Політична традиція | 450 | 675 |
| Ключові терміни та дати | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/syntez-kyivska-rus.yaml`. Go through EVERY `points:` item in EVERY section:
