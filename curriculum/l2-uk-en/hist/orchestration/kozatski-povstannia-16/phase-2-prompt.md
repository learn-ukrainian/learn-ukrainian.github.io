...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/kozatski-povstannia-16-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/kozatski-povstannia-16.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/kozatski-povstannia-16.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Козацькі повстання XVI століття** (hist track).
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/kozatski-povstannia-16.yaml`. Go through EVERY `points:` item in EVERY section:
