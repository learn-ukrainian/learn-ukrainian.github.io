...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/revoliutsiia-hidnosti-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/revoliutsiia-hidnosti.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/revoliutsiia-hidnosti.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Революція Гідності: Євромайдан** (hist track).
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/revoliutsiia-hidnosti.yaml`. Go through EVERY `points:` item in EVERY section:
