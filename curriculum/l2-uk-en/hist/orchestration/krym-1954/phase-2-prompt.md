...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/krym-1954-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/krym-1954.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/krym-1954.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Крим 1954: Передача УРСР** (hist track).
...
|---------|--------|---------------------|
| Вступ: «Подарунок» чи рішення? | 500 | 750 |
| Контекст: Крим до 1954 року — Депортація та руїна | 800 | 1200 |
| Контекст: Крим до 1954 року — Провал колонізації та вода | 800 | 1200 |
| Передача: як це відбулося — Ініціатива та рішення | 600 | 900 |
| Передача: як це відбулося — Юридична процедура | 600 | 900 |
| Первинні джерела | 600 | 900 |
| Деколонізаційний погляд | 600 | 900 |
| Підсумок: Від 1954 до 2014 | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/krym-1954.yaml`. Go through EVERY `points:` item in EVERY section:
