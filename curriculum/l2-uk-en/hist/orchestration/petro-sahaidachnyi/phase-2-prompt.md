...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/petro-sahaidachnyi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/petro-sahaidachnyi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/petro-sahaidachnyi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Петро Сагайдачний: Гетьман і меценат** (hist track).
...
|---------|--------|---------------------|
| Вступ | 300 | 450 |
| Шлях від Кульчиць до Січі | 600 | 900 |
| Військова слава: Кафа та Москва — шлях переможця | 900 | 1350 |
| Читання: Голос барокової епохи | 500 | 750 |
| Меценатство та Освіта: Революція духу | 800 | 1200 |
| Хотинська епопея (1621): Битва за майбутнє Європи | 1000 | 1500 |
| Первинні джерела: Свідчення очевидців та славослів'я | 400 | 600 |
| Деколонізаційний погляд: Повернення справжнього гетьмана | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/petro-sahaidachnyi.yaml`. Go through EVERY `points:` item in EVERY section:
