...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/zlochyny-stiikist-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/zlochyny-stiikist.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/zlochyny-stiikist.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Злочини і стійкість** (hist track).
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/zlochyny-stiikist.yaml`. Go through EVERY `points:` item in EVERY section:
