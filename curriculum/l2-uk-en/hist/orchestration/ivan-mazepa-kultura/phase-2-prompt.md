...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/ivan-mazepa-kultura-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/ivan-mazepa-kultura.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/ivan-mazepa-kultura.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Іван Мазепа II: освіта і культура** (hist track).
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/ivan-mazepa-kultura.yaml`. Go through EVERY `points:` item in EVERY section:
