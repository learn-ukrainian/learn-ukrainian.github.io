...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/tsentralna-rada-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/tsentralna-rada.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/tsentralna-rada.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Центральна Рада: Від автономії до незалежності** (hist track).
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/tsentralna-rada.yaml`. Go through EVERY `points:` item in EVERY section:
