...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/velyke-kniazivstvo-lytovske-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/velyke-kniazivstvo-lytovske.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/velyke-kniazivstvo-lytovske.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Велике князівство Литовське — Руська держава** (hist track).
...
|---------|--------|---------------------|
| Вступ | 300 | 450 |
| Читання: I — Литовська експансія та Битва на Синіх Водах | 600 | 900 |
| Читання: II — Руська мова як державна і «lingua franca» | 600 | 900 |
| Читання: III — Релігійна толерантність та руська шляхта | 500 | 750 |
| Первинні джерела: I — Литовські статути | 600 | 900 |
| Первинні джерела: II — Європейська правова культура | 600 | 900 |
| Деколонізаційний погляд: I — Дві моделі державності | 600 | 900 |
| Деколонізаційний погляд: II — Демократична спадщина Русі | 500 | 750 |
| Критерії оцінювання | 100 | 150 |
| Зразок відповіді | 400 | 600 |
| Підсумок — Спільна спадщина | 300 | 450 |
| Потрібно більше практики? | 100 | 150 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/velyke-kniazivstvo-lytovske.yaml`. Go through EVERY `points:` item in EVERY section:
