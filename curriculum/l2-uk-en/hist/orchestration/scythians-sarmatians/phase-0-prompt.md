...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/scythians-sarmatians.yaml
```

## Your Task

Research **Скіфи та сармати — Володарі степу** for the **hist** track. Produce structured research notes that will drive content writing in later phases.
