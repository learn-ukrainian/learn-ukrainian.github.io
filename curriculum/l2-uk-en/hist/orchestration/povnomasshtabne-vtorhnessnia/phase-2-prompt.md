...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/research/povnomasshtabne-vtorhnessnia-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/povnomasshtabne-vtorhnessnia.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/povnomasshtabne-vtorhnessnia.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Повномасштабне вторгнення** (hist track).
...
|---------|--------|---------------------|
| Вступ: День, що змінив світ | 700 | 1050 |
| Перші дні | 800 | 1200 |
| Битва за Київ: I — Оборона столиці | 900 | 1350 |
| Битва за Київ: II — Окупація та звільнення | 900 | 1350 |
| Первинні джерела | 600 | 900 |
| Деколонізаційний погляд | 600 | 900 |
| Підсумок: Перші перемоги | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/povnomasshtabne-vtorhnessnia.yaml`. Go through EVERY `points:` item in EVERY section:
