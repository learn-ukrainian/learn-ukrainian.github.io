...
| Module persona | Senior Professor of History, acting as Territorial Defense Fighter |
...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/povnomasshtabne-vtorhnessnia.md
```

**Plan file** (vocabulary_hints — vocabulary list to follow):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/hist/povnomasshtabne-vtorhnessnia.yaml
```

**Meta file** (activity count targets, pedagogy):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/hist/meta/povnomasshtabne-vtorhnessnia.yaml
```

**Activity schema** (CRITICAL — defines allowed fields per activity type):
```
schemas/activities-hist.schema.json
```
...
- **Schema violations**: `additionalProperties: false` means ANY unlisted field = instant fail. Read `schemas/activities-hist.schema.json` before writing.
...
3. **Seminar style** (hist): Reading Input → Analytical Output. Focus on comprehension, analysis, and critical thinking — NOT drill exercises.
...
### CRITICAL: Activity Type Constraints for hist
