...
Not covered:
  - Трипільська культура → hist-01
  - Грецькі міста-колонії (детально) → hist-03
Related: hist-03, hist-08
-->
...
> [!quote]
> **Геродот («Історія», книга 4) [Джерело](http://litopys.org.ua/):**
...
Скіфський період — ідеальна ілюстрація цієї ідеї. Золота Пектораль — це грецька (еллінська) досконала форма, наповнена скіфським (степовим) могутнім змістом. Це й є код української культури — унікальний синтез Заходу та Сходу, порядку і стихії, який робить нас тими, ким ми є.
