...
word_target: 5000
objectives:
- Дізнатися про життя та творчість Михайло Бойчук
sources:
...
content_outline:
- section: Вступ — Painter, founded Boychukism
  points:
  - <!-- point -->
  words: 850
...
Research **Михайло Бойчук: <!-- Title -->** for the **bio** track. Produce structured research notes that will drive content writing in Phase B.
