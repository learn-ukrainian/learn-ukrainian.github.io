...
```
curriculum/l2-uk-en/plans/lit-hist-fic/kokotyukha-red.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
curriculum/l2-uk-en/lit-hist-fic/meta/kokotyukha-red.yaml
```
...
Research **Kokotyukha Red** for the **lit-hist-fic** track. Produce structured research notes that will drive content writing in Phase B.
