...
- `query_wikipedia(query="Збірка давніх текстів XI-XIII ст.", mode="extract")` — factual backbone
- `search_literary(query="Збірка давніх текстів XI-XIII ст.")` — primary source excerpts
