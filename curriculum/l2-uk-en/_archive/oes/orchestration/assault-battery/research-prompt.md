...
version: '2.0'
title: Побої та образи
subtitle: Assault & Battery
focus: Instrumental Case review
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Assault & Battery
  words: 1250
...
Research **Побої та образи** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
