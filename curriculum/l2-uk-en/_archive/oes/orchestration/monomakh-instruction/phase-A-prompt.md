...
```
curriculum/l2-uk-en/plans/oes/monomakh-instruction.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
curriculum/l2-uk-en/oes/meta/monomakh-instruction.yaml
```
...
Research **Monomakh Instruction** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
...
# Дослідження: Monomakh Instruction
