...
version: '2.0'
title: Повчання Мономаха
subtitle: Monomakh's Instruction
focus: Didactic genre — Imperative mood
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Monomakh's Instruction
  words: 1250
...
Research **Повчання Мономаха** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
