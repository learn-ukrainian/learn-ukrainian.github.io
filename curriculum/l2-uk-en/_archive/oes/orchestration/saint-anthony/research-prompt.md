...
slug: saint-anthony
version: '2.0'
title: Святий Антоній
subtitle: Saint Anthony
focus: Asceticism terminology
phase: 4
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Saint Anthony
  words: 1250
...
Research **Святий Антоній** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
