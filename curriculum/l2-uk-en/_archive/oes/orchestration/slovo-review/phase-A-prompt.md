...
```
curriculum/l2-uk-en/plans/oes/slovo-review.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
curriculum/l2-uk-en/oes/meta/slovo-review.yaml
```
...
Research **Slovo Review** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
