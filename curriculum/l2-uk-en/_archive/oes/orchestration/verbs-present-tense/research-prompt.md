...
version: '2.0'
title: 'Дієслова I: Теперішній час'
subtitle: 'Verbs I: Present Tense'
focus: Action in the moment (graffiti examples)
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to Verbs I: Present Tense'
  words: 1250
...
Research **Дієслова I: Теперішній час** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
