...
version: '2.0'
title: Орфографія та єри (Ъ, Ь)
subtitle: Orthography & The Yers
focus: Why we write ъ/ь and where they went
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Orthography & The Yers
  words: 1250
...
persona:
  ...
  role: Manuscript Restorer
prerequisites:
- alphabet-glagolitic-cyrillic
connects_to:
- pleophony-sound-of-rus
objectives:
...
Research **Орфографія та єри (Ъ, Ь)** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
