...
version: '2.0'
title: 'ПВЛ: Ярослав Мудрий'
subtitle: 'PVL: Yaroslav the Wise'
focus: Law & Culture — Ruska Pravda context
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to PVL: Yaroslav the Wise'
  words: 1250
...
Research **ПВЛ: Ярослав Мудрий** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
