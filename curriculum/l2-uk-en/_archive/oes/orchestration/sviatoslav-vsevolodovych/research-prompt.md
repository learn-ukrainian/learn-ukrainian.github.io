...
version: '2.0'
title: Святослав Всеволодович
subtitle: Sviatoslav Vsevolodovych
focus: '"Golden Word" context'
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Sviatoslav Vsevolodovych
  words: 1250
...
persona:
  ...
  role: Kyiv Grand Prince
prerequisites:
- ihor-campaign-chronicle
connects_to:
- roman-mstyslavych
objectives:
...
Research **Святослав Всеволодович** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
