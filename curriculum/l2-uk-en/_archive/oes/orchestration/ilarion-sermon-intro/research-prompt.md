...
version: '2.0'
title: 'Проповідь Іларіона: Вступ'
subtitle: Ilarion's Sermon (Intro)
focus: Law (Moses) vs Grace (Jesus)
phase: 4
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Ilarion's Sermon (Intro)
  words: 1250
...
Research **Проповідь Іларіона: Вступ** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
