...
version: '2.0'
title: Святий Феодосій
subtitle: Saint Theodosius
focus: Monastic community organization
phase: 4
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Saint Theodosius
  words: 1250
...
Research **Святий Феодосій** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
