...
version: '2.0'
title: 'Займенники: Я та інші'
subtitle: 'Pronouns: Self and Other'
focus: Я, ти, мьнѣ, тобѣ in personal letters
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to Pronouns: Self and Other'
  words: 1250
...
Research **Займенники: Я та інші** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
