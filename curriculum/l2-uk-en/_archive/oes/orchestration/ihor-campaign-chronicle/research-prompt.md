...
version: '2.0'
title: Похід Ігоря (літопис)
subtitle: Ihor's Campaign (Chronicle)
focus: Link to Slovo — Historical vs Poetic
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Ihor's Campaign (Chronicle)
  words: 1250
...
Research **Похід Ігоря (літопис)** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
