...
version: '2.0'
title: Загадка яті (ѣ)
subtitle: The Yat' Mystery
focus: The unique sound of ѣ and its Ukrainian path
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to The Yat' Mystery
  words: 1250
...
Research **Загадка яті (ѣ)** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
