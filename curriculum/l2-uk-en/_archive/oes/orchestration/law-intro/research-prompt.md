...
slug: law-intro
version: '2.0'
title: Вступ до права
subtitle: Intro to Law
focus: Pravda, Zakon, Sud — "If" (Ashche) clauses
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Intro to Law
  words: 1250
...
Research **Вступ до права** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
