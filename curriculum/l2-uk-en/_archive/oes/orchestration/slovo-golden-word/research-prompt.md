...
version: '2.0'
title: 'Слово: Золоте слово'
subtitle: 'Slovo: The Golden Word'
focus: Rhetoric — The plea for unity
phase: 4
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to Slovo: The Golden Word'
  words: 1250
...
persona:
  ...
  role: Grand Prince's Orator
prerequisites:
- slovo-svyatoslav-dream
connects_to:
...
Research **Слово: Золоте слово** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
