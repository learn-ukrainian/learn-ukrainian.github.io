...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/oes/pvl-volodymyr-choice.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/oes/meta/pvl-volodymyr-choice.yaml
```
...
Research **Pvl Volodymyr Choice** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
