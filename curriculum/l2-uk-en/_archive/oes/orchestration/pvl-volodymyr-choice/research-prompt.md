...
version: '2.0'
title: 'ПВЛ: Вибір Володимира'
subtitle: 'PVL: Volodymyr''s Choice'
focus: Comparative religion vocabulary
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to PVL: Volodymyr''s Choice'
  words: 1250
...
Research **ПВЛ: Вибір Володимира** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
...
- `query_wikipedia(query="ПВЛ: Вибір Володимира", mode="extract")` — factual backbone
- `search_literary(query="ПВЛ: Вибір Володимира")` — primary source excerpts
