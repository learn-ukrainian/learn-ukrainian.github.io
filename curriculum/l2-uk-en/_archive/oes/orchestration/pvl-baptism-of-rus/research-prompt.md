...
version: '2.0'
title: 'ПВЛ: Хрещення Русі'
subtitle: 'PVL: Baptism of Rus'''
focus: Ritual vocabulary — "Povele" (He commanded)
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to PVL: Baptism of Rus'''
  words: 1250
...
Research **ПВЛ: Хрещення Русі** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
