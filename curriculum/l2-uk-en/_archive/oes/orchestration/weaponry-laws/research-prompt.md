...
slug: weaponry-laws
version: '2.0'
title: Закони про зброю
subtitle: Weaponry Laws
focus: Vocabulary of arms
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Weaponry Laws
  words: 1250
...
Research **Закони про зброю** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
