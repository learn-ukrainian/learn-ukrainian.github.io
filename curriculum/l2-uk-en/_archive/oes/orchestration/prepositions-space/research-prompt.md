...
version: '2.0'
title: Прийменники та простір
subtitle: Prepositions & Space
focus: Въ, на, къ — Direction vs Location
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Prepositions & Space
  words: 1250
...
Research **Прийменники та простір** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
...
```yaml
subject: "Прийменники та простір"
