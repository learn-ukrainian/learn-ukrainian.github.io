...
version: '2.0'
title: 'Слово: Плач Ярославни'
subtitle: 'Slovo: Yaroslavna''s Lament'
focus: Lyrical genre — Address to Wind/Sun/Dnipro
phase: 4
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to Slovo: Yaroslavna''s Lament'
  words: 1250
...
Research **Слово: Плач Ярославни** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
