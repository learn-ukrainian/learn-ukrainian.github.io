...
version: '2.0'
title: Договір 911 (Олег)
subtitle: Treaty of 911 (Oleg)
focus: Diplomatic formulas — "My ot rodu ruskoho..."
phase: 3
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Treaty of 911 (Oleg)
  words: 1250
...
persona:
  ...
  role: Imperial Translator
prerequisites:
- review-social-pyramid
connects_to:
- trade-rights
objectives:
...
Research **Договір 911 (Олег)** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
...
- `query_wikipedia(query="Договір 911 (Олег)", mode="extract")` — factual backbone
- `search_literary(query="Договір 911 (Олег)")` — primary source excerpts
