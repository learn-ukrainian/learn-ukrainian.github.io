...
version: '2.0'
title: 'Слово: Дискусія про автентичність'
subtitle: 'Slovo: The Authenticity Debate'
focus: Arguments for/against 12th c. origin
phase: 4
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to Slovo: The Authenticity Debate'
  words: 1250
...
Research **Слово: Дискусія про автентичність** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
