...
version: '2.0'
title: 'Лабораторія: Смерть царя'
subtitle: 'Lab: The Death of a Tsar'
focus: Analyzing the 1054 graffiti on Yaroslav's death
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to Lab: The Death of a Tsar'
  words: 1250
...
Research **Лабораторія: Смерть царя** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
