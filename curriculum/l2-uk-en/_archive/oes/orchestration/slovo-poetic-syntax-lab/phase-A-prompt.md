...
```
curriculum/l2-uk-en/plans/oes/slovo-poetic-syntax-lab.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
curriculum/l2-uk-en/oes/meta/slovo-poetic-syntax-lab.yaml
```
...
Research **Slovo Poetic Syntax Lab** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
