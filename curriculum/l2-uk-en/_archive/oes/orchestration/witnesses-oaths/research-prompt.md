...
version: '2.0'
title: Свідки та присяги
subtitle: Witnesses & Oaths
focus: Dual — "Two witnesses"
phase: 3
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Witnesses & Oaths
  words: 1250
...
Research **Свідки та присяги** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
