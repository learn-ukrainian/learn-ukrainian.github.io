...
version: '2.0'
title: Банкрути-купці
subtitle: Bankrupt Merchants
focus: Trade law basics
phase: 3
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Bankrupt Merchants
  words: 1250
...
Research **Банкрути-купці** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
