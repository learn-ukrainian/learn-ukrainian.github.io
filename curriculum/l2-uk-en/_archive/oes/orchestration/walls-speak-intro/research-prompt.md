...
subtitle: 'St. Sophia Graffiti: The Walls Speak'
focus: Intro to epigraphy, graffiti as historical source
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to graffiti as linguistic archaeology
  words: 550
- section: Текст
  points:
  - Primary source excerpts with glosses
  words: 550
- section: Що таке епіграфіка?
  points:
  - Definition and types of epigraphic inscriptions
  words: 550
- section: Мовний аналіз
  points:
  - 'Grammatical analysis: dative, perfect, vocative'
  words: 550
- section: Історичний контекст
  points:
  - St. Sophia Cathedral, who wrote graffiti, dating methods
  words: 550
- section: 'Диглосія: два регістри однієї мови'
  points:
  - 'Diglossia model: literary vs vernacular'
  words: 550
- section: Зв'язок із сучасною мовою
  points:
  - What survived in modern Ukrainian
  words: 550
- section: 'Методологія: як читати давні тексти'
  points:
  - Step-by-step reading methodology
  words: 550
- section: Підсумок
  points:
  - Summary and vocabulary table
  words: 600
vocabulary_hints:
- графіті
- тать
...
- Застосовувати знання з теми «Історичний контекст» у власній мовній практиці
...
Research **Софійські графіті: Стіни говорять** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
