...
version: '2.0'
title: 'Двоїна: Вступ'
subtitle: The Dual Number
focus: Handling pairs (eyes, hands, two people)
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to The Dual Number
  words: 1250
...
Research **Двоїна: Вступ** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
