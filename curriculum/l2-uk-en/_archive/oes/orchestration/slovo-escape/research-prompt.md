...
version: '2.0'
title: 'Слово: Втеча'
subtitle: 'Slovo: The Escape'
focus: Action verbs — Transformation motif
phase: 4
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to Slovo: The Escape'
  words: 1250
...
persona:
  ...
  role: Guide of the Steppe
prerequisites:
- slovo-yaroslavna-lament
connects_to:
- slovo-return
objectives:
...
Research **Слово: Втеча** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
