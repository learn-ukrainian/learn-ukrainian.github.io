...
slug: verbs-perfect
version: '2.0'
title: 'Дієслова III: Перфект'
subtitle: 'Verbs III: The Perfect'
focus: '"Вкрав єси..." — Origin of modern past tense'
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to Verbs III: The Perfect'
  words: 1250
...
Research **Дієслова III: Перфект** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
