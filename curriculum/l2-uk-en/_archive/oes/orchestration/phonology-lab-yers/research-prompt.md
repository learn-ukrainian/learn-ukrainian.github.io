...
version: '2.0'
title: 'Фонологічна лабораторія: Єри'
subtitle: 'Phonology Lab: Fall of Yers'
focus: Tracing Yer loss & Yat evolution
phase: 4
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to Phonology Lab: Fall of Yers'
  words: 1250
...
Research **Фонологічна лабораторія: Єри** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
