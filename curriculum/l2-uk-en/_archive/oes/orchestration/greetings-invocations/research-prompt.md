...
version: '2.0'
title: Вітання та звертання
subtitle: Greetings & Invocations
focus: '"Господи, помози..." — Dative case in prayers'
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Greetings & Invocations
  words: 1250
...
Research **Вітання та звертання** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
