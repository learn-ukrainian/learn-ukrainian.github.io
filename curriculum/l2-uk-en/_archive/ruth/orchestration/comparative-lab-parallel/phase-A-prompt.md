...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/ruth/comparative-lab-parallel.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/ruth/meta/comparative-lab-parallel.yaml
```
...
Research **Comparative Lab Parallel** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
...
# Дослідження: Comparative Lab Parallel
