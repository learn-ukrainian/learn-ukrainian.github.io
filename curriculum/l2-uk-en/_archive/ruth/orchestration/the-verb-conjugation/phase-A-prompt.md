...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/ruth/the-verb-conjugation.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/ruth/meta/the-verb-conjugation.yaml
```
...
Research **The Verb Conjugation** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
...
# Дослідження: The Verb Conjugation
