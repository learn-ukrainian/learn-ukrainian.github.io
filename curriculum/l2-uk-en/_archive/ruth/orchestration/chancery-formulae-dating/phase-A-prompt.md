...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/ruth/chancery-formulae-dating.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/ruth/meta/chancery-formulae-dating.yaml
```
...
Research **Chancery Formulae Dating** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
