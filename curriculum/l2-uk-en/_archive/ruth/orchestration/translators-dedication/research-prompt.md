...
version: '2.0'
title: Перекладачі
subtitle: The Translators
focus: Archimandrite Hryhorii & Mykhailo
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to The Translators
  words: 1250
...
Research **Перекладачі** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
