...
version: '2.0'
title: 'Притча: Блудний син'
subtitle: 'The Parables II: Prodigal Son'
focus: Family & emotional vocabulary
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to The Parables II: Prodigal Son'
  words: 1250
...
Research **Притча: Блудний син** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
