...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/ruth/polonisms-in-law.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/ruth/meta/polonisms-in-law.yaml
```
...
Research **Polonisms In Law** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
