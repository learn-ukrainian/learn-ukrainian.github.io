...
version: '2.0'
title: Філософська лабораторія
subtitle: Philosophical Lab
focus: Analyzing a Socratic dialogue
phase: 4
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Philosophical Lab
  words: 1250
...
Research **Філософська лабораторія** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
...
- `query_wikipedia(query="Філософська лабораторія", mode="extract")` — factual backbone
- `search_literary(query="Філософська лабораторія")` — primary source excerpts
...
```yaml
subject: "Філософська лабораторія"
