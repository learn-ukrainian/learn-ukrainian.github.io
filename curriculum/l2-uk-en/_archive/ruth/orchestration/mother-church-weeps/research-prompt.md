...
version: '2.0'
title: Матір-Церква плаче
subtitle: Mother Church Weeps
focus: Threnos — Central metaphor, Personification
phase: 3
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Mother Church Weeps
  words: 1250
...
Research **Матір-Церква плаче** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
