...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/ruth/mother-church-weeps.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/ruth/meta/mother-church-weeps.yaml
```
...
Research **Mother Church Weeps** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
...
# Дослідження: Mother Church Weeps
