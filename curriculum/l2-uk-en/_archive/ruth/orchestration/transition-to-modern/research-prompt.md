...
version: '2.0'
title: Перехід до сучасності
subtitle: Transition to Modern
focus: Bridging to Kotliarevsky's Eneida
phase: 4
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Transition to Modern
  words: 1250
...
Research **Перехід до сучасності** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
...
- `query_wikipedia(query="Перехід до сучасності", mode="extract")` — factual backbone
- `search_literary(query="Перехід до сучасності")` — primary source excerpts
