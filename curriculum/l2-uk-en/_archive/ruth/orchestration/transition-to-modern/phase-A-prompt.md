...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/ruth/transition-to-modern.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/ruth/meta/transition-to-modern.yaml
```
...
Research **Transition To Modern** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
...
# Дослідження: Transition To Modern
