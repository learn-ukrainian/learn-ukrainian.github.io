...
version: '2.0'
title: Мандрівний філософ
subtitle: The Wandering Philosopher
focus: Skovoroda — Life as text
phase: 4
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to The Wandering Philosopher
  words: 1250
...
persona:
  ...
  role: Wandering Sage (Mandrivny)
prerequisites:
- orlyk-latin-comparison
connects_to:
- fables-kharkiv
objectives:
...
Research **Мандрівний філософ** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
