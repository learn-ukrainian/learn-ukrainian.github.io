...
```
curriculum/l2-uk-en/ruth/research/likarski-poradnyky-research.md
```

Read the plan file (SOURCE OF TRUTH for structure):

```
curriculum/l2-uk-en/plans/ruth/likarski-poradnyky.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
curriculum/l2-uk-en/ruth/meta/likarski-poradnyky.yaml
```
