...
version: '2.0'
title: Прославлення Війська
subtitle: Glorifying the Host
focus: Hrabianka — Origins of Cossacks (Khazars myth)
phase: 4
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Glorifying the Host
  words: 1250
...
Research **Прославлення Війська** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
