...
version: '2.0'
title: 'Мелетій Смотрицький: Апологія'
subtitle: 'Meletiy Smotrytsky: Apologia'
focus: Defense of Slavonic as "dignified" language
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to Meletiy Smotrytsky: Apologia'
  words: 1250
...
persona:
  ...
  role: Uniate Polemicist
prerequisites:
- vyshensky-epistles
connects_to:
- comparative-lab-parallel
objectives:
...
Research **Мелетій Смотрицький: Апологія** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
...
```yaml
subject: "Мелетій Смотрицький: Апологія"
