...
slug: chronicle-lab
version: '2.0'
title: Лабораторія літопису
subtitle: Chronicle Lab
focus: Drafting a chronicle entry for a modern event
phase: 4
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Chronicle Lab
  words: 1250
...
Research **Лабораторія літопису** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
