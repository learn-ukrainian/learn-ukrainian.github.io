...
version: '2.0'
title: Друкарська лексика
subtitle: Printing Vocabulary
focus: Друкарня, Тисяч — Colophon terms
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Printing Vocabulary
  words: 1250
...
persona:
  ...
  role: Gutenberg's Disciple
prerequisites:
- herasym-smotrytsky-poems
connects_to:
- ostrih-legacy
objectives:
...
Research **Друкарська лексика** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
