...
version: '2.0'
title: Соціальна критика
subtitle: Social Critique
focus: Defense of the poor vs rich prelates
phase: 3
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Social Critique
  words: 1250
...
Research **Соціальна критика** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
