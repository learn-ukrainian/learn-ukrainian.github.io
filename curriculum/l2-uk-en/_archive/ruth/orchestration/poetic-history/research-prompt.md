...
slug: poetic-history
version: '2.0'
title: Поетична історія
subtitle: Poetic History
focus: Verse in chronicles
phase: 4
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Poetic History
  words: 1250
...
Research **Поетична історія** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
