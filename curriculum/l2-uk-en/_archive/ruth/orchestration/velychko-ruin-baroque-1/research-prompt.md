...
version: '2.0'
title: Самійло Величко I — Архіваріус Руїни
subtitle: Samiilo Velychko I — Archivist of the Ruin
focus: Velychko's method, sources, and baroque architectural structure
phase: 4
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Velychko — Baroque Method
  words: 1250
...
persona:
  ...
  role: Cossack Archivist
prerequisites:
- hrabianka-heroic-chronicle
connects_to:
- velychko-ruin-baroque-2
objectives:
...
Research **Самійло Величко I — Архіваріус Руїни** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
