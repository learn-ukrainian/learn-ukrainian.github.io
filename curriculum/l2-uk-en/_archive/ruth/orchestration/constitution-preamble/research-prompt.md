...
version: '2.0'
title: 'Конституція: Преамбула'
subtitle: The Constitution
focus: Historical justification of Cossack rights
phase: 4
word_target: 5000
content_outline:
- section: Вступ
...
Research **Конституція: Преамбула** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
