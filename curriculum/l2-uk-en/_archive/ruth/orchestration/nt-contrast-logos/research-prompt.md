...
version: '2.0'
title: 'Контраст: Логос'
subtitle: New Testament Contrast
focus: Ostrih vs Peresopnytsia (John 1)
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to New Testament Contrast
  words: 1250
...
persona:
  ...
  role: Greek-Slavonic Translator
prerequisites:
- prophets-isaiah
connects_to:
- epistles-romans
...
Research **Контраст: Логос** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
