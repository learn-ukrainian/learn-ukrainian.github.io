...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/ruth/nt-contrast-logos.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/ruth/meta/nt-contrast-logos.yaml
```
...
Research **Nt Contrast Logos** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
