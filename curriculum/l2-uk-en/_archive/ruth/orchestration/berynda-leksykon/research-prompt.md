...
version: '2.0'
title: Лексикон словенороський Памва Беринди (1627)
subtitle: Berynda's Slaveno-Ruthenian Lexicon (1627)
focus: The most comprehensive pre-modern Ukrainian dictionary — 7000+ entries mapping Church Slavonic to living Ukrainian
phase: 5
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Pamvo Berynda: monk, scholar, printer at Kyiv-Pechersk Lavra. Context: why a 7000-entry dictionary was needed — the gap
    between liturgical and spoken language.'
  words: 1250
- section: Основний матеріал
  points:
  - Structure and methodology of the Lexicon. Sample entries showing multiple Ukrainian synonyms for single CS terms. Evidence
    of dialectal variation. Botanical, medical, everyday vocabulary.
  words: 1250
- section: Практика
  points:
  - Working with actual Lexicon entries. Tracing words from Berynda through to modern Ukrainian dictionaries. Identifying
    lost words and surviving ones.
  words: 1250
- section: Підсумок
  points:
  - 'Berynda''s legacy: establishing Ukrainian lexicographic tradition. The Lexicon as a snapshot of living Ukrainian in the
    1620s.'
  words: 1250
vocabulary_hints:
- лексикон
...
persona:
  voice: Lexicographer
  role: Lavra Scholar
source_url: http://litopys.org.ua/berlex/be.htm
prerequisites:
- zyzaniy-leksys
connects_to:
- uzhevych-hramatyka
...
Research **Лексикон словенороський Памва Беринди (1627)** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
...
- `query_wikipedia(query="Лексикон словенороський Памва Беринди (1627)", mode="extract")` — factual backbone
- `search_literary(query="Лексикон словенороський Памва Беринди (1627)")` — primary source excerpts
