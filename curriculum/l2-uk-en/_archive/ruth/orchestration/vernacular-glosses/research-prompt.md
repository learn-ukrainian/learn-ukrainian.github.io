...
version: '2.0'
title: Народні глоси
subtitle: Vernacular Glosses
focus: 'Synonyms: чыто -> або — "Translating for the people"'
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Vernacular Glosses
  words: 1250
...
Research **Народні глоси** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
