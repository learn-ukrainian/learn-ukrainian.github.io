...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/ruth/the-ruin.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/ruth/meta/the-ruin.yaml
```
...
Research **The Ruin** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
