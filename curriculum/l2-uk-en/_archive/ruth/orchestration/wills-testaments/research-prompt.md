...
version: '2.0'
title: Заповіти
subtitle: Wills & Testaments
focus: Тестамент, Духовниця
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Wills & Testaments
  words: 1250
...
Research **Заповіти** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
