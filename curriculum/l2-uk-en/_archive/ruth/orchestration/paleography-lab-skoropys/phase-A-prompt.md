...
```
curriculum/l2-uk-en/ruth/meta/paleography-lab-skoropys.yaml
```
...
Research **Paleography Lab Skoropys** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
