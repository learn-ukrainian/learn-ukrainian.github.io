...
version: '2.0'
title: Адміністративна реформа
subtitle: Administrative Reform
focus: Воєводство, Повіт — Territorial units
phase: 1
word_target: 5000
content_outline:
- section: Вступ
...
Research **Адміністративна реформа** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
...
```yaml
subject: "Адміністративна реформа"
