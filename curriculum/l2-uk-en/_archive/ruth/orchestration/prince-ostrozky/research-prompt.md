...
version: '2.0'
title: Князь Острозький
subtitle: Prince Ostrozky
focus: Cultural project of Ostrih Academy
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Prince Ostrozky
  words: 1250
...
Research **Князь Острозький** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
