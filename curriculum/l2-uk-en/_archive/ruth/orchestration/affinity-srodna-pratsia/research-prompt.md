...
title: Спорідненість
subtitle: Affinity
focus: The concept of Сродна праця
phase: 4
word_target: 5000
content_outline:
- section: Вступ
...
Research **Спорідненість** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
