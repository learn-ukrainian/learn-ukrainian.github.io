...
version: '2.0'
title: 'Орлик: Порівняння з латиною'
subtitle: Orlyk's Latin
focus: Ruthenian vs Latin versions
phase: 4
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Orlyk's Latin
  words: 1250
...
Research **Орлик: Порівняння з латиною** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
