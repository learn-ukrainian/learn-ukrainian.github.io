...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/ruth/orlyk-latin-comparison.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/ruth/meta/orlyk-latin-comparison.yaml
```
...
Research **Orlyk Latin Comparison** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
...
# Дослідження: Orlyk Latin Comparison
