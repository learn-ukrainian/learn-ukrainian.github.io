...
title: Латинізми
subtitle: Latinisms
focus: Акт, Протокол, Інстигатор
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Latinisms
  words: 1250
...
Research **Латинізми** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
