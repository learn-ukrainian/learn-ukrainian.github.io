...
version: '2.0'
title: Розподіл влади
subtitle: Separation of Powers
focus: Limiting the Hetman's power
phase: 4
word_target: 5000
content_outline:
- section: Вступ
...
Research **Розподіл влади** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
