...
slug: divine-songs
version: '2.0'
title: Божественні пісні
subtitle: Divine Songs
focus: '"De Libertate" — Rhythm, meter, Baroque choral'
phase: 4
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Divine Songs
  words: 1250
...
Research **Божественні пісні** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
...
- `query_wikipedia(query="Божественні пісні", mode="extract")` — factual backbone
- `search_literary(query="Божественні пісні")` — primary source excerpts
