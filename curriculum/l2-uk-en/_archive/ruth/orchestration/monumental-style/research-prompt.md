...
version: '2.0'
title: Монументальний стиль
subtitle: The Monumental Style
focus: Velychko — Documents as text
phase: 4
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to The Monumental Style
  words: 1250
...
Research **Монументальний стиль** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
