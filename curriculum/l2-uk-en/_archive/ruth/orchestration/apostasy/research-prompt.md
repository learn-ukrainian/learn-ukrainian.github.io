...
title: Апостазія
subtitle: Apostasy
focus: Naming noble families who converted
phase: 3
word_target: 5000
content_outline:
- section: Вступ
...
Research **Апостазія** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
