...
version: '2.0'
title: Козацька ієрархія
subtitle: Cossack Hierarchy
focus: Ranks and Titles — Старшина
phase: 4
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Cossack Hierarchy
  words: 1250
...
Research **Козацька ієрархія** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
