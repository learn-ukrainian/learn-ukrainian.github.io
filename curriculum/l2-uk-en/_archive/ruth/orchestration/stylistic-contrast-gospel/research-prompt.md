...
version: '2.0'
title: Стилістичний контраст
subtitle: Stylistic Contrast
focus: Peresopnytsia Gospel vs Chancery style
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Stylistic Contrast
  words: 1250
...
Research **Стилістичний контраст** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
