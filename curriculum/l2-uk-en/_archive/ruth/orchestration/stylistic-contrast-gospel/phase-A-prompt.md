...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/ruth/stylistic-contrast-gospel.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/ruth/meta/stylistic-contrast-gospel.yaml
```
...
Research **Stylistic Contrast Gospel** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
...
# Дослідження: Stylistic Contrast Gospel
