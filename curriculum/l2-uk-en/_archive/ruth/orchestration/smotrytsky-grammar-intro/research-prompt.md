...
version: '2.0'
title: 'Граматика Смотрицького: Вступ'
subtitle: Smotrytsky's Grammar
focus: Codification of CS — Syntaxis, Prosodia
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Smotrytsky's Grammar
  words: 1250
...
Research **Граматика Смотрицького: Вступ** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
