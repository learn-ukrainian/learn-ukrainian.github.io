...
```
curriculum/l2-uk-en/plans/ruth/smotrytsky-grammar-intro.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
curriculum/l2-uk-en/ruth/meta/smotrytsky-grammar-intro.yaml
```
...
Research **Smotrytsky Grammar Intro** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
...
# Дослідження: Smotrytsky Grammar Intro
