...
version: '2.0'
title: Спадщина Вишенського
subtitle: Vyshensky's Legacy
focus: '"The Firebrand of Orthodoxy"'
phase: 3
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Vyshensky's Legacy
  words: 1250
...
Research **Спадщина Вишенського** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
