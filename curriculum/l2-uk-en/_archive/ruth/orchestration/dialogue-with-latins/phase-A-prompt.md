...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/ruth/dialogue-with-latins.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/ruth/meta/dialogue-with-latins.yaml
```
...
Research **Dialogue With Latins** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
...
# Дослідження: Dialogue With Latins
