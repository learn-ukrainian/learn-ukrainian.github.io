...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/ruth/beatitudes-matthew.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/ruth/meta/beatitudes-matthew.yaml
```
...
Research **Beatitudes Matthew** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
...
# Дослідження: Beatitudes Matthew
