...
version: '2.0'
title: 'Буття: Створення'
subtitle: 'Genesis: Creation'
focus: High Church Slavonic cosmology
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to Genesis: Creation'
  words: 1250
...
Research **Буття: Створення** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
