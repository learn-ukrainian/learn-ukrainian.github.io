...
```
curriculum/l2-uk-en/plans/ruth/genesis-creation.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
curriculum/l2-uk-en/ruth/meta/genesis-creation.yaml
```
...
Research **Genesis Creation** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
