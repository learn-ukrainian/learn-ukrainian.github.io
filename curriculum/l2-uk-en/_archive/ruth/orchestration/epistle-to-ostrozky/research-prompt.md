...
version: '2.0'
title: Лист до Острозького
subtitle: Epistle to Ostrozky
focus: Political theology
phase: 3
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Epistle to Ostrozky
  words: 1250
...
Research **Лист до Острозького** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
