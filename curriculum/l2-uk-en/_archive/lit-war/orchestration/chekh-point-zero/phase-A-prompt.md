...
```
curriculum/l2-uk-en/lit-war/meta/chekh-point-zero.yaml
```
...
Research **Chekh Point Zero** for the **lit-war** track. Produce structured research notes that will drive content writing in Phase B.
