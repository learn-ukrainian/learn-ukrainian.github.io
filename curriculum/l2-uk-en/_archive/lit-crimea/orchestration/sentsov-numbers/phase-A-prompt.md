...
```
curriculum/l2-uk-en/plans/lit/sentsov-numbers.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
curriculum/l2-uk-en/lit/meta/sentsov-numbers.yaml
```
...
Research **Sentsov Numbers** for the **lit** track. Produce structured research notes that will drive content writing in Phase B.
