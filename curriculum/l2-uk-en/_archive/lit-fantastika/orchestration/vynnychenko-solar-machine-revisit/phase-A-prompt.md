...
```
curriculum/l2-uk-en/lit-fantastika/meta/vynnychenko-solar-machine-revisit.yaml
```
...
Research **Vynnychenko Solar Machine Revisit** for the **lit-fantastika** track. Produce structured research notes that will drive content writing in Phase B.
