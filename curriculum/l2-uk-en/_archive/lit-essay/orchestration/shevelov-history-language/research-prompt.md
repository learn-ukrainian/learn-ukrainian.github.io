...
version: '2.0'
title: Shevelov History Language
subtitle: Shevelov History Language
content_outline:
...
phase: LIT Expansion
objectives:
- Проаналізувати творчість Shevelov History Language у контексті української літератури
...
```yaml
subject: "Shevelov History Language"
