...
version: '2.0'
title: Plokhy Frontline
subtitle: Plokhy Frontline
content_outline:
...
phase: LIT Expansion
objectives:
- Проаналізувати творчість Plokhy Frontline у контексті української літератури
...
Research **Plokhy Frontline** for the **lit-essay** track. Produce structured research notes that will drive content writing in Phase B.
