...
version: '2.0'
title: Lysiah Rudnytsky History
subtitle: Lysiah Rudnytsky History
content_outline:
...
phase: LIT Expansion
objectives:
- Проаналізувати творчість Lysiah Rudnytsky History у контексті української літератури
- Дослідити вплив автора на формування національної ідентичності
persona:
  voice: Senior Specialist
  role: Political Thinker
word_target: 5000
...
Research **Lysiah Rudnytsky History** for the **lit-essay** track. Produce structured research notes that will drive content writing in Phase B.
...
# Дослідження: Lysiah Rudnytsky History

## Key Facts Ledger
<!-- IMMUTABLE TRUTH ANCHOR — review phase verifies prose against this -->
```yaml
subject: "Lysiah Rudnytsky History"
