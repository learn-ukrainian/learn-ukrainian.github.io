...
version: '2.0'
title: Kostomarov Two Rus Nationalities
subtitle: Kostomarov Two Rus Nationalities
content_outline:
...
phase: LIT Expansion
objectives:
- Проаналізувати творчість Kostomarov Two Rus Nationalities у контексті української
  літератури
- Дослідити вплив автора на формування національної ідентичності
persona:
  voice: Senior Specialist
  role: Slavic Ethnographer
word_target: 5000
...
Research **Kostomarov Two Rus Nationalities** for the **lit-essay** track. Produce structured research notes that will drive content writing in Phase B.
