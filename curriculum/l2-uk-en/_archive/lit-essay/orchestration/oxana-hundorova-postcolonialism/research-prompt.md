...
version: '2.0'
title: Oxana Hundorova Postcolonialism
subtitle: Oxana Hundorova Postcolonialism
content_outline:
...
phase: LIT Expansion
objectives:
- Проаналізувати творчість Oxana Hundorova Postcolonialism у контексті української
  літератури
- Дослідити вплив автора на формування національної ідентичності
persona:
  voice: Senior Specialist
  role: Postcolonial Scholar
word_target: 5000
