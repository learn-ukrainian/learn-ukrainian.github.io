...
version: '2.0'
title: Drahomanov Chudatski Dumky
subtitle: Drahomanov Chudatski Dumky
content_outline:
...
phase: LIT Expansion
objectives:
- Проаналізувати творчість Drahomanov Chudatski Dumky у контексті української літератури
- Дослідити вплив автора на формування національної ідентичності
persona:
  voice: Senior Specialist
  role: Radical Publicist
word_target: 5000
