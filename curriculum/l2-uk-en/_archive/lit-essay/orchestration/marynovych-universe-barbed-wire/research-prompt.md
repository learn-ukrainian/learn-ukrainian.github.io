...
version: '2.0'
title: Marynovych Universe Barbed Wire
subtitle: Marynovych Universe Barbed Wire
content_outline:
...
phase: LIT Expansion
objectives:
- Проаналізувати творчість Marynovych Universe Barbed Wire у контексті української
  літератури
- Дослідити вплив автора на формування національної ідентичності
persona:
  voice: Senior Specialist
  role: Gulag Theologian
word_target: 5000
...
Research **Marynovych Universe Barbed Wire** for the **lit-essay** track. Produce structured research notes that will drive content writing in Phase B.
...
```yaml
subject: "Marynovych Universe Barbed Wire"
