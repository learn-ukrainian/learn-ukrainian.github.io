...
version: '2.0'
title: Kulish Panteleimon Essayist
subtitle: Kulish Panteleimon Essayist
content_outline:
...
phase: LIT Expansion
objectives:
- Проаналізувати Куліша як есеїста у контексті української літератури
- Дослідити вплив автора на формування національної ідентичності
persona:
  voice: Senior Specialist
  role: Khutir Philosopher
word_target: 5000
...
Research **Kulish Panteleimon Essayist** for the **lit-essay** track. Produce structured research notes that will drive content writing in Phase B.
