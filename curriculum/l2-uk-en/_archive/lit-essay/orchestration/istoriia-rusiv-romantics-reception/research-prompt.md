...
version: '2.0'
title: Istoriia Rusiv Romantics Reception
subtitle: Istoriia Rusiv Romantics Reception
content_outline:
...
phase: LIT Expansion
objectives:
- Проаналізувати рецепцію «Історії Русів» серед романтиків у контексті ідентичності
- Дослідити вплив тексту на формування національної ідентичності
persona:
  voice: Senior Specialist
  role: Romantic Reader
word_target: 5000
...
Research **Istoriia Rusiv Romantics Reception** for the **lit-essay** track. Produce structured research notes that will drive content writing in Phase B.
