...
```
curriculum/l2-uk-en/plans/lit-juvenile/andrusyak-rabbits.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
curriculum/l2-uk-en/lit-juvenile/meta/andrusyak-rabbits.yaml
```
...
Research **Andrusyak Rabbits** for the **lit-juvenile** track. Produce structured research notes that will drive content writing in Phase B.
