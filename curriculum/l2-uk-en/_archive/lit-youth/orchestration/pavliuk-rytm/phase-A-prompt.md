...
```
curriculum/l2-uk-en/plans/lit-juvenile/pavliuk-rytm.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
curriculum/l2-uk-en/lit-juvenile/meta/pavliuk-rytm.yaml
```
...
Research **Pavliuk Rytm** for the **lit-juvenile** track. Produce structured research notes that will drive content writing in Phase B.
