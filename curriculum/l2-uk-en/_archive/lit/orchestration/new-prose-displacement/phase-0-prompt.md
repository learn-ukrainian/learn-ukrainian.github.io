...
```
curriculum/l2-uk-en/plans/lit/new-prose-displacement.yaml
```

Read the current meta file for content_outline structure:

```
curriculum/l2-uk-en/lit/meta/new-prose-displacement.yaml
```

## Your Task

Research **New Prose Displacement** for the **lit** track. Produce structured research notes that will drive content writing in later phases.
