...
subtitle: Pachlovska Diaspora Theory
focus: literature
pedagogy: Seminar
phase: LIT.5 Independence Era 1991-Present
word_target: 5000
objectives:
- Проаналізувати твір Pachlovska Diaspora Theory у контексті епохи
- Дослідити стилістичні особливості тексту
- Зрозуміти деколонізаційне значення автора
sources:
- name: Pachlovska Diaspora Theory — тексти та аналіз
...
activity_hints:
- type: reading
  focus: Аналіз ключових уривків pachlovska-diaspora-theory
  source: UkrLib
  items: 5+
- type: essay-response
...
- `query_wikipedia(query="Pachlovska Diaspora Theory", mode="extract")` — factual backbone
- `search_literary(query="Pachlovska Diaspora Theory")` — primary source excerpts
