...
```
curriculum/l2-uk-en/lit/research/stefanyk-stone-cross-research.md
```

Read the plan file (SOURCE OF TRUTH for structure):

```
curriculum/l2-uk-en/plans/lit/stefanyk-stone-cross.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
curriculum/l2-uk-en/lit/meta/stefanyk-stone-cross.yaml
```
