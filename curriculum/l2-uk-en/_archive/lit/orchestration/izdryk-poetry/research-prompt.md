...
activity_hints:
- type: reading
  focus: Аналіз ключових уривків izdryk-poetry
  source: UkrLib
  items: 5+
- type: essay-response
