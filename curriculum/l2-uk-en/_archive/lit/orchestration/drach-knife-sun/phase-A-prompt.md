...
```
curriculum/l2-uk-en/lit/meta/drach-knife-sun.yaml
```
...
Research **Drach Knife Sun** for the **lit** track. Produce structured research notes that will drive content writing in Phase B.
