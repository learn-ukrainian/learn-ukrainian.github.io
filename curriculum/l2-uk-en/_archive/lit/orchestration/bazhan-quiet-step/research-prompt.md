...
activity_hints:
- type: reading
  focus: Аналіз ключових уривків bazhan-quiet-step
  source: UkrLib
  items: 5+
- type: essay-response
