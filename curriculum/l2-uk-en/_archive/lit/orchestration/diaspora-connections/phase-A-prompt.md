...
```
curriculum/l2-uk-en/plans/lit/diaspora-connections.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
curriculum/l2-uk-en/lit/meta/diaspora-connections.yaml
```
...
Research **Diaspora Connections** for the **lit** track. Produce structured research notes that will drive content writing in Phase B.
