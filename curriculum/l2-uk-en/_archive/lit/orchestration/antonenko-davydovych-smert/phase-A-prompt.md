...
```
curriculum/l2-uk-en/lit/meta/antonenko-davydovych-smert.yaml
```
...
Research **Antonenko Davydovych Smert** for the **lit** track. Produce structured research notes that will drive content writing in Phase B.
