...
subtitle: Prokhasko Magical Carpathians
focus: literature
pedagogy: Seminar
phase: LIT.5 Independence Era 1991-Present
word_target: 5000
objectives:
- Проаналізувати твір Prokhasko Magical Carpathians у контексті епохи
- Дослідити стилістичні особливості тексту
- Зрозуміти деколонізаційне значення автора
sources:
- name: Prokhasko Magical Carpathians — тексти та аналіз
...
activity_hints:
- type: reading
  focus: Аналіз ключових уривків prokhasko-magical-carpathians
  source: UkrLib
  items: 5+
- type: essay-response
