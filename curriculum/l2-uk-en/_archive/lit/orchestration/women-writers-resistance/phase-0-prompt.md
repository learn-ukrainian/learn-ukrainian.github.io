...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/lit/women-writers-resistance.yaml
```

Read the current meta file for content_outline structure:

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/lit/meta/women-writers-resistance.yaml
```

## Your Task

Research **Women Writers Resistance** for the **lit** track. Produce structured research notes that will drive content writing in later phases.
