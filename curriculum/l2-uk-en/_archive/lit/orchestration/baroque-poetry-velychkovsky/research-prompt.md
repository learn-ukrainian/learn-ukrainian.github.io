...
subtitle: Baroque Poetry Velychkovsky
focus: literature
pedagogy: Seminar
phase: LIT.0 Baroque Heritage 1620-1798
word_target: 5000
objectives:
- Проаналізувати барокову поезію Величковського у контексті КМА
- Дослідити стилістичні особливості фігурної поезії
- Зрозуміти деколонізаційне значення автора
sources:
- name: Baroque Poetry Velychkovsky — тексти та аналіз
...
activity_hints:
- type: reading
  focus: Аналіз ключових уривків baroque-poetry-velychkovsky
  source: UkrLib
  items: 5+
- type: essay-response
