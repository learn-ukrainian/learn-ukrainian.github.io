...
```
curriculum/l2-uk-en/plans/lit/synthesis-3.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
curriculum/l2-uk-en/lit/meta/synthesis-3.yaml
```
...
Research **Синтез: Горизонти епохи 3** for the **lit** track. Produce structured research notes that will drive content writing in Phase B.
