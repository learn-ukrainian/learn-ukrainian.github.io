...
```
curriculum/l2-uk-en/plans/lit/rylsky-translations.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
curriculum/l2-uk-en/lit/meta/rylsky-translations.yaml
```
...
Research **Rylsky Translations** for the **lit** track. Produce structured research notes that will drive content writing in Phase B.
