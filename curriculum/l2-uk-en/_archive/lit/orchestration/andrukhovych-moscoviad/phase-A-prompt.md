...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/lit/andrukhovych-moscoviad.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/lit/meta/andrukhovych-moscoviad.yaml
```
...
Research **Andrukhovych Moscoviad** for the **lit** track. Produce structured research notes that will drive content writing in Phase B.
