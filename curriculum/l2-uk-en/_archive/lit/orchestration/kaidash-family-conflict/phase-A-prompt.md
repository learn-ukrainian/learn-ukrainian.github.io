...
```
curriculum/l2-uk-en/lit/research/kaidash-family-conflict-research.md
```

Read the plan file (SOURCE OF TRUTH for structure):

```
curriculum/l2-uk-en/plans/lit/kaidash-family-conflict.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
curriculum/l2-uk-en/lit/meta/kaidash-family-conflict.yaml
```
