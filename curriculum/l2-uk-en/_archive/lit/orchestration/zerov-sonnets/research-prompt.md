...
activity_hints:
- type: reading
  focus: Аналіз ключових уривків zerov-sonnets
  source: UkrLib
  items: 5+
- type: essay-response
