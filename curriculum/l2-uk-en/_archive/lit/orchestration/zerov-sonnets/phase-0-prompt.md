...
```
curriculum/l2-uk-en/plans/lit/zerov-sonnets.yaml
```

Read the current meta file for content_outline structure:

```
curriculum/l2-uk-en/lit/meta/zerov-sonnets.yaml
```

## Your Task

Research **Zerov Sonnets** for the **lit** track. Produce structured research notes that will drive content writing in later phases.
