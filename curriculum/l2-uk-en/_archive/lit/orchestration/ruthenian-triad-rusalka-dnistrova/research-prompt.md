...
vocabulary_hints:
  ...
  recommended: []
prerequisites:
- baroque-poetry-velychkovsky
connects_to:
- kobrynska-pershyi-vinok
objectives:
...
Research **Ruthenian Triad Rusalka Dnistrova** for the **lit** track. Produce structured research notes that will drive content writing in Phase B.
