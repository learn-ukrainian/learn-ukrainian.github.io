...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/lit/sofia-andrukhovych-amados.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/lit/meta/sofia-andrukhovych-amados.yaml
```
...
Research **Sofia Andrukhovych Amados** for the **lit** track. Produce structured research notes that will drive content writing in Phase B.
...
# Дослідження: Sofia Andrukhovych Amados

## Key Facts Ledger
<!-- IMMUTABLE TRUTH ANCHOR — Phase D verifies prose against this -->
```yaml
subject: "Sofia Andrukhovych Amados"
