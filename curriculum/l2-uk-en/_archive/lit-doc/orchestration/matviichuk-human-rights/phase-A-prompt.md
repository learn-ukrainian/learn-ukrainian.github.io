...
```
curriculum/l2-uk-en/plans/lit-doc/matviichuk-human-rights.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
curriculum/l2-uk-en/lit-doc/meta/matviichuk-human-rights.yaml
```
...
Research **Matviichuk Human Rights** for the **lit-doc** track. Produce structured research notes that will drive content writing in Phase B.
...
```yaml
subject: "Matviichuk Human Rights"
