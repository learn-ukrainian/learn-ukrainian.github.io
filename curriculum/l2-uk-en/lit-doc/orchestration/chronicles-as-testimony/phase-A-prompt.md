...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/lit-doc/chronicles-as-testimony.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/lit-doc/meta/chronicles-as-testimony.yaml
```
...
Research **Хроніка як свідчення: Козацькі Літописи як Витоки Документальної Прози** for the **lit-doc** track. Produce structured research notes that will drive content writing in Phase B.
