...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/istorio/nova-ukrainska-istorio.yaml
```

Read the current meta file for content_outline structure:

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/istorio/meta/nova-ukrainska-istorio.yaml
```

## Your Task

Research **Нова українська історіографія після 1991** for the **istorio** track. Produce structured research notes that will drive content writing in later phases.
