...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/istorio/khrushchov-shelest-tsykl.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/istorio/meta/khrushchov-shelest-tsykl.yaml
```
...
Research **Хрущов — Шелест — Щербицький** for the **istorio** track. Produce structured research notes that will drive content writing in Phase B.
