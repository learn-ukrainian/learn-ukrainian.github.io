...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/istorio/ukrainska-istoriohrafichna-tradytsiia.md
```

**Plan file** (vocabulary_hints — vocabulary list to follow):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/istorio/ukrainska-istoriohrafichna-tradytsiia.yaml
```

**Meta file** (activity count targets, pedagogy):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/istorio/meta/ukrainska-istoriohrafichna-tradytsiia.yaml
```

**Activity schema** (CRITICAL — defines allowed fields per activity type):
```
schemas/activities-istorio.schema.json
```
...
- **Schema violations**: `additionalProperties: false` means ANY unlisted field = instant fail. Read `schemas/activities-istorio.schema.json` before writing.
...
3. **Seminar style** (istorio): Reading Input → Analytical Output. Focus on comprehension, analysis, and critical thinking — NOT drill exercises.
...
### CRITICAL: Activity Type Constraints for istorio
