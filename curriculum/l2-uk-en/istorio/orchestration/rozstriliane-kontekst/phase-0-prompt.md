...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/istorio/rozstriliane-kontekst.yaml
```

Read the current meta file for content_outline structure:

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/istorio/meta/rozstriliane-kontekst.yaml
```

## Your Task

Research **Розстріляне відродження: Контекст 1920-х** for the **istorio** track. Produce structured research notes that will drive content writing in later phases.
