...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/istorio/kulturna-rezystentsiia.yaml
```

Read the current meta file for content_outline structure:

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/istorio/meta/kulturna-rezystentsiia.yaml
```

## Your Task

Research **Культурна резистенція: Стратегії виживання** for the **istorio** track. Produce structured research notes that will drive content writing in later phases.
