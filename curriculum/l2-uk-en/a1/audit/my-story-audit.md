...
- **[INFO]** Dative case used at A1: 'тобі' (taught formally at A2)
  - FIX: No action needed — incidental dative exposure is acceptable.
- **[LEVEL_RESTRICTION]** Activity 'anagram' should be phased out after A1 M10 (current: M52)
...
- **Immersion:** 🇺🇦 32.8% (target 20-40% (M52))
...
| **Три часи́ ра́зом (Three Tenses Together)** | ✅ | 457 | Included in Core |
| **Моя історія (My Story)** | ✅ | 389 | Included in Core |
| **Summary** | ✅ | 291 | Included in Core |