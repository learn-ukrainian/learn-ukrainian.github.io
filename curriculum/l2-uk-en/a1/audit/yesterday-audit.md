...
- Priority types used: 3/8 (anagram, fill-in, match-up) ✅
- Low density activities: 0

## PEDAGOGICAL VIOLATIONS
- **[LEVEL_RESTRICTION]** Activity 'anagram' should be phased out after A1 M10 (current: M49)
...
- **Immersion:** 🇺🇦 23.5% (target 20-40% (M49))
...
|---|---|---|---|
| **Intro/Narrative** | ✅ | 575 | Included in Core |
| **Ро́зповідь про день (Narrating a Day)** | ✅ | 479 | Included in Core |
| **Мій учора́шній день (My Yesterday)** | ✅ | 438 | Included in Core |
| **Summary** | ✅ | 228 | Included in Core |