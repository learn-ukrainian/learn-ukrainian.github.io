...
- **Immersion:** ⚠️ 35.1% (target 20-35%, within tolerance (M49))
...
| **Ро́зповідь про день (Narrating a Day)** | ✅ | 335 | Included in Core |
| **Мій учора́шній день (My Yesterday)** | ✅ | 308 | Included in Core |
| **Summary** | ✅ | 322 | Included in Core |