...
- **[LEVEL_RESTRICTION]** Activity 'anagram' should be phased out after A1 M10 (current: M33)
...
- **Immersion:** 🇺🇦 16.4% (target 15-40% (M33))
...
|---|---|---|---|
| **Intro/Narrative** | ✅ | 475 | Included in Core |
| **Де і куди ра́зом (Where and Where To Together)** | ✅ | 409 | Included in Core |
| **Мій райо́н (My Neighborhood)** | ✅ | 384 | Included in Core |
| **Підсумок — Summary** | ✅ | 313 | Included in Core |