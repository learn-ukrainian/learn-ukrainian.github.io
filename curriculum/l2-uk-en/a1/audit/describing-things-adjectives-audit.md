...
**Level:** A1 | **Module:** M11 | **Phase:** A1.1 | **Pedagogy:** PPP | **Target:** 2000
**Overall Status:** ✅ PASS
**Generated:** 2026-02-28 03:27:15
...
|---|------|-------|-------|-----|--------|
| 1 | group-sort | Рід іменників: Він, Вона чи Воно? | 15 | 12 | ✅ |
| 2 | match-up | Антоніми: знайдіть протилежне | 9 | 8 | ✅ |
| 3 | quiz | Питання: Який, Яка, Яке, Які? | 8 | 8 | ✅ |
| 4 | group-sort | Закінчення прикметників | 20 | 12 | ✅ |
| 5 | fill-in | Узгодження: Тверда група | 8 | 8 | ✅ |
| 6 | fill-in | Узгодження: М'яка група (синій) | 8 | 8 | ✅ |
| 7 | unjumble | Складіть речення: Опис (Стандартна позиція) | 6 | 6 | ✅ |
| 8 | unjumble | Складіть речення: Характеристика (Позиція після) | 6 | 6 | ✅ |
| 9 | match-up | Словниковий запас: Переклад | 12 | 8 | ✅ |
| 10 | fill-in | Діалог: У пошуках квартири | 8 | 8 | ✅ |
...
- **Immersion:** 🇺🇦 38.5% (target 25-40% (M11))
