...
- **Immersion:** 🇺🇦 25.5% (target 10-30% (M07))
...
| **Що ми зна́ємо? (What Do We Know?)** | ✅ | 260 | Included in Core |
| **Чита́ння (Reading Practice)** | ⚪️ | 0 | Skipped (using YAML) |
| **Грама́тика (Grammar Summary)** | ✅ | 286 | Included in Core |
| **Діало́г (Capstone Dialogue)** | ✅ | 460 | Included in Core |
| **Підсумок — Summary** | ✅ | 531 | Included in Core |