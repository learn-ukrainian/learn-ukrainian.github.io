...
- **[LEVEL_RESTRICTION]** Activity 'anagram' should be phased out after A1 M10 (current: M35)
...
- **Immersion:** 🇺🇦 23.1% (target 20-40% (M35))
...
|---|---|---|---|
| **Intro/Narrative** | ✅ | 277 | Included in Core |
| **Чита́ння (Reading Practice)** | ⚪️ | 0 | Skipped (using YAML) |
| **Грама́тика (Grammar Summary)** | ✅ | 361 | Included in Core |
| **Діало́г (Connected Dialogue)** | ✅ | 402 | Included in Core |
| **Підсумок — Summary** | ✅ | 95 | Included in Core |