...
- **Immersion:** 🇺🇦 35.9% (target 20-40% (M50))
...
|---|---|---|---|
| **Intro/Narrative** | ✅ | 442 | Included in Core |
| **Майбу́тній час (Future Tense)** | ✅ | 307 | Included in Core |
| **Пра́ктика (Practice)** | ✅ | 290 | Included in Core |
| **Summary** | ✅ | 221 | Included in Core |