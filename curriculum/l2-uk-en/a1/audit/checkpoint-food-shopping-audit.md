...
- **[INFO]** Dative case used at A1: 'вам' (taught formally at A2)
  - FIX: No action needed — incidental dative exposure is acceptable.
- **[LEVEL_RESTRICTION]** Activity 'anagram' should be phased out after A1 M10 (current: M41)
...
- **Immersion:** 🇺🇦 24.2% (target 20-40% (M41))
...
| **Грама́тика (Grammar Summary)** | ✅ | 224 | Included in Core |
| **Діало́г (Connected Dialogue)** | ✅ | 352 | Included in Core |
| **Підсумок — Summary** | ✅ | 137 | Included in Core |