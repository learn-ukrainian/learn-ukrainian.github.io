...
- **[LEVEL_RESTRICTION]** Activity 'anagram' should be phased out after A1 M10 (current: M42)
...
- **Immersion:** 🇺🇦 20.1% (target 20-40% (M42))
...
|---|---|---|---|
| **Intro/Narrative** | ✅ | 390 | Included in Core |
| **Кличний відмінок (The Vocative Case)** | ✅ | 366 | Included in Core |
| **Закінчення кличного (Vocative Endings)** | ✅ | 399 | Included in Core |
| **Підсумок — Summary** | ✅ | 205 | Included in Core |