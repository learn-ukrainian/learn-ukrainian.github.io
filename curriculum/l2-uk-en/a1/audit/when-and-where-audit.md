...
- **Immersion:** 🇺🇦 29.2% (target 20-40% (M45))
...
| **Складне речення (Complex Sentences)** | ✅ | 269 | Included in Core |
| **Що, де, коли — дво́є обли́ч (Two Faces)** | ✅ | 309 | Included in Core |
| **Підсумок — Summary** | ✅ | 280 | Included in Core |