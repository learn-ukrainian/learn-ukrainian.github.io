...
- **[SECTION_BALANCE_BLOATED]** Section 'Чита́ння слів (Reading Words)' has 607 words (42% of total). Bloated sections: 'Чита́ння слів (Reading Words)' (42%)
...
| **Склади (Syllables)** | ✅ | 273 | Included in Core |
| **Голосні́ лі́тери (Vowel Letters)** | ✅ | 392 | Included in Core |
| **Чита́ння слів (Reading Words)** | ⚪️ | 0 | Skipped (using YAML) |
| **Підсумок — Summary** | ✅ | 823 | Included in Core |