...
- **Immersion:** 🇺🇦 17.6% (target 15-40% (M25))
...
|---|---|---|---|
| **Intro/Narrative** | ✅ | 331 | Included in Core |
| **Мій типовий день** | ✅ | 348 | Included in Core |
| **Від ра́нку до ве́чора** | ✅ | 333 | Included in Core |
