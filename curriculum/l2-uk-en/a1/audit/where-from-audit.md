...
- **Immersion:** 🇺🇦 15.1% (target 15-40% (M34))
...
|---|---|---|---|
| **Intro/Narrative** | ✅ | 364 | Included in Core |
| **Звідки? — Where From?** | ✅ | 505 | Included in Core |
| **Краї́ни і міста́ — Countries and Cities** | ✅ | 456 | Included in Core |
| **Підсумок — Summary** | ✅ | 348 | Included in Core |