...
- **Immersion:** ⚠️ 13.8% (target 15-35%, within tolerance (M19))
...
| **Пита́льні слова́ (Question Words)** | ✅ | 593 | Included in Core |
| **Запере́чення (Negation)** | ✅ | 376 | Included in Core |
