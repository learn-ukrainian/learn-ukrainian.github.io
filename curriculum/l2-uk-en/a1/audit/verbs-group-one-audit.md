...
- **[LEVEL_RESTRICTION]** Activity 'anagram' should be phased out after A1 M10 (current: M16)
...
- **Immersion:** ⚠️ 14.6% (target 15-35%, within tolerance (M16))
...
|---|---|---|---|
| **Intro/Narrative** | ✅ | 366 | Included in Core |
| **Пе́рша дієвідмі́на (Group I Verbs)** | ✅ | 324 | Included in Core |
| **Я, ти, він/вона (Persons)** | ✅ | 367 | Included in Core |
