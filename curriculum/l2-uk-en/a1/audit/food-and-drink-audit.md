...
- **Immersion:** 🇺🇦 24.1% (target 20-40% (M36))
...
|---|---|---|---|
| **Intro/Narrative** | ✅ | 404 | Included in Core |
| **Їжа (Food)** | ✅ | 377 | Included in Core |
| **Напо́ї (Drinks)** | ✅ | 420 | Included in Core |
| **Підсумок — Summary** | ✅ | 450 | Included in Core |