...
- **[LEVEL_RESTRICTION]** Activity 'anagram' should be phased out after A1 M10 (current: M27)
...
- **Immersion:** 🇺🇦 28.4% (target 15-40% (M27))
...
|---|---|---|---|
| **Intro/Narrative** | ✅ | 209 | Included in Core |
| **Читання (Reading Practice)** | ⚪️ | 0 | Skipped (using YAML) |
| **Граматика (Grammar Summary)** | ✅ | 320 | Included in Core |
| **Діалог (Connected Dialogue)** | ✅ | 309 | Included in Core |
