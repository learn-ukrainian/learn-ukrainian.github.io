...
- **[YAML_SCHEMA_VIOLATION]** Schema error in my-family.yaml: Schema validation error at key '0': {'letters': ['б', 'р', 'а', 'т'], 'answer': 'брат', 'hint': 'brother'} is not valid under any of the given schemas
