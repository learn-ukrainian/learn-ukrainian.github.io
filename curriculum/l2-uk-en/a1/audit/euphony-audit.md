...
- **Immersion:** 🇺🇦 22.9% (target 15-30% (M28))
...
| **Діало́ги (Dialogues)** | ✅ | 440 | Included in Core |
| **У чи В? (У or В?)** | ✅ | 330 | Included in Core |
| **І чи Й? З, із, чи зі?** | ✅ | 351 | Included in Core |
| **Підсумок — Summary** | ✅ | 877 | Included in Core |