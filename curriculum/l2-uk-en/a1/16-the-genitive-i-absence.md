...
tags:
  ...
  - prepositions
grammar:
  - Genitive case for absence and negation
  - Genitive endings (masculine -у/-а, feminine -и/-і, neuter -а)
  - Expression "немає + genitive"
...
> Fill in the blanks with the correct genitive form.
...
8. Which pattern is correct for "She doesn't have money"?
   - [ ] Вона не має гроші
...
- [x] Genitive case is used after "немає" (there isn't).
  > Correct! немає always requires genitive.

- [ ] The pattern is "Я немає + nominative".
  > Incorrect! The pattern is "У мене немає + genitive".

- [x] "Без" (without) requires genitive case.
  > Correct! без + genitive is the rule.

- [ ] Feminine nouns don't change in genitive.
  > Incorrect! Feminine -а becomes -и in genitive.

- [x] "Немає проблем" means "No problem".
  > Correct! This is a common idiomatic expression.

- [ ] Masculine genitive always ends in -а.
  > Incorrect! Masculine can be -у or -а (часу, друга).

- [x] Neuter -о becomes -а in genitive.
  > Correct! вікно → вікна.

- [ ] You say "Я не маю час" for "I don't have time".
  > Incorrect! The correct form is "У мене немає часу".

- [x] Genitive expresses absence or negation.
  > Correct! That's one of genitive's main functions.

- [ ] Genitive is only used with "немає".
  > Incorrect! It's also used with quantities, possession, and more (future modules).

- [x] "У + person" means "by/at person" in possession contexts.
  > Correct! У мене = "by me" = "I have".
