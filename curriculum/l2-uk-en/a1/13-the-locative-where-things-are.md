...
1. Де ти? — Я ___ кафе.
   ...
   - [ ] у
   - [ ] біля
   > Enclosed space (café) uses в.

2. Де книга? — Вона ___ столі.
   - [x] на
   - [ ] в
   - [ ] у
   - [ ] під
   > Tables are surfaces, so we use на.

3. Де ти живеш? — Я живу ___ Києві.
   - [ ] в
   - [x] у
   - [ ] на
   - [ ] при
...
9. Де ти працюєш? — Я працюю ___ офісі.
   - [ ] на
   - [x] в
   - [ ] під
   - [ ] біля
   > Enclosed workspace uses в/у.

10. Де твій паспорт? — ___ сумці.
    - [ ] На
    - [x] У
    - [ ] В
    - [ ] Під
    > Container (bag) uses у.

11. Де музей? — ___ центрі міста.
    - [x] У
    - [ ] В
    - [ ] На
    - [ ] Від
    > Center has consonant cluster.

12. Де вони? — Вони ___ пляжі.
    - [x] на
    - [ ] в
    - [ ] у
    - [ ] під
...
- [x] The locative case always requires a preposition (в/у or на).
  > Correct! You never use locative without a preposition.

- [ ] Locative case is used to show direction (where you're going).
  > Incorrect! Locative shows LOCATION (where you are). Direction uses accusative.

- [x] "У" and "в" are the same preposition, just different forms.
  > Correct! "У" is used before consonant clusters for easier pronunciation.

- [ ] All cities use "на" (e.g., на Києві).
  > Incorrect! Cities use "в/у" (у Києві, в Одесі).

- [x] Most feminine nouns ending in -а change to -і in locative.
  > Correct! кімната → в кімнаті, школа → у школі.

- [ ] Masculine nouns always end in -і in locative.
  > Incorrect! Hard masculine nouns often end in -у (у банку, в парку).

- [x] The phrase "в Україні" (not "на Україні") is politically significant.
  > Correct! Russian uses "на" to imply Ukraine is just a borderland region.

- [x] "На роботі" is a fixed expression.
  > Correct! You always say "на роботі" (at work), never "в роботі".

- [ ] You can use locative case without a preposition in questions.
  > Incorrect! Even in questions, you need a preposition: "Де ти?" → "В кафе."

- [x] Events (concerts, meetings) use "на".
  > Correct! на концерті, на зустрічі, на уроці.

- [ ] "На столі" means "to the table."
  > Incorrect! "На столі" means "ON the table" (location). Direction would be accusative.
...
6. Концерт ___ стадіоні.
   > [!answer] на
   > [!options] в | на | у | при

7. Я живу ___ Україні.
   > [!answer] в
   > [!options] в | на | у | від
...
11. Твій телефон ___ сумці?
    > [!answer] у
    > [!options] у | на | біля | коло

12. Зустріч ___ офісі.
    > [!answer] в
    > [!options] в | на | у | при
