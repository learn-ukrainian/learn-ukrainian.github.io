...
| те | neuter singular |
| ті | all plurals |
| цей стілець | this chair (m) |
| ця чашка | this cup (f) |
| це вікно | this window (n) |
| ці ключі | these keys (pl) |

## match-up: Objects and Translations
...
1. ___ телефон (this phone, masculine)
   - [x] цей
   - [ ] ця
   - [ ] це
   - [ ] ці
   > Телефон is masculine, so use цей.
...
3. ___ вікно (this window, neuter)
   ...
   - [x] це
   - [ ] ці
   > Вікно is neuter, so use це.

4. ___ ключі (these keys, plural)
   - [ ] цей
   - [ ] ця
   - [ ] це
   - [x] ці
   > Plural objects use ці.

5. ___ диван (that couch, masculine)
   - [x] той
   - [ ] та
   - [ ] те
   - [ ] ті
   > Диван is masculine, so use той.

6. ___ шафа (that wardrobe, feminine)
   - [ ] той
   - [x] та
   - [ ] те
   - [ ] ті
   > Шафа is feminine, so use та.

7. ___ крісло (that armchair, neuter)
   - [ ] той
   - [ ] та
   - [x] те
   - [ ] ті
   > Крісло is neuter, so use те.

8. ___ двері (those doors, plural)
   - [ ] той
   - [ ] та
   - [ ] те
   - [x] ті
...
9. ___ лампа (this lamp, feminine)
   - [ ] цей
   - [x] ця
   - [ ] це
   - [ ] ці
   > Лампа is feminine, so use ця.

10. ___ пилосос (that vacuum cleaner, masculine)
    - [x] той
    - [ ] та
    - [ ] те
    - [ ] ті
    > Пилосос is masculine, so use той.

11. ___ дзеркало (this mirror, neuter)
    - [ ] цей
    - [ ] ця
    - [x] це
    - [ ] ці
    > Дзеркало is neuter, so use це.

12. ___ картини (those paintings, plural)
    - [ ] той
    - [ ] та
    - [ ] те
    - [x] ті
...
## fill-in: Complete with Demonstratives
> Fill in the blank with the correct demonstrative.

1. ___ ніж (this knife)
   > [!answer] Цей
   > [!options] Цей | Ця | Це | Ці

2. ___ ложка (this spoon)
   > [!answer] Ця
   > [!options] Цей | Ця | Це | Ці

3. ___ вікно (that window)
   > [!answer] Те
   > [!options] Той | Та | Те | Ті

4. ___ сумка (this bag)
   > [!answer] Ця
   > [!options] Цей | Ця | Це | Ці

5. ___ телефон (that phone)
   > [!answer] Той
   > [!options] Той | Та | Те | Ті

6. ___ стілець (this chair)
   > [!answer] Цей
   > [!options] Цей | Ця | Це | Ці

7. ___ крісло (that armchair)
   > [!answer] Те
   > [!options] Той | Та | Те | Ті

8. ___ ключі (these keys)
   > [!answer] Ці
   > [!options] Цей | Ця | Це | Ці

9. ___ шафа (that wardrobe)
   > [!answer] Та
   > [!options] Той | Та | Те | Ті

10. ___ лампа (this lamp)
    > [!answer] Ця
    > [!options] Цей | Ця | Це | Ці

11. ___ холодильник (this refrigerator)
    > [!answer] Цей
    > [!options] Цей | Ця | Це | Ці

12. ___ двері (those doors)
    > [!answer] Ті
    > [!options] Той | Та | Те | Ті

## true-false: Demonstrative Agreement
> Decide if each statement is true or false.

- [x] "Цей" is used with masculine singular nouns.
  > Correct! Цей стілець (this chair).

- [x] "Ця" is used with feminine singular nouns.
  > Correct! Ця чашка (this cup).

- [ ] "Це" is used with masculine singular nouns.
  > Incorrect! Це is for neuter singular nouns (це вікно).

- [x] "Ці" is used with all plural nouns regardless of gender.
  > Correct! Ці ключі, ці чашки, ці вікна.

- [ ] "Той" is used with feminine singular nouns.
  > Incorrect! Той is for masculine singular (той стілець). Use "та" for feminine.

- [x] "Та" is used with feminine singular nouns.
  > Correct! Та сумка (that bag).

- [x] "Те" is used with neuter singular nouns.
  > Correct! Те вікно (that window).

- [x] "Ті" is used with all plural nouns.
  > Correct! Ті стільці, ті сумки, ті вікна.

- [ ] "Це" can only mean "this" (neuter).
  > Incorrect! "Це" also means "this is" in general (Це книга = This is a book).

- [x] Demonstratives must agree with the gender of the noun.
  > Correct! This is the key rule.

- [x] Most objects ending in -а or -я are feminine.
  > Correct! Чашка, ложка, сумка, лампа.

- [x] Most objects ending in consonants are masculine.
...
1. — Що ___? — ___ ніж. (What is this? This is a knife.)
   > [!answer] це | Це
   > [!options] це, Це | той, Той | ця, Ця | ці, Ці

2. — ___ чашка твоя? — Так, моя. (Is this cup yours? Yes, mine.)
   > [!answer] Ця
   > [!options] Цей | Ця | Це | Ці

3. — Де мій телефон? — ___ телефон на столі. (Where is my phone? That phone is on the table.)
   > [!answer] Той
   > [!options] Той | Та | Те | Ті

4. — ___ ключі? — Так, ці ключі. (These keys? Yes, these keys.)
   > [!answer] Ці
   > [!options] Цей | Ця | Це | Ці

5. — ___ вікно велике! — Так, дуже велике. (That window is big! Yes, very big.)
   > [!answer] Те
   > [!options] Той | Та | Те | Ті

6. — ___ сумка нова? — Ні, стара. (Is this bag new? No, old.)
   > [!answer] Ця
   > [!options] Цей | Ця | Це | Ці

7. — ___ стілець гарний? — Так, дуже гарний. (Is this chair nice? Yes, very nice.)
   > [!answer] Цей
   > [!options] Цей | Ця | Це | Ці
...
10. — ___ годинник новий? — Так, новий. (Is that clock new? Yes, new.)
    > [!answer] Той
    > [!options] Той | Та | Те | Ті

11. — Де ___ двері? — Там. (Where are those doors? There.)
    > [!answer] ті
    > [!options] той | та | те | ті

12. — ___ дзеркало дуже гарне! — Дякую! (This mirror is very nice! Thank you!)
    > [!answer] Це
    > [!options] Цей | Ця | Це | Ці
