...
```json file=activities.yaml
{
      ...
      "items": [
        {
          ...
          "explanation": "Голосні звуки визначають кількість складів і допомагають прочитати слово плавно."
        },
        {
          ...
          "explanation": "У слові «університет» п'ять голосних звуків (у, і, е, и, е), тому п'ять складів."
        },
        {
        ...
        },
        {
          ...
          "explanation": "Кожен дотик підборіддя до долоні відповідає одному голосному звуку і складу."
        },
        {
  ...
  "workbook": [
    ...
    },
    {
      ...
      "instruction": "Знайди слово, яке відрізняється кількістю складів від решти слів у рядку.",
      "items": [
        {
          "words": [
            "ма́ма",
