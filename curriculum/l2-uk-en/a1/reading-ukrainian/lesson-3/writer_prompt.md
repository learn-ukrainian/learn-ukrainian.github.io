...
Previously introduced in this module: ["склад", "голосни́й звук", "при́голосний звук", "чита́ти", "писа́ти", "ма́ма", "та́то", "молоко́", "я́блуко", "люди́на", "ву́лиця", "столи́ця", "ка́ша", "пі́сня", "день", "о́сінь", "ба́тько", "вчи́тель", "джерело́", "дзе́ркало", "абе́тка", "м'яки́й знак", "апо́строф", "Ки́їв", "Украї́на", "так", "ні"]
