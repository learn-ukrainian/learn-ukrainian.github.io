...
Previously introduced in this module: ["склад", "голосни́й звук", "при́голосний звук", "чита́ти", "писа́ти", "ма́ма", "та́то", "молоко́", "я́блуко", "люди́на", "ву́лиця", "столи́ця", "ка́ша", "пі́сня"]
