The subagent `sources_linguist` has been launched with MCP tools enabled to verify our candidate vocabulary and forms against VESUM and Sources. I will await its verification results before finalizing the artifacts.
I am waiting for the `sources_linguist` subagent to complete its dictionary verification of all target vocabulary and inflectional forms.
...
```json file=activities.yaml
{
  ...
  "workbook": [
    ...
    },
    {
      ...
      "type": "group-sort",
      "title": "Його чи її?",
      "instruction": "Розподіли речення за тим, чи стосується розповідь чоловіка (його) або жінки (її).",
      "groups": [
        {
          "label": "його (his)",
          "items": [
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "explanation": "На рівні A1 уникаємо неправильних конструкцій з «немає + називний відмінок»."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "explanation": "Звертання на ім'я та по батькові сигналізує про ввічливе, офіційне спілкування."
        },
        {
