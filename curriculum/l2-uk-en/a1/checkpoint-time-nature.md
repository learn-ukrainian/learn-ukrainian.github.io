...
<div class="dialogue-line"><span class="speaker">Оля:</span> Приві́т, Дмитре! Яка за́втра погода? *(Hi, Dmytro! What's the weather tomorrow?)*</div>


<div class="dialogue-line"><span class="speaker">Дмитро:</span> Привіт! Тепло і сонячно, без дощу́! *(Hi! Warm and sunny, no rain!)*</div>


<div class="dialogue-line"><span class="speaker">Оля:</span> Чудо́во! Ході́мо в парк у суботу? *(Wonderful! Let's go to the park on Saturday?)*</div>


<div class="dialogue-line"><span class="speaker">Дмитро:</span> До́бре! Я завжди гуляю в суботу. *(OK! I always walk on Saturday.)*</div>


<div class="dialogue-line"><span class="speaker">Оля:</span> О котрій зустрі́немося? *(At what time shall we meet?)*</div>


<div class="dialogue-line"><span class="speaker">Дмитро:</span> О деся́тій ранку бі́ля метро́. *(At ten in the morning near the metro.)*</div>


<div class="dialogue-line"><span class="speaker">Оля:</span> Люблю́ весну́. Навесні так га́рно! *(I love spring. It's so beautiful in spring!)*</div>


<div class="dialogue-line"><span class="speaker">Дмитро:</span> Я теж! Взимку сиди́ш вдо́ма... *(Me too! In winter you sit at home...)*</div>


<div class="dialogue-line"><span class="speaker">Оля:</span> А потім пі́демо в кіно? *(And then shall we go to the cinema?)*</div>


<div class="dialogue-line"><span class="speaker">Дмитро:</span> О котрій починається фільм? *(What time does the movie start?)*</div>


<div class="dialogue-line"><span class="speaker">Оля:</span> О п'я́тій три́дцять. *(At five thirty.)*</div>


<div class="dialogue-line"><span class="speaker">Дмитро:</span> Добре, я часто ходжу в кіно ввечері. *(Good, I often go to the cinema in the evening.)*</div>


<div class="dialogue-line"><span class="speaker">Оля:</span> Як часто ти ди́вишся фі́льми? *(How often do you watch movies?)*</div>


<div class="dialogue-line"><span class="speaker">Дмитро:</span> Іноді — раз на тиждень. *(Sometimes — once a week.)*</div>


<div class="dialogue-line"><span class="speaker">Оля:</span> Чудово! До субо́ти! *(Wonderful! See you Saturday!)*</div>


<div class="dialogue-line"><span class="speaker">Дмитро:</span> До зу́стрічі! *(See you!)*</div>
...
| **за́раз** | now | присл. |  |
| **ра́нку** | in the morning (time of day) | ім. | ж. |
| **ве́чора** | in the evening (time of day) | ім. | ч. |
...
| **тепло́** | it's warm; warm | присл. |  |
| **хо́лодно** | it's cold; cold | присл. |  |
| **со́нячно** | it's sunny; sunny | присл. |  |
| **хма́рно** | it's cloudy; cloudy | присл. |  |
| **сні́дати** | to have breakfast | дієсл. |  |
| **вече́ряти** | to have dinner | дієсл. |  |
| **працюва́ти** | to work | дієсл. |  |
| **вивча́ти** | to study; to learn | дієсл. |  |
| **гуля́ти** | to walk; to go for a walk | дієсл. |  |
| **ходи́ти** | to go (on foot); to walk | дієсл. |  |
| **диви́тися** | to watch; to look | дієсл. |  |
| **споча́тку** | first; at first | присл. |  |
| **по́тім** | then; afterwards | присл. |  |
| **за́вжди́** | always | присл. |  |
| **ча́сто** | often | присл. |  |
| **і́ноді** | sometimes | присл. |  |
| **рі́дко** | rarely; seldom | присл. |  |
| **ти́ждень** | week | ім. | ч. |
| **кіно́** | cinema; movie | ім. | с. |
| **метро́** | metro; subway | ім. | с. |
| **квито́к** | ticket | ім. | ч. |
| **евфоні́я** | euphony (vowel alternation in Ukrainian) | ім. | ж. |
| **мо́ва** | language | ім. | ж. |
...
| **пів на восьму** | half past seven |
| **у неділю** | on Sunday |
| **у березні** | in March |
| **у жовтні** | in October |
| **без дощу** | without rain; no rain |
| **розпорядок дня** | daily routine |
| **займатися спортом** | to exercise; to do sport |
| **Ходімо в парк!** | Let's go to the park! |
| **До суботи!** | See you Saturday! |
| **У тебе виходить!** | You're doing great! / You've got it! |

### Картки́ — Flashcards

<FlashcardDeck client:only="react" cards={[{ front: "годи́на", back: "hour; o'clock", subtitle: "ім.", tag: "ж.", tagColor: "#C2185B" }, { front: "зу́стріч", back: "meeting", subtitle: "ім.", tag: "ж.", tagColor: "#C2185B" }, { front: "за́раз", back: "now", subtitle: "присл." }, { front: "ра́нку", back: "in the morning (time of day)", subtitle: "ім.", tag: "ж.", tagColor: "#C2185B" }, { front: "ве́чора", back: "in the evening (time of day)", subtitle: "ім.", tag: "ч.", tagColor: "#0057B8" }, { front: "понеді́лок", back: "Monday", subtitle: "ім.", tag: "ч.", tagColor: "#0057B8" }, { front: "вівто́рок", back: "Tuesday", subtitle: "ім.", tag: "ч.", tagColor: "#0057B8" }, { front: "середа́", back: "Wednesday", subtitle: "ім.", tag: "ж.", tagColor: "#C2185B" }, { front: "четве́р", back: "Thursday", subtitle: "ім.", tag: "ч.", tagColor: "#0057B8" }, { front: "субо́та", back: "Saturday", subtitle: "ім.", tag: "ж.", tagColor: "#C2185B" }, { front: "неді́ля", back: "Sunday", subtitle: "ім.", tag: "ж.", tagColor: "#C2185B" }, { front: "вве́чері", back: "in the evening", subtitle: "присл." }, { front: "зра́нку", back: "in the morning", subtitle: "присл." }, { front: "сі́чень", back: "January", subtitle: "ім.", tag: "ч.", tagColor: "#0057B8" }, { front: "бе́резень", back: "March", subtitle: "ім.", tag: "ч.", tagColor: "#0057B8" }, { front: "се́рпень", back: "August", subtitle: "ім.", tag: "ч.", tagColor: "#0057B8" }, { front: "жо́втень", back: "October", subtitle: "ім.", tag: "ч.", tagColor: "#0057B8" }, { front: "листопа́д", back: "November", subtitle: "ім.", tag: "ч.", tagColor: "#0057B8" }, { front: "взи́мку", back: "in winter", subtitle: "присл." }, { front: "навесні́", back: "in spring", subtitle: "присл." }, { front: "влі́тку", back: "in summer", subtitle: "присл." }, { front: "восени́", back: "in autumn", subtitle: "присл." }, { front: "весна́", back: "spring", subtitle: "ім.", tag: "ж.", tagColor: "#C2185B" }, { front: "пого́да", back: "weather", subtitle: "ім.", tag: "ж.", tagColor: "#C2185B" }, { front: "тепло́", back: "it's warm; warm", subtitle: "присл." }, { front: "хо́лодно", back: "it's cold; cold", subtitle: "присл." }, { front: "со́нячно", back: "it's sunny; sunny", subtitle: "присл." }, { front: "хма́рно", back: "it's cloudy; cloudy", subtitle: "присл." }, { front: "сні́дати", back: "to have breakfast", subtitle: "дієсл." }, { front: "вече́ряти", back: "to have dinner", subtitle: "дієсл." }, { front: "працюва́ти", back: "to work", subtitle: "дієсл." }, { front: "вивча́ти", back: "to study; to learn", subtitle: "дієсл." }, { front: "гуля́ти", back: "to walk; to go for a walk", subtitle: "дієсл." }, { front: "ходи́ти", back: "to go (on foot); to walk", subtitle: "дієсл." }, { front: "диви́тися", back: "to watch; to look", subtitle: "дієсл." }, { front: "споча́тку", back: "first; at first", subtitle: "присл." }, { front: "по́тім", back: "then; afterwards", subtitle: "присл." }, { front: "за́вжди́", back: "always", subtitle: "присл." }, { front: "ча́сто", back: "often", subtitle: "присл." }, { front: "і́ноді", back: "sometimes", subtitle: "присл." }, { front: "рі́дко", back: "rarely; seldom", subtitle: "присл." }, { front: "ти́ждень", back: "week", subtitle: "ім.", tag: "ч.", tagColor: "#0057B8" }, { front: "кіно́", back: "cinema; movie", subtitle: "ім.", tag: "с.", tagColor: "#E65100" }, { front: "метро́", back: "metro; subway", subtitle: "ім.", tag: "с.", tagColor: "#E65100" }, { front: "квито́к", back: "ticket", subtitle: "ім.", tag: "ч.", tagColor: "#0057B8" }, { front: "евфоні́я", back: "euphony (vowel alternation in Ukrainian)", subtitle: "ім.", tag: "ж.", tagColor: "#C2185B" }, { front: "мо́ва", back: "language", subtitle: "ім.", tag: "ж.", tagColor: "#C2185B" }]} />
...
- Synthesis of M22-M26 content
  _No new material — review and integration of A1.4 phase._
