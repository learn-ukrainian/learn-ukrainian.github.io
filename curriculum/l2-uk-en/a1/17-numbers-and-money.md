...
grammar:
  - "Cardinals 0-100"
  - "Number agreement with nouns (1=nom.sg, 2-4=nom.pl, 5+=gen.pl)"
...
1. У мене ___ гривень. (I have ___ hryvnias.) [10]
   > [!answer] десять
   > [!options] десять | п'ять | двадцять | сто

2. Це коштує ___ гривень. (This costs ___ hryvnias.) [50]
   > [!answer] п'ятдесят
   > [!options] п'ятнадцять | п'ятдесят | п'ять | сорок

3. Вона має ___ років. (She is ___ years old.) [23]
   > [!answer] двадцять три
   > [!options] двадцять три | тридцять два | двадцять | три

4. Автобус номер ___. (Bus number ___.) [40]
   > [!answer] сорок
   > [!options] чотири | чотирнадцять | сорок | чотирдесят

5. ___ студентів у класі. (___ students in the class.) [15]
   > [!answer] П'ятнадцять
   > [!options] П'ять | П'ятнадцять | П'ятдесят | Шістнадцять

6. Хліб коштує ___ гривень. (Bread costs ___ hryvnias.) [8]
   > [!answer] вісім
   > [!options] вісім | вісімнадцять | вісімдесят | сім

7. Я маю ___ рік. (I am ___ years old.) [21]
   > [!answer] двадцять один
   > [!options] один | двадцять | двадцять один | одинадцять

8. Це коштує ___ гривень. (This costs ___ hryvnias.) [100]
   > [!answer] сто
   > [!options] десять | сто | вісімдесят | дев'яносто

9. У мене є ___ копійок. (I have ___ kopecks.) [75]
   > [!answer] сімдесят п'ять
   > [!options] сімдесят п'ять | сім | п'ятдесят сім | п'ять

10. Каса номер ___. (Cashier number ___.) [7]
    > [!answer] сім
    > [!options] сім | сімдесят | сімнадцять | вісім

11. ___ книг на столі. (___ books on the table.) [12]
    > [!answer] Дванадцять
    > [!options] Два | Дванадцять | Двадцять | Двадцять два

12. Молоко коштує ___ гривень. (Milk costs ___ hryvnias.) [20]
    > [!answer] двадцять
...
1. How do you say "one hryvnia"?
   ...
   - [ ] одне гривня
   - [ ] одні гривні
   > гривня is feminine, so use одна

2. How do you say "two hryvnias"?
   - [ ] два гривні
   - [x] дві гривні
   - [ ] два гривня
   - [ ] дві гривень
   > 2-4 use nominative plural: дві гривні (feminine form)

3. How do you say "five hryvnias"?
   - [ ] п'ять гривні
   - [ ] п'ять гривня
   - [x] п'ять гривень
   - [ ] п'яти гривень
...
- [x] The Ukrainian currency is called гривня.
  > Correct! It's been used since 1996.

- [ ] Numbers 2-4 use genitive plural forms.
  > Incorrect! Numbers 2-4 use nominative plural. Only 5+ use genitive plural.

- [x] The number 2 has different forms for different genders.
  > Correct! два (m/n) vs дві (f)

- [ ] "Дорого" means "cheap."
  > Incorrect! "Дорого" means expensive. "Дешево" means cheap.

- [x] The hryvnia symbol is ₴.
  > Correct! It's a stylized Г with two lines.

- [x] Bargaining is not common in Ukrainian supermarkets.
  > Correct! Prices are fixed in shops.

- [ ] "Готівка" means "card."
  > Incorrect! "Готівка" means cash. "Картка" means card.

- [x] The word "гривня" dates back to Kyivan Rus'.
  > Correct! It meant a silver neck ring.

- [ ] Numbers 5-20 use nominative case.
  > Incorrect! They use genitive plural.

- [x] "Скільки коштує?" is the phrase for asking prices.
  > Correct! Essential shopping phrase.

- [ ] One hundred is "дев'яносто."
  > Incorrect! One hundred is "сто." Дев'яносто is ninety.

- [x] Ukrainian banknotes feature historical figures.
...
1. Доброго дня! Що ___? (Good afternoon! What ___ you want?)
   > [!answer] бажаєте
   > [!options] бажаєте | є | коштує | маю

2. ___ коштує молоко? (___ does milk cost?)
   > [!answer] Скільки
   > [!options] Скільки | Що | Де | Хто

3. Двадцять ___. (Twenty ___.)
   > [!answer] гривень
   > [!options] гривня | гривні | гривень | гривнів

4. Добре. Одне молоко, ___ ласка. (Okay. One milk, ___.)
   > [!answer] будь
   > [!options] будь | є | маю | дякую

5. Можна платити ___? (Can I pay by ___?)
   > [!answer] карткою
   > [!options] картка | карткою | картки | карток

6. Так, звичайно. ___! (Yes, of course. ___!)
   > [!answer] Дякую
   > [!options] Дякую | Привіт | До побачення | Вибачте

7. Ось ваше молоко. ___ гривень, будь ласка. (Here's your milk. ___ hryvnias, please.)
   > [!answer] Двадцять
   > [!options] Два | Двадцять | Дванадцять | Сто

8. У вас є ___? (Do you have ___?)
   > [!answer] гроші
