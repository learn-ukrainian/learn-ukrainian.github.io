...
Previously introduced in this module: ["ім'я", "прізвище", "знайомство", "познайомитися", "професія", "походження", "Вітаю", "Дуже приємно", "Мені теж", "Мене звати", "Як тебе звати?", "Звідки ти?", "Я з", "Мені 20 років", "У мене є", "студент", "студентка", "сім'я"]
