...
> [!conversation] Як справи? (How Are Things?)
>
> — Привіт! Як справи?
...
> [!conversation] Як він грає? (How Does He Play?)
>
> — Як грає твій брат?
> — Він грає **дуже добре**!
> — А твоя сестра?
...
8. Він танцює дуже ___.
   > [!answer] погано
   > [!options] погано | поганий | погана | погане

9. Вона працює дуже ___.
   > [!answer] важко
...
## true-false: Adverb Rules

Is this true or false?

- [x] Adverbs describe verbs (actions).
- [ ] Adverbs describe nouns.
  > Incorrect! that's adjectives

- [x] Most adverbs end in -о.
- [ ] "Добрий" is an adverb.
  > Incorrect! it's an adjective

- [x] "Добре" is an adverb.
- [ ] "Ніколи" doesn't need "не" before the verb.
  > Incorrect! you need two negatives

- [x] "Завжди" means "always".
- [x] "Дуже" can modify adverbs (дуже добре).
- [ ] "Швидкий" describes how you do something.
  > Incorrect! it's an adjective

- [x] "Швидко" describes how you do something.
- [ ] "Як справи?" — "Добрий!".
  > Incorrect! should be "Добре!"
