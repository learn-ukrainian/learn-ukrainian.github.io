...
Універсальний варіант — це слово **алло** [ɑˈlɔ]. Це слово тільки для телефону. Воно підходить для неформальних розмов. Дзвонить друг? Кажіть алло. Дзвонить мама? Кажіть алло. 

However, in professional or formal contexts, Ukrainian speakers use a different, very polite approach. They say **слухаю** [ˈsluxɐju], which literally means "I am listening". This word is a form of the verb "to listen". By answering with this word, you signal that you are attentive, professional, and ready to assist the caller. It is the standard greeting for receptionists, customer service representatives, or anyone answering a business line.
...
Now, let us look at a very common word you will use: the verb to call, which is **дзвонити** [d͡zʋoˈnɪtɪ]. You can also use a more formal alternative, **телефонувати** [tɛlɛfonuˈʋɑtɪ]. Let us focus on the first word, as it introduces a fascinating sound.
...
Лінія зайнята? Ви почуєте слово **зайнятий** [ˈzɑi̯nʲɐtɪi̯]. У вас є вибір. Можна зателефонувати пізніше. Це дієслово **передзвонити** [pɛrɛd͡zʋoˈnɪtɪ]. Можна написати текст.
