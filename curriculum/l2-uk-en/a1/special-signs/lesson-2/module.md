...
> **Оле́г**: Приві́т! Як перено́сити сло́во бур'я́н? *(Hi! How to divide the word бур'я́н across lines?)*
> **Мар'я́на**: Ду́же про́сто: бур'-ян. Апо́строф залиша́ється з лі́терою пе́ред ним. *(Very simple: бур'-ян. The apostrophe stays with the letter before it.)*
> **Оле́г**: А як перено́сити сло́во па́льці? *(And how to divide the word па́льці?)*
> **Мар'я́на**: Ось так: паль-ці. М'яки́й знак теж залиша́ється з лі́терою пе́ред ним. *(Like this: паль-ці. The soft sign also stays with the letter before it.)*
