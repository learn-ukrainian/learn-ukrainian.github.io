...
Previously introduced in this module: ["м'яки́й знак", "апо́строф", "знак", "м'яки́й", "тверди́й", "йото́ваний", "розді́льно", "зли́то", "день", "кінь", "сіль", "вчи́тель", "сім'я́", "м'я́со", "п'ять", "де́в'ять", "ім'я́", "комп'ю́тер"]
