...
3. **Збіг при́голосних перед я без апо́строфа** *(consonant cluster before ya without apostrophe)*:
   У слова́х **свя́то** та **цвях** пе́ред губни́м зву́ком `[в]` стої́ть інший при́голосний (**с** або **ц**), тому́ апо́строф не пи́шеється — in the words **свя́то** and **цвях**, before the labial sound `[v]` stands another consonant (**s** or **ts**), so no apostrophe is written.
  ...
  "inline": [
    ...
    },
    {
      ...
      "items": [
        ...
        {
          "statement": "При переносі слів апостроф ніколи не відривається від літери перед ним.",
          "correct": true,
