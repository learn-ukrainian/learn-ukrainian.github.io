...
Previously introduced in this module: ["рід", "іме́нник", "хто це?", "що це?", "він", "вона́", "воно́", "мій", "моя́", "моє́", "стіл", "кни́га", "вікно́", "мі́сто", "та́то", "ба́тько", "соба́ка", "Мико́ла", "у мене́ є", "у тебе́ є", "кімна́та", "лі́жко", "стіле́ць", "ла́мпа", "телефо́н", "комп'ю́тер", "зо́шит", "ру́чка", "су́мка", "крі́сло", "дзе́ркало", "ключ", "фо́то", "стіна́"]
