...
Previously introduced in this module: ["привіт", "добрий день", "мене звати", "як тебе звати?", "як вас звати?", "а тебе?", "а вас?", "дуже приємно", "дякую", "спасибі", "вибачте", "пробачте", "теж", "також"]
