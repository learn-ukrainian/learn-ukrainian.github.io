...
Previously introduced in this module: ["привіт", "добрий день", "мене звати", "як тебе звати?", "як вас звати?", "а тебе?", "а вас?", "дуже приємно", "дякую", "спасибі", "вибачте", "пробачте", "теж", "також", "я", "ти", "він", "вона", "ми", "ви", "вони", "це", "хто", "що", "тато", "мама", "подруга", "студент", "студентка", "вчитель", "вчителька", "лікар", "лікарка", "програміст", "програмістка", "інженер", "інженерка", "українець", "українка", "канадієць", "канадка", "американець", "американка"]
