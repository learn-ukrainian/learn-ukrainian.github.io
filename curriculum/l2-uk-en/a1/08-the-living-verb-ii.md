...
> Arrange the letters to form the correct Ukrainian verb.
...
- [x] Class II verbs end in -ити or -іти in the infinitive.
  > Correct! This is the defining feature of Class II verbs.

- [ ] The verb "читати" is Class II.
  > Incorrect! "читати" ends in -ати, so it's Class I.

- [x] Irregular verbs like їсти and пити don't follow standard conjugation patterns.
  > Correct! These verbs have unique conjugation forms.

- [x] In Class II, the first person singular ending is -ю or -у.
  > Correct! я говорю, я роблю (with consonant mutation).

- [ ] The verb "говорити" conjugates as "я говорую."
  > Incorrect! It's "я говорю" (not "говорую").

- [x] "Дякувати" is a Class I verb.
  > Correct! It ends in -увати, which is a Class I pattern.

- [ ] All verbs ending in -ати are Class I.
  > Incorrect! "спати" ends in -ати but behaves like Class II in some forms.

- [x] The third person plural ending for Class II is -ять or -ать.
  > Correct! вони говорять, вони роблять.

- [x] "Я хочу" is an irregular form.
  > Correct! хотіти is irregular: хочу, хочеш, хоче.

- [ ] Class II verbs don't have consonant mutations.
  > Incorrect! Many do: робити → роблю, ходити → ходжу.

- [x] "П'ю" is the first person singular of "пити."
  > Correct! я п'ю (I drink).

- [x] Ukrainian distinguishes between ходити (on foot) and їздити (by vehicle).
  > Correct! This precision is a beautiful feature of Ukrainian.

## group-sort: Verb Types
...
1. Марія: Привіт! Ти ___ книгу?
   > [!answer] читаєш
   > [!options] читаю | читаєш | читає | читають

2. Петро: Так, я ___ книгу.
   > [!answer] читаю
   > [!options] читаю | читаєш | читає | читають

3. Марія: Я ___ каву зараз.
   > [!answer] п'ю
   > [!options] п'ю | п'єш | п'є | п'ють

4. Петро: Я ___ музику!
   > [!answer] люблю
   > [!options] люблю | любиш | любить | люблять

5. Марія: Ти ___ в університет?
   > [!answer] ходиш
   > [!options] ходжу | ходиш | ходить | ходять

6. Петро: Так, я ___ українську мову.
   > [!answer] вчу
   > [!options] вчу | вчиш | вчить | вчать

7. Марія: Ти ___ українську?
   > [!answer] любиш
   > [!options] люблю | любиш | любить | люблять

8. Петро: Так! Я ___ українську мову!
   > [!answer] люблю
   > [!options] люблю | любиш | любить | люблять

9. Марія: Я ___ вивчати більше.
   > [!answer] хочу
   > [!options] хочу | хочеш | хоче | хочуть

10. Петро: Ти ___ борщ?
    > [!answer] любиш
    > [!options] люблю | любиш | любить | люблять

11. Марія: Так, я дуже ___ борщ!
    > [!answer] люблю
    > [!options] люблю | любиш | любить | люблять

12. Петро: Ти ___ фільм сьогодні?
    > [!answer] дивишся
    > [!options] дивлюся | дивишся | дивиться | дивляться

13. Марія: Так, я ___ фільм!
    > [!answer] дивлюся
    > [!options] дивлюся | дивишся | дивиться | дивляться
