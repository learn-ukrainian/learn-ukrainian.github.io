...
Note that **ма́ло** and **мала́** do not differ by stress alone: they also change their ending vowel from **-о** to **-а** (**о** → **а**). The stress shifts from the first syllable to the second, matching the change from an adverb (**ма́ло**) to a feminine adjective (**мала́**):
...
- `ма́м-а` (stating a fact) → `ма́м-о!` (calling her with warmth and respect).
