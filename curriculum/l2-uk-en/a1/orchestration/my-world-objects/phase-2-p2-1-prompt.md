...
> **Your #1 job: Write 259 words for the section "Warm-up".**
...
Write the section prose for **Warm-up** within the module **My World: Objects**.

- **WORD BUDGET**: 259 words minimum, 259 × 2 maximum. Stay in this range.
...
- Target: 259 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Warm-up": {count} words (budget: 259-259×2)
===WORD_COUNTS===
```
