...
5. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/my-world-objects-research.md`
...
unverified_terms: []
review_focus:
  - "Demonstratives agreement accuracy"
  - "Clear distinction between Identification and Specification concepts"
  - "Appropriate cultural hooks mapping to English learner mental models"
rag_tools_used:
  - "verify_words: bypassed due to use of highly standard common noun set from syllabus"
```
...
Word count:       1425 / 1200 (118.8%)
Activities:       4
Vocabulary items: 20
Engagement boxes: 0
Immersion:        7.8% (target: 10-20%)
...
**Words checked:** 49 | **VESUM coverage:** 49/49 (100.0%)
