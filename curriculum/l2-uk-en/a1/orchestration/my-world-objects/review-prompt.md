...
3. Verify with Grep: `Grep pattern="first 5-6 words" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/my-world-objects.md"`
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/my-world-objects-research.md`
...
Word count:       3961 / 2000 (198.0%)
Activities:       9
Vocabulary items: 29
Engagement boxes: 4
Immersion:        15.0% (target: 15-35%)
Richness:         70% (threshold: 95%)
Richness gaps:    engagement: 3/5, cultural: 1/3, examples: 11/24, dialogues: 3/4, tables: 1/2
Audit status:     FAIL
```
...
**Words checked:** 317 | **VESUM coverage:** 317/317 (100.0%)
...
**When you find an issue, produce the fix immediately.** The pipeline applies these fixes automatically via exact string matching — if FIND text doesn't match the file exactly, the fix is silently skipped.
