...
- type: fill-in
  ...
  items:
    ...
    - sentence: 'Що це? — Це ___.'
      answer: "ліжко"
      options: ["ліжко", "вікно", "крісло", "блюдо"]
      explanation: "Ліжко means bed."
    - sentence: 'Що це? — Це ___.'
      answer: "кімната"
      options: ["кімната", "квартира", "хата", "лампа"]
      explanation: "Кімната means room."
    - sentence: 'Що це? — Це ___.'
      answer: "лампа"
      options: ["лампа", "ложка", "книга", "шафа"]
      explanation: "Лампа means lamp."
    - sentence: 'Що це? — Це ___.'
      answer: "шафа"
      options: ["шафа", "хата", "кімната", "книга"]
      explanation: "Шафа means wardrobe."
    - sentence: 'Що це? — Це ___.'
      answer: "стілець"
      options: ["стілець", "стіл", "диван", "дім"]
      explanation: "Стілець means chair."
    - sentence: 'Що це? — Це ___.'
      answer: "крісло"
      options: ["крісло", "ліжко", "блюдо", "вікно"]
      explanation: "Крісло means armchair."
    - sentence: 'Що це? — Це ___.'
      answer: "ніж"
      options: ["ніж", "стіл", "телефон", "дім"]
      explanation: "Ніж means knife."
    - sentence: 'Що це? — Це ___.'
      answer: "ложка"
      options: ["ложка", "лампа", "книга", "шафа"]
      explanation: "Ложка means spoon."
    - sentence: 'Що це? — Це ___.'
      answer: "блюдо"
      options: ["блюдо", "крісло", "ліжко", "вікно"]
      explanation: "Блюдо means dish."
```
