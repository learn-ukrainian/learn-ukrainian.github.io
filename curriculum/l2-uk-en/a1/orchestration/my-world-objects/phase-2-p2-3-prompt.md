...
> **Your #1 job: Write 540 words for the section "Practice".**
...
Write the section prose for **Practice** within the module **My World: Objects**.

- **WORD BUDGET**: 540 words minimum, 540 × 2 maximum. Stay in this range.
...
- Target: 540 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Practice": {count} words (budget: 540-540×2)
===WORD_COUNTS===
```
