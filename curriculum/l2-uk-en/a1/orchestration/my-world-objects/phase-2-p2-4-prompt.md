...
> **Your #1 job: Write 583 words for the section "Cultural Insight".**
...
Write the section prose for **Cultural Insight** within the module **My World: Objects**.

- **WORD BUDGET**: 583 words minimum, 583 × 2 maximum. Stay in this range.
...
- Target: 583 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Cultural Insight": {count} words (budget: 583-583×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Cultural Insight)
