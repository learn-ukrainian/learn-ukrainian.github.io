...
1. **Content** (the lesson you're reviewing): `curriculum/l2-uk-en/a1/my-world-objects.md`
2. **Activities**: `curriculum/l2-uk-en/a1/activities/my-world-objects.yaml`
3. **Vocabulary**: `curriculum/l2-uk-en/a1/vocabulary/my-world-objects.yaml`
4. **Plan** (source of truth for scope): `curriculum/l2-uk-en/plans/a1/my-world-objects.yaml`
5. **Meta** (build config): `curriculum/l2-uk-en/a1/meta/my-world-objects.yaml`
