...
> **Your #1 job: Write 112 words for the section "Production".**
...
Write the section prose for **Production** within the module **My World: Objects**.

- **WORD BUDGET**: 112 words minimum, 112 × 2 maximum. Stay in this range.
...
- Target: 112 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Production": {count} words (budget: 112-112×2)
===WORD_COUNTS===
```
