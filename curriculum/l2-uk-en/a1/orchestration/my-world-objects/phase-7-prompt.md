...
1. **Plan** (source of truth): `curriculum/l2-uk-en/plans/a1/my-world-objects.yaml`
2. **Meta** (build config): `curriculum/l2-uk-en/a1/meta/my-world-objects.yaml`
3. **Content** (the lesson): `curriculum/l2-uk-en/a1/my-world-objects.md`
4. **Activities**: `curriculum/l2-uk-en/a1/activities/my-world-objects.yaml`
5. **Vocabulary**: `curriculum/l2-uk-en/a1/vocabulary/my-world-objects.yaml`
6. **Review** (Green Team review from Phase 6): `curriculum/l2-uk-en/a1/review/my-world-objects-review.md`
7. **Phase 6b fix log** (if exists): `curriculum/l2-uk-en/a1/orchestration/my-world-objects/phase-6b-fixes.md`
...
```bash
scripts/audit_module.sh curriculum/l2-uk-en/a1/my-world-objects.md
```
...
Check against `curriculum/l2-uk-en/plans/a1/my-world-objects.yaml`:
...
Read `curriculum/l2-uk-en/a1/my-world-objects.md` in FULL. Check for:

### 3a: Russianisms (auto-fail)
```bash
grep -inP 'кушати|получати|приймати участь|слідуючий|любий\b|дякуючи' curriculum/l2-uk-en/a1/my-world-objects.md
grep -inP 'кушати|получати|приймати участь|слідуючий|любий\b|дякуючи' curriculum/l2-uk-en/a1/activities/my-world-objects.yaml
```

### 3b: Russian characters (auto-fail)
```bash
grep -nP '[ыэёъ]' curriculum/l2-uk-en/a1/my-world-objects.md
grep -nP '[ыэёъ]' curriculum/l2-uk-en/a1/activities/my-world-objects.yaml
```
...
```bash
.venv/bin/python scripts/lint_ipa.py curriculum/l2-uk-en/a1/my-world-objects.md
```

If issues found, auto-fix:
```bash
.venv/bin/python scripts/lint_ipa.py curriculum/l2-uk-en/a1/my-world-objects.md --fix
```
...
```bash
grep -nP '\[/[^]]+/\]|(?<!\[)/[а-яіїєґА-ЯІЇЄҐ][^/]*/(?!\])' curriculum/l2-uk-en/a1/my-world-objects.md
```
If found and track is B1+: move to vocabulary, remove from content.

### 3e: English leakage
```bash
grep -inP '\b(the|is|are|was|were|has|have|this|that|with|from|for|and|but|not|can|will)\b' curriculum/l2-uk-en/a1/my-world-objects.md
```
...
```bash
.venv/bin/python scripts/calc_immersion.py curriculum/l2-uk-en/a1/my-world-objects.md
```
...
Read `curriculum/l2-uk-en/a1/activities/my-world-objects.yaml` in FULL.
...
Read `curriculum/l2-uk-en/a1/review/my-world-objects-review.md`. For EACH issue in "Critical Issues Found" or "Fix Plan":
