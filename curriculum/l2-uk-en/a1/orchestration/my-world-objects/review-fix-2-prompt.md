...
failing gates:
lesson: 4884/3300 (raw: 5147) | pedagogy: 1 violations | immersion: 14.9% LOW (target 15-35% (M10))
...
Welcome back. Today, we are going to step into your personal space. By the end of this lesson, you will be able to point at any object around you and say "this table" or "that window" with perfect grammatical agreement — using gender-matched demonstrative pronouns in Ukrainian. Our environment is filled with objects that matter to us. We pick them up, we point at them from across the room, and we organize our daily lives around them. Being able to talk about these objects smoothly is one of the most practical skills you can develop. 
...
> [!note] **Active Reading Strategy**
> As you read the passages below, underline or circle every demonstrative pronoun you see. Then check: does it start with **Ц-** (near) or **Т-** (far)? Does its ending match the noun's gender? This active approach will help the patterns stick.
...
> The Ukrainian word for furniture is **ме́блі**, and just like **две́рі**, it is used in the plural form. The singular *мебля* exists as an archaic form but is rarely used in modern Ukrainian — you will almost always hear the plural **меблі**, just as English speakers always say "furniture" rather than "a furniture." So if you want to point at the furniture in your room, you always use the plural demonstrative: **ці ме́блі** (this furniture, near) or **ті ме́блі** (that furniture, far).
...
> **Продавець (Salesperson):** Цей сті́л? Він га́рний. А та ша́фа?
...
> [!cultural] **The Піч — Soul of the Ukrainian Home**
...
> [!cultural] **Рушники — More Than Towels**
