...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/my-world-objects.md"
   ```
...
Word count:       2255 / 2000 (112.8%)
Activities:       9
Vocabulary items: 20
Engagement boxes: 5
Immersion:        13.0% (target: 10-25%)
Audit status:     FAIL
```

## Content Sections (H2 headers in the content file)

1. Вступ: Вказуємо на світ
2. Теорія: Вказівні займенники (Цей і Той)
3. Практика: Побут і речі
4. Культурний контекст: Український дім
5. Використання: Описуємо кімнату
