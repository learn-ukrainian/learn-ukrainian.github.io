...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/description-adverbs.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/description-adverbs-research.md`
...
Word count:       2891 / 2000 (144.6%)
Activities:       10
Vocabulary items: 20
Engagement boxes: 9
Immersion:        35.4% (target: 35-55%)
Audit status:     FAIL
```

## Content Sections (H2 headers in the content file)

1. Розминка: Як чи Який?
2. Презентація: Утворення та Винятки
3. Презентація 2: Як часто?
4. Презентація 3: Ступені та Інтенсивність
5. Практика: Звички та Стиль Життя
