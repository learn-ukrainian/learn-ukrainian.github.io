...
> **Your #1 job: Write 300 words for the section "Частота та інтенсивність: Коли і наскільки?".**
...
Write the section prose for **Частота та інтенсивність: Коли і наскільки?** within the module **Description: Adverbs**.
...
- ### Прикметник чи прислівник?
  → Уявіть, що ми з вами п’ємо ранкову каву на кухні. Кава може бути смачна. Це її ознака. Але ми можемо пити її **повільно*...
- ### Магія перетворення: Від -ий до -о
  → Як же створити ці слова? Це дуже просто. Уявіть, що ви — конструктор слів. Більшість українських прислівників народжують...
- ### Де ставити слово?
  → Тепер ви знаєте слова, але де їх поставити у реченні? Українська мова дуже гнучка, і ви можете змінювати порядок слів. А...
---
...
```
===WORD_COUNTS===
Section "Частота та інтенсивність: Коли і наскільки?": {count} words (budget: 300-300×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Частота та інтенсивність: Коли і наскільки?)
