...
3. Verify with Grep: `Grep pattern="first 5-6 words" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/description-adverbs.md"`
...
5. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/description-adverbs-research.md`
...
deviations:
  - section: "none"
    reason: "Strict adherence to all requirements and precise matching of all sections and bullet points."
frictions:
  - type: "NONE"
...
unverified_terms:
  - "None."
review_focus:
  - "Check that the transition from adjectives to adverbs is clearly explained, word counts match the target per section, and that all activities match exactly the target item counts requested in the plan."
rag_tools_used:
  - "Relied on built-in knowledge of Grade 7 materials (Заболотний) for derivation and structural guidelines."
```
...
Word count:       1285 / 1200 (107.1%)
Activities:       8
Vocabulary items: 20
Engagement boxes: 1
Immersion:        18.5% (target: 20-35%)
...
2. Основи та Формування (Basics and Formation)
3. Час та Частота (Time and Frequency)
4. Синтаксис та Інтенсивність (Syntax and Intensity)
5. Підсумок та Культура (Summary and Culture)
...
**Words checked:** 116 | **VESUM coverage:** 115/116 (99.1%)
