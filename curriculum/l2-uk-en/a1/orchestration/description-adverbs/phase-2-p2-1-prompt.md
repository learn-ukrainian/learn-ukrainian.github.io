...
> **Your #1 job: Write 300 words for the section "Прислівники способу дії: Як це робити?".**
...
Write the section prose for **Прислівники способу дії: Як це робити?** within the module **Description: Adverbs**.
...
```
===WORD_COUNTS===
Section "Прислівники способу дії: Як це робити?": {count} words (budget: 300-300×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Прислівники способу дії: Як це робити?)
