...
- type: fill-in
  ...
  items:
    ...
    - sentence: "Ми працюємо ___. (важкий)"
      answer: "важко"
      options: ["важко", "важка", "важкий", "важку"]
      explanation: "The adjective важкий becomes the adverb важко to describe how we work."
    - sentence: "Вона готує ___. (смачний)"
      answer: "смачно"
      options: ["смачно", "смачна", "смачний", "смачну"]
      explanation: "The adjective смачний becomes the adverb смачно to describe how she cooks."
    - sentence: "Він відпочиває ___. (повільний)"
      answer: "повільно"
      options: ["повільно", "повільна", "повільний", "повільну"]
      explanation: "The adjective повільний becomes the adverb повільно to describe how he rests."
    - sentence: "Ми читаємо ___. (голосний)"
      answer: "голосно"
      options: ["голосно", "голосна", "голосний", "голосну"]
      explanation: "The adjective голосний becomes the adverb голосно to describe how we read."
    - sentence: "Вони їдять ___. (швидкий)"
      answer: "швидко"
      options: ["швидко", "швидка", "швидкий", "швидку"]
      explanation: "The adjective швидкий becomes the adverb швидко to describe how they eat."
    - sentence: "Я говорю ___. (тихий)"
      answer: "тихо"
      options: ["тихо", "тиха", "тихий", "тиху"]
      explanation: "The adjective тихий becomes the adverb тихо to describe how I speak."
    - sentence: "Вона працює ___. (гарний)"
      answer: "гарно"
      options: ["гарно", "гарна", "гарний", "гарну"]
      explanation: "The adjective гарний becomes the adverb гарно to describe how she works."
    - sentence: "Він ходить ___. (повільний)"
      answer: "повільно"
      options: ["повільно", "повільна", "повільний", "повільну"]
      explanation: "The adjective повільний becomes the adverb повільно to describe how he walks."
    - sentence: "Вони грають ___. (голосний)"
      answer: "голосно"
      options: ["голосно", "голосна", "голосний", "голосну"]
      explanation: "The adjective голосний becomes the adverb голосно to describe how they play."
    - sentence: "Я розумію ___. (поганий)"
      answer: "погано"
      options: ["погано", "погана", "поганий", "погану"]
      explanation: "The adjective поганий becomes the adverb погано to describe how I understand."
    - sentence: "Вона снідає ___. (швидкий)"
      answer: "швидко"
      options: ["швидко", "швидка", "швидкий", "швидку"]
      explanation: "The adjective швидкий becomes the adverb швидко to describe how she eats breakfast."
...
- type: fill-in
  ...
  items:
    ...
    - sentence: "Вона ___ їсть м'ясо."
      answer: "рідко"
      options: ["рідко", "дуже", "добре", "швидко"]
      explanation: "Вона рідко їсть м'ясо means She rarely eats meat."
    - sentence: "Він працює трохи ___."
      answer: "повільно"
      options: ["повільно", "завжди", "ніколи", "іноді"]
      explanation: "Він працює трохи повільно means He works a bit slowly. Трохи softens the adverb."
    - sentence: "Ми ___ не п'ємо каву."
      answer: "ніколи"
      options: ["ніколи", "добре", "швидко", "часто"]
      explanation: "Ми ніколи не п'ємо каву means We never drink coffee. Remember: ніколи requires не."
    - sentence: "Вона готує дуже ___."
      answer: "смачно"
      options: ["смачно", "завжди", "іноді", "рідко"]
      explanation: "Вона готує дуже смачно means She cooks very deliciously."
    - sentence: "Він ___ відпочиває тут."
      answer: "завжди"
      options: ["завжди", "погано", "швидко", "добре"]
      explanation: "Він завжди відпочиває тут means He always rests here."
    - sentence: "Я працюю ___ і добре."
      answer: "швидко"
      options: ["швидко", "ніколи", "рідко", "іноді"]
      explanation: "Я працюю швидко і добре means I work quickly and well."
