...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/description-adverbs-research.md` | Research notes |
...
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/description-adverbs.yaml` | Objectives, vocabulary_hints |
...
Write the lesson prose for **Description: Adverbs** (a1 track).
...
- **Structure**: Follow the content_outline from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/description-adverbs.yaml` — each section maps to an H2. **Write ALL sections. Do not skip any section, even short ones like Summary.** Missing sections fail validation.
...
| Основи та формування (Basics and Formation) | 300 |
| Час та частота (Time and Frequency) | 300 |
| Синтаксис та інтенсивність (Syntax and Intensity) | 200 |
| Підсумок: Як ми це робимо? (Summary: How We Do It) | 150 |
| **Total** | **1200** |
