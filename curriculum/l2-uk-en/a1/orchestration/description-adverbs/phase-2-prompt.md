...
Write the full lesson prose for **Description: Adverbs** (a1 track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Основи та формування | 450 | 675 |
| Час та частота | 450 | 675 |
| Синтаксис та інтенсивність | 400 | 600 |
| Підсумок та культура | 300 | 450 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/description-adverbs.yaml`. Go through EVERY `points:` item in EVERY section:
