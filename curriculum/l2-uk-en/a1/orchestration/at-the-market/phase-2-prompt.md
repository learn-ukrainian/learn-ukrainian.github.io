...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/at-the-market-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/at-the-market.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/at-the-market.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **At the Market** (a1 track).
...
| Презентація лексики та граматики | 600 | 900 |
| Мовні помилки та практика | 400 | 600 |
| Діалоги та рольові ігри | 500 | 750 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/at-the-market.yaml`. Go through EVERY `points:` item in EVERY section:
