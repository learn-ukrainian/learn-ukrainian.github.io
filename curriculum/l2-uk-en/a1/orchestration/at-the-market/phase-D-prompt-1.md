...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/at-the-market.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/at-the-market-research.md`
...
Word count:       2685 / 2000 (134.2%)
Activities:       10
Vocabulary items: 0
Engagement boxes: 5
Immersion:        35.2% (target: 35-55%)
Richness:         81% (threshold: 95%)
Richness gaps:    cultural: 2/3, dialogues: 0/4
Audit status:     PASS
```
...
1. Вступ: Культура українського ринку
2. Лексика та Граматика: Як купувати?
3. Практика: Діалоги на ринку
4. Історія: Мій похід на Привоз
