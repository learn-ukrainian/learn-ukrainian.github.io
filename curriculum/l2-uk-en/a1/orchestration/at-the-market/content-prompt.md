...
|------|----------------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/at-the-market-research.md` | Background knowledge, engagement hooks |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/at-the-market.yaml` | Objectives, vocabulary_hints (source of truth) |
...
| Tool | When | Example |
|------|------|---------|
| `search_text` | Find textbook pedagogy | `search_text("Genitive for quantities (кілограм + genitive) Accusative for requests", grade=3-5)` |
...
**Modules completed before this one:** 59
**Previous module:** Writing Skills

**Cumulative vocabulary (623 words):**
...
привіт, структура, просто

**Grammar already taught (191 topics):**
...
**Coming next (module after this):** Location questions (Де знаходиться...?), Accusative for shopping, Quantity expressions
...
- ринок (market) — на ринку, піти на ринок; розмовний синонім «базар»
- кілограм (kilogram) — один кілограм, два кілограми (Nom.Pl), п'ять кілограмів (Gen.Pl), пів кілограма
- штука (piece) — одна штука, п'ять штук; часто використовується для поштучного товару
- свіжий (fresh) — свіжі овочі, свіже молоко; ідіома «тільки з грядки» (fresh from the garden)
- овочі (vegetables) — свіжі овочі, купити овочі на вагу
- фрукти (fruits) — солодкі фрукти, сезонні фрукти
- скільки (how much) — скільки коштує?, скільки з мене?, скільки це важить?
- дайте (give me) — дайте, будь ласка; ввічлива форма наказового способу

**Recommended** (use in your content to reach the vocabulary target):
- решта (change) — без решти (exact change), візьміть решту; синонім «здача» менш частотний
- продавець (vendor) — ввічливий продавець, запитати продавця про якість
- яблука (apples) — кілограм яблук, солодкі яблука
- картопля (potatoes) — кілограм картоплі, молода картопля
- помідори (tomatoes) — червоні помідори, два кілограми помідорів
- огірки (cucumbers) — свіжі огірки, п'ять штук огірків
...
- **ULP S1 Ep9: How much does it cost? At the market in Ukraine**
...
- **1 S1 Ep9: ULP 1-09 How much does it cost? At the market in Ukraine**
  URL: https://www.ukrainianlessons.com/lesson/9/
  Relevance: 1.0
  Topics: ULP, Season 1


### Textbook References
- **Grade 5, Сторінка 241**
  238
ЗМІСТ
Дорогi п’ятикласники та п’ятикласницi! . . . . . . . . . . . . . . . 3
ВСТУП
Значення мови в житті людини та суспільства. Українська мова – державна мова України  . . . . . . . . . . . . . ....

- **Grade 11, Сторінка 269**
  269
ЗМІСТ
...
Моя батьківщина там, де моя б(и/і)бл(и/і...

- **Grade 5, Сторінка 253**
  253
ЗМІСТ
Дорогі п’ятикласниці та п’ятикласники! ..................................... 3
ВСТУП
§ 1. Мова в житті людини .......................................................... 5
РОЗДІЛ І. Лексиколо...
...
Write **At the Market** for the a1 track.
...
- `## Вступ та культура (Introduction & Culture)` (~275 words)
  - Культура українських ринків: Бессарабський ринок (Київ, 1912 р., стиль модерн, перші холодильники, репутація 'найдорожчого') та легендарний Привоз (Одеса, 1827 р., гумор, легенда про слона Мурзу).
  - Традиція «Спробуйте!»: культурна значущість дегустації товару (сир, мед, фрукти) перед покупкою як спосіб встановлення довіри між продавцем та покупцем.
- `## Презентація лексики та граматики (Vocabulary & Grammar Presentation)` (~375 words)
  - Одиниці виміру та споживчі товари згідно зі Стандартом §3.8: вивчення слів «кілограм», «грам», «штука», «пучок» у контексті овочів та фруктів.
  - Граматична конструкція «кілограм + родовий відмінок»: засвоєння сталих виразів «кілограм яблук», «кілограм картоплі» як цілісних лексичних блоків без заглиблення в теорію відмінків.
  - Ввічливі запити та ціна: використання «Дайте, будь ласка» та «Можна...» замість різкого «Я хочу»; питання «Скільки з мене?» як фінальний етап транзакції.
- `## Мовні помилки та практика (Learner Errors & Practice)` (~275 words)
  - Типова помилка: відмінювання після числівників 2-4 — вправа на корекцію форми «Два кілограм» на правильну «Два кілограми» (Nom.Pl) у порівнянні з «П'ять кілограмів» (Gen.Pl).
  - Лексичний нюанс «Решта» vs «Здача»: закріплення слова «решта» (23× частотніше за «здача» в ГРАК); відпрацювання фраз «без решти» та «візьміть решту». Слово «здача» подається як синонім.
  - Помилка вживання називного відмінка замість родового після міри ваги: дриль на заміну «Кілограм картопля» на «Кілограм картоплі».
- `## Діалоги та рольові ігри (Dialogues & Roleplay)` (~275 words)
  - Атмосфера одеського Привозу: рольова гра з елементами торгу («А дешевше можна?») та використанням колоритних фразеологізмів, як-от «тільки з грядки».
  - Сценарій купівлі на вагу та поштучно: інтеграція всіх вивчених одиниць виміру та ввічливих форм у реалістичний діалог на ринку.
...
| Section | Minimum |
|---------|---------|
| Вступ та культура (Introduction & Culture) | 275+ |
| Презентація лексики та граматики (Vocabulary & Grammar Presentation) | 375+ |
| Мовні помилки та практика (Learner Errors & Practice) | 275+ |
| Діалоги та рольові ігри (Dialogues & Roleplay) | 275+ |
...
### Workflow
1. **Research first**: `search_text("Genitive for quantities (кілограм + genitive) Accusative for requests", grade=3-5)` — find how textbooks teach this
