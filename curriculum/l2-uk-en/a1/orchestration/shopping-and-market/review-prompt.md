...
3. Verify with Grep: `Grep pattern="first 5-6 words" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/shopping-and-market.md"`
...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/shopping-and-market.md`
2. **Activities**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/activities/shopping-and-market.yaml`
3. **Vocabulary**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/vocabulary/shopping-and-market.yaml`
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/shopping-and-market.yaml`
5. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/shopping-and-market-research.md`
...
unverified_terms: []
review_focus:
  - "Please check the number-noun case agreement rules explained in the Кількість та одиниці section, particularly ensuring clarity for the 2-4 and 5+ Genitive rules with various unit genders."
rag_tools_used: []
```
...
Word count:       1845 / 1200 (153.8%)
Activities:       4
Vocabulary items: 20
Engagement boxes: 1
Immersion:        17.7% (target: 20-35%)
Richness:         72% (threshold: 60%)
...
1. Скільки коштує? (How much?)
2. У магазині (In the Store)
3. Кількість та одиниці (Quantities and Units)
4. Засоби гігієни (Hygiene Products)
5. Практика (Practice)
...
**Words checked:** 123 | **VESUM coverage:** 122/123 (99.2%)
