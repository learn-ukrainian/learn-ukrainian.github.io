...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/shopping-and-market-research.md` | Factual foundation — use exhaustively |
...
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/shopping-and-market.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Shopping and Market** (a1 track).
...
|---------|--------|---------------------|
| Скільки коштує? | 500 | 750 |
| У магазині | 400 | 600 |
| Кількість та одиниці | 400 | 600 |
| Засоби гігієни | 300 | 450 |
| Практика | 400 | 600 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/shopping-and-market.yaml`. Go through EVERY `points:` item in EVERY section:
