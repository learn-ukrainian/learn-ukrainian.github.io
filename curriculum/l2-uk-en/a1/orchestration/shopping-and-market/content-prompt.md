...
**Cumulative vocabulary (442 words):**
...
потім, післязавтра, вранці, вдень, ввечері, майбутнє, овочі, фрукти, паляниця, компот
картопля, помідор
...
Write **Shopping and Market** for the a1 track.
...
### Workflow
1. **Research first**: `search_text("Скільки коштує construction Genitive with quantities", grade=3-5)` — find how textbooks teach this
