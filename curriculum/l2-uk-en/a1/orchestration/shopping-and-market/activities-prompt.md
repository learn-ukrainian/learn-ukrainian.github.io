...
**Grade 3, ponomarova** — Сторінка 124:
```
124
6. Прочитай назви атракціонів у харківському парку.
… Харкові є мала копія Ейфелевої вежі. 
… неї відчуваєш атмосферу Франції, Парижа.
… гвинтових сходах вежі можна піднятися … 
оглядовий майданчик і помилуватися містом.
8. На яких атракціонах хотілося б побувати тобі? Чому?
Напиши про це текст (3–4 речення).
7. Кожний з друзів побував на двох атракціонах. Чита-
лочка витратила на них 70 грн, Щебетунчик — 90 грн, 
Родзинка — 80 грн, а Ґаджик — 100 грн. Поміркуй, 
хто які атракціони міг відві
```

**Grade 3, vashulenko** — Сторінка 138:
```
138
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/shopping-and-market.md` | Lesson content to test/reinforce |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/shopping-and-market.yaml` | vocabulary_hints |
