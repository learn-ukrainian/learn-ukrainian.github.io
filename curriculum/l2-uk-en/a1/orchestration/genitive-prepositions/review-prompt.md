...
3. Verify with Grep: `Grep pattern="first 5-6 words" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/genitive-prepositions.md"`
...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/genitive-prepositions.md`
2. **Activities**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/activities/genitive-prepositions.yaml`
3. **Vocabulary**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/vocabulary/genitive-prepositions.yaml`
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/genitive-prepositions.yaml`
5. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/genitive-prepositions-research.md`
...
unverified_terms: []
review_focus:
  - "Check euphony rule explanations for в/у"
  - "Verify consonant mutation tables for Locative case"
  - "Check distinction between в and на based on exceptions"
  - "Verify all activities use only A1 vocabulary and valid target forms"
rag_tools_used: []
```
...
Module persona:   Patient Supportive Tutor, acting as City Cartographer
Word count:       2030 / 1200 (169.2%)
Activities:       4
Vocabulary items: 20
Engagement boxes: 1
Immersion:        13.3% (target: 15-30%)
...
2. **[PLAN_SECTION_MISSING]** (severity: HIGH)
   Location: (plan vs content)
   Text: Missing 4 plan section(s): В/У + Місцевий (In + Locative), На + Місцевий (On + Locative), Біля/Поруч/Між (Near/Next to/B
...
3. **[ACTIVITY_VESUM_FAIL]** (severity: HIGH)
   Location: genitive-prepositions.yaml
   Text: Activity answers contain VESUM-failed words: Львові, ногі, ноці
...
**Words checked:** 106 | **VESUM coverage:** 97/106 (91.5%)

**❌ Not found in VESUM or textbooks (8):**
- `зв` (source: prose)
- `льв` (source: prose)
- `Львові` (source: prose)
- `ногі` (source: activities)
- `ноці` (source: activities)
- `св` (source: prose)
