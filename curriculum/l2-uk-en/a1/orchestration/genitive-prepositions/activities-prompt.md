...
**Grade 3, ponomarova** — Сторінка 73:
```
73
3. Допоможи Родзинці вибрати в колонках перевірні слова 
до виділених. Запиши їх парами.
4. Допоможи Щебетунчикові вставити орфограми. Спиши 
вірш. 
честь 
...
верхній 
Як я малим збирався нав..сні
піти у світ незнаними ст..жками, —    
сорочку мати виш..ла мені
червоними і чорними н..ткàми.
                             За Андрієм Малишком
5. Прочитай текст. Поясни Ґаджикові, чим знаменний для 
українців день 24 серпня. Випиши в колонку виділ
```

**Grade 3, ponomarova** — Сторінка 57:
```
57
5. Разом із сусідом/сусідкою по парті виконайте завдання 
Щебетунчика.
1. Знайдіть на карті України місто Кам’янець-
Подільський. 
2. Визначте, у якій області воно розташоване. 
3. На честь кого названий обласний центр?
6. Прочитай повідомлення Читалочки. Випиши виділені
слова. Утвори від них спільнокореневі за допомогою
префіксів  і  запиши.  Познач  префікси.
7. Спиши текст, замінивши виділені слова синонімами
з довідки. Познач префікси у вставлених словах.
Настав зимîвий ранок. На чистому 
```

**Grade 3, vashulenko** — Сторінка 68:
```
68
...
**Grade 3, vashulenko** — Сторінка 22:
```
22
Основна частина  
(опис окремих 
...
**Grade 3, kravtsova** — Сторінка 17:
```
17
44.
1.	 Прочитай і спиши текст.
Ростуть над ставком дві берези. 
Стрункі, високі, білокорі. Опустили деревця 
зелені коси. Віє вітер, розчісує їх. Тихо шеле-
стять листям берізки. То вони про щось 
розмовляють.
За Василем Сухомлинським 
2.	 Підкресли слова, ужиті в переносному значенні. 
1.	 Знайди та прочитай слова.
45.	
а
б
в
...
м
в
Код 1. 2а, 1а, 1б, 2б, 2г, 1в, 1б, 1г.
Код 2. 2а, 1а, 1б, 3в, 3г, 1в, 1б, 1г.
Код 3. 3а, 3б, 2в, 1а, 3б, 2г, 1б, 2ґ,
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/genitive-prepositions.md` | Lesson content to test/reinforce |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/genitive-prepositions.yaml` | vocabulary_hints |
