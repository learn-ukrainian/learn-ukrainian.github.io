        # Fix ALL 3 issue(s) in `genitive-prepositions`
...
**What:** Agreement mismatch: 'живе' (n) + 'Брат' (m)
**How to fix:** Change 'живе' to match the gender/case of 'Брат', or vice versa.
**Where:** ~line 24

### Fix 2: AGREEMENT_ERROR
**What:** Agreement mismatch: 'Золоті' (p) + 'Майдан' (m)
**How to fix:** Change 'Золоті' to match the gender/case of 'Майдан', or vice versa.
**Where:** ~line 120
