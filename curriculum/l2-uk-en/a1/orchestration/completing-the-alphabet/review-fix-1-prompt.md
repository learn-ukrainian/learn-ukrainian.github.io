...
- type: fill-in
  ...
  items:
    ...
    - sentence: "_____ за допомогу!"
      answer: "Дякую"
      options: ["Дякую", "Добрий", "Давай", "Добре"]
      explanation: "Дякую! means Thank you! — one of the most essential survival phrases."
    - sentence: "_____, де метро?"
      answer: "Будь ласка"
      options: ["Будь ласка", "Будь здоров", "Добрий день", "Як справи"]
      explanation: "Будь ласка! means Please! — used when making polite requests."
