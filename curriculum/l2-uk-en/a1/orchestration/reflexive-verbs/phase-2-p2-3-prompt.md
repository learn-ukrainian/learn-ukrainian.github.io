...
> **Your #1 job: Write 308 words for the section "Практика: Відмінювання та вправи".**
...
| File | Purpose |
|------|---------|
| `curriculum/l2-uk-en/a1/research/reflexive-verbs-research.md` | Factual foundation — use exhaustively |
| `curriculum/l2-uk-en/a1/meta/reflexive-verbs.yaml` | Content outline with section word allocations |
| `curriculum/l2-uk-en/plans/a1/reflexive-verbs.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the section prose for **Практика: Відмінювання та вправи** within the module **Reflexive Verbs (-ся)**.

- **WORD BUDGET**: 308 words minimum, 308 × 2 maximum. Stay in this range.
...
### Topics Covered:\n- The -ся/-сь Rule: Consonant vs. Vowel\n- Conjugation Table: Вмиватися\n- Type 1: True Reflexive\n- Type 2: Reciprocal Action\n- Type 3: Lexicalized (Always Reflexive)\n\n### Last Paragraphs:\nSome verbs are born reflexive. They do not have a non-reflexive partner, or the meaning is very different. For example, **сміятися** (to laugh) or **подобатися** (to please/like). You cannot "laugh someone else." These verbs describe a state of mind or feeling that is internal.\n\n*   **Мені подобається кава.** — I like coffee (Literally: Coffee pleases me).\n*   **Ми сміємося.** — We are laughing.
...
Previously used callout types in this module: fact, note, tip
...
- Target: 308 words. Ceiling: 2× that number.
...
## Практика: Відмінювання та вправи
...
```
===WORD_COUNTS===
Section "Практика: Відмінювання та вправи": {count} words (budget: 308-308×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Практика: Відмінювання та вправи)
