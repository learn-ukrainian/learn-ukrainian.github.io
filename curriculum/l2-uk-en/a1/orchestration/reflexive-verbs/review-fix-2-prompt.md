...
- type: fill-in
  ...
  items:
    ...
    - sentence: "Він голить___."
      answer: "ся"
      options: ["ся", "сь", "се", "си"]
      explanation: "Голить ends in a soft consonant, so we use -ся."
    - sentence: "Я смію___."
      answer: "сь"
      options: ["ся", "сь", "се", "си"]
      explanation: "Смію ends in the vowel ю, so we use -сь."
    - sentence: "Вони вмивають___."
      answer: "ся"
      options: ["ся", "сь", "се", "си"]
      explanation: "Вмивають ends in the consonant т, so we use -ся."
    - sentence: "Ми займаємо___."
      answer: "сь"
      options: ["ся", "сь", "се", "си"]
      explanation: "Займаємо ends in the vowel о, so we use -сь."
    - sentence: "Він зупиняєть___."
      answer: "ся"
      options: ["ся", "сь", "се", "си"]
      explanation: "Зупиняєть ends in a soft consonant, so we use -ся."
    - sentence: "Я повертаю___."
      answer: "сь"
      options: ["ся", "сь", "се", "си"]
      explanation: "Повертаю ends in the vowel ю, so we use -сь."
    - sentence: "Вони одягають___."
      answer: "ся"
      options: ["ся", "сь", "се", "си"]
      explanation: "Одягають ends in the consonant т, so we use -ся."
    - sentence: "Ви вмиваєте___."
      answer: "сь"
      options: ["ся", "сь", "се", "си"]
      explanation: "Вмиваєте ends in the vowel е, so we use -сь."
    - sentence: "Ти голиш___."
      answer: "ся"
      options: ["ся", "сь", "се", "си"]
      explanation: "Голиш ends in the consonant ш, so we use -ся."
    - sentence: "Вони повертають___."
      answer: "ся"
      options: ["ся", "сь", "се", "си"]
      explanation: "Повертають ends in the consonant т, so we use -ся."
...
- type: fill-in
  ...
  items:
    ...
    - sentence: "Він ___ спортом щодня."
      answer: "займається"
      options: ["займаюся", "займається", "займаємося", "займаються"]
      explanation: "The subject is він (he), third person singular: займається."
    - sentence: "Вона ___ вранці холодною водою."
      answer: "вмивається"
      options: ["вмиваюся", "вмивається", "вмиваємося", "вмиваються"]
      explanation: "The subject is вона (she), third person singular: вмивається."
    - sentence: "Я ___ додому о шостій."
      answer: "повертаюся"
      options: ["повертаюся", "повертаєшся", "повертається", "повертаються"]
      explanation: "The subject is я (I), first person singular: повертаюся."
    - sentence: "Ви ___ йогою?"
      answer: "займаєтеся"
      options: ["займаюся", "займаєшся", "займаєтеся", "займаються"]
      explanation: "The subject is ви (you, plural/formal), second person plural: займаєтеся."
    - sentence: "Вони ___ голосно."
      answer: "сміються"
      options: ["сміюся", "сміється", "сміємося", "сміються"]
      explanation: "The subject is вони (they), third person plural: сміються."
    - sentence: "Він ___ вранці."
      answer: "голиться"
      options: ["голюся", "голишся", "голиться", "голяться"]
      explanation: "The subject is він (he), third person singular: голиться."
    - sentence: "Ти ___ музикою?"
      answer: "цікавишся"
      options: ["цікавлюся", "цікавишся", "цікавиться", "цікавляться"]
      explanation: "The subject is ти (you), second person singular: цікавишся."
    - sentence: "Автобус ___ тут."
      answer: "зупиняється"
      options: ["зупиняюся", "зупиняєшся", "зупиняється", "зупиняються"]
      explanation: "The subject is автобус (bus), third person singular: зупиняється."
    - sentence: "Ми ___ кожного ранку."
      answer: "розминаємося"
      options: ["розминаюся", "розминаєшся", "розминаємося", "розминаються"]
      explanation: "The subject is ми (we), first person plural: розминаємося."
```
...
items:
  ...
  - lemma: "розминатися"
    ...
    pos: "verb"
    aspect: "imperfective"
    usage: "Спочатку ми розминаємося."
    notes: "Reflexive verb used in exercise/yoga context."
  - lemma: "розслаблятися"
    translation: "to relax"
    pos: "verb"
    aspect: "imperfective"
    usage: "Після йоги ми розслаблюємося."
    notes: "Reflexive verb. The action of relaxing is directed at oneself."
```
