...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/reflexive-verbs.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/reflexive-verbs-research.md`
...
Word count:       2477 / 2000 (123.8%)
Activities:       10
Vocabulary items: 23
Engagement boxes: 5
Immersion:        22.6% (target: 15-35%)
Richness:         82% (threshold: 95%)
Richness gaps:    cultural: 0/3, dialogues: 2/4
Audit status:     PASS
```
...
1. Розминка: Що таке зворотні дієслова?
2. Теорія: Відмінювання та групи
3. Практика: Дія на себе чи на іншого?
4. Культура: Секрети вимови
...
1. **[RUSSIANISM]** (severity: WARNING)
   Text: Found 1 Russicism(s) in content: 'надіятися' → сподіватися
