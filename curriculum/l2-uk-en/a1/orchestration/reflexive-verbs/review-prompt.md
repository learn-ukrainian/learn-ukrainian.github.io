...
3. Verify with Grep: `Grep pattern="first 5-6 words" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/reflexive-verbs.md"`
...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/reflexive-verbs.md`
2. **Activities**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/activities/reflexive-verbs.yaml`
3. **Vocabulary**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/vocabulary/reflexive-verbs.yaml`
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/reflexive-verbs.yaml`
5. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/reflexive-verbs-research.md`
...
unverified_terms: []
review_focus:
  - "Check the explicit use of the bracketed transcription [ц':а] as mandated by the Outline, which overrides the general ban on bracketed pronunciation guides."
rag_tools_used: []
```
...
Word count:       1944 / 1200 (162.0%)
Activities:       4
Vocabulary items: 20
Engagement boxes: 1
Immersion:        12.3% (target: 15-25%)
...
1. Вступ: Дзеркало дії (Introduction: Mirroring Action)
2. Презентація: Форми та відмінювання (Presentation: Forms and Conjugation)
3. Семантичні групи (Semantic Groups)
4. Практика та застосування (Practice and Application)
...
1. **[ACTIVITY_VESUM_FAIL]** (severity: HIGH)
   Location: reflexive-verbs.yaml
   Text: Activity answers contain VESUM-failed words: сь, шся
...
**Words checked:** 175 | **VESUM coverage:** 168/175 (96.0%)

**❌ Not found in VESUM or textbooks (7):**
- `сь` (source: prose)
- `ть` (source: activities)
- `ться` (source: prose)
- `Хрещатик` (source: prose)
- `ш` (source: prose)
- `шся` (source: activities)
- `ю` (source: prose)
