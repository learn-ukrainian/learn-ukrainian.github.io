...
> **Your #1 job: Write 300 words for the section "Культурний аспект та особливості вимови".**
...
Write the section prose for **Культурний аспект та особливості вимови** within the module **Reflexive Verbs (-ся)**.
...
### Topics Covered:\n- Drill: Transform the Self\n- Matching: Transitive vs. Reflexive\n- Suffix Challenge: Vowel or Consonant?\n- Dialogue Builder: Meeting New People\n- Common Mistakes: Don't Drop the Self!\n\n### Last Paragraphs:\nA very common mistake is to forget the **-ся** when changing the person. Remember, the suffix is loyal! It stays with the verb no matter who is doing the action. If you say **я мию** (I wash [something]), people will wait for you to say *what* you are washing. If you mean yourself, you must say **я миюся**.
...
Previously used callout types in this module: fact, note, tip, warning
...
```
===WORD_COUNTS===
Section "Культурний аспект та особливості вимови": {count} words (budget: 300-300×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Культурний аспект та особливості вимови)
