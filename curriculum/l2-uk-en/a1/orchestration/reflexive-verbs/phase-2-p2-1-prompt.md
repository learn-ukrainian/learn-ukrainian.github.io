...
> **Your #1 job: Write 308 words for the section "Розминка: Повернення дії на себе".**
...
Write the section prose for **Розминка: Повернення дії на себе** within the module **Reflexive Verbs (-ся)**.
...
```
===WORD_COUNTS===
Section "Розминка: Повернення дії на себе": {count} words (budget: 308-308×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Розминка: Повернення дії на себе)
