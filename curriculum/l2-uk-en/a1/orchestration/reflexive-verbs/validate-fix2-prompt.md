        # Fix ALL 7 issue(s) in `reflexive-verbs`
...
**What:** Accusative 'тарілку' (VESUM: noun:inanim:f:v_zna) in M17. Accusative not taught until M25.
**How to fix:** Replace 'тарілку' (accusative) with nominative form or use English equivalent.
**Where:** ~line 147

### Fix 2: MORPHOLOGICAL_VIOLATION
**What:** Accusative 'дитину' (VESUM: noun:anim:f:v_zna) in M17. Accusative not taught until M25.
**How to fix:** Replace 'дитину' (accusative) with nominative form or use English equivalent.
**Where:** ~line 153

### Fix 3: MORPHOLOGICAL_VIOLATION
**What:** Non-nominative 'школі' (dative, VESUM: noun:inanim:f:v_dav) in M17. Only nominative case allowed before M25.
**How to fix:** Replace 'школі' (dative) with its nominative form or use English equivalent.
**Where:** ~line 161

### Fix 4: MORPHOLOGICAL_VIOLATION
**What:** Non-nominative 'спортом' (instrumental, VESUM: noun:inanim:m:v_oru) in M17. Only nominative case allowed before M25.
**How to fix:** Replace 'спортом' (instrumental) with its nominative form or use English equivalent.
**Where:** ~line 163

### Fix 5: MORPHOLOGICAL_VIOLATION
**What:** Non-nominative 'гітарі' (dative, VESUM: noun:inanim:f:v_dav) in M17. Only nominative case allowed before M25.
**How to fix:** Replace 'гітарі' (dative) with its nominative form or use English equivalent.
**Where:** ~line 174

### Fix 6: MORPHOLOGICAL_VIOLATION
**What:** Non-nominative 'мене' (genitive, VESUM: noun:anim:s:v_rod:pron:pers:1) in M17. Only nominative case allowed before M25.
