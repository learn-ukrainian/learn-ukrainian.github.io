...
1. **Content** (the lesson you're reviewing): `curriculum/l2-uk-en/a1/reflexive-verbs.md`
2. **Activities**: `curriculum/l2-uk-en/a1/activities/reflexive-verbs.yaml`
3. **Vocabulary**: `curriculum/l2-uk-en/a1/vocabulary/reflexive-verbs.yaml`
4. **Plan** (source of truth for scope): `curriculum/l2-uk-en/plans/a1/reflexive-verbs.yaml`
5. **Meta** (build config): `curriculum/l2-uk-en/a1/meta/reflexive-verbs.yaml`
6. **Research notes** (if exists): `curriculum/l2-uk-en/a1/research/reflexive-verbs-research.md`
...
```
Word count:       {AUDIT_WORD_COUNT} / 830 ({WORD_PERCENT}%)
...
At module 9, students know ONLY modules 1-{PREV_MODULE}. Any grammar from later modules is scope creep.
