...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/reflexive-verbs-research.md` | Factual foundation — use exhaustively |
...
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/reflexive-verbs.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Reflexive Verbs (-ся)** (a1 track).
...
|---------|--------|---------------------|
| Вступ: Дзеркало дії | 400 | 600 |
| Презентація: Форми та відмінювання | 600 | 900 |
| Семантичні групи | 500 | 750 |
| Практика та застосування | 500 | 750 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/reflexive-verbs.yaml`. Go through EVERY `points:` item in EVERY section:
