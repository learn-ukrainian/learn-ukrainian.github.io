...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/reflexive-verbs-research.md` | Research notes |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/reflexive-verbs.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/reflexive-verbs.yaml` | Objectives, vocabulary_hints |
...
**Grade 1, zaharijchuk** — Сторінка 27:
```
25
Слова — назви дій
Що робить?
...
**Grade 1, zaharijchuk** — Сторінка 15:
```
13
...
**Grade 1, zaharijchuk** — Сторінка 56:
```
54
Бачу Н, н (ен).  Чую [н], [н' ].
н а * * и * и
...
**Grade 1, zaharijchuk** — Сторінка 60:
```
58
Бачу В, в (ве).  Чую [в].
в і н о *
...
Write the lesson prose for **Reflexive Verbs (-ся)** (a1 track).
...
- **Structure**: Follow the content_outline from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/reflexive-verbs.yaml` — each section maps to an H2. **Write ALL sections. Do not skip any section, even short ones like Summary.** Missing sections fail validation.
...
| Section | Target |
|---------|--------|
| Вступ: Що таке дієслова на -ся? (Introduction: What are Reflexive Verbs?) | 250 |
| Відмінювання: Теперішній час (Conjugation: Present Tense) | 350 |
| Семантичні групи та щоденна рутина (Semantic Groups and Daily Routine) | 350 |
| Підсумок і перевірка (Summary and Self-Check) | 250 |
| **Total** | **1200** |
