...
> **Your #1 job: Write 330 words for the section "Презентація: Правила вживання та відмінювання".**
...
Write the section prose for **Презентація: Правила вживання та відмінювання** within the module **Reflexive Verbs (-ся)**.
...
Previously used callout types in this module: fact
...
```
===WORD_COUNTS===
Section "Презентація: Правила вживання та відмінювання": {count} words (budget: 330-330×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Презентація: Правила вживання та відмінювання)
