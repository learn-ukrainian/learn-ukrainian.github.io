I will first verify the existence of the module files on disk to ensure I am reviewing the correct artifacts, and then I will perform the deep review as requested.

I will search for any files containing "36" in the curriculum directory to confirm if the module files exist on disk under a different naming convention.

I will read the content, plan, vocabulary, activities, metadata, and research files from the disk to ensure I am reviewing the most up-to-date versions of the module.
