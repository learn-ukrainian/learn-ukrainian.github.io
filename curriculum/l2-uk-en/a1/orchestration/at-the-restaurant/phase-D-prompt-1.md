...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/at-the-restaurant.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/at-the-restaurant-research.md`
...
Word count:       2863 / 2000 (143.2%)
Activities:       10
Vocabulary items: 20
Engagement boxes: 6
Immersion:        35.5% (target: 35-55%)
Richness:         80% (threshold: 95%)
...
1. Розминка: Структура меню та етикет
2. Презентація: Як зробити замовлення
3. Практика: Діалоги у ресторані
4. Культурний контекст: Українська гостинність
