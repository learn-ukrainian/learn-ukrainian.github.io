...
|---------|--------|---------------------|
| Розминка: Структура меню та етикет | 400 | 600 |
| Презентація: Як зробити замовлення | 800 | 1200 |
| Практика: Діалоги у ресторані | 500 | 750 |
| Культурний контекст: Українська гостинність | 300 | 450 |
| **Total** | **2000** | **3000** |
