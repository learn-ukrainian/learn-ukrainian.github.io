...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/at-the-restaurant-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/at-the-restaurant.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/at-the-restaurant.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **At the Restaurant** (a1 track).
...
|---------|--------|---------------------|
| Вступ та культурний контекст | 450 | 675 |
| Презентація: Мова замовлення | 650 | 975 |
| Практика: Типові ситуації | 500 | 750 |
| Підсумок та етикет | 400 | 600 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/at-the-restaurant.yaml`. Go through EVERY `points:` item in EVERY section:
