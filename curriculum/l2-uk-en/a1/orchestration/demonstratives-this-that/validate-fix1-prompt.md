        # Fix ALL 15 issue(s) in `demonstratives-this-that`
        ...
        **After you finish, count your fixes. If the count is less than 15, go back and fix the ones you missed.**
        ...
        ### Fix 1: IPA_BANNED
**What:** Banned IPA transcription: [neuter noun]
**How to fix:** Remove phonetic brackets. Use only stress marks (´) for pronunciation.
**Where:** ~line 24

### Fix 2: IPA_BANNED
**What:** Banned IPA transcription: [thing]
**How to fix:** Remove phonetic brackets. Use only stress marks (´) for pronunciation.
**Where:** ~line 32

### Fix 3: MORPHOLOGICAL_VIOLATION
**What:** Non-nominative 'УКРАЇНСЬКОЮ' (instrumental, VESUM: noun:inanim:f:v_oru) in M21. Only nominative case allowed before M25.
...
**What:** Non-nominative 'мені́' (dative, VESUM: noun:anim:s:v_dav:pron:pers:1) in M21. Only nominative case allowed before M25.
...
**What:** Agreement mismatch: 'УКРАЇНСЬКОЮ' (f) + 'ЗАЙМЕННИКИ' (p)
**How to fix:** Change 'УКРАЇНСЬКОЮ' to match the gender/case of 'ЗАЙМЕННИКИ', or vice versa.
**Where:** ~line 40

### Fix 10: AGREEMENT_ERROR
**What:** Agreement mismatch: 'УКРАЇНСЬКОЮ' (f) + 'УРОК' (m/p)
**How to fix:** Change 'УКРАЇНСЬКОЮ' to match the gender/case of 'УРОК', or vice versa.
**Where:** ~line 40

### Fix 11: AGREEMENT_ERROR
**What:** Agreement mismatch: 'УКРАЇНСЬКОЮ' (f) + 'ПОЯСНЕННЯ' (n/p)
**How to fix:** Change 'УКРАЇНСЬКОЮ' to match the gender/case of 'ПОЯСНЕННЯ', or vice versa.
**Where:** ~line 65

### Fix 12: STRESS_MISMATCH
**What:** Wrong stress: 'ді́вчина' → should be 'ді́вчи́на'
**How to fix:** Replace 'ді́вчина' with 'ді́вчи́на'.
**Where:** ~line 17
...
**What:** Stressed word not in dictionary: сама́ (сама)
**How to fix:** Verify stress manually — word not found in ukrainian-word-stress dictionary.
**Where:** ~line 114
