        # Fix ALL 5 issue(s) in `demonstratives-this-that`
...
**What:** Non-nominative 'кімнаті' (dative, VESUM: noun:inanim:f:v_dav) in M21. Only nominative case allowed before M25.
**How to fix:** Replace 'кімнаті' (dative) with its nominative form or use English equivalent.
**Where:** ~line 156

### Fix 2: MORPHOLOGICAL_VIOLATION
**What:** Accusative 'цю' (VESUM: adj:f:v_zna:pron:dem) in M21. Accusative not taught until M25.
**How to fix:** Replace 'цю' (accusative) with nominative form or use English equivalent.
**Where:** ~line 161

### Fix 3: MORPHOLOGICAL_VIOLATION
**What:** Accusative 'кімнату' (VESUM: noun:inanim:f:v_zna) in M21. Accusative not taught until M25.
**How to fix:** Replace 'кімнату' (accusative) with nominative form or use English equivalent.
**Where:** ~line 161

### Fix 4: MORPHOLOGICAL_VIOLATION
**What:** Non-present verb 'говорили' (past tense, VESUM: verb:imperf:past:p) in M21. Only present tense available before M36.
**How to fix:** Replace 'говорили' with present tense form or English.
**Where:** ~line 170
