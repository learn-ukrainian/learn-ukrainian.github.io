...
⚠️  [PHANTOM_SECTION_REFERENCE] Review references 3 section(s) not found in content: "Цей/ця/це: Вказуємо на близькі об'єкти", "Ці: Вказуємо на багато об'єктів", "Той/та/те/ті: Вказуємо на далекі об'єкти". Verify section names match actual content headers.
...
*   _____ **хло́пець** (masculine)
*   _____ **ву́лиця** (feminine)
*   _____ **о́зеро** (neuter)
*   _____ **книжки́** (plural)
...
- type: fill-in
  ...
  instruction: Fill in the blank with the correct form of 'this' or 'that' based on
...
- type: quiz
  ...
  instruction: Choose the correct answer for each question about Ukrainian demonstrative
    pronouns.
  items:
  - question: Which demonstrative pronoun do you use with a masculine noun to say
      'this'?
    options:
    - text: цей
      correct: true
  ...
  - question: How do you say 'those people' in Ukrainian?
    ...
    - text: ті люди
      correct: true
    explanation: Люди is plural, so we use ті (those) — gender does not matter in
      plural.
  - question: What is special about the word ці?
    ...
    - text: It is used only for masculine nouns
      correct: false
    explanation: Ці is the universal plural form — цей, ця, and це all become ці in
      the plural.
  - question: Which sentence uses це as a linking word meaning 'This is...'?
    ...
    - text: Це село — гарне.
      correct: false
    explanation: '''Це стілець'' means ''This is a chair'' — це acts as a linking
      word, not a gender-matching pronoun. Стілець is masculine, but це does not change.'
  - question: Why is 'цей книжки' incorrect?
    ...
    - text: Цей is not a real Ukrainian word
      correct: false
    explanation: Книжки is the plural form of книжка. All plural nouns use ці, regardless
      of gender.
  ...
  - question: In the sentence 'Та дівчина та її подруга', what does the first та mean?
    ...
    - text: those
      correct: false
    explanation: The first та is a demonstrative pronoun meaning 'that girl'. The
      second та is the conjunction 'and'.
  ...
  - question: You are in a cafe and want to point at a cake right in front of you.
      What do you say?
    options:
    ...
    - text: Ця торт, будь ласка.
      correct: false
    explanation: The cake is close to you, so use цей (this). Торт is masculine —
      цей торт.
...
- type: group-sort
  ...
  instruction: Sort these nouns into the correct demonstrative group. Which pronoun
    — цей, ця, це, or ці — goes with each noun?
  groups:
  - name: цей (masculine)
    items:
    - будинок
  ...
  - name: ці (plural)
    ...
    - люди
- type: classify
  title: це as Linking Word or Demonstrative?
  instruction: 'Classify each sentence: does це act as a linking word (''This is...'')
    or as a demonstrative pronoun (''this specific neuter noun'')?'
  categories:
  - items:
    - Це стілець.
    - Це кафе.
    - Це місто.
    label: Linking word (This is...)
  - items:
    - Це місто — старе.
    - Це озеро — велике.
    - Це кафе — гарне.
    label: Demonstrative (this + neuter noun)
