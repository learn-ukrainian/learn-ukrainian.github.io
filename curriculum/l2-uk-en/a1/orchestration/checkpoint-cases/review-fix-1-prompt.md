...
❌ [INLINE_ENGLISH_IN_PROSE] Inline English translations in B1+ prose (3 occurrences): (No preposition), (After preposition), (After preposition) — breaks immersion target
--- STRICT GATES (Level A1) ---
Pedagogy     ❌ 1 violations
Immersion    🇺🇦 11.4% (checkpoint - no gate)
...
Here is a handy reference table for the adjective **нови́й** (new) across cases and genders:

| | Masculine | Feminine | Neuter |
|------------|-----------|----------|--------|
| **Nominative** | нови́й | нова́ | нове́ |
| **Accusative** | нови́й (inan) | нову́ | нове́ |
| **Locative** | ново́му | нові́й | ново́му |
...
1. Яки́й відмі́нок ми використо́вуємо для напря́мку? (Which case do we use for direction?) — Accusative case (Знахі́дний відмі́нок).
2. Яки́й відмі́нок ми використо́вуємо пі́сля сло́ва «нема́є»? (Which case do we use after the word "немає"?) — Genitive case (Родови́й відмі́нок).
