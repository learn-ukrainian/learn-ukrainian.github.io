...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/checkpoint-cases-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/checkpoint-cases.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/checkpoint-cases.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Checkpoint: Cases** (a1 track).
...
|---------|--------|---------------------|
| Огляд (Overview) | 300 | 450 |
| Навичка 1: Відмінки (Skill 1: Cases) | 500 | 750 |
| Навичка 2: Прийменники (Skill 2: Prepositions) | 400 | 600 |
| Навичка 3: Узгодження (Skill 3: Agreement) | 400 | 600 |
| Інтеграційне завдання (Integration Task) | 400 | 600 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/checkpoint-cases.yaml`. Go through EVERY `points:` item in EVERY section:
