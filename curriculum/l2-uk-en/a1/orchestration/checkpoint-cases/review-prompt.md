...
3. Verify with Grep: `Grep pattern="first 5-6 words" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/checkpoint-cases.md"`
...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/checkpoint-cases.md`
2. **Activities**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/activities/checkpoint-cases.yaml`
3. **Vocabulary**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/vocabulary/checkpoint-cases.yaml`
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/checkpoint-cases.yaml`
5. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/checkpoint-cases-research.md`
6. **Builder notes** (from content builder):

(No builder notes from content phase)
...
Word count:       1802 / 1200 (150.2%)
Activities:       6
Vocabulary items: 20
Engagement boxes: 3
Immersion:        11.5% (target: 15-30%)
Richness:         89% (threshold: 85%)
Richness gaps:    engagement: 2/3, activity_types: 6/8
Audit status:     FAIL
```
...
1. Огляд (Overview)
2. Навичка 1: Відмінки (Skill 1: Cases)
3. Навичка 2: Прийменники (Skill 2: Prepositions)
4. Навичка 3: Узгодження (Skill 3: Agreement)
...
1. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 80
   Text: Agreement mismatch: 'нови́й' (m) + 'нову́' (f)
   Fix: Change 'нови́й' to match the gender/case of 'нову́', or vice versa.
2. **[STRESS_UNKNOWN]** (severity: INFO)
   Location: ~line 24
   Text: Stressed word not in dictionary: Кого́ (кого)
...
6. **[STRESS_MISMATCH]** (severity: HIGH)
   Location: ~line 112
   Text: Wrong stress: 'Виба́чте' → should be 'ви́бачте'
   Fix: Replace 'Виба́чте' with 'ви́бачте'.
7. **[STRESS_UNKNOWN]** (severity: INFO)
   Location: ~line 118
   Text: Stressed word not in dictionary: мого́ (мого)
   Fix: Verify stress manually — word not found in ukrainian-word-stress dictionary.
8. **[STRESS_MISMATCH]** (severity: HIGH)
   Location: ~line 135
   Text: Wrong stress: 'використову́ємо' → should be 'використо́вуємо'
   Fix: Replace 'використову́ємо' with 'використо́вуємо'.
9. **[STRESS_MISMATCH]** (severity: HIGH)
   Location: ~line 135
   Text: Wrong stress: 'напря́мку' → should be 'на́прямку'
   Fix: Replace 'напря́мку' with 'на́прямку'.
10. **[STRESS_MISMATCH]** (severity: HIGH)
   Location: ~line 136
   Text: Wrong stress: 'сло́ва' → should be 'слова́'
   Fix: Replace 'сло́ва' with 'слова́'.
11. **[STRESS_MISMATCH]** (severity: HIGH)
   Location: ~line 136
   Text: Wrong stress: 'Родови́й' → should be 'родо́ви́й'
   Fix: Replace 'Родови́й' with 'родо́ви́й'.
...
**Words checked:** 132 | **VESUM coverage:** 130/132 (98.5%)
