...
|------|----------------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/prohibitions-and-signs-research.md` | Background knowledge, engagement hooks |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/prohibitions-and-signs.yaml` | Objectives, vocabulary_hints (source of truth) |
...
| Tool | When | Example |
|------|------|---------|
| `search_text` | Find textbook pedagogy | `search_text("Infinitive in prohibitions Sign language conventions", grade=3-5)` |
...
**Modules completed before this one:** 54
**Previous module:** Checkpoint: Communication

**Cumulative vocabulary (570 words):**
...
подарунок, дарувати, отримувати, торт, свічка, Кутя, страва, взаємно, малювати, танцювати
плавати, стадіон, басейн, захоплюватися, велосипед, спортзал, вихідні, співати, готувати, фотографувати
футбол, бігати, гуляти, тролейбус, трамвай, таксі, потяг, літак, маршрутка, аеропорт
зупинка, валіза, прямо, направо, наліво, подорож, замовити, перше, друге, третє
столик, будьмо, гарнір, без м'яса, без глютену, піца, десерт, повинен, запрошувати, поїзд

**Grammar already taught (176 topics):**
...
**Coming next (module after this):** Direction with до + genitive, Time expressions for schedules, Numbers for platforms and seats
...
### Videos
- **День гамбургера. Складаємо сенкан.** (Bright Kids Ukrainian)
  URL: https://www.youtube.com/watch?v=iwp6JYZaoa4
  Score: 0.8 -- The video demonstrates the use of key vocabulary words 'увага' (attention/warning) and 'не можна' (it is not allowed/forbidden) in a natural context, directly relating to the module's theme of prohibitions and signs.
  Suggested placement: After section: Заборони (Prohibitions) - The phrase 'не можна' directly translates to 'it is not allowed', fitting the topic of prohibitions.
  Key excerpt: Ану лисочку не можна кладемо нашу котлетку і вгорі скадаємо нашу частинку нашої булочки.
...
- **Grade 11, Сторінка 203**
  Особливої уваги вимагають правила вживання розділових зна-
ків між сурядними частинами, коли підрядна частина є спільною для обох 
сурядних. Сурядні й підрядні частини відокремлюються комами; у випадк...
...
Write **Prohibitions and Signs** for the a1 track.
...
- `## Заборони (Prohibitions)` (~275 words)
  - Infinitive prohibitions on signs: Не курити! (No smoking!). Не входити! (Do not enter!). Не торкатися! (Do not touch!). Public signs use infinitive, not imperative — this is a register distinction.
  - Common public signs: Вхід (Entrance), Вихід (Exit), Зачинено (Closed), Відчинено (Open). Everyday survival vocabulary for navigating Ukrainian public spaces.
  - Sign vs personal command contrast: Не торкатися! (sign — infinitive, impersonal) vs Не чіпай! (personal command — imperative). Same meaning, different grammatical form and social context.
- `## Попередження (Warnings)` (~250 words)
  - Warning exclamations: Увага! (Attention!). Обережно! (Careful!). Небезпечно! (Dangerous!). Short-form adjectives and adverbs used as standalone warnings.
  - Warning signs: Мокра підлога (Wet floor). Висока напруга (High voltage). Recognizing danger signs for personal safety. Reading compound noun phrases on signs.
  - Understanding urgency: Warning signs protect safety — these are high-priority vocabulary items. Learner should recognize them instantly without translation.
- `## Розклади та оголошення (Schedules and notices)` (~250 words)
  - Reading schedules: години роботи (operating hours), вихідний (day off), перерва (break). Format: з 9:00 до 18:00 (from 9:00 to 18:00). Genitive of time.
  - Bus/train schedule reading: відправлення (departure), прибуття (arrival), номер маршруту (route number). Connecting to a1-52 (Travel and Transport) vocabulary.
  - Notices and announcements: Оголошення (Announcement). Акція (Sale/Promotion). Знижка (Discount). Practical reading for everyday life.
- `## На вулиці (On the street)` (~250 words)
  - Street signs: вулиця (street), площа (square), провулок (lane). Reading address plates: вул. Хрещатик, пл. Незалежності. Abbreviations on signs.
  - Traffic and transport signs: Стоп (Stop), Пішохідний перехід (Pedestrian crossing). Metro signs: Вхід (Entrance), Вихід (Exit), Перехід (Transfer). Urban navigation.
- `## Практика (Practice)` (~175 words)
  - Sign reading drills: Identify the meaning and grammatical form (infinitive vs imperative vs noun phrase) of various Ukrainian signs.
  - Schedule comprehension: Read a schedule and answer questions about operating hours, days off, and departure times. Practical reading skill development.
...
| Section | Minimum |
|---------|---------|
| Заборони (Prohibitions) | 275+ |
| Попередження (Warnings) | 250+ |
| Розклади та оголошення (Schedules and notices) | 250+ |
| На вулиці (On the street) | 250+ |
...
### Workflow
1. **Research first**: `search_text("Infinitive in prohibitions Sign language conventions", grade=3-5)` — find how textbooks teach this
...
**Required types:** match-up, quiz, true-false, fill-in
