...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/prohibitions-and-signs-research.md` | Factual foundation — use exhaustively |
...
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/prohibitions-and-signs.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Prohibitions and Signs** (a1 track).
...
|---------|--------|---------------------|
| Заборони | 500 | 750 |
| Попередження | 400 | 600 |
| Розклади та оголошення | 400 | 600 |
| На вулиці | 400 | 600 |
| Практика | 300 | 450 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/prohibitions-and-signs.yaml`. Go through EVERY `points:` item in EVERY section:
