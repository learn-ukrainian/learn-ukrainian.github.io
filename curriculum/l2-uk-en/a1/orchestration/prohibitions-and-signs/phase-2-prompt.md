...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/prohibitions-and-signs-research.md` | Research notes |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/prohibitions-and-signs.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/prohibitions-and-signs.yaml` | Objectives, vocabulary_hints |
...
У словах — назвах намальованих предметів 
букви стоять не на своєму місці. Прочитай 
назви предметів.
Зій-ди,  зі-ронь-ко-зір-ни-це,
Зо-ло-та-ва  зо-ря-ни-це,
За-ві-тай  до  нас  в  до-ли-ну,
За-сі-яй  хоч  на  хви-ли-ну,
Бо  згу-би-лись  зай-че-нят-ка
І  не  мо-жуть  знай-ти  хат-ку.
                                                    Леся Вознюк
	 Знайди у вірші букву з.
рузб
зулізо
рнозе
	 Розглянь малюнки. Прочитай на­
зви предметів.  Чим цікаві ці слова?
Замок,   замок.
	 Прочитай ві
```

**Grade 1, bolshakova** — Сторінка 49:
```
49
Один — багато
...

Текст і малюнок
У валізу склали різні речі. Назви їх. Яку річ краще не 
зберігати у валізі? Чому? 
1
2
В в
	 ва	
...
**Grade 1, zaharijchuk** — Сторінка 97:
```
95
...
**Grade 1, zaharijchuk** — Сторінка 68:
```
66
дз
Бачу  Дз, дз (дз). 
...
**Grade 1, bolshakova** — Сторінка 61:
```
61
...
**Grade 1, bolshakova** — Сторінка 77:
```
77
Знайди слово — підпис до малюнка.
...

Досліджую медіа
Порівняй обкладинку книжки та афішу.
Прочитай рекламу вистави. Чи хочеш ти відвідати її? 
Чому? Розкажи про виставу друзям.
Подивіться історію про маленького равлика.
Равлик шукав зручний будинок.
Які тільки домівки він не побачив! І підземел-
ля крота, і гніздо сороки, і нірку мишки. Навіть 
собачу будку. А потім знайшов... Приходь на 
виставу  і дізн
```
...
Write the lesson prose for **Prohibitions and Signs** (a1 track).
...
- **Structure**: Follow the content_outline from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/prohibitions-and-signs.yaml` — each section maps to an H2. **Write ALL sections. Do not skip any section, even short ones like Summary.** Missing sections fail validation.
