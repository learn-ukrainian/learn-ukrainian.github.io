...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/the-cyrillic-code-iv-research.md` | Factual foundation — use exhaustively |
...
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/the-cyrillic-code-iv.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **The Cyrillic Code IV** (a1 track).
...
|---------|--------|---------------------|
| Вступ | 250 | 375 |
| Шиплячі та свистячі | 500 | 750 |
| Йотовані голосні | 500 | 750 |
| М'який знак та апостроф | 450 | 675 |
| Підсумок: Весь алфавіт | 300 | 450 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/the-cyrillic-code-iv.yaml`. Go through EVERY `points:` item in EVERY section:
