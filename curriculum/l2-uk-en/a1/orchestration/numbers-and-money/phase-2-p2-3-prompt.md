...
> **Your #1 job: Write 332 words for the section "Практика: Покупки та ціни".**
...
Write the section prose for **Практика: Покупки та ціни** within the module **Numbers & Money**.

- **WORD BUDGET**: 332 words minimum, 332 × 2 maximum. Stay in this range.
...
- Target: 332 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Практика: Покупки та ціни": {count} words (budget: 332-332×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Практика: Покупки та ціни)
