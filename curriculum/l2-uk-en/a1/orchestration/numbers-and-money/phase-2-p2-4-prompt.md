...
> **Your #1 job: Write 300 words for the section "Культурний огляд: Світ української гривні".**
...
Write the section prose for **Культурний огляд: Світ української гривні** within the module **Numbers & Money**.
...
Previously used callout types in this module: tip, warning, fact
...
```
===WORD_COUNTS===
Section "Культурний огляд: Світ української гривні": {count} words (budget: 300-300×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Культурний огляд: Світ української гривні)
