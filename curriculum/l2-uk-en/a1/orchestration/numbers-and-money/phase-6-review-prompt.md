...
1. **Content** (the lesson you're reviewing): `curriculum/l2-uk-en/a1/numbers-and-money.md`
2. **Activities**: `curriculum/l2-uk-en/a1/activities/numbers-and-money.yaml`
3. **Vocabulary**: `curriculum/l2-uk-en/a1/vocabulary/numbers-and-money.yaml`
4. **Plan** (source of truth for scope): `curriculum/l2-uk-en/plans/a1/numbers-and-money.yaml`
5. **Meta** (build config): `curriculum/l2-uk-en/a1/meta/numbers-and-money.yaml`
