...
> **Your #1 job: Write 675 words for the section "Презентація: Рахуємо до ста та правила узгодження".**
...
| File | Purpose |
|------|---------|
| `curriculum/l2-uk-en/a1/research/numbers-and-money-research.md` | Factual foundation — use exhaustively |
| `curriculum/l2-uk-en/a1/meta/numbers-and-money.yaml` | Content outline with section word allocations |
| `curriculum/l2-uk-en/plans/a1/numbers-and-money.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the section prose for **Презентація: Рахуємо до ста та правила узгодження** within the module **Numbers & Money**.

- **WORD BUDGET**: 675 words minimum, 675 × 2 maximum. Stay in this range.
...
TARGET: 25-40% Ukrainian, 60-75% English. Grammar RULES explained in English. But cultural notes, practical sections, and observations USE simple Ukrainian (2-3 sentence paragraphs, max 10 words per sentence) with English gloss in parentheses for new words. Provide 3-4 Ukrainian examples per grammar point (not just 1-2). Practice/drill instructions in Ukrainian. Some callout/tip text in Ukrainian. The student reads simple Ukrainian — use it for concrete, practical content while keeping abstract grammar explanations in English.
...
- Target: 675 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Презентація: Рахуємо до ста та правила узгодження": {count} words (budget: 675-675×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Презентація: Рахуємо до ста та правила узгодження)
