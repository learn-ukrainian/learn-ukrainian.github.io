...
> **Your #1 job: Write 330 words for the section "Розминка: Числа в повсякденному житті".**
...
Write the section prose for **Розминка: Числа в повсякденному житті** within the module **Numbers & Money**.

- **WORD BUDGET**: 330 words minimum, 330 × 2 maximum. Stay in this range.
...
Previously used callout types in this module: 
...
- Target: 330 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Розминка: Числа в повсякденному житті": {count} words (budget: 330-330×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Розминка: Числа в повсякденному житті)
