...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/numbers-and-money-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/numbers-and-money.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/numbers-and-money.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Numbers & Money** (a1 track).
...
|---------|--------|---------------------|
| Розминка: Числа в повсякденному житті | 250 | 375 |
| Числа від 0 до 20 | 350 | 525 |
| Десятки та сотня | 300 | 450 |
| Граматика: Правило 1-2-5 та валюта | 450 | 675 |
| В магазині: Як запитати ціну | 350 | 525 |
| Практика: Лічба та покупки | 300 | 450 |
| Культурний контекст: Історія гривні | 200 | 300 |
| **Total** | **2000** | **3000** |
