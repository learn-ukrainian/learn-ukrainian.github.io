...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/numbers-and-money.yaml`. Go through EVERY `points:` item in EVERY section:
