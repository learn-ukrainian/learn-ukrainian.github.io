...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/numbers-and-money-research.md` | Research notes |
...
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/numbers-and-money.yaml` | Objectives, vocabulary_hints |
...
**Grade 1, zaharijchuk** — Сторінка 94:
```
92
...
**Grade 1, zaharijchuk** — Сторінка 84:
```
82
Бачу  Р, р (ер). Чую [р], [р'].
р а в л и к
* у р * к
* и * р
	 Що на малюнку зображено не так? Розкажи.
 [ –•  – |  – • – ]
 [  –  • –   –  ]
а
о
...
Write the lesson prose for **Numbers & Money** (a1 track).
...
- **Structure**: Follow the content_outline from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/numbers-and-money.yaml` — each section maps to an H2. **Write ALL sections. Do not skip any section, even short ones like Summary.** Missing sections fail validation.
...
| Section | Target |
|---------|--------|
| Вступ: Навіщо потрібні числа та гроші? | 200 |
| Презентація: Від нуля до ста | 450 |
| Практика та Культура: Рахуємо гроші | 400 |
| Підсумок | 150 |
| **Total** | **1200** |
