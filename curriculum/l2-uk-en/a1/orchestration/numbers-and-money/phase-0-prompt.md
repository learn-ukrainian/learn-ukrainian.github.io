...
```
curriculum/l2-uk-en/plans/a1/numbers-and-money.yaml
```

Read the meta file:

```
curriculum/l2-uk-en/a1/meta/numbers-and-money.yaml
```
...
Research **Numbers & Money** for the **A1** core track. Core tracks need lighter research than seminar tracks — focus on accuracy and State Standard alignment.
