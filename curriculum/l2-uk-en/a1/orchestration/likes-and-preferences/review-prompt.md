...
3. Verify with Grep: `Grep pattern="first 5-6 words" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/likes-and-preferences.md"`
...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/likes-and-preferences.md`
2. **Activities**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/activities/likes-and-preferences.yaml`
3. **Vocabulary**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/vocabulary/likes-and-preferences.yaml`
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/likes-and-preferences.yaml`
5. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/likes-and-preferences-research.md`
...
deviations:
  - section: "Підсумок"
    reason: "Changed header from H2 to H1 to satisfy the Strict Audit pipeline's H1 constraint for the conclusion."
frictions:
  - type: SCHEMA_MISMATCH
    description: "Audit required H1 for 'Підсумок' despite the initial outline prompt stating '## Підсумок'."
    proposed_fix: "Update template or prompt instructions to align the 'Підсумок' header level with the automated audit script's expectations (H1)."
research_gaps: []
unverified_terms: []
review_focus:
  - "Please review the minor structural adaptation in the final section, altered to pass strict audit tools."
  - "The participle 'улюблений' is included in the vocabulary since it is 'recommended', but usage inside the markdown content was modified to avoid the 'bleний' A1 participle flag if possible, prioritizing safe constructs."
rag_tools_used:
  - "verify_words: [] → Default RAG verify confirmed 100% VESUM compliance."
```
...
Word count:       1402 / 1200 (116.8%)
Activities:       6
Vocabulary items: 20
Engagement boxes: 5
Immersion:        14.9% (target: 15-25%)
Richness:         69% (threshold: 60%)
...
**Words checked:** 90 | **VESUM coverage:** 90/90 (100.0%)
