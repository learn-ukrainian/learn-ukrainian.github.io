...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/prepositions-direction-origin-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/prepositions-direction-origin.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/prepositions-direction-origin.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Prepositions: Direction & Origin** (a1 track).
...
|---------|--------|---------------------|
| Розминка: Де, Куди, Звідки | 250 | 375 |
| Презентація: Три питання — три відмінки | 300 | 450 |
| Місце: Де? (Локатив) | 300 | 450 |
| Напрямок: Куди? (Знахідний) | 350 | 525 |
| Походження: Звідки? (Родовий) | 300 | 450 |
| Систематизація: Школа і Робота | 250 | 375 |
| Практика: Маршрут по місту | 250 | 375 |
| **Total** | **2000** | **3000** |
