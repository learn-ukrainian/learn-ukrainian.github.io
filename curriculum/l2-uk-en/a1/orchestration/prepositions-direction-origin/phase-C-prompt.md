...
| Module persona | Patient Supportive Tutor, acting as Set Designer |
...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/prepositions-direction-origin.md
```

**Plan file** (vocabulary_hints — vocabulary list to follow):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/prepositions-direction-origin.yaml
```

**Meta file** (activity count targets, pedagogy):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/prepositions-direction-origin.yaml
```
