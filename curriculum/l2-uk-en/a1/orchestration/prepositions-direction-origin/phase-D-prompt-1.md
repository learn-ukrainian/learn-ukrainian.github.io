...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/prepositions-direction-origin.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/prepositions-direction-origin-research.md`
...
Word count:       2215 / 2000 (110.8%)
Activities:       10
Vocabulary items: 20
Engagement boxes: 5
Immersion:        44.4% (target: 35-55%)
Richness:         98% (threshold: 95%)
Richness gaps:    none
Audit status:     PASS
```
...
1. Розминка: Де, Куди, Звідки
2. Презентація: Три питання — три відмінки
3. Місце: Де? (Локатив)
4. Напрямок: Куди? (Знахідний)
5. Походження: Звідки? (Родовий)
6. Систематизація: Школа і Робота
7. Практика: Маршрут по місту
