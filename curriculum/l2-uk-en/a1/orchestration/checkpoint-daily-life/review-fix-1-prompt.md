...
❌ [INLINE_ENGLISH_IN_PROSE] Inline English translations in B1+ prose (5 occurrences): (Masculine speaker), (Feminine speaker), (Neuter subject) — breaks immersion target
--- STRICT GATES (Level A1) ---
Immersion    🇺🇦 17.8% (checkpoint - no gate)
...
Let's test your shopping dialogue skills. You have learned the crucial question **Скі́льки кошту́є?** (How much does it cost?) and the verb **коштува́ти** (to cost). You also know quantity expressions and polite request patterns to use at the market or in a bakery.
