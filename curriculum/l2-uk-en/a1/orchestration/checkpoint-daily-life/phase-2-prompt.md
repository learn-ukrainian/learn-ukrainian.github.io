...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/checkpoint-daily-life-research.md` | Factual foundation — use exhaustively |
...
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/checkpoint-daily-life.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Checkpoint: Daily Life** (a1 track).
...
|---------|--------|---------------------|
| Огляд | 200 | 300 |
| Навичка 1: Часові форми | 600 | 900 |
| Навичка 2: Повсякденне життя | 400 | 600 |
| Навичка 3: Опис та погода | 400 | 600 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/checkpoint-daily-life.yaml`. Go through EVERY `points:` item in EVERY section:
