...
| Module persona | Patient Supportive Tutor, acting as Day Planner |
...
**Grade 3, vashulenko** — Сторінка 130:
```
130
 
 Прочитайте заголовок оповідання. Як ви думаєте, що 
означає це слово? Про що може йти мова в цьому 
творі?
ЛЬОДОХІД
...
кригу, плесо спучується, закипає бурунами, і могутній потік 
мчить, мов шалений, зносячи все, що трапиться на його путі.
Якось Костик і Ярик пішли подивитися н
```

**Grade 3, savchenko** — Сторінка 129:
```
129
Анатолій Качан
* * * 
...
де комиш,| верба,| вода|| —
там і рай на світі.
Прочитай вірш повільно, ніби уявляючи п
```

**Grade 3, vashulenko** — Сторінка 95:
```
95
...
**Grade 3, ponomarova** — Сторінка 78:
```
78
ÐÎÇÐ²ÇÍßÞ ²ÌÅÍÍÈÊÈ — 
ÐÎÇÐ²ÇÍßÞ ²ÌÅÍÍÈÊÈ — 
ÍÀÇÂÈ ²ÑÒÎÒ ² ÍÅ²ÑÒÎÒ
ÍÀÇÂÈ ²ÑÒÎÒ ² ÍÅ²ÑÒÎÒ
1. Запиши подані іменники у дві колонки.
2. Прочитай повідомлення Родзинки. Запитай у вчителя/
вчительки значення слів, які тобі не зрозумілі. Випиши 
в одну колонку чотири нàзви істот, а в другу — чотири
нàзви  неістот.
Школярі, олівець, артист, ведмідь, трава, теле-
фон, птахи, мікрофон.
ХТО?                                  ЩО?
Проведи дослідження!
1. Які іменники називають людей і тварин?
2. Які іменни
```
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/checkpoint-daily-life.md` | Checkpoint content to reinforce |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/checkpoint-daily-life.yaml` | vocabulary_hints (all REVIEW words) |
