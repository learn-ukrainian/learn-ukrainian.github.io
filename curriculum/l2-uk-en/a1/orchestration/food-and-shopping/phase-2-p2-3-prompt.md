...
> **Your #1 job: Write 300 words for the section "Практика: У магазині та культурні традиції".**
...
Write the section prose for **Практика: У магазині та культурні традиції** within the module **Food, Drinks & Shopping**.
...
```
===WORD_COUNTS===
Section "Практика: У магазині та культурні традиції": {count} words (budget: 300-300×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Практика: У магазині та культурні традиції)
