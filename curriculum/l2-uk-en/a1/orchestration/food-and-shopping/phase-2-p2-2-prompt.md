...
> **Your #1 job: Write 525 words for the section "Презентація: Продукти та покупки".**
...
Write the section prose for **Презентація: Продукти та покупки** within the module **Food, Drinks & Shopping**.
...
```
===WORD_COUNTS===
Section "Презентація: Продукти та покупки": {count} words (budget: 525-525×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Презентація: Продукти та покупки)
