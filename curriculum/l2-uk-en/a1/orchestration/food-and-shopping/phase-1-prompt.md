...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/food-and-shopping-research.md
```

Read the **plan file** (SOURCE OF TRUTH for structure, objectives, vocabulary):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/food-and-shopping.yaml
```

Read the **old meta file** (for reference only — you are REPLACING the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/food-and-shopping.yaml
```
