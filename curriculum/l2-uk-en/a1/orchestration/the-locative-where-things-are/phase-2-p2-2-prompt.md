...
> **Your #1 job: Write 889 words for the section "Теорія: Місцевий відмінок".**
...
Write the section prose for **Теорія: Місцевий відмінок** within the module **The Locative: Where Things Are**.

- **WORD BUDGET**: 889 words minimum, 889 × 2 maximum. Stay in this range.
...
- Target: 889 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Теорія: Місцевий відмінок": {count} words (budget: 889-889×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Теорія: Місцевий відмінок)
