...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/the-locative-where-things-are.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/the-locative-where-things-are-research.md`
...
Word count:       2752 / 2000 (137.6%)
Activities:       10
Vocabulary items: 20
Engagement boxes: 5
Immersion:        25.4% (target: 25-40%)
Audit status:     FAIL
```
...
1. Вступ: Питання «Де?»
2. Граматика: Місцевий відмінок
3. Практика: Де це знаходиться?
4. Застосування: Моя кімната і місто
