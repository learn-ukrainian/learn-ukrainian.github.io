...
> **Persona reminder:** You are full-rebuild-core-a. Write in the voice of The Helpful Neighbor: Friendly, direct, practical. Uses simple analogies.. Maintain this persona throughout — do not drift into generic AI tone.

> **Your #1 job: Write 238 words for the section "Розминка: Де ми знаходимося?".**
...
| File | Purpose |
|------|---------|
| `curriculum/l2-uk-en/a1/research/the-locative-where-things-are-research.md` | Factual foundation — use exhaustively |
| `curriculum/l2-uk-en/a1/meta/the-locative-where-things-are.yaml` | Content outline with section word allocations |
| `curriculum/l2-uk-en/plans/a1/the-locative-where-things-are.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the section prose for **Розминка: Де ми знаходимося?** within the module **The Locative: Where Things Are**.

- **WORD BUDGET**: 238 words minimum, 238 × 2 maximum. Stay in this range.
...
- No participles
- Allowed cases: Nominative, Accusative, Locative, Genitive (basics), Vocative
...
- Target: 238 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Розминка: Де ми знаходимося?": {count} words (budget: 238-238×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Розминка: Де ми знаходимося?)
