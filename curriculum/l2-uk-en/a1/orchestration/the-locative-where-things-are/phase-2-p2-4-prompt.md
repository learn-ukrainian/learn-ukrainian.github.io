...
> **Your #1 job: Write 321 words for the section "Підсумок: Мій світ".**
...
Write the section prose for **Підсумок: Мій світ** within the module **The Locative: Where Things Are**.

- **WORD BUDGET**: 321 words minimum, 321 × 2 maximum. Stay in this range.
...
- Target: 321 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Підсумок: Мій світ": {count} words (budget: 321-321×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Підсумок: Мій світ)
