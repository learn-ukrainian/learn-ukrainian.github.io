...
```
curriculum/l2-uk-en/a1/research/the-locative-where-things-are-research.md
```
...
2. Word allocations sum to **exactly 1331** (the plan's word_target)
