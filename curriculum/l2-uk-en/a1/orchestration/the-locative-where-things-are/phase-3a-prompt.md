...
```
curriculum/l2-uk-en/a1/the-locative-where-things-are.md
```

**Plan file** (vocabulary_hints — vocabulary list to follow):
```
curriculum/l2-uk-en/plans/a1/the-locative-where-things-are.yaml
```

**Meta file** (activity count targets, pedagogy):
```
curriculum/l2-uk-en/a1/meta/the-locative-where-things-are.yaml
```
