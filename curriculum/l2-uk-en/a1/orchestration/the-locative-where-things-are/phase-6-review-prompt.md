...
1. **Content** (the lesson you're reviewing): `curriculum/l2-uk-en/a1/the-locative-where-things-are.md`
2. **Activities**: `curriculum/l2-uk-en/a1/activities/the-locative-where-things-are.yaml`
3. **Vocabulary**: `curriculum/l2-uk-en/a1/vocabulary/the-locative-where-things-are.yaml`
4. **Plan** (source of truth for scope): `curriculum/l2-uk-en/plans/a1/the-locative-where-things-are.yaml`
5. **Meta** (build config): `curriculum/l2-uk-en/a1/meta/the-locative-where-things-are.yaml`
...
Word count:       2959 / 1331 (222%)
Activities:       10
Vocabulary items: 23
Engagement boxes: 8
Immersion:        28% (target: 25-40%)
