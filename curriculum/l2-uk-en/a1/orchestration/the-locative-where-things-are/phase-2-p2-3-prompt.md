...
> **Your #1 job: Write 547 words for the section "Практика: Вдома та в місті".**
...
Write the section prose for **Практика: Вдома та в місті** within the module **The Locative: Where Things Are**.

- **WORD BUDGET**: 547 words minimum, 547 × 2 maximum. Stay in this range.
...
- Target: 547 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Практика: Вдома та в місті": {count} words (budget: 547-547×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Практика: Вдома та в місті)
