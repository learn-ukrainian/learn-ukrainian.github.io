...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/the-locative-where-things-are-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/the-locative-where-things-are.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/the-locative-where-things-are.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **The Locative: Where Things Are** (a1 track).
...
|---------|--------|---------------------|
| Вступ: Питання «Де?» | 300 | 450 |
| Граматика: Місцевий відмінок | 800 | 1200 |
| Практика: Де це знаходиться? | 500 | 750 |
| Застосування: Моя кімната і місто | 400 | 600 |
| **Total** | **2000** | **3000** |
