...
| Практика | 400 | 600 |
| Виробництво та підсумок | 400 | 600 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/the-locative-where-things-are.yaml`. Go through EVERY `points:` item in EVERY section:
