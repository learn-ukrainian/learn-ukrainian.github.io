...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/stress-and-intonation-research.md` | Factual foundation — use exhaustively |
...
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/stress-and-intonation.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Stress and Intonation** (a1 track).
...
|---------|--------|---------------------|
| Наголос | 500 | 750 |
| Типові наголоси | 500 | 750 |
| Рухомий наголос | 400 | 600 |
| Інтонація | 400 | 600 |
| Практика | 200 | 300 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/stress-and-intonation.yaml`. Go through EVERY `points:` item in EVERY section:
