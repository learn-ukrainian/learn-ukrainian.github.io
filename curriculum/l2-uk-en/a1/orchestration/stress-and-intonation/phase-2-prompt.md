...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/stress-and-intonation-research.md` | Research notes |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/stress-and-intonation.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/stress-and-intonation.yaml` | Objectives, vocabulary_hints |
...
**Grade 1, bolshakova** — Сторінка 28:
```
28
НАГОЛОС
...
Write the lesson prose for **Stress and Intonation** (a1 track).
...
- **Structure**: Follow the content_outline from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/stress-and-intonation.yaml` — each section maps to an H2. **Write ALL sections. Do not skip any section, even short ones like Summary.** Missing sections fail validation.
...
| Section | Target |
|---------|--------|
| Що таке наголос? (What is Stress?) | 250 |
| Типові наголоси (Common Stress Patterns) | 300 |
| Рухомий наголос (Mobile Stress) | 250 |
| Музика мови: Інтонація (The Music of Language: Intonation) | 250 |
