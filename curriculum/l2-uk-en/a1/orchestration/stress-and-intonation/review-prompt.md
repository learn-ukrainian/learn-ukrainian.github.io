...
3. Verify with Grep: `Grep pattern="first 5-6 words" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/stress-and-intonation.md"`
...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/stress-and-intonation.md`
2. **Activities**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/activities/stress-and-intonation.yaml`
3. **Vocabulary**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/vocabulary/stress-and-intonation.yaml`
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/stress-and-intonation.yaml`
5. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/stress-and-intonation-research.md`
...
deviations:
  - section: "Типові наголоси — Common Stress Patterns"
    reason: "The outline explicitly grouped 'далеко' under 'last-syllable stress' (далеко́), which is a common Russianism error. However, the vocabulary hints correctly noted 'далеко' as 'penultimate stress дале́ко'. To avoid failing the linguistic accuracy check while retaining the word, I moved 'дале́ко' to the penultimate section in the text and added a specific teaching note to warn learners against stressing it on the last syllable. All other outline points were strictly followed."
frictions:
  - type: PLAN_GAP
    description: "The plan outline contradicts its own vocabulary hints regarding the stress of 'далеко' (далеко́ vs дале́ко). Corrected in content."
    proposed_fix: "Update the plan for A1 Module 006 to remove 'далекО' from the 'Last-syllable stress' bullet point and explicitly list it under 'Penultimate stress'."
research_gaps:
  - "None"
unverified_terms:
  - "None"
review_focus:
  - "Verify the handling of the 'далеко' stress contradiction to ensure the content remains linguistically accurate while still fulfilling the required points."
rag_tools_used:
  - "goroh.pp.ua / slovnyk.me checks for stress verification"
```
...
Word count:       1731 / 1200 (144.2%)
Activities:       6
Vocabulary items: 20
Engagement boxes: 0
Immersion:        4.3% (target: 5-15%)
...
2. **[STRESS_UNKNOWN]** (severity: INFO)
   Location: ~line 9
   Text: Stressed word not in dictionary: му́ка (мука)
   Fix: Verify stress manually — word not found in ukrainian-word-stress dictionary.
3. **[STRESS_MISMATCH]** (severity: HIGH)
   Location: ~line 72
   Text: Wrong stress: 'відпо́відь' → should be 'ві́дповідь'
   Fix: Replace 'відпо́відь' with 'ві́дповідь'.
4. **[STRESS_MISMATCH]** (severity: HIGH)
   Location: ~line 110
   Text: Wrong stress: 'пла́кати' → should be 'плака́ти'
   Fix: Replace 'пла́кати' with 'плака́ти'.
...
**Words checked:** 57 | **VESUM coverage:** 54/57 (94.7%)

**❌ Not found in VESUM or textbooks (3):**
- `КА` (source: activities)
