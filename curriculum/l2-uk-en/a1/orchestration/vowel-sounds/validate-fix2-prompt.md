        # Fix 3 issue(s) in `vowel-sounds`

        ### Fix 1: MORPHOLOGICAL_VIOLATION
**What:** Verb 'Пої́хали' (VESUM: verb:perf:past:p) in pre-verb module M2. Verbs are forbidden before M15.
**How to fix:** Replace verb 'Пої́хали' with an English equivalent or a noun phrase. Students haven't learned verbs yet.
**Where:** ~line 6

### Fix 2: MORPHOLOGICAL_VIOLATION
**What:** Verb 'Чита́ємо' (VESUM: verb:imperf:pres:p:1) in pre-verb module M2. Verbs are forbidden before M15.
**How to fix:** Replace verb 'Чита́ємо' with an English equivalent or a noun phrase. Students haven't learned verbs yet.
**Where:** ~line 28

### Fix 3: MORPHOLOGICAL_VIOLATION
**What:** Imperative 'Чита́й' (VESUM: verb:imperf:impr:s:2) — imperatives not taught until M47.
**How to fix:** Replace 'Чита́й' with English instruction. E.g., use 'Remember that...' instead of Ukrainian imperatives.
**Where:** ~line 86

### Other Audit Failures

```
Голосні в словах — Vowels in Words          134 /  200  ❌ (-66)
```
