...
Here is what you already know from Module 1, and what we are adding today:

* **Module 1 (Alphabet Map)**: You learned the 33 letters and practiced writing 10 of them
* **Module 2 (Today)**: The vowel system — 10 vowel letters, word stress, and reading practice
...
| Йотована | Sounds Like | At Word Start | After Consonant |
|----------|------------|---------------|-----------------|
| **Я** | й + а | **я́блуко** (apple) | softens: **дя́дько** (uncle) vs **м'я́ти** (apostrophe keeps й) |
| **Ю** | й + у | **юна́к** (young man) | softens: **лю́ди** (people) |
| **Є** | й + е | **Євро́па** (Europe) | softens: **си́нє** (blue, neuter) |
| **Ї** | й + і | **ї́жа** (food) | ALWAYS two sounds — never softens |
...
Now try this short exchange at a market:
