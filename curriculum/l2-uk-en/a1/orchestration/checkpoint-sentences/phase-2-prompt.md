...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/checkpoint-sentences-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/checkpoint-sentences.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/checkpoint-sentences.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Checkpoint: Sentences** (a1 track).
...
|---------|--------|---------------------|
| Огляд | 300 | 450 |
| Навичка 1: Дієслова | 500 | 750 |
| Навичка 2: Питання та заперечення | 400 | 600 |
| Навичка 3: Уподобання та присвійні | 400 | 600 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/checkpoint-sentences.yaml`. Go through EVERY `points:` item in EVERY section:
