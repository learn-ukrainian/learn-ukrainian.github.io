        # Fix ALL 16 issue(s) in `checkpoint-sentences`
...
**What:** Accusative 'книгу' (VESUM: noun:inanim:f:v_zna) in M24. Accusative not taught until M25.
**How to fix:** Replace 'книгу' (accusative) with nominative form or use English equivalent.
**Where:** ~line 48

### Fix 2: MORPHOLOGICAL_VIOLATION
**What:** Non-nominative 'англійською' (instrumental, VESUM: noun:inanim:f:v_oru) in M24. Only nominative case allowed before M25.
**How to fix:** Replace 'англійською' (instrumental) with its nominative form or use English equivalent.
**Where:** ~line 76

### Fix 3: MORPHOLOGICAL_VIOLATION
**What:** Accusative 'каву' (VESUM: noun:inanim:f:v_zna) in M24. Accusative not taught until M25.
...
**What:** Non-nominative 'Мені' (dative, VESUM: noun:anim:s:v_dav:pron:pers:1) in M24. Only nominative case allowed before M25.
...
**What:** Accusative 'цю' (VESUM: adj:f:v_zna:pron:dem) in M24. Accusative not taught until M25.
...
**What:** Non-nominative 'українською' (instrumental, VESUM: noun:inanim:f:v_oru) in M24. Only nominative case allowed before M25.
**How to fix:** Replace 'українською' (instrumental) with its nominative form or use English equivalent.
**Where:** ~line 134

### Fix 16: STRESS_MISMATCH
**What:** Wrong stress: 'говоря́ть' → should be 'гово́рять'
**How to fix:** Replace 'говоря́ть' with 'гово́рять'.
**Where:** ~line 37
