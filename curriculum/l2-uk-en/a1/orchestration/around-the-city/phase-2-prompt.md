...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/around-the-city-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/around-the-city.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/around-the-city.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Around the City** (a1 track).
...
|---------|--------|---------------------|
| Вступ: Міський простір | 400 | 600 |
| Презентація: Граматика та напрямки | 600 | 900 |
| Практика: Орієнтування за мапою | 600 | 900 |
| Культура та Продакшн: Життя в місті | 400 | 600 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/around-the-city.yaml`. Go through EVERY `points:` item in EVERY section:
