...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/review/around-the-city-review.md
```

**Current content** (the file you are fixing):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/around-the-city.md
```

**Plan file** (source of truth for scope — check if fixes align):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/around-the-city.yaml
```

**Research notes** (reference for factual accuracy):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/around-the-city-research.md
```
