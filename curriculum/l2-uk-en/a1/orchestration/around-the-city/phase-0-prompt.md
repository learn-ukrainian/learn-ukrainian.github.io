...
```
curriculum/l2-uk-en/a1/meta/around-the-city.yaml
```
...
Research **Around the City** for the **A1** core track. Core tracks need lighter research than seminar tracks — focus on accuracy and State Standard alignment.
