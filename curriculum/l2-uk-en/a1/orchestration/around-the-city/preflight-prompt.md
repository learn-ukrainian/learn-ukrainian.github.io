...
|------|----------------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/around-the-city-research.md` | Background knowledge, engagement hooks |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/around-the-city.yaml` | Objectives, vocabulary_hints (source of truth) |
...
| Tool | When | Example |
|------|------|---------|
| `search_text` | Find textbook pedagogy | `search_text("Locative case in context Directional expressions", grade=3-5)` |
...
робота, банк, підлога, стіна, туалет, нога

**Grammar already taught (95 topics):**
...
- **Ukrainian Phrasebook: Places** (ukrainianlessons.com)
  URL: https://www.ukrainianlessons.com/ph-places/
  Relevance: 0.3
  Topics: places, directions, city
...
- **Grade 8, Сторінка 90**
  Прочитайте текст повторно й стисло перекажіть його за складеним планом 
(письмово). За потреби використайте опорні слова. Опорні слова
іменники
прикметники
дієприкметники
дієслова
...
- **Grade 8, Сторінка 64**
  А. Випишіть речення з непрямим порядком слів. Б. Підкресліть інверсовані слова відповідно до їхньої синтаксичної ролі....
...
Write **Around the City** for the a1 track.
...
- `## Вступ: Міський простір (Introduction: Urban Space)` (~250 words)
  - Орієнтація в центрі: Розрізнення понять «Майдан» та «Площа»; Майдан як серце міста та соціальний хаб, Площа як загальна назва (напр., Майдан Незалежності vs Площа Ринок).
  - Запитання про дорогу: Контраст між пошуком об'єкта «Де знаходиться...?» (Location) та маршрутом «Як дістатися до...?» (Direction) згідно зі State Standard §4.2.3.2/3.
- `## Презентація: Граматика та напрямки (Presentation: Grammar and Directions)` (~350 words)
  - Інфраструктура та Місцевий відмінок (§4.2.3.3): Використання прийменників «на» (зупинці, пошті, площі) та «в» (аптеці); робота над типовою помилкою «в площі» та «в зупинці».
  - Словник напрямків: «Прямо», «наліво/направо» та їхні формальні відповідники «ліворуч/праворуч», які часто зустрічаються на офіційних вказівниках.
  - Концепція «Де» vs «Куди»: Диференціація статичного перебування (Locative) та руху до цілі (Accusative §4.2.3.2.2); виправлення помилки «Де ти йдеш?» на коректне «Куди ти йдеш?».
  - Прийменники-блоки з Родовим відмінком: «Біля» та «Навпроти» як лексичні чанки (біля аптеки, навпроти пошти); запобігання помилці вживання Називного відмінка («біля аптека»).
- `## Практика: Орієнтування за мапою (Practice: Navigating by Map)` (~350 words)
  - Навігація за орієнтирами: Практика пояснення дороги через впізнавані будівлі (landmarks) замість сторін світу, що є домінуючим стилем в українській комунікації.
  - Дріл на відмінки та питання: Вправи на заповнення пропусків «Де?» (Locative) vs «Куди?» (Accusative) у контексті діалогу з перехожим на вулиці.
  - Корекція типових помилок: Спеціальні завдання на вибір правильного прийменника (в/на) для різних типів міських локацій (аптека vs пошта).
- `## Культура та Продакшн: Життя в місті (Culture and Production: City Life)` (~250 words)
  - Етикет Маршрутки: Культурний аспект — фраза «На зупинці, будь ласка!» як необхідність привернути увагу водія; обговорення відсутності автоматичних зупинок.
  - Рольова гра «Загублений турист»: Використання вивчених орієнтирів та напрямків для пояснення дороги до власного дому; акцент на «Де знаходиться?» vs «Як дістатися?».
...
| Section | Minimum |
|---------|---------|
| Вступ: Міський простір (Introduction: Urban Space) | 250+ |
| Презентація: Граматика та напрямки (Presentation: Grammar and Directions) | 350+ |
| Практика: Орієнтування за мапою (Practice: Navigating by Map) | 350+ |
| Культура та Продакшн: Життя в місті (Culture and Production: City Life) | 250+ |
...
### Workflow
1. **Research first**: `search_text("Locative case in context Directional expressions", grade=3-5)` — find how textbooks teach this
...
**Required types:** match-up, fill-in, fill-in, match-up
