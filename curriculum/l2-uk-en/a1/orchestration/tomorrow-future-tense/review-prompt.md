...
3. Verify with Grep: `Grep pattern="first 5-6 words" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/tomorrow-future-tense.md"`
...
5. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/tomorrow-future-tense-research.md`
...
unverified_terms: []
review_focus:
  - "Check that compound future rules are clearly and accurately explained."
  - "Check that the aspect constraint (imperfective only) is well-communicated to prevent learner errors."
rag_tools_used: []
```
...
1. **[MORPHOLOGICAL_VIOLATION]** (severity: HIGH)
   Location: ~line 86
   Text: Imperative 'кажи́' (VESUM: verb:imperf:impr:s:2) — imperatives not taught until M47.
   Fix: Replace 'кажи́' with English instruction. E.g., use 'Remember that...' instead of Ukrainian imperatives.
2. **[STRESS_MISMATCH]** (severity: HIGH)
   Location: ~line 101
   Text: Wrong stress: 'те́бе' → should be 'тебе́'
...
**Words checked:** 98 | **VESUM coverage:** 97/98 (99.0%)
