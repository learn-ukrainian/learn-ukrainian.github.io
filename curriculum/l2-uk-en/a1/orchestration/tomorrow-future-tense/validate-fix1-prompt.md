        # Fix ALL 5 issue(s) in `tomorrow-future-tense`
        ...
        **After you finish, count your fixes. If the count is less than 5, go back and fix the ones you missed.**
        ...
        ### Fix 1: IPA_BANNED
**What:** Banned IPA transcription: [Future Tense in Ukrainian]
**How to fix:** Remove phonetic brackets. Use only stress marks (´) for pronunciation.
**Where:** ~line 196

### Fix 2: MORPHOLOGICAL_VIOLATION
**What:** Imperative 'кажи' (VESUM: verb:imperf:impr:s:2) — imperatives not taught until M47.
**How to fix:** Replace 'кажи' with English instruction. E.g., use 'Remember that...' instead of Ukrainian imperatives.
**Where:** ~line 134
...
**What:** Agreement mismatch: 'парку' (f) + 'до' (n/p)
**How to fix:** Change 'парку' to match the gender/case of 'до', or vice versa.
**Where:** ~line 146
