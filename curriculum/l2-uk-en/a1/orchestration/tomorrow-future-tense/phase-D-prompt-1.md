...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/tomorrow-future-tense.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/tomorrow-future-tense-research.md`
...
Vocabulary items: 21
Engagement boxes: 6
Immersion:        35.9% (target: 35-55%)
Audit status:     FAIL
```

## Content Sections (H2 headers in the content file)

1. Розминка: Час летить (Time Flies)
2. Граматика: Майбутній час (Я буду...)
3. Плани та наміри: Що ми будемо робити?
4. Коли це буде? (Частина 1: Конкретний час)
5. Коли це буде? (Частина 2: Абстрактний час)
6. Наші плани: Вихідні та відпустка
7. Практика: Діалоги про плани
8. Практика: Мій ідеальний день завтра
