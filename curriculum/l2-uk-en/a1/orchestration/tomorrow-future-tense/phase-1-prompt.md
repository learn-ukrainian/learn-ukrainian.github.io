...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/tomorrow-future-tense.yaml
```

Read the **old meta file** (for reference only — you are REPLACING the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/tomorrow-future-tense.yaml
```
...
2. Word allocations sum to **exactly 1082** (the plan's word_target)
