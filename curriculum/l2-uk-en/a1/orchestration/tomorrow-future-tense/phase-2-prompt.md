...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Презентація граматики | 600 | 900 |
| Лексика та культурний контекст | 600 | 900 |
| Практика та підсумок | 400 | 600 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/tomorrow-future-tense.yaml`. Go through EVERY `points:` item in EVERY section:
