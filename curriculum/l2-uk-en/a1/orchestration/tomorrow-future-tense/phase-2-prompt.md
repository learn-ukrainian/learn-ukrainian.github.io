...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/tomorrow-future-tense-research.md` | Research notes |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/tomorrow-future-tense.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/tomorrow-future-tense.yaml` | Objectives, vocabulary_hints |
...
**Grade 1, zaharijchuk** — Сторінка 2:
```
...
Write the lesson prose for **Tomorrow - Future Tense** (a1 track).
...
- **Structure**: Follow the content_outline from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/tomorrow-future-tense.yaml` — each section maps to an H2. **Write ALL sections. Do not skip any section, even short ones like Summary.** Missing sections fail validation.
...
| Презентація граматики: Буду + Інфінітив (Grammar: Буду + Infinitive) | 350 |
| Лексика та культурний контекст: Плани на майбутнє (Vocabulary and Plans) | 350 |
