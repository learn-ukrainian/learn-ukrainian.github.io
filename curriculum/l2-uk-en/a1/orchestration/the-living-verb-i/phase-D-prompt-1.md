...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/the-living-verb-i.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/the-living-verb-i-research.md`
...
Word count:       2732 / 2000 (136.6%)
Activities:       10
Vocabulary items: 25
Engagement boxes: 6
Immersion:        18.3% (target: 15-35%)
Audit status:     FAIL
```

## Content Sections (H2 headers in the content file)

1. Вступ: Від статичних описів до живих дій
2. Теорія: Магія закінчень -ати
3. Практика: Використовуємо дієслова в житті
4. Культурний контекст: Сила українського слова
