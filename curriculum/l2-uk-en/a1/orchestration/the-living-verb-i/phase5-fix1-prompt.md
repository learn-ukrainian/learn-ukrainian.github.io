...
────────────────────────────────────────────────────────────
  ...
  failing gates:
    lesson: 2659/2000 (raw: 2990) | pedagogy: 3 violations
...
─── Audit output (last 15 lines) ───
    [COMPLEXITY] true-false 'Граматична правда' has 6 items (minimum: 8)
       → FIX: Add more items. A1 true-false requires at least 8 items.
