...
> **Your #1 job: Write 750 words for the section "Презентація: Перша дієвідміна".**
...
| File | Purpose |
|------|---------|
| `curriculum/l2-uk-en/a1/research/the-living-verb-i-research.md` | Factual foundation — use exhaustively |
| `curriculum/l2-uk-en/a1/meta/the-living-verb-i.yaml` | Content outline with section word allocations |
| `curriculum/l2-uk-en/plans/a1/the-living-verb-i.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the section prose for **Презентація: Перша дієвідміна** within the module **The Living Verb I**.

- **WORD BUDGET**: 750 words minimum, 750 × 2 maximum. Stay in this range.
- **Immersion**: Content is 65-85% English. Growing Ukrainian immersion. Grammar concepts explained in English with Ukrainian terminology introduced. Sentences max 10 words. Dative and Instrumental cases FORBIDDEN. No subordinate clauses.
- **Engagement callouts**: Include at least 1 callout(s) in this section.
- **Example sentences**: Include at least 2 example sentences in this section.
...
### From Objects to Action
### The Master Key
### Your Day in Ukrainian
---
Welcome back! You already know many Ukrainian words. You see a **телефон** [tɛlɛˈfɔn] (phone) or a **журнал** [ʒurˈnɑl] (magazine). But naming things is not enough. You want to speak. To speak, we need action. We need the **дієслово** [dijɛˈslɔwɔ] (verb). The verb is the engine of the sentence. It turns a static picture into a movie. Without verbs, we just point at objects. With verbs, we truly communicate.

### The Master Key
You might worry about complex grammar. Please, do not worry. Ukrainian verbs follow a beautiful logic. Today, we discover a "Master Key". This is the **-ати** pattern. Many essential verbs share this pattern. You learn one simple rule, and you unlock hundreds of words immediately. It is like magic. You will confidently say "I read", "I know", or "I listen". Trust this pattern.
...
*   **Я працюю.** [jɑ prɑˈtsʲuju] — I work.
*   **Я слухаю радіо.** [jɑ ˈsluxɑju ˈrɑdijo] — I listen to the radio.
*   **Він знає все.** [win ˈznɑje wsɛ] — He knows everything.

> [!tip]
> **Where is "I"?**
> In Ukrainian, the verb ending often tells us *who* is doing the action. You can say **Я читаю** [jɑ tʃɪˈtɑju] (I read) or just **Читаю** [tʃɪˈtɑju]. Both are correct! We will see this logic in action very soon.
...
Previously used callout types in this module: tip
...
- Target: 750 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Презентація: Перша дієвідміна": {count} words (budget: 750-750×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Презентація: Перша дієвідміна)
