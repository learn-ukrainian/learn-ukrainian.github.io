...
> **Your #1 job: Write 375 words for the section "Практика: Життя в русі".**
...
Write the section prose for **Практика: Життя в русі** within the module **The Living Verb I**.
...
### The Sleeping Verb
### The Master Key
### Model Verb: Читати (To Read)
### Where is "I"? (The Pro-Drop Concept)
### Expanding Your Toolkit
### A Note on "Working"
### Common Trap: The "Robot" Mistake
---
...
**Я працюю вдома.** [jɑ prɑˈtsʲuju ˈwdɔmɑ] — I work at home.
...
**Ми знаємо місто.** [mɪ ˈznɑjɛmɔ ˈmistɔ] — We know the city.
...
Previously used callout types in this module: tip,tip,context
...
```
===WORD_COUNTS===
Section "Практика: Життя в русі": {count} words (budget: 375-375×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Практика: Життя в русі)
