...
> **Your #1 job: Write 300 words for the section "Розминка: Від слів до дій".**
...
Write the section prose for **Розминка: Від слів до дій** within the module **The Living Verb I**.
...
(Start of module. No previous content.)
...
```
===WORD_COUNTS===
Section "Розминка: Від слів до дій": {count} words (budget: 300-300×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Розминка: Від слів до дій)
