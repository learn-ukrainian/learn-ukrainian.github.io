...
1. **Content** (the lesson you're reviewing): `curriculum/l2-uk-en/a1/the-living-verb-i.md`
2. **Activities**: `curriculum/l2-uk-en/a1/activities/the-living-verb-i.yaml`
3. **Vocabulary**: `curriculum/l2-uk-en/a1/vocabulary/the-living-verb-i.yaml`
4. **Plan** (source of truth for scope): `curriculum/l2-uk-en/plans/a1/the-living-verb-i.yaml`
5. **Meta** (build config): `curriculum/l2-uk-en/a1/meta/the-living-verb-i.yaml`
6. **Research notes** (if exists): `curriculum/l2-uk-en/a1/research/the-living-verb-i-research.md`
...
```
Word count:       1786 / 1210 (147%%)
Activities:       8
Vocabulary items: 22
Engagement boxes: 4
Immersion:        15.1%% (target: 15-35%)
...
At module 6, students know ONLY modules 1-a1-05 (My World - Objects). Any grammar from later modules is scope creep.
