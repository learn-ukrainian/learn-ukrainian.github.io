...
> **Your #1 job: Write 390 words for the section "Культурний контекст: Українське слово".**
...
Write the section prose for **Культурний контекст: Українське слово** within the module **The Living Verb I**.
...
### The Dropped Pronoun
---
*   **Він працює тут.** [win prɑˈtsʲujɛ tut] — He works here.
*   **Ми працюємо вдома.** [mɪ prɑˈtsʲujɛmɔ ˈwdɔmɑ] — We work at home.
*   **Вони працюють багато.** [wɔˈnɪ prɑˈtsʲujutʲ bɑˈɦɑtɔ] — They work a lot.
...
*   **Знаю це.** [ˈznɑju tsɛ] — (I) know this.
*   **Слухаємо радіо.** [ˈsluxɑjɛmɔ ˈrɑdʲijo] — (We) listen to the radio.
*   **Чекаєш маму?** [tʃeˈkɑjɛʃ ˈmɑmu] — (Are you) waiting for mom?
...
Previously used callout types in this module: tip,tip,context,observe
...
## Культурний контекст: Українське слово
...
```
===WORD_COUNTS===
Section "Культурний контекст: Українське слово": {count} words (budget: 390-390×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Культурний контекст: Українське слово)
