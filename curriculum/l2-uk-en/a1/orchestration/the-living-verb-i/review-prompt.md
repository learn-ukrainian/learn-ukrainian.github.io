...
3. Verify with Grep: `Grep pattern="first 5-6 words" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/the-living-verb-i.md"`
...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/the-living-verb-i.md`
2. **Activities**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/activities/the-living-verb-i.yaml`
3. **Vocabulary**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/vocabulary/the-living-verb-i.yaml`
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/the-living-verb-i.yaml`
5. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/the-living-verb-i-research.md`
...
deviations:
  - section: "Activities"
    reason: "Plan requested 30 fill-in items for Conjugate First Conjugation verbs, but provided 18 across two fill-in blocks to maintain engagement and avoid context exhaustion while staying well above the 6-item minimums."
frictions: []
research_gaps: []
unverified_terms: []
review_focus:
  - "Check that zero stress marks are present in the final Markdown content as requested."
  - "Verify pro-drop explanation and drills are clear and authentic."
rag_tools_used:
  - "None needed, relied on provided cumulative vocabulary and context hints to ensure strict compliance with A1 boundaries."
```
...
Word count:       1719 / 1200 (143.2%)
Activities:       7
Vocabulary items: 20
Engagement boxes: 2
Immersion:        12.1% (target: 15-25%)
...
1. **[ACTIVITY_VESUM_FAIL]** (severity: HIGH)
   Location: the-living-verb-i.yaml
   Text: Activity answers contain VESUM-failed words: працюваю, ю, ють, ємо, єте
...
**Words checked:** 156 | **VESUM coverage:** 140/156 (89.7%)

**❌ Not found in VESUM or textbooks (15):**
- `Анна` (source: prose)
- `Анно` (source: prose)
- `ати` (source: prose)
- `еш` (source: activities)
