...
```
curriculum/l2-uk-en/a1/review/the-living-verb-i-review.md
```
...
```
curriculum/l2-uk-en/a1/activities/the-living-verb-i.yaml
```

**Current vocabulary** (fix if review mentions vocabulary issues):
```
curriculum/l2-uk-en/a1/vocabulary/the-living-verb-i.yaml
```
...
```
curriculum/l2-uk-en/a1/research/the-living-verb-i-research.md
```
