...
1. **Plan** (source of truth): `curriculum/l2-uk-en/plans/a1/the-living-verb-i.yaml`
2. **Meta** (build config): `curriculum/l2-uk-en/a1/meta/the-living-verb-i.yaml`
3. **Content** (the lesson): `curriculum/l2-uk-en/a1/the-living-verb-i.md`
4. **Activities**: `curriculum/l2-uk-en/a1/activities/the-living-verb-i.yaml`
5. **Vocabulary**: `curriculum/l2-uk-en/a1/vocabulary/the-living-verb-i.yaml`
6. **Review** (Green Team review from Phase 6): `curriculum/l2-uk-en/a1/review/the-living-verb-i-review.md`
7. **Phase 6b fix log** (if exists): `curriculum/l2-uk-en/a1/orchestration/the-living-verb-i/phase-6b-fixes.md`
...
```bash
scripts/audit_module.sh curriculum/l2-uk-en/a1/the-living-verb-i.md
```
...
Check against `curriculum/l2-uk-en/plans/a1/the-living-verb-i.yaml`:
...
Read `curriculum/l2-uk-en/a1/the-living-verb-i.md` in FULL. Check for:

### 3a: Russianisms (auto-fail)
```bash
grep -inP 'кушати|получати|приймати участь|слідуючий|любий\b|дякуючи' curriculum/l2-uk-en/a1/the-living-verb-i.md
grep -inP 'кушати|получати|приймати участь|слідуючий|любий\b|дякуючи' curriculum/l2-uk-en/a1/activities/the-living-verb-i.yaml
```

### 3b: Russian characters (auto-fail)
```bash
grep -nP '[ыэёъ]' curriculum/l2-uk-en/a1/the-living-verb-i.md
grep -nP '[ыэёъ]' curriculum/l2-uk-en/a1/activities/the-living-verb-i.yaml
```

### 3c: IPA errors
```bash
grep -n '/w/' curriculum/l2-uk-en/a1/the-living-verb-i.md
grep -n '/ʊ/' curriculum/l2-uk-en/a1/the-living-verb-i.md
grep -n '/w/' curriculum/l2-uk-en/a1/vocabulary/the-living-verb-i.yaml
grep -n '/ʊ/' curriculum/l2-uk-en/a1/vocabulary/the-living-verb-i.yaml
```
Fix: /w/ -> /ʋ/, /ʊ/ -> /u/
...
```bash
grep -nP '\[/[^]]+/\]|(?<!\[)/[а-яіїєґА-ЯІЇЄҐ][^/]*/(?!\])' curriculum/l2-uk-en/a1/the-living-verb-i.md
```
If found and track is B1+: move to vocabulary, remove from content.

### 3e: English leakage
```bash
grep -inP '\b(the|is|are|was|were|has|have|this|that|with|from|for|and|but|not|can|will)\b' curriculum/l2-uk-en/a1/the-living-verb-i.md
```
...
```bash
.venv/bin/python scripts/calc_immersion.py curriculum/l2-uk-en/a1/the-living-verb-i.md
```
...
Read `curriculum/l2-uk-en/a1/activities/the-living-verb-i.yaml` in FULL.
...
Read `curriculum/l2-uk-en/a1/review/the-living-verb-i-review.md`. For EACH issue in "Critical Issues Found" or "Fix Plan":
...
```
===FINAL_REVIEW_START===
# Final Review: the-living-verb-i
