...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/prepositions-of-place-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/prepositions-of-place.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/prepositions-of-place.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Prepositions of Place** (a1 track).
...
|---------|--------|---------------------|
| В/У + Місцевий відмінок | 500 | 750 |
| На + Місцевий відмінок | 500 | 750 |
| Біля, поруч, між | 400 | 600 |
| Де знаходиться...? | 350 | 525 |
| Практика | 250 | 375 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/prepositions-of-place.yaml`. Go through EVERY `points:` item in EVERY section:
