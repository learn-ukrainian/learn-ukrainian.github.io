...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/at-the-store.yaml`. Go through EVERY `points:` item in EVERY section:
