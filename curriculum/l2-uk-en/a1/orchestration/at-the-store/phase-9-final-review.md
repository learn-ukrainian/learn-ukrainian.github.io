...
- Line 86: `[mɔˈlɔtʃnɪi̯ ˈʋidʲːil]` — should be `[mɔˈlɔtʃnɪi̯ ʋidˈdʲil]`
- Line 91: `[mjɑsˈnɪi̯ ˈʋidʲːil]` — should be `[mjɑsˈnɪi̯ ʋidˈdʲil]`
- Line 118: `[u jɑˈkɔmʊ ˈʋidʲːili]` — should be `[u jɑˈkɔmʊ ʋidˈdʲilʲi]` (also: locative лі = [lʲi])
...
"Коштувати" → "коштує" — stress: кош-ТУ́-є [kɔʃˈtʊjɛ]. The transcription `[ˈkɔʃtʊje]` puts stress on the first syllable and uses [e] instead of [ɛ].

**Issue 3: "закупи" stress on wrong syllable (line 52)**

SUM gives: заку́пи [zɑˈkʊpɪ] (stress on second syllable). The transcription `[ˈzɑkʊpɪ]` puts stress on the first syllable.
...
FILE: curriculum/l2-uk-en/a1/at-the-store.md
---OLD---
**Молочний відділ** [mɔˈlɔtʃnɪi̯ ˈʋidʲːil] — Dairy department.
---NEW---
...
FILE: curriculum/l2-uk-en/a1/at-the-store.md
---OLD---
To ask "In which department...?", we use the phrase **У якому відділі...?** [u jɑˈkɔmʊ ˈʋidʲːili]. Notice that the word *відділ* changes to *відділі*.
---NEW---
To ask "In which department...?", we use the phrase **У якому відділі...?** [u jɑˈkɔmʊ ʋidˈdʲilʲi]. Notice that the word *відділ* changes to *відділі*.
===FIX_END===

===FIX_START===
FILE: curriculum/l2-uk-en/a1/at-the-store.md
---OLD---
2.  **Робити закупи** [rɔˈbɪtɪ ˈzɑkʊpɪ] — To do the shopping.
---NEW---
