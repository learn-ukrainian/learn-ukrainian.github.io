...
> **Your #1 job: Write 645 words for the section "Практика: Робочі дні та вихідні".**
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/my-daily-routine-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/my-daily-routine.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/my-daily-routine.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the section prose for **Практика: Робочі дні та вихідні** within the module **My Daily Routine**.

- **WORD BUDGET**: 645 words minimum, 645 × 2 maximum. Stay in this range.
...
- Target: 645 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Практика: Робочі дні та вихідні": {count} words (budget: 645-645×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Практика: Робочі дні та вихідні)
