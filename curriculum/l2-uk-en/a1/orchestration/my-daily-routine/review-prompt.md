...
3. Verify with Grep: `Grep pattern="first 5-6 words" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/my-daily-routine.md"`
...
5. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/my-daily-routine-research.md`
...
unverified_terms: []
review_focus:
  - "Check that reflexive verb rules (-ся / -сь) are accurately explained and properly distributed among consonant/vowel endings."
  - "Verify all required sequence markers (спочатку, потім, нарешті) are used effectively in the text."
  - "Ensure no Russianisms or Latin transliterations leaked into the document."
rag_tools_used:
  - "verify_words: skipped direct query because all vocabulary words are core A1 level and explicitly defined in the plan."
```
...
Word count:       1865 / 1200 (155.4%)
Activities:       4
Vocabulary items: 20
Engagement boxes: 0
Immersion:        13.9% (target: 20-35%)
...
3. Практика (Practice)
4. Продукування та Підсумок (Production and Summary)
...
**Words checked:** 130 | **VESUM coverage:** 127/130 (97.7%)

**❌ Not found in VESUM or textbooks (3):**
- `вмиваєть` (source: activities)
- `сь` (source: prose)
- `ть` (source: prose)
