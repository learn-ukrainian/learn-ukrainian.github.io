I will locate the relevant files for Module 25 "My Daily Routine" to ensure I am reviewing the current versions from disk as instructed.
I will search for the file path of Module 25 by listing the contents of the `curriculum/l2-uk-en` directory.
I will list the contents of `curriculum/l2-uk-en` to understand the directory structure and locate the module files.
I will list the contents of the `curriculum/l2-uk-en/a1` directory to find the specific files for Module 25.
I will list the contents of the `activities`, `vocabulary`, `meta`, and `plans` directories to confirm the exact filenames for Module 25.
I will check the `curriculum/l2-uk-en/plans/a1` directory to confirm the plan file name.
I will read the content, activities, vocabulary, plan, and meta files for Module 25 to proceed with the review.
I will check for the existence of the research notes file for Module 25.
I will list the contents of the `curriculum/l2-uk-en/a1/research` directory to check for the research notes file.
I will read the research notes for Module 25 to complete the set of files required for the review.
===REVIEW_START===
