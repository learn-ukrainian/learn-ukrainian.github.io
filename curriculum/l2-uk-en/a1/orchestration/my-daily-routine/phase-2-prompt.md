...
Write the full lesson prose for **My Daily Routine** (a1 track).
...
| Презентація | 600 | 900 |
| Практика | 550 | 825 |
| Продукування та Підсумок | 450 | 675 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/my-daily-routine.yaml`. Go through EVERY `points:` item in EVERY section:
