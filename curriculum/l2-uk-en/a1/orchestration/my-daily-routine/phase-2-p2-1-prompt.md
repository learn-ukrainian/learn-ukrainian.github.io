...
> **Your #1 job: Write 480 words for the section "Теорія: Мій розпорядок дня".**
...
Write the section prose for **Теорія: Мій розпорядок дня** within the module **My Daily Routine**.
...
```
===WORD_COUNTS===
Section "Теорія: Мій розпорядок дня": {count} words (budget: 480-480×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Теорія: Мій розпорядок дня)
