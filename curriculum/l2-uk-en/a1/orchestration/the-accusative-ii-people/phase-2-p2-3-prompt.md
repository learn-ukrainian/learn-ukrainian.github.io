...
> **Your #1 job: Write 657 words for the section "Використання: Моя сім'я та друзі".**
...
Write the section prose for **Використання: Моя сім'я та друзі** within the module **The Accusative II: People**.

- **WORD BUDGET**: 657 words minimum, 657 × 2 maximum. Stay in this range.
...
_Приклад:_
- **Я люблю маму і тата.** — [jɑ lʲʊˈblʲʊ ˈmɑmʊ i ˈtɑtɑ] (I love mom and dad.)
- **Ми знаємо сусіда.** — [mɪ ˈznɑjɛmɔ sʊˈsidɑ] (We know the neighbor.)
- **Вона чекає подругу.** — [ʋɔˈnɑ tʃɛˈkɑjɛ ˈpɔdrʊɦʊ] (She is waiting for a friend.)

`[!warning]` **Не забувайте закінчення!** (Do not forget the ending!)
...
Previously used callout types in this module: observe, tip, warning
...
- Target: 657 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Використання: Моя сім'я та друзі": {count} words (budget: 657-657×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Використання: Моя сім'я та друзі)
