...
| Розминка | 300 | 450 |
| Презентація | 650 | 975 |
| Культурний контекст | 400 | 600 |
| Типові помилки та практика | 450 | 675 |
| Вироблення навичок та підсумок | 200 | 300 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/the-accusative-ii-people.yaml`. Go through EVERY `points:` item in EVERY section:
