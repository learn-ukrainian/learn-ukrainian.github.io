...
> **Your #1 job: Write 390 words for the section "Практика: Робота з формою".**
...
| File | Purpose |
|------|---------|
| `curriculum/l2-uk-en/a1/research/the-accusative-ii-people-research.md` | Factual foundation — use exhaustively |
| `curriculum/l2-uk-en/a1/meta/the-accusative-ii-people.yaml` | Content outline with section word allocations |
| `curriculum/l2-uk-en/plans/a1/the-accusative-ii-people.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the section prose for **Практика: Робота з формою** within the module **The Accusative II: People**.
...
---
In Ukrainian, animals are part of the "Heart Words" group too! Your pets are treated like people in grammar. This means a masculine animal like **кіт** — [kit] (cat) or **пес** — [pes] (dog) will change its ending. They are alive, so they take the **-а** ending.

If you have a cat, you say **«Я маю кота»**. Note that **кіт** changes to **кот-** before the ending. This is a small vowel change. If you see a dog, you say **«Я бачу пса»**. Here, the **е** in **пес** disappears. These are "Heart Words" with a little extra character!

_Приклад:_
- **Я маю кота.** — [jɑ ˈmɑjʊ kɔˈtɑ] (I have a cat.)
- **Ти бачиш пса.** — [tɪ ˈbɑtʃɪʃ psɑ] (You see a dog.)
- **Ми любимо кота.** — [mɪ ˈlʲʊbɪmɔ kɔˈtɑ] (We love the cat.)
...
Previously used callout types in this module: observe
...
```
===WORD_COUNTS===
Section "Практика: Робота з формою": {count} words (budget: 390-390×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Практика: Робота з формою)
