...
> **Your #1 job: Write 393 words for the section "Культурний контекст: Відносини та імена".**
...
Write the section prose for **Культурний контекст: Відносини та імена** within the module **The Accusative II: People**.

- **WORD BUDGET**: 393 words minimum, 393 × 2 maximum. Stay in this range.
...
**Студент бачить вчителя.** — [stʊˈdɛnt ˈbɑtʃitʲ ˈʋtʃitɛlʲɑ] (The student sees the teacher.)
...
**Колега любить кота.** — [kɔˈlɛɦɑ ˈlʲʊbitʲ kɔˈtɑ] (The colleague loves the cat.)
- **Колега** (Colleague) = **підмет**
- **Любить** (Loves) = **присудок**
- **Кота** (Cat) = **додаток**

**Тварини — це теж істоти.** — [tʋɑˈrɪnɪ tsɛ tɛʒ iˈstɔtɪ] (Animals are also animate beings.)
Cats and dogs are «Heart Words» too! Even though they are not people, grammatically they are alive and follow the same rules.
**Вони мають такі самі правила.** — [ʋɔˈnɪ ˈmɑɪʊtʲ tɑˈki ˈsɑmi ˈprɑʋɪlɑ] (They have the same rules.)
**Любіть тварин і говоріть правильно!** — [lʲʊˈbitʲ tʋɑˈrɪn i hɔʋɔˈritʲ ˈprɑʋilʲnɔ] (Love animals and speak correctly!)
...
Previously used callout types in this module: context, culture, observe, tip, warning
...
- Target: 393 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Культурний контекст: Відносини та імена": {count} words (budget: 393-393×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Культурний контекст: Відносини та імена)
