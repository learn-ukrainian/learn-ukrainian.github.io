...
> **Your #1 job: Write 150 words for the section "Summary".**
...
Write the section prose for **Summary** within the module **The Accusative II: People**.

- **WORD BUDGET**: 150 words minimum, 150 × 2 maximum. Stay in this range.
- **Engagement callouts**: Include at least 0 callout(s) in this section.
- **Example sentences**: Include at least 0 example sentences in this section.
...
```
===WORD_COUNTS===
Section "Summary": {count} words (budget: 150-150×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Summary)
