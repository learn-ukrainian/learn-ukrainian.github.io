...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/the-accusative-ii-people.yaml
```

Read the **old meta file** (for reference only — you are REPLACING the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/the-accusative-ii-people.yaml
```
...
2. Word allocations sum to approximately **2000** (the level's word target, provided by the build system)
...
- Allocations should sum to approximately 2000 words (±10% is acceptable)
