...
```
curriculum/l2-uk-en/a1/research/the-accusative-ii-people-research.md
```

Read the **plan file** (SOURCE OF TRUTH for structure, word_target, objectives, vocabulary):

```
curriculum/l2-uk-en/plans/a1/the-accusative-ii-people.yaml
```

Read the **old meta file** (for reference only — you are REPLACING the content_outline):

```
curriculum/l2-uk-en/a1/meta/the-accusative-ii-people.yaml
```
...
2. Word allocations sum to **exactly 1374** (the plan's word_target)
