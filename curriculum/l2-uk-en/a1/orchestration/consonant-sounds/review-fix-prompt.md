        # Review and Fix: consonant-sounds
...
- points:
  ...
  words: 100
- points:
  - 'Sonorants are the ''musical'' consonants — voice dominates over noise. 5 sonorants:
    Л М Н Р В. You already know Л М Н from M1.'
  - 'Р — the rolled/trilled R! Words: риба (fish), рука (hand). Practice the tongue-tip
    trill. Looks like English P but sounds completely different.'
...
- points:
  ...
  - 'CRITICAL RULE: voiced consonants stay voiced at word end! зуб = зу[б], NOT зу[п].
    хліб = хлі[б], NOT хлі[п]. Different from Russian and German.'
...
- points:
  ...
  - 'Compare: лук (hard Л — bow (weapon)) vs люк (soft Л — hatch). The consonant changes,
    not the vowel!'
  - 'Always-hard: Ж, Ш are always hard. Й is always soft. Details on Ь (the soft sign
    that forces softening) in M4.'
  section: Тверді та м'які — Hard and Soft Consonants
  words: 250
- points:
  - Words using the full consonant inventory. All vowels from M2 available.
  - 'NO full sentences with verbs — grammar is not taught yet. Use word groups, noun
    phrases, and labeling: Це дім. Це хліб. Ось бабуся.'
...
- points:
  ...
  - 'Self-check: What are the 5 sonorants? What is the voiceless partner of Б? Is
    Г a hard ''g'' or a soft throaty sound? Do voiced consonants devoice at word end?'
  - 'Next: M4 completes the alphabet — soft sign (Ь), apostrophe, affricates (Ц Ч
    Щ), digraphs (ДЖ ДЗ), and rare Ф.'
...
- 'Key rule: Ukrainian voiced consonants do NOT devoice at word end (зуб = зу[б],
  not зу[п])'
pedagogy: PPP
persona:
...
- word: цибуля
  ...
  example: Це цибуля.
        ...
        ```
        Auditing: /Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/consonant-sounds.md
Saving log to: curriculum/l2-uk-en/a1/audit/consonant-sounds-audit.log


========================================
  📋 Loaded Plan from: plans/a1/consonant-sounds.yaml
  📋 Loaded Metadata from YAML sidecar

📋 Auditing: A1 M03 — Consonant Sounds
   File: /Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/consonant-sounds.md | Target: 1200 words
  📋 Required activity types from meta: classify, image-to-letter, match-up, quiz, watch-and-repeat
  📋 Template: docs/l2-uk-en/templates/a1-module-template.md (pedagogy: PPP)

  📊 Section Word Analysis:
     Вступ — Introduction                                 233 /  100  ✅ (+133)
     Сонорні — Sonorant Consonants                        502 /  200  ✅ (+302)
     Дзвінкі та глухі пари — Voiced and Voiceless Pairs   669 /  400  ✅ (+269)
     Тверді та м'які — Hard and Soft Consonants           446 /  250  ✅ (+196)
     Читання — Reading Practice                           170 /  150  ✅ (+20)
