...
- section: "Дзвінкі та глухі пари — Voiced and Voiceless Pairs"
  words: 400
  points:
  - "Hands-on-ears test (закрий долонями вуха): voiced (дзвінкий) = you hear a buzz. Voiceless (глухий)
...
- type: match-up
  ...
  items: 6
- type: quiz
  focus: "Hands-on-ears test — is this consonant voiced or voiceless?"
  items: 10
- type: classify
