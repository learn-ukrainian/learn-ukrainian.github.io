...
> **Your #1 job: Write 408 words for the section "Характеристики: Опис предметів і простору".**
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/describing-things-adjectives-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/describing-things-adjectives.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/describing-things-adjectives.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the section prose for **Характеристики: Опис предметів і простору** within the module **Describing Things - Adjectives**.

- **WORD BUDGET**: 408 words minimum, 408 × 2 maximum. Stay in this range.
...
- ### Порядок слів: Де стоїть прикметник?
---
**1. Before the noun (Descriptive)**
This is the standard position. You are simply naming the object with its quality.
*   **Це великий стіл.** [tʃɛ ʋɛˈlɪkɪj sʲtʲil] (This is a big table.)
*   **Це добрий студент.** [tʃɛ ˈdɔbrɪj stuˈdɛnt] (This is a good student.)

**2. After the noun (Statement)**
Here, you are making a specific claim about the object. In English, you use "is" (The table *is* big). In Ukrainian, we skip "is", but the meaning is clear from the word order and intonation.
*   **Цей стіл великий.** [tʃɛj sʲtʲil ʋɛˈlɪkɪj] (This table [is] big.)
*   **Цей студент добрий.** [tʃɛj stuˈdɛnt ˈdɔbrɪj] (This student [is] good.)

In both cases, the ending matches the noun. The rule never changes!
...
- Target: 408 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Характеристики: Опис предметів і простору": {count} words (budget: 408-408×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Характеристики: Опис предметів і простору)
