...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/describing-things-adjectives.yaml
```
...
2. Word allocations sum to **exactly 853** (the plan's word_target)
