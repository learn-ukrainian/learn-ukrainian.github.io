...
> **Your #1 job: Write 453 words for the section "Основи: Рід і число прикметників".**
...
Write the section prose for **Основи: Рід і число прикметників** within the module **Describing Things - Adjectives**.

- **WORD BUDGET**: 453 words minimum, 453 × 2 maximum. Stay in this range.
...
- Target: 453 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Основи: Рід і число прикметників": {count} words (budget: 453-453×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Основи: Рід і число прикметників)
