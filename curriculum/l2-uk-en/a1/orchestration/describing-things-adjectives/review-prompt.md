...
3. Verify with Grep: `Grep pattern="first 5-6 words" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/describing-things-adjectives.md"`
...
5. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/describing-things-adjectives-research.md`
...
unverified_terms: []
review_focus:
  - "Check that noun-adjective pairings strictly use previously taught nouns from the A1 cumulative list."
  - "Verify strict adherence to pre-verbal constraints (zero copula used instead of 'є')."
  - "Ensure no IPA or Russianisms exist in the content."
rag_tools_used:
  - "search_text: 'Adjective endings for gender' → Used Grade 3 textbook references provided in prompt."
```
...
Word count:       1670 / 1200 (139.2%)
Activities:       8
Vocabulary items: 20
Engagement boxes: 0
Immersion:        13.8% (target: 10-20%)
...
1. **[IPA_BANNED]** (severity: HIGH)
   Location: ~line 43
   Text: Banned IPA transcription: [is]
...
3. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 80
   Text: Agreement mismatch: 'гарні' (p) + 'день' (m)
   Fix: Change 'гарні' to match the gender/case of 'день', or vice versa.
4. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 81
   Text: Agreement mismatch: 'гарні' (p) + 'дівчина' (f)
   Fix: Change 'гарні' to match the gender/case of 'дівчина', or vice versa.
5. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 82
   Text: Agreement mismatch: 'нові' (p) + 'вікно' (n)
   Fix: Change 'нові' to match the gender/case of 'вікно', or vice versa.
6. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 84
   Text: Agreement mismatch: 'гарна' (f) + 'дні' (m/n/p)
   Fix: Change 'гарна' to match the gender/case of 'дні', or vice versa.
7. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 121
   Text: Agreement mismatch: 'новий' (m) + 'нова' (f)
   Fix: Change 'новий' to match the gender/case of 'нова', or vice versa.
8. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 121
   Text: Agreement mismatch: 'нова' (f) + 'нове' (n)
   Fix: Change 'нова' to match the gender/case of 'нове', or vice versa.
9. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 121
   Text: Agreement mismatch: 'нове' (n) + 'нові' (p)
   Fix: Change 'нове' to match the gender/case of 'нові', or vice versa.
...
13. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 128
   Text: Agreement mismatch: 'старий' (m) + 'місто' (n)
   Fix: Change 'старий' to match the gender/case of 'місто', or vice versa.
14. **[LOW_ENGAGEMENT]** (severity: MEDIUM)
...
15. **[ACTIVITY_VESUM_FAIL]** (severity: HIGH)
   Location: describing-things-adjectives.yaml
   Text: Activity answers contain VESUM-failed words: ий
...
**Words checked:** 127 | **VESUM coverage:** 124/127 (97.6%)
