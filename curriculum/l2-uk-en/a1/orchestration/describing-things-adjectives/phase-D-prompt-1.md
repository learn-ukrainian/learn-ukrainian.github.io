...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/describing-things-adjectives.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/describing-things-adjectives-research.md`
...
Word count:       2431 / 2000 (121.5%)
Activities:       10
Vocabulary items: 26
Engagement boxes: 7
Immersion:        38.5% (target: 35-55%)
Audit status:     FAIL
```

## Content Sections (H2 headers in the content file)

1. Розминка: Що навколо?
2. Тверда група прикметників
3. М'яка група прикметників
4. Позиція прикметника
5. Антоніми та опис об'єктів
6. Опис простору та людей
7. Практика: Діалоги
8. Практика: Мій дім
