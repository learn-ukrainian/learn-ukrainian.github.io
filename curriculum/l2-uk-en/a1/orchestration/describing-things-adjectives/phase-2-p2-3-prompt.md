...
> **Your #1 job: Write 418 words for the section "Практика: Діалоги про речі".**
...
Write the section prose for **Практика: Діалоги про речі** within the module **Describing Things - Adjectives**.

- **WORD BUDGET**: 418 words minimum, 418 × 2 maximum. Stay in this range.
...
---
**The Soft Group (-ій)** is like a soft pillow. Words like **синій** (blue) or **вечірній** (evening) feel softer.

| Type | Masculine | Feminine | Neuter | Plural |
| :--- | :--- | :--- | :--- | :--- |
| **Hard (Brick)** | **-ий** (новий) | **-а** (нова) | **-е** (нове) | **-і** (нові) |
| **Soft (Pillow)** | **-ій** (синій) | **-я** (синя) | **-є** (синє) | **-і** (сині) |

Most adjectives you learn now are "Bricks". They are hard and reliable.
...
- Target: 418 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Практика: Діалоги про речі": {count} words (budget: 418-418×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Практика: Діалоги про речі)
