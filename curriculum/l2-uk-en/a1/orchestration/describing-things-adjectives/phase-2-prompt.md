...
Write the full lesson prose for **Describing Things - Adjectives** (a1 track).
...
|---------|--------|---------------------|
| Вступ: Світ прикметників | 400 | 600 |
| Презентація: Тверда група | 600 | 900 |
| Презентація 2: М'яка група та Специфіка | 500 | 750 |
| Практика та Культурний контекст | 500 | 750 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/describing-things-adjectives.yaml`. Go through EVERY `points:` item in EVERY section:
