...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/combined-practice.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/combined-practice-research.md`
...
1. Вступ: Культура планування
2. Презентація: Структура та Причини
3. Практика: Сценарії реального життя
4. Висновок: Мій наратив
