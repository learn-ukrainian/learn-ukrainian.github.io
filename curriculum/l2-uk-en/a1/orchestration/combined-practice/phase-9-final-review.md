...
1. **Line 19**: `[pʲiˈtɪ nɑ ˈkɑwʊ]` for "каву" — the `в` is intervocalic (а-в-у), onset of the second syllable before a vowel, so it is [v], not [w]. Correct: `[ˈkɑvʊ]`.
2. **Line 86**: `[spɔˈtʃɑtkʊ]` — affricate `ч` missing tie bar. Correct: `[spɔˈt͡ʃɑtkʊ]`.
3. **Line 240**: `[jɑkˈʃtʃɔ]` — affricate in `щ` missing tie bar. Correct: `[jɑkˈʃt͡ʃɔ]`. (Status JSON confirms: "5 IPA issues".)
...
---OLD---
**піти на каву** [pʲiˈtɪ nɑ ˈkɑwʊ] (to go for coffee)
---NEW---
**піти на каву** [pʲiˈtɪ nɑ ˈkɑvʊ] (to go for coffee)
===FIX_END===
...
FILE: curriculum/l2-uk-en/a1/combined-practice.md
---OLD---
**Спочатку** [spɔˈtʃɑtkʊ] is used to introduce the very first action in your sequence.
---NEW---
**Спочатку** [spɔˈt͡ʃɑtkʊ] is used to introduce the very first action in your sequence.
===FIX_END===
...
FILE: curriculum/l2-uk-en/a1/combined-practice.md
---OLD---
we use the conditional word **якщо** [jɑkˈʃtʃɔ] (if).
---NEW---
