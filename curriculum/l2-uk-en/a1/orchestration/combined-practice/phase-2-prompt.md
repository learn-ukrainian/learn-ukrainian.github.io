...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/combined-practice-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/combined-practice.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/combined-practice.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Combined Practice** (a1 track).
...
|---------|--------|---------------------|
| Вступ: Культура планування | 450 | 675 |
| Презентація: Структура та Причини | 650 | 975 |
| Практика: Сценарії реального життя | 500 | 750 |
| Висновок: Мій наратив | 400 | 600 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/combined-practice.yaml`. Go through EVERY `points:` item in EVERY section:
