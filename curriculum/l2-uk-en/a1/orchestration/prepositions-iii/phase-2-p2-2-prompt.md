...
> **Your #1 job: Write 330 words for the section "Рух: Напрямок та Походження (Куди? Звідки?)".**
...
Write the section prose for **Рух: Напрямок та Походження (Куди? Звідки?)** within the module **Prepositions III**.
...
- ### Питання «Де?»: Ваш GPS-навігатор
  → Привіт, сусіде! Заходьте, двері відчинені. Коли ми зустрічаємося, ми завжди хочемо знати, де ми є. Уявіть, що ви дзвонит...
- ### Культура простору: Вдома
  → В Україні простір має свої правила. Коли ви заходите до мене в гості, ви перетинаєте кордон. Вулиця залишається там, за...
- ### В чи На? Контейнер проти Поверхні
  → Тепер найцікавіше. Ви питаєте «Де?», але яку відповідь ви отримаєте? Українська мова дуже логічна. Ми маємо два головних...
- ### Місцевий відмінок: Коротке нагадування
  → Ви вже знаєте це з попередніх уроків, але давайте згадаємо. Коли ми відповідаємо на питання «Де?», слово змінюється. Це...
---
...
```
===WORD_COUNTS===
Section "Рух: Напрямок та Походження (Куди? Звідки?)": {count} words (budget: 330-330×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Рух: Напрямок та Походження (Куди? Звідки?))
