...
> **Your #1 job: Write 444 words for the section "Практичні вправи".**
...
Write the section prose for **Практичні вправи** within the module **Prepositions III**.

- **WORD BUDGET**: 444 words minimum, 444 × 2 maximum. Stay in this range.
...
- ### Логіка руху: Статика і Динаміка
  → Тепер ми візьмемо цю просту карту «Вхід-Вихід» і вийдемо в місто. Ви вже знаєте, як бути в місці (статика) і як рухатися...
- ### Ваш день: Маршрут містом
  → Давайте проживемо один типовий день. Ми використаємо всі три питання: **Звідки?**, **Куди?** і **Де?**. Це ланцюжок поді...
- ### Як ми рухаємося: Йти чи Їхати
  → В англійській мові ви просто "go". Ви можете "go" пішки, машиною або літаком. В українській мові важливо знати *як саме*...
- ### Українська залізниця: Історії в купе
  → Подорож потягом — це особлива частина української культури. Потяги "Укрзалізниці" з'єднують усю країну. Люди часто прово...
- ### Діалог: Як знайти дорогу?
  → Ви в новому місті. Ви вийшли з потяга. Вам треба знайти готель або метро. Не бійтеся питати людей. Українці завжди допом...
---
...
Previously used callout types in this module: context, culture, observe, tip
...
These are the first 3 words of paragraphs from previous sections: Зверніть увагу
...
- Target: 444 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Практичні вправи": {count} words (budget: 444-444×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Практичні вправи)
