...
> **Your #1 job: Write 315 words for the section "У контексті: Місто та Подорожі".**
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/prepositions-iii-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/prepositions-iii.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/prepositions-iii.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the section prose for **У контексті: Місто та Подорожі** within the module **Prepositions III**.
...
- ### Питання «Куди?»: Рух вперед
  → Стояти на місці зручно, але іноді нам потрібен хліб або свіже повітря. Нам потрібно рухатися. Коли ми йдемо в нове місце...
- ### Питання «Звідки?»: Повернення додому
  → Ви сходили за хлібом. Тепер ви повертаєтеся. Ваш сусід бачить вас і питає: **«Звідки?»** [ˈzvidkɪ] (Where from?). Це пит...
- ### Гармонія пар: Туди і Назад
  → Українська мова любить порядок. Наші прийменники працюють у парах. Це як вхід і вихід. Якщо ви зайшли **в** (into) примі...
---
...
These are the first 3 words of paragraphs from previous sections: None yet
...
```
===WORD_COUNTS===
Section "У контексті: Місто та Подорожі": {count} words (budget: 315-315×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (У контексті: Місто та Подорожі)
