...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/a1-final-exam.md"
   ```
...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/a1-final-exam.md`
...
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/a1-final-exam.yaml`
5. **Meta** (build config): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/a1-final-exam.yaml`
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/a1-final-exam-research.md`
...
Word count:       3558 / 2000 (177.9%)
Activities:       10
Vocabulary items: 20
Engagement boxes: 4
Immersion:        37.8% (target: 35-55%)
Audit status:     PASS
```

## Content Sections (H2 headers in the content file)

1. Вступ та орієнтація
2. Морфологічний та синтаксичний огляд
3. Культурна подорож: Київ та Львів
4. Фінальне оцінювання та перехід до A2
