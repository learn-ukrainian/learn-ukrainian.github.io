...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/a1-final-exam-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/a1-final-exam.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/a1-final-exam.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **A1 Final Exam** (a1 track).
...
|---------|--------|---------------------|
| Вступ та орієнтація | 300 | 450 |
| Морфологічний та синтаксичний огляд | 650 | 975 |
| Культурна подорож: Київ та Львів | 650 | 975 |
| Фінальне оцінювання та перехід до A2 | 400 | 600 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/a1-final-exam.yaml`. Go through EVERY `points:` item in EVERY section:
