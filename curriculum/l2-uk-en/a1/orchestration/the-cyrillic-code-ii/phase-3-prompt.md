...
| Module persona | Patient Supportive Tutor, acting as Ancient Manuscript Restorer |
| Activities required | 8–12 |
| Items per activity | ≥12 |
| Required types | fill-in, match-up, quiz, true-false, group-sort, anagram |
| Priority types | match-up, anagram |
| Vocabulary items | 20 |
...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/the-cyrillic-code-ii.md
```

**Plan file** (vocabulary_hints — vocabulary list to follow):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/the-cyrillic-code-ii.yaml
```

**Meta file** (activity count targets, pedagogy):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/the-cyrillic-code-ii.yaml
```
...
**ALLOWED types (use ONLY these):** quiz, fill-in, true-false, match-up, group-sort, anagram

**FORBIDDEN types (audit will auto-FAIL if you use these):** cloze, error-correction, select, translate, unjumble
