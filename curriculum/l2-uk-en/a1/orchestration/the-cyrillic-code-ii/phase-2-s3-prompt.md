...
> **Your #1 job: Write 765 words for the section "Практичний блок: Читання та вимова".**
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/the-cyrillic-code-ii-research.md` | Factual foundation — use exhaustively |
...
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/the-cyrillic-code-ii.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the section prose for **Практичний блок: Читання та вимова** within the module **The Cyrillic Code II**.

- **Section minimum**: 255 words
- **Write at least**: 765 words (1.2x — quality over quantity)
- **Immersion**: 10-15% immersion target. Provide full transliteration in the format: слово (slovo).
...
- Г, Ґ, Ж, Ш, Щ, Ч, Ц pronunciation and mechanics.
- Є, Ї, Ю, Я iotated vowels.
- Soft sign (Ь) and its effect on consonants.
- Hard И vs Soft І distinction.
...
Previously used callout types in this module: [!tip], [!history-bite], [!myth-buster], [!observe], [!decolonization]
...
## How to Hit 765 Words (Expansion Method)
...
```
===WORD_COUNTS===
Section "Практичний блок: Читання та вимова": {count} words (minimum: 255)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Практичний блок: Читання та вимова)
