...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/taking-transport.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/taking-transport-research.md`
...
1. Вступ: Транспорт у місті
2. Презентація: Види транспорту та оплата
3. Практика: Орієнтування в місті
4. Закріплення: Подорож метром
5. Підсумок
