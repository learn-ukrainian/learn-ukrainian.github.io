...
Write the full lesson prose for **Can, Must, Want - Modals** (a1 track).
...
|---------|--------|---------------------|
| Вступ: Модальність у житті | 150 | 225 |
| Могти та Вміти: Фізична можливість і Навичка | 350 | 525 |
| Обов'язок: Треба, Потрібно, Повинен | 350 | 525 |
| Дозвіл і Заборона: Можна та Не можна | 250 | 375 |
| Порада: Варто | 150 | 225 |
| Спроба: Пробувати, Намагатися | 150 | 225 |
| Характеристика: Необхідний, Обов'язковий, Можливий | 150 | 225 |
| Контекст: Правила та Плани | 150 | 225 |
| Практика: Дозвіл та Етикет | 150 | 225 |
| Практика: Мої можливості та Обов'язки | 150 | 225 |
| **Total** | **2000** | **3000** |
