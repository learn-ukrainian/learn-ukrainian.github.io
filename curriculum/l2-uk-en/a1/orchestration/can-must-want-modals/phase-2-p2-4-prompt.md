...
> **Your #1 job: Write 454 words for the section "Практичне застосування: Діалоги та Ситуації".**
...
Write the section prose for **Практичне застосування: Діалоги та Ситуації** within the module **Can, Must, Want - Modals**.

- **WORD BUDGET**: 454 words minimum, 454 × 2 maximum. Stay in this range.
...
Previously used callout types in this module: culture, myth-buster, observe, quote, tip, warning
...
- Target: 454 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Практичне застосування: Діалоги та Ситуації": {count} words (budget: 454-454×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Практичне застосування: Діалоги та Ситуації)
