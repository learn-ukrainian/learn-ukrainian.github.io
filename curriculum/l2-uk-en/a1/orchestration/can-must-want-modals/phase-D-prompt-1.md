...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/can-must-want-modals.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/can-must-want-modals-research.md`
...
Word count:       2452 / 2000 (122.6%)
Activities:       8
Vocabulary items: 15
Engagement boxes: 6
Immersion:        43.6% (target: 35-55%)
Audit status:     FAIL
```

## Content Sections (H2 headers in the content file)

1. Вступ: Модальність у житті
2. Могти та Вміти: Фізична можливість і Навичка
3. Обов'язок: Треба, Потрібно, Повинен
4. Дозвіл і Заборона: Можна та Не можна
5. Порада: Варто
6. Спроба: Пробувати, Намагатися
7. Характеристика: Необхідний, Обов'язковий, Можливий
8. Контекст: Правила та Плани
9. Практика: Дозвіл та Етикет
10. Практика: Мої можливості та Обов'язки
