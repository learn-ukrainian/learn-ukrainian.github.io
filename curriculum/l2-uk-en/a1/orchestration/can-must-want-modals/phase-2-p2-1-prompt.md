...
> **Your #1 job: Write 310 words for the section "Могти та Вміти: Ваші перші кроки".**
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/can-must-want-modals-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/can-must-want-modals.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/can-must-want-modals.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the section prose for **Могти та Вміти: Ваші перші кроки** within the module **Can, Must, Want - Modals**.

- **WORD BUDGET**: 310 words minimum, 310 × 2 maximum. Stay in this range.
...
- Target: 310 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Могти та Вміти: Ваші перші кроки": {count} words (budget: 310-310×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Могти та Вміти: Ваші перші кроки)
