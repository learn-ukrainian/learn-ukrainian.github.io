...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/can-and-know-how-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/can-and-know-how.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/can-and-know-how.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Can and Know How** (a1 track).
...
| Могти | 500 | 750 |
| Вміти | 400 | 600 |
| Можна та не можна | 400 | 600 |
| Контрастні заперечення | 350 | 525 |
| Практика | 350 | 525 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/can-and-know-how.yaml`. Go through EVERY `points:` item in EVERY section:
