...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/syllables-and-transfer-research.md` | Factual foundation — use exhaustively |
...
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/syllables-and-transfer.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Syllables and Transfer** (a1 track).
...
|---------|--------|---------------------|
| Що таке склад? | 400 | 600 |
| Типи складів | 400 | 600 |
| Правила переносу | 500 | 750 |
| Наголос і склади | 400 | 600 |
| Практика | 300 | 450 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/syllables-and-transfer.yaml`. Go through EVERY `points:` item in EVERY section:
