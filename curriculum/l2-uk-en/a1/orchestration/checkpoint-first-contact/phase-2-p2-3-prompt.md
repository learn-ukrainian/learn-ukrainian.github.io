...
> **Your #1 job: Write 570 words for the section "Комунікація: Питальні речення та замовлення в кафе".**
...
Write the section prose for **Комунікація: Питальні речення та замовлення в кафе** within the module **Checkpoint: First Contact**.

- **WORD BUDGET**: 570 words minimum, 570 × 2 maximum. Stay in this range.
...
### Topics Covered:\n- The Conjugation Master Class\n- Core Verbs Drill\n- The Plural Trap (-уть vs -ать)\n- Building Sentences: Subject and Predicate\n\n### Last Paragraphs:\nNow that we have our verbs ready, let's put them into sentences. A sentence needs two heroes: a **підмет** (subject) and a **присудок** (predicate). The subject is the 'doer', and the predicate is the 'action'. In Ukrainian, they must agree in number and person. It is like a handshake between words.\n\n*   **Студент читає.** (The student reads.)\n*   **Ми говоримо.** (We speak.)\n*   **Вони знають.** (They know.)
...
Previously used callout types in this module: tip, warning, note
...
- Target: 570 words. Ceiling: 2× that number.
...
## Комунікація: Питальні речення та замовлення в кафе
...
```
===WORD_COUNTS===
Section "Комунікація: Питальні речення та замовлення в кафе": {count} words (budget: 570-570×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Комунікація: Питальні речення та замовлення в кафе)
