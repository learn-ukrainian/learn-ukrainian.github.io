...
> **Persona reminder:** You are full-rebuild-core-a. Write in the voice of The Helpful Neighbor: Patient Supportive Tutor. Maintain this persona throughout — do not drift into generic AI tone.

> **Your #1 job: Write 315 words for the section "Дієвідмінювання дієслів теперішнього часу".**
...
| File | Purpose |
|------|---------|
| `curriculum/l2-uk-en/a1/research/checkpoint-first-contact-research.md` | Factual foundation — use exhaustively |
| `curriculum/l2-uk-en/a1/meta/checkpoint-first-contact.yaml` | Content outline with section word allocations |
| `curriculum/l2-uk-en/plans/a1/checkpoint-first-contact.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the section prose for **Дієвідмінювання дієслів теперішнього часу** within the module **Checkpoint: First Contact**.

- **WORD BUDGET**: 315 words minimum, 315 × 2 maximum. Stay in this range.
...
HARD GRAMMAR RULES (audit will reject violations): - Max 10 words per Ukrainian sentence (STRICT — count every word) - ONLY 1 clause per sentence (no compound sentences) - Dative case FORBIDDEN (no мені, тобі, йому, їй, нам, вам, їм, -ові/-еві endings) - Instrumental case FORBIDDEN (no з другом, з мамою, -ом/-ою/-ем/-ею endings) - NO subordinate clauses: який/яка/яке, що-clause, коли, якщо, тому що, бо, щоб, поки are ALL BANNED - Only imperfective aspect verbs - No participles - Allowed cases: Nominative, Accusative, Locative (from M13), Genitive (basics), Vocative
...
### Topics Covered:\n- The Alphabet Challenge\n- Reading Without Training Wheels\n- The Gender Sorting Hat\n- Biological Exceptions\n\n### Last Paragraphs:\nIn Ukrainian, grammatical gender is strict, but life is richer. Sometimes, a word's ending doesn't match its meaning. We call these «biological exceptions.» Words like **тато** (dad), **батько** (father), or names like **Михайло** end in **-о**, which usually signals neuter gender. But a dad is definitely masculine! These words take masculine adjectives because they refer to men. It is a victory of biology over grammar.\n\n*   **Мій тато** (My dad) — Masculine agreement.\n*   **Добрий батько** (Good father) — Masculine agreement.
...
Previously used callout types in this module: tip, warning
...
- Target: 315 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Дієвідмінювання дієслів теперішнього часу": {count} words (budget: 315-315×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Дієвідмінювання дієслів теперішнього часу)
