...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/checkpoint-first-contact-research.md` | Factual foundation — use exhaustively |
...
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/checkpoint-first-contact.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Checkpoint: First Contact** (a1 track).
...
|---------|--------|---------------------|
| Огляд | 200 | 300 |
| Навичка 1: Читання та рід | 500 | 750 |
| Навичка 2: Дієслова та питання | 600 | 900 |
| Культурний контекст: Кафе | 400 | 600 |
| Інтеграційне завдання | 300 | 450 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/checkpoint-first-contact.yaml`. Go through EVERY `points:` item in EVERY section:
