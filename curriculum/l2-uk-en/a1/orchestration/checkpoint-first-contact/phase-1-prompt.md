...
```
curriculum/l2-uk-en/a1/research/checkpoint-first-contact-research.md
```
...
```
curriculum/l2-uk-en/a1/meta/checkpoint-first-contact.yaml
```
...
2. Word allocations sum to **exactly 875** (the plan's word_target)
