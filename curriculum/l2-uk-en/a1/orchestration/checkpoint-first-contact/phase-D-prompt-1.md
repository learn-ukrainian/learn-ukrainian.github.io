...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/checkpoint-first-contact.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/checkpoint-first-contact-research.md`
...
1. Огляд та мета
2. Skill 1: Читання кирилиці
3. Skill 2: Визначення роду
4. Skill 3: Дієвідміна
5. Skill 4: Питальні речення
6. Skill 5: Замовлення їжі
