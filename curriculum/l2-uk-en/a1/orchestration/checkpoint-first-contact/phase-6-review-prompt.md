...
1. **Content** (the lesson you're reviewing): `curriculum/l2-uk-en/a1/checkpoint-first-contact.md`
2. **Activities**: `curriculum/l2-uk-en/a1/activities/checkpoint-first-contact.yaml`
3. **Vocabulary**: `curriculum/l2-uk-en/a1/vocabulary/checkpoint-first-contact.yaml`
4. **Plan** (source of truth for scope): `curriculum/l2-uk-en/plans/a1/checkpoint-first-contact.yaml`
5. **Meta** (build config): `curriculum/l2-uk-en/a1/meta/checkpoint-first-contact.yaml`
6. **Research notes** (if exists): `curriculum/l2-uk-en/a1/research/checkpoint-first-contact-research.md`
...
```
Word count:       {AUDIT_WORD_COUNT} / 875 ({WORD_PERCENT}%)
...
At module 10, students know ONLY modules 1-{PREV_MODULE}. Any grammar from later modules is scope creep.
