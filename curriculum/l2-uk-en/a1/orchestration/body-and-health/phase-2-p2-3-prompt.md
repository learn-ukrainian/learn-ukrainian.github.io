...
> **Your #1 job: Write 513 words for the section "Практика: Діалоги про здоров'я".**
...
Write the section prose for **Практика: Діалоги про здоров'я** within the module **Body & Health**.

- **WORD BUDGET**: 513 words minimum, 513 × 2 maximum. Stay in this range.
...
- ### Аптека (The Pharmacy)
  → Отже, ви знаєте симптоми. Ви кажете: «У мене температура». Тепер час діяти. Коли українці хворіють, вони йдуть у місце з...
- ### Ліки (Medicines)
  → В аптеці ви купуєте **ліки** [ˈlʲikɪ] (medicines). Це слово завжди в множині, як "glasses" або "scissors" в англійській...
- ### Що робити вдома? (What to do at home?)
  → Ви купили ліки і прийшли додому. Ваш сусід або лікар дає вам пораду. Лікування — це не тільки таблетки. Це також режим д...
---
...
These are the first 3 words of paragraphs from previous sections: **«У здоровому тілі | **Вона п'є воду.** | **Вони купують вітаміни.** | **Лікар каже: ми | **Ми купуємо сироп.** | **Ти відпочиваєш вдома.** | **Я купую таблетку.** | Іноді лікування дуже | Але якщо слово | Англійською ми кажемо | В аптеці ви | В українській мові | Ваш діалог в | Ви купили ліки | Для цього ми | Запам’ятайте ці слова, | Зверніть увагу на | Зверніть увагу: слово | Коли ви говорите | Коли ви хворієте, | Конструкція дуже проста: | Ось найпопулярніші форми | Отже, ви знаєте | Подивіться на ці | Також дуже важливо | Тут все просто, | Уявіть, що ви | Це означає, що
...
- Target: 513 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Практика: Діалоги про здоров'я": {count} words (budget: 513-513×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Практика: Діалоги про здоров'я)
