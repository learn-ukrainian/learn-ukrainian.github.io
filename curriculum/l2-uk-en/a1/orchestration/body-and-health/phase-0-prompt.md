...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/body-and-health.yaml
```

Read the meta file:

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/body-and-health.yaml
```
...
Research **Body & Health** for the **A1** core track. Core tracks need lighter research than seminar tracks — focus on accuracy and State Standard alignment.
