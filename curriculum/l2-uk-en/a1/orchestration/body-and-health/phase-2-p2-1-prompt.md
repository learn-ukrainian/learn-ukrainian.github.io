...
> **Your #1 job: Write 376 words for the section "Частини тіла та симптоми: Що болить?".**
...
Write the section prose for **Частини тіла та симптоми: Що болить?** within the module **Body & Health**.
...
```
===WORD_COUNTS===
Section "Частини тіла та симптоми: Що болить?": {count} words (budget: 376-376×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Частини тіла та симптоми: Що болить?)
