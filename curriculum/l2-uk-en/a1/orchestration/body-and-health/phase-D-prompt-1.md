...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/body-and-health.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/body-and-health-research.md`
...
Vocabulary items: 22
Engagement boxes: 5
Immersion:        35.6% (target: 35-55%)
Audit status:     FAIL
```

## Content Sections (H2 headers in the content file)

1. Розминка: Частини тіла
2. Граматика: Конструкція «У мене болить...»
3. Лексика: Здоров'я
4. Лексика: В аптеці
5. Ситуація: У лікаря
6. Практикум: Діалоги про здоров'я
