...
Write the full lesson prose for **Body & Health** (a1 track).
...
|---------|--------|---------------------|
| Вступ: Частини тіла та народна мудрість | 400 | 600 |
| Презентація: Як ми говоримо про біль | 600 | 900 |
| Діалог: У лікаря та в аптеці | 500 | 750 |
| Практика: Пояснення причин | 500 | 750 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/body-and-health.yaml`. Go through EVERY `points:` item in EVERY section:
