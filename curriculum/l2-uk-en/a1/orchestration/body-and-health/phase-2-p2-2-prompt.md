...
> **Your #1 job: Write 340 words for the section "В аптеці та у лікаря: Лікування".**
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/body-and-health-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/body-and-health.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/body-and-health.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the section prose for **В аптеці та у лікаря: Лікування** within the module **Body & Health**.

- **WORD BUDGET**: 340 words minimum, 340 × 2 maximum. Stay in this range.
...
- ### Основні частини тіла
  → Уявіть, що ви прокинулися і відчуваєте дискомфорт. Щоб пояснити проблему лікарю або другу, вам потрібно знати назви част...
- ### Конструкція «У мене болить...»
  → В англійській мові ми кажемо "I have a headache". Українська логіка інша. Ми не "маємо" біль, біль "існує" у нас. Дослів...
- ### Однина і множина: Болить чи Болять?
  → Оскільки частина тіла — це суб’єкт, дієслово мусить узгоджуватися з нею. Якщо болить щось одне, ми кажемо **болить**. Як...
- ### Загальний стан: Мені погано
  → Іноді у вас нічого не болить конкретно, але ви почуваєтеся жахливо. Для цього ми використовуємо конструкцію з Давальним...
...
These numbers/measurements have already appeared in previous sections: None yet
...
These are the first 3 words of paragraphs from previous sections: **«У здоровому тілі | Англійською ми кажемо | Запам’ятайте ці слова, | Зверніть увагу на | Конструкція дуже проста: | Тут все просто, | Це означає, що
...
These biographical details have appeared in previous `[!biography]` callouts or prose: None yet
...
- Target: 340 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "В аптеці та у лікаря: Лікування": {count} words (budget: 340-340×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (В аптеці та у лікаря: Лікування)
