...
Write the full lesson prose for **What Time Is It?** (a1 track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Презентація часу | 600 | 900 |
| Дні та місяці | 600 | 900 |
| Практика та розклад | 400 | 600 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/what-time-is-it.yaml`. Go through EVERY `points:` item in EVERY section:
