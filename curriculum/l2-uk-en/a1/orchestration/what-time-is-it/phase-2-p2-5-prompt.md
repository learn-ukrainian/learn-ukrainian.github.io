...
> **Your #1 job: Write 138 words for the section "Прийменники часу".**
...
Write the section prose for **Прийменники часу** within the module **What Time Is It?**.

- **WORD BUDGET**: 138 words minimum, 138 × 2 maximum. Stay in this range.
...
Previously used callout types in this module: culture, fact, myth-buster, observe, tip, warning
...
- Target: 138 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Прийменники часу": {count} words (budget: 138-138×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Прийменники часу)
