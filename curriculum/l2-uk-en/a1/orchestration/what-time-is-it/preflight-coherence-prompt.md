You are a curriculum reviewer checking whether a content generation prompt correctly implements its plan.
...
**Cumulative vocabulary (301 words):**
...
Write **What Time Is It?** for the a1 track.
...
### Workflow
1. **Research first**: `search_text("Clock time expressions (Котра година?) Time prepositions (о, до, після)", grade=3-5)` — find how textbooks teach this
