...
> **Your #1 job: Write 184 words for the section "Місяці та пори року".**
...
Write the section prose for **Місяці та пори року** within the module **What Time Is It?**.

- **WORD BUDGET**: 184 words minimum, 184 × 2 maximum. Stay in this range.
...
- Target: 184 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Місяці та пори року": {count} words (budget: 184-184×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Місяці та пори року)
