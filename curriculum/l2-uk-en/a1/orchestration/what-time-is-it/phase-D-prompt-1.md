...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/what-time-is-it.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/what-time-is-it-research.md`
...
Word count:       2625 / 2000 (131.2%)
Activities:       10
Vocabulary items: 22
Engagement boxes: 11
Immersion:        38.8% (target: 35-55%)
Audit status:     FAIL
```
...
1. Warm-up
2. Presentation: The Clock Face
3. Days of the Week
4. Months of the Year
5. Time Prepositions
6. Presentation 2: Daily Schedules
7. Practice
