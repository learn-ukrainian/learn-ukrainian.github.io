...
> **Your #1 job: Write 115 words for the section "Дні тижня".**
...
Write the section prose for **Дні тижня** within the module **What Time Is It?**.

- **WORD BUDGET**: 115 words minimum, 115 × 2 maximum. Stay in this range.
...
Previously used callout types in this module: culture, fact, observe, tip, warning
...
- Target: 115 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Дні тижня": {count} words (budget: 115-115×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Дні тижня)
