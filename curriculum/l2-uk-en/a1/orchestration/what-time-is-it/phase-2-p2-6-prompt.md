...
> **Your #1 job: Write 390 words for the section "Укрзалізниця: Розклад і подорожі".**
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/what-time-is-it-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/what-time-is-it.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/what-time-is-it.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the section prose for **Укрзалізниця: Розклад і подорожі** within the module **What Time Is It?**.

- **WORD BUDGET**: 390 words minimum, 390 × 2 maximum. Stay in this range.
...
Previously used callout types in this module: culture, fact, important, myth-buster, observe, tip, warning
...
- Target: 390 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Укрзалізниця: Розклад і подорожі": {count} words (budget: 390-390×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Укрзалізниця: Розклад і подорожі)
