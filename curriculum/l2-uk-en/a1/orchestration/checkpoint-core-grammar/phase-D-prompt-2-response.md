...
===SECTION_FIX_START===
FILE: /Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/checkpoint-core-grammar.md
---
FIND:
«(for example, **плачу** — *I pay* vs **плачу** — *I cry*).»
REPLACE:
«(for example, **плачу́** — *I pay* vs **пла́чу** — *I cry*).»
---
FIND:
«Words ending in soft sign **-ь** can be masculine (день, тато) or feminine (ніч, сіль).»
REPLACE:
«Words ending in soft sign **-ь** can be masculine (день, вчитель) or feminine (ніч, сіль).»
---
FIND:
«*   Я йду **в парк**. (Банк — unchanged, because inanimate, masc. gender)»
REPLACE:
«*   Я йду **в парк**. (Парк — unchanged, because inanimate, masc. gender)»
---
FILE: /Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/activities/checkpoint-core-grammar.yaml
---
FIND:
...
REPLACE:
«  title: 'Напрямок чи Місце (Закінчення)'»
---
===SECTION_FIX_END===
