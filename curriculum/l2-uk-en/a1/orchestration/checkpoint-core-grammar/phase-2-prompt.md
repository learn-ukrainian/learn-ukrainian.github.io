...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/checkpoint-core-grammar-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/checkpoint-core-grammar.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/checkpoint-core-grammar.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Checkpoint: Core Grammar** (a1 track).
...
|---------|--------|---------------------|
| Огляд: Граматичний чекпоінт | 200 | 300 |
| Навичка 1: Читання та вимова | 300 | 450 |
| Навичка 2: Рід та узгодження | 300 | 450 |
| Навичка 3: Система дієслів | 400 | 600 |
| Навичка 4: Система відмінків | 400 | 600 |
| Навичка 5: Практичні ситуації | 250 | 375 |
| Інтеграційне завдання | 150 | 225 |
| **Total** | **2000** | **3000** |
