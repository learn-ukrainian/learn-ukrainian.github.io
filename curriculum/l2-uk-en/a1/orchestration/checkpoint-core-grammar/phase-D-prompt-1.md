...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/checkpoint-core-grammar.md"
   ```
...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/checkpoint-core-grammar.md`
2. **Activities**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/activities/checkpoint-core-grammar.yaml`
3. **Vocabulary**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/vocabulary/checkpoint-core-grammar.yaml`
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/checkpoint-core-grammar.yaml`
5. **Meta** (build config): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/checkpoint-core-grammar.yaml`
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/checkpoint-core-grammar-research.md`
...
Module persona:   Patient Supportive Tutor, acting as University Dean
Word count:       2436 / 2000 (121.8%)
Activities:       8
Vocabulary items: 8
Engagement boxes: 5
Immersion:        14.7% (target: 35-55%)
Audit status:     FAIL
```

## Content Sections (H2 headers in the content file)

1. Огляд: Граматичний чекпоінт
2. Навичка 1: Читання та вимова
3. Навичка 2: Рід та узгодження
4. Навичка 3: Система дієслів
5. Навичка 4: Система відмінків
6. Навичка 5: Практичні ситуації
7. Інтеграційне завдання
8. Підсумок
9. Vocabulary
