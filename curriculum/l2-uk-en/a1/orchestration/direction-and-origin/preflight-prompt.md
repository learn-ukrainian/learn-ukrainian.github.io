...
звідки, немає, мене, тебе, красивий, маленький
...
Write **Direction and Origin** for the a1 track.
...
### Workflow
1. **Research first**: `search_text("Direction prepositions + Accusative До + Genitive", grade=3-5)` — find how textbooks teach this
