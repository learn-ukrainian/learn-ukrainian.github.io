...
**What:** Imperative 'ідіть' (VESUM: verb:imperf:impr:p:2) — imperatives not taught until M47.
**How to fix:** Replace 'ідіть' with English instruction. E.g., use 'Remember that...' instead of Ukrainian imperatives.
**Where:** ~line 88
...
**What:** Activity answers contain VESUM-failed words: Києва, Одеси
**How to fix:** Fix spelling or replace these words — students will practice non-existent forms.
**Where:** direction-and-origin.yaml

### Fix: Gate `Naturalness` FAIL — Not scored
