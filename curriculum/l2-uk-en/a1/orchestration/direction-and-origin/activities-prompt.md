...
| Module persona | Patient Supportive Tutor, acting as Train Conductor |
...
**Grade 3, ponomarova** — Сторінка 145:
```
145
7. Прочитай у довідці назви цікавих місць Києва. Вибери,
де тобі хотілося б побувати. Поясни чому. Напиши про
це текст-міркування за поданим твердженням. 
Довідка: цирк, зоопарк, ляльковий театр, 
Музей  води,  океанаріум,  аквапарк.
7
Я хочу відвідати … .
8. Прочитай текст і визнач його тип. Утвори з цього тексту 
міркування, придумавши твердження і висновок. Можеш 
скористатися словами з довідки. Запиши утворений 
текст. 
Під час екскурсій ми відкриваємо для себе багато 
нового й цікавого.
```

**Grade 3, ponomarova** — Сторінка 126:
```
126
...
У множині прикметники н
```

**Grade 3, ponomarova** — Сторінка 98:
```
98
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/direction-and-origin.md` | Lesson content to test/reinforce |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/direction-and-origin.yaml` | vocabulary_hints |
