...
3. Verify with Grep: `Grep pattern="first 5-6 words" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/direction-and-origin.md"`
...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/direction-and-origin.md`
2. **Activities**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/activities/direction-and-origin.yaml`
3. **Vocabulary**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/vocabulary/direction-and-origin.yaml`
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/direction-and-origin.yaml`
5. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/direction-and-origin-research.md`
...
deviations:
  - section: "До + Родовий"
    reason: "Replaced 'Я іду в лікарню' with 'Я іду в аптеку' because 'лікарня' is not in the cumulative A1 vocabulary, but 'аптека' is. The semantic contrast (building vs person) is preserved perfectly."
  - section: "Звідки? + Родовий"
    reason: "Replaced 'лист від мами' with 'книжка від мами' / 'кава від брата' in content and activities, as 'лист' and 'подарунок' are not yet strictly taught in the cumulative A1 list."
frictions: []
research_gaps: []
unverified_terms: []
review_focus:
  - "Check euphony rules (з/із/зі) formatting and accuracy."
  - "Verify strict adherence to single clause constraints and known vocabulary."
rag_tools_used: []
```
...
Word count:       1738 / 1200 (144.8%)
Activities:       4
Vocabulary items: 20
Engagement boxes: 0
Immersion:        11.9% (target: 20-35%)
Richness:         65% (threshold: 60%)
Richness gaps:    engagement: 0/2, video_embeds: 1/2
Audit status:     FAIL
```
...
1. **[IPA_BANNED]** (severity: HIGH)
   Location: ~line 120
   Text: Banned IPA transcription: [Watch on YouTube]
...
2. **[ACTIVITY_VESUM_FAIL]** (severity: HIGH)
   ...
   Text: Activity answers contain VESUM-failed words: Києва, Львова
...
**Words checked:** 84 | **VESUM coverage:** 78/84 (92.9%)
