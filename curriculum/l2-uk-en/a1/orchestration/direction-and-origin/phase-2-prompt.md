...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/direction-and-origin-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/direction-and-origin.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/direction-and-origin.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Direction and Origin** (a1 track).
...
|---------|--------|---------------------|
| Куди? + Знахідний | 500 | 750 |
| До + Родовий | 400 | 600 |
| Звідки? + Родовий | 400 | 600 |
| Три питання | 400 | 600 |
| Практика | 300 | 450 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/direction-and-origin.yaml`. Go through EVERY `points:` item in EVERY section:
