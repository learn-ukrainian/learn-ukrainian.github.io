...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/orchestration/my-family/phase-5-response.md
```

**Current content** (the file you are fixing):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/32-my-family.md
```

**Current activities** (fix if review mentions activity issues):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/activities/32-my-family.yaml
```

**Current vocabulary** (fix if review mentions vocabulary issues):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/vocabulary/32-my-family.yaml
```

**Plan file** (source of truth for scope — check if fixes align):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/32-my-family.yaml
```
