...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/my-family-research.md
```

Read the **plan file** (SOURCE OF TRUTH for structure, objectives, vocabulary):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/my-family.yaml
```

Read the **old meta file** (for reference only — you are REPLACING the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/my-family.yaml
```
...
2. Word allocations sum to approximately **750** (the level's word target, provided by the build system)
...
- Allocations should sum to approximately 750 words (±10% is acceptable)
