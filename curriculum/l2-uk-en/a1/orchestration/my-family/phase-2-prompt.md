...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/my-family-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/my-family.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/my-family.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
|---------|--------|---------------------|
| Вступ: Моя сім'я | 400 | 600 |
| Презентація: Близька та розширена родина | 600 | 900 |
| Презентація: Характеристики та стосунки | 500 | 750 |
| Практика: Звертання та спілкування | 500 | 750 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/my-family.yaml`. Go through EVERY `points:` item in EVERY section:
