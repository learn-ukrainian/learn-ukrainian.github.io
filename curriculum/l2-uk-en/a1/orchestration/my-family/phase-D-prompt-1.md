...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/my-family.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/my-family-research.md`
...
1. Розминка: Члени сім'ї (Warm-up: Family Members)
2. Близька та розширена родина (Close and Extended Family)
3. Опис родини: Вік та характер (Describing Family: Age & Character)
4. Практика: Моя сім'я (Practice: My Family)
5. Діалоги та фотоальбом
6. Підсумок: Розповідь про себе (Summary)
