...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/imperative-and-requests-research.md` | Factual foundation — use exhaustively |
...
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/imperative-and-requests.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Imperative and Requests** (a1 track).
...
|---------|--------|---------------------|
| Наказовий спосіб | 500 | 750 |
| Вісім обов'язкових дієслів | 500 | 750 |
| Ввічливе прохання | 400 | 600 |
| Заборони | 300 | 450 |
| Практика | 300 | 450 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/imperative-and-requests.yaml`. Go through EVERY `points:` item in EVERY section:
