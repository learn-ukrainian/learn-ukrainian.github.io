        # Fix ALL 1 issue(s) in `food-vocabulary`
...
**What:** Agreement mismatch: 'Льві́вська' (f) + 'лимо́н' (m)
**How to fix:** Change 'Льві́вська' to match the gender/case of 'лимо́н', or vice versa.
**Where:** ~line 73
