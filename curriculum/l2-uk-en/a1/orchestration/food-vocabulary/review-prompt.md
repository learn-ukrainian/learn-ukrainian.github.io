...
3. Verify with Grep: `Grep pattern="first 5-6 words" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/food-vocabulary.md"`
...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/food-vocabulary.md`
2. **Activities**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/activities/food-vocabulary.yaml`
3. **Vocabulary**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/vocabulary/food-vocabulary.yaml`
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/food-vocabulary.yaml`
5. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/food-vocabulary-research.md`
...
deviations:
  - section: "None"
    reason: "Followed the outline strictly."
frictions: []
research_gaps: []
unverified_terms: []
review_focus:
  - "Check that formatting of rules matches standard practices (no IPA, just stress marks)."
  - "Verify all 16 target vocabulary words appear in the text and vocabulary YAML."
  - "Check that distractors in the activities are strictly VESUM-verified real Ukrainian words."
rag_tools_used:
  - "search_text: 'Food noun gender Я не їм construction' → Grade 1 & Grade 2 textbook excerpts on food and syllables"
```
...
Module persona:   Patient Supportive Tutor, acting as Ukrainian Chef
Word count:       1656 / 1200 (138.0%)
Activities:       7
Vocabulary items: 20
Engagement boxes: 0
Immersion:        15.5% (target: 20-35%)
Richness:         66% (threshold: 60%)
...
1. Їжа (Food)
2. Напої (Drinks)
3. Паляниця (The Shibboleth Bread)
4. Мені подобається / Я не їм (Preferences)
5. Практика (Practice)
...
**Words checked:** 101 | **VESUM coverage:** 99/101 (98.0%)
