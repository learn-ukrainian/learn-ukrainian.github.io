...
```
📚 IMMERSION TOO LOW (15.3% vs 20-35% target)
--- STRICT GATES (Level A1) ---
Pedagogy     ❌ 1 violations
Immersion    ❌ 15.3% LOW (target 20-35% (M39))
...
Notice how the endings change? Masculine adjectives end in **-ий** or **-ій**, feminine in **-а** or **-я**, and neuter in **-е** or **-о**. This is exactly what you practiced in earlier lessons, now applied to your dinner plate!
...
- type: quiz
  ...
  items:
    ...
    - question: "Which adjective form correctly matches the feminine noun каша?"
      options:
        - text: "гаряча каша"
          correct: true
        - text: "гарячий каша"
        ...
        - text: "гарячі каша"
          correct: false
      explanation: "Каша is feminine, so the adjective takes the feminine ending -а: гаряча каша."
