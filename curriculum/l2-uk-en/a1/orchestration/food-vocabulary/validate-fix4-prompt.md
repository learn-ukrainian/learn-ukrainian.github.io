...
**Context (line 139):** `Вивчімо назви найвідоміших та найпопулярніших напоїв. Вони будуть потрібні вам щодня у будь-якому місті. Запам'ятайте їхній граматичний рід.`
...
**How to fix:** Replace imperative verbs with English instructions or simple noun phrases. E.g. 'Слухайте уважно!' → 'Listen carefully!' or 'Listening practice:'
**Context (line 326):** `Зараз настав ідеальний час для вашої активної практики. Використовуйте всі нові слова у реальних ситуаціях. Ми багато вивчили сьогодні. Повторення допомагає запам'ятати нові слова. Ви будете говорити дуже впевнено.`
...
**How to fix:** Replace imperative verbs with English instructions or simple noun phrases. E.g. 'Слухайте уважно!' → 'Listen carefully!' or 'Listening practice:'
**Context (line 332):** `Уявіть дуже популярний український ресторан. Ви щойно зайшли туди. Ви уважно читаєте їхнє гарне меню.`

### Fix 4: PEDAGOGICAL
**What:** [NO_IMPERATIVES_EARLY_A1] 'згадайте' — Imperative verb forms should not appear in early A1 modules (M1-46). Students haven't learned verb conjugation yet.
**How to fix:** Replace imperative verbs with English instructions or simple noun phrases. E.g. 'Слухайте уважно!' → 'Listen carefully!' or 'Listening practice:'
**Context (line 348):** `Коли ви дивитеся на це меню, згадайте граматичний рід. Це дуже чудове тренування. Зробіть замовлення у своїй голові. Змініть закінчення для жіночого роду.`

### Fix 5: PEDAGOGICAL
**What:** [NO_IMPERATIVES_EARLY_A1] 'Зробіть' — Imperative verb forms should not appear in early A1 modules (M1-46). Students haven't learned verb conjugation yet.
**How to fix:** Replace imperative verbs with English instructions or simple noun phrases. E.g. 'Слухайте уважно!' → 'Listen carefully!' or 'Listening practice:'
**Context (line 348):** `Коли ви дивитеся на це меню, згадайте граматичний рід. Це дуже чудове тренування. Зробіть замовлення у своїй голові. Змініть закінчення для жіночого роду.`
...
This module is 4552 words. Fix ONLY sections: "Мені подобається / Я не їм (Preferences)", "Напої (Drinks)"
