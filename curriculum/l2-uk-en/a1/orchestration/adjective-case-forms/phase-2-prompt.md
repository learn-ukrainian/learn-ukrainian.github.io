...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/adjective-case-forms-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/adjective-case-forms.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/adjective-case-forms.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Adjective Case Forms** (a1 track).
...
|---------|--------|---------------------|
| Прикметник у Знахідному (Adj in Accusative) | 500 | 750 |
| Прикметник у Місцевому (Adj in Locative) | 500 | 750 |
| Порівняння форм (Comparing forms) | 400 | 600 |
| Типові помилки (Common errors) | 300 | 450 |
| Практика (Practice) | 300 | 450 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/adjective-case-forms.yaml`. Go through EVERY `points:` item in EVERY section:
