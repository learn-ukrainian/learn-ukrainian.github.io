...
3. Verify with Grep: `Grep pattern="first 5-6 words" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/adjective-case-forms.md"`
...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/adjective-case-forms.md`
2. **Activities**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/activities/adjective-case-forms.yaml`
3. **Vocabulary**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/vocabulary/adjective-case-forms.yaml`
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/adjective-case-forms.yaml`
5. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/adjective-case-forms-research.md`
...
unverified_terms: []
review_focus:
  - "Checked adherence to structural containers for Ukrainian sentences to ensure A1 immersion compliance."
  - "Verified A1 vocabulary limits and replaced unknown verbs or distractors with known forms in activities."
  - "Confirmed required H2 headers are used exactly as outlined."
rag_tools_used: []
```
...
Word count:       2036 / 1200 (169.7%)
Activities:       4
Vocabulary items: 20
Engagement boxes: 4
Immersion:        16.0% (target: 15-30%)
...
1. Прикметник у Знахідному (Adj in Accusative)
2. Прикметник у Місцевому (Adj in Locative)
3. Порівняння форм (Comparing forms)
4. Типові помилки (Common errors)
5. Практика (Practice)
...
1. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 40
   Text: Agreement mismatch: 'нову' (f) + 'беру' (m)
   Fix: Change 'нову' to match the gender/case of 'беру', or vice versa.
2. **[ACTIVITY_VESUM_FAIL]** (severity: HIGH)
   Location: adjective-case-forms.yaml
   Text: Activity answers contain VESUM-failed words: ій
...
**Words checked:** 154 | **VESUM coverage:** 151/154 (98.1%)
