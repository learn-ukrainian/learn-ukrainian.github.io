...
> **Your #1 job: Write 315 words for the section "Навичка 4: Присвійні займенники".**
...
Write the section prose for **Навичка 4: Присвійні займенники** within the module **Checkpoint: Navigation**.
...
---
### Check Your Skills
Now it is time for a quick self-check. **Це ваша перевірка** (This is your check). Can you describe your current situation? Think about the items in your bag or your location. Use the Genitive case to answer these questions. This helps you see if you are ready for the next level. **Ви великий молодець** (You are a great fellow)!

*Спробуйте відповісти (Try to answer):*
1. Де ви зараз? — [dɛ ʋɪ ˈzaraz] (Where are you now?)
2. Чого у вас немає? — [tʃɔˈɦɔ u ʋas nɛˈmajɛ] (What do you not have?)

If you can say **«Я з Лондона»** or **«У мене немає квитка»**, you are doing great! These patterns are the foundation of navigating any Ukrainian city. **Ви знаєте ці правила** (You know these rules). **Бажаю успіху** (I wish you success)!
...
Previously used callout types in this module: culture, fact, tip, warning
...
```
===WORD_COUNTS===
Section "Навичка 4: Присвійні займенники": {count} words (budget: 315-315×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Навичка 4: Присвійні займенники)
