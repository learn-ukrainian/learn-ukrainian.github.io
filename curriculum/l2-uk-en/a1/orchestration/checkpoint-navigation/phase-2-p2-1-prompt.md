...
> **Your #1 job: Write 330 words for the section "Огляд та навичка 1: Знахідний відмінок".**
...
Write the section prose for **Огляд та навичка 1: Знахідний відмінок** within the module **Checkpoint: Navigation**.
...
## Огляд та навичка 1: Знахідний відмінок
...
```
===WORD_COUNTS===
Section "Огляд та навичка 1: Знахідний відмінок": {count} words (budget: 330-330×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Огляд та навичка 1: Знахідний відмінок)
