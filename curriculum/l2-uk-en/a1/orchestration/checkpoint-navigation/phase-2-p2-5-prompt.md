...
> **Your #1 job: Write 322 words for the section "Орієнтування та практичне завдання".**
...
Write the section prose for **Орієнтування та практичне завдання** within the module **Checkpoint: Navigation**.
...
```
===WORD_COUNTS===
Section "Орієнтування та практичне завдання": {count} words (budget: 322-322×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Орієнтування та практичне завдання)
