...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/checkpoint-navigation.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/checkpoint-navigation-research.md`
...
Word count:       2557 / 2000 (127.8%)
Activities:       10
Vocabulary items: 20
Engagement boxes: 8
Immersion:        18.5% (target: 25-40%)
Audit status:     FAIL
```
...
1. Огляд: Навігація
2. Навичка 1: Знахідний відмінок
3. Навичка 2: Місцевий відмінок
4. Навичка 3: Родовий відмінок
5. Навичка 4: Присвійні займенники
6. Навичка 5: Орієнтування в місті
7. Інтеграція: Практика в місті
