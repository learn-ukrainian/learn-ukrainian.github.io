...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/20-checkpoint-navigation.md`
2. **Activities**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/activities/20-checkpoint-navigation.yaml`
3. **Vocabulary**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/vocabulary/20-checkpoint-navigation.yaml`
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/20-checkpoint-navigation.yaml`
5. **Meta** (build config): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/20-checkpoint-navigation.yaml`
6. **Research notes** (if exists): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/checkpoint-navigation-research.md`
...
```
Word count:       1439 / 1073 (134%%)
Activities:       10
Vocabulary items: 0
Engagement boxes: 7
Immersion:        ?% (target: 15-35% (M20))
Audit status:     PASS
```
...
At module 20, students know ONLY modules 1-19. Any grammar from later modules is scope creep.
...
Write your complete review to the output file specified in the task: **/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/orchestration/checkpoint-navigation/phase-5-re-review.md**
