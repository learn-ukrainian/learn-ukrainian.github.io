...
> **Your #1 job: Write 319 words for the section "Навичка 3: Родовий відмінок".**
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/checkpoint-navigation-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/checkpoint-navigation.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/checkpoint-navigation.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the section prose for **Навичка 3: Родовий відмінок** within the module **Checkpoint: Navigation**.

- **WORD BUDGET**: 319 words minimum, 319 × 2 maximum. Stay in this range.
...
- ### Питання «Де?» — Static Location
- ### Правила та зміни (Rules and changes)
- ### Станція «Арсенальна» — The Deepest Spot
---
When you are there, you are **на станції** (at the station) or **у метро** (in the metro). Remember, you cannot forget the preposition! Saying «Я метро» would mean «I am a metro train,» which might get you a few strange looks.

*Приклад:*
1. Метро у Києві гарне — [mɛˈtrɔ u ˈkɪjɛʋʲi ˈɦarnɛ] (The metro in Kyiv is beautiful).
2. Станція «Арсенальна» дуже глибока — [ˈstantsʲija arsɛˈnalʲna ˈduʒɛ hlɪˈbɔka] (Arsenalna station is very deep).
3. Ми зараз на станції — [mɪ ˈzaraz na ˈstantsʲiji] (We are at the station now).

[!culture]
**Цікавий факт:** Арсенальна — найглибша станція метро у світі (Arsenalna is the deepest metro station in the world). Її глибина — 105 метрів (Its depth is 105 meters). Це дуже глибоко (This is very deep).
...
Previously used callout types in this module: culture, tip
...
- Target: 319 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Навичка 3: Родовий відмінок": {count} words (budget: 319-319×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Навичка 3: Родовий відмінок)
