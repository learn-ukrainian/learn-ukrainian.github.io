        # Fix ALL 5 issue(s) in `questions-and-negation`
...
**What:** Non-nominative 'роботі' (locative, VESUM: noun:anim:m:v_mis) in M18. Only nominative case allowed before M25.
**How to fix:** Replace 'роботі' (locative) with its nominative form or use English equivalent.
**Where:** ~line 81

### Fix 2: MORPHOLOGICAL_VIOLATION
**What:** Non-nominative 'України' (genitive, VESUM: noun:inanim:f:v_rod:prop:geo:alt) in M18. Only nominative case allowed before M25.
**How to fix:** Replace 'України' (genitive) with its nominative form or use English equivalent.
**Where:** ~line 92
...
**What:** Non-nominative 'тебе' (genitive, VESUM: noun:anim:s:v_rod:pron:pers:2) in M18. Only nominative case allowed before M25.
**How to fix:** Replace 'тебе' (genitive) with its nominative form or use English equivalent.
**Where:** ~line 141
