...
> **Your #1 job: Write 228 words for the section "У реальному житті: Діалоги".**
...
Write the section prose for **У реальному житті: Діалоги** within the module **Questions & Negation**.

- **WORD BUDGET**: 228 words minimum, 228 × 2 maximum. Stay in this range.
...
*   **Це правда.** [tsɛ prˈɑwdɑ] — This is true. (Statement)
*   **Це правда?** [tsɛ prˈɑwdɑ] — Is this true? (Question)

The sentence looks identical on paper, but it sounds completely different. It is like musical notation.

*   **Він знає.** [vin znˈɑje] — He knows.
*   **Він знає?** [vin znˈɑje] — Does he know?
...
Previously used callout types in this module: tip, warning, culture, observe
...
- Target: 228 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "У реальному житті: Діалоги": {count} words (budget: 228-228×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (У реальному житті: Діалоги)
