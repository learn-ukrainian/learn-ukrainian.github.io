...
```
curriculum/l2-uk-en/plans/a1/questions-and-negation.yaml
```

Read the meta file:

```
curriculum/l2-uk-en/a1/meta/questions-and-negation.yaml
```
...
Research **Questions & Negation** for the **A1** core track. Core tracks need lighter research than seminar tracks — focus on accuracy and State Standard alignment.
