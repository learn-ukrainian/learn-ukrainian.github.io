...
```
⚠️  Outline compliance: 1 errors, 1 warnings
❌ [MISSING_OUTLINE_SECTION] Section 'З'єднуємо слова та ідеї (Connecting Words and Ideas)' defined in outline but not found in markdown.
⚠️ [EXTRA_SECTION_IN_MARKDOWN] Section 'З'єднуємо речення (Joining Sentences)' found in markdown but not in outline.
