...
1. **Content** (the lesson you're reviewing): `curriculum/l2-uk-en/a1/questions-and-negation.md`
2. **Activities**: `curriculum/l2-uk-en/a1/activities/questions-and-negation.yaml`
3. **Vocabulary**: `curriculum/l2-uk-en/a1/vocabulary/questions-and-negation.yaml`
4. **Plan** (source of truth for scope): `curriculum/l2-uk-en/plans/a1/questions-and-negation.yaml`
5. **Meta** (build config): `curriculum/l2-uk-en/a1/meta/questions-and-negation.yaml`
6. **Research notes** (if exists): `curriculum/l2-uk-en/a1/research/questions-and-negation-research.md`
...
```
Word count:       {AUDIT_WORD_COUNT} / 1131 ({WORD_PERCENT}%)
...
At module 7, students know ONLY modules 1-{PREV_MODULE}. Any grammar from later modules is scope creep.
