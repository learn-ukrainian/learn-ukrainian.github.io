...
> **Your #1 job: Write 150 words for the section "Вступ: Мистецтво запитань".**
...
Write the section prose for **Вступ: Мистецтво запитань** within the module **Questions & Negation**.
...
```
===WORD_COUNTS===
Section "Вступ: Мистецтво запитань": {count} words (budget: 150-150×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Вступ: Мистецтво запитань)
