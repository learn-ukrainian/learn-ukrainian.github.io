        # Fix 1 issue(s) in `questions-and-negation`
...
**Context (line 40):** `Порівняйте:`

### Other Audit Failures

```
Практика: Тренування заперечень та запитань (Practice: Drilling Negation and Questions)    169 /  250  ❌ (-81)
