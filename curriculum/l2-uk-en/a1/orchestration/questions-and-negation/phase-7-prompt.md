...
1. **Plan** (source of truth): `curriculum/l2-uk-en/plans/a1/questions-and-negation.yaml`
2. **Meta** (build config): `curriculum/l2-uk-en/a1/meta/questions-and-negation.yaml`
3. **Content** (the lesson): `curriculum/l2-uk-en/a1/questions-and-negation.md`
4. **Activities**: `curriculum/l2-uk-en/a1/activities/questions-and-negation.yaml`
5. **Vocabulary**: `curriculum/l2-uk-en/a1/vocabulary/questions-and-negation.yaml`
6. **Review** (Green Team review from Phase 6): `curriculum/l2-uk-en/a1/review/questions-and-negation-review.md`
7. **Phase 6b fix log** (if exists): `curriculum/l2-uk-en/a1/orchestration/questions-and-negation/phase-6b-fixes.md`
...
```bash
scripts/audit_module.sh curriculum/l2-uk-en/a1/questions-and-negation.md
```
...
Check against `curriculum/l2-uk-en/plans/a1/questions-and-negation.yaml`:
...
Read `curriculum/l2-uk-en/a1/questions-and-negation.md` in FULL. Check for:

### 3a: Russianisms (auto-fail)
```bash
grep -inP 'кушати|получати|приймати участь|слідуючий|любий\b|дякуючи' curriculum/l2-uk-en/a1/questions-and-negation.md
grep -inP 'кушати|получати|приймати участь|слідуючий|любий\b|дякуючи' curriculum/l2-uk-en/a1/activities/questions-and-negation.yaml
```

### 3b: Russian characters (auto-fail)
```bash
grep -nP '[ыэёъ]' curriculum/l2-uk-en/a1/questions-and-negation.md
grep -nP '[ыэёъ]' curriculum/l2-uk-en/a1/activities/questions-and-negation.yaml
```
...
```bash
.venv/bin/python scripts/lint_ipa.py curriculum/l2-uk-en/a1/questions-and-negation.md
```

If issues found, auto-fix:
```bash
.venv/bin/python scripts/lint_ipa.py curriculum/l2-uk-en/a1/questions-and-negation.md --fix
```
...
```bash
grep -nP '\[/[^]]+/\]|(?<!\[)/[а-яіїєґА-ЯІЇЄҐ][^/]*/(?!\])' curriculum/l2-uk-en/a1/questions-and-negation.md
```
If found and track is B1+: move to vocabulary, remove from content.

### 3e: English leakage
```bash
grep -inP '\b(the|is|are|was|were|has|have|this|that|with|from|for|and|but|not|can|will)\b' curriculum/l2-uk-en/a1/questions-and-negation.md
```
...
```bash
.venv/bin/python scripts/calc_immersion.py curriculum/l2-uk-en/a1/questions-and-negation.md
```
...
Read `curriculum/l2-uk-en/a1/activities/questions-and-negation.yaml` in FULL.
...
Read `curriculum/l2-uk-en/a1/review/questions-and-negation-review.md`. For EACH issue in "Critical Issues Found" or "Fix Plan":
...
```bash
.venv/bin/python scripts/generate_mdx.py l2-uk-en a1 7
```
...
```
===FINAL_REVIEW_START===
# Final Review: questions-and-negation
