...
> **Your #1 job: Write 186 words for the section "Культурний контекст: «Чи» та Альф".**
...
| File | Purpose |
|------|---------|
| `curriculum/l2-uk-en/a1/research/questions-and-negation-research.md` | Factual foundation — use exhaustively |
| `curriculum/l2-uk-en/a1/meta/questions-and-negation.yaml` | Content outline with section word allocations |
| `curriculum/l2-uk-en/plans/a1/questions-and-negation.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the section prose for **Культурний контекст: «Чи» та Альф** within the module **Questions & Negation**.

- **WORD BUDGET**: 186 words minimum, 186 × 2 maximum. Stay in this range.
...
TARGET: 15-35% Ukrainian, 65-85% English. Explanatory prose primarily in English. Grammar concepts explained in English with Ukrainian terminology introduced (bolded, with translation on first use). Examples increasingly in Ukrainian with translations. Callout text in English. Ukrainian sentences max 10 words.
...
### At the Café: The Polite «Чи»
Imagine you are entering a cozy café in Lviv. When you speak to the barista or a stranger, you want to sound polite and clear. This is where the particle **чи** [tʃɪ] is your best friend. It acts like a gentle warning signal that says, "I am asking a question."
...
*   **Чи це кава?** [tʃɪ tsɛ kˈɑwɑ] — Is this coffee?
*   **Так, це кава.** [tɑk tsɛ kˈɑwɑ] — Yes, this is coffee.
*   **Чи ви знаєте?** [tʃɪ vɪ znˈɑjɛtɛ] — Do you know?
...
*   **— Це чай?** [tsɛ tʃɑj] — Is this tea?
*   **— Ні, це не чай. Це суп.** [ni tsɛ nɛ tʃɑj. tsɛ sup] — No, this is not tea. This is soup.

*   **— Він знає?** [vin znˈɑjɛ] — Does he know?
*   **— Ні, він не знає.** [ni vin nɛ znˈɑjɛ] — No, he does not know.
...
Previously used callout types in this module: tip, warning, culture, observe, fact
...
- Target: 186 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Культурний контекст: «Чи» та Альф": {count} words (budget: 186-186×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Культурний контекст: «Чи» та Альф)
