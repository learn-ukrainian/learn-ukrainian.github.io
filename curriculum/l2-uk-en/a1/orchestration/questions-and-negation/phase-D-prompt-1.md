...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/questions-and-negation.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/questions-and-negation-research.md`
...
Word count:       2741 / 2000 (137.1%)
Activities:       8
Vocabulary items: 24
Engagement boxes: 5
Immersion:        21.2% (target: 15-35%)
Richness:         70% (threshold: 95%)
Richness gaps:    cultural: 0/3, dialogues: 0/4, tables: 0/2
Audit status:     PASS
```
...
1. Вступ: Мистецтво ставити питання
2. Граматика: Як будувати питання
3. Практика: Інтонація та конструктор
4. Застосування: Розмова в реальному житті
5. Культурний контекст: Ввічливість і гумор
