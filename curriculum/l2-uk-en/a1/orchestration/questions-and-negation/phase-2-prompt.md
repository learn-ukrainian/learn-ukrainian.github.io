...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/questions-and-negation-research.md` | Factual foundation — use exhaustively |
...
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/questions-and-negation.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Questions & Negation** (a1 track).
...
|---------|--------|---------------------|
| Вступ: Основи заперечення та інтонації | 300 | 450 |
| Презентація: Питальні конструкції | 700 | 1050 |
| Практика: Тренування заперечень та запитань | 400 | 600 |
| Продукція: Комунікативні сценарії | 400 | 600 |
| Культурний контекст та ALF | 200 | 300 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/questions-and-negation.yaml`. Go through EVERY `points:` item in EVERY section:
