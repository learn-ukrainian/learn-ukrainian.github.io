...
> **Your #1 job: Write 19 words for the section "Підсумок: Ваша погода".**
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/weather-and-nature-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/weather-and-nature.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/weather-and-nature.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the section prose for **Підсумок: Ваша погода** within the module **Weather & Nature**.

- **WORD BUDGET**: 19 words minimum, 19 × 2 maximum. Stay in this range.
...
TARGET: 35-55% Ukrainian, 45-65% English. Explanatory prose mixed — short Ukrainian sentences woven into English explanations. Grammar still anchored in English. Examples primarily Ukrainian with translations. Ukrainian sentences max 10 words.
...
- ### Розмова на вулиці
  → We know the words for rain, sun, and wind. Now let us speak with neighbors. In Ukraine, weather is a very popular topic...
- ### Планування прогулянки
  → Weather changes our plans. In the Carpathians, we respect nature. When the weather is bad, we stay home. When the weathe...
- ### Улюблена пора року
  → Friends often discuss what season they like. We have four distinct seasons, and everyone has a favorite. To ask about th...
---
### Улюблена пора року
Friends often discuss what season they like. We have four distinct seasons, and everyone has a favorite. To ask about this preference, say: **Яка твоя улюблена пора року?** [jɑˈkɑ tvɔˈjɑ uˈlʲublɛnɑ pɔˈrɑ ˈrɔku].
...
Previously used callout types in this module: culture, fact, observe, tip
...
- Target: 19 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Підсумок: Ваша погода": {count} words (budget: 19-19×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Підсумок: Ваша погода)
