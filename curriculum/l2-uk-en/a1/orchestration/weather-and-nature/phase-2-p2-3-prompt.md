...
> **Your #1 job: Write 103 words for the section "Запитання про погоду".**
...
Write the section prose for **Запитання про погоду** within the module **Weather & Nature**.

- **WORD BUDGET**: 103 words minimum, 103 × 2 maximum. Stay in this range.
...
- ### Температура: Просто одне слово
  → В англійській мові ми кажемо «It is cold». У нас є підмет «it» і дієслово «is». В українській мові все простіше. Ми вико...
- ### Опади: Дощ і сніг «йдуть»
  → Як ми кажемо про дощ або сніг? Ми використовуємо дієслово **йде** [jde] (goes). Дощ і сніг — це активні речі. Вони рухаю...
- ### Небо: Хмари і вітер
  → Іноді немає дощу, але немає і сонця. Тоді ми знову використовуємо короткі слова-прислівники. Як і з температурою, нам не...
---
...
- Target: 103 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Запитання про погоду": {count} words (budget: 103-103×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Запитання про погоду)
