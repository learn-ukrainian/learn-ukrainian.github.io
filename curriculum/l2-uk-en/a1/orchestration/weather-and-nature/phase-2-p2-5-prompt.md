...
> **Your #1 job: Write 274 words for the section "Прогноз і клімат".**
...
Write the section prose for **Прогноз і клімат** within the module **Weather & Nature**.

- **WORD BUDGET**: 274 words minimum, 274 × 2 maximum. Stay in this range.
...
- ### Чотири сезони (The Four Seasons)
  → We don't just ask about today. We plan for the whole year. In Ukraine, nature changes dramatically four times. It is a c...
- ### Коли? (When?)
  → To say "in winter," we use a special time word (an adverb). We don't use a preposition like "in." Look at how the stress...
---
### Коли? (When?)
...
| :--- | :--- | :--- |
| **зима** | **взимку** | [ˈwzɪmku] |
| **весна** | **навесні** | [nɑvɛsˈnʲi] |
| **літо** | **влітку** | [ˈwlʲitku] |
...
- Target: 274 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Прогноз і клімат": {count} words (budget: 274-274×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Прогноз і клімат)
