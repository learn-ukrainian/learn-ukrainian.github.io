...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Погода та безособові форми | 500 | 750 |
| Пори року та природа | 550 | 825 |
| Складні речення та прогноз | 550 | 825 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/weather-and-nature.yaml`. Go through EVERY `points:` item in EVERY section:
