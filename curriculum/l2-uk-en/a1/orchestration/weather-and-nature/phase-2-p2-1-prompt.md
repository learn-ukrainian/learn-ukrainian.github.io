...
> **Your #1 job: Write 81 words for the section "Вступ: Погода в Україні".**
...
Write the section prose for **Вступ: Погода в Україні** within the module **Weather & Nature**.

- **WORD BUDGET**: 81 words minimum, 81 × 2 maximum. Stay in this range.
...
- Target: 81 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Вступ: Погода в Україні": {count} words (budget: 81-81×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Вступ: Погода в Україні)
