...
> **Your #1 job: Write 561 words for the section "Практика: Розмови про погоду".**
...
Write the section prose for **Практика: Розмови про погоду** within the module **Weather & Nature**.

- **WORD BUDGET**: 561 words minimum, 561 × 2 maximum. Stay in this range.
...
- ### Завтра буде... (Tomorrow will be...)
  → To talk about the future, we use a very simple helper word: **буде** [ˈbudɛ]. This means "will be." You do not need to c...
- ### Небо і вітер (Sky and Wind)
  → When you look at the sky, you see more than just rain or snow. Often, we describe the sky itself. Is the sun shining? Ar...
- ### Погода в Карпатах (Weather in the Carpathians)
  → Here in the mountains, the climate is special. It is not like the city. The four seasons are very distinct, but nature h...
---
...
Previously used callout types in this module: culture, fact, tip
...
- Target: 561 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Практика: Розмови про погоду": {count} words (budget: 561-561×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Практика: Розмови про погоду)
