...
> **Your #1 job: Write 58 words for the section "Пори року".**
...
Write the section prose for **Пори року** within the module **Weather & Nature**.

- **WORD BUDGET**: 58 words minimum, 58 × 2 maximum. Stay in this range.
...
- ### Головне питання
  → Ми знаємо, як сказати, що надворі гарно. Але як запитати про це? Уявіть, що ви дзвоните другу в Київ. Ви не бачите небо....
- ### Деталі: Дощ чи сніг?
  → Іноді вам потрібні деталі. Вам треба парасоля? Щоб поставити питання «так/ні», ми часто використовуємо маленьке слово **...
- ### Температура
  → Якщо ви плануєте пікнік, слово «тепло» — це не завжди точно. Вам потрібна цифра. Слово **температура** [tɛmpɛrɑˈturɑ] зв...
---
...
- Target: 58 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Пори року": {count} words (budget: 58-58×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Пори року)
