...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/checkpoint-communication-research.md` | Research notes |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/checkpoint-communication.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/checkpoint-communication.yaml` | Objectives, vocabulary_hints |
...
Write the lesson prose for **Checkpoint: Communication** (a1 track).
...
- **Structure**: Follow the content_outline from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/checkpoint-communication.yaml` — each section maps to an H2. **Write ALL sections. Do not skip any section, even short ones like Summary.** Missing sections fail validation.
...
| Section | Target |
|---------|--------|
| Огляд: Checkpoint Communication | 200 |
| Навичка 1: Модальні дієслова | 300 |
| Навичка 2: Накази та прохання | 250 |
| Навичка 3: Повсякдення | 250 |
| Інтеграційне завдання | 200 |
| **Total** | **1200** |
