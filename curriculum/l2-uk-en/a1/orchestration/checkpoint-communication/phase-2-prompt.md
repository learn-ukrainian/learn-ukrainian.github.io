...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/checkpoint-communication-research.md` | Factual foundation — use exhaustively |
...
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/checkpoint-communication.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Checkpoint: Communication** (a1 track).
...
|---------|--------|---------------------|
| Огляд | 300 | 450 |
| Навичка 1: Модальні дієслова | 500 | 750 |
| Навичка 2: Накази та прохання | 400 | 600 |
| Навичка 3: Повсякдення | 400 | 600 |
| Інтеграційне завдання | 400 | 600 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/checkpoint-communication.yaml`. Go through EVERY `points:` item in EVERY section:
