...
3. Verify with Grep: `Grep pattern="first 5-6 words" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/the-living-verb-ii.md"`
...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/the-living-verb-ii.md`
2. **Activities**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/activities/the-living-verb-ii.yaml`
3. **Vocabulary**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/vocabulary/the-living-verb-ii.yaml`
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/the-living-verb-ii.yaml`
5. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/the-living-verb-ii-research.md`
...
deviations:
  - section: "none"
    reason: "Fully adhered to the plan and outline."
frictions:
  - type: PLAN_GAP
    description: "The verb 'пити' was listed under regular -ити verbs, but it is a 1st conjugation verb (п'ю, п'єш). Addressed by treating it purely as a vocabulary item for the hospitality triad without conjugating it as a 2nd conjugation verb."
    proposed_fix: "Update the vocabulary hint in the plan to note that 'пити' is 1st conjugation despite the -ити ending."
research_gaps:
  - "none"
unverified_terms:
  - "none"
review_focus:
  - "Check that the distinction between 1st and 2nd conjugation is clear and the presentation of mutations feels intuitive for an A1 learner. Ensure distractors in activities are verified valid words as per constraints."
rag_tools_used:
  - "search_text: 'Second Conjugation pattern (-ити → -у, -иш...) Consonant mutation patterns' → Used results to confirm textbook framing."
```
...
Word count:       1435 / 1200 (119.6%)
Activities:       6
Vocabulary items: 20
Engagement boxes: 0
Immersion:        8.3% (target: 15-25%)
Richness:         57% (threshold: 60%)
...
1. **[MORPHOLOGICAL_VIOLATION]** (severity: HIGH)
   Location: ~line 110
   Text: Non-nominative 'українською' (instrumental, VESUM: noun:inanim:f:v_oru) in M16. Only nominative case allowed before M25.
...
4. **[LOW_ENGAGEMENT]** (severity: MEDIUM)
...
**Words checked:** 117 | **VESUM coverage:** 106/117 (90.6%)

**❌ Not found in VESUM or textbooks (11):**
- `бачеш` (source: prose)
- `дж` (source: prose)
- `имо` (source: activities)
- `ите` (source: activities)
- `ити` (source: prose)
- `ить` (source: activities)
- `иш` (source: activities)
