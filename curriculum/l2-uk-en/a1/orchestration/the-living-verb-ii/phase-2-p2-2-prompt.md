...
> **Your #1 job: Write 300 words for the section "Практика та застосування у мовленні".**
...
Write the section prose for **Практика та застосування у мовленні** within the module **The Living Verb II**.
...
### Topics Covered:\n- Aspect Overview: Ongoing Actions\n- Class I vs. Class II: A Comparison\n- The Present Tense Paradigm\n- Consonant Mutations: The 1st Person Shift\n- The Labial L: A Helping Sound\n- Error Prevention: The Conjugation Trap\n\n### Last Paragraphs:\nIf you say **ти говореш** instead of **ти говориш**, it sounds a little bit clumsy, like putting a hat on your foot. The best way to avoid this trap is to check the **Інфінітив** in your mind. If it ends in **-ити**, you know you are in the "и-family." With a little bit of practice, you will be navigating these families like a pro in no time!\n\n_Приклад:_\n**Ви вчите мову.** [wɪ ˈwtʃɪtɛ ˈmɔwʊ] — You are learning the language.
...
## Практика та застосування у мовленні
...
```
===WORD_COUNTS===
Section "Практика та застосування у мовленні": {count} words (budget: 300-300×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Практика та застосування у мовленні)
