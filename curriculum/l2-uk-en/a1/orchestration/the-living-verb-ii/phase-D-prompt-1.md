...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/the-living-verb-ii.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/the-living-verb-ii-research.md`
...
Word count:       2419 / 2000 (121.0%)
Activities:       10
Vocabulary items: 21
Engagement boxes: 6
Immersion:        26.4% (target: 15-35%)
Audit status:     FAIL
```
...
1. Вступ: Родина -ити
2. Презентація: Друга дієвідміна
3. Практика: Тренування форм
4. Використання: Розповіді про дії
5. Культурний контекст: Глибина слова
