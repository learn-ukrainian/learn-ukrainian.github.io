...
1. **Content** (the lesson you're reviewing): `curriculum/l2-uk-en/a1/the-living-verb-ii.md`
2. **Activities**: `curriculum/l2-uk-en/a1/activities/the-living-verb-ii.yaml`
3. **Vocabulary**: `curriculum/l2-uk-en/a1/vocabulary/the-living-verb-ii.yaml`
4. **Plan** (source of truth for scope): `curriculum/l2-uk-en/plans/a1/the-living-verb-ii.yaml`
5. **Meta** (build config): `curriculum/l2-uk-en/a1/meta/the-living-verb-ii.yaml`
6. **Research notes** (if exists): `curriculum/l2-uk-en/a1/research/the-living-verb-ii-research.md`
...
```
Word count:       {AUDIT_WORD_COUNT} / 972 ({WORD_PERCENT}%)
...
At module 8, students know ONLY modules 1-{PREV_MODULE}. Any grammar from later modules is scope creep.
