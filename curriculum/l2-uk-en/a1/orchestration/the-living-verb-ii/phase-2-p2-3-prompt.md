...
> **Your #1 job: Write 200 words for the section "Культурна довідка: Давні корені дієслова".**
...
Write the section prose for **Культурна довідка: Давні корені дієслова** within the module **The Living Verb II**.

- **WORD BUDGET**: 200 words minimum, 200 × 2 maximum. Stay in this range.
...
### Topics Covered:\n- Sorting Exercise: The "E" vs. "Y" Game\n- Contextual Collocations: Speaking and Doing\n- Third-Person Drill: -ить vs. -ять\n- Sentence Patterns: Daily Situations\n- Bonus Verbs: Їсти and Пити\n\n### Last Paragraphs:\nThese two verbs are essential for hospitality, so keep them close!\n\n> [!cultural]\n> In Ukrainian culture, offering food and drink is a sacred duty of a host. You will often hear **“Прошу до столу!”** (Please come to the table!) followed quickly by **“Ви будете їсти?”** (Will you eat?). Knowing how to answer with **“Я їм...”** or **“Я п’ю...”** is the first step to being a great guest.
...
Previously used callout types in this module: tip, warning, cultural
...
- Target: 200 words. Ceiling: 2× that number.
...
## Культурна довідка: Давні корені дієслова
...
```
===WORD_COUNTS===
Section "Культурна довідка: Давні корені дієслова": {count} words (budget: 200-200×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Культурна довідка: Давні корені дієслова)
