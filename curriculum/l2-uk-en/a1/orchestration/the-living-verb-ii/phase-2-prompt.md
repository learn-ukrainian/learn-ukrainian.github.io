...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/the-living-verb-ii-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/the-living-verb-ii.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/the-living-verb-ii.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **The Living Verb II** (a1 track).
...
|---------|--------|---------------------|
| Вступ: Тріада гостинності | 400 | 600 |
| Презентація: Моделі та мутації | 650 | 975 |
| Практика: Помилки та автоматизація | 500 | 750 |
| Продукування та культурний контекст | 450 | 675 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/the-living-verb-ii.yaml`. Go through EVERY `points:` item in EVERY section:
