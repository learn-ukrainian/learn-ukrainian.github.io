        # Fix ALL 15 issue(s) in `the-living-verb-ii`
...
**What:** Imperative 'Сідай' (VESUM: verb:imperf:impr:s:2) — imperatives not taught until M47.
**How to fix:** Replace 'Сідай' with English instruction. E.g., use 'Remember that...' instead of Ukrainian imperatives.
**Where:** ~line 18

### Fix 2: MORPHOLOGICAL_VIOLATION
**What:** Imperative 'їж' (VESUM: verb:imperf:impr:s:2) — imperatives not taught until M47.
**How to fix:** Replace 'їж' with English instruction. E.g., use 'Remember that...' instead of Ukrainian imperatives.
**Where:** ~line 18

### Fix 3: MORPHOLOGICAL_VIOLATION
**What:** Accusative 'книгу' (VESUM: noun:inanim:f:v_zna) in M16. Accusative not taught until M25.
**How to fix:** Replace 'книгу' (accusative) with nominative form or use English equivalent.
**Where:** ~line 24

### Fix 4: MORPHOLOGICAL_VIOLATION
**What:** Non-nominative 'українською' (instrumental, VESUM: noun:inanim:f:v_oru) in M16. Only nominative case allowed before M25.
...
**What:** Accusative 'природу' (VESUM: noun:inanim:f:v_zna) in M16. Accusative not taught until M25.
**How to fix:** Replace 'природу' (accusative) with nominative form or use English equivalent.
**Where:** ~line 50

### Fix 6: MORPHOLOGICAL_VIOLATION
**What:** Accusative 'мову' (VESUM: noun:inanim:f:v_zna) in M16. Accusative not taught until M25.
**How to fix:** Replace 'мову' (accusative) with nominative form or use English equivalent.
**Where:** ~line 51

### Fix 7: MORPHOLOGICAL_VIOLATION
**What:** Accusative 'каву' (VESUM: noun:inanim:f:v_zna) in M16. Accusative not taught until M25.
...
**What:** Accusative 'правду' (VESUM: noun:inanim:f:v_zna) in M16. Accusative not taught until M25.
**How to fix:** Replace 'правду' (accusative) with nominative form or use English equivalent.
**Where:** ~line 175
