...
> **Your #1 job: Write 708 words for the section "Розминка та презентація: Друга дієвідміна".**
...
| File | Purpose |
|------|---------|
| `curriculum/l2-uk-en/a1/research/the-living-verb-ii-research.md` | Factual foundation — use exhaustively |
| `curriculum/l2-uk-en/a1/meta/the-living-verb-ii.yaml` | Content outline with section word allocations |
| `curriculum/l2-uk-en/plans/a1/the-living-verb-ii.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the section prose for **Розминка та презентація: Друга дієвідміна** within the module **The Living Verb II**.

- **WORD BUDGET**: 708 words minimum, 708 × 2 maximum. Stay in this range.
- **Engagement callouts**: Include at least 2 callout(s) in this section.
...
Previously used callout types in this module: None
...
- Target: 708 words. Ceiling: 2× that number.
...
## Розминка та презентація: Друга дієвідміна
...
```
===WORD_COUNTS===
Section "Розминка та презентація: Друга дієвідміна": {count} words (budget: 708-708×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Розминка та презентація: Друга дієвідміна)
