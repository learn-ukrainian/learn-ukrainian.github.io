...
|-------|-------|----------|----|
| pre-verify | gemini-tools (gemini-3-flash-preview) | 168s | ✅ |
| skeleton | gemini (gemini-3-flash-preview) | 162s | ✅ |
| write | gemini-tools (gemini-3.1-pro-preview) | 222s | ✅ |
| activities | gemini-tools (gemini-3.1-pro-preview) | 343s | ✅ |
