...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/pronoun-declension-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/pronoun-declension.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/pronoun-declension.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Pronoun Declension** (a1 track).
...
|---------|--------|---------------------|
| Знахідний відмінок (Accusative pronouns) | 500 | 750 |
| Місцевий відмінок (Locative pronouns) | 400 | 600 |
| Давальний відмінок (Dative pronouns) | 400 | 600 |
| Родовий відмінок (Genitive pronouns) | 400 | 600 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/pronoun-declension.yaml`. Go through EVERY `points:` item in EVERY section:
