...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/phone-basics-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/phone-basics.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/phone-basics.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Phone Basics** (a1 track).
...
|---------|--------|---------------------|
| Вступ та етикет | 450 | 675 |
| Презентація: Основні структури | 650 | 975 |
| Практика: Життєві ситуації | 550 | 825 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/phone-basics.yaml`. Go through EVERY `points:` item in EVERY section:
