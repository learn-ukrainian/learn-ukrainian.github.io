...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/phone-basics.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/phone-basics-research.md`
...
Word count:       2121 / 2000 (106.0%)
Activities:       10
Vocabulary items: 20
Engagement boxes: 4
Immersion:        36.4% (target: 35-55%)
Audit status:     FAIL
```
...
1. Вступ та етикет
2. Презентація: Основні структури
3. Практика: Життєві ситуації
4. Продукція та підсумок
