...
**Grade 7, litvinova — Сторінка 217**:
```
214
...
• Якщо представляєтеся самі, чітко назвіть своє повне 
ім’я та прізвище. 
• Процес знайомства варто завершувати етикетними фра-
зами на кшталт «Радий/а знайомству», «Дуже приємно» 
тощо.
Захват, захоплення  — емоційне внутрішнє піднесення, 
збудження, порив, запал. Для висловлення захвату подіями, 
вчинками 
```

**Grade 7, zabolotnyi — Сторінка 49**:
```
МЕРЕЖЕВИЙ ЕТИКЕТ
Мережевий етикет (інтернет-етикет, диджи-
тал-етикет, цифровий етикет, не тикет) – формальні правила поведінки, 
спілкування в інтернет-просторі. У деяких випадках за наявності доказової 
бази порушень найпопулярніших пра вил 
можна домогтися від системних адміні-
страторів покарання на рівні мережі, а то 
й на рівні закону. Серед найпоширеніших 
порушень є марнослів’я (флуд), масове 
розсилання кореспонденції рекламного або 
іншого характеру (спам),  зневажливе ви-
словлювання 
```

**Grade 6, zabolotnyi — Сторінка 228**:
```
228
Розвиток мовлення
...
основ­них правил поводження в залі.
2-га група — знайомство з однолітками в таборі відпочинку й розмова 
про плани на літо.
3-тя група — пропозиція допомогти літній людині з важким пакунком 
біля супермаркету.
Етикетні формули
вітання
знайомство
...
Research **Phone Basics** for the **A1** track.
