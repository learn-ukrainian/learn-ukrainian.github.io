...
| Module persona | Patient Supportive Tutor, acting as Tech Support Specialist |
...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/phone-basics.yaml
```

**Meta file** (activity count targets, pedagogy):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/phone-basics.yaml
```
