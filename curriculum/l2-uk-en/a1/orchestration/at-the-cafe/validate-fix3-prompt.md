        # Fix ALL 6 issue(s) in `at-the-cafe`
...
**What:** Imperative 'Ході́мо' (VESUM: verb:imperf:impr:p:1) — imperatives not taught until M47.
**How to fix:** Replace 'Ході́мо' with English instruction. E.g., use 'Remember that...' instead of Ukrainian imperatives.
**Where:** ~line 9

### Fix 2: AGREEMENT_ERROR
**What:** Agreement mismatch: 'гаря́чу' (f) + 'ла́ска' (f)
**How to fix:** Change 'гаря́чу' to match the gender/case of 'ла́ска', or vice versa.
**Where:** ~line 69

### Fix 3: STRESS_MISMATCH
**What:** Wrong stress: 'во́ду' → should be 'воду́'
**How to fix:** Replace 'во́ду' with 'воду́'.
**Where:** ~line 57
...
**What:** Stressed word not in dictionary: заплачу́ (заплачу)
**How to fix:** Verify stress manually — word not found in ukrainian-word-stress dictionary.
**Where:** ~line 93
