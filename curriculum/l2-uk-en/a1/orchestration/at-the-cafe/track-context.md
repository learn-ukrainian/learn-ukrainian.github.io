...
Центр міста — це серце життя. Тут ми зустрічаємось, гуляємо і п’ємо каву. Головне місце — це **площа** або **майдан**.
...
To understand them, you need to recognize key buildings and infrastructure. We don't count steps; we look for the **аптека** (pharmacy) or the **пошта** (post office). This lesson focuses on these visual anchors. By the end of this module, you will be able to guide a tourist from the opera house to the best coffee shop in town.
...
#### Прямо (Straight)
**Прямо** means "straight ahead." It is an adverb describing the path.
...
*   **Ліворуч** (on the left / to the left)
*   **Праворуч** (on the right / to the right)
...
#### Вулиця (Street)
**Вулиця** is the generic word for street.
...
#### Зупинка (Stop)
**Зупинка** refers to a bus, tram, or trolleybus stop. It is crucial for public transport.
...
#### Станція (Station)
**Станція** usually refers to a metro station (*станція метро*) or a small train station. Large intercity train hubs are often called *вокзал*, but *станція* is your daily word for the subway.
...
#### Біля (Near/By)
**Біля** means "near," "by," or "at." It requires the **Genitive case**.
...
#### Навпроти (Opposite)
**Навпроти** means "opposite" or "across from." It also uses the same **Genitive pattern** as *біля*.
...
In many Ukrainian cities, the **маршрутка** (minibus) is the most common way to get around. Unlike big municipal buses that stop at every official stop, a marshrutka driver might skip a stop if nobody wants to get off or on.
...
2.  **Н vs H**: Ukrainian **Н** (en) is "N". It is not "H"!
    *   *Приклад:* **Новий** — New, **Ні** [nʲi] — No.
3.  **С vs C**: Ukrainian **С** (es) is [s].
    *   *Приклад:* **Соус** — Sauce, **Суп** [sup] — Soup.
...
*   **Г** (he) — fricative sound [ɦ].
    *   *Приклад:* **Говорити** — to speak.
*   **Ґ** (ge) — stop sound [ɡ]. It has a "curl".
    *   *Приклад:* **Ґудзик** — button.

#### Е vs Є
*   **Е** — is [ɛ]. Hard sound.
    *   *Приклад:* **Де** [dɛ] — Where.
*   **Є** — is [jɛ].
    *   *Приклад:* **Європа** — Europe.
...
2.  **Я буду...** — I will have... (Literally: I will be...)
    *   *Я буду салат.*
    *   *Я буду чай.*
3.  **Будь ласка** — Please / You are welcome.
...
*   **Напої** — Drinks (Coffee, Tea, Juice)
*   **Страви** — Dishes (Soup, Salad, Main course)
*   **Десерти** — Desserts (Cake, Ice cream)
*   **Супи** — Soups (Borscht!)
...
Давайте практикуватися! Сортуємо прості слова на дві категорії: **Їжа** (Food) та **Напої** (Drinks).
...
**Овочі (Vegetables)**
*   **Картопля** (Potato) — The queen of the kitchen. Note that in Ukrainian, it is singular (potato), whereas in English we often say "potatoes". It ends in **-я** (feminine).
*   **Морква** (Carrot) — Feminine, ends in **-а**.
*   **Цибуля** (Onion) — Feminine, ends in **-я**.
*   **Помідор** (Tomato) — Masculine.
...
**Фрукти (Fruits)**
*   **Яблуко** (Apple) — Neuter. Easy! No change.
*   **Банан** (Banana) — Masculine. No change.
*   **Лимон** (Lemon) — Masculine. No change.
...
*   **Свинина** (Pork) — Feminine. Common in Ukraine.
*   **Курка** (Chicken) — Feminine. Very versatile.
*   **Яловичина** (Beef) — Feminine.
...
*   **Батон** — Long white loaf. Masculine. Similar to a French baguette but softer and wider.
*   **Булка** (Roll/Bun) — Feminine. Sweet or savory.

> [!myth-buster]
> **The Password: Паляниця**
> You may have heard the word **паляниця**. It is a type of traditional round wheat bread. But recently, it became famous as a "shibboleth" — a password used to identify non-native speakers. The combination of soft **л** and hard **ц** followed by soft **я** is extremely difficult for Russian speakers to pronounce correctly. For a Ukrainian, it is effortless. It represents safety and identity.
...
Де ваш список? Список покупок — це **список покупок**.

Before you go, you need a list. A shopping list in Ukrainian is **список покупок**.
...
**Ціна** means "price". It is a feminine word.
...
The correct, beautiful word is **їхній**. Unlike "his/her", this word **does** behave like an adjective! It changes by gender, just like **мій**.
...
2.  **Feminine (Вона):** Usually ends in **-а** or **-я** (like **книга** — book).
3.  **Neuter (Воно):** Usually ends in **-о** or **-е** (like **вікно** — window).
...
*   **Цей телефон** (this phone) — sticking to your hand.
*   **Ця книга** (this book) — right in front of you.
...
1.  **вікно** — window
2.  **ліжко** — bed
3.  **крісло** — armchair (distinct from simple chair)
...
2.  **ложка** — spoon (Feminine)
3.  **чашка** — cup (Feminine)
4.  **тарілка** — plate (Feminine)
5.  **блюдо** — platter/dish (Neuter)
...
1.  **комп'ютер** — computer (Masculine)
2.  **сумка** — bag (Feminine)
3.  **ключі** — keys (Plural)
4.  **окуляри** — glasses (Plural)
...
*   **Хата** — This is the traditional rural house. Historically, it refers to the white-washed clay cottage with a thatched roof, but today it implies a detached house in a village or a traditional dwelling. It carries a warm, cozy, historical feeling.
*   **Квартира** — This is an apartment or flat. Most urban Ukrainians live in a **квартира**.
...
If you enter a traditional Ukrainian home (and even many modern ones), you might notice a special arrangement in the corner diagonally opposite the door. This is called the **Покуття**.

Historically, this was the spiritual center of the house. It was decorated with **рушники** (embroidered towels) and icons. It was where the family table stood, and where honored guests were seated.
...
There is one tricky word in our vocabulary list: **двері** (door/doors).
...
Вітаю! Welcome back. Today we are tackling a topic that is instantly practical: numbers (**числа**) and money (**гроші**).
...
*   **Номери** (numbers) of buses, trams, and trolleybuses. **Подивіться на автобус.**
*   **Адреси** (addresses) — street numbers and apartment numbers. **Це моя адреса.**
...
It applies to everything you count: dollars, cats, coffees, hours. But today, we will focus on the Ukrainian currency: **гривня** (hryvnia).
...
*   Жіночий (Feminine): **одна** (e.g., одна кава, одна гривня, одна машина)
*   Середній (Neuter): **одне** (e.g., одне яблуко, одне місто, одне вікно)
...
We haven't fully covered Genitive Plural yet, but for now, just treat it as a special "counting form." For **гривня**, the Genitive Plural form is **гривень**.
...
The smaller unit of currency is the **копійка**. It follows the exact same pattern because it is also feminine.
*   1 копійка
*   2 копійки
*   5 копійок (Genitive Plural form)
...
> [!note]
> **Vocabulary: Здача**
> The word **здача** means "change" (the money you get back). You will hear this constantly.
...
*   **Це лампа**. (This is a lamp.) — Here, the lamp is the subject. It is just being a lamp.
*   **Я бачу лампу**. (I see a lamp.) — Now, *you* are the subject. You are doing the action (seeing). The lamp is receiving the action.
...
*   *Subject:* **Книга** на столі.
*   *Object:* Я читаю **книгу**.
...
Let's look at how this works with the verb **бачити** (to see).

*   **кава** (coffee) → Я бачу **каву**.
*   **газета** (newspaper) → Я бачу **газету**.
*   **кухня** (kitchen) → Я бачу **кухню**.
...
*   **вікно** (window) → Я бачу **вікно**.
*   **місто** (city) → Я бачу **місто**.
*   **море** (sea) → Я бачу **море**.
...
1.  **мати** (to have)
    *   Я маю **проблему**. (I have a problem.)
...
3.  **брати** (to take)
    *   Я беру **сумку**. (I take the bag.)
    *   Я беру **телефон**. (I take the phone.)

4.  **купувати** (to buy)
    *   Він купує **машину**. (He is buying a car.)
...
*   **Я маю ідею**. (I have an idea.) — *ідея → ідею*
...
*   **Ми хочемо спокій**. (We want peace.)
...
**Оксана:** Я п'ю **каву**. Ти хочеш **каву**?
**Андрій:** Ні, дякую. Я хочу **воду**.
**Оксана:** Добре. Ось вода.
**Андрій:** Дякую. Слухай, я маю **ідею**.
**Оксана:** Яку ідею? (What idea?)
**Андрій:** Я хочу купити **піцу**.
...
*   Я бачу **ціну**. (I see the price.)
*   Я бачу **знижку**. (I see a discount.)
*   Я бачу **товар**. (I see goods/product.)
*   Я бачу **касу**. (I see the checkout.)
*   Я бачу **чергу**. (I see a queue.)

### Вдома: Я беру... (At home: I take...)
You are getting ready to go out.

*   Я беру **парасолю**. (I take an umbrella.)
*   Я беру **куртку**. (I take a jacket.)
...
**Я беру...** (I take...)
*   ... **паспорт** (passport) — *masculine, no change*.
*   ... **квиток** (ticket) — *masculine, no change*.
*   ... **карту** (map/card) — *feminine, change!*
*   ... **щітку** (toothbrush) — *feminine, change!*
*   ... **фотоапарат** (camera) — *masculine, no change*.
...
### Базар (The Market)
In Ukraine, the **базар** (market) is a vital institution. It is not just a place to buy food; it is a place to talk, to smell, and to taste. Even with modern supermarkets everywhere, many people prefer the bazaar for fresh meat, dairy, and vegetables.
...
*   Я купую **вишиванку**. (I buy an embroidered shirt.)
*   Я купую **магніт**. (I buy a magnet.)
*   Я купую **булаву**. (I buy a mace - symbol of power.)
*   Я купую **тарілку**. (I buy a plate.)
...
**Examples:**
-   **мама** (mom) — Looks and sounds exactly like you expect.
...
*   **Example**: **літо** (summer). Notice the "L" becomes soft.
...
3.  **школа** — school. Start with the hush sound **Ш** [ʃ]. It is soft and wide.
4.  **гарний** — beautiful. Start with the soft, voiced **Г** [ɦ]. Do not say "garniy." Say "harniy" with voice.
5.  **жінка** — woman. Feel the vibration in the **Ж** [ʒ]. It buzzes.
...
*   **жити** (to live) — Uses **И**. The "Zh" and "t" are hard. The sound is deep in your chest.
*   **діти** (children) — Uses **І**. The "d" becomes very soft [dʲ], sounding almost like "dy".
*   **пити** (to drink) — Uses **И**. Hard "p".
*   **літо** (summer) — Uses **І**. Soft "l".
...
*   **батько** (father). The **Т** is soft before the hard **К**.

### Сила апострофа
Don't rush this word. Respect the stop.
*   **сім'я** (family).
*   **м'ясо** (meat). "M-yaso". The pause makes it clear.
...
*   **сестра** — sister (ends in 'a' → Feminine)
*   **книга** — book (ends in 'a' → Feminine)
*   **земля** — earth/land (ends in 'ya' → Feminine)
...
> [!context]
> **Usage Note: "Моя"**
> To say "my" for feminine words, use **моя**. Notice the rhyme: **Мам-а** → **Мо-я**.
> *   **моя мама** (my mom)
> *   **моя книга** (my book)
> *   **моя земля** (my land)
...
*   **серце** — heart (ends in 'e' → Neuter)

> [!context]
> **Usage Note: "Моє"**
> When you possess a neuter object, you use the word **моє** (my). Listen to the sound — it matches the "roundness" of the neuter endings.
> *   **моє місто** (my city)
> *   **моє серце** (my heart)
> *   **моє море** (my sea)
...
**The "Dad" Exception:**
Look at the word **тато** (dad). It ends in **-о**, so it looks Neuter, right?
**WRONG.**
...
*   **Укриття** (Shelter) — Ends in '-я' after a double consonant. It is **Neuter** — a place, a state of safety.
...
The word **немає** is the negative counterpart of **є** (there is / there exists). In spoken Ukrainian, you will often hear it shortened to **нема**.
...
> [!caution] **Не плутайте «Не» і «Немає»**
...
## Verbs (Дієслова): Рух і Дія

### Від статуй до бігунів
Imagine a world where nothing moves. Everything is frozen in place like a photograph. That is the world of nouns. You can say **книга** (book) or **журнал** (magazine), but nothing happens to them. They just exist.

To make things happen, you need energy. In language, that energy comes from the **verb**. The word itself comes from **дія** (action) and **слово** (word). It is literally an "action word."
...
These are the most friendly, regular, and common verbs in the language. If you look them up in a dictionary, they will all look similar. This dictionary form is called the **інфінітив** (infinitive).
...
When you encounter a new verb next week, like **малювати** (to draw/paint), you don't need to panic. You look at it. You see the **-ати**.
...
*   **Я роблю** — I do (See the **-лю**?)
*   **Ти робиш** — You do (No **л** here!)
*   **Він робить** — He does
*   **Ми робимо** — We do
*   **Ви робите** — You do
*   **Вони роблять** — They do (Wait! The **Л** reappears in "They" for some verbs, but the "I" form is the most important one to remember right now).
...
*   **Я сиджу** — I sit (The **д** became **дж**)
*   **Ти сидиш** — You sit (Wait, incorrect! The mutation is ONLY in the "I" form!)
*   **Ти сидиш** — You sit (Back to **д**)
*   **Він сидить** — He sits
...
*   **Ти їси** — You eat (Very unique ending)
...
*   **Магазин** (store) → **У магазині** (in the store).
...
2.  **Open Spaces**: Stations, airports, post offices (often viewed as open hubs).
    *   **Вокзал** (train station) → **На вокзалі** (at the station).
    *   **Пошта** (post office) → **На пошті** (at the post office).
...
*   **Сумка** (bag) → Remove -а → sumk- → change k to ts → **У сумці**.
...
*   **Поверх** (Floor) → Ends in -х. Change Х to С. Add -і.
...
Often, your host will offer you **тапочки** (slippers).
...
*   **Студент** (student, m.) → **Він** (He)
*   **Стіл** [stil] (table, m.) → **Він** (He)
*   **Лампа** (lamp, f.) → **Вона** (She)
*   **Вікно** (window, n.) → **Воно** (It)
