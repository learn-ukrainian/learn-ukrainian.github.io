...
Sometimes you need to politely direct the staff, such as asking for a napkin or the menu. For these situations, we can simply use the phrases we learned. You already know **будь ла́ска** (please), which is an essential part of any request. Remember that you can pair it with the name of the item you want to order. This is a very reliable way to communicate your needs in any restaurant or café setting.
...
A critical moment arrives when you are ready to leave. There is a very common trap here for English speakers. In English, we often ask for the "check." If you ask a Ukrainian waiter for a **чек**, they will bring you the small printed fiscal receipt from the cash register, but this is not the word used to ask for the total amount you owe. In a Ukrainian dining establishment, you must always ask for the **рахунок** (bill). Asking for a **чек** when you want to pay can lead to mild confusion or an awkward pause. Let us practice the correct way to wrap up your meal.
...
- type: fill-in
  ...
  items:
    ...
    - sentence: "Мені, будь ласка, ___."
      answer: "меню"
      options: ["меню", "меню́ю", "ме́ню", "меню́м"]
      explanation: "Меню is an indeclinable borrowed word — it never changes its ending."
...
- type: fill-in
  ...
  items:
    ...
    - sentence: "Оплата ___ чи готівкою?"
      ...
      explanation: "Оплата карткою — payment by card uses the Instrumental case: картка → карткою."
    - sentence: "Я заплачу ___."
      answer: "готівкою"
      options: ["готівкою", "готівка", "готівку", "готівці"]
      explanation: "Paying with cash uses the Instrumental case: готівка → готівкою."
    - sentence: "___, будь ласка."
      answer: "Рахунок"
...
- type: fill-in
  ...
  items:
    ...
    - sentence: "Вода без ___."
      ...
      explanation: "Без (without) requires the Genitive case: газ → газу."
    - sentence: "Чай з ___."
      answer: "лимоном"
      options: ["лимоном", "лимон", "лимона", "лимону"]
      explanation: "З (with) requires the Instrumental case: лимон → лимоном."
  ...
  items:
    ...
    - question: "What does the phrase кава з молоком mean?"
      options:
        ...
        - text: "Black coffee"
          correct: false
      explanation: "З means with, and молоком is the Instrumental form of молоко (milk)."
    ...
    - question: "How do you say I will pay by card in Ukrainian?"
      options:
        ...
        - text: "Я заплачу картці."
          correct: false
      explanation: "Paying by card uses the Instrumental case: картка → карткою. Я заплачу карткою."
```
