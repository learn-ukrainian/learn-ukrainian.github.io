...
> **Your #1 job: Write 322 words for the section "Вступ: Кав'ярня в Україні".**
...
Write the section prose for **Вступ: Кав'ярня в Україні** within the module **At the Café**.

- **WORD BUDGET**: 322 words minimum, 322 × 2 maximum. Stay in this range.
...
- Target: 322 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Вступ: Кав'ярня в Україні": {count} words (budget: 322-322×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Вступ: Кав'ярня в Україні)
