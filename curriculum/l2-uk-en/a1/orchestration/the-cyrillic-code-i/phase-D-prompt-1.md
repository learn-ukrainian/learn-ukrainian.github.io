...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/the-cyrillic-code-i.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/the-cyrillic-code-i-research.md`
...
Word count:       2613 / 2000 (130.7%)
Activities:       9
Vocabulary items: 20
Engagement boxes: 4
Immersion:        6.2% (target: 5-15%)
Audit status:     FAIL
```

## Content Sections (H2 headers in the content file)

1. Розминка: Чому кирилиця?
2. Презентація: Літери-друзі та літери-пастки
3. Практика: Читаємо міжнародні слова
4. Культурний контекст: Українська ідентичність літери «І»
5. Продукція: Ваші перші слова
