...
| Priority types | fill-in, match-up, anagram |
| Vocabulary items | 20 |
...
**ALLOWED types (use ONLY these):** quiz, match-up, fill-in, group-sort, unjumble, true-false, anagram

**FORBIDDEN types (audit will auto-FAIL if you use these):** cloze, error-correction, select, translate
