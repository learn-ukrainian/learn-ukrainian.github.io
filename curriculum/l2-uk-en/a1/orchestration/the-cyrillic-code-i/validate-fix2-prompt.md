...
─── Audit output (last 15 lines) ───
  ...
  Verifying: the-cyrillic-code-i.md
    VESUM misses: 4 — querying RAG...
  [embed] Loading BGE-M3 from BAAI/bge-m3...

  Fetching 30 files:   0%|          | 0/30 [00:00<?, ?it/s]
  Fetching 30 files: 100%|██████████| 30/30 [00:00<00:00, 39681.21it/s]
  [embed] BGE-M3 loaded.
  You're using a XLMRobertaTokenizerFast tokenizer. Please note that with a fast tokenizer, using the `__call__` method is faster than using a method to encode the text followed by a call to the `pad` method to get a padded encoding.
    Words: 84 | VESUM: 80 (95.2%) | RAG: 4 | Not found: 0
...
VESUM: 80/84 (95%) verified
⚠️ VESUM not found (4): Африка, ЛУ, СА, УН
        ```
