...
> **Your #1 job: Write 3057 words of rich, structured Ukrainian content.**
...
- **Total minimum**: 1019 words
- **Write at least**: 3057 words (2.0x — you consistently underwrite, so aim high)
- **Immersion**: M01-05 (Phonetics): 10-15% immersion
- **Engagement callouts**: 3+ across sections, at least 4 different types
- **Example sentences**: 12+ in varied formats (inline, standalone, tables, dialogues)
...
|---------|-------------|
| Теорія: Розгадуємо кириличний код | 606 |
| Культурний контекст: Чому українська абетка особлива | 200 |
| Практика та Підсумок: Перші кроки в читанні | 213 |
| **TOTAL** | **1019** |
...
## How to Hit 3057 Words (Expansion Method)
...
...
Total: {total} words (target: 1019, ratio: {total/WORD_TARGET}x)
===WORD_COUNTS===
```
...
- Do NOT write fewer than 1019 words total
