...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/the-cyrillic-code-i-research.md` | Research notes |
...
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/the-cyrillic-code-i.yaml` | Objectives, vocabulary_hints |
...
- **Літера О**: [Anna Ohoiko — Ukrainian Lessons — О](https://www.youtube.com/watch?v=QT3c1TiZZgk)
...
**Grade 1, bolshakova** — Сторінка 31:
```
31
к а з|к и
...
Write the lesson prose for **The Cyrillic Code I** (a1 track).
...
- **Structure**: Follow the content_outline from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/the-cyrillic-code-i.yaml` — each section maps to an H2. **Write ALL sections. Do not skip any section, even short ones like Summary.** Missing sections fail validation.
...
| Голосні — Vowels | 300 |
| Приголосні — Consonants | 300 |
| Склади і слова — Syllables and Words | 300 |
