...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/euphony-and-polish-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/euphony-and-polish.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/euphony-and-polish.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Euphony and Polish** (a1 track).
...
|---------|--------|---------------------|
| У/В чергування | 500 | 750 |
| І/Й чергування | 400 | 600 |
| З/Із/Зі чергування | 450 | 675 |
| Інші правила евфонії | 300 | 450 |
| Практика | 350 | 525 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/euphony-and-polish.yaml`. Go through EVERY `points:` item in EVERY section:
