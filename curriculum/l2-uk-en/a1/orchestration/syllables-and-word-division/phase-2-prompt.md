...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/syllables-and-transfer-research.md` | Research notes |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/syllables-and-transfer.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/syllables-and-transfer.yaml` | Objectives, vocabulary_hints |
...
**Grade 1, zaharijchuk** — Сторінка 95:
```
93
...
**Grade 1, bolshakova** — Сторінка 32:
```
32
И и
к н и|г и
...
**Grade 1, zaharijchuk** — Сторінка 54:
```
52
Ц ц
Бачу  Ц, ц (це). Чую  [ц], [ц′].
...
Write the lesson prose for **Syllables and Word Division** (a1 track).
...
- **Structure**: Follow the content_outline from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/syllables-and-transfer.yaml` — each section maps to an H2. **Write ALL sections. Do not skip any section, even short ones like Summary.** Missing sections fail validation.
...
| Типи складів — Open and Closed Syllables | 300 |
| Правила переносу — Word Division Rules | 350 |
| Підсумок — Summary & Self-Check | 250 |
| **Total** | **1200** |
