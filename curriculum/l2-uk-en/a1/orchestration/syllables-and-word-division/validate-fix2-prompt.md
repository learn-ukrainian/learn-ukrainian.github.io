        # Fix ALL 3 issue(s) in `syllables-and-word-division`
...
**What:** Activity answers contain VESUM-failed words: ам, бу, вер-си-тет, вер-ситет, верси-тет, верситет, ий, ийй, коо, н
**How to fix:** Fix spelling or replace these words — students will practice non-existent forms.
**Where:** syllables-and-word-division.yaml
