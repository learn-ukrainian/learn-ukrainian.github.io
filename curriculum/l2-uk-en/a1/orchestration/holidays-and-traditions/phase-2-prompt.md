...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/holidays-and-traditions-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/holidays-and-traditions.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/holidays-and-traditions.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Holidays & Traditions** (a1 track).
...
|---------|--------|---------------------|
| Вступ та культура | 500 | 750 |
| Презентація: Вітання | 500 | 750 |
| Презентація: Побажання | 500 | 750 |
| Практика та дні народження | 500 | 750 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/holidays-and-traditions.yaml`. Go through EVERY `points:` item in EVERY section:
