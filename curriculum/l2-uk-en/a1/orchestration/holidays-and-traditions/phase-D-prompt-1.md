...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/holidays-and-traditions.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/holidays-and-traditions-research.md`
...
Word count:       2601 / 2000 (130.1%)
Activities:       10
Vocabulary items: 20
Engagement boxes: 5
Immersion:        45.7% (target: 35-55%)
Audit status:     FAIL
```
