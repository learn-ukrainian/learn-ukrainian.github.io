...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/plurals-and-alternation-research.md` | Factual foundation — use exhaustively |
...
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/plurals-and-alternation.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Plurals and Alternation** (a1 track).
...
|---------|--------|---------------------|
| Множина іменників | 500 | 750 |
| Чергування | 450 | 675 |
| Множина прикметників | 400 | 600 |
| Винятки та особливості | 350 | 525 |
| Практика | 300 | 450 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/plurals-and-alternation.yaml`. Go through EVERY `points:` item in EVERY section:
