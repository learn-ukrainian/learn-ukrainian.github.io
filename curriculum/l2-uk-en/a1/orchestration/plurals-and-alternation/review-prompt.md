...
3. Verify with Grep: `Grep pattern="first 5-6 words" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/plurals-and-alternation.md"`
...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/plurals-and-alternation.md`
2. **Activities**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/activities/plurals-and-alternation.yaml`
3. **Vocabulary**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/vocabulary/plurals-and-alternation.yaml`
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/plurals-and-alternation.yaml`
5. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/plurals-and-alternation-research.md`
...
unverified_terms: []
review_focus:
  - "Ensured 100% adherence to A1 grammar constraints (no compound sentences using і/а/але to join clauses, all verbs used are purely existential 'є' or zero copula 'це')."
  - "Safely used real dictionary words from the cumulative vocabulary list as activity distractors to guarantee VESUM validation."
  - "Consistently preserved English paragraphs with inline bolded Ukrainian words, while structural containers (bullet lists) were strictly used for short, complete Ukrainian sentences."
  - "Double-checked avoidance of LLM stylistic patterns such as grandiose openers or 'In this lesson, we will' structures, opting for warm direct imperatives like 'Take a look at...'."
rag_tools_used: []
```
...
Word count:       2338 / 1200 (194.8%)
Activities:       4
Vocabulary items: 20
Engagement boxes: 0
Immersion:        10.8% (target: 10-20%)
...
1. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 53
   Text: Agreement mismatch: 'нови́й' (m) + 'нова́' (f)
   Fix: Change 'нови́й' to match the gender/case of 'нова́', or vice versa.
2. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 53
   Text: Agreement mismatch: 'нова́' (f) + 'нове́' (n)
   Fix: Change 'нова́' to match the gender/case of 'нове́', or vice versa.
...
4. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 56
   Text: Agreement mismatch: 'стари́й' (m) + 'стара́' (f)
   Fix: Change 'стари́й' to match the gender/case of 'стара́', or vice versa.
5. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 56
   Text: Agreement mismatch: 'стара́' (f) + 'старе́' (n)
   Fix: Change 'стара́' to match the gender/case of 'старе́', or vice versa.
...
7. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 57
   Text: Agreement mismatch: 'га́рний' (m) + 'га́рна' (f)
   Fix: Change 'га́рний' to match the gender/case of 'га́рна', or vice versa.
8. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 57
   Text: Agreement mismatch: 'га́рна' (f) + 'га́рне' (n)
   Fix: Change 'га́рна' to match the gender/case of 'га́рне', or vice versa.
9. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 57
   Text: Agreement mismatch: 'га́рне' (n) + 'га́рні' (p)
   Fix: Change 'га́рне' to match the gender/case of 'га́рні', or vice versa.
10. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 58
   Text: Agreement mismatch: 'молоди́й' (m) + 'молода́' (f)
   Fix: Change 'молоди́й' to match the gender/case of 'молода́', or vice versa.
11. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 58
   Text: Agreement mismatch: 'молоде́' (n) + 'молоді́' (f/p)
   Fix: Change 'молоде́' to match the gender/case of 'молоді́', or vice versa.
12. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 60
   Text: Agreement mismatch: 'си́ній' (f/m) + 'си́ня' (f)
   Fix: Change 'си́ній' to match the gender/case of 'си́ня', or vice versa.
13. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 60
   Text: Agreement mismatch: 'си́ня' (f) + 'си́нє' (n)
   Fix: Change 'си́ня' to match the gender/case of 'си́нє', or vice versa.
14. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 60
   Text: Agreement mismatch: 'си́нє' (n) + 'си́ні' (f/m/p)
   Fix: Change 'си́нє' to match the gender/case of 'си́ні', or vice versa.
15. **[STRESS_MISMATCH]** (severity: HIGH)
   Location: ~line 9
   Text: Wrong stress: 'брати́' → should be 'бра́ти'
   Fix: Replace 'брати́' with 'бра́ти'.
16. **[STRESS_MISMATCH]** (severity: HIGH)
   Location: ~line 13
   Text: Wrong stress: 'землі́' → should be 'зе́млі'
   Fix: Replace 'землі́' with 'зе́млі'.
17. **[STRESS_MISMATCH]** (severity: HIGH)
   Location: ~line 16
   Text: Wrong stress: 'ма́ми' → should be 'ма́ми́'
   Fix: Replace 'ма́ми' with 'ма́ми́'.
18. **[STRESS_MISMATCH]** (severity: HIGH)
   Location: ~line 17
   Text: Wrong stress: 'се́стри' → should be 'сестри́'
   Fix: Replace 'се́стри' with 'сестри́'.
19. **[STRESS_MISMATCH]** (severity: HIGH)
   Location: ~line 20
   Text: Wrong stress: 'міста́' → should be 'мі́ста'
   Fix: Replace 'міста́' with 'мі́ста'.
20. **[STRESS_MISMATCH]** (severity: HIGH)
   Location: ~line 20
   Text: Wrong stress: 'моря́' → should be 'мо́ря'
   Fix: Replace 'моря́' with 'мо́ря'.
21. **[STRESS_MISMATCH]** (severity: HIGH)
   Location: ~line 33
   Text: Wrong stress: 'печі́' → should be 'пе́чі'
   Fix: Replace 'печі́' with 'пе́чі'.
22. **[STRESS_MISMATCH]** (severity: HIGH)
   Location: ~line 39
   Text: Wrong stress: 'со́ки' → should be 'соки́'
   Fix: Replace 'со́ки' with 'соки́'.
23. **[STRESS_UNKNOWN]** (severity: INFO)
   Location: ~line 43
   Text: Stressed word not in dictionary: руці́ (руці)
   Fix: Verify stress manually — word not found in ukrainian-word-stress dictionary.
24. **[STRESS_UNKNOWN]** (severity: INFO)
   Location: ~line 43
   Text: Stressed word not in dictionary: нозі́ (нозі)
   Fix: Verify stress manually — word not found in ukrainian-word-stress dictionary.
25. **[STRESS_UNKNOWN]** (severity: INFO)
   Location: ~line 58
   Text: Stressed word not in dictionary: молоді́ (молоді)
   Fix: Verify stress manually — word not found in ukrainian-word-stress dictionary.
26. **[STRESS_UNKNOWN]** (severity: INFO)
   Location: ~line 88
   Text: Stressed word not in dictionary: гро́ші (гроші)
   Fix: Verify stress manually — word not found in ukrainian-word-stress dictionary.
27. **[LOW_ENGAGEMENT]** (severity: MEDIUM)
...
28. **[ACTIVITY_VESUM_FAIL]** (severity: HIGH)
   Location: plurals-and-alternation.yaml
   Text: Activity answers contain VESUM-failed words: дитин, ніжа, окна
