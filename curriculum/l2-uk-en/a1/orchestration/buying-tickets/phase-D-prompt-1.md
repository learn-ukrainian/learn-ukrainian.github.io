...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/buying-tickets.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/buying-tickets-research.md`
...
1. Види транспорту та вокзали
2. Купівля квитка та напрямок
3. Деталі подорожі: Клас і Розклад
4. Практика: Діалоги на вокзалі
5. Подорож поїздом: Традиції
