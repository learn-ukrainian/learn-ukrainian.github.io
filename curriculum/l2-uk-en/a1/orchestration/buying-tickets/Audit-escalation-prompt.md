...
────────────────────────────────────────────────────────────
  ...
  failing gates:
    lesson: 2568/2000 (raw: 2814) | immersion: 34.4% LOW (target 35-55% (M39))
...
─── Audit output (last 15 lines) ───
  ...
  Immersion    ❌ 34.4% LOW (target 35-55% (M39))
...
Тепер ви знаєте все. Ви маєте квиток. Ви знаєте свій вагон. Ви маєте все для подорожі. Україна чекає на вас!
