...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/buying-tickets-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/buying-tickets.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/buying-tickets.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Buying Tickets** (a1 track).
...
|---------|--------|---------------------|
| Вступ та підготовка | 450 | 675 |
| Каса та замовлення | 650 | 975 |
| Поїздка та комфорт | 550 | 825 |
| Практика та підсумок | 350 | 525 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/buying-tickets.yaml`. Go through EVERY `points:` item in EVERY section:
