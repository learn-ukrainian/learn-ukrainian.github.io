...
|---------|--------|---------------------|
| Види транспорту та вокзали | 300 | 450 |
| Купівля квитка та напрямок | 500 | 750 |
| Деталі подорожі: Клас і Розклад | 500 | 750 |
| Практика: Діалоги на вокзалі | 400 | 600 |
| Подорож поїздом: Традиції | 300 | 450 |
| **Total** | **2000** | **3000** |
