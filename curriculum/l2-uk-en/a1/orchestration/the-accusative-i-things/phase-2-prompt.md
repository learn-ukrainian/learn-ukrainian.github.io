...
|---------|--------|---------------------|
| Вступ: Предмети навколо нас | 300 | 450 |
| Теорія: Знахідний відмінок для неістот | 600 | 900 |
| Практика: Вчимося змінювати закінчення | 400 | 600 |
| Ситуація: У магазині та вдома | 400 | 600 |
| Культурний погляд: Базар чи супермаркет? | 300 | 450 |
| **Total** | **2000** | **3000** |
