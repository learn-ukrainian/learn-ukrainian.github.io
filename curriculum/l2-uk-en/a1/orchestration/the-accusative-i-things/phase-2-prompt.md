...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/the-accusative-i-things-research.md` | Factual foundation — use exhaustively |
...
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/the-accusative-i-things.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **The Accusative I: Things** (a1 track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Презентація: Знахідний відмінок | 600 | 900 |
| Практика та запобігання помилкам | 600 | 900 |
| Виробництво та культура | 400 | 600 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/the-accusative-i-things.yaml`. Go through EVERY `points:` item in EVERY section:
