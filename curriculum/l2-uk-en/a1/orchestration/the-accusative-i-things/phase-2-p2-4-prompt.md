...
> **Your #1 job: Write 94 words for the section "Production".**
...
| File | Purpose |
|------|---------|
| `curriculum/l2-uk-en/a1/research/the-accusative-i-things-research.md` | Factual foundation — use exhaustively |
| `curriculum/l2-uk-en/a1/meta/the-accusative-i-things.yaml` | Content outline with section word allocations |
| `curriculum/l2-uk-en/plans/a1/the-accusative-i-things.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the section prose for **Production** within the module **The Accusative I: Things**.

- **WORD BUDGET**: 94 words minimum, 94 × 2 maximum. Stay in this range.
...
\n\n## Warm-up\n### Що це? (What is this?)\n### The Target of Action\n---\n\n\n## Presentation\n### The "Target" of Our Action\n### Feminine Nouns: The -У Rule\n### Feminine Nouns: The Soft -Ю Rule\n### Masculine Nouns: The Stable Friends\n### Neuter Nouns: Perfect Reflections\n### Key Verbs: Бачити and Чути\n### Key Verbs: Купувати and Мати\n### Usage Note: The Word "Це"\n---\n\n\n## Practice\n### From Naming to Doing\n### Building Your Sentences\n---\n
...
Previously used callout types in this module: tip, culture, observe
...
- Target: 94 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Production": {count} words (budget: 94-94×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Production)
