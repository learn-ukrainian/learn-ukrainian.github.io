...
1. **Content** (the lesson you're reviewing): `curriculum/l2-uk-en/a1/the-accusative-i-things.md`
2. **Activities**: `curriculum/l2-uk-en/a1/activities/the-accusative-i-things.yaml`
3. **Vocabulary**: `curriculum/l2-uk-en/a1/vocabulary/the-accusative-i-things.yaml`
4. **Plan** (source of truth for scope): `curriculum/l2-uk-en/plans/a1/the-accusative-i-things.yaml`
5. **Meta** (build config): `curriculum/l2-uk-en/a1/meta/the-accusative-i-things.yaml`
6. **Research notes** (if exists): `curriculum/l2-uk-en/a1/research/the-accusative-i-things-research.md`
...
```
Word count:       2238 / 855 (261%)
Activities:       8
Vocabulary items: 36
Engagement boxes: 5
Immersion:        34.8% (target: 25-40%)
Audit status:     PASS
```
