...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/the-accusative-i-things.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/the-accusative-i-things-research.md`
...
Word count:       2748 / 2000 (137.4%)
Activities:       10
Vocabulary items: 20
Engagement boxes: 3
Immersion:        27.5% (target: 25-40%)
Audit status:     FAIL
```

## Content Sections (H2 headers in the content file)

1. Вступ: Предмети навколо нас
2. Теорія: Знахідний відмінок для неістот
3. Практика: Вчимося змінювати закінчення
4. Ситуація: У магазині та вдома
5. Культурний погляд: Базар чи супермаркет?
