...
|------|----------------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/the-accusative-i-things-research.md` | Background knowledge, engagement hooks |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/the-accusative-i-things.yaml` | Objectives, vocabulary_hints (source of truth) |
...
| Tool | When | Example |
|------|------|---------|
| `search_text` | Find textbook pedagogy | `search_text("Accusative case (inanimate) Feminine: -а → -у, -я → -ю", grade=3-5)` |
...
**Coming next (module after this):** Accusative for animate nouns, Masculine animate: accusative = genitive, Feminine animate: same as inanimate
...
- бачити (to see) — бачити проблему, я бачу...; High frequency core verb
- чути (to hear) — чути музику, чути голос; High frequency core verb
- брати (to take) — брати участь, брати трубку, брати каву; High frequency
- мати (to have) — мати рацію, мати час, мати можливість; Very High frequency (Core A1)
- хотіти (to want) — хотіти їсти, хотіти спати, я хочу...; Very High frequency (Core A1)
- купувати (to buy) — купувати продукти, купувати одяг; High frequency
- книга (book) — читати цікаву книгу; High frequency; paradigm example for Feminine Accusative
- кава (coffee) — пити каву, замовляти каву; Feminine -а to -у pattern
- хліб (bread) — купувати хліб; Masculine inanimate (no change)
- гречка (buckwheat) — хочу купити гречку; Cultural staple; Feminine pattern
- пакет (bag/packet) — 'Пакет потрібен?'; Key checkout vocabulary; Masculine inanimate

**Recommended** (use in your content to reach the vocabulary target):
- любити (to love) — я люблю каву; triggers Accusative
- шукати (to look for) — шукати вихід, шукати книгу
- знаходити (to find) — знаходити час, знаходити відповідь
- відкривати (to open) — відкривати вікно, відкривати книгу
...
- **Accusative Case in Ukrainian** (Complete guide with tables and examples)
  URL: https://www.ukrainianlessons.com/accusativecase/
  Relevance: 1.0

- **Shopping for clothes — Accusative case in Ukrainian** (ukrainianlessons.com)
  URL: https://www.ukrainianlessons.com/episode32/
  Relevance: 1.0

- **Talking about books in Ukrainian — Accusative case of people** (ukrainianlessons.com)
  URL: https://www.ukrainianlessons.com/episode33/
  Relevance: 1.0

- **Asking for advice + Accusative case in Ukrainian** (ukrainianlessons.com)
...
- **Grade 9, Сторінка 58**
  ІІ. Поміркуйте, у якому реченні події зіставляються. ІІІ. Запишіть виділені слова у формі родового відмінка множини. 103
104
105
106...
...
Write **The Accusative I: Things** for the a1 track.
...
- `## Вступ (Introduction)` (~250 words)
  - The base form — називний відмінок (nominative case). Every noun you have learned so far is in its називний form — the 'naming' case. It answers хто? (who?) or що? (what?). книга, стіл, молоко — these are all називний.
  - Ukrainian has 7 cases — words change their endings depending on their role in the sentence. Today you learn the first case change: знахідний відмінок (accusative) — used for the thing you see, take, read, want.
  - Warm-up: 'Що я бачу в кімнаті?' — anchor concrete objects before introducing the case change.
- `## Презентація: Знахідний відмінок (Presentation: Accusative Case)` (~350 words)
  - Feminine Singular transformation: -а → -у, -я → -ю (книга → книгу, кава → каву). Emphasize that the change is mandatory to avoid the 'Conceptual Nominative' error common at A1.
  - Masculine and Neuter 'Safe Harbor': Explain that inanimate masculine and neuter nouns do not change (стіл → стіл, вікно → вікно). Explicitly warn against 'Masculine Inanimate Confusion' (adding -a endings like 'бачу стола').
  - High-frequency Action Verbs as triggers: Presentation of 'мати' (мати рацію, мати час), 'хотіти' (хотіти їсти), 'брати' (брати каву/участь), 'чути', 'бачити', and 'купувати'.
- `## Практика та запобігання помилкам (Practice and Error Prevention)` (~350 words)
  - Transformation drills: Nominative to Accusative focusing on the contrast between changing Feminine forms and stable Masculine/Neuter inanimate nouns.
  - Error Prevention: Targeted drills to correct 'Conceptual Nominative' (e.g., changing 'Я читаю книга' to 'Я читаю книгу') and preventing over-application of endings to masculine inanimate things.
  - High-frequency collocations practice using research-backed items: 'бачити проблему', 'чути голос', 'брати трубку', and 'мати можливість'.
- `## Виробництво та культура (Production and Culture)` (~250 words)
  - Cultural Hook: The 'Пакет потрібен?' checkout meme. Discussion of shopping dynamics: the impersonal 'супермаркет' vs. the social hub of the 'базар'.
  - Production: Creating a shopping list ('Я хочу купити...') including staples 'хліб' and 'гречка'. Describe items in a Ukrainian store context using 'Я бачу...' and 'Я купую...'.
...
| Презентація: Знахідний відмінок (Presentation: Accusative Case) | 350+ |
| Практика та запобігання помилкам (Practice and Error Prevention) | 350+ |
| Виробництво та культура (Production and Culture) | 250+ |
...
### Workflow
1. **Research first**: `search_text("Accusative case (inanimate) Feminine: -а → -у, -я → -ю", grade=3-5)` — find how textbooks teach this
...
**Required types:** fill-in, fill-in, quiz
