...
> **Your #1 job: Write 132 words for the section "Practice".**
...
Write the section prose for **Practice** within the module **The Accusative I: Things**.

- **WORD BUDGET**: 132 words minimum, 132 × 2 maximum. Stay in this range.
...
Previously used callout types in this module: tip, culture
...
- Target: 132 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Practice": {count} words (budget: 132-132×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Practice)
