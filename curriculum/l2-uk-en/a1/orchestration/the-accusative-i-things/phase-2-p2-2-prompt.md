...
> **Your #1 job: Write 889 words for the section "Presentation".**
...
Write the section prose for **Presentation** within the module **The Accusative I: Things**.
...
```
===WORD_COUNTS===
Section "Presentation": {count} words (budget: 889-889×2)
===WORD_COUNTS===
```
