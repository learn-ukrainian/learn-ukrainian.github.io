...
> **Your #1 job: Write 76 words for the section "Cultural Insight".**
...
Write the section prose for **Cultural Insight** within the module **The Accusative I: Things**.

- **WORD BUDGET**: 76 words minimum, 76 × 2 maximum. Stay in this range.
...
- Target: 76 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Cultural Insight": {count} words (budget: 76-76×2)
===WORD_COUNTS===
```
