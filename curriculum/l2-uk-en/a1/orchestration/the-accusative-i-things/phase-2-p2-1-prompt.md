...
> **Your #1 job: Write 90 words for the section "Warm-up".**
...
Write the section prose for **Warm-up** within the module **The Accusative I: Things**.

- **WORD BUDGET**: 90 words minimum, 90 × 2 maximum. Stay in this range.
...
- Target: 90 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Warm-up": {count} words (budget: 90-90×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Warm-up)
