...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/accusative-prepositions-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/accusative-prepositions.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/accusative-prepositions.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Accusative Prepositions** (a1 track).
...
|---------|--------|---------------------|
| Куди? з Acc (Direction with Acc) | 500 | 750 |
| За + Acc (Behind/For) | 400 | 600 |
| Через + Acc (Through/Because of) | 400 | 600 |
| Про + Acc (About) | 300 | 450 |
| Практика (Practice) | 400 | 600 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/accusative-prepositions.yaml`. Go through EVERY `points:` item in EVERY section:
