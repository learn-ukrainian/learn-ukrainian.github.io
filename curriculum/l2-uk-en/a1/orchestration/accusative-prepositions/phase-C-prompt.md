...
| Module persona | Patient Supportive Tutor, acting as Travel Agent |
...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/accusative-prepositions.md
```

**Plan file** (vocabulary_hints — vocabulary list to follow):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/accusative-prepositions.yaml
```

**Meta file** (activity count targets, pedagogy):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/accusative-prepositions.yaml
```
