...
> **Your #1 job: Write 208 words for the section "Вступ".**
...
Write the section prose for **Вступ** within the module **This Is / I Am**.

- **WORD BUDGET**: 208 words minimum, 208 × 2 maximum. Stay in this range.
- **Immersion**: 
...
- Target: 208 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Вступ": {count} words (budget: 208-208×2)
===WORD_COUNTS===
```
