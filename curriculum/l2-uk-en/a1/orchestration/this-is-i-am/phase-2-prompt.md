...
|---------|--------|---------------------|
| Вступ: Де дієслово «бути»? | 300 | 450 |
| Граматика: Займенники та «нульова зв'язка» | 700 | 1050 |
| Практикум: Хто це і що це? | 500 | 750 |
| Ваш вихід: Розкажіть про себе | 250 | 375 |
| Культура: Тонкощі «Ти» і «Ви» | 250 | 375 |
| **Total** | **2000** | **3000** |
