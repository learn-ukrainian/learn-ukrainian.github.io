...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/this-is-i-am-research.md` | Factual foundation — use exhaustively |
...
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/this-is-i-am.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **This Is / I Am** (a1 track).
...
|---------|--------|---------------------|
| Вступ: Хто це? Що це? | 400 | 600 |
| Презентація: Особові займенники | 600 | 900 |
| Граматика: Секрет нульової зв'язки | 400 | 600 |
| Робота над помилками та практика | 300 | 450 |
| Продакшн: Хто я і Хто ви? | 300 | 450 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/this-is-i-am.yaml`. Go through EVERY `points:` item in EVERY section:
