...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/this-is-i-am.md"
   ```
...
5. **Meta** (build config): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/this-is-i-am.yaml`
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/this-is-i-am-research.md`
...
Word count:       2534 / 2000 (126.7%)
Activities:       9
Vocabulary items: 5
Engagement boxes: 8
Immersion:        11.2% (target: 10-25%)
Audit status:     PASS
```

## Content Sections (H2 headers in the content file)

1. Вступ: Де дієслово «бути»?
2. Граматика: Займенники та «нульова зв'язка»
3. Практикум: Хто це і що це?
4. Ваш вихід: Розкажіть про себе
5. Культура: Тонкощі «Ти» і «Ви»
