...
> **Your #1 job: Write 249 words for the section "Культурний контекст".**
...
Write the section prose for **Культурний контекст** within the module **This Is / I Am**.

- **WORD BUDGET**: 249 words minimum, 249 × 2 maximum. Stay in this range.
- **Immersion**: 
...
Представляємо себе, Називаємо світ навколо, Ми та Вони
...
Previously used callout types in this module: [!tip], [!myth-buster], [!note], [!fact]
...
- Target: 249 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Культурний контекст": {count} words (budget: 249-249×2)
===WORD_COUNTS===
```
