...
3. Verify with Grep: `Grep pattern="first 5-6 words" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/this-is-i-am.md"`
...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/this-is-i-am.md`
2. **Activities**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/activities/this-is-i-am.yaml`
3. **Vocabulary**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/vocabulary/this-is-i-am.yaml`
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/this-is-i-am.yaml`
5. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/this-is-i-am-research.md`
...
unverified_terms: []
review_focus:
  - "Check that the zero copula explanation is clear and easy to understand for beginners."
  - "Verify the 'It Trap' explanation regarding 'воно' makes sense in relation to previous gender lessons."
rag_tools_used: []
```
...
Word count:       2007 / 1200 (167.2%)
Activities:       3
Vocabulary items: 20
Engagement boxes: 2
Immersion:        10.6% (target: 10-20%)
Richness:         79% (threshold: 60%)
...
1. Вступ: Хто це? Що це? (Introduction: Who is this? What is this?)
2. Презентація: Особові займенники (Presentation: Personal Pronouns)
3. Граматика: Секрет нульової зв'язки (Grammar: The Zero Copula Secret)
4. Робота над помилками та практика (Error Correction and Practice)
5. Продакшн: Хто я і Хто ви? (Production: Who am I and Who are you?)
6. Підсумок — Summary
...
1. **[ACTIVITY_VESUM_FAIL]** (severity: HIGH)
   Location: this-is-i-am.yaml
   Text: Activity answers contain VESUM-failed words: Ірина, Анна, Марк
...
**Words checked:** 71 | **VESUM coverage:** 66/71 (93.0%)
