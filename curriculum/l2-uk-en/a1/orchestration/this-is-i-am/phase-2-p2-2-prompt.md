...
> **Your #1 job: Write 1296 words for the section "Презентація".**
...
Write the section prose for **Презентація** within the module **This Is / I Am**.

- **WORD BUDGET**: 1296 words minimum, 1296 × 2 maximum. Stay in this range.
- **Immersion**: 
- **Engagement callouts**: Include at least 2 callout(s) in this section.
- **Example sentences**: Include at least 5 example sentences in this section.
...
Ефект «Зниклого дієслова», Формула: Суб'єкт + Опис, Приклади в дії
...
- Target: 1296 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Презентація": {count} words (budget: 1296-1296×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Презентація)
