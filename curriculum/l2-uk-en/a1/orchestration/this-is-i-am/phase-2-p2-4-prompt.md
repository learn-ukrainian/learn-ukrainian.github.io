...
> **Your #1 job: Write 189 words for the section "Продукція".**
...
Write the section prose for **Продукція** within the module **This Is / I Am**.

- **WORD BUDGET**: 189 words minimum, 189 × 2 maximum. Stay in this range.
- **Immersion**: 
...
Магія перетворення: Імена та займенники, Предмети теж мають характер (Він чи Вона?), Ти чи Ви: Кого ми зустріли?
...
Previously used callout types in this module: [!tip], [!myth-buster], [!note]
...
- Target: 189 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Продукція": {count} words (budget: 189-189×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Продукція)
