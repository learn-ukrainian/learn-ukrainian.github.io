...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/emergencies-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/emergencies.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/emergencies.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
| Презентація | 650 | 975 |
| Практика | 600 | 900 |
| Виробництво та підсумок | 350 | 525 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/emergencies.yaml`. Go through EVERY `points:` item in EVERY section:
