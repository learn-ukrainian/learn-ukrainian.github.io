        # Fix 1 issue(s) in `greetings-and-politeness`

        ### Fix: Gate `Immersion` FAIL — 15.0% LOW (target 15-35% (M08))
...
❌ AUDIT FAILED (see curriculum/l2-uk-en/krisztiankoos/audit/greetings-and-politeness-audit.log for details)
```
