...
**Cumulative vocabulary (117 words):**
...
що, щастя, факт, джерело, дзвін, об'єкт, склад, голосний, приголосний, перенесення
сестра, дерево, вулиця, автобус, бібліотека, університет, чайка, замок, писати, школа
добрий, далеко, наголос, інтонація, питання, відповідь, хата, кава, кафе, книжка
дорога, брат, вікно, книга, море, ніч, земля, серце, сонце, собака
ім'я, артефакт, зона, укриття, кімната, чоловік, жінка
