...
|------|----------------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/writing-skills-research.md` | Background knowledge, engagement hooks |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/writing-skills.yaml` | Objectives, vocabulary_hints (source of truth) |
...
| Tool | When | Example |
|------|------|---------|
| `search_text` | Find textbook pedagogy | `search_text("Written register basics Form vocabulary and field types", grade=3-5)` |
...
**Modules completed before this one:** 58
**Previous module:** Phone Basics

**Cumulative vocabulary (613 words):**
...
дзвінок, зайнятий, розмова

**Grammar already taught (188 topics):**
...
**Coming next (module after this):** Genitive for quantities (кілограм + genitive), Accusative for requests, Numbers with nouns
...
- листівка (postcard) — Привіт з Києва!; written communication
- анкета (form/questionnaire) — заповнити анкету; official document
- прізвище (surname) — Ваше прізвище?; form field
- ім'я (first name) — Ваше ім'я?; form field
- адреса (address) — домашня адреса; form field and envelope
- місто (city) — Київ, Львів; address component
- вулиця (street) — вул. Хрещатик; address component
- будинок (building) — будинок 5; address component
- квартира (apartment) — квартира 12; address component
- індекс (postal code) — поштовий індекс; address component

**Recommended** (use in your content to reach the vocabulary target):
- по батькові (patronymic) — Іванович/Іванівна; Ukrainian name tradition
- дата народження (date of birth) — 15.03.1990; form field
- конверт (envelope) — підписати конверт; postal vocabulary
- марка (stamp) — поштова марка; postal vocabulary
...
352.	 1.	 Напиши лист-подяку людям, які ро...

- **Grade 3, Сторінка 75**
  75
3. Чи вмієш ти писати записки? Перевір себе за правилом.
Записка складається зі звертання, повідомлення 
або прохання і підпису автора.
4. Прочитай записки друзів. Поясни, що вони пропустили. 
5. Я...

- **Grade 5, Сторінка 176**
  176
РОЗВИТОК МОВЛЕННЯ
...
- **Grade 7, Сторінка 217**
  214
Рекомендації для знайомства
• Якщо є можливість, попросіть, щоб вас представила 
третя особа.
• Під час знайомства підтримуйте зоровий контакт зі спів-
розмовником, дружньо посміхайтеся.
• Якщо пр...
...
Write **Writing Skills** for the a1 track.
...
- `## Поштова листівка (Postcard)` (~300 words)
  - Postcard structure: Привіт з Києва! (Greetings from Kyiv!) + 3-4 sentences about what you see/do + Бувай(те)! (Bye!) + Підпис (Signature). A fixed template for A1 writing.
  - Useful phrases: Тут дуже гарно (It is very beautiful here). Погода чудова (The weather is wonderful). Я бачу... (I see...). Connecting visual experience to simple written sentences.
  - Greeting variations: Привіт з + Genitive (city name). Вітаю з + Genitive (holiday). Practising the з + Genitive construction in a natural writing context.
- `## Анкета (Form filling)` (~250 words)
  - Common form fields: Прізвище (surname), Ім'я (first name), По батькові (patronymic), Дата народження (date of birth), Стать (gender), Адреса (address), Телефон (phone), Електронна пошта (email).
  - How to fill them: Writing dates in Ukrainian format (day.month.year). Gender options: чоловіча/жіноча. Understanding what each field asks for and providing appropriate data.
- `## Про себе (About yourself)` (~250 words)
  - Self-description paragraph template: Мене звати... (My name is...). Мені ... років (I am ... years old). Я з... (I am from...). Я працюю/вчуся... (I work/study...). Моє хобі... (My hobby...).
  - Writing a brief self-introduction (30-50 words): Combining previously learned patterns into a coherent written paragraph. Focus on logical flow and sentence connection.
- `## Конверт та адреса (Envelope and address)` (~200 words)
  - Ukrainian address format: Кому (To whom — Dative), Від кого (From whom — Genitive), Вулиця (Street), будинок (building number), квартира (apartment), місто (city), індекс (postal code).
  - Differences from English format: Traditional Ukrainian postal format goes from general to specific (country → city → street → building), the opposite of the English specific-to-general order (name → street → city → country). Modern Ukrainian practice increasingly follows the Western order.
- `## Практика (Practice)` (~200 words)
  - Write a postcard: Given a destination and a few visual prompts, compose a short postcard using the template structure.
  - Fill a form: Complete a simulated Ukrainian registration form with personal information. Compose a brief self-introduction paragraph (30-50 words).
...
| Section | Minimum |
|---------|---------|
| Поштова листівка (Postcard) | 300+ |
| Анкета (Form filling) | 250+ |
| Про себе (About yourself) | 250+ |
| Конверт та адреса (Envelope and address) | 200+ |
...
### Workflow
1. **Research first**: `search_text("Written register basics Form vocabulary and field types", grade=3-5)` — find how textbooks teach this
...
**Required types:** fill-in, quiz, unjumble, match-up
...
subtitle: Pen to Paper
focus: vocabulary
pedagogy: PPP
phase: A1.6 [Real-World Skills]
word_target: 1200
objectives:
- Write a simple postcard in Ukrainian
- Fill in personal information on a form
- Compose a brief self-introduction paragraph
- Address an envelope in Ukrainian format
content_outline:
- section: Поштова листівка (Postcard)
  words: 300
  points:
  - 'Postcard structure: Привіт з Києва! (Greetings from Kyiv!) + 3-4 sentences about what you see/do + Бувай(те)! (Bye!)
    + Підпис (Signature). A fixed template for A1 writing.'
  - 'Useful phrases: Тут дуже гарно (It is very beautiful here). Погода чудова (The weather is wonderful). Я бачу... (I see...).
    Connecting visual experience to simple written sentences.'
  - 'Greeting variations: Привіт з + Genitive (city name). Вітаю з + Genitive (holiday). Practising the з + Genitive construction
    in a natural writing context.'
- section: Анкета (Form filling)
  words: 250
  points:
  - 'Common form fields: Прізвище (surname), Ім''я (first name), По батькові (patronymic), Дата народження (date of birth),
    Стать (gender), Адреса (address), Телефон (phone), Електронна пошта (email).'
  - 'How to fill them: Writing dates in Ukrainian format (day.month.year). Gender options: чоловіча/жіноча. Understanding
    what each field asks for and providing appropriate data.'
- section: Про себе (About yourself)
  words: 250
  points:
  - 'Self-description paragraph template: Мене звати... (My name is...). Мені ... років (I am ... years old). Я з... (I am
    from...). Я працюю/вчуся... (I work/study...). Моє хобі... (My hobby...).'
  - 'Writing a brief self-introduction (30-50 words): Combining previously learned patterns into a coherent written paragraph.
    Focus on logical flow and sentence connection.'
- section: Конверт та адреса (Envelope and address)
  words: 200
  points:
  - 'Ukrainian address format: Кому (To whom — Dative), Від кого (From whom — Genitive), Вулиця (Street), будинок (building
    number), квартира (apartment), місто (city), індекс (postal code).'
  - 'Differences from English format: Traditional Ukrainian postal format goes from general to specific (country → city → street
    → building), the opposite of the English specific-to-general order (name → street → city → country). Modern Ukrainian practice
    increasingly follows the Western order.'
- section: Практика (Practice)
  words: 200
  points:
  - 'Write a postcard: Given a destination and a few visual prompts, compose a short postcard using the template structure.'
  - 'Fill a form: Complete a simulated Ukrainian registration form with personal information. Compose a brief self-introduction
    paragraph (30-50 words).'
vocabulary_hints:
  required:
  - листівка (postcard) — Привіт з Києва!; written communication
  - анкета (form/questionnaire) — заповнити анкету; official document
...
activity_hints:
- type: fill-in
  focus: Complete form fields with appropriate information
  items: 10
- type: quiz
  focus: Address format and form field identification
  items: 8
- type: unjumble
  focus: Reorder postcard sentences into correct structure
  items: 6
- type: match-up
  focus: Match form field label to correct answer type
  items: 10
connects_to:
- a1-60 (At the Market)
prerequisites:
