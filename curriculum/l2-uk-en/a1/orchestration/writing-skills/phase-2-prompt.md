...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/writing-skills-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/writing-skills.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/writing-skills.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Writing Skills** (a1 track).
...
|---------|--------|---------------------|
| Поштова листівка | 450 | 675 |
| Анкета | 450 | 675 |
| Про себе | 400 | 600 |
| Конверт та адреса | 400 | 600 |
| Практика | 300 | 450 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/writing-skills.yaml`. Go through EVERY `points:` item in EVERY section:
