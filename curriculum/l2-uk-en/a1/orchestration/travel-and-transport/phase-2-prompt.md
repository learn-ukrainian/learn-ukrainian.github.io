...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/travel-and-transport-research.md` | Factual foundation — use exhaustively |
...
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/travel-and-transport.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Travel and Transport** (a1 track).
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/travel-and-transport.yaml`. Go through EVERY `points:` item in EVERY section:
