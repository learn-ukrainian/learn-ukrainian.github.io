...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/travel-and-transport-research.md` | Research notes |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/travel-and-transport.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/travel-and-transport.yaml` | Objectives, vocabulary_hints |
...
**Grade 1, bolshakova** — Сторінка 11:
```
11
...
**Grade 1, bolshakova** — Сторінка 16:
```
16
Знайди слово — підпис до малюнка. 
...
**Grade 1, bolshakova** — Сторінка 48:
```
48
Знайди слово — підпис до малюнка.  
Відшукай слово до схеми.
...
Валерій

Текст-розповідь. Головна думка. 
Театралізуємо
Як ми валізу збирали
Ми з мамою їдемо до 
бабусі. Вітя і Віка складають 
свій одяг у валізу. Заліз кіт 
Вусик у валізу. Вилазити 
не хоче. Згорнувся клубком 
і  наче говорить-муркотить:
— Візьміть мене із собою.
— Валіза для речей, а не 
для котів, — сказа
```
...
Write the lesson prose for **Travel and Transport** (a1 track).
...
- **Structure**: Follow the content_outline from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/travel-and-transport.yaml` — each section maps to an H2. **Write ALL sections. Do not skip any section, even short ones like Summary.** Missing sections fail validation.
...
| Section | Target |
|---------|--------|
| Транспорт (Transport types) | 250 |
| Вокзал та аеропорт (Station and airport) | 275 |
| Напрямки (Directions) | 250 |
| Подорожі (Journeys) | 250 |
