...
|------|----------------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/travel-and-transport-research.md` | Background knowledge, engagement hooks |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/travel-and-transport.yaml` | Objectives, vocabulary_hints (source of truth) |
...
| Tool | When | Example |
|------|------|---------|
| `search_text` | Find textbook pedagogy | `search_text("Instrumental for transport means (потягом, автобусом) Direction vocabulary and imperative usage", grade=3-5)` |
...
**Modules completed before this one:** 51
**Previous module:** Leisure and Hobbies

**Cumulative vocabulary (543 words):**
...
футбол, бігати, гуляти

**Grammar already taught (166 topics):**
...
**Coming next (module after this):** Practical usage of A1 cases, Polite requests and questions, Future tense for ordering
...
- автобус (bus) — їхати автобусом; most common public transport
- метро (metro) — їхати на метро; indeclinable neuter noun
- потяг (train) — їхати потягом; long-distance transport
- літак (airplane) — летіти літаком; air travel
- вокзал (station) — залізничний вокзал; travel hub
- аеропорт (airport) — бути в аеропорту; travel hub
- наліво (left) — Поверніть наліво; direction word
- направо (right) — Поверніть направо; direction word
- прямо (straight) — Ідіть прямо; direction word

**Recommended** (use in your content to reach the vocabulary target):
- маршрутка (minibus) — їхати маршруткою; uniquely Ukrainian transport
- трамвай (tram) — їхати трамваєм; city transport
- зупинка (stop) — автобусна зупинка; where to wait
- квиток (ticket) — купити квиток; travel essential
...
- **ULP S3 Ep99: Travel plan (Voice message №4)**
  URL: https://www.ukrainianlessons.com/episode99/
  Relevance: 0.5
  Topics: grammar, verbs, future tense, vocabulary, food
...
- **ULP S1 Ep26: Talking about traveling — Past tense in Ukrainian**
  URL: https://www.ukrainianlessons.com/episode26/
  Relevance: 0.4
  Topics: grammar, verbs, past tense, vocabulary, travel

- **ULP S1 Ep27: Traveling in Ukraine in winter — More Past tense**
  URL: https://www.ukrainianlessons.com/episode27/
  Relevance: 0.4
  Topics: grammar, verbs, past tense, vocabulary, travel

- **ULP S1 Ep30: Review 21-29 — My travels in Ukrainian**
  URL: https://www.ukrainianlessons.com/episode30/
  Relevance: 0.4
  Topics: vocabulary, travel, review
...
Write **Travel and Transport** for the a1 track.
...
- `## Транспорт (Transport types)` (~250 words)
  - Public transport: автобус (bus), тролейбус (trolleybus), маршрутка (minibus), метро (metro), трамвай (tram). Ukrainian cities and their transport systems.
  - Long-distance transport: потяг (train), літак (airplane), таксі (taxi). Public vs private transport distinction. Choosing transport for different distances.
- `## Вокзал та аеропорт (Station and airport)` (~275 words)
  - Station types: залізничний вокзал (train station), автовокзал (bus station), аеропорт (airport). Key locations inside: каса (ticket office), зал очікування (waiting hall), платформа (platform).
  - Essential phrases: Де вокзал? (Where is the station?). Звідки відправляється потяг? (Where does the train depart from?). О котрій годині? (At what time?). Building station navigation skills.
  - Ticket vocabulary: квиток (ticket), купити квиток (buy a ticket), у один бік (one way), туди й назад (round trip). Connection to a1-56 (Buying Tickets).
- `## Напрямки (Directions)` (~250 words)
  - Direction vocabulary: наліво (left), направо (right), прямо (straight), назад (back). Ordinal turns: перший поворот (first turn), другий поворот (second turn).
  - Imperative directions: Поверніть наліво (Turn left). Ідіть прямо (Go straight). Asking: Як дістатися до...? (How to get to...?) + Genitive. Скажіть, будь ласка, де...? (Tell me please, where is...?)
- `## Подорожі (Journeys)` (~250 words)
  - Destination: Я їду до Львова (I am going to Lviv). До + Genitive for destination cities. Connection to prepositions modules (a1-27, a1-28).
  - Means of transport: Instrumental case without preposition: потягом (by train), автобусом (by bus), літаком (by plane). Я їду потягом — a key A1 instrumental usage.
  - Duration: Скільки часу їхати? (How long is the ride?). Я їду 3 години (I travel 3 hours). Connecting numbers and time with transport.
- `## Практика (Practice)` (~175 words)
  - Direction-giving dialogues: asking and giving directions to specific locations in a city. Combining imperative forms with direction vocabulary.
  - Journey descriptions: Describing a real or imagined trip using transport vocabulary, destination, duration, and means of transport.
...
### Workflow
1. **Research first**: `search_text("Instrumental for transport means (потягом, автобусом) Direction vocabulary and imperative usage", grade=3-5)` — find how textbooks teach this
...
- Navigate stations and airports with basic phrases
- Give and follow simple directions
- Describe a journey including duration and means
content_outline:
- section: Транспорт (Transport types)
  words: 250
  points:
  - 'Public transport: автобус (bus), тролейбус (trolleybus), маршрутка (minibus), метро (metro), трамвай (tram). Ukrainian
    cities and their transport systems.'
  - 'Long-distance transport: потяг (train), літак (airplane), таксі (taxi). Public vs private transport distinction. Choosing
    transport for different distances.'
- section: Вокзал та аеропорт (Station and airport)
  words: 275
  points:
  - 'Station types: залізничний вокзал (train station), автовокзал (bus station), аеропорт (airport). Key locations inside:
    каса (ticket office), зал очікування (waiting hall), платформа (platform).'
  - 'Essential phrases: Де вокзал? (Where is the station?). Звідки відправляється потяг? (Where does the train depart from?).
    О котрій годині? (At what time?). Building station navigation skills.'
  - 'Ticket vocabulary: квиток (ticket), купити квиток (buy a ticket), у один бік (one way), туди й назад (round trip). Connection
    to a1-56 (Buying Tickets).'
- section: Напрямки (Directions)
  words: 250
  points:
  - 'Direction vocabulary: наліво (left), направо (right), прямо (straight), назад (back). Ordinal turns: перший поворот (first
    turn), другий поворот (second turn).'
  - 'Imperative directions: Поверніть наліво (Turn left). Ідіть прямо (Go straight). Asking: Як дістатися до...? (How to get
    to...?) + Genitive. Скажіть, будь ласка, де...? (Tell me please, where is...?)'
- section: Подорожі (Journeys)
  words: 250
  points:
  - 'Destination: Я їду до Львова (I am going to Lviv). До + Genitive for destination cities. Connection to prepositions modules
    (a1-27, a1-28).'
  - 'Means of transport: Instrumental case without preposition: потягом (by train), автобусом (by bus), літаком (by plane).
    Я їду потягом — a key A1 instrumental usage.'
  - 'Duration: Скільки часу їхати? (How long is the ride?). Я їду 3 години (I travel 3 hours). Connecting numbers and time
    with transport.'
- section: Практика (Practice)
  words: 175
  points:
  - 'Direction-giving dialogues: asking and giving directions to specific locations in a city. Combining imperative forms
    with direction vocabulary.'
  - 'Journey descriptions: Describing a real or imagined trip using transport vocabulary, destination, duration, and means
    of transport.'
vocabulary_hints:
  required:
  - автобус (bus) — їхати автобусом; most common public transport
...
activity_hints:
- type: match-up
  focus: Match transport type to appropriate context
  items: 10
- type: quiz
  focus: Direction and travel phrase comprehension
  items: 10
- type: fill-in
  focus: Complete journey dialogue with correct phrases
  items: 10
- type: unjumble
  focus: Reorder words to form direction instructions
  items: 6
connects_to:
- a1-53 (At the Restaurant)
prerequisites:
- a1-51 (Leisure and Hobbies)
persona:
