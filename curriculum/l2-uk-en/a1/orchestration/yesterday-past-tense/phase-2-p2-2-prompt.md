...
> **Your #1 job: Write 825 words for the section "Граматика: Минулий час".**
...
Write the section prose for **Граматика: Минулий час** within the module **Yesterday - Past Tense**.

- **WORD BUDGET**: 825 words minimum, 825 × 2 maximum. Stay in this range.
...
Previously used callout types in this module: history-bite, tip
...
- Target: 825 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Граматика: Минулий час": {count} words (budget: 825-825×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Граматика: Минулий час)
