...
> **Your #1 job: Write 363 words for the section "Практика: Розповідь про вчора".**
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/yesterday-past-tense-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/yesterday-past-tense.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/yesterday-past-tense.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the section prose for **Практика: Розповідь про вчора** within the module **Yesterday - Past Tense**.

- **WORD BUDGET**: 363 words minimum, 363 × 2 maximum. Stay in this range.
...
Previously used callout types in this module: history-bite, myth-buster, observe, tip, warning
...
- Target: 363 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Практика: Розповідь про вчора": {count} words (budget: 363-363×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Практика: Розповідь про вчора)
