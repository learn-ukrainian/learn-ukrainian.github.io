...
3. Verify with Grep: `Grep pattern="first 5-6 words" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/yesterday-past-tense.md"`
...
5. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/yesterday-past-tense-research.md`
...
unverified_terms: []
review_focus:
  - "Check that all distractors in activities correctly use standard verified past tense verb forms as requested by the plan."
  - "Verify strict adherence to English/Ukrainian code-switching per A1 guidelines."
rag_tools_used: []
```
...
Word count:       1601 / 1200 (133.4%)
Activities:       3
Vocabulary items: 20
Engagement boxes: 0
Immersion:        11.0% (target: 20-35%)
Richness:         54% (threshold: 60%)
...
**Words checked:** 149 | **VESUM coverage:** 142/149 (95.3%)

**❌ Not found in VESUM or textbooks (7):**
- `ЗУНР` (source: prose)
- `лася` (source: activities)
- `ли` (source: prose)
- `лися` (source: activities)
- `ло` (source: prose)
