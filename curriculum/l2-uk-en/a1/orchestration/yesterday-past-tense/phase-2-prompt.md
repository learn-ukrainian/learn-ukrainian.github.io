...
Write the full lesson prose for **Yesterday - Past Tense** (a1 track).
...
|---------|--------|---------------------|
| Вступ: Що було вчора? | 400 | 600 |
| Основи минулого часу | 650 | 975 |
| Складні випадки та практика | 600 | 900 |
| Підсумок: Мій день | 350 | 525 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/yesterday-past-tense.yaml`. Go through EVERY `points:` item in EVERY section:
