...
**Grade 3, ponomarova** — Сторінка 120:
```
120
6. Прочитай, як описав ярмарок самими лише дієсловами 
український письменник Остап Вишня.
6
І все це ворушиться, дихає, 
кричить, мекає, ірже, позіхає, 
кувікає, 
пахне, 
кудкудаче, 
лускає насіння, крутиться на
каруселях…
7. Склади і запиши за описом Остапа Вишні розповідь
про стародавній ярмарок. Користуйся поданими запи-
таннями. 
7
1. Як добиралися люди на ярмарок? 
2. Що продавали на ярмарку? 
3. Як розважалась молодь на ярмарку?
8. Прочитай пари речень. Що можеш сказати про значення 
...
**Grade 3, ponomarova** — Сторінка 112:
```
112
