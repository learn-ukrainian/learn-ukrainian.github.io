...
📚 IMMERSION TOO LOW (11.4% vs 20-35% target)
--- STRICT GATES (Level A1) ---
Pedagogy     ❌ 1 violations
Immersion    ❌ 11.4% LOW (target 20-35% (M36))
...
- type: fill-in
  ...
  items:
    ...
    - sentence: "Він ___ каву. (робити)"
      answer: "робив"
      options: ["робив", "робила", "робило", "робили"]
      explanation: "Він is masculine, so we use the -в ending: робив."
...
- type: fill-in
  ...
  instruction: "Complete each sentence with the correct past tense verb from the options."
  items:
    - sentence: "Вчора я ___ каву зранку."
      answer: "робив"
      options: ["робив", "робила", "робили", "робило"]
      explanation: "The speaker (masculine) made coffee yesterday morning. Робив is the masculine past tense of робити."
    - sentence: "Вчора ввечері ми ___ фільм."
      answer: "дивилися"
      options: ["дивився", "дивилася", "дивилися", "дивилося"]
      explanation: "Ми is plural, so the reflexive verb takes the -лися ending."
    - sentence: "Минулого тижня вона ___ в ресторані."
      answer: "їла"
      options: ["їв", "їла", "їли", "їло"]
      explanation: "Вона is feminine. The irregular past tense of їсти for feminine is їла."
    - sentence: "Вчора він ___ книгу."
      answer: "читав"
      options: ["читав", "читала", "читали", "читало"]
      explanation: "Він is masculine, so we use the -в ending: читав."
    - sentence: "Минулого місяця вони ___ у магазині."
      answer: "купували"
      options: ["купував", "купувала", "купували", "купувало"]
      explanation: "Вони is plural, so we use the -ли ending: купували."
    - sentence: "Вчора зранку вона ___ в магазин."
      answer: "ходила"
      options: ["ходив", "ходила", "ходили", "ходило"]
      explanation: "Вона is feminine, so we use the -ла ending: ходила."
```
