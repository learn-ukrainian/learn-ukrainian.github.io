...
3. Verify with Grep: `Grep pattern="first 5-6 words" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/colors-and-clothing.md"`
...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/colors-and-clothing.md`
2. **Activities**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/activities/colors-and-clothing.yaml`
3. **Vocabulary**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/vocabulary/colors-and-clothing.yaml`
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/colors-and-clothing.yaml`
5. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/colors-and-clothing-research.md`
...
unverified_terms: []
review_focus:
  - "Adherence to A1.1 grammar constraints: strictly verb-free sentences (Це + noun/adj) used for descriptions to prevent premature introduction of cases/verbs."
  - "Gender agreement consistency, particularly the contrastive pairings for hard/soft stems (синій) and pluralia tantum nouns."
rag_tools_used:
  - "search_text: 'Color adjectives with agreement Clothing vocabulary' → verified exact grammar rule framing and appropriate contextual usage for A1 adjectives in Ukrainian Grade 1-4 standard curricula."
```
...
Word count:       1566 / 1200 (130.5%)
Activities:       8
Vocabulary items: 20
Engagement boxes: 0
Immersion:        11.7% (target: 10-20%)
Richness:         61% (threshold: 60%)
...
1. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 25
   Text: Agreement mismatch: 'червоний' (m) + 'сорочка' (f)
   Fix: Change 'червоний' to match the gender/case of 'сорочка', or vice versa.
2. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 28
   Text: Agreement mismatch: 'червона' (f) + 'светр' (m)
   Fix: Change 'червона' to match the gender/case of 'светр', or vice versa.
3. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 29
   Text: Agreement mismatch: 'чорна' (f) + 'кіт' (m)
   Fix: Change 'чорна' to match the gender/case of 'кіт', or vice versa.
4. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 30
   Text: Agreement mismatch: 'біле' (n) + 'дім' (m)
   Fix: Change 'біле' to match the gender/case of 'дім', or vice versa.
5. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 84
   Text: Agreement mismatch: 'біла' (f) + 'джинси' (f/p)
   Fix: Change 'біла' to match the gender/case of 'джинси', or vice versa.
6. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 88
   Text: Agreement mismatch: 'чорний' (m) + 'вишиванка' (f)
   Fix: Change 'чорний' to match the gender/case of 'вишиванка', or vice versa.
7. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 90
   Text: Agreement mismatch: 'чорна' (f) + 'светр' (m)
   Fix: Change 'чорна' to match the gender/case of 'светр', or vice versa.
8. **[AGREEMENT_ERROR]** (severity: HIGH)
   Location: ~line 90
   Text: Agreement mismatch: 'синій' (f/m) + 'штани' (p)
   Fix: Change 'синій' to match the gender/case of 'штани', or vice versa.
...
**Words checked:** 78 | **VESUM coverage:** 74/78 (94.9%)

**❌ Not found in VESUM or textbooks (4):**
- `ий` (source: prose)
- `синьа` (source: activities)
- `штан` (source: prose)
- `ій` (source: prose)
