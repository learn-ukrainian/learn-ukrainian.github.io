...
Write the full lesson prose for **Colors & Clothing** (a1 track).
...
|---------|--------|---------------------|
| Вступ та культурний контекст (Introduction & Cultural Context) | 400 | 600 |
| Презентація кольорів та граматика узгодження (Colors & Grammar of Agreement) | 500 | 750 |
| Одяг та дієслово «носити» (Clothing & the Verb 'To Wear') | 600 | 900 |
| Практичне застосування та покупки (Practice & Shopping) | 500 | 750 |
| **Total** | **2000** | **3000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/colors-and-clothing.yaml`. Go through EVERY `points:` item in EVERY section:
