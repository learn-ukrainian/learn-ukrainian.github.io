...
- type: match-up
  ...
  pairs:
    - left: "білий"
      right: "white (masculine)"
    - left: "чорний"
      right: "black (masculine)"
    - left: "червоний"
      right: "red (masculine)"
    - left: "синій"
      right: "blue (masculine)"
    - left: "зелений"
      right: "green (masculine)"
    - left: "жовтий"
      right: "yellow (masculine)"
    - left: "біла"
      right: "white (feminine)"
    - left: "чорна"
      right: "black (feminine)"
    - left: "червона"
      right: "red (feminine)"
    - left: "синя"
      right: "blue (feminine)"
    - left: "зелена"
      right: "green (feminine)"
    - left: "жовта"
      right: "yellow (feminine)"
    - left: "біле"
      right: "white (neuter)"
    - left: "чорне"
      right: "black (neuter)"
    ...
    - left: "жовте"
      right: "yellow (neuter)"
    - left: "бордо"
      right: "burgundy (invariable)"
    - left: "хакі"
      right: "khaki (invariable)"
    - left: "білі"
      right: "white (plural)"
    - left: "чорні"
      right: "black (plural)"
...
- type: match-up
  ...
  pairs:
    ...
    - left: "чорна куртка"
      right: "black jacket"
    - left: "синє плаття"
      right: "blue dress (neuter)"
    - left: "жовтий светр"
      right: "yellow sweater"
    - left: "зелена сорочка"
      right: "green shirt"
...
- type: fill-in
  ...
  items:
    ...
    - sentence: "Це ___ джинси."
      answer: "сині"
      options: ["синій", "синя", "синє", "сині"]
      explanation: "Джинси is plural, so the adjective takes the plural ending -і."
    - sentence: "Ці окуляри — ___."
      answer: "нові"
      options: ["новий", "нова", "нове", "нові"]
      explanation: "Окуляри is plural (pluralia tantum), so the adjective takes the plural ending -і."
...
- type: fill-in
  ...
  items:
    ...
    - sentence: "Це нове ___."
      answer: "плаття"
      options: ["плаття", "сукня", "светр", "штани"]
      explanation: "Нове is neuter, so it matches the neuter noun плаття."
    - sentence: "Ці ___ — білі."
      answer: "штани"
      options: ["штани", "сукня", "светр", "куртка"]
      explanation: "Білі is plural, and штани is the only plural noun among the options."
    - sentence: "Це синя ___."
      answer: "куртка"
      options: ["куртка", "светр", "плаття", "одяг"]
      explanation: "Синя is feminine (soft group), so it matches the feminine noun куртка."
    - sentence: "Мої ___ — нові."
      answer: "джинси"
      options: ["джинси", "куртка", "сукня", "светр"]
      explanation: "Мої and нові are plural forms, and джинси is the only plural noun among the options."
