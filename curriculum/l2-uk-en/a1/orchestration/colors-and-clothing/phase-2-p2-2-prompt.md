...
> **Your #1 job: Write 300 words for the section "Український одяг: Що ми носимо?".**
...
Write the section prose for **Український одяг: Що ми носимо?** within the module **Colors & Clothing**.
...
```
===WORD_COUNTS===
Section "Український одяг: Що ми носимо?": {count} words (budget: 300-300×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Український одяг: Що ми носимо?)
