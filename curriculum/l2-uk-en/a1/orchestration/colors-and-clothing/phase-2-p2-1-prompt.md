...
> **Your #1 job: Write 300 words for the section "Світ кольорів: Узгодження прикметників".**
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/colors-and-clothing-research.md` | Factual foundation — use exhaustively |
...
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/colors-and-clothing.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the section prose for **Світ кольорів: Узгодження прикметників** within the module **Colors & Clothing**.
...
```
===WORD_COUNTS===
Section "Світ кольорів: Узгодження прикметників": {count} words (budget: 300-300×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Світ кольорів: Узгодження прикметників)
