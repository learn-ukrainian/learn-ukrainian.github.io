...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/colors-and-clothing.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/colors-and-clothing-research.md`
...
Word count:       2302 / 2000 (115.1%)
Activities:       9
Vocabulary items: 31
Engagement boxes: 5
Immersion:        36.3% (target: 35-55%)
Audit status:     FAIL
```

## Content Sections (H2 headers in the content file)

1. Кольори навколо нас
2. Основні кольори та узгодження
3. Одяг і дієслово «носити»
4. Множина: штани та окуляри
5. Опис зовнішності та вишиванка
6. Діалог: У магазині одягу
7. Практика: Опис одягу
