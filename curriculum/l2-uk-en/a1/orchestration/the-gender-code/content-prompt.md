...
### Workflow
1. **Research first**: `search_text("Three-gender system Declension families overview", grade=1-2)` — find how textbooks teach this
...
5. **CELEBRATE** — in the final `## Культурний код та підсумок (Cultural Code and Summary)` section, tell learners what they can now do
