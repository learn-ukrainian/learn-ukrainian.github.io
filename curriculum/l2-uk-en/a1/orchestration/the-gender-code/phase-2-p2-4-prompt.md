...
> **Your #1 job: Write 300 words for the section "Застосування: Культура та практика".**
...
Write the section prose for **Застосування: Культура та практика** within the module **The Gender Code**.
...
**Це моє імʼя.** [tsɛ mɔˈjɛ imˈjɑ] — This is my name.
...
Previously used callout types in this module: context, myth-buster, tip, warning
...
```
===WORD_COUNTS===
Section "Застосування: Культура та практика": {count} words (budget: 300-300×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Застосування: Культура та практика)
