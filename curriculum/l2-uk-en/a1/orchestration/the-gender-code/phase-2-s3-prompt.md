...
> **Your #1 job: Write 603 words for the section "Культурний контекст".**
...
Write the section prose for **Культурний контекст** within the module **The Gender Code**.

- **Section minimum**: 201 words
- **Write at least**: 603 words (1.2x — quality over quantity)
...
- Gender rules (M/F/N) and "Dad" exception.
- Declension Families (1-4) and the "Name" trap (ім'я).
...
Previously used callout types in this module: [!tip], [!culture], [!fact], [!warning]
...
## How to Hit 603 Words (Expansion Method)
...
```
===WORD_COUNTS===
Section "Культурний контекст": {count} words (minimum: 201)
===WORD_COUNTS===
```
