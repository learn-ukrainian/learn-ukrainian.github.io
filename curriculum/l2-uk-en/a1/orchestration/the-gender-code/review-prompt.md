...
3. Verify with Grep: `Grep pattern="first 5-6 words" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/the-gender-code.md"`
...
5. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/the-gender-code-research.md`
...
unverified_terms: []
review_focus:
  - "Check that the warm, encouraging tone hits the A1 marks properly."
  - "Verify strict adherence to word length constraints in sentences containing Ukrainian vocabulary."
  - "Ensure no IPA or Russian characters slipped in."
rag_tools_used:
  - "search_text: 'Three-gender system Declension families overview' → relied on pre-populated textbook research context, no extra API queries needed"
```
...
Word count:       1554 / 1200 (129.5%)
Activities:       8
Vocabulary items: 20
Engagement boxes: 1
Immersion:        8.5% (target: 10-20%)
...
**Words checked:** 59 | **VESUM coverage:** 57/59 (96.6%)
