...
> **Your #1 job: Write 328 words for the section "Класифікація: Чотири родини (відміни)".**
...
Write the section prose for **Класифікація: Чотири родини (відміни)** within the module **The Gender Code**.

- **WORD BUDGET**: 328 words minimum, 328 × 2 maximum. Stay in this range.
...
**Це мій дім.** [tsɛ mij dim] — This is my house.
**Це моя книга.** [tsɛ mɔˈjɑ ˈknɪɦɑ] — This is my book.
**Це моє серце.** [tsɛ mɔˈjɛ ˈsɛrtse] — This is my heart.

When you speak about your family or your things, always check the ending of the noun first. If you see a consonant, reach for **мій**. If you see an -а, choose **моя**. If you see an -о, pick **моє**. This simple choice shows your listeners that you have mastered the «Gender Code»!
...
Previously used callout types in this module: context, myth-buster, tip
...
- Target: 328 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Класифікація: Чотири родини (відміни)": {count} words (budget: 328-328×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Класифікація: Чотири родини (відміни))
