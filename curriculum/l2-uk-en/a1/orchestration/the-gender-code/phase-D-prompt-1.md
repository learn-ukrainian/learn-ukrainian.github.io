...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/the-gender-code.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/the-gender-code-research.md`
...
Word count:       2803 / 2000 (140.2%)
Activities:       9
Vocabulary items: 26
Engagement boxes: 8
Immersion:        12.6% (target: 10-25%)
Audit status:     PASS
```

## Content Sections (H2 headers in the content file)

1. Вступ: Таємний код української мови
2. Презентація: Три кити роду
3. Практика: Чотири сім'ї та винятки
4. Продукція: Колір і форма
5. Культурний контекст: Жива мова
6. Підсумок
