...
Write the full lesson prose for **The Gender Code** (a1 track).
...
|---------|--------|---------------------|
| Вступ: Таємний код української мови | 300 | 450 |
| Теорія: Основи визначення роду | 500 | 750 |
| Систематизація: Чотири граматичні сім'ї | 600 | 900 |
| Практикум: Тренування розпізнавання | 300 | 450 |
| Культурний контекст: Жива мова | 300 | 450 |
| **Total** | **2000** | **3000** |
