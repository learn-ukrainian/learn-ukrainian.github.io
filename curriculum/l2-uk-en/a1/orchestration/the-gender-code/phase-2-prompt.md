...
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/the-gender-code.yaml` | Section titles + word allocations, activity count targets |
...
## Lexical Sandbox for M7

**FORBIDDEN at M7:** ALL verbs, imperative forms, oblique cases (only nominative/vocative)
...
| брат | masculine | брат, брате, брати |
| сестра | feminine | сестра, сестри, сестро |
| мама | feminine | мама, мами, мамо |
| тато | masculine | тати, тато, тату |
| дім | masculine | доме, доми, дім |
| вікно | neuter | вікна, вікно |
| книга | feminine | книга, книги, книго |
| місто | neuter | міста, місто |
| стіл | masculine | столе, столи, стіл |
| мор | masculine | мор, море |
| ніч | feminine | ноче, ночі, ніч |
| земля | feminine | земле, земля, землі |
| серце | neuter | серце, серця |
| сонце | neuter | сонце, сонця |
| собака | masculine | собака, собаки, собако |
| ім'я | neuter | ім'я, імена, імене, імені |
| артефакт | masculine | артефакт, артефакте, артефакти |
| зона | feminine | зона, зони, зоно |
| укриття | neuter | укриття |
...
Write **The Gender Code** for the a1 track.
...
- `## Вступ (Introduction: The Three Genders)` (~200 words)
- `## Презентація правил (Decoding the Endings)` (~350 words)
- `## Практичні вправи (Exceptions and Families)` (~300 words)
- `## Самостійна робота (Beating the 'It' Trap)` (~200 words)
- `## Культурний код та підсумок (Summary and Self-Check)` (~150 words)

### Section Word Budgets

| Section | Target |
|---------|--------|
| Вступ (Introduction: The Three Genders) | 200 |
| Презентація правил (Decoding the Endings) | 350 |
| Практичні вправи (Exceptions and Families) | 300 |
| Самостійна робота (Beating the 'It' Trap) | 200 |
| Культурний код та підсумок (Summary and Self-Check) | 150 |
| **Total** | **1200** |
