...
> **Your #1 job: Write 1230 words for the section "Презентація: Код роду".**
...
Write the section prose for **Презентація: Код роду** within the module **The Gender Code**.

- **Section minimum**: 410 words
- **Write at least**: 1230 words (1.2x — quality over quantity)
...
## How to Hit 1230 Words (Expansion Method)
...
```
===WORD_COUNTS===
Section "Презентація: Код роду": {count} words (minimum: 410)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Презентація: Код роду)
