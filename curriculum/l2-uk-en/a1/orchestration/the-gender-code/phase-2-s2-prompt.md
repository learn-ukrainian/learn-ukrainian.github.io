...
> **Your #1 job: Write 969 words for the section "Практика: Чотири відміни".**
...
Write the section prose for **Практика: Чотири відміни** within the module **The Gender Code**.

- **Section minimum**: 323 words
- **Write at least**: 969 words (1.2x — quality over quantity)
...
Covered in "Презентація: Код роду":
- The Architecture of Ukrainian Nouns
- Masculine Rule: Consonants (стіл, брат)
- Feminine Rule: -A/-Я (книга, земля)
- Neuter Rule: -O/-E (вікно, море)
- The "Dad" Exception (тато)
- Basics of Agreement (мій, моя, моє)
...
## How to Hit 969 Words (Expansion Method)
...
```
===WORD_COUNTS===
Section "Практика: Чотири відміни": {count} words (minimum: 323)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Практика: Чотири відміни)
