...
> **Your #1 job: Write 450 words for the section "Презентація: Основні правила роду".**
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/the-gender-code-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/the-gender-code.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a1/the-gender-code.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the section prose for **Презентація: Основні правила роду** within the module **The Gender Code**.

- **WORD BUDGET**: 450 words minimum, 450 × 2 maximum. Stay in this range.
...
TARGET: 10-25% Ukrainian, 75-90% English. ALL explanatory prose in English. Grammar explained in English. Ukrainian in examples and short phrases only — always with English translations. Callout text in English. Ukrainian sentences max 10 words.
...
---
### The Instinct Test: Guessing New Words
Let's try a small test of your new intuition. Imagine you are at a local cafe in Kyiv. You are looking at a menu with new words. You can use the «ending rule» to guess their gender immediately. Take a look at the ending first. What is the gender of «піца» [ˈpitsɑ] (pizza)? It ends in -а, so it must be feminine! What is the gender of «таксі» [tɑkˈsi] (taxi)? This is a loanword from another language. Most words you encounter will follow our simple code. You will soon start to «feel» the language. It feels like meeting new neighbors. You see their faces and you instinctively know their names. In Ukrainian, you see the ending and you know the gender. This code helps you speak better because it affects your adjectives and pronouns later. **Успіхів!** [ˈuspixʲiu̯] (Good luck!)

- **мама** [ˈmɑmɑ] — mother (feminine). **Це моя мама.** [tsɛ mɔˈjɑ ˈmɑmɑ] — This is my mother.
- **тато** [ˈtɑtɔ] — father (masculine). **Це мій тато.** [tsɛ mij ˈtɑtɔ] — This is my father.
- **серце** [ˈsɛrtse] — heart (neuter). **Це моє серце.** [tsɛ mɔˈjɛ ˈsɛrtse] — This is my heart.
...
Previously used callout types in this module: context, tip
...
- Target: 450 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Презентація: Основні правила роду": {count} words (budget: 450-450×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Презентація: Основні правила роду)
