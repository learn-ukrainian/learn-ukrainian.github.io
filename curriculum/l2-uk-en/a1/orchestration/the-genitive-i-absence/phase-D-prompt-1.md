...
2. For EVERY Ukrainian sentence you plan to cite, run:
   ```bash
   grep -c "first 5-6 words of the sentence" /Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/the-genitive-i-absence.md
   ```
...
5. **Meta** (build config): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/meta/the-genitive-i-absence.yaml`
