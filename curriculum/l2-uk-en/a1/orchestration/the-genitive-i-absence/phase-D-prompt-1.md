...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/the-genitive-i-absence.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a1/research/the-genitive-i-absence-research.md`
...
Word count:       2227 / 2000 (111.3%)
Activities:       10
Vocabulary items: 20
Engagement boxes: 6
Immersion:        29.2% (target: 25-40%)
Audit status:     FAIL
```

## Content Sections (H2 headers in the content file)

1. Вступ: Ситуація відсутності
2. Граматика: Конструкція «Немає» та «Без»
3. Практика: Родовий відмінок у дії
4. Культурний контекст: «Немає проблем»
