...
> **Your #1 job: Write 507 words for the section "Презентація".**
...
Write the section prose for **Презентація** within the module **The Genitive I: Absence**.

- **WORD BUDGET**: 507 words minimum, 507 × 2 maximum. Stay in this range.
...
- Target: 507 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Презентація": {count} words (budget: 507-507×2)
===WORD_COUNTS===
```
