...
> **Your #1 job: Write 375 words for the section "Культурний контекст".**
...
| File | Purpose |
|------|---------|
| `curriculum/l2-uk-en/a1/research/the-genitive-i-absence-research.md` | Factual foundation — use exhaustively |
| `curriculum/l2-uk-en/a1/meta/the-genitive-i-absence.yaml` | Content outline with section word allocations |
| `curriculum/l2-uk-en/plans/a1/the-genitive-i-absence.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the section prose for **Культурний контекст** within the module **The Genitive I: Absence**.

- **WORD BUDGET**: 375 words minimum, 375 × 2 maximum. Stay in this range.
...
Previously used callout types in this module: tip, warning, culture, context, fact, observe
...
- Target: 375 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Культурний контекст": {count} words (budget: 375-375×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Культурний контекст)
