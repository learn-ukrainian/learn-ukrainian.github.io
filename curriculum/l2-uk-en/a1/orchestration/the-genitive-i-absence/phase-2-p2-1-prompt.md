...
> **Your #1 job: Write 300 words for the section "Розминка".**
...
Write the section prose for **Розминка** within the module **The Genitive I: Absence**.
...
```
===WORD_COUNTS===
Section "Розминка": {count} words (budget: 300-300×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Розминка)
