...
|---------|--------|---------------------|
| Вступ: Ситуація відсутності | 300 | 450 |
| Граматика: Конструкція 'Немає' та 'Без' | 800 | 1200 |
| Практика: Родовий відмінок у дії | 500 | 750 |
| Культурний контекст: 'Немає проблем' | 400 | 600 |
| **Total** | **2000** | **3000** |
