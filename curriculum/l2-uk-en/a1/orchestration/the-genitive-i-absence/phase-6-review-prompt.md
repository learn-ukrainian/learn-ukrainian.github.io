...
1. **Content** (the lesson you're reviewing): `curriculum/l2-uk-en/a1/the-genitive-i-absence.md`
2. **Activities**: `curriculum/l2-uk-en/a1/activities/the-genitive-i-absence.yaml`
3. **Vocabulary**: `curriculum/l2-uk-en/a1/vocabulary/the-genitive-i-absence.yaml`
4. **Plan** (source of truth for scope): `curriculum/l2-uk-en/plans/a1/the-genitive-i-absence.yaml`
5. **Meta** (build config): `curriculum/l2-uk-en/a1/meta/the-genitive-i-absence.yaml`
