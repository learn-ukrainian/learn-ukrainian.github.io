...
```
curriculum/l2-uk-en/plans/a1/the-genitive-i-absence.yaml
```

Read the meta file:

```
curriculum/l2-uk-en/a1/meta/the-genitive-i-absence.yaml
```
...
Research **The Genitive I: Absence** for the **A1** core track. Core tracks need lighter research than seminar tracks — focus on accuracy and State Standard alignment.
