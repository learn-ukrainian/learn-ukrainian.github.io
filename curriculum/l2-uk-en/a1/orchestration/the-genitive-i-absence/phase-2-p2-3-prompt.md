...
> **Your #1 job: Write 375 words for the section "Практика".**
...
Write the section prose for **Практика** within the module **The Genitive I: Absence**.
...
Previously used callout types in this module: tip, warning, culture
...
```
===WORD_COUNTS===
Section "Практика": {count} words (budget: 375-375×2)
===WORD_COUNTS===
```
