...
Previously introduced in this module: ["наголос", "мелодика", "склад", "наголошений", "ненаголошений", "голосний", "слово", "речення", "питання", "хто", "що", "де", "коли", "як", "кава", "вода", "столиця", "ранок", "метро", "фотографія", "одинадцять", "чотирнадцять", "молоко", "голова", "голови", "українська", "відпочинок", "новий", "старий", "гарно", "Марія"]
