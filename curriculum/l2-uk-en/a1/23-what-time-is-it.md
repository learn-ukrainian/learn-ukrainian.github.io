...
grammar:
  ...
  - Time prepositions (о, до, після, перед, з...до)
  - Days of the week
  - Months of the year
objectives:
...
Match the Ukrainian day with its English equivalent.
...
## match-up: Months of the Year

Match the Ukrainian month with its English equivalent.
...
2. О котрій зустріч? — О ___.
   > [!answer] п'ятій
   > [!options] п'ятій | п'ять | п'ятого | п'яти

3. Магазин працює з дев'ятої ___ шостої.
   > [!answer] до
   > [!options] до | о | на | в

4. ___ обіду я відпочиваю.
   > [!answer] Після
   > [!options] Після | До | О | На

5. Я приїду ___ третій.
   > [!answer] о
   > [!options] о | до | з | на

6. Зараз пів ___ третю.
   > [!answer] на
   > [!options] на | до | о | в

7. Зустріч ___ дванадцятій.
   > [!answer] о
   > [!options] о | до | на | в
...
## true-false: Calendar Knowledge

Decide if each statement is true or false.

- [x] Понеділок — перший день тижня в Україні.
  > Correct! The Ukrainian week starts on Monday.

- [ ] Тиждень має шість днів.
  > Incorrect! A week has seven days.

- [x] Листопад названий від "листя падає".
  > Correct! Listopad means "leaves fall."

- [ ] Субота — це робочий день.
  > Incorrect! Saturday is a weekend day.

- [x] Червень, липень, серпень — це літо.
  > Correct! These are the summer months.

- [ ] Січень — це весняний місяць.
  > Incorrect! January is a winter month.

- [x] Неділя означає "немає діла" (no work).
  > Correct! Nedilya means "no work."

- [ ] Середа — це останній день тижня.
  > Incorrect! Wednesday is the middle of the week.

- [x] Україна використовує 24-годинний формат часу.
  > Correct! Ukraine uses 24-hour time officially.

- [ ] "Рано" означає "late".
  > Incorrect! "Рано" means "early."

- [x] "Вчасно" означає "on time".
  > Correct!

- [ ] Вихідні — це понеділок і вівторок.
  > Incorrect! Weekend is Saturday and Sunday.
