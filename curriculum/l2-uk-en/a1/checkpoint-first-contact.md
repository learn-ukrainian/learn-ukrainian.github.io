...
3.  **С vs C**: Ukrainian **С** (es) is [s].
    *   *Приклад:* **Соус** [ˈsɔus] — Sauce, **Суп** [sup] — Soup.
...
*   **Г** (he) — fricative sound [ɦ].
    *   *Приклад:* **Говорити** [ɦɔʋɔˈrɪtɪ] — to speak.
*   **Ґ** (ge) — stop sound [ɡ]. It has a "curl".
    *   *Приклад:* **Ґудзик** [ˈɡud͡zɪk] — button.

#### Е vs Є
*   **Е** — is [ɛ]. Hard sound.
    *   *Приклад:* **Де** [dɛ] — Where.
*   **Є** — is [jɛ].
    *   *Приклад:* **Європа** [jɛˈʋrɔpɑ] — Europe.
...
*   **Напої** [nɑˈpɔji] — Drinks (Coffee, Tea, Juice)
*   **Страви** [ˈstrɑʋɪ] — Dishes (Soup, Salad, Main course)
*   **Десерти** [dɛˈsɛrtɪ] — Desserts (Cake, Ice cream)
*   **Супи** [ˈsupɪ] — Soups (Borscht!)

The waiter will say: **«Смачного!»** [smɑt͡ʃˈnɔɦɔ]. This is "Bon appétit" or "Enjoy your meal".
Your answer: **«Дякую!»**.

### The Bill
You need **рахунок** [rɑˈxunɔk] — bill.
