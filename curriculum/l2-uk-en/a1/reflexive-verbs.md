...
word_target: 2000
content_outline:
- section: 'Розминка: Що таке зворотні дієслова?'
  words: 300
  points:
  - 'Intro: Use the ''mirror'' analogy to explain how -ся turns action back onto the
    subject (Reflexive = Reflection)'
  - 'Etymology: Explain that -ся is short for себе (self), historically a separate
    word that fused'
  - 'Common Error: Explicitly warn against ''The Myself Redundancy'' (saying ''Я мию
    себе'' instead of ''Я миюся'')'
  - 'English Scaffolding: Since this is A1, use clear English explanations for the
    concept of reflexivity'
- section: 'Теорія: Відмінювання та групи'
  words: 700
  points:
  - 'The Golden Rule: Use -ся after consonants and -сь after vowels (euphony)'
  - 'Conjugation Table: Present tense focus per State Standard (дивлюся, дивишся,
    дивиться...)'
  - 'Type 1 (True Reflexive): Routine actions like вмиватися, одягатися (collocations:
    холодною водою, тепло)'
  - 'Type 2 (Reciprocal): Actions involving two people like зустрічатися, вітатися,
    цілуватися'
  - 'Type 3 (Lexicalized): Words where -ся changes meaning entirely like сміятися,
    дивитися'
  - 'Preposition Alert: Teach ''сміятися з'' (laugh from) vs Russian/English ''laugh
    at'''
- section: 'Практика: Дія на себе чи на іншого?'
  words: 600
  points:
  - 'Contrast: Explicitly compare transitive мити (washing a plate) vs reflexive митися
    (washing face)'
  - 'Scenario: Одягати (dressing a child/doll) vs Одягатися (getting dressed yourself)'
  - 'Drill: Choosing between -ся and -сь based on the verb ending'
  - 'Usage: Contextual examples with high-frequency verbs (вчитися, займатися)'
- section: 'Культура: Секрети вимови'
  words: 400
  points:
  - 'Pronunciation Hook: The -ться combination sounds like [ц'':а] (long soft ''ts'')'
  - 'Accent Reduction: Mastering this soft buzzing sound is a ''shibboleth'' for sounding
    natural'
  - 'Etiquette Debate: ''Вибачаюсь'' (I excuse myself) vs ''Вибачте'' (Excuse me)
    — why logic matters'
  - 'Summary: Reflexive verbs reflect the Ukrainian mindset of self-contained action'
---
