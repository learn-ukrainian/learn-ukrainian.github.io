...
subtitle: "Я вважаю, На мою думку..."
level: B1
phase: B1.1
duration: 45
...
| На мою думку, ... | In my opinion, ... | neutral |
| На мій погляд, ... | In my view, ... | formal |
| З моєї точки зору, ... | From my point of view, ... | formal |
| Мені здається, що... | It seems to me that... | softer |
...
| Ukrainian | English |
|-----------|---------|
| Я впевнений/а, що... | I'm sure that... |
| Я переконаний/а, що... | I'm convinced that... |
| Без сумніву, ... | Without a doubt, ... |
| Безперечно, ... | Undoubtedly, ... |
| Очевидно, що... | Obviously, ... |
| Звісно, що... | Of course, ... |
...
| Не впевнений/а, але... | Not sure, but... |
| Важко сказати, але... | Hard to say, but... |
...
| тому що | because |
| оскільки | since, as |
| через те, що | because of the fact that |
| завдяки тому, що | thanks to the fact that |
| адже | for, since, because |
| бо | because (informal) |
...
| Ukrainian | English |
|-----------|---------|
| Головне, що... | The main thing is that... |
| Найважливіше, що... | The most important thing is that... |
...
1. ___ думку, це правильно. (In my)
   > [!answer] **На мою**
2. Я ___, що він має рацію. (think/believe)
   > [!answer] **вважаю/думаю**
3. ___ боку, це добре. (On one)
   > [!answer] **З одного**
4. ___ сумніву, це найкращий варіант. (Without)
   > [!answer] **Без**
5. Він помилився, ___ не мав досвіду. (because)
   > [!answer] **тому що/бо**
