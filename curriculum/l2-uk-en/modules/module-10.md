...
Congratulations! You've completed A1.1 - the first phase of your Ukrainian journey. Let's review everything you've learned in Modules 1-9:

✅ **The Cyrillic Code** - All 33 letters
✅ **Noun Gender** - Masculine, feminine, neuter
✅ **Pronouns** - Я, ти, він, вона, воно, ми, ви, вони
✅ **Demonstratives** - Цей, ця, це, ці
✅ **Verbs** - Class I and Class II conjugation
✅ **Questions** - Чи, що, хто, де, куди, коли, чому, як
✅ **Negation** - Не, ніхто, ніщо, ніколи
✅ **Numbers** - 0-100

> 💡 **Did You Know?**
>
> By completing A1.1, you can already:
> - Read any Ukrainian word (even if you don't know what it means)
> - Introduce yourself
> - Ask and answer basic questions
> - Count and talk about prices
> - Form basic sentences in present tense
>
...
**True Friends (same look & sound):** А Е І О К М Т

**False Friends (look Latin, different sound):** В=V, Н=N, Р=R, С=S, У=U, Х=KH

**Unique Letters:** Г=H, Ґ=G, Ж=ZH, Ш=SH, Щ=SHCH, Ч=CH, Ц=TS

**Iotated Vowels:** Є=YE, Ї=YI, Ю=YU, Я=YA

**Special:** И=short i, Й=Y consonant, Ь=soft sign (no sound)

### Gender Quick Check

| Ending | Gender | Example |
|--------|--------|---------|
| Consonant | Masculine | стіл, студент |
| -а, -я | Feminine | книга, земля |
| -о, -е | Neuter | вікно, море |
| -ь after ч/ш/щ | Feminine | ніч, річ |

### Verb Patterns

**Class I (-ати/-яти):** читаю, чита**є**ш, чита**є**, чита**є**мо, чита**є**те, читають

**Class II (-ити/-іти):** говорю, говор**и**ш, говор**и**ть, говор**и**мо, говор**и**те, говорять

**Key difference:** -є- (Class I) vs -и- (Class II)

### Question Formation

**Yes/No:** Чи ти читаєш? / Ти читаєш? ↗

**Wh-questions:** Що? Хто? Де? Куди? Коли? Чому? Як? Скільки?

### Negation

- Simple: Я **не** знаю.
- Double: Я **ні**чого **не** знаю.
- Negative words: ніхто, ніщо, ніде, ніколи

### Numbers

- 1-10: один, два, три, чотири, п'ять, шість, сім, вісім, дев'ять, десять
- Teens: одинадцять... дев'ятнадцять
- Tens: двадцять, тридцять, **сорок**, п'ятдесят... **дев'яносто**, сто

> 🎯 **Self-Assessment Checklist**
>
> Can you...
> - [ ] Read Cyrillic without hesitation?
> - [ ] Identify noun genders by endings?
> - [ ] Conjugate -ати and -ити verbs?
> - [ ] Form questions with Чи and question words?
> - [ ] Use double negatives correctly?
> - [ ] Count from 0 to 100?
> - [ ] Say basic prices in гривні?
...
Read and translate:
1. Це моя книга. Вона нова.
2. Чи ти говориш українською?
3. Я нічого не знаю про це.
4. Скільки коштує ця сумка?
5. Двадцять п'ять гривень.

### Quick Conjugation

Complete:
- читати: я ___, ти ___, він ___
- говорити: я ___, ти ___, вона ___
- робити: я ___, ми ___, вони ___

### Gender Sorting

Classify: стіл, книга, вікно, ніч, море, день, земля, молоко

## production

### Self-Introduction

Write/say about yourself:
- Привіт! Я ___ (name).
- Я з ___ (country).
- Я ___ (profession/student).
- Я говорю ___ (languages).
- Мені ___ років. (age)
...
B: Привіт! Мене звати ___. А тебе?
A: Мене звати ___. Ти студент?
B: Так / Ні, я ___.
...
## A1.1 Competencies Achieved

| Skill | Status |
|-------|--------|
| Read Cyrillic | ✅ Complete |
| Identify gender | ✅ Complete |
| Use pronouns | ✅ Complete |
| Use demonstratives | ✅ Complete |
| Conjugate Class I | ✅ Complete |
| Conjugate Class II | ✅ Complete |
| Form questions | ✅ Complete |
| Use negation | ✅ Complete |
| Count 0-100 | ✅ Complete |

## Ready for A1.2!

You're now prepared to learn:
- **Cases** - How nouns change form (accusative, locative, genitive)
- **More vocabulary** - City, food, places
- **Practical skills** - Ordering food, asking directions
...
>
> - **Alphabet:** 33 letters including Ї (unique to Ukrainian)
> - **Gender:** Consonant=M, -а/-я=F, -о/-е=N
> - **Verbs:** Class I (-ати, -є- pattern), Class II (-ити, -и- pattern)
> - **Questions:** Чи + statement, or question words
> - **Negation:** Не before verb, double negatives required
> - **Numbers:** 0-100, with noun agreement rules

> 🎯 **Coming Next: A1.2 Navigation**
>
> In Module 11, you'll start learning cases:
> - **Accusative case** - for direct objects
> - "I see the book" = Я бачу книг**у** (not книга!)
> - Your first real grammar transformation!
