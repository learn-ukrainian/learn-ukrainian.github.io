...
1. Він ___ (приходив/прийшов) вчора о п'ятій. → **прийшов** (single event)
2. Вона завжди ___ (готувала/приготувала) смачно. → **готувала** (always = repeated)
3. Одного разу ми ___ (бачили/побачили) ведмедя в лісі. → **побачили** (once)
4. Раніше він часто ___ (хворів/захворів). → **хворів** (often = repeated)
5. Минулого року вона ___ (закінчувала/закінчила) університет. → **закінчила** (single)
6. Кожного ранку він ___ (бігав/побігав). → **бігав** (every morning = repeated)

### Transform: Single to Repeated

Change from perfective (single) to imperfective (repeated):

1. Він подзвонив мені вчора. → Він **телефонував** мені щодня.
2. Вона приготувала вечерю. → Вона завжди **готувала** вечерю.
3. Я відповів на запитання. → Я **відповідав** на всі запитання.
4. Ми купили хліб. → Ми **купували** хліб щодня.

### Transform: Repeated to Single

Change from imperfective (repeated) to perfective (single):

1. Він завжди приходив рано. → Вчора він **прийшов** рано.
2. Вона часто писала листи. → Вона **написала** один лист.
3. Ми зустрічалися щотижня. → Ми **зустрілися** в понеділок.
4. Я читав цю книгу. → Я **прочитав** цю книгу.
