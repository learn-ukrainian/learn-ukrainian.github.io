...
1. Я йду з ___ (друг).
   > [!answer] другом
2. Вона живе з ___ (сестра).
   > [!answer] сестрою
3. Ми розмовляємо з ___ (вчитель).
   > [!answer] вчителем
4. Він їде з ___ (батьки).
   > [!answer] батьками
5. Я хочу бути з ___ (ти).
   > [!answer] тобою
6. Вони працюють з ___ (ми).
   > [!answer] нами
...
1. Я / жити / батьки
   > [!answer] Я живу з батьками.
2. Вона / гуляти / собака
   > [!answer] Вона гуляє з собакою.
3. Ми / їхати / друзі
   > [!answer] Ми їдемо з друзями.
4. Він / працювати / колеги
   > [!answer] Він працює з колегами.
