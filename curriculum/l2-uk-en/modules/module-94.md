...
|-----------|---------|--------|
| Пройдіть прямо. | Go straight. | про- |
| Перейдіть вулицю. | Cross the street. | пере- |
...
**Local:** Gives directions using motion verbs

Use: пройти, перейти, зайти, обійти, увійти, повернути
