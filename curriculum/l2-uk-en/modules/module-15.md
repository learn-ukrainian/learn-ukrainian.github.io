...
objectives:
  ...
  - Use direction words (straight, left, right)
...
You've landed in Kyiv. You need to find your hotel, a café, the metro... How do you ask for directions?
...
> 💡 **Did You Know?**
>
> Ukrainian cities have excellent public transport! Kyiv's metro is one of the deepest in the world (some stations are 100m underground - built to double as bomb shelters). The words "метро" and "станція" will be among your most useful vocabulary!
...
- Вибачте, де...? (Excuse me, where is...?)
- Ви не підкажете, де...? (Could you tell me where...?)

> ⚡ **Pro Tip: Politeness Matters**
>
> Always start with:
> - **Вибачте** (Excuse me) - literally "forgive me"
> - **Скажіть, будь ласка** (Tell me, please)
>
> Ukrainians appreciate polite beginnings to requests!
...
| там | tam | there |
| далеко | daleko | far |
| близько | blyzko | near, close |
| поруч | poruch | next to, nearby |

> 📜 **History Bite: Право- and Ліво-**
>
> "Праворуч" (right) contains "право" (right/law), connected to "правда" (truth) and "правий" (correct). In many cultures, right = correct/good. "Ліворуч" (left) contains "ліво" - connected to concepts of "other" or "different." These associations are thousands of years old across Indo-European languages!
...
| Infinitive | Imperative (ви) | English |
|------------|-----------------|---------|
| йти | йдіть | go (on foot) |
| іти | ідіть | go |
| повернути | поверніть | turn |
| перейти | перейдіть | cross |
| пройти | пройдіть | pass, go through |
...
- Пройдіть два квартали. (Go two blocks.)

> 🎯 **Fun Fact: Metro Station Names**
>
> Kyiv metro stations often have meaningful names:
> - **Майдан Незалежності** - Independence Square
> - **Золоті ворота** - Golden Gate (medieval gate)
> - **Хрещатик** - main street name (from хрещення = baptism)
> - **Університет** - University
>
> Learning station names teaches you history and vocabulary!
...
> 🎭 **Culture Corner: Street Names**
>
> Ukrainian streets are named after:
> - **Famous people**: вулиця Шевченка, вулиця Лесі Українки
> - **Historical events**: вулиця Незалежності (Independence Street)
> - **Cities**: Київська вулиця, Львівська вулиця
>
> Many streets were renamed after 2014 and 2022, replacing Soviet-era names with Ukrainian ones!
...
>
> - **Де...?** for asking location
> - Direction words: прямо, праворуч, ліворуч, назад
> - Prepositions: біля, навпроти, до, за
> - Imperatives: йдіть, поверніть, перейдіть
> - City vocabulary: метро, станція, аптека, банк
> - Polite openers: Вибачте, Скажіть, будь ласка

> 🎯 **Coming Next**
>
> In Module 16, you'll learn the **genitive case**:
> - Expressing possession: книга **студента** (the student's book)
> - Absence: немає **часу** (no time)
> - After numbers 5+: п'ять **книг** (five books)
