...
grammar:
  - Perfective past for results
  - Imperfective past for process/duration
  - Context-based aspect selection
---
...
| She was cooking dinner. | She cooked dinner (it's ready). |
...
1. Я ___ (дивився/подивився) цей фільм три рази. → **дивився** (three times = process)
2. Ти вже ___ (снідав/поснідав)? → **поснідав** (already = result)
3. Вона ___ (працювала/попрацювала) там п'ять років. → **працювала** (duration)
4. Він швидко ___ (одягався/одягнувся). → **одягнувся** (quickly completed)
5. Ми ___ (будували/побудували) дім за рік. → **побудували** (completed in a year)
6. Що ви ___ (робили/зробили) весь день? → **робили** (all day = process)
...
1. Він прочитав книгу. → Він **читав** книгу весь вечір.
2. Ми побудували дім. → Ми **будували** дім два роки.
3. Вона написала листа. → Вона **писала** листа годину.

Change perspective from process to result:

1. Я вчив нові слова. → Я **вивчив** нові слова.
2. Вона готувала обід. → Вона **приготувала** обід.
3. Ми шукали ключі. → Ми **знайшли** ключі.
...
**Completion (IN HOW MUCH TIME) = Perfective:**
- за годину, за два дні, швидко

## Key Patterns

1. **Interrupted action** → imperfective (Я читав, коли...)
2. **Duration words** → imperfective (...три години)
3. **"Вже" (already)** → perfective (Він вже приїхав)
4. **"За + time"** → perfective (Я зробив це за годину)
