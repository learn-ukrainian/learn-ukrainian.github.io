...
objectives:
  ...
  - Match possessives to noun gender and number
  - Distinguish свій from regular possessives
  - Express ownership and relationships
grammar:
  - Possessive pronouns (мій, твій, наш, ваш, etc.)
  - Gender/number agreement
  - Свій (reflexive possessive)
---
...
You learned demonstratives (цей, ця, це) in Module 05. Possessive pronouns work the same way - they match the noun's gender and number!

- **мій** стіл (my table - masculine)
- **моя** книга (my book - feminine)
- **моє** вікно (my window - neuter)
- **мої** друзі (my friends - plural)

Same root "мо-", different endings for each gender.

> 💡 **Did You Know?**
>
> Ukrainian possessives come from the genitive (possession) forms of personal pronouns. "Мій" literally evolved from something like "of me." This is why possessives in all Slavic languages look similar - they share this ancient origin!

## presentation

### First & Second Person Possessives

**Мій (my) - matches noun gender:**

| Gender | Form | Example |
|--------|------|---------|
| Masculine | мій | мій брат (my brother) |
| Feminine | моя | моя сестра (my sister) |
| Neuter | моє | моє ім'я (my name) |
| Plural | мої | мої друзі (my friends) |

**Твій (your - informal) - same pattern:**

| Gender | Form | Example |
|--------|------|---------|
| Masculine | твій | твій телефон (your phone) |
| Feminine | твоя | твоя книга (your book) |
| Neuter | твоє | твоє місто (your city) |
| Plural | твої | твої речі (your things) |

> ⚡ **Pro Tip: The Pattern**
>
> All possessives follow the same endings:
> - Masculine: -ій (мій, твій, наш)
> - Feminine: -я (моя, твоя, наша)
> - Neuter: -є (моє, твоє, наше)
> - Plural: -і (мої, твої, наші)

### Third Person Possessives

**Його (his/its) - NEVER changes!**
- його брат (his brother)
- його сестра (his sister)
- його ім'я (his name)
- його друзі (his friends)

**Її (her) - NEVER changes!**
- її брат (her brother)
- її книга (her book)
- її місто (her city)
- її друзі (her friends)

**Їхній (their) - changes like мій:**

| Gender | Form | Example |
|--------|------|---------|
| Masculine | їхній | їхній дім (their house) |
| Feminine | їхня | їхня машина (their car) |
| Neuter | їхнє | їхнє рішення (their decision) |
| Plural | їхні | їхні діти (their children) |

> 🎯 **Fun Fact: The Unchanging Ones**
>
> Why don't його and її change? They're actually genitive forms of він and вона, frozen as possessives:
> - "його книга" literally = "the book of him"
> - "її дім" literally = "the house of her"
>
> This frozen genitive construction is why they never change for gender!
...
| Gender | Form | Example |
|--------|------|---------|
| Masculine | наш | наш клас (our class) |
| Feminine | наша | наша родина (our family) |
| Neuter | наше | наше місто (our city) |
...
| Gender | Form | Example |
|--------|------|---------|
| Masculine | ваш | ваш паспорт (your passport) |
| Feminine | ваша | ваша валіза (your suitcase) |
| Neuter | ваше | ваше місце (your seat) |
| Plural | ваші | ваші документи (your documents) |

> 📜 **History Bite: Наш vs Ваш**
>
...
> - Use **твій** with friends, family, children, peers
> - Use **ваш** with strangers, elders, in professional settings
> - Addressing someone with ти/твій when ви/ваш is expected is considered rude!
>
> When in doubt, use ви/ваш - it's always safe.

## practice

### Match Possessive to Noun

Choose the correct form:
1. ___ брат (мій/моя/моє)
   > [!answer] мій
2. ___ книга (твій/твоя/твоє)
   > [!answer] твоя
3. ___ місто (наш/наша/наше)
   > [!answer] наше
4. ___ друзі (ваш/ваша/ваші)
   > [!answer] ваші
...
> - **Ні, це її сумка.** - No, it's her bag.
> - **Де ваш паспорт?** - Where is your passport?
...
| reflexive | свій | своя | своє | свої |

## Key Rules

1. **Його, її** - never change
2. **All others** - match gender/number of the noun they describe
3. **Свій** - use when possessive refers back to subject
...
>
> - Possessives agree with the **noun's gender**, not the owner's!
> - Pattern: -ій (m), -я (f), -є (n), -і (pl)
> - **Його** and **її** never change
> - **Свій** = reflexive "one's own"
> - Question word: **Чий?** (whose?)
