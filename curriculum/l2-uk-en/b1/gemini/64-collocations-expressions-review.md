...
|---|---|---|---|
| **Колокації та вирази** | ⚪️ | 25 | Skipped |
| **Diagnostics** | ✅ | 132 | Included in Core |
| **Analysis** | ⚪️ | 885 | Skipped |
...
| **fill-in: Правильна колокація** | 🎮 | 14 | Activity (14 items, min 8) |
| **fill-in: Колокації в контексті** | 🎮 | 14 | Activity (14 items, min 8) |
| **unjumble: Речення з колокаціями** | 🎮 | 10 | Activity (10 items, min 6) |
| **error-correction: Помилки в колокаціях** | 🎮 | 14 | Activity (14 items, min 6) |
| **cloze: Діловий лист** | 🎮 | 6 | Activity (6 items, min 6) |
| **translate: Переклад колокацій** | 🎮 | 14 | Activity (14 items, min 6) |
| **group-sort: Колокації за відмінком** | 🎮 | 8 | Activity (8 items, min 8) |
| **mark-the-words: Знайдіть колокації** | 🎮 | 7 | Activity (7 items, min 6) |
