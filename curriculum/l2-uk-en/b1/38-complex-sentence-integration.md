...
|-------|----------|----------|
| сурядний | coordinate | рівноправний зв'язок |
| підрядний | subordinate | залежний зв'язок |
| синтаксис | syntax | будова речень |
| головне речення | main clause | незалежна частина |
| підрядне речення | subordinate clause | залежна частина |
| сполучник | conjunction | з'єднує частини |
| єднальний | copulative, joining | і, та, й |
| зіставлення | comparison | а |
| протиставлення | contrast | але, проте |
| причинове | causal | тому що, бо |
| часове | temporal | коли, після |
| умовне | conditional | якщо, якби |
| означальне | attributive | який, що |
| з'ясувальне | explanatory | що, щоб |
| допустове | concessive | хоча, хоч |
| рівень підрядності | level of subordination | глибина залежності |
| дворівневий | two-level | два рівні |
| трирівневий | three-level | три рівні |
| комбінування | combining | поєднання |
| інтеграція | integration | об'єднання |
| послідовність | sequence | порядок |
| структура | structure | будова |
| компонент | component | частина |
| логічний | logical | розумний зв'язок |
| архітектура | architecture | будова, структура |
