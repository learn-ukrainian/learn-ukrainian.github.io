...
> У 1619 році Мелетій Смотрицький видав свою знамениту «Грамматіку». Це була одна з перших спроб систематизувати церковнослов'янську та староукраїнську мови на науковому рівні. Саме він офіційно ввів ужиток літери **«ґ»**, щоб на письмі розрізняти запозичений вибуховий звук [ɡ] і питомий дзвінкий фрикативний [ɦ] (літера «г»). Його граматичні правила та термінологія залишалися стандартом понад 200 років.
...
Це правило працює у 90% випадків і є надійним орієнтиром для початківців. Винятки (наприклад, *Микола* — чоловічий рід, хоча закінчується на -а) зазвичай пов'язані з реальною біологічною статтю людини.
...
Головна граматична особливість прислівника — він **незмінний** (invariable). Це означає, що у нього немає закінчень, які змінюються залежно від особи, роду чи часу. Він завжди має одну форму, тому вам не потрібно думати про його узгодження з іншими словами.
...
В українській мові, як і в багатьох європейських мовах (французькій, німецькій), дуже важливо розрізняти займенники **ти** (informal singular 'you') та **Ви** (formal/plural 'You').
...
**Складені числівники**
Числівники можуть бути простими (*три*), складними (*п'ятдесят*) або складеними (*сто двадцять п'ять*). Під час відмінювання складених числівників кожна їхня частина змінюється окремо. Ми вивчатимемо ці правила поступово.
...
Слова, які додають реченню додаткових відтінків або емоцій, називаються **частками**. Вони не мають самостійного лексичного значення і не є членами речення, але виконують важливі граматичні функції: можуть заперечувати (*не, ні*), посилювати думку (*ж, же*), створювати умову (*би, б*) або формувати питання (*чи*).
...
Наступна важлива тема — **відмінки** (cases). Відмінок — це граматична форма, яка показує функцію та роль іменника в конкретному реченні.
...
> [!culture]
> **Кличний відмінок у фольклорі**
> Українська мова зберегла кличний відмінок як повноцінну граматичну категорію. Ця форма настільки вкорінена в мовну свідомість, що в народних піснях та поезії навіть до неживих предметів чи абстрактних понять часто звертаються як до живих істот: «Ой, **земле** моя!», «Гей, **доле**!». Це надає текстам особливої виразності та емоційності.
...
**Спільнокореневі слова (Word Families)**
Розуміння морфеміки дозволяє бачити лексичні зв'язки. Візьмемо корінь **-світ-** (light/world):
*   *Світ* (іменник) — World.
...
В українській мові при зміні слова звуки можуть змінюватися. Це називається **чергування**. Найпопулярніше — це чергування **О** та **І**: у називному відмінку звук **о** стає **і**, а в інших відмінках повертається **о**.
...
Ви опрацювали базову граматичну термінологію (метамову). Розуміння таких понять, як *іменник*, *відмінок* чи *дієслово*, стане вашим надійним інструментом для подальшого вивчення української граматики.
...
4.  Який відмінок потребує прийменника у 100% випадків?
