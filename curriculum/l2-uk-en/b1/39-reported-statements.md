...
| пряма мова | direct speech | дослівне цитування |
| дієслово введення | reporting verb | вводить непряму мову |
| сказати | to say | нейтральне дієслово введення |
| говорити | to speak/tell | тривала розмова |
| повідомити | to inform | офіційне повідомлення |
| заявити | to declare | офіційна заява |
| пояснити | to explain | роз'яснення |
| додати | to add | додаткова інформація |
| зауважити | to remark | короткий коментар |
| стверджувати | to claim | наполягання на правдивості |
| визнати | to admit | визнання факту |
| заперечити | to deny | заперечення факту |
| підтвердити | to confirm | підтвердження інформації |
| натякнути | to hint | непряма вказівка |
| зсув часу | tense backshift | зміна часу дієслова |
| наступного дня | the next day | = завтра в минулому |
| напередодні | the day before | = вчора в минулому |
| того дня | that day | = сьогодні в минулому |
| тоді | then | = зараз в минулому |
| переказ | retelling | передача змісту |
| цитування | quotation | дослівне повторення |
| передати | to convey | передати інформацію |
| спотворити | to distort | змінити зміст |
| контекст | context | обставини |
| наголошувати | to emphasize | підкреслювати думку |
| зазначати | to note / state | офіційно вказувати |
| припускати | to assume | робити припущення |
| погрожувати | to threaten | загрожувати |
| доповідати | to report | подавати звіт |
| шепотіти | to whisper | говорити тихо |
| відзначати | to note / mark | вказувати на щось |
