...
|-------|----------|----------|
| заголовок | headline | перший рядок новини, передає головну думку |
| лід | lead | перший абзац з ключовою інформацією |
| підзаголовок | subheading | вторинний заголовок, уточнює тему |
| абзац | paragraph | частина тексту, відокремлена відступом |
| цитата | quote | дослівне відтворення чиїхось слів |
| джерело | source | звідки отримано інформацію |
| факт | fact | об'єктивна, перевірена інформація |
| думка | opinion | суб'єктивна оцінка, точка зору |
| аналіз | analysis | детальний розбір теми чи проблеми |
| коментар | comment | пояснення або думка про подію |
| редакція | editorial office | колектив журналістів видання |
| колонка | column | авторська стаття з власною думкою |
| репортаж | report | розповідь з місця події |
| хроніка | chronicle | послідовний виклад подій |
| зведення | summary, digest | короткий огляд головних новин |
| огляд | review, overview | загальний аналіз теми чи періоду |
| дайджест | digest | добірка найважливіших новин |
| головна новина | top story | найважливіша новина дня |
| термінове повідомлення | breaking news | новина, що щойно сталася |
| ексклюзив | exclusive | новина, яку має лише одне видання |
