...
У назві цього модуля слово **умовний** означає не форму дієслова з часткою **б/би**, а цілий тип речення: одна дія можлива за певної умови. На B1 нам треба навчитися говорити не тільки **я поїду**, **ми зустрінемося**, **він зателефонує**, а й **якщо буде час, я поїду**, **якщо ми зустрінемося раніше, встигнемо на потяг**, **якщо він зателефонує сьогодні, я підготую документи**. У таких реченнях умова не є мрією або фантазією. Вона справді може здійснитися.
