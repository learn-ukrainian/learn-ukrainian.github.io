...
> *Imagine a situation: a state census worker has arrived in a Ukrainian village. His task is to collect accurate statistics about every resident, the size of the household, and the amount of property. The master of the house answers the questions using various quantity expressions. Pay attention to how the noun endings change after different numbers and words that denote quantity.*

> — **Переписувач:** Добрий день! Я проводжу перепис населення. Скільки людей постійно проживає у вашому домі? *(Good day! I am conducting a census. How many people permanently live in your house?)*
> — **Господар:** Добрий день. П'ятеро: я, моя дружина, двоє дітей та моя літня мати. *(Good day. Five: me, my wife, two children, and my elderly mother.)*
> — **Переписувач:** Зрозуміло. А скільки кімнат має ваш будинок? *(Understood. And how many rooms does your house have?)*
> — **Господар:** Ми маємо кілька кімнат: три спальні, одну велику вітальню та кухню. *(We have several rooms: three bedrooms, one large living room, and a kitchen.)*
> — **Переписувач:** Ви маєте багато землі біля хати? *(Do you have a lot of land near the house?)*
> — **Господар:** Так, чимало. Ми обробляємо два гектари поля. На це йде дуже багато зусиль та часу. *(Yes, quite a lot. We cultivate two hectares of field. It takes a lot of effort and time.)*
> — **Переписувач:** Чи тримаєте ви худобу? *(Do you keep livestock?)*
> — **Господар:** Мало худоби залишилося. Тільки одна корова, двоє коней та десять курей. *(Little livestock is left. Only one cow, two horses, and ten chickens.)*
...
> — **Покупець:** Добрий день! Дайте, будь ласка, три кілограми яблук. *(Good day! Give me three kilograms of apples, please.)*
> — **Продавець:** Ось, тримайте. Це буде рівно три кілограми. Щось ще? *(Here you go. This is exactly three kilograms. Anything else?)*
> — **Покупець:** Так, скільки коштують ці п'ять персиків? *(Yes, how much do these five peaches cost?)*
> — **Продавець:** Вони великі, тому коштують вісімдесят п'ять гривень. Але я зроблю вам знижку на п'ятнадцять відсотків. *(They are large, so they cost eighty-five hryvnias. But I will give you a discount of fifteen percent.)*
> — **Покупець:** Дякую! Тоді візьму ще півкілограма слив. *(Thank you! Then I will also take half a kilogram of plums.)*
