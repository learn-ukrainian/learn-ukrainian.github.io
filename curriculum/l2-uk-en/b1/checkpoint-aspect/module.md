...
Заперечний наказ потребує особливої уваги. Для звичайної заборони українська сильно тяжіє до недоконаного виду: **Не відкривайте вікно**, **Не бігайте в коридорі**, **Не забувайте про контекст**, **Не пишіть кальками**. Доконана форма в заперечному наказі часто звучить не як проста заборона, а як попередження про випадковий результат: **Не забудьте ключі**, **Не впустіть телефон**, **Не переплутайте форми**. У контрольній роботі не треба робити з доконаного заперечного наказу універсальну заборону. Спершу запитайте: це правило чи попередження?
...
Заперечення в наказовому способі повертає нас до попереднього розділу. **Не відкривайте двері** є стандартною забороною або інструкцією. **Не відкрийте двері випадково** звучить як попередження, де мовець боїться одного небажаного результату. **Не забувайте перевіряти контекст** є загальною порадою. **Не забудьте перевірити контекст перед відповіддю** є конкретним нагадуванням. Обидві моделі потрібні, але вони не взаємозамінні.
