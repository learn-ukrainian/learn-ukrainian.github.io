...
Нормативні дрібниці теж належать до розпорядку. Кажи «за десять шоста», коли до шостої лишається десять хвилин; модель <!-- bad -->без десяти шість<!-- /bad --> не потрібна в літературній українській. Для регулярності кажи «по четвергах» або «щочетверга»; форма <!-- bad -->по четвергам<!-- /bad --> переносить чужу модель. Для тривалості часу кажи «протягом дня»; іменник «протяг» означає рух повітря, а не часову тривалість. Якщо говориш про хворобу, вживай «хворію на грип». Якщо говориш про мову спілкування, природно: «спілкуватися українською мовою». <!-- VERIFY: source="Knowledge Packet decolonization ban-2 and l2_errors err-2, err-5" grade="B1" author="compiled wiki" -->
