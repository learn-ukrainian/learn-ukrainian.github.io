<!-- SCOPE
Covers: Збірні числівники (двоє, троє, четверо), дробові числівники (половина, третина, чверть), особливі форми (півтора, півтори), відсотки та узгодження іменників.
Not covered:
  - Складні складені числівники від 100 до 1000 
Related: b1-48 (Diminutives Master Class), b1-50 (Checkpoint Participles Numerals)
-->
...
Українська мова пропонує різні, тонко налаштовані інструменти для опису кількості. Базовий рівень, з яким ви знайомі з перших уроків — це кількісний числівник. Використовуючи слова «один», «два», «три», «чотири», ви чудово працюєте з ситуаціями, коли рахуєте окремі, незалежні об'єкти: два столи, три книги, чотири дні. Ця лічба є об'єктивною і трохи відстороненою. 
...
Після глибокого опрацювання і успішного завершення цього об'ємного модуля ви зможете:
- Впевнено і без вагань обирати між кількісними та збірними числівниками в спонтанних розмовних ситуаціях.
...
Ми беремо збірний числівник «двоє», «троє» або «семеро» і додаємо до нього іменник. Головний закон тут такий: іменник після будь-якого збірного числівника ЗАВЖДИ і без винятків стоїть у формі Родового відмінка множини (Genitive Plural). Ця конструкція є непорушною монолітною структурою.
...
- Минулого тижня до нашого фінансового відділу приєдналися **троє нових співробітників**, які швидко і легко влилися в дружній колектив.
...
Друга велика категорія, яка категорично і завжди вимагає використання виключно збірних числівників — це назви маленьких дитинчат тварин та птахів. В українській мові іменники, що позначають малят, зазвичай мають розпізнавальні суфікси -еня або -я (цуценя, кошеня, теля, курча, каченя, левеня). Для підрахунку цих маленьких, тендітних створінь ми традиційно і обов'язково використовуємо збірні форми. З мовної точки зору вони підкреслюють беззахисність малят і той природний факт, що вони завжди тримаються разом, гріючись біля матері у своєму гнізді чи норі.

**Як це працює граматично:**
Збірний числівник (наприклад, «п'ятеро») безпосередньо поєднується з назвою дитинчати тварини у формі Родового відмінка множини (Genitive Plural). Зверніть особливу увагу на характерну зміну суфікса у множині для цих слів (цуценя в однині перетворюється на цуценят у родовому множини).
...
**Як це працює граматично:**
Числівник (двоє, троє, п'ятеро) поєднується з іменником pluralia tantum. Іменник при цьому обов'язково стоїть у формі Родового відмінка множини (Genitive Plural). Наприклад, від слова «двері» утворюється форма родового відмінка «дверей».
...
- Під час масштабного ремонту в цьому старому будинку ми повністю поміняли **четверо дверей**, щоб зберегти тепло і комфорт взимку.
...
> [!observe] **Зверніть увагу на відмінювання самих числівників**
...
> [!warning] **Абсолютна граматична заборона**
...
**Як це працює граматично:**
Для підрахунку всіх звичайних неживих предметів (які мають форму однини) використовуйте виключно класичні кількісні числівники (два, три, чотири). Після них залежний іменник стоїть у формі Називного відмінка множини (для слів чоловічого роду після числівників два, три, чотири ця форма сьогодні графічно збігається з Називним множини, хоча історично це був дуже давній двоїстий відмінок, який залишив свій невидимий структурний слід).
...
Ця елегантна конструкція є чітким маркером високого рівня володіння живою мовою, оскільки вона легко і красиво замінює незграбні, дослівні переклади з інших європейських мов (ніколи не варто казати штучне «ми є два» або «нас є двоє людей»).
...
**Як це працює граматично:**
Абсолютно так само, як і популярне слово «половина», слова «третина» і «чверть» вимагають управління: вони поєднуються з наступними іменниками виключно в Родовому відмінку (Genitive case). Вони відмінюються як звичайні іменники жіночого роду (слово «третина» відмінюється як «стіна», а слово «чверть» — як іменник третьої відміни на кшталт слова «тінь», тобто воно має нульове закінчення у Називному відмінку і форму «чверті» у Родовому).
...
> Коротке і дзвінке слово «чверть» має надзвичайно глибоке та цікаве історичне коріння в традиційній українській мові. У далекому минулому воно широко використовувалося як повноцінна, офіційна міра об'єму для продажу рідин і сипучих речовин (наприклад, селяни купували «чверть відра» зерна або меду), а також як точна міра для вимірювання площі родючої землі. Сьогодні воно втратило своє фізичне вимірювальне значення, але повністю зберегло свою незамінну академічну, статистичну та часову функцію в сучасній мові.
...
**Як це працює граматично:**
- Щоб сказати, що пройшла половина години (наприклад, 13:30), ми використовуємо витончену конструкцію **«о пів на»** + наступна година у Знахідному відмінку (Accusative). Буквально, з філософської точки зору, це означає: ми стоїмо на половині шляху і рухаємося назустріч наступній, майбутній годині.
...
Тепер ми переходимо до одного з найцікавіших, найунікальніших і найпоширеніших числівників української мови — до слова **півтора** (в англійській це відповідає концепту "one and a half"). Це слово має захопливу історію: воно органічно походить від давнього, довгого виразу «половина другого» (що з часом скоротилося до «пів-в-тора»). Воно є надзвичайно активним як у щоденному побутовому розмовному, так і в суворому офіційно-діловому мовленні.
...
**Як це працює граматично:**
Базовий числівник «півтора» використовується виключно з іменниками чоловічого та середнього роду. Іменник після слова «півтора» ЗАВЖДИ і без будь-яких винятків стоїть у формі **Родового відмінка однини** (Genitive Singular). Зверніть особливу, критичну увагу: ми використовуємо саме форму однини, а не множини! Ця форма є свідченням того, що ми маємо один цілий предмет і ще шматочок (половину) іншого такого ж предмета.
...
**Практична порада щодо використання:**
Іноземні студенти дуже часто роблять одну типову помилку, інтуїтивно намагаючись використати форму множини після слова півтора (наприклад, помилково кажуть «півтора років», «півтора місяців» або «півтора літрів», проводячи аналогію з числівником «п'ять»). Запам'ятайте раз і назавжди: це груба і дуже помітна граматична помилка. Вивчіть золоту формулу напам'ять: числівник півтора + іменник чоловічого або середнього роду + суворо форма Родового відмінка однини.

### «Півтори»: Унікальна форма для жіночого роду
Слово «півтора» має одну чудову властивість: воно має спеціальну, окрему фонетичну форму виключно для обслуговування іменників жіночого роду. Ця форма — **півтори**. Граматична логіка взаємодії залишається абсолютно такою ж самою (ми так само потребуємо родового відмінка однини), але ми змінюємо закінчення самого числівника (з -а на -и), щоб гармонійно та милозвучно адаптувати його до жіночого роду наступного іменника.

**Як це працює граматично:**
Числівник «півтори» використовується завжди і тільки з іменниками жіночого роду. Іменник після слова «півтори» суворо стоїть у формі Родового відмінка однини (Genitive Singular).

**Приклади в живому контексті:**
- Наша неймовірно цікава університетська лекція з сучасної літератури тривала довгих **півтори години** без жодної, навіть найменшої перерви на відпочинок.
...
У сучасному діловому та професійному середовищі ви щоденно і безперервно працюватимете з математичним словом **відсоток** (яке є українським відповідником інтернаціонального "percent"). Відсотки — це, по своїй суті, просто зручний математичний різновид дробів (оскільки це соті частини цілого). Проте граматична робота з відсотками вимагає від вас дуже впевненого, автоматичного знання правил відмінювання звичайних кількісних числівників, оскільки слово «відсоток» повністю, беззаперечно підкоряється їм.
...
- Величезна сезонна знижка на абсолютно всі якісні зимові товари в цьому великому магазині сьогодні досягає п'ятдесяти **відсотків**.

### Десяткові дроби: Читання цілих та десятих частин
У серйозній науці, точній медицині, програмуванні та макроекономіці ми повсюдно і постійно використовуємо так звані десяткові дроби (decimals, числа з комою). Українська мова має дуже чіткий, суворо регламентований і математично абсолютно точний спосіб їх правильного читання вголос. Ми завжди окремо, з відповідними словами, називаємо спочатку цілу частину (цілі) і одразу після неї дробову частину (десяті, соті, тисячні).

**Як це працює граматично:**
Загальна формула правильного читання виглядає так: [Цифра] ціла/цілі/цілих + [Цифра] десята/десяті/десятих. Зверніть увагу, що слова «ціла» і «десята» граматично поводяться як звичайні прикметники, повністю узгоджуючись за родом і числом з числом, що стоїть перед ними.
...
**Приклади в живому контексті:**
- Офіційна державна інфляція в нашій країні в цьому звітному місяці несподівано склала **дві цілих три десятих** відсотка (запис 2,3%).
...
> [!quote] **Фольклорна мудрість у піснях**
...
Головні сміливі герої та небезпечні випробування на їхньому шляху завжди з'являються групами рівно по троє. Саме тут наш знайомий збірний числівник «троє» розкриває свій повний граматичний і стилістичний потенціал, невидимою ниткою об'єднуючи різних персонажів у єдину, напруженую сюжетну лінію.
...
Цей стародавній казковий патерн потрійності є настільки глибоким і сильним в українському менталітеті, що він постійно, часто навіть несвідомо, впливає на всю сучасну літературу та кінематограф в Україні, де талановиті автори раз за разом копіюють цю перевірену століттями потрійну структуру розвитку конфлікту та його емоційної розв'язки.

### Форма «утрьох» у щоденному соціальному контексті
Коли ми сьогодні говоримо про число три в сучасному соціальному вимірі, ми просто зобов'язані обов'язково згадати дуже корисний, короткий і красивий прислівник **утрьох** (що англійською найкраще перекладається як "the three of us together" або "together as three"). Він органічно і природно утворений від уже добре знайомого нам збірного числівника «троє» і означає будь-яку спільну, об'єднану дію рівно трьох осіб. За таким самим граматичним принципом в українській мові також існують і активно використовуються форми удвох (або вдвох) і вчотирьох.
...
Якщо магічне число три впевнено керує нашими казками, фольклором та повсякденними розмовними приказками, то число дванадцять (так звана сакральна дюжина) повністю керує і визначає правила одного з найсвітліших і найважливіших родинних свят усього українського річного календаря — Різдва Христового. А якщо бути ще більш точним, воно керує його передднем, який традиційно, з великою повагою називається **Святий Вечір** (або коротко Святвечір).
...
> [!culture] **Кулінарна традиція Різдва**
...
Давайте подивимося на практиці, як різні числа, складні збірні числівники та точні дроби, які ми щойно вивчили, органічно і бездоганно працюють разом у живому, зв'язному тексті, що розповідає про підготовку великої української родини до найбільшого зимового свята. Читаючи цей текст, звертайте увагу на виділені слова.

«У нашому великому сільському домі підготовка до Святого Вечора завжди починалася ще дуже рано, вдосвіта, коли надворі було ще зовсім темно. На теплій кухні біля старої печі зазвичай невтомно працювали **троє жінок**: моя старенька бабуся, моя енергійна мама і я, її старша сестра. Вони заздалегідь чітко і справедливо розподіляли між собою всі складні обов'язки так, щоб гарантовано встигнути приготувати всі обрядові **дванадцять страв** до урочистої появи першої яскравої зірки на вечірньому морозному небі. 

Я дуже добре пам'ятаю, як бабуся суворо, з виглядом експерта казала, що для правильної, справжньої куті потрібно взяти рівно **півтора кілограма** найдобірнішої, найчистішої пшениці і дуже довго варити її на повільному вогні в глиняному горщику. Тим часом мама швидко і вправно займалася улюбленими варениками з тушкованою капустою і сушеними білими грибами. Майже добра **третина часу** йшла тільки на те, щоб ідеально тонко розкачати тісто і зліпити їх усі однаковими, з красивими краями. 
...
Цей короткий, але емоційний текст яскраво демонструє вам, як сухі граматичні структури, які ми вивчили і проаналізували в цьому модулі, абсолютно природно, легко і органічно вплітаються в живу розповідь про справжнє українське життя, роблячи мову персонажів природною, плавною та надзвичайно емоційно наповненою.
...
Сучасний ресторан або затишне міське кафе — це просто ідеальний, найкращий з можливих майданчиків для щоденного тренування збірних числівників. Коли ви впевнено заходите до будь-якого популярного закладу з групою друзів, адміністратор (хостес) на вході одразу і обов'язково запитає вас про загальну кількість людей у вашій компанії. І саме тут, у цю секунду, вам знадобиться ідеально вивчена конструкція «нас + збірний числівник».
...
У серйозному діловому стилі абсолютна чіткість вимови складних окончань (наприклад, чітке вимовляння «відсотків», «десятих», «місяця») є прямою і явною ознакою вашого високого професіоналізму та бездоганної освіти. Тут категорично немає місця для граматичних сумнівів, невизначеності чи пауз на обдумування відмінка.
...
> [!warning] **Суворе попередження: Уникайте росіянізмів**
...
1. Як ви абсолютно правильно скажете українською мовою фразу "the two of us" у ситуації, коли ви телефонуєте в ресторан і бронюєте столик на вечір?
2. Який саме різновид числівника (звичайний кількісний чи спеціальний збірний) ви обов'язково використаєте для слова "окуляри" (glasses)? Поясніть логічно, чому ви зробили такий вибір?
3. Знайдіть і поясніть дуже грубу граматичну помилку в цьому реченні: "На вулиці біля нашого будинку довго гуляли четверо дівчат". Як її правильно виправити, щоб мова звучала природно?
4. У якому конкретно відмінку і в якому числі (однина чи множина) обов'язково має стояти будь-який іменник після слова "півтора" (наприклад, слово місяць або літр)?
