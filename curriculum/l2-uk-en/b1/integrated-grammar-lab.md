...
Одним із найпотужніших інструментів стилістичної гнучкості є синоніми. Українська мова надзвичайно багата на слова з однаковим або дуже схожим значенням. Група таких слів називається синонімічним рядом. Кожне слово в цьому ряду має свій власний відтінок, емоційне забарвлення та сферу використання.
...
Якщо ви пишете звіт про погоду, ви використаєте слово «горизонт». Якщо ви пишете вірш або романтичне повідомлення, слово «небокрай» буде більш доречним. Ваша здатність вибирати правильне слово з синонімічного ряду визначає ваш справжній рівень володіння мовою.

Ось ще один практичний приклад синонімічного ряду для дієслова «говорити»:
*   **Говорити** — нейтральне (Він говорить правду).
*   **Розмовляти** — процес спілкування (Ми довго розмовляли).
*   **Казати** — передача інформації, часто перед цитатою (Він каже, що прийде).
*   **Мовити** — поетичне, урочисте (Вона тихо мовила слово).
*   **Теревенити** — дуже розмовне, означає говорити багато і про дурниці (Дівчата теревенили цілий вечір).

### Синтез: об'єднання елементів

Коли ми говоримо про **синтез** у граматиці, ми маємо на увазі здатність поєднувати різні правила в одному складному реченні, зберігаючи при цьому **зв'язність** (coherence) тексту. На рівні B1 ви вже не повинні думати окремо про відмінок, окремо про вид дієслова і окремо про займенник. Ви повинні бачити всю картину.
...
Процес синтезу вимагає постійного тренування. Спочатку це здається складним, але з часом ви починаєте робити це автоматично. Саме для цього ми створили наші сценарії. У наступних розділах ми розглянемо три абсолютно різні життєві ситуації і побачимо, як граматика і лексика адаптуються до кожної з них.

> [!culture] **Актив понад усе**
...
1.  **Офіційне звертання:** «Шановна» + ім'я та по батькові в кличному відмінку (Олено Іванівно).
...
У цьому короткому діалозі є все: розмовне «слухай», займенник «його» замість повторення, демінутиви «котиком», «сонечко» і «кавочки», пропускання дієслова «зроблю» у запитанні «Будеш?» (замість «Будеш пити?»). Це і є справжня жива українська мова.
...
**Сценарій В: Ви уявляєте, що ви — VIP-персона, і про ваше запізнення пишуть у новинах (Медіа-стиль)**
...
3.  **«Я приймав участь...»** — Класичний росіянізм, про який ми вже згадували в цьому модулі.
...
Зверніть увагу, наскільки чистішим, сильнішим і переконливішим став текст після видалення пасивних конструкцій і неправильних слів. Це і є магія стилістичного редагування.
