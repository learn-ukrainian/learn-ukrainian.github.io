...
|-------|----------|----------|
| **причина** | cause, reason | чому щось сталося |
| **наслідок** | consequence, result | що сталося в результаті |
| **тому що** | because | нейтральний причиновий |
| **бо** | because | розмовний причиновий |
| **оскільки** | since, as | книжний причиновий |
| **через те що** | because of | формальний причиновий |
| **позаяк** | since, inasmuch as | архаїчний, книжний |
| **адже** | after all, for | емоційний причиновий |
| **завдяки тому що** | thanks to | позитивна причина |
| **внаслідок того що** | as a result of | офіційний стиль |
| **у зв'язку з тим що** | in connection with | адміністративний |
| **тому** | therefore, so | нейтральний наслідковий |
| **отже** | thus, therefore | книжний наслідковий |
| **таким чином** | thus, in this way | офіційний наслідковий |
| **відтак** | consequently | книжний наслідковий |
| **внаслідок цього** | as a result | формальний наслідковий |
| **як наслідок** | as a consequence | нейтральний наслідковий |
| **через це** | because of this | розмовний наслідковий |
| **ось чому** | that's why | пояснення |
| **саме тому** | that's exactly why | наголос на причині |
| **з огляду на те що** | given that | офіційний стиль |
| **в результаті** | as a result | нейтральний наслідковий |
| **пояснювати** | to explain | давати пояснення |
| **причинно-наслідковий** | cause-and-effect | логічний зв'язок |
| **аргументувати** | to argue, give reasons | наводити аргументи |
