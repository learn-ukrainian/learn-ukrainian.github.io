...
> [!tip]
> Якщо в англійській хочеться поставити **I am**, **I need**, **I managed**, **I am twenty**, перевірте, чи українська не просить модель **мені + стан / потрібно / вдалося / двадцять років**.
...
Не плутайте вік із володінням. **У мене є двадцять гривень** - це справді володіння, і тут потрібна конструкція **у мене є**. **Мені двадцять років** - це вік, не предмет і не сума грошей. Англомовному учневі допомагає просте правило: якщо йдеться про age, українська майже завжди починає з давального займенника: **мені**, **тобі**, **йому**, **їй**.
...
**Варто** означає "було б добре / доцільно". **Тобі варто відпочити**, **йому варто перевірити текст**, **нам варто прийти раніше**. Це м'якше, ніж прямий наказ, і дуже корисне для порад. Більш офіційне **слід** також може брати давальний: **студентові слід подати заяву до п'ятниці**. Але **слід** звучить формальніше, тому в продуктивних вправах цього модуля головними будуть **потрібно**, **треба**, **варто**, **можна**.
...
Дуже часта помилка - брати англійське **to** або **for** і механічно перекладати його прийменником. Англійське "write to a friend" в українській не дає `писати до друга` в значенні адресата листа; нейтрально **писати другові** або **написати другові листа**. Англійське "call the doctor" не дає `дзвонити лікаря`; українське дієслово **дзвонити / телефонувати** просить давальний: **дзвонити лікарю**, **телефонувати лікареві**.
...
Ще одна корисна модель - **назустріч + давальний**: **йти назустріч гостям**, **вийти назустріч делегації**, **рухатися назустріч мрії**. У прямому просторовому значенні це "у напрямку до когось". У переносному значенні - готовність допомогти або зробити крок: **університет пішов назустріч студентам**. Цю модель легко перевірити питанням **кому?**.
