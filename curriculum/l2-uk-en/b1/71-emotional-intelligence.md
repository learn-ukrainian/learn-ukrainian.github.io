...
|-------|----------|----------|
| **емпатія** | empathy | виявляти емпатію, розвивати емпатію |
| **співчуття** | sympathy, compassion | висловити співчуття, глибоке співчуття |
| **розуміння** | understanding | проявляти розуміння, знайти розуміння |
| **терпіння** | patience | мати терпіння, втратити терпіння |
| **терпимість** | tolerance | виявляти терпимість, релігійна терпимість |
| **толерантність** | tolerance | розвивати толерантність, нульова толерантність |
| **повага** | respect | ставитися з повагою, заслуговувати на повагу |
| **ввічливість** | politeness | виявляти ввічливість, елементарна ввічливість |
| **тактовність** | tact | проявляти тактовність, дипломатична тактовність |
| **делікатність** | delicacy | з делікатністю, надзвичайна делікатність |
| **щирість** | sincerity | цінувати щирість, з повною щирістю |
| **відвертість** | frankness | цінувати відвертість, надмірна відвертість |
| **чесність** | honesty | цінувати чесність, повна чесність |
| **порядність** | decency | людина порядності, елементарна порядність |
| **відповідальність** | responsibility | нести / брати відповідальність |
| **зобов'язання** | obligation, commitment | виконувати зобов'язання |
| **обіцянка** | promise | дати обіцянку, дотримуватися обіцянки |
| **вибачення** | apology | просити вибачення, прийняти вибачення |
| **пробачення** | forgiveness | просити пробачення, дати пробачення |
| **примирення** | reconciliation | процес примирення, досягти примирення |
| **компроміс** | compromise | знайти компроміс, піти на компроміс |
| **порозуміння** | understanding, accord | досягти порозуміння |
| **взаєморозуміння** | mutual understanding | повне взаєморозуміння |
| **підтримка** | support | надавати підтримку, моральна підтримка |
| **заохочення** | encouragement | слова заохочення, потребувати заохочення |
| **похвала** | praise | заслужити похвалу, щира похвала |
| **критика** | criticism | конструктивна критика, сприймати критику |
| **зауваження** | remark, comment | зробити зауваження, справедливе зауваження |
| **порада** | advice | дати пораду, попросити поради |
| **рекомендація** | recommendation | дати рекомендацію, слідувати рекомендаціям |
| **вірність** | loyalty, faithfulness | зберігати вірність, вірність друзям |
| **довіра** | trust | заслужити довіру, втратити довіру |
| **співпереживання** | empathy, fellow-feeling | виявляти співпереживання |
| **вдячність** | gratitude | висловити вдячність, відчувати вдячність |
| **поступливість** | compliance, yielding | виявляти поступливість, готовність до поступок |
...
>
> **Практика читання:**
> - [Психологічний портал](https://psychologis.com.ua) — статті про емоційний інтелект
> - [Українська правда. Життя](https://life.pravda.com.ua) — матеріали про стосунки та психологію
>
> **Відео:**
> - [TED українською](https://www.ted.com/talks?language=uk) — лекції про емоційний інтелект та комунікацію
