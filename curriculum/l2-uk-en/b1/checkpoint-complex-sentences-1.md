...
1. Знайдіть 2 відносні речення: «яку... планувала», «де туристи губляться»
2. Знайдіть 2 підрядні мети: «щоб краще зрозуміти», «щоб вона відвідала»
3. Знайдіть реальну умову: «Якщо вистачить часу...»
4. Знайдіть нереальну умову: «Якби знала мову...»
...
1. **Відносні речення:** застосування слів-зв'язків (який, де, куди, звідки, коли, що) з правильним відмінюванням.
2. **Підрядні мети:** правильний вибір між інфінітивом і минулою формою після щоб залежно від суб'єктів.
3. **Умовні конструкції:** розпізнавання та побудова реальних, нереальних і змішаних умов з відповідними часовими планами.
