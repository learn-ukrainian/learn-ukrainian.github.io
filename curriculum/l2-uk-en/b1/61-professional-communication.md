...
|-------|--------|----------|-----|----------|
| **колега** | /kɔˈlɛɦɑ/ | colleague | ім. (ч./ж.р.) | колега по роботі |
| **керівник** | /kɛˈrivnɪk/ | manager, supervisor | ім. (ч.р.) | керівник відділу |
| **підлеглий** | /pidˈlɛɦlɪj/ | subordinate | ім. (ч.р.) | мої підлеглі |
| **співробітник** | /spivroˈbitnɪk/ | employee, coworker | ім. (ч.р.) | новий співробітник |
| **команда** | /kɔˈmɑndɑ/ | team | ім. (ж.р.) | працювати в команді |
| **відділ** | /vidˈdil/ | department | ім. (ч.р.) | відділ продажів |
| **офіс** | /ˈɔfis/ | office | ім. (ч.р.) | головний офіс |
| **нарада** | /nɑˈrɑdɑ/ | meeting (formal) | ім. (ж.р.) | провести нараду |
| **зустріч** | /ˈzustrʲitʃ/ | meeting, appointment | ім. (ж.р.) | ділова зустріч |
| **звіт** | /zvit/ | report | ім. (ч.р.) | підготувати звіт |
| **презентація** | /prɛzɛnˈtɑt͡sijɑ/ | presentation | ім. (ж.р.) | робити презентацію |
| **дедлайн** | /ˈdɛdlɑjn/ | deadline | ім. (ч.р.) | дотримуватися дедлайну |
| **проєкт** | /prɔˈjɛkt/ | project | ім. (ч.р.) | працювати над проєктом |
| **завдання** | /zɑvˈdɑnːɑ/ | task | ім. (с.р.) | виконати завдання |
| **відповідальність** | /vidpɔviˈdɑlʲnistʲ/ | responsibility | ім. (ж.р.) | брати відповідальність |
| **ефективність** | /ɛfɛktɪvˈnistʲ/ | effectiveness, efficiency | ім. (ж.р.) | підвищити ефективність |
| **продуктивність** | /prɔduktɪvˈnistʲ/ | productivity | ім. (ж.р.) | висока продуктивність |
| **кар'єра** | /kɑrˈjɛrɑ/ | career | ім. (ж.р.) | будувати кар'єру |
| **підвищення** | /pidˈvɪʃːɛnːɑ/ | promotion, raise | ім. (с.р.) | отримати підвищення |
| **зарплата** | /zɑrˈplɑtɑ/ | salary | ім. (ж.р.) | отримувати зарплату |
| **премія** | /ˈprɛmijɑ/ | bonus | ім. (ж.р.) | річна премія |
| **відпустка** | /vidˈpustkɑ/ | vacation, leave | ім. (ж.р.) | взяти відпустку |
| **лікарняний** | /liˈkɑrnʲɑnɪj/ | sick leave | ім. (ч.р.) | бути на лікарняному |
| **резюме** | /rɛzʲuˈmɛ/ | resume, CV | ім. (с.р.) | надіслати резюме |
| **співбесіда** | /spivbɛˈsidɑ/ | job interview | ім. (ж.р.) | пройти співбесіду |
| **кваліфікація** | /kvɑlifiˈkɑt͡sijɑ/ | qualification | ім. (ж.р.) | висока кваліфікація |
| **досвід** | /ˈdɔsvid/ | experience | ім. (ч.р.) | мати досвід |
| **навички** | /nɑˈvɪtʃkɪ/ | skills | ім. (мн.) | професійні навички |
| **компетенція** | /kɔmpɛˈtɛnt͡sijɑ/ | competence | ім. (ж.р.) | ключова компетенція |
| **професіоналізм** | /prɔfɛsiɔnɑˈlizm/ | professionalism | ім. (ч.р.) | високий професіоналізм |
| **вакансія** | /vɑˈkɑnsijɑ/ | vacancy, job opening | ім. (ж.р.) | відкрита вакансія |
| **кандидат** | /kɑndɪˈdɑt/ | candidate | ім. (ч.р.) | ідеальний кандидат |
| **обов'язки** | /ɔbɔˈvjɑzkɪ/ | duties, responsibilities | ім. (мн.) | посадові обов'язки |
| **посада** | /pɔˈsɑdɑ/ | position, post | ім. (ж.р.) | обіймати посаду |
| **стажування** | /stɑʒuˈvɑnːɑ/ | internship | ім. (с.р.) | пройти стажування |
...
>
> **Практика читання:**
> - 📰 [DOU.ua](https://dou.ua) — новини IT та вакансії українською
> - 📖 [Work.ua](https://www.work.ua) — оголошення про роботу
>
> **Відео:**
> - 📺 [Як пройти співбесіду](https://www.youtube.com/results?search_query=як+пройти+співбесіду+українською) — поради від HR
> - 📺 [Кар'єра в IT](https://www.youtube.com/results?search_query=кар%27єра+в+IT+Україна) — розповіді про роботу в технологічних компаніях
