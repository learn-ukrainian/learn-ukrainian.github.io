...
|-------|--------|----------|-----|----------|
| **стосунки** | /stɔˈsunkɪ/ | relationships | ім. (мн.) | особисті стосунки, романтичні стосунки |
| **відносини** | /vidˈnɔsɪnɪ/ | relations | ім. (мн.) | офіційні, ділові відносини |
| **зв'язок** | /zvjɑˈzɔk/ | connection, bond | ім. (ч.р.) | емоційний зв'язок, тісний зв'язок |
| **дружба** | /ˈdruʒbɑ/ | friendship | ім. (ж.р.) | міцна дружба, дружба з дитинства |
| **кохання** | /kɔˈxɑnːɑ/ | love | ім. (с.р.) | взаємне кохання, перше кохання |
| **романтика** | /rɔˈmɑntɪkɑ/ | romance | ім. (ж.р.) | романтика у стосунках |
| **сім'я** | /siˈmjɑ/ | family | ім. (ж.р.) | створити сім'ю, велика сім'я |
| **партнер** | /ˈpɑrtnɛr/ | partner | ім. (ч.р.) | життєвий партнер, надійний партнер |
| **пара** | /ˈpɑrɑ/ | couple | ім. (ж.р.) | щаслива пара, молода пара |
| **шлюб** | /ʃlʲub/ | marriage | ім. (ч.р.) | укласти шлюб, щасливий шлюб |
| **розлучення** | /rɔzˈlutʃɛnːɑ/ | divorce | ім. (с.р.) | подати на розлучення |
| **конфлікт** | /kɔnˈflikt/ | conflict | ім. (ч.р.) | сімейний конфлікт, розв'язати конфлікт |
| **суперечка** | /supɛˈrɛtʃkɑ/ | argument, dispute | ім. (ж.р.) | мати суперечку, гаряча суперечка |
| **примирення** | /prɪmɪˈrɛnːɑ/ | reconciliation | ім. (с.р.) | досягти примирення |
| **довіра** | /dɔˈvirɑ/ | trust | ім. (ж.р.) | повна довіра, втратити довіру |
| **відданість** | /vidˈdɑnistʲ/ | devotion, dedication | ім. (ж.р.) | повна відданість |
| **вірність** | /ˈvirnistʲ/ | faithfulness, fidelity | ім. (ж.р.) | зберігати вірність |
| **зрада** | /ˈzrɑdɑ/ | betrayal | ім. (ж.р.) | зрада партнера, пережити зраду |
| **підтримка** | /pidˈtrɪmkɑ/ | support | ім. (ж.р.) | емоційна підтримка, надати підтримку |
| **турбота** | /turˈbɔtɑ/ | care, concern | ім. (ж.р.) | виявляти турботу, материнська турбота |
| **повага** | /pɔˈvɑɦɑ/ | respect | ім. (ж.р.) | взаємна повага |
| **розуміння** | /rɔzuˈminːɑ/ | understanding | ім. (с.р.) | взаємне розуміння |
| **спілкування** | /spilkuˈvɑnːɑ/ | communication | ім. (с.р.) | відкрите спілкування |
| **близькість** | /blɪzʲˈkistʲ/ | closeness, intimacy | ім. (ж.р.) | емоційна близькість |
| **відстань** | /ˈvidstɑnʲ/ | distance | ім. (ж.р.) | тримати відстань, емоційна відстань |
| **ревнощі** | /rɛvˈnɔʃːi/ | jealousy | ім. (мн.) | відчувати ревнощі, хворобливі ревнощі |
| **прив'язаність** | /prɪˈvjɑzɑnistʲ/ | attachment | ім. (ж.р.) | емоційна прив'язаність |
| **розрив** | /ˈrɔzrɪv/ | breakup | ім. (ч.р.) | пережити розрив, болісний розрив |
| **обов'язок** | /ɔˈbɔvjɑzɔk/ | obligation, duty | ім. (ч.р.) | сімейні обов'язки |
| **компроміс** | /kɔmpˈrɔmis/ | compromise | ім. (ч.р.) | знайти компроміс, йти на компроміс |
| **взаєморозуміння** | /vzɑjɛmɔrɔˈzuminːɑ/ | mutual understanding | ім. (с.р.) | досягти взаєморозуміння |
| **гармонія** | /ɦɑrˈmɔnijɑ/ | harmony | ім. (ж.р.) | сімейна гармонія, жити в гармонії |
| **інтимність** | /inˈtɪmnistʲ/ | intimacy | ім. (ж.р.) | емоційна інтимність |
| **симпатія** | /sɪmˈpɑtijɑ/ | sympathy, liking | ім. (ж.р.) | взаємна симпатія, відчувати симпатію |
| **вдячність** | /vˈdʲɑtʃnistʲ/ | gratitude | ім. (ж.р.) | виявляти вдячність, глибока вдячність |
...
>
> **Практика читання:**
> - 📰 [Психологія стосунків](https://www.psychologies.com.ua) — статті про стосунки та сім'ю
> - 📖 [Українська правда. Життя](https://life.pravda.com.ua) — статті про особисте життя
>
> **Відео:**
> - 📺 [Ukraїner: Традиції](https://www.youtube.com/@ukralovers) — документальні фільми про українські традиції
> - 📺 [Сніданок з 1+1](https://www.youtube.com/@snidanok1plus1) — ранкове шоу з темами про сім'ю та стосунки
