...
3. **Відносний:** Все, **що** я знаю, — це факти. (Що = яке; описує "все")
4. **Сполучник:** Я знаю, **що** це факти. (Що = that; вводить те, що знаю)
...
1. **Опис часу**: "День, **коли**..." (не "який").
2. **Опис фактів**: "Те, **що**..." (не "яке").
3. **Опис речей**: "Книга, **яку**..." (тут потрібен "який").
