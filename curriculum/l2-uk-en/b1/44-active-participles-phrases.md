...
> 🎬 **Культурна довідка: Українська поезія**
>
> Найкращі українські письменники завжди віддавали перевагу природним конструкціям. Порівняйте два варіанти відомого образу:
>
...
>
> Тарас Шевченко, Леся Українка, Іван Франко — усі вони використовували природні українські конструкції. Дієприкметники на **-лий** («посивілий», «зів'ялий», «опалий») часто зустрічаються в їхніх творах, бо це автентичні українські форми.
...
>
> Це не просто граматична корекція — це відновлення природного ладу української мови, який був штучно спотворений під час радянської русифікації. Кожного разу, коли ви обираєте «наступний» замість «слідуючий» або «колишній» замість «бувший», ви робите свій внесок у відродження автентичної української мови.
...
>
> - **Словники:** [Словник.UA](https://slovnyk.ua/) — перевірка правопису та стилістики
> - **Граматика:** [Як ми говоримо](https://r2u.org.ua/yak-my-hovorymo/) — класичний посібник О. Антоненка-Давидовича про русизми
> - **Відео:** [Ukrainian Lessons — Канцелярити](https://www.ukrainianlessons.com/) — практичні уроки з деколонізації мови
> - **Блог:** [Мова — ДНК нації](https://mova-dnk.org.ua/) — сучасні матеріали про мовну культуру
...
|-------|----------|----------|
| посивілий | greying, grey-haired | природній дієприкметник на -лий, від «посивіти» |
| зів'ялий | wilted | природній дієприкметник на -лий, від «зів'янути» |
| замерзлий | frozen | природній дієприкметник на -лий, від «замерзнути» |
| загорілий | tanned | природній дієприкметник на -лий, від «загоріти» |
| змоклий | soaked | природній дієприкметник на -лий, від «змокнути» |
| колишній | former, ex- | правильна форма (не русизм «бувший») |
| наступний | next, following | правильна форма (не русизм «слідуючий») |
| навколишній | surrounding | правильна форма (не калька «оточуючий») |
| наявний | existing, present | правильна форма (не канцелярит «існуючий») |
| чинний | valid, in force | правильна форма (не русизм «діючий») |
| охочий | willing, eager | правильна форма (не канцелярит «бажаючий») |
| канцелярит | bureaucratese | бюрократична мова, штучні форми |
| русизм | russicism | запозичення з російської мови |
| калька | calque, loan translation | дослівний переклад з іншої мови |
| підрядне речення | subordinate clause | речення з «який/яка/яке» |
| стилістика | stylistics | наука про стиль мовлення |
| деколонізація | decolonization | звільнення від колоніальних впливів |
| прибулий | arrived | природній дієприкметник на -лий, від «прибути» |
| відсталий | backward, lagging | природній дієприкметник на -лий, від «відстати» |
| дорослий | adult | природній дієприкметник на -лий, від «дорости» |
| стоячий | standing | усталена форма (стоячий квиток) |
| лежачий | lying | усталена форма (лежачий хворий) |
| сидячий | sitting, sedentary | усталена форма (сидячий спосіб життя) |
| попередній | previous | правильна українська форма |
| збіжний | coinciding | правильна форма (не калька «співпадаючий») |
| слідуючий | following (russicism) | русизм, уникайте! Правильно: наступний |
| бувший | former (russicism) | русизм, уникайте! Правильно: колишній |
| оточуючий | surrounding (russicism) | калька, уникайте! Правильно: навколишній |
| існуючий | existing (bureaucratese) | канцелярит, уникайте! Правильно: наявний |
| бажаючий | willing (bureaucratese) | канцелярит, уникайте! Правильно: охочий |
| діючий | acting, in force (russicism) | русизм, уникайте! Правильно: чинний |
| читаючий | reading (bureaucratese) | канцелярит, уникайте! Правильно: той, хто читає |
| працюючий | working (bureaucratese) | канцелярит, уникайте! Правильно: той, хто працює |
| відповідаючий | corresponding (bureaucratese) | канцелярит, уникайте! Правильно: відповідний |
| опалий | fallen (leaves) | природній дієприкметник на -лий, від «опасти» |
| пожовклий | yellowed | природній дієприкметник на -лий, від «пожовкнути» |
