...
1. Форма **який** залежить від двох факторів: рід/число антецедента + відмінок у підрядному реченні.
2. Живі істоти чоловічого роду в знахідному відмінку мають форму **якого** (як у родовому).
3. Прийменник обов'язковий у місцевому відмінку: в, на, о, при + який/якому/якій.
4. Орудний відмінок має три форми: **яким** (чол./сер.), **якою** (жін.), **якими** (множ.).
5. Прийменники не відокремлюються від форми який: для якого, з яким, про яку, над яким.
6. Антецедент визначає рід/число, але функція в реченні визначає відмінок.
