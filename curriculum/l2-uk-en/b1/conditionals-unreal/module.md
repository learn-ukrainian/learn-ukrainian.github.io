...
:::warning[Якби вже містить би]
У базовій моделі не дублюйте частку в першій частині: **якби я знав**, не `*якби я знав би`. Залиште **б/би** для наслідку: **я б допоміг**, **вона сказала б**, **ми прийшли б**.
:::
