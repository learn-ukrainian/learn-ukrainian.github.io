...
|-------|----------|----------|
| **і** | and | просте додавання однорідних понять |
| **а** | and/but (contrast) | протиставлення або контраст |
| **але** | but | стандартний контраст, розмовний та письмовий |
| **проте** | however, yet | сильніший контраст, формальніший |
| **однак** | however, nonetheless | найсильніший контраст, книжний стиль |
| **хоча** | although, though | поступка, застереження |
| **хоч** | although | розмовний варіант "хоча" |
| **тому** | therefore, so | наслідок, результат |
| **через це** | because of this | причина-наслідок |
| **отже** | so, therefore | логічний висновок |
| **таким чином** | thus, in this way | формальний підсумок |
| **значить** | so, means | розмовний висновок |
| **тобто** | that is, i.e. | переформулювання, пояснення |
| **а саме** | namely | конкретизація, список |
| **наприклад** | for example | приклад |
| **зокрема** | in particular, especially | особливо, виділення |
| **власне** | actually, properly speaking | уточнення |
| **взагалі** | in general, generally | узагальнення |
| **загалом** | overall, on the whole | в цілому, підсумок |
| **справді** | really, truly | емоційне підтвердження |
| **дійсно** | indeed, really | фактичне підтвердження |
| **насправді** | in fact, actually | контраст очікування та реальності |
| **до речі** | by the way | вставне слово, нова тема |
| **між іншим** | by the way, incidentally | вставне слово, додаткова інформація |
| **до того ж** | moreover, besides | додавання інформації |
| **натомість** | instead, on the other hand | заміна, альтернатива |
| **водночас** | at the same time, meanwhile | одночасність дій або думок |
| **разом з тим** | at the same time, along with that | формальне додавання |
| **скажімо** | for instance | розмовний приклад |
| **принаймні** | at least | обмеження, мінімум |
| **безперечно** | undoubtedly, certainly | сильне підтвердження |
| **точніше** | more precisely | уточнення попередньої думки |
| **інакше кажучи** | in other words | переформулювання |
| **крім того** | besides, in addition | формальне додавання |
| **тим не менше** | nevertheless, nonetheless | книжний контраст |
...
>
> **Практика читання:**
> - 📰 [Українська правда](https://www.pravda.com.ua) — новини з багатьма дискурсивними маркерами
> - 📖 [Тиждень](https://tyzhden.ua) — аналітичні статті з формальним стилем
>
> **Відео:**
> - 📺 [Громадське](https://www.youtube.com/@haborets) — новинні сюжети з живою мовою
> - 📺 [Культурна столиця](https://www.youtube.com/c/CultCapital) — інтерв'ю з культурними діячами
