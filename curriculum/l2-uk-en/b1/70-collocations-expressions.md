...
|-------|--------|----------|-----|----------|
| **приймати рішення** | /prɪjˈmɑtɪ riˈʃɛnːɑ/ | to make a decision | колок. | не: "робити рішення" |
| **брати участь** | /ˈbrɑtɪ uˈt͡ʃɑstʲ/ | to take part, participate | колок. | не: "приймати участь" |
| **мати значення** | /ˈmɑtɪ znɑˈt͡ʃɛnːɑ/ | to matter, to be important | колок. | це має значення |
| **надавати перевагу** | /nɑdɑˈvɑtɪ pɛrɛˈvɑɦu/ | to prefer | колок. | + дативний відм. |
| **звертати увагу** | /zvɛrˈtɑtɪ uˈvɑɦu/ | to pay attention | колок. | + на + знах. відм. |
| **робити висновки** | /rɔˈbɪtɪ ˈvɪsnɔvkɪ/ | to draw conclusions | колок. | множина |
| **ставити питання** | /stɑˈvɪtɪ pɪˈtɑnːɑ/ | to ask a question, raise an issue | колок. | формальне |
| **грати роль** | /ˈɦrɑtɪ rɔlʲ/ | to play a role | колок. | = відігравати роль |
| **вести переговори** | /vɛsˈtɪ pɛrɛɦɔˈvɔrɪ/ | to negotiate, conduct negotiations | колок. | ділове мовлення |
| **нести відповідальність** | /nɛsˈtɪ vidpɔviˈdɑlʲnistʲ/ | to bear responsibility | колок. | за + знах. відм. |
| **здобувати освіту** | /zdɔbuˈvɑtɪ ɔsˈvitu/ | to get an education | колок. | активний процес |
| **набувати досвіду** | /nɑbuˈvɑtɪ ˈdɔsvidu/ | to gain experience | колок. | родовий відм. |
| **висувати вимоги** | /vɪsuˈvɑtɪ vɪˈmɔɦɪ/ | to make demands | колок. | формальне |
| **порушувати проблему** | /pɔruˈʃuvɑtɪ prɔˈblɛmu/ | to raise an issue | колок. | не плутати з "порушувати закон" |
| **досягати успіху** | /dɔsʲɑˈɦɑtɪ usˈpixu/ | to achieve success | колок. | родовий відм. |
| **зазнавати невдачі** | /zɑznɑˈvɑtɪ nɛvˈdɑt͡ʃi/ | to fail, suffer failure | колок. | антонім: досягати успіху |
| **вдаватися до заходів** | /vdɑˈvɑtɪsʲɑ dɔ ˈzɑxɔdiv/ | to take measures | колок. | формальне, офіційне |
| **відігравати роль** | /vidiˈɦrɑvɑtɪ rɔlʲ/ | to play a role | колок. | = грати роль (формальніше) |
| **справляти враження** | /sprɑvˈlʲɑtɪ vrɑˈʒɛnːɑ/ | to make an impression | колок. | на + знах. відм. |
| **мати вплив** | /ˈmɑtɪ ˈvplɪv/ | to have influence | колок. | на + знах. відм. |
| **чинити опір** | /t͡ʃɪˈnɪtɪ ˈɔpir/ | to resist | колок. | давальний відм. |
| **виконувати обов'язки** | /vɪkɔˈnuvɑtɪ ɔˈbɔvjɑzkɪ/ | to fulfill duties | колок. | антонім: нехтувати |
| **порушувати закон** | /pɔruˈʃuvɑtɪ zɑˈkɔn/ | to break the law | колок. | негативне значення |
| **дотримуватися правил** | /dɔˈtrɪmuvɑtɪsʲɑ ˈprɑvɪl/ | to follow the rules | колок. | родовий відм. |
| **нехтувати обов'язками** | /nɛxtuˈvɑtɪ ɔˈbɔvjɑzkɑmɪ/ | to neglect duties | колок. | орудний відм. |
| **подавати заяву** | /pɔdɑˈvɑtɪ zɑˈjɑvu/ | to submit an application | колок. | на + знах. відм. |
| **укладати угоду** | /uklɑˈdɑtɪ uˈɦɔdu/ | to conclude an agreement | колок. | ділове мовлення |
| **займати посаду** | /zɑjˈmɑtɪ pɔˈsɑdu/ | to hold a position | колок. | знахідний відм. |
| **провадити діяльність** | /prɔˈvɑdɪtɪ diˈjɑlʲnistʲ/ | to conduct activities | колок. | формальне, юридичне |
| **отримувати дохід** | /ɔˈtrɪmuvɑtɪ dɔˈxid/ | to receive income | колок. | знахідний відм. |
| **виявляти ініціативу** | /vɪjɑvˈlʲɑtɪ iniˈt͡siɑtɪvu/ | to show initiative | колок. | позитивна конотація |
| **докладати зусиль** | /dɔklɑˈdɑtɪ zuˈsɪlʲ/ | to make efforts | колок. | родовий відм. |
| **забезпечувати якість** | /zɑbɛzˈpɛt͡ʃuvɑtɪ ˈjɑkistʲ/ | to ensure quality | колок. | знахідний відм. |
| **впроваджувати зміни** | /vprɔˈvɑdʒuvɑtɪ ˈzminɪ/ | to implement changes | колок. | множина |
| **налагоджувати зв'язки** | /nɑlɑˈɦɔdʒuvɑtɪ zvjɑzˈkɪ/ | to establish connections | колок. | ділове/дипломатичне |
...
>
> **Практика читання:**
> - 📰 [Українська правда](https://www.pravda.com.ua) — новини з діловими колокаціями
> - 📖 [Економічна правда](https://www.epravda.com.ua) — бізнес-лексика в контексті
>
> **Відео:**
> - 📺 [Громадське](https://www.youtube.com/@hromadske) — інтерв'ю та аналітика
> - 📺 [Радіо Свобода](https://www.youtube.com/@radiosvoboda) — новини та обговорення
