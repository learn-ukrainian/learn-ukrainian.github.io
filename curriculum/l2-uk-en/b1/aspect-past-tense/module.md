...
<!-- VERIFY: source=7-klas-ukrmova-litvinova-2024 chunk=7-klas-ukrmova-litvinova-2024_s3910 -->
У шкільному поясненні вид розрізняють через питання: **що робити? що робив?** для недоконаного виду і **що зробити? що зробив?** для доконаного. Це не дитячий прийом, а дуже корисний інструмент для дорослого учня. Питання швидко показує, як мовець бачить дію: відкритою, тривалою, повторюваною або завершеною.
...
У першому стовпчику ти можеш продовжити речення словами **але не знаю, чи закінчив**, **у цей час**, **довго**, **щодня**, **часто**. У другому стовпчику природніше чути **і тепер готово**, **до кінця**, **нарешті**, **після цього**. Така перевірка не замінює живої мови, але швидко показує, чи ти бачиш різницю.
...
<!-- VERIFY: source=7-klas-ukrmova-litvinova-2024 chunk=7-klas-ukrmova-litvinova-2024_s3912 -->
...
## Видові пари і часові маркери

Видові пари треба вчити не як сухий словник, а як інструменти для думки. На цьому рівні тобі потрібні частотні пари, з якими можна описати день, навчання, роботу, розмову й побут.

| Недоконаний вид | Доконаний вид | Типовий контраст |
| --- | --- | --- |
...
<!-- VERIFY: source=7-klas-ukrmova-avramenko-2024 chunk=7-klas-ukrmova-avramenko-2024_s3812 -->
...
Окремо потренуй пару **говорити / сказати**. Вона не завжди поводиться як проста префіксальна пара, але для минулого часу дуже корисна.
...
У цьому тексті майже всі дієслова недоконані. Не тому, що кожна дія не мала кінця. Кава, звісно, була куплена, сторінки були прочитані, розмови завершувалися. Але текст не про один конкретний вечір. Він про звичний ритм. Недоконаний вид створює тло.
...
Часто учень робить помилку, бо бачить завершений факт у реальному світі й автоматично ставить доконаний вид. Наприклад: **У дитинстві ми щоліта поїхали до бабусі**. У реальному житті кожна поїздка завершувалася, але речення не про одну поїздку. Воно про повторювану звичку. Тому природно: **щоліта їздили**.
...
Перші речення малюють звичну сцену. Потім **одного вечора** перемикає текст на подію. Вид допомагає читачеві зрозуміти, де тло, а де сюжет.
...
Коли ти розповідаєш історію, вид працює як камера. Недоконаний вид показує фон: що тривало, що було звичним, що створювало обставини. Доконаний вид показує кроки сюжету: що сталося, що змінило ситуацію, що дало результат.
...
| тло + раптом + подія | Ми **говорили** тихо, і раптом двері **відчинилися**. |
...
Уникай перекладної схеми, де кожна подія автоматично стає доконаною. Українська історія дихає, коли ти чергуєш тло й кроки сюжету. Запитай себе: ця форма малює сцену чи рухає подію? Якщо малює сцену — часто недоконаний. Якщо рухає подію — часто доконаний.
...
3. Перевір намір: процес, звичка, тло, результат чи подія.
...
Перед письмовою роботою корисно підкреслити всі дієслова минулого часу. Над кожним напиши коротку позначку: **процес**, **результат**, **звичка**, **подія**, **тло**. Якщо слово не відповідає позначці, виправ його. Це повільна вправа, але вона швидко робить вид усвідомленим.
...
| тло | недоконаний | Я писав звіт, коли задзвонив телефон. |
...
Якщо можеш пояснити кожну форму в такому тексті словами **процес**, **результат**, **звичка**, **подія**, **тло**, значить, вид у минулому часі перестає бути набором правил і стає інструментом мислення.
...
Не намагайся запам'ятати всі можливі випадки одразу. Краще навчись ставити точні питання до власного речення. **Що я показую: процес чи результат? Звичку чи один випадок? Тло чи крок сюжету?** Коли ці питання стають автоматичними, український вид починає працювати природно.
