...
|-------|----------|----------|
| **подорож** | journey, voyage, travel | здійснити подорож, подорож мрії; ж.р. |
| **мандрівка** | travel, wandering | захоплива мандрівка; ж.р., поетичніше |
| **поїздка** | trip | ділова поїздка, коротка поїздка; ж.р. |
| **турист** | tourist | іноземний турист, група туристів; ч.р. |
| **турагентство** | travel agency | звернутися до турагентства; с.р. |
| **бронювання** | booking, reservation | підтвердити бронювання, скасувати; с.р. |
| **резервація** | reservation | зробити резервацію; ж.р. |
| **готель** | hotel | зупинитися в готелі, п'ятизірковий; ч.р. |
| **хостел** | hostel | молодіжний хостел; ч.р. |
| **віза** | visa | оформити візу, туристична віза; ж.р. |
| **паспорт** | passport | закордонний паспорт, біометричний; ч.р. |
| **митниця** | customs | пройти митницю, митний контроль; ж.р. |
| **кордон** | border | перетнути кордон, державний кордон; ч.р. |
| **авіаквиток** | airline ticket | замовити авіаквиток, електронний; ч.р. |
| **посадковий талон** | boarding pass | отримати посадковий талон; ч.р. |
| **багаж** | luggage, baggage | зареєструвати багаж, ручна поклажа; ч.р. |
| **валіза** | suitcase | спакувати валізу, велика валіза; ж.р. |
| **рюкзак** | backpack | туристичний рюкзак, легкий рюкзак; ч.р. |
| **пам'ятка** | landmark, sight | історична пам'ятка, оглянути пам'ятки; ж.р. |
| **екскурсія** | excursion, tour | замовити екскурсію, пішохідна; ж.р. |
| **гід** | guide | досвідчений гід, екскурсовод; ч.р. |
| **маршрут** | route, itinerary | скласти маршрут, туристичний; ч.р. |
| **карта** | map | туристична карта, карта міста; ж.р. |
| **напрямок** | direction | рухатися в напрямку, вказати; ч.р. |
| **північ** | north | на півночі, північний напрямок; ж.р. |
| **південь** | south | на півдні, південний регіон; ч.р. |
| **схід** | east | на сході, східний кордон; ч.р. |
| **захід** | west | на заході, західні області; ч.р. |
| **континент** | continent | європейський континент; ч.р. |
| **острів** | island | тропічний острів, острів Зміїний; ч.р. |
| **аеропорт** | airport | міжнародний аеропорт; ч.р. |
| **вокзал** | train station | залізничний вокзал, автовокзал; ч.р. |
| **подорожувати** | to travel | подорожувати світом; дієсл. |
| **мандрувати** | to wander, travel | мандрувати Україною; дієсл., поетичне |
| **відпустка** | vacation, holiday | поїхати у відпустку; ж.р. |
...
>
> **Практика читання:**
> - [Lonely Planet Ukraine](https://www.lonelyplanet.com/ukraine) — путівник англійською з українськими назвами
> - [Ukraine.ua](https://ukraine.ua/) — офіційний портал про Україну
>
> **Відео:**
> - [Один день у Львові](https://www.youtube.com/results?search_query=один+день+у+львові) — влоги мандрівників
> - [Карпати з висоти](https://www.youtube.com/results?search_query=карпати+україна+дрон) — відео про гори
