# Module 80: Активне довголіття (Active Lifestyle)

**Template:** b1-vocab-module-template.md | **Compliance:** ✅ PASS
**Overall Score:** 9.5/10
**Status:** ✅ PASS
**Generated:** 2026-01-25 00:16:00
**Reviewer:** Gemini
...
| Linguistic Accuracy | 9/10  | Check capitalization and `спортмастер`.                                                      |
...
- **Urbanism:** Discussing `урбаністика` and bike lanes (`велодоріжки`) reflects the modern transformation of Ukrainian cities (Kyiv, Lviv, Vinnytsia).
- **Street Workout:** Mentions the `вуличний спорт` culture (Hydropark gym) which is uniquely popular in Kyiv.

## Issues

- **Vocabulary YAML:** Capitalize proper nouns. Remove `Спортмастер`.

## Recommendation

✅ PASS — Excellent lifestyle module.

## Action Items

1. **Fix Vocab:** Remove `Спортмастер`. Capitalize names.
