...
| Linguistic Accuracy | 9/10  | Check `болячий` in vocab.                                                       |
...
- **Vocabulary YAML:** `болячий` -> `болючий`, `рацс` -> `РАЦС`.
...
1. **Fix Vocab:** Correct specific items.
