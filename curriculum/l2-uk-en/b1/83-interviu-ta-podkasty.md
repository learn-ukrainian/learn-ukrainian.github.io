...
|-------|----------|----------|
| інтерв'ю | interview | н., незм. — з журналістом або для роботи |
| подкаст | podcast | ч. — аудіопрограма в інтернеті |
| ведучий | host, presenter | ч. (ведуча — ж.) — той, хто веде програму |
| гість | guest | ч. — запрошена особа |
| питання | question | н. — те, що ви запитуєте |
| відповідь | answer | ж. — реакція на питання |
| обговорення | discussion | н. — дискусія, розмова про тему |
| дискусія | debate, discussion | ж. — обмін думками |
| розмова | conversation | ж. — комунікація між людьми |
| бесіда | talk, chat | ж. — неформальна розмова |
| слухати | to listen | недок. — сприймати звуки свідомо |
| чути | to hear | недок. — сприймати звуки (без зусиль) |
| розуміти | to understand | недок. — осягати зміст |
| перепитувати | to ask again, clarify | недок. — просити повторити |
| уточнювати | to clarify, specify | недок. — робити більш точним |
| нотатки | notes | мн. — записи під час слухання |
| конспект | summary notes | ч. — структуровані нотатки |
| тези | thesis points, key points | мн. — основні положення |
| резюме | summary | н., незм. — короткий виклад |
| висновок | conclusion | ч. — підсумкова думка |
...
> [!resources]
> **Подкасти:**
> - Чорний лебідь — журналістські розслідування
> - Книжковий Арсенал — про книги та культуру
> - Ще не вмерла — про сучасну Україну
> - Україна: The Human Stories (BBC) — журналістика англійською та українською
> - Слово — про мову та культуру
>
> **YouTube-канали:**
> - Точка опори — політичні інтерв'ю
> - Розмова — глибокі інтерв'ю
> - Суспільне Культура — культурний контент
>
> **Поради для ефективного слухання:**
> 1. Починайте з коротких епізодів (10-15 хвилин)
> 2. Використовуйте субтитри, якщо вони доступні
> 3. Слухайте один і той самий епізод кілька разів
> 4. Робіть нотатки — це покращує концентрацію
> 5. Обговорюйте почуте з друзями або в мовних клубах
