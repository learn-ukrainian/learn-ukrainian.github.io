...
|-------|--------|----------|-----|----------|
| **процес** | /prɔˈt͡sɛs/ | process | ім. (ч.р.) | тривалий процес, складний процес |
| **розвиток** | /ˈrɔzvɪtɔk/ | development | ім. (ч.р.) | економічний розвиток, сталий розвиток |
| **прогрес** | /prɔˈɦrɛs/ | progress | ім. (ч.р.) | значний прогрес, досягти прогресу |
| **зміна** | /ˈzminɑ/ | change | ім. (ж.р.) | внести зміни, значні зміни |
| **перетворення** | /pɛrɛˈtvɔrɛnːɑ/ | transformation | ім. (с.р.) | докорінне перетворення |
| **еволюція** | /ɛvɔˈlʲut͡sijɑ/ | evolution | ім. (ж.р.) | природна еволюція, еволюція поглядів |
| **революція** | /rɛvɔˈlʲut͡sijɑ/ | revolution | ім. (ж.р.) | технологічна революція |
| **реформа** | /rɛˈfɔrmɑ/ | reform | ім. (ж.р.) | провести реформу, судова реформа |
| **модернізація** | /mɔdɛrniˈzɑt͡sijɑ/ | modernization | ім. (ж.р.) | технічна модернізація |
| **оновлення** | /ɔˈnɔvlɛnːɑ/ | renewal, update | ім. (с.р.) | оновлення системи |
| **покращення** | /pɔˈkrɑʃːɛnːɑ/ | improvement | ім. (с.р.) | значне покращення |
| **погіршення** | /pɔˈɦirʃɛnːɑ/ | deterioration | ім. (с.р.) | різке погіршення |
| **зростання** | /zrɔsˈtɑnːɑ/ | growth | ім. (с.р.) | економічне зростання |
| **спадання** | /spɑˈdɑnːɑ/ | decline | ім. (с.р.) | економічне спадання |
| **підвищення** | /pidˈvɪʃːɛnːɑ/ | increase, rise | ім. (с.р.) | підвищення цін |
| **зниження** | /ˈznɪʒɛnːɑ/ | decrease, reduction | ім. (с.р.) | зниження рівня |
| **розширення** | /rɔzˈʃɪrɛnːɑ/ | expansion | ім. (с.р.) | розширення бізнесу |
| **скорочення** | /skɔˈrɔt͡ʃɛnːɑ/ | reduction, cutback | ім. (с.р.) | скорочення витрат |
| **збільшення** | /zbilʲˈʃɛnːɑ/ | increase | ім. (с.р.) | значне збільшення |
| **зменшення** | /ˈzmɛnʃɛnːɑ/ | decrease | ім. (с.р.) | поступове зменшення |
| **прискорення** | /prɪsˈkɔrɛnːɑ/ | acceleration | ім. (с.р.) | прискорення реформ |
| **сповільнення** | /spɔˈvilʲnɛnːɑ/ | slowdown | ім. (с.р.) | економічне сповільнення |
| **стабілізація** | /stɑbiliˈzɑt͡sijɑ/ | stabilization | ім. (ж.р.) | стабілізація курсу |
| **криза** | /ˈkrɪzɑ/ | crisis | ім. (ж.р.) | економічна криза |
| **підйом** | /pidˈjɔm/ | rise, upswing | ім. (ч.р.) | економічний підйом |
| **занепад** | /zɑˈnɛpɑd/ | decline, decay | ім. (ч.р.) | культурний занепад |
| **відновлення** | /vidˈnɔvlɛnːɑ/ | recovery, restoration | ім. (с.р.) | економічне відновлення |
| **регрес** | /rɛˈɦrɛs/ | regression | ім. (ч.р.) | економічний регрес |
| **трансформація** | /trɑnsfɔrˈmɑt͡sijɑ/ | transformation | ім. (ж.р.) | цифрова трансформація |
| **адаптація** | /ɑdɑpˈtɑt͡sijɑ/ | adaptation | ім. (ж.р.) | швидка адаптація |
| **тенденція** | /tɛnˈdɛnt͡sijɑ/ | tendency, trend | ім. (ж.р.) | загальна тенденція, позитивна тенденція |
| **динаміка** | /dɪˈnɑmikɑ/ | dynamics | ім. (ж.р.) | позитивна динаміка, динаміка зростання |
| **інновація** | /inɔˈvɑt͡sijɑ/ | innovation | ім. (ж.р.) | технологічна інновація, впроваджувати інновації |
| **оптимізація** | /ɔptɪmiˈzɑt͡sijɑ/ | optimization | ім. (ж.р.) | оптимізація процесів, оптимізація витрат |
| **інтеграція** | /intɛˈɦrɑt͡sijɑ/ | integration | ім. (ж.р.) | європейська інтеграція, інтеграція систем |
...
>
> **Практика читання:**
> - [Економічна правда](https://www.epravda.com.ua) — економічні новини з багатою лексикою процесів
> - [Тиждень](https://tyzhden.ua) — аналітичні статті про суспільні зміни
>
> **Відео:**
> - [Громадське](https://www.youtube.com/@hborets) — новинні сюжети про реформи
> - [Радіо Свобода](https://www.youtube.com/@radiosvoboda) — аналітика та інтерв'ю
