...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/abstract-concepts-processes-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/abstract-concepts-processes.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/abstract-concepts-processes.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Абстрактні концепції: процеси та зміни** (b1 track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Основна лексика: Тренди та динаміка | 900 | 1350 |
| Словотворення та граматичне вживання | 800 | 1200 |
| Аналітичне читання та аудіювання | 1000 | 1500 |
| Комунікація та обговорення | 600 | 900 |
| Підсумок та закріплення | 300 | 450 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/abstract-concepts-processes.yaml`. Go through EVERY `points:` item in EVERY section:
