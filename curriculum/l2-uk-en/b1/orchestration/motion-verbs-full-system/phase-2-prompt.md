...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/motion-verbs-full-system-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/motion-verbs-full-system.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/motion-verbs-full-system.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Дієслова руху: повна система** (b1 track).
...
|---------|--------|---------------------|
| Вступ | 500 | 750 |
| Презентація 14 пар дієслів | 1200 | 1800 |
| Аналіз типових помилок | 800 | 1200 |
| Культурний код: Логістика та залізниця | 800 | 1200 |
| Синтез та практичне застосування | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/motion-verbs-full-system.yaml`. Go through EVERY `points:` item in EVERY section:
