...
Let's look at three common translation traps and how to escape them. The first trap is the "unrealized result." An English speaker might say, "I read the book yesterday," meaning they spent time reading it, but they haven't finished it yet. The instinct is to translate "read" as the perfective **прочитав**. However, if the book is not finished, you must use the imperfective **читав**. The perfective aspect strictly requires a completed result. 

The second trap is the "duration paradox." You might want to say, "I cleaned the room for two hours." Because the room is now clean, you might be tempted to use the perfective **прибрав**. But the phrase "for two hours" explicitly highlights the duration of the process. In Ukrainian, whenever you focus on how long an action took, you must use the imperfective aspect. Therefore, you should say, "Я прибирав у кімнаті дві години."

The third trap is the "repeated result." Consider the sentence, "Every summer we went to the sea." Going to the sea is a completed journey, so the perfective **поїхали** might seem logical. But the marker "every summer" indicates a repeated, habitual action. As we saw on our decision matrix, repetition always demands the imperfective aspect. The correct choice is "Щоліта ми їздили на море."
...
**PIPELINE NOTE — Word count: 5556 words** (calculated deterministically by the pipeline, NOT by the writer. This number is CORRECT. Do NOT estimate your own word count — use this number for the Structural integrity dimension.)
...
Verified: 1033 words | Not found: 11 words
...
All 1033 other words are confirmed to exist in VESUM.
