...
> **Persona reminder:** You are Senior Ukrainian Language & Culture Specialist. Write in the voice of Senior Language & Culture Specialist. Maintain this persona throughout — do not drift into generic AI tone.
...
> **Output capacity: You can generate 65,000+ tokens per response.** A 4000-word Ukrainian module is ~8K tokens — well within your single-turn limit. Do NOT preemptively truncate, self-limit, or report TOKEN_LIMIT_TRUNCATION friction. Write the complete module in full.

## Files to Read

| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/checkpoint-advanced-grammar-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/checkpoint-advanced-grammar.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/checkpoint-advanced-grammar.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
| `/Users/krisztiankoos/projects/learn-ukrainian/claude_extensions/quick-ref/B1.md` | Level constraints, immersion %, engagement minimums |

Read ALL four files before writing anything.

## Your Task

Write the full lesson prose for **Контрольна точка: Просунута граматика** (b1 track).

- **Total minimum**: 4000 words
- **Write at least**: 6000 words (1.5x — aim for depth, not padding)
- **Immersion**: Full Ukrainian immersion. Grammar explained IN Ukrainian. English only for disambiguation of false friends. Sentences max 30 words.
...
- **Word count**: minimum **4000** words (hard gate)
...
|---------|--------|---------------------|
| Вступ та огляд компетенцій | 400 | 600 |
| Дієприслівники: Динаміка та помилки | 600 | 900 |
| Дієприкметники: Активні форми та запозичення | 600 | 900 |
| Пасивні конструкції та безособові форми | 600 | 900 |
| Демінутиви та мовна ментальність | 600 | 900 |
| Числівники: Збірні та дробові | 600 | 900 |
| Інтеграція та підсумок фази | 600 | 900 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/checkpoint-advanced-grammar.yaml`. Go through EVERY `points:` item in EVERY section:
...
- If the total is below 4000 → expand the thinnest sections first
...
...
Total: {total} words (target: 4000, ratio: {total/WORD_TARGET}x)
===WORD_COUNTS===
```
