...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/relative-clauses-de-kudy-zvidky-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/relative-clauses-de-kudy-zvidky.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/relative-clauses-de-kudy-zvidky.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Підрядні означальні: де, куди, звідки** (b1 track).
...
| Теорія: Тріада просторових відношень | 1000 | 1500 |
| Поглиблення та робота над помилками | 1100 | 1650 |
| Культурна географія України | 800 | 1200 |
| Практика та інтеграція | 600 | 900 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/relative-clauses-de-kudy-zvidky.yaml`. Go through EVERY `points:` item in EVERY section:
