...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/technology-and-startups-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/technology-and-startups.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/technology-and-startups.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Технології та стартапи** (b1 track).
...
|---------|--------|---------------------|
| Вступ та історія українського IT | 600 | 900 |
| Українські єдинороги та історії успіху | 1000 | 1500 |
| Дія — держава в смартфоні | 800 | 1200 |
| Словотворення та назви професій | 800 | 1200 |
| Практика та типові помилки | 400 | 600 |
| Підсумок: Технології під час війни та майбутнє | 400 | 600 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/technology-and-startups.yaml`. Go through EVERY `points:` item in EVERY section:
