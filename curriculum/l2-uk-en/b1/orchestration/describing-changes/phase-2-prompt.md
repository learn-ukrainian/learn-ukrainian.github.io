...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/describing-changes-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/describing-changes.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/describing-changes.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Опис змін** (b1 track).
...
|---------|--------|---------------------|
| Вступ: Мова динаміки | 500 | 750 |
| Презентація та граматичні нюанси | 1000 | 1500 |
| Читання: Клімат та трансформація міст | 1000 | 1500 |
| Діалоги: Від прогнозів до цифровізації | 800 | 1200 |
| Виробництво та підсумок | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/describing-changes.yaml`. Go through EVERY `points:` item in EVERY section:
