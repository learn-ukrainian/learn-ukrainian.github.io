...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/novyny-yak-chytaty-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/novyny-yak-chytaty.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/novyny-yak-chytaty.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Новини: як читати** (b1 track).
...
|---------|--------|---------------------|
| Вступ | 600 | 900 |
| Стратегії читання: Заголовки та ліди | 1100 | 1650 |
| Медіаграмотність: Факти та маніпуляції | 1000 | 1500 |
| Лексичні пастки та автентичний контекст | 900 | 1350 |
| Продукція та підсумок | 400 | 600 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/novyny-yak-chytaty.yaml`. Go through EVERY `points:` item in EVERY section:
