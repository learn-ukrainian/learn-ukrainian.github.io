...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/complex-sentence-integration-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/complex-sentence-integration.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/complex-sentence-integration.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Інтеграція складних речень** (b1 track).
...
|---------|--------|---------------------|
| Діагностика та вступ | 600 | 900 |
| Граматичні основи та типи зв'язку | 1000 | 1500 |
| Культура, ритм та пунктуація | 800 | 1200 |
| Практичне застосування та стилістика | 900 | 1350 |
| Творча майстерня редактора | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/complex-sentence-integration.yaml`. Go through EVERY `points:` item in EVERY section:
