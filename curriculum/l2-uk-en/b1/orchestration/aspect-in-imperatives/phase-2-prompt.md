...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/aspect-in-imperatives-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/aspect-in-imperatives.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/aspect-in-imperatives.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Вид у наказовому способі** (b1 track).
...
|---------|--------|---------------------|
| Вступ та діагностика | 500 | 750 |
| Граматика: Стверджувальні конструкції | 1200 | 1800 |
| Граматика: Заперечення та застереження | 1000 | 1500 |
| Практика та розбір помилок | 800 | 1200 |
| Культурний код та діалоги | 600 | 900 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/aspect-in-imperatives.yaml`. Go through EVERY `points:` item in EVERY section:
