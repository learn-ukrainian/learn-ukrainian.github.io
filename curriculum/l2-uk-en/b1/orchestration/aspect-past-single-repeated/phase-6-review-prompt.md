...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/aspect-past-single-repeated.md`
2. **Activities**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/activities/aspect-past-single-repeated.yaml`
3. **Vocabulary**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/vocabulary/aspect-past-single-repeated.yaml`
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/aspect-past-single-repeated.yaml`
5. **Meta** (build config): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/aspect-past-single-repeated.yaml`
...
Tier 2 Core (B1) Review Guidance:
- Focus on Teaching Quality (effective, engaging teaching).
- Apply the 'Did I Learn?' test: clear 'aha' moment, практичне застосування.
- Check the Teaching Arc: HOOK → DISCOVER → EXPLAIN → PRACTICE → APPLY → SUMMARIZE.
- Verify B1 complexity: concept density (3-5 per section), rich culturally embedded examples.
- Engagement beats: driving question, insight moments, real-world application, common mistake warnings.
- Humanity & Warmth: direct address (ви, давайте), encouragement, confusion anticipation.
- Grammar accuracy: verify aspectual pairs and rule precision.
- Reject rubber-stamped reviews; find at least 1-2 real issues with «quotes».
...
```
===REVIEW_START===
# Рецензія: Вид у минулому: одного разу vs щодня

**Level:** B1 | **Module:** {MODULE_NUM}
