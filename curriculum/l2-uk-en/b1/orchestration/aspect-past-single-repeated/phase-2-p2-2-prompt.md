...
> **Your #1 job: Write 846 words for the section "Практика".**
...
Write the section prose for **Практика** within the module **Вид у минулому: одного разу vs щодня**.

- **Section minimum**: 705 words
- **Write at least**: 846 words (1.2x — quality over quantity)
...
Covered in 'Пояснення': The 'Zoom In' Effect, Repeated Actions (Imperfective), Single Events (Perfective), Cultural Hook: 'Одного разу...', Contrast Table, Addressing the 'Used to' confusion, Gender Agreement alert. Deep dive into time markers and aspectual choice logic.
...
Previously used callout types in this module: [!culture], [!context], [!myth-buster], [!warning], [!tip]
...
## How to Hit 846 Words (Expansion Method)
...
```
===WORD_COUNTS===
Section "Практика": {count} words (minimum: 705)
===WORD_COUNTS===
```
