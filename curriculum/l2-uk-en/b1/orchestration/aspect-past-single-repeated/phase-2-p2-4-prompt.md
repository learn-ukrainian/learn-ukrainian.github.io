...
> **Your #1 job: Write 650 words for the section "Підсумок".**
...
Write the section prose for **Підсумок** within the module **Вид у минулому: одного разу vs щодня**.

- **Section minimum**: 541 words
- **Write at least**: 650 words (1.2x — quality over quantity)
...
Covered in 'Діалоги': School Memories (habit vs event), Summer Stories (nostalgic holiday account), Work Experience (routine vs project completion). Emphasized natural flow between background (Imp) and foreground (Perf).
...
Previously used callout types in this module: [!culture], [!context], [!myth-buster], [!warning], [!tip], [!fact], [!quote], [!history-bite], [!observe]
...
## How to Hit 650 Words (Expansion Method)
...
```
===WORD_COUNTS===
Section "Підсумок": {count} words (minimum: 541)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Підсумок)
