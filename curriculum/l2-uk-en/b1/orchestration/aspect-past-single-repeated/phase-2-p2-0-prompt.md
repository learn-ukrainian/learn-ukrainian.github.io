...
> **Your #1 job: Write 340 words for the section "Тест".**
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/aspect-past-single-repeated-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/aspect-past-single-repeated.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/aspect-past-single-repeated.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the section prose for **Тест** within the module **Вид у минулому: одного разу vs щодня**.

- **Section minimum**: 283 words
- **Write at least**: 340 words (1.2x — quality over quantity)
- **Immersion**: Full Ukrainian immersion
...
## How to Hit 340 Words (Expansion Method)
...
```
===WORD_COUNTS===
Section "Тест": {count} words (minimum: 283)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Тест)
