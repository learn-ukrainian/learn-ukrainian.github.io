...
| Persona flavor | Ethnographer |
| Module persona | Senior Language & Culture Specialist, acting as Memoirist |
| Activities required | 8–12 |
| Items per activity | ≥6 |
| Required types | None |
| Priority types | fill-in-b1, quiz-b1, match-up-b1 |
| Vocabulary items | 15 |
...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/aspect-past-single-repeated.md
```

**Plan file** (vocabulary_hints — vocabulary list to follow):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/aspect-past-single-repeated.yaml
```

**Meta file** (activity count targets, pedagogy):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/aspect-past-single-repeated.yaml
```
...
4. **Activity count**: 8-12 activities (4-9 for seminar tracks)
...
**ALLOWED types (use ONLY these):** authorial-intent-b1, cloze-b1, comparative-study-b1, critical-analysis-b1, error-correction-b1, essay-response-b1, fill-in-b1, group-sort-b1, mark-the-words-b1, match-up-b1, quiz-b1, reading-b1, select-b1, translate-b1, true-false-b1, unjumble-b1

**FORBIDDEN types (audit will auto-FAIL if you use these):** None
...
**Count your activities before outputting.** You MUST generate 8-12 activities. Previous rebuilds consistently underproduced (8 activities when 12-16 were needed). If under target, ADD MORE activities before submitting. Types to add when short: quiz (8+ items), fill-in (8+ items), match-up (8+ pairs).
