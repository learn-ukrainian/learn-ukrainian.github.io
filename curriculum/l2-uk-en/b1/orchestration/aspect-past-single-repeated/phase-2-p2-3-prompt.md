...
> **Your #1 job: Write 988 words for the section "Діалоги".**
...
Write the section prose for **Діалоги** within the module **Вид у минулому: одного разу vs щодня**.

- **Section minimum**: 824 words
- **Write at least**: 988 words (1.2x — quality over quantity)
...
Covered in 'Практика': Selection Algorithm (checklist for choosing aspect), Common Mistakes Analysis (daily life errors), Transforming Narratives (switching between habitual and single event), Scenario-based practice (typical vs memorable day).
...
Previously used callout types in this module: [!culture], [!context], [!myth-buster], [!warning], [!tip], [!fact], [!quote]
...
## How to Hit 988 Words (Expansion Method)
...
```
===WORD_COUNTS===
Section "Діалоги": {count} words (minimum: 824)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Діалоги)
