...
> **Your #1 job: Write 1976 words for the section "Пояснення".**
...
Write the section prose for **Пояснення** within the module **Вид у минулому: одного разу vs щодня**.

- **Section minimum**: 1647 words
- **Write at least**: 1976 words (1.2x — quality over quantity)
- **Immersion**: Full Ukrainian immersion
- **Engagement callouts**: Include at least 3 callout(s) in this section.
- **Example sentences**: Include at least 8 example sentences in this section.
...
Covered in 'Тест': ### Щоденний ритм, ### Момент зміни, ### Ключ до розуміння. Focus was on the intuitive difference between background routine (Imp) and foreground events (Perf).
...
## How to Hit 1976 Words (Expansion Method)
...
```
===WORD_COUNTS===
Section "Пояснення": {count} words (minimum: 1647)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Пояснення)
