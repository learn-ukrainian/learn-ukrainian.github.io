...
Write the full lesson prose for **Вид у минулому: одного разу vs щодня** (b1 track).
...
|---------|--------|---------------------|
| Тест: Два спогади | 600 | 900 |
| Презентація: Теорія та культурний контекст | 1200 | 1800 |
| Грамматичні нюанси та типові помилки | 800 | 1200 |
| Практика: Минуле в деталях | 900 | 1350 |
| Підсумок: Резюме маркерів | 500 | 750 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/aspect-past-single-repeated.yaml`. Go through EVERY `points:` item in EVERY section:
