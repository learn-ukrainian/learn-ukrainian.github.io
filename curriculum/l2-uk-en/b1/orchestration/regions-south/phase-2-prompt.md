...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/regions-south-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/regions-south.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/regions-south.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Українські регіони: Південь** (b1 track).
...
|---------|--------|---------------------|
| Вступ: Море та Степ | 600 | 900 |
| Одеса — Перлина Чорного моря | 1000 | 1500 |
| Від Миколаєва до Олешківських пісків | 1000 | 1500 |
| Крим та кримськотатарська спадщина | 800 | 1200 |
| Практика та мовні нюанси | 400 | 600 |
| Підсумок: Туристичні принади Півдня | 200 | 300 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/regions-south.yaml`. Go through EVERY `points:` item in EVERY section:
