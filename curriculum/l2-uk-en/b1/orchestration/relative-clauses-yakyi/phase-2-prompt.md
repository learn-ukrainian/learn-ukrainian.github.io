...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/relative-clauses-yakyi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/relative-clauses-yakyi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/relative-clauses-yakyi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Підрядні означальні: який** (b1 track).
...
|---------|--------|---------------------|
| Діагностичний тест | 800 | 1200 |
| Презентація та теорія | 1000 | 1500 |
| Поглиблення: Культурний код | 800 | 1200 |
| Практика та аналіз помилок | 800 | 1200 |
| Діалоги та синтез | 600 | 900 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/relative-clauses-yakyi.yaml`. Go through EVERY `points:` item in EVERY section:
