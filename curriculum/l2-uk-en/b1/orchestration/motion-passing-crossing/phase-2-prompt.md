...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/motion-passing-crossing-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/motion-passing-crossing.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/motion-passing-crossing.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Рух: перехід і обхід** (b1 track).
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/motion-passing-crossing.yaml`. Go through EVERY `points:` item in EVERY section:
