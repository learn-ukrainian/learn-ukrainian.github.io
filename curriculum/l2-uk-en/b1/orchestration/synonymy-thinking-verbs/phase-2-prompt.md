...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/synonymy-thinking-verbs-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/synonymy-thinking-verbs.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/synonymy-thinking-verbs.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Синонімія I: Дієслова мислення** (b1 track).
...
|---------|--------|---------------------|
| Вступ: Я мислю, отже я існую | 700 | 1050 |
| Словник думок: Від «думати» до «вважати» | 900 | 1350 |
| Аналіз помилок: Рахувати чи вважати? | 800 | 1200 |
| Літературні думи та народна мудрість | 900 | 1350 |
| Практика та підсумок: Точність міркувань | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/synonymy-thinking-verbs.yaml`. Go through EVERY `points:` item in EVERY section:
