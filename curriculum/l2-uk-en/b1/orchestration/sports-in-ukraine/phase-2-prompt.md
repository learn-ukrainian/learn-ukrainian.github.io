...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/sports-in-ukraine-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/sports-in-ukraine.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/sports-in-ukraine.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Спорт в Україні** (b1 track).
...
|---------|--------|---------------------|
| Вступ — Спортивна нація | 500 | 750 |
| Футбол — Релігія мільйонів | 900 | 1350 |
| Бокс — Сила та незламність | 900 | 1350 |
| Олімпійська та паралімпійська слава | 800 | 1200 |
| Спорт під час війни та дипломатія | 600 | 900 |
| Підсумок — Мовна норма та здобутки | 300 | 450 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/sports-in-ukraine.yaml`. Go through EVERY `points:` item in EVERY section:
