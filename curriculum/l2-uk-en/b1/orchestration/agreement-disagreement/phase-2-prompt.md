...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/agreement-disagreement-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/agreement-disagreement.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/agreement-disagreement.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Згода і незгода** (b1 track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Словник та фразеологія | 900 | 1350 |
| Граматика та типові помилки | 800 | 1200 |
| Стратегії ввічливої дискусії | 1000 | 1500 |
| Практика: Дебати та месенджери | 600 | 900 |
| Підсумок | 300 | 450 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/agreement-disagreement.yaml`. Go through EVERY `points:` item in EVERY section:
