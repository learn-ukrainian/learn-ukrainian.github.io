...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/ukrainian-cinema-and-tv-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/ukrainian-cinema-and-tv.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/ukrainian-cinema-and-tv.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Українське кіно та серіали** (b1 track).
...
|---------|--------|---------------------|
| Вступ — Україна на екрані | 500 | 750 |
| Золота ера — Довженко і поетичне кіно | 800 | 1200 |
| Сучасне кіно та феномен дубляжу | 900 | 1350 |
| Документальне кіно та голос правди | 700 | 1050 |
| Як говорити про фільми: лексика та граматика | 700 | 1050 |
| Підсумок — Дивись українською! | 400 | 600 |
| Потрібно більше практики? | 571 | 856 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/ukrainian-cinema-and-tv.yaml`. Go through EVERY `points:` item in EVERY section:
