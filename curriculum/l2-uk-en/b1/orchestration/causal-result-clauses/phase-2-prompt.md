...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/causal-result-clauses-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/causal-result-clauses.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/causal-result-clauses.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Причинові та наслідкові речення** (b1 track).
...
|---------|--------|---------------------|
| Вступ | 500 | 750 |
| Причинові речення | 1000 | 1500 |
| Наслідкові речення | 900 | 1350 |
| Логіка та регістри | 800 | 1200 |
| Агентність та практика | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/causal-result-clauses.yaml`. Go through EVERY `points:` item in EVERY section:
