...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/motion-starting-returning-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/motion-starting-returning.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/motion-starting-returning.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Рух: початок і повернення** (b1 track).
...
| Семантика префіксів за державним стандартом | 1000 | 1500 |
| Мовні нюанси та запобігання помилкам | 900 | 1350 |
| Культурний контекст та транспортний етикет | 800 | 1200 |
| Комплексна практика та підсумок | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/motion-starting-returning.yaml`. Go through EVERY `points:` item in EVERY section:
