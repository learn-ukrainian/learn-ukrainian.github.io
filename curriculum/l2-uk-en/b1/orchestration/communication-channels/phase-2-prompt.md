...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/communication-channels-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/communication-channels.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/communication-channels.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Канали комунікації** (b1 track).
...
|---------|--------|---------------------|
| Вступ — Вибір каналу та культурний контекст | 800 | 1200 |
| Телефонний зв'язок та етикет | 800 | 1200 |
| Листування в месенджерах та соціальних мережах | 800 | 1200 |
| Електронна пошта та ділове листування | 800 | 1200 |
| Практикум та аналіз комунікаційних сценаріїв | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/communication-channels.yaml`. Go through EVERY `points:` item in EVERY section:
