...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/feedback-negotiation-complaints-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/feedback-negotiation-complaints.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/feedback-negotiation-complaints.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Зворотний зв'язок, переговори, скарги** (b1 track).
...
|---------|--------|---------------------|
| Вступ: Культура фідбеку та переговорів | 500 | 750 |
| Давати та отримувати зворотний зв'язок | 800 | 1200 |
| Мистецтво переговорів та компромісів | 900 | 1350 |
| Ввічливі скарги та захист прав споживачів | 1000 | 1500 |
| Практикум: Сценарії вирішення проблем | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/feedback-negotiation-complaints.yaml`. Go through EVERY `points:` item in EVERY section:
