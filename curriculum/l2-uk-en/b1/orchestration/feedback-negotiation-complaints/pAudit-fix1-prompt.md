...
────────────────────────────────────────────────────────────
  ...
  failing gates:
    lesson: 6831/4000 (raw: 7389) | pedagogy: 8 violations | richness: 81% < 95% min (grammar)

  Otaman has NOT completed this module.
  Fix the issues above and re-run this script.

─── Audit output (last 15 lines) ───
       → FIX: Break into shorter sentences. First 5 words: 'Використовуючи на практиці психологічний сендвіч...'
    [CONTENT_REDUNDANCY] Redundant information detected in lesson (73% overlap): "* ✅ Правильно: Давайте сядемо і **обговоримо нові умови** повернення товару до магазину.". Shares significant keywords with sentence at index 227.
