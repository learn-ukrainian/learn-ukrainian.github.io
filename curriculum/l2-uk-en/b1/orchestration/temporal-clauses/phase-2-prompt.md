...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/temporal-clauses-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/temporal-clauses.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/temporal-clauses.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Часові підрядні речення** (b1 track).
...
| Пояснення: Одночасність та Тривалість | 1000 | 1500 |
| Пояснення: Послідовність та пастка «поки не» | 1000 | 1500 |
| Культурна перспектива: Час і Доля | 700 | 1050 |
| Практика та Синтез | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/temporal-clauses.yaml`. Go through EVERY `points:` item in EVERY section:
