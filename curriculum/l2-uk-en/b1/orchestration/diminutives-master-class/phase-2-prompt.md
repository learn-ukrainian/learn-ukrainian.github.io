...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/diminutives-master-class-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/diminutives-master-class.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/diminutives-master-class.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Демінутиви: майстер-клас** (b1 track).
...
|---------|--------|---------------------|
| Вступ: Світ українських демінутивів | 500 | 750 |
| Морфологія: Від іменників до дієслів | 1000 | 1500 |
| Прагматика та соціальні регістри | 1000 | 1500 |
| Культурний код та іронія | 1000 | 1500 |
| Підсумок: Мистецтво доречності | 500 | 750 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/diminutives-master-class.yaml`. Go through EVERY `points:` item in EVERY section:
