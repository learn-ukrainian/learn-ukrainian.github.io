...
| Module persona | Senior Language & Culture Specialist, acting as Kindergarten Teacher |
...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/diminutives-master-class.md
```

**Plan file** (vocabulary_hints — vocabulary list to follow):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/diminutives-master-class.yaml
```

**Meta file** (activity count targets, pedagogy):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/diminutives-master-class.yaml
```
