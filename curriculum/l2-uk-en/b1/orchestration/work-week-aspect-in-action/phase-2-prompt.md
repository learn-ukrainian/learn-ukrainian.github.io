...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/work-week-aspect-in-action-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/work-week-aspect-in-action.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/work-week-aspect-in-action.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Робочий тиждень: вид у дії** (b1 track).
...
|---------|--------|---------------------|
| Вступ: Робота та вид дієслова | 600 | 900 |
| Презентація: Робочі завдання та звіти | 1000 | 1500 |
| Аналіз помилок: Пастки для іноземців | 900 | 1350 |
| Ділові ситуації та діалоги | 1000 | 1500 |
| Підсумок та професійна комунікація | 500 | 750 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/work-week-aspect-in-action.yaml`. Go through EVERY `points:` item in EVERY section:
