...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/work-week-aspect-in-action.yaml
```

Read the meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/work-week-aspect-in-action.yaml
```
...
Research **Робочий тиждень: вид у дії** for the **B1** core track. Core tracks need lighter research than seminar tracks — focus on accuracy and State Standard alignment.
