...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/discourse-markers-advanced-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/discourse-markers-advanced.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/discourse-markers-advanced.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Дискурсивні маркери II: складна організація** (b1 track).
...
|---------|--------|---------------------|
| Вступ | 500 | 750 |
| Презентація лексики | 1000 | 1500 |
| Граматика та вживання | 1000 | 1500 |
| Аналіз та читання | 1000 | 1500 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/discourse-markers-advanced.yaml`. Go through EVERY `points:` item in EVERY section:
