...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/winter-sports-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/winter-sports.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/winter-sports.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Зимові види спорту** (b1 track).
...
|---------|--------|---------------------|
| Вступ | 500 | 750 |
| Гірськолижні курорти: Буковель та Драгобрат | 1200 | 1800 |
| Термінологія та типові помилки | 1000 | 1500 |
| Практика: Бронювання та спорядження | 900 | 1350 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/winter-sports.yaml`. Go through EVERY `points:` item in EVERY section:
