...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/running-in-ukraine-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/running-in-ukraine.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/running-in-ukraine.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Біг в Україні** (b1 track).
...
|---------|--------|---------------------|
| Вступ: Розквіт бігової культури | 600 | 900 |
| Головні події та соціальна місія | 1000 | 1500 |
| Організація та підготовка | 800 | 1200 |
| Мовний практикум: Типові помилки | 800 | 1200 |
| Спільнота та бігова дипломатія | 600 | 900 |
| Підсумок: Ваш перший забіг | 200 | 300 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/running-in-ukraine.yaml`. Go through EVERY `points:` item in EVERY section:
