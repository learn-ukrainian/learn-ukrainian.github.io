...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/regions-center-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/regions-center.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/regions-center.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Українські регіони: Центр** (b1 track).
...
|---------|--------|---------------------|
| Вступ: Центр — Серце та Колиска України | 400 | 600 |
| Полтавщина: Колиска літературної мови | 1000 | 1500 |
| Черкащина: Козацьке серце та гетьманська слава | 1100 | 1650 |
| Київ: Від княжої столиці до європейського центру | 900 | 1350 |
| Практика: Робота над типовими помилками | 400 | 600 |
| Підсумок: Джерело української ідентичності | 200 | 300 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/regions-center.yaml`. Go through EVERY `points:` item in EVERY section:
