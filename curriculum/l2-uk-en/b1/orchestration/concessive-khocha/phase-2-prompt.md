...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/concessive-khocha-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/concessive-khocha.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/concessive-khocha.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Допустові речення: хоча, незважаючи на** (b1 track).
...
| Граматичні основи та державний стандарт | 1000 | 1500 |
| Стилістичні нюанси: попри та дарма що | 800 | 1200 |
| Практичний практикум: Робота над помилками | 800 | 1200 |
| Культурна інтеграція та дебати | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/concessive-khocha.yaml`. Go through EVERY `points:` item in EVERY section:
