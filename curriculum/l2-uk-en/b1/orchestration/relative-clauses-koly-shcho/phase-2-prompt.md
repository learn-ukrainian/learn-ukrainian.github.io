...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/relative-clauses-koly-shcho-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/relative-clauses-koly-shcho.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/relative-clauses-koly-shcho.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Підрядні означальні: коли, що** (b1 track).
...
|---------|--------|---------------------|
| Вступ та Культурний контекст | 400 | 600 |
| Часові підрядні: Коли | 900 | 1350 |
| З'ясувальні та означальні речення: Що | 1100 | 1650 |
| Порівняльний аналіз та типові помилки | 800 | 1200 |
| Практичне застосування: Діалоги | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/relative-clauses-koly-shcho.yaml`. Go through EVERY `points:` item in EVERY section:
