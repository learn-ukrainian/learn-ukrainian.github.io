...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/aspect-pairs-essential-40-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/aspect-pairs-essential-40.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/aspect-pairs-essential-40.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Видові пари: 40 найважливіших** (b1 track).
...
| Морфологія та типи творення | 800 | 1200 |
| Системний огляд 40 пар | 1000 | 1500 |
| Культурний та фразеологічний вимір | 600 | 900 |
| Корекція типових помилок | 600 | 900 |
| Підсумок та практичне застосування | 400 | 600 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/aspect-pairs-essential-40.yaml`. Go through EVERY `points:` item in EVERY section:
