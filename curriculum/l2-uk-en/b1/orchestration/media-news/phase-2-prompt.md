...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/media-news-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/media-news.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/media-news.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Медіа та новини** (b1 track).
...
|---------|--------|---------------------|
| Вступ | 600 | 900 |
| Презентація: Джерела та формати | 1000 | 1500 |
| Лексика та культура мовлення | 1100 | 1650 |
| Практика: Аналіз та дискусія | 800 | 1200 |
| Підсумок | 500 | 750 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/media-news.yaml`. Go through EVERY `points:` item in EVERY section:
