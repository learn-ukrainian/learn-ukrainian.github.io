...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/presentations-visuals-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/presentations-visuals.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/presentations-visuals.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Презентації та візуалізація** (b1 track).
...
|---------|--------|---------------------|
| Вступ | 600 | 900 |
| Структура виступу та етикет | 800 | 1200 |
| Опис візуальних даних | 900 | 1350 |
| Мовні засоби презентатора | 700 | 1050 |
| Узагальнення та робота з джерелами | 600 | 900 |
| Практика: Міні-презентація | 400 | 600 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/presentations-visuals.yaml`. Go through EVERY `points:` item in EVERY section:
