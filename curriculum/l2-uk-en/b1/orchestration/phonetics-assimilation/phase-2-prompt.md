...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/phonetics-assimilation-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/phonetics-assimilation.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/phonetics-assimilation.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Фонетика: асиміляція та спрощення** (b1 track).
...
|---------|--------|---------------------|
| Вступ: Принцип милозвучності | 500 | 750 |
| Асиміляція за дзвінкістю та глухістю | 800 | 1200 |
| Асиміляція за м'якістю та вимова -ться | 700 | 1050 |
| Спрощення в групах приголосних | 700 | 1050 |
| Чергування голосних та приголосних | 800 | 1200 |
| Практика та запобігання помилкам | 500 | 750 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/phonetics-assimilation.yaml`. Go through EVERY `points:` item in EVERY section:
