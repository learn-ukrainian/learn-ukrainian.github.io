...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/conditionals-real-yakshcho-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/conditionals-real-yakshcho.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/conditionals-real-yakshcho.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Умовні речення: реальна умова (якщо)** (b1 track).
...
|---------|--------|---------------------|
| Вступ: Реальні умови в мовленні | 600 | 900 |
| Граматична презентація: Якщо та майбутній час | 1000 | 1500 |
| Семантичні нюанси: Якщо проти Коли | 800 | 1200 |
| Практика: Культура, стилістика та лексика | 900 | 1350 |
| Діалоги та вироблення навичок | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/conditionals-real-yakshcho.yaml`. Go through EVERY `points:` item in EVERY section:
