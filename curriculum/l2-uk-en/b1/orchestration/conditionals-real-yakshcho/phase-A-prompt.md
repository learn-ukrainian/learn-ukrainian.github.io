...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/conditionals-real-yakshcho.yaml
```

Read the meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/conditionals-real-yakshcho.yaml
```
...
Research **Умовні речення: реальна умова (якщо)** for the **B1** core track. Core tracks need lighter research than seminar tracks — focus on accuracy and State Standard alignment.
...
# Дослідження: Умовні речення: реальна умова (якщо)
