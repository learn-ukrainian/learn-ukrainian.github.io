...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/b1-final-exam-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/b1-final-exam.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/b1-final-exam.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Фінальний іспит B1** (b1 track).
...
|---------|--------|---------------------|
| Вступ: Структура іспиту та оцінювання | 600 | 900 |
| Читання та аудіювання: Академічний контекст | 800 | 1200 |
| Граматика та лексика: Аналіз типових помилок | 1000 | 1500 |
| Продуктивні навички: Письмо та говоріння | 1000 | 1500 |
| Результати та перехід до рівня B2 | 600 | 900 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/b1-final-exam.yaml`. Go through EVERY `points:` item in EVERY section:
