...
**Note:** No meta file exists yet — this is a clean rebuild. The plan is the sole source of truth.
...
This module teaches learners to **read and understand Ukrainian grammar explanations** — the metalanguage of grammar instruction. Key areas:
- Grammar explanation patterns (використовується, показує, означає)
- Instruction words (порівняйте, зверніть увагу, наприклад)
- Comparison patterns (на відміну від, подібно до)
- Activity instruction verbs (виберіть, знайдіть, з'єднайте, доповніть)
- Analytical terms (контекст, маркер, частота, аспектуальна пара)
- Style/register terminology (розмовна мова, літературна мова, формальна мова)
- Word formation terms (корінь, префікс, суфікс, основа, закінчення)
...
- Register distinctions (formal vs. informal usage) — relevant for style/register terminology in this module
