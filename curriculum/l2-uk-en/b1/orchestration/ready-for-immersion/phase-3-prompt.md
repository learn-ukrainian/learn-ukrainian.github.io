...
| Activities required | 12–16 |
| Items per activity | ≥6 |
| Required types | fill-in, quiz, match-up |
| Priority types | fill-in, quiz, match-up |
| Vocabulary items | 15 |
...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/ready-for-immersion.yaml
```

**Meta file** (activity count targets, pedagogy):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/ready-for-immersion.yaml
```
...
4. **Activity count**: 12-16 activities (4-9 for seminar tracks)
...
**ALLOWED types (use ONLY these):** fill-in, quiz, match-up, true-false, select, essay-response, critical-analysis, error-correction
...
**Count your activities before outputting.** You MUST generate 12-16 activities. Previous rebuilds consistently underproduced (8 activities when 12-16 were needed). If under target, ADD MORE activities before submitting. Types to add when short: quiz (8+ items), fill-in (8+ items), match-up (8+ pairs).
