...
> **Persona reminder:** You are Patient & Supportive Ukrainian Tutor. Write in the voice of Senior Language & Culture Specialist. Maintain this persona throughout — do not drift into generic AI tone.
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/ready-for-immersion-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/ready-for-immersion.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/ready-for-immersion.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Готові до занурення** (b1 track).

- **Total minimum**: 4000 words
- **Write at least**: 6000 words (1.5x — aim for depth, not padding)
- **Immersion**: Bridge modules: teach grammar metalanguage. English scaffolding for abstract concepts. Parenthetical equivalents for new terms. Sentences max 30 words.
...
|---------|--------|---------------------|
| Вступ: Нові правила гри | 300 | 450 |
| Діагностика: Що ми пам'ятаємо? | 250 | 375 |
| Система мови: Частини мови | 500 | 750 |
| Дієслово: Час і Вид | 450 | 675 |
| Стилістика: Як читати правила | 450 | 675 |
| Синтаксис: Будова речення | 500 | 750 |
| Практика розуміння: Граматичний текст | 500 | 750 |
| Практикум: Метамова в дії | 400 | 600 |
| Ситуації: Урок української | 350 | 525 |
| Підсумок: Готовність до занурення | 300 | 450 |
| **Total** | **4000** | **6000** |
