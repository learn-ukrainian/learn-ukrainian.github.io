...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/ready-for-immersion.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/ready-for-immersion-research.md`
...
Word count:       4460 / 4000 (111.5%)
Activities:       6
Vocabulary items: 27
Engagement boxes: 7
Immersion:        98.4% (target: 60-100%)
...
1. Вступ: Нові правила гри
2. Діагностика: Що ми пам'ятаємо?
3. Система мови: Частини мови
4. Дієслово: Час і Вид
5. Стилістика: Як читати правила
6. Синтаксис: Будова речення
7. Практика розуміння: Граматичний текст
8. Практикум: Метамова в дії
9. Ситуації: Урок української
10. Підсумок: Готовність до занурення
