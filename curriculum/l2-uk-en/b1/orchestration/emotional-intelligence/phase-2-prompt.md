...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/emotional-intelligence-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/emotional-intelligence.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/emotional-intelligence.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Емоційний інтелект та міжособистісні навички** (b1 track).
...
|---------|--------|---------------------|
| Вступ: Що таке емоційний інтелект? | 500 | 750 |
| Емпатія та співчуття: Розуміння серцем | 800 | 1200 |
| Підтримка та турбота в міжособистісних навичках | 700 | 1050 |
| Культура вибачення та подолання конфліктів | 800 | 1200 |
| Діалоги: Підтримка та делікатні розмови | 600 | 900 |
| Саморефлексія та підсумок | 600 | 900 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/emotional-intelligence.yaml`. Go through EVERY `points:` item in EVERY section:
