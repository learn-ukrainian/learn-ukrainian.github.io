...
- FIX: Missing section heading: 'Iти / ходити: найширший спектр'
- FIX: Missing section heading: 'Летіти: швидкість'
- FIX: Missing section heading: 'Пливти: плавність і повільність'
- FIX: Missing section heading: 'Бігти, їхати, нести та інші'
- FIX: Missing section heading: 'Українські вирази vs англійські кальки'
