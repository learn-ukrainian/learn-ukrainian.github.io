...
**Section to write:** Летіти: швидкість (~550 words total)
...
тому, що дія розгортається просто зараз перед нашими очима. Це робить нашу мову набагато живішою і природнішою в щоденному, неформальному спілкуванні. Четверта сфера використання дієслова «іти» є найбільш абстрактною, але водночас критично важливою для вільного володіння українською мовою на рівні B1 і вище. Йдеться про логіку, мислення та сталі фразеологічні вирази. Найголовніша фраза, яку ви повинні запам'ятати назавжди, — це **мова йде про** *(it is about / we are talking about)*. Ми використовуємо цей вираз постійно, коли хочемо пояснити головну тему нашої розмови, статті або книги. Наприклад: «У цій статті мова йде про нові економічні реформи». Існує також ще більш елегантна, безособова форма цього виразу: **йдеться про** *(it concerns / the issue is)*. Наприклад: «У цьому складному законі йдеться про національну безпеку держави». Ніколи не використовуйте російську кальку «мова іде» — правильно казати лише «мова йде» або «йдеться». Окрім цього, є багато сталих виразів, які описують соціальну поведінку або вибір людини. Коли дві сторони конфлікту нарешті знаходять спільне рішення, ми кажемо, що вони вирішили **йти на компроміс** *(to compromise)*. Коли людина робить щось небезпечне заради можливого успіху, вона готова **йти на ризик** *(to take a risk)*. А коли ви хочете допомогти комусь і робите крок йому назустріч, ви можете **йти назустріч** *(to accommodate / to meet halfway)* проханню цієї людини. Усі ці вирази показують, що абстрактні соціальні дії сприймаються українцями як своєрідний ментальний рух у певному напрямку. Остання велика група — це дієслова руху з різними префіксами, які кардинально змінюють своє значення і стають повністю переносними. Додавання маленького префікса до слова «іти» створює абсолютно нові, часто несподівані сенси, які вимагають окремої уваги та вивчення. Наприклад, візьмемо префікс «ви-». Дієслово **вийти** *(to turn out / to result)* у переносному значенні означає остаточний результат якогось складного процесу або дії. Уявіть, що ви готували вечерю за новим і невідомим рецептом, і у вас **вийшов смачний пиріг** *(a tasty pie turned out)*. Або ви щось дуже швидко і неуважно порахували, і у вас **вийшла помилка** *(a mistake occurred)*. Інший надзвичайно важливий і корисний приклад — це дієслово **підійти** *(to suit / to fit)*. У прямому значенні це означає фізично підійти ближче до когось ногами, скоротити дистанцію між людьми в просторі. Але в магазині одягу або під час вибору речей ви використовуєте його зовсім інакше: «Цей червоний **колір мені підходить** *(this red color suits me)*». Це означає, що річ ідеально гармонує з вашим стилем, смаком або типом вашої фігури. Ще одне дуже корисне дієслово для опису інтелектуальної діяльності — це **дійти** *(to reach / to come to)*. Ми використовуємо його, коли говоримо про складні ментальні процеси, серйозні обговорення або глибокі логічні роздуми над певною проблемою. Після довгих суперечок та детального аналізу всіх наявних фактів ви можете нарешті **дійти висновку** *(to reach a conclusion)*. А якщо ви довго думали над робочою проблемою і раптом знайшли геніальне рішення, ви скажете: «Мені **прийшла ідея** *(an idea came to me)*». Ці префіксальні форми є справжнім мовним скарбом для тих, хто хоче говорити багатою, яскравою і по-справжньому українською мовою. <!-- INJECT_ACTIVITY: match-up, Match figurative motion expressions with their meanings -->
</previous_context>
