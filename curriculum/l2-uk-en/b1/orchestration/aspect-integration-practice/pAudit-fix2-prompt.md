...
────────────────────────────────────────────────────────────
  ...
  failing gates:
    lesson: 6164/4000 (raw: 6494) | pedagogy: 3 violations

  Otaman has NOT completed this module.
  Fix the issues above and re-run this script.

─── Audit output (last 15 lines) ───
       → FIX: Break into shorter sentences. First 5 words: 'Коли ви доречно вчасно використовуєте...'
    [COMPLEXITY] Sentence too long for B1: 40 words (max 30)
       → FIX: Break into shorter sentences. First 5 words: 'Вона завжди виникає через цілком...'
