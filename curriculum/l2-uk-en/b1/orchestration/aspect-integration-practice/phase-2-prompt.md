...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/aspect-integration-practice-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/aspect-integration-practice.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/aspect-integration-practice.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Інтеграція виду: практика** (b1 track).
...
|---------|--------|---------------------|
| Вступ та діагностика | 600 | 900 |
| Поглиблення: Часові сполучники | 1000 | 1500 |
| Логічний перемикач: Послідовність чи одночасність | 900 | 1350 |
| Культурний контекст та типові помилки | 800 | 1200 |
| Практичне застосування та діалоги | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/aspect-integration-practice.yaml`. Go through EVERY `points:` item in EVERY section:
