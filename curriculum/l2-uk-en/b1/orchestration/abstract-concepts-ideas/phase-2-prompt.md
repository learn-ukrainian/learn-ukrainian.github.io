...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/abstract-concepts-ideas-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/abstract-concepts-ideas.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/abstract-concepts-ideas.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Абстрактні концепції: ідеї та думки** (b1 track).
...
|---------|--------|---------------------|
| Вступ | 500 | 750 |
| Лексичний блок | 1000 | 1500 |
| Граматика та синтаксис | 800 | 1200 |
| Культурний контекст | 900 | 1350 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/abstract-concepts-ideas.yaml`. Go through EVERY `points:` item in EVERY section:
