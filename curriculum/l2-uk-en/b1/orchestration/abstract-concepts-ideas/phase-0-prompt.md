...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/abstract-concepts-ideas.yaml
```

Read the meta file:

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/abstract-concepts-ideas.yaml
```
...
Research **Абстрактні концепції: ідеї та думки** for the **B1** core track. Core tracks need lighter research than seminar tracks — focus on accuracy and State Standard alignment.
