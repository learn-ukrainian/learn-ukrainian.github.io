...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/passive-constructions-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/passive-constructions.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/passive-constructions.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Пасивні конструкції: повна система** (b1 track).
...
|---------|--------|---------------------|
| Вступ та діагностичний тест | 600 | 900 |
| Граматична система: три типи пасиву | 1000 | 1500 |
| Культурний контекст: боротьба з «канцеляритом» | 800 | 1200 |
| Практика та корекція помилок | 900 | 1350 |
| Діалоги та застосування в мовленні | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/passive-constructions.yaml`. Go through EVERY `points:` item in EVERY section:
