...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/motion-patterns-other-verbs-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/motion-patterns-other-verbs.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/motion-patterns-other-verbs.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Префікси руху в інших дієсловах** (b1 track).
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/motion-patterns-other-verbs.yaml`. Go through EVERY `points:` item in EVERY section:
