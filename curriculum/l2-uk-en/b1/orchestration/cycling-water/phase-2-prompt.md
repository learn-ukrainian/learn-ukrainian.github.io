...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/cycling-water-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/cycling-water.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/cycling-water.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Велосипед та водні види** (b1 track).
...
|---------|--------|---------------------|
| Вступ та цілі | 400 | 600 |
| Велосипедна культура та інфраструктура | 1000 | 1500 |
| Водні види спорту: від Дніпра до Карпат | 1000 | 1500 |
| Практика: тонкощі дієслів руху | 800 | 1200 |
| Продукція: планування активного відпочинку | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/cycling-water.yaml`. Go through EVERY `points:` item in EVERY section:
