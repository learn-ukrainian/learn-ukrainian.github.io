...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/adverbial-participles-imperfective-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/adverbial-participles-imperfective.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/adverbial-participles-imperfective.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Дієприслівники недоконаного виду** (b1 track).
...
|---------|--------|---------------------|
| Вступ | 600 | 900 |
| Граматичне пояснення: Творення та вживання | 1000 | 1500 |
| Синтаксичні пастки та помилки | 800 | 1200 |
| Практика та культурний контекст | 900 | 1350 |
| Підсумок та самоконтроль | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/adverbial-participles-imperfective.yaml`. Go through EVERY `points:` item in EVERY section:
