...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/checkpoint-motion-verbs-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/checkpoint-motion-verbs.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/checkpoint-motion-verbs.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Контрольна точка: Дієслова руху** (b1 track).
...
|---------|--------|---------------------|
| Вступ та діагностика | 400 | 600 |
| Культурний контекст: Метро та залізниця | 800 | 1200 |
| Аналіз та корекція типових помилок | 800 | 1200 |
| Префіксальна логіка: Простір та напрямок | 800 | 1200 |
| Переносні значення та ідіоматика | 800 | 1200 |
| Підсумок та інтеграційний наратив | 400 | 600 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/checkpoint-motion-verbs.yaml`. Go through EVERY `points:` item in EVERY section:
