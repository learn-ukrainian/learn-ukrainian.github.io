...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/reported-statements-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/reported-statements.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/reported-statements.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Непряма мова: твердження** (b1 track).
...
| Практика трансформації | 1000 | 1500 |
| Комунікація та культура | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/reported-statements.yaml`. Go through EVERY `points:` item in EVERY section:
