...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/purpose-shchob-infinitive-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/purpose-shchob-infinitive.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/purpose-shchob-infinitive.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Підрядні речення мети: щоб + інфінітив** (b1 track).
...
| Граматика: Конструкція «щоб + інфінітив» | 1000 | 1500 |
| Культурний контекст та стійкість | 800 | 1200 |
| Аналіз помилок та Практика | 1000 | 1500 |
| Підсумок та застосування | 600 | 900 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/purpose-shchob-infinitive.yaml`. Go through EVERY `points:` item in EVERY section:
