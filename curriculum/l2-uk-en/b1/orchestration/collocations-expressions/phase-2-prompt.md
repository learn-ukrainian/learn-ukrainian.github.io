...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/collocations-expressions-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/collocations-expressions.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/collocations-expressions.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Колокації та вирази** (b1 track).
...
|---------|--------|---------------------|
| Вступ та теоретична основа | 600 | 900 |
| Основні дієслівні колокації | 1000 | 1500 |
| Культура мовлення та боротьба з кальками | 900 | 1350 |
| Читання: Колокації в контексті | 800 | 1200 |
| Практика та комунікативна продукція | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/collocations-expressions.yaml`. Go through EVERY `points:` item in EVERY section:
