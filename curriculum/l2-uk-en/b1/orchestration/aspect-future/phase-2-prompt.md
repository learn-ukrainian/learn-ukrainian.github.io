...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/aspect-future-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/aspect-future.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/aspect-future.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Вид у майбутньому часі** (b1 track).
...
| Граматичне пояснення | 1200 | 1800 |
| Культурний та етнолінгвістичний контекст | 800 | 1200 |
| Практика та корекція помилок | 800 | 1200 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/aspect-future.yaml`. Go through EVERY `points:` item in EVERY section:
