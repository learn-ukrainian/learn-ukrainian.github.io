...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/interviu-ta-podkasty-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/interviu-ta-podkasty.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/interviu-ta-podkasty.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Інтерв'ю та подкасти** (b1 track).
...
|---------|--------|---------------------|
| Вступ: Феномен українського аудіопростору | 600 | 900 |
| Стратегії активного слухання | 1200 | 1800 |
| Практичний аналіз інтерв'ю | 1200 | 1800 |
| Продукція: Створення власного резюме | 600 | 900 |
| Підсумок: Слухай щодня | 400 | 600 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/interviu-ta-podkasty.yaml`. Go through EVERY `points:` item in EVERY section:
