...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/motion-approaching-departing-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/motion-approaching-departing.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/motion-approaching-departing.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Рух: наближення і віддалення** (b1 track).
...
|---------|--------|---------------------|
| Діагностика: Вступний тест | 600 | 900 |
| Граматика: Простір та межі | 1000 | 1500 |
| Культурний контекст: Проводи та традиції | 800 | 1200 |
| Переносне значення та фразеологія | 1000 | 1500 |
| Практика: Роль начальника станції | 600 | 900 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/motion-approaching-departing.yaml`. Go through EVERY `points:` item in EVERY section:
