...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/environment-ecology-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/environment-ecology.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/environment-ecology.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Довкілля та екологія** (b1 track).
...
|---------|--------|---------------------|
| Вступ | 600 | 900 |
| Словник та поняття | 1000 | 1500 |
| Природа України: Карпати | 1000 | 1500 |
| Причина і наслідок | 800 | 1200 |
| Практика та підсумок | 600 | 900 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/environment-ecology.yaml`. Go through EVERY `points:` item in EVERY section:
