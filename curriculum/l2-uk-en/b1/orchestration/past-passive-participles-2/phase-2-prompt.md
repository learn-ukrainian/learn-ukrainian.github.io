...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/past-passive-participles-2-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/past-passive-participles-2.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/past-passive-participles-2.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Пасивні дієприкметники: коротка форма** (b1 track).
...
|---------|--------|---------------------|
| Вступ: Оголошення навколо нас | 600 | 900 |
| Граматичний аналіз: Утворення та синтаксис | 1000 | 1500 |
| Культурний та історичний контекст | 800 | 1200 |
| Практика: Від теорії до автоматизму | 900 | 1350 |
| Комунікативні вправи та підсумок | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/past-passive-participles-2.yaml`. Go through EVERY `points:` item in EVERY section:
