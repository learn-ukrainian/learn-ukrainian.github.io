...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/conditionals-unreal-yakby-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/conditionals-unreal-yakby.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/conditionals-unreal-yakby.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Умовні речення: нереальна умова (якби)** (b1 track).
...
|---------|--------|---------------------|
| Вступ | 600 | 900 |
| Граматика та правила | 1200 | 1800 |
| Культурний контекст | 800 | 1200 |
| Практика та типові помилки | 900 | 1350 |
| Діалоги та застосування | 500 | 750 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/conditionals-unreal-yakby.yaml`. Go through EVERY `points:` item in EVERY section:
