...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/indefinite-negative-pronouns-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/indefinite-negative-pronouns.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/indefinite-negative-pronouns.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Невизначені та заперечні займенники** (b1 track).
...
|---------|--------|---------------------|
| Вступ: Логіка невизначеності | 600 | 900 |
| Реальна невизначеність: Займенники з часткою -сь | 850 | 1275 |
| Гіпотетична та парціальна невизначеність: -небудь та де- | 850 | 1275 |
| Абсолютне заперечення: Займенники з ні- | 900 | 1350 |
| Практикум: Контрасти та розв'язання помилок | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/indefinite-negative-pronouns.yaml`. Go through EVERY `points:` item in EVERY section:
