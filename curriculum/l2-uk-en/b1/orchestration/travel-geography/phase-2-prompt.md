...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/travel-geography-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/travel-geography.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/travel-geography.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Подорожі та географія** (b1 track).
...
|---------|--------|---------------------|
| Вступ (Introduction) | 600 | 900 |
| Лексичні нюанси: Поняття «подорож» (Lexical Nuances: The Concept of 'Travel') | 800 | 1200 |
| Географія та природні дива (Geography & Natural Wonders) | 1000 | 1500 |
| Граматичний практикум: Прийменники та локації (Grammar Workshop: Prepositions & Locations) | 800 | 1200 |
| Подорожні плани та враження (Travel Plans & Impressions) | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/travel-geography.yaml`. Go through EVERY `points:` item in EVERY section:
