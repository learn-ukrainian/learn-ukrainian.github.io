...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/numerals-collectives-fractions-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/numerals-collectives-fractions.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/numerals-collectives-fractions.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Числівники: збірні та дроби** (b1 track).
...
| Збірні числівники та «Пастки» | 1200 | 1800 |
| Дроби, відсотки та особливі форми | 1000 | 1500 |
| Культурний контекст: Магія чисел | 800 | 1200 |
| Мовленнєва практика та підсумок | 500 | 750 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/numerals-collectives-fractions.yaml`. Go through EVERY `points:` item in EVERY section:
