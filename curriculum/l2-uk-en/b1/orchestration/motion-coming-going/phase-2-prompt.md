...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/motion-coming-going-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/motion-coming-going.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/motion-coming-going.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Рух: Прибуття та вихід** (b1 track).
...
|---------|--------|---------------------|
| Вступ | 500 | 750 |
| Тест та діагностика | 600 | 900 |
| Граматична концепція: Префікси при-, ви-, в- | 1400 | 2100 |
| Практика та усунення помилок | 800 | 1200 |
| Культурний код та ідіоматика | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/motion-coming-going.yaml`. Go through EVERY `points:` item in EVERY section:
