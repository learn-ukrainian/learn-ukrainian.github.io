...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/active-participles-phrases-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/active-participles-phrases.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/active-participles-phrases.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Активні дієприкметники та їхній стиль** (b1 track).
...
|---------|--------|---------------------|
| Вступ: Природа дієприкметника | 500 | 750 |
| Морфологія та мовна норма | 900 | 1350 |
| Боротьба з канцеляритом | 1100 | 1650 |
| Синтаксис та трансформації | 1000 | 1500 |
| Практика та стилістичний підсумок | 500 | 750 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/active-participles-phrases.yaml`. Go through EVERY `points:` item in EVERY section:
