...
**Section to write:** Медична лексика та морфонеміка (~600 words total)
...
## Медична лексика та морфонеміка (~600 words total)
- P1 (~120 words): [Integrating medical vocabulary with morphophonemic rules. Analyzing word families: біль (noun with i/o alternation) → болить (verb with i/o alternation) → безболісний. Discussion of лікар as a suffixal noun (-ар) and its plural forms. Analyzing 'здоров'я' (apostrophe) and its relationship to 'здоровий'.]
- P2 (~130 words): [Review of medical case government (керування). Detailed explanation of: скаржитися на + Accusative (скаржитися на біль, на нежить), лікуватися від + Genitive (лікуватися від застуди), одужати від + Genitive. Comparison with English "suffer from" vs Ukrainian "скаржитися на".]
- P3 (~150 words): [Review of body part names that exhibit alternations. Explaining ніс → носа (vowel shift), вухо → у вусі (x→s), око → в оці (k→ts). Reviewing III declension medical terms: мазь → маззю (Instrumental doubling), кров → кров'ю (labial, no doubling).]
- Reading Comprehension Exercise: [Based on a text about a visit to the clinic. 6 items testing grammatical identification: "Якого роду слово нежить?", "Визначте відмінок слова ліків", "Яке чергування відбулося в дієслові сиджу?".] (~200 words including text and questions)
...
відміни стосується утворення орудного відмінка. Якщо основа такого слова закінчується на один приголосний звук, відбувається обов'язкове **подвоєння** *(doubling)* цього звука. Наприклад, коротке слово «**ніч**» *(night)* перетворюється на довшу форму «ніччю». Слово «**сіль**» *(salt)* змінюється на «сіллю», а слово «**подорож**» *(journey)* — на «подорожжю». Проте, тут існує суворе обмеження: якщо основа слова закінчується на збіг двох приголосних, подвоєння ніколи не відбувається. Тому слово «**радість**» *(joy)* утворює форму «радістю» (без подвійного [т]). Також подвоєння відсутнє після губних приголосних звуків (б, п, в, м, ф) та після звука [р], де ми просто ставимо апостроф. Отже, ми завжди кажемо «**кров**» *(blood)* — «кров'ю», а слово «мати» змінюється на «матір'ю». У родовому відмінку однини ці слова зазвичай мають закінчення «-і», але для деяких іменників паралельно дозволяється варіант «-и» («радості» або «радости», слово «**любов**» *(love)* може мати форму «любові» або «любови»). Окрему та цікаву категорію становлять іменники «pluralia tantum». Це слова, які існують виключно у формі множини і взагалі ніколи не мають форми однини. До цієї групи належать такі повсякденні слова, як «**двері**» *(doors)*, «**гроші**» *(money)*, «**ножиці**» *(scissors)*, «**ліки**» *(medicine)*. Сюди також входять географічні назви, наприклад, гори «**Карпати**» *(Carpathians)*. Оскільки ці слова фізично не мають початкової форми однини, вони не належать до жодної з чотирьох стандартних відмін. Найбільше труднощів викликає родовий відмінок цих специфічних іменників, оскільки тут існують три різні моделі закінчень. Деякі слова отримують нульове закінчення (наприклад, слово «**ворота**» *(gates)* змінюється на «воріт», а слово «**канікули**» *(holidays)* — на «канікул»). Інша група отримує закінчення «-ів» (слово «**окуляри**» *(glasses)* стає «окулярів»). Третя група має специфічне закінчення «-ей» (ми кажемо «грошей» або «дверей»). Вашу увагу варто звернути на орудний відмінок. Тут існує унікальне українське закінчення «-ми», яке активно використовується у словах «грішми» (синонім до «грошима») та «ворітьми» (синонім до «воротами»). Прикметники та дієслова з такими іменниками завжди узгоджуються лише у формі множини: «великі двері» або «ліки закінчилися». Правильне і впевнене використання цих граматичних форм вимагає певного аналітичного підходу. Перш ніж механічно змінити слово за відмінком, ви повинні чітко визначити його граматичну ідентичність. Ви маєте запитати себе: чи належить це конкретне слово до третьої відміни? Чи це іменник мішаної групи? Або це специфічний іменник, що існує лише у множині? Тільки після такої перевірки ви можете сміливо застосовувати відповідні правила. Наприклад, візьмемо просте слово «ніч». Спочатку ми визначаємо, що це третя відміна. Тому в орудному відмінку воно отримує закономірну форму «ніччю» з подвоєнням. Але у знахідному відмінку, згідно з правилами третьої відміни, воно завжди залишається без змін — просто «ніч». Розуміння цих базових категорій робить процес відмінювання дуже логічним. Нарешті, коротко згадаємо про використання всіх цих підкласів іменників із різними українськими прийменниками. Глибоке знання правильного відмінка після певного прийменника є критичним для побудови природних речень. Наприклад, ми часто кажемо «за дверима», обов'язково використовуючи орудний відмінок від слова «двері». Ми кажемо «після канікул», правильно вживаючи родовий відмінок із нульовим закінченням. Ми робимо щось «з радістю», використовуючи форму орудного відмінка без подвоєння. Або ми можемо сказати, що якась річ лежить «під ножем», правильно використовуючи специфічне закінчення нашої мішаної групи. Всі ці поширені синтаксичні конструкції варто просто запам'ятати як готові мовні блоки.
</previous_context>
