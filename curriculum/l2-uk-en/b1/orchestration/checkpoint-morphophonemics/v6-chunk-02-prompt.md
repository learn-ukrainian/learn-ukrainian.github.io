...
**Section to write:** Огляд підкласів іменників (~720 words total)
...
## Огляд підкласів іменників (~720 words total)
- P1 (~60 words): [Introduction to the specific noun subclasses reviewed in this phase: Мішана група, III відміна, and Pluralia tantum. Explaining that these categories require special attention because their endings differ from the "standard" patterns taught at A1/A2.]
- P2 (~150 words): [Detailed review of the Mixed Group (мішана група). Defining the criteria: stems ending in "hissing" consonants (ж, ч, ш, щ). Focus on the key differentiator: the Instrumental singular ending -ем (сторожем, ножем, товаришем). Contrast with regular Hard group -ом (братом) and Soft group -ем/-єм (вчителем).]
- P3 (~170 words): [Deep dive into the III Declension (жіночий рід + zero ending). Reviewing the critical morphophonemic rule in the Instrumental case: doubling (подвоєння) for single final consonants (ніччю, сіллю, подорожжю) vs. no doubling for clusters or labial/r consonants (радістю, кров'ю, матір'ю, матір'ю).]
- P4 (~150 words): [Review of Pluralia tantum nouns (іменники, що мають лише множину). Explaining the lack of declension group classification and the three patterns for the Genitive case: zero ending (воріт, канікул), -ів (окулярів), and -ей (грошей, дверей). Special mention of the Ukrainian-specific Instrumental -ми (грішми, ворітьми).]
- P5 (~100 words): [Synthesizing the interaction between these subclasses and cases. Explaining how a learner must first identify the "identity" of a noun (Is it III declension? Is it Mixed? Is it Pluralia tantum?) before applying the case rules. Contrast between 'ніч' (III declension) and 'ніччю' vs 'ніч' (Accusative) which remains 'ніч'.]
- P6 (~90 words): [Discussion on case government review for these groups. Common prepositional combinations: за дверима (Instrumental), після канікул (Genitive), з радістю (Instrumental), під ножем (Instrumental).]
