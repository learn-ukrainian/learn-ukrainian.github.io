...
**Section to write:** Комплексні вправи: чергування (~600 words total)
...
## Комплексні вправи: чергування (~600 words total)
- P1 (~50 words): [Instructional bridge to the exercise block. Explaining how to approach identification vs. production tasks in morphophonemics.]
- Exercise: [Quiz from activity_hints, Focus: Identifying vowel/consonant/simplification types in pairs (рік-року, рука-руці, тиждень-тижня). 10 items with detailed feedback on the logic of each change.] (~200 words)
- P2 (~100 words): [Transition to consonant production. Mnemonic tips for [г]→[з'], [к]→[ц'], [х]→[с'] (the "Hand-Foot-Ear" rule: рука-нога-вухо).]
- Exercise: [Match-up from activity_hints, Focus: Matching base forms (nominative/infinitive) to correct alternated forms (locative/1st person). Examples: нога → на нозі, хотіти → хочу, козак → козаче. 10 items.] (~250 words)
...
це ідеальне практичне середовище для повторення всіх морфонемічних правил, які ми детально вивчили. Розгляньмо типові **родинні слова** *(word families)*. Наприклад, іменник «**біль**» *(pain)* має чоловічий рід і закритий склад. Коли ми утворюємо дієслово «**болить**» *(hurts)* або прикметник «**безболісний**» *(painless)*, склад відкривається, і звук [і] закономірно переходить в [о]. Інший яскравий приклад — це слово «**лікар**» *(doctor)*, яке належить до другої відміни. Його множина утворюється стандартно: «лікарі», а спорідненими словами є «**лікувати**» *(to treat)*, іменник «**лікування**» *(treatment)* та навіть специфічне слово «**ліки**» *(medicine)*. Також варто звернути увагу на слово «**здоров'я**» *(health)*. Тут ми обов'язково пишемо апостроф після губного звука [в] перед ятіфакованим [я]. Проте у спорідненому прикметнику «**здоровий**» *(healthy)* або в іменнику «**оздоровлення**» *(healing)* апостроф зникає, оскільки там більше немає звука [й]. Правильне граматичне **керування** *(case government)* — це абсолютна основа природного спілкування у лікарні чи аптеці. В англійській мові ви часто використовуєте універсальну конструкцію «suffer from», але українською ми висловлюємо цю думку інакше. Якщо ви маєте певний симптом, ви повинні використовувати дієслово «**скаржитися на**» *(to complain about)* плюс знахідний відмінок. Наприклад, пацієнт скаржиться на головний біль, на **нежить** *(runny nose)* або на загальну слабкість. Якщо ви просто називаєте свою хворобу, ви можете сказати «**хворіти на**» *(to be ill with)* плюс знахідний відмінок (хворіти на грип). Але якщо ви проходите тривалу терапію, ви використовуєте дієслово «**лікуватися від**» *(to be treated for)* плюс родовий відмінок: лікуватися від застуди, лікуватися від інфекції. Коли лікування нарешті завершується успішно, ви можете «**одужати від**» *(to recover from)* хвороби, також вимагаючи родового відмінка. Назви багатьох частин тіла також яскраво демонструють цікаві граматичні чергування. Базове слово «**ніс**» *(nose)* має закритий склад, тому в родовому відмінку воно закономірно змінюється на «носа» (відбувається чергування [і] з [о]). Якщо медична проблема стосується вух або очей, ми часто використовуємо місцевий відмінок. Тут слово «**вухо**» *(ear)* змінюється на «у вусі» (чергування [х] з [с]), а слово «**око**» *(eye)* перетворюється на «в оці» (чергування [к] з [ц]). Крім того, багато важливих медичних термінів належать до третьої відміни. Наприклад, слово «**мазь**» *(ointment)* в орудному відмінку отримує очікуване подвоєння: ми мажемо «маззю». Але слово «**кров**» *(blood)* закінчується на губний приголосний звук, тому подвоєння там ніколи не відбувається: ми пишемо «кров'ю» з апострофом. Нарешті, завжди пам'ятайте про специфічні іменники «pluralia tantum». Такі слова, як «ліки» або «**краплі**» *(drops)*, фізично не мають однини. Вони завжди вимагають від дієслів і прикметників виключно форми множини. Прочитайте цей короткий текст про візит до поліклініки. Зосередьте свою увагу не на сюжеті, а на граматичних формах різних слів. > Учора мій товариш пішов до лікарні. > Він скаржився на сильний біль у вусі та нежить. > Спочатку він довго чекав біля великих дверей кабінету. > Лікар уважно оглянув його і сказав: «Я бачу запалення в оці». > Пацієнт зараз активно лікується від інфекції. > Лікар виписав рецепт і порадив користуватися маззю та краплями. > Він також сказав пити багато теплої води з сіллю. > Товариш швидко купив ліки в аптеці та заплатив грошима. > Він дуже сподівається швидко одужати від цієї хвороби. <!-- INJECT_ACTIVITY: reading-comprehension, Medical text grammar check (відмінок identification, чергування) -->
</previous_context>
