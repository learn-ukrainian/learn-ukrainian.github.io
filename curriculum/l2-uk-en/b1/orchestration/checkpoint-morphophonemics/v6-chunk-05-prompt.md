...
**Section to write:** Комплексні вправи: відмінювання (~660 words total)
...
## Комплексні вправи: відмінювання (~660 words total)
- P1 (~60 words): [Recap of the declension traps for Mixed Group and III declension. Reminding the learner about the 'labial/r/cluster' rule for no doubling in the Instrumental.]
- Exercise: [Group-sort from activity_hints, Focus: Sorting 12 nouns into categories: Мішана група (сторож, меч), III відміна (тінь, паморозь), Pluralia tantum (граблі, вершки), and Regular (стіл, книга). Learner must justify one choice from each category.] (~250 words)
- P2 (~90 words): [Final tips on Pluralia tantum genitive endings. Why it is 'грошей' but 'воріт'. Practical usage in phrases like 'багато грошей' vs 'біля воріт'.]
- Exercise: [Fill-in from activity_hints, Focus: Declining nouns in complex sentences. "Я захоплююся вашою (радість)", "У (лікар) немає моїх (ліки)", "Ми зустрілися з (товариш) біля (двері)". 10 items.] (~260 words)
...
воно закономірно змінюється на «носа» (відбувається чергування [і] з [о]). Якщо медична проблема стосується вух або очей, ми часто використовуємо місцевий відмінок. Тут слово «**вухо**» *(ear)* змінюється на «у вусі» (чергування [х] з [с]), а слово «**око**» *(eye)* перетворюється на «в оці» (чергування [к] з [ц]). Крім того, багато важливих медичних термінів належать до третьої відміни. Наприклад, слово «**мазь**» *(ointment)* в орудному відмінку отримує очікуване подвоєння: ми мажемо «маззю». Але слово «**кров**» *(blood)* закінчується на губний приголосний звук, тому подвоєння там ніколи не відбувається: ми пишемо «кров'ю» з апострофом. Нарешті, завжди пам'ятайте про специфічні іменники «pluralia tantum». Такі слова, як «ліки» або «**краплі**» *(drops)*, фізично не мають однини. Вони завжди вимагають від дієслів і прикметників виключно форми множини. Прочитайте цей короткий текст про візит до поліклініки. Зосередьте свою увагу не на сюжеті, а на граматичних формах різних слів. > Учора мій товариш пішов до лікарні. > Він скаржився на сильний біль у вусі та нежить. > Спочатку він довго чекав біля великих дверей кабінету. > Лікар уважно оглянув його і сказав: «Я бачу запалення в оці». > Пацієнт зараз активно лікується від інфекції. > Лікар виписав рецепт і порадив користуватися маззю та краплями. > Він також сказав пити багато теплої води з сіллю. > Товариш швидко купив ліки в аптеці та заплатив грошима. > Він дуже сподівається швидко одужати від цієї хвороби. <!-- INJECT_ACTIVITY: reading-comprehension, Medical text grammar check (відмінок identification, чергування) --> ## Комплексні вправи: чергування Тепер настав час перевірити ваші знання на практиці. Перший крок до вільного володіння українською мовою — це вміння правильно ідентифікувати фонетичні явища у тексті. Коли ви розумієте, чому саме слово змінюється в певній ситуації, ви перестаєте просто механічно запам'ятовувати граматичні форми. У наступній вправі ми зосередимося на розпізнаванні трьох різних типів граматичних явищ. Вам потрібно буде проаналізувати пари слів і визначити, чи це зміна голосних звуків, чи **чергування** *(alternation)* приголосних, чи це явище **спрощення** *(simplification)* у групі приголосних. Будьте дуже уважні, адже деякі пари можуть бути оманливими і не мати жодних змін. <!-- INJECT_ACTIVITY: quiz, Identifying vowel/consonant/simplification types in pairs (рік-року, рука-руці, тиждень-тижня) --> Розпізнавати морфонемічні зміни дуже корисно, але наша головна комунікативна мета — це вміти самостійно та швидко утворювати правильні форми під час розмови. Для цього потрібно довести застосування цих правил до повного автоматизму. Особливу увагу варто звернути на чергування приголосних звуків [г]→[з'], [к]→[ц'], [х]→[с'], яке постійно відбувається у місцевому та давальному відмінках іменників. Найкращий спосіб назавжди запам'ятати це правило — використовувати класичну мнемонічну техніку «Рука-нога-вухо» *(Hand-foot-ear)*. Просто уявіть ці три частини тіла і утворіть форми місцевого відмінка: на **руці** *(on the hand)*, на **нозі** *(on the foot)*, у **вусі** *(in the ear)*. Ця проста трійка базових слів ідеально ілюструє всі три ключові чергування. Також завжди пам'ятайте про паралельні фонетичні зміни в дієсловах першої особи однини. Там звук [т] часто переходить у [ч] (хотіти — хочу), а звук [д] закономірно перетворюється на [дж] (сидіти — сиджу). Наступне завдання перевірить вашу здатність впевнено генерувати ці форми без підказок. <!-- INJECT_ACTIVITY: match-up, Matching base forms to alternated forms (нога-на нозі, хотіти-хочу, козак-козаче) -->
</previous_context>
