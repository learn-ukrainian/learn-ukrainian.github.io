...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/emotions-deep-dive-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/emotions-deep-dive.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/emotions-deep-dive.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Емоції: глибоке занурення** (b1 track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Лексико-граматичні нюанси | 1000 | 1500 |
| Тексти та культурний контекст | 1200 | 1800 |
| Комунікативна практика | 1000 | 1500 |
| Рефлексія та висновки | 400 | 600 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/emotions-deep-dive.yaml`. Go through EVERY `points:` item in EVERY section:
