...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/business-basics-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/business-basics.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/business-basics.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Основи бізнесу** (b1 track).
...
|---------|--------|---------------------|
| Вступ та історія | 800 | 1200 |
| Структури та формати бізнесу | 800 | 1200 |
| Професійна комунікація та етика | 800 | 1200 |
| Офіційне працевлаштування та послуги | 800 | 1200 |
| Інвестиції, прибуток та підсумок | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/business-basics.yaml`. Go through EVERY `points:` item in EVERY section:
