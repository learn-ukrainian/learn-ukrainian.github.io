...
Звук [і] тут працює як чіткий, гучний сигнал: це форма чоловічого роду минулого часу. Як і в кожній складній мовній системі, тут існують певні винятки, про які необхідно пам'ятати. Найважливіше правило стосується слів іншомовного походження. **Запозичені слова** *(borrowed words)*, які прийшли в українську мову з інших європейських мов, зазвичай не підкоряються правилу чергування голосних. Вони зберігають свою оригінальну фонетичну форму, щоб їх було легко впізнати. Наприклад, ми завжди кажемо «мотор — мотору», а не «мотір». Слово «автомобіль» зберігає свій звук [о] у всіх відмінках. Так само слова «коридор» та «бетон» ніколи не змінюють свої голосні, навіть якщо їхній склад закривається в називному відмінку. Якщо слово звучить сучасно, є технічним терміном або має виразний інтернаціональний характер, звук [о] залишається стабільним і незмінним. Крім того, існує кілька питомо українських слів-винятків, де звук [о] зберігається через особливу історичну довжину голосного в давнину. Найвідоміший приклад — це слово «слон». Ми завжди кажемо «слон», і цей [о] залишається з нами і в закритому, і у відкритому складі («слона»). А тепер давайте подивимося, як усі ці слова працюють разом у природному контексті. Прочитайте цей невеликий текст і зверніть увагу на те, як слова змінюють свою форму залежно від контексту та граматики. «Це наш старий, традиційний український двір. Посеред кімнати стоїть великий дубовий стіл. Біля стіни красується велика біла піч. Мій дідусь переступає через високий дерев'яний поріг і заходить до хати. На вулиці стоїть красивий чорний кінь. Цей кінь дуже сильний і розумний. Наші сусіди теж мають тварин, у них є прекрасні гніді коні. У хаті дуже тепло. Бабуся дістає свіжий, рум'яний хліб просто з гарячої печі. Вона кладе цей запашний хліб посеред великого стола. Наш двір завжди сповнений гостей, і ми завжди раді вітати їх біля нашого порога. Кожного вечора ми збираємося разом і слухаємо цікаві історії». У цьому простому тексті ви можете побачити живий механізм чергування. Кінь стоїть (закритий), але там бігають коні (відкритий). Хліб дістали з печі (відкритий), хоча в кімнаті стоїть піч (закритий). Стіл (закритий) стає формою стола (відкритий). Тепер час перевірити, як добре ви відчуваєте ритм відкритого та закритого складу. У наступній вправі вам потрібно буде з'єднати початкову форму слова з його зміненою формою. Уважно дивіться на те, де склад закінчується на приголосний звук, а де він відкривається завдяки новому голосному закінченню. Знайдіть правильну пару для кожного слова. <!-- INJECT_ACTIVITY: match-up, Match Nominative forms (кінь, стіл, рік, ніч, сіль, віз, двір, річ) with Genitive counterparts (коня, стола, року, ночі, солі, воза, двору, речі) --> Наступне завдання вимагає від вас справжньої фонетичної інтуїції. Уважно прочитайте кожну пару слів і визначте, який саме голосний звук пропущений у корені. Пам'ятайте головне правило: якщо склад повністю закритий приголосним звуком, сміливо пишіть вузький звук [і]. Але якщо склад є відкритим, вам потрібно відновити оригінальний звук [о] або звук [е], залежно від слова. Це завдання допоможе вам запам'ятати найважливіші пари. <!-- INJECT_ACTIVITY: fill-in, Provide missing vowel based on syllable structure for 8 words: П_д_л -> Подолу, В_ч_р -> Вечора, К_р_нь -> Кореня, Пор_г -> Порога, Н_ч -> Ночі, Р_ч -> Речі, П_ч -> Печі, Ос_нь -> Осені -->
</previous_context>
