...
> **Your #1 job: Write 1111 words for the section "Граматика".**
...
Write the section prose for **Граматика** within the module **Вид дієслова: повна система**.

- **Section minimum**: 741 words
- **Write at least**: 1111 words (1.2x — quality over quantity)
...
Section 'Розминка' covered: Процес чи результат: Дві сторони однієї дії,Погляд режисера: Відеокамера проти фотоапарата,Інтуїція та контекст: Торт існує чи ні?,Філософія часу: Переживати чи здійснити,
...
## How to Hit 1111 Words (Expansion Method)
...
```
===WORD_COUNTS===
Section "Граматика": {count} words (minimum: 741)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Граматика)
