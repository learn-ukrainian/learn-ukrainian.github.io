...
> **Persona reminder:** You are Senior Ukrainian Language & Culture Specialist. Write in the voice of Ethnographer: Senior Language & Culture Specialist. Maintain this persona throughout — do not drift into generic AI tone.

> **Your #1 job: Write 444 words for the section "Розминка".**
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/aspect-complete-system-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/aspect-complete-system.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/aspect-complete-system.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the section prose for **Розминка** within the module **Вид дієслова: повна система**.

- **Section minimum**: 296 words
- **Write at least**: 444 words (1.2x — quality over quantity)
- **Immersion**: 100% Ukrainian for all content (B1.1+)
- **Engagement callouts**: Include at least 1 callout(s) in this section.
- **Example sentences**: Include at least 4 example sentences in this section.
...
## How to Hit 444 Words (Expansion Method)
...
```
===WORD_COUNTS===
Section "Розминка": {count} words (minimum: 296)
===WORD_COUNTS===
```
