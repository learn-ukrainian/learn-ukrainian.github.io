...
> **Your #1 job: Write 3112 words for the section "Практика".**
...
Write the section prose for **Практика** within the module **Вид дієслова: повна система**.

- **Section minimum**: 2075 words
- **Write at least**: 3112 words (1.2x — quality over quantity)
- **Immersion**: 100% Ukrainian for all content (B1.1+)
- **Engagement callouts**: Include at least 3 callout(s) in this section.
- **Example sentences**: Include at least 10 example sentences in this section.
...
Previous sections covered: Недоконаний вид: Фокус на процесі,Доконаний вид: Фокус на результаті,Смислові нюанси: Спроба чи успіх?,Початок дії: Динаміка зміни стану,Культурний вимір: Статика і динаміка,
...
Previously used callout types in this module: context,culture,myth-buster,tip,warning,
...
## How to Hit 3112 Words (Expansion Method)
...
```
===WORD_COUNTS===
Section "Практика": {count} words (minimum: 2075)
===WORD_COUNTS===
```
