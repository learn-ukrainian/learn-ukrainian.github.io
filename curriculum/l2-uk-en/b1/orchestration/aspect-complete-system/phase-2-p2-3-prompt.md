...
> **Your #1 job: Write 1332 words for the section "Діалоги".**
...
Write the section prose for **Діалоги** within the module **Вид дієслова: повна система**.

- **Section minimum**: 888 words
- **Write at least**: 1332 words (1.2x — quality over quantity)
...
Previous section covered: Алгоритм вибору виду: 4 ключові питання,Ситуативний аналіз: порівняння контекстів,Маркери часу: слова-підказки,Типові помилки: Теперішній час,Типові помилки: Майбутній час та видові пари,
...
Previously used callout types in this module: context,culture,fact,myth-buster,observe,tip,warning,
...
## How to Hit 1332 Words (Expansion Method)
...
```
===WORD_COUNTS===
Section "Діалоги": {count} words (minimum: 888)
===WORD_COUNTS===
```
