...
| Required types | quiz, match-up, fill-in, true-false |
| Priority types | quiz, match-up, fill-in, true-false |
| Vocabulary items | 20+ |
...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/aspect-complete-system.md
```
...
4. **Activity count**: 4-6 activities (4-9 for seminar tracks)
...
**ALLOWED types (use ONLY these):** quiz, match-up, fill-in, error-correction, mark-the-words, essay-response, critical-analysis
...
**Count your activities before outputting.** You MUST generate 4-6 activities. Previous rebuilds consistently underproduced (8 activities when 12-16 were needed). If under target, ADD MORE activities before submitting. Types to add when short: quiz (8+ items), fill-in (8+ items), match-up (8+ pairs).
