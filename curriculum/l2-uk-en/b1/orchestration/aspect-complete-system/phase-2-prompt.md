...
Write the full lesson prose for **Вид дієслова: повна система** (b1 track).
...
|---------|--------|---------------------|
| Розминка та Контекст | 600 | 900 |
| Граматична Система: Форми та Функції | 1000 | 1500 |
| Глибинна Семантика: Процес та Результат | 800 | 1200 |
| Аналіз Помилок та Тонкощі | 800 | 1200 |
| Практика та Мовленнєві Ситуації | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/aspect-complete-system.yaml`. Go through EVERY `points:` item in EVERY section:
