...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/reported-questions-commands-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/reported-questions-commands.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/reported-questions-commands.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Непрямі питання та накази** (b1 track).
...
|---------|--------|---------------------|
| Діагностичний тест | 500 | 750 |
| Граматичне пояснення | 1300 | 1950 |
| Практичні вправи | 1000 | 1500 |
| Культурний контекст та діалоги | 700 | 1050 |
| Підсумок та самоперевірка | 500 | 750 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/reported-questions-commands.yaml`. Go through EVERY `points:` item in EVERY section:
