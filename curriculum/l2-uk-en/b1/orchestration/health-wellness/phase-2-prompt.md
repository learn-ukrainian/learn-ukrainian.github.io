...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/health-wellness-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/health-wellness.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/health-wellness.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Здоров'я та самопочуття** (b1 track).
...
|---------|--------|---------------------|
| Вступ | 600 | 900 |
| Термінологія та симптоми | 1000 | 1500 |
| Культурний контекст: Протяг та траволікування | 800 | 1200 |
| Практика: У лікаря та в аптеці | 1000 | 1500 |
| Підсумок та поради | 600 | 900 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/health-wellness.yaml`. Go through EVERY `points:` item in EVERY section:
