...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/regions-west-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/regions-west.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/regions-west.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Українські регіони: Захід** (b1 track).
...
|---------|--------|---------------------|
| Вступ: Захід як вікно в Європу | 600 | 900 |
| Львів — місто кави та архітектури | 1000 | 1500 |
| Галичина: Традиції та мовний колорит | 800 | 1200 |
| Закарпаття — мозаїка культур та природи | 1000 | 1500 |
| Підсумок: Захід у серці України | 600 | 900 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/regions-west.yaml`. Go through EVERY `points:` item in EVERY section:
