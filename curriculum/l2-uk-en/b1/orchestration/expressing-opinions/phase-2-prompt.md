...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/expressing-opinions-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/expressing-opinions.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/expressing-opinions.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Вираження думок та поглядів** (b1 track).
...
|---------|--------|---------------------|
| Вступ: Культура дискусії та стандарти | 600 | 900 |
| Ключова лексика та подолання кальок | 1000 | 1500 |
| Градація впевненості та ввічлива незгода | 1000 | 1500 |
| Робота з текстами та аргументація | 800 | 1200 |
| Практичне застосування та підсумок | 600 | 900 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/expressing-opinions.yaml`. Go through EVERY `points:` item in EVERY section:
