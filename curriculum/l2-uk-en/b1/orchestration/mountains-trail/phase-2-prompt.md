...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/mountains-trail-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/mountains-trail.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/mountains-trail.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Гори та трейлраннінг** (b1 track).
...
|---------|--------|---------------------|
| Вступ: Світ українських Карпат | 600 | 900 |
| Вершини та легенди Чорногори | 1000 | 1500 |
| Трейлраннінг: Спорт на межі | 800 | 1200 |
| Спорядження, мова та безпека | 800 | 1200 |
| Практична граматика та продукція | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/mountains-trail.yaml`. Go through EVERY `points:` item in EVERY section:
