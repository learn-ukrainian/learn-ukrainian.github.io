...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/past-passive-participles-1-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/past-passive-participles-1.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/past-passive-participles-1.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Пасивні дієприкметники минулого часу I** (b1 track).
...
|---------|--------|---------------------|
| Вступ та вступний тест | 500 | 750 |
| Творення: Логіка суфіксів та Чергування | 950 | 1425 |
| Граматичне узгодження та типові помилки | 850 | 1275 |
| Синтаксис: Дієприкметниковий зворот та Агентність | 850 | 1275 |
| Культурний контекст: Феномен «-но/-то» | 550 | 825 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/past-passive-participles-1.yaml`. Go through EVERY `points:` item in EVERY section:
