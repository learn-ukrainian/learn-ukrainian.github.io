...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/discourse-markers-basic-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/discourse-markers-basic.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/discourse-markers-basic.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Дискурсивні маркери: базові конектори** (b1 track).
...
|---------|--------|---------------------|
| Вступ | 500 | 750 |
| Презентація: Категорії та частотність | 700 | 1050 |
| Граматика та пунктуація | 800 | 1200 |
| Регістри та культура мовлення | 700 | 1050 |
| Практика: Читання та аналіз | 600 | 900 |
| Практика та продукція: Діалоги | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/discourse-markers-basic.yaml`. Go through EVERY `points:` item in EVERY section:
