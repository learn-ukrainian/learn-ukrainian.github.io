...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/professional-communication-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/professional-communication.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/professional-communication.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Професійна комунікація** (b1 track).
...
|---------|--------|---------------------|
| Вступ | 500 | 750 |
| Робоча комунікація та етикет | 1100 | 1650 |
| Освітня комунікація та традиції | 1000 | 1500 |
| Аналіз помилок та фразеологія | 700 | 1050 |
| Практика та підсумок | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/professional-communication.yaml`. Go through EVERY `points:` item in EVERY section:
