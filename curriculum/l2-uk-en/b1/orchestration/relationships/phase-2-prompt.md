...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/relationships-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/relationships.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/relationships.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Стосунки та зв'язки** (b1 track).
...
|---------|--------|---------------------|
| Вступ: Термінологія стосунків | 800 | 1200 |
| Читання та Культура: Інститут кумівства | 900 | 1350 |
| Мовна тонкість: Любити чи Кохати? | 800 | 1200 |
| Граматика та типові помилки | 800 | 1200 |
| Практика: Розмови про життя | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/relationships.yaml`. Go through EVERY `points:` item in EVERY section:
