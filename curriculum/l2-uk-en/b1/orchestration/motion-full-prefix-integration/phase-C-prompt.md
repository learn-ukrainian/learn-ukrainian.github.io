...
| Module persona | Senior Language & Culture Specialist, acting as Urban Explorer |
...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/motion-full-prefix-integration.md
```

**Plan file** (vocabulary_hints — vocabulary list to follow):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/motion-full-prefix-integration.yaml
```

**Meta file** (activity count targets, pedagogy):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/motion-full-prefix-integration.yaml
```
