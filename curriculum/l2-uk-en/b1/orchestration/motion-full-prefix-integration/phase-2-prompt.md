...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/motion-full-prefix-integration-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/motion-full-prefix-integration.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/motion-full-prefix-integration.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Рух: інтеграція префіксів** (b1 track).
...
|---------|--------|---------------------|
| Діагностичний тест | 400 | 600 |
| Система просторових префіксів | 1000 | 1500 |
| Переносні значення та сталі вирази | 800 | 1200 |
| Урбаністика та легенди | 1200 | 1800 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/motion-full-prefix-integration.yaml`. Go through EVERY `points:` item in EVERY section:
