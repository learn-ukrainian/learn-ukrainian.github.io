...
────────────────────────────────────────────────────────────
  ...
  failing gates:
    lesson: 10096/4000 (raw: 10755) | pedagogy: 16 violations | richness: 91% < 95% min (grammar)

  Otaman has NOT completed this module.
  Fix the issues above and re-run this script.

─── Audit output (last 15 lines) ───
    [INLINE_ENGLISH_IN_PROSE] Inline English translations in B1+ prose (4 occurrences): (To go way too far), (To peacefully disperse and go home), (Setting off) — breaks immersion target
