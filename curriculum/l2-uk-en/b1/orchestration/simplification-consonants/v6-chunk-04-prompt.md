...
**Section to write:** Спрощення [сонце], [серце] та інші особливі випадки (~600 words total)
...
з цієї складної категорії — це надзвичайно популярний числівник **шістнадцять** *(sixteen)*. Коли ви дуже швидко рахуєте предмети або гроші, ви цілком природно кажете [шіснац':ат']. Ви непомітно ковтаєте зайвий звук [т], щоб не ламати язика об таку важку граматичну конструкцію. Проте, коли ви акуратно заповнюєте будь-який офіційний документ, ви категорично мусите написати цю літеру «т». Якщо ви пропустите цей важливий знак, це буде вважатися дуже грубою орфографічною помилкою. До цієї ж специфічної групи належить серйозний медичний або анатомічний термін **зап'ястний** *(carpal)*. Він безпосередньо походить від знайомого багатьом іменника «зап'ястя» *(wrist)*. Також сюди обов'язково входить великий складений числівник **шістсот** *(six hundred)*, який теж зберігає складну форму. В офіційних українських шкільних підручниках для п'ятого класу такі нетипові випадки називають «спрощенням у вимові, але не на письмі». Окрім питомо українських слів, існує ще одна велика і дуже продуктивна категорія, яка категорично відмовляється від повного і беззастережного спрощення. Це різноманітні слова іншомовного походження, тобто наукові та технічні терміни з інших мов. Вони прийшли до нашого сучасного словника із латини, стародавньої грецької, сучасної французької чи англійської мов. Ми часто беремо довгий міжнародний корінь, що природно закінчується на складну комбінацію приголосних [ст]. Коли ми додаємо до нього наш типовий український суфікс «-н-», літера «т» завжди залишається на своєму законному місці. Найбільш яскраві та частотні приклади — це такі серйозні інтелектуальні прикметники, як **контрастний** *(contrasting)*, **баластний** *(ballast)* або **компостний** *(compost)*. Сюди також належить дуже важливий військовий термін **форпостний** *(outpost)*. Чому ж так історично відбувається у нашій граматиці? Українська літературна мова тут робить дуже свідомий і раціональний вибір між двома важливими речами. Зберегти візуальну впізнаваність міжнародного кореня для неї набагато важливіше, ніж механічно застосувати своє власне фонетичне правило милозвучності. Ми вимовляємо ці іноземні слова легко, швидко і без звука [т], наприклад [контрасний]. Але на папері ми суворо і послідовно зберігаємо оригінальну візуальну структуру базового слова-донора. Як же звичайному іноземному студенту ефективно запам'ятати всю цю складну багаторівневу систему? Як ніколи не плутатися під час написання важких диктантів чи довгих електронних листів? Найкращий, найбільш дієвий спосіб — це самостійно створити для себе надійний логічний гачок пам'яті. Зверніть свою увагу на те, що слова, які вперто зберігають «німу» літеру «т» на письмі, мають спільну рису. Вони зазвичай дуже міцно і візуально прив'язані до своєї короткої базової основи. Наприклад, такі поширені числівники, як «шістнадцять» та «шістсот», мають бути миттєво впізнаваними в тексті. Вони повинні завжди нагадувати уважному читачеві про базову цифру «шість». Якби ми просто викинули літеру «т» на письмі, цей важливий візуальний зв'язок із базовим коренем став би значно менш очевидним. Абсолютно те саме фонетичне правило стосується і частин людського тіла. Довге слово «зап'ястний» має чітко показувати свою пряму спорідненість із коротким словом «зап'ястя». Тому загальне правило тут насправді досить просте і дуже логічне. Якщо нове слово прямо походить від цифри «шість» або позначає частину тіла, хитра літера обов'язково залишається для візуального зв'язку. Вона гордо стоїть у тексті, навіть якщо ваш розслаблений язик її повністю ігнорує під час швидкої розмови. <!-- INJECT_ACTIVITY: quiz, Decide "Keep or Drop?" for derived words like "контраст + ний", "шість + надцять", and "радість + ний" -->
</previous_context>
