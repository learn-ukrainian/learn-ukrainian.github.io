...
детально розглянемо, як саме це правило працює на практиці під час створення нових слів. Усі ці дивовижні звукові трансформації абсолютно дзеркально повторюють ті логічні зміни, які ми вже бачили у формі першої особи однини. Наприклад, коли ми маємо справу зі звуком [д], він так само закономірно перетворюється на знайому африкату [дж]. Візьмемо звичайне базове дієслово доконаного виду «зарядити» (наприклад, телефон або батарею). Щоб перетворити його на регулярну або тривалу дію, ми додаємо суфікс «-ати» і миттєво отримуємо нове слово «заряджати». Аналогічно працює серйозне дієслово «засудити», яке легко трансформується у форму тривалої дії «засуджувати». Абсолютно ідентична, прозора логіка постійно діє і для глухого звука [т], який органічно переходить у шиплячий [ч]. Якщо ви хочете максимально швидко «скоротити» великий текст, то в процесі вашої довгої роботи ви будете його обережно «скорочувати». Коли ж ви маєте на меті суттєво «збагатити» свій словниковий запас новими словами, ви регулярно починаєте його «збагачувати». Ці фонетичні зміни є надзвичайно глибокими. Ця сама бездоганна граматична логіка поширюється і на велику групу свистячих приголосних звуків. Дзвінкий звук [з] під час утворення нових форм недоконаного виду дуже передбачувано перетворюється на шиплячий [ж]. Наприклад, якщо ми вирішили остаточно «знизити» ціни в магазині, то в процесі щоденної роботи ми будемо їх плавно «знижувати». Глухий свистячий звук [с] абсолютно так само слухняно і природно переходить у відповідний шиплячий звук [ш]. Якщо відважні пожежники змогли успішно «погасити» велике полум'я, то це об'єктивно означає, що вони спочатку почали його довго «погашати» або «погашувати». Крім того, знайомі нам складні комплекси теж чудово працюють за цим правилом. Якщо раптова дія означає «простити» когось, то тривалий процес буде звучати як «прощати» (тут відбувається закономірний перехід [ст] у [шч], тобто з'являється унікальна буква «щ»). Просто порівняйте всі ці нові форми з уже знайомими нам словами «я знижу» та «я погашу». Ви відразу чітко побачите, що українська фонетична система щодня працює як ідеальний годинниковий механізм. Ці правила ніколи не суперечать одне одному і створюють гармонію. <!-- INJECT_ACTIVITY: fill-in, Form imperfective verbs with -ати/-увати from perfective stems, 6 items. Includes: простити, зарядити, скоротити, знизити, засудити, погасити. --> Глибоке системне розуміння цього універсального історичного механізму дає вам надзвичайно потужну і корисну **стратегію декодування** *(decoding strategy)*. Ви зможете успішно використовувати її під час самостійного читання складних оригінальних українських текстів. Коли ви раптом бачите в книзі незнайоме вам довге дієслово з характерним шиплячим звуком, ви можете дуже легко знайти його справжній базовий корінь. Цей цікавий інтелектуальний процес нагадує справжню лінгвістичну гру. Наприклад, ви вперше в житті зустрічаєте довге слово «запрошувати» у великій газетній статті. Ви відразу чітко бачите там характерний звук [ш]. Тому ви миттєво і цілком логічно припускаєте, що в оригінальному короткому корені спочатку був свистячий [с]. Ви дуже акуратно подумки відкидаєте зайвий суфікс і робите швидку зворотну звукову заміну. В результаті ви без жодних проблем знаходите добре знайоме вам базове дієслово «просити». Відповідно, це нове довге слово означає тривалий процес прохання або активного запрошення гостей. Ця важлива практична навичка дозволяє вам інтуїтивно і швидко розпізнавати сотні нових українських слів. Ви просто впевнено спираєтеся лише на знайомі базові корені та прості історичні закони.
</previous_context>
