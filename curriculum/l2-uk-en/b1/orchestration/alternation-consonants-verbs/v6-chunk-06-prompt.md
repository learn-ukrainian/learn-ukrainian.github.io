...
**Section to write:** Повна парадигма: від інфінітива до всіх форм (~600 words total)
...
чергуватися. Це відбувається переважно тому, що нові голосні звуки створюють зовсім інше фонетичне середовище. Воно категорично вимагає зміни приголосного для збереження природного ритму, плавності та традиційної мелодійності українського мовлення. Розглянемо дуже класичний і абсолютно зрозумілий практичний приклад. Візьмемо поширене дієслово **зарядити** *(to charge, perfective)*, наприклад, мобільний телефон або батарею автомобіля. Якщо ми хочемо підкреслити, що цей процес відбувається довго або регулярно, ми додаємо суфікс **-ати**. У результаті звук **[д]** перед новим голосним суфіксом закономірно перетворюється на вже знайому нам дзвінку африкату **[дж]**. Таким чином ми отримуємо нове повноцінне дієслово **заряджати** *(to charge, imperfective)*. Ця трансформація є абсолютно ідентичною до тієї моделі, яку ми щойно бачили у формі першої особи однини. Цей потужний принцип словотворення працює надзвичайно систематично для всіх груп приголосних, які ми ретельно вивчали раніше. Давайте детально розглянемо інші типові зміни звуків на конкретних прикладах. Наприклад, регулярне чергування звука **[с]** зі звуком **[ш]** можна дуже легко побачити у такій цікавій парі дієслів. Слово **погасити** *(to extinguish, perfective)* за допомогою спеціального суфікса перетворюється на форму **погашати** *(to extinguish, imperfective)* або частіше **погашувати**. Якщо корінь слова закінчується на звук **[т]**, він цілком очікувано і закономірно зміниться на звук **[ч]**. Саме так базове дієслово **скоротити** *(to shorten, perfective)* трансформується у набагато довше слово **скорочувати** *(to shorten, imperfective)*. Складніші комбінації приголосних також абсолютно слухняно підкоряються цим універсальним граматичним правилам. Звукова група **[зд]** дуже гармонійно переходить у складну дзвінку африкату **[ждж]**. Дієслово **об'їздити** *(to travel all over, perfective)* ритмічно змінюється на форму **об'їжджати** *(to travel all over, imperfective)*. Так само поводиться комбінація **[ст]**, яка закономірно перетворюється на літеру **щ**, що передає звуки **[шч]**. Відоме всім дієслово **простити** *(to forgive, perfective)* завдяки цьому давньому правилу стає красивим словом **прощати** *(to forgive, imperfective)*. Звук **[з]** також регулярно чергується зі звуком **[ж]**, що ми чітко бачимо у поширеній парі **знизити** *(to lower, perfective)* та **знижувати** *(to lower, imperfective)*. Розуміння цього механізму дає вам надзвичайно потужну стратегію для впевненого читання та швидкого збагачення словникового запасу. Якщо ви зустрічаєте в тексті нове дієслово недоконаного виду, яке має у своєму корені шиплячі звуки або африкати, не панікуйте. Вам зовсім не обов'язково одразу ж шукати це нове і довге слово у своєму словнику. Ви можете легко застосувати цікавий метод зворотної інженерії та самостійно розшифрувати його справжнє лексичне значення. Знаючи, що звук **[дж]** зазвичай походить від **[д]**, ви можете візуально відкинути суфікс недоконаного виду і відновити початковий корінь. Наприклад, побачивши слово **заряджати**, ви повинні логічно шукати його базовий корінь зі звуком **[д]**. Це миттєво приведе вас до знайомого дієслова **зарядити**, яке ви вже добре знаєте і розумієте. Так само працює слово **засуджувати** *(to condemn, imperfective)*, яке походить від дієслова **засудити** *(to condemn, perfective)*. Ця залізна логіка ідеально працює і з іншими українськими звуками. Якщо ви бачите слово **збагачувати** *(to enrich, imperfective)* зі звуком **[ч]**, шукайте корінь зі звуком **[т]**. Це автоматично приведе вас до базового слова **збагатити** *(to enrich, perfective)*. Ця навичка перетворює ваше пасивне читання на активний аналітичний процес, дозволяючи вам інтуїтивно розуміти сотні нових українських слів. <!-- INJECT_ACTIVITY: fill-in, Form imperfective with -ати/-увати: (засудити, знизити, збагатити, простити), 6 items -->
</previous_context>
