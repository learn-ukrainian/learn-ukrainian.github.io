...
**Section to write:** Чергування задньоязикових у дієсловах: [г]->[ж], [к]->[ч], [х]->[ш] (~660 words total)
...
поширене дієслово руху «їздити». У формі першої особи воно звучить як «я їжджу». Це може здатися складним для вимови на перший погляд. Але насправді це просто комбінація зміни [з] на [ж] і зміни [д] на [дж], які відбулися одночасно. Аналогічно поводиться група глухих приголосних [ст]. Вона закономірно перетворюється на комбінацію шиплячих звуків [шч]. На письмі цей звук завжди позначається однією літерою «щ». Наприклад, від дієслова «мостити» ми утворюємо форму «я мощу», а від «вимостити» — «я вимощу». Дуже часто ми зустрічаємо це явище у слові «чистити». Щоранку ми кажемо: «Я чищу зуби». Дієслово «пустити» також має таку форму: «Я пущу тебе додому». Це комплексне чергування гарантує, що потік мовлення залишатиметься мелодійним. Воно запобігає появі важких для вимови стиків твердих і м'яких звуків. > — **Ведучий:** Добрий вечір, шановні глядачі! Ми починаємо наш кулінарний фінал. Я **ходжу** *(walk)* по кухні і спостерігаю за нашими талановитими учасниками. > — **Олена:** Я вже **чищу** *(clean)* картоплю і зараз **посаджу** *(plant/put)* її варитися. > — **Ведучий:** Чудово! А що робить наш другий фіналіст? Я **прошу** *(ask)* вас розпочати презентацію вашої страви. > — **Максим:** Я саме зараз **мішу** *(knead)* тісто для нашого фірмового пирога. > — **Ведучий:** Дуже цікаво! А хто **возить** *(transports)* свіжі продукти для вашої команди? Я бачу багато інгредієнтів. > — **Максим:** Я **вожу** *(transport)* їх сам, щоб завжди бути впевненим у найвищій якості кожного томата. > — **Олена:** А я зараз **кручу** *(twist/turn)* м'ясорубку, щоб підготувати ідеальну начинку для нашого головного шедевра. > — **Ведучий:** Ваша енергія просто неймовірна! Я **сиджу** *(sit)* за суддівським столом і з нетерпінням чекаю на результати. > — **Максим:** Я вам обіцяю, я **збагачу** *(enrich)* цю страву неймовірними спеціями. Давайте ще раз закріпимо найголовніше граматичне правило, яке стосується всіх згаданих вище фонетичних процесів. Це так зване правило ізольованої форми. Абсолютно всі чергування зубних та свистячих приголосних у другій дієвідміні відбуваються строго і виключно у формі першої особи однини. Тобто, коли ми використовуємо займенник «я». Щоб остаточно в цьому переконатися, корисно порівняти повні **парадигми** *(paradigms)* відмінювання кількох типових дієслів. Розглянемо дієслово «сидіти». Ми маємо форму з чергуванням: «я сиджу». Але далі корінь залишається стабільним: «ти сидиш», «він сидить», «ми сидимо», «ви сидите», «вони сидять». Як бачите, африката [дж] більше ніде не з'являється. Візьмемо дієслово «крутити». Лише одна форма має шиплячий звук: «я кручу». Решта форм зберігають оригінальний звук: «ти крутиш», «вона крутить», «ми крутимо», «ви крутите», «вони крутять». Це ж правило застосовується до слова «просити». Після форми «я прошу» ми відразу повертаємося до бази: «ти просиш», «ми просимо». Розуміння цього строгого обмеження є ключем до грамотного спілкування. Вам не потрібно запам'ятовувати сотні різних форм для кожного окремого слова. Достатньо лише вивчити, як утворюється форма «я». Для всіх інших осіб треба просто додавати стандартні закінчення до оригінальної словникової основи. Це робить українську граматику набагато передбачуванішою і логічнішою, ніж може здатися на перший погляд. <!-- INJECT_ACTIVITY: group-sort, Sort verbs by alternation type: [д]->[дж], [т]->[ч], [з]->[ж], [с]->[ш], 10 items --> <!-- INJECT_ACTIVITY: fill-in, Conjugate verbs in the я-form based on infinitive: (летіти, будити, місити, чистити, садити), 12 items -->
</previous_context>
