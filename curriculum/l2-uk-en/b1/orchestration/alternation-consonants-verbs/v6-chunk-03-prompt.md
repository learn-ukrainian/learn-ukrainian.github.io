...
**Section to write:** Чергування задньоязикових у дієсловах: [г]->[ж], [к]->[ч], [х]->[ш] (~650 words total)
...
## Чергування задньоязикових у дієсловах: [г]->[ж], [к]->[ч], [х]->[ш] (~650 words total)
- P1 (~160 words): [Introduction to I conjugation verbs using velar stems. Explain the [к] to [ч] shift in "плакати — плачу", "пекти — печу", and "тикати — тичу". Compare "печеш" (2nd person) to show that in I conjugation, the alternation can sometimes spread further than just the 1st person.]
- P2 (~160 words): [The [г] to [ж] shift. Use "могти — можу", "берегти — бережу", and "стригти — стрижу". Highlight that these are often "strong" verbs with roots that remain stable across many related words.]
- P3 (~130 words): [The [х] to [ш] shift. Focus on "колихати — колишу" and "махати — машу". Explain the stylistic difference between "машу" and the colloquial/non-alternating forms sometimes heard.]
- P4 (~100 words): [Comparison with Nouns (M09): Show how "друг -> друже" (Vocative) uses the exact same [г-ж] logic as "берегти -> бережу" (Verb). This reinforces the idea of a unified phonological system across the language.]
- Exercise (~100 words): [Activity: quiz. Focus: Identify which alternation type applies to a given verb: зубний, задньоязиковий, or губний + [л]. Items: плакати, сидіти, любити, махати, летіти, могти, купити, просити.]
