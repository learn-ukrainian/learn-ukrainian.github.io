...
- P1 (~180 words): [Explain the "Aspect Bridge." When a perfective verb becomes imperfective via the -ати or -увати suffixes, the root consonant often alternates. Use "зарядити (perf) -> заряджати (impf)" as the primary example.]
- P2 (~160 words): [The [т] to [ч] and [с] to [ш] patterns in word formation. Examples: "скоротити — скорочувати", "збагатити — збагачувати", "погасити — погашати". Explain that this isn't just about conjugation; it's about building new words.]
- P3 (~140 words): [Decoding strategy for learners: If you see "запрошувати", you can guess the root is "просити" (с-ш). If you see "народжувати", the root is "родити" (д-дж). This helps expand vocabulary exponentially.]
- Exercise (~120 words): [Activity: fill-in. Focus: Form imperfective verbs with -ати/-увати from perfective stems. Items: простити, зарядити, знизити, засудити, скоротити, збагатити.]
