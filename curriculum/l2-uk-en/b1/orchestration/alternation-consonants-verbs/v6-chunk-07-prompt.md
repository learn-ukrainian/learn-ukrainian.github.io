...
| [зд]| [ждж]| їздити-їжджу |
| [ст]| [щ] | простити-прощу, чистити-чищу |
...
2. Чому в дієслові 'роблю' з'являється звук [л']? (Відповідь: губний приголосний + давній суфікс j)
3. Провідмінюйте дієслово 'просити' в теперішньому часі. (я прошу, ти просиш...)
4. Утворіть недоконаний вид: простити, зарядити, знизити. (прощати, заряджати, знижувати)]
- P3 (~100 words): [Final recap: Consonant shifts are a fundamental melody of Ukrainian verbs. Mastering the "1st person singular" and "aspect formation" shifts allows for natural, rhythmic speech. Preview of M11: Simplification of consonant clusters (спрощення).]
