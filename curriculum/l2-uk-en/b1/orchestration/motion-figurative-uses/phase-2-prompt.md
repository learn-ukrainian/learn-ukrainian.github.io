...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/motion-figurative-uses-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/motion-figurative-uses.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/motion-figurative-uses.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Переносні значення дієслів руху** (b1 track).
...
|---------|--------|---------------------|
| Діагностика: Пряме та переносне значення | 500 | 750 |
| Аналіз: Логіка префіксів та культурний код | 1100 | 1650 |
| Поглиблення: Пастки переносних значень | 800 | 1200 |
| Практика: Метафори в контексті | 900 | 1350 |
| Підсумок: Читання та рефлексія | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/motion-figurative-uses.yaml`. Go through EVERY `points:` item in EVERY section:
