...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/checkpoint-complex-sentences-2.yaml
```

Read the meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/checkpoint-complex-sentences-2.yaml
```
...
Research **Контрольна точка: складні речення (частина 2)** for the **B1** core track. Core tracks need lighter research than seminar tracks — focus on accuracy and State Standard alignment.
