...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/checkpoint-complex-sentences-2-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/checkpoint-complex-sentences-2.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/checkpoint-complex-sentences-2.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Контрольна точка: складні речення (частина 2)** (b1 track).
...
|---------|--------|---------------------|
| Огляд та цілі | 400 | 600 |
| Допустові та часові зв'язки | 1000 | 1500 |
| Причиново-наслідкова логіка | 900 | 1350 |
| Трансформація непрямої мови | 1000 | 1500 |
| Комплексна практика та самоконтроль | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/checkpoint-complex-sentences-2.yaml`. Go through EVERY `points:` item in EVERY section:
