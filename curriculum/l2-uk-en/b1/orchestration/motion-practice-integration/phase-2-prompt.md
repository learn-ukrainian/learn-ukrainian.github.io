...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/motion-practice-integration-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/motion-practice-integration.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/motion-practice-integration.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Дієслова руху: практика та інтеграція** (b1 track).
...
|---------|--------|---------------------|
| Вступ: Перевірка та мотивація | 500 | 750 |
| Пояснення: Матриця навігації та прийменників | 1200 | 1800 |
| Культурний контекст: Шляхи та ідіоми | 800 | 1200 |
| Практика: Київська Одіссея | 1000 | 1500 |
| Підсумок та застосування | 500 | 750 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/motion-practice-integration.yaml`. Go through EVERY `points:` item in EVERY section:
