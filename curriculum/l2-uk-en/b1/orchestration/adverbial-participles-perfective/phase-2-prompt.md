...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/adverbial-participles-perfective-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/adverbial-participles-perfective.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/adverbial-participles-perfective.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Дієприслівники доконаного виду** (b1 track).
...
|---------|--------|---------------------|
| Вступ | 500 | 750 |
| Граматика: Формування та значення | 900 | 1350 |
| Аналіз помилок та обмеження | 1000 | 1500 |
| Лексика та культурний контекст | 1000 | 1500 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/adverbial-participles-perfective.yaml`. Go through EVERY `points:` item in EVERY section:
