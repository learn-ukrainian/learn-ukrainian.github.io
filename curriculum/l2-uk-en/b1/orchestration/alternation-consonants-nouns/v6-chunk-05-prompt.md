...
- P1 (~150 words): [Systematic view of the 2nd declension masculine paradigm. Full declension of 'друг' and 'козак'. Highlighting that the ONLY place the consonant changes in this paradigm is the Vocative. Contrast with non-alternating cases like Genitive (друга) or Instrumental (другом).]
- P2 (~150 words): [Comparison between I and II declensions. Visualizing where the 'danger zones' for consonants are: Masculine (only Vocative) vs Feminine (Dative and Locative). This helps learners build a mental map of when to 'switch' the consonant.]
- P3 (~150 words): [Analysis of the -е ending vs -у/-ю endings in Vocative. Why 'сину' and 'батьку' don't alternate (the -у ending doesn't trigger it), whereas the -e ending (as in 'друже') is the active catalyst.]
- Exercise: [type: error-correction, focus: Find and fix consonant alternation errors in sentences (e.g., *на ножі -> на нозі, *козаже -> козаче), 6 items]
