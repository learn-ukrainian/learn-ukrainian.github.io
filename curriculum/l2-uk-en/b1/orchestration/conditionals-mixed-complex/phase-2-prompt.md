...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/conditionals-mixed-complex-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/conditionals-mixed-complex.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/conditionals-mixed-complex.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Умовні речення: змішані та складні умови** (b1 track).
...
|---------|--------|---------------------|
| Тест: Перевірте себе | 400 | 600 |
| Пояснення: Змішані типи та складні умови | 1300 | 1950 |
| Практика: Побудова логічних ланцюжків | 1000 | 1500 |
| Діалоги: Від макогона до історії | 900 | 1350 |
| Підсумок та рефлексія | 400 | 600 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/conditionals-mixed-complex.yaml`. Go through EVERY `points:` item in EVERY section:
