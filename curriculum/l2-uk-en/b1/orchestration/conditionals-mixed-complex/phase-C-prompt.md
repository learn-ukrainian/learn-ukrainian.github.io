...
| Module persona | Senior Language & Culture Specialist, acting as Chess Grandmaster |
...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/conditionals-mixed-complex.md
```

**Plan file** (vocabulary_hints — vocabulary list to follow):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/conditionals-mixed-complex.yaml
```

**Meta file** (activity count targets, pedagogy):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/conditionals-mixed-complex.yaml
```
