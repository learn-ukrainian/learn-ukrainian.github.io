...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/checkpoint-complex-sentences-1-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/checkpoint-complex-sentences-1.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/checkpoint-complex-sentences-1.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Контрольна точка: складні речення (частина 1)** (b1 track).
...
|---------|--------|---------------------|
| Вступ та огляд | 500 | 750 |
| Відносні речення та «симфонічний» синтаксис | 1000 | 1500 |
| Підрядні речення мети | 800 | 1200 |
| Умовні речення: реальні та ірреальні ситуації | 900 | 1350 |
| Інтеграційний виклик та самоконтроль | 800 | 1200 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/checkpoint-complex-sentences-1.yaml`. Go through EVERY `points:` item in EVERY section:
