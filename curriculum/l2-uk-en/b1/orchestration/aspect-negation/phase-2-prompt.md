...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/aspect-negation-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/aspect-negation.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/aspect-negation.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Вид у запереченні** (b1 track).
...
|---------|--------|---------------------|
| Вступ | 500 | 750 |
| Пояснення граматики | 1100 | 1650 |
| Практика та аналіз помилок | 1000 | 1500 |
| Культура та діалоги | 1000 | 1500 |
| Підсумок | 400 | 600 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/aspect-negation.yaml`. Go through EVERY `points:` item in EVERY section:
