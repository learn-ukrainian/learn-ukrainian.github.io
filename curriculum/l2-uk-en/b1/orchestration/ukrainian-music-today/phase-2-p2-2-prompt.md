...
> **Your #1 job: Write 825 words for the section "Історія та культура".**
...
Write the section prose for **Історія та культура** within the module **Українська музика сьогодні**.
...
```
===WORD_COUNTS===
Section "Історія та культура": {count} words (budget: 825-825×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Історія та культура)
