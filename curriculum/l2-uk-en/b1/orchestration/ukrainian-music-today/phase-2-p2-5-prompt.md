...
> **Your #1 job: Write 543 words for the section "Продукція".**
...
Write the section prose for **Продукція** within the module **Українська музика сьогодні**.

- **WORD BUDGET**: 543 words minimum, 543 × 2 maximum. Stay in this range.
...
- Target: 543 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Продукція": {count} words (budget: 543-543×2)
===WORD_COUNTS===
```
