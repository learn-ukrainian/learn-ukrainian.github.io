...
> **Your #1 job: Write 225 words for the section "Вступ — Музика як ідентичність".**
...
Write the section prose for **Вступ — Музика як ідентичність** within the module **Українська музика сьогодні**.
...
```
===WORD_COUNTS===
Section "Вступ — Музика як ідентичність": {count} words (budget: 225-225×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Вступ — Музика як ідентичність)
