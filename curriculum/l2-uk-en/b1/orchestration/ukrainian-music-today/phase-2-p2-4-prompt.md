...
> **Your #1 job: Write 525 words for the section "Практика".**
...
Write the section prose for **Практика** within the module **Українська музика сьогодні**.
...
```
===WORD_COUNTS===
Section "Практика": {count} words (budget: 525-525×2)
===WORD_COUNTS===
```
