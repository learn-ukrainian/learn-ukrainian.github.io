...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/checkpoint-aspect-mastery-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/checkpoint-aspect-mastery.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/checkpoint-aspect-mastery.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Контрольна точка: Опанування виду** (b1 track).
...
|---------|--------|---------------------|
| Вступ та самоаналіз | 500 | 750 |
| Навичка 1: Минулий час та народна мудрість | 700 | 1050 |
| Навичка 2: Майбутній час — синтетика проти аналітики | 800 | 1200 |
| Навичка 3: Наказовий спосіб та заборони | 700 | 1050 |
| Навичка 4: Системність видових пар | 650 | 975 |
| Інтеграція: Комплексна перевірка | 650 | 975 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/checkpoint-aspect-mastery.yaml`. Go through EVERY `points:` item in EVERY section:
