...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/purpose-shchob-past-form-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/purpose-shchob-past-form.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/purpose-shchob-past-form.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Підрядні речення мети: щоб + минула форма** (b1 track).
...
|---------|--------|---------------------|
| Вступ | 500 | 750 |
| Граматична презентація | 1000 | 1500 |
| Типові помилки та контраст | 900 | 1350 |
| Культурний контекст та діалоги | 1100 | 1650 |
| Практика та підсумок | 500 | 750 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/purpose-shchob-past-form.yaml`. Go through EVERY `points:` item in EVERY section:
