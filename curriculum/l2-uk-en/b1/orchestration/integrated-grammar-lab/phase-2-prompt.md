...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/integrated-grammar-lab-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/integrated-grammar-lab.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/integrated-grammar-lab.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Інтегрована граматична лабораторія** (b1 track).
...
|---------|--------|---------------------|
| Вступний тест: Стилістична діагностика | 400 | 600 |
| Пояснення: Синтез і стилістична гнучкість | 600 | 900 |
| Сценарій 1: Офіційно-діловий звіт | 600 | 900 |
| Сценарій 2: Неофіційна сімейна розмова | 600 | 900 |
| Сценарій 3: Новини та медіа | 600 | 900 |
| Практика: Лабораторія редагування | 600 | 900 |
| Діалоги та текстотворення | 400 | 600 |
| Підсумок: Потрібно більше практики? | 200 | 300 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/integrated-grammar-lab.yaml`. Go through EVERY `points:` item in EVERY section:
