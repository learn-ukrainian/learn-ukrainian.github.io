...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/integrated-grammar-lab.md"
   ```
...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/integrated-grammar-lab.md`
2. **Activities**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/activities/integrated-grammar-lab.yaml`
3. **Vocabulary**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/vocabulary/integrated-grammar-lab.yaml`
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/integrated-grammar-lab.yaml`
5. **Meta** (build config): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/integrated-grammar-lab.yaml`
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/integrated-grammar-lab-research.md`
...
Word count:       4329 / 4000 (108.2%)
Activities:       10
Vocabulary items: 30
Engagement boxes: 7
Immersion:        99.1% (target: 85-100%)
Richness:         96% (threshold: 95%)
Richness gaps:    cultural: 2/3
Audit status:     PASS
```
...
1. Вступний тест: Стилістична діагностика
2. Пояснення: Синтез і стилістична гнучкість
3. Сценарій 1: Офіційно-діловий звіт
4. Сценарій 2: Неофіційна сімейна розмова
5. Сценарій 3: Новини та медіа
6. Практика: Лабораторія редагування
7. Діалоги та текстотворення
