...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/regions-east-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/regions-east.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/regions-east.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Українські регіони: Схід** (b1 track).
...
|---------|--------|---------------------|
| Вступ | 600 | 900 |
| Харків: Місто студентів, науки та архітектури | 1000 | 1500 |
| Історія Слобожанщини та Донбасу | 1000 | 1500 |
| Мовна практика та типові помилки | 800 | 1200 |
| Підсумок: Стійкість та єдність Сходу | 600 | 900 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/regions-east.yaml`. Go through EVERY `points:` item in EVERY section:
