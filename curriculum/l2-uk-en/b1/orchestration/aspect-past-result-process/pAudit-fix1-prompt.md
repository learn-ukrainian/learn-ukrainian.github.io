...
────────────────────────────────────────────────────────────
  ...
  failing gates:
    lesson: 4244/4000 (raw: 4556) | pedagogy: 1 violations | richness: 85% < 95% min (grammar)

  Otaman has NOT completed this module.
  Fix the issues above and re-run this script.

─── Audit output (last 15 lines) ───
       → FIX: Break into shorter sentences. First 5 words: 'Недоконаний вид професійному звіті прийнятний...'
    [INLINE_ENGLISH_IN_PROSE] Inline English translations in B1+ prose (4 occurrences): (Aspect complete system), (Aspect integration practice), (Imperfective aspect) — breaks immersion target
