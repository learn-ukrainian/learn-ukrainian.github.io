...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/aspect-past-result-process-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/aspect-past-result-process.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/aspect-past-result-process.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Вид у минулому: результат і процес** (b1 track).
...
|---------|--------|---------------------|
| Діагностичний тест | 600 | 900 |
| Презентація та теорія | 1000 | 1500 |
| Порівняльний аналіз | 800 | 1200 |
| Практика та виправлення помилок | 900 | 1350 |
| Діалоги та підсумок | 700 | 1050 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/aspect-past-result-process.yaml`. Go through EVERY `points:` item in EVERY section:
