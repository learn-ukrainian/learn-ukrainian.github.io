...
**Section to write:** Порівняння трьох конструкцій (~660 words total)
...
виконано**» *(The work will be completed)*. Зверніть увагу, що допоміжне дієслово тут завжди незмінно стоїть у формі третьої особи однини. Чому ж українські мовознавці так наполегливо називають конструкції на **-но/-то** найкращим і найправильнішим вибором для вираження пасиву? Відомі мовознавці та автори сучасних шкільних підручників, зокрема Олександр Авраменко, постійно наголошують на їхній абсолютній природності. Давайте разом порівняємо дві схожі за змістом фрази. Перша фраза: «Засідання проводиться комітетом». Вона дуже перевантажена, має пасивний суфікс **-ся** та містить орудний відмінок для позначення виконавця. Через це вона звучить надзвичайно штучно і нагадує поганий переклад. Друга фраза: «Засідання **проведено**» *(The meeting has been held)*. Вона дуже коротка, динамічна і повністю зосереджена на найголовнішому — на успішному результаті. У формах на **-но/-то** виконавець дії принципово і назавжди зникає з речення. Цей зникаючий виконавець є ідеальним стилістичним інструментом для багатьох офіційних ситуацій. Ми використовуємо його тоді, коли нам абсолютно не важливо, хто саме зробив цю роботу. Найголовніше для нас полягає в тому, що її успішно завершено. Сучасна українська мова понад усе любить конкретику завершених дій. Щоб швидко навчитися вільно та без помилок використовувати ці форми на практиці, давайте детально подивимося на логіку їхнього творення. Як саме правильно перетворити звичайне активне речення на ідеальну пасивну конструкцію з безособовою формою на **-но/-то**? Цей цікавий граматичний процес завжди складається з трьох дуже простих і послідовних кроків. Спочатку ми беремо типове активне речення: «Художник намалював картину» *(The artist painted a picture)*. Наш перший крок: ми повністю і безжально прибираємо підмет-виконавець (слово «художник»). Він нам у новій конструкції більше взагалі не потрібен. Наш другий крок: ми свідомо змінюємо активне дієслово минулого часу («намалював») на відповідну безособову форму («намальовано»). Наш третій крок, який є найважливішим правилом: ми суворо залишаємо об'єкт («картину») у правильному знахідному відмінку. Фінальний результат нашої трансформації: «Картину **намальовано**» *(The picture has been painted)*. Розгляньмо ще один корисний приклад. Активне речення звучить так: «Уряд ухвалив новий закон» *(The government adopted a new law)*. Правильне пасивне речення: «Новий закон **ухвалено**» *(A new law has been adopted)*. Ви гарантовано будете зустрічати ці характерні граматичні форми майже щодня. Вони постійно звучать в телевізійних новинах, активно використовуються у діловому листуванні, пишуться на вивісках магазинів та в різноманітних офіційних інструкціях. Це абсолютно невід'ємна частина сучасного українського суспільного життя. Вам варто надійно запам'ятати кілька найпоширеніших дієслів, які дуже часто вживаються саме у формі на **-но/-то**. В різних офіційних документах та контрактах ви постійно бачитимете важливі слова **ухвалено** *(has been adopted)*, **затверджено** *(has been approved)* та **підписано** *(has been signed)*. У щоденному повсякденному житті на скляних дверях кафе чи магазинів часто висять інформаційні таблички **зачинено** *(closed)* або **відчинено** *(opened)*. В електронному листуванні ваша поштова система регулярно повідомляє вам, що нове повідомлення успішно **надіслано** *(has been sent)* або непотрібний файл назавжди **видалено** *(has been deleted)*. А коли ви із задоволенням робите покупки в інтернет-магазинах, ви бачите фінальний статус: бажаний товар **куплено** *(has been bought)* або помилкове замовлення **скасовано** *(has been cancelled)*. Глибоке знання цих форм суттєво полегшить вам розуміння українських текстів. <!-- INJECT_ACTIVITY: fill-in, focus: Complete sentences with the correct -но/-то form of the given verb, 8 items -->
</previous_context>
