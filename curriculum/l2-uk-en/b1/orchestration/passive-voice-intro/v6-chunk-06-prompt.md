...
**Section to write:** Підсумок та перехід (~450 words total)
...
## Підсумок та перехід (~450 words total)
- P1 (~150 words): Recap of the core rules. Passive voice shifts focus to the object. -ся forms (будується) are for processes/states, while -но/-то forms (збудовано) are for impersonal results. Ukrainian's cardinal rule: favor the active voice to keep the language alive and natural.
- P2 (~150 words): Self-check for the learner. Can you answer these?
  - Я можу розрізнити активний і пасивний стан? (Студент читає vs Книга читається)
  - Я знаю, як утворити форму на -но/-то від дієслова "написати"? (Написано)
  - Я розумію, чому речення "Книгу прочитано мною" є неправильним? (Бо -но/-то не вживається з виконавцем)
  - Я можу пояснити, чому "знаходитися" — це природна пасивна конструкція?
- P3 (~150 words): Preview of Module 24. Now that we understand how verbs behave in sentences (voice, aspect, reflexive), we will look at how they are *built*. We will explore prefixes and suffixes (писати -> написати -> переписати) to see how Ukrainian expands its vocabulary through verb formation.
...
чітко перенести цей досягнутий результат у минулий час, ми просто додаємо допоміжне дієслово «було». Таким чином ми ясно показуємо, що дія логічно завершилася колись давно. А ось дієслово зі зворотним суфіксом -ся, наприклад «координувалися», навпаки описує досить тривалий **процес** *(process)* у минулому, а не швидкий результат. Тепер спробуємо кардинально змінити загальний стиль і настрій цього тексту. Ваше завдання — повністю переписати цей дуже офіційний репортаж так, ніби ви пишете надзвичайно емоційний пост для особистого блогу. Уявіть, що саме ви були одним із головних організаторів свята, тому вам потрібно перетворити сухі пасивні конструкції на живий та яскравий активний стан. Наприклад, замість офіційного речення «Виставку відкрито» сміливо напишіть так: «Ми нарешті урочисто відкрили нашу неймовірну виставку!». Замість «Усі заходи проведено» радісно скажіть: «Ми дуже успішно провели всі наші круті заходи!». Відчуваєте, як миттєво змінюється загальна **тональність** *(tone)* вашого оновленого тексту? Він одразу стає значно теплішим, ближчим до читача та більш відвертим. Зникає психологічна дистанція між автором та його аудиторією. Виконайте це перетворення для всіх безособових форм, які ви знайдете у тексті вище. Це чудове тренування допоможе вам інтуїтивно відчувати принципову різницю між формальним книжковим і повсякденним розмовним стилями. <!-- INJECT_ACTIVITY: sentence-builder, Transform active sentences to -но/-то passive and vice versa, 8 items --> А тепер настав час для вашої власної самостійної **творчості** *(creativity)*. Спробуйте написати короткий офіційний звіт про свій минулий робочий або навчальний тиждень. Ваша головна мета — придумати п'ять змістовних речень, обов'язково використовуючи у них щонайменше три різні українські форми на -но/-то. Уявіть, що ви відповідально звітуєте перед дуже суворим керівником, якому цікаві виключно готові результати вашої праці. Ви можете використовувати такі базові приклади для натхнення: «Усі важливі електронні листи вже успішно **надіслано** *(have been sent)*. Мій складний проєкт нарешті повністю **завершено** *(has been completed)*. Нову цікаву книгу уважно **прочитано** *(has been read)*. Домашнє завдання з математики **виконано** *(has been done)* без жодних помилок. Мою кімнату ідеально **прибрано** *(has been cleaned)* ще вчора». Ця невелика, але дуже корисна вправа гарантовано допоможе вам швидко автоматизувати використання цих специфічних пасивних форм для тих реальних життєвих ситуацій, коли вам дійсно потрібно дуже чітко, професійно і максимально коротко відзвітувати про успішно зроблену вами роботу. <!-- INJECT_ACTIVITY: fill-in, Complete sentences with the correct -но/-то form of the given verb, 8 items --> Наостанок нам варто звернути увагу на ще один важливий граматичний **нюанс** *(nuance)* — правильне використання пасивних конструкцій у різних часових формах. Як ми вже знаємо, форми на -но/-то самі по собі зазвичай означають повністю завершений результат. Але що робити, якщо цей результат стосується моменту в минулому чи майбутньому? Тут на допомогу завжди приходить наше допоміжне дієслово «бути». Якщо ви хочете сказати про важливе рішення в минулому, просто кажіть: «**було вирішено** *(it was decided)*». Якщо ж ви впевнено говорите про майбутній результат, використовуйте форму майбутнього часу: «обов'язково **буде зроблено** *(it will be done)*» або «буде відкрито». Звичайні зворотні дієслова на -ся також дуже легко змінюються за часами: «дім будується» (зараз), «дім будувався» (раніше), «дім буде будуватися» (у майбутньому). Це робить всю пасивну систему української мови дуже гнучкою, логічною та максимально зручною у щоденному використанні.
</previous_context>
