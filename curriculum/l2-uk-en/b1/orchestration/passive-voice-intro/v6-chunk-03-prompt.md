...
**Section to write:** Форми на -но/-то: українська спеціальність (~920 words total)
**Word target for this section:** 920 words (aim for 1012 to account for undershoot)
...
конструкції із зазначенням діяча в орудному відмінку вважаються вкрай штучними та неприродними для живого спілкування. Лінгвісти називають це явище типовим проявом поганого бюрократичного стилю, або **канцеляриту** *(bureaucratese)*. Справжні українці майже ніколи не скажуть «Новий дім будується робітниками». Вони інтуїтивно відчувають, що активна дія робить речення живим і динамічним. Тому вони просто скажуть: «Робітники будують новий дім». Ви добре пам'ятаєте з попередніх уроків, що цей самий суфікс **-ся** також активно утворює звичайні зворотні дієслова. Як тоді студенту без помилок відрізнити пасивний стан від простої зворотної дії? Для цього в мовознавстві існує дуже логічний і надзвичайно надійний метод — тест на істоту. Вам потрібно лише уважно подивитися на граматичний підмет у вашому реченні. Якщо цей підмет позначає абстрактне поняття або предмет, тобто це **неістота** *(inanimate object)*, він фізично не може виконувати жодну дію самостійно. Тому перед вами майже завжди типовий пасивний стан. Наприклад, у реченні «Великий міський магазин відкривається о восьмій годині» *(The big city store opens at eight o'clock)* магазин ніяк не може відкрити сам себе. Це очевидна пасивна дія. Натомість у реченні «Маленька дитина щоранку самостійно вмивається» *(A small child washes itself independently every morning)* дитина — це жива істота, яка свідомо виконує реальну дію над самою собою. Тому в цьому випадку слово «вмивається» є класичним зворотним дієсловом, а не пасивом. Однак у цьому чіткому граматичному правилі є свої цікаві та дуже поширені винятки. Деякі специфічні дієслова із суфіксом **-ся** використовуються людьми настільки часто, що носії мови повністю забули про їхнє первісне пасивне походження. Вони поступово стали абсолютно самостійними словами зі своїм власним, незалежним лексичним значенням. Найяскравіші та найпотрібніші для вас приклади — це популярні дієслова **знаходитися** *(to be located)*, **називатися** *(to be called)* та **вважатися** *(to be considered)*. Коли ви впевнено кажете «Національний історичний музей знаходиться в центрі міста», ви зовсім не думаєте про те, що хтось його там постійно «знаходить». Так само звичні фрази «Це мальовниче місто історично називається Київ» або «Він справедливо вважається найкращим експертом» лунають абсолютно природно. Їх можна сміливо використовувати у своєму щоденному мовленні без жодного страху. Вони ніколи не прозвучать як важкий чи незграбний канцелярит, бо давно стали невіддільною частиною українського словника. Пасивні конструкції із суфіксом **-ся** мають свої повноцінні часові форми, як і будь-які інші дієслова. Вони можуть легко описувати різні ситуації в минулому, теперішньому та майбутньому часі. Проте важливо розуміти один тонкий нюанс. Такі слова зазвичай підкреслюють тривалий процес дії, а не фінальний чи остаточний результат. У теперішньому часі ми кажемо так: «Цей величезний житловий будинок зараз активно будується» *(This huge residential building is currently being built actively)*. У минулому часі форма дієслова закономірно змінюється: «Цей прекрасний будинок досить довго будувався» *(This beautiful house was being built for quite a long time)*. Для вираження тієї ж самої дії в майбутньому часі ми традиційно використовуємо складену дієслівну форму. Ми скажемо: «Новий сучасний будинок буде будуватися наступного року» *(A new modern house will be built next year)*. В усіх цих прикладах наша увага зосереджена саме на процесі, який розгортається в часі. <!-- INJECT_ACTIVITY: error-correction, Fix unnatural passive constructions by rewriting as active voice -->
</previous_context>
