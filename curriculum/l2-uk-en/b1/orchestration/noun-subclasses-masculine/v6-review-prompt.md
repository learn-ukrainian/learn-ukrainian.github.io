...
### М'яка група
Більшість питомо українських професій на **-ар** мають **ненаголошений** суфікс (наголос падає на корінь слова) або наголос, який **переходить** із суфікса на закінчення (наприклад: буквар — букваря). Такі слова завжди і без винятків належать до м'якої групи.
...
**PIPELINE NOTE — Word count: 4690 words** (calculated deterministically by the pipeline, NOT by the writer. This number is CORRECT. Do NOT estimate your own word count — use this number for the Structural integrity dimension.)
...
Verified: 1693 words | Not found: 58 words
...
Words NOT in VESUM (may be errors, proper nouns, or valid words missing from dict):
  ...
  ✗ бодна — NOT IN VESUM
  ✗ гончарам — NOT IN VESUM
  ✗ гончаре — NOT IN VESUM
  ✗ гончари — NOT IN VESUM
  ✗ гончаром — NOT IN VESUM
  ✗ гончару — NOT IN VESUM
  ✗ горожанин — NOT IN VESUM
  ...
  ✗ сес — NOT IN VESUM
  ✗ столярем — NOT IN VESUM

All 1693 other words are confirmed to exist in VESUM.
