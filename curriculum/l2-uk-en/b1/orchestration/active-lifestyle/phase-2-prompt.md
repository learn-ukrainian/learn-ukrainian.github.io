...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/research/active-lifestyle-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/active-lifestyle.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b1/active-lifestyle.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Активний відпочинок** (b1 track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Історія та культура | 1000 | 1500 |
| Сучасний активний стиль життя | 1000 | 1500 |
| Граматика та типові помилки | 800 | 1200 |
| Практичні сценарії | 600 | 900 |
| Підсумок | 200 | 300 |
| **Total** | **4000** | **6000** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b1/meta/active-lifestyle.yaml`. Go through EVERY `points:` item in EVERY section:
