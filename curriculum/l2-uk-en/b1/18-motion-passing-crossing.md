...
**Правильна форма:** Я **пройшов** повз магазин.
...
**Треба:** Ми обійшли навколо будівлі.
...
**Коректно:** Я перейшов через дорогу пішки.
...
1. **Префікс пере-** — перетинання простору (crossing over) з прийменником **через**.

2. **Префікс про-** — рух повз або крізь (passing by/through) з прийменниками **повз/через**.

3. **Префікс об-** — обхід навколо (going around) з прийменниками **навколо/довкола**.
