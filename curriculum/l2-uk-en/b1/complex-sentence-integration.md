<!-- SCOPE
Covers: поєднання сурядності та підрядності, типи зв'язку у складному реченні, пунктуація, стилістика, розрізнення регістрів
Not covered:
  - Непряма мова → b1-39
Related: b1-37
-->
...
> [!history-bite] **Історичний вимір синтаксису**
...
> [!analysis] **Граматичний аналіз: Відтінки значень**
...
> [!myth-buster] **Руйнуємо міфи: Кома як структурний знак**
