...
:::tip[Найбезпечніша формула]
Якщо маєте вибір, починайте з моделі **ім'я + по батькові**: вона найстабільніша для офіційного звертання. Прізвище додавайте тільки тоді, коли форма прізвища вже точно відома або її підказує сам адресат.
:::
