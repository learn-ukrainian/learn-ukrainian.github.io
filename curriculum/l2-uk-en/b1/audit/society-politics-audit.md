...
| **Суспільство та політика** | ✅ | 64 | Included in Core |
| **Вступ** | ✅ | 533 | Included in Core |
| **Політичні інституції та влада** | ✅ | 901 | Included in Core |
| **Громадянське суспільство та історія** | ✅ | 886 | Included in Core |
| **Демократичний процес та дискурс** | ✅ | 917 | Included in Core |
| **Право, закон та громадянські права** | ✅ | 796 | Included in Core |
