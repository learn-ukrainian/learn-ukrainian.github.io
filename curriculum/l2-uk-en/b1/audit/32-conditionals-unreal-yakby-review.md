...
**Level:** B1 | **Module:** M32 | **Phase:** B1 | **Pedagogy:** TTT | **Target:** 1500
**Naturalness:** 9/10 (PASS)
**Overall Status:** ❌ FAIL
**Generated:** 2026-01-26 22:27:04
...
**Required Types:** error-correction, fill-in, speaking, transformation
...
- **[INVALID_ACTIVITY_TYPE]** Invalid activity types in activity_hints: ['transformation', 'speaking']. Valid types: ['match-up', 'fill-in', 'quiz', 'true-false', 'group-sort', 'unjumble', 'error-correction', 'anagram', 'select', 'translate', 'cloze', 'mark-the-words', 'reading', 'essay-response', 'critical-analysis', 'comparative-study', 'authorial-intent']
