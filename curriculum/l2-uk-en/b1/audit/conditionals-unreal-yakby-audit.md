...
| **Умовні речення: нереальна умова (якби)** | ✅ | 105 | Included in Core |
| **Вступ** | ✅ | 853 | Included in Core |
| **Граматика та правила** | ✅ | 942 | Included in Core |
| **Культурний контекст** | ✅ | 869 | Included in Core |
| **Практика та типові помилки** | ✅ | 1079 | Included in Core |
| **Діалоги та застосування** | ✅ | 1041 | Included in Core |
