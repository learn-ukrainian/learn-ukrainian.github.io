...
| **Підрядні означальні: коли, що** | ✅ | 66 | Included in Core |
| **Вступ та Культурний контекст** | ✅ | 417 | Included in Core |
| **Часові підрядні: Коли** | ✅ | 940 | Included in Core |
| **З'ясувальні та означальні речення: Що** | ✅ | 1151 | Included in Core |
| **Порівняльний аналіз та типові помилки** | ✅ | 725 | Included in Core |
| **Практичне застосування: Діалоги** | ✅ | 691 | Included in Core |
