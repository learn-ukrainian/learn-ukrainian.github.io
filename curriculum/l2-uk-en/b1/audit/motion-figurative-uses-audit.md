...
| **Переносні значення дієслів руху** | ✅ | 91 | Included in Core |
| **Діагностика: Пряме та переносне значення** | ✅ | 573 | Included in Core |
| **Аналіз: Логіка префіксів та культурний код** | ✅ | 1309 | Included in Core |
| **Поглиблення: Пастки переносних значень** | ✅ | 788 | Included in Core |
| **Практика: Метафори в контексті** | ✅ | 930 | Included in Core |
| **Підсумок: Читання та рефлексія** | ✅ | 769 | Included in Core |