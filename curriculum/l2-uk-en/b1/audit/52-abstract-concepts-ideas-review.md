# Audit Report: M52 — 52-abstract-concepts-ideas.md
**Level:** B1 | **Module:** M52 | **Phase:** B1 | **Pedagogy:** PPP | **Target:** 1500
**Naturalness:** 9/10 (PASS)
**Overall Status:** ❌ FAIL
**Generated:** 2026-01-26 22:27:17
...
|---|------|-------|-------|-----|--------|
| 1 | quiz | Розуміння абстрактних концепцій | 8 | 8 | ✅ |
| 2 | match-up | Колокації — іменник + дієслово | 12 | 8 | ✅ |
| 3 | match-up | Синоніми та переклад | 12 | 8 | ✅ |
| 4 | group-sort | Групування за значенням | 18 | 12 | ✅ |
...
| 12 | mark-the-words | Знайдіть абстрактні іменники | 10 | 6 | ✅ |
...
| **Вступ** | ✅ | 88 | Included in Core |
| **Вивчення слів** | ⚪️ | 303 | Skipped |
| **Вживання** | ⚪️ | 428 | Skipped |
