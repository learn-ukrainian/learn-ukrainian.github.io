...
**Required Types:** error-correction, fill-in, match-up, translate
...
| **Підрядні означальні: де, куди, звідки** | ✅ | 132 | Included in Core |
| **Вступ та діагностика** | ✅ | 991 | Included in Core |
| **Теорія: Тріада просторових відношень** | ✅ | 1630 | Included in Core |
| **Поглиблення та робота над помилками** | ✅ | 1805 | Included in Core |
| **Культурна географія України** | ✅ | 1131 | Included in Core |
| **Практика та інтеграція** | ✅ | 1409 | Included in Core |
| **Підсумок** | ✅ | 332 | Included in Core |