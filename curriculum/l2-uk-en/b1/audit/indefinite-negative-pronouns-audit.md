...
| **Невизначені та заперечні займенники** | ✅ | 91 | Included in Core |
| **Вступ: Логіка невизначеності** | ✅ | 749 | Included in Core |
| **Реальна невизначеність: Займенники з часткою -сь** | ✅ | 1090 | Included in Core |
| **Гіпотетична та парціальна невизначеність: -небудь та де-** | ✅ | 980 | Included in Core |
| **Абсолютне заперечення: Займенники з ні-** | ✅ | 930 | Included in Core |
| **Практикум: Контрасти та розв'язання помилок** | ✅ | 858 | Included in Core |
