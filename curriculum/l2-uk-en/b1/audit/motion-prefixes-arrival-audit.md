# Audit Report: M36 — motion-prefixes-arrival.md
**Level:** B1 | **Module:** M36 | **Phase:** B1.3 | **Pedagogy:** PPP | **Target:** 4000
**Overall Status:** ❌ FAIL
**Generated:** 2026-04-10 21:26:16
...
- **[SALAD_EXCESSIVE_INLINE_GLOSSES]** paragraph has 10 inline **term** (gloss) markers across 8 sentence(s) — too dense; move to vocabulary section or convert to UK paragraph + translation block
...
- **[SALAD_EXCESSIVE_INLINE_GLOSSES]** paragraph has 10 inline **term** (gloss) markers across 10 sentence(s) — too dense; move to vocabulary section or convert to UK paragraph + translation block
  - FIX: Convert inline-gloss paragraphs to monolingual Ukrainian paragraphs followed by a blockquote + italic English translation block. See docs/best-practices/language-salad.md.
- **[SALAD_EXCESSIVE_INLINE_GLOSSES]** paragraph has 10 inline **term** (gloss) markers across 10 sentence(s) — too dense; move to vocabulary section or convert to UK paragraph + translation block
  - FIX: Convert inline-gloss paragraphs to monolingual Ukrainian paragraphs followed by a blockquote + italic English translation block. See docs/best-practices/language-salad.md.
...
- **Richness:** ❌ 64% < 95% min (grammar) - REWRITE needed
...
|---|---|---|---|
| **Intro/Narrative** | ✅ | 782 | Included in Core |
| **Префікс при-: прибуття** | ✅ | 1262 | Included in Core |
| **Префікс до-: досягнення мети** | ✅ | 952 | Included in Core |
| **При- чи до-? Різниця у значенні** | ✅ | 850 | Included in Core |
| **Практика: прибуття та досягнення** | ✅ | 864 | Included in Core |
| **Підсумок: при- і до-** | ✅ | 315 | Included in Core |