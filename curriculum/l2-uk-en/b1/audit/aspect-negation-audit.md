# Audit Report: M10 — aspect-negation.md
**Level:** B1 | **Module:** M10 | **Phase:** B1.1 | **Pedagogy:** TTT | **Target:** 4000
**Overall Status:** ✅ PASS
**Generated:** 2026-02-24 12:08:43
...
- **Immersion:** 🇺🇦 99.0% (target 85-100% (B1.1 Aspect))
- **Richness:** ✅ 95% (grammar)
...
| **Вид у запереченні** | ✅ | 59 | Included in Core |
| **Вступ** | ✅ | 528 | Included in Core |
| **Пояснення граматики** | ✅ | 902 | Included in Core |
| **Практика та аналіз помилок** | ✅ | 1323 | Included in Core |
| **Культура та діалоги** | ✅ | 921 | Included in Core |
