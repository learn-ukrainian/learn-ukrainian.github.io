...
| **Допустові речення: хоча, незважаючи на** | ✅ | 48 | Included in Core |
| **Вступ та діагностика** | ✅ | 672 | Included in Core |
| **Граматичні основи та державний стандарт** | ✅ | 865 | Included in Core |
| **Стилістичні нюанси: попри та дарма що** | ✅ | 805 | Included in Core |
| **Практичний практикум: Робота над помилками** | ✅ | 871 | Included in Core |
| **Культурна інтеграція та дебати** | ✅ | 908 | Included in Core |
