...
- **Immersion:** 🇺🇦 98.8% (target 85-100% (B1.1 Aspect))
- **Richness:** ✅ 96% (grammar)
...
| **Вид у майбутньому часі** | ✅ | 92 | Included in Core |
| **Діагностичний тест** | ✅ | 641 | Included in Core |
| **Граматичне пояснення** | ✅ | 1244 | Included in Core |
| **Культурний та етнолінгвістичний контекст** | ✅ | 859 | Included in Core |
| **Практика та корекція помилок** | ✅ | 859 | Included in Core |
| **Продукція та підсумок** | ✅ | 575 | Included in Core |
