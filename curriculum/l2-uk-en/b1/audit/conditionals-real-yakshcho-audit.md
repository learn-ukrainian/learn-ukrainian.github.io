...
| **Умовні речення: реальна умова (якщо)** | ✅ | 66 | Included in Core |
| **Вступ: Реальні умови в мовленні** | ✅ | 618 | Included in Core |
| **Граматична презентація: Якщо та майбутній час** | ✅ | 999 | Included in Core |
| **Семантичні нюанси: Якщо проти Коли** | ✅ | 765 | Included in Core |
| **Практика: Культура, стилістика та лексика** | ✅ | 937 | Included in Core |
| **Діалоги та вироблення навичок** | ✅ | 649 | Included in Core |
