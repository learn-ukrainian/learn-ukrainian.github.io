...
| **Вид у минулому: одного разу vs щодня** | ✅ | 46 | Included in Core |
| **Тест: Два спогади** | ✅ | 614 | Included in Core |
| **Презентація: Теорія та культурний контекст** | ✅ | 1375 | Included in Core |
| **Грамматичні нюанси та типові помилки** | ✅ | 1194 | Included in Core |
| **Практика: Минуле в деталях** | ✅ | 1441 | Included in Core |
| **Підсумок: Резюме маркерів** | ✅ | 569 | Included in Core |