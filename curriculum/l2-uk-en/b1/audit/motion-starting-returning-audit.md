...
- **Immersion:** 🇺🇦 90.5% (target 85-100% (B1.2 Motion))
- **Richness:** ✅ 99% (grammar)
...
| **Рух: початок і повернення** | ✅ | 101 | Included in Core |
| **Вступ та Діагностика** | ✅ | 1050 | Included in Core |
| **Семантика префіксів за державним стандартом** | ✅ | 1627 | Included in Core |
| **Мовні нюанси та запобігання помилкам** | ✅ | 1633 | Included in Core |
| **Культурний контекст та транспортний етикет** | ✅ | 1199 | Included in Core |
| **Комплексна практика та підсумок** | ✅ | 959 | Included in Core |
