...
| **Пасивні конструкції: повна система** | ✅ | 97 | Included in Core |
| **Вступ та діагностичний тест** | ✅ | 647 | Included in Core |
| **Граматична система: три типи пасиву** | ✅ | 968 | Included in Core |
| **Культурний контекст: боротьба з «канцеляритом»** | ✅ | 832 | Included in Core |
| **Практика та корекція помилок** | ✅ | 1052 | Included in Core |
| **Діалоги та застосування в мовленні** | ✅ | 1000 | Included in Core |
| **Підсумок** | ✅ | 361 | Included in Core |