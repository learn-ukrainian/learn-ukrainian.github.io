# Audit Report: M22 — conditionals-real.md
**Level:** B1 | **Module:** M22 | **Phase:** B1.2 | **Pedagogy:** PPP | **Target:** 4000
**Overall Status:** ❌ FAIL
**Generated:** 2026-04-10 21:26:06
...
| 3 | match-up | match-up | 8 | 8 | ✅ |
| 4 | fill-in | fill-in | 8 | 8 | ✅ |
| 5 | unjumble | unjumble | 6 | 6 | ✅ |
| 6 | fill-in | fill-in | 8 | 8 | ✅ |
| 7 | error-correction | error-correction | 6 | 6 | ✅ |
| 8 | group-sort | group-sort | 8 | 6 | ✅ |
...
- **[COMPLEXITY_WORD_COUNT]** unjumble '' item 1 has 7 words (target: 9-16)
  - FIX: Adjust sentence length to 9-16 words to match B1 complexity.
- **[COMPLEXITY_WORD_COUNT]** unjumble '' item 2 has 7 words (target: 9-16)
  - FIX: Adjust sentence length to 9-16 words to match B1 complexity.
- **[COMPLEXITY_WORD_COUNT]** unjumble '' item 4 has 7 words (target: 9-16)
  - FIX: Adjust sentence length to 9-16 words to match B1 complexity.
- **[COMPLEXITY_WORD_COUNT]** unjumble '' item 6 has 7 words (target: 9-16)
  - FIX: Adjust sentence length to 9-16 words to match B1 complexity.
- **[COMPLEXITY]** group-sort '' has 8 items (target: 12-999)
  - FIX: Adjust number of items to sort to 12-999.
- **[PHASE_TRANSLATIONS_LOW]** Early B1 (B1 M01-M30) targets ~25% translated UK paragraphs — currently 0% (0/37)
  - FIX: 
...
- **Immersion:** 🇺🇦 93.6% (target 85-100% (B1.3-4 Complex))
...
| **Утворення умовного способу** | ✅ | 750 | Included in Core |
| **Реальна умова з якщо** | ✅ | 660 | Included in Core |
| **Умовний спосіб для ввічливості** | ✅ | 626 | Included in Core |
| **Практика: якщо-речення у спілкуванні** | ✅ | 792 | Included in Core |
| **Типові помилки** | ✅ | 428 | Included in Core |
| **Підсумок та перехід до M19** | ✅ | 374 | Included in Core |