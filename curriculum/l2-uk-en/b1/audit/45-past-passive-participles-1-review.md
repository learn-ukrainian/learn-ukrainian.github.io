...
**Level:** B1 | **Module:** M45 | **Phase:** B1 | **Pedagogy:** TTT | **Target:** 1500
...
**Required Types:** agreement, error-correction, fill-in, transformation
...
- **[INVALID_ACTIVITY_TYPE]** Invalid activity types in activity_hints: ['transformation', 'agreement']. Valid types: ['match-up', 'fill-in', 'quiz', 'true-false', 'group-sort', 'unjumble', 'error-correction', 'anagram', 'select', 'translate', 'cloze', 'mark-the-words', 'reading', 'essay-response', 'critical-analysis', 'comparative-study', 'authorial-intent']
