# Audit Report: M30 — purpose-shchob-past-form.md
**Level:** B1 | **Module:** M30 | **Phase:** B1.3a | **Pedagogy:** TTT | **Target:** 4000
**Overall Status:** ✅ PASS
**Generated:** 2026-02-25 10:43:58
...
**Required Types:** error-correction, fill-in, translate
...
| **Підрядні речення мети: щоб + минула форма** | ✅ | 61 | Included in Core |
| **Вступ** | ✅ | 618 | Included in Core |
| **Граматична презентація** | ✅ | 1045 | Included in Core |
| **Типові помилки та контраст** | ✅ | 953 | Included in Core |
| **Культурний контекст та діалоги** | ✅ | 1105 | Included in Core |
| **Практика та підсумок** | ✅ | 542 | Included in Core |
