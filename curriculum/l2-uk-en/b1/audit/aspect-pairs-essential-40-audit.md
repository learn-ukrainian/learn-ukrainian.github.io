...
| **Видові пари: 40 найважливіших** | ✅ | 70 | Included in Core |
| **Вступ та діагностика** | ✅ | 724 | Included in Core |
| **Морфологія та типи творення** | ✅ | 891 | Included in Core |
| **Системний огляд 40 пар** | ✅ | 810 | Included in Core |
| **Культурний та фразеологічний вимір** | ✅ | 510 | Included in Core |
| **Корекція типових помилок** | ✅ | 733 | Included in Core |
| **Підсумок та практичне застосування** | ✅ | 489 | Included in Core |