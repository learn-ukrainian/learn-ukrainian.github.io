...
**Level:** B1 | **Module:** M36 | **Phase:** B1 | **Pedagogy:** TTT | **Target:** 1500
**Naturalness:** 9/10 (PASS)
**Overall Status:** ❌ FAIL
**Generated:** 2026-01-26 22:27:07
...
**Required Types:** fill-in, sentence-combining, transformation, translation
...
|---|------|-------|-------|-----|--------|
| 1 | quiz | Причинові та наслідкові сполучники | 8 | 8 | ✅ |
| 2 | match-up | Причина та наслідок | 12 | 8 | ✅ |
| 3 | fill-in | Доповніть речення правильним сполучником | 14 | 8 | ✅ |
| 4 | true-false | Правда чи неправда? | 12 | 8 | ✅ |
| 5 | group-sort | Розподіліть сполучники за функцією | 15 | 12 | ✅ |
...
| 9 | mark-the-words | Позначте причинові та наслідкові сполучники | 8 | 6 | ✅ |
| 10 | select | Виберіть усі граматично правильні речення | 6 | 6 | ✅ |
| 11 | translate | Перекладіть на українську мову | 6 | 6 | ✅ |
...
- **[INVALID_ACTIVITY_TYPE]** Invalid activity types in activity_hints: ['transformation', 'sentence-combining', 'translation']. Valid types: ['match-up', 'fill-in', 'quiz', 'true-false', 'group-sort', 'unjumble', 'error-correction', 'anagram', 'select', 'translate', 'cloze', 'mark-the-words', 'reading', 'essay-response', 'critical-analysis', 'comparative-study', 'authorial-intent']
