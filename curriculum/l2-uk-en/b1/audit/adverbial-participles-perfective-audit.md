...
| **Дієприслівники доконаного виду** | ✅ | 50 | Included in Core |
| **Вступ** | ✅ | 507 | Included in Core |
| **Граматика: Формування та значення** | ✅ | 1054 | Included in Core |
| **Аналіз помилок та обмеження** | ✅ | 1064 | Included in Core |
| **Лексика та культурний контекст** | ✅ | 1077 | Included in Core |
| **Практичне застосування та підсумок** | ✅ | 656 | Included in Core |
