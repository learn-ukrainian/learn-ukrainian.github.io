...
| **Вид у наказовому способі** | ✅ | 88 | Included in Core |
| **Вступ та діагностика** | ✅ | 675 | Included in Core |
| **Граматика: Стверджувальні конструкції** | ✅ | 1487 | Included in Core |
| **Граматика: Заперечення та застереження** | ✅ | 1337 | Included in Core |
| **Практика та розбір помилок** | ✅ | 1176 | Included in Core |
| **Культурний код та діалоги** | ✅ | 837 | Included in Core |
| **Підсумок** | ✅ | 338 | Included in Core |