...
| **Контрольна точка: Просунута граматика** | ✅ | 65 | Included in Core |
| **Вступ та огляд компетенцій** | ✅ | 516 | Included in Core |
| **Навичка 1: Дієприслівники: Динаміка та помилки** | ✅ | 579 | Included in Core |
| **Навичка 2: Дієприкметники: Активні форми та запозичення** | ✅ | 586 | Included in Core |
| **Навичка 3: Пасивні конструкції та безособові форми** | ✅ | 693 | Included in Core |
| **Навичка 4: Демінутиви та мовна ментальність** | ✅ | 644 | Included in Core |
| **Навичка 5: Числівники: Збірні та дробові** | ✅ | 598 | Included in Core |
| **Інтеграція та підсумок фази** | ✅ | 461 | Included in Core |
