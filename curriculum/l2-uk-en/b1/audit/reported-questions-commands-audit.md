...
| **Непрямі питання та накази** | ✅ | 93 | Included in Core |
| **Діагностичний тест** | ✅ | 706 | Included in Core |
| **Граматичне пояснення** | ✅ | 1777 | Included in Core |
| **Практичні вправи** | ✅ | 1341 | Included in Core |
| **Культурний контекст та діалоги** | ✅ | 960 | Included in Core |
| **Підсумок та самоперевірка** | ✅ | 472 | Included in Core |