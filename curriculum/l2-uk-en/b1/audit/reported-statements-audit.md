...
| **Непряма мова: твердження** | ✅ | 73 | Included in Core |
| **Вступ** | ✅ | 493 | Included in Core |
| **Діагностика** | ✅ | 516 | Included in Core |
| **Граматичне пояснення** | ✅ | 1222 | Included in Core |
| **Практика трансформації** | ✅ | 1083 | Included in Core |
| **Комунікація та культура** | ✅ | 855 | Included in Core |
