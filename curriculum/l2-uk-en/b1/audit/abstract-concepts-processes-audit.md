...
| usage_examples | 71 | 15 | 100% | 20% | 20.0% |
...
| **Абстрактні концепції: процеси та зміни** | ✅ | 63 | Included in Core |
| **Вступ** | ✅ | 417 | Included in Core |
| **Основна лексика: Тренди та динаміка** | ✅ | 955 | Included in Core |
| **Словотворення та граматичне вживання** | ✅ | 696 | Included in Core |
| **Аналітичне читання та аудіювання** | ✅ | 1027 | Included in Core |
| **Комунікація та обговорення** | ✅ | 881 | Included in Core |
| **Підсумок та закріплення** | ✅ | 285 | Included in Core |