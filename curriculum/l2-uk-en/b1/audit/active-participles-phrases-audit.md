...
| **Активні дієприкметники та їхній стиль** | ✅ | 70 | Included in Core |
| **Вступ: Природа дієприкметника** | ✅ | 809 | Included in Core |
| **Морфологія та мовна норма** | ✅ | 1262 | Included in Core |
| **Боротьба з канцеляритом** | ✅ | 1092 | Included in Core |
| **Синтаксис та трансформації** | ✅ | 1154 | Included in Core |
| **Практика та стилістичний підсумок** | ✅ | 480 | Included in Core |
