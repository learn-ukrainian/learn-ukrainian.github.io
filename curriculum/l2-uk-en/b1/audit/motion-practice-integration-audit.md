...
| **Дієслова руху: практика та інтеграція** | ✅ | 48 | Included in Core |
| **Вступ: Перевірка та мотивація** | ✅ | 496 | Included in Core |
| **Пояснення: Матриця навігації та прийменників** | ✅ | 1471 | Included in Core |
| **Культурний контекст: Шляхи та ідіоми** | ✅ | 1027 | Included in Core |
| **Практика: Київська Одіссея** | ✅ | 914 | Included in Core |
| **Підсумок та застосування** | ✅ | 497 | Included in Core |