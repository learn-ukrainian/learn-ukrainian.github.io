...
| **Рух: Прибуття та вихід** | ✅ | 72 | Included in Core |
| **Вступ** | ✅ | 580 | Included in Core |
| **Тест та діагностика** | ✅ | 668 | Included in Core |
| **Граматична концепція: Префікси при-, ви-, в-** | ✅ | 1114 | Included in Core |
| **Практика та усунення помилок** | ✅ | 971 | Included in Core |
| **Культурний код та ідіоматика** | ✅ | 820 | Included in Core |
