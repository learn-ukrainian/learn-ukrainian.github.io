...
- **Immersion:** 🇺🇦 96.5% (target 85-100% (B1.5-6 Vocab))
- **Richness:** ✅ 99% (grammar)
- **Grammar:** ✅ Validated (6/43 confirmed)
...
|---|---|---|---|
| **Пасивні дієприкметники: коротка форма** | ⚪️ | 111 | Skipped |
| **Тест** | ⚪️ | 100 | Skipped |
| **Пояснення** | ⚪️ | 417 | Skipped |
| **Практика** | ⚪️ | 170 | Skipped |
| **Діалоги** | ✅ | 529 | Included in Core |
