...
| **Інтеграція складних речень** | ✅ | 72 | Included in Core |
| **Діагностика та вступ** | ✅ | 829 | Included in Core |
| **Граматичні основи та типи зв'язку** | ✅ | 913 | Included in Core |
| **Культура, ритм та пунктуація** | ✅ | 755 | Included in Core |
| **Практичне застосування та стилістика** | ✅ | 905 | Included in Core |
| **Творча майстерня редактора** | ✅ | 782 | Included in Core |
