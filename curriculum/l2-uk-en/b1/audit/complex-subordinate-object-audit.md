# Audit Report: M76 — complex-subordinate-object.md
**Level:** B1 | **Module:** M76 | **Phase:** B1.7 | **Pedagogy:** PPP | **Target:** 4000
**Overall Status:** ❌ FAIL
**Generated:** 2026-04-11 18:42:47
...
- **[STATE_STANDARD_LOW_IMMERSION]** Module 76 has 34.2% immersion (target: 90.0%+)
...
- **Immersion:** ❌ 34.2% LOW (target 85-100% (B1.7-8 Ukraine))
...
|---|---|---|---|
| **Intro/Narrative** | ✅ | 1121 | Included in Core |
| **З'ясувальні підрядні частини (~935 words total)** | ✅ | 1086 | Included in Core |
| **Сполучник vs сполучне слово (~660 words total)** | ✅ | 983 | Included in Core |
| **Пунктуація та побудова (~715 words total)** | ✅ | 903 | Included in Core |
| **З'ясувальні речення у мовленні (~825 words total)** | ✅ | 1232 | Included in Core |
| **Підсумок та перехід до M68 (~495 words total)** | ✅ | 718 | Included in Core |