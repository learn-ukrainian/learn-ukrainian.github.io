...
**Required Types:** fill-in, quiz, translate
...
| **Пасивні дієприкметники: коротка форма** | ✅ | 72 | Included in Core |
| **Вступ: Оголошення навколо нас** | ✅ | 619 | Included in Core |
| **Граматичний аналіз: Утворення та синтаксис** | ✅ | 947 | Included in Core |
| **Культурний та історичний контекст** | ✅ | 739 | Included in Core |
| **Практика: Від теорії до автоматизму** | ✅ | 897 | Included in Core |
| **Комунікативні вправи та підсумок** | ✅ | 761 | Included in Core |
