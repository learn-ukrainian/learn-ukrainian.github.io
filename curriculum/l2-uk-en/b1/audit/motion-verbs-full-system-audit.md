...
| **Дієслова руху: повна система** | ✅ | 49 | Included in Core |
| **Вступ** | ✅ | 994 | Included in Core |
| **Презентація 14 пар дієслів** | ✅ | 2207 | Included in Core |
| **Аналіз типових помилок** | ✅ | 923 | Included in Core |
| **Культурний код: Логістика та залізниця** | ✅ | 753 | Included in Core |
| **Синтез та практичне застосування** | ✅ | 820 | Included in Core |
