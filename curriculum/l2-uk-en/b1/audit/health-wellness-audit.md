...
| **Здоров'я та самопочуття** | ✅ | 138 | Included in Core |
| **Вступ** | ✅ | 753 | Included in Core |
| **Термінологія та симптоми** | ✅ | 936 | Included in Core |
| **Культурний контекст: Протяг та траволікування** | ✅ | 1111 | Included in Core |
| **Практика: У лікаря та в аптеці** | ✅ | 1064 | Included in Core |
| **Підсумок та поради** | ✅ | 605 | Included in Core |
