...
|--------|-------|--------|-------|--------|--------------|
| collocations | 27 | 20 | 100% | 25% | 25.0% |
| usage_examples | 59 | 15 | 100% | 20% | 20.0% |
...
| **Абстрактні концепції: ідеї та думки** | ✅ | 36 | Included in Core |
| **Вступ** | ✅ | 530 | Included in Core |
| **Лексичний блок** | ✅ | 954 | Included in Core |
| **Граматика та синтаксис** | ✅ | 642 | Included in Core |
| **Культурний контекст** | ✅ | 761 | Included in Core |
| **Практика та застосування** | ✅ | 1009 | Included in Core |
