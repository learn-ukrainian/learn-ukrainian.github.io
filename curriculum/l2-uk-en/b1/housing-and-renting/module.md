...
Почнімо з базових назв. **Квартира** — найчастіше слово для apartment. **Будинок** може означати house або building залежно від контексту. **Приватний будинок** — окремий house, де живе одна родина або кілька людей без багатоквартирної структури. **Гуртожиток** — dormitory; він важливий для студентського контексту. За кількістю кімнат кажемо **однокімнатна квартира**, **двокімнатна квартира**, **трикімнатна квартира**. У скорочених оголошеннях це часто стає **1к**, **2к**, **3к**.

Кімнати й частини житла треба вчити як групу, бо вони постійно повторюються в описах: **вітальня**, **спальня**, **кухня**, **ванна кімната**, **туалет**, **коридор**, **балкон**, **комора**, **підвал**, **горище**. У розмові можна сказати **велика кухня**, **світла спальня**, **простора вітальня**, **окремий туалет**, **суміжний санвузол**. Слово **санвузол** корисне для оголошень: воно означає bathroom/toilet area; **суміжний санвузол** — ванна і туалет разом, **роздільний санвузол** — окремо.
...
> [!warning]
> **Ремонт** може означати repair або renovation. У житлових оголошеннях **євроремонт** зазвичай означає "modern renovated interior", але це не офіційний стандарт якості. Сприймайте це як рекламний маркер, а не гарантію.
...
Перше слово **здається** тут означає "is available for rent" або "is being rented out". Воно не означає "seems" у цьому контексті, хоча форма така сама, як у реченні **мені здається**. Контекст вирішує. Якщо після **здається** стоїть тип житла, район, ціна, поверх, це оголошення про оренду.
...
Тут **оренда 1к квартири** — називна фраза без дієслова. **Новобудова** означає new building. **Індивідуальне опалення** часто приваблює орендарів, бо людина може контролювати тепло. **Під ключ** означає "готова до заселення": можна зайти й жити без великої підготовки. Але все одно треба уточнити, що саме входить: меблі, техніка, посуд, постіль, інтернет, паркування.
...
Після переїзду найчастіше потрібна мова проблем. Тут важливо говорити не емоційно, а точно. **Протікає кран** — water is leaking from the tap. **Протікає труба** — pipe is leaking. **Не працює опалення**, **немає гарячої води**, **зламалася пральна машина**, **не працює ліфт**, **у кімнаті цвіль**, **сусіди шумлять**, **вибиває світло**, **замок не зачиняється**. Такі фрази дають власникові або службі зрозумілу дію.
