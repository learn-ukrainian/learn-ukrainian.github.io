...
|-------|----------|----------|
| **по-перше** | firstly | послідовність, початок переліку |
| **по-друге** | secondly | послідовність, продовження |
| **по-третє** | thirdly | послідовність, продовження |
| **насамперед** | first of all, first and foremost | підкреслює першочерговість |
| **передусім** | primarily, above all | підкреслює пріоритет (формально) |
| **крім того** | besides, in addition | додавання нової інформації |
| **додатково** | additionally | додавання (більш нейтральне) |
| **більше того** | moreover, what's more | посилення аргументу |
| **не кажучи вже про** | not to mention, let alone | підкреслює очевидність додаткового |
| **тим паче** | especially since, all the more | посилення з причиною |
| **тим більше** | even more so, all the more | посилення з причиною |
| **з іншого боку** | on the other hand | контраст, альтернативний погляд |
| **натомість** | instead, on the contrary | заміна або протиставлення |
| **водночас** | at the same time, simultaneously | паралельність, контраст |
| **попри це** | despite this, nevertheless | всупереч |
| **незважаючи на** | despite, regardless of | всупереч + іменник |
| **внаслідок** | as a result of, due to | причинно-наслідковий зв'язок |
| **у результаті** | as a result | наслідок дії |
| **підсумовуючи** | to summarize, summing up | висновок (дієприслівник) |
| **загалом кажучи** | generally speaking | загальна оцінка |
| **у підсумку** | in the end, ultimately | фінальний результат |
| **нарешті** | finally, at last | останній пункт переліку |
| **насамкінець** | in conclusion, lastly | завершення (формально) |
| **на завершення** | in conclusion | завершення доповіді |
| **врешті-решт** | after all, in the end | остаточний висновок |
| **отже** | so, therefore | логічний наслідок |
| **таким чином** | thus, in this way | формальний висновок |
| **зокрема** | in particular, specifically | конкретизація |
| **а саме** | namely, that is | уточнення |
| **наприклад** | for example | приклад (скорочено: напр.) |
| **інакше кажучи** | in other words | перефразування |
| **іншими словами** | in other words | перефразування (альтернатива) |
| **тобто** | that is, i.e. | пояснення |
| **точніше** | more precisely | уточнення |
| **одним словом** | in a word, in short | короткий підсумок |
...
>
> **Практика читання:**
> - 📰 [Українська правда](https://www.pravda.com.ua) — аналітичні статті з дискурсивними маркерами
> - 📖 [Тиждень](https://tyzhden.ua) — аналітика та есе
>
> **Відео:**
> - 📺 [Hromadske](https://www.youtube.com/@haborets) — аналітичні програми
> - 📺 [Українські TEDx виступи](https://www.youtube.com/results?search_query=tedx+ukraine+ukrainian) — структуровані доповіді
