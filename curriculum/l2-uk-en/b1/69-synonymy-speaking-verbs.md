...
|-------|--------|----------|-----|----------|
| **казати** | /kɑˈzɑtɪ/ | to say | дієсл. (НДВ) | казати правду, ДВ: сказати |
| **говорити** | /ɦɔvɔˈrɪtɪ/ | to speak, talk | дієсл. (НДВ) | говорити про, говорити українською |
| **розповідати** | /rɔzpɔviˈdɑtɪ/ | to tell, narrate | дієсл. (НДВ) | розповідати історію, ДВ: розповісти |
| **повідомляти** | /pɔviˈdɔmlʲɑtɪ/ | to inform, report | дієсл. (НДВ) | повідомляти про, ДВ: повідомити |
| **пояснювати** | /pɔjɑsˈnʲuvɑtɪ/ | to explain | дієсл. (НДВ) | пояснювати причини, ДВ: пояснити |
| **описувати** | /ɔpɪˈsuvɑtɪ/ | to describe | дієсл. (НДВ) | описувати ситуацію, ДВ: описати |
| **стверджувати** | /stvɛrˈdʒuvɑtɪ/ | to claim, assert | дієсл. (НДВ) | стверджувати, що... (формально) |
| **заявляти** | /zɑjɑvˈlʲɑtɪ/ | to declare, state | дієсл. (НДВ) | офіційно заявляти, ДВ: заявити |
| **оголошувати** | /ɔɦɔˈlɔʃuvɑtɪ/ | to announce | дієсл. (НДВ) | оголошувати результати, ДВ: оголосити |
| **констатувати** | /kɔnstɑˈtuvɑtɪ/ | to state (fact) | дієсл. (НДВ) | констатувати факт (формально) |
| **зауважувати** | /zɑuˈvɑʒuvɑtɪ/ | to remark, note | дієсл. (НДВ) | слушно зауважувати, ДВ: зауважити |
| **згадувати** | /zɦɑˈduvɑtɪ/ | to mention | дієсл. (НДВ) | мимохідь згадувати, ДВ: згадати |
| **нагадувати** | /nɑɦɑˈduvɑtɪ/ | to remind | дієсл. (НДВ) | нагадувати про дедлайн, ДВ: нагадати |
| **додавати** | /dɔˈdɑvɑtɪ/ | to add | дієсл. (НДВ) | додавати до сказаного, ДВ: додати |
| **уточнювати** | /utɔtʃˈnʲuvɑtɪ/ | to clarify, specify | дієсл. (НДВ) | уточнювати деталі, ДВ: уточнити |
| **наголошувати** | /nɑɦɔˈlɔʃuvɑtɪ/ | to emphasize | дієсл. (НДВ) | наголошувати на важливості, ДВ: наголосити |
| **підкреслювати** | /pidˈkrɛslʲuvɑtɪ/ | to stress, underline | дієсл. (НДВ) | підкреслювати значення, ДВ: підкреслити |
| **наполягати** | /nɑpɔˈlʲɑɦɑtɪ/ | to insist | дієсл. (НДВ) | наполягати НА + місц. (без пари ДВ) |
| **переконувати** | /pɛrɛˈkɔnuvɑtɪ/ | to persuade | дієсл. (НДВ) | переконувати когось, ДВ: переконати |
| **погоджуватися** | /pɔɦɔˈdʒuvɑtɪsʲɑ/ | to agree | дієсл. (НДВ) | погоджуватися З + оруд., ДВ: погодитися |
| **запитувати** | /zɑˈpɪtuvɑtɪ/ | to ask | дієсл. (НДВ) | запитувати когось, ДВ: запитати |
| **відповідати** | /vidpɔviˈdɑtɪ/ | to answer, reply | дієсл. (НДВ) | відповідати на запитання, ДВ: відповісти |
| **питати** | /pɪˈtɑtɪ/ | to ask (informal) | дієсл. (НДВ) | питати когось, ДВ: спитати |
| **заперечувати** | /zɑpɛˈrɛtʃuvɑtɪ/ | to deny, object | дієсл. (НДВ) | заперечувати факт, ДВ: заперечити |
| **підтверджувати** | /pidˈtvɛrdʒuvɑtɪ/ | to confirm | дієсл. (НДВ) | підтверджувати інформацію, ДВ: підтвердити |
| **сперечатися** | /spɛrɛˈtʃɑtɪsʲɑ/ | to argue, dispute | дієсл. (НДВ) | сперечатися з кимось |
| **обіцяти** | /ɔbiˈt͡sʲɑtɪ/ | to promise | дієсл. (НДВ) | обіцяти допомогу, ДВ: пообіцяти |
| **пропонувати** | /prɔpɔˈnuvɑtɪ/ | to suggest, propose | дієсл. (НДВ) | пропонувати ідею, ДВ: запропонувати |
| **радити** | /ˈrɑdɪtɪ/ | to advise | дієсл. (НДВ) | радити комусь, ДВ: порадити |
| **попереджати** | /pɔpɛˈrɛdʒɑtɪ/ | to warn | дієсл. (НДВ) | попереджати про небезпеку, ДВ: попередити |
| **хвалити** | /xvɑˈlɪtɪ/ | to praise | дієсл. (НДВ) | хвалити когось, ДВ: похвалити |
| **критикувати** | /krɪtɪˈkuvɑtɪ/ | to criticize | дієсл. (НДВ) | критикувати рішення |
| **скаржитися** | /ˈskɑrʒɪtɪsʲɑ/ | to complain | дієсл. (НДВ) | скаржитися на щось |
| **вітати** | /viˈtɑtɪ/ | to greet | дієсл. (НДВ) | вітати гостей, ДВ: привітати |
| **дякувати** | /dʲɑˈkuvɑtɪ/ | to thank | дієсл. (НДВ) | дякувати комусь, ДВ: подякувати |
...
>
> **Практика слухання:**
> - 📺 [Засідання Верховної Ради](https://rada.gov.ua) — офіційний канал
> - 📺 [Інтерв'ю на Громадському](https://www.youtube.com/@hromadske) — різні стилі мовлення
>
> **Читання:**
> - 📰 [Українська правда](https://www.pravda.com.ua) — новинні репортажі
> - 📖 [Літакцент](https://litakcent.com) — літературна критика
