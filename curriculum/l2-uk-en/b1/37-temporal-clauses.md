...
|-------|----------|----------|
| коли | when | універсальний часовий сполучник |
| після того як | after | послідовність подій |
| перш ніж | before | попередність дії |
| перед тим як | before | синонім «перш ніж» |
| до того як | before | формальний варіант |
| поки | while | тривалість дії |
| поки не | until | очікування результату |
| доки | while, as long as | синонім «поки» |
| доки не | until | синонім «поки не» |
| як тільки | as soon as | негайна реакція |
| щойно | just, barely | миттєвість дії |
| ледве | scarcely, hardly | ледве встиг |
| мало не | almost | ледве не |
| у той час як | while, whereas | паралельність дій |
| в міру того як | as, to the extent that | поступовість зміни |
| у той момент коли | at the moment when | точний момент |
| відтоді як | since then | від минулого моменту |
| з тих пір як | since | синонім «відтоді як» |
| до тих пір поки | until | до досягнення результату |
| весь час поки | the whole time while | увесь період |
| кожного разу коли | every time when | регулярність дії |
| щоразу як | each time when | синонім |
| одночасність | simultaneity | паралельність дій (ім., ж.р.) |
| послідовність | sequence | порядок дій (ім., ж.р.) |
| попередність | precedence | раніше за іншу дію (ім., ж.р.) |
