...
Держкіно має у своєму каталозі кінофільм «Літа молодії», для якого було створено пісню (відому за першим рядком «Рідна мати моя»). Каталог Держкіно розрізняє рік виробництва стрічки — 1958-й — і прем’єру в Україні 9 березня 1959 року. Тут корисно розділити авторство й канал. Малишко є автором слів, Майборода — музики; вихід фільму в прокат 1959 року став медійним шляхом до аудиторії. Подальші записи, концерти або родинні виконання можуть створювати нові рамки. Жодна з них не робить пісню безіменною «народною», хоча її впізнаваність може бути дуже широкою.

Якщо ви переходите до необов’язкового самостійного читання, відкрийте [повний текст «Пісні про рушник»](https://www.ukrlib.com.ua/books/printit.php?tid=961). Під час читання позначте звертання, образ дороги та місця повернення ключової конструкції. Спроба подати композиційну схему й коротке пояснення функції повтору допоможе втримати увагу на будові твору, а не на механічному переказі строф.

Працюючи з наданим фрагментом тексту або з необов’язковим повним текстом, важливо розрізняти три явища. **Лексичний повтор** дослівно повертає слово або словосполучення. **Синтаксичний паралелізм** відтворює будову вислову з іншою лексикою. **Тяглість адресата** може зберігатися без нового вокатива — через форми другої особи та присвійні слова **ти**, **твоя**, **твої**. Тому твердження про повтор треба прив’язувати до конкретної мовної ознаки: не казати, що початкова фраза звучить знову, якщо повертається лише синтаксична модель або зв’язок із матір’ю. Для додаткової практики можна скласти короткий запис у форматі «ознака — приклад — функція», а вже потім вирішувати, чи повтор утримує адресата, поєднує образи дороги й пам’яті або виконує кілька цих функцій одночасно.
