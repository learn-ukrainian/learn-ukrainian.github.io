...
Пізні збірки додають до картини офіційне визнання: Шевченківську премію за «Далекі орбіти» та Державну премію СРСР за «Дорогу під яворами». Нагорода, однак, не пояснює художнього оновлення. У літературній історії його пов’язують із розмовною мовою й народною етикою на противагу казенній риториці. Цю зміну найкраще обговорювати через зіставлення текстів різних періодів: однакові формальні показники — тип звертання, довжина фрази, повтор, образний ряд — роблять порівняння послідовним.
...
Перший прохід читання суто описовий. Назвіть адресата, присвійний зв’язок і порядок слів у короткому фрагменті. У повному тексті позначте місця, де повертається та сама синтаксична конструкція, а потім зведіть їх до схеми «звертання — дія — образ дороги — повтор». Різні читачі можуть бачити ті самі композиційні частини, але по-різному тлумачити їхню емоційну функцію.

Після схеми можна інтерпретувати. Наприклад, повтор може сповільнювати розповідь, підсилювати звертання або переводити приватний голос у ритуальний регістр. Це альтернативні прочитання однієї конструкції. Формула «звертання повертається після нового образу» точніша за загальне «пісня дуже щира», бо називає конкретний композиційний прийом і відкриває простір для дискусії про його функцію.
