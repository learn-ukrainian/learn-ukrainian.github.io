...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/mykola-leontovych-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/mykola-leontovych.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/mykola-leontovych.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Микола Леонтович: Автор «Щедрика»** (bio track).
...
|---------|--------|---------------------|
| Вступ — Пісня, що підкорила світ | 600 | 900 |
| Ранні роки: Подільське коріння (1877-1892) | 600 | 900 |
| Освіта та ранні композиторські спроби (1892-1903) | 600 | 900 |
| Педагогічна діяльність: Вчитель і хормейстер (1903-1917) | 700 | 1050 |
| Творча лабораторія: Народження шедеврів | 700 | 1050 |
| Революційні роки: Доба УНР та культурна дипломатія (1917-1921) | 700 | 1050 |
| Загибель та пам'ять: Хроніка злочину (1921) | 600 | 900 |
| Світове визнання: Від «Щедрика» до Carol of the Bells | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/mykola-leontovych.yaml`. Go through EVERY `points:` item in EVERY section:
