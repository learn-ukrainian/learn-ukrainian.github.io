...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/oleg-sentsov-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/oleg-sentsov.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/oleg-sentsov.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Олег Сенцов: Режисер власної долі та воїн** (bio track).
...
|---------|--------|---------------------|
| Вступ — Людина, яка не злякалася імперії | 400 | 600 |
| Життєпис: I — Кримський гамбіт та початок шляху | 600 | 900 |
| Життєпис: II — В'язень сумління в лещатах ФСБ | 900 | 1350 |
| Життєпис: III — Битва волі: Голодування та звільнення | 750 | 1125 |
| Історичний контекст: Геополітика та солідарність | 500 | 750 |
| Творчість та опір: Кінематограф правди | 600 | 900 |
| Сучасний етап: Режисер у пікселі | 750 | 1125 |
| Вплив: Голос совісті у світовому масштабі | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/oleg-sentsov.yaml`. Go through EVERY `points:` item in EVERY section:
