...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/kniaz-yaroslav-mudryi.yaml
```

Read the current meta file for content_outline structure:

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/kniaz-yaroslav-mudryi.yaml
```

## Your Task

Research **Князь Ярослав Мудрий: Законодавець** for the **bio** track. Produce structured research notes that will drive content writing in later phases.
