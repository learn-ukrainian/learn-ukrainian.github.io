...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/yuriy-vynnychuk-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/yuriy-vynnychuk.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/yuriy-vynnychuk.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Юрій Винничук: Львівський казкар** (bio track).
...
|---------|--------|---------------------|
| Вступ — Майстер львівської містики | 500 | 750 |
| Львівське дитинство | 600 | 900 |
| Андеграунд та перші публікації | 700 | 1050 |
| Містифікації та гра з читачем | 800 | 1200 |
| Танґо смерті та великі романи | 1000 | 1500 |
| Сучасна творчість | 700 | 1050 |
| Дискусія — Літературна містифікація як жанр | 700 | 1050 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/yuriy-vynnychuk.yaml`. Go through EVERY `points:` item in EVERY section:
