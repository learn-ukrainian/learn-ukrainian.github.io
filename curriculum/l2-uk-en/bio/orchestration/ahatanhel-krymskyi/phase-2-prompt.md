...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/ahatanhel-krymskyi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/ahatanhel-krymskyi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/ahatanhel-krymskyi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Агатангел Кримський: Поліглот і мученик науки** (bio track).
...
|---------|--------|---------------------|
| Вступ: Людина-енциклопедія | 600 | 900 |
| Становлення: Вибір ідентичності (1871–1892) | 800 | 1200 |
| Сходознавець: Від Бейрута до світового визнання (1892–1918) | 900 | 1350 |
| Архітектор ВУАН: Розбудова національної науки (1918–1928) | 900 | 1350 |
| Голгофа: Репресії та знищення (1929–1941) | 900 | 1350 |
| Спадщина: Безсмертя духу | 900 | 1350 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/ahatanhel-krymskyi.yaml`. Go through EVERY `points:` item in EVERY section:
