...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/valerian-pidmohylnyi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/valerian-pidmohylnyi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/valerian-pidmohylnyi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Валер'ян Підмогильний: <!-- Title -->** (bio track).
...
|---------|--------|---------------------|
| Вступ: Інтелектуал європейського масштабу | 300 | 450 |
| Ранні роки: Становлення модерніста | 500 | 750 |
| Літературне середовище: Ланка і МАРС | 600 | 900 |
| Творчість I: Роман «Місто» — урбаністичний маніфест | 1000 | 1500 |
| Творчість II: Інтелектуальна проза та переклади | 800 | 1200 |
| Репресії: Хроніка знищення | 800 | 1200 |
| Спадщина: Розстріляне, але живе відродження | 1000 | 1500 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/valerian-pidmohylnyi.yaml`. Go through EVERY `points:` item in EVERY section:
