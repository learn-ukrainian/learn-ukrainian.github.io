...
> **Persona reminder:** You are Professor of Ukrainian Arts (biography). Write in the voice of Academic Historian. Maintain this persona throughout — do not drift into generic AI tone.
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/natalia-yakovenko-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/natalia-yakovenko.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/natalia-yakovenko.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Наталя Яковенко: Матріарх критичної історії** (bio track).
...
|---------|--------|---------------------|
| Вступ — Зміна парадигми | 450 | 675 |
| Ранні роки: Архіви та класика | 450 | 675 |
| Повернення шляхти: Книга-прорив | 600 | 900 |
| Шляхетська ідентичність та «Інший» | 600 | 900 |
| Методологія: Антропологічний вимір | 600 | 900 |
| Методологія: Історія як текст | 600 | 900 |
| Педагогічна діяльність: Нова школа | 500 | 750 |
| Спадщина: «Школа Яковенко» | 600 | 900 |
| Дискусія — Еліта чи Народ? | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/natalia-yakovenko.yaml`. Go through EVERY `points:` item in EVERY section:
