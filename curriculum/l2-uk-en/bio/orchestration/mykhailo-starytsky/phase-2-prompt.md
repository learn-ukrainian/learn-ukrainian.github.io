...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/mykhailo-starytsky-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/mykhailo-starytsky.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/mykhailo-starytsky.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
> As has already been noted, Staryc’kyj was a supporter
of the ideas of Olena Pcilka concerning the Ukrainian language’s need for
cultural elevation. Yet in his own theatrical works he submitted to the
examples of Kropyvnyc’kyj. And, in several cases, he "amended" his works
by augmenting their eth

**Чижевський — Історія української літератури** (1956, scholarly):
> Another proponent of such views about the further
development of Ukrainian literature was art older contemporary of Olena Pcilka,
Myxajlo Staryc’kyj (1840-1904), the author of numerous verse and prose works in
Ukrainian and Russian. His Ukrainian verse efforts were, to a certain /88/
extent, exp

**Енциклопедія українознавства** (1955, encyclopedia):
> ЕТНОГРАФІЧНО-ПОБУТОВИЙ ТЕАТР І ПОЧАТКИ НОВОГО ТЕАТРУ (1881
— 1917) . . . . . . . . . . . . . . . . . . . 851

Загальна характеристика (851). Організація театру
(852). Драматургія (854). Актори й режисура (855) В. Гаєвський, В. Ревуцький
...
**Літопис Величка** (1720, chronicle):
> 1276 Калга-солтан з
ордами й Петриком таки йшов на Україну. (Див. приміт. 1253).
...
> Нинїшня Полтавщина представлена в 
реєстрі пятьма полками: Переяславським, Кропивенським, Миргородським, 
Полтавським і Прилуцьким. Кропивенський (на місці такого ж ефемерного 
Ірклїївського полку) 15) потім був подїлений між Переяславським і 
Лубенським; Лубенський 16) в реєстрі подїлений між К

**Енциклопедія українознавства** (1955, encyclopedia):
> Рос. окупація Центр. і Сх. Укр. Земель (934). Початки
большевицької освіти (935). Позашкільна освіта (935). Система шкільництва в
20-их pp. (936). Організація шкільного процесу і методи навчання (937).
Організація шкільництва (938). Шкільна мережа (938). Другий період у розвитку
шкільництва (від
...
Write the full lesson prose for **Михайло Старицький: Корифей українського театру** (bio track).
...
|---------|--------|---------------------|
| Вступ — Архітектор національної сцени | 400 | 600 |
| Полтавщина та формування (1840-1860-ті): I — Походження | 400 | 600 |
| Полтавщина та формування (1840-1860-ті): II — Освіта | 400 | 600 |
| Київський період та Стара Громада (1870-ті): I — Громадська діяльність | 450 | 675 |
| Київський період та Стара Громада (1870-ті): II — Репресії | 450 | 675 |
| Театральна революція (1882-1895): I — Заснування трупи | 550 | 825 |
| Театральна революція (1882-1895): II — Тріумф і тиск | 550 | 825 |
| Літературна спадщина: I — Драматургія та поезія | 450 | 675 |
| Літературна спадщина: II — Проза та переклади | 450 | 675 |
| Спадщина — Батько української сцени: I — Останні роки | 450 | 675 |
| Спадщина — Батько української сцени: II — Деколонізація та вплив | 450 | 675 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/mykhailo-starytsky.yaml`. Go through EVERY `points:` item in EVERY section:
