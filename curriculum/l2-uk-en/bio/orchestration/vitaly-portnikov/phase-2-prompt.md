...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/vitaly-portnikov-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/vitaly-portnikov.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/vitaly-portnikov.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Віталій Портников: Журналіст і аналітик** (bio track).
...
|---------|--------|---------------------|
| Вступ — Голос української журналістики | 400 | 600 |
| Ранні роки та освіта | 600 | 900 |
| Журналістська діяльність | 800 | 1200 |
| Аналітик пострадянського простору | 1000 | 1500 |
| Стиль та методологія | 800 | 1200 |
| Сучасна діяльність | 800 | 1200 |
| Дискусія — Журналістика як місія | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/vitaly-portnikov.yaml`. Go through EVERY `points:` item in EVERY section:
