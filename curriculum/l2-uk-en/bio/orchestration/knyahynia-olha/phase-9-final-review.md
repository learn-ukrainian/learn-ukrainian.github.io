...
## Deep Adversarial Review: knyahynia-olha (bio #1)
...
===FIX_START===
FILE: curriculum/l2-uk-en/bio/knyahynia-olha.md
---OLD---
Її сприймали як самостійну фігуру, рівну чоловікам, а повноправним політичним гравцем.
---NEW---
...
===FIX_START===
FILE: curriculum/l2-uk-en/bio/activities/knyahynia-olha.yaml
---OLD---
...
===FIX_START===
FILE: curriculum/l2-uk-en/bio/vocabulary/knyahynia-olha.yaml
---OLD---
    ipa:
---NEW---
    ipa:
...
- SCOPE line 5 says "Related: bio-01 (Олег)" while plan says "prerequisites: bio-01 (Олег Віщий)" — contradicts sequence: 1 assignment. Metadata inconsistency in plan, not content.
