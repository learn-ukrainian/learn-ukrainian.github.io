...
> **Persona reminder:** You are Professor of Ukrainian Arts (biography). Write in the voice of Ethnomusicologist. Maintain this persona throughout — do not drift into generic AI tone.
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/nina-matviyenko-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/nina-matviyenko.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/nina-matviyenko.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Ніна Матвієнко: Голос душі** (bio track).
...
|---------|--------|---------------------|
| Вступ — Берегиня пісні | 250 | 375 |
| Дитинство і становлення: Інтернат і коріння | 400 | 600 |
| Дитинство і становлення: Від заводу до сцени | 400 | 600 |
| Хор імені Верьовки: Солістка епохи | 500 | 750 |
| Хор імені Верьовки: Під наглядом системи | 500 | 750 |
| Акторська кар'єра: Екранні образи | 400 | 600 |
| Акторська кар'єра: Трагедія 'Цвіту папороті' | 500 | 750 |
| Стиль і манера: Архаїка голосу | 500 | 750 |
| Стиль і манера: Діалог із сучасністю | 400 | 600 |
| Родина і спадщина: Гончарів рід | 400 | 600 |
| Родина і спадщина: Прощання з легендою | 350 | 525 |
| Дискусія — Пісня як код нації | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/nina-matviyenko.yaml`. Go through EVERY `points:` item in EVERY section:
