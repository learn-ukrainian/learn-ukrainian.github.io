...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/illia-chernilevskyi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/illia-chernilevskyi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/illia-chernilevskyi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Ілля Чернілевський** (bio track).
...
|---------|--------|---------------------|
| Вступ та контекст: Покоління Незалежності | 400 | 600 |
| Вступ та контекст: Родинне коло і ранній старт | 400 | 600 |
| Голос розстріляного покоління Z: Доброволець | 600 | 900 |
| Голос розстріляного покоління Z: Трагедія під Кам'янкою | 600 | 900 |
| Музика та поезія спротиву: Метафора птаха | 500 | 750 |
| Музика та поезія спротиву: Перекладацький міст | 500 | 750 |
| Музика та поезія спротиву: Музичний вимір | 400 | 600 |
| Деколонізаційна перспектива: Історична циклічність | 500 | 750 |
| Деколонізаційна перспектива: Озброєна культура | 500 | 750 |
| Підсумок та спадщина: Повернення в слові | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/illia-chernilevskyi.yaml`. Go through EVERY `points:` item in EVERY section:
