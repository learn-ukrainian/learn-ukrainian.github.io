...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/volodymyr-ivasyuk.yaml
```

Read the current meta file for content_outline structure:

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/volodymyr-ivasyuk.yaml
```

## Your Task

Research **Володимир Івасюк: Автор Червоної рути** for the **bio** track. Produce structured research notes that will drive content writing in later phases.
