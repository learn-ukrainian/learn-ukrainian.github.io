...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/roman-ratushny-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/roman-ratushny.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/roman-ratushny.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Роман Ратушний: Громадянин, активіст, воїн** (bio track).
...
|---------|--------|---------------------|
| Вступ: Голос Протасового Яру | 600 | 900 |
| Життєпис: Від барикад Майдану до боротьби за Київ | 1000 | 1500 |
| Феномен Протасового Яру: Війна за міський простір | 1000 | 1500 |
| Філософія суб'єктності: Активізм як деколонізація | 800 | 1200 |
| Останні роки: Шлях Воїна (2022) | 800 | 1200 |
| Спадщина: «Роман не хотів би, щоб ми плакали» | 800 | 1200 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/roman-ratushny.yaml`. Go through EVERY `points:` item in EVERY section:
