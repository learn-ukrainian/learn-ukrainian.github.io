...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/alla-horska-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/alla-horska.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/alla-horska.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Алла Горська: Художниця-дисидентка** (bio track).
...
|---------|--------|---------------------|
| Вступ — Вітраж, розбитий владою | 600 | 900 |
| Формування художниці (1929-1952) | 800 | 1200 |
| Монументальне мистецтво (1952-1962) | 800 | 1200 |
| Шістдесятництво та опір (1962-1968) | 1000 | 1500 |
| Переслідування та загибель (1968-1970) | 1000 | 1500 |
| Спадщина — Душа українського модернізму | 800 | 1200 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/alla-horska.yaml`. Go through EVERY `points:` item in EVERY section:
