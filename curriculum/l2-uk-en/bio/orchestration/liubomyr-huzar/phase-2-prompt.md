...
> **Persona reminder:** You are Professor of Ukrainian Arts (biography). Write in the voice of Theologian. Maintain this persona throughout — do not drift into generic AI tone.
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/liubomyr-huzar-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/liubomyr-huzar.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/liubomyr-huzar.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Любомир Гузар: Моральний авторитет нації** (bio track).
...
|---------|--------|---------------------|
| Вступ — Патріарх свободи | 600 | 900 |
| Шлях вигнанця | 800 | 1200 |
| Повернення додому | 800 | 1200 |
| Мудрість простоти | 700 | 1050 |
| Майдан і громадянська позиція | 700 | 1050 |
| Спадщина | 700 | 1050 |
| Дискусія — Роль церкви в світській державі | 700 | 1050 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/liubomyr-huzar.yaml`. Go through EVERY `points:` item in EVERY section:
