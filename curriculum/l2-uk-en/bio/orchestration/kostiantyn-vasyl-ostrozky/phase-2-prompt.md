...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/kostiantyn-vasyl-ostrozky-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/kostiantyn-vasyl-ostrozky.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/kostiantyn-vasyl-ostrozky.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Костянтин-Василь Острозький: Князь-Просвітник** (bio track).
...
|---------|--------|---------------------|
| Вступ — Некоронований король Русі | 600 | 900 |
| Життєпис: I — Від магната до захисника | 800 | 1200 |
| Життєпис: II — Доба великих викликів | 1000 | 1500 |
| Історичний контекст | 800 | 1200 |
| Внесок та Спадщина: I — Волинські Афіни | 900 | 1350 |
| Внесок та Спадщина: II — Острозька Біблія | 500 | 750 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/kostiantyn-vasyl-ostrozky.yaml`. Go through EVERY `points:` item in EVERY section:
