...
subtitle: Володимир Вакуленко
focus: history
pedagogy: seminar
phase: Executed Renaissance 2.0
word_target: 5000
objectives:
- Дослідити життя та внесок Володимир Вакуленко у сучасну українську культуру
- Проаналізувати історичну тяглість російських репресій проти української інтелігенції
content_outline:
- section: Вступ та контекст
  points: []
  words: 1000
- section: Життя та мучеництво в Ізюмі
  points: []
  words: 1000
- section: 'Щоденник окупації: Голос з-під землі'
  points: []
  words: 1000
...
Research **Володимир Вакуленко** for the **bio** track. Produce structured research notes that will drive content writing in Phase B.
