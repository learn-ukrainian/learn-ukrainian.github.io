...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/sylvestr-kosiv-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/sylvestr-kosiv.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/sylvestr-kosiv.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Сильвестр Косів: Освітянин і будівничий** (bio track).
...
|---------|--------|---------------------|
| Вступ — Митрополит бурхливої епохи | 300 | 450 |
| Життєпис: I — Формування інтелектуала | 500 | 750 |
| Життєпис: II — Шлях до митрополичого престолу | 500 | 750 |
| Історичний контекст: Геополітика віри | 700 | 1050 |
| Внесок: I — «Екзегезис» і захист латини | 600 | 900 |
| Внесок: II — «Патерикон» і творення ідентичності | 600 | 900 |
| Останні роки: I — Переяславський злам | 700 | 1050 |
| Останні роки: II — Дипломатичний спротив | 600 | 900 |
| Спадщина | 300 | 450 |
| Підсумок | 200 | 300 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/sylvestr-kosiv.yaml`. Go through EVERY `points:` item in EVERY section:
