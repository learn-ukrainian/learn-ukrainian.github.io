...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/hryhoriy-skovoroda-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/hryhoriy-skovoroda.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/hryhoriy-skovoroda.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Григорій Сковорода: Мандрівний філософ** (bio track).
...
|---------|--------|---------------------|
| Вступ — Український Сократ | 400 | 600 |
| Життєпис: I — Формування особистості | 600 | 900 |
| Життєпис: II — Європейський досвід та педагогіка | 600 | 900 |
| Життєпис: III — Шлях мандрівного філософа | 600 | 900 |
| Історичний контекст: Філософія на тлі руїни | 500 | 750 |
| Внесок: I — Філософська система | 700 | 1050 |
| Внесок: II — Літературна спадщина | 500 | 750 |
| Останні роки та легенда | 400 | 600 |
| Спадщина: Живий символ | 600 | 900 |
| Підсумок | 200 | 300 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/hryhoriy-skovoroda.yaml`. Go through EVERY `points:` item in EVERY section:
