...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/yaroslav-hrytsak-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/yaroslav-hrytsak.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/yaroslav-hrytsak.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Ярослав Грицак: Публічний історик** (bio track).
...
|---------|--------|---------------------|
| Вступ — Історик, який говорить з людьми | 400 | 600 |
| Львівське дитинство та інтелектуальні витоки | 600 | 900 |
| Академічна кар'єра: Переосмислення канону | 800 | 1200 |
| Подолання минулого: Глобальна історія | 600 | 900 |
| Подолання минулого: Цінності та модернізація | 600 | 900 |
| Публічна історія та громадянська позиція | 800 | 1200 |
| Війна та сучасність: Битва за майбутнє | 700 | 1050 |
| Дискусія — Обов'язок історика | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/yaroslav-hrytsak.yaml`. Go through EVERY `points:` item in EVERY section:
