...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/volodymyr-vernadskyi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/volodymyr-vernadskyi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/volodymyr-vernadskyi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Володимир Вернадський: Батько української науки** (bio track).
...
|---------|--------|---------------------|
| Вступ — Вчений, який змінив науку | 400 | 600 |
| Життєпис: I — Від козацького роду до імперської науки | 700 | 1050 |
| Життєпис: II — Засновник Академії та повернення | 800 | 1200 |
| Історичний контекст | 500 | 750 |
| Внесок: I — Вчення про біосферу | 700 | 1050 |
| Внесок: II — Ноосфера та нові горизонти | 700 | 1050 |
| Останні роки | 600 | 900 |
| Спадщина | 600 | 900 |
| Підсумок | 300 | 450 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/volodymyr-vernadskyi.yaml`. Go through EVERY `points:` item in EVERY section:
