...
> **Persona reminder:** You are Professor of Ukrainian Arts (biography). Write in the voice of Theater Critic. Maintain this persona throughout — do not drift into generic AI tone.
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/bohdan-stupka-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/bohdan-stupka.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/bohdan-stupka.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Богдан Ступка: Гетьман сцени** (bio track).
...
|---------|--------|---------------------|
| Вступ — Актор №1: Патріарх української сцени | 400 | 600 |
| Львівський період: Становлення у театрі Заньковецької | 500 | 750 |
| Львівський період: Перші знакові ролі | 500 | 750 |
| Київ і Театр Франка: Тандем з Данченком | 550 | 825 |
| Київ і Театр Франка: Тев'є-Тевель як роль життя | 600 | 900 |
| Кінокар'єра: Дебют у 'Білому птасі' | 600 | 900 |
| Кінокар'єра: Історичні постаті та гетьмани | 650 | 975 |
| Міністр культури: 'Оборона культури' | 400 | 600 |
| Останні роки: Філософія та прощання | 400 | 600 |
| Дискусія: Відповідальність митця | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/bohdan-stupka.yaml`. Go through EVERY `points:` item in EVERY section:
