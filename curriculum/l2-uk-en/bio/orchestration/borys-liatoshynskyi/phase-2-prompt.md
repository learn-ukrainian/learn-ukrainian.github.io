...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/borys-liatoshynskyi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/borys-liatoshynskyi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/borys-liatoshynskyi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Борис Лятошинський: Симфоніст** (bio track).
...
|---------|--------|---------------------|
| Вступ — Голос української симфонії | 600 | 900 |
| Юні роки та освіта (1895-1918) | 800 | 1200 |
| Розквіт модернізму (1918-1930) | 1000 | 1500 |
| Під тиском системи (1930-1950) | 1000 | 1500 |
| Пізній період (1950-1968) | 800 | 1200 |
| Спадщина — Батько української симфонії | 800 | 1200 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/borys-liatoshynskyi.yaml`. Go through EVERY `points:` item in EVERY section:
