...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/mykhailo-drahomanov-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/mykhailo-drahomanov.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/mykhailo-drahomanov.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Михайло Драгоманов: Політичний мислитель** (bio track).
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/mykhailo-drahomanov.yaml`. Go through EVERY `points:` item in EVERY section:
