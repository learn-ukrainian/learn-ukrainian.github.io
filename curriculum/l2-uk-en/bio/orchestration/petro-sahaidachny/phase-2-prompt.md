...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/petro-sahaidachny-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/petro-sahaidachny.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/petro-sahaidachny.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Петро Сагайдачний: Гетьман-Державник** (bio track).
...
|---------|--------|---------------------|
| Вступ — Меч і Хрест | 600 | 900 |
| Життєпис: I — Становлення та Морські походи | 1000 | 1500 |
| Життєпис: II — Московський похід та Відновлення Церкви | 1000 | 1500 |
| Життєпис: III — Хотинська епопея та Смерть | 800 | 1200 |
| Історичний контекст | 600 | 900 |
| Внесок та Спадщина | 600 | 900 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/petro-sahaidachny.yaml`. Go through EVERY `points:` item in EVERY section:
