...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/heo-shkurupii-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/heo-shkurupii.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/heo-shkurupii.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Гео Шкурупій: <!-- Title -->** (bio track).
...
|---------|--------|---------------------|
| Вступ: Король Футуропрерій | 600 | 900 |
| Ранні роки та «Психотези»: Народження футуриста | 800 | 1200 |
| Кіно та «Нова ґенерація»: Екранне мислення | 800 | 1200 |
| Прозовий вибух: «Двері в день» | 1000 | 1500 |
| «Жанна-батальйонерка»: Жінка на війні | 800 | 1200 |
| Арешт і Сандармох: Знищення покоління | 600 | 900 |
| Спадщина: Повернення авангарду | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/heo-shkurupii.yaml`. Go through EVERY `points:` item in EVERY section:
