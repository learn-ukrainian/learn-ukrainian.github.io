...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/mykola-lysenko-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/mykola-lysenko.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/mykola-lysenko.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Микола Лисенко: Батько української музики** (bio track).
...
|---------|--------|---------------------|
| Вступ — Батько української музики | 400 | 600 |
| Ранні роки: Між наукою та мистецтвом (1842–1867) | 700 | 1050 |
| Лейпциг і Петербург: Європейський вишкіл (1867–1876) | 800 | 1200 |
| Великий проєкт: Етнографія як фундамент | 600 | 900 |
| Оперна спадщина: Драма і Сатира | 900 | 1350 |
| Музика до Кобзаря: Діалог з Пророком | 400 | 600 |
| Громадський діяч: Всупереч імперії | 700 | 1050 |
| Спадщина: Школа Лисенка (1905–1912) | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/mykola-lysenko.yaml`. Go through EVERY `points:` item in EVERY section:
