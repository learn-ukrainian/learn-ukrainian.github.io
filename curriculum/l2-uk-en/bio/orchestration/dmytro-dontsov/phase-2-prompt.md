...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/dmytro-dontsov-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/dmytro-dontsov.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/dmytro-dontsov.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Дмитро Донцов: Ідеолог націоналізму** (bio track).
...
|---------|--------|---------------------|
| Вступ — Апостол волюнтаризму | 400 | 600 |
| Юність та ідейне формування (1883–1913) | 800 | 1200 |
| Від соціаліста до націоналіста: I — Велика Війна та Гетьманат (1913–1918) | 700 | 1050 |
| Від соціаліста до націоналіста: II — Кристалізація доктрини (1919–1926) | 700 | 1050 |
| Літературний Критик та ідеолог «Вісниківства» (1926–1939) | 1000 | 1500 |
| Друга світова війна та еміграція (1939–1973) | 600 | 900 |
| Спадщина — Між генієм і демоном | 800 | 1200 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/dmytro-dontsov.yaml`. Go through EVERY `points:` item in EVERY section:
