...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/kniaz-sviatoslav-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/kniaz-sviatoslav.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/kniaz-sviatoslav.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Князь Святослав: Воїн-завойовник** (bio track).
