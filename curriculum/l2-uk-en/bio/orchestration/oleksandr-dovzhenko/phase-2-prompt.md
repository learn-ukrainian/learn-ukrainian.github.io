...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/oleksandr-dovzhenko-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/oleksandr-dovzhenko.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/oleksandr-dovzhenko.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Олександр Довженко: Батько українського кіно** (bio track).
...
|---------|--------|---------------------|
| Вступ — Геній світового кінематографу | 400 | 600 |
| Ранні роки та освіта | 600 | 900 |
| Шлях до кіно | 600 | 900 |
| Українська трилогія: I — Народження поетичного кіно | 800 | 1200 |
| Українська трилогія: II — «Земля» і вічність | 800 | 1200 |
| Конфлікти з владою: I — Цькування та компроміси | 600 | 900 |
| Конфлікти з владою: II — «Україна в огні» | 600 | 900 |
| Пізня творчість | 500 | 750 |
| Спадщина та вплив | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/oleksandr-dovzhenko.yaml`. Go through EVERY `points:` item in EVERY section:
