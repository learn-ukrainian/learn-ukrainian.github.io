...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/mykola-vasylenko-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/mykola-vasylenko.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/mykola-vasylenko.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Микола Василенко: Юрист і державник** (bio track).
...
|---------|--------|---------------------|
| Вступ: Архітектор української юриспруденції | 400 | 600 |
| Ранні роки: Між Полтавою та Дерптом (1866–1894) | 600 | 900 |
| Академічна кар'єра: Вчений і громадянин (1894–1917) | 800 | 1200 |
| Гетьманат: Час великих реформ (1918) | 1200 | 1800 |
| Opus Magnum: Заснування Академії наук (1918) | 800 | 1200 |
| Радянський період: Боротьба за виживання (1919–1935) | 900 | 1350 |
| Спадщина: Повернення із забуття | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/mykola-vasylenko.yaml`. Go through EVERY `points:` item in EVERY section:
