...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/kateryna-bilokur-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/kateryna-bilokur.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/kateryna-bilokur.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Катерина Білокур: Геній наївного мистецтва** (bio track).
...
|---------|--------|---------------------|
| Вступ — Квіти, народжені генієм | 600 | 900 |
| Юність без можливостей (1900-1920-ті) | 900 | 1350 |
| Таємне мистецтво (1920-1940-ті) | 900 | 1350 |
| Відкриття таланту (1940-ві) | 900 | 1350 |
| Пізній період (1950-1961) | 900 | 1350 |
| Спадщина — Геній із села | 800 | 1200 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/kateryna-bilokur.yaml`. Go through EVERY `points:` item in EVERY section:
