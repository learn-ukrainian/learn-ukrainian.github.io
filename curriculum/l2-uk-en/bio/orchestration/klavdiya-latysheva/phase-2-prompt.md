...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/klavdiya-latysheva-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/klavdiya-latysheva.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/klavdiya-latysheva.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Клавдія Латишева: Піонерка авіації** (bio track).
...
|---------|--------|---------------------|
| Вступ — Математик, що підкорила рівняння | 600 | 900 |
| Юність та освіта: Шлях до знань (1897-1925) | 800 | 1200 |
| Наукове становлення та школа Кравчука (1925-1940) | 1000 | 1500 |
| Війна та евакуація: Наука в екзилі (1941-1945) | 800 | 1200 |
| Тріумф та визнання: Перша леді математики (1946-1956) | 1000 | 1500 |
| Спадщина — Жінка без обмежень | 800 | 1200 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/klavdiya-latysheva.yaml`. Go through EVERY `points:` item in EVERY section:
