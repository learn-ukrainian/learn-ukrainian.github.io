...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/lev-danylovych-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/lev-danylovych.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/lev-danylovych.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Лев Данилович: Будівничий Львова** (bio track).
...
|---------|--------|---------------------|
| Вступ — Князь, що дав місту своє ім'я | 400 | 600 |
| Молодість та прихід до влади | 800 | 1200 |
| Львів — нова столиця | 900 | 1350 |
| Територіальна експансія | 800 | 1200 |
| Відносини з Ордою | 800 | 1200 |
| Внутрішня політика | 800 | 1200 |
| Підсумок — Князь-будівничий | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/lev-danylovych.yaml`. Go through EVERY `points:` item in EVERY section:
