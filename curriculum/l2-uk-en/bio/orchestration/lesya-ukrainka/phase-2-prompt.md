...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/lesya-ukrainka-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/lesya-ukrainka.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/lesya-ukrainka.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Леся Українка: Прометей української літератури** (bio track).
...
|---------|--------|---------------------|
| Вступ — Прометей у жіночій подобі | 400 | 600 |
| Дитинство та родина (1871-1884) | 600 | 900 |
| Хвороба та творчий злет (1884-1900) | 800 | 1200 |
| Драматургія та ідеї: I — Драматичні поеми та антиколоніалізм | 900 | 1350 |
| Драматургія та ідеї: II — «Лісова пісня» та особистий вимір | 800 | 1200 |
| Останні роки та спадщина (1909-1913) | 700 | 1050 |
| Вплив на сучасність | 800 | 1200 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/lesya-ukrainka.yaml`. Go through EVERY `points:` item in EVERY section:
