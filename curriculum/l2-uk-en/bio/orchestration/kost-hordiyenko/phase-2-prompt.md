...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/kost-hordiyenko-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/kost-hordiyenko.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/kost-hordiyenko.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Кость Гордієнко: Запорозький кошовий** (bio track).
...
|---------|--------|---------------------|
| Вступ — Лицар степу | 500 | 750 |
| Життєпис: I — Шлях до булави та протистояння фортецям | 800 | 1200 |
| Життєпис: II — Союз із Мазепою та війна за вольності | 900 | 1350 |
| Історичний контекст | 600 | 900 |
| Внесок | 600 | 900 |
| Останні роки: I — Олешківська Січ | 400 | 600 |
| Останні роки: II — Кам'янська Січ | 400 | 600 |
| Спадщина | 500 | 750 |
| Підсумок | 300 | 450 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/kost-hordiyenko.yaml`. Go through EVERY `points:` item in EVERY section:
