...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/ivan-franko-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/ivan-franko.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/ivan-franko.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Іван Франко: Каменяр** (bio track).
...
|---------|--------|---------------------|
| Вступ — Титан праці | 400 | 600 |
| Юність у Нагуєвичах: Кузня характеру (1856-1874) | 600 | 900 |
| Студентські роки: I — Академічні горизонти та ідейний пошук | 400 | 600 |
| Студентські роки: II — Тюрма як університет життя | 400 | 600 |
| Каменяр української культури: I — Літературні вершини | 800 | 1200 |
| Каменяр української культури: II — Науковець і політик | 600 | 900 |
| Каменяр української культури: III — «Мойсей» | 600 | 900 |
| Хвороба та останні роки: I — Боротьба з болем | 400 | 600 |
| Хвороба та останні роки: II — Війна і визнання | 400 | 600 |
| Спадщина — Вічний каменяр | 800 | 1200 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/ivan-franko.yaml`. Go through EVERY `points:` item in EVERY section:
