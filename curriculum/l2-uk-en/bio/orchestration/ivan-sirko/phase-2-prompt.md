...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/ivan-sirko-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/ivan-sirko.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/ivan-sirko.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Іван Сірко: Легендарний кошовий отаман** (bio track).
...
|---------|--------|---------------------|
| Вступ — Легенда Запорозької Січі | 400 | 600 |
| Життєпис: I — Походження та європейський гарт | 450 | 675 |
| Життєпис: II — Шлях до булави | 450 | 675 |
| Історичний контекст: I — Епоха Руїни | 500 | 750 |
| Історичний контекст: II — Боротьба за автономію | 500 | 750 |
| Внесок: I — Військовий геній та Кримські походи | 600 | 900 |
| Внесок: II — Сакральна місія та заслання | 600 | 900 |
| Останні роки: I — Чигирин та Лист султану | 450 | 675 |
| Останні роки: II — Смерть та вічність | 450 | 675 |
| Спадщина | 350 | 525 |
| Підсумок | 250 | 375 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/ivan-sirko.yaml`. Go through EVERY `points:` item in EVERY section:
