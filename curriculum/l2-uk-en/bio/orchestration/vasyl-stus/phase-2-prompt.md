...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/vasyl-stus-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/vasyl-stus.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/vasyl-stus.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Василь Стус: Вертикальне стояння духу** (bio track).
...
|---------|--------|---------------------|
| Вступ — Поезія як форма спротиву | 400 | 600 |
| Донбаське дитинство | 600 | 900 |
| Літературне становлення | 600 | 900 |
| Шістдесятництво та перший арешт: I — Протест | 500 | 750 |
| Шістдесятництво та перший арешт: II — Вирок 1972 | 500 | 750 |
| Другий арешт та табори: I — Рецидивіст духу | 600 | 900 |
| Другий арешт та табори: II — Перм-36 | 600 | 900 |
| Загибель та безсмертя | 800 | 1200 |
| Дискусія — Ціна свободи | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/vasyl-stus.yaml`. Go through EVERY `points:` item in EVERY section:
