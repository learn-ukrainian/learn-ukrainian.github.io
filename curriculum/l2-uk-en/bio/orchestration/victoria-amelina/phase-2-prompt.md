...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/victoria-amelina-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/victoria-amelina.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/victoria-amelina.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Вікторія Амеліна** (bio track).
...
|---------|--------|---------------------|
| Вступ та контекст: Вибір шляху | 1000 | 1500 |
| Від романістки до дослідниці воєнних злочинів | 1200 | 1800 |
| Концепція Нового Розстріляного Відродження | 1200 | 1800 |
| Деколонізаційна перспектива: Повернення голосу | 1000 | 1500 |
| Підсумок та спадщина: Голос, що не змовк | 800 | 1200 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/victoria-amelina.yaml`. Go through EVERY `points:` item in EVERY section:
