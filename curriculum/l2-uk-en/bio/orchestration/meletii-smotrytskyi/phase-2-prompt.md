...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/meletii-smotrytskyi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/meletii-smotrytskyi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/meletii-smotrytskyi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Мелетій Смотрицький: Творець граматики** (bio track).
...
|---------|--------|---------------------|
| Вступ — Інтелектуальний титан доби бароко | 400 | 600 |
| Життєпис: I — Становлення та освіта | 450 | 675 |
| Життєпис: II — Європейський вояж | 450 | 675 |
| Історичний контекст: I — Релігійна боротьба та «Тренос» | 450 | 675 |
| Історичний контекст: II — Козацький захист та висвячення | 450 | 675 |
| Внесок: I — Архітектура «Граматики» | 500 | 750 |
| Внесок: II — Мовна революція | 500 | 750 |
| Останні роки: I — Подорож на Схід та розчарування | 450 | 675 |
| Останні роки: II — Дерманський самітник | 450 | 675 |
| Спадщина: I — Вчитель народів | 400 | 600 |
| Спадщина: II — Переосмислення ролі | 400 | 600 |
| Підсумок | 300 | 450 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/meletii-smotrytskyi.yaml`. Go through EVERY `points:` item in EVERY section:
