...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/mykhailo-hrushevskyi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/mykhailo-hrushevskyi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/mykhailo-hrushevskyi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Михайло Грушевський: Історик і президент** (bio track).
...
|---------|--------|---------------------|
| Вступ — Батько української історії | 400 | 600 |
| Ранні роки та освіта (1866-1894) | 500 | 750 |
| Львівський період: Український П'ємонт і НТШ | 600 | 900 |
| Львівський період: Magnum Opus | 600 | 900 |
| Революція та УНР: Від автономії до незалежності | 700 | 1050 |
| Революція та УНР: Четвертий Універсал і крах | 600 | 900 |
| Еміграція та повернення: Наука у вигнанні | 500 | 750 |
| Еміграція та повернення: Київська катастрофа | 600 | 900 |
| Смерть та спадщина | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/mykhailo-hrushevskyi.yaml`. Go through EVERY `points:` item in EVERY section:
