...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/oleg-antonov-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/oleg-antonov.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/oleg-antonov.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Олег Антонов: Крила України та геній авіації** (bio track).
...
|---------|--------|---------------------|
| Вступ — Людина, що подарувала небу крила | 400 | 600 |
| Життєпис: I — Шлях до Києва та народження легенди | 700 | 1050 |
| Життєпис: II — Епоха гігантів та світове визнання | 750 | 1125 |
| Історичний контекст: I — Київ як авіаційна столиця | 650 | 975 |
| Історичний контекст: II — Громадянська позиція та інтелектуальний опір | 650 | 975 |
| Внесок: Школа Антонова та технічні інновації | 600 | 900 |
| Сучасний етап: Спадщина в небі | 600 | 900 |
| Спадщина: Небо стає ближчим | 650 | 975 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/oleg-antonov.yaml`. Go through EVERY `points:` item in EVERY section:
