...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/ivan-nechuy-levytskyi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/ivan-nechuy-levytskyi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/ivan-nechuy-levytskyi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Іван Нечуй-Левицький: Майстер українського реалізму** (bio track).
...
|---------|--------|---------------------|
| Вступ: Колосальне всеобіймаюче око | 450 | 675 |
| Походження: Між вівтарем і школою | 650 | 975 |
| Учительська одіссея та цензура | 600 | 900 |
| Кайдашева сім'я: Анатомія національного розбрату | 600 | 900 |
| Галерея характерів: Від Омелька до Мотрі | 600 | 900 |
| Микола Джеря: У пошуках втраченої волі | 650 | 975 |
| Мовна війна: Категоричний імператив | 800 | 1200 |
| Епілог: Самотність у вихорі історії | 650 | 975 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/ivan-nechuy-levytskyi.yaml`. Go through EVERY `points:` item in EVERY section:
