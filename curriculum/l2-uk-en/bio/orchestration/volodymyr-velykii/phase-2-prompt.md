...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/volodymyr-velykii-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/volodymyr-velykii.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/volodymyr-velykii.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Володимир Великий: Хреститель Русі** (bio track).
...
|---------|--------|---------------------|
| Вступ: Архітектор цивілізаційного коду | 400 | 600 |
| Походження: Від 'робичича' до великого стратега | 450 | 675 |
| Боротьба за престол: Кривава усобиця Рюриковичів | 500 | 750 |
| Язичницька реформа: Спроба створення державної віри | 450 | 675 |
| Геополітичний вибір: Тендер світових релігій | 500 | 750 |
| Корсунь та Хрещення: Дипломатія примусу до рівності | 550 | 825 |
| Державне будівництво: Змієві вали та власний карб | 500 | 750 |
| Культурна революція: Десятинна церква та освіта еліт | 450 | 675 |
| Трансформація особистості: Від деспота до милосердного батька | 450 | 675 |
| Спадщина: Деколонізація образу та тяглість Тризуба | 400 | 600 |
| Підсумок: Візіонер руської ойкумени | 300 | 450 |
| **Total** | **5000** | **7500** |
