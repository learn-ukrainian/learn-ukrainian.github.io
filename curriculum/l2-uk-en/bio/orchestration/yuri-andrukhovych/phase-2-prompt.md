...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/yuri-andrukhovych-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/yuri-andrukhovych.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/yuri-andrukhovych.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Юрій Андрухович: Карнавал на руїнах імперії** (bio track).
...
|---------|--------|---------------------|
| Вступ — Enfant terrible української літератури | 400 | 600 |
| Станіславів та юність (1960-1982): I — Міф міста | 450 | 675 |
| Станіславів та юність (1960-1982): II — Львівський гарт | 400 | 600 |
| Бу-Ба-Бу (1985-1991): I — Абревіатура свободи | 500 | 750 |
| Бу-Ба-Бу (1985-1991): II — Поезоопера на руїнах | 550 | 825 |
| Романи (1992-1999): I — Карнавальний вибух «Рекреацій» | 500 | 750 |
| Романи (1992-1999): II — Антиімперський горор «Московіади» | 700 | 1050 |
| Романи (1992-1999): III — Венеційські дзеркала «Перверзії» | 500 | 750 |
| Громадянська позиція (2000-): I — Геопоетика та есеїстика | 450 | 675 |
| Громадянська позиція (2000-): II — Голос сумління | 550 | 825 |
| Спадщина — Постмодерніст як деколонізатор | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/yuri-andrukhovych.yaml`. Go through EVERY `points:` item in EVERY section:
