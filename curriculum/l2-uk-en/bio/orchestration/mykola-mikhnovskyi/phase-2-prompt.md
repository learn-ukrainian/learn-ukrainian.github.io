...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/mykola-mikhnovskyi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/mykola-mikhnovskyi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/mykola-mikhnovskyi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Микола Міхновський: Ідеолог самостійництва** (bio track).
...
|---------|--------|---------------------|
| Вступ — Голос української незалежності | 400 | 600 |
| Ранні роки та освіта (1873-1895) | 600 | 900 |
| «Самостійна Україна» (1900-1905): I — Маніфест | 500 | 750 |
| «Самостійна Україна» (1900-1905): II — Політична кристалізація | 500 | 750 |
| Політична діяльність (1905-1917) | 800 | 1200 |
| Революційні роки (1917-1918): I — Військова ініціатива | 600 | 900 |
| Революційні роки (1917-1918): II — Виступ полуботківців | 600 | 900 |
| Останні роки та загибель (1918-1924) | 1000 | 1500 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/mykola-mikhnovskyi.yaml`. Go through EVERY `points:` item in EVERY section:
