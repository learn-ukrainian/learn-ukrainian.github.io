...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/olena-teliha-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/olena-teliha.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/olena-teliha.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Олена Теліга: Поетка-патріотка** (bio track).
...
|---------|--------|---------------------|
| Вступ: Вогняна муза | 400 | 600 |
| Ранні роки: Від Петербурга до еміграції (1906-1922) | 600 | 900 |
| Празький період: Становлення поетки (1922-1939) | 800 | 1200 |
| Поезія чину: Естетика і філософія | 800 | 1200 |
| Повернення: Дорога на Київ (1939-1941) | 600 | 900 |
| Київський підпільний фронт (1941-1942) | 800 | 1200 |
| Героїчна смерть: Бабин Яр (1942) | 600 | 900 |
| Спадщина: Символ нескореності | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/olena-teliha.yaml`. Go through EVERY `points:` item in EVERY section:
