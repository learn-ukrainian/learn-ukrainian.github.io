...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/oksana-zabuzhko-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/oksana-zabuzhko.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/oksana-zabuzhko.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Оксана Забужко: Інтелектуал і феміністка** (bio track).
...
|---------|--------|---------------------|
| Вступ — Голос українського інтелектуалізму | 450 | 675 |
| Ранні роки: Дисидентське коріння та формування | 700 | 1050 |
| «Польові дослідження»: Анатомія національної травми | 900 | 1350 |
| «Музей покинутих секретів»: Епос пам'яті | 1000 | 1500 |
| Філософія та есеїстика: Notre Dame d'Ukraine | 950 | 1425 |
| Громадська позиція: Війна за смисли | 1000 | 1500 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/oksana-zabuzhko.yaml`. Go through EVERY `points:` item in EVERY section:
