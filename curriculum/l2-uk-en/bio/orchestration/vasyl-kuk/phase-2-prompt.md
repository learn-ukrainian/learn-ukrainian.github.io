...
> **Persona reminder:** You are Professor of Ukrainian Arts (biography). Write in the voice of Military Historian. Maintain this persona throughout — do not drift into generic AI tone.
...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/vasyl-kuk-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/vasyl-kuk.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/vasyl-kuk.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Василь Кук: Останній командир** (bio track).
...
|---------|--------|---------------------|
| Вступ — Символ незламності | 800 | 1200 |
| Молодість і ОУН | 700 | 1050 |
| Підпілля та УПА-Південь | 700 | 1050 |
| Останній бій (1950-1954) | 700 | 1050 |
| Полон та "помилування" | 700 | 1050 |
| Незалежність і реабілітація | 700 | 1050 |
| Дискусія — Ціна компромісу | 700 | 1050 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/vasyl-kuk.yaml`. Go through EVERY `points:` item in EVERY section:
