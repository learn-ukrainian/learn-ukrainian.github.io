...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/mariya-zankovetska-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/mariya-zankovetska.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/mariya-zankovetska.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Марія Заньковецька: Перша леді сцени** (bio track).
...
|---------|--------|---------------------|
| Вступ — Королева українського театру | 400 | 600 |
| Дитинство та юність: Шляхетне коріння | 500 | 750 |
| Ранні роки: Вибір шляху | 500 | 750 |
| Початок кар'єри: Народження легенди | 500 | 750 |
| Зоряні роки: Тріумф у столицях імперії | 550 | 825 |
| Імператорська спокуса: Громадянський вибір | 500 | 750 |
| Вершини майстерності: Галерея образів | 600 | 900 |
| Особиста драма: Заньковецька і Садовський | 550 | 825 |
| Пізній період: Відродження та визнання | 500 | 750 |
| Спадщина та пам'ять: Вічний символ | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/mariya-zankovetska.yaml`. Go through EVERY `points:` item in EVERY section:
