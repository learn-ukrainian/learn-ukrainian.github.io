...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/olha-basarab-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/olha-basarab.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/olha-basarab.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Ольга Басараб: Розвідниця і мучениця** (bio track).
...
|---------|--------|---------------------|
| Вступ: Символ жіночого героїзму | 400 | 600 |
| Молодість: I — Родинне коріння та освіта | 500 | 750 |
| Молодість: II — Громадський активізм | 500 | 750 |
| Війна: I — Благодійність та «Комітет допомоги» | 500 | 750 |
| Війна: II — Перші кроки у підпіллі | 500 | 750 |
| Розвідка: I — Дипломатія та шпигунство | 600 | 900 |
| Розвідка: II — Зв'язкова Коновальця | 600 | 900 |
| Загибель: I — Арешт і слідство | 600 | 900 |
| Загибель: II — Мученицька смерть | 600 | 900 |
| Пам'ять: Культ та спадщина | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/olha-basarab.yaml`. Go through EVERY `points:` item in EVERY section:
