...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/dmytro-kotsyubailo-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/dmytro-kotsyubailo.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/dmytro-kotsyubailo.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Дмитро «Да Вінчі» Коцюбайло: Символ покоління добровольців** (bio track).
...
|---------|--------|---------------------|
| Вступ: Наймолодший Герой | 600 | 900 |
| Життєпис I: Майдан і початок війни | 700 | 1050 |
| Життєпис II: Вовча зграя (2015–2021) | 800 | 1200 |
| Історичний контекст: Еволюція добровольців | 600 | 900 |
| Внесок: Військове новаторство та лідерство | 600 | 900 |
| Останні роки I: Велика війна | 800 | 1200 |
| Останні роки II: Битва за Бахмут | 500 | 750 |
| Спадщина: Безсмертя героя | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/dmytro-kotsyubailo.yaml`. Go through EVERY `points:` item in EVERY section:
