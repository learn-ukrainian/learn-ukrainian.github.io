...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/bohdan-ihor-antonych-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/bohdan-ihor-antonych.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/bohdan-ihor-antonych.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Богдан-Ігор Антонич: Зелена Євангелія** (bio track).
...
|---------|--------|---------------------|
| Вступ — Поет космічного організму | 400 | 600 |
| Лемківщина та дитинство: Витоки міфу (1909-1928) | 700 | 1050 |
| Львівський період: Вибір ідентичності (1928-1933) | 800 | 1200 |
| Зелена поетика: Міфологія природи (1931-1937) | 1000 | 1500 |
| Урбаністика та філософія: Від «Книги Лева» до «Ротацій» | 900 | 1350 |
| Передчасна смерть та посмертна доля (1937-1960-ті) | 600 | 900 |
| Спадщина — Безсмертний лемко Львова | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/bohdan-ihor-antonych.yaml`. Go through EVERY `points:` item in EVERY section:
