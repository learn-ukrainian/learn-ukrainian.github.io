...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/yevhen-pluzhnyk-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/yevhen-pluzhnyk.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/yevhen-pluzhnyk.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Євген Плужник: <!-- Title -->** (bio track).
...
|---------|--------|---------------------|
| Вступ: Тихий пророк епохи | 600 | 900 |
| Ранні роки: Від Кантемирівки до Києва | 800 | 1200 |
| Творчий злет: Поезія та проза | 1000 | 1500 |
| У колі однодумців: «Ланка» та МАРС | 800 | 1200 |
| Справа № 1377: Арешт і Соловки | 1000 | 1500 |
| Спадщина: Повернення із забуття | 800 | 1200 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/yevhen-pluzhnyk.yaml`. Go through EVERY `points:` item in EVERY section:
