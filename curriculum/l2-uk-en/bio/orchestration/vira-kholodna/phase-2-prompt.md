...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/vira-kholodna-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/vira-kholodna.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/vira-kholodna.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Віра Холодна: Королева німого кіно** (bio track).
...
|---------|--------|---------------------|
| Вступ — Зірка, яка згасла зарано | 500 | 750 |
| Дитинство та юність: I — Полтавське коріння | 500 | 750 |
| Дитинство та юність: II — Московський період | 500 | 750 |
| Шлях до екрану | 600 | 900 |
| Королева екрану | 700 | 1050 |
| Мистецтво німого кіно | 600 | 900 |
| Трагічний фінал: I — Переїзд до Одеси | 500 | 750 |
| Трагічний фінал: II — Останні дні | 500 | 750 |
| Дискусія — Легенда та реальність: I — Версії загибелі | 400 | 600 |
| Дискусія — Легенда та реальність: II — Спадщина та пам'ять | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/vira-kholodna.yaml`. Go through EVERY `points:` item in EVERY section:
