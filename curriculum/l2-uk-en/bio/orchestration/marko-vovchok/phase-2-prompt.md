...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/marko-vovchok-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/marko-vovchok.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/marko-vovchok.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Марко Вовчок: Голос пригноблених** (bio track).
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/marko-vovchok.yaml`. Go through EVERY `points:` item in EVERY section:
