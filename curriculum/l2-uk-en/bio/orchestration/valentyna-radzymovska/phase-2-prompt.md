...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/valentyna-radzymovska-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/valentyna-radzymovska.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/valentyna-radzymovska.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Валентина Радзимовська: Жертва терору** (bio track).
...
|---------|--------|---------------------|
| Вступ — Наука як жертва режиму | 450 | 675 |
| Ранні роки та освіта: I — Родина Яновських | 500 | 750 |
| Ранні роки та освіта: II — Шлях до наукової кар'єри | 500 | 750 |
| Наукова діяльність: I — Піонерка біохімії | 650 | 975 |
| Українізація та наукове середовище | 550 | 825 |
| Сталінські репресії: I — Арешт і справа СВУ | 600 | 900 |
| Сталінські репресії: II — Життя під наглядом | 550 | 825 |
| Памятка та відновлення імені: I — Еміграція та збереження знань | 550 | 825 |
| Памятка та відновлення імені: II — Повернення в Україну | 400 | 600 |
| Дискусія — Ціна репресій для нації | 450 | 675 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/valentyna-radzymovska.yaml`. Go through EVERY `points:` item in EVERY section:
