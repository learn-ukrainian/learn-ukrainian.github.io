...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/viacheslav-chornovil-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/viacheslav-chornovil.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/viacheslav-chornovil.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **В'ячеслав Чорновіл: Незламний правозахисник** (bio track).
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/viacheslav-chornovil.yaml`. Go through EVERY `points:` item in EVERY section:
