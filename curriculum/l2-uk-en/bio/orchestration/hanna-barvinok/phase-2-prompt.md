...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/hanna-barvinok-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/hanna-barvinok.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/hanna-barvinok.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Ганна Барвінок: Письменниця і етнографка** (bio track).
...
|---------|--------|---------------------|
| Вступ — Перша з жінок української літератури | 400 | 600 |
| Юність та виховання (1828-1847) | 800 | 1200 |
| Подружжя з Кулішем (1847-1860-ті) | 1000 | 1500 |
| Літературна діяльність (1860-ті–1890-ті) | 1200 | 1800 |
| Пізній період (1890-1911) | 800 | 1200 |
| Спадщина — Голос селянської України | 800 | 1200 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/hanna-barvinok.yaml`. Go through EVERY `points:` item in EVERY section:
