...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/kateryna-handziuk-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/kateryna-handziuk.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/kateryna-handziuk.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Катерина Гандзюк: Голос правди та боротьба проти свавілля** (bio track).
...
|---------|--------|---------------------|
| Вступ — Символ нескореності | 600 | 900 |
| Життєпис: Шлях активістки — I. Становлення | 700 | 1050 |
| Життєпис: Шлях активістки — II. Проти системи | 900 | 1350 |
| Життєпис: Шлях активістки — III. Замах | 800 | 1200 |
| Історичний контекст: Активізм під ударом | 800 | 1200 |
| Внесок: Пробудження суспільства | 600 | 900 |
| Останні роки: Боротьба триває | 600 | 900 |
| Спадщина: Громадянська варта | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/kateryna-handziuk.yaml`. Go through EVERY `points:` item in EVERY section:
