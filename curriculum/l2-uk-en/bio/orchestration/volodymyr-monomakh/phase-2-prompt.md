...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/volodymyr-monomakh-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/volodymyr-monomakh.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/volodymyr-monomakh.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Володимир Мономах: Укріплювач Русі** (bio track).
...
|---------|--------|---------------------|
| Вступ — Останній великий самодержець Києва | 400 | 600 |
| Життєпис: I — Становлення та випробування | 500 | 750 |
| Життєпис: II — Дипломатія єдності | 500 | 750 |
| Історичний контекст: I — Виклики доби | 500 | 750 |
| Історичний контекст: II — Київське повстання 1113 року | 600 | 900 |
| Внесок: I — «Устав» та соціальні реформи | 600 | 900 |
| Внесок: II — «Повчання дітям» | 600 | 900 |
| Останні роки: Династичний зеніт | 500 | 750 |
| Спадщина: I — Образ в історії | 400 | 600 |
| Спадщина: II — Міф про «Шапку Мономаха» | 400 | 600 |
| Підсумок | 300 | 450 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/volodymyr-monomakh.yaml`. Go through EVERY `points:` item in EVERY section:
