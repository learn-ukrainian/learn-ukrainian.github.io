...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/george-shevelov.yaml
```

Read the current meta file for content_outline structure:

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/george-shevelov.yaml
```

## Your Task

Research **Юрій Шевельов: Архітектор української лінгвістики** for the **bio** track. Produce structured research notes that will drive content writing in later phases.
