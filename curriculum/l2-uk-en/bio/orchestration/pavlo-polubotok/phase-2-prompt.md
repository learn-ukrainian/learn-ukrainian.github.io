...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/pavlo-polubotok-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/pavlo-polubotok.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/pavlo-polubotok.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Павло Полуботок: Мученик за автономію** (bio track).
...
|---------|--------|---------------------|
| Вступ — Символ нескореності | 400 | 600 |
| Життєпис: I — Походження та шлях до влади | 450 | 675 |
| Життєпис: II — Наказний гетьман і арешт | 450 | 675 |
| Історичний контекст | 500 | 750 |
| Внесок: I — Захист прав через закон | 500 | 750 |
| Внесок: II — Меценатство та розбудова | 450 | 675 |
| Останні роки: I — Ув'язнення і діалог з Петром I | 500 | 750 |
| Останні роки: II — Моральна перемога | 450 | 675 |
| Спадщина: I — Легенда про золото | 500 | 750 |
| Спадщина: II — Символ національної гідності | 450 | 675 |
| Підсумок | 350 | 525 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/pavlo-polubotok.yaml`. Go through EVERY `points:` item in EVERY section:
