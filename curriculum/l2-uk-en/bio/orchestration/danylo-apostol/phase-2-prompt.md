...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/danylo-apostol-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/danylo-apostol.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/danylo-apostol.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Данило Апостол: Останній обраний гетьман** (bio track).
...
|---------|--------|---------------------|
| Вступ — Гетьман стабілізації | 400 | 600 |
| Життєпис: I — Шлях воїна | 700 | 1050 |
| Життєпис: II — Шлях до булави | 700 | 1050 |
| Історичний контекст | 600 | 900 |
| Внесок: I — Конституційний устрій | 800 | 1200 |
| Внесок: II — Соціально-економічні реформи | 800 | 1200 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/danylo-apostol.yaml`. Go through EVERY `points:` item in EVERY section:
