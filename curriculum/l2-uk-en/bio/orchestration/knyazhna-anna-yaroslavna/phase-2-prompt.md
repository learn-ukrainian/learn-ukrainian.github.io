...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/knyazhna-anna-yaroslavna-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/knyazhna-anna-yaroslavna.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/knyazhna-anna-yaroslavna.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Анна Ярославна: Королева Франції** (bio track).
...
|---------|--------|---------------------|
| Вступ — Руська княжна на престолі Франції | 500 | 750 |
| Життєпис: I — Дитинство та посольство | 600 | 900 |
| Життєпис: II — Коронація та життя в Парижі | 600 | 900 |
| Історичний контекст | 700 | 1050 |
| Внесок: I — Культурний вплив на французький двір | 600 | 900 |
| Внесок: II — Заснування монастиря святого Вікентія | 500 | 750 |
| Останні роки: I — Регентство при синові Філіпові I | 400 | 600 |
| Останні роки: II — Другий шлюб та вшанування пам'яті | 500 | 750 |
| Спадщина | 400 | 600 |
| Підсумок | 200 | 300 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/knyazhna-anna-yaroslavna.yaml`. Go through EVERY `points:` item in EVERY section:
