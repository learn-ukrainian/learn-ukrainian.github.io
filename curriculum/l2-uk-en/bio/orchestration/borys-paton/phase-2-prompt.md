...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/borys-paton-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/borys-paton.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/borys-paton.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Борис Патон: Академік століття** (bio track).
...
|---------|--------|---------------------|
| Вступ — Найдовше президентство в історії науки | 400 | 600 |
| Молодість і становлення: Інженер у тіні титана | 600 | 900 |
| Наукові досягнення: Ера металу і вогню | 800 | 1200 |
| Медична інженерія: Шов без ниток | 500 | 750 |
| Президент НАН України: Епоха стабільності і застою | 900 | 1350 |
| Державний діяч: Між наукою і владою | 800 | 1200 |
| Спадщина столітнього академіка: Підсумки | 1000 | 1500 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/borys-paton.yaml`. Go through EVERY `points:` item in EVERY section:
