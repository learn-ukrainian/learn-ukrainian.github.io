...
word_target: 5000
objectives:
- Дізнатися про життя та творчість Павло Филипович
sources:
...
content_outline:
- section: Вступ — Poet, Neoclassicist
  points:
  - <!-- point -->
  words: 850
...
Research **Павло Филипович: <!-- Title -->** for the **bio** track. Produce structured research notes that will drive content writing in Phase B.
