...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/josyf-slipyj-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/josyf-slipyj.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/josyf-slipyj.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Патріарх Йосиф Сліпий: Незламний сповідник віри** (bio track).
...
|---------|--------|---------------------|
| Вступ — 18 років у ГУЛАЗі | 500 | 750 |
| Молодість і духовне покликання: I — Галицьке коріння та західна освіта | 400 | 600 |
| Молодість і духовне покликання: II — Ректор і візіонер | 400 | 600 |
| Арешт і табори: I — Ніч арешту та відмова від зради | 400 | 600 |
| Арешт і табори: II — Географія страждань | 400 | 600 |
| Арешт і табори: III — Феномен духовної стійкості | 400 | 600 |
| Звільнення та місія в діаспорі: I — Дипломатія і свобода | 350 | 525 |
| Звільнення та місія в діаспорі: II — Голос на II Ватиканському соборі | 350 | 525 |
| Звільнення та місія в діаспорі: III — Інституційна розбудова | 300 | 450 |
| Боротьба за патріархат: I — Візія зрілої Церкви | 300 | 450 |
| Боротьба за патріархат: II — Конфлікт з Ватиканом (Ostpolitik) | 300 | 450 |
| Боротьба за патріархат: III — Самопроголошення і ствердження | 300 | 450 |
| Спадщина сповідника: I — Духовний Заповіт | 200 | 300 |
| Спадщина сповідника: II — Повернення додому | 200 | 300 |
| Спадщина сповідника: III — Сучасне значення | 200 | 300 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/josyf-slipyj.yaml`. Go through EVERY `points:` item in EVERY section:
