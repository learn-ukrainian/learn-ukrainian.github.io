...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/nataliya-kobrynska-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/nataliya-kobrynska.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/nataliya-kobrynska.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Наталія Кобринська: Піонерка фемінізму** (bio track).
...
|---------|--------|---------------------|
| Вступ: Народження українського фемінізму | 600 | 900 |
| Дитинство та освіта (1855-1875) | 800 | 1200 |
| Шлюб та переломний момент (1875-1883) | 800 | 1200 |
| «Перший вінок» та жіночий рух (1884-1893) | 1000 | 1500 |
| Літературна творчість | 1000 | 1500 |
| Останні роки та спадщина (1893-1920) | 800 | 1200 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/nataliya-kobrynska.yaml`. Go through EVERY `points:` item in EVERY section:
