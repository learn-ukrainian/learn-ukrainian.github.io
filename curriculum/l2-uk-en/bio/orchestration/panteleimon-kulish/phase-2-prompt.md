...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/panteleimon-kulish-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/panteleimon-kulish.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/panteleimon-kulish.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Пантелеймон Куліш: Будівничий української мови** (bio track).
...
|---------|--------|---------------------|
| Вступ: Архітектор українського слова | 500 | 750 |
| Ранні роки: Між хутором та університетом (1819-1840) | 750 | 1125 |
| Кирило-Мефодіївське братство: Просвіта проти бунту (1845-1847) | 850 | 1275 |
| Куліш і Шевченко: Діалог двох полюсів | 850 | 1275 |
| Мовотворча революція: Кулішівка та Святе Письмо | 1050 | 1575 |
| Пізній етап: «Чорна рада» та філософія культури (1860-1897) | 1050 | 1575 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/panteleimon-kulish.yaml`. Go through EVERY `points:` item in EVERY section:
