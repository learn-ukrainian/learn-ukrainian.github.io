...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/mykhailo-kotsiubynsky-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/mykhailo-kotsiubynsky.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/mykhailo-kotsiubynsky.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Михайло Коцюбинський: Імпресіоніст українського слова** (bio track).
...
|---------|--------|---------------------|
| Вступ: Чарівник настрою | 500 | 750 |
| Вінниччина та Поділля: Формування естетики (1864-1882) | 600 | 900 |
| Учитель і народник: Від етнографії до психологізму (1882-1897) | 650 | 975 |
| Чернігівський період: Літературна зрілість і «Fata Morgana» (1898-1913) | 700 | 1050 |
| Тіні забутих предків: Гуцульська симфонія | 750 | 1125 |
| Європейські горизонти: Крим, Капрі та діалог культур | 650 | 975 |
| Імпресіоністична поетика: Архітектура кольору і звуку | 650 | 975 |
| Спадщина: Сонцепоклонник у пам'яті поколінь | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/mykhailo-kotsiubynsky.yaml`. Go through EVERY `points:` item in EVERY section:
