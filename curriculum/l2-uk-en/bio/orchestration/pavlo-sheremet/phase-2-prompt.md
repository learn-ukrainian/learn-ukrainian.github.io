...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/pavlo-sheremet-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/pavlo-sheremet.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/pavlo-sheremet.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Павло Шеремет: Журналістика як місія свободи** (bio track).
...
|---------|--------|---------------------|
| Вступ — Журналіст трьох країн | 600 | 900 |
| Життєпис: I — Білоруський фронт | 800 | 1200 |
| Життєпис: II — Московське розчарування | 800 | 1200 |
| Життєпис: III — Український вибір | 800 | 1200 |
| Історичний контекст: Свобода слова в лещатах війни | 600 | 900 |
| Внесок та Останні роки: Місія правди | 800 | 1200 |
| Спадщина: Вільне слово не вбити | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/pavlo-sheremet.yaml`. Go through EVERY `points:` item in EVERY section:
