...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/petro-bolbochan-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/petro-bolbochan.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/petro-bolbochan.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Петро Болбочан: Полковник-герой** (bio track).
...
|---------|--------|---------------------|
| Вступ — Герой Криму | 400 | 600 |
| Ранні роки та військова освіта (1883-1914) | 600 | 900 |
| Перша світова війна: Шлях до українського війська | 700 | 1050 |
| Кримський похід: I — Прорив на півострів | 800 | 1200 |
| Кримський похід: II — Геополітика і зброя | 800 | 1200 |
| Конфлікт з владою: Державник проти соціалістів | 800 | 1200 |
| Трагедія фіналу: Арешт, суд і страта | 900 | 1350 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/petro-bolbochan.yaml`. Go through EVERY `points:` item in EVERY section:
