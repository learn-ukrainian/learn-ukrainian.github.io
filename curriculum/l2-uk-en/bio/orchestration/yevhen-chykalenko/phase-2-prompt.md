...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/yevhen-chykalenko-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/yevhen-chykalenko.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/yevhen-chykalenko.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Євген Чикаленко: Меценат і видавець** (bio track).
...
|---------|--------|---------------------|
| Вступ — Людина, яка платила за Україну | 500 | 750 |
| Полтавщина та формування світогляду | 500 | 750 |
| Господарська діяльність | 500 | 750 |
| Меценат і видавець: I — Газета «Рада» | 600 | 900 |
| Меценат і видавець: II — Підтримка ініціатив | 500 | 750 |
| Громадська діяльність: I — Дореволюційний період | 600 | 900 |
| Громадська діяльність: II — Доба визвольних змагань | 500 | 750 |
| Еміграція та щоденники | 700 | 1050 |
| Дискусія — Роль меценатства в національному русі | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/yevhen-chykalenko.yaml`. Go through EVERY `points:` item in EVERY section:
