...
| Module persona | Senior Biographer, acting as Agronomist Publisher |
...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/yevhen-chykalenko.md
```

**Plan file** (vocabulary_hints — vocabulary list to follow):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/yevhen-chykalenko.yaml
```

**Meta file** (activity count targets, pedagogy):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/yevhen-chykalenko.yaml
```
