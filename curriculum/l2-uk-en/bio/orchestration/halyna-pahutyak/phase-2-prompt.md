...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/halyna-pahutyak-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/halyna-pahutyak.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/halyna-pahutyak.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Галина Пагутяк: Містична письменниця** (bio track).
...
|---------|--------|---------------------|
| Вступ — Голос з іншого світу | 400 | 600 |
| Юність та формування (1958-1980) | 500 | 750 |
| Ранній період творчості (1980-1990-ті): I — Дебют «Діти» | 600 | 900 |
| Ранній період творчості (1980-1990-ті): II — Пошук власного голосу | 600 | 900 |
| Химерний реалізм (2000-ні): I — «Слуга з Добромиля» | 800 | 1200 |
| Химерний реалізм (2000-ні): II — «Урізька готика» | 800 | 1200 |
| Філософська проза (2010-ні): I — Есеїстика та природа | 700 | 1050 |
| Філософська проза (2010-ні): II — Публіцистичний голос | 600 | 900 |
| Спадщина — Архітекторка світів | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/halyna-pahutyak.yaml`. Go through EVERY `points:` item in EVERY section:
