...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/mariya-pavlova-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/mariya-pavlova.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/mariya-pavlova.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Марія Павлова: Видатний палеонтолог** (bio track).
...
|---------|--------|---------------------|
| Вступ — Жінка, що читала кістки | 450 | 675 |
| Ранні роки: Козелець і Київ (1854-1880) | 700 | 1050 |
| Паризький університет: Народження науковця (1880-1886) | 800 | 1200 |
| Московський період: Будівництво музею (1886-1920) | 900 | 1350 |
| Еволюція коней та хоботних: Головні відкриття | 1100 | 1650 |
| Останні роки та спадщина (1920-1938) | 1050 | 1575 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/mariya-pavlova.yaml`. Go through EVERY `points:` item in EVERY section:
