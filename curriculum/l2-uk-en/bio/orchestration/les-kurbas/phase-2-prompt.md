...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/les-kurbas-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/les-kurbas.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/les-kurbas.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Лесь Курбас: Реформатор театру** (bio track).
...
|---------|--------|---------------------|
| Вступ — Людина, що перевернула театр | 600 | 900 |
| Ранні роки та становлення (1887-1916) | 800 | 1200 |
| Молодий театр та «Березіль»: I — Епоха пошуку (1916-1926) | 800 | 1200 |
| Молодий театр та «Березіль»: II — Харківський модернізм (1926-1933) | 1000 | 1500 |
| Театральна революція та естетика | 1000 | 1500 |
| Репресії та знищення (1933-1937) | 600 | 900 |
| Спадщина та реабілітація | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/les-kurbas.yaml`. Go through EVERY `points:` item in EVERY section:
