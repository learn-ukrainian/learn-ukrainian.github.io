...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/danylo-halytskyi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/danylo-halytskyi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/danylo-halytskyi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Данило Галицький: Король Русі** (bio track).
...
|---------|--------|---------------------|
| Вступ — Єдиний коронований король Русі | 300 | 450 |
| Життєпис: I — Дитинство та уроки вигнання | 500 | 750 |
| Життєпис: II — Відновлення єдності та перемога | 600 | 900 |
| Внесок: I — Дипломатія виживання та коронація | 700 | 1050 |
| Внесок: II — Урбаністика та економіка | 600 | 900 |
| Останні роки: I — Успішний опір Куремсі | 500 | 750 |
| Останні роки: II — Ультиматум Бурундая | 500 | 750 |
| Спадщина: Королівська традиція | 500 | 750 |
| Спадщина: Цивілізаційний вибір (Данило vs Невський) | 400 | 600 |
| Підсумок — Король без королівства? | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/danylo-halytskyi.yaml`. Go through EVERY `points:` item in EVERY section:
