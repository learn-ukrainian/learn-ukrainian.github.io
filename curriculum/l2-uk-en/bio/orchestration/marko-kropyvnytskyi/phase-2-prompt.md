...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/marko-kropyvnytskyi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/marko-kropyvnytskyi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/marko-kropyvnytskyi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Марко Кропивницький: Корифей театру** (bio track).
...
|---------|--------|---------------------|
| Вступ — Батько українського театру | 400 | 600 |
| Ранні роки: Формування особистості (1840–1865) | 600 | 900 |
| Всупереч імперії: Шлях до сцени (1865–1882) | 600 | 900 |
| Народження Театру корифеїв: 1882 рік | 800 | 1200 |
| Тріумф і розкол: Гастролі та динаміка трупи | 600 | 900 |
| Драматургічна спадщина: Соціальний реалізм | 500 | 750 |
| Музика і сценографія: Етнографічний метод | 500 | 750 |
| Останні роки: Патріарх на хуторі Затишок | 500 | 750 |
| Вплив та пам'ять: Фундамент модернізму | 500 | 750 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/marko-kropyvnytskyi.yaml`. Go through EVERY `points:` item in EVERY section:
