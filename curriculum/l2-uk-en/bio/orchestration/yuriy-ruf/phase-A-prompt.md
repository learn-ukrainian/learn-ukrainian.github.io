...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/yuriy-ruf.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/yuriy-ruf.yaml
```
...
Research **Юрій Руф** for the **bio** track. Produce structured research notes that will drive content writing in Phase B.
