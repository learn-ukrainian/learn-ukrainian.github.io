...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/taras-shevchenko-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/taras-shevchenko.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/taras-shevchenko.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Тарас Шевченко: Національний Пророк** (bio track).
...
|---------|--------|---------------------|
| Вступ — Більше ніж поет | 500 | 750 |
| Кріпацтво та ранні роки: I — Дитинство в Моринцях | 400 | 600 |
| Кріпацтво та ранні роки: II — Служба та формування пам'яті | 400 | 600 |
| Викуп та становлення митця: I — Знайомство з елітою та викуп | 450 | 675 |
| Викуп та становлення митця: II — Академія мистецтв | 400 | 600 |
| Кобзар та пробудження нації: I — Вихід «Кобзаря» (1840) | 500 | 750 |
| Кобзар та пробудження нації: II — Період «трьох літ» | 500 | 750 |
| Кирило-Мефодіївське братство та заслання: I — Діяльність у товаристві та арешт | 450 | 675 |
| Кирило-Мефодіївське братство та заслання: II — Голгофа заслання | 450 | 675 |
| Останні роки та безсмертя | 500 | 750 |
| Дискусія — Шевченко в деколонізаційному дискурсі | 450 | 675 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/taras-shevchenko.yaml`. Go through EVERY `points:` item in EVERY section:
