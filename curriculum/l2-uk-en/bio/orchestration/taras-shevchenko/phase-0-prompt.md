...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/taras-shevchenko.yaml
```

Read the current meta file for content_outline structure:

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/taras-shevchenko.yaml
```

## Your Task

Research **Тарас Шевченко: Національний Пророк** for the **bio** track. Produce structured research notes that will drive content writing in later phases.
