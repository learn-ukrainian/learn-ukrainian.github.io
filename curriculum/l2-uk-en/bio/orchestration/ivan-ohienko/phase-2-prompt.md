...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/ivan-ohienko-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/ivan-ohienko.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/ivan-ohienko.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Іван Огієнко: Митрополит і Захисник Мови** (bio track).
...
|---------|--------|---------------------|
| Вступ — Людина багатьох покликань | 600 | 900 |
| Житомирщина та формування: Від Брусилова до Києва | 700 | 1050 |
| Мовознавець і освітянин: На сторожі слова | 800 | 1200 |
| Державна діяльність: Будівничий УНР | 750 | 1125 |
| Еміграція та церковна служба: Митрополит Іларіон | 800 | 1200 |
| Переклад Біблії: Справа всього життя | 750 | 1125 |
| Дискусія — Мова і віра як основи нації | 600 | 900 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/ivan-ohienko.yaml`. Go through EVERY `points:` item in EVERY section:
