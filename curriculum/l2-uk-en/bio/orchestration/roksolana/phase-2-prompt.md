...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/roksolana-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/roksolana.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/roksolana.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Роксолана: Від рабині до султанші** (bio track).
...
|---------|--------|---------------------|
| Вступ — Найвпливовіша жінка Османської імперії | 400 | 600 |
| Викрадення та рабство | 500 | 750 |
| Сходження до влади: I — Прихильність Сулеймана | 600 | 900 |
| Сходження до влади: II — Від рабині до хасекі | 500 | 750 |
| Політичний вплив: I — Державні справи та дипломатія | 600 | 900 |
| Політичний вплив: II — Інтриги та боротьба за владу | 600 | 900 |
| Благодійність та будівництво | 500 | 750 |
| Спадщина та образ у культурі: I — Османська пам'ять та поховання | 400 | 600 |
| Спадщина та образ у культурі: II — Український міф та мистецтво | 500 | 750 |
| Підсумок — Жінка, що змінила імперію | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/roksolana.yaml`. Go through EVERY `points:` item in EVERY section:
