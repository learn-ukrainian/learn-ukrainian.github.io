...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/dmytro-falkivskyi-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/dmytro-falkivskyi.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/dmytro-falkivskyi.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Дмитро Фальківський: <!-- Title -->** (bio track).
...
|---------|--------|---------------------|
| Вступ: Поет із тавром чекіста | 400 | 600 |
| Ранні роки: Полісся, війна і «гріх молодості» | 800 | 1200 |
| Літературне життя Києва: У колі «Ланки» | 900 | 1350 |
| Поетичний світ: Від «Чабана» до «Полісся» | 1000 | 1500 |
| Феномен одного вірша: «Очерет мені був за колиску» | 700 | 1050 |
| Грудень 1934-го: Хроніка вбивства | 800 | 1200 |
| Спадщина: Повернення із забуття | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/dmytro-falkivskyi.yaml`. Go through EVERY `points:` item in EVERY section:
