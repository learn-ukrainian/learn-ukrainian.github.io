...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/mykhailo-yangel-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/mykhailo-yangel.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/mykhailo-yangel.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Михайло Янгель: Творець ракетного щита та космічної міці** (bio track).
...
|---------|--------|---------------------|
| Вступ — Архітектор ракетної столиці | 600 | 900 |
| Життєпис: I — Коріння та шлях до мети | 600 | 900 |
| Життєпис: II — Протистояння титанів та народження КБ | 700 | 1050 |
| Історичний контекст: I — Феномен закритого міста | 500 | 750 |
| Історичний контекст: II — Українська агентність | 500 | 750 |
| Внесок: I — Стратегічний щит і трагедія | 600 | 900 |
| Внесок: II — Мирний космос та автоматизація | 500 | 750 |
| Сучасний етап: Космічна спадщина Дніпра | 600 | 900 |
| Спадщина: Зірка на ім'я Янгель | 400 | 600 |
| **Total** | **5000** | **7500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/mykhailo-yangel.yaml`. Go through EVERY `points:` item in EVERY section:
