...
| Module persona | Senior Biographer, acting as Underground Commander |
...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/yevhen-konovalets.md
```

**Plan file** (vocabulary_hints — vocabulary list to follow):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/yevhen-konovalets.yaml
```

**Meta file** (activity count targets, pedagogy):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/yevhen-konovalets.yaml
```
