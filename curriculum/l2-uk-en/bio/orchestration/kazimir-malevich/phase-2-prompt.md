...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/research/kazimir-malevich-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/kazimir-malevich.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/bio/kazimir-malevich.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Казимир Малевич: Революція в мистецтві** (bio track).
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/bio/meta/kazimir-malevich.yaml`. Go through EVERY `points:` item in EVERY section:
