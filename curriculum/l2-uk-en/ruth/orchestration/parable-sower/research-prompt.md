...
version: '2.0'
title: 'Притча: Сіяч'
subtitle: 'The Parables I: Sower'
focus: Agricultural vocabulary — Ролія, Зерно
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to The Parables I: Sower'
  words: 1250
...
Research **Притча: Сіяч** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
