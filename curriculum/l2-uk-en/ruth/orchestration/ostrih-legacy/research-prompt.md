...
slug: ostrih-legacy
version: '2.0'
title: Спадщина Острога
subtitle: Ostrih Legacy
focus: Impact on Muscovite/Russian norms
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Ostrih Legacy
  words: 1250
...
Research **Спадщина Острога** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
