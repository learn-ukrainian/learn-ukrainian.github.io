...
version: '2.0'
title: Проста мова
subtitle: The Simple Tongue
focus: Why he mixed vernacular with CS
phase: 3
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to The Simple Tongue
  words: 1250
...
persona:
  ...
  role: Defender of the Simple Tongue
prerequisites:
- social-critique
connects_to:
- epistle-to-ostrozky
...
Research **Проста мова** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
