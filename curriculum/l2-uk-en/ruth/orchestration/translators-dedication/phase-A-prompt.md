...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/ruth/translators-dedication.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/ruth/meta/translators-dedication.yaml
```
...
Research **Translators Dedication** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
...
# Дослідження: Translators Dedication
