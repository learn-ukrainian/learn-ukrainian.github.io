...
version: '2.0'
title: Основи земельного права
subtitle: Land Law Basics
focus: Земля, Ім'єніє — Feudal tenure
phase: 1
word_target: 5000
content_outline:
- section: Вступ
...
Research **Основи земельного права** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
...
```yaml
subject: "Основи земельного права"
