...
version: '2.0'
title: Грабянка — Героїчна Хроніка
subtitle: Hrabianka — Heroic Chronicle
focus: Reading Hrabianka's chronicle as heroic epic and historical document
phase: 4
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Hrabianka — Heroic Chronicle
  words: 1250
...
persona:
  ...
  role: Cossack Heroic Chronicler
prerequisites:
- chronicle-lab
connects_to:
- velychko-ruin-baroque-1
objectives:
...
Research **Грабянка — Героїчна Хроніка** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
