...
version: '2.0'
title: Полонізми у праві
subtitle: Polonisms in Law
focus: Identifying Polish loanwords
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Polonisms in Law
  words: 1250
...
Research **Полонізми у праві** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
...
- `query_wikipedia(query="Полонізми у праві", mode="extract")` — factual backbone
- `search_literary(query="Полонізми у праві")` — primary source excerpts
