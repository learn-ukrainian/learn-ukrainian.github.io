...
version: '2.0'
title: Напад на єпископів
subtitle: Attack on Bishops
focus: Fierce invective — Wolves in shepherds' skins
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Attack on Bishops
  words: 1250
...
Research **Напад на єпископів** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
