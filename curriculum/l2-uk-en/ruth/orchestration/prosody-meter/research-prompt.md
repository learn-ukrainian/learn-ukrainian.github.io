...
title: Просодія
subtitle: Prosody
focus: Poetic rules — Quantitative vs Syllabic
phase: 2
word_target: 5000
content_outline:
- section: Вступ
...
Research **Просодія** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
