...
version: '2.0'
title: 'Палеографія: Скоропис'
subtitle: 'Paleography Lab: Skoropys'
focus: Reading 16th c. Chancery Cursive
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to Paleography Lab: Skoropys'
  words: 1250
...
Research **Палеографія: Скоропис** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
