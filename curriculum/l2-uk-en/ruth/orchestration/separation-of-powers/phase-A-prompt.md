...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/ruth/separation-of-powers.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/ruth/meta/separation-of-powers.yaml
```
...
Research **Separation Of Powers** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
...
# Дослідження: Separation Of Powers
