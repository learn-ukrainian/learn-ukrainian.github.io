...
version: '2.0'
title: Граматична лабораторія
subtitle: Grammar Lab
focus: Parsing a CS sentence using Smotrytsky's rules
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Grammar Lab
  words: 1250
...
Research **Граматична лабораторія** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
...
# Дослідження: Граматична лабораторія
