...
slug: baroque-lists
version: '2.0'
title: Барокові списки
subtitle: Baroque Lists
focus: The heaping technique — Нагромадження
phase: 3
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Baroque Lists
  words: 1250
...
Research **Барокові списки** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
