...
version: '2.0'
title: 'Пророки: Ісая'
subtitle: 'Prophets: Isaiah'
focus: Rhetorical complexity — Greek calques
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to Prophets: Isaiah'
  words: 1250
...
Research **Пророки: Ісая** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
