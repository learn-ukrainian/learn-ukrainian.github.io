...
version: '2.0'
title: Опіка
subtitle: Guardianship
focus: Опека — Protecting orphans
phase: 1
word_target: 5000
content_outline:
- section: Вступ
...
Research **Опіка** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
