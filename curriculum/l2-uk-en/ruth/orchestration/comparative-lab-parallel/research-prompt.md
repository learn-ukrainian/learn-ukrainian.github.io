...
version: '2.0'
title: Порівняльна лабораторія
subtitle: Comparative Lab
focus: Analyzing one verse across 4 versions
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Comparative Lab
  words: 1250
...
Research **Порівняльна лабораторія** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
...
```yaml
subject: "Порівняльна лабораторія"
