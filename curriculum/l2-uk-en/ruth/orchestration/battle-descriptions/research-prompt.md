...
version: '2.0'
title: Описи битв
subtitle: Battle Descriptions
focus: Comparing chroniclers on same event (Berestechko)
phase: 4
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Battle Descriptions
  words: 1250
...
Research **Описи битв** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
