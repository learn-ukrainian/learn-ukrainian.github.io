...
version: '2.0'
title: 'Канцелярські формули: Датування'
subtitle: Chancery Formulae II
focus: Dating clauses — "Pisan u Vilni..."
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Chancery Formulae II
  words: 1250
...
Research **Канцелярські формули: Датування** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
...
- `query_wikipedia(query="Канцелярські формули: Датування", mode="extract")` — factual backbone
- `search_literary(query="Канцелярські формули: Датування")` — primary source excerpts
