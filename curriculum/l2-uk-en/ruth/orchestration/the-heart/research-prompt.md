...
title: Серце
subtitle: The Heart
focus: Cordocentrism — Кордоцентризм
phase: 4
word_target: 5000
content_outline:
- section: Вступ
...
persona:
  ...
  role: Cordocentric Thinker
prerequisites:
- affinity-srodna-pratsia
connects_to:
- divine-songs
objectives:
...
Research **Серце** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
