...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/ruth/diplomatic-language.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/ruth/meta/diplomatic-language.yaml
```
...
Research **Diplomatic Language** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
...
# Дослідження: Diplomatic Language
