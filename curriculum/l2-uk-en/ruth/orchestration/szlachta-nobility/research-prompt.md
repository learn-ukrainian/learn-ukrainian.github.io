...
version: '2.0'
title: Шляхта
subtitle: The Szlachta
focus: Rights and privileges of nobility
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to The Szlachta
  words: 1250
...
Research **Шляхта** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
