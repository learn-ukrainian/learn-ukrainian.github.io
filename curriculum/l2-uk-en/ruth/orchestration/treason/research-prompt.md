...
title: Зрада
subtitle: Treason
focus: Образа Маєстату — High crimes
phase: 1
word_target: 5000
content_outline:
- section: Вступ
...
Research **Зрада** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
