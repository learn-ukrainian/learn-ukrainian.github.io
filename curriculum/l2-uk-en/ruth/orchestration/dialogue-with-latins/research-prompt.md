...
version: '2.0'
title: Діалог з латинами
subtitle: Dialogue with Latins
focus: Arguments against Union of Brest
phase: 3
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Dialogue with Latins
  words: 1250
...
Research **Діалог з латинами** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
