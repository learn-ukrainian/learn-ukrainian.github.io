...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/ruth/parts-of-speech.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/ruth/meta/parts-of-speech.yaml
```
...
Research **Parts Of Speech** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
