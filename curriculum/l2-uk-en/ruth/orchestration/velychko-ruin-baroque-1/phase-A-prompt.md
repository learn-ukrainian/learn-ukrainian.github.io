...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/ruth/velychko-ruin-baroque-1.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/ruth/meta/velychko-ruin-baroque-1.yaml
```
...
Research **Velychko Ruin Baroque 1** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
...
```yaml
subject: "Velychko Ruin Baroque 1"
