...
subtitle: Judicial Procedure
focus: Позва, Свідченіє — Summons, Testimony
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Judicial Procedure
  words: 1250
...
Research **Судовий процес** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
...
# Дослідження: Судовий процес

## Key Facts Ledger
<!-- IMMUTABLE TRUTH ANCHOR — review phase verifies prose against this -->
```yaml
subject: "Судовий процес"
