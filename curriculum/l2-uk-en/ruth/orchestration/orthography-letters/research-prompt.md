...
version: '2.0'
title: 'Орфографія: Літери'
subtitle: Orthography
focus: The letter "Ґ" (G) vs "КГ"
phase: 2
word_target: 5000
content_outline:
- section: Вступ
...
Research **Орфографія: Літери** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
