...
version: '2.0'
title: Потреба норм
subtitle: The Need for Norms
focus: Why codify? The Latin challenge
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to The Need for Norms
  words: 1250
...
Research **Потреба норм** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
