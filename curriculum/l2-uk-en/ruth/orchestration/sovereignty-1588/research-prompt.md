...
version: '2.0'
title: Суверенітет (1588)
subtitle: Sovereignty
focus: GDL independence rhetoric
phase: 1
word_target: 5000
content_outline:
- section: Вступ
...
Research **Суверенітет (1588)** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
...
- `query_wikipedia(query="Суверенітет (1588)", mode="extract")` — factual backbone
- `search_literary(query="Суверенітет (1588)")` — primary source excerpts
