...
version: '2.0'
title: Юридична професія
subtitle: The Legal Profession
focus: Прокуратор, Возний — Roles in court
phase: 1
word_target: 5000
content_outline:
- section: Вступ
...
Research **Юридична професія** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
