...
version: '2.0'
title: Мистецтво та правопис
subtitle: Art & Orthography
focus: Visual style of the manuscript
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Art & Orthography
  words: 1250
...
Research **Мистецтво та правопис** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
