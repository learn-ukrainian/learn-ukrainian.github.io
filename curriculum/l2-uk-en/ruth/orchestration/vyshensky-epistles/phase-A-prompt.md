...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/ruth/vyshensky-epistles.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/ruth/meta/vyshensky-epistles.yaml
```
...
Research **Vyshensky Epistles** for the **ruth** track. Produce structured research notes that will drive content writing in Phase B.
