...
subtitle: Daily Life Vocabulary
focus: Bread, meat, horses, boats (Vernacular vs Liturgical)
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Daily Life Vocabulary
  words: 1250
...
Research **Побутова лексика** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
