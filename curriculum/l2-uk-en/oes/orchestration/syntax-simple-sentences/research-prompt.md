...
version: '2.0'
title: 'Синтаксис: Прості речення'
subtitle: 'Syntax: Simple Sentences'
focus: Word order in vernacular vs Church Slavonic
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to Syntax: Simple Sentences'
  words: 1250
...
Research **Синтаксис: Прості речення** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
