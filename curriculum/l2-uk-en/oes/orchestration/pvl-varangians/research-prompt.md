...
version: '2.0'
title: 'ПВЛ: Варяги'
subtitle: 'PVL: The Varangians'
focus: Aorist intro — "Riksha" (They said)
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to PVL: The Varangians'
  words: 1250
...
Research **ПВЛ: Варяги** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
