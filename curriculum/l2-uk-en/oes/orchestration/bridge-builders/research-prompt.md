...
version: '2.0'
title: Мостники
subtitle: The Bridge Builders
focus: First fee schedule — Economic vocabulary
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to The Bridge Builders
  words: 1250
...
Research **Мостники** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
