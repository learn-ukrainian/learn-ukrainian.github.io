...
version: '2.0'
title: 'ПВЛ: Смерть Ігоря'
subtitle: 'PVL: Death of Igor'
focus: Aorist mastery — dramatic narrative
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to PVL: Death of Igor'
  words: 1250
...
Research **ПВЛ: Смерть Ігоря** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
