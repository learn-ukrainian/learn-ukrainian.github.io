...
version: '2.0'
title: Челядь (невільники)
subtitle: The Cheliadin (Slaves)
focus: Social hierarchy intro
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to The Cheliadin (Slaves)
  words: 1250
...
Research **Челядь (невільники)** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
