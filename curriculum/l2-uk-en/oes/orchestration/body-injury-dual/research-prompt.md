...
version: '2.0'
title: Тіло та ушкодження
subtitle: The Body & Injury
focus: Dual Number — Eyes, ears, legs
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to The Body & Injury
  words: 1250
...
Research **Тіло та ушкодження** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
