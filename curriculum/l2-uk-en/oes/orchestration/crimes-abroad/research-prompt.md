...
slug: crimes-abroad
version: '2.0'
title: Злочини за кордоном
subtitle: Crimes Abroad
focus: Extradition & International justice
phase: 3
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Crimes Abroad
  words: 1250
...
Research **Злочини за кордоном** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
...
- `query_wikipedia(query="Злочини за кордоном", mode="extract")` — factual backbone
- `search_literary(query="Злочини за кордоном")` — primary source excerpts
