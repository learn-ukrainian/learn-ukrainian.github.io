...
version: '2.0'
title: 'Алфавіт: Від глаголиці до кирилиці'
subtitle: 'Alphabet: Glagolitic to Cyrillic'
focus: Early scripts in St. Sophia
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to Alphabet: Glagolitic to Cyrillic'
  words: 1250
...
Research **Алфавіт: Від глаголиці до кирилиці** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
