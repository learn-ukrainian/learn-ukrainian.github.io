...
version: '2.0'
title: Прикметники та узгодження
subtitle: Adjectives & Agreement
focus: Куни лодійні — Agreement in case/gender
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Adjectives & Agreement
  words: 1250
...
Research **Прикметники та узгодження** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
