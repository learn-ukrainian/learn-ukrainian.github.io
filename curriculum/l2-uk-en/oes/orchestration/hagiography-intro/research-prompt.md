...
version: '2.0'
title: Вступ до агіографії
subtitle: Intro to Hagiography
focus: Genre conventions — "Life" (Zhitiye)
phase: 4
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Intro to Hagiography
  words: 1250
...
Research **Вступ до агіографії** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
