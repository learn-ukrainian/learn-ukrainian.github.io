...
version: '2.0'
title: 'Слово: Унікальні слова'
subtitle: 'Slovo: Hapax Legomena'
focus: Striltsy, Shereshiry, Karnu/Zhylya
phase: 4
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to Slovo: Hapax Legomena'
  words: 1250
...
Research **Слово: Унікальні слова** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
