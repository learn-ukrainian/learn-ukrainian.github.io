...
version: '2.0'
title: Данило Заточник
subtitle: Daniel the Exile
focus: Courtly wit vs Monastic solemnity
phase: 4
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Daniel the Exile
  words: 1250
...
Research **Данило Заточник** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
