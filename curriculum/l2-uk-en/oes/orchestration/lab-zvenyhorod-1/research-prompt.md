...
version: '2.0'
title: 'Лабораторія: Звенигород №1'
subtitle: 'Lab: Zvenyhorod Letter #1'
focus: Detailed breakdown of the Govinova letter
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to Lab: Zvenyhorod Letter #1'
  words: 1250
...
Research **Лабораторія: Звенигород №1** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
...
```yaml
subject: "Лабораторія: Звенигород №1"
