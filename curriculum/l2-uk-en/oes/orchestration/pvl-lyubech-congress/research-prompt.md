...
version: '2.0'
title: 'ПВЛ: Любецький з''їзд'
subtitle: 'PVL: Lyubech Congress'
focus: '"Let us not ruin the Rus land" — Hortative mood'
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to PVL: Lyubech Congress'
  words: 1250
...
Research **ПВЛ: Любецький з'їзд** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
