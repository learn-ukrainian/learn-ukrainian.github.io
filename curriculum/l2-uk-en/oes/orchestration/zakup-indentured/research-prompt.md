...
version: '2.0'
title: Закупи
subtitle: The Zakup (Indentured)
focus: Debt slavery laws
phase: 3
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to The Zakup (Indentured)
  words: 1250
...
Research **Закупи** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
