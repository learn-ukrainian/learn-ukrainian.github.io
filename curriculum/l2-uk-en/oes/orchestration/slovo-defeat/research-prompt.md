...
version: '2.0'
title: 'Слово: Поразка'
subtitle: 'Slovo: The Defeat'
focus: Metaphor — "Sowing fields with bones"
phase: 4
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to Slovo: The Defeat'
  words: 1250
...
Research **Слово: Поразка** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
