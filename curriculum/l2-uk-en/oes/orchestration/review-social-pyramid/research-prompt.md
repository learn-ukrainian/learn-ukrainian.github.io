...
version: '2.0'
title: 'Огляд: Соціальна піраміда'
subtitle: 'Review: Social Pyramid'
focus: Consolidation of social terms
phase: 3
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to Review: Social Pyramid'
  words: 1250
...
Research **Огляд: Соціальна піраміда** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
