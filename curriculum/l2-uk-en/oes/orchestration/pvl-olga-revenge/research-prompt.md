...
version: '2.0'
title: 'ПВЛ: Помста Ольги'
subtitle: 'PVL: Olga''s Revenge'
focus: Mixed tenses — Planning (Imp) vs Execution (Aor)
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to PVL: Olga''s Revenge'
  words: 1250
...
Research **ПВЛ: Помста Ольги** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
