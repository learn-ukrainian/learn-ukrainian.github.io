...
version: '2.0'
title: Числа та валюта
subtitle: Numbers & Currency
focus: 'Куни, ногати, гривні (Zvenyhorod #1)'
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Numbers & Currency
  words: 1250
...
Research **Числа та валюта** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
