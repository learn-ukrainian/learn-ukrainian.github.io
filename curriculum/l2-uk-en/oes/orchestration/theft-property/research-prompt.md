...
slug: theft-property
version: '2.0'
title: Крадіжка (власність)
subtitle: Theft (Property)
focus: Accusative Plural
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Theft (Property)
  words: 1250
...
Research **Крадіжка (власність)** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
