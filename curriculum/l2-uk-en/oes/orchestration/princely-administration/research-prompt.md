...
version: '2.0'
title: Княжа адміністрація
subtitle: The Princely Administration
focus: Administrative titles
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to The Princely Administration
  words: 1250
...
Research **Княжа адміністрація** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
