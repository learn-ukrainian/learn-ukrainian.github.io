...
version: '2.0'
title: 'ПВЛ: Три брати'
subtitle: 'PVL: The Three Brothers'
focus: Yaroslavychi — Feudal terminology
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to PVL: The Three Brothers'
  words: 1250
...
Research **ПВЛ: Три брати** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
