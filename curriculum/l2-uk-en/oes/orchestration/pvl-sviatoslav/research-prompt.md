...
version: '2.0'
title: 'ПВЛ: Святослав'
subtitle: 'PVL: Sviatoslav'
focus: The Warrior Prince — "Idu na vy"
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to PVL: Sviatoslav'
  words: 1250
...
persona:
  ...
  role: Campaign Logistics Officer
prerequisites:
- pvl-olga-revenge
connects_to:
- pvl-volodymyr-choice
objectives:
...
Research **ПВЛ: Святослав** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
...
- `query_wikipedia(query="ПВЛ: Святослав", mode="extract")` — factual backbone
- `search_literary(query="ПВЛ: Святослав")` — primary source excerpts
