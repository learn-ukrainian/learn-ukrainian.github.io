...
version: '2.0'
title: 'Лабораторія: Злодій Козьма'
subtitle: 'Lab: The Thief Kuzma'
focus: Analysis of the curse graffiti
phase: 1
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to Lab: The Thief Kuzma'
  words: 1250
...
Research **Лабораторія: Злодій Козьма** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
...
```yaml
subject: "Лабораторія: Злодій Козьма"
