...
version: '2.0'
title: 'Слово: Перша битва'
subtitle: 'Slovo: The First Battle'
focus: Aorist/Imperfect poetic usage
phase: 4
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to Slovo: The First Battle'
  words: 1250
...
Research **Слово: Перша битва** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
