...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/oes/slovo-authenticity-debate.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/oes/meta/slovo-authenticity-debate.yaml
```
...
Research **Slovo Authenticity Debate** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
