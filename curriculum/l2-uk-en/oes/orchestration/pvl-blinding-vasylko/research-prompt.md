...
version: '2.0'
title: 'ПВЛ: Осліплення Василька'
subtitle: 'PVL: Blinding of Vasylko'
focus: Psychological horror — complex syntax
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to PVL: Blinding of Vasylko'
  words: 1250
...
prerequisites:
- pvl-lyubech-congress
connects_to:
- monomakh-instruction
objectives:
...
Research **ПВЛ: Осліплення Василька** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
