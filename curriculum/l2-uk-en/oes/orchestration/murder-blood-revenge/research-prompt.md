...
version: '2.0'
title: Вбивство та кровна помста
subtitle: Murder & Blood Revenge
focus: The concept of Vyra (Weregild)
phase: 2
word_target: 5000
content_outline:
- section: Вступ
  points:
  - Introduction to Murder & Blood Revenge
  words: 1250
...
Research **Вбивство та кровна помста** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
