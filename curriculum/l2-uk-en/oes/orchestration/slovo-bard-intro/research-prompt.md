...
version: '2.0'
title: 'Слово: Вступ барда'
subtitle: 'Slovo: The Bard''s Intro'
focus: '"Ne lěpo li ny..." — Poetic vs Historical truth'
phase: 3
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to Slovo: The Bard''s Intro'
  words: 1250
...
Research **Слово: Вступ барда** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
