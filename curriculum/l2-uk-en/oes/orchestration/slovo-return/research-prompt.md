...
slug: slovo-return
version: '2.0'
title: 'Слово: Повернення'
subtitle: 'Slovo: The Return'
focus: Joyous vocabulary — Doxology
phase: 4
word_target: 5000
content_outline:
- section: Вступ
  points:
  - 'Introduction to Slovo: The Return'
  words: 1250
...
Research **Слово: Повернення** for the **oes** track. Produce structured research notes that will drive content writing in Phase B.
