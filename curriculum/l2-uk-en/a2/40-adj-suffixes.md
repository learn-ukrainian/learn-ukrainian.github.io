...
- **-Ов- (Стандарт):** Це найпоширеніший суфікс для багатьох матеріалів. Він створює логічний зв'язок між іменником та якістю.
  - _Дуб_ (oak) -> **Дубовий** стіл.
  - _Цукор_ (sugar) -> **Цукровий** сироп.
  - _Колір_ (color) -> **Кольоровий** олівець.
  - _Папір_ (paper) -> **Паперовий** пакет.
- **-Ян- (Природа та тканини):** Цей суфікс ми використовуємо для природних матеріалів, металів та тканин.
  - _Дерево_ (wood) -> **Дерев'яний**.
  - _Шерсть_ (wool) -> **Шерстяний**.
  - _Скло_ (glass) -> **Скляний**.
  - _Шкіра_ (leather) -> **Шкіряний**.
  - _Срібло_ (silver) -> **Срібний**.
...
- **Сільський** від слова _село_.
- **Міський** від слова _місто_.
...
- **К, Ц, Ч** + ськ -> **-цьк-**
  - _Козак_ -> **Козацький**.
  - _Гірник_ (miner) -> **Гірницький**.
- **Г, Ж, З** + ськ -> **-зьк-**
  - _Прага_ -> **Празький**.
  - _Запоріжжя_ -> **Запорізький**.
  - _Париж_ -> **Паризький**.
- **Х, Ш, С** + ськ -> **-ськ-**
  - _Чех_ -> **Чеський**.
  - _Одеса_ -> **Одеський**.
...
- _Історія_ -> **Історичний**.
- _Музика_ -> **Музичний**.
- _Логіка_ -> **Логічний**.
- _Економіка_ -> **Економічний**.
