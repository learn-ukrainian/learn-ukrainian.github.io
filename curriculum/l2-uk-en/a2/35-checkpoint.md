# Контрольна точка: Складні думки та здоров'я (Checkpoint A2.2)
...
### 1. The Conjunction Masterclass (Логічні містки)

Давайте повторимо, як ми поєднуємо думки. В українській мові вибір сполучника залежить від напрямку вашої думки:

- **Look Back (Reason):** Використовуйте **тому що** або **бо**.
  - _Я запізнився, **тому що** був затор._ (Formal/Neutral).
  - _Я не прийшов, **бо** захворів._ (Informal/Spoken).
- **Look Forward (Goal):** Використовуйте **щоб**.
  - _Я працюю, **щоб** мати гроші._ (Goal: Earning).
- **External Blame (Cause of Noun):** Використовуйте **через** + Accusative.
  - _Я не гуляв **через** дощ._

### 2. The Logic of Intent: Subject Agency

Це правило часто викликає труднощі. Повторимо логіку "щоб":

1. **Subject 1 creates Goal 1:** Use **Infinitive**.
   - _Я прийшов, **щоб допомогти**._ (I came to help).
2. **Subject 1 wants Subject 2 to act:** Use **Past Tense**.
   - _Я хочу, **щоб ти допоміг**._ (I want you to help/I want that you helped).
     This "Past Tense" loophole is vital. Never say «Я хочу тебе йти». Always: «Я хочу, щоб ти йшов».
...
- **Locative (Place):** Місто, **у якому** ми живемо.

### 4. The Time Masterclass: Sequence vs. Simultaneity
...
Будьте точними у висловленні симптомів:

- **У мене болить** + Однина (голова, зуб, живіт).
- **У мене болять** + Множина (ноги, очі, вуха).
  А також не забувайте про фрази емпатії: «**Шкода, що так сталося**» та «**Видужуйте швидше**».

> [!important] **Comma Placement Masterlist**
> В українській мові ми майже **завжди** ставимо кому перед **що, щоб, який, коли, тому що**. Це візуальні маяки для вашого співрозмовника. Кома — це знак того, що зараз почнеться нова логічна частина вашої думки.

> [!tip] **The Want-to Trap**
> In A2, we often translate English logic directly. Remember: "I want you to sleep" = **Я хочу, щоб ти спав**. The English "Infinitive after Object" doesn't exist here!

## Practice / Практика

### 1. Diagnostic Test (Знайдіть помилку)
...
4. Я купив молоко, бо я хочу пити.
   -> **3 is incorrect.** (Correct: Я хочу, щоб ти купив молоко).

### 2. Connector Coordination (Оберіть сполучник)

Fill in the gaps with the best phrase.

1. Ми не гуляли, \_\_\_ (тому що / щоб) йшов дощ. -> **тому що**
2. Я дзвоню, \_\_\_ (бо / щоб) запитати про роботу. -> **щоб**
3. \_\_\_ (Хоча / Через) був вечір, було ще тепло. -> **Хоча**
4. Ми запізнилися \_\_\_ (через / бо) тебе. -> **через**
5. Я буду чекати, \_\_\_ (поки / поки не) ти прийдеш. -> **поки не**

### 3. Case Detective (Відмінки займенника «який»)

Choose the correct form of **який**.

1. Це лікар, \_\_\_ (який / якого / якому) я бачила в поліклініці. -> **якого** (Object)
2. Ось парк, \_\_\_ (у якому / який) ми гуляли. -> **у якому** (Place)
3. Люди, \_\_\_ (які / яких) працюють тут, дуже добрі. -> **які** (Subject)

> [!reflection] **The Maturity of Thinking**
