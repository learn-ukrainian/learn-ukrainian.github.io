...
## fill-in: Choose the Form

> Select the correct form based on gender and case.

1. Це дівчина, ___ танцює. (Subj, f)
   > [!answer] яка
   > [!options] яка | яку | якій

2. Це дівчина, ___ я люблю. (Obj, f)
   > [!answer] яку
   > [!options] яку | яка | якою

3. Це хлопець, ___ живе тут. (Subj, m)
   > [!answer] який
   > [!options] який | якого | якому

4. Це хлопець, ___ я знаю. (Obj, m - Live Animate/Genitive form)
   > [!answer] якого
   > [!options] якого | який | якому

5. Це місто, ___ ми любимо. (Obj, n)
   > [!answer] яке
   > [!options] яке | якого | якому

6. Це люди, з ___ я працюю. (Instr, pl)
   > [!answer] якими
   > [!options] якими | які | яких

7. Це книга, про ___ я мрію. (Loc, f)
   > [!answer] яку
   > [!options] яку | якій | яка
   > Wait. "Про" takes Accusative. "Про мене", "Про книгу". So "Про яку". Yes.

8. Це будинок, у ___ я живу. (Loc, m)
   > [!answer] якому
...
Я мрію про дім, [___:1] стоїть у лісі.
...
- Якого чоловіка?
- Того, який стоїть біля вікна.
- Ні, я не знаю, хто це.
- Він схожий на актора, якого я люблю.
- У якому фільмі він грав?
- У фільмі, який ми дивилися вчора.
- А! Це той, який врятував світ?

> [!answer]
> 1. Ти знаєш цього чоловіка?
> 2. Якого чоловіка?
> 3. Того, який стоїть біля вікна.
> 4. Ні, я не знаю, хто це.
> 5. Він схожий на актора, якого я люблю.
> 6. У якому фільмі він грав?
> 7. У фільмі, який ми дивилися вчора.
> 8. А! Це той, який врятував світ?

## mark-the-words: Find Relative Clauses

Це [фільм, який я люблю](correct). Я знаю [дівчину, яка тут живе](correct). Це [місце, де ми зустрілися](correct).
Він [людина, яку поважають](correct). Це [книга, про яку всі говорять](correct).

---

Я хочу [спати](incorrect). Він [пішов додому](incorrect). Це [мій друг](incorrect).

## error-correction: Fix the Link

1. Це жінка, **який** співає. (Gender mismatch)
   > [!error] який
   > [!answer] яка
   > [!explanation] Woman is feminine -> яка.
   > [!options] яка | який

2. Це місто, **який** я люблю. (Gender mismatch)
   > [!error] який
   > [!answer] яке
   > [!explanation] City is neuter -> яке.
   > [!options] яке | який

3. Я знаю хлопця, **який** я бачу. (Case error)
   > [!error] який
   > [!answer] якого
   > [!explanation] Direct object of "see" -> Accusative (Active Animate) -> якого.
   > [!options] якого | який

4. Це друг, з **який** я гуляю. (Case error)
   > [!error] з який
   > [!answer] з яким
   > [!explanation] "With" triggers Instrumental -> з яким.
   > [!options] з яким | з який

5. Книга, **про якій** я говорив. (Case error)
   > [!error] про якій
   > [!answer] про яку
   > [!explanation] "About" triggers Accusative -> про яку.
   > [!options] про яку | про якій

6. Люди, **яка** тут. (Number mismatch)
   > [!error] яка
   > [!answer] які
...
1. The man who sleeps.
   - [x] Чоловік, який спить.
   - [ ] Чоловік, якого спить.

2. The book which I read.
   - [x] Книга, яку я читаю.
   - [ ] Книга, яка я читаю.

3. The city in which I live.
   - [x] Місто, у якому я живу.
   - [ ] Місто, який я живу.

4. The friends with whom I speak.
   - [x] Друзі, з якими я говорю.
   - [ ] Друзі, з які я говорю.

5. The girl who helps me.
   - [x] Дівчина, яка допомагає мені.
   - [ ] Дівчина, яку допомагає мені.

6. The house that stands there.
   - [x] Будинок, який стоїть там.
   - [ ] Будинок, якого стоїть там.
