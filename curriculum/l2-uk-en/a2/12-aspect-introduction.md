...
Тепер ви розумієте основи аспекту! Продовжуйте практикувати — це найважливіша граматична тема для природного мовлення українською. 📚
...
## fill-in: Choose the Correct Aspect

> Complete each sentence with the correct verb form.

1. Я ___ книгу дві години. (читав / прочитав)
   > [!answer] читав
   > [!options] читав | прочитав

2. Вона ___ листа вчора. (писала / написала)
   > [!answer] написала
   > [!options] писала | написала

3. Він ___ картину. (малював / намалював) — it's finished and hanging on the wall
   > [!answer] намалював
   > [!options] малював | намалював

4. Ми ___ щодня. (читаємо / прочитаємо)
   > [!answer] читаємо
   > [!options] читаємо | прочитаємо

5. Вона завжди ___ правду. (говорить / скаже)
   > [!answer] говорить
   > [!options] говорить | скаже

6. Я вже ___ цю книгу. (читав / прочитав)
   > [!answer] прочитав
   > [!options] читав | прочитав

7. Що ти ___ увечері? (робив / зробив)
   > [!answer] робив
   > [!options] робив | зробив

8. Я ___ домашнє завдання! (робив / зробив) — just finished
   > [!answer] зробив
   > [!options] робив | зробив

9. Він довго ___. (говорив / сказав)
   > [!answer] говорив
   > [!options] говорив | сказав

10. Він ___ "ні." (говорив / сказав)
    > [!answer] сказав
    > [!options] говорив | сказав

11. Ми ___ три години. (їхали / приїхали)
    > [!answer] їхали
    > [!options] їхали | приїхали

12. Ми нарешті ___! (їхали / приїхали)
    > [!answer] приїхали
    > [!options] їхали | приїхали
...
1. Я ___ книгу три години. (completed action)
...
Учора я [___:1] цілий день. Спочатку я [___:2] статтю для роботи. Потім я [___:3] кілька листів. Увечері я нарешті [___:4] книгу, яку [___:5] цілий місяць.

1. працювати / попрацювати
> [!answer] працював
...
> 1. Ти написав листа?
> 2. Ні, ще пишу.
> 3. Довго ти вже пишеш?
> 4. Дві години.
> 5. Коли закінчиш?
> 6. Скоро напишу!

## mark-the-words: Identify Aspect

Click on PERFECTIVE verbs only.

Я [прочитав](correct) книгу. Потім я [написав](correct) рецензію. Я довго писав, але нарешті [закінчив](correct).
...
Що ти робив? Я читав і писав. Потім я [зробив](correct) домашнє завдання і [пообідав](correct).

## translate: English to Ukrainian

I was reading a book. (process)
...
I finished reading the book. (result)
...
She wrote the letter. (completed)

- [x] Вона написала листа.
- [ ] Вона писала листа.

---

He was writing for 3 hours. (duration)

- [x] Він писав три години.
- [ ] Він написав три години.

---

They said "yes." (single event)
...
We finally arrived! (result)

- [x] Ми нарешті приїхали!
- [ ] Ми нарешті їхали!

---

She takes the book. (imperfective)
...
I saw the sea! (first time, result)
...
She always speaks Ukrainian. (habitual)

- [x] Вона завжди говорить українською.
- [ ] Вона завжди скаже українською.
