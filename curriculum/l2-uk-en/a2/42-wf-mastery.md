...
1. Людина, яка слухає. Це [___].
   > [!answer] слухач
   > [!options] слухач | мовець | письменник

2. Процес обміну словами. Це [___].
   > [!answer] розмова
   > [!options] розмова | промова | замовлення

3. Те, що ми думаємо. Це [___].
   > [!answer] думка
   > [!options] думка | слух | мова

4. Офіційний виступ. Це [___].
   > [!answer] промова
   > [!options] промова | розмова | мовчання

5. Те, що ми робимо в ресторані. Це [___].
   > [!answer] замовлення
   > [!options] замовлення | промова | слух

6. Перекласти текст іншою мовою. Це [___].
   > [!answer] переклад
   > [!options] переклад | перехід | перерва

7. Коли ти не говориш. Це [___].
   > [!answer] мовчання
   > [!options] мовчання | розмова | крик

8. Результат творчості. Це [___].
   > [!answer] твір
