...
> Match the word to its root logic.
...
- Вхід :: Entrance (Go)
- Письмо :: Writing
- Вигляд :: Appearance (See)
- Перемога :: Victory (Over-power)
- Розмова :: Conversation

## group-sort: Family Tree
...
## fill-in: Logic Puzzle

> Guess the word.

1. Людина, яка слухає. Це [___]. [Hint: Listener]
   > [!answer] слухач
   > [!options] слухач | мовець | письменник

2. Процес обміну словами. Це [___]. [Hint: Conversation]
   > [!answer] розмова
   > [!options] розмова | промова | замовлення

3. Те, що ми думаємо. Це [___]. [Hint: Thought]
   > [!answer] думка
   > [!options] думка | слух | мова

4. Офіційний виступ. Це [___]. [Hint: Speech]
   > [!answer] промова
   > [!options] промова | розмова | мовчання

5. Те, що ми робимо в ресторані. Це [___]. [Hint: Order]
   > [!answer] замовлення
   > [!options] замовлення | промова | слух

6. Перекласти текст іншою мовою. Це [___]. [Hint: Translation]
   > [!answer] переклад
...
8. Результат творчості. Це [___]. [Hint: Creation/Work (Act)]
   > [!answer] твір
...
На сцені стоїть [___:1] [Hint: speaker/orator].
