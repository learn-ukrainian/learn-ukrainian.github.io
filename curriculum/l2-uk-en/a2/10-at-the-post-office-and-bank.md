...
- [x] Пошта is the Ukrainian word for post office.
  > Correct!

- [x] Accusative case is used for direct objects in service contexts.
  > Yes! Відправити листа, зняти гроші.

- [ ] Курс means "cash" in Ukrainian.
  > Курс means exchange rate. Cash is готівка.

- [x] Instrumental case is used with "платити" for payment method.
  > Correct! Платити карткою = pay by card.

- [ ] Ukrainian banks only use hryvnia.
  > Banks also exchange foreign currency.

- [x] Genitive case is used after "з" meaning "from."
  > Yes! Посилка з України.

- [x] Рахунок means "account" in banking context.
  > Correct!

- [ ] Посилка means letter.
  > Посилка means package. Letter is лист.

- [x] You can use "Мені потрібно" to make polite requests.
  > Yes! Мені потрібно зняти гроші.

- [x] Дайте мені uses dative case for "мені."
  > Correct! Дайте мені = Give to me.

- [ ] Марка means money.
  > Марка means stamp.

- [x] Квитанція means receipt.
  > Correct!
...
1. Я хочу відправити лист.
   > [!error] лист
   > [!answer] листа
   > [!explanation] Animate accusative for лист = листа.
   > [!options] лист | листа | листом | листі

2. Мені потрібно зняти грошей.
   > [!error] грошей
   > [!answer] гроші
...
5. коштує | коштуєте | коштують
> [!answer] коштує

6. гривня | гривні | гривень
> [!answer] гривень

---

— Я хочу обміняти [___:1] на [___:2].
— Скільки?
— Двісті [___:3].
— [___:4] сьогодні — 37 [___:5] за долар.
— Гаразд. Ось [___:6].
...
- Що в посилці?
- Книги і одяг.
- Покладіть на вагу. Три кілограми.
- Скільки це коштує?

> [!answer]
> 1. Добрий день! Чим можу допомогти?
> 2. Я хочу відправити посилку до Німеччини.
> 3. Що в посилці?
> 4. Книги і одяг.
> 5. Покладіть на вагу. Три кілограми.
> 6. Скільки це коштує?

---

- Добрий день! Я хочу обміняти валюту.
- Яку валюту?
- Долари на гривні.
- Скільки доларів?
- П'ятсот.
- Курс сьогодні 37. Вісімнадцять тисяч п'ятсот гривень.

> [!answer]
> 1. Добрий день! Я хочу обміняти валюту.
> 2. Яку валюту?
> 3. Долари на гривні.
> 4. Скільки доларів?
> 5. П'ятсот.
> 6. Курс сьогодні 37. Вісімнадцять тисяч п'ятсот гривень.

## mark-the-words: Find Case Forms
...
- [x] Я хочу обміняти долари.
- [ ] Я хочу обміняти долар.
- [ ] Я хочу обміняти доларів.
