# Мистецтво розповіді: Спочатку, потім, нарешті (Telling Stories)
...
> [!reflection] **Storytelling as a Social Bridge**
...
_(спочатку, потім, раптом, нарешті)_
...
> [!context] **The Culture of "Anekdot"**
...
> [!context] **Fishing and Exaggeration**
...
- Навчилися додавати драми за допомогою слова **раптом**.
