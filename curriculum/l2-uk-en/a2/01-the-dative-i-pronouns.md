...
- **Match-up & Group-sort**: Recognition — can you identify Dative forms?
- **True-false & Quiz**: Comprehension — do you understand the rules?
- **Fill-in & Error-correction**: Controlled production — can you choose correctly?
- **Cloze & Unjumble**: Guided production — can you complete sentences?
- **Dialogue-reorder & Translate**: Free production — can you produce Dative sentences?
...
- [x] Давальні форми слів «він» і «воно» — обидві «йому».
  > Yes! Masculine and neuter share the same Dative form.

- [ ] Щоб сказати «I need», використовують «Я потрібно».
  > Ні! Використовують «Мені потрібно» з займенником у давальному відмінку.

- [x] The verb «подобатися» always requires a Dative object.
  > Yes! The person who likes something is always in the Dative case.
...
- [x] «Дякую тобі» uses the Dative case.
  > Yes! The verb «дякувати» requires a Dative object.
