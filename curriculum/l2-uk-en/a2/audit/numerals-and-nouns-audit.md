...
| **Узгодження числівників з іменниками (Numerals and Nouns)** | ✅ | 58 | Included in Core |
| **Вступ** | ✅ | 494 | Included in Core |
| **Презентація: Зони 1 та 2** | ✅ | 1034 | Included in Core |
| **Презентація: Зона 3 та Складні числівники** | ✅ | 1146 | Included in Core |
| **Практика на ринку** | ✅ | 800 | Included in Core |
| **Діалоги та одушевленість** | ✅ | 817 | Included in Core |
