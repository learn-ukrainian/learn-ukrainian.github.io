...
- **Immersion:** ⚠️ 47.8% (target 50-80%, within tolerance (A2.2))
...
|---|---|---|---|
| **Intro/Narrative** | ✅ | 656 | Included in Core |
| **Закінчення орудного відмінка однини (Instrumental Singular Endings)** | ✅ | 910 | Included in Core |
| **З/із/зі + орудний відмінок (Z/iz/zi + Instrumental)** | ✅ | 538 | Included in Core |
| **Практика: З ким? З чим? (Practice: With Whom? With What?)** | ✅ | 488 | Included in Core |
