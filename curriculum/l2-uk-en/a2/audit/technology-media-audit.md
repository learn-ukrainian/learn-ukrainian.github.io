...
| **Technology and Media** | ✅ | 113 | Included in Core |
| **Вступ: Україна як IT-хаб** | ✅ | 670 | Included in Core |
| **Цифровий словник та культура** | ✅ | 916 | Included in Core |
| **Граматичні пастки та вибір слів** | ✅ | 992 | Included in Core |
| **Практика: Життя в мережі** | ✅ | 938 | Included in Core |
| **Підсумок та поради** | ✅ | 542 | Included in Core |