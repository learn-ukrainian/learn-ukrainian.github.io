...
| **Advanced Motion Prefixes: Crossing, Passing, and Approaching** | ✅ | 45 | Included in Core |
| **Вступ** | ✅ | 380 | Included in Core |
| **Геометрія руху: Пере-, Про-, Об-** | ✅ | 649 | Included in Core |
| **Наближення та Прибуття: Під-, До-, За-, При-** | ✅ | 748 | Included in Core |
| **Практика та Корекція** | ✅ | 578 | Included in Core |
| **Діалоги та Сценарії** | ✅ | 456 | Included in Core |
