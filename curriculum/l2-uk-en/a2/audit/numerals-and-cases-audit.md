# Audit Report: M55 — numerals-and-cases.md
**Level:** A2 | **Module:** M55 | **Phase:** A2.8 | **Pedagogy:** PPP | **Target:** 2000
**Overall Status:** ❌ FAIL
**Generated:** 2026-04-11 00:49:48
...
- **[COMPLEXITY]** Sentence too long for A2: 24 words (max 15)
  - FIX: Break into shorter sentences. First 5 words: 'одного яча Родовий відмінок три...'
...
- **[COMPLEXITY]** match-up '' has 6 pairs (target: 8-14)
  - FIX: Adjust number of pairs to 8-14.
- **[METALANGUAGE]** Metalanguage terms used but not in vocabulary: іменник, множина, прикметник
...
- **Immersion:** 🇺🇦 81.6% (target 65-90% (A2.3))
...
|---|---|---|---|
| **Intro/Narrative** | ✅ | 630 | Included in Core |
| **Один/одна/одне у відмінках (One in All Cases)** | ✅ | 464 | Included in Core |
| **Скільки чого? Числівник + іменник (How Many? Numeral + Noun Agreement)** | ✅ | 707 | Included in Core |
| **Числа навколо нас (Numbers Around Us)** | ✅ | 583 | Included in Core |
