...
- **Immersion:** 🇺🇦 66.6% (target 50-80% (A2.2))
...
|---|---|---|---|
| **Intro/Narrative** | ✅ | 774 | Included in Core |
| **Знахідний відмінок множини: Живе чи неживе? (Accusative Plural: Animate vs. Inanimate)** | ✅ | 661 | Included in Core |
| **Називний чи знахідний? Визначаємо за контекстом (Nominative or Accusative?)** | ✅ | 756 | Included in Core |
