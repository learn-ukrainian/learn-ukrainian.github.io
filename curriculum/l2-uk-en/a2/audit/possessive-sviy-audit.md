...
| **Possessive Sviy** | ✅ | 78 | Included in Core |
| **Вступ: Світ через займенник «свій»** | ✅ | 483 | Included in Core |
| **Презентація: Правило «Суб’єкт = Власник»** | ✅ | 727 | Included in Core |
| **Культурний код: Свій — Чужий** | ✅ | 494 | Included in Core |
| **Аналіз помилок: Уникнення тавтології та неясності** | ✅ | 654 | Included in Core |
| **Практичне застосування та підсумок** | ✅ | 477 | Included in Core |
