...
| **Bigger, Better, Stronger** | ✅ | 61 | Included in Core |
| **Вступ: Арена порівняння** | ✅ | 446 | Included in Core |
| **Презентація: Творення ступенів** | ✅ | 725 | Included in Core |
| **Структури порівняння: ніж vs за** | ✅ | 790 | Included in Core |
| **Практика: Рекорди України** | ✅ | 747 | Included in Core |
| **Діалоги та Висновки** | ✅ | 306 | Included in Core |
