...
> [!cultural] Карпати — Серце України
...
## fill-in: Choose the Prefix

> Select the correct prefix.

1. [___]йти вулицю (to cross the street)
   > [!answer] Пере
   > [!options] Пере | Про | За

2. [___]їхати через місто (to drive through the city)
   > [!answer] Про
   > [!options] Про | Пере | За

3. [___]йти в кафе (to stop by the cafe)
   > [!answer] За
   > [!options] За | Про | До

4. [___]йти до парку (to reach the park)
   > [!answer] До
   > [!options] До | За | Про

5. [___]йти озеро (to walk around the lake)
   > [!answer] Об
   > [!options] Об | Про | Пере

6. [___]йти ближче (to approach)
   > [!answer] Під
   > [!options] Під | До | Про

7. [___]їхати зупинку (to miss the stop)
   > [!answer] Про
   > [!options] Про | Пере | За

8. [___]їхати за хлібом (to stop by for bread)
   > [!answer] За
   > [!options] За | До | Про
...
- Перейди вулицю :: Cross the street
- Пройди через парк :: Walk through the park
- Зайди до друга :: Stop by your friend's
- Дійди до кінця :: Reach the end
- Обійди будинок :: Go around the building
- Підійди ближче :: Come closer
- Проїдь зупинку :: Pass the stop
- Заїдь за молоком :: Stop by for milk

## fill-in: Daily Commute

> Complete Oleh's route.

1. Олег [___] з дому о сьомій. (exits)
   > [!answer] виходить
   > [!options] виходить | заходить | проходить

2. Він [___] до зупинки. (approaches)
   > [!answer] підходить
   > [!options] підходить | проходить | заходить

3. Автобус [___] три зупинки. (passes)
   > [!answer] проїжджає
   > [!options] проїжджає | переїжджає | об'їжджає

4. Олег [___] вулицю. (crosses)
   > [!answer] переходить
   > [!options] переходить | проходить | обходить

5. Він [___] до офісу. (reaches)
   > [!answer] доходить
   > [!options] доходить | заходить | проходить

6. У обід він [___] квартал. (walks around)
   > [!answer] обходить
   > [!options] обходить | проходить | переходить

7. Він [___] в кафе. (stops by)
   > [!answer] заходить
   > [!options] заходить | доходить | проходить

8. Увечері він [___] в супермаркет. (stops by, driving)
   > [!answer] заїжджає
   > [!options] заїжджає | проїжджає | об'їжджає

## cloze: Carpathians Trip
