<!-- SCOPE
Covers: Word formation logic, prefixation (по-, з-/с-, ви-, пере-, за-), aspectual pairs derivation, root recognition (-ход-, -пис-, -роб-), euphony (Cafe Ptakh), and diminutive suffixes (-ник, -ння).
Not covered:
