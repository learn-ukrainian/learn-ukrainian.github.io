...
## fill-in: Identify the Pattern

> What pattern forms this aspect pair?

1. читати → прочитати: ___
   > [!answer] про- prefix
...
- [x] Verbs with -ва-/-ува- are usually imperfective.
  > Yes!

- [ ] All aspect pairs use the same root.
  > Suppletive pairs like говорити/сказати use different roots.

- [x] "про-" often means through or completion.
  > Correct! Прочитати = read through.

- [x] Suppletive pairs must be memorized.
  > Yes, no pattern to predict them.

- [ ] "сказати" is imperfective.
  > "Сказати" is perfective. "Говорити" is imperfective.

- [x] "Давати → дати" shows -ва- removal.
  > Correct!

- [x] Prefix changes can change verb meaning.
  > Yes! Писати, написати, переписати, підписати all differ!

- [ ] "Вставати" is perfective.
  > "Вставати" has -ва-, so it's imperfective.

- [x] "По-" can mark moment of perception.
  > Yes! Побачити = to catch sight of.

- [x] Prefixed verbs can have their own imperfective forms.
  > Correct! Переписати → переписувати.
...
> What's the perfective of each verb?
...
- Як утворити доконаний вид від "читати"?
- Додай префікс "про-" і отримаєш "прочитати."
- А від "давати"?
- Тут інакше — видали суфікс "-ва-" і отримаєш "дати."
- А "говорити"?
- Це суплетивна пара — доконаний вид "сказати" має інший корінь!

> [!answer]
> 1. Як утворити доконаний вид від "читати"?
> 2. Додай префікс "про-" і отримаєш "прочитати."
> 3. А від "давати"?
> 4. Тут інакше — видали суфікс "-ва-" і отримаєш "дати."
> 5. А "говорити"?
> 6. Це суплетивна пара — доконаний вид "сказати" має інший корінь!

---

- Чому "написати" і "переписати" різні?
- Бо різні префікси додають різні значення.
- Яке значення "пере-"?
- "Пере-" означає "знову" або "через."
- Отже, "переписати" — написати знову?
- Так, точно!

> [!answer]
> 1. Чому "написати" і "переписати" різні?
> 2. Бо різні префікси додають різні значення.
> 3. Яке значення "пере-"?
> 4. "Пере-" означає "знову" або "через."
> 5. Отже, "переписати" — написати знову?
> 6. Так, точно!

## mark-the-words: Identify Perfective Verbs

Click on PERFECTIVE verbs only.

Я [прочитав](correct) книгу. Потім я [написав](correct) рецензію. Він [сказав](correct) правду. Вона довго говорила.

---

Ми [вивчили](correct) урок. Вона [встала](correct) рано. Він давав книгу, а потім [дав](correct).

---

Вони [побачили](correct) море! Він [почув](correct) шум. Я [взяв](correct) книгу і [пішов](correct).

## translate: English to Ukrainian

I read through the book. (finished)
