...
## fill-in: Choose the Correct Preposition

> Complete each sentence with the correct preposition.

1. Вона йде ___ школи.
   > [!answer] до
   > [!options] до | на | в
...
4. Подарунок ___ тебе.
   > [!answer] для
   > [!options] для | від | до

5. Він іде ___ роботи.
   > [!answer] з
   > [!options] з | до | на
...
- [x] Prepositions in Ukrainian require specific grammatical cases.
  > Correct! Every Ukrainian preposition is linked to one or more cases.

- [ ] "В школу" and "в школі" mean exactly the same thing.
  > False! "В школу" (accusative) means motion TO school; "в школі" (locative) means location AT school.

- [x] "Без" always takes the genitive case.
  > Yes! "Без цукру" (without sugar) uses genitive.

- [x] "Над" always takes the instrumental case.
  > Correct! "Над столом" (above the table) uses instrumental.

- [ ] "На" only takes accusative case.
  > False! "На" takes accusative for motion, locative for location.

- [x] "До" takes genitive case.
  > Yes! "До школи" (to school) uses genitive.

- [ ] "З" always means "from."
  > "З" can mean "from" with genitive OR "with" with instrumental.

- [x] Motion uses accusative with в/у, на, під, за.
  > Correct! These two-way prepositions use accusative for motion.

- [x] "В" and "у" have the same meaning.
  > Yes! They differ only in when you use them for euphony.

- [ ] "Перед" takes locative case.
  > "Перед" takes instrumental: "перед дверима."

- [x] "Між" means "between" and takes instrumental.
  > Correct! "Між нами" (between us).

- [x] Location after "під" uses instrumental, not locative.
...
2. на + Acc | до + Gen | з + Gen
   > [!answer] на + Acc

3. в/у + Loc | на + Acc | з + Gen
   > [!answer] в/у + Loc

4. Після + Gen | До + Gen | Для + Gen
   > [!answer] Після + Gen
...
2. на + Loc | в + Acc | до + Gen
   > [!answer] на + Loc

3. над + Instr | під + Instr | перед + Instr
   > [!answer] над + Instr
...
- Вибачте, як дійти до пошти?
- Йдіть через парк.
- Дякую!
- Потім поверніть за будинок.
- Пошта буде перед вами.
- Будь ласка!

> [!answer]
> 1. Вибачте, як дійти до пошти?
> 2. Йдіть через парк.
> 3. Потім поверніть за будинок.
> 4. Пошта буде перед вами.
> 5. Дякую!
> 6. Будь ласка!
...
> 2. Він між аптекою і магазином.
> 3. Далеко від станції метро?
> 4. Ні, біля станції.
> 5. Добре, дякую!
> 6. Немає за що!

## mark-the-words: Find Preposition + Case

Click on preposition + noun combinations.

Він іде [до школи](correct). Потім він буде [в класі](correct). Книги лежать [на столі](correct). Олівець [під зошитом](correct).

---

Вона живе [біля парку](correct). Гуляє [з собакою](correct). Сидить [перед телевізором](correct). Після роботи йде [до магазину](correct).

---

Лист [від друга](correct). Подарунок [для сестри](correct). Кава [без цукру](correct). Розмова [про майбутнє](correct).
...
- [x] Він гуляє з друзями.
- [ ] Він гуляє до друзів.
- [ ] Він гуляє від друзів.

---

They're talking about me.

- [x] Вони говорять про мене.
- [ ] Вони говорять для мене.
- [ ] Вони говорять до мене.
