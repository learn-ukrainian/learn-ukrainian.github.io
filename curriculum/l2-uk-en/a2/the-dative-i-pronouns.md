...
Форма **нам** дуже проста і коротка. Вона схожа на закінчення в слові "мама" або "там". «Нам весело» — "to us is fun" — це фраза, яку ви часто почуєте на вечірках.
...
Форма множини **Їм** (для "Вони") — це [йім]. Починайте з чіткого [й].
