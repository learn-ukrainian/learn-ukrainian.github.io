...
1. Цей текст поганий. Треба його ___.
   > [!answer] переписати
   > [!options] переписати | дописати | записати

2. Я не ___ книгу, вона нудна.
   > [!answer] дочитав
   > [!options] дочитав | перечитав | почитав

3. Будь ласка, ___ двері. Холодно.
   > [!answer] закрий
   > [!options] закрий | відкрий | розкрий

4. Я хочу ___ твій номер телефону.
   > [!answer] записати
   > [!options] записати | підписати | написати

5. Де тут можна ___ документи?
   > [!answer] підписати
   > [!options] підписати | описати | виписати

6. Мама попросила ___ посуд.
   > [!answer] перемити
   > [!options] перемити | домити | замити

7. Треба ___ роботу до вечора.
   > [!answer] доробити
   > [!options] доробити | переробити | зробити

8. Він ___ двері ключем.
   > [!answer] відкрив
