...
3. Ми займаємося ____.
   > [!answer] йогою
   > [!options] йогою | йога | йогу | йозі
   > Instrumental case.

4. Вона займається ____.
   > [!answer] фітнесом
...
## true-false: Sports Rules

1. You say "грати в футбол".
   - [x] true
   > Play + in + Acc.

2. You say "займатися футбол".
   - [x] false
   > Must be футболом (Instrumental case).

3. "Басейн" is a place to run.
   - [x] false
   > To swim.

4. Usyk is a football player.
   - [x] false
   > Boxer.

5. "Вболівальник" plays on the field.
   - [x] false
   > Spectator/fan.

6. "Перемога" is when you lose.
   - [x] false
   > It means victory.

7. Stadiums are for concerts and sports.
   - [x] true
   > Yes.

8. "Рахунок" tells who is winning.
   - [x] true
   > Score.

9. You can "займатися" in a gym.
   - [x] true
   > Workout/exercise.

10. "Команда" means one person.
    - [x] false
    > Team.

11. Hoverla is a river in Kyiv.
    - [x] false
    > Mountain.

12. Ukrainians like sports.
    - [x] true
    > Very much.

## group-sort: Action vs Place
...
9. Він не вміє грати на футбол.
   > [!error] на
   > [!answer] в
   > [!options] в | на | з | про
   > [!explanation] Грати В гру. Грати НА інструменті.

10. Це моя улюблена спорту.
    > [!error] спорту
    > [!answer] спорт
...
## cloze: Football Match

Ми на стадіоні. Сьогодні [___:1].
...
1. матч
> [!answer] матч
> [!options] матч | урок | обід

2. вболівальник
> [!answer] вболівальник
> [!options] вболівальник | гравець | лікар
...
4. гравець
> [!answer] гравець
> [!options] гравець | тренер | водій

5. рахунок
> [!answer] рахунок
> [!options] рахунок | ціна | година

6. перемога
> [!answer] перемога
> [!options] перемога | проблема | машина

7. емоції
> [!answer] емоції
> [!options] емоції | порції | акції

## dialogue-reorder: Gym Chat

- Привіт! Ти теж тут тренуєшся?
- Привіт. Так, я ходжу сюди в понеділок і середу.
- А я тільки почав. Ти можеш мені допомогти?
- Звичайно. Що ти хочеш робити?
- Я хочу качати прес.
- Добре. Лягай на килимок.
- Скільки разів робити?
- Роби 3 підходи по 15 разів.
- Ох, це важко!
- Не здавайся. Спорт любить сильних.
- Дякую за мотивацію!
- Будь ласка. Відпочивай хвилину.

## mark-the-words: Sports List
...
7. To cheer/support.
   - [x] Вболівати.
   - [ ] Хворіти.
   > Вболівати (also means to be sick, context matters!).
