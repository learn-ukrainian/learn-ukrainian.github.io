...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/checkpoint-full-grammar-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/checkpoint-full-grammar.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/checkpoint-full-grammar.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Checkpoint — Full Grammar** (a2 track).
...
| Милозвучність: Секрет мелодійності | 500 | 750 |
| Система відмінків та Кличний | 600 | 900 |
| Дієслово: Вид та Рух | 600 | 900 |
| Сфери життя та Метамова | 500 | 750 |
| Підсумок та інтеграція | 400 | 600 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/checkpoint-full-grammar.yaml`. Go through EVERY `points:` item in EVERY section:
