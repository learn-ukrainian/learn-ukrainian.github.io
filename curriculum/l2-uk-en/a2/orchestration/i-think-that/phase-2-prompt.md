...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/i-think-that-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/i-think-that.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/i-think-that.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **I Think That...** (a2 track).
...
|---------|--------|---------------------|
| Вступ: Від фактів до поглядів | 400 | 600 |
| Презентація: Дієслова думки | 800 | 1200 |
| Граматика: Сполучник «що» та впевненість | 600 | 900 |
| Практика: Обґрунтування думки | 700 | 1050 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/i-think-that.yaml`. Go through EVERY `points:` item in EVERY section:
