...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/asking-for-directions-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/asking-for-directions.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/asking-for-directions.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Asking for Directions** (a2 track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Презентація | 950 | 1425 |
| Культурний контекст | 650 | 975 |
| Практика та діалоги | 600 | 900 |
| Підсумок та розповідь | 400 | 600 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/asking-for-directions.yaml`. Go through EVERY `points:` item in EVERY section:
