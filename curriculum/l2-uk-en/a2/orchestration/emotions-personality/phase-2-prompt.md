...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/emotions-personality-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/emotions-personality.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/emotions-personality.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Emotions and Personality** (a2 track).
...
|---------|--------|---------------------|
| Вступ: Кордоцентризм та світ емоцій | 500 | 750 |
| Граматика: Стани та якості | 850 | 1275 |
| Лексика та портрет особистості | 700 | 1050 |
| Практика: Опис характеру та стану | 600 | 900 |
| Підсумок: Від серця до розуму | 350 | 525 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/emotions-personality.yaml`. Go through EVERY `points:` item in EVERY section:
