...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/practical-warm-up-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/practical-warm-up.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/practical-warm-up.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Practical Warm-up** (a2 track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Навички читання: Скарби Книжкового Форуму | 700 | 1050 |
| Слухання та говоріння: Активне сприйняття | 800 | 1200 |
| Письмо: Радіодиктант національної єдності | 700 | 1050 |
| Інтеграція та підсумок | 400 | 600 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/practical-warm-up.yaml`. Go through EVERY `points:` item in EVERY section:
