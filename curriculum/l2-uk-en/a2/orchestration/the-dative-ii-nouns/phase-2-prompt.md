...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/the-dative-ii-nouns-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/the-dative-ii-nouns.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/the-dative-ii-nouns.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **The Dative II — Nouns** (a2 track).
...
|---------|--------|---------------------|
| Вступ: Концепція адресата та вік | 500 | 750 |
| Чоловічий та середній рід: -ові/-еві та -у/-ю | 700 | 1050 |
| Жіночий рід та множина: -і та чергування | 700 | 1050 |
| Дієслова: Керування давальним відмінком | 600 | 900 |
| Культура та етикет: Подарунки і свята | 500 | 750 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/the-dative-ii-nouns.yaml`. Go through EVERY `points:` item in EVERY section:
