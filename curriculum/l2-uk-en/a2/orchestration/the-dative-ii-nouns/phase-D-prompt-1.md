...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/the-dative-ii-nouns.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/the-dative-ii-nouns-research.md`
...
Word count:       3689 / 3000 (123.0%)
Activities:       12
Vocabulary items: 26
Engagement boxes: 4
Immersion:        56.9% (target: 50-60%)
Audit status:     FAIL
```

## Content Sections (H2 headers in the content file)

1. Вступ: Концепція адресата
2. Чоловічий та середній рід: -ові/-у
3. Жіночий рід та чергування приголосних
4. Plural: Даруємо всім!
5. Ключові дієслова та керування
6. Практика: Етикет подарунків
7. Діалоги: День Ангела
