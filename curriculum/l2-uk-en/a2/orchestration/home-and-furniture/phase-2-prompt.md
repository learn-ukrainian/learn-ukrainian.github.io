...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/home-and-furniture-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/home-and-furniture.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/home-and-furniture.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Home and Furniture** (a2 track).
...
|---------|--------|---------------------|
| Вступ: Типи житла та помешкання | 500 | 750 |
| Презентація: Кімнати та меблі | 800 | 1200 |
| Граматика: Місцевий відмінок та прийменники | 700 | 1050 |
| Практика: Опис оселі та етикет | 600 | 900 |
| Підсумок: Мій дім — моя фортеця | 400 | 600 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/home-and-furniture.yaml`. Go through EVERY `points:` item in EVERY section:
