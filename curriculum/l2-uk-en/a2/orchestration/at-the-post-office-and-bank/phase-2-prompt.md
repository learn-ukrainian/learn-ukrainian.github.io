...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/at-the-post-office-and-bank-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/at-the-post-office-and-bank.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/at-the-post-office-and-bank.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **At the Post Office and Bank** (a2 track).
...
|---------|--------|---------------------|
| Вступ: Світ послуг в Україні | 500 | 750 |
| Укрпошта: Листи та патріотичні марки | 700 | 1050 |
| Банківські операції та цифрова екосистема | 700 | 1050 |
| Граматичний практикум: Куди чи де? | 600 | 900 |
| Діалоги та підсумок | 500 | 750 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/at-the-post-office-and-bank.yaml`. Go through EVERY `points:` item in EVERY section:
