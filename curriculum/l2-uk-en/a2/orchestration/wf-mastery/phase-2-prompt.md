...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/wf-mastery-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/wf-mastery.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/wf-mastery.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Майстерня слів: Велика гра** (a2 track).
...
|---------|--------|---------------------|
| Вступ: Українська як LEGO | 500 | 750 |
| Презентація: Архітектор слова | 750 | 1125 |
| Практика: Логіка синтезу | 800 | 1200 |
| Діалоги: Емоційна інженерія | 600 | 900 |
| Підсумок: Матриця майстерності | 350 | 525 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/wf-mastery.yaml`. Go through EVERY `points:` item in EVERY section:
