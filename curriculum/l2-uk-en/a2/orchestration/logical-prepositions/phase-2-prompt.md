...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/logical-prepositions-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/logical-prepositions.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/logical-prepositions.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Logical Prepositions** (a2 track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Презентація: Причина та Мета | 800 | 1200 |
| Культурний контекст та логічні пастки | 400 | 600 |
| Практика: Час та Відносини | 800 | 1200 |
| Діалоги та підсумок | 600 | 900 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/logical-prepositions.yaml`. Go through EVERY `points:` item in EVERY section:
