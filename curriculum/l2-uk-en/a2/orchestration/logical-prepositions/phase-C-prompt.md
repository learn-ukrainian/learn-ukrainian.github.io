...
| Module persona | Encouraging Cultural Guide, acting as Chess Grandmaster |
...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/logical-prepositions.md
```

**Plan file** (vocabulary_hints — vocabulary list to follow):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/logical-prepositions.yaml
```

**Meta file** (activity count targets, pedagogy):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/logical-prepositions.yaml
```
