...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/adjective-suffixes-qualities.yaml
```

Read the meta file:

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/adjective-suffixes-qualities.yaml
```
...
Research **Adjective Suffixes — Qualities** for the **A2** core track. Core tracks need lighter research than seminar tracks — focus on accuracy and State Standard alignment.
