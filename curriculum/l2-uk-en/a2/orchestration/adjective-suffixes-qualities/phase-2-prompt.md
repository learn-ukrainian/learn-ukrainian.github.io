...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/adjective-suffixes-qualities-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/adjective-suffixes-qualities.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/adjective-suffixes-qualities.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Adjective Suffixes — Qualities** (a2 track).
...
| Презентація 1: Пестливість та периферія (Presentation 1: Diminutives and Precision) | 750 | 1125 |
| Презентація 2: Гіпербола та Відношення (Presentation 2: Hyperbole and Relationships) | 750 | 1125 |
| Практика та орфографія (Practice and Orthography) | 650 | 975 |
| Діалоги та підсумок (Dialogues and Summary) | 450 | 675 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/adjective-suffixes-qualities.yaml`. Go through EVERY `points:` item in EVERY section:
