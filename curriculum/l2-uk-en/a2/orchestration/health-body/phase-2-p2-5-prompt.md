...
> **Your #1 job: Write 150 words for the section "Summary / Підсумок".**
...
Write the section prose for **Summary / Підсумок** within the module **Health and Body**.

- **WORD BUDGET**: 150 words minimum, 150 × 2 maximum. Stay in this range.
...
Previously used callout types in this module: [!tip], [!warning], [!culture], [!fact], [!observe]
...
- Target: 150 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Summary / Підсумок": {count} words (budget: 150-150×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Summary / Підсумок)
