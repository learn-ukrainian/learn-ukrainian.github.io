...
> **Your #1 job: Write 150 words for the section "Introduction / Вступ".**
...
Write the section prose for **Introduction / Вступ** within the module **Health and Body**.
...
```
===WORD_COUNTS===
Section "Introduction / Вступ": {count} words (budget: 150-150×2)
===WORD_COUNTS===
```
