...
1. **Content** (the lesson you're reviewing): `curriculum/l2-uk-en/a2/health-body.md`
2. **Activities**: `curriculum/l2-uk-en/a2/activities/health-body.yaml`
3. **Vocabulary**: `curriculum/l2-uk-en/a2/vocabulary/health-body.yaml`
4. **Plan** (source of truth for scope): `curriculum/l2-uk-en/plans/a2/health-body.yaml`
5. **Meta** (build config): `curriculum/l2-uk-en/a2/meta/health-body.yaml`
6. **Research notes** (if exists): `curriculum/l2-uk-en/a2/research/health-body-research.md`
...
```
Word count:       {AUDIT_WORD_COUNT} / 1000 ({WORD_PERCENT}%)
...
At module 55, students know ONLY modules 1-{PREV_MODULE}. Any grammar from later modules is scope creep.
