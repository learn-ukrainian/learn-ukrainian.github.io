...
> **Your #1 job: Write 315 words for the section "Practice / Практика".**
...
| File | Purpose |
|------|---------|
| `curriculum/l2-uk-en/a2/research/health-body-research.md` | Factual foundation — use exhaustively |
| `curriculum/l2-uk-en/a2/meta/health-body.yaml` | Content outline with section word allocations |
| `curriculum/l2-uk-en/plans/a2/health-body.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the section prose for **Practice / Практика** within the module **Health and Body**.
...
TARGET: 75-90% Ukrainian, 10-25% English. English only in vocabulary tables and brief grammar notes. Near-full Ukrainian immersion. Ukrainian sentences max 15 words. Max 2 clauses. All cases allowed. Simple subordinate clauses only. Full aspect pairs. No participles.
...
GRAMMAR RULES: - Max 15 words per Ukrainian sentence - Max 2 clauses per sentence - All cases allowed - Simple subordinate clauses allowed (який/що/коли) - Aspect pairs introduced but not complex - No participles
...
```
===WORD_COUNTS===
Section "Practice / Практика": {count} words (budget: 315-315×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Practice / Практика)
