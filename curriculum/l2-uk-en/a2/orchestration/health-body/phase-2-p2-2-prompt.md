...
> **Your #1 job: Write 570 words for the section "Presentation / Презентація".**
...
Write the section prose for **Presentation / Презентація** within the module **Health and Body**.
...
```
===WORD_COUNTS===
Section "Presentation / Презентація": {count} words (budget: 570-570×2)
===WORD_COUNTS===
```
