...
> **Your #1 job: Write 314 words for the section "Dialogues / Діалоги".**
...
Write the section prose for **Dialogues / Діалоги** within the module **Health and Body**.

- **WORD BUDGET**: 314 words minimum, 314 × 2 maximum. Stay in this range.
...
Previously used callout types in this module: [!tip], [!warning], [!culture], [!fact]
...
- Target: 314 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Dialogues / Діалоги": {count} words (budget: 314-314×2)
===WORD_COUNTS===
```
