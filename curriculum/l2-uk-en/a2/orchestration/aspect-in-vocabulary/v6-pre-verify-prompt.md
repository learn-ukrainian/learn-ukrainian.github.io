...
- **Спосіб 3: Зовсім інші слова (суплетивізм) (Method 3: Completely Different Words - Suppletion)**: Some of the most common verbs have suppletive pairs that must be memorized.; Essential pairs: брати / взяти (to take); говорити / сказати (to say/tell); ловити / зловити (to catch); шукати / знайти (to look for / to find).; Present a list of the 20 most important aspectual pairs for A2 learners to memorize, covering all three formation types.
