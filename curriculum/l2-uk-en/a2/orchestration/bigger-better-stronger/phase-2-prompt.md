...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/bigger-better-stronger-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/bigger-better-stronger.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/bigger-better-stronger.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Bigger, Better, Stronger** (a2 track).
...
|---------|--------|---------------------|
| Вступ: Арена порівняння | 500 | 750 |
| Презентація: Творення ступенів | 800 | 1200 |
| Структури порівняння: ніж vs за | 700 | 1050 |
| Практика: Рекорди України | 600 | 900 |
| Діалоги та Висновки | 400 | 600 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/bigger-better-stronger.yaml`. Go through EVERY `points:` item in EVERY section:
