...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/bigger-better-stronger.md"
   ```
...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/bigger-better-stronger.md`
2. **Activities**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/activities/bigger-better-stronger.yaml`
3. **Vocabulary**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/vocabulary/bigger-better-stronger.yaml`
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/bigger-better-stronger.yaml`
5. **Meta** (build config): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/bigger-better-stronger.yaml`
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/bigger-better-stronger-research.md`
...
Word count:       3331 / 3000 (111.0%)
Activities:       11
Vocabulary items: 2
Engagement boxes: 8
Immersion:        52.9% (target: 50-60%)
Richness:         74% (threshold: 95%)
Richness gaps:    examples: 14/24, dialogues: 0/4, tables: 1/2
Audit status:     FAIL
```
...
1. Вступ: Арена порівняння
2. Презентація: Творення ступенів
3. Структури порівняння: ніж vs за
4. Практика: Рекорди України
5. Діалоги та Висновки
