...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/if-i-were-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/if-i-were.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/if-i-were.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **If I Were** (a2 track).
...
|---------|--------|---------------------|
| Вступ (Introduction) | 500 | 750 |
| Презентація граматики (Grammar Presentation) | 800 | 1200 |
| Культурний контекст (Cultural Context) | 500 | 750 |
| Практика та аналіз помилок (Practice and Error Analysis) | 700 | 1050 |
| Діалоги та застосування (Dialogues and Application) | 500 | 750 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/if-i-were.yaml`. Go through EVERY `points:` item in EVERY section:
