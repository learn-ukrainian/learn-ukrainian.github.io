...
| Module persona | Encouraging Cultural Guide, acting as Lviv Coffeehouse Philosopher |
...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/if-i-were.md
```

**Plan file** (vocabulary_hints — vocabulary list to follow):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/if-i-were.yaml
```

**Meta file** (activity count targets, pedagogy):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/if-i-were.yaml
```
