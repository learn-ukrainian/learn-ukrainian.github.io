...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/health-wellness-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/health-wellness.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/health-wellness.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Health & Wellness** (a2 track).
...
|---------|--------|---------------------|
| Вступ: Здоров'я — найбільше багатство | 400 | 600 |
| Презентація: Моє тіло та самопочуття | 700 | 1050 |
| Здоровий спосіб життя та ментальне здоров'я | 600 | 900 |
| Народна медицина та традиційні практики | 600 | 900 |
| Система охорони здоров'я та аптека | 700 | 1050 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/health-wellness.yaml`. Go through EVERY `points:` item in EVERY section:
