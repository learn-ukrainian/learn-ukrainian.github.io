...
- P1 (~150 words): [Self-check questions: 1. Яке закінчення мають прикметники чоловічого роду в родовому відмінку? (Answer: -ого/-ього). 2. Чи змінюються займенники 'його' та 'її' як присвійні? (Answer: Ні). 3. Яка форма займенника 'цей' для жіночого роду? (Answer: цієї). Recap table: hard stems (-ого, -ої), soft stems (-ього, -ьої), possessives (мого, моєї, нашого, нашої), demonstratives (цього, цієї).]
