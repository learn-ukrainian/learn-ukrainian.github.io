...
**Section to write:** Який? Якого? Прикметники в родовому (Which? Whose? Adjectives in the Genitive) (~750 words total)
...
## Який? Якого? Прикметники в родовому (Which? Whose? Adjectives in the Genitive) (~750 words total)
- P1 (~100 words): [Intro to the Genitive adjective questions: Якого? (m/n) and Якої? (f). Contextual setup at a lost-and-found office: "Я шукаю свого нового (adj) телефона (m)". Setting the stage for agreement.]
- P2 (~100 words): [Masculine and Neuter hard stem adjective endings (-ого). Explain that the vowel 'и' or 'і' from Nominative changes to 'о'. Examples: новий -> нового, старий -> старого, велике -> великого.]
- P3 (~100 words): [Masculine and Neuter soft stem adjective endings (-ього). Explain the role of 'ь' in maintaining softness. Examples: синій -> синього, літній -> літнього, вчорашнє -> вчорашнього.]
- P4 (~100 words): [Feminine hard stem adjective endings (-ої). Note the similarity to the feminine noun ending but with the characteristic adjective 'ої'. Examples: нова -> нової, велика -> великої, гарна -> гарної.]
- P5 (~100 words): [Feminine soft stem adjective endings (-ьої). Explain the preservation of softness before 'ої'. Examples: синя -> синьої, вечірня -> вечірньої, літня -> літньої.]
- P6 (~150 words): [Deep dive into agreement within prepositional phrases. Using 'без' (without), 'біля' (near), and 'до' (to/until). Examples: без великого олівця (m), біля старої церкви (f), до синього моря (n). Focus on how the adjective mirrors the noun's gender and case.]
- Exercise: [fill-in, Put the adjective and noun into the correct Genitive form, 8 items] (~100 words)
