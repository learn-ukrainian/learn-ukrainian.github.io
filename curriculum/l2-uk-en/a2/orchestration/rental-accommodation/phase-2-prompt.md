...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/rental-accommodation-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/rental-accommodation.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/rental-accommodation.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Rental Accommodation** (a2 track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Презентація лексики | 500 | 750 |
| Контекстне читання: Оголошення | 500 | 750 |
| Діалог: Огляд квартири | 600 | 900 |
| Комунальні послуги та умови | 400 | 600 |
| Укладання договору | 300 | 450 |
| Практика та розповідь | 300 | 450 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/rental-accommodation.yaml`. Go through EVERY `points:` item in EVERY section:
