...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/technology-media-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/technology-media.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/technology-media.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Technology and Media** (a2 track).
...
|---------|--------|---------------------|
| Вступ: Україна як IT-хаб | 500 | 750 |
| Цифровий словник та культура | 700 | 1050 |
| Граматичні пастки та вибір слів | 600 | 900 |
| Практика: Життя в мережі | 700 | 1050 |
| Підсумок та поради | 500 | 750 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/technology-media.yaml`. Go through EVERY `points:` item in EVERY section:
