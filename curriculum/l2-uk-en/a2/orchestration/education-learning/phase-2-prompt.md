...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/education-learning-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/education-learning.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/education-learning.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Education and Learning** (a2 track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Лексика: Навчальні предмети та речі | 600 | 900 |
| Граматика: Дієслова навчання | 800 | 1200 |
| Академічне життя | 500 | 750 |
| Оцінювання та іспити | 500 | 750 |
| Підсумок | 200 | 300 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/education-learning.yaml`. Go through EVERY `points:` item in EVERY section:
