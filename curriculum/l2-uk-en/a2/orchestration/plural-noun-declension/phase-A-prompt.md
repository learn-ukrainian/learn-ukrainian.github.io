...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/plural-noun-declension.yaml
```

Read the meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/plural-noun-declension.yaml
```
...
Research **Plural Noun Declension** for the **A2** core track. Core tracks need lighter research than seminar tracks — focus on accuracy and State Standard alignment.
...
# Дослідження: Plural Noun Declension
