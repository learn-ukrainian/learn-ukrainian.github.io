...
| 6 | Vocabulary Quality | 8/10 | 25 items with IPA, POS, and aspect pairing. Minor IPA issue: «досягти» transcribed as — stress placement on the cluster «гт» is ambiguous; should clearly show with stress on second syllable. |
