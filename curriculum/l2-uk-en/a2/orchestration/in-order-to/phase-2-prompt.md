...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/in-order-to-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/in-order-to.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/in-order-to.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **In Order To** (a2 track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Презентація: Логіка суб'єктів | 1000 | 1500 |
| Культурний контекст та Реєстр | 600 | 900 |
| Практичне застосування | 600 | 900 |
| Комунікація: Цілі та плани | 400 | 600 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/in-order-to.yaml`. Go through EVERY `points:` item in EVERY section:
