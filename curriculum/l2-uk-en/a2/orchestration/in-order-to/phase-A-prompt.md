...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/in-order-to.yaml
```

Read the meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/in-order-to.yaml
```
...
Research **In Order To** for the **A2** core track. Core tracks need lighter research than seminar tracks — focus on accuracy and State Standard alignment.
