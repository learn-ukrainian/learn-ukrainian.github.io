...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/all-cases-practice-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/all-cases-practice.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/all-cases-practice.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **All Cases Practice** (a2 track).
...
|---------|--------|---------------------|
| Вступ: Важливість відмінкової системи | 450 | 675 |
| Презентація: Система та логіка | 750 | 1125 |
| Культурний аспект: Кличний відмінок | 450 | 675 |
| Практика та аналіз помилок | 850 | 1275 |
| Діалоги та реальне застосування | 500 | 750 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/all-cases-practice.yaml`. Go through EVERY `points:` item in EVERY section:
