...
**Section to write:** По телефону, по радіо: місцевий із прийменником «по» (Locative with "po") (~500 words total)
...
## По телефону, по радіо: місцевий із прийменником «по» (Locative with "po") (~500 words total)
- P1 (~120 words): Using "по" + Locative to express the means or channel of communication. Provide the core set: по телефону (by phone), по радіо (on the radio), по пошті (by mail), по телевізору (on TV). Note that the masculine nouns here often take the -у ending in the Locative when used with "по".
- P2 (~110 words): The semantic distinction between "про" (Topic) and "по" (Tool). Explain that we talk *about* something (про + Acc/Loc) *via* something (по + Loc). Example: "Я розмовляв про роботу (topic) по телефону (tool)." This prevents the common error of using "про" for the communication medium.
- P3 (~120 words): Spatial-contextual expressions with "по". Introduce "по дорозі" (on the way) as a context of movement. Contrast "по дорозі додому" (on the way home) with "на дорозі" (standing physically on the asphalt). Explain that "по" implies being "within the process" of the journey.
- P4 (~100 words): Dialogue 2: Student and Tutor. The student discusses their schedule "на цьому тижні" and mentions reading about history "у підручнику" (in a textbook). The tutor asks if they can talk "по телефону" later. This reinforces the "means" and "abstract source" functions.
- Exercise: [match-up, Match locative expressions with their English equivalents across all four function types, 8 items] (~50 words)
...
have a lot of work.)* На минулому тижні ми були в театрі. *(Last week we were at the theater.)* На наступному тижні вона їде до Києва. *(Next week she is going to Kyiv.)* You can also use the locative case to describe broad periods of life or time as backgrounds for events. These function exactly like physical containers, placing an event "inside" an era. * **дитинство** (childhood) → **у дитинстві** (in childhood) * **молодість** (youth) → **у молодості** (in youth) * **старість** (old age) → **у старості** (in old age) * **минуле** (the past) → **у минулому** (in the past) * **майбутнє** (the future) → **у майбутньому** (in the future) «Читаємо українською» У дитинстві я любив грати у футбол. *(In childhood I loved playing football.)* Моя бабуся багато читала у молодості. *(My grandmother read a lot in youth.)* У старості люди хочуть мати спокій. *(In old age people want to have peace.)* У минулому це місто було маленьким. *(In the past this city was small.)* У майбутньому я хочу працювати в освіті. *(In the future I want to work in education.)* Let's see how these temporal markers combine with the abstract domains we learned earlier, as well as new forms of communication. Notice how the locative case helps define both when an event happened and what sphere it relates to. > — **Марія:** Привіт, Ігоре! Як справи? Що нового у житті? *(Hi, Ihor! How are you? What is new in life?)* > — **Ігор:** Привіт, Маріє! На цьому тижні я відпочиваю. *(Hi, Mariia! This week I am resting.)* > — **Марія:** А я у минулому місяці змінила роботу. *(And I changed jobs last month.)* > — **Ігор:** Це цікаво! Де ти тепер працюєш? *(That is interesting! Where do you work now?)* > — **Марія:** Тепер я працюю в освіті. А що ти робив на минулому тижні? *(Now I work in education. And what did you do last week?)* > — **Ігор:** Я читав. А вчора я розмовляв по телефону з мамою. *(I read. And yesterday I talked on the phone with mom.)* > — **Марія:** Усе добре? *(Is everything fine?)* > — **Ігор:** Так, вона просто хвилюється. *(Yes, she is just worrying.)* It is crucial to understand the logical difference between the locative and the accusative cases when talking about time. You use the locative case to answer the question **Коли?** (When? — for months or weeks). However, if you want to answer the question **Як довго?** (How long?), you must use the accusative case to show the duration of an action. «Читаємо українською» Я був там у червні. *(I was there in June.)* — Коли? (Locative) Я був там увесь червень. *(I was there all June.)* — Як довго? (Accusative) Вона відпочивала на минулому тижні. *(She rested last week.)* — Коли? (Locative) Вона відпочивала цілий тиждень. *(She rested the whole week.)* — Як довго? (Accusative) <!-- INJECT_ACTIVITY: fill-in, Complete sentences with the correct locative form of the noun (у минулому ___, на цьому ___, по ___), 8 items -->
</previous_context>
