...
**Section to write:** Часовий місцевий відмінок (Temporal Locative) (~600 words total)
...
## Часовий місцевий відмінок (Temporal Locative) (~600 words total)
- P1 (~120 words): Calendar months as temporal "containers." Explain the use of the preposition "у/в" with months. Specifically detail the stem change for masculine months ending in -ень where the 'e' drops: січень → у січні, березень → у березні, травень → у травні. Provide a list of 3-4 common months to illustrate the consistency.
- P2 (~100 words): The "на" exception for weeks. Explain that while months take "у", the noun "тиждень" (week) requires "на". Provide the essential temporal triad for weeks: на цьому тижні (this week), на минулому тижні (last week), and на наступному тижні (next week).
- P3 (~120 words): Life periods as broad temporal contexts. Teach "у дитинстві" (in childhood), "у молодості" (in youth), and "у старості" (in old age). Explain that these function as "backgrounds" for events, using the Locative to define the era of one's life. Include "у минулому" (in the past) and "у майбутньому" (in the future).
- P4 (~130 words): Dialogue 1: Two friends (Марія and Ігор) catching up. Марія explains she changed jobs "у минулому місяці" and now works "в освіті." Ігор mentions he talked to his mom "по телефону." This dialogue synthesizes abstract domains with temporal markers and introduces communication means.
- P5 (~80 words): Logical contrast between the Locative and Accusative for time. Explain the difference between "Коли?" (When? - Locative for months/weeks) and "Як довго?" (How long? - Accusative for duration). Example: "Я був там у червні" (Loc) vs. "Я був там весь червень" (Acc).
- Exercise: [fill-in, Complete sentences with the correct locative form of the noun (у минулому ___, на цьому ___, по ___), 8 items] (~50 words)
...
**політика** (politics) → **у політиці** (in politics) * **релігія** (religion) → **у релігії** (in religion) * **наука** (science) → **у науці** (in science) «Читаємо українською» Мій брат працює у політиці. *(My brother works in politics.)* Він каже, що у політиці багато проблем. *(He says that there are many problems in politics.)* Моя сестра працює у культурі. *(My sister works in culture.)* Вона думає, що у культурі мало грошей. *(She thinks that there is little money in culture.)* Я дуже люблю працювати в освіті. *(I really love working in education.)* Masculine and neuter abstract nouns also follow the standard locative rules you already know. They typically take the **-і** ending, and sometimes the **-я** ending depending on the noun's stem. Just like with feminine nouns, these words express immersion in a subject or an aspect of life rather than a physical spot. When you talk about your career, your passions, or general life experiences, you will often use these forms. * **бізнес** (business) → **у бізнесі** (in business) * **мистецтво** (art) → **у мистецтві** (in art) * **право** (law) → **у праві** (in law) * **життя** (life) → **у житті** (in life) * **спорт** (sport) → **у спорті** (in sport) «Читаємо українською» У житті бувають різні ситуації. *(There are different situations in life.)* Мій друг працює у великому бізнесі. *(My friend works in big business.)* Він каже, що у бізнесі треба багато працювати. *(He says that in business you need to work a lot.)* Мистецтво дуже важливе для мене. *(Art is very important for me.)* Я шукаю нові ідеї у мистецтві. *(I look for new ideas in art.)* When dealing with abstract nouns, you will almost always use the preposition **у/в** to indicate being "inside" a field. However, there is a very important exception that every learner must memorize. We use the preposition **на** (on/at) with the word **робота** (work) when talking about work as an activity, a process, or a status. You must say **на роботі** (at work), and never «у роботі». Contrast this with physical locations or broad industries: you sit **в офісі** (in the office — physical location), you work **у бізнесі** (in business — industry domain), but you are currently **на роботі** (at work — engaged in the activity). This is a fixed idiomatic expression in Ukrainian that you will hear every single day. «Читаємо українською» — **Марія:** Привіт, Ігоре! Ти де? *(Hi, Ihor! Where are you?)* — **Ігор:** Привіт! Я зараз на роботі. *(Hi! I am at work now.)* — **Марія:** Ти працюєш в офісі? *(Do you work in an office?)* — **Ігор:** Так, я працюю в офісі. *(Yes, I work in an office.)* — **Марія:** А що ти робиш? *(And what do you do?)* — **Ігор:** Я працюю у сфері технологій. *(I work in the sphere of technologies.)* — **Марія:** Це цікаво. Я також зараз на роботі. *(That is interesting. I am also at work now.)* <!-- INJECT_ACTIVITY: quiz, Identify the function of locative in each sentence (physical location, abstract domain, temporal, or means) -->
</previous_context>
...
*www.ua.pistacja.tv*  
Речення
Реченням називаємо одне або кілька слів, що 
