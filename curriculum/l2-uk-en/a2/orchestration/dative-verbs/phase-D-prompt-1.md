...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/dative-verbs.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/dative-verbs-research.md`
...
Word count:       3452 / 3000 (115.1%)
Activities:       12
Vocabulary items: 38
Engagement boxes: 5
Immersion:        51.9% (target: 50-60%)
Audit status:     FAIL
```

## Content Sections (H2 headers in the content file)

1. Вступ: Керування та Адресат
2. Презентація: Дієслова Давального відмінка
3. Практика: Відмінки в дії
4. Діалоги: Взаємодопомога та Вдячність
