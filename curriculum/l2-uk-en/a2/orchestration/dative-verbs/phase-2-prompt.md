...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/dative-verbs-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/dative-verbs.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/dative-verbs.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Dative Verbs** (a2 track).
...
|---------|--------|---------------------|
| Вступ: Керування та Адресат | 450 | 675 |
| Презентація: Дієслова Давального відмінка | 1300 | 1950 |
| Практика: Відмінки в дії | 800 | 1200 |
| Діалоги: Взаємодопомога та Вдячність | 650 | 975 |
| **Total** | **3000** | **4500** |
