...
> **Your #1 job: Write 225 words for the section "Practice / Практика".**
...
| File | Purpose |
|------|---------|
| `curriculum/l2-uk-en/a2/research/telling-stories-research.md` | Factual foundation — use exhaustively |
| `curriculum/l2-uk-en/a2/meta/telling-stories.yaml` | Content outline with section word allocations |
| `curriculum/l2-uk-en/plans/a2/telling-stories.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the section prose for **Practice / Практика** within the module **Telling Stories**.

- **WORD BUDGET**: 225 words minimum, 225 × 2 maximum. Stay in this range.
- **Immersion**: Content is 25-40% English. English only for abstract concepts. Ukrainian for everything else. Sentences max 15 words. Max 2 clauses. All cases allowed. Simple subordinate clauses only. Aspect pairs introduced. No participles.
...
---
The **Казка** [ˈkazka] (Fairy Tale) mode is slow and formulaic. It usually starts with **«Жили-були...»** [ʒɪˈlɪ buˈlɪ] (Once upon a time / There lived-were...) or **«Одного разу...»** [odˈnɔɦɔ ˈrazu] (One time...). It uses simple connectors like *потім* and *і*.

The **Анекдот** [anekˈdɔt] (Anecdote/Joke) mode is fast. It relies heavily on the present tense for vividness (even for past events) and uses **раптом** or a pause before the punchline.

_Приклад:_ 
*   **Казка:** **Одного разу** пес пішов у ліс. **Потім** він зустрів вовка... (Slow, past tense).
...
Previously used callout types in this module: culture, tip, warning, myth-buster
...
- Target: 225 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Practice / Практика": {count} words (budget: 225-225×2)
===WORD_COUNTS===
```
