...
> **Your #1 job: Write 900 words for the section "Presentation / Презентація".**
...
Write the section prose for **Presentation / Презентація** within the module **Telling Stories**.

- **WORD BUDGET**: 900 words minimum, 900 × 2 maximum. Stay in this range.
...
---
We will focus on three main types of signals:
1.  **Sequence:** **Спочатку** [spoˈtʃatku] (First) and **потім** [ˈpɔtʲim] (Then).
2.  **Drama:** **Раптом** [ˈraptɔm] (Suddenly) — for plot twists.
3.  **Conclusion:** **Нарешті** [naˈrɛʃtʲi] (Finally) — for the happy ending.
...
- Target: 900 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Presentation / Презентація": {count} words (budget: 900-900×2)
===WORD_COUNTS===
```
