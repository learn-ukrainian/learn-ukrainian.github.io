...
> **Your #1 job: Write 300 words for the section "Introduction / Вступ".**
...
Write the section prose for **Introduction / Вступ** within the module **Telling Stories**.
...
```
===WORD_COUNTS===
Section "Introduction / Вступ": {count} words (budget: 300-300×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Introduction / Вступ)
