...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/telling-stories-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/telling-stories.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/telling-stories.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Telling Stories** (a2 track).
...
|---------|--------|---------------------|
| Вступ | 500 | 750 |
| Презентація: Дорожні знаки часу | 700 | 1050 |
| Презентація: Драма та несподіванки | 600 | 900 |
| Практика: Сміхова культура | 600 | 900 |
| Продукція та підсумок | 600 | 900 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/telling-stories.yaml`. Go through EVERY `points:` item in EVERY section:
