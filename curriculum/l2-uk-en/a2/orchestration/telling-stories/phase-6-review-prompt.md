...
1. **Content** (the lesson you're reviewing): `curriculum/l2-uk-en/a2/telling-stories.md`
2. **Activities**: `curriculum/l2-uk-en/a2/activities/telling-stories.yaml`
3. **Vocabulary**: `curriculum/l2-uk-en/a2/vocabulary/telling-stories.yaml`
4. **Plan** (source of truth for scope): `curriculum/l2-uk-en/plans/a2/telling-stories.yaml`
5. **Meta** (build config): `curriculum/l2-uk-en/a2/meta/telling-stories.yaml`
6. **Research notes** (if exists): `curriculum/l2-uk-en/a2/research/telling-stories-research.md`
...
```
Word count:       1882 / 1000 (188%)
Activities:       10
Vocabulary items: 25
Engagement boxes: 5
Immersion:        63.7% (target: 60-75%)
Audit status:     passed
```
...
At module 26, students know ONLY modules 1-checkpoint-aspect-comparison. Any grammar from later modules is scope creep.
