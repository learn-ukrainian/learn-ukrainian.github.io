...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/action-verb-prefixes-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/action-verb-prefixes.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/action-verb-prefixes.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Action Verb Prefixes** (a2 track).
...
|---------|--------|---------------------|
| Вступ: Логіка LEGO в українських дієсловах | 400 | 600 |
| Презентація: Світ префіксів пере-, до- та по- | 850 | 1275 |
| Відчинити чи відкрити? Битва за простір | 750 | 1125 |
| Практика: Трансформація смислів | 600 | 900 |
| Діалоги та підсумок | 400 | 600 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/action-verb-prefixes.yaml`. Go through EVERY `points:` item in EVERY section:
