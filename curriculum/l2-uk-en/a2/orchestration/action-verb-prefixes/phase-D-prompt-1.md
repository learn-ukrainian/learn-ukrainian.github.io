...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/action-verb-prefixes.md"
   ```
...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/action-verb-prefixes.md`
2. **Activities**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/activities/action-verb-prefixes.yaml`
3. **Vocabulary**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/vocabulary/action-verb-prefixes.yaml`
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/action-verb-prefixes.yaml`
5. **Meta** (build config): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/action-verb-prefixes.yaml`
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/action-verb-prefixes-research.md`
...
Module persona:   Encouraging Cultural Guide, acting as Film Director
Word count:       3865 / 3000 (128.8%)
Activities:       12
Vocabulary items: 12
Engagement boxes: 5
Immersion:        71.3% (target: 60-75%)
Audit status:     FAIL
```

## Content Sections (H2 headers in the content file)

1. Вступ: Логіка LEGO в українських дієсловах
2. Презентація: Світ префіксів пере-, до- та по-
3. Відчинити чи відкрити? Битва за простір
4. Практика: Трансформація смислів
