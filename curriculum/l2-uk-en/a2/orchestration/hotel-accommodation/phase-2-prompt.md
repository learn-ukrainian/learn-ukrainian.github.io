...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/hotel-accommodation-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/hotel-accommodation.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/hotel-accommodation.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Hotel Accommodation** (a2 track).
...
|---------|--------|---------------------|
| Вступ: Готелі в Україні | 500 | 750 |
| Бронювання та заселення | 800 | 1200 |
| Послуги та зручності | 700 | 1050 |
| Проблеми та розрахунок | 600 | 900 |
| Практика: Проживання в готелі | 400 | 600 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/hotel-accommodation.yaml`. Go through EVERY `points:` item in EVERY section:
