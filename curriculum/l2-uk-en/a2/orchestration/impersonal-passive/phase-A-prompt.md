...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/impersonal-passive.yaml
```

Read the meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/impersonal-passive.yaml
```
...
Research **Impersonal Passive Forms** for the **A2** core track. Core tracks need lighter research than seminar tracks — focus on accuracy and State Standard alignment.
