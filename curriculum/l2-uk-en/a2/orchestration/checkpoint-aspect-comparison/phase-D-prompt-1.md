...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/checkpoint-aspect-comparison.md"
   ```
...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/checkpoint-aspect-comparison.md`
2. **Activities**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/activities/checkpoint-aspect-comparison.yaml`
3. **Vocabulary**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/vocabulary/checkpoint-aspect-comparison.yaml`
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/checkpoint-aspect-comparison.yaml`
5. **Meta** (build config): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/checkpoint-aspect-comparison.yaml`
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/checkpoint-aspect-comparison-research.md`
...
Word count:       3234 / 3000 (107.8%)
Activities:       12
Vocabulary items: 31
Engagement boxes: 8
Immersion:        59.6% (target: 60-75%)
Audit status:     FAIL
```

## Content Sections (H2 headers in the content file)

1. Огляд та вступ: Карта навичок
2. Навичка 1: Вид дієслова: Процес та результат
3. Навичка 2: Ступені порівняння: Від якості до досконалості
4. Навичка 3: Модальність та узгодження числівників
5. Навичка 4: Синтез та практичне завдання
