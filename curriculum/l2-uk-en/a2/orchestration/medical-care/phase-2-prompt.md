...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/medical-care-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/medical-care.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/medical-care.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Medical Care** (a2 track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Запис на прийом | 600 | 900 |
| Медична консультація | 1000 | 1500 |
| Діагноз та лікування | 600 | 900 |
| Підсумок та народні засоби | 400 | 600 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/medical-care.yaml`. Go through EVERY `points:` item in EVERY section:
