...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/checkpoint-cases.md"
   ```
...
Word count:       2573 / 3000 (85.8%)
Activities:       12
Vocabulary items: 25
Engagement boxes: 6
Immersion:        18.0% (target: 50-60%)
Audit status:     FAIL
```
...
3. Навичка 2: Граматичні тонкощі: Родовий, Знахідний та Кличний
4. Навичка 3: Сервіси та цифрова Україна
