...
3. Verify with Grep: `Grep pattern="first 5-6 words" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/checkpoint-cases.md"`
...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/checkpoint-cases.md`
...
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/checkpoint-cases.yaml`
5. **Meta** (build config): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/checkpoint-cases.yaml`
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/checkpoint-cases-research.md`
...
Word count:       3432 / 3000 (114.4%)
Activities:       12
Vocabulary items: 25
Engagement boxes: 6
Immersion:        21.6% (target: 50-60%)
...
1. Огляд та самооцінка
2. Навичка 1: Відмінки в дії: Давальний та Орудний
3. Граматичні тонкощі: Родовий, Знахідний та Кличний
4. Сервіси та цифрова Україна
5. Історичний виклик та підсумок
