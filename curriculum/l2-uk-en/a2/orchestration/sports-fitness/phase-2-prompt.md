...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/sports-fitness-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/sports-fitness.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/sports-fitness.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Sports and Fitness** (a2 track).
...
|---------|--------|---------------------|
| Вступ | 450 | 675 |
| Спортивні споруди та види спорту | 700 | 1050 |
| Граматика: Керування дієслів | 950 | 1425 |
| Практика та діалоги | 600 | 900 |
| Здоровий спосіб життя та підсумок | 300 | 450 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/sports-fitness.yaml`. Go through EVERY `points:` item in EVERY section:
