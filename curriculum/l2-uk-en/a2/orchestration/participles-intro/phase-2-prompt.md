...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/participles-intro-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/participles-intro.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/participles-intro.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Introduction to Participles** (a2 track).

- **Total minimum**: 3000 words
- **Write at least**: 4500 words (1.5x — aim for depth, not padding)
- **Immersion**: TARGET: 75-90% Ukrainian, 10-25% English. English only in vocabulary tables and brief grammar notes. Near-full Ukrainian immersion. Ukrainian sentences max 15 words. Max 2 clauses. All cases allowed. Simple subordinate clauses only. Full aspect pairs. No participles.
...
|---------|--------|---------------------|
| Вступ: Дієприкметники навколо нас | 450 | 675 |
| Дієприкметники минулого часу | 850 | 1275 |
| Безособові форми на -но, -то | 650 | 975 |
| Дієприслівники: Одночасна та попередня дія | 650 | 975 |
| Помилки та Культурний контекст | 400 | 600 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/participles-intro.yaml`. Go through EVERY `points:` item in EVERY section:
