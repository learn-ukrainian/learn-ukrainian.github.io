...
**Section to write:** Практика: Знаряддя чи супутник? (Practice: Tool or Companion?) (~510 words total)
**Word target for this section:** 510 words (aim for 561 to account for undershoot)

---

## Section Skeleton (follow this exactly)

## Практика: Знаряддя чи супутник? (Practice: Tool or Companion?) (~510 words total)
- P1 (~120 words): [The "З" vs. "No З" rule. Explain the semantic difference: "Писати ручкою" (Tool - using the pen) vs. "Йти з ручкою" (Companion/Accompaniment - carrying the pen). Use the "я гуляю з собакою" example from Bolshakova to show when "з" is mandatory for accompaniment.]
- P2 (~110 words): [Contrastive examples with people vs. objects. "Я їду з братом" (with brother) vs. "Я їду автобусом" (by bus). "Він малює з учителем" (with teacher) vs. "Він малює олівцем" (with pencil). Emphasize that adding "з" to a tool makes it sound like the tool is a person accompanying you.]
- P3 (~120 words): [Fixed expressions and verbs that take the Instrumental without a preposition, even if they don't seem like "tools." Introduce: займатися спортом (to do sports), цікавитися музикою (to be interested in music), пахнути квітами (to smell of flowers). These are essential "means" or "objects of interest" in Instrumental.]
- Exercise: [quiz, focus: Choose between з + Instrumental (companion) and bare Instrumental (tool), 8 items] (~80 words)
- Exercise: [group-sort, focus: Sort sentences into Tool/Means vs. Accompaniment categories, 8 items] (~80 words)
