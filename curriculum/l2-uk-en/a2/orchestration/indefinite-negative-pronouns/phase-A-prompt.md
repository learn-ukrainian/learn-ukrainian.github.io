...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/indefinite-negative-pronouns.yaml
```

Read the meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/indefinite-negative-pronouns.yaml
```
...
Research **Indefinite and Negative Pronouns** for the **A2** core track. Core tracks need lighter research than seminar tracks — focus on accuracy and State Standard alignment.
...
- **Word count**: minimum **3000** words — allocate outline sections accordingly
...
- Allocations must sum to approximately **3000** words (±10% acceptable)
...
# Дослідження: Indefinite and Negative Pronouns
