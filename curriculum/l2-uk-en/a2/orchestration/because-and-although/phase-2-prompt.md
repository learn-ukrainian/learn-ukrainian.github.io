...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/because-and-although-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/because-and-although.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/because-and-although.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Because and Although** (a2 track).
...
| Презентація: Чому та Як (Presentation: Why and How) | 800 | 1200 |
| Презентація: Всупереч обставинам (Presentation: Despite the Circumstances) | 650 | 975 |
| Практика: Логічне обґрунтування (Practice: Logical Justification) | 650 | 975 |
| Продукція та Діалоги (Production and Dialogues) | 450 | 675 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/because-and-although.yaml`. Go through EVERY `points:` item in EVERY section:
