...
| Module persona | Encouraging Cultural Guide, acting as Investigative Journalist |
...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/because-and-although.md
```

**Plan file** (vocabulary_hints — vocabulary list to follow):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/because-and-although.yaml
```

**Meta file** (activity count targets, pedagogy):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/because-and-although.yaml
```
