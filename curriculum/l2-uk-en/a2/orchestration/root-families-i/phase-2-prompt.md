...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/root-families-i-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/root-families-i.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/root-families-i.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Root Families I** (a2 track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Родини ход- та пис- | 700 | 1050 |
| Родини чит- та бач- | 700 | 1050 |
| Фонетика та префікси | 600 | 900 |
| Практичне застосування | 600 | 900 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/root-families-i.yaml`. Go through EVERY `points:` item in EVERY section:
