...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/root-families-i.md
```

**Plan file** (vocabulary_hints — vocabulary list to follow):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/root-families-i.yaml
```

**Meta file** (activity count targets, pedagogy):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/root-families-i.yaml
```
