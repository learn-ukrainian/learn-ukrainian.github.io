...
| Module persona | Encouraging Cultural Guide, acting as Administrative Assistant |
...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/scheduling-appointments.md
```

**Plan file** (vocabulary_hints — vocabulary list to follow):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/scheduling-appointments.yaml
```

**Meta file** (activity count targets, pedagogy):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/scheduling-appointments.yaml
```
