...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/i-feel-like.md
```

**Plan file** (vocabulary_hints — vocabulary list to follow):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/i-feel-like.yaml
```

**Meta file** (activity count targets, pedagogy):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/i-feel-like.yaml
```
