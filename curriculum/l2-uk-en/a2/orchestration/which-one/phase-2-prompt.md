...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/which-one-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/which-one.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/which-one.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Which One?** (a2 track).
...
|---------|--------|---------------------|
| Вступ: Опис за межами прикметників | 450 | 675 |
| Презентація: Відмінювання та узгодження | 900 | 1350 |
| Культурний контекст та вибір | 600 | 900 |
| Практика та типові помилки | 700 | 1050 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/which-one.yaml`. Go through EVERY `points:` item in EVERY section:
