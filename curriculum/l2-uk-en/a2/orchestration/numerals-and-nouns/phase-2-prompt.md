...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/numerals-and-nouns-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/numerals-and-nouns.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/numerals-and-nouns.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Numerals and Nouns** (a2 track).
...
|---------|--------|---------------------|
| Вступ | 450 | 675 |
| Презентація: Зони 1 та 2 | 750 | 1125 |
| Презентація: Зона 3 та Складні числівники | 750 | 1125 |
| Практика на ринку | 600 | 900 |
| Діалоги та одушевленість | 450 | 675 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/numerals-and-nouns.yaml`. Go through EVERY `points:` item in EVERY section:
