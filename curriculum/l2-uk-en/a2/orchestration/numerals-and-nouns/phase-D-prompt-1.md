...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/numerals-and-nouns.md"
   ```
...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/numerals-and-nouns.md`
2. **Activities**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/activities/numerals-and-nouns.yaml`
3. **Vocabulary**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/vocabulary/numerals-and-nouns.yaml`
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/numerals-and-nouns.yaml`
5. **Meta** (build config): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/numerals-and-nouns.yaml`
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/numerals-and-nouns-research.md`
...
Word count:       4633 / 3000 (154.4%)
Activities:       12
Vocabulary items: 27
Engagement boxes: 6
Immersion:        72.3% (target: 60-75%)
Audit status:     FAIL
```
...
1. Вступ
2. Презентація: Зони 1 та 2
3. Презентація: Зона 3 та Складні числівники
4. Практика на ринку
5. Діалоги та одушевленість
