...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/adjective-suffixes-types-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/adjective-suffixes-types.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/adjective-suffixes-types.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Adjective Suffixes — Types** (a2 track).
...
|---------|--------|---------------------|
| Вступ | 450 | 675 |
| Презентація: Матеріали та походження | 850 | 1275 |
| Культурний контекст: Традиційні вироби | 600 | 900 |
| Практика та аналіз помилок | 700 | 1050 |
| Діалог та продукція | 400 | 600 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/adjective-suffixes-types.yaml`. Go through EVERY `points:` item in EVERY section:
