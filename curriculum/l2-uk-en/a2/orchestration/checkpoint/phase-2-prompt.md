...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/checkpoint-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/checkpoint.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/checkpoint.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Checkpoint** (a2 track).
...
|---------|--------|---------------------|
| Вступ та цілі | 300 | 450 |
| Синтаксис логіки: Причина та Мета | 850 | 1275 |
| Опис та послідовність дій | 850 | 1275 |
| Медицина, тіло та народні методи | 700 | 1050 |
| Практичне застосування та підсумок | 300 | 450 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/checkpoint.yaml`. Go through EVERY `points:` item in EVERY section:
