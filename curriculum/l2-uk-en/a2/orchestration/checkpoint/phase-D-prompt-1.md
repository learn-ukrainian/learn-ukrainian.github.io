...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/checkpoint.md"
   ```
...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/checkpoint.md`
2. **Activities**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/activities/checkpoint.yaml`
3. **Vocabulary**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/vocabulary/checkpoint.yaml`
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/checkpoint.yaml`
5. **Meta** (build config): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/checkpoint.yaml`
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/checkpoint-research.md`
...
Word count:       3570 / 3000 (119.0%)
Activities:       12
Vocabulary items: 25
Engagement boxes: 5
Immersion:        71.5% (target: 60-75%)
Richness:         99% (threshold: 85%)
Richness gaps:    none
Audit status:     PASS
```
...
1. Вступ та цілі
2. Навичка 1: Синтаксис логіки: Причина та Мета
3. Навичка 2: Опис та послідовність дій
4. Навичка 3: Медицина, тіло та народні методи
5. Навичка 4: Практичне застосування та підсумок
