...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/aspect-introduction-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/aspect-introduction.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/aspect-introduction.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Aspect Introduction** (a2 track).
...
|---------|--------|---------------------|
| Вступ | 500 | 750 |
| Презентація: Видові пари | 800 | 1200 |
| Нюанси та типові помилки | 700 | 1050 |
| Практика та вправи | 600 | 900 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/aspect-introduction.yaml`. Go through EVERY `points:` item in EVERY section:
