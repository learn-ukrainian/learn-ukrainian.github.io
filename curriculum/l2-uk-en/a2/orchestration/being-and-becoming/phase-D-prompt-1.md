...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/being-and-becoming.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/being-and-becoming-research.md`
...
Word count:       3047 / 3000 (101.6%)
Activities:       12
Vocabulary items: 20
Engagement boxes: 6
Immersion:        60.0% (target: 50-60%)
Audit status:     PASS
```

## Content Sections (H2 headers in the content file)

1. Вступ: Роль та ідентичність
2. Презентація: Бути, стати, працювати
3. Практика: Від мрії до реальності
4. Діалоги: Кар'єра та робота
