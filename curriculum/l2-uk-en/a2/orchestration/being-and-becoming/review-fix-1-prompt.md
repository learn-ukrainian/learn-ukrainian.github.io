...
In 2020, Ukraine officially updated its national grammar rules to explicitly include and standardize *feminitives* (feminine forms of professions). While older texts or more conservative speakers might still use masculine forms for everyone (for example, calling a female director a «директор»), modern standard Ukrainian actively and proudly uses feminine endings for women's professions. This reform reflects modern Ukrainian societal shifts toward gender equality and visibility. 
...
In this module, you learned how to effectively talk about professions, past roles, and future aspirations using the instrumental case. We learned that while your current permanent identity uses the nominative case (**Я лікар**), expressing a role or change of state with verbs like **бути**, **стати**, and **працювати** requires the instrumental case (**Я буду лікарем**, **Він став айтівцем**, **Вона працює менеджеркою**). We also covered why it matters to use modern feminitives (**директорка**, **лікарка**) and avoiding the English "work as" calque (remember: never use **як** with **працювати**). 

1. How do you say "He works as a doctor"? 
   *(Він працює лікарем.)*
2. What is the correct translation for "She wants to become a programmer"?
   *(Вона хоче стати програмісткою.)*
3. Translate the following phrase: "I was a student (masculine)".
   *(Я був студентом.)*
4. Can you express "She dreams of becoming a citizen of Ukraine" in Ukrainian?
