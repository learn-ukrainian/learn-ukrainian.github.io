You are reviewing a content generation prompt BEFORE it is used to build a module. Your job is to find problems that will cause the generated content to FAIL the audit.
...
| Презентація: Дієслова та відмінювання (Presentation: Verbs and Governing) | 475 |
| Соціокультурний контекст: Фемінітиви та IT (Sociocultural Context: Femininitives and IT) | 400 |
