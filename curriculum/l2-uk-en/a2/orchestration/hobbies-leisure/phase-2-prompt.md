...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/hobbies-leisure-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/hobbies-leisure.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/hobbies-leisure.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Hobbies and Leisure** (a2 track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Лексика: Світ хобі | 600 | 900 |
| Граматика: Грати чи займатися? | 900 | 1350 |
| Практика та діалоги | 800 | 1200 |
| Підсумок | 300 | 450 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/hobbies-leisure.yaml`. Go through EVERY `points:` item in EVERY section:
