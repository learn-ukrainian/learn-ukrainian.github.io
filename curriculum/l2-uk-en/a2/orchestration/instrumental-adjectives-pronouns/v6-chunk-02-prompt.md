...
**Section to write:** Присвійні та вказівні займенники (Possessive and Demonstrative Pronouns) (~550 words)
...
- P1 (~140 words): [Focus on the "Big Three" possessive pronouns: мій, твій, свій. Explain their Instrumental forms for all genders: моїм/моєю, твоїм/твоєю, своїм/своєю. Explain the logic: they behave almost like adjectives but have a unique "ї" or "є" in the stem. Example: "Я пишаюся своєю сестрою" (I am proud of my sister).]
- P2 (~130 words): [Focus on plural-based possessives: наш, ваш. Explain their hard-group behavior: "нашим/нашою", "вашим/вашою". Contrast this with "їхній" (their), which is a soft-group pronoun: "їхнім/їхньою". Provide a "Decolonization Note" from the wiki: explicitly teach "їхній" (declined) as the standard, rather than the Russian-influenced invariable "їх".]
- P3 (~140 words): [The "Invariable" rule for "його" and "її". Explain that when these words act as possessives (his/her), they DO NOT change regardless of the case. Example: "з його другом", "з її сестрою". This is a common point of confusion for students who try to say "їєю" or "йогом".]
- P4 (~140 words): [Demonstrative pronouns: цей (this) and той (that). Present the forms: цей -> цим/цією; той -> тим/тією. Use spatial examples: "за цим будинком" (behind this building), "під тією ялинкою" (under that spruce). Explain the frequent use of "цим вечором" (this evening) as a temporal expression.]
- <!-- INJECT_ACTIVITY: match-up-nom-ins --> [match-up, Match Nominative phrases to Instrumental forms, 8 items]
- <!-- INJECT_ACTIVITY: quiz-pronoun-gender --> [quiz, Choose the correct pronoun form (моїм vs. моєю) based on noun gender, 8 items]
