...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/complete-imperative-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/complete-imperative.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/complete-imperative.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Complete Imperative** (a2 track).

- **Total minimum**: 3000 words
- **Write at least**: 4500 words (1.5x — aim for depth, not padding)
- **Immersion**: TARGET: 60-75% Ukrainian, 25-40% English. English only for abstract grammar concepts. Ukrainian for everything else — examples, dialogues, cultural context. Ukrainian sentences max 15 words. Max 2 clauses. All cases allowed. Simple subordinate clauses only. Aspect pairs introduced. No participles.
...
|---------|--------|---------------------|
| Вступ: Воля та соціальний клей (Introduction: Willpower and Social Glue) | 500 | 750 |
| Граматична база: Усі особи наказового способу (Grammar Base: All Persons of Imperative) | 800 | 1200 |
| Виклики та пастки для учня (Challenges and Learner Traps) | 600 | 900 |
| Культурний контекст: Ритуал тостів (Cultural Context: Ritual of Toasts) | 600 | 900 |
| Практичне застосування: Борщ та координація (Practical Application: Borscht and Coordination) | 500 | 750 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/complete-imperative.yaml`. Go through EVERY `points:` item in EVERY section:
