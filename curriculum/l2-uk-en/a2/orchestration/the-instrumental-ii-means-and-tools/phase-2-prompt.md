...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/the-instrumental-ii-means-and-tools-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/the-instrumental-ii-means-and-tools.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/the-instrumental-ii-means-and-tools.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **The Instrumental II — Means and Tools** (a2 track).
...
|---------|--------|---------------------|
| Вступ: Без прийменника «з» | 500 | 750 |
| Транспорт і рух | 700 | 1050 |
| Інструменти та знаряддя | 700 | 1050 |
| Питання та відповіді | 600 | 900 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/the-instrumental-ii-means-and-tools.yaml`. Go through EVERY `points:` item in EVERY section:
