...
1. **Content** (the lesson you're reviewing): `# Checkpoint - Word Formation
...
- lemma: інсайт
  ...
  gender: m
`
4. **Plan** (source of truth for scope): `module: a2-44
level: A2
sequence: 44
...
naturalness:
  score: 10
  status: PASS
  justification: Clear checkpoint format
duration: 60
...
`
6. **Research notes** (if exists): `# Research Notes: A2 M44 Checkpoint - Word Formation
...
At module 44, students know ONLY modules 1-43. Any grammar from later modules is scope creep.
