...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/checkpoint-word-formation-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/checkpoint-word-formation.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/checkpoint-word-formation.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Checkpoint: Word Formation** (a2 track).
...
|---------|--------|---------------------|
| Огляд та місток до B1 | 400 | 600 |
| Словотворчі префікси та дієслівний вид | 700 | 1050 |
| Суфіксальне багатство: -ння, -ість, -ач | 700 | 1050 |
| Ад’єктивні суфікси та родини коренів | 700 | 1050 |
| Підсумковий практикум: «Паляниця» та помилки | 500 | 750 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/checkpoint-word-formation.yaml`. Go through EVERY `points:` item in EVERY section:
