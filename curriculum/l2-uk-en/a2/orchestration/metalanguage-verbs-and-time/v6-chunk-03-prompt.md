...
**Section to write:** Словникова грамотність: читаємо словник (~550 words)
...
- P1 (~120 words): [Dialogue: 'Що це за скорочення?' (What is this abbreviation?). A student looks at a Goroh.pp.ua entry for 'бачити' and asks the teacher what 'недок.' and 'дієсл.' mean. The teacher explains that dictionaries use a shorthand 'code' for grammar.]
- P2 (~130 words): [Anatomy of a Dictionary Entry. Explaining the 'Заголовне слово' (Headword), the 'Наголос' (Stress mark), and the grammatical block. Why the stress mark is the first thing a learner should check to avoid 'accent errors'.]
- P3 (~150 words): [The Big Table of Abbreviations. Providing a comprehensive list of standard Ukrainian dictionary codes: ім. (іменник), прикм. (прикметник), дієсл. (дієслово), присл. (прислівник), ч.р./ж.р./с.р. (genders), одн./мн. (numbers), док./недок. (aspects).]
- P4 (~150 words): [Decoding Practice. Walking through two real entries. 1. 'Книга' (ім., ж.р., одн.) — identifying it as a feminine noun. 2. 'Зробити' (дієсл., док. вид) — identifying it as a perfective verb. Explaining how 'док.' tells the learner they cannot use this verb in the present tense.]
- <!-- INJECT_ACTIVITY: quiz-dictionary-literacy --> [quiz, Read snippets of real dictionary entries for 5-6 words and identify their part of speech, gender, or aspect based on abbreviations, 8 items]
