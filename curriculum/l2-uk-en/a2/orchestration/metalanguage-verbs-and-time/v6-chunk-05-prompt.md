...
## Підсумок (~150 words)
- P1 (~150 words): [Self-check checklist. Can you name the 3 tenses in Ukrainian? Can you explain the difference between 'док.' and 'недок.'? Do you know which gender 'ж.р.' refers to? A final list of the 10 most critical abbreviations for the A2-B1 transition.]

Grand total: ~2170 words
