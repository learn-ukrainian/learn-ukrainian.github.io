...
**Section to write:** Дієвідміна та особа (~450 words)
...
- P1 (~150 words): [Особа (Person) and Число (Number). Explaining the 1st (перша), 2nd (друга), and 3rd (третя) person in both Singular (однина) and Plural (множина). Providing a reference table of personal pronouns (я, ти, він/вона/воно, ми, ви, вони) and their corresponding grammatical labels.]
- P2 (~150 words): [Дієвідміна (Conjugation Class). Understanding why some verbs have '-еш/-е' endings (І дієвідміна) and others have '-иш/-ить' (ІІ дієвідміна). The 'vowel test': looking at the 2nd person singular (пиш-Е-ш vs говор-И-ш) or the 3rd person plural (пишуть vs говорять).]
- P3 (~150 words): [Morphological Analysis. A practical guide on how to 'dissect' a verb form. Example: 'ми читаємо'. Identifying: 1. Частина мови (дієслово), 2. Час (теперішній), 3. Вид (недоконаний), 4. Особа (1-ша), 5. Число (множина), 6. Дієвідміна (І).]
- <!-- INJECT_ACTIVITY: group-sort-verb-tense --> [group-sort, Sort 24 verb forms into three categories: минулий, теперішній, майбутній, 8 items]
