...
**Section to write:** Дієслово: категорії та терміни (~620 words)
...
- P1 (~120 words): [Introduction to the 'Language of the Classroom'. Transitioning from intuitive speaking to analytical understanding. Introducing the term 'Термінологія' (Terminology) and why identifying 'Частини мови' (Parts of Speech) is the key to independent learning in B1.]
- P2 (~80 words): [The Verb (Дієслово). Defining the verb as the 'heart' of the sentence. Overview of the three 'big' categories we will re-label today: Час (Tense), Вид (Aspect), and Спосіб (Mood).]
- P3 (~150 words): [Час (Tense). Re-introducing the three timelines with Ukrainian labels: Минулий час (Past: я працював), Теперішній час (Present: я працюю), and Майбутній час (Future: я буду працювати / я попрацюю). Explaining that only the 'Indicative' mood has tenses.]
- P4 (~150 words): [Вид (Aspect). The fundamental Slavic distinction. Недоконаний вид (Imperfective) for processes (що робити? — читати) vs. Доконаний вид (Perfective) for results or completed actions (що зробити? — прочитати). Comparison of 'купував' vs 'купив' using metalanguage.]
- P5 (~120 words): [Спосіб (Mood). Differentiating between stating facts (Дійсний спосіб: Сонце світить), giving commands (Наказовий спосіб: Слухай!), and hypothetical conditions (Умовний спосіб: Я б пішов). Special decolonization warning: avoid using 'давайте' for commands; use the synthetic '-мо' form like 'ходімо' or 'працюймо'.]
- <!-- INJECT_ACTIVITY: match-up-verb-terms --> [match-up, Match verb category terms (вид, час, спосіб, дієслово) to their definitions/examples, 8 items]
...
<knowledge_packet>
# Knowledge Packet: Дія і час
**Module:** metalanguage-verbs-and-time | **Track:** A2
...
Write the section starting with the H2 heading **`## Дієслово: категорії та терміни (~620 words)`** (verbatim — do not paraphrase). Output ONLY the section content — no preamble, no summary, no notes.
