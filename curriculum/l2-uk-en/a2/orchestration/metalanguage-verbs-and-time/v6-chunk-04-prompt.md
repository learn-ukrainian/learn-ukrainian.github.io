...
**Section to write:** Прислівник: види та приклади (~400 words)
...
- P1 (~100 words): [Defining 'Прислівник' (Adverb). The 'unchangeable' word (незмінне слово). Unlike nouns or verbs, adverbs don't have endings that change for case or person. This makes them 'easy' to use but 'hard' to find in dictionary paradigms.]
- P2 (~150 words): [Adverb Classification by Meaning. Using Ukrainian terms to categorize: 1. Прислівник місця (Place: тут, далеко, всюди), 2. Прислівник часу (Time: вчора, завтра, вранці), 3. Прислівник способу дії (Manner: добре, швидко, повільно).]
- P3 (~150 words): [The Adjective-Adverb link. How Ukrainian builds adverbs from adjectives using the -о/-е suffix. Examples: гарний -> гарно, швидкий -> швидко, гарячий -> гаряче. Explaining that the dictionary will label these as 'присл.']
- <!-- INJECT_ACTIVITY: fill-in-metalanguage --> [fill-in, Complete sentences about Ukrainian grammar using the correct metalanguage terms: 'Слово 'холодно' — це ... (прислівник)', 8 items]
