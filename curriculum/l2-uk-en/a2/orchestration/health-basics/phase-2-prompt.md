...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/health-basics-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/health-basics.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/health-basics.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Health Basics** (a2 track).
...
|---------|--------|---------------------|
| Вступ: Здоров’я — це скарб | 300 | 450 |
| Частини тіла та анатомія | 500 | 750 |
| Конструкція «У мене болить»: Граматика болю | 700 | 1050 |
| Симптоми, хвороби та народна медицина | 600 | 900 |
| У поліклініці та аптеці | 500 | 750 |
| Практика: Що трапилося? | 400 | 600 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/health-basics.yaml`. Go through EVERY `points:` item in EVERY section:
