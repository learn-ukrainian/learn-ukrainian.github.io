...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/health-basics.md"
   ```
...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/health-basics.md`
2. **Activities**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/activities/health-basics.yaml`
3. **Vocabulary**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/vocabulary/health-basics.yaml`
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/health-basics.yaml`
5. **Meta** (build config): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/health-basics.yaml`
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/health-basics-research.md`
...
Word count:       3315 / 3000 (110.5%)
Activities:       12
Vocabulary items: 30
Engagement boxes: 12
Immersion:        73.7% (target: 60-75%)
Audit status:     FAIL
```

## Content Sections (H2 headers in the content file)

1. Вступ: Здоров’я — це скарб
2. Частини тіла та анатомія
3. Конструкція «У мене болить»: Граматика болю
4. Симптоми, хвороби та народна медицина
5. У поліклініці та аптеці
6. Практика: Що трапилося?
