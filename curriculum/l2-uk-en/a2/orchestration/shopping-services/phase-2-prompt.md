...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/shopping-services-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/shopping-services.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/shopping-services.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Shopping and Services** (a2 track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Лексика та культура | 700 | 1050 |
| Граматика | 800 | 1200 |
| Діалоги та практика | 700 | 1050 |
| Послуги та підсумок | 400 | 600 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/shopping-services.yaml`. Go through EVERY `points:` item in EVERY section:
