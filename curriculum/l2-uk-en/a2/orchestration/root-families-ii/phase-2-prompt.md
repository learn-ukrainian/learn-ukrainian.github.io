...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/root-families-ii-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/root-families-ii.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/root-families-ii.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Root Families II** (a2 track).
...
|---------|--------|---------------------|
| Вступ | 450 | 675 |
| Презентація | 900 | 1350 |
| Культурний контекст та лексичні нюанси | 700 | 1050 |
| Практика та корекція помилок | 600 | 900 |
| Діалоги та підсумок | 350 | 525 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/root-families-ii.yaml`. Go through EVERY `points:` item in EVERY section:
