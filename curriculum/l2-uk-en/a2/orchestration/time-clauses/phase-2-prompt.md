...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/time-clauses-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/time-clauses.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/time-clauses.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Time Clauses** (a2 track).
...
| Презентація: Граматичні основи (Presentation: Grammatical Foundations) | 800 | 1200 |
| Презентація: Складні випадки та культура (Presentation: Complex Cases and Culture) | 700 | 1050 |
| Практика та корекція помилок (Practice and Error Correction) | 600 | 900 |
| Продукція та діалоги (Production and Dialogues) | 500 | 750 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/time-clauses.yaml`. Go through EVERY `points:` item in EVERY section:
