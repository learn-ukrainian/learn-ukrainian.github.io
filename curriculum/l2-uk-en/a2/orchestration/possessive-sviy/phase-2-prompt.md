...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/possessive-sviy-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/possessive-sviy.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/possessive-sviy.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Possessive Sviy** (a2 track).
...
|---------|--------|---------------------|
| Вступ: Світ через займенник «свій» | 500 | 750 |
| Презентація: Правило «Суб’єкт = Власник» | 800 | 1200 |
| Культурний код: Свій — Чужий | 600 | 900 |
| Аналіз помилок: Уникнення тавтології та неясності | 600 | 900 |
| Практичне застосування та підсумок | 500 | 750 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/possessive-sviy.yaml`. Go through EVERY `points:` item in EVERY section:
