...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/possessive-sviy.md"
   ```
...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/possessive-sviy.md`
2. **Activities**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/activities/possessive-sviy.yaml`
3. **Vocabulary**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/vocabulary/possessive-sviy.yaml`
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/possessive-sviy.yaml`
5. **Meta** (build config): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/possessive-sviy.yaml`
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/possessive-sviy-research.md`
...
Module persona:   Encouraging Cultural Guide, acting as Real Estate Agent
Word count:       3100 / 3000 (103.3%)
Activities:       12
Vocabulary items: 34
Engagement boxes: 5
Immersion:        59.7% (target: 50-60%)
Audit status:     FAIL
```

## Content Sections (H2 headers in the content file)

1. Вступ: Світ через займенник «свій»
2. Презентація: Правило «Суб’єкт = Власник»
3. Культурний код: Свій — Чужий
4. Аналіз помилок: Уникнення тавтології та неясності
5. Практичне застосування та підсумок
