...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/future-plans-and-promises-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/future-plans-and-promises.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/future-plans-and-promises.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Future Plans and Promises** (a2 track).
...
|---------|--------|---------------------|
| Вступ | 500 | 750 |
| Презентація: Доконаний вид | 700 | 1050 |
| Презентація: Недоконаний вид | 600 | 900 |
| Практика та діалоги | 700 | 1050 |
| Висновок та застосування | 500 | 750 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/future-plans-and-promises.yaml`. Go through EVERY `points:` item in EVERY section:
