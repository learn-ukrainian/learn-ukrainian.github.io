...
**Section to write:** Скільки чого? Кількість у житті (~550 words total)
...
і не отримують нічого нового. Наприклад, велике місто перетворюється на багато міст. Одне яблуко стає п'ять яблук. Тут немає нічого складного, ви просто забираєте останню літеру. > *Neuter nouns ending in "o" lose their ending and get nothing new. For example, a big city turns into many cities. One apple becomes five apples. There is nothing complicated here, you just take away the last letter.* Just like feminine nouns, neuter nouns often need a fleeting vowel to make pronunciation easier. The vowel "o" often changes to "i" in closed syllables. Слово «слово» у родовому відмінку множини має форму «слів». Буква «о» змінюється на «і», бо склад тепер закритий. Велике село стає «багато сіл». А слово «вікно» отримує вставний голосний «о». Ми кажемо: у цій кімнаті є п'ять вікон. For neuter nouns that end in the soft vowels **-е** or **-я**, the rules split into two distinct paths. Nouns ending in **-е** generally act like masculine nouns and take the **-ів** ending. Слова середнього роду, які закінчуються на «е», дуже часто отримують закінчення «ів». Ми маємо одне море, але у світі є багато морів. Одне поле перетворюється на багато полів. Звісно, існують винятки, але «полів» — це сучасна норма. > *Neuter words that end in "e" very often get the ending "iv". We have one sea, but there are many seas in the world. One field turns into many fields. Of course, there are exceptions, but "poliv" is the modern norm.* Neuter nouns ending in **-я** often represent concepts, tasks, or abstract ideas. These nouns take a zero ending. Importantly, if the noun has a doubled consonant before the **-я**, that doubling disappears. Кожен студент отримує одне завдання на урок. Але після уроку він має п'ять завдань. Зверніть увагу, що подвоєння літер зникає. Одне знання, але багато знань. Одне обличчя, але в кімнаті є десять різних облич. > *Every student gets one task per lesson. But after the lesson, he has five tasks. Note that the doubling of letters disappears. One knowledge, but much knowledge. One face, but there are ten different faces in the room.* There is a special group of masculine nouns that denote nationality, citizenship, or social status. In the singular, these words end in the suffix **-ин**. When forming the plural, this suffix completely vanishes. Коли ми говоримо про національність або статус, слова часто мають суфікс «ин» в однині. Наприклад, киянин або громадянин. У множині цей суфікс зникає. Тому ми кажемо: один киянин, але п'ять киян. Один селянин, але багато селян. > *When we talk about nationality or status, words often have the suffix "yn" in the singular. For example, a Kyivan or a citizen. In the plural, this suffix disappears. That is why we say: one Kyivan, but five Kyivans. One villager, but many villagers.* :::info **Grammar box** Never add **-ів** to these nationality or status nouns. A very common learner mistake is to say "киянинів" or "громадянинів". The correct form uses the zero ending after dropping the suffix: **киян**, **громадян**. ::: <!-- INJECT_ACTIVITY: match-up-singular-plural -->
</previous_context>
...
Write the section starting with the H2 heading **`## Скільки чого? Кількість у житті (~550 words total)`** (verbatim — do not paraphrase). Output ONLY the section content — no preamble, no summary, no notes.
