...
**Section to write:** Чому родовий множини такий складний? (~420 words total)
...
Write the section starting with the H2 heading **`## Чому родовий множини такий складний? (~420 words total)`** (verbatim — do not paraphrase). Output ONLY the section content — no preamble, no summary, no notes.
