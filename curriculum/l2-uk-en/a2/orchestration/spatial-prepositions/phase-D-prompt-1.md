...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/spatial-prepositions.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/spatial-prepositions-research.md`
...
Word count:       3640 / 3000 (121.3%)
Activities:       12
Vocabulary items: 25
Engagement boxes: 5
Immersion:        51.5% (target: 50-60%)
Audit status:     FAIL
```
