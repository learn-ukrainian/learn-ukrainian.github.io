...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/nature-and-weather-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/nature-and-weather.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/nature-and-weather.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Nature and Weather** (a2 track).
...
|---------|--------|---------------------|
| Вступ: Природа України | 300 | 450 |
| Лексика: Ландшафти та легенди | 800 | 1200 |
| Граматика: Погода та стани | 1000 | 1500 |
| Практика: Прогноз та розмови | 600 | 900 |
| Підсумок | 300 | 450 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/nature-and-weather.yaml`. Go through EVERY `points:` item in EVERY section:
