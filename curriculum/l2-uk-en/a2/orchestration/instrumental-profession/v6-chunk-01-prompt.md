...
**Section to write:** Бути ким? Професія в орудному відмінку (~600 words total)
...
- P1 (~120 words): [Introduction to expressing identity and profession. Contrast the Nominative "Я вчитель" (static identity) with the Instrumental used for functions and states. Explain that in the present tense, we usually use the Nominative with a dash (Тато — інженер), but as soon as we move to past, future, or specific action verbs, the Instrumental case becomes mandatory.]
- P2 (~120 words): [Focus on the verb "бути" (to be) in the past and future. Explain that while "є" is omitted, "був/була" and "буду/буде" require the Instrumental case because they describe a role or status held over time. Examples: "Він був лікарем", "Вона буде програмісткою", "Ми були студентами".]
- P3 (~120 words): [Feminine nouns (I declension) in the Instrumental. Detail the endings -ою for hard bases (вчителька → вчителькою, менеджерка → менеджеркою) and -ею for soft/mixed bases (будівельниця → будівельницею, продавчиня → продавчинею). Emphasize that feminine forms are the standard way to refer to women in these professions in modern Ukrainian.]
- P4 (~120 words): [Masculine nouns (II declension) in the Instrumental. Explain the -ом ending for hard bases (інженер → інженером, програміст → програмістом) and the -ем/-єм endings for soft/mixed bases (вчитель → вчителем, водій → водієм). Specifically highlight nouns ending in -р: директор → директором (hard) vs. лікар → лікарем (soft/mixed group), referencing the dictionary requirement.]
- P5 (~120 words): [The verb "працювати" (to work). Explicitly warn against using the English/Russian "як" (as). Explain that "працювати" + Instrumental directly conveys "to work as". Examples: "Мій брат працює архітектором", "Вона працює журналісткою у Києві".]
- <!-- INJECT_ACTIVITY: fill-in-profession-forms --> [fill-in, Put profession nouns into Instrumental after бути/стати/працювати, 8 items]
...
<knowledge_packet>
# Knowledge Packet: Я буду вчителькою
**Module:** instrumental-profession | **Track:** A2
...
### Вікі: grammar/a2/instrumental-profession.md
...
Write the section starting with the H2 heading **`## Бути ким? Професія в орудному відмінку (~600 words total)`** (verbatim — do not paraphrase). Output ONLY the section content — no preamble, no summary, no notes.
