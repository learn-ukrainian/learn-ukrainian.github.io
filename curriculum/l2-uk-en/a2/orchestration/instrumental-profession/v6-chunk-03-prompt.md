...
**Section to write:** Хто ти за фахом? (~550 words total)
...
- P1 (~130 words): [Key question patterns for social interaction. Explain "Ким ти працюєш?" (focus on current job), "Хто ти за фахом?" (focus on education/specialty), and "Ким ти хочеш стати?" (focus on the future). Introduce the word "фах" as a synonym for "професія" or "спеціальність".]
- P2 (~120 words): [Dialogue: High school reunion. Two former classmates, Олена and Андрій, meet after 5 years. Олена: "Я стала лікаркою, працюю у лікарні." Андрій: "А я мріяв бути музикантом, але став програмістом. Проте я все ще захоплююся гітарою." Includes common social fillers and reactions.]
- P3 (~150 words): [Vocabulary expansion for A2. Introduce: перукар/перукарка (hairdresser), кухар/кухарка (cook), журналіст/журналістка, музикант/музикантка, юрист/юристка. Provide small context sentences for each: "Перукарка працює у салоні краси", "Мій дядько — талановитий кухар".]
- P4 (~150 words): [Useful collocations and professional idioms. "Працювати за фахом" (to work in one's field) vs "працювати не за фахом". "Мріяти про професію" vs "мріяти стати...". Explain how to express "dreaming of becoming" using "мріяти стати" + Instrumental.]
- <!-- INJECT_ACTIVITY: fill-in-answer-questions --> [fill-in, Answer questions about professions using full Instrumental sentences, 8 items]
