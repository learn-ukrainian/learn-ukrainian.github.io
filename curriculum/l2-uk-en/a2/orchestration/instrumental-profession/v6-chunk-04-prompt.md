...
**Section to write:** Практика: Ким бути? (~450 words total)
...
- P1 (~150 words): [Deep dive into transformation drills. Walk the learner through the mental shift from "identity" to "action". Take the noun "художник". Level 1: "Він художник" (Nom). Level 2: "Він працює художником" (Inst). Level 3: "Він хоче стати відомим художником" (Inst). This reinforces the grammatical trigger of the verb.]
- P2 (~150 words): [Family and social circle practice. Narrating the lives of others. "Моя сестра цікавиться медициною, тому вона хоче стати лікаркою. Мій брат займається спортом, він мріє бути тренером." This helps the learner apply the case to third-person descriptions which are common in A2 exams.]
- P3 (~150 words): [Mini-dialogue: Child and Parent. A playful look at future dreams. Дитина: "Мамо, я буду ветеринаром!" Мама: "Чому саме ветеринаром?" Дитина: "Бо я дуже захоплююся тваринами і хочу їм допомагати." Highlights the causal link between passion (захоплюватися) and goal (стати/бути).]
