...
**Section to write:** Практика: Ким бути? (~400 words total)
...
## Практика: Ким бути? (~400 words total)
- P1 (~130 words): [Transformation logic: Moving from simple statements to complex descriptions. Show how *Він любить тварин* (Verb+Acc) transforms into *Він хоче стати ветеринаром* (Aspiration+Inst) and *Він захоплюється медициною* (Passion+Inst).]
- P2 (~120 words): [Mini-dialogue: Future dreams. A child and a parent. *— Тату, я хочу бути кухарем! — Чому? — Бо я захоплююся кулінарією і хочу готувати смачні обіди. — Тоді ти станеш справжнім майстром!* Use specific terms like *майстер* and *фахівець*.]
- Exercise: [fill-in, Answer questions about professions using full Instrumental sentences, 8 items. Focus: *Ким працює твій батько? Чим ти займаєшся у вільний час? Ким ти мріяв бути в дитинстві?*]
...
am finally working stably in my specialty.)* > — **Максим:** Це супер! І ким ти зараз працюєш? *(That's super! And who do you work as now?)* > — **Олена:** Я стала лікаркою в нашій міській дитячій лікарні. Це дуже важка, але справді цікава робота. А ти? *(I became a doctor in our city children's hospital. It is very hard but truly interesting work. And you?)* > — **Максим:** А я зараз працюю програмістом у великій міжнародній компанії. *(And I now work as a programmer in a large international company.)* > — **Олена:** Я так і знала! Ти ще в школі **мріяв стати** *(dreamed of becoming)* програмістом. *(I knew it! You dreamed of becoming a programmer back in school.)* > — **Максим:** Так, ти маєш рацію. Я завжди глибоко цікавився комп'ютерами. *(Yes, you are right. I was always deeply interested in computers.)* > — **Олена:** Це дуже круто, коли дитяча мрія стає реальною професією. *(It is very cool when a childhood dream becomes a real profession.)* > — **Максим:** Згоден. А чим ти захоплюєшся зараз, крім своєї медицини? *(I agree. And what are you into now, besides your medicine?)* > — **Олена:** Я серйозно захоплююся сучасною фотографією. Це моє нове велике хобі. *(I am seriously passionate about modern photography. It's my new big hobby.)* Українська мова є надзвичайно багатою, гнучкою і сучасною. Ми маємо спеціальні жіночі форми майже для всіх сучасних професій. Ці слова називаються фемінітивами. Це абсолютно природне й історичне явище для нашої мови, а не якась нова штучна мода. In standard Ukrainian, it is completely natural and respectful to use feminine forms for professions when talking about women. Наприклад, чоловік — це **перукар** *(hairdresser)*, а жінка — **перукарка**. Чоловік — це талановитий **музикант** *(musician)*, а жінка — талановита **музикантка**. Він працює як головний **кухар** *(chef)*, а вона — чудова **кухарка**. У супермаркеті працює привітний **продавець** *(seller)*, а також працює привітна **продавчиня**. These feminine forms are usually created easily by adding simple suffixes like "-ка" or "-иня" to the masculine root. You should try to use these paired words naturally in your daily Ukrainian speech. Якщо ви говорите про жінку, завжди використовуйте жіночу форму професії. Наприклад, ви можете сміливо сказати: «Вона — талановита музикантка». Або ви можете сказати це з орудним відмінком: «Вона завжди мріяла стати талановитою музиканткою». Якщо ви говорите про чоловіка, ви логічно використовуєте чоловічу форму. Наприклад: «Мій брат працює продавцем у новому книжковому магазині». Або: «Він довго був найкращим перукарем у нашому великому місті». Ukrainian society actively embraces these gender-paired words because they make women's daily work visible, important, and respected. Пам'ятайте, що орудний відмінок завжди змінює останнє закінчення вашого слова. Жіночі професії на букву «-а» завжди матимуть закінчення «-ою» в орудному відмінку (лікарка — лікаркою). Чоловічі професії на твердий приголосний зазвичай мають закінчення «-ом» (програміст — програмістом). Професії на м'який приголосний мають закінчення «-ем» (лікар — лікарем, перукар — перукарем). <!-- INJECT_ACTIVITY: quiz, Choose Nominative or Instrumental for the profession noun based on tense, 8 items. Focus: Я (студент/студентом). Він був (лікар/лікарем). Ми станемо (майстри/майстрами). -->
</previous_context>
