...
Create a detailed paragraph-level skeleton for module **14: Багато книг, мало студентів** (A2, A2.2 [Genitive Case Complete]).
...
<knowledge_packet>
# Knowledge Packet: Багато книг, мало студентів
**Module:** genitive-plural | **Track:** A2
