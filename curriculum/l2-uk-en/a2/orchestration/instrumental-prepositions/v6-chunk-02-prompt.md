...
**Section to write:** Описуємо кімнату (~500 words total)
...
- P1 (~100 words): [Vocabulary expansion for interior descriptions. Introduce 'стеля' (ceiling), 'підлога' (floor), 'стіна' (wall), 'кут' (corner), and 'полиця' (shelf). Connect them to the prepositions: під стелею, на підлозі (recap), над полицею.]
- P2 (~120 words): [Descriptive narrative of a room. "У моїй кімнаті панує порядок. Над ліжком висить картина. Під вікном стоїть великий стіл. Між шафою і ліжком є маленька тумбочка." Focus on the flow of spatial logic.]
- P3 (~120 words): [Dialogue: Two friends, Олена and Максим, arranging furniture in a new apartment. Олена asks: "Де ми поставимо телевізор?" Максим suggests: "Давай поставимо його на тумбочку перед диваном." Using 'перед', 'за', and 'між' in a functional conversation.]
- P4 (~80 words): [Question-Answer patterns for finding things. Question: "Де мої капці?" Answer: "Вони під диваном." Question: "Де ключі?" Answer: "За книгою на полиці." Focus on pre-positioned clusters.]
- P5 (~80 words): [Cultural note: The importance of 'перед' in Ukrainian folklore and daily etiquette — "перед гостями" (in front of guests), showing respect and hospitality.]
- <!-- INJECT_ACTIVITY: fill-in-room-description --> [fill-in, Complete location sentences with correct preposition + Instrumental noun form, 8 items]
...
over something without physical contact. The preposition for 'under' simply describes a location below something, like a **ліжко** (bed). Лампа висить над столом. Птах летить над містом. У цих випадках немає фізичного контакту між предметами. Книга лежить на столі, але кіт сидить під столом. Моя ложка лежить під тарілкою, а твоє взуття стоїть під ліжком. > *The lamp hangs above the table. A bird flies over the city. In these cases, there is no physical contact between the objects. The book lies on the table, but the cat sits under the table. My spoon lies under the plate, and your shoes stand under the bed.* Next, we have the prepositions **перед** (in front of) and **за** (behind). These are incredibly useful for describing the position of objects around a **будинок** (building). You can use them to explain what is located in front of you and what is hidden behind something else. Велике дерево росте перед будинком. Твоя нова машина стоїть перед гаражем. Ми часто відпочиваємо перед школою. Гарний сад знаходиться за будинком. Ліс починається відразу за річкою. Сонце сховалося за хмарою, тому на вулиці темно. > *A large tree grows in front of the building. Your new car stands in front of the garage. We often relax in front of the school. A beautiful garden is located behind the building. The forest begins right behind the river. The sun hid behind a cloud, therefore it is dark outside.* The preposition **між** (between) is unique because it describes a position involving two or more reference points. When you use it with two singular nouns, both nouns must be in the Instrumental case. You can also use it with a single plural noun to indicate that something is surrounded by multiple objects. Мій стілець стоїть між столом і шафою. Новий парк знаходиться між школою та бібліотекою. Це гарне місто лежить між високими горами. Дорога проходить між старими будинками. Я завжди сиджу між моїм братом і моєю сестрою. > *My chair stands between the table and the cabinet. The new park is located between the school and the library. This beautiful city lies between high mountains. The road passes between old buildings. I always sit between my brother and my sister.* Finally, let's briefly review the Instrumental case for plural nouns. The endings are "-ами" or "-ями", regardless of gender. Some words, like the word for "door", are always plural in Ukrainian. Ми любимо гуляти під високими деревами. Літак летить високо над білими хмарами. Хтось зараз стоїть перед нашими дверима. Слово «двері» завжди має форму множини в українській мові. Тому ми кажемо «перед дверима» або «за дверима». > *We love to walk under tall trees. The airplane flies high above white clouds. Someone is currently standing in front of our door. The word "door" always has a plural form in the Ukrainian language. Therefore, we say "in front of the door" or "behind the door".* <!-- INJECT_ACTIVITY: match-up, Match prepositions (над, під, перед, за, між) to pictures showing spatial relationships, 8 items -->
</previous_context>
...
Write the section starting with the H2 heading **`## Описуємо кімнату (~500 words total)`** (verbatim — do not paraphrase). Output ONLY the section content — no preamble, no summary, no notes.
