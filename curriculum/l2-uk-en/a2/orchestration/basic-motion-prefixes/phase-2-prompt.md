...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/basic-motion-prefixes-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/basic-motion-prefixes.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/basic-motion-prefixes.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Basic Motion Prefixes** (a2 track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Презентація: В- та Ви- | 900 | 1350 |
| Культурний контекст | 500 | 750 |
| Практика та помилки | 800 | 1200 |
| Підсумок та діалоги | 400 | 600 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/basic-motion-prefixes.yaml`. Go through EVERY `points:` item in EVERY section:
