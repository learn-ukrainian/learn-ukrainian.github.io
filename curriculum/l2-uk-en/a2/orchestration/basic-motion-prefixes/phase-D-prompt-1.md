...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/basic-motion-prefixes.md"
   ```
...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/basic-motion-prefixes.md`
2. **Activities**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/activities/basic-motion-prefixes.yaml`
3. **Vocabulary**: `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/vocabulary/basic-motion-prefixes.yaml`
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/basic-motion-prefixes.yaml`
5. **Meta** (build config): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/basic-motion-prefixes.yaml`
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/basic-motion-prefixes-research.md`
...
Word count:       2996 / 3000 (99.9%)
Activities:       12
Vocabulary items: 26
Engagement boxes: 6
Immersion:        70.9% (target: 60-75%)
Richness:         77% (threshold: 95%)
Richness gaps:    cultural: 1/3, dialogues: 0/4
Audit status:     PASS
```
...
1. Вступ
2. Презентація: В- та Ви-
3. Культурний контекст
4. Практика та помилки
5. Підсумок та діалоги
