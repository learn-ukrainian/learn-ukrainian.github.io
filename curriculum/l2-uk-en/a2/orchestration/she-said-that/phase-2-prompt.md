...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/she-said-that-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/she-said-that.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/she-said-that.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **She Said That...** (a2 track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Презентація: Твердження та дієслова | 800 | 1200 |
| Презентація: Питання та накази | 800 | 1200 |
| Практика: Трансформація та робота над помилками | 600 | 900 |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/she-said-that.yaml`. Go through EVERY `points:` item in EVERY section:
