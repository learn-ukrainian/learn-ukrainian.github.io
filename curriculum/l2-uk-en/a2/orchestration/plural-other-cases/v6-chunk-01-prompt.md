...
**Section to write:** Давальний множини: Кому? (Dative Plural: To Whom?) (~550 words total)
...
Write the section starting with the H2 heading **`## Давальний множини: Кому? (Dative Plural: To Whom?) (~550 words total)`** (verbatim — do not paraphrase). Output ONLY the section content — no preamble, no summary, no notes.
