...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/scheduling-interviews-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/scheduling-interviews.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/scheduling-interviews.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Scheduling Interviews** (a2 track).
...
| Граматика та практика (Grammar and Practice) | 600 | 900 |
| Діалоги (Dialogues) | 650 | 975 |
| Розповідь (Narrative) | 450 | 675 |
| Підсумок (Need More Practice?) | 200 | 300 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/scheduling-interviews.yaml`. Go through EVERY `points:` item in EVERY section:
