...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/at-the-pharmacy-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/at-the-pharmacy.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/at-the-pharmacy.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **At the Pharmacy** (a2 track).
...
|---------|--------|---------------------|
| Вступ: Українські аптеки | 600 | 900 |
| Пошук ліків: Симптоми та запити | 700 | 1050 |
| Інструкції та етикетки | 600 | 900 |
| Дозування та побічні ефекти | 600 | 900 |
| Практика: Діалог в аптеці | 500 | 750 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/at-the-pharmacy.yaml`. Go through EVERY `points:` item in EVERY section:
