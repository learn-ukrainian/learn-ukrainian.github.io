...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/aspect-morphology-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/aspect-morphology.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/aspect-morphology.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Aspect Morphology** (a2 track).

- **Total minimum**: 3000 words
- **Write at least**: 4500 words (1.5x — aim for depth, not padding)
- **Immersion**: TARGET: 50-60% Ukrainian, 40-50% English. Grammar theory in English, dialogues and examples in Ukrainian. Section intros can mix languages. Ukrainian sentences max 15 words. Max 2 clauses. All cases allowed. Simple subordinate clauses only (який/що/коли). Aspect pairs introduced. No participles.
...
|---------|--------|---------------------|
| Вступ: Концепція видових пар (Introduction: The Aspectual Pair Concept) | 450 | 675 |
| Творення префіксами та правило правопису (Prefixal Formation and Spelling Rules) | 750 | 1125 |
| Творення суфіксами та суплетивні пари (Suffixal Formation and Suppletive Pairs) | 750 | 1125 |
| Практика: Помилки та вибір аспекту (Practice: Errors and Aspect Choice) | 600 | 900 |
| Культурний контекст та діалоги (Cultural Context and Dialogues) | 450 | 675 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/aspect-morphology.yaml`. Go through EVERY `points:` item in EVERY section:
