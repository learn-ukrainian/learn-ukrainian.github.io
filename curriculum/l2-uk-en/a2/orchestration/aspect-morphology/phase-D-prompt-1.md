...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/aspect-morphology.md"
   ```
...
1. **Content** (the lesson you're reviewing): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/aspect-morphology.md`
...
4. **Plan** (source of truth for scope): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/aspect-morphology.yaml`
5. **Meta** (build config): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/aspect-morphology.yaml`
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/aspect-morphology-research.md`
...
Word count:       3722 / 3000 (124.1%)
Activities:       12
Vocabulary items: 28
Engagement boxes: 4
Immersion:        52.6% (target: 50-60%)
Richness:         64% (threshold: 95%)
Richness gaps:    engagement: 3/5, cultural: 0/3, dialogues: 0/4, tables: 0/2
Audit status:     FAIL
```
...
1. Вступ: Концепція видових пар (Introduction: The Aspectual Pair Concept)
2. Творення префіксами та правило правопису (Prefixal Formation and Spelling Rules)
3. Творення суфіксами та суплетивні пари (Suffixal Formation and Suppletive Pairs)
4. Практика: Помилки та вибір аспекту (Practice: Errors and Aspect Choice)
5. Культурний контекст та діалоги (Cultural Context and Dialogues)
...
1. **[RUSSIANISM]** (severity: WARNING)
   Text: Found 2 Russicism(s) in content: 'давайте подивимося' → подивімося
   Fix: Replace Russicisms with standard Ukrainian equivalents. These are Russian calques that have standard Ukrainian forms. Se
