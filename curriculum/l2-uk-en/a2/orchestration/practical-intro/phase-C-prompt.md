...
| Module persona | Encouraging Cultural Guide, acting as Camp Counselor |
...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/practical-intro.md
```

**Plan file** (vocabulary_hints — vocabulary list to follow):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/practical-intro.yaml
```

**Meta file** (activity count targets, pedagogy):
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/practical-intro.yaml
```
