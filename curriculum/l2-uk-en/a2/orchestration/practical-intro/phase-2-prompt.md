...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/practical-intro-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/practical-intro.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/practical-intro.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Practical Intro** (a2 track).
...
|---------|--------|---------------------|
| Вступ: Від теорії до практики | 450 | 675 |
| Сім відмінків у дії | 750 | 1125 |
| Вид дієслова в контексті | 650 | 975 |
| Складні речення та пояснення | 650 | 975 |
| Типові помилки та інтеграція | 500 | 750 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/practical-intro.yaml`. Go through EVERY `points:` item in EVERY section:
