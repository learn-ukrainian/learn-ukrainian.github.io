...
─── Audit output (last 15 lines) ───
       → FIX: Break into shorter sentences. First 5 words: 'Ви фізично не можете розірвати...'
    [METALANGUAGE] Metalanguage terms used but not in vocabulary: доконаний, недоконаний, кличний, орудний, знахідний
