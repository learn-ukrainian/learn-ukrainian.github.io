...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/the-completed-past-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/the-completed-past.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/the-completed-past.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **The Completed Past** (a2 track).
...
|---------|--------|---------------------|
| Вступ | 450 | 675 |
| Творення та граматична узгодженість | 750 | 1125 |
| Процес проти результату | 800 | 1200 |
| Наративна послідовність у музеї | 600 | 900 |
| Практика та усунення помилок | 400 | 600 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/the-completed-past.yaml`. Go through EVERY `points:` item in EVERY section:
