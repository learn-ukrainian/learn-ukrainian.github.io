...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/social-media-ukrainian-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/social-media-ukrainian.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/social-media-ukrainian.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Social Media Ukrainian** (a2 track).
...
|---------|--------|---------------------|
| Вступ | 450 | 675 |
| Презентація | 800 | 1200 |
| Практика | 600 | 900 |
| Діалоги та взаємодія | 600 | 900 |
| Розповідь та підсумок | 550 | 825 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/social-media-ukrainian.yaml`. Go through EVERY `points:` item in EVERY section:
