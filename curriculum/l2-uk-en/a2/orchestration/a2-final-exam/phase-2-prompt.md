...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/a2-final-exam-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/a2-final-exam.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/a2-final-exam.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **A2 Final Exam** (a2 track).
...
|---------|--------|---------------------|
| Вступ: Огляд іспиту (Overview / Огляд) | 450 | 675 |
| Навичка 1: Майстерність відмінків (Case System Mastery) | 700 | 1050 |
| Навичка 2: Вид дієслова — Процес чи результат? (Verb Aspect) | 700 | 1050 |
| Навичка 3: Навігація до екзаменаційного центру (Navigation) | 550 | 825 |
| Інтеграційне завдання: Культура іспитів (Integration Challenge) | 600 | 900 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/a2-final-exam.yaml`. Go through EVERY `points:` item in EVERY section:
