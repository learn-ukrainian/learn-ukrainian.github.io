...
> **Your #1 job: Write 75 words for the section "Dialogues / Діалоги".**
...
Write the section prose for **Dialogues / Діалоги** within the module **The Dative I — Pronouns**.

- **WORD BUDGET**: 75 words minimum, 75 × 2 maximum. Stay in this range.
...
- Asking for Help and Objects
- Softening Your Opinions
- The Mental Switch: Nominative to Dative
- Checking In on Others
---
These short questions are the glue of daily empathy. They show you care about the other person's experience, not just their actions.

Useful Check-ins:
*   **Як тобі?** — [jak tɔˈbi] — How is it (for) you? (How do you like it?)
*   **Вам зручно?** — [vam ˈzrutʃnɔ] — Is it comfortable (for) you?
*   **Тобі не сумно?** — [tɔˈbi nɛ ˈsumnɔ] — Are you not sad? (Are you okay?)
*   **Вам допомогти?** — [vam dɔpɔmɔɦˈtɪ] — (Should I) help you?
...
Previously used callout types in this module: ['culture', 'tip', 'myth-buster', 'warning']
...
- Target: 75 words. Ceiling: 2× that number.
...
```
===WORD_COUNTS===
Section "Dialogues / Діалоги": {count} words (budget: 75-75×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Dialogues / Діалоги)
