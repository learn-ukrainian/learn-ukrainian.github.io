...
> **Your #1 job: Write 450 words for the section "Introduction / Вступ".**
...
Write the section prose for **Introduction / Вступ** within the module **The Dative I — Pronouns**.
...
```
===WORD_COUNTS===
Section "Introduction / Вступ": {count} words (budget: 450-450×2)
===WORD_COUNTS===
```
