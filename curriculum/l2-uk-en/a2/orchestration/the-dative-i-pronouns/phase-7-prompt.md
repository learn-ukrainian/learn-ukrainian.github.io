...
1. **Plan** (source of truth): `curriculum/l2-uk-en/plans/a2/the-dative-i-pronouns.yaml`
2. **Meta** (build config): `curriculum/l2-uk-en/a2/meta/the-dative-i-pronouns.yaml`
3. **Content** (the lesson): `curriculum/l2-uk-en/a2/the-dative-i-pronouns.md`
4. **Activities**: `curriculum/l2-uk-en/a2/activities/the-dative-i-pronouns.yaml`
5. **Vocabulary**: `curriculum/l2-uk-en/a2/vocabulary/the-dative-i-pronouns.yaml`
6. **Review** (Green Team review from Phase 6): `curriculum/l2-uk-en/a2/review/the-dative-i-pronouns-review.md`
7. **Phase 6b fix log** (if exists): `curriculum/l2-uk-en/a2/orchestration/the-dative-i-pronouns/phase-6b-fixes.md`
...
```bash
scripts/audit_module.sh curriculum/l2-uk-en/a2/the-dative-i-pronouns.md
```
...
Check against `curriculum/l2-uk-en/plans/a2/the-dative-i-pronouns.yaml`:
...
Read `curriculum/l2-uk-en/a2/the-dative-i-pronouns.md` in FULL. Check for:

### 3a: Russianisms (auto-fail)
```bash
grep -inP 'кушати|получати|приймати участь|слідуючий|любий\b|дякуючи' curriculum/l2-uk-en/a2/the-dative-i-pronouns.md
grep -inP 'кушати|получати|приймати участь|слідуючий|любий\b|дякуючи' curriculum/l2-uk-en/a2/activities/the-dative-i-pronouns.yaml
```

### 3b: Russian characters (auto-fail)
```bash
grep -nP '[ыэёъ]' curriculum/l2-uk-en/a2/the-dative-i-pronouns.md
grep -nP '[ыэёъ]' curriculum/l2-uk-en/a2/activities/the-dative-i-pronouns.yaml
```

### 3c: IPA errors
```bash
grep -n '/w/' curriculum/l2-uk-en/a2/the-dative-i-pronouns.md
grep -n '/ʊ/' curriculum/l2-uk-en/a2/the-dative-i-pronouns.md
grep -n '/w/' curriculum/l2-uk-en/a2/vocabulary/the-dative-i-pronouns.yaml
grep -n '/ʊ/' curriculum/l2-uk-en/a2/vocabulary/the-dative-i-pronouns.yaml
```
Fix: /w/ -> /ʋ/, /ʊ/ -> /u/
...
```bash
grep -nP '\[/[^]]+/\]|(?<!\[)/[а-яіїєґА-ЯІЇЄҐ][^/]*/(?!\])' curriculum/l2-uk-en/a2/the-dative-i-pronouns.md
```
If found and track is B1+: move to vocabulary, remove from content.

### 3e: English leakage
```bash
grep -inP '\b(the|is|are|was|were|has|have|this|that|with|from|for|and|but|not|can|will)\b' curriculum/l2-uk-en/a2/the-dative-i-pronouns.md
```
...
```bash
.venv/bin/python scripts/calc_immersion.py curriculum/l2-uk-en/a2/the-dative-i-pronouns.md
```
...
Read `curriculum/l2-uk-en/a2/activities/the-dative-i-pronouns.yaml` in FULL.
...
Read `curriculum/l2-uk-en/a2/review/the-dative-i-pronouns-review.md`. For EACH issue in "Critical Issues Found" or "Fix Plan":
...
```bash
.venv/bin/python scripts/generate_mdx.py l2-uk-en a2 1
```
...
```
===FINAL_REVIEW_START===
# Final Review: the-dative-i-pronouns
