...
> **Persona reminder:** You are full-rebuild-core-a. Write in the voice of The Helpful Neighbor: Encouraging Cultural Guide. Maintain this persona throughout — do not drift into generic AI tone.

> **Your #1 job: Write 750 words for the section "Presentation / Презентація".**
...
| File | Purpose |
|------|---------|
| `curriculum/l2-uk-en/a2/research/the-dative-i-pronouns-research.md` | Factual foundation — use exhaustively |
| `curriculum/l2-uk-en/a2/meta/the-dative-i-pronouns.yaml` | Content outline with section word allocations |
| `curriculum/l2-uk-en/plans/a2/the-dative-i-pronouns.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
| `claude_extensions/quick-ref/A2.md` | Level constraints, immersion %, engagement minimums |

Read ALL four files before writing anything.

## Your Task

Write the section prose for **Presentation / Презентація** within the module **The Dative I — Pronouns**.

- **WORD BUDGET**: 750 words minimum, 750 × 2 maximum. Stay in this range.
- **Immersion**: Content is 50-60% English. Grammar in English, examples in Ukrainian. Sentences max 15 words. All cases allowed. Simple subordinate clauses only.
...
- The Joy of Giving: Давальний відмінок
- The Magic Questions: Кому? Чому?
- The "Passive" Experiencer
---
This is why the Dative case is so critical for beginners. It is the key to talking about your physical state, your emotions, and your preferences. You are no longer just an actor in the world; you are a person experiencing the world.
...
Mastering this structure will make you sound much more natural and "Ukrainian" than simply translating English sentences word-for-word.
...
Previously used callout types in this module: ['culture']
...
```
===WORD_COUNTS===
Section "Presentation / Презентація": {count} words (budget: 750-750×2)
===WORD_COUNTS===
```
...
```
===FRICTION_START===
**Phase**: Phase 2: Section Content (Presentation / Презентація)
