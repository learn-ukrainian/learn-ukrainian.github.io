...
3. After writing a citation, verify it with Grep:
   ```
   Grep pattern="first 5-6 words of your citation" path="/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/the-dative-i-pronouns.md"
   ```
...
6. **Research notes** (seminar tracks only — for fact verification): `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/the-dative-i-pronouns-research.md`
...
Word count:       4016 / 3000 (133.9%)
Activities:       12
Vocabulary items: 33
Engagement boxes: 8
Immersion:        51.2% (target: 50-60%)
Audit status:     PASS
```
...
3. States and Verbs / Стани і дієслова
4. Practice / Практика
5. Dialogues / Діалоги
