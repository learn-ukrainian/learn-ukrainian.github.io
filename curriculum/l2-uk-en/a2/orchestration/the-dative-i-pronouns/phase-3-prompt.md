...
| Module persona | Encouraging Cultural Guide, acting as Empathic Psychologist |
...
```
curriculum/l2-uk-en/a2/the-dative-i-pronouns.md
```

**Plan file** (vocabulary_hints — vocabulary list to follow):
```
curriculum/l2-uk-en/plans/a2/the-dative-i-pronouns.yaml
```

**Meta file** (activity count targets, pedagogy):
```
curriculum/l2-uk-en/a2/meta/the-dative-i-pronouns.yaml
```
...
**ALLOWED types (use ONLY these):** quiz, fill-in, match-up, anagram, unjumble, mark-the-words, reorder, cloze

**FORBIDDEN types (audit will auto-FAIL if you use these):** 
