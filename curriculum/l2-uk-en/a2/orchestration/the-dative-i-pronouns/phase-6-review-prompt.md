...
1. **Content** (the lesson you're reviewing): `curriculum/l2-uk-en/a2/the-dative-i-pronouns.md`
2. **Activities**: `curriculum/l2-uk-en/a2/activities/the-dative-i-pronouns.yaml`
3. **Vocabulary**: `curriculum/l2-uk-en/a2/vocabulary/the-dative-i-pronouns.yaml`
4. **Plan** (source of truth for scope): `curriculum/l2-uk-en/plans/a2/the-dative-i-pronouns.yaml`
5. **Meta** (build config): `curriculum/l2-uk-en/a2/meta/the-dative-i-pronouns.yaml`
6. **Research notes** (if exists): `curriculum/l2-uk-en/a2/research/the-dative-i-pronouns-research.md`
...
```
Word count:       2486 / 1000 (248%%)
Activities:       10
Vocabulary items: 26
Engagement boxes: 4
Immersion:        12.0%% (target: 50-60%)
Audit status:     FAILED (Immersion low, but content valid)
```
...
At module 1, students know ONLY modules 1-A1-34. Any grammar from later modules is scope creep.
