...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/work-professions-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/work-professions.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/work-professions.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Work and Professions** (a2 track).
...
|---------|--------|---------------------|
| Вступ: Світ роботи (Introduction: World of Work) | 450 | 675 |
| Назви професій та гендер (Profession Names and Gender) | 600 | 900 |
| Граматика: Орудний відмінок (Grammar: Instrumental Case) | 850 | 1275 |
| Діловий етикет та звертання (Business Etiquette and Address) | 550 | 825 |
| Практика: Співбесіда та обов'язки (Practice: Interview and Duties) | 550 | 825 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/work-professions.yaml`. Go through EVERY `points:` item in EVERY section:
