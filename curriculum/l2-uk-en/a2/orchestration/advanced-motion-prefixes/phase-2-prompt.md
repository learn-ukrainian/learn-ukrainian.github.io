...
| File | Purpose |
|------|---------|
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/research/advanced-motion-prefixes-research.md` | Factual foundation — use exhaustively |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/advanced-motion-prefixes.yaml` | Content outline with section word allocations |
| `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/a2/advanced-motion-prefixes.yaml` | Objectives, vocabulary_hints (use ONLY these words) |
...
Write the full lesson prose for **Advanced Motion Prefixes** (a2 track).
...
|---------|--------|---------------------|
| Вступ | 400 | 600 |
| Геометрія руху: Пере-, Про-, Об- | 700 | 1050 |
| Наближення та Прибуття: Під-, До-, За-, При- | 800 | 1200 |
| Практика та Корекція | 600 | 900 |
| Діалоги та Сценарії | 500 | 750 |
| **Total** | **3000** | **4500** |
...
Open the `content_outline` from `/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/a2/meta/advanced-motion-prefixes.yaml`. Go through EVERY `points:` item in EVERY section:
