...
2. "Бо" is a short form of:
   - [x] Тому що
   - [ ] Але
   - [ ] Або

3. Which word introduces a POSITIVE cause?
   - [x] Завдяки
   - [ ] Через
   - [ ] Проте

4. "Зате" is best used when:
   - [x] Finding a positive side to a negative situation
   - [ ] Explaining a strict logical reason
   - [ ] Changing the subject

5. Which sentence needs a comma?
   - [x] Я йду тому що хочу. (Needs comma before тому що)
   - [ ] Я йду.

6. "Оскільки" usually comes:
   - [x] At the beginning of a sentence
   - [ ] At the very end
   - [ ] After the verb
...
10. "Якби не" starts:
    - [x] A hypothetical condition
    - [ ] A strict fact
    - [ ] A question

11. "Дарма що" is a synonym for:
    - [x] Хоча
    - [ ] Тому що
    - [ ] Коли
...
## cloze: The Job Interview

> Complete the text.

Я хочу отримати цю роботу, [___:1] мені потрібні гроші.
