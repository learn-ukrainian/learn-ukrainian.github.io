...
Коли ви заходите всередину, вас зустрічає **фармацевт** (pharmacist). Фармацевт в Україні — це не просто продавець. Це кваліфікований спеціаліст, який може дати пораду щодо легких симптомів, порекомендувати аналоги препаратів або розповісти про взаємодію різних медикаментів.

### Електронний рецепт

Важлива зміна в українській медичній системі відбулася у дві тисячі двадцятому році, а з дві тисячі двадцять другого року вона стала ще суворішою. Тепер багато серйозних препаратів продаються лише за наявності рецепта. Ця система називається **е-рецепт** (electronic prescription). 
...
Слово **ліки** (medicine) має дуже важливу граматичну особливість в українській мові. Це іменник, який має лише форму множини (pluralia tantum). Він ніколи не вживається в однині. Це означає, що всі прикметники, займенники та дієслова, які з ним пов'язані, також повинні стояти у формі множини.
...
|-----------------------|----------------------|----------|
| Це ефективне ліки. | **Ці ліки ефективні.** | Займенник «ці» та прикметник «ефктивні» у множині. |
| Я купив нове ліки. | **Я купив нові ліки.** | Прикметник у знахідному відмінку множини. |
...
Наприклад, слово **біль** (pain) в українській мові чоловічого роду. Це важливо пам'ятати, коли ви додаєте прикметники: сильний біль, гострий біль, тупий біль. Якщо у вас висока **температура** (fever), вам потрібні спеціальні препарати для її зниження. А якщо у вас **кашель** (cough), фармацевт може запропонувати сироп.
...
### Конструкція «від + родовий відмінок»

Це найважливіше граматичне правило цього уроку. Коли ми говоримо про медикаменти, які борються з певною хворобою або симптомом, ми використовуємо прийменник **від** (against/from) плюс іменник у **родовому відмінку** (Genitive case).
...
**Правила утворення:**
Прийменник «від» завжди вимагає після себе родового відмінка (Кого? Чого?).
* кашель (називний) → від кашлю (родовий)
* біль (називний) → від болю (родовий)
* застуда (називний) → від застуди (родовий)
...
Якщо ви не знаєте назву ліків, ви можете просто розповісти фармацевту про свій стан. Для цього є кілька зручних фраз. Найпростіша з них — це конструкція **«У мене болить...»** (I have a pain in...). Після цієї фрази ми ставимо частину тіла в називному відмінку.
...
В аптеках є цілі відділи з різними травами, чаями та натуральними сиропами. Дуже популярною є **калина** (viburnum) — традиційна українська ягода, яку використовують від застуди. Також часто купують ромашку (chamomile) для заспокоєння та липу (linden) від кашлю.
...
* «Цей сироп від кашлю зроблений на основі натуральних трав.» (This cough syrup is made on the basis of natural herbs.)
...
В українській мові існує велика різниця між тим, як ми говоримо про ліки з друзями, і тим, що написано в офіційній інструкції. Найкращий приклад — це дієслово «to take».
...
* «Спосіб застосування описаний на зворотному боці коробки.» (The method of application is described on the back of the box.)

> [!culture]
> **Довіра до інструкцій**
> В Україні люди дуже серйозно ставляться до паперових інструкцій у коробках з ліками (вони називаються «листок-вкладиш»). Навіть якщо лікар призначив лікування, багато пацієнтів спочатку уважно читають весь довгий текст інструкції, особливо розділи про побічні ефекти та взаємодію з іншими препаратами.

### Наказовий спосіб в інструкціях

Коли ви читаєте інструкцію, ви часто бачите дієслова у формі **наказового способу** (Imperative mood). Виробник ліків ніби дає вам прямі команди, як безпечно використовувати продукт. В інструкціях зазвичай використовується форма для множини або ввічлива форма на «ви».

**Правила утворення (Наказовий спосіб на «ви»):**
Основа теперішнього часу + закінчення «-іть» або «-йте».
* зберігати → зберігайте (keep)
* приймати → приймайте (take)
* збовтати → збовтайте (shake)

**Приклади вживання:**
* «**Приймайте** по одній таблетці від болю.» (Take one pill for pain.)
* «Перед використанням **збовтайте** пляшку з сиропом.» (Shake the bottle with syrup before use.)
...
Майже на всіх ліках ви побачите фразу: **«Зберігати в недоступному для дітей місці»** (Keep out of reach of children). Дієслово «зберігати» (to store/keep) тут стоїть в інфінітиві — це ще один спосіб давати офіційні інструкції в українській мові.
...
В українській аптеці ви можете купити ліки в різних формах. Дуже важливо знати їхні назви та граматичний рід, щоб правильно поєднувати з прикметниками та дієсловами.
...
Для опису частоти прийому ліків українська мова використовує прийменник «на» та іменники, що означають час (день, доба, тиждень). Слово «доба» означає повні двадцять чотири години.
...
Коли ми говоримо про кількість таблеток за один раз, ми використовуємо конструкцію **«по + місцевий/давальний відмінок»**. 
...
> [!tip]
> **Доба чи день?**
> В медичному контексті лікарі дуже люблять слово «доба» (24 hours). Коли інструкція каже «двічі на добу», це означає, що між прийомами має пройти приблизно дванадцять годин. Це точніше, ніж просто «двічі на день».
...
Також надзвичайно важливо знати, чи є у вас **алергія** (allergy) на якісь компоненти. Українською мовою ми говоримо «у мене алергія на...» плюс знахідний відмінок.

Якщо ви приймаєте кілька різних препаратів, фармацевт може попередити вас про їхню взаємодію. Ми використовуємо прийменник «з» + орудний відмінок: взаємодіяти з іншими ліками.
...
Тепер, коли ми вивчили всі необхідні слова та правила, давайте подивимося, як це працює в реальному житті. В українських аптеках спілкування зазвичай дуже ввічливе та швидке. Ви маєте чітко пояснити ситуацію, а фармацевт запропонує найкраще рішення.

### Сценарій 1: Застуда та базові ліки

У цьому сценарії покупець прийшов до аптеки з типовими осінніми симптомами: застудою та слабкістю. Зверніть увагу, як він використовує конструкцію «від + родовий відмінок».
...
Цей діалог показує ідеальну базову взаємодію. Покупець описує проблему («щось від кашлю»), фармацевт дає інструкції («приймайте по одній ложці», «після їди») та попереджає про наслідки.

### Сценарій 2: Антибіотики та рецепт

Ця ситуація складніша. Покупець хоче купити серйозний препарат, але не знає нових правил української медичної системи щодо електронних рецептів.
...
**Фармацевт:** З дві тисячі двадцять другого року правила змінилися. Тепер для антибіотиків потрібен е-рецепт. Я не можу продати їх вам без коду в СМС.
...
Щоб попросити препарат, використовуйте конструкцію «від + родовий відмінок»: **ліки від кашлю**, **таблетки від болю**, **сироп від температури**. Звертайте увагу на інструкції: фармацевти використовують дієслово «приймати» (to take) замість розмовного «пити». Завжди перевіряйте дозування (наприклад, «приймати по одній таблетці») та час прийому щодо їжі («до їди», «після їди»). 

Якщо ви віддаєте перевагу натуральним методам, українська фітотерапія запропонує вам безліч трав'яних зборів та чаїв.
