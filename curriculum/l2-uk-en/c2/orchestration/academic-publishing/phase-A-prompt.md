...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c2/academic-publishing.yaml
```

Read the meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c2/meta/academic-publishing.yaml
```
...
Research **Академічне публікування українською мовою** for the **C2** core track. Core tracks need lighter research than seminar tracks — focus on accuracy and State Standard alignment.
...
# Дослідження: Академічне публікування українською мовою
