...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c2/creative-writing-prose.yaml
```

Read the meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c2/meta/creative-writing-prose.yaml
```
...
Research **Творче письмо — проза** for the **C2** core track. Core tracks need lighter research than seminar tracks — focus on accuracy and State Standard alignment.
