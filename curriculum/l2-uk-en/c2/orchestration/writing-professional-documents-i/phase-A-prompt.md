...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c2/writing-professional-documents-i.yaml
```

Read the meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c2/meta/writing-professional-documents-i.yaml
```

Read the level quick-ref for constraints:

```
/Users/krisztiankoos/projects/learn-ukrainian/claude_extensions/quick-ref/C2.md
```
...
Research **Написання професійних документів I — Звіти та реферати** for the **C2** core track. Core tracks need lighter research than seminar tracks — focus on accuracy and State Standard alignment.
