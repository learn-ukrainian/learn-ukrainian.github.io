...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/c2/c2-riven-zaversheno.yaml
```

Read the meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/c2/meta/c2-riven-zaversheno.yaml
```
...
Research **C2 РІВЕНЬ ЗАВЕРШЕНО — Сертифікація та перспективи** for the **C2** core track. Core tracks need lighter research than seminar tracks — focus on accuracy and State Standard alignment.
...
# Дослідження: C2 РІВЕНЬ ЗАВЕРШЕНО — Сертифікація та перспективи
