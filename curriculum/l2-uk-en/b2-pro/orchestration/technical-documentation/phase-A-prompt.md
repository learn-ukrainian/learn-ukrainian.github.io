...
```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/plans/b2-pro/technical-documentation.yaml
```

Read the current meta file (for reference — you will replace the content_outline):

```
/Users/krisztiankoos/projects/learn-ukrainian/curriculum/l2-uk-en/b2-pro/meta/technical-documentation.yaml
```
...
Research **Технічна документація** for the **b2-pro** professional track. Produce structured research notes that will drive authentic, professionally accurate content in Phase B.
