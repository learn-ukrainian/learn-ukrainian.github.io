...
*   **Word Count** (from `config.py` v2026-02-15): A1: 2000, A2: 3000, B1+: 4000, Seminars (HIST/C1-BIO/ISTORIOHRAFIIA/LIT/C2/OES/RUTH): 5000. If this date is older than config.py's latest change, re-read config.py.
...
MANDATORY for `hist`, `c1-bio`, `istoriohrafiia`, `lit`, `oes`, `ruth`.
...
- **Transliteration Ban (C1+)**: Latin transliteration STRICTLY PROHIBITED in ISTORIOHRAFIIA/C1-BIO
