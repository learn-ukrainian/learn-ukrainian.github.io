...
<MatchUp client:only="react" pairs={[{"left": "почувати себе", "right": "відчувати свій фізичний або моральний стан"}, {"left": "сам по собі", "right": "діяти ізольовано, без стороннього впливу"}, {"left": "так собі", "right": "результат не дуже хороший, але й не критично поганий"}, {"left": "від себе", "right": "сказати щось від власного імені або додати свої думки"}, {"left": "не по собі", "right": "внутрішній стан тривоги або дискомфорту"}, {"left": "пишатися собою", "right": "бути дуже задоволеним своїм результатом"}]} instruction={"З'єднайте терміни з розділу «Зворотний займенник себе» з їхніми визначеннями."} />
...
<div class="dialogue-line"><span class="speaker">Професор:</span> Сьогодні ми говоримо про істину. Кожен має свою думку, але чи існує об'єктивна реальність? *(Today we are talking about truth. Everyone has their own opinion, but does objective reality exist?)*</div>

<div class="dialogue-line"><span class="speaker">Олена:</span> Мені здається, що будь-яка відповідь може бути правильною за певних умов. Ніщо не є хибним. *(It seems to me that any answer can be correct under certain conditions. Nothing is absolutely false.)*</div>

<div class="dialogue-line"><span class="speaker">Марко:</span> Я ні з чим не можу погодитися. Якщо все правильно, то істина втрачає сенс. Ніхто не може заперечити очевидні факти. *(I cannot agree with anything. If everything is correct, then truth loses its meaning. Nobody can deny obvious facts.)*</div>

<div class="dialogue-line"><span class="speaker">Олена:</span> Але дехто з нас бачить факти інакше! Те, що для тебе очевидне, для когось іншого — ілюзія. Люди часто обманюють самі себе. *(But some of us see facts differently! What is obvious to you is an illusion for someone else. People often deceive themselves.)*</div>

<div class="dialogue-line"><span class="speaker">Професор:</span> Це цікава думка. Хто-небудь хоче додати щось до слів Олени? Чия позиція вам ближча? *(This is an interesting thought. Does anyone want to add something to Olena's words? Whose position is closer to you?)*</div>

<div class="dialogue-line"><span class="speaker">Андрій:</span> Я згоден з Марком. Ми не можемо просто вигадувати будь-що. Інакше ми ніколи ні до чого не дійдемо в наших дискусіях. *(I agree with Marko. We cannot just invent anything. Otherwise, we will never arrive at anything in our discussions.)*</div>
...
<FillIn client:only="react" items={[{"sentence": "___ зараз година?", "answer": "Котра", "options": ["Яка", "Котра", "Що", "Котрий"]}, {"sentence": "З ___ сестрою він розмовляє?", "answer": "чиєю", "options": ["чиєю", "якою", "чиїй", "ким"]}, {"sentence": "Ось той старий будинок, у ___ ми колись жили.", "answer": "якому", "options": ["якому", "чому", "яким", "котрому"]}, {"sentence": "___ ти шукаєш у цьому натовпі?", "answer": "Кого", "options": ["Хто", "Кого", "Що", "Ким"]}, {"sentence": "___ ти найбільше цікавишся?", "answer": "Чим", "options": ["Ким", "Чим", "Що", "Чому"]}, {"sentence": "Я знаю людину, ___ дитина тут грається.", "answer": "чия", "options": ["яка", "чий", "чия", "чию"]}]} instruction={"Вставте правильну граматичну форму у реченнях на тему питально-відносні займенники."} />

<Quiz client:only="react" questions={[{"question": "Який займенник завжди вказує на неістот та абстрактні поняття?", "options": [{"text": "що", "correct": true}, {"text": "хто", "correct": false}, {"text": "який", "correct": false}, {"text": "чий", "correct": false}]}, {"question": "Який займенник використовується виключно для запитання про порядок предметів або про час?", "options": [{"text": "котрий", "correct": true}, {"text": "який", "correct": false}, {"text": "чий", "correct": false}, {"text": "що", "correct": false}]}, {"question": "У реченні «Людина, яка знає правду, мовчить» слово «яка» — це:", "options": [{"text": "відносний займенник", "correct": true}, {"text": "питальний займенник", "correct": false}, {"text": "особовий займенник", "correct": false}, {"text": "заперечний займенник", "correct": false}]}, {"question": "Форма знахідного відмінка займенника «хто» повністю збігається з формою:", "options": [{"text": "родового відмінка (кого)", "correct": true}, {"text": "давального відмінка (кому)", "correct": false}, {"text": "орудного відмінка (ким)", "correct": false}, {"text": "місцевого відмінка (на кому)", "correct": false}]}, {"question": "Як правильно запитати про час українською мовою?", "options": [{"text": "Котра зараз година?", "correct": true}, {"text": "Яка зараз година?", "correct": false}, {"text": "Котрий зараз час?", "correct": false}, {"text": "Який зараз час?", "correct": false}]}, {"question": "Якщо відносний займенник з'єднує підрядну частину з головною, від чого залежить його відмінок?", "options": [{"text": "від його ролі у підрядному реченні", "correct": true}, {"text": "від слова-антецедента у головному реченні", "correct": false}, {"text": "завжди стоїть у називному відмінку", "correct": false}, {"text": "завжди збігається з родом і числом", "correct": false}]}]} instruction={"Оберіть правильний варіант: лексика та граматика з розділу «Питально-відносні займенники»."} />

<FillIn client:only="react" items={[{"sentence": "У двері ___ дзвонить, але я не бачу хто це.", "answer": "хтось", "options": ["хтось", "хто-небудь", "будь-хто", "ніхто"]}, {"sentence": "Чи є тут ___ живий? Відгукніться!", "answer": "хто-небудь", "options": ["хтось", "хто-небудь", "дехто", "ніщо"]}, {"sentence": "Цю просту задачу може розв'язати ___ з наших студентів.", "answer": "будь-хто", "options": ["хтось", "будь-хто", "абихто", "ніщо"]}, {"sentence": "Він зробив цю роботу погано і використав ___ матеріали.", "answer": "абиякі", "options": ["абиякі", "якісь", "будь-які", "ніякі"]}, {"sentence": "___ з нас уже знає правильну відповідь, але ми поки мовчимо.", "answer": "Дехто", "options": ["Хтось", "Дехто", "Будь-хто", "Увесь"]}, {"sentence": "Цей старий лист надійшов від ___, я навіть не можу прочитати ім'я.", "answer": "казна-кого", "options": ["казна-кого", "когось", "будь-кого", "кожного"]}]} instruction={"Вставте правильний неозначений займенник, звертаючи увагу на контекст та правопис."} />

<ErrorCorrection client:only="react" items={[{"sentence": "Ніхто знає правильну відповідь на це складне питання.", "errorWord": "знає", "correctForm": "не знає", "options": ["не знає", "незнає", "ні знає", "не має"], "explanation": "В українській мові діє суворе правило подвійного заперечення: якщо є заперечний займенник, дієслово повинно мати частку «не»."}, {"sentence": "Я нічого розумію з цього філософського тексту.", "errorWord": "розумію", "correctForm": "не розумію", "options": ["не розумію", "нерозумію", "ні розумію", "нічого розуміти"], "explanation": "Обов'язково додаємо заперечну частку «не» перед дієсловом."}, {"sentence": "Він нікому вірить у цій складній ситуації.", "errorWord": "вірить", "correctForm": "не вірить", "options": ["не вірить", "невірить", "ні вірить", "не повірить"], "explanation": "Подвійне заперечення є обов'язковим: «нікому не вірить»."}, {"sentence": "Ми сьогодні нікуди йдемо, бо на вулиці сильний дощ.", "errorWord": "йдемо", "correctForm": "не йдемо", "options": ["не йдемо", "нейдемо", "ні йдемо", "не підемо"], "explanation": "Дієслово повинно підтримувати заперечення часткою «не»."}, {"sentence": "У цій темній кімнаті нікого є.", "errorWord": "є", "correctForm": "немає", "options": ["немає", "не є", "нема", "нічого"], "explanation": "Замість дієслова «є» у заперечних конструкціях використовується слово «немає»."}, {"sentence": "Ніщо привернуло моєї уваги відразу.", "errorWord": "привернуло", "correctForm": "не привернуло", "options": ["не привернуло", "непривернуло", "ні привернуло", "не було"], "explanation": "Заперечний займенник «ніщо» вимагає частки «не» перед дієсловом."}]} instruction={"Знайдіть і виправте синтаксичну помилку в заперечних реченнях (правило подвійного заперечення)."} />

<GroupSort client:only="react" groups={{"Пишемо разом (частки -сь, де-, аби-)": ["хтось", "дещо", "абиякий", "дехто", "щось", "абихто"], "Пишемо через дефіс (частки будь-, -небудь, казна-, хтозна-)": ["будь-хто", "що-небудь", "казна-який", "хтозна-що", "будь-який", "хто-небудь"]}} instruction={"Розподіліть неозначені займенники за правилами правопису: разом чи через дефіс."} />

<MatchUp client:only="react" pairs={[{"left": "Питально-відносний", "right": "хто, що, який, чий, котрий"}, {"left": "Зворотний", "right": "себе (собою, собі)"}, {"left": "Неозначений", "right": "хтось, будь-хто, дехто, абиякий"}, {"left": "Заперечний", "right": "ніхто, ніщо, ніякий, нічий"}, {"left": "Означальний", "right": "кожен, весь, сам, інший"}, {"left": "Особовий", "right": "я, ти, він, вона, ми, ви, вони"}]} instruction={"З'єднайте розряд займенників з відповідним прикладом."} />

<FillIn client:only="react" items={[{"sentence": "___ студент має право на власну думку.", "answer": "Кожен", "options": ["Кожен", "Увесь", "Сам", "Самий"]}, {"sentence": "Він читав цю книгу ___ час, поки їхав у поїзді.", "answer": "увесь", "options": ["увесь", "кожен", "самий", "будь-який"]}, {"sentence": "Я хочу почути ___ підхід до вирішення цієї проблеми.", "answer": "інший", "options": ["інший", "кожен", "сам", "самий"]}, {"sentence": "Він ___ зробив цю складну роботу, без жодної сторонньої допомоги.", "answer": "сам", "options": ["сам", "самий", "кожен", "увесь"]}, {"sentence": "Ми зустрілися вчора у тій ___ кімнаті.", "answer": "самій", "options": ["самій", "самі", "одній", "своїй"]}, {"sentence": "Я розповів цю таємницю ___ своїм друзям.", "answer": "всім", "options": ["всім", "кожним", "самим", "всіма"]}]} instruction={"Вставте правильний означальний займенник, звертаючи увагу на його значення."} />

<EssayResponse client:only="react" title={"Напишіть 5 речень, використовуючи нову лексику з розділу «Зворотний займенник себе»."} prompt={"Розкажіть про своє ставлення до себе або опишіть ситуацію з власного життя. Напишіть мінімум 5 речень (близько 50 слів), використовуючи різні відмінки зворотного займенника «себе» (себе, собі, собою, на собі). Також спробуйте використати стійкі вирази, такі як «почувати себе», «сам по собі», «від себе» або «не по собі»."} modelAnswer={"Я намагаюся завжди бути чесним із собою. Коли я досягаю успіху, я щиро пишаюся собою і можу дозволити собі невеликий подарунок. Звісно, іноді я відчуваю себе не по собі у нових компаніях. Але я розумію, що впевненість не з'являється сама по собі. Тому я постійно працюю над собою, щоб ставати кращим."} />
