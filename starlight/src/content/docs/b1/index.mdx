...
description: "B1 landing — 4 available / 4 reviewed / 90 planned"
template: splash
---
...
<LevelLanding
  ...
  level="B1"
  title="Крок вперед"
  subtitle="4 learner pages available · 4 reviewed · 90 planned"
  progressTitle="Build status"
  progressDescription="4 available · 4 reviewed · 90 planned"
  moduleCount={94}
  wordTarget={4000}
  color="var(--lu-id-b1)"
  modules={[
