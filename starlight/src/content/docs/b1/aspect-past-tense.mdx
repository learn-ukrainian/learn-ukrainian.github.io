...
<Quiz client:only="react" questions={[{"question": "Вчора я _______ цікаву книжку, але ще не закінчив.", "options": [{"text": "читав", "correct": true}, {"text": "прочитав", "correct": false}, {"text": "читаю", "correct": false}, {"text": "читатиму", "correct": false}]}, {"question": "Минулого тижня він _______ три листи і відправив їх.", "options": [{"text": "писав", "correct": false}, {"text": "написав", "correct": true}, {"text": "пише", "correct": false}, {"text": "писатиме", "correct": false}]}, {"question": "Вона цілий день _______ звіт, тому дуже втомилася.", "options": [{"text": "зробила", "correct": false}, {"text": "робила", "correct": true}, {"text": "робить", "correct": false}, {"text": "зробить", "correct": false}]}, {"question": "Я нарешті _______ ту складну проблему!", "options": [{"text": "вирішував", "correct": false}, {"text": "вирішую", "correct": false}, {"text": "вирішу", "correct": false}, {"text": "вирішив", "correct": true}]}, {"question": "Щовечора ми _______ фільми разом.", "options": [{"text": "подивилися", "correct": false}, {"text": "дивилися", "correct": true}, {"text": "дивимося", "correct": false}, {"text": "подивимось", "correct": false}]}, {"question": "Одного разу я _______ цей фільм у кінотеатрі.", "options": [{"text": "дивився", "correct": false}, {"text": "дивлюся", "correct": false}, {"text": "подивився", "correct": true}, {"text": "подивлюсь", "correct": false}]}]} instruction={"Оберіть найбільш природний варіант для кожної ситуації"} />
...
<div class="dialogue-line"><span class="speaker">Тарас:</span> Привіт! Як твій день учора? Я вчора написав три звіти, відправив усі листи і зробив презентацію. *(Hi! How was your day yesterday? Yesterday I wrote three reports, sent all the letters, and made a presentation.)*</div>

<div class="dialogue-line"><span class="speaker">Оксана:</span> Привіт... А я цілий день писала один звіт, робила презентацію, намагалася знайти помилку в таблиці, але так нічого і не закінчила. *(Hi... And I spent the whole day writing one report, making a presentation, trying to find a mistake in the table, but I didn't finish anything.)*</div>

<div class="dialogue-line"><span class="speaker">Тарас:</span> Ого. Але ж ти працювала весь день? *(Wow. But you were working the whole day?)*</div>

<div class="dialogue-line"><span class="speaker">Оксана:</span> Так, я дуже втомилася, хоча результату немає. *(Yes, I am very tired, even though there is no result.)*</div>
...
<FillIn client:only="react" items={[{"sentence": "Цілий день я ____ обід, тому так втомилася.", "answer": "готувала", "options": ["готувала", "приготувала", "готує", "приготує"]}, {"sentence": "Сьогодні вранці я швидко ____ смачний сніданок.", "answer": "приготував", "options": ["приготував", "готував", "готує", "готуватиме"]}, {"sentence": "Вона щодня ____ нові слова, щоб краще говорити.", "answer": "вчила", "options": ["вчила", "вивчила", "вчить", "вивчить"]}, {"sentence": "Він нарешті ____ всі ці складні граматичні правила!", "answer": "вивчив", "options": ["вивчив", "вчив", "вчить", "вивчить"]}, {"sentence": "Раптом мій телефон задзвонив, і я ____ слухавку.", "answer": "взяв", "options": ["взяв", "брав", "бере", "візьме"]}, {"sentence": "Раніше я завжди ____ парасольку, коли йшов дощ.", "answer": "брав", "options": ["брав", "взяв", "бере", "візьме"]}, {"sentence": "Ми ____ про політику цілі дві години.", "answer": "говорили", "options": ["говорили", "сказали", "говорять", "скажуть"]}, {"sentence": "Директор зайшов і ____ нам дуже важливу новину.", "answer": "сказав", "options": ["сказав", "говорив", "каже", "скаже"]}]} instruction={"Вставте правильну форму минулого часу (доконаний чи недоконаний вид)"} />
...
<MatchUp client:only="react" pairs={[{"left": "щодня", "right": "недоконаний (повторюваність)"}, {"left": "одного разу", "right": "доконаний (однократність)"}, {"left": "довго", "right": "недоконаний (процес)"}, {"left": "нарешті", "right": "доконаний (результат)"}, {"left": "часто", "right": "недоконаний (повторюваність)"}, {"left": "раптом", "right": "доконаний (однократність)"}, {"left": "цілий день", "right": "недоконаний (тривалість)"}, {"left": "за годину", "right": "доконаний (завершеність)"}]} instruction={"З'єднайте часовий маркер з видом дієслова, який він зазвичай вимагає"} />
...
<div class="dialogue-line"><span class="speaker">Онук:</span> Дідусю, розкажи, як ти жив, коли був малим? *(Grandpa, tell me, how did you live when you were little?)*</div>

<div class="dialogue-line"><span class="speaker">Дідусь:</span> О, то був зовсім інший час. Щоранку я прокидався дуже рано, десь о п’ятій годині. *(Oh, that was a completely different time. Every morning I woke up very early, around five o'clock.)*</div>

<div class="dialogue-line"><span class="speaker">Онук:</span> Ти завжди так рано вставав? *(Did you always get up so early?)*</div>

<div class="dialogue-line"><span class="speaker">Дідусь:</span> Так, завжди. Потім я йшов до колодязя, набирав воду і допомагав мамі по господарству. Це була моя щоденна робота. *(Yes, always. Then I went to the well, drew water, and helped my mother with the housework. That was my daily job.)*</div>

<div class="dialogue-line"><span class="speaker">Онук:</span> А ти колись потрапляв у пригоди? *(And did you ever get into adventures?)*</div>

<div class="dialogue-line"><span class="speaker">Дідусь:</span> Звісно! Пам’ятаю, одного разу влітку раптом почалася страшна буря. *(Of course! I remember, one time in the summer, a terrible storm suddenly started.)*</div>

<div class="dialogue-line"><span class="speaker">Онук:</span> І що сталося? *(And what happened?)*</div>

<div class="dialogue-line"><span class="speaker">Дідусь:</span> Вітер був такий сильний, що старе дерево біля нашої хати впало прямо на дорогу. *(The wind was so strong that the old tree near our house fell right onto the road.)*</div>

<div class="dialogue-line"><span class="speaker">Онук:</span> Ого! Ви його потім прибрали? *(Wow! Did you clean it up later?)*</div>

<div class="dialogue-line"><span class="speaker">Дідусь:</span> Так, ми з батьком цілий день його розпилювали, але до вечора нарешті прибрали все гілля. *(Yes, my father and I were sawing it all day, but by evening we finally cleared all the branches.)*</div>
...
<GroupSort client:only="react" groups={{"Недоконаний вид (процес, повторюваність)": ["щодня", "завжди", "довго", "цілий день", "часто", "звична рутина"], "Доконаний вид (результат, однократність)": ["одного разу", "раптом", "нарешті", "за годину", "минулого вівторка", "швидка зміна ситуації"]}} instruction={"Розподіліть маркери часу та типові ситуації за категоріями виду"} />
...
<GroupSort client:only="react" groups={{"Недоконаний вид (процес)": ["читати", "робити", "говорити", "вчити", "готувати", "відповідати", "писати", "брати"], "Доконаний вид (результат)": ["прочитати", "зробити", "сказати", "вивчити", "приготувати", "відповісти", "написати", "взяти"]}} instruction={"Розподіліть дієслова за видом (доконаний чи недоконаний)"} />

<MatchUp client:only="react" pairs={[{"left": "читати", "right": "прочитати"}, {"left": "робити", "right": "зробити"}, {"left": "говорити", "right": "сказати"}, {"left": "вчити", "right": "вивчити"}, {"left": "готувати", "right": "приготувати"}, {"left": "відповідати", "right": "відповісти"}, {"left": "писати", "right": "написати"}, {"left": "брати", "right": "взяти"}]} instruction={"З'єднайте недоконане дієслово з його доконаною парою"} />

<FillIn client:only="react" items={[{"sentence": "Він довго ____ домашнє завдання, але так і не закінчив.", "answer": "робив", "options": ["робив", "зробив", "робить", "зробить"]}, {"sentence": "Вчора ввечері я нарешті ____ цей звіт!", "answer": "написав", "options": ["написав", "писав", "пишу", "напишу"]}, {"sentence": "Ми щодня ____ на ці складні питання на уроці.", "answer": "відповідали", "options": ["відповідали", "відповіли", "відповідають", "відповідять"]}, {"sentence": "Сьогодні на іспиті він успішно ____ на всі питання.", "answer": "відповів", "options": ["відповів", "відповідав", "відповідає", "відповідатиме"]}, {"sentence": "Одного разу ми гуляли в парку, і раптом ____ сильний дощ.", "answer": "почався", "options": ["почався", "починався", "почнеться", "починається"]}, {"sentence": "Вона завжди ____ парасольку, коли йшла на роботу.", "answer": "брала", "options": ["брала", "взяла", "бере", "візьме"]}]} instruction={"Оберіть правильний вид дієслова для контексту"} />

<GroupSort client:only="react" groups={{"Процес або рутина (Недоконаний вид)": ["Я читав цю книгу вчора.", "Ми довго говорили про політику.", "Він робив свій новий звіт цілий день.", "Вона часто телефонувала своїй мамі.", "Щоліта ми їздили на тепле море.", "Він постійно брав мої речі без дозволу."], "Результат або однократність (Доконаний вид)": ["Я успішно прочитав цю книгу до кінця.", "Він сказав нам дуже важливу новину.", "Тарас нарешті зробив свій фінансовий звіт.", "Вчора вона зателефонувала дуже пізно.", "Одного разу ми несподівано поїхали в гори.", "Він швидко взяв таксі і поїхав на вокзал."]}} instruction={"Розподіліть речення за тим, що вони описують: тривалий процес чи конкретний результат"} />

<EssayResponse client:only="react" title={"Напишіть про свій минулий тиждень"} prompt={"Напишіть невелику розповідь про ваш минулий тиждень. Опишіть три регулярні, звичні дії (використайте недоконаний вид) та три конкретні, завершені події (використайте доконаний вид). Наприкінці додайте одне речення, де фоновий процес переривається раптовою дією («Коли я..., раптом...»)."} modelAnswer={"Минулого тижня я щоранку прокидався о сьомій годині, пив міцну каву і йшов на роботу. Після роботи я зазвичай читав новини та відпочивав. Але в середу я нарешті написав складний звіт. У четвер мій друг несподівано запросив мене в кіно, і ми подивилися цікавий фільм. У п'ятницю я купив квитки на концерт. Коли я спокійно дивився телевізор у неділю, мені раптом зателефонував керівник."} rubric={`- Використання недоконаного виду: Студент успішно описує фонові та повторювані дії за допомогою правильних форм минулого часу недоконаного виду.
- Використання доконаного виду: Студент чітко позначає результативні та однократні дії за допомогою правильних форм минулого часу доконаного виду.
- Контраст видів (перервана дія): Студент вміє поєднувати тривалий процес (НВ) з раптовою подією (ДВ) в одному реченні.`} />
