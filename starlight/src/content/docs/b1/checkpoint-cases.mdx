...
Expressing causality requires sensitivity to the context and an understanding of the "Golden Rule" of Ukrainian decolonization. For negative or neutral causes, the only correct preposition is **через** followed by the Accusative case. For positive outcomes where gratitude, success, or appreciation is implied, you must use **завдяки** with the Dative case. The preposition **із-за** used for causality is a direct Russianism and must be completely avoided in modern Ukrainian. You only use it for its true spatial meaning, like pulling something out from behind a physical object.
...
When using professional titles alongside a surname, the title takes the Vocative case, but an invariable surname like **Петренко** remains unchanged: **лікарю Петренко**. However, if you combine a polite word and a profession, both take the Vocative form: **пане професоре**. Mastering these nuances shows deep respect for cultural norms.
...
Порядкові числівники допомагають нам орієнтуватися в часі та просторі. Ми використовуємо їх, коли називаємо дати, поверхи в будинку або сторінки в книзі. Якщо ви хочете сказати про частину чогось, ви використовуєте дроби. Українці дуже часто вживають слова «половина» і «чверть» у повсякденному житті.
...
<Quiz client:only="react" questions={[{"question": "Шановний ____, ми раді вас вітати.", "options": [{"text": "Іван Петрович", "correct": false}, {"text": "Іване Петровичу", "correct": true}, {"text": "Івану Петровичу", "correct": false}, {"text": "Іване Петрович", "correct": false}]}, {"question": "Ми купили для офісу п'ять нових ____.", "options": [{"text": "столи", "correct": false}, {"text": "столів", "correct": true}, {"text": "стола", "correct": false}, {"text": "столом", "correct": false}]}, {"question": "У нашого директора є троє ____.", "options": [{"text": "діти", "correct": false}, {"text": "дітей", "correct": true}, {"text": "дитини", "correct": false}, {"text": "дітям", "correct": false}]}, {"question": "Я вчора не говорив про це ____.", "options": [{"text": "з ніким", "correct": false}, {"text": "ніким", "correct": false}, {"text": "ні з ким", "correct": true}, {"text": "ні з кими", "correct": false}]}, {"question": "Цей проект буде тривати півтора ____.", "options": [{"text": "місяці", "correct": false}, {"text": "місяців", "correct": false}, {"text": "місяця", "correct": true}, {"text": "місяць", "correct": false}]}, {"question": "Мій брат купив ____ нову красиву машину.", "options": [{"text": "собою", "correct": false}, {"text": "самому", "correct": false}, {"text": "себе", "correct": false}, {"text": "собі", "correct": true}]}]} instruction={"Оберіть правильний варіант для числівників та займенників."} />

## Комплексні завдання

Житловий ринок сучасної України переживає значні зміни, особливо у великих містах, як Київ та Львів. Історично склалося так, що квартири у цих містах мали великий попит. Протягом останніх років ця ситуація стала ще динамічнішою. Завдяки інвестиціям у міське будівництво, з'явилося багато сучасних житлових комплексів. Однак, через економічні коливання, вартість оренди значно зросла. Сьогодні бути власником квартири в центрі міста — це розкіш. Більшість людей віддають перевагу довгостроковій оренді, підписуючи контракти протягом року.
...
<Quiz client:only="react" questions={[{"question": "Чому житловий ринок сучасної України переживає серйозні трансформації?", "options": [{"text": "Завдяки великим європейським інвестиціям", "correct": false}, {"text": "Через війну та економічні зміни", "correct": true}, {"text": "Через нові закони про нерухомість", "correct": false}, {"text": "Завдяки туристичному буму в столиці", "correct": false}]}, {"question": "Чому багато молодих спеціалістів у Києві свідомо обирають стати орендарями?", "options": [{"text": "Вони взагалі не планують залишатися в Києві", "correct": false}, {"text": "У столиці зовсім немає нових гарних будинків", "correct": false}, {"text": "Бути власником квартири в центрі дуже дорого", "correct": true}, {"text": "Оренда зараз коштує понад дві тисячі доларів", "correct": false}]}, {"question": "Що саме приваблює багатьох людей переїхати до Львова?", "options": [{"text": "Відносна безпека та європейська атмосфера", "correct": true}, {"text": "Можливість зробити дуже дешевий ремонт", "correct": false}, {"text": "Неймовірно швидкий ритм сучасного життя", "correct": false}, {"text": "Великий вибір дешевих квартир у центрі", "correct": false}]}, {"question": "Чому попит на безпечне житло у Львові зріс неймовірно швидко?", "options": [{"text": "Завдяки великому студентському містечку", "correct": false}, {"text": "Через те що оренда стала дуже дешевою", "correct": false}, {"text": "Завдяки новим будівельним компаніям", "correct": false}, {"text": "Через велику кількість переміщених осіб", "correct": true}]}, {"question": "Що близько третини покупців розглядає як надійний спосіб збереження капіталу?", "options": [{"text": "Нові зошити для важливих записів", "correct": false}, {"text": "Сучасні квартири та нерухомість", "correct": true}, {"text": "Довгострокову оренду на один рік", "correct": false}, {"text": "Старі будинки без якісного ремонту", "correct": false}]}, {"question": "Скільки часу сучасні інвестори цілком готові чекати на здачу нового будинку?", "options": [{"text": "Один рік", "correct": false}, {"text": "Два роки", "correct": false}, {"text": "Півтора року", "correct": true}, {"text": "Півтора місяця", "correct": false}]}]} instruction={"Прочитайте текст про житловий ринок України та дайте відповіді на запитання."} />

<div class="dialogue">

<div class="dialogue-line"><span class="speaker">Професор:</span> Добрий день, шановні студенти! Пане Олександре, ви готові почати вашу презентацію про сучасну урбаністику? *(Good day, dear students! Mr. Oleksandr, are you ready to start your presentation on modern urban studies?)*</div>

<div class="dialogue-line"><span class="speaker">Олександр:</span> Так, пане професоре! Сьогодні я розповім про міський простір. Нам важливо зрозуміти, як інфраструктура впливає на людей. *(Yes, Professor! Today I will talk about urban space. It is important for us to understand how infrastructure affects people.)*</div>

<div class="dialogue-line"><span class="speaker">Професор:</span> Які дані ви використовували для дослідження? *(What data did you use for the research?)*</div>

<div class="dialogue-line"><span class="speaker">Олександр:</span> Двоє дослідників зібрали статистику щодо нових районів Києва. Завдяки їхній роботі, ми маємо точні цифри. *(Two researchers collected statistics regarding the new districts of Kyiv. Thanks to their work, we have exact numbers.)*</div>

<div class="dialogue-line"><span class="speaker">Професор:</span> Які головні проблеми ви виявили? *(What main problems did you discover?)*</div>

<div class="dialogue-line"><span class="speaker">Олександр:</span> Найбільша проблема — це постійні затори. Через високу кількість автомобілів, мешканцям важко дістатися до центру. *(The biggest problem is constant traffic jams. Due to the high number of cars, it is difficult for residents to reach the center.)*</div>
...
<FillIn client:only="react" items={[{"sentence": "Шановний ____! Я звертаюся до вас щодо оренди житла.", "answer": "пане Сидоренку", "options": ["пане Сидоренку", "пан Сидоренко", "пане Сидоренко"]}, {"sentence": "Я пишу вам, ____ шукаю нову комфортну квартиру.", "answer": "через те що", "options": ["через те що", "із-за того що", "завдяки тому що"]}, {"sentence": "Я планую орендувати вашу квартиру ____ одного року.", "answer": "протягом", "options": ["протягом", "за", "через"]}, {"sentence": "Це просторе житло ідеально підходить ____.", "answer": "для мене та моєї родини", "options": ["для мене та моєї родини", "мені та моїй родині", "по мене та мою родину"]}, {"sentence": "Мій максимальний бюджет на оренду становить п'ятнадцять ____ гривень.", "answer": "тисяч", "options": ["тисяч", "тисячі", "тисяча"]}, {"sentence": "Я дуже хочу жити недалеко від ____ станції метро.", "answer": "третьої", "options": ["третьої", "третя", "третій"]}]} instruction={"Складіть формальний електронний лист пану Сидоренку, обравши правильні граматичні форми."} />
...
<Quiz client:only="react" questions={[{"question": "Якщо ви хочете пити, ви скажете: 'Дайте мені склянку ____'.", "options": [{"text": "вода", "correct": false}, {"text": "водою", "correct": false}, {"text": "воду", "correct": false}, {"text": "води", "correct": true}]}, {"question": "Як правильно сказати, що вам бракує вільного часу?", "options": [{"text": "Я маю не час", "correct": false}, {"text": "У мене немає час", "correct": false}, {"text": "Мені немає часу", "correct": false}, {"text": "У мене немає часу", "correct": true}]}, {"question": "Виберіть правильне речення з прийменником причини:", "options": [{"text": "Він не прийшов із-за дощу", "correct": false}, {"text": "Він не прийшов через дощ", "correct": true}, {"text": "Він не прийшов завдяки дощу", "correct": false}, {"text": "Він не прийшов по дощ", "correct": false}]}, {"question": "Як правильно висловити вдячність українською мовою?", "options": [{"text": "Дякую вам", "correct": true}, {"text": "Дякую вас", "correct": false}, {"text": "Дякую для вас", "correct": false}, {"text": "Дякую до вас", "correct": false}]}, {"question": "Яку граматичну форму вимагає дієслово 'навчатися'?", "options": [{"text": "Знахідний відмінок", "correct": false}, {"text": "Давальний відмінок", "correct": false}, {"text": "Родовий відмінок", "correct": true}, {"text": "Орудний відмінок", "correct": false}]}, {"question": "Як правильно побудувати конструкцію з 'згідно'?", "options": [{"text": "Згідно закону", "correct": false}, {"text": "Відповідно із законом", "correct": false}, {"text": "Згідно до закону", "correct": false}, {"text": "Згідно із законом", "correct": true}]}]} instruction={"Діагностика: оберіть правильний варіант (відмінки, займенники, прийменники)."} />
...
<FillIn client:only="react" items={[{"sentence": "Студенти завжди бояться складного ____.", "answer": "іспиту", "options": ["іспиту", "іспит", "іспитом"]}, {"sentence": "Зараз мені дуже ____, тому я зачиню вікно.", "answer": "холодно", "options": ["холодно", "холодний", "холодом"]}, {"sentence": "Він мріє працювати ____ у великій компанії.", "answer": "архітектором", "options": ["архітектор", "архітектора", "архітектором"]}, {"sentence": "У мене сьогодні зовсім немає вільного ____.", "answer": "часу", "options": ["час", "часу", "часом"]}, {"sentence": "Ми хочемо випити склянку чистої ____.", "answer": "води", "options": ["вода", "воду", "води"]}, {"sentence": "Вона дуже цікавиться сучасним ____.", "answer": "мистецтвом", "options": ["мистецтво", "мистецтва", "мистецтвом"]}]} instruction={"Вставте правильну граматичну форму (семантичні ролі відмінків)."} />

<MatchUp client:only="react" pairs={[{"left": "рубрика", "right": "спеціальний розділ у тексті"}, {"left": "аналіз помилок", "right": "пошук і вивчення неправильних відповідей"}, {"left": "прогалина", "right": "відсутність знань з певної теми"}, {"left": "повторення", "right": "процес закріплення вивченого матеріалу"}, {"left": "самооцінка", "right": "перевірка власних результатів"}, {"left": "комплексний", "right": "той, що охоплює всі частини цілого"}, {"left": "діагностика", "right": "визначення рівня ваших знань"}]} instruction={"З'єднайте терміни з їхніми визначеннями."} />

<GroupSort client:only="react" groups={{"Позитивна причина (Давальний відмінок)": ["завдяки зусиллям", "завдяки лікарям", "завдяки інвестиціям"], "Негативна або нейтральна причина (Знахідний відмінок)": ["через дощ", "через негоду", "через затори"]}} instruction={"Розподіліть прийменники залежно від того, яку причину вони позначають."} />

<ErrorCorrection client:only="react" items={[{"sentence": "Він завжди сміється наді мною.", "errorWord": "наді мною", "correctForm": "з мене", "options": ["з мене", "про мене", "за мене"], "explanation": "В українській мові ми сміємося 'з когось'."}, {"sentence": "Я хочу щиро подякувати вас за допомогу.", "errorWord": "вас", "correctForm": "вам", "options": ["вам", "до вас", "для вас"], "explanation": "Дієслово 'дякувати' вимагає Давального відмінка."}, {"sentence": "Моя сестра зараз навчається музиці.", "errorWord": "музиці", "correctForm": "музики", "options": ["музики", "музику", "музикою"], "explanation": "Дієслово 'навчатися' вимагає Родового відмінка."}, {"sentence": "Ми не поїхали на море із-за поганої погоди.", "errorWord": "із-за", "correctForm": "через", "options": ["через", "завдяки", "для"], "explanation": "Для причини використовується прийменник 'через'."}, {"sentence": "Він швидко пішов у магазин за молоком.", "errorWord": "за молоком", "correctForm": "по молоко", "options": ["по молоко", "на молоко", "до молока"], "explanation": "Мета руху (принести щось) позначається прийменником 'по' + Знахідний відмінок."}, {"sentence": "Вони працюють повністю згідно нових правил.", "errorWord": "згідно нових правил", "correctForm": "згідно з новими правилами", "options": ["згідно з новими правилами", "відповідно з новими правилами", "згідно до нових правил"], "explanation": "Правильна конструкція: 'згідно з' + Орудний відмінок."}]} instruction={"Знайдіть і виправте лексичні та граматичні помилки (росіянізми)."} />

<Unjumble client:only="react" items={[{"words": "з / мене. / Не / треба / сміятися", "answer": "Не треба сміятися з мене."}, {"words": "завдяки / команди. / ми / перемогли / зусиллям / Сьогодні", "answer": "Сьогодні ми перемогли завдяки зусиллям команди."}, {"words": "У / мене / часу. / немає / сьогодні / вільного", "answer": "У мене сьогодні немає вільного часу."}, {"words": "пішла / магазин / Вона / хліб. / у / по", "answer": "Вона пішла у магазин по хліб."}, {"words": "дуже / мені / холодно. / сьогодні / Зранку", "answer": "Зранку мені сьогодні дуже холодно."}, {"words": "законом. / із / працюємо / Ми / згідно / завжди", "answer": "Ми завжди працюємо згідно із законом."}]} instruction={"Складіть правильні речення зі слів."} />
