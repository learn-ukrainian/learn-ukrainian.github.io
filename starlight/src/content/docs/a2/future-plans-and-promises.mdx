...
sidebar:
  order: 16
  label: "16. Future Plans and Promises"
pipeline: v3
build_status: draft
draft: true
---
...
| --- | --- | --- | --- | --- | --- |
| обіцянка |  | promise | noun | ж |  |
| слово |  | word | noun | с |  |
| буду |  | I will be | verb |  |  |
| зроблю |  | I will do, I will make | verb |  | Simple future form of зробити |
| напишу |  | I will write | verb |  | Simple future form of написати |
| скажу |  | I will say, I will tell | verb |  | Simple future form of сказати |
| піду |  | I will go | verb |  | Simple future form of піти |
| прочитаю |  | I will read (to the end) | verb |  | Simple future form of прочитати |
| побачу |  | I will see | verb |  | Simple future form of побачити |
| почую |  | I will hear | verb |  | Simple future form of почути |
| візьму |  | I will take | verb |  | Simple future form of взяти |
| дам |  | I will give | verb |  | Simple future form of дати |
| вид |  | aspect (grammar) | noun | ч |  |
