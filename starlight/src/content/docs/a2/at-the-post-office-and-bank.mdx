...
sidebar:
  order: 12
  label: "12. At the Post Office and Bank"
pipeline: v3
build_status: draft
draft: true
---
...
| банк |  | bank | noun | ч |  |
| лист |  | letter | noun | ч |  |
| посилка |  | package | noun | ж |  |
| бандероль |  | parcel | noun | ж |  |
| марка |  | stamp | noun | ж |  |
...
| гроші |  | money | noun |  |  |
| рахунок |  | account / bill | noun | ч |  |
| картка |  | card | noun | ж |  |
| готівка |  | cash | noun | ж |  |
| валюта |  | currency | noun | ж |  |
| переказ |  | transfer | noun | ч |  |
| знімати |  | to withdraw | verb |  |  |
| вкладати |  | to deposit | verb |  |  |
...
<GroupSort client:load groups={JSON.parse(`{"Пошта": ["посилка", "бандероль", "марка", "конверт", "індекс"], "Банк": ["рахунок", "валюта", "готівка", "переказ", "картка"]}`)} />
