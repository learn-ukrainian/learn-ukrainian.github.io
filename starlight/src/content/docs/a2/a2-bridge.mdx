...
|-------|----------|-------------|-----|
| **вид** | aspect (grammatical category of verbs — forward reference, taught fully in M02) | ім. | ч. |
| **доко́наний** | perfective (verb aspect — forward reference) | прикм. |  |
| **недоко́наний** | imperfective (verb aspect — forward reference) | прикм. |  |
