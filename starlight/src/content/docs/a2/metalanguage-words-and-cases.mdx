...
<div class="dialogue-line"><span class="speaker">Студент:</span> Скажіть, будь ласка, слово «мій» — це яка частина мови? *(Tell me please, the word "my" — what part of speech is it?)*</div>

<div class="dialogue-line"><span class="speaker">Вчитель:</span> Слово «мій» — це **займенник** *(pronoun)*.</div>

<div class="dialogue-line"><span class="speaker">Студент:</span> Чому воно так називається? *(Why is it called that?)*</div>

<div class="dialogue-line"><span class="speaker">Вчитель:</span> Тому що воно стоїть замість імені. *(Because it stands instead of a name.)* Воно не називає предмет. Воно тільки вказує на нього. *(It only points to it.)*</div>

<div class="dialogue-line"><span class="speaker">Студент:</span> А слово «швидко»? *(And the word "quickly"?)*</div>

<div class="dialogue-line"><span class="speaker">Вчитель:</span> Це **прислівник** *(adverb)*. Воно показує, як саме ми робимо дію. *(It shows exactly how we do an action.)*</div>
...
<MatchUp client:only="react" pairs={[{"left": "істота", "right": "animate noun"}, {"left": "неістота", "right": "inanimate noun"}, {"left": "збігатися", "right": "to coincide"}, {"left": "об'єкт дії", "right": "object of an action"}, {"left": "відмінок", "right": "grammatical case"}, {"left": "відмінювання", "right": "declension"}, {"left": "однина", "right": "singular"}, {"left": "множина", "right": "plural"}]} instruction={"З'єднайте українські терміни з їхніми англійськими значеннями"} />
...
<div class="dialogue-line"><span class="speaker">Марко:</span> Наступне речення: «Я бачу кота». *(Next sentence: "I see a cat".)*</div>

<div class="dialogue-line"><span class="speaker">Анна:</span> Добре, шукаємо іменник. Це слово «кота». *(Good, we look for the noun. It is the word "cat".)*</div>

<div class="dialogue-line"><span class="speaker">Марко:</span> Який це відмінок? *(Which case is this?)*</div>

<div class="dialogue-line"><span class="speaker">Анна:</span> Треба поставити питання від дієслова. Бачу кого? — Кота. *(We need to ask a question from the verb. See whom? — A cat.)*</div>

<div class="dialogue-line"><span class="speaker">Марко:</span> Питання «кого?» має **Знахідний відмінок** *(Accusative case)*. *(The question "whom?" has the Accusative case.)*</div>

<div class="dialogue-line"><span class="speaker">Анна:</span> Правильно! А слово «я» — це **Називний відмінок** *(Nominative case)*. *(Correct! And the word "I" is the Nominative case.)*</div>

<div class="dialogue-line"><span class="speaker">Марко:</span> Так, бо це головний герой. Хто? — Я. *(Yes, because it is the main character. Who? — I.)*</div>
...
<MatchUp client:only="react" pairs={[{"left": "іменник", "right": "noun"}, {"left": "прикметник", "right": "adjective"}, {"left": "дієслово", "right": "verb"}, {"left": "займенник", "right": "pronoun"}, {"left": "прислівник", "right": "adverb"}, {"left": "прийменник", "right": "preposition"}, {"left": "сполучник", "right": "conjunction"}, {"left": "числівник", "right": "numeral"}]} instruction={"З'єднайте українські терміни з їхніми англійськими відповідниками"} />

<GroupSort client:only="react" groups={{"Іменник (noun)": ["стіл", "мама", "радість", "місто", "лікар"], "Прикметник (adjective)": ["великий", "гарна", "синє", "теплі"], "Дієслово (verb)": ["читати", "писати", "бігати", "знати", "бачити"], "Займенник (pronoun)": ["я", "ти", "ми", "цей", "хтось"], "Прислівник (adverb)": ["швидко", "тут", "завтра", "добре", "завжди"]}} instruction={"Розподіліть слова за частинами мови"} />

<FillIn client:only="react" items={[{"sentence": "1. Називний — ___? ___?", "answer": "хто, що", "options": ["хто, що", "кого, чого", "кому, чому"]}, {"sentence": "2. ___ — кого? чого?", "answer": "Родовий", "options": ["Родовий", "Давальний", "Місцевий"]}, {"sentence": "3. Давальний — ___? ___?", "answer": "кому, чому", "options": ["кому, чому", "кого, що", "ким, чим"]}, {"sentence": "4. Знахідний — ___? ___?", "answer": "кого, що", "options": ["кого, що", "кого, чого", "кому, чому"]}, {"sentence": "5. ___ — ким? чим?", "answer": "Орудний", "options": ["Орудний", "Місцевий", "Кличний"]}, {"sentence": "6. Місцевий — на ___? на ___?", "answer": "кому, чому", "options": ["кому, чому", "ким, чим", "кого, що"]}]} instruction={"Доповніть назву відмінка та його питання"} />

<Quiz client:only="react" questions={[{"question": "Я бачу великого **кота**.", "options": [{"text": "іменник, Знахідний відмінок", "correct": true}, {"text": "іменник, Називний відмінок", "correct": false}, {"text": "прикметник, Знахідний відмінок", "correct": false}, {"text": "займенник, Родовий відмінок", "correct": false}]}, {"question": "**Вона** читає цікаву книгу.", "options": [{"text": "займенник, Називний відмінок", "correct": true}, {"text": "іменник, Називний відмінок", "correct": false}, {"text": "займенник, Знахідний відмінок", "correct": false}, {"text": "прикметник, Родовий відмінок", "correct": false}]}, {"question": "Студент дав зошит **вчителю**.", "options": [{"text": "іменник, Давальний відмінок", "correct": true}, {"text": "іменник, Місцевий відмінок", "correct": false}, {"text": "дієслово, Давальний відмінок", "correct": false}, {"text": "іменник, Родовий відмінок", "correct": false}]}, {"question": "На **столі** лежить книга.", "options": [{"text": "іменник, Місцевий відмінок", "correct": true}, {"text": "іменник, Орудний відмінок", "correct": false}, {"text": "прикметник, Місцевий відмінок", "correct": false}, {"text": "іменник, Давальний відмінок", "correct": false}]}, {"question": "Брат пише **ручкою**.", "options": [{"text": "іменник, Орудний відмінок", "correct": true}, {"text": "іменник, Знахідний відмінок", "correct": false}, {"text": "прислівник, Орудний відмінок", "correct": false}, {"text": "іменник, Давальний відмінок", "correct": false}]}, {"question": "Це будинок моєї **мами**.", "options": [{"text": "іменник, Родовий відмінок", "correct": true}, {"text": "іменник, Давальний відмінок", "correct": false}, {"text": "прикметник, Родовий відмінок", "correct": false}, {"text": "іменник, Знахідний відмінок", "correct": false}]}, {"question": "Я люблю **тепле** молоко.", "options": [{"text": "прикметник, Знахідний відмінок", "correct": true}, {"text": "прикметник, Називний відмінок", "correct": false}, {"text": "іменник, Знахідний відмінок", "correct": false}, {"text": "прислівник, Називний відмінок", "correct": false}]}, {"question": "**Хтось** стукає у двері.", "options": [{"text": "займенник, Називний відмінок", "correct": true}, {"text": "іменник, Називний відмінок", "correct": false}, {"text": "займенник, Родовий відмінок", "correct": false}, {"text": "числівник, Називний відмінок", "correct": false}]}]} instruction={"Визначте частину мови та відмінок виділеного слова"} />

<ErrorCorrection client:only="react" items={[{"sentence": "Мій мама працює лікарем.", "errorWord": "Мій", "correctForm": "Моя", "options": ["Моя", "Моє", "Мої"], "explanation": "Мама — це іменник жіночого роду, тому потрібен займенник «моя»."}, {"sentence": "Це велика стіл.", "errorWord": "велика", "correctForm": "великий", "options": ["великий", "велике", "великі"], "explanation": "Стіл — це іменник чоловічого роду, тому прикметник має бути «великий»."}, {"sentence": "Яке гарний місто!", "errorWord": "гарний", "correctForm": "гарне", "options": ["гарне", "гарна", "гарні"], "explanation": "Місто — це іменник середнього роду, тому потрібен прикметник «гарне»."}, {"sentence": "Він прочитав цікавий книгу.", "errorWord": "цікавий", "correctForm": "цікаву", "options": ["цікаву", "цікаве", "цікаві"], "explanation": "Книга — жіночий рід, Знахідний відмінок має закінчення -у."}, {"sentence": "Це теплий вікно.", "errorWord": "теплий", "correctForm": "тепле", "options": ["тепле", "тепла", "теплі"], "explanation": "Вікно — середній рід, закінчення прикметника -е."}, {"sentence": "Моя брат живе в Києві.", "errorWord": "Моя", "correctForm": "Мій", "options": ["Мій", "Моє", "Мої"], "explanation": "Брат — чоловічий рід, тому займенник має бути «мій»."}]} instruction={"Знайдіть і виправте помилку в узгодженні роду"} />

<Quiz client:only="react" questions={[{"question": "До якого роду належить слово «родина»?", "options": [{"text": "жіночий рід", "correct": true}, {"text": "чоловічий рід", "correct": false}, {"text": "середній рід", "correct": false}, {"text": "це множина, рід не визначається", "correct": false}]}, {"question": "До якого роду належить слово «дім»?", "options": [{"text": "чоловічий рід", "correct": true}, {"text": "жіночий рід", "correct": false}, {"text": "середній рід", "correct": false}, {"text": "це множина", "correct": false}]}, {"question": "До якого роду належить слово «море»?", "options": [{"text": "середній рід", "correct": true}, {"text": "чоловічий рід", "correct": false}, {"text": "жіночий рід", "correct": false}, {"text": "це дієслово", "correct": false}]}, {"question": "До якого роду належить слово «парк»?", "options": [{"text": "чоловічий рід", "correct": true}, {"text": "жіночий рід", "correct": false}, {"text": "середній рід", "correct": false}, {"text": "це прикметник", "correct": false}]}, {"question": "До якого роду належить слово «сестра»?", "options": [{"text": "жіночий рід", "correct": true}, {"text": "чоловічий рід", "correct": false}, {"text": "середній рід", "correct": false}, {"text": "це множина", "correct": false}]}, {"question": "До якого роду належить слово «сонце»?", "options": [{"text": "середній рід", "correct": true}, {"text": "жіночий рід", "correct": false}, {"text": "чоловічий рід", "correct": false}, {"text": "це множина", "correct": false}]}]} instruction={"Визначте рід іменника за його закінченням"} />

<TrueFalse client:only="react" items={[{"statement": "Слово «іменник» походить від слова «ім'я».", "isTrue": true, "explanation": "Так, іменник називає предмет і має «ім'я»."}, {"statement": "Іменники відповідають на питання «який? яка? яке?».", "isTrue": false, "explanation": "Іменники відповідають на питання «хто? що?». На питання «який?» відповідає прикметник."}, {"statement": "Дієслово показує дію предмета.", "isTrue": true, "explanation": "Дієслова — це «мотор» речення, вони відповідають на питання «що робити?»."}, {"statement": "В українській мові є шість відмінків.", "isTrue": false, "explanation": "В українській мові є сім відмінків (Називний, Родовий, Давальний, Знахідний, Орудний, Місцевий, Кличний)."}, {"statement": "Слово «стяг» — це дієслово.", "isTrue": false, "explanation": "Слово «стяг» відповідає на питання «що?», це іменник (прапор)."}, {"statement": "Форма знахідного відмінка для істот завжди збігається з формою родового відмінка.", "isTrue": true, "explanation": "Так, це правило з українського підручника. Бачу (кого?) друга — немає (кого?) друга."}, {"statement": "Прикметник завжди має такий самий рід, число і відмінок, як і його іменник.", "isTrue": true, "explanation": "Прикметник «приклеюється» до іменника і повторює всі його форми."}, {"statement": "Кличний відмінок відповідає на питання «кого? що?».", "isTrue": false, "explanation": "Кличний відмінок не має питань, це форма для звертання."}]} instruction={"Правда чи ні? Виберіть правильну відповідь за текстом."} />

<Translate client:only="react" questions={[{"source": "Noun", "options": [{"text": "іменник", "correct": true}, {"text": "дієслово", "correct": false}, {"text": "прикметник", "correct": false}, {"text": "прислівник", "correct": false}]}, {"source": "Verb", "options": [{"text": "дієслово", "correct": true}, {"text": "займенник", "correct": false}, {"text": "числівник", "correct": false}, {"text": "іменник", "correct": false}]}, {"source": "Adjective", "options": [{"text": "прикметник", "correct": true}, {"text": "прийменник", "correct": false}, {"text": "дієслово", "correct": false}, {"text": "прислівник", "correct": false}]}, {"source": "Pronoun", "options": [{"text": "займенник", "correct": true}, {"text": "іменник", "correct": false}, {"text": "сполучник", "correct": false}, {"text": "числівник", "correct": false}]}, {"source": "Adverb", "options": [{"text": "прислівник", "correct": true}, {"text": "прикметник", "correct": false}, {"text": "прийменник", "correct": false}, {"text": "дієслово", "correct": false}]}, {"source": "Preposition", "options": [{"text": "прийменник", "correct": true}, {"text": "прислівник", "correct": false}, {"text": "займенник", "correct": false}, {"text": "сполучник", "correct": false}]}, {"source": "Plural", "options": [{"text": "множина", "correct": true}, {"text": "однина", "correct": false}, {"text": "відмінок", "correct": false}, {"text": "рід", "correct": false}]}, {"source": "Gender", "options": [{"text": "рід", "correct": true}, {"text": "відмінок", "correct": false}, {"text": "число", "correct": false}, {"text": "особа", "correct": false}]}]} instruction={"Оберіть правильний український переклад для граматичного терміна"} />

<Unjumble client:only="react" items={[{"words": "називає / Іменник / предмет.", "answer": "Іменник називає предмет."}, {"words": "відповідає / на / Дієслово / питання / робити? / що", "answer": "Дієслово відповідає на питання що робити?"}, {"words": "показує / Прикметник / ознаку / предмета.", "answer": "Прикметник показує ознаку предмета."}, {"words": "мова / сім / має / Українська / відмінків.", "answer": "Українська мова має сім відмінків."}, {"words": "закінчення. / змінюють / свої / Слова / у / реченні", "answer": "Слова у реченні змінюють свої закінчення."}, {"words": "це / для / форма / Кличний / відмінок / — / звертання.", "answer": "Кличний відмінок — це форма для звертання."}]} instruction={"Складіть правильне речення зі слів"} />
