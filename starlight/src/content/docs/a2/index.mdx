...
description: "Pre-Intermediate beta preview — 19 of 69 modules available"
template: splash
---
...
<LevelLanding
  ...
  subtitle="Pre-Intermediate beta preview — 19/69 modules available"
  moduleCount={69}
  wordTarget={2000}
  color="#1565C0"
  progressTitle="A2 Beta Preview"
  progressDescription="19 preview modules available; 50 modules remain locked while content quality review continues."
  modules={[
    {
