...
description: "Pre-Intermediate beta preview — 26 of 69 modules available"
template: splash
---
...
<LevelLanding
  ...
  subtitle="Pre-Intermediate beta preview — 26/69 modules available"
  moduleCount={69}
  wordTarget={2000}
  color="var(--lu-id-a2)"
  progressTitle="A2 Beta Preview"
  progressDescription="26 preview modules available; 43 modules remain locked while content quality review continues."
  modules={[
    {
