...
description: "Pre-Intermediate beta preview — 3 of 69 modules available"
template: splash
---
...
<LevelLanding
  ...
  subtitle="Pre-Intermediate beta preview — 3/69 modules available"
  moduleCount={69}
  wordTarget={2000}
  color="#1565C0"
  progressTitle="A2 Beta Preview"
  progressDescription="3 preview modules available; 66 modules remain locked while content quality review continues."
  modules={[
    {
