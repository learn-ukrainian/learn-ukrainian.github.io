...
description: "Pre-Intermediate beta preview — 8 of 69 modules available"
template: splash
---
...
<LevelLanding
  ...
  subtitle="Pre-Intermediate beta preview — 8/69 modules available"
  moduleCount={69}
  wordTarget={2000}
  color="#1565C0"
  progressTitle="A2 Beta Preview"
  progressDescription="8 preview modules available; 61 modules remain locked while content quality review continues."
  modules={[
    {
