...
| --- | --- | --- | --- | --- | --- |
| зробив |  | did / made (masculine) | verb |  |  |
| сказав |  | said / told (masculine) | verb |  |  |
| написав |  | wrote (masculine) | verb |  |  |
| прочитав |  | read completely (masculine) | verb |  |  |
| пішов |  | went / set off (masculine) | verb |  |  |
| прийшов |  | arrived / came (masculine) | verb |  |  |
| зрозумів |  | understood / realized (masculine) | verb |  |  |
| забув |  | forgot (masculine) | verb |  |  |
| знайшов |  | found (masculine) | verb |  |  |
| доконаний |  | perfective | adjective |  |  |
| недоконаний |  | imperfective | adjective |  |  |
| вид |  | aspect (grammar) | noun | masculine |  |
...
<GroupSort client:load groups={JSON.parse(`{"Чоловічий рід (-в)": ["зробив", "сказав", "написав", "пішов", "знайшов"], "Жіночий рід (-ла)": ["зробила", "сказала", "написала", "пішла", "знайшла"], "Середній рід (-ло)": ["спрацювало", "зникло", "пройшло", "зійшло", "сталося"], "Множина (-ли)": ["зробили", "сказали", "написали", "пішли", "знайшли"]}`)} />

### Знайдіть пару: Процес і результат

<MatchUp client:load pairs={JSON.parse(`[{"left": "робити", "right": "зробити"}, {"left": "писати", "right": "написати"}, {"left": "читати", "right": "прочитати"}, {"left": "йти", "right": "піти"}, {"left": "розуміти", "right": "зрозуміти"}, {"left": "шукати", "right": "знайти"}, {"left": "казати", "right": "сказати"}, {"left": "бачити", "right": "побачити"}]`)} />
