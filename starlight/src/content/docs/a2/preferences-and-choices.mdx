...
sidebar:
  order: 24
  label: "24. Preferences and Choices"
pipeline: v3
build_status: draft
draft: true
---
...
1. **Experiencer (Dative)**: **Мені** (To me)
2. **Verb**: **подобається** (is pleasing)
3. **Subject (Nominative)**: **книжка** (the book)
...
:::warning[⚠️ **Double Check Your Endings**]
...
Крок 1: Підхід з дієсловом **любити** (Підмет у Nominative, додаток у Accusative).
"Я люблю нову пісню."
Тут "Я" — це активний підмет. "нову пісню" — це прямий додаток (жіноче закінчення -а змінюється на -ю). Це виражає сильну, усталену прихильність.
...
Крок 3: Підхід з дієсловом **подобатися** (Експерієнцер у Dative, підмет у називному).
По-перше, змініть експерієнцер "I" на Dative "to me": **Мені**.
По-друге, змініть дієслово, щоб воно узгоджувалося з новим підметом (піснею): **подобається**.
По-третє, поверніть об'єкт у Nominative. Тепер це підмет, який викликає відчуття.

"Мені подобається нова пісня."

Давайте спробуємо ще одне. "He loves this city."
Крок 1: "Він любить це місто." (Називний: Він. Знахідний: це місто - іменники середнього роду не змінюють форму).
Крок 2: Трансформуємо на "This city is pleasing to him."
Крок 3: Давальний відмінок "to him" — це **Йому**. Дієслово — **подобається**. Підмет у Nominative залишається **це місто**.
"Йому подобається це місто."
...
У вас є сильна перевага щодо кави в цей час дня. Ви хочете чітко заявити про це вподобання. Ви можете використати просте дієслово **вибирати**.
"Я вибираю каву." (I choose coffee.)

Але давайте зробимо це більш природним, пояснивши ваше вподобання. Ви хочете сказати офіціанту, що кава вам зараз більше подобається. Ви повинні використати логіку Dative.
"Мені більше подобається кава." (Coffee is more pleasing to me. / I like coffee more.)
...
Ви дивитесь на чорне пальто. Воно гарне, але не зовсім у вашому стилі. Вам потрібно висловити м'яке негативне ставлення. Пам'ятайте, Pronoun у Dative залишається тим самим; ми просто додаємо заперечення до дієслова.
"Мені не дуже подобається це чорне пальто." (This black coat is not very pleasing to me. / I don't really like this black coat.)

Потім продавець показує сіру куртку. Вона одразу привертає вашу увагу. Ваша естетична реакція позитивна.
"А ця сіра куртка мені дуже подобається." (And this grey jacket is very pleasing to me. / I really like this grey jacket.)
...
Давайте порівняємо їхнє розташування. "The center is better than the suburbs."
"Центр — це краще ніж передмістя." (Використовуємо **краще** як загальний порівняльний прислівник для ситуації).

Давайте порівняємо їхні розміри, використовуючи **більш** та **менш**. Прикметник для "big" — **великий**. Прикметник для "small" — **малий**.
"Квартира Б більш велика." (Apartment B is more large/bigger.)
"Квартира А менш велика." (Apartment A is less large.)
...
**1. The Dative Shift:** Translate the underlying logic of the sentence "I like this music" into the structural English required for Ukrainian translation. (What is the "To me is pleasing..." equivalent?)
**2. Identifying the Error:** Look at the sentence "Він подобається ця кава." Explain exactly why it is grammatically incorrect and provide the correct version.
**3. Choosing the Verb:** You are at an art gallery and see a painting for the first time that strikes you as beautiful. Which verb do you use to express your feeling: *любити* or *подобатися*? Why?
**4. Formal Preference:** You are in a job interview and want to state that you generally prefer working in a team rather than alone. Which phrase should you use instead of the spontaneous *подобатися*?
**5. Comparative Mechanics:** Create a sentence comparing two nouns (e.g., tea and juice) using the structure that means "better than."
**6. Cultural Grace:** Your friend thinks a new building is beautiful, but you think it is ugly. You don't want to argue. What Ukrainian proverb can you use to politely acknowledge that people have different aesthetic judgments?
...
| краще |  | better | adverb |  |  |
| хотів би |  | would like | verb |  |  |
| перевага |  | preference, advantage | noun | ж |  |
| філіжанка |  | small cup, demitasse | noun | ж |  |
| смак |  | taste | noun | ч |  |
| колір |  | color | noun | ч |  |
| товариш |  | friend, comrade | noun | ч |  |
| замовити |  | to order | verb |  |  |
| десерт |  | dessert | noun | ч |  |
| кава |  | coffee | noun | ж |  |
| чай |  | tea | noun | ч |  |
| ніж |  | than | conjunction |  |  |
| більш |  | more | adverb |  |  |
| менш |  | less | adverb |  |  |
| чорний |  | black | adjective |  |  |
| сірий |  | grey | adjective |  |  |
| пальто |  | coat | noun | с |  |
| куртка |  | jacket | noun | ж |  |
| книжка |  | book | noun | ж |  |
| місто |  | city | noun | с |  |
| пісня |  | song | noun | ж |  |
| любити |  | to love, to like deeply | verb |  |  |
| віддавати |  | to give, to yield | verb |  |  |
...
<MatchUp client:load pairs={JSON.parse(`[{"left": "філіжанка", "right": "a small cup (traditional in Lviv)"}, {"left": "вибирати", "right": "to choose"}, {"left": "замовити", "right": "to order"}, {"left": "краще", "right": "better"}, {"left": "смак", "right": "taste"}, {"left": "колір", "right": "color"}, {"left": "перевага", "right": "preference or advantage"}, {"left": "віддавати перевагу", "right": "to give preference (formal)"}, {"left": "кава на піску", "right": "coffee brewed in sand"}, {"left": "я хотів би", "right": "I would like (male speaker)"}, {"left": "я хотіла би", "right": "I would like (female speaker)"}, {"left": "подобатися", "right": "to be pleasing to"}]`)} />

### Граматика: Подобатися чи любити?

<Quiz client:load questions={JSON.parse(`[{"question": "Який відмінок потрібен для особи, яка відчуває вподобання з дієсловом подобатися?", "options": [{"text": "Називний (я, ти, він)", "correct": false}, {"text": "Знахідний (мене, тебе, його)", "correct": false}, {"text": "Давальний (мені, тобі, йому)", "correct": true}, {"text": "Місцевий (на мені, на тобі)", "correct": false}], "explanation": "Дієслово подобатися вимагає давального відмінка для особи експерієнсера."}, {"question": "Який відмінок потрібен для предмета, який подобається?", "options": [{"text": "Знахідний відмінок", "correct": false}, {"text": "Називний відмінок", "correct": true}, {"text": "Родовий відмінок", "correct": false}, {"text": "Орудний відмінок", "correct": false}], "explanation": "Предмет, який подобається, є підметом, тому він стоїть у називному відмінку."}, {"question": "Як правильно сказати I like this book українською мовою?", "options": [{"text": "Я подобаюся цю книжку.", "correct": false}, {"text": "Я люблю ця книжка.", "correct": false}, {"text": "Мені подобається цю книжку.", "correct": false}, {"text": "Мені подобається ця книжка.", "correct": true}], "explanation": "Особа (мені) в давальному, предмет (ця книжка) в називному."}, {"question": "Яке дієслово краще використовувати для глибокої, тривалої прихильності?", "options": [{"text": "подобатися", "correct": false}, {"text": "любити", "correct": true}, {"text": "вибирати", "correct": false}, {"text": "хотіти", "correct": false}], "explanation": "Дієслово любити описує глибоку, стабільну любов."}, {"question": "Як правильно перекласти фразу I would like to order coffee (male)?", "options": [{"text": "Я хочу замовляю каву.", "correct": false}, {"text": "Я хотіла би замовити каву.", "correct": false}, {"text": "Я хотів би замовити каву.", "correct": true}, {"text": "Мені хотіти замовити каву.", "correct": false}], "explanation": "Чоловік каже я хотів би."}, {"question": "Що означає формальне словосполучення віддавати перевагу?", "options": [{"text": "Робити спонтанний вибір дуже швидко.", "correct": false}, {"text": "Робити свідомий, обдуманий вибір.", "correct": true}, {"text": "Не любити щось дуже сильно.", "correct": false}, {"text": "Замовляти каву у відомому кафе.", "correct": false}], "explanation": "Віддавати перевагу означає робити свідомий, обдуманий вибір."}, {"question": "Яке слово використовується як міст для порівняння двох предметів?", "options": [{"text": "або", "correct": false}, {"text": "ніж", "correct": true}, {"text": "як", "correct": false}, {"text": "чи", "correct": false}], "explanation": "Слово ніж використовується для порівняння (краще ніж)."}, {"question": "Як українською мовою буде приказка To each their own?", "options": [{"text": "На колір і смак товариш не всяк.", "correct": true}, {"text": "Кава краща ніж чай завжди.", "correct": false}, {"text": "Кожен любить своє місто найбільше.", "correct": false}, {"text": "Мені подобається все нове і цікаве.", "correct": false}], "explanation": "Приказка звучить На колір і смак товариш не всяк."}]`)} />

### Вставте пропущене слово: Вподобання

<FillIn client:load items={JSON.parse(`[{"sentence": "Я хотів _____ замовити філіжанку кави.", "answer": "би", "options": ["би", "б", "був", "бути"]}, {"sentence": "_____ подобається ця нова пісня.", "answer": "Мені", "options": ["Я", "Мені", "Мене", "Мною"]}, {"sentence": "Чи _____ подобається Львівська кава?", "answer": "тобі", "options": ["ти", "тебе", "тобі", "тобою"]}, {"sentence": "Ця книжка _____ ніж той старий журнал.", "answer": "краща", "options": ["краще", "кращий", "краща", "кращі"]}, {"sentence": "Мені подобається чай більше _____ кава.", "answer": "ніж", "options": ["ніж", "як", "що", "або"]}, {"sentence": "Він віддає _____ класичній музиці.", "answer": "перевагу", "options": ["вибір", "перевагу", "смак", "колір"]}, {"sentence": "Я глибоко _____ свою сім'ю.", "answer": "люблю", "options": ["подобаюся", "люблю", "вибираю", "хочу"]}, {"sentence": "Йому не дуже _____ це чорне пальто.", "answer": "подобається", "options": ["любить", "подобається", "хоче", "вибирає"]}, {"sentence": "На колір і _____ товариш не всяк.", "answer": "смак", "options": ["запах", "вибір", "смак", "звук"]}, {"sentence": "Квартира в центрі _____ велика, ніж у передмісті.", "answer": "менш", "options": ["краще", "більш", "менш", "дуже"]}, {"sentence": "Я _____ би вибрати десерт, будь ласка.", "answer": "хотіла", "options": ["хотів", "хотіла", "хочу", "хотіти"]}, {"sentence": "Нам _____ подобається це тихе місто.", "answer": "дуже", "options": ["багато", "дуже", "краще", "більш"]}]`)} />

### Сортування: Подобається чи Любить?

<GroupSort client:load groups={JSON.parse(`{"З дієсловом ПОДОБАЄТЬСЯ (Давальний)": ["мені", "тобі", "йому", "їй", "нам", "вам", "їм", "студентові"], "З дієсловом ЛЮБИТЬ або ЛЮБЛЮ (Називний)": ["я", "ти", "він", "вона", "ми", "ви", "вони", "студент"]}`)} />

### Складіть речення: Вибір та порівняння

<Unjumble client:load items={JSON.parse(`[{"jumbled": "мені / дуже / ця / подобається / пісня", "answer": "Мені дуже подобається ця пісня."}, {"jumbled": "я / хотів / замовити / би / борщ", "answer": "Я хотів би замовити борщ."}, {"jumbled": "кава / краща / чай / ніж", "answer": "Кава краща ніж чай."}, {"jumbled": "йому / подобається / не / чорне / пальто / це", "answer": "Йому не подобається це чорне пальто."}, {"jumbled": "ми / віддаємо / традиціям / перевагу", "answer": "Ми віддаємо перевагу традиціям."}, {"jumbled": "на / і / смак / колір / не / товариш / всяк", "answer": "На колір і смак товариш не всяк."}, {"jumbled": "яку / вибираєте / каву / ви", "answer": "Яку каву ви вибираєте?"}, {"jumbled": "ця / менш / книжка / цікава", "answer": "Ця книжка менш цікава."}]`)} />

### Виправте помилки: Називний перевантаження

<ErrorCorrection client:load>
  <ErrorCorrectionItem sentence="Я подобається ця львівська кава." errorWord="Я" correctForm="Мені" options={JSON.parse(`["Мені", "Мене", "Мною", "Моя"]`)} explanation="Дієслово подобатися вимагає давального відмінка для особи експерієнсера." />
  <ErrorCorrectionItem sentence="Він подобається читати книжки ввечері." errorWord="Він" correctForm="Йому" options={JSON.parse(`["Його", "Йому", "Ним", "Він"]`)} explanation="Потрібен давальний відмінок для особи: йому." />
  <ErrorCorrectionItem sentence="Мені подобається цю нову куртку." errorWord="цю нову куртку" correctForm="ця нова куртка" options={JSON.parse(`["ця нова куртка", "цієї нової куртки", "цій новій куртці", "цією новою курткою"]`)} explanation="Предмет, який подобається, є підметом і має стояти в називному відмінку." />
  <ErrorCorrectionItem sentence="Вона віддає перевага зеленому чаю." errorWord="перевага" correctForm="перевагу" options={JSON.parse(`["переваги", "перевазі", "перевагу", "перевагою"]`)} explanation="Вираз віддавати перевагу вимагає знахідного відмінка для слова перевага." />
  <ErrorCorrectionItem sentence="Київ більший як Львів." errorWord="як" correctForm="ніж" options={JSON.parse(`["ніж", "що", "чи", "або"]`)} explanation="Для прямого порівняння використовується слово ніж." />
  <ErrorCorrectionItem sentence="Я хочу би замовити десерт." errorWord="хочу" correctForm="хотів" options={JSON.parse(`["хотів", "хотіти", "хоч", "хотіли"]`)} explanation="Правильна форма для ввічливого прохання — я хотів би (для чоловіка) або я хотіла би (для жінки)." />
  <ErrorCorrectionItem sentence="Ми подобаємося цей старий фільм." errorWord="Ми подобаємося" correctForm="Нам подобається" options={JSON.parse(`["Нам подобається", "Ми любимо", "Нас подобається", "Ми подобається"]`)} explanation="Особа має бути в давальному відмінку (нам), а дієслово узгоджується з підметом (фільм - подобається)." />
  <ErrorCorrectionItem sentence="Ця пісня більш краща." errorWord="більш краща" correctForm="краща" options={JSON.parse(`["краща", "більш хороша", "найбільш краща", "дуже краща"]`)} explanation="Слово краща вже містить порівняння, тому додавати слово більш не потрібно." />
</ErrorCorrection>

### Знайдіть займенники

<MarkTheWords client:load>
  <MarkTheWordsActivity instruction="Знайдіть і позначте всі займенники в давальному відмінку експерієнсери." text="Мені дуже подобається це місто. Тобі подобається львівська кава? Йому не подобається цей чорний чай. Нам подобається гуляти в парку. Вам подобається українська музика? Їй подобається читати, а їм подобається спорт." correctWords={JSON.parse(`["Мені", "Тобі", "Йому", "Нам", "Вам", "Їй", "їм"]`)} />
</MarkTheWords>

### Правда чи брехня: Правила та культура

<TrueFalse client:load items={JSON.parse(`[{"statement": "Дієслово подобатися використовується з називним відмінком особи, наприклад Я подобається.", "isTrue": false, "explanation": "Ні, воно використовується з давальним відмінком, правильно казати Мені подобається."}, {"statement": "Фраза я хотів би робить ваше прохання більш ввічливим у ресторані.", "isTrue": true, "explanation": "Так, це пом'якшує ваше прохання і є культурним стандартом."}, {"statement": "У Львові традиційну чашку кави називають філіжанка.", "isTrue": true, "explanation": "Так, це традиційне галицьке слово для чашки."}, {"statement": "Дієслово любити краще використовувати для швидкого вибору десерту в кафе.", "isTrue": false, "explanation": "Для швидкого естетичного вибору краще використовувати дієслово подобатися."}, {"statement": "Приказка На колір і смак товариш не всяк означає, що всі люди мають однакові смаки.", "isTrue": false, "explanation": "Вона означає протилежне: смаки у всіх різні (To each their own)."}, {"statement": "Слово краще може бути як прикметником, так і прислівником.", "isTrue": true, "explanation": "Так, воно може описувати і предмет (краща книжка), і дію (краще зробити)."}, {"statement": "У реченні Мені подобається музика слово музика стоїть у знахідному відмінку.", "isTrue": false, "explanation": "Воно стоїть у називному відмінку, оскільки є підметом, який виконує дію."}, {"statement": "Вираз віддавати перевагу використовується для формального або обдуманого вибору.", "isTrue": true, "explanation": "Так, це більш формальний аналог слова подобатися."}, {"statement": "Жінка повинна казати я хотів би замовити каву.", "isTrue": false, "explanation": "Жінка використовує форму жіночого роду: я хотіла би."}, {"statement": "Слово ніж використовується для порівняння двох предметів.", "isTrue": true, "explanation": "Так, воно є частиною конструкції краще ніж."}, {"statement": "Кава на піску готується дуже швидко в сучасній машині.", "isTrue": false, "explanation": "Вона готується повільно в спеціальній турці на гарячому піску."}, {"statement": "Дієслово вибирати вимагає знахідного відмінка, наприклад вибирати книжку.", "isTrue": true, "explanation": "Так, це стандартне перехідне дієслово."}]`)} />

### Діалог у кав'ярні: Зробіть свій вибір

<Cloze client:load passage={"Офіціант: Доброго дня! Що ви будете пити? Каву [___:0]} чай? \nКлієнт: Доброго дня. Я [___:1]} би замовити каву. \nОфіціант: Яку саме каву ви [___:2]}? У нас є еспресо та кава на [___:3]}. \nКлієнт: Мені більше [___:4]} кава на піску. Вона [___:5]} ніж звичайне еспресо. \nОфіціант: Чудовий вибір. Бажаєте [___:6]} до кави? \nКлієнт: Так, я хотів би [___:7]} цей шоколадний торт. \nОфіціант: На жаль, шоколадного торта вже немає. Є фруктовий. \nКлієнт: Мені не дуже подобається фруктовий торт. Я віддаю [___:8]} традиційному сирнику. \nОфіціант: Добре, одна [___:9]} кави на піску та сирник. \nКлієнт: Дякую. Знаєте, мій друг дуже [___:10]} фруктові торти. Але, як кажуть, на колір і [___:11]} товариш не [___:12]}. \nОфіціант: Точно! Ваш сирник буде готовий через хвилину. Це наш [___:13]} десерт."} blanks={JSON.parse(`[{"index": 0, "answer": "чи", "options": ["чи", "або", "що", "ніж"]}, {"index": 1, "answer": "хотів", "options": ["хотів", "хочу", "хотіла", "хотіти"]}, {"index": 2, "answer": "вибираєте", "options": ["вибираєте", "любите", "подобаєте", "хочете"]}, {"index": 3, "answer": "піску", "options": ["піску", "воді", "молоці", "столі"]}, {"index": 4, "answer": "подобається", "options": ["подобається", "любить", "смакує", "хочеться"]}, {"index": 5, "answer": "краща", "options": ["краща", "краще", "більш", "менш"]}, {"index": 6, "answer": "десерт", "options": ["десерт", "цукор", "молоко", "сніданок"]}, {"index": 7, "answer": "спробувати", "options": ["спробувати", "вибрати", "подивитися", "знайти"]}, {"index": 8, "answer": "перевагу", "options": ["перевагу", "вибір", "любов", "увагу"]}, {"index": 9, "answer": "філіжанка", "options": ["філіжанка", "чашка", "пляшка", "склянка"]}, {"index": 10, "answer": "любить", "options": ["любить", "подобається", "хоче", "їсть"]}, {"index": 11, "answer": "смак", "options": ["смак", "вигляд", "запах", "колір"]}, {"index": 12, "answer": "всяк", "options": ["всяк", "кожен", "друг", "брат"]}, {"index": 13, "answer": "найкращий", "options": ["найкращий", "більший", "краще", "добрий"]}]`)} />

### Оберіть правильні варіанти: Граматика

<Select client:load questions={JSON.parse(`[{"question": "Які з цих займенників стоять у давальному відмінку?", "options": [{"text": "мені", "correct": true}, {"text": "тобі", "correct": true}, {"text": "вона", "correct": false}, {"text": "йому", "correct": true}], "explanation": ""}, {"question": "Які слова можна використати для порівняння предметів?", "options": [{"text": "краще", "correct": true}, {"text": "більш", "correct": true}, {"text": "дуже", "correct": false}, {"text": "менш", "correct": true}, {"text": "ніж", "correct": true}], "explanation": ""}, {"question": "Оберіть правильні фрази для ввічливого замовлення в кафе.", "options": [{"text": "Я хотів би...", "correct": true}, {"text": "Я хотіла би...", "correct": true}, {"text": "Дай мені...", "correct": false}, {"text": "Мені треба...", "correct": false}], "explanation": ""}, {"question": "Які речення є граматично правильними та натуральними?", "options": [{"text": "Мені подобається Львів.", "correct": true}, {"text": "Я подобаюся Львів.", "correct": false}, {"text": "Йому подобається ця кава.", "correct": true}, {"text": "Він подобається цю каву.", "correct": false}], "explanation": ""}, {"question": "Які дієслова описують процес вибору або вираження вподобань?", "options": [{"text": "вибирати", "correct": true}, {"text": "подобатися", "correct": true}, {"text": "працювати", "correct": false}, {"text": "віддавати перевагу", "correct": true}], "explanation": ""}, {"question": "Що традиційно асоціюється з львівською кавовою культурою?", "options": [{"text": "філіжанка", "correct": true}, {"text": "кава на піску", "correct": true}, {"text": "швидкий еспресо на ходу", "correct": false}, {"text": "неспішна розмова", "correct": true}], "explanation": ""}]`)} />

### Переклад: Вираження вподобань

<Translate client:load questions={JSON.parse(`[{"source": "I like this book.", "options": [{"text": "Мені подобається ця книжка.", "correct": true}, {"text": "Я люблю цю книжку.", "correct": false}, {"text": "Мені подобається цю книжку.", "correct": false}]}, {"source": "I would like to order a coffee.", "options": [{"text": "Я хотів би замовити каву.", "correct": true}, {"text": "Я хочу замовляти каву.", "correct": false}, {"text": "Мені треба кава негайно.", "correct": false}]}, {"source": "Coffee is better than tea.", "options": [{"text": "Кава краща ніж чай.", "correct": true}, {"text": "Кава добре ніж чай.", "correct": false}, {"text": "Кава більш краща чай.", "correct": false}, {"text": "Кава є краще від чай.", "correct": false}]}, {"source": "He prefers classical music.", "options": [{"text": "Він віддає перевагу класичній музиці.", "correct": true}, {"text": "Йому подобається класична музика.", "correct": false}, {"text": "Він любить класична музика.", "correct": false}]}, {"source": "To each their own.", "options": [{"text": "На колір і смак товариш не всяк.", "correct": true}, {"text": "Кожному своє власне.", "correct": false}, {"text": "Усі люди різні завжди.", "correct": false}]}, {"source": "I don't really like this black coat.", "options": [{"text": "Мені не дуже подобається це чорне пальто.", "correct": true}, {"text": "Я не люблю це чорне пальто.", "correct": false}, {"text": "Мені не подобається це чорне пальто дуже.", "correct": false}]}]`)} />

### Ситуації та реакції

<MatchUp client:load pairs={JSON.parse(`[{"left": "Офіціант запитує, що ви будете пити.", "right": "Я хотів би замовити каву на піску."}, {"left": "Друг пропонує подивитися фільм жахів, а ви їх не любите.", "right": "Дякую, але мені не дуже подобаються такі фільми."}, {"left": "Ви в магазині і вам пропонують дві куртки.", "right": "Мені більше подобається ця сіра куртка."}, {"left": "Ви обговорюєте з колегою професійні методи роботи.", "right": "Я віддаю перевагу традиційним методам."}, {"left": "Ви з другом не можете дійти згоди щодо найкращого десерту.", "right": "Ну що ж, на колір і смак товариш не всяк."}, {"left": "Ви порівнюєте два міста для подорожі на вихідні.", "right": "Львів — це краще ніж Київ для вихідних."}, {"left": "Ви висловлюєте свою постійну, глибоку любов до читання.", "right": "Я люблю читати історичні книжки."}, {"left": "Ви оцінюєте загальний розмір двох квартир.", "right": "Квартира А більш велика, ніж квартира Б."}]`)} />
