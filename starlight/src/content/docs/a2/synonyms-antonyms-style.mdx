...
<div class="dialogue-line"><span class="speaker">Викладач:</span> Сьогодні ми редагуємо наш текст. *(Today we are editing our text.)* Як зробити його кращим? *(How to make it better?)*</div>

<div class="dialogue-line"><span class="speaker">Студентка:</span> У мене є фраза «великий будинок». *(I have the phrase "big house".)* Це звучить нудно. *(It sounds boring.)*</div>

<div class="dialogue-line"><span class="speaker">Викладач:</span> Правильно. *(Right.)* Яке слово ми можемо використати замість слова «великий»? *(What word can we use instead of the word "big"?)*</div>

<div class="dialogue-line"><span class="speaker">Студент:</span> Можемо сказати «величезний палац». *(We can say "huge palace".)*</div>

<div class="dialogue-line"><span class="speaker">Викладач:</span> Чудово! *(Excellent!)* А як щодо фрази «маленька дівчинка»? *(And what about the phrase "little girl"?)*</div>

<div class="dialogue-line"><span class="speaker">Студентка:</span> Краще звучить «крихітна дівчинка». *(“Tiny girl” sounds better.)*</div>

<div class="dialogue-line"><span class="speaker">Викладач:</span> Так, текст стає цікавішим. *(Yes, the text becomes more interesting.)* А тепер знайдемо протилежні слова. *(And now let's find opposite words.)* Замість «холодний вітер» напишемо «теплий вечір». *(Instead of "cold wind" we will write "warm evening".)*</div>
...
<MatchUp client:only="react" pairs={[{"left": "говорити", "right": "розповідати"}, {"left": "гарний", "right": "чудовий"}, {"left": "великий", "right": "величезний"}, {"left": "красивий", "right": "вродливий"}, {"left": "день", "right": "ніч"}, {"left": "гарячий", "right": "холодний"}, {"left": "початок", "right": "кінець"}, {"left": "лихо", "right": "добро"}]} instruction={"З'єднайте синоніми та антоніми в пари"} />
...
<Quiz client:only="react" questions={[{"question": "срібний дощ", "options": [{"text": "епітет", "correct": true}, {"text": "метафора", "correct": false}, {"text": "персоніфікація", "correct": false}, {"text": "пряме значення", "correct": false}]}, {"question": "зоря надії", "options": [{"text": "епітет", "correct": false}, {"text": "метафора", "correct": true}, {"text": "персоніфікація", "correct": false}, {"text": "пряме значення", "correct": false}]}, {"question": "сонце сміється", "options": [{"text": "епітет", "correct": false}, {"text": "метафора", "correct": false}, {"text": "персоніфікація", "correct": true}, {"text": "пряме значення", "correct": false}]}, {"question": "палке серце", "options": [{"text": "епітет", "correct": true}, {"text": "метафора", "correct": false}, {"text": "персоніфікація", "correct": false}, {"text": "пряме значення", "correct": false}]}, {"question": "море квітів", "options": [{"text": "епітет", "correct": false}, {"text": "метафора", "correct": true}, {"text": "персоніфікація", "correct": false}, {"text": "пряме значення", "correct": false}]}, {"question": "вітер співає", "options": [{"text": "епітет", "correct": false}, {"text": "метафора", "correct": false}, {"text": "персоніфікація", "correct": true}, {"text": "пряме значення", "correct": false}]}, {"question": "калинова мова", "options": [{"text": "епітет", "correct": true}, {"text": "метафора", "correct": false}, {"text": "персоніфікація", "correct": false}, {"text": "пряме значення", "correct": false}]}, {"question": "золотий годинник", "options": [{"text": "епітет", "correct": false}, {"text": "метафора", "correct": false}, {"text": "персоніфікація", "correct": false}, {"text": "пряме значення", "correct": true}]}]} instruction={"Визначте художній засіб: епітет, метафора, персоніфікація чи пряме значення"} />
...
<FillIn client:only="react" items={[{"sentence": "Великий стіл стає маленьким словом ____.", "answer": "столик", "options": ["стільчик", "столик", "стіл"]}, {"sentence": "Звичайний кіт стає милим словом ____.", "answer": "котик", "options": ["котик", "коти", "котом"]}, {"sentence": "Слово син стає ніжним словом ____.", "answer": "синок", "options": ["синок", "сини", "сином"]}, {"sentence": "Суворе слово батько може стати дуже теплим словом ____.", "answer": "батечко", "options": ["батечко", "батьком", "батьки"]}, {"sentence": "Слово квітка перетворюється на миле слово ____.", "answer": "квіточка", "options": ["квіточка", "квітки", "квіткою"]}, {"sentence": "Яскрава зірка на небі стає словом ____.", "answer": "зірочка", "options": ["зірочка", "зірки", "зоря"]}, {"sentence": "Слово річка може стати ніжною формою ____.", "answer": "річечка", "options": ["річечка", "річки", "ріка"]}, {"sentence": "Замість слова малий ми говоримо ____.", "answer": "маленький", "options": ["маленький", "малі", "мало"]}]} instruction={"Утворіть ласкаві слова (зменшувальні форми), обравши правильний варіант"} />
...
<GroupSort client:only="react" groups={{"Еліпсис (пропуск слова)": ["Я — каву, а ти?", "Він — додому.", "Усе найкраще — дітям!", "Кожному — своє."], "Повтор (інтенсивність дії)": ["Ми думали-думали, і знайшли.", "Вони живуть далеко-далеко.", "Ішов, ішов та й прийшов.", "Вони ходили-ходили."]}} instruction={"Розподіліть приклади на дві синтаксичні категорії: еліпсис та повтор"} />
...
<Quiz client:only="react" questions={[{"question": "Коли ми описуємо пейзаж, ідеально підходить слово _____.", "options": [{"text": "красивий", "correct": true}, {"text": "вродливий", "correct": false}, {"text": "смачний", "correct": false}, {"text": "розумний", "correct": false}]}, {"question": "Постійне повторення одного слова — це _____.", "options": [{"text": "тавтологія", "correct": true}, {"text": "епітет", "correct": false}, {"text": "метафора", "correct": false}, {"text": "еліпсис", "correct": false}]}, {"question": "Слова з абсолютно протилежним значенням називаються _____.", "options": [{"text": "антоніми", "correct": true}, {"text": "синоніми", "correct": false}, {"text": "епітети", "correct": false}, {"text": "суфікси", "correct": false}]}, {"question": "Слово «вродливий» ми використовуємо, коли говоримо про _____.", "options": [{"text": "зовнішність людини", "correct": true}, {"text": "гарну погоду", "correct": false}, {"text": "смачну їжу", "correct": false}, {"text": "новий будинок", "correct": false}]}, {"question": "Слова «день» і «ніч» — це _____.", "options": [{"text": "антоніми", "correct": true}, {"text": "синоніми", "correct": false}, {"text": "епітети", "correct": false}, {"text": "повтори", "correct": false}]}, {"question": "Яке слово є синонімом до слова «говорити» (спілкуватися неформально)?", "options": [{"text": "балакати", "correct": true}, {"text": "кричати", "correct": false}, {"text": "співати", "correct": false}, {"text": "слухати", "correct": false}]}]} instruction={"Оберіть правильне слово за контекстом"} />

<ErrorCorrection client:only="react" items={[{"sentence": "Вона дуже вродливий дівчина.", "errorWord": "вродливий", "correctForm": "вродлива", "options": ["вродлива", "вродливе", "вродливі"], "explanation": "Дівчина (girl) — це іменник жіночого роду, тому прикметник також має бути жіночого роду."}, {"sentence": "Цей величезна будинок дуже старий.", "errorWord": "величезна", "correctForm": "величезний", "options": ["величезний", "величезне", "величезні"], "explanation": "Будинок (house) — це іменник чоловічого роду, тому прикметник також має бути чоловічого роду."}, {"sentence": "Слово «батько» може стати ласкавим словом батечка.", "errorWord": "батечка", "correctForm": "батечко", "options": ["батечко", "батьком", "батьку"], "explanation": "Зменшувально-пестлива форма (diminutive) від слова батько — це батечко."}, {"sentence": "Я бачу багато красивий квітів.", "errorWord": "красивий", "correctForm": "красивих", "options": ["красивих", "красива", "красиві"], "explanation": "Квітів — це родовий відмінок множини (Genitive plural), тому прикметник також має стояти у родовій множині."}, {"sentence": "Вона має палкий серце.", "errorWord": "палкий", "correctForm": "палке", "options": ["палке", "палка", "палкі"], "explanation": "Серце (heart) — це іменник середнього роду, тому прикметник також має бути середнього роду."}, {"sentence": "Ми розмовляли цілу нічок.", "errorWord": "нічок", "correctForm": "ніченьку", "options": ["ніченьку", "нічка", "ніч"], "explanation": "Зменшувальна форма для слова ніч — це ніченька (жіночий рід), а не нічок."}]} instruction={"Знайдіть і виправте граматичну помилку в реченні"} />

<TrueFalse client:only="react" items={[{"statement": "Тавтологія робить текст цікавішим і багатшим.", "isTrue": false, "explanation": "Тавтологія (постійне повторення одного слова) робить текст бідним і нецікавим."}, {"statement": "Слово «вродливий» найкраще використовувати для опису пейзажу.", "isTrue": false, "explanation": "Для пейзажу краще підходить «красивий», а «вродливий» — для зовнішності людини."}, {"statement": "Персоніфікація наділяє неживі предмети людськими рисами.", "isTrue": true, "explanation": "Так, наприклад, «вітер співає» або «сонце сміється»."}, {"statement": "Еліпсис — це пропуск слова в реченні, яке легко зрозуміти.", "isTrue": true, "explanation": "Це робить мовлення дуже динамічним і коротким."}, {"statement": "Зменшувальні суфікси показують тільки малий розмір предмета.", "isTrue": false, "explanation": "Головна їхня функція — це емоції (любов, ніжність, близькість)."}, {"statement": "Антоніми часто використовуються в українських прислів'ях для контрасту.", "isTrue": true, "explanation": "Так, наприклад: «Не знаючи лиха, не пізнаєш і добра»."}, {"statement": "Епітети, метафори та персоніфікація роблять нашу мову образною та виразною.", "isTrue": true, "explanation": "Вони допомагають малювати словами і передавати складні емоції."}]} instruction={"Правда чи ні? Визначте правильність тверджень"} />

<Translate client:only="react" questions={[{"source": "golden autumn", "options": [{"text": "золота осінь", "correct": true}, {"text": "жовта осінь", "correct": false}, {"text": "золотий годинник", "correct": false}, {"text": "тепла осінь", "correct": false}]}, {"source": "a sea of flowers", "options": [{"text": "море квітів", "correct": true}, {"text": "багато квітів", "correct": false}, {"text": "вода і квіти", "correct": false}, {"text": "озеро квітів", "correct": false}]}, {"source": "skilful hands", "options": [{"text": "золоті руки", "correct": true}, {"text": "добрі руки", "correct": false}, {"text": "великі руки", "correct": false}, {"text": "красиві руки", "correct": false}]}, {"source": "the sun laughs", "options": [{"text": "сонце сміється", "correct": true}, {"text": "сонце світить", "correct": false}, {"text": "сонце плаче", "correct": false}, {"text": "сонце співає", "correct": false}]}, {"source": "little star", "options": [{"text": "зірочка", "correct": true}, {"text": "зірка", "correct": false}, {"text": "сонце", "correct": false}, {"text": "ніченька", "correct": false}]}, {"source": "very far away", "options": [{"text": "далеко-далеко", "correct": true}, {"text": "близько-близько", "correct": false}, {"text": "туди-сюди", "correct": false}, {"text": "довго-довго", "correct": false}]}]} instruction={"Оберіть правильний переклад для образних виразів"} />
