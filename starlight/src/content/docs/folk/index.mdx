  ...
  modules={[
    {
      unit: "FOLK.1",
      items: [
        { num: 1, slug: "koliadky-shchedrivky", title: "Колядки та щедрівки: Міф про створення світу", sub: "Carols and Shchedrivky: The Cosmogonic Myth", status: "locked" },
    ...
    },
    {
      ...
      items: [
        ...
        { num: 19, slug: "dumy-lytsarski", title: "Лицарські думи: Оспівування звитяги", sub: "Heroic Dumas: Celebrating Valor", status: "locked" },
