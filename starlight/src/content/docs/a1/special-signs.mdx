...
<FillIn client:only="react" items={[{"sentence": "сім____я", "answer": "'", "options": ["ь", "'"]}, {"sentence": "ден____", "answer": "ь", "options": ["ь", "'"]}, {"sentence": "п____ять", "answer": "'", "options": ["ь", "'"]}]} instruction={"Fill in the missing sign to complete each word. Choose Ь (soft sign) or ' (apostrophe)."} />
...
<Quiz client:only="react" questions={[{"question": "сіль", "options": [{"text": "Soft sign (Ь)", "correct": true}, {"text": "Apostrophe (')", "correct": false}, {"text": "Neither", "correct": false}]}, {"question": "м'ясо", "options": [{"text": "Soft sign (Ь)", "correct": false}, {"text": "Apostrophe (')", "correct": true}, {"text": "Neither", "correct": false}]}, {"question": "риба", "options": [{"text": "Soft sign (Ь)", "correct": false}, {"text": "Apostrophe (')", "correct": false}, {"text": "Neither", "correct": true}]}, {"question": "батько", "options": [{"text": "Soft sign (Ь)", "correct": true}, {"text": "Apostrophe (')", "correct": false}, {"text": "Neither", "correct": false}]}]} instruction={"Does this word contain a soft sign (Ь), an apostrophe ('), or neither?"} />
...
<MatchUp client:only="react" pairs={[{"left": "Б", "right": "П"}, {"left": "Д", "right": "Т"}, {"left": "З", "right": "С"}, {"left": "Ж", "right": "Ш"}]} instruction={"Match each voiced consonant with its voiceless pair."} />
...
<Quiz client:only="react" questions={[{"question": "гарно — What sound does Г make here?", "options": [{"text": "Breathy voiced [ɦ] (like voiced H)", "correct": true}, {"text": "Hard [g] (like English G in 'go')", "correct": false}]}, {"question": "ґанок — What sound does Ґ make here?", "options": [{"text": "Breathy voiced [ɦ] (like voiced H)", "correct": false}, {"text": "Hard [g] (like English G in 'go')", "correct": true}]}, {"question": "голова — What sound does Г make here?", "options": [{"text": "Breathy voiced [ɦ] (like voiced H)", "correct": true}, {"text": "Hard [g] (like English G in 'go')", "correct": false}]}, {"question": "ґудзик — What sound does Ґ make here?", "options": [{"text": "Breathy voiced [ɦ] (like voiced H)", "correct": false}, {"text": "Hard [g] (like English G in 'go')", "correct": true}]}]} instruction={"Which sound does the highlighted letter make? Г = breathy voiced [ɦ], Ґ = hard [g]."} />
...
<FillIn client:only="react" items={[{"sentence": "м____ясо", "answer": "'", "options": ["ь", "'"]}, {"sentence": "кін____", "answer": "ь", "options": ["ь", "'"]}, {"sentence": "комп____ютер", "answer": "'", "options": ["ь", "'"]}, {"sentence": "учител____", "answer": "ь", "options": ["ь", "'"]}, {"sentence": "дев____ять", "answer": "'", "options": ["ь", "'"]}, {"sentence": "осін____", "answer": "ь", "options": ["ь", "'"]}]} instruction={"Fill in the missing sign to complete each word. Choose Ь (soft sign) or ' (apostrophe)."} />

<Quiz client:only="react" questions={[{"question": "камінь", "options": [{"text": "Soft sign (Ь)", "correct": true}, {"text": "Apostrophe (')", "correct": false}, {"text": "Neither", "correct": false}]}, {"question": "комп'ютер", "options": [{"text": "Soft sign (Ь)", "correct": false}, {"text": "Apostrophe (')", "correct": true}, {"text": "Neither", "correct": false}]}, {"question": "гарно", "options": [{"text": "Soft sign (Ь)", "correct": false}, {"text": "Apostrophe (')", "correct": false}, {"text": "Neither", "correct": true}]}, {"question": "подвір'я", "options": [{"text": "Soft sign (Ь)", "correct": false}, {"text": "Apostrophe (')", "correct": true}, {"text": "Neither", "correct": false}]}, {"question": "маленький", "options": [{"text": "Soft sign (Ь)", "correct": true}, {"text": "Apostrophe (')", "correct": false}, {"text": "Neither", "correct": false}]}, {"question": "зима", "options": [{"text": "Soft sign (Ь)", "correct": false}, {"text": "Apostrophe (')", "correct": false}, {"text": "Neither", "correct": true}]}, {"question": "здоров'я", "options": [{"text": "Soft sign (Ь)", "correct": false}, {"text": "Apostrophe (')", "correct": true}, {"text": "Neither", "correct": false}]}, {"question": "тихо", "options": [{"text": "Soft sign (Ь)", "correct": false}, {"text": "Apostrophe (')", "correct": false}, {"text": "Neither", "correct": true}]}]} instruction={"Does this word contain a soft sign (Ь), an apostrophe ('), or neither?"} />

<MatchUp client:only="react" pairs={[{"left": "Б", "right": "П"}, {"left": "Д", "right": "Т"}, {"left": "Г", "right": "Х"}, {"left": "Ґ", "right": "К"}, {"left": "З", "right": "С"}, {"left": "Ж", "right": "Ш"}, {"left": "ДЗ", "right": "Ц"}, {"left": "ДЖ", "right": "Ч"}]} instruction={"Match all eight voiced-voiceless consonant pairs in Ukrainian."} />

<GroupSort client:only="react" groups={{"Soft sign (Ь)": ["день", "сіль", "батько", "учитель"], "Apostrophe (')": ["сім'я", "м'ясо", "п'ять", "дев'ять"], "Neither": ["гарно", "риба", "рис", "зима"]}} instruction={"Sort these words into three groups: words with a soft sign (Ь), words with an apostrophe ('), and words with neither sign."} />

<TrueFalse client:only="react" items={[{"statement": "The soft sign (Ь) softens the consonant before it.", "isTrue": true, "explanation": "Correct — Ь has no sound of its own. It only softens the preceding consonant, as in день and сіль."}, {"statement": "The apostrophe appears before the vowels А, О, У, Е.", "isTrue": false, "explanation": "The apostrophe appears only before Я, Ю, Є, Ї — not before А, О, У, Е."}, {"statement": "In Ukrainian, voiced consonants stay voiced at the end of a word.", "isTrue": true, "explanation": "Correct — unlike Russian, Ukrainian keeps consonants voiced at word end. Дуб is [дуб], not *[дуп]."}, {"statement": "Г and Ґ make the same sound in Ukrainian.", "isTrue": false, "explanation": "Г is a breathy voiced [ɦ] (like voiced H), while Ґ is a hard [g] (like English G in 'go'). They are different sounds."}]} instruction={"Read each statement and decide: true or false?"} />

<Quiz client:only="react" questions={[{"question": "After which consonants can the apostrophe appear?", "options": [{"text": "Б, П, В, М, Ф, Р", "correct": true}, {"text": "Д, Т, Н, Л, З, С", "correct": false}, {"text": "Any consonant", "correct": false}, {"text": "Only Г and Ґ", "correct": false}]}, {"question": "What is the difference between рис and рись?", "options": [{"text": "рис means 'rice' and рись means 'lynx' — the soft sign changes the meaning", "correct": true}, {"text": "They mean the same thing", "correct": false}, {"text": "рись is the plural of рис", "correct": false}, {"text": "рис is feminine and рись is masculine", "correct": false}]}, {"question": "How many voiced-voiceless consonant pairs does Ukrainian have?", "options": [{"text": "Four", "correct": false}, {"text": "Six", "correct": false}, {"text": "Eight", "correct": true}, {"text": "Ten", "correct": false}]}, {"question": "What happens to the vowel after an apostrophe?", "options": [{"text": "It disappears", "correct": false}, {"text": "It keeps its full two-sound value (e.g., Я = [й] + [а])", "correct": true}, {"text": "It becomes silent", "correct": false}, {"text": "It changes to a different vowel", "correct": false}]}]} instruction={"Choose the correct answer about Ukrainian special signs and sounds."} />
...
- [Приголосні м'які й тверді, дзвінкі й глухі; вимова приголосних [ґ] і [г]]([miyklas.com.ua](https://www.miyklas.com.ua/p/ukrainska-mova/5-klas/fonetika-grafika-orfoepiia-orfografiia-14565/prigolosni-m-iaki-i-tverdi-dzvinki-i-glukhi-vimova-prigolosnikh-g-i-g-40885))
