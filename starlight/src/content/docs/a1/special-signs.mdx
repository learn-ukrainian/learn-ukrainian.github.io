...
<ErrorCorrection client:only='react' instruction="Choose the correct Ukrainian form." items={JSON.parse(`[{"sentence": "Do not drop the apostrophe in сім'я.", "errorWord": "сімя", "correctForm": "сім'я", "options": ["сім'я", "family word without apostrophe"], "explanation": "The apostrophe is required in сім'я."}, {"sentence": "Do not write ден.", "errorWord": "ден", "correctForm": "день", "options": ["день", "ден"], "explanation": "День needs the soft sign."}, {"sentence": "Do not put apostrophe in свято.", "errorWord": "apostrophe in свято", "correctForm": "свято", "options": ["свято", "apostrophe spelling"], "explanation": "Свято is a prepared no-apostrophe word."}, {"sentence": "Do not invent a soft sign in ложка.", "errorWord": "льожка", "correctForm": "ложка", "options": ["ложка", "invented soft-sign spelling"], "explanation": "Ложка does not have a soft sign after л."}, {"sentence": "Do not treat apostrophe as a hard stop.", "errorWord": "hard stop", "correctForm": "smooth й sound", "options": ["smooth й sound", "full stop"], "explanation": "The apostrophe separates sounds but does not create a full pause."}]`)} />
