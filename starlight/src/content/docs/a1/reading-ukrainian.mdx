...
<ErrorCorrection client:only='react'>
  ...
  <ErrorCorrectionItem sentence="Do not read молоко as м[а]локо." errorWord="м[а]локо" correctForm="молоко" options={JSON.parse(`["молоко", "blurred о"]`)} explanation="Ukrainian о stays clean; read молоко with three open beats." />

  <ErrorCorrectionItem sentence="Do not read дж as two broken sounds." errorWord="two broken sounds" correctForm="one joined sound" options={JSON.parse(`["one joined sound", "д plus ж"]`)} explanation="ДЖ marks one joined reading unit in words such as джерело." />

  <ErrorCorrectionItem sentence="Do not read Ї as plain І." errorWord="plain І" correctForm="[йі]" options={JSON.parse(`["[йі]", "[і]"]`)} explanation="Ї is always [йі]." />

  <ErrorCorrectionItem sentence="Do not add a vowel after день." errorWord="add a vowel" correctForm="soften н and stop" options={JSON.parse(`["soften н and stop", "add і after нь"]`)} explanation="Ь has no sound of its own; it softens the previous consonant." />
