...
<ErrorCorrection client:only='react'>
  <ErrorCorrectionItem sentence="English has I am, but Ukrainian identity lines drop the present-time copula." errorWord="Я є студент." correctForm="Я студент." options={JSON.parse(`["Я студент.", "Я є студент."]`)} explanation="In present-time identity, say Я студент or Я — студент." />
  <ErrorCorrectionItem sentence="Use the natural name chunk." errorWord="Моє ім'я є Джон." correctForm="Мене звати Джон." options={JSON.parse(`["Мене звати Джон.", "Моє ім'я є Джон."]`)} explanation="Мене звати... is the high-frequency introduction model." />
  <ErrorCorrectionItem sentence="Treat age as a later memorized model, not an identity pattern today." errorWord="Я маю 20 років." correctForm="Мені 20 років." options={JSON.parse(`["Мені 20 років.", "Я маю 20 років."]`)} explanation="Age uses a different chunk and is not the model for this lesson." />
  <ErrorCorrectionItem sentence="A woman uses the feminine profession form." errorWord="Я (жінка) лікар." correctForm="Я лікарка." options={JSON.parse(`["Я лікарка.", "Я (жінка) лікар."]`)} explanation="Лікарка is the standard feminine form for a woman doctor." />
  <ErrorCorrectionItem sentence="Do not use воно for a person." errorWord="Воно мій тато." correctForm="Це мій тато." options={JSON.parse(`["Це мій тато.", "Воно мій тато."]`)} explanation="Use це for identifying a person, or він after the person is known." />
  <ErrorCorrectionItem sentence="Match greeting to register." errorWord="Привіт, пане професоре!" correctForm="Добрий день, пане професоре!" options={JSON.parse(`["Добрий день, пане професоре!", "Привіт, пане професоре!"]`)} explanation="Use Добрий день with a professor or unknown adult." />
</ErrorCorrection>
