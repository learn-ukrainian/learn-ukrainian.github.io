...
<GroupSort client:load groups={JSON.parse(`{"Сполучники та причини (Conjunctions & Reasons)": ["тому що", "бо", "і", "але", "якщо"], "Маркери часу (Time markers)": ["спочатку", "потім", "нарешті", "сьогодні", "завтра", "вранці", "увечері"]}`)} />

### Знайдіть переклад

<MatchUp client:load pairs={JSON.parse(`[{"left": "спочатку", "right": "first"}, {"left": "потім", "right": "then"}, {"left": "нарешті", "right": "finally"}, {"left": "тому що", "right": "because (formal)"}, {"left": "бо", "right": "because (colloquial)"}, {"left": "якщо", "right": "if"}, {"left": "також", "right": "also"}, {"left": "разом", "right": "together"}]`)} />
