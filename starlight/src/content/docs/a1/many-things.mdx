...
<ErrorCorrection client:only='react' instruction="Choose the standard Ukrainian repair.">
  <ErrorCorrectionItem sentence="великий м'ячі" errorWord="великий м'ячі" correctForm="великі м'ячі" options={JSON.parse(`["великі м'ячі", "великий м'ячі", "велика м'ячі"]`)} explanation="Plural adjectives use -і." />
  <ErrorCorrectionItem sentence="синія шарфи" errorWord="синія шарфи" correctForm="сині шарфи" options={JSON.parse(`["сині шарфи", "синія шарфи", "синій шарфи"]`)} explanation="The plural color form is сині." />
  <ErrorCorrectionItem sentence="два зошитів / два смартфонів" errorWord="два зошитів / два смартфонів" correctForm="два зошити / чотири смартфони" options={JSON.parse(`["два зошити / чотири смартфони", "два зошитів / два смартфонів", "два зошита / чотири смартфона"]`)} explanation="Two, three, and four use the ordinary plural form here." />
  <ErrorCorrectionItem sentence="п'ять зошити / десять учні" errorWord="п'ять зошити / десять учні" correctForm="п'ять зошитів / десять учнів" options={JSON.parse(`["п'ять зошитів / десять учнів", "п'ять зошити / десять учні", "п'ять зошита / десять учня"]`)} explanation="Keep the 5+ chunk п'ять зошитів." />
  <ErrorCorrectionItem sentence="один двері / два двері" errorWord="один двері / два двері" correctForm="одні двері / двоє дверей" options={JSON.parse(`["одні двері / двоє дверей", "один двері / два двері", "одна двері / дві двері"]`)} explanation="Двері is plural-only in everyday use." />
  <ErrorCorrectionItem sentence="молоді / дітвори" errorWord="молоді / дітвори" correctForm="молодь / дітвора" options={JSON.parse(`["молодь / дітвора", "молоді / дітвори", "молодя / дітвори"]`)} explanation="Молодь is a singular collective word." />
  <ErrorCorrectionItem sentence="для ми / з ми" errorWord="для ми / з ми" correctForm="для нас / з нами" options={JSON.parse(`["для нас / з нами", "для ми / з ми", "для нам / з нас"]`)} explanation="Use the pronoun chunks: для нас, з нами." />
</ErrorCorrection>
