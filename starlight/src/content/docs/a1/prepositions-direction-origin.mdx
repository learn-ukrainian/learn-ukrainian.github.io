...
sidebar:
  order: 30
  label: "30. Prepositions: Direction & Origin"
---
...
<GroupSort client:load groups={JSON.parse(`{"Де? (Location)": ["у парку", "на роботі", "вдома", "у школі"], "Куди? (Direction)": ["у парк", "на роботу", "додому", "до лікаря"], "Звідки? (Origin)": ["з парку", "з роботи", "з дому", "від лікаря"]}`)} />
...
<GroupSort client:load groups={JSON.parse(`{"В (У)": ["парк", "школа", "магазин", "кімната", "Київ", "банк"], "На": ["робота", "вулиця", "концерт", "стіл", "пошта", "вокзал"]}`)} />
