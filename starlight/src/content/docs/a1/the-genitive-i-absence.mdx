...
sidebar:
  order: 32
  label: "32. The Genitive I: Absence"
---
...
<GroupSort client:load groups={JSON.parse(`{"Закінчення -а (Конкретні)": ["квиток", "паспорт", "брат", "студент", "автобус", "стіл"], "Закінчення -у (Абстрактні/Речовини/Іншомовні)": ["час", "цукор", "чай", "обід", "спокій", "телефон", "сир"]}`)} />

### Знайдіть пару

<MatchUp client:load pairs={JSON.parse(`[{"left": "немає часу", "right": "no time"}, {"left": "без цукру", "right": "without sugar"}, {"left": "немає грошей", "right": "no money"}, {"left": "без молока", "right": "without milk"}, {"left": "немає води", "right": "no water"}, {"left": "без квитка", "right": "without a ticket"}, {"left": "без хліба", "right": "without bread"}, {"left": "немає світла", "right": "no light"}]`)} />
...
<GroupSort client:load groups={JSON.parse(`{"Чоловічий (Masc)": ["паспорт", "квиток", "чай", "цукор", "час", "борщ", "автобус"], "Жіночий (Fem)": ["вода", "кава", "проблема", "кухня", "віза", "мова", "робота"]}`)} />
...
- [ULP 2-46 | Grocery Store + Genitive](https://www.ukrainianlessons.com/episode46/) — Practice genitive at the grocery store
- [ULP 2-49 | Syrnyky Recipe + Genitive](https://www.ukrainianlessons.com/episode49/) — Learn cooking vocabulary with genitive
:::
