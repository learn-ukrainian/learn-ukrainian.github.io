...
<ErrorCorrection client:only='react' instruction="Fix the adjective or sentence frame.">
  <ErrorCorrectionItem sentence="Він є добрий студент." errorWord="Він є добрий студент." correctForm="Він добрий студент." options={JSON.parse(`["Він добрий студент.", "Він добра студент.", "Він є добра студент."]`)} explanation="In this present-tense frame, Ukrainian normally omits є." />
  <ErrorCorrectionItem sentence="Це гарна хлопець." errorWord="Це гарна хлопець." correctForm="Це гарний хлопець." options={JSON.parse(`["Це гарний хлопець.", "Це гарне хлопець.", "Це гарна хлопець."]`)} explanation="Хлопець is masculine." />
  <ErrorCorrectionItem sentence="Який твоє ім'я?" errorWord="Який твоє ім'я?" correctForm="Яке твоє ім'я? (або: Як тебе звати?)" options={JSON.parse(`["Яке твоє ім'я? (або: Як тебе звати?)", "Яка твоє ім'я?", "Який твоє ім'я?"]`)} explanation="Ім'я is neuter; in real introductions, use Як тебе звати?" />
  <ErrorCorrectionItem sentence="Вона читає цікавий книжку." errorWord="Вона читає цікавий книжку." correctForm="Вона читає цікаву книжку." options={JSON.parse(`["Вона читає цікаву книжку.", "Вона читає цікавий книжку.", "Вона читає цікаве книжку."]`)} explanation="This is an object form; notice that adjective and noun move together." />
  <ErrorCorrectionItem sentence="Моя мамалига смачний." errorWord="Моя мамалига смачний." correctForm="Моя мамалига смачна." options={JSON.parse(`["Моя мамалига смачна.", "Моя мамалига смачний.", "Моя мамалига смачне."]`)} explanation="Мамалига is feminine, so use смачна." />
  <ErrorCorrectionItem sentence="Це мій синій ручка." errorWord="Це мій синій ручка." correctForm="Це моя синя ручка." options={JSON.parse(`["Це моя синя ручка.", "Це мій синій ручка.", "Це моє синє ручка."]`)} explanation="Ручка is feminine, and синій is a soft-stem adjective." />
</ErrorCorrection>
