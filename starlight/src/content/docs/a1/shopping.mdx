...
**Покупець:** Скі́льки ко́шту́є кілогра́м я́блук? *(How much does a kilogram of apples cost?)*


**Продавець:** Соро́к гри́вень. *(Forty hryvnias.)*


**Покупець:** А помідо́ри? *(And the tomatoes?)*


**Продавець:** Три́дцять п'ять гривень за кілограм. *(Thirty-five hryvnias per kilogram.)*


**Покупець:** Дайте, будь ласка, два кілогра́ми помідо́рів і кілограм яблук. *(Give me, please, two kilograms of tomatoes and a kilogram of apples.)*


**Продавець:** Сімдеся́т п'ять гривень. *(Seventy-five hryvnias.)*
...
**Покупець:** Ви́бачте, де тут хліб? *(Excuse me, where is the bread here?)*


**Продавець:** Хліб у тре́тьому ря́ді. *(The bread is in the third aisle.)*


**Покупець:** А молоко́? *(And the milk?)*


**Продавець:** Молоко в холоди́льнику, там. *(The milk is in the fridge, there.)*


**Покупець:** Скільки коштує цей сир? *(How much does this cheese cost?)*


**Продавець:** Сто два́дцять гривень. *(One hundred twenty hryvnias.)*


**Покупець:** До́рого! А є деше́вший? *(Expensive! Is there a cheaper one?)*


**Продавець:** Так, ось цей — вісімдеся́т. *(Yes, this one here is eighty.)*
...
<FillIn client:only="react" instruction={"Скільки коштує чи коштують?"} items={[{"sentence": "Скільки коштує {хліб|хліба}? — Двадцять гривень.", "answer": ""}, {"sentence": "Скільки коштує {вода|воду}? — Де́сять гривень.", "answer": ""}, {"sentence": "Скільки коштує {сир|сиру}? — Сто гривень.", "answer": ""}, {"sentence": "Скільки коштують {яблука|яблук}? — Сорок гривень.", "answer": ""}, {"sentence": "Скільки коштують {помідори|помідорів}? — Тридцять гривень.", "answer": ""}, {"sentence": "Скільки коштує {молоко|молока́}? — П'ятдеся́т гривень.", "answer": ""}, {"sentence": "Скільки коштує {сік|соку}? — Шістдеся́т гривень.", "answer": ""}, {"sentence": "Скільки коштують {банани|бананів}? — Сімдесят гривень.", "answer": ""}]} />
...
* **Дві копійки́.** *(Two kopecks.)*
* **П'ятдесят копійо́к.** *(Fifty kopecks.)*

<Quiz client:only="react" instruction={"Choose the correct currency form"} questions={[{"question": "21 ___", "options": [{"text": "гривня", "correct": true}, {"text": "гривні", "correct": false}, {"text": "гривень", "correct": false}]}, {"question": "32 ___", "options": [{"text": "гривні", "correct": true}, {"text": "гривня", "correct": false}, {"text": "гривень", "correct": false}]}, {"question": "45 ___", "options": [{"text": "гривень", "correct": true}, {"text": "гривня", "correct": false}, {"text": "гривні", "correct": false}]}, {"question": "100 ___", "options": [{"text": "гривень", "correct": true}, {"text": "гривня", "correct": false}, {"text": "гривні", "correct": false}]}, {"question": "1 ___", "options": [{"text": "гривня", "correct": true}, {"text": "гривні", "correct": false}, {"text": "гривень", "correct": false}]}, {"question": "3 ___", "options": [{"text": "гривні", "correct": true}, {"text": "гривня", "correct": false}, {"text": "гривень", "correct": false}]}, {"question": "10 ___", "options": [{"text": "гривень", "correct": true}, {"text": "гривня", "correct": false}, {"text": "гривні", "correct": false}]}, {"question": "54 ___", "options": [{"text": "гривні", "correct": true}, {"text": "гривня", "correct": false}, {"text": "гривень", "correct": false}]}]} />
...
<MatchUp client:only="react" instruction={"Where do you buy it?"} pairs={[{"left": "помідори", "right": "ринок"}, {"left": "м'я́со", "right": "м'ясний відділ"}, {"left": "сир", "right": "молочний відділ"}, {"left": "хліб", "right": "крамниця"}, {"left": "молоко", "right": "супермаркет"}, {"left": "вода", "right": "магазин"}, {"left": "ка́ва", "right": "кафе́"}, {"left": "борщ", "right": "рестора́н"}]} />
...
* **два лі́три води** *(two liters of water)*
...
* **Дайте, будь ласка, буха́нку хліба.** *(Give me, please, a loaf of bread.)*
...
<FillIn client:only="react" instruction={"At the market"} items={[{"sentence": "Дайте {кілограм|літр|пляшку} яблук.", "answer": ""}, {"sentence": "Дайте {літр|кілограм|пачку} молока.", "answer": ""}, {"sentence": "Дайте {пляшку|кілограм|літр} води.", "answer": ""}, {"sentence": "Дайте {пачку|літр|пляшку} чаю.", "answer": ""}, {"sentence": "Дайте {буханку|літр|кілограм} хліба.", "answer": ""}, {"sentence": "Дайте {кілограм|літр|пляшку} помідорів.", "answer": ""}]} />
...
* **Дорого!** *(Expensive!)*
* **Дешево!** *(Cheap!)*
* **Добре, беру́.** *(Good, I will take it.)*

**4. Ask for the total:**
* **Скільки за все?** *(How much for everything?)*
* **Можна ка́рткою?** *(Can I pay by card?)*
