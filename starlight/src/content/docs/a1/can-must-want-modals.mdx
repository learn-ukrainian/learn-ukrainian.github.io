...
<MatchUp client:load pairs={JSON.parse(`[{"left": "⛔ Вхід заборонено", "right": "You cannot enter"}, {"left": "🅿️ Парковка дозволена", "right": "You can park here"}, {"left": "🚭 Курити заборонено", "right": "No smoking"}, {"left": "📸 Фотографувати заборонено", "right": "No photos"}, {"left": "Можна?", "right": "May I?"}, {"left": "Не можна", "right": "It is forbidden"}, {"left": "Тут можна", "right": "It is allowed here"}, {"left": "Вхід", "right": "Entrance"}]`)} />
...
<GroupSort client:load groups={JSON.parse(`{"Бажання (Desire)": ["Я хочу кави", "Ми хочемо спати", "Він хоче грати", "Ти хочеш чаю"], "Можливість (Possibility/Skill)": ["Я можу допомогти", "Вона вміє співати", "Тут можна сидіти", "Ти можеш йти"], "Обов'язок (Obligation/Need)": ["Мені треба йти", "Я повинен працювати", "Нам потрібно вчитися", "Вона повинна спати"]}`)} />
