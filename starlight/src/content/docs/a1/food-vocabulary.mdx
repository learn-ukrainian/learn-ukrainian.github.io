...
:::warning[⚠️ **False Friends: «Кушати» vs «Їсти»**]
...
| борщ |  | borscht | noun | ч |  |
| м'ясо |  | meat | noun | с |  |
| овочі |  | vegetables | noun | pl |  |
| фрукти |  | fruits | noun | pl |  |
| вода |  | water | noun | ж |  |
| кава |  | coffee | noun | ж |  |
| чай |  | tea | noun | ч |  |
| молоко |  | milk | noun | с |  |
| сік |  | juice | noun | ч |  |
| суп |  | soup | noun | ч |  |
| паляниця |  | palianytsia | noun | ж |  |
| каша |  | porridge | noun | ж |  |
| компот |  | compote | noun | ч |  |
| риба |  | fish | noun | ж |  |
| сир |  | cheese | noun | ч |  |
| сало |  | salo (cured fat) | noun | с |  |
| цибуля |  | onion | noun | ж |  |
| їсти |  | to eat | verb |  |  |
| пити |  | to drink | verb |  |  |
...
### Translate the Food Words

<MatchUp client:load pairs={JSON.parse(`[{"left": "хліб", "right": "bread"}, {"left": "борщ", "right": "borscht"}, {"left": "м'ясо", "right": "meat"}, {"left": "овочі", "right": "vegetables"}, {"left": "фрукти", "right": "fruits"}, {"left": "вода", "right": "water"}, {"left": "кава", "right": "coffee"}, {"left": "чай", "right": "tea"}, {"left": "молоко", "right": "milk"}, {"left": "сік", "right": "juice"}, {"left": "суп", "right": "soup"}, {"left": "риба", "right": "fish"}]`)} />

### Ordering and Preferences

<Quiz client:load questions={JSON.parse(`[{"question": "How do you say: I want coffee?", "options": [{"text": "Я хочу каву.", "correct": true}, {"text": "Я хочу кава.", "correct": false}, {"text": "Я хочу каві.", "correct": false}, {"text": "Я хочу кавою.", "correct": false}], "explanation": "Кава is a feminine noun. In the accusative case (after want/love), the ending -а changes to -у."}, {"question": "How do you say: I want water?", "options": [{"text": "Я хочу воду.", "correct": true}, {"text": "Я хочу вода.", "correct": false}, {"text": "Я хочу воді.", "correct": false}, {"text": "Я хочу водою.", "correct": false}], "explanation": "Вода is a feminine noun. In the accusative case, the ending -а changes to -у."}, {"question": "How do you say: I want tea?", "options": [{"text": "Я хочу чай.", "correct": true}, {"text": "Я хочу чаю.", "correct": false}, {"text": "Я хочу чая.", "correct": false}, {"text": "Я хочу чаєм.", "correct": false}], "explanation": "Чай is a masculine noun. Masculine inanimate nouns do not change their ending in the accusative case."}, {"question": "How do you say: I love borscht?", "options": [{"text": "Я люблю борщ.", "correct": true}, {"text": "Я люблю борщу.", "correct": false}, {"text": "Я люблю борща.", "correct": false}, {"text": "Я люблю борщем.", "correct": false}], "explanation": "Борщ is a masculine inanimate noun and does not change."}, {"question": "How do you say: I do not eat meat?", "options": [{"text": "Я не їм м'ясо.", "correct": true}, {"text": "Я їм не м'ясо.", "correct": false}, {"text": "Я не м'ясо їм.", "correct": false}, {"text": "Не я їм м'ясо.", "correct": false}], "explanation": "The negative particle не goes before the verb."}, {"question": "How do you say: I do not drink milk?", "options": [{"text": "Я не п'ю молоко.", "correct": true}, {"text": "Я п'ю не молоко.", "correct": false}, {"text": "Я не молоко п'ю.", "correct": false}, {"text": "Не я п'ю молоко.", "correct": false}], "explanation": "The negative particle не goes before the verb."}, {"question": "How do you say: I have an allergy to nuts?", "options": [{"text": "У мене алергія на горіхи.", "correct": true}, {"text": "Я алергія на горіхи.", "correct": false}, {"text": "Я не їм горіхи.", "correct": false}, {"text": "Мій горіхи алергія.", "correct": false}], "explanation": "Use the phrase: У мене алергія на..."}, {"question": "What does Я люблю рибу mean?", "options": [{"text": "I love fish.", "correct": true}, {"text": "I eat fish.", "correct": false}, {"text": "I do not like fish.", "correct": false}, {"text": "I want fish.", "correct": false}], "explanation": "Рибу is the accusative form of риба (fish)."}, {"question": "How do you say: I want juice?", "options": [{"text": "Я хочу сік.", "correct": true}, {"text": "Я хочу соку.", "correct": false}, {"text": "Я хочу сока.", "correct": false}, {"text": "Я хочу сіка.", "correct": false}], "explanation": "Сік is masculine and does not change."}, {"question": "How do you say: I eat fresh bread?", "options": [{"text": "Я їм свіжий хліб.", "correct": true}, {"text": "Я їм свіжу хліб.", "correct": false}, {"text": "Я їм свіже хліб.", "correct": false}, {"text": "Я їм свіжі хліб.", "correct": false}], "explanation": "Хліб is masculine and does not change."}]`)} />

### Complete the Sentences

<FillIn client:load items={JSON.parse(`[{"sentence": "Мама готує смачний ___.", "answer": "борщ", "options": ["борщ", "вода", "кава", "каша"]}, {"sentence": "Я хочу гарячу ___.", "answer": "каву", "options": ["каву", "борщ", "суп", "чай"]}, {"sentence": "На столі лежить свіжий ___.", "answer": "хліб", "options": ["хліб", "вода", "риба", "кава"]}, {"sentence": "Я не п'ю ___.", "answer": "молоко", "options": ["молоко", "м'ясо", "хліб", "каша"]}, {"sentence": "Діти дуже люблять солодкі ___.", "answer": "фрукти", "options": ["фрукти", "овочі", "суп", "борщ"]}, {"sentence": "Я хочу холодну ___.", "answer": "воду", "options": ["воду", "каву", "чай", "сік"]}, {"sentence": "У мене алергія на ___.", "answer": "молоко", "options": ["молоко", "суп", "борщ", "вода"]}, {"sentence": "Я люблю смажену ___.", "answer": "рибу", "options": ["рибу", "борщ", "суп", "хліб"]}]`)} />

### Food or Drink?

<GroupSort client:load groups={JSON.parse(`{"Їжа": ["хліб", "борщ", "суп", "сир", "м'ясо", "каша", "риба"], "Напої": ["вода", "кава", "чай", "сік", "компот", "молоко"]}`)} />

### True or False?

<TrueFalse client:load items={JSON.parse(`[{"statement": "The word суп (soup) is a masculine noun in Ukrainian.", "isTrue": true, "explanation": "Суп ends in a hard consonant, which means it is masculine."}, {"statement": "In Ukrainian culture, soup is considered a drink.", "isTrue": false, "explanation": "Soup is thick and hearty, so Ukrainians always say they eat (їсти) soup, not drink it."}, {"statement": "The phrase Я не їм means I do not eat.", "isTrue": true, "explanation": "The negative particle не is placed directly before the verb."}, {"statement": "When ordering water, you should say Я хочу вода.", "isTrue": false, "explanation": "Вода is feminine, so you must use the accusative case and say Я хочу воду."}, {"statement": "Сало is a type of sweet fruit compote.", "isTrue": false, "explanation": "Сало is traditional cured fat. Компот is a fruit drink."}, {"statement": "When offering bread to a guest, it is traditionally accompanied by salt.", "isTrue": true, "explanation": "Bread and salt (хліб-сіль) is a traditional symbol of hospitality and friendship."}, {"statement": "The word паляниця is very easy for foreigners to pronounce.", "isTrue": false, "explanation": "Паляниця is famously difficult to pronounce for non-native speakers because of its soft sounds and specific vowels."}, {"statement": "Я люблю is used to express that you like or love a certain food.", "isTrue": true, "explanation": "This verb is naturally used to describe your favorite meals."}]`)} />

### Phrases and Translation

<MatchUp client:load pairs={JSON.parse(`[{"left": "Я хочу воду", "right": "I want water"}, {"left": "Я люблю каву", "right": "I love coffee"}, {"left": "Я не їм м'ясо", "right": "I do not eat meat"}, {"left": "Я не п'ю молоко", "right": "I do not drink milk"}, {"left": "Свіжий хліб", "right": "Fresh bread"}, {"left": "Гарячий суп", "right": "Hot soup"}, {"left": "Холодна вода", "right": "Cold water"}, {"left": "Смачна риба", "right": "Delicious fish"}]`)} />

### Sentence Builder

<Unjumble client:load items={JSON.parse(`[{"jumbled": "Я / хочу / гарячу / каву", "answer": "Я хочу гарячу каву"}, {"jumbled": "У / мене / алергія / на / молоко", "answer": "У мене алергія на молоко"}, {"jumbled": "Я / не / їм / свіже / м'ясо", "answer": "Я не їм свіже м'ясо"}, {"jumbled": "Ми / їмо / смачний / український / борщ", "answer": "Ми їмо смачний український борщ"}, {"jumbled": "Вона / дуже / любить / солодкі / фрукти", "answer": "Вона дуже любить солодкі фрукти"}, {"jumbled": "Я / хочу / холодну / воду", "answer": "Я хочу холодну воду"}]`)} />

### Identify the Gender

<Quiz client:load questions={JSON.parse(`[{"question": "Which word is masculine?", "options": [{"text": "суп", "correct": true}, {"text": "вода", "correct": false}, {"text": "м'ясо", "correct": false}, {"text": "каша", "correct": false}], "explanation": "Суп ends in a hard consonant."}, {"question": "Which word is feminine?", "options": [{"text": "риба", "correct": true}, {"text": "хліб", "correct": false}, {"text": "сало", "correct": false}, {"text": "сік", "correct": false}], "explanation": "Риба ends in а, which is typical for feminine nouns."}, {"question": "Which word is neuter?", "options": [{"text": "молоко", "correct": true}, {"text": "сир", "correct": false}, {"text": "борщ", "correct": false}, {"text": "кава", "correct": false}], "explanation": "Молоко ends in о, which is typical for neuter nouns."}, {"question": "Which word is masculine?", "options": [{"text": "сир", "correct": true}, {"text": "риба", "correct": false}, {"text": "вода", "correct": false}, {"text": "м'ясо", "correct": false}], "explanation": "Сир ends in a hard consonant."}, {"question": "Which word is feminine?", "options": [{"text": "вода", "correct": true}, {"text": "чай", "correct": false}, {"text": "компот", "correct": false}, {"text": "хліб", "correct": false}], "explanation": "Вода ends in а."}, {"question": "Which word is masculine?", "options": [{"text": "борщ", "correct": true}, {"text": "каша", "correct": false}, {"text": "риба", "correct": false}, {"text": "вода", "correct": false}], "explanation": "Борщ ends in a consonant."}, {"question": "Which word is feminine?", "options": [{"text": "кава", "correct": true}, {"text": "сік", "correct": false}, {"text": "чай", "correct": false}, {"text": "сир", "correct": false}], "explanation": "Кава ends in а."}, {"question": "Which word is neuter?", "options": [{"text": "сало", "correct": true}, {"text": "суп", "correct": false}, {"text": "риба", "correct": false}, {"text": "кава", "correct": false}], "explanation": "Сало ends in о."}]`)} />
...
- [More about food in Ukrainian](https://www.ukrainianlessons.com/episode13/)
- [Ordering food in Ukrainian](https://www.ukrainianlessons.com/episode12/)
- [Food festivals + Genitive case](https://www.ukrainianlessons.com/episode47/)
