...
<ErrorCorrection client:only='react' instruction="Choose the safer Ukrainian sentence.">
  <ErrorCorrectionItem sentence="Мій книга, мій ручка (якщо говорить чоловік)." errorWord="Мій книга, мій ручка (якщо говорить чоловік)." correctForm="Моя книга, моя ручка." options={JSON.parse(`["Моя книга, моя ручка.", "Мій книга, мій ручка."]`)} explanation="The possessive follows the nouns книга and ручка, not the speaker." />
  <ErrorCorrectionItem sentence="Мій книга тут." errorWord="Мій книга тут." correctForm="Моя книга тут." options={JSON.parse(`["Моя книга тут.", "Мій книга тут."]`)} explanation="Книга is feminine, so use моя." />
  <ErrorCorrectionItem sentence="Мій ручка там." errorWord="Мій ручка там." correctForm="Моя ручка там." options={JSON.parse(`["Моя ручка там.", "Мій ручка там."]`)} explanation="Ручка is feminine, so use моя." />
  <ErrorCorrectionItem sentence="Де стіл? — Воно там. (Where is the table? — It is there.)" errorWord="Де стіл? — Воно там. (Where is the table? — It is there.)" correctForm="Де стіл? — Він там." options={JSON.parse(`["Де стіл? — Він там.", "Де стіл? — Воно там."]`)} explanation="Стіл is masculine, so the pronoun is він." />
  <ErrorCorrectionItem sentence="Це моя тато." errorWord="Це моя тато." correctForm="Це мій тато." options={JSON.parse(`["Це мій тато.", "Це моя тато."]`)} explanation="Тато is masculine." />
  <ErrorCorrectionItem sentence="Вона Микола." errorWord="Вона Микола." correctForm="Він Микола." options={JSON.parse(`["Він Микола.", "Вона Микола."]`)} explanation="Микола is a masculine name." />
  <ErrorCorrectionItem sentence="Моя собака дуже гарна." errorWord="Моя собака дуже гарна." correctForm="Мій собака дуже гарний." options={JSON.parse(`["Мій собака дуже гарний.", "Моя собака дуже гарна."]`)} explanation="Собака is masculine in Ukrainian; memorize мій собака." />
  <ErrorCorrectionItem sentence="Я є студент." errorWord="Я є студент." correctForm="Я студент." options={JSON.parse(`["Я студент.", "Я є студент."]`)} explanation="Present identity normally omits є." />
  <ErrorCorrectionItem sentence="Моє ім'я є Джон." errorWord="Моє ім'я є Джон." correctForm="Мене звати Джон." options={JSON.parse(`["Мене звати Джон.", "Моє ім'я є Джон."]`)} explanation="Мене звати... is the safe name chunk." />
</ErrorCorrection>
