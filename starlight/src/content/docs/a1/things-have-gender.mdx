...
<RuleBox title="Правило: gender by ending">
  <table>
    <thead>
      <tr>
        <th>Рід</th>
    ...
    <tbody>
      <tr>
        <td><span class="gender-m">Чоловічий (м)</span></td>
        <td>consonant ending</td>
        <td><strong>він</strong>, <strong>мій</strong></td>
        <td><strong>стіл</strong>, <strong>телефон</strong>, <strong>зошит</strong>, <strong>ключ</strong></td>
      </tr>
      <tr>
        <td><span class="gender-f">Жіночий (ж)</span></td>
        <td><strong>-а / -я</strong></td>
        <td><strong>вона</strong>, <strong>моя</strong></td>
        <td><strong>книга</strong>, <strong>лампа</strong>, <strong>кімната</strong>, <strong>ручка</strong></td>
      </tr>
      <tr>
        <td><span class="gender-n">Середній (с)</span></td>
        <td><strong>-о / -е</strong></td>
        <td><strong>воно</strong>, <strong>моє</strong></td>
        <td><strong>вікно</strong>, <strong>ліжко</strong>, <strong>дзеркало</strong>, <strong>море</strong></td>
      </tr>
    </tbody>
  </table>
</RuleBox>
...
<ObserveBox
  title="Порівняйте"
  pairs={[
    { left: "<strong>мій</strong> стіл", right: "стіл ends in <strong>-л</strong> (consonant)" },
    { left: "<strong>моя</strong> книга", right: "книга ends in <strong>-а</strong>" },
    { left: "<strong>моє</strong> вікно", right: "вікно ends in <strong>-о</strong>" },
  ]}
  question="What pattern do you see between the noun ending and the gender-test word?"
/>
...
dialogue first, then use the English support in each line to check meaning.

<Dialogue
  title="At the window"
  lines={[
    { speaker: "Марія", uk: "Привіт! Дивись, це моя кімната.", trans: "Hi! Look, this is my room." },
    { speaker: "Оленка", uk: "Класно! У тебе є стіл?", trans: "Cool! Do you have a table?" },
    { speaker: "Марія", uk: "Так, у мене є стіл і ліжко.", trans: "Yes, I have a table and a bed." },
    { speaker: "Оленка", uk: "А це твоя лампа?", trans: "And is this your lamp?" },
    { speaker: "Марія", uk: "Так. Це моя лампа. Вона тут.", trans: "Yes. This is my lamp. It is here." },
    { speaker: "Оленка", uk: "А вікно?", trans: "And the window?" },
    { speaker: "Марія", uk: "Ось воно. Моє вікно велике.", trans: "Here it is. My window is big." },
  ]}
/>
...
<Dialogue
  title="In the bag"
  lines={[
    { speaker: "Оленка", uk: "Що у тебе є?", trans: "What do you have?" },
    { speaker: "Марія", uk: "У мене є книга, телефон і фото.", trans: "I have a book, a phone, and a photo." },
    { speaker: "Оленка", uk: "А у мене є ручка і зошит.", trans: "And I have a pen and a notebook." },
  ]}
/>
