...
<ErrorCorrection client:only='react' instruction="Choose the safer Ukrainian line.">
  <ErrorCorrectionItem sentence="Моє ім'я є Джон." errorWord="Моє ім'я є Джон." correctForm="Мене звати Джон." options={JSON.parse(`["Мене звати Джон.", "Моє ім'я є Джон."]`)} explanation="Мене звати... is the natural first-introduction model." />
  <ErrorCorrectionItem sentence="Я маю 20 років." errorWord="Я маю 20 років." correctForm="Мені 20 років." options={JSON.parse(`["Мені 20 років.", "Я маю 20 років."]`)} explanation="Age uses the chunk Мені ... років." />
  <ErrorCorrectionItem sentence="Це мій мама." errorWord="Це мій мама." correctForm="Це моя мама." options={JSON.parse(`["Це моя мама.", "Це мій мама."]`)} explanation="Мама is feminine, so use моя." />
  <ErrorCorrectionItem sentence="Я є брат." errorWord="Я є брат." correctForm="Я брат." options={JSON.parse(`["Я брат.", "Я є брат."]`)} explanation="Present-time identity can omit є." />
  <ErrorCorrectionItem sentence="Батьки (у значенні батька)" errorWord="Батьки (у значенні батька)" correctForm="Тато / батько" options={JSON.parse(`["Тато / батько", "Батьки"]`)} explanation="Батьки means parents, not one father." />
  <ErrorCorrectionItem sentence="Чия це? (про брата)" errorWord="Чия це? (про брата)" correctForm="Чий це брат?" options={JSON.parse(`["Чий це брат?", "Чия це?"]`)} explanation="Брат is masculine, so the question word is чий." />
</ErrorCorrection>
