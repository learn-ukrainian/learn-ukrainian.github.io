...
Distinguishing between **И** and **І** is not just about having a nice accent; it is a critical phonemic distinction that changes the meaning of words. The State Standard explicitly highlights the difference between hard and soft consonants, which these vowels often follow.
...
Let us practice the distinction between these two key vowels in a controlled environment. The difference is subtle for English speakers but enormous for Ukrainians.
...
You have also learned to navigate "trap letters" that visually mimic Latin letters but carry different sounds, and you understand the crucial phonetic distinction between the deep **И** and the sharp **І**. In our next module, The Cyrillic Code III, we will maintain this momentum by introducing voiced and voiceless consonant pairs, giving you even more reading power.
...
<WatchAndRepeat client:load items={JSON.parse(`[{"video": "https://www.youtube.com/watch?v=J7sGEI4-xJo", "letter": "К", "word": "кіт"}, {"video": "https://www.youtube.com/watch?v=W-1rCu0indE", "letter": "И", "word": "риба"}, {"video": "https://www.youtube.com/watch?v=fMGsQ5KPQgg", "letter": "Р", "word": "рука"}, {"video": "https://www.youtube.com/watch?v=V1hxBE_JbGg", "letter": "Б", "word": "банан"}, {"video": "https://www.youtube.com/watch?v=aFcvYfvQ2X4", "letter": "В", "word": "вода"}, {"video": "https://www.youtube.com/watch?v=g4Bh-lqzd48", "letter": "Д", "word": "дім"}, {"video": "https://www.youtube.com/watch?v=Z9TH0H4ShGo", "letter": "І", "word": "кіно"}, {"video": "https://www.youtube.com/watch?v=QT3c1TiZZgk", "letter": "О", "word": "молоко"}]`)} title="Watch and Repeat" />

### Vowels and Consonants

<Classify client:load categories={JSON.parse(`[{"label": "Голосні (Vowels)", "items": ["И", "І", "О"]}, {"label": "Приголосні (Consonants)", "items": ["К", "Р", "Б", "В", "Д"]}]`)} title="Vowels and Consonants" instruction="Sort the new letters into vowels and consonants." />

### First Sound

<ImageToLetter client:load items={JSON.parse(`[{"emoji": "🐱", "answer": "К", "distractors": ["Р", "Б"]}, {"emoji": "🍌", "answer": "Б", "distractors": ["В", "Д"]}, {"emoji": "🐺", "answer": "В", "distractors": ["Б", "Р"]}, {"emoji": "🏠", "answer": "Д", "distractors": ["К", "Б"]}, {"emoji": "🐟", "answer": "Р", "distractors": ["К", "Д"]}, {"emoji": "🥛", "answer": "О", "distractors": ["И", "І"]}, {"emoji": "🖐️", "answer": "Р", "distractors": ["В", "Б"]}, {"emoji": "👩", "answer": "М", "distractors": ["Н", "К"]}]`)} title="First Sound" />

### Letter to Word Match

<MatchUp client:load pairs={JSON.parse(`[{"left": "К", "right": "кіт"}, {"left": "Р", "right": "рука"}, {"left": "Б", "right": "банан"}, {"left": "В", "right": "вода"}, {"left": "Д", "right": "дім"}, {"left": "И", "right": "риба"}, {"left": "І", "right": "кіно"}, {"left": "О", "right": "молоко"}]`)} />

### Sound Recognition

<Quiz client:load questions={JSON.parse(`[{"question": "Which Cyrillic letter looks like a Latin P but sounds like a rolled R?", "options": [{"text": "Р", "correct": true}, {"text": "П", "correct": false}, {"text": "В", "correct": false}, {"text": "К", "correct": false}], "explanation": "The letter Р is a visual trap; it makes the rolled r sound."}, {"question": "Which Cyrillic letter looks like a Latin B but makes a v sound?", "options": [{"text": "В", "correct": true}, {"text": "Б", "correct": false}, {"text": "Р", "correct": false}, {"text": "Д", "correct": false}], "explanation": "The letter В looks like a B but sounds like a v or w."}, {"question": "What is the key difference between the vowels И and І?", "options": [{"text": "И is deep and hard, while І is high and soft", "correct": true}, {"text": "И is high and soft, while І is deep and hard", "correct": false}, {"text": "И sounds like o, while І sounds like a", "correct": false}, {"text": "И sounds like ee, while І sounds like u", "correct": false}], "explanation": "И is deep and relaxed, while І is high, sharp, and smiling."}, {"question": "Does the unstressed Ukrainian letter О ever reduce to an a sound?", "options": [{"text": "No, it always maintains a pure o sound", "correct": true}, {"text": "Yes, it always reduces to an a sound", "correct": false}, {"text": "Only at the end of a word", "correct": false}, {"text": "Only when followed by a consonant", "correct": false}], "explanation": "In Ukrainian, the unstressed О maintains a pure o sound and never reduces."}, {"question": "Which letter provides the bright, smiling sound in the word кіно?", "options": [{"text": "І", "correct": true}, {"text": "И", "correct": false}, {"text": "О", "correct": false}, {"text": "К", "correct": false}], "explanation": "The dotted І gives кіно its sharp, smiling ee sound."}, {"question": "Which consonant requires an active tongue-tip trill to pronounce correctly?", "options": [{"text": "Р", "correct": true}, {"text": "Д", "correct": false}, {"text": "К", "correct": false}, {"text": "В", "correct": false}], "explanation": "The letter Р requires a trill from the tip of your tongue."}, {"question": "Which letter represents the d sound, resembling a small house on legs?", "options": [{"text": "Д", "correct": true}, {"text": "Б", "correct": false}, {"text": "В", "correct": false}, {"text": "К", "correct": false}], "explanation": "The letter Д looks like a house and makes a d sound."}, {"question": "Which word correctly begins with the Cyrillic letter for the b sound?", "options": [{"text": "банан", "correct": true}, {"text": "вода", "correct": false}, {"text": "рука", "correct": false}, {"text": "кіт", "correct": false}], "explanation": "The word банан begins with the letter Б."}, {"question": "Which of the following letters is entirely phonetic friends with its English equivalent?", "options": [{"text": "К", "correct": true}, {"text": "Р", "correct": false}, {"text": "В", "correct": false}, {"text": "И", "correct": false}], "explanation": "The letter К looks and sounds exactly like the English K."}, {"question": "How should you physically prepare your mouth to pronounce the letter И?", "options": [{"text": "Keep the jaw relaxed and slightly dropped", "correct": true}, {"text": "Pull the lips back into a wide smile", "correct": false}, {"text": "Round the lips forward in a tight circle", "correct": false}, {"text": "Bite the bottom lip lightly", "correct": false}], "explanation": "For the deep И sound, your jaw should be relaxed and slightly pulled back."}]`)} />

### Fact Check

<TrueFalse client:load items={JSON.parse(`[{"statement": "The Cyrillic letter Р represents the p sound in Ukrainian.", "isTrue": false, "explanation": "The letter Р is a rolled r sound."}, {"statement": "The Ukrainian letter В makes a sound similar to the English v.", "isTrue": true, "explanation": "The letter В looks like a B but sounds like a v or w."}, {"statement": "The unstressed letter О in the word молоко sounds exactly like an a.", "isTrue": false, "explanation": "In Ukrainian, the letter О maintains its pure o sound even when unstressed."}, {"statement": "The letter Д represents the d sound and looks like a small house.", "isTrue": true, "explanation": "Yes, Д makes the d sound and resembles a house."}, {"statement": "To pronounce the letter І, you should pull your lips into a smile.", "isTrue": true, "explanation": "The dotted І is a high, sharp sound that requires smiling lips."}, {"statement": "The letter И is pronounced exactly like the English letter ee.", "isTrue": false, "explanation": "И is a deep, relaxed sound, not a sharp ee sound."}, {"statement": "The word вода starts with the Cyrillic letter В.", "isTrue": true, "explanation": "Вода begins with В, which sounds like v."}, {"statement": "The letter Б looks exactly like the English B.", "isTrue": false, "explanation": "The letter В looks like an English B. The letter Б looks like a 6 with a flat top."}]`)} />

### Unscramble the Words

<Anagram client:load items={JSON.parse(`[{"scrambled": "і к т", "answer": "кіт", "hint": ""}, {"scrambled": "о д а в", "answer": "вода", "hint": ""}, {"scrambled": "і д м", "answer": "дім", "hint": ""}, {"scrambled": "у к а р", "answer": "рука", "hint": ""}, {"scrambled": "о н і к", "answer": "кіно", "hint": ""}, {"scrambled": "н а б а н", "answer": "банан", "hint": ""}, {"scrambled": "о к о м л о", "answer": "молоко", "hint": ""}, {"scrambled": "и в с а л", "answer": "слива", "hint": ""}]`)} />

### Complete the Words

<FillIn client:load items={JSON.parse(`[{"sentence": "The Ukrainian word for water (вода) starts with the letter ___.", "answer": "в", "options": ["в", "б", "р", "к"]}, {"sentence": "The Ukrainian word for cat (кіт) uses the vowel ___.", "answer": "і", "options": ["і", "и", "о", "а"]}, {"sentence": "The Ukrainian word for banana (банан) starts with the letter ___.", "answer": "б", "options": ["б", "в", "д", "р"]}, {"sentence": "The Ukrainian word for house (дім) starts with the letter ___.", "answer": "д", "options": ["д", "к", "б", "м"]}, {"sentence": "The Ukrainian word for hand or arm (рука) starts with the letter ___.", "answer": "р", "options": ["р", "в", "п", "к"]}, {"sentence": "The Ukrainian word for milk (молоко) uses the pure vowel ___.", "answer": "о", "options": ["о", "а", "и", "і"]}, {"sentence": "The Ukrainian word for cinema (кіно) uses the dotted vowel ___.", "answer": "і", "options": ["і", "и", "о", "у"]}, {"sentence": "The Ukrainian word for fish (риба) uses the vowel ___.", "answer": "и", "options": ["и", "і", "а", "о"]}]`)} />

### Unscramble the Short Words

<Anagram client:load items={JSON.parse(`[{"scrambled": "а м а м", "answer": "мама", "hint": ""}, {"scrambled": "и с н", "answer": "син", "hint": ""}, {"scrambled": "а к м", "answer": "мак", "hint": ""}, {"scrambled": "и р с", "answer": "рис", "hint": ""}, {"scrambled": "р б а т", "answer": "брат", "hint": ""}, {"scrambled": "в о к в", "answer": "вовк", "hint": ""}, {"scrambled": "о л с в о", "answer": "слово", "hint": ""}, {"scrambled": "а к в а", "answer": "кава", "hint": ""}]`)} />

### Sort by Letter: В vs Б

<GroupSort client:load groups={JSON.parse(`{"Words with В (v-sound)": ["вода", "вовк", "нива", "слива", "кава", "слово"], "Words with Б (b-sound)": ["банан", "риба", "баба", "брат", "банк", "бар"]}`)} />
