...
<Quiz client:only="react" questions={[{"question": "You see a car crash.", "options": [{"text": "Тут аварія! Викличте швидку!", "correct": true}, {"text": "Тут пожежа! Допоможіть!", "correct": false}, {"text": "Я загубив паспорт.", "correct": false}]}, {"question": "You see a building on fire.", "options": [{"text": "Тут аварія!", "correct": false}, {"text": "Тут пожежа! Допоможіть!", "correct": true}, {"text": "Мені потрібен лікар.", "correct": false}]}, {"question": "Someone is feeling very ill on the street.", "options": [{"text": "Людині погано! Викличте швидку!", "correct": true}, {"text": "Викличте поліцію!", "correct": false}, {"text": "Я загубив паспорт.", "correct": false}]}, {"question": "You cannot find your passport at the airport.", "options": [{"text": "Тут аварія!", "correct": false}, {"text": "Мені потрібна швидка.", "correct": false}, {"text": "Я загубив паспорт.", "correct": true}]}, {"question": "Someone stole your wallet.", "options": [{"text": "Тут пожежа!", "correct": false}, {"text": "Викличте поліцію! Допоможіть!", "correct": true}, {"text": "Мені потрібен лікар.", "correct": false}]}, {"question": "Your arm is hurting at the hospital.", "options": [{"text": "Тут аварія!", "correct": false}, {"text": "Я загубив паспорт.", "correct": false}, {"text": "Мені потрібен лікар.", "correct": true}]}]} instruction={"Оберіть правильну фразу для ситуації (Choose the correct phrase for the situation)"} />
...
<FillIn client:only="react" items={[{"sentence": "Алло! ____! Тут аварія!", "answer": "Допоможіть", "options": ["Допоможіть", "Дякую", "Вибачте"]}, {"sentence": "____ швидку допомогу!", "answer": "Викличте", "options": ["Викличте", "Загубив", "Потрібен"]}, {"sentence": "Я на ____ Хрещатик, біля метро.", "answer": "вулиці", "options": ["вулиці", "лікарні", "поліції"]}, {"sentence": "Мене ____ Адам.", "answer": "звати", "options": ["звати", "прізвище", "адреса"]}, {"sentence": "Мій номер ____ — нуль дев'яносто три...", "answer": "телефону", "options": ["телефону", "паспорта", "будинку"]}, {"sentence": "Мені потрібна ____!", "answer": "допомога", "options": ["допомога", "пожежа", "аварія"]}]} instruction={"Вставте правильне слово (Fill in the correct word)"} />

<Order client:only="react" items={["— Служба порятунку, слухаю вас.", "— Допоможіть! Тут пожежа!", "— Де ви?", "— На вулиці Шевченка, будинок п'ять.", "— Зрозуміло. Швидка і пожежники вже їдуть. Як вас звати?", "— Мене звати Анна. Дякую!"]} correct_order={[0, 1, 2, 3, 4, 5]} instruction={"Розставте репліки в правильному порядку (Put the dialogue lines in the correct order)"} />
...
<MatchUp client:only="react" pairs={[{"left": "Тут аварія!", "right": "car crash"}, {"left": "Тут пожежа!", "right": "fire"}, {"left": "Мені потрібен лікар.", "right": "at the hospital"}, {"left": "Викличте поліцію!", "right": "call the police"}, {"left": "Я загубив паспорт.", "right": "lost document"}, {"left": "Людині погано!", "right": "someone feels ill"}]} instruction={"З'єднайте фразу з ситуацією (Match the phrase to the situation)"} />

<GroupSort client:only="react" groups={{"Екстрені фрази (Emergency phrases)": ["Допоможіть!", "Тут аварія!", "Тут пожежа!", "Викличте швидку!", "Людині погано!", "Викличте поліцію!"], "Особиста інформація (Personal info)": ["Мене звати...", "Моє прізвище...", "Мій номер телефону...", "Я загубив паспорт.", "Моя адреса...", "Я з Канади."]}} instruction={"Розподіліть фрази за категоріями (Sort the phrases by category)"} />

<TrueFalse client:only="react" items={[{"statement": "В Україні є один номер для всіх служб порятунку — 112.", "isTrue": true, "explanation": "112 (один один два) is Ukraine's universal emergency number connecting you to ambulance, police, and fire services."}, {"statement": "Адам бачить аварію і телефонує до поліції.", "isTrue": false, "explanation": "Адам calls служба порятунку (emergency rescue service) — the 112 operator dispatches the ambulance, not the police."}, {"statement": "Оператор спочатку запитує «Де ви?», а потім ім'я.", "isTrue": true, "explanation": "Location comes first — the operator must know where to send help before asking for personal details."}, {"statement": "Адам загубив паспорт у готелі.", "isTrue": false, "explanation": "Адам says 'Може, в метро' — maybe in the metro. He does not know exactly where he lost it."}, {"statement": "У лікарні треба сказати «У мене алергія на...», якщо є алергія.", "isTrue": true, "explanation": "Always tell medical staff about allergies. Use 'У мене алергія на...' followed by the allergen (e.g., ці таблетки, горіхи)."}, {"statement": "Адам загубив телефон, а не паспорт.", "isTrue": false, "explanation": "Адам lost his passport (паспорт). He reports this at the поліція (police station)."}]} instruction={"Правда чи ні? (True or false?)"} />

<Unjumble client:only="react" items={[{"words": "Допоможіть! / Викличте / швидку!", "answer": "Допоможіть! Викличте швидку!", "hint": "Two urgent commands together"}, {"words": "потрібен / Мені / лікар.", "answer": "Мені потрібен лікар.", "hint": "Dative + потрібен + noun"}, {"words": "аварія! / Тут", "answer": "Тут аварія!", "hint": "Location word first"}, {"words": "паспорт. / загубив / Я", "answer": "Я загубив паспорт.", "hint": "Subject + verb + object"}, {"words": "ласка. / Повторіть, / будь", "answer": "Повторіть, будь ласка.", "hint": "Imperative + будь ласка"}, {"words": "телефону / Мій / номер", "answer": "Мій номер телефону", "hint": "Possessive + noun + genitive"}]} instruction={"Складіть правильне речення зі слів (Put the words in the correct order)"} />

<Translate client:only="react" questions={[{"source": "Help!", "options": [{"text": "Допоможіть!", "correct": true}, {"text": "Дякую!", "correct": false}, {"text": "Вибачте!", "correct": false}]}, {"source": "Call an ambulance!", "options": [{"text": "Викличте поліцію!", "correct": false}, {"text": "Викличте швидку!", "correct": true}, {"text": "Тут аварія!", "correct": false}]}, {"source": "I lost my passport.", "options": [{"text": "Я загубив паспорт.", "correct": true}, {"text": "Я загубила форму.", "correct": false}, {"text": "Я не розумію.", "correct": false}]}, {"source": "There's a fire here!", "options": [{"text": "Тут аварія!", "correct": false}, {"text": "Людині погано!", "correct": false}, {"text": "Тут пожежа!", "correct": true}]}, {"source": "I need a doctor.", "options": [{"text": "Мені потрібна допомога.", "correct": false}, {"text": "Мені потрібен лікар.", "correct": true}, {"text": "Повторіть, будь ласка.", "correct": false}]}, {"source": "Please repeat.", "options": [{"text": "Повторіть, будь ласка.", "correct": true}, {"text": "Говоріть повільніше, будь ласка.", "correct": false}, {"text": "Я не розумію.", "correct": false}]}]} instruction={"Оберіть правильний переклад (Choose the correct translation)"} />
