...
**Лікар:** Що у вас боли́ть? *(What hurts you?)*


**Пацієнт:** У мене́ болить голова́ і го́рло. *(My head and throat hurt.)*


**Лікар:** Давно́? *(For a long time?)*


**Пацієнт:** З учо́ра. І в мене температу́ра. *(Since yesterday. And I have a fever.)*
...
**Лікар:** Зрозумі́ло. Це засту́да. Я ви́пишу лі́ки. Відпочива́йте! *(I see. This is a cold. I will prescribe medicine. Rest!)*
...
**Фармацевт:** До́брий день! *(Good day!)*


**Клієнт:** Добрий день! У мене болить голова. Да́йте, будь ла́ска, табле́тки. *(Good day! My head hurts. Give me pills, please.)*


**Фармацевт:** Від головно́го бо́лю? *(For a headache?)*


**Клієнт:** Так. І від ка́шлю, будь ласка. *(Yes. And for a cough, please.)*


**Фармацевт:** Ось, будь ласка. Ще щось? *(Here you go. Anything else?)*


**Клієнт:** А є щось від не́житі? *(And is there anything for a runny nose?)*


**Фармацевт:** Так, ось кра́плі. *(Yes, here are drops.)*


**Клієнт:** Дякую! Скі́льки це ко́шту́є? *(Thank you! How much does this cost?)*
...
<FillIn client:only="react" instruction={"Знайди потрі́бне сло́во (At the pharmacy or doctor)"} items={[{"sentence": "Дайте, {будь ласка|добрий день|дякую}, таблетки від головного болю.", "answer": ""}, {"sentence": "Що у вас {болить|хворий|лікар}?", "answer": ""}, {"sentence": "У мене {температура|аптека|лікар} і болить горло.", "answer": ""}, {"sentence": "Ме́ні {погано|хворий|добре}. Ви́кличте лі́каря!", "answer": ""}, {"sentence": "Де тут найбли́жча {аптека|голова|спина}? Мені потрі́бні ліки.", "answer": ""}]} />
...
<MatchUp client:only="react" instruction={"У́твори па́ру (Match the body parts)"} pairs={[{"left": "голова", "right": "head"}, {"left": "живіт", "right": "stomach"}, {"left": "горло", "right": "throat"}, {"left": "спина", "right": "back"}, {"left": "рука", "right": "hand/arm"}, {"left": "нога", "right": "leg/foot"}, {"left": "зуб", "right": "tooth"}, {"left": "око", "right": "eye"}]} />
...
*   **Я хво́ра.** (I am sick. — spoken by a woman)
...
<FillIn client:only="react" instruction={"Обери́ правильне слово (Complete the symptom)"} items={[{"sentence": "У мене болить {голова|рука|нога}. Я хо́чу спа́ти.", "answer": ""}, {"sentence": "У мене болить {живіт|вухо|око}. Я не хочу ї́сти.", "answer": ""}, {"sentence": "У мене болить {горло|спина|ніс} і є температура. Я не мо́жу говори́ти.", "answer": ""}, {"sentence": "У мене {кашель|нежить|зуб}, я пості́йно ка́шляю.", "answer": ""}, {"sentence": "У мене болить {зуб|голова|нога}, мені потрі́бен стомато́лог.", "answer": ""}, {"sentence": "Я {хворий|лікар|аптека}. У мене болить голова і спина.", "answer": ""}]} />
...
<Quiz client:only="react" instruction={"Обери логі́чну ві́дповідь (Choose the logical response)"} questions={[{"question": "У мене болить голова.", "options": [{"text": "Ось таблетки від головного болю.", "correct": true}, {"text": "Ось краплі від нежиті.", "correct": false}, {"text": "Ви́пийте сиро́п від кашлю.", "correct": false}]}, {"question": "У мене си́льний кашель.", "options": [{"text": "Вам потрібні таблетки від кашлю.", "correct": true}, {"text": "Ось краплі для но́са.", "correct": false}, {"text": "У мене болить зуб.", "correct": false}]}, {"question": "Що у вас болить?", "options": [{"text": "У мене болить горло.", "correct": true}, {"text": "Я лікар.", "correct": false}, {"text": "Де аптека?", "correct": false}]}, {"question": "Добрий день. Дайте, будь ласка, щось від нежиті.", "options": [{"text": "Ось краплі, будь ласка.", "correct": true}, {"text": "У мене болить спина.", "correct": false}, {"text": "Це таблетки від головного болю.", "correct": false}]}]} />
...
| **живі́т** | stomach | ім. | ч. |
| **боли́ть** | hurts | дієсл. |  |
| **Давно́** | For a long time? | присл. |  |
| **тро́хи** | a little | присл. |  |
| **Зрозумі́ло** | I see | присл. |  |
| **засту́да** | cold | ім. | ж. |
| **лі́ки** | medicine | ім. |  |
...
| **вели́кий** | big | прикм. |  |
| **боля́ть** | hurt | дієсл. |  |
| **найбли́жча** | nearest | прикм. |  |
| **стомато́лог** | dentist | ім. | ч. |
| **сиро́п** | syrup | ім. | ч. |
| **пості́йно** | constantly | присл. |  |
...
| **Ви кашляєте?** | Are you coughing? |
| **Відпочивайте!** | Rest! |
| **від головного болю** | for a headache |
| **від кашлю** | for a cough |
| **від нежиті** | for a runny nose |
