...
| --- | --- | --- | --- | --- | --- |
| у |  | in, at (after consonant) | preposition |  |  |
| в |  | in, at (after vowel) | preposition |  |  |
| і |  | and (after consonant) | conjunction |  |  |
| й |  | and (after vowel) | conjunction |  |  |
| та |  | and (alternative) | conjunction |  |  |
| з |  | from, with (default) | preposition |  |  |
| із |  | from, with (before clusters) | preposition |  |  |
| зі |  | from, with (before sibilants) | preposition |  |  |
| мене |  | me (genitive) | pronoun |  |  |
| мною |  | me (instrumental) | pronoun |  |  |
| школа |  | school | noun | ж |  |
| Київ |  | Kyiv | noun | ч |  |
| Львів |  | Lviv | noun | ч |  |
| батько |  | father | noun | ч |  |
| мати |  | mother | noun | ж |  |
| евфонія |  | euphony | noun | ж |  |
| чергування |  | alternation | noun | с |  |
| приголосний |  | consonant | noun | ч |  |
| голосний |  | vowel | noun | ч |  |
| удень |  | in the daytime (after consonant) | adverb |  |  |
