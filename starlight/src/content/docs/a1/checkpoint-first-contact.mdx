...
<FillIn client:only='react' items={JSON.parse(`[{"sentence": "Моє ім'я є Джон.", "answer": "Мене звати Джон.", "options": ["Мене звати Джон.", "Моє ім'я є Джон."]}, {"sentence": "Я є студент.", "answer": "Я студент.", "options": ["Я студент.", "Я є студент."]}, {"sentence": "Я маю 20 років.", "answer": "Мені 20 років.", "options": ["Мені 20 років.", "Я маю 20 років."]}, {"sentence": "Привіт, Максим!", "answer": "Привіт, Максиме!", "options": ["Привіт, Максиме!", "Привіт, Максим!"]}, {"sentence": "Здрастуйте! Мене звати Оксана.", "answer": "Добрий день! Мене звати Оксана.", "options": ["Добрий день! Мене звати Оксана.", "Здрастуйте! Мене звати Оксана."]}, {"sentence": "Моя фамілія Сміт.", "answer": "Моє прізвище Сміт.", "options": ["Моє прізвище Сміт.", "Моя фамілія Сміт."]}, {"sentence": "Пока!", "answer": "До побачення!", "options": ["До побачення!", "Пока!"]}, {"sentence": "Ігнорування роду іменника", "answer": "Вивчення слова разом із його родом", "options": ["Вивчення слова разом із його родом", "Ігнорування роду іменника"]}]`)} />
