...
<FillIn client:only="react" items={[{"sentence": "— ___! Як справи?", "answer": "Привіт"}, {"sentence": "— ___. А у тебе?", "answer": "Добре"}, {"sentence": "— ___!", "answer": "Чудово"}, {"sentence": "— Добре, дякую! А у ___?", "answer": "тебе"}]} />
