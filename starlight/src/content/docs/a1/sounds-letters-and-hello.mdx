...
<Quiz client:only="react" questions={[{"question": "What do we hear and pronounce?", "options": [{"text": "звуки (sounds)", "correct": true}, {"text": "літери (letters)", "correct": false}, {"text": "слова́ (words)", "correct": false}]}, {"question": "What do we see and write?", "options": [{"text": "літери (letters)", "correct": true}, {"text": "звуки (sounds)", "correct": false}, {"text": "речення (sentences)", "correct": false}]}, {"question": "How many letters are in the Ukrainian alphabet?", "options": [{"text": "33", "correct": true}, {"text": "38", "correct": false}, {"text": "26", "correct": false}]}, {"question": "How many distinct sounds does Ukrainian have?", "options": [{"text": "38", "correct": true}, {"text": "33", "correct": false}, {"text": "32", "correct": false}]}, {"question": "What does the soft sign Ь do?", "options": [{"text": "Softens the consonant before it", "correct": true}, {"text": "Makes a vowel sound", "correct": false}, {"text": "Adds a pause between words", "correct": false}]}, {"question": "How many vowel sounds are there in Ukrainian?", "options": [{"text": "6", "correct": true}, {"text": "10", "correct": false}, {"text": "8", "correct": false}]}]} />
...
<MatchUp client:only="react" pairs={[{"left": "В", "right": "sounds like «v» in vest"}, {"left": "Н", "right": "sounds like «n» in no"}, {"left": "Р", "right": "a rolled «r»"}, {"left": "С", "right": "sounds like «s» in sun"}, {"left": "У", "right": "sounds like «oo» in moon"}, {"left": "Х", "right": "sounds like «ch» in loch"}]} />

## Приві́т! (Hello!)

Time for your first Ukrainian conversation. Imagine you are meeting a friend on the street in Kyiv. What do you say?

<DialogueBox client:only="react" exchanges={[{"speaker": "А", "text": "Привіт!"}, {"speaker": "Б", "text": "Привіт! Як спра́ви?"}, {"speaker": "А", "text": "До́бре! А у тебе́?"}, {"speaker": "Б", "text": "Чудо́во!"}]} />
...
<FillIn client:only="react" items={[{"sentence": "___! Як справи?", "answer": "Привіт"}, {"sentence": "Як справи? — ___, дякую.", "answer": "Добре"}, {"sentence": "А у ___?", "answer": "тебе"}, {"sentence": "Як справи? — ___!", "answer": "Чудово"}]} />
