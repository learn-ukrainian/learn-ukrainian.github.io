...
:::warning[⚠️ **Nominative vs Dative**]
...
:::note[🏺 **Public Transport Etiquette**]
...
:::info[ℹ️ **The Versatility of Давай**]
...
:::warning[⚠️ **Avoid Common Mistakes**]
...
| --- | --- | --- | --- | --- | --- |
| могти |  | to be able to (physically) | verb |  |  |
| вміти |  | to know how to (skill) | verb |  |  |
...
### Знайдіть відповідники: базовий словник

<MatchUp client:load pairs={JSON.parse(`[{"left": "подорож", "right": "journey"}, {"left": "стадіон", "right": "stadium"}, {"left": "автобусом", "right": "by bus"}, {"left": "наліво", "right": "to the left"}, {"left": "хобі", "right": "hobby"}, {"left": "запрошувати", "right": "to invite"}]`)} />

### Модальні дієслова: Могти чи Вміти?

<Quiz client:load questions={JSON.parse(`[{"question": "Яке дієслово ми використовуємо для опису фізичної можливості?", "options": [{"text": "могти", "correct": true}, {"text": "вміти", "correct": false}, {"text": "хотіти", "correct": false}, {"text": "треба", "correct": false}], "explanation": "Слово могти означає фізичну можливість або наявність часу."}, {"question": "Яке дієслово ми використовуємо для опису набутої навички?", "options": [{"text": "вміти", "correct": true}, {"text": "могти", "correct": false}, {"text": "повинен", "correct": false}, {"text": "можна", "correct": false}], "explanation": "Слово вміти означає навичку, якої ви навчилися."}, {"question": "Як правильно сказати, що ви знаєте, як грати на гітарі?", "options": [{"text": "Я вмію грати на гітарі.", "correct": true}, {"text": "Я можу грати на гітарі.", "correct": false}, {"text": "Мені треба грати на гітарі.", "correct": false}, {"text": "Я повинен грати на гітарі.", "correct": false}], "explanation": "Грати на гітарі — це навичка, тому ми використовуємо вміти."}, {"question": "Як сказати, що ви не маєте часу допомогти сьогодні?", "options": [{"text": "Я не можу допомогти сьогодні.", "correct": true}, {"text": "Я не вмію допомогти сьогодні.", "correct": false}, {"text": "Мені не можна допомогти сьогодні.", "correct": false}, {"text": "Я не повинен допомогти сьогодні.", "correct": false}], "explanation": "Брак часу — це зовнішня обставина, тому використовуємо не можу."}, {"question": "Яке слово означає загальну або сувору заборону для всіх людей?", "options": [{"text": "не можна", "correct": true}, {"text": "не можу", "correct": false}, {"text": "не вмію", "correct": false}, {"text": "не хочу", "correct": false}], "explanation": "Слово не можна використовується для заборон і правил."}, {"question": "Що ви скажете, якщо вам зараз занадто темно читати книгу?", "options": [{"text": "Я не можу читати.", "correct": true}, {"text": "Я не вмію читати.", "correct": false}, {"text": "Мені не можна читати.", "correct": false}, {"text": "Я не хочу читати.", "correct": false}], "explanation": "Темрява — це зовнішня обставина, тому ми кажемо не можу."}]`)} />

### Заповніть пропуски: Необхідність та обов'язок

<FillIn client:load items={JSON.parse(`[{"sentence": "Мені ____ купити квитки на автобус сьогодні.", "answer": "треба", "options": ["треба", "повинен", "хочу", "можеш"]}, {"sentence": "Він ____ працювати завтра рано вранці.", "answer": "повинен", "options": ["повинен", "треба", "хочуть", "вміємо"]}, {"sentence": "Ти ____ поїхати з нами в подорож?", "answer": "хочеш", "options": ["хочеш", "треба", "повинен", "вмієш"]}, {"sentence": "Нам ____ знайти правильну дорогу до стадіону.", "answer": "треба", "options": ["треба", "повинні", "хочемо", "може"]}, {"sentence": "Я ____ закінчити цю роботу якомога швидше.", "answer": "повинен", "options": ["повинен", "треба", "хоче", "можеш"]}, {"sentence": "Олені ____ повернутися додому в неділю ввечері.", "answer": "треба", "options": ["треба", "повинна", "хоче", "може"]}]`)} />

### Складіть речення: Накази та прохання

<Unjumble client:load items={JSON.parse(`[{"jumbled": "Скажіть / будь / ласка / де / автобус", "answer": "Скажіть, будь ласка, де автобус."}, {"jumbled": "Я / хочу / запросити / тебе / на / стадіон", "answer": "Я хочу запросити тебе на стадіон."}, {"jumbled": "Нам / треба / купити / квитки / на / автобус", "answer": "Нам треба купити квитки на автобус."}, {"jumbled": "Читай / цей / текст / дуже / швидко", "answer": "Читай цей текст дуже швидко."}, {"jumbled": "Дайте / мені / квиток / будь / ласка", "answer": "Дайте мені квиток, будь ласка."}]`)} />

### Розподіліть форми наказового способу

<GroupSort client:load groups={JSON.parse(`{"Форма Ти (неформальна)": ["читай", "пиши", "скажи", "дай", "іди"], "Форма Ви (формальна або множина)": ["слухайте", "дивіться", "стійте", "читайте", "скажіть"]}`)} />

### Перевірте знання: Транспорт та напрямки

<Quiz client:load questions={JSON.parse(`[{"question": "В якому граматичному відмінку стоїть слово у фразі їхати автобусом?", "options": [{"text": "в орудному відмінку", "correct": true}, {"text": "в давальному відмінку", "correct": false}, {"text": "у місцевому відмінку", "correct": false}, {"text": "у знахідному відмінку", "correct": false}], "explanation": "Для транспорту ми використовуємо орудний відмінок без прийменника."}, {"question": "Як правильно сказати, що ви подорожуєте на великому поїзді?", "options": [{"text": "Я їду поїздом.", "correct": true}, {"text": "Я їду поїзд.", "correct": false}, {"text": "Мені треба поїзд.", "correct": false}, {"text": "Я їду на поїзд.", "correct": false}], "explanation": "Транспорт завжди потребує орудного відмінка: поїздом."}, {"question": "Що вам скажуть люди, якщо вам треба йти прямо?", "options": [{"text": "Ідіть прямо по вулиці.", "correct": true}, {"text": "Ідіть направо по вулиці.", "correct": false}, {"text": "Ідіть наліво по вулиці.", "correct": false}, {"text": "Стійте прямо по вулиці.", "correct": false}], "explanation": "Прямо означає рух вперед по прямій лінії."}, {"question": "Як ввічливо попросити незнайому людину показати вам правильну дорогу?", "options": [{"text": "Скажіть, будь ласка, де станція?", "correct": true}, {"text": "Пишіть, будь ласка, де станція?", "correct": false}, {"text": "Читай, де станція?", "correct": false}, {"text": "Іди, де станція?", "correct": false}], "explanation": "Ми використовуємо ввічливу форму Ви та слово будь ласка."}, {"question": "Яке слово ми використовуємо, коли пропонуємо другу піти кудись разом?", "options": [{"text": "Ходімо!", "correct": true}, {"text": "Стійте!", "correct": false}, {"text": "Дайте!", "correct": false}, {"text": "Дивись!", "correct": false}], "explanation": "Ходімо — це популярна фраза для дружнього запрошення."}, {"question": "Як правильно описати напрямок руху, якщо ви повертаєте ліворуч?", "options": [{"text": "Автобус повертає наліво.", "correct": true}, {"text": "Автобус повертає направо.", "correct": false}, {"text": "Автобус повертає прямо.", "correct": false}, {"text": "Автобус їде автобусом.", "correct": false}], "explanation": "Слово наліво означає рух у лівий бік."}]`)} />

### Заповніть пропуски: Повсякденне життя

<FillIn client:load items={JSON.parse(`[{"sentence": "Моєму старшому брату зараз тридцять ____.", "answer": "років", "options": ["років", "рік", "роки", "вік"]}, {"sentence": "Він має високий зріст і темне ____.", "answer": "волосся", "options": ["волосся", "хобі", "автобус", "квиток"]}, {"sentence": "Моя подруга чудово ____ на гітарі.", "answer": "грає", "options": ["грає", "грати", "читає", "дивиться"]}, {"sentence": "Мій брат любить грати ____ теніс.", "answer": "в", "options": ["в", "на", "з", "до"]}, {"sentence": "Я хочу ____ тебе в нове кіно.", "answer": "запросити", "options": ["запросити", "сказати", "дати", "стояти"]}, {"sentence": "Ми довго подорожуємо великим ____.", "answer": "містом", "options": ["містом", "місту", "місто", "міста"]}]`)} />

### Знайдіть пару: Накази та заборони

<MatchUp client:load pairs={JSON.parse(`[{"left": "читай", "right": "не читай"}, {"left": "ідіть", "right": "не ідіть"}, {"left": "дивіться", "right": "не дивіться"}, {"left": "слухай", "right": "не слухай"}, {"left": "пишіть", "right": "не пишіть"}, {"left": "стій", "right": "не стій"}]`)} />

### Складіть речення: Модальні дієслова у контексті

<Unjumble client:load items={JSON.parse(`[{"jumbled": "Мені / треба / працювати / в / суботу", "answer": "Мені треба працювати в суботу."}, {"jumbled": "Ми / можемо / поїхати / в / подорож", "answer": "Ми можемо поїхати в подорож."}, {"jumbled": "Ти / вмієш / грати / на / гітарі", "answer": "Ти вмієш грати на гітарі?"}, {"jumbled": "Я / повинен / купити / їжу / сьогодні", "answer": "Я повинен купити їжу сьогодні."}]`)} />

### Фінальний тест: Комунікація

<Quiz client:load questions={JSON.parse(`[{"question": "Яка форма є найбільш ввічливою для прохання до літньої людини?", "options": [{"text": "Прошу вас дати мені квиток.", "correct": true}, {"text": "Дай мені свій квиток.", "correct": false}, {"text": "Дай, будь ласка, свій квиток.", "correct": false}, {"text": "Дайте мені квиток.", "correct": false}], "explanation": "Конструкція Прошу вас є дуже формальною та ввічливою."}, {"question": "Як правильно описати вік вашого друга Антона українською мовою?", "options": [{"text": "Йому двадцять п'ять років.", "correct": true}, {"text": "Він має двадцять п'ять років.", "correct": false}, {"text": "Він є двадцять п'ять років.", "correct": false}, {"text": "Його двадцять п'ять років.", "correct": false}], "explanation": "Для віку ми завжди використовуємо давальний відмінок: Йому."}, {"question": "Що ви скажете, якщо вам потрібно знайти станцію метро?", "options": [{"text": "Скажіть, будь ласка, де станція?", "correct": true}, {"text": "Дивіться, будь ласка, де станція?", "correct": false}, {"text": "Ідіть, будь ласка, де станція?", "correct": false}, {"text": "Пишіть, будь ласка, де станція?", "correct": false}], "explanation": "Для запитання про дорогу найкраще підходить дієслово скажіть."}, {"question": "Який відмінок завжди використовується після модального слова треба?", "options": [{"text": "давальний відмінок", "correct": true}, {"text": "називний відмінок", "correct": false}, {"text": "знахідний відмінок", "correct": false}, {"text": "орудний відмінок", "correct": false}], "explanation": "Ми кажемо: мені треба, йому треба, нам треба."}, {"question": "Яке дієслово змінюється за родами (він, вона) у теперішньому часі?", "options": [{"text": "повинен", "correct": true}, {"text": "треба", "correct": false}, {"text": "можна", "correct": false}, {"text": "потрібно", "correct": false}], "explanation": "Слово повинен змінюється: він повинен, вона повинна."}, {"question": "Як правильно запросити близького друга на вечірній концерт?", "options": [{"text": "Давай зустрінемось на вечірньому концерті.", "correct": true}, {"text": "Прошу вас піти на концерт.", "correct": false}, {"text": "Вам треба йти на концерт.", "correct": false}, {"text": "Ви повинні бути на концерті.", "correct": false}], "explanation": "Для друзів ми використовуємо неформальні фрази, як-от давай зустрінемось."}]`)} />
