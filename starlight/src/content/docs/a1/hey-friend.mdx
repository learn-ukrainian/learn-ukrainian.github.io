...
Have you ever noticed how people's names seem to magically change when you travel to Ukraine? You might meet a man introduced as **Тарас** (Taras), but when his friends call out to him across the street, they shout **Тара́се!** (Tarase!). You might read about a woman named **Олена** (Olena), but her text messages from friends begin with **Оле́но!** (Oleno!). 
...
**Олена:** Приві́т! Як спра́ви? *(Hi! How are you?)*


**Тарас:** До́бре, дякую, Олено! А в тебе́? *(Good, thanks, Olena! And you?)*


**Олена:** Теж добре. Тарасе, ти зна́єш мого бра́та? *(Also good. Taras, do you know my brother?)*


**Тарас:** Ні. *(No.)*


**Олена:** Андрію, ходи сюди́! Це Тарас. *(Andriy, come here! This is Taras.)*
...
<FillIn client:only="react" instruction={"Знайди мі́сце (Complete the dialogue)"} items={[{"sentence": "— ___, привіт! Як справи?", "answer": "Олено"}, {"sentence": "— Добре, дякую, ___!", "answer": "Тарасе"}, {"sentence": "— ___, ходи сюди!", "answer": "Андрію"}]} />
...
**Мама:** На столі́, синку́. *(On the table, son.)*


**Донька:** Та́ту, а де ключі́? *(Dad, and where are the keys?)*


**Тато:** У кише́ні, до́чко. *(In the pocket, daughter.)*


**Син:** Бабу́сю, ми йдемо́! *(Grandma, we are going!)*


**Бабуся:** Добре, бу́дьте обере́жні! *(Good, be careful!)*
...
<FillIn client:only="react" instruction={"Знайди місце (Complete the dialogue)"} items={[{"sentence": "— ___, де мій телефон?", "answer": "Мамо"}, {"sentence": "— На столі, ___.", "answer": "синку"}, {"sentence": "— ___, ми йдемо!", "answer": "Бабусю"}]} />
...
*   **Пане, да́йте я́блука!** *(Sir, give [me] apples!)*
*   **Пані, де молоко́?** *(Ma'am, where is the milk?)*
...
<Quiz client:only="react" instruction={"Обери́ правильне сло́во (Choose the right word)"} questions={[{"question": "___, привіт!", "options": [{"text": "Олено", "correct": true}, {"text": "Олена", "correct": false}, {"text": "О́ле́ню", "correct": false}]}, {"question": "Як справи, ___?", "options": [{"text": "Тарасе", "correct": true}, {"text": "Тарас", "correct": false}, {"text": "Тара́су", "correct": false}]}, {"question": "Дякую, ___!", "options": [{"text": "мамо", "correct": true}, {"text": "мама", "correct": false}, {"text": "маме", "correct": false}]}, {"question": "Ходи сюди, ___!", "options": [{"text": "Іва́не", "correct": true}, {"text": "Іва́н", "correct": false}, {"text": "Іва́ну", "correct": false}]}, {"question": "Будь обере́жний, ___!", "options": [{"text": "синку", "correct": true}, {"text": "синок", "correct": false}, {"text": "синке", "correct": false}]}, {"question": "Що ти ро́биш, ___?", "options": [{"text": "бра́те", "correct": true}, {"text": "брат", "correct": false}, {"text": "бра́ту", "correct": false}]}, {"question": "До́брий день, ___!", "options": [{"text": "пане", "correct": true}, {"text": "пан", "correct": false}, {"text": "па́ну", "correct": false}]}, {"question": "Привіт, ___!", "options": [{"text": "Андрію", "correct": true}, {"text": "Андрій", "correct": false}, {"text": "А́ндрі́є", "correct": false}]}]} />
...
<GroupSort client:only="react" instruction={"Розпо́діли (Sort vocative endings)"} groups={[{"name": "-о (feminine)", "items": ["Олено", "мамо", "сестро"]}, {"name": "-е (masculine hard)", "items": ["Тарасе", "Іване", "брате", "пане"]}, {"name": "-ю (masculine soft)", "items": ["Андрію", "дідусю", "вчителю"]}]} />
...
<FillIn client:only="react" instruction={"У́твори па́ру (Write vocative)"} items={[{"sentence": "Олена → ___", "answer": "Олено"}, {"sentence": "Тарас → ___", "answer": "Тарасе"}, {"sentence": "мама → ___", "answer": "мамо"}, {"sentence": "Іван → ___", "answer": "Іване"}, {"sentence": "сестра → ___", "answer": "сестро"}, {"sentence": "Андрій → ___", "answer": "Андрію"}, {"sentence": "подруга → ___", "answer": "подруго"}, {"sentence": "брат → ___", "answer": "брате"}, {"sentence": "Марія → ___", "answer": "Маріє"}, {"sentence": "бабуся → ___", "answer": "бабусю"}]} />
...
| **тату** | dad (vocative) | ім. | ч. |
| **бабу́сю** | grandma (vocative) | ім. | ж. |
| **діду́сю** | grandpa (vocative) | ім. | ч. |
| **дру́же** | friend (vocative) | ім. | ч. |
| **коза́че** | Cossack (vocative) | ім. | ч. |
| **бра́те** | brother (vocative) | ім. | ч. |
| **се́стро** | sister (vocative) | ім. | ж. |
| **па́не** | sir (vocative) | ім. | ч. |
| **по́друго** | female friend (vocative) | ім. | ж. |
| **вчи́телю** | teacher (vocative) | ім. | ч. |
