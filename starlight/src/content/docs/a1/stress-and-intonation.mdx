...
Right now, your only goal is awareness. Mobile stress will matter more when learning grammar patterns. For instance, many Ukrainian words shift their emphasis when they change their form or number — even **писа́ти** (to write) shifts its stress across different conjugated forms. We will explore these patterns together in later modules!
...
- **писа́ти** (to write) → **пишу́**, **пи́шеш** — we will explore verb stress patterns later
