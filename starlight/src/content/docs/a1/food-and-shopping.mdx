...
<MatchUp client:load pairs={JSON.parse(`[{"left": "пляшка", "right": "води"}, {"left": "пакет", "right": "молока"}, {"left": "кілограм", "right": "яблук"}, {"left": "чашка", "right": "кави"}, {"left": "склянка", "right": "соку"}, {"left": "шматок", "right": "хліба"}, {"left": "пачка", "right": "масла"}, {"left": "літр", "right": "соку"}]`)} />
