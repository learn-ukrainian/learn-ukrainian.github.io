...
Українські шкільні підручники вводять відмінювання прикметників та займенників системно, зазвичай у 6-му класі, після того, як учні засвоїли відмінки іменників [S38][S39].

Основний принцип, за яким будується пояснення — це поділ прикметників на **тверду** та **м'яку групи** залежно від кінцевого приголосного основи [S40][S41].
...
2.  **М'яка група (Soft Group):** Прикметники з основою на м'який приголосний `-н-` або `-й-` (`синій`, `вечірній`, `безкраїй`). Їхні закінчення часто містять `і` там, де у твердій групі `и`. [S42].

Присвійні займенники (`мій`, `твій`, `наш`, `ваш`, `їхній`, `свій`) та вказівні (`цей`, `той`) вивчаються в цьому ж контексті. Підручники наголошують, що вони відмінюються подібно до прикметників [S43][S44].
- `наш`, `ваш` відмінюються як прикметники **твердої групи** [S45].
- `їхній` відмінюється як прикметник **м'якої групи** [S45].
- `мій`, `твій`, `свій` мають особливий тип відмінювання, який потрібно запам'ятати, але він також має риси прикметникового.
- Займенники `його`, `її` у присвійному значенні **не відмінюються** [S46].

Вправи зазвичай включають:
- Провідміняти словосполучення «присвійний займенник + іменник» (`моя мама`, `твій клас`) [S47].
- Поставити займенники в дужках у правильну форму в реченні [S48][S46].
- Складання речень з поданими словосполученнями [S47].
...
Відмінкові закінчення орудного відмінка для прикметників [S40][S49].
...
**Важливо:** У жіночому роді закінчення завжди `-ою`, навіть для прикметників м'якої групи (`синь**ою**`, а не `синь**ею**`) [S40].
...
| Ми говорили з **її** братом. | Ми говорили з **її** братом. (Правильно) | Це не помилка, але може викликати плутанину. Студенти можуть намагатися відмінювати `її` як `їїм`, за аналогією до `моїм`. Важливо наголосити, що присвійні займенники `його` та `її` **незмінні** [S46]. |
...
| Вони приїхали з **їх** дітьми. | Вони приїхали з **їхніми** дітьми. | Калька з російської. В українській мові для позначення присвійності "their" використовується займенник `їхній`, який відмінюється. `Їх` - це форма особового займенника "вони" в родовому/знахідному відмінку [S50]. |
...
*   Ми жили там разом **з моїм молодшим братом** Миколою. [S51]
*   Це природно, адже емоції допомагають (ми) краще зрозуміти одне одного, а також висловити власне ставлення до ситуації. Та інколи **своєю реакцією** (ми) можемо зробити боляче й неприємно людям навколо... [S48]
*   Ми **з моїм хлопцем** знімали будиночок, який ще називається таунхаус. [S52]

**Група 2: Прикметники множини в орудному відмінку**
*   Сорочку мати вишила мені **червоними і чорними нитками**. [S53]
*   Моїм батькам дуже цікаво познайомитися **з іноземцями**. [S51]
*   На цих двох заповідях утверджується весь закон і пророки. [S54] (Тут `двох` - родовий, але ілюструє узгодження). Кращий приклад: Він повернувся **іншими шляхами**. <!-- VERIFY -->

**Група 3: Вказівні займенники в орудному відмінку**
*   Ходи по **тій землі**, що Каменяр ходив, і пий із тих джерел, які його поїли. [S46] (тут місцевий відмінок, але показує `тій`).
*   Складіть речення **з тими віршами**. [S47]
*   Я не хочу розмовляти **з таким хлопцем**. <!-- VERIFY -->

**Група 4: Прикметники та дієприкметники як означення**
*   Ліс стояв, неначе молода під весільним вінцем. На дорогому зимовому уборі мигтіли й зникали блискітки. І все те диво світилось у **раннім сонячнім промінні**. ([S55], [S56], що збігаються з орудним для м'якої групи).
*   Він **є відомим** у ремеслах. [S57]
*   Я пишаюся **своїм новим комп'ютером**. [S48]

**Група 5: Займенник `свій`**
*   Краще черствий хліб у **своєму домі**, ніж різноманітність страв за чужим столом. [S46] (тут місцевий, але ілюструє вживання `свій`).
*   Тому варто контролювати **свою поведінку** й емоції. [S48] (тут знахідний).
*   Він усюди ходить зі **своєю собакою**. [S48].
