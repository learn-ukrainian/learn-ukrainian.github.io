✅ Message sent to Gemini (ID: 28213) [auto-acked: self-addressed]

🚀 Invoking Gemini to process message #28213...
📨 Message #28213
   From: gemini → To: gemini
   Type: query
   Task: wiki-review-b2-active-participles-past-r1
   Time: 2026-04-05T23:03:30.099358+00:00
...
Track: b2, Slug: active-participles-past, Round: 1
...
🤖 Processing with Gemini (gemini-3.1-pro-preview) [sync, 30 min timeout]...
  [gemini] attempt 1/5, model=gemini-3.1-pro-preview, prompt=17689 chars: You are Gemini, participating in a collaboration with Claude. This is a message from Claude to you:  --- You are a HARSH adversarial reviewer of a grammar brief for the Ukrainian language curriculum w...
Dimension scores:
1. Factual: 2/10 — The article completely omits the critical linguistic rule that active past participles on `-лий` are formed EXCLUSIVELY from **intransitive** (неперехідні) verbs. Without this rule, the formula `[Основа інфінітива доконаного виду] + -л-` is factually incorrect and will lead writers to generate impossible forms like *прочиталий* or *написалий*. It also fails to explain where `пожовклий` comes from in the paradigm (the base verb was `пожовтіти` in the steps, which yields `пожовтілий`, while `пожовклий` comes from `пожовкнути`). Finally, using *~~розбилий~~* with "склянка" is a gender mismatch (should be *~~розбила~~*).
2. Language: 8/10 — The Ukrainian is mostly natural and professional. It uses standard pedagogical metalanguage. The only notable error is the gender mismatch mentioned above ("розбилий склянка").
3. Decolonization: 5/10 — The article explicitly centers Russian by dedicating massive sections ("Типові помилки", "Деколонізаційні застереження") to debunking the Russian suffix `-вший`. For an L2 English curriculum aimed at English speakers (who will NEVER spontaneously invent the suffix `-вший`), framing the entire pedagogical approach around "zero tolerance to `-вший`" violates the rule against "like Russian but..." framing and assumes Russian interference where there is none. 
4. Completeness: 3/10 — The explanation of stem alterations is incomplete. It ignores how to handle verbs ending in `-сти` where the root consonant is dropped (e.g., *опасти* -> *опа-л-ий*, *осісти* -> *осі-л-ий*), despite using them in the table. It also misses the fundamental transitivity restriction.
5. Actionable: 4/10 — Provides extremely generic advice ("Учень має навчитися..."). It lacks specific activity formats, drill sequences, or exercise templates for curriculum writers. The L2 errors focus on Russian speakers, giving zero actionable advice on how to fix actual English speaker errors (like English speakers over-applying `-лий` to transitive verbs by analogy to English past participles).

**Overall: 4.4/10**

<fixes>
old: Активні дієприкметники минулого часу утворюються від основи інфінітива **доконаних** дієслів за допомогою суфікса **-л-**.
new: Активні дієприкметники минулого часу утворюються від основи інфінітива **неперехідних доконаних** дієслів за допомогою суфікса **-л-**. Від перехідних дієслів утворюються лише пасивні дієприкметники.
---
old: **Формула творення:**
`[Основа інфінітива доконаного виду]` + `-л-` + `[прикметникове закінчення]`

**Крок 1: Взяти дієслово доконаного виду.**
new: **Формула творення:**
`[Основа інфінітива неперехідного доконаного виду]` + `-л-` + `[прикметникове закінчення]`

**Крок 1: Взяти неперехідне дієслово доконаного виду.**
---
old: **Крок 3: Якщо основа закінчується на `-ну-`, цей суфікс випадає.**
*   *пожовті-, посиві-, розквіт-, зів'я-, схуд-*
new: **Крок 3: Якщо основа закінчується на `-ну-`, цей суфікс випадає. Для дієслів на `-сти` (опасти, осісти) відкидається вся кінцівка `-сти` (залишається корінь на голосний).**
*   *пожовті-, посиві-, розквіт-, зів'я-, схуд-, опа-*
---
old: **Парадигма відмінювання (на прикладі *пожовклий*)**
new: **Парадигма відмінювання (на прикладі *пожовклий* — від *пожовкнути*)**
---
old: 4.  **Плутанина з пасивними дієприкметниками.** Деякі дієприкметники на `-лий` можуть бути схожими на пасивні, або ж учні можуть плутати, коли вживати активну, а коли пасивну форму.
    *   *Наприклад:* Учень може сказати *~~розбилий~~* (активний, неіснуючий) замість **розбитий** (пасивний, правильний) для слова "склянка". Треба чітко пояснити різницю: активний — предмет сам виконав дію (*лист пожовк*), пасивний — над предметом виконали дію (*хтось написав лист*).
new: 4.  **Плутанина з пасивними дієприкметниками.** Деякі дієприкметники на `-лий` можуть бути схожими на пасивні, або ж учні можуть плутати, коли вживати активну, а коли пасивну форму.
    *   *Наприклад:* Учень може сказати *~~розбила~~* (активна форма, неіснуюча) замість **розбита** (пасивна, правильна) для слова "склянка". Треба чітко пояснити: активний на `-лий` утворюється тільки від неперехідних дієслів (*лист пожовк*), пасивний — від перехідних (*хтось написав лист*).
5.  **Гіперкорекція перехідності (L2 English).** Англомовні учні намагатимуться застосувати суфікс `-лий` до перехідних дієслів за аналогією з англійською. Їм треба чітко завчити, що форми на зразок *~~прочиталий~~* чи *~~зробилий~~* не існують.
---
old: **Головне застереження: Активні дієприкметники на `-вший` (`-ший`) є ЧУЖИМИ для української мови.**
new: **Головне застереження: Активні дієприкметники на `-вший` (`-ший`) є ЧУЖИМИ для української мови (хоча учні можуть чути їх як суржик від носіїв).**
---
INSERT AFTER: *   **Дієприслівників** (`-учи, -ачи, -ши, -вши`): учень не буде плутати ознаку предмета (дієприкметник) з додатковою дією (дієприслівник).
NEW TEXT: 

## Рекомендовані типи вправ (Actionable Activities)

1.  **Сортування (Transitive vs Intransitive):** Дати список дієслів (написати, зів'янути, розбити, посивіти). Учень має розподілити їх на ті, що утворюють форму на `-лий` (неперехідні), і ті, що утворюють `-ний/-тий` (перехідні).
2.  **Трансформація з `-ну-`:** Вправи на заповнення пропусків, де учень перетворює інфінітив на `-нути` у дієприкметник, свідомо відкидаючи суфікс (напр., `[схуднути] хлопець` -> `схудлий`).
3.  **Заміна підрядної частини:** Редагування тексту: заміна громіздких конструкцій "листя, яке опало" на природні "опале листя" для тренування лаконічності та досягнення стилістики рівня B2.
</fixes>


────────────────────────────────────────
✅ Gemini finished (5558 chars)
✅ Message sent to Claude (ID: 28214)
✓ Message 28214 acknowledged
   Auto-acknowledged reply #28214 (stdout delivery — no inbox accumulation)
   ℹ️  No issue number in task_id 'wiki-review-b2-active-participles-past-r1' — skipping GH posting (review saved to orchestration/)
✓ Message 28213 acknowledged
