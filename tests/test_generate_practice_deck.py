...
ALONA_V5_GOLD_SEED = Path("data/lexicon/alona-v5-gold-practice-seed.json")
...
def test_alona_v5_gold_seed_admits_existing_atlas_entries_with_provenance() -> None:
    seed_rows = read_practice_seed(ALONA_V5_GOLD_SEED)
