...
Перевірте своє розуміння виду дієслова. Чи готові ви до виклику? Як часто ви використовуєте накази?

> [!note]
> Наказовий спосіб в українській мові має свої особливості.
...
**Працюй старанно!** — постійна дія.
**Гуляй на вулиці!** — загальна порада.
**Співай пісню!** — процес насолоди.
**Дивись телевізор!** — тривалий процес.
**Говори повільно!** — спосіб дії.
**Малюй картину!** — творчий процес.

> 🌍 **У реальному житті**
>
> На вулиці ви почуєте: «Чекай!» (тривала дія), але «Зачекай!» (одноразова). Уявіть, що ви в місті Київ або на вокзалі.
...
**Зроби вправу!** — завершення завдання.
**Купи хліба!** — результат покупки.
**Відкрий вікно!** — одноразовий акт.
**Закрий двері!** — завершена дія.
**Принеси воду!** — результат досягнуто.
**Випий каву!** — одноразова подія.

> [!tip]
> Використовуйте доконаний вид, коли вам важливий результат.

> 🎬 **У кіно**
>
> У фільмах часто чуємо: «Зроби це!» — наказ на результат. Це часто можна побачити в українських стрічках про козак.
...
| Слухай! | Послухай! | увага / факт |
| Роби! | Зроби! | дія / результат |

> 🎯 **Запам'ятай!**
>
> Недоконаний = процес, доконаний = результат. Це як традиція вишиванки — важливий і процес, і результат.
...
**Ситуація 3:** Друзі в місті Одеса:
- «Купуй фрукти тут!» (порада)
- «Купи ці яблука!» (конкретна дія)

**Ситуація 4:** Туристи у Львові:
- «Гуляй містом!» (процес)
- «Піднімись на Високий Замок!» (результат)

> 💡 **Цікавий факт**
>
> Українці інтуїтивно обирають правильний вид, навіть не знаючи правил. Як ви думаєте, чому так? Чи допоможе вам практика?
...
Визначте, який вид краще підходить для кожної ситуації. Яку форму ви оберете?
...
class TestCalculateRichness:
    def test_high_score_for_rich_content(self, rich_b1_module):
        ...
        assert result['score'] >= 95  # Above threshold
