...
def test_codex_adapter_no_effort_means_default_high_override(tmp_path):
    """effort=None applies the Sol orchestrator default
    ``-c model_reasoning_effort=high`` (operator 2026-09-22); an explicit
