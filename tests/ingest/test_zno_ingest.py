...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("ТЕМА: Синтаксис. Складне речення. Синонімія складних речень", "syntactic_norm"),
        (
            "ТЕМА: Синтаксис. Синонімія складнопідрядних речень і простих речень, ускладнених відокремленими обставинами",
            "syntactic_norm",
        ),
        ("ТЕМА: Морфологія. Сполучник. Синонімія сполучників.", "morphological_norm"),
