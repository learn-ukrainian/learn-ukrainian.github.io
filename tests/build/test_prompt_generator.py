...
def test_writer_context_off_is_unchanged_by_flag(m20):
    ...
    assert set(default) == {
        ...
        "SIZE_POLICY", "SECTION_WORD_BUDGETS", "WRITER_SPECIFIC_DIRECTIVES", "PLAN_CONTENT",
        "KNOWLEDGE_PACKET", "WIKI_MANIFEST",
        "WIKI_COVERAGE_REQUIRED_ITEMS", "IMPLEMENTATION_MAP_CONTRACT", "LEARNER_STATE",
        "MODULE_ARCHETYPE", "IMMERSION_RULE", "CONTRACT_YAML", "ALLOWED_ACTIVITY_TYPES",
        "FORBIDDEN_ACTIVITY_TYPES", "INLINE_ALLOWED_TYPES", "WORKBOOK_ALLOWED_TYPES",
        "ACTIVITY_COUNT_TARGET", "VOCAB_COUNT_TARGET", "COMPONENT_PROPS_SCHEMA",
