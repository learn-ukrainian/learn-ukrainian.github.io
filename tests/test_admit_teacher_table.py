...
from scripts.lexicon.admit_teacher_table import TableRow, _read_extract, admit_and_enrich, measure_table_coverage
    ...
    assert artifacts["residuals"] == [
        {
            ...
            "proof": {"vesum_db": "fixture-vesum.db", "analysis_count": 2},
        }
    ]
