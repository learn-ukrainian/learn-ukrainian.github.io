    ...
    try:
        ...
        conn.execute(
            ...
            (
                ...
                "мисль",
                (
                    "Мисль, мИсля, -лі, ж. Мысль. Мислі до суду не позивають. "
                    "Ном. № 5805. Що з голови, то з мислі. Ном. № 5804."
                ),
                "Грінченко",
            ),
        )
        conn.execute(
            ...
            (
                ...
                "відношення",
                (
                    "ВІДНО́ШЕННЯ, я, с. 1. Стосунок, причетність до кого-, чого-небудь; "
                    "зв’язок з кимсь, чимсь. 2. Взаємозв’язок між предметами, явищами. "
                    "3. заст. Ставлення. 4. Діловий лист, що надсилається в установу "
                    "або офіційній особі."
                ),
                (
                    "відношення: ВІДНО́ШЕННЯ, я, с. 1. Стосунок, причетність до кого-, "
                    "чого-небудь; зв’язок з кимсь, чимсь. 2. Взаємозв’язок між предметами, явищами. "
                    "3. заст. Ставлення. 4. Діловий лист, що надсилається в установу "
                    "або офіційній особі."
                ),
                "СУМ-11",
        ...
        conn.execute(
            ...
            (
                ...
                "поїздка",
                (
                    "ПОЇ́ЗДКА, и, ж. Виїзд куди-небудь на короткий час; "
                    "коротка подорож."
                ),
                (
                    "поїздка: ПОЇ́ЗДКА, и, ж. Виїзд куди-небудь на короткий час; "
                    "коротка подорож."
                ),
                "СУМ-11",
                0,
