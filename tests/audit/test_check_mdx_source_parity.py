...
def test_check_parity_skips_arc_generated_pages(mock_legacy_levels, mock_subprocess, tmp_path):
    # Module pages generated by build_arc_landing have no per-module curriculum source dir.
    generated = MDX_DIR / "a1" / "arc-parity-fixture" / "index.mdx"
    mock_subprocess.return_value = "1 file changed\n"
    with patch("pathlib.Path.read_text", return_value='---\ntitle: "x"\narc_kind: module\n---\n'):
        assert check_parity([generated], {generated}) == []
    with patch("pathlib.Path.read_text", return_value='---\ntitle: "x"\n---\nbody\n'):
        assert len(check_parity([generated], {generated})) == 1
