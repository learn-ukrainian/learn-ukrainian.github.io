...
@pytest.mark.skipif(
    not _GOLDEN_VOCAB_PATH.exists(),
    reason=(
        "Golden vocabulary fixture deleted by EPIC #1577 Phase 1 "
        "(commit 9e41c65465 — discard V6-generated legacy outputs). "
        "Auto-resumes when the file is regenerated by the Phase 4 "
        "exemplar build (A1/20 my-morning) or the Phase 5 fan-out."
    ),
)
def test_a1_1_sounds_letters_golden() -> None:
    ...
    result = check_vocab_coverage(plan_path, _GOLDEN_VOCAB_PATH)
