...
def test_a13_receipt_binds_the_merged_a12_receipt_by_its_known_public_sha() -> None:
    # The merged A12 receipt's public sha256, frozen at dispatch time (PR #7654 repair cycle 2:
    # A6-A9 gained positive-completion evidence, rippling A12's own binding hash forward).
    assert a13.sha256_file(A12_RECEIPT_PATH) == "2cf58f64339209a640014f62378f30a0b45c0d95b921b8aa3cd78e760c20f94f"
    assert a13.A12_RECEIPT_SHA256_AT_MERGE == "2cf58f64339209a640014f62378f30a0b45c0d95b921b8aa3cd78e760c20f94f"
