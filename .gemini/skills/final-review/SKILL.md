...
- If track is b1, b2, c1, c2, or any compound (hist, bio, etc.):
...
For hist, bio, istorio, lit, oes, ruth:
...
- Seminar tracks (hist, bio, etc.): activities should be seminar-style (4-9 activities, not drill-heavy)
...
### Tier 3: Seminar Modules (HIST, ISTORIO, BIO, LIT, OES, RUTH)
