...
description: "B1 landing — 10 available / 10 reviewed / 84 planned"
template: splash
---
...
<LevelLanding
  ...
  level="B1"
  title="Крок вперед"
  subtitle="10 learner pages available · 10 reviewed · 84 planned"
  progressTitle="Build status"
  progressDescription="10 available · 10 reviewed · 84 planned"
  moduleCount={94}
  wordTarget={4000}
  color="var(--lu-id-b1)"
  modules={[
    {
      ...
      items: [
        ...
        { num: 10, slug: "checkpoint-aspect", title: "Контрольна робота: вид дієслова", sub: "Діагностична перевірка вибору виду в контекстах M01-M09", status: "active" },
      ]
    },
    {
