...
description: "B1 landing — 11 available / 11 reviewed / 83 planned"
template: splash
---
...
<LevelLanding
  ...
  level="B1"
  title="Крок вперед"
  subtitle="11 learner pages available · 11 reviewed · 83 planned"
  progressTitle="Build status"
  progressDescription="11 available · 11 reviewed · 83 planned"
  moduleCount={94}
  wordTarget={4000}
  color="var(--lu-id-b1)"
  modules={[
