...
description: "B1 landing — 12 available / 12 reviewed / 82 planned"
template: splash
---
...
<LevelLanding
  ...
  level="B1"
  title="Крок вперед"
  subtitle="12 learner pages available · 12 reviewed · 82 planned"
  progressTitle="Build status"
  progressDescription="12 available · 12 reviewed · 82 planned"
  moduleCount={94}
  wordTarget={4000}
  color="var(--lu-id-b1)"
  modules={[
