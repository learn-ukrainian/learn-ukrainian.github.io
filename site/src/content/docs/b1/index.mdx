...
description: "B1 landing — 9 available / 9 reviewed / 85 planned"
template: splash
---
...
<LevelLanding
  ...
  level="B1"
  title="Крок вперед"
  subtitle="9 learner pages available · 9 reviewed · 85 planned"
  progressTitle="Build status"
  progressDescription="9 available · 9 reviewed · 85 planned"
  moduleCount={94}
  wordTarget={4000}
  color="var(--lu-id-b1)"
  modules={[
