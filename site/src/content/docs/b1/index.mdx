...
description: "B1 landing — 5 available / 5 reviewed / 89 planned"
template: splash
---
...
<LevelLanding
  ...
  level="B1"
  title="Крок вперед"
  subtitle="5 learner pages available · 5 reviewed · 89 planned"
  progressTitle="Build status"
  progressDescription="5 available · 5 reviewed · 89 planned"
  moduleCount={94}
  wordTarget={4000}
  color="var(--lu-id-b1)"
  modules={[
