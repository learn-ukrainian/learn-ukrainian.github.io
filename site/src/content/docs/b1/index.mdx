...
description: "B1 landing — 7 available / 7 reviewed / 87 planned"
template: splash
---
...
<LevelLanding
  ...
  level="B1"
  title="Крок вперед"
  subtitle="7 learner pages available · 7 reviewed · 87 planned"
  progressTitle="Build status"
  progressDescription="7 available · 7 reviewed · 87 planned"
  moduleCount={94}
  wordTarget={4000}
  color="var(--lu-id-b1)"
  modules={[
