...
description: "B1 landing — 6 available / 6 reviewed / 88 planned"
template: splash
---
...
<LevelLanding
  ...
  level="B1"
  title="Крок вперед"
  subtitle="6 learner pages available · 6 reviewed · 88 planned"
  progressTitle="Build status"
  progressDescription="6 available · 6 reviewed · 88 planned"
  moduleCount={94}
  wordTarget={4000}
  color="var(--lu-id-b1)"
  modules={[
