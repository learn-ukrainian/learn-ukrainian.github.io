...
<GroupSort client:only='react' groups={JSON.parse(`{"У": ["у Львові", "у школі", "у вівторок"], "В": ["в Києві", "в офісі", "в аптеці"], "І": ["брат і сестра", "Марія і Яна", "І він іде"], "Й": ["мама й тато", "ти й Іван", "Олена й Анна"]}`)} isUkrainian={false} />
