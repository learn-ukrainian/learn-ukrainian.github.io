...
<GroupSort client:only='react' groups={JSON.parse(`{"Hard pattern -ий/-а/-е": ["червоний олівець", "жовта стрічка", "зелене яблуко", "білий светр", "чорна сукня", "сіре пальто", "коричневі черевики", "помаранчевий олівець"], "Soft pattern -ій/-я/-є": ["синій светр", "синя ручка", "синє море", "сині речі"]}`)} instruction={"Sort the color chunks by adjective pattern."} isUkrainian={false} />
...
<MatchUp client:only='react' pairs={JSON.parse(`[{"left": "карі очі", "right": "brown eyes"}, {"left": "русяве волосся", "right": "fair or light-brown hair"}, {"left": "сиве волосся", "right": "grey hair"}, {"left": "руде волосся", "right": "red hair"}, {"left": "блакитне небо", "right": "light-blue sky"}, {"left": "синьо-жовтий прапор", "right": "Ukrainian flag colors"}]`)} instruction={"Match each Ukrainian chunk with its natural context."} isUkrainian={false} />
