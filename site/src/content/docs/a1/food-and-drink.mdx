...
<GroupSort client:only='react' groups={JSON.parse(`{"Їжа": ["хліб", "риба", "м'ясо", "каша", "сир"], "Напої": ["кава", "чай", "вода", "сік", "молоко"], "Прийоми їжі": ["сніданок", "обід", "вечеря"], "Українські страви": ["борщ", "вареники", "сало"]}`)} isUkrainian={false} />
