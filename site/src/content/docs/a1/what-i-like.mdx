...
<MatchUp client:only='react' pairs={JSON.parse(`[{"left": "читати", "right": "to read"}, {"left": "гуляти", "right": "to walk"}, {"left": "готувати", "right": "to cook"}, {"left": "слухати", "right": "to listen"}, {"left": "дивитися", "right": "to watch"}, {"left": "грати", "right": "to play"}, {"left": "малювати", "right": "to draw"}, {"left": "співати", "right": "to sing"}]`)} isUkrainian={false} />
...
<GroupSort client:only='react' groups={JSON.parse(`{"Я люблю + action": ["читати", "гуляти", "готувати", "малювати"], "Мені подобається + thing": ["музика", "книга", "фільм", "Київ"]}`)} isUkrainian={false} />
