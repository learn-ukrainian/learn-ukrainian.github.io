...
<MatchUp client:only='react' pairs={JSON.parse(`[{"left": "він", "right": "-в"}, {"left": "вона", "right": "-ла"}, {"left": "воно", "right": "-ло"}, {"left": "вони", "right": "-ли"}, {"left": "ми", "right": "-ли"}, {"left": "Олена", "right": "-ла"}, {"left": "Тарас", "right": "-в"}, {"left": "друзі", "right": "-ли"}]`)} isUkrainian={false} />
