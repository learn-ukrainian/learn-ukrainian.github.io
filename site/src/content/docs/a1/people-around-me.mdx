...
<GroupSort client:only='react' groups={JSON.parse(`{"Істоти: кого?": ["брата", "маму", "друга", "лікаря", "Олену", "сусіда"], "Неістоти: що?": ["хліб", "каву", "воду", "чай", "борщ", "дерево"]}`)} isUkrainian={false} />
...
<MatchUp client:only='react' pairs={JSON.parse(`[{"left": "мама", "right": "маму"}, {"left": "Олена", "right": "Олену"}, {"left": "сестра", "right": "сестру"}, {"left": "подруга", "right": "подругу"}, {"left": "брат", "right": "брата"}, {"left": "друг", "right": "друга"}, {"left": "лікар", "right": "лікаря"}, {"left": "сусід", "right": "сусіда"}]`)} isUkrainian={false} />
