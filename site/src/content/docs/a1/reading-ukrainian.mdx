...
<MatchUp client:only='react' pairs={JSON.parse(`[{"left": "А", "right": "чистий [а]"}, {"left": "О", "right": "чистий [о]"}, {"left": "И", "right": "чистий [и]"}, {"left": "І", "right": "чистий [і]"}, {"left": "Я на початку слова", "right": "[йа]"}, {"left": "Ї", "right": "завжди [йі]"}]`)} />
