...
<GroupSort client:only='react' groups={JSON.parse(`{"Де?": ["в Україні", "у Києві", "на роботі", "у школі"], "Куди?": ["в Україну", "у Київ", "на роботу", "у школу"], "Звідки?": ["з України", "з Києва", "з роботи", "зі школи"]}`)} instruction={"Sort each chunk by the question it answers."} isUkrainian={false} />
