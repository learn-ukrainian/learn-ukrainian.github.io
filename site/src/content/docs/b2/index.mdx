...
description: "Released upper-intermediate Ukrainian course — 93 modules in curriculum order"
template: splash
---
...
<LevelLanding
  client:load
  level="B2"
  title="Впевнено · Confident Ukrainian"
  subtitle="Released upper-intermediate Ukrainian course — 93 learner pages available"
  progressTitle="B2 Release Status"
  progressDescription="93 available · deterministic checks clear · 0 planned"
  moduleCount={93}
  wordTarget={4000}
  color="var(--lu-id-b2)"
  modules={[
