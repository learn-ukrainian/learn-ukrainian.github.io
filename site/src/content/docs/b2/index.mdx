...
description: "Upper-intermediate Ukrainian preview map — 9 learner pages available · 84 planned"
template: splash
---
...
<LevelLanding
  ...
  level="B2"
  title="Впевнено"
subtitle="Upper-intermediate Ukrainian preview map — 9 learner pages available · 84 planned"
  progressTitle="B2 Preview Status"
progressDescription="9 available · 0 reviewed · 84 planned"
  moduleCount={93}
  wordTarget={4000}
  color="var(--lu-id-b2)"
  modules={[
