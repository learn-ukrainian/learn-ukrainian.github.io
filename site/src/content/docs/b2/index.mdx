...
description: "Upper-intermediate Ukrainian preview map — 8 learner pages available · 85 planned"
template: splash
---
...
<LevelLanding
  ...
  level="B2"
  title="Впевнено"
subtitle="Upper-intermediate Ukrainian preview map — 8 learner pages available · 85 planned"
  progressTitle="B2 Preview Status"
progressDescription="8 available · 0 reviewed · 85 planned"
  moduleCount={93}
  wordTarget={4000}
  color="var(--lu-id-b2)"
  modules={[
