...
description: "Upper-intermediate Ukrainian preview map — 7 learner pages available · 86 planned"
template: splash
---
...
<LevelLanding
  ...
  level="B2"
  title="Впевнено"
  subtitle="Upper-intermediate Ukrainian preview map — 7 learner pages available · 86 planned"
  progressTitle="B2 Preview Status"
  progressDescription="7 available · 0 reviewed · 86 planned"
  moduleCount={93}
  wordTarget={4000}
  color="var(--lu-id-b2)"
  modules={[
