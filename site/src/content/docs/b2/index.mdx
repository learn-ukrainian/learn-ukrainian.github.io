...
description: "Upper-intermediate Ukrainian preview map — 6 learner pages available · 87 planned"
template: splash
---
...
<LevelLanding
  ...
  level="B2"
  title="Впевнено"
  subtitle="Upper-intermediate Ukrainian preview map — 6 learner pages available · 87 planned"
  progressTitle="B2 Preview Status"
  progressDescription="6 available · 0 reviewed · 87 planned"
  moduleCount={93}
  wordTarget={4000}
  color="var(--lu-id-b2)"
  modules={[
