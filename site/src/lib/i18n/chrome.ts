...
const en = {
  ...
  'home.cardPracticeDesc': 'Spaced repetition flashcards and drills for Ukrainian vocabulary and grammar across all CEFR levels.',
  ...
  'home.roadmapC1': 'Advanced course map',
  'home.roadmapC2': 'Mastery course map',
  ...
  'practice.sessionRestart': 'Start over',
  'practice.sessionSize10': '10',
  'practice.sessionSize20': '20',
  'practice.sessionSizeUntilZero': 'Until clear',
  'practice.switchSessionOffer': 'Start a new session with this set?',
  'practice.switchSessionAccept': 'Yes, new session',
  'practice.switchSessionDecline': 'Keep current',
...
const uk: Record<ChromeKey, string> = {
  ...
  'home.cardPracticeDesc': 'Інтервальне повторення слів та граматичні тренування для всіх рівнів CEFR з локальним прогресом у браузері.',
  ...
  'home.roadmapC1': 'Карта просунутого курсу',
  'home.roadmapC2': 'Карта курсу досконалості',
  ...
  'practice.weakAreas': 'Слабкі місця',
  ...
  'practice.sessionRestart': 'Почати наново',
  'practice.sessionSize10': '10',
  'practice.sessionSize20': '20',
  'practice.sessionSizeUntilZero': 'Доки не закінчаться',
  'practice.switchSessionOffer': 'Почати нову сесію з цим набором?',
  'practice.switchSessionAccept': 'Так, нова сесія',
  'practice.switchSessionDecline': 'Лишити',
