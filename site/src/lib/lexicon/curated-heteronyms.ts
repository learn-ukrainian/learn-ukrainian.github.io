  ...
  "значитися": [
    {
      ...
      "gloss": "be registered/listed, be on a roster; signify, have meaning (imperfective)",
      "pos": "verb",
      "cefr": "B1",
      "heritage_status": {
        "classification": "standard",
      ...
      "distinction_note": "Означає «бути внесеним до списку, числитися десь» або «мати значення, важити» (недоконаний вид). Не плутати з «значи́тися» (виділятися, помічатися).",
      "meaning": {
        "definitions": [
          "Бути записаним, внесеним до якогось реєстру чи списку; мати певне значення."
        ],
        "source": "ВТС / СУМ-11"
      },
      "soviet_colonization_context": {
    ...
    },
    {
      ...
      "distinction_note": "Означає «позначатися, вирізнятися на тлі, бути помітним» (рідко, недоконаний вид). Не плутати з «зна́читися» (числитися в списках).",
      "meaning": {
        "definitions": [
  ...
  "зольник": [
    {
      ...
      "distinction_note": "Археологічний термін: «курганоподібний насип з попелом, золою та рештками побуту стародавніх городищ». Не плутати з виробничим резервуаром чи піддувалом «зольни́к».",
      "meaning": {
        "definitions": [
    ...
    },
    {
      ...
      "gloss": "ash-pit in furnace / tanning vat containing lye or ash for soaking hides",
      "pos": "noun",
      "cefr": "B2",
      "heritage_status": {
        "classification": "standard",
      ...
      "distinction_note": "Спеціальний термін: «чан, яма з розчином вапна або золи для зоління шкір у кушнірстві» або «піддувало, камера під колосниками для збирання попелу». Не плутати з археологічним курганом «зо́льник».",
      "meaning": {
        "definitions": [
          "Яма чи резервуар для обробки шкір золою (у чинбарстві); бункер або отвір під топкою для збору попелу."
        ],
        "source": "ВТС / СУМ-11"
      },
      "soviet_colonization_context": {
