  ...
  "замикатися": [
    {
      ...
      "distinction_note": "Означає «зачинятися на замок» або «ставати відлюдькуватим, зосереджуватися на собі» (недоконаний вид). Не плутати з доконаним розмовним «зами́катися» (втомитися від блукання).",
      "meaning": {
        "definitions": [
    ...
    },
    {
      ...
      "gloss": "exhaust oneself by prolonged wandering/roaming, wear oneself out tramping (colloquial, perf.)",
      "pos": "verb",
      "cefr": "B2",
      "heritage_status": {
        "classification": "authentic-dialectism",
      ...
      "distinction_note": "Означає «довго блукаючи, микаючись, втомитися» (від дієслова микатися; розм., доконаний вид). Не плутати з «замика́тися» (замикати замок).",
      "meaning": {
        "definitions": [
          "Блукаючи, микаючись по різних місцях, знесилитися або втомитися."
        ],
        "source": "Грінченко (1907) / ВТС"
      },
      "soviet_colonization_context": {
  ...
  "колонковий": [
    {
      ...
      "gloss": "relating to a column (mechanical, geological core drill, newspaper column)",
      "pos": "adj",
      "cefr": "B2",
      "heritage_status": {
        "classification": "standard",
      ...
      "distinction_note": "Прикметник до «колонка» (технічна або друкарська колонка, бурове колонкове буріння тощо). Не плутати з «колонко́вий» (прикметник до «колоно́к» — сибірський хутровий звірок).",
      "meaning": {
        "definitions": [
          "Стосовний до колонки (технічної, бурової або друкарської)."
        ],
        "source": "ВТС / СУМ-11"
      },
      "soviet_colonization_context": {
        ...
        "sovietization_risk": 0,
        "keywords": [],
        "historical_note": "Технічний термін, зафіксований у СУМ-11."
      }
    },
    {
      "lemma": "колонковий",
      ...
      "distinction_note": "Прикметник до зоологічної назви хижака «колоно́к» (родини куницевих): колонкове хутро, колонковий пензель. Не плутати з «коло́нковий» (від колонка).",
      "meaning": {
        "definitions": [
  ...
  "консерваторка": [
    {
      ...
      "distinction_note": "Жіночий відповідник до «консерва́тор»: прихильниця політичного чи світоглядного консерватизму, прихильниця збереження традиційних підвалин. Не плутати з «консервато́рка» (студентка або викладачка консерваторії).",
      "meaning": {
        "definitions": [
    ...
    },
    {
      ...
      "distinction_note": "Розмовне слово: студентка або випускниця музичної консерваторії (жін. до «консервато́рець»). Засвідчено у класичній літературі: Леся Українка («У мене сестра консерваторка»). Не плутати з «консерва́торка» (прихильниця консерватизму).",
      "meaning": {
        "definitions": [
          "Студентка або викладачка вищого музичного навчального закладу — консерваторії (розм., жін. до консервато́рець)."
        ],
        "source": "ВТС / СУМ-11"
      },
      "pre_soviet_witness": {
