  ...
  "перекладка": [
    {
      ...
      "distinction_note": "Означає «поперечна балка, планка, перекладина або розділова прокладка (іменник)». Не плутати з «перекла́дка» (дія за значенням «перекладати» — перекладання речей або переклад тексту).",
      "meaning": {
        "definitions": [
  ...
  "травник": [
    {
      ...
      "distinction_note": "Означає «гербарій рослин або старовинна книжка про лікувальні трави (травник, фармакопея)». Не плутати з «травни́к» (трав'яна настоянка або зарослий травою моріг).",
      "meaning": {
        "definitions": [
