...
export function resolveAntiCalqueRule(): AdverbRuleResolution {
  return {
    ...
    ruleUa:
      "Слід уникати калькованих канцеляризмів та суржику: вживайте 'насамперед / передусім' замість 'в першу чергу'; 'навряд чи' замість 'вряд ли'; 'переважно / здебільшого' замість 'по більшій мірі'; 'принаймні' замість 'по крайній мірі'; 'у крайньому разі' замість 'в крайньому випадку'.",
    ruleEn:
      "Avoid Russian bureaucratic calques and Surzhyk: use 'насамперед' instead of *в першу чергу*; 'навряд чи' instead of *вряд ли*; 'переважно' instead of *по більшій мірі*; 'принаймні' instead of *по крайній мірі*; 'у крайньому разі' instead of *в крайньому випадку*.",
  };
}
