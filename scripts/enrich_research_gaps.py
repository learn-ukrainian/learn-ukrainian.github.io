...
MODULES = [
    ...
    ("istorio", "istorychna-pamiat-i-polityka", ["sources", "chronology"]),
    ("istorio", "povist-mynulykh-lit-i",        ["sources", "chronology"]),
    ("istorio", "litopys-samovidtsia",          ["sources", "section_notes"]),
    ("istorio", "litopys-velychka",             ["sources", "primary_quotes"]),
    ("istorio", "pereyaslavski-statti",         ["sources", "chronology"]),
    ("istorio", "samvydav-shcho-tse",           ["sources", "chronology"]),
    ("istorio", "khreshchennia-spadshchyna",    ["sources", "primary_quotes"]),
    ("istorio", "syntez-diaspora",              ["sources", "primary_quotes"]),
    ("istorio", "yanukovych-tsykl",             ["sources", "chronology"]),
    ("istorio", "radianska-propaganda",         ["sources", "chronology"]),
    ("istorio", "syntez-pislya-2014",           ["chronology", "primary_quotes"]),
    ("istorio", "kulturna-rezystentsiia",       ["sources", "primary_quotes"]),
