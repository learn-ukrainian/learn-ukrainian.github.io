...
MODULES = [
    ...
    ("c1-hist", "litopys-velychka",             ["sources", "primary_quotes"]),
    ("c1-hist", "pereyaslavski-statti",         ["sources", "chronology"]),
    ("c1-hist", "samvydav-shcho-tse",           ["sources", "chronology"]),
    ("c1-hist", "khreshchennia-spadshchyna",    ["sources", "primary_quotes"]),
    ("c1-hist", "syntez-diaspora",              ["sources", "primary_quotes"]),
    ("c1-hist", "yanukovych-tsykl",             ["sources", "chronology"]),
    ("c1-hist", "radianska-propaganda",         ["sources", "chronology"]),
    ("c1-hist", "syntez-pislya-2014",           ["chronology", "primary_quotes"]),
    ("c1-hist", "kulturna-rezystentsiia",       ["sources", "primary_quotes"]),
