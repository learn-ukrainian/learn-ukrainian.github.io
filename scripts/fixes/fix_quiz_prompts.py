...
for activity in activities:
    if activity.get('title') == 'Виявлення упередження в медіа':
        ...
        print("✅ Fixed quiz 'Виявлення упередження в медіа' Q3")
        print("   Old (4 words): Як перевірити достовірність новини?")
        print("   New (7 words): Як правильно перевірити достовірність новини в мережі?")
...
for activity in activities:
    if activity.get('title') == 'Підсумкова перевірка комунікаційних навичок':
        ...
        print("✅ Fixed quiz 'Підсумкова перевірка комунікаційних навичок' Q9")
        print("   Old (4 words): Яка презентація буде найефективнішою?")
        print("   New (7 words): Яка презентація буде найбільш ефективною для аудиторії?")
