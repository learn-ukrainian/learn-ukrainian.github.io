...
for i, line in enumerate(lines):
    # 1. Euphony
    if i+1 == 21: line = line.replace("у єдину", "в єдину")
    if i+1 == 79: line = line.replace("в спальному", "у спальному")
    if i+1 == 130: line = line.replace("і або", "й або")
    if i+1 == 133: line = line.replace("в цьому", "у цьому")
    if i+1 == 134: line = line.replace("в цьому", "у цьому")
    if i+1 == 148: line = line.replace("часто і яскраво", "часто й яскраво")
    if i+1 == 198: line = line.replace("в вказуючи", "у вказуючи")
    if i+1 == 215: line = line.replace("перебуваєте і яку", "перебуваєте й яку")
    if i+1 == 317: line = line.replace("з чоловіком", "із чоловіком")
    if i+1 == 359: line = line.replace("з часом", "із часом")
    if i+1 == 369: line = line.replace("з самого", "із самого")
