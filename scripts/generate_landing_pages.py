...
# Levels whose landing scripts/build/build_arc_landing.py generates from the
# accepted arc (#8397); this generator must not overwrite them.
...
def main():
    ...
    for level in tracks:
        ...
        if level in ARC_LANDING_LEVELS:
            print(f"Skipping {level.upper()} - landing generated by scripts/build/build_arc_landing.py")
            continue
