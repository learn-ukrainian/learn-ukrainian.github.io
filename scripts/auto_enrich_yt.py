...
def find_video_for_subject(subject: str) -> tuple[str, str] | None:
    ...
    try:
        ...
        print(f"Search returned no valid results (likely YouTube bot protection without cookies).")
        
    except subprocess.CalledProcessError as e:
        print(f"Search failed (likely YouTube bot protection without cookies).")
