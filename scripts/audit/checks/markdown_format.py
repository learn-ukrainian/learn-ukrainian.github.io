...
def check_heading_levels(content: str, level_code: str = None) -> list[dict]:
    ...
    Note: Seminar tracks (c1-bio, hist, istoriohrafiia, lit, oes, ruth) use a different
    ...
    seminar_tracks = ['c1-bio', 'hist', 'istoriohrafiia', 'lit', 'oes', 'ruth']
...
def check_markdown_format(content: str, level_code: str = None) -> list[dict]:
    ...
    Args:
        ...
        level_code: Optional level code (e.g., 'c1-bio', 'hist') for track-aware checks
