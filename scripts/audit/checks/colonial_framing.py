...
Track exemptions:
  OES, RUTH, LIT, HIST, C1-HIST — may contain legitimate comparative linguistics
...
EXEMPT_TRACKS = {"oes", "ruth", "lit", "hist", "c1-hist", "c1-bio"}
...
def _detect_track(file_path: str) -> str | None:
    if not file_path:
        return None
    path = str(file_path)
    for track in ["c1-hist", "c1-bio", "hist", "b2-pro", "c1-pro",
