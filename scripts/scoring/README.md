...
| `istorio` | Historiography (C1) | 30 | Source criticism, methodology, thematic coherence |
| `bio` | Ukrainian Biographies (C1) | 128 | Biographical accuracy, legacy analysis, context |
