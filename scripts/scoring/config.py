...
TRACK_CONFIGS: dict[str, TrackConfig] = {
    ...
    'lit-essay': {
        'name': 'LIT-ESSAY: Essay & Non-Fiction',
        'level_dir': 'lit-essay',
        'module_count': 53,
                'criteria': {
            'audit_pass_rate': {
 ...
 # Will inherit from lit via track_config if I update the logic, or I should copy
    },
    'lit-drama': {
        'name': 'LIT-DRAMA: Modern Stage',
        'level_dir': 'lit-drama',
        'module_count': 11,
                'criteria': {
            'audit_pass_rate': {
    ...
    'lit-doc': {
        'name': 'LIT-DOC: Literature of Fact',
        'level_dir': 'lit-doc',
        'module_count': 8,
                'criteria': {
            'audit_pass_rate': {
    ...
    'lit-crimea': {
        'name': 'LIT-CRIMEA: Voices of Peninsula',
        'level_dir': 'lit-crimea',
        'module_count': 5,
                'criteria': {
            'audit_pass_rate': {
                'name': 'Audit Pass Rate',
    ...
    'lit-fantastika': {
        'name': 'LIT-FANTASTIKA: Sci-Fi & Fantasy',
        'level_dir': 'lit-fantastika',
        'module_count': 27,
                'criteria': {
            'audit_pass_rate': {
                'name': 'Audit Pass Rate',
    ...
    'lit-hist-fic': {
        'name': 'LIT-HIST-FIC: Historical Fiction',
        'level_dir': 'lit-hist-fic',
        'module_count': 20,
                'criteria': {
            'audit_pass_rate': {
                'name': 'Audit Pass Rate',
