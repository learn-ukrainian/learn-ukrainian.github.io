...
def check_split_duplicate_safety(
    ...
    *,
    ...
    require(isinstance(reference_texts, dict) and reference_texts, "reference_texts must be a nonempty mapping -- refusing a check against zero references")
    ...
    for label, reference_text in reference_texts.items():
        ...
        require(isinstance(reference_text, str) and reference_text, f"reference text for {label!r} must be a nonempty string")
