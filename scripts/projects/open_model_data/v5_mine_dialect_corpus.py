...
def canonical_source_work(cit: str, collector: str = "") -> str:
    ...
    """
    # Normalize unicode apostrophes in citation and collector without destroying word-internal apostrophes
    s = cit.replace("’", "'").replace("`", "'").replace("ʼ", "'")
    if collector:
        collector = collector.replace("’", "'").replace("`", "'").replace("ʼ", "'")
    ...
    AUTHOR_ALIASES: list[tuple[str, str]] = [
        (r"\b(?:Леся\s+Українка|Л\.\s*Українка|Лесі\s+Українки|Л\.\s*Укр\b\.?)", "Л. Укр."),
        (r"\b(?:Ольга\s+Кобилянська|О\.\s*Кобилянська|Кобилянська|Коб\b\.?)", "Коб."),
        (r"\b(?:Іван\s+Франко|Ів\.\s*Франко|Франко|Фр\b\.?)", "Фр."),
        (r"\b(?:Василь\s+Стефаник|В\.\s*Стефаник|Стефаник|Стеф\b\.?)", "Стеф."),
        (r"\b(?:Іван\s+Нечуй-Левицький|І\.\s*Нечуй-Левицький|Нечуй-Левицький|Нечуй|Н\.-Лев\b\.?)", "Н.-Лев."),
        (r"\b(?:Гнат\s+Хоткевич|Гн\.\s*Хоткевич|Хоткевич|Хотк\b\.?)", "Хотк."),
        (r"\b(?:Юрій\s+Федькович|Ю\.\s*Федькович|Федькович|Федьк\b\.?)", "Федьк."),
        ...
        (r"\b(?:Марко\s+Кропивницький|М\.\s*Кропивницький|Кропивницький|Кроп\b\.?)", "Кроп."),
        (r"\b(?:Іван\s+Карпенко-Карий|І\.\s*Карпенко-Карий|Карпенко-Карий|К\.-Карий\b)", "К.-Карий"),
        (r"\b(?:Кость\s+Гордієнко|К\.\s*Гордієнко|Гордієнко|Горд\b\.?)", "Горд."),
        (r"\b(?:Дмитро\s+Яворницький|Д\.\s*Яворницький|Яворницький|Яворн\b\.?|Эварн\b\.?|Еварн\b\.?)", "Яворн."),
        (r"\b(?:К\.\s*Шейковський|Шейковський|Шейк\b\.?)", "Шейк."),
        (r"\b(?:Лесь\s+Мартович|Л\.\s*Мартович|Мартович|Март\b\.?)", "Март."),
        (r"\b(?:Марко\s+Черемшина|М\.\s*Черемшина|Черемшина|Черемш\b\.?)", "Черемш."),
        (r"\b(?:Микола\s+Хвильовий|М\.\s*Хвильовий|Хвильовий|Хвиль\b)", "Хвиль"),
        (r"\b(?:Панас\s+Мирний|П\.\s*Мирний|Мирний\b)", "Мирний"),
        (r"\b(?:Олесь\s+Гончар|О\.\s*Гончар|Гончар\b)", "Гончар"),
        (r"\b(?:Василь\s+Кучер|В\.\s*Кучер|Кучер\b)", "Кучер"),
        (r"\b(?:Улас\s+Самчук|У\.\s*Самчук|Самчук\b)", "Самчук"),
        (r"\b(?:Андрій\s+Головко|А\.\s*Головко|Головко\b)", "Головко"),
        (r"\b(?:Остап\s+Вишня|О\.\s*Вишня|Вишня\b)", "Вишня"),
        (r"\b(?:Матвій\s+Номис|М\.\s*Номис|Номис\b)", "Номис"),
        (r"\b(?:Євген\s+Желехівський|Желехівський|Желех\b\.?)", "Желех."),
        (r"\b(?:Іван\s+Верхратський|Верхратський|Вх\b\.?)", "Вх."),
        (r"\b(?:Володимир\s+Гнатюк|Гнатюк|Гнат\b\.?)", "Гнат."),
    ]
