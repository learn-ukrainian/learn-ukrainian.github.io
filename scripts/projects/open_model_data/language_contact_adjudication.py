...
<label>Мовна ідентичність<select id="language"><option>ukrainian</option><option>russian</option><option>mixed_ukrainian_russian</option><option>historical_east_slavic_unresolved</option><option>church_slavonic_candidate</option><option>other_language</option><option selected>uncertain</option></select></label>
<label>Репрезентація<select id="representation"><option>standard_orthography</option><option>ukrainian_phonetic_rendering_of_russian</option><option>historical_orthography</option><option>transliteration</option><option>ocr_or_encoding_candidate</option><option selected>unknown</option></select></label>
<label>Роль<select id="role"><option>narration</option><option>quotation</option><option>dialogue</option><option>epigraph</option><option>title</option><option>citation_or_document</option><option>metalinguistic_example</option><option selected>unknown</option></select></label>
...
<h2>Подання у видах даних</h2><label>Сучасна літературна українська<select id="modern_view"><option>retain_original</option><option>mask_span_from_loss</option><option>exclude_span_or_record</option><option>protected</option><option selected>unresolved</option></select></label>
<label>Корекційний вид<select id="correction_view"><option>eligible_intake</option><option>not_applicable</option><option>protected</option><option selected>unresolved</option></select></label>
<label>Преференційний вид<select id="preference_view"><option>eligible_intake</option><option>not_applicable</option><option>protected</option><option selected>unresolved</option></select></label>
<h2>Доказ</h2><label>Переглянуті джерела (по одному на рядок)<textarea id="evidence_viewed"></textarea></label>
<label>Тип цитованого джерела<select id="source_kind"><option>primary_source</option><option>dictionary</option><option>grammar</option><option>corpus</option><option>editorial_policy</option><option>other</option></select></label>
