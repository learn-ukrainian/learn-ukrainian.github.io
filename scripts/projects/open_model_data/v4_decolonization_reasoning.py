...
DEFAULT_HERITAGE_PAIRS = resolve_data_path("registry/lexicon/heritage_pairs.yaml")
DEFAULT_HERITAGE_OVERLAY = resolve_data_path("registry/lexicon/heritage_pairs.wave1-calque.yaml")
