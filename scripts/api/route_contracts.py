...
PAGE_CONTRACTS: tuple[PageContract, ...] = (
    ...
    PageContract(
        ...
        "/api/fleet/* over the existing durable-plane SQLite read models, endpoint registry, sanitized runtime/ACP evidence, bounded legacy operations read models, and GET /api/occupancy for cloud-observer presence.",
        "Client fetches bounded read-only projections with a 5s timeout, including occupancy; no client mutation controls or artifact-body retrieval.",
        ("humans", "operators"),
