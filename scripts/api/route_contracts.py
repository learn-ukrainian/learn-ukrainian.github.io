...
ROUTE_CONTRACTS: tuple[RouteContract, ...] = (
    ...
    RouteContract(
        ...
        "exact",
        "http",
        "Opaque host occupancy: load fields, sanitized occupants {kind, agent, task_id, epic}, and burn_state in {active, idle, unknown}; burn_sources has exactly atlas_job, driver, and foundry, each with state in {active, clear, unknown} and non-negative observation_age_s. Observer heartbeats appear under host_id cloud-observer.",
