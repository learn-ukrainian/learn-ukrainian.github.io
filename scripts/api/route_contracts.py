...
ROUTE_CONTRACTS: tuple[RouteContract, ...] = (
    ...
    RouteContract(
        ...
        "prefix",
        "http",
        "Agent runtime inventory, usage, default-model quota headroom, recent calls, auth mode, and cached transport health.",
        "Runtime config, usage JSONL, sanitized probe receipt, environment presence booleans, and OAuth credential presence.",
        "No route cache; live file/env reads. Transport health carries its own receipt expiry; auth reports booleans/source names only, never secret values.",
