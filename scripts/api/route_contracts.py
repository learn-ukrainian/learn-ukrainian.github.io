...
ROUTE_CONTRACTS: tuple[RouteContract, ...] = (
    ...
    RouteContract(
        ...
        "exact",
        "http",
        "Opaque host occupancy: load fields, sanitized occupants {kind, agent, task_id, epic}, burn_state in {active, idle, unknown}, top-level attention items empty_host_underused:<host_id> and empty_host_unknown_capacity:<host_id>; burn_sources has exactly atlas_job, driver, and foundry, each with state in {active, clear, unknown} and non-negative observation_age_s. Observer heartbeats appear under host_id cloud-observer.",
    ...
    RouteContract(
        ...
        "exact",
        "http",
        "Loopback-only observer heartbeat: grok-bot/QA/Cursor/Codex report current task without a RAM lease.",
        "In-process TTL store keyed by observer agent; occupancy reads live rows into host_id cloud-observer.",
