...
GOLDEN_FRAGMENTS: dict[str, str] = {
    ...
    "intermediate": textwrap.dedent("""\
        ...
        Порівняйте:
        - **написаний лист** — пасивний дієприкметник
        - **зігрітий чай** — пасивний дієприкметник
        ...
        *Note: Grammar explained in Ukrainian using Ukrainian linguistic terms. No English in the module body; L1 anchoring lives only in Tab 2 (Словник).*"""),
...
# WORKBOOK = deeper, longer practice in the dedicated Вправи tab
#
...
ACTIVITY_CONFIGS: dict[str, dict[str, str]] = {
    ...
    "a1": {
        ...
        "INLINE_ALLOWED_TYPES": "image-to-letter, letter-grid, watch-and-repeat, divide-words, count-syllables, pick-syllables, unjumble, order, odd-one-out, observe, phrase-table, match-up, group-sort, quiz, true-false, fill-in",
        "WORKBOOK_ALLOWED_TYPES": "divide-words, count-syllables, pick-syllables, anagram, unjumble, order, odd-one-out, observe, phrase-table, match-up, group-sort, quiz, true-false, fill-in, error-correction, translate",
        ...
        "ALLOWED_ACTIVITY_TYPES": "image-to-letter, letter-grid, watch-and-repeat, divide-words, count-syllables, pick-syllables, anagram, unjumble, order, odd-one-out, observe, phrase-table, match-up, group-sort, quiz, true-false, fill-in, error-correction, translate",
        "FORBIDDEN_ACTIVITY_TYPES": "classify, mark-the-words, cloze, grammar-identify, highlight-morphemes, essay-response, reading, critical-analysis, translation-critique, comparative-study, source-evaluation, authorial-intent, debate, etymology-trace, paleography-analysis, dialect-comparison, transcription, select",
        "REQUIRED_TYPES": "",
    ...
    "a1-checkpoint": {
        ...
        "WORKBOOK_ALLOWED_TYPES": "fill-in, match-up, group-sort, unjumble, quiz, true-false, observe, phrase-table, odd-one-out, anagram",
        ...
        "ALLOWED_ACTIVITY_TYPES": "match-up, quiz, fill-in, true-false, group-sort, unjumble, observe, phrase-table, odd-one-out, anagram",
        "FORBIDDEN_ACTIVITY_TYPES": "image-to-letter, letter-grid, watch-and-repeat, divide-words, count-syllables, pick-syllables, classify, cloze, error-correction, mark-the-words, translate, essay-response, critical-analysis, reading, comparative-study, authorial-intent, etymology-trace, translation-critique, source-evaluation, debate, paleography-analysis, dialect-comparison, transcription, highlight-morphemes, grammar-identify, select",
        "REQUIRED_TYPES": "",
    ...
    "a2": {
        ...
        "INLINE_ALLOWED_TYPES": "unjumble, order, odd-one-out, observe, match-up, group-sort, quiz, true-false, fill-in, mark-the-words, error-correction",
        # #1550 U4: added 'order' (audit prioritises sequencing at A2; was missing from pipeline allow-list).
        "WORKBOOK_ALLOWED_TYPES": "unjumble, order, odd-one-out, observe, phrase-table, match-up, group-sort, quiz, true-false, fill-in, mark-the-words, error-correction, cloze, translate",
        ...
        "ALLOWED_ACTIVITY_TYPES": "unjumble, order, odd-one-out, observe, phrase-table, match-up, group-sort, quiz, true-false, fill-in, mark-the-words, error-correction, cloze, translate",
        "FORBIDDEN_ACTIVITY_TYPES": "image-to-letter, letter-grid, watch-and-repeat, divide-words, count-syllables, pick-syllables, anagram, classify, grammar-identify, highlight-morphemes, essay-response, reading, critical-analysis, translation-critique, comparative-study, source-evaluation, authorial-intent, debate, etymology-trace, paleography-analysis, dialect-comparison, transcription, select",
        "REQUIRED_TYPES": "",
    ...
    "a2-checkpoint": {
        ...
        "VOCAB_COUNT_TARGET": "20",
        "INLINE_ALLOWED_TYPES": "quiz, true-false, fill-in, match-up, group-sort, mark-the-words",
        ...
        "ALLOWED_ACTIVITY_TYPES": "quiz, true-false, fill-in, match-up, unjumble, mark-the-words, cloze, error-correction, group-sort, translate, odd-one-out, observe, phrase-table",
        "FORBIDDEN_ACTIVITY_TYPES": "anagram, classify, essay-response, critical-analysis, reading, comparative-study, authorial-intent, etymology-trace, translation-critique, source-evaluation, debate, paleography-analysis, dialect-comparison, transcription, image-to-letter, letter-grid, watch-and-repeat, divide-words, count-syllables, pick-syllables, highlight-morphemes, grammar-identify, select",
        "REQUIRED_TYPES": "",
        "PRIORITY_TYPES": "error-correction, cloze, fill-in, unjumble, translate",
    },
    # =====================================================================
    ...
    "b1-core": {
        ...
        "INLINE_ALLOWED_TYPES": "unjumble, order, match-up, group-sort, quiz, true-false, fill-in, mark-the-words, error-correction, grammar-identify, highlight-morphemes",
        "WORKBOOK_ALLOWED_TYPES": "unjumble, order, odd-one-out, match-up, group-sort, quiz, true-false, fill-in, mark-the-words, error-correction, cloze, translate, grammar-identify, highlight-morphemes, essay-response",
        ...
        "ALLOWED_ACTIVITY_TYPES": "unjumble, order, odd-one-out, match-up, group-sort, quiz, true-false, fill-in, mark-the-words, error-correction, cloze, translate, grammar-identify, highlight-morphemes, essay-response",
        "FORBIDDEN_ACTIVITY_TYPES": "image-to-letter, letter-grid, watch-and-repeat, divide-words, count-syllables, pick-syllables, anagram, observe, phrase-table, classify, reading, critical-analysis, translation-critique, comparative-study, source-evaluation, authorial-intent, debate, etymology-trace, paleography-analysis, dialect-comparison, transcription, select",
        "REQUIRED_TYPES": "",
    ...
    "b2": {
        ...
        "ITEMS_MIN": "8",
        "VOCAB_COUNT_TARGET": "30",
        "INLINE_ALLOWED_TYPES": "match-up, group-sort, quiz, true-false, fill-in, mark-the-words, error-correction, grammar-identify, highlight-morphemes",
        "WORKBOOK_ALLOWED_TYPES": "match-up, group-sort, true-false, fill-in, mark-the-words, error-correction, cloze, translate, grammar-identify, highlight-morphemes, essay-response, reading, translation-critique",
    ...
    "c1-core": {
        ...
        "WORKBOOK_ALLOWED_TYPES": "fill-in, mark-the-words, error-correction, cloze, translate, grammar-identify, highlight-morphemes, essay-response, reading, critical-analysis, translation-critique, comparative-study, etymology-trace",
        ...
        "ACTIVITY_COUNT_TARGET": "16", "ACTIVITY_MIN": "0", "ACTIVITY_MAX": "20",
        "ALLOWED_ACTIVITY_TYPES": "match-up, quiz, fill-in, mark-the-words, error-correction, cloze, translate, grammar-identify, highlight-morphemes, essay-response, reading, critical-analysis, translation-critique, comparative-study, etymology-trace",
        "FORBIDDEN_ACTIVITY_TYPES": "image-to-letter, letter-grid, watch-and-repeat, divide-words, count-syllables, pick-syllables, anagram, unjumble, order, odd-one-out, observe, phrase-table, classify, group-sort, true-false, source-evaluation, authorial-intent, debate, paleography-analysis, dialect-comparison, transcription, select",
        "REQUIRED_TYPES": "",
    ...
    "c2": {
        ...
        "ITEMS_MIN": "6",
        "VOCAB_COUNT_TARGET": "30",
        "INLINE_ALLOWED_TYPES": "quiz, fill-in, mark-the-words, grammar-identify, highlight-morphemes",
        "WORKBOOK_ALLOWED_TYPES": "error-correction, cloze, grammar-identify, highlight-morphemes, essay-response, reading, critical-analysis, translation-critique, comparative-study, authorial-intent, debate, etymology-trace",
        "INLINE_PRIORITY_TYPES": "mark-the-words, grammar-identify, quiz",
        ...
        "ALLOWED_ACTIVITY_TYPES": "quiz, fill-in, mark-the-words, error-correction, cloze, grammar-identify, highlight-morphemes, essay-response, reading, critical-analysis, translation-critique, comparative-study, authorial-intent, debate, etymology-trace",
        "FORBIDDEN_ACTIVITY_TYPES": "image-to-letter, letter-grid, watch-and-repeat, divide-words, count-syllables, pick-syllables, anagram, unjumble, order, odd-one-out, observe, phrase-table, classify, match-up, group-sort, true-false, translate, source-evaluation, paleography-analysis, dialect-comparison, transcription, select",
        "REQUIRED_TYPES": "",
    ...
    "hist": {
        ...
        "ITEMS_MIN": "4",
        "VOCAB_COUNT_TARGET": "25",
        "INLINE_ALLOWED_TYPES": "match-up, quiz, true-false, fill-in, mark-the-words",
        "WORKBOOK_ALLOWED_TYPES": "mark-the-words, essay-response, reading, critical-analysis, comparative-study, source-evaluation",
        ...
        "ALLOWED_ACTIVITY_TYPES": "match-up, quiz, true-false, fill-in, mark-the-words, essay-response, reading, critical-analysis, comparative-study, source-evaluation",
        "FORBIDDEN_ACTIVITY_TYPES": "image-to-letter, letter-grid, watch-and-repeat, divide-words, count-syllables, pick-syllables, anagram, unjumble, order, odd-one-out, observe, phrase-table, classify, group-sort, error-correction, cloze, translate, grammar-identify, highlight-morphemes, translation-critique, authorial-intent, debate, etymology-trace, paleography-analysis, dialect-comparison, transcription, select",
    ...
    "bio": {
        ...
        "VOCAB_COUNT_TARGET": "30",
        "INLINE_ALLOWED_TYPES": "match-up, quiz, true-false, fill-in, mark-the-words",
        "WORKBOOK_ALLOWED_TYPES": "mark-the-words, essay-response, reading, critical-analysis, comparative-study, source-evaluation, authorial-intent",
        "INLINE_PRIORITY_TYPES": "quiz, true-false, fill-in",
        "WORKBOOK_PRIORITY_TYPES": "reading, essay-response, critical-analysis, authorial-intent",
        "ACTIVITY_COUNT_TARGET": "10", "ACTIVITY_MIN": "0", "ACTIVITY_MAX": "12",
        "ALLOWED_ACTIVITY_TYPES": "match-up, quiz, true-false, fill-in, mark-the-words, essay-response, reading, critical-analysis, comparative-study, source-evaluation, authorial-intent",
        "FORBIDDEN_ACTIVITY_TYPES": "image-to-letter, letter-grid, watch-and-repeat, divide-words, count-syllables, pick-syllables, anagram, unjumble, order, odd-one-out, observe, phrase-table, classify, group-sort, error-correction, cloze, translate, grammar-identify, highlight-morphemes, translation-critique, debate, etymology-trace, paleography-analysis, dialect-comparison, transcription, select",
    ...
    "lit": {
        ...
        "INLINE_ALLOWED_TYPES": "match-up, quiz, true-false, fill-in, mark-the-words",
        "WORKBOOK_ALLOWED_TYPES": "mark-the-words, essay-response, reading, critical-analysis, translation-critique, comparative-study, authorial-intent, debate",
        ...
        "ACTIVITY_COUNT_TARGET": "10", "ACTIVITY_MIN": "0", "ACTIVITY_MAX": "12",
        "ALLOWED_ACTIVITY_TYPES": "match-up, quiz, true-false, fill-in, mark-the-words, essay-response, reading, critical-analysis, translation-critique, comparative-study, authorial-intent, debate",
        "FORBIDDEN_ACTIVITY_TYPES": "image-to-letter, letter-grid, watch-and-repeat, divide-words, count-syllables, pick-syllables, anagram, unjumble, order, odd-one-out, observe, phrase-table, classify, group-sort, error-correction, cloze, translate, grammar-identify, highlight-morphemes, source-evaluation, etymology-trace, paleography-analysis, dialect-comparison, transcription, select",
        "REQUIRED_TYPES": "reading, essay-response, critical-analysis",
    ...
    "oes": {
        ...
        "WORKBOOK_ALLOWED_TYPES": "mark-the-words, grammar-identify, highlight-morphemes, essay-response, reading, critical-analysis, comparative-study, etymology-trace, paleography-analysis, transcription",
        ...
        "ACTIVITY_COUNT_TARGET": "10", "ACTIVITY_MIN": "0", "ACTIVITY_MAX": "12",
        "ALLOWED_ACTIVITY_TYPES": "quiz, true-false, fill-in, mark-the-words, grammar-identify, highlight-morphemes, essay-response, reading, critical-analysis, comparative-study, etymology-trace, paleography-analysis, transcription",
        "FORBIDDEN_ACTIVITY_TYPES": "image-to-letter, letter-grid, watch-and-repeat, divide-words, count-syllables, pick-syllables, anagram, unjumble, order, odd-one-out, observe, phrase-table, classify, match-up, group-sort, error-correction, cloze, translate, translation-critique, source-evaluation, authorial-intent, debate, dialect-comparison, select",
    ...
    "ruth": {
        ...
        "VOCAB_COUNT_TARGET": "35",
        "INLINE_ALLOWED_TYPES": "quiz, true-false, fill-in, mark-the-words, grammar-identify, highlight-morphemes",
        "WORKBOOK_ALLOWED_TYPES": "mark-the-words, grammar-identify, highlight-morphemes, essay-response, reading, critical-analysis, comparative-study, etymology-trace, paleography-analysis, dialect-comparison, transcription",
        "INLINE_PRIORITY_TYPES": "mark-the-words, grammar-identify, fill-in",
        "WORKBOOK_PRIORITY_TYPES": "transcription, etymology-trace, paleography-analysis, reading, critical-analysis",
        "ACTIVITY_COUNT_TARGET": "10", "ACTIVITY_MIN": "0", "ACTIVITY_MAX": "12",
        "ALLOWED_ACTIVITY_TYPES": "quiz, true-false, fill-in, mark-the-words, grammar-identify, highlight-morphemes, essay-response, reading, critical-analysis, comparative-study, etymology-trace, paleography-analysis, dialect-comparison, transcription",
        "FORBIDDEN_ACTIVITY_TYPES": "image-to-letter, letter-grid, watch-and-repeat, divide-words, count-syllables, pick-syllables, anagram, unjumble, order, odd-one-out, observe, phrase-table, classify, match-up, group-sort, error-correction, cloze, translate, translation-critique, source-evaluation, authorial-intent, debate, select",
        "REQUIRED_TYPES": "transcription, etymology-trace",
        "PRIORITY_TYPES": "transcription, etymology-trace, paleography-analysis, reading, critical-analysis",
    },
}
