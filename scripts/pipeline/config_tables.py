...
ACTIVITY_CONFIGS: dict[str, dict[str, str]] = {
    ...
    "a2": {
        ...
        "WORKBOOK_ALLOWED_TYPES": "cloze, error-correction, fill-in, unjumble, translate, match-up, group-sort, odd-one-out, observe, phrase-table, order, quiz, true-false, mark-the-words",
        ...
        "ALLOWED_ACTIVITY_TYPES": "quiz, true-false, fill-in, match-up, unjumble, mark-the-words, cloze, error-correction, group-sort, classify, translate, odd-one-out, observe, phrase-table, order",
    ...
    "b1-core": {
        ...
        # #1550 U4: added 'reading' and 'critical-analysis' (audit prioritises them
        # for B1-vocab/skills/culture/grammar variants which all map to b1-core).
        "WORKBOOK_ALLOWED_TYPES": "cloze, error-correction, translate, fill-in, unjumble, essay-response, critical-analysis, reading, match-up, mark-the-words, grammar-identify, highlight-morphemes, group-sort",
        ...
        "ALLOWED_ACTIVITY_TYPES": "quiz, true-false, fill-in, match-up, unjumble, mark-the-words, cloze, error-correction, group-sort, translate, essay-response, critical-analysis, reading, grammar-identify, highlight-morphemes",
        "FORBIDDEN_ACTIVITY_TYPES": "anagram, image-to-letter, letter-grid, watch-and-repeat, divide-words, count-syllables, pick-syllables, source-evaluation, comparative-study, authorial-intent, debate, paleography-analysis, dialect-comparison, transcription, translation-critique, etymology-trace, classify, observe, phrase-table, odd-one-out",
        "REQUIRED_TYPES": "",
    ...
    "b2": {
        ...
        # #1550 U4: added 'critical-analysis' (audit prioritises it for B2-skills/synthesis variants).
        "WORKBOOK_ALLOWED_TYPES": "cloze, error-correction, translate, translation-critique, essay-response, critical-analysis, unjumble, reading, grammar-identify, highlight-morphemes, mark-the-words, fill-in, match-up",
        ...
        "ACTIVITY_COUNT_TARGET": "16", "ACTIVITY_MIN": "0", "ACTIVITY_MAX": "20",
        "ALLOWED_ACTIVITY_TYPES": "quiz, true-false, fill-in, match-up, unjumble, mark-the-words, cloze, error-correction, group-sort, translate, essay-response, critical-analysis, grammar-identify, highlight-morphemes, reading, translation-critique",
        "FORBIDDEN_ACTIVITY_TYPES": "anagram, image-to-letter, letter-grid, watch-and-repeat, divide-words, count-syllables, pick-syllables, paleography-analysis, dialect-comparison, transcription, debate, source-evaluation, etymology-trace, classify, observe, phrase-table, odd-one-out, select",
        "REQUIRED_TYPES": "",
    ...
    "c1-core": {
        ...
        # #1550 U4: added 'comparative-study' and 'authorial-intent' (audit prioritises them
        # for C1-folk/literature/stylistics variants).
        "WORKBOOK_ALLOWED_TYPES": "critical-analysis, essay-response, translation-critique, comparative-study, authorial-intent, cloze, reading, error-correction, translate, etymology-trace, grammar-identify, highlight-morphemes, mark-the-words, fill-in",
        ...
        "ACTIVITY_COUNT_TARGET": "16", "ACTIVITY_MIN": "0", "ACTIVITY_MAX": "20",
        "ALLOWED_ACTIVITY_TYPES": "quiz, fill-in, match-up, mark-the-words, cloze, error-correction, translate, essay-response, grammar-identify, highlight-morphemes, reading, critical-analysis, comparative-study, authorial-intent, translation-critique, etymology-trace",
        "FORBIDDEN_ACTIVITY_TYPES": "anagram, image-to-letter, letter-grid, watch-and-repeat, divide-words, count-syllables, pick-syllables, true-false, unjumble, group-sort, classify, observe, phrase-table, odd-one-out, select, source-evaluation, debate, paleography-analysis, dialect-comparison, transcription",
        "REQUIRED_TYPES": "",
    ...
    "oes": {
        ...
        # #1550 U4: added ISSUE-502 OES types (phonology-lab, grammar-lab, parallel-text,
        # historical-writing, loanword-trace) so audit-priority ⊆ pipeline-allowed.
        "WORKBOOK_ALLOWED_TYPES": "reading, essay-response, critical-analysis, etymology-trace, transcription, paleography-analysis, comparative-study, phonology-lab, grammar-lab, parallel-text, historical-writing, loanword-trace",
        ...
        "ACTIVITY_COUNT_TARGET": "10", "ACTIVITY_MIN": "0", "ACTIVITY_MAX": "12",
        "ALLOWED_ACTIVITY_TYPES": "quiz, true-false, fill-in, mark-the-words, grammar-identify, highlight-morphemes, reading, essay-response, critical-analysis, etymology-trace, transcription, paleography-analysis, comparative-study, phonology-lab, grammar-lab, parallel-text, historical-writing, loanword-trace",
    ...
    "ruth": {
        ...
        "VOCAB_COUNT_TARGET": "35",
        "INLINE_ALLOWED_TYPES": "quiz, true-false, fill-in, mark-the-words, grammar-identify, highlight-morphemes",
        # #1550 U4: added ISSUE-502 RUTH types (grammar-lab, parallel-text, historical-writing,
        # register-identify, loanword-trace, comparative-style) so audit-priority ⊆ pipeline-allowed.
        "WORKBOOK_ALLOWED_TYPES": "reading, essay-response, critical-analysis, etymology-trace, transcription, paleography-analysis, comparative-study, dialect-comparison, grammar-lab, parallel-text, historical-writing, register-identify, loanword-trace, comparative-style",
        "INLINE_PRIORITY_TYPES": "mark-the-words, grammar-identify, fill-in",
        "WORKBOOK_PRIORITY_TYPES": "transcription, etymology-trace, paleography-analysis, reading, critical-analysis",
        "ACTIVITY_COUNT_TARGET": "10", "ACTIVITY_MIN": "0", "ACTIVITY_MAX": "12",
        "ALLOWED_ACTIVITY_TYPES": "quiz, true-false, fill-in, mark-the-words, grammar-identify, highlight-morphemes, reading, essay-response, critical-analysis, etymology-trace, transcription, paleography-analysis, comparative-study, dialect-comparison, grammar-lab, parallel-text, historical-writing, register-identify, loanword-trace, comparative-style",
