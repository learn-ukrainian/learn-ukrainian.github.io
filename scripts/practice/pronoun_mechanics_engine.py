        ...
        PronounCard(
            ...
            distractors=(
                ...
                PronounDistractor(
                    text="аби-що",
                    interference_type=PronounInterferenceType.CORRUPTED_DECLENSION_STEM,
                    explanation_ua="Контекст стосується особи (істоти), тому вживається 'абихто', а не предметний неозначений 'аби-що'.",
                    explanation_en="Context refers to a person (animate); 'абихто' is required, not inanimate 'аби-що'.",
                ),
            ),
            rule_citation=cit_orth,
            rule_summary_ua=ua_orth_tog,
        ...
        PronounCard(
            ...
            distractors=(
                ...
                PronounDistractor(
                    text="хто-будь",
                    interference_type=PronounInterferenceType.CORRUPTED_DECLENSION_STEM,
                    explanation_ua="Частка будь- є префіксом і стоїть перед словом ('будь-хто'), постфікса *-будь не існує.",
                    explanation_en="Particle будь- is a prefix ('будь-хто'); postfix *-будь does not exist in Ukrainian.",
                ),
            ),
            rule_citation=cit_orth,
            rule_summary_ua=ua_orth_tog,
        ...
        PronounCard(
            ...
            distractors=(
                ...
                PronounDistractor(
                    text="будь-яку",
                    interference_type=PronounInterferenceType.CORRUPTED_DECLENSION_STEM,
                    explanation_ua="У значенні 'невибагливу, будь-якої невисокої якості' вживається саме 'абияку'; префікс аби- несе відповідне семантичне забарвлення.",
                    explanation_en="In the sense of 'unpretentious, of any modest quality', 'абияку' is used; prefix аби- carries that nuance.",
                ),
            ),
            rule_citation=cit_orth,
            rule_summary_ua=ua_orth_tog,
        ...
        PronounCard(
            ...
            distractors=(
                ...
                PronounDistractor(
                    text="що-небудь",
                    interference_type=PronounInterferenceType.CORRUPTED_DECLENSION_STEM,
                    explanation_ua="Суфікс -небудь позначає цілковиту байдужість вибору, тоді як для впевненого спостереження невідомого предмета вживається 'щось'.",
                    explanation_en="Suffix -небудь indicates indifference of choice, whereas noticing an unidentified object requires 'щось'.",
                ),
            ),
            rule_citation=cit_orth,
            rule_summary_ua=ua_orth_tog,
        ...
        PronounCard(
            ...
            distractors=(
                ...
                PronounDistractor(
                    text="абихто",
                    interference_type=PronounInterferenceType.CORRUPTED_DECLENSION_STEM,
                    explanation_ua="'Абихто' має зневажливе значення ('перший-ліпший, не вартий уваги'), тоді як для довільного позитивного вибору вживається 'будь-хто'.",
                    explanation_en="'Абихто' has a depreciatory nuance ('anyone indifferent'), whereas arbitrary positive choice requires 'будь-хто'.",
                ),
            ),
            rule_citation=cit_orth,
        ...
        PronounCard(
            ...
            distractors=(
                ...
                PronounDistractor(
                    text="абияке",
                    interference_type=PronounInterferenceType.CORRUPTED_DECLENSION_STEM,
                    explanation_ua="'Абияке' означає погане або недбало зроблене; позитивне значення довільного доручення передає 'будь-яке'.",
                    explanation_en="'Абияке' means shoddy or substandard; positive sense of any assignment requires 'будь-яке'.",
                ),
            ),
            rule_citation=cit_orth,
            rule_summary_ua=ua_orth_hyph,
