...
def build_canonical_numeral_cards() -> list[NumeralCard]:
    ...
    cards: list[NumeralCard] = [
        ...
        NumeralCard(
            ...
            correct_answer="чотири аспірантки",
            distractors=(
                NumeralDistractor(
                    text="четверо аспіранток",
                    interference_type=NumeralInterferenceType.COLLECTIVE_WITH_ADULT_FEMALE,
                    explanation_ua="З іменниками жіночого роду на позначення дорослих осіб збірні числівники не вживаються (*четверо аспіранток* — ненормативно; літературна норма — 'чотири аспірантки').",
                    explanation_en="Collective numerals are not used with adult feminine nouns (*четверо аспіранток* is non-standard; literary norm is 'чотири аспірантки').",
                ),
                NumeralDistractor(
                    text="чотири аспіранток",
                    interference_type=NumeralInterferenceType.WRONG_CASE_GOVERNMENT_5_PLUS,
                    explanation_ua="Числівник 4 вимагає називного відмінка множини ('чотири аспірантки'), а форма родового 'аспіранток' вживається з 5+.",
                    explanation_en="Numeral 4 governs Nominative plural ('чотири аспірантки'); Genitive 'аспіранток' is used with 5+.",
                ),
                NumeralDistractor(
                    text="чотири аспірантці",
                    interference_type=NumeralInterferenceType.UNINFLECTED_BASE_FORM,
...
def main() -> None:
    ...
    parser.add_argument(
        "--output", type=str, default="registry/practice/numeral_mechanics_deck.json", help="Output path"
    )
