        ...
        InterjectionCard(
            ...
            distractors=(
                ...
                InterjectionDistractor(
                    text="Тік-так",
                    interference_key=InterjectionInterferenceKey.INCORRECT_SOUND_SOURCE,
                    explanation_ua="«Тік-так» є звуконаслідуванням ходу годинника, а обережний стукіт у шибку вікна відтворює «тук-тук».",
                    explanation_en="'Тік-так' is an onomatopoeia for clock ticking, whereas tapping on a window pane is conveyed by 'тук-тук'.",
                ),
            ),
            rule_citation=cit9,
            rule_summary_ua=ua9,
...
def main() -> None:
    ...
    parser.add_argument(
        "--output", type=str, default="registry/practice/interjection_mechanics_deck.json", help="Output path"
    )
