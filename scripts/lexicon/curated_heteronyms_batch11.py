...
CURATED_HETERONYMS_BATCH_11: dict[str, list[dict[str, Any]]] = {'попереносити': [{'headword': 'поперено́сити',
               ...
               {'headword': 'поправни́й',
                ...
                'soviet_colonization_context': {'source': 'СУМ-11 (1970–1980)',
                                                ...
                                                'historical_note': 'Зафіксовано в радянський період (СУМ-11). Наведено '
                                                                   'для лексикографічної прозорості.'},
                'pre_soviet_witness': None}],
 'поривний': [{'headword': 'пори́вний',
               'short_label': 'рвучкий, нестримний або сповнений душевного пориву',
               'gloss': 'gusty, tempestuous, impulsive or full of passionate ardour',
               'pos': 'adj',
               'cefr': 'B2',
               'heritage_status': {'classification': 'standard',
                                   'is_russianism': False,
                                   'russian_shadow': False,
                                   'vesum_attested': True},
               'pronunciation': {'ipa': '[pɔˈrɪu̯nɪj]'},
               'stress': {'form': 'пори́вний', 'source': 'ВТС', 'url': 'https://slovnyk.me/dict/vts/поривний'},
               'morphology': {'pos': 'прикметник', 'paradigm': {'kind': 'adjective'}},
               'distinction_note': 'Означає рвучкий (про вітер), нестримний або палкий (про людину, характер: '
                                   '«поривний юнак, поривний вітер»). Не плутати з технічним значенням розриву '
                                   '«поривни́й».',
               'meaning': {'definitions': ['Сповнений пориву, рвучкий; нестримний, палкий.'], 'source': 'ВТС'},
               'soviet_colonization_context': {'source': 'СУМ-11 (1970–1980)',
                                               'definition': 'ПОРИ́ВНИЙ, а, е. 1. Який дме нерівномірно, поривами, '
                                                             'раптово збільшуючи силу й швидкість (про вітер). В '
                                                             'кімнату залетів поривний вихор, скуйовдив на Савченковій '
                                                             'голові волосся, підняв на столі папери, розсіяв по '
                                                             'підлозі, завертів ними по кімнаті (Збан., Сеспель, 1961, '
                                                             '444); З далини степу летіли вітри гарячі й поривні '
                                                             '(Цюпа, Три явори, 1958, 5); // Дуже швидкий, стрімкий, '
                                                             'навальний (про рух, процес і т. ін.). Він бажав.. руху, '
                                                             'поривного й нескінченного руху (Фр., VI, 1951, 243); '
                                                             'Бистрий поривний «Чардаш» одразу взяв в галоп (Шиян, '
                                                             'Партиз. край, 1946, 200); *Образно. Люблю я бистрину '
                                                             'життя Прозору, поривну, глибоку (Павл., Бистрина, 1959, '
                                                             '121). 2. Різкий, рвучкий (про рух, жест і т. ін.). Павло '
                                                             'обіперся брудним чоботом на табуретку і поривними, '
                                                             'сердитими рухами почав гортати забабрані пальцями аркуші '
                                                             'гірничого журналу робочих записів бригад (Хор., Місто.., '
                                                             '1962, 10). 3. перен. Схильний до захоплення, до '
                                                             'бурхливого вияву своїх почуттів (про вдачу людини). '
                                                             'Поривний і гарячий, не міг він терпіти ніякої кривди, '
                                                             'заступався і за себе, і за інших (Коз., Характер, 1953, '
                                                             '18); Поет залишиться для Федора таким, як за молодості. '
                                                             'Поривним і дужим (Мушк., Серце.., 1962, 38); // Який '
                                                             'виявляється бурхливо (про почуття). Поривна ніжність; // '
                                                             'Збуджений, схвильований чим-небудь; який виражає '
                                                             'збудження, захоплення, схвильованість і т. ін. '
                                                             'Здавалось, його поривний погляд потягне за собою все '
                                                             'тіло (Гончар, II, 1954, 106).',
                                               'sovietization_risk': 0,
                                               'keywords': [],
                                               'historical_note': 'Зафіксовано в радянський період (СУМ-11). Наведено '
                                                                  'для лексикографічної прозорості.'},
               'pre_soviet_witness': None},
              {'headword': 'поривни́й',
               'short_label': 'стосовний до розривання або відриву, розривний (спец.)',
               'gloss': 'rupturing, tearing, designed for breaking/tearing off (spec.)',
               'pos': 'adj',
               'cefr': 'C1',
               'heritage_status': {'classification': 'standard',
                                   'is_russianism': False,
                                   'russian_shadow': False,
                                   'vesum_attested': True},
               'pronunciation': {'ipa': '[pɔrɪu̯ˈnɪj]'},
               'stress': {'form': 'поривни́й', 'source': 'ВТС', 'url': 'https://slovnyk.me/dict/vts/поривний'},
               'morphology': {'pos': 'прикметник', 'paradigm': {'kind': 'adjective'}},
               'distinction_note': 'Спеціальний термін від «поривати» (розривати, відривати щось; розривний пристрій, '
                                   'поривна сила). Не плутати з емоційним чи метеорологічним «пори́вний».',
               'meaning': {'definitions': ['Призначений для розривання або відриву; розривний (спец.).'],
                           'source': 'ВТС'},
               'soviet_colonization_context': {'source': 'СУМ-11 (1970–1980)',
                                               'definition': 'ПОРИВНИ́Й, а́, е́. 1. лінгв. Такий, при вимові якого '
                                                             'відбувається змичка артикулюючих органів мови на шляху '
                                                             'видихуваного повітря (про звуки мови). В українській '
                                                             'мові переважають щілинні і проривні фонеми при відносно '
                                                             'значній кількості африкат (Сучасна укр. літ. м., І, '
                                                             '1969, 259); // у знач. ім. проривни́й, но́го, ч. '
                                                             'Приголосний звук, при вимові якого відбувається змичка '
                                                             'артикулюючих органів мови на шляху видихуваного повітря. '
                                                             '2. розм. Стос. до прориву (у 3 знач.). Бригаду.. '
                                                             'підсилити ніким, і, очевидно, вона стане проривною '
                                                             'ланкою (Собко, Любов, 1935, 124). 3. мед. Стос. до '
                                                             'проривання ( див. прорива́ння¹ 2).',
                                               'sovietization_risk': 0,
                                               'keywords': [],
                                               'historical_note': 'Зафіксовано в радянський період (СУМ-11). Наведено '
                                                                  'для лексикографічної прозорості.'},
 ...
 'потикати': [{'headword': 'поти́кати',
               ...
               'pre_soviet_witness': {'witness': 'Грінченко (1907–1909)',
                                      'quote': 'Потикатися, -каюся, -єшся, сов. в. поткнУтися, -нУся, -нЕшся, гл. 1) '
                                               'Спотыкаться, споткнуться. Ой поткнувся Нечаїв кінь на малу тичину. '
                                               'Лукаш. 110. Взєвси джурі маленькому коник потикати. АД. II. 86. 2) '
                                               'Показываться, показаться. Ло батька боюсь і потикаться. Г. Барв. 275. '
                                               'Там добре, де нас нема, а куди ми поткнемось, так і попсуємо. Ном. № '
                                               '2052.',
 ...
 'прозірний': [{'headword': 'прозі́рний',
                'short_label': 'прозорий, чистий, ясний, проникний для світла (розм., поет.)',
                'gloss': 'translucent, clear, limpid (poet., colloq.)',
                'pos': 'adj',
                'cefr': 'B2',
                'heritage_status': {'classification': 'standard',
                                    'is_russianism': False,
                ...
                'morphology': {'pos': 'прикметник', 'paradigm': {'kind': 'adjective'}},
                'distinction_note': 'Поетичний або народний синонім до «прозорий» («хвиля прозірна, глибінь прохолодна '
                                    'й прозірна»). Не плутати з проникливим розумом «прозірни́й».',
                'meaning': {'definitions': ['Те саме, що прозо́рий (чистий, проникний для світла; поет., розм.).'],
                            'source': 'ВТС'},
                'soviet_colonization_context': {'source': 'СУМ-11 (1970–1980)',
                ...
                'pre_soviet_witness': None},
               {'headword': 'прозірни́й',
                'short_label': 'далекоглядний, проникливий, здатний передбачати майбутнє',
                'gloss': 'perspicacious, far-sighted, visionary',
                'pos': 'adj',
                'cefr': 'C1',
                'heritage_status': {'classification': 'standard',
                                    'is_russianism': False,
                ...
                'morphology': {'pos': 'прикметник', 'paradigm': {'kind': 'adjective'}},
                'distinction_note': 'Позначає здатність глибоко проникати зором чи думкою в суть явищ, передбачати '
                                    'події (прозорливий, далекоглядний політик чи план). Не плутати з прозорою водою '
                                    '«прозі́рний».',
                'meaning': {'definitions': ['В який можна проникнути зором; далекоглядний, проникливий.'],
                            'source': 'ВТС'},
                'soviet_colonization_context': {'source': 'СУМ-11 (1970–1980)',
 ...
 'розвідниця': [{'headword': 'розві́дниця',
                 'short_label': 'жінка-військовослужбовець розвідки або розвідувальної служби',
                 'gloss': 'female reconnaissance scout or intelligence operative',
                 'pos': 'noun',
                 'cefr': 'B2',
                 'heritage_status': {'classification': 'standard',
                                     'is_russianism': False,
                 ...
                 'distinction_note': 'Військовий термін: жінка, що веде розвідку або здобуває відомості про '
                                     'супротивника. Не плутати з діалектним позначенням розлученої жінки '
                                     '«розвідни́ця».',
                ...
                {'headword': 'розвідни́ця',
                 'short_label': 'розлучена жінка або та, що ініціює розлучення (діал.)',
                 'gloss': 'divorced woman, woman initiating divorce (dial.)',
                 'pos': 'noun',
                 'cefr': 'B2',
                 'heritage_status': {'classification': 'standard',
                                     'is_russianism': False,
                 ...
                 'distinction_note': 'Діалектний іменник: жіноча пара до розвідни́к (чоловік, що розлучився або '
                                     'розводить подружжя). Не плутати з військовою розвідницею «розві́дниця».',
                 'meaning': {'definitions': ['Жіночий рід до розвідни́к (жінка, що розлучилася з чоловіком; діал.).'],
                             'source': 'ВТС'},
                 'soviet_colonization_context': {'source': 'СУМ-11 (1970–1980)',
 ...
 'розвозитися': [{'headword': 'розво́зитися',
                 ...
                 {'headword': 'розвози́тися',
                  'short_label': 'довго й марудно поратися, зволікати або розплакатися (док., розм.)',
                  'gloss': 'dally, dawdle fussing over something; burst into tears (colloq., perf.)',
                  'pos': 'verb',
                  'cefr': 'B2',
                  'heritage_status': {'classification': 'standard',
                                      'is_russianism': False,
                  ...
                  'morphology': {'pos': 'дієслово', 'paradigm': {'kind': 'verb', 'aspect': 'доконаний'}},
                  'distinction_note': 'Означає змарнувати купу часу на дрібну роботу, довго поратися або нестримно '
                                      'розпустити нюні/плакати (док. вид; розм.). Не плутати з транспортуванням товару '
                                      '«розво́зитися».',
                  'meaning': {'definitions': ['Витратити багато часу, займаючись ким-, чим-небудь; марудно зволікати '
                                              '(доконаний вид; розм., рідко).'],
                              'source': 'ВТС'},
                  'soviet_colonization_context': {'source': 'СУМ-11 (1970–1980)',
