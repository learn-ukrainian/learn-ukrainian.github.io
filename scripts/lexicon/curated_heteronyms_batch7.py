...
CURATED_HETERONYMS_BATCH_7: dict[str, list[dict[str, Any]]] = {
  ...
  "важниця": [
    {
      "headword": "ва́жниця",
      "short_label": "поважна особа (розм., ірон.)",
      "gloss": "person of importance, bigwig (colloq., iron.)",
      "pos": "noun",
      "cefr": "B2",
      "heritage_status": {
        "classification": "standard",
      ...
      "stress": {
        "form": "ва́жниця",
        "source": "ВТС / СУМ-11",
        "url": "https://slovnyk.me/dict/vts/важниця"
      },
      "morphology": {
        "pos": "іменник",
        "paradigm": {
      ...
      "distinction_note": "Розмовне або іронічне позначення поважної, значної особи (Номис, 1864: «А що він за важниця!»). Іменник істоти (знахідний множини: ва́жниць). Не плутати з «ва́жниця» (важлива справа) та «важни́ця» (чумацький інструмент або ваги).",
      "meaning": {
        "definitions": [
          "Поважна, значна особа (розм., ірон.)."
        ],
        "source": "ВТС / СУМ-11"
      },
      "soviet_colonization_context": {
        "source": "СУМ-11 (1970–1980)",
        "definition": "ВА́ЖНИЦЯ, і, ж., розм. 1. Поважна, значна особа. А що він за важниця! (Номис, 1864, № 5542).",
        "sovietization_risk": 0,
        "keywords": [],
        "historical_note": "Зафіксовано у фольклорних збірниках М. Номиса (1864) та СУМ-11 як розмовне/іронічне найменування поважної особи."
      }
    },
    {
      "headword": "ва́жниця",
      "short_label": "важлива справа (розм., фразеол.)",
      "gloss": "matter of importance, significant affair (colloq., in idioms)",
      "pos": "noun",
      "cefr": "B2",
      "heritage_status": {
        "classification": "standard",
      ...
      "distinction_note": "Важлива справа (переважно у звороті «яка́ ва́жниця!» — не важливо, дрібниця, пусте). Іменник неістоти (знахідний множини: ва́жниці). Не плутати з «ва́жниця» (поважна особа) та «важни́ця» (підставка під віз / ваги).",
      "meaning": {
        "definitions": [
          "Важлива справа (розм.; переважно у фразеологізмі «яка́ ва́жниця!» — не має значення, дрібниця)."
        ],
        "source": "ВТС / СУМ-11"
      },
      "soviet_colonization_context": {
        "source": "СУМ-11 (1970–1980)",
        "definition": "ВА́ЖНИЦЯ, і, ж., розм. 2. Важлива справа. ◊ Яка́ ва́жниця! — не важливо, не заслуговує уваги.",
        "sovietization_risk": 0,
        "keywords": [],
        "historical_note": "Зафіксовано в СУМ-11 як розмовний вираз зі значенням важливої справи або вигуку знецінення («яка́ ва́жниця!»)."
      }
    },
    {
      "headword": "важни́ця",
      "short_label": "підставка під віз (чумацька) / (заст.) ваги, терези",
      "gloss": "wagon axle prop (lever block for greasing wheels); (arch.) scales, weighing instrument, balance",
      "pos": "noun",
      "cefr": "B2",
      "heritage_status": {
      ...
      "distinction_note": "Історичний чумацький термін: підставка під вісь воза при змащуванні коліс, або прилад для зважування (ваги, терези: «зваж мене на праведній важниці»). Не плутати з «ва́жниця» (поважна особа [істота] чи важлива справа [неістота]).",
      "meaning": {
        "definitions": [
          "Підставка для підважування воза під час змащування коліс (чумац., заст.); (рідко, заст.) ваги, терези, прилад для зважування."
        ],
        "source": "ВТС / СУМ-11"
      },
      "soviet_colonization_context": {
        "source": "СУМ-11 (1970–1980)",
        "definition": "ВАЖНИ́ЦЯ, і, ж., заст. 1. Підставка для підважування воза під час змащування коліс. 2. рідко. Те саме, що вага́ 5.",
        "sovietization_risk": 0,
        "keywords": [],
        "historical_note": "Автентичний етнографічний термін чумацького побуту (підставка під вісь воза) та давня назва терезів/вагів, зафіксована у Грінченка (1907: «Торговые весы на базаре; весы. О, зваж мене на праведній важниці — К. Іов. 66») всупереч антиукраїнським імперським заборонам (Валуєвський циркуляр 1863 р., Емський указ 1876 р.) та в СУМ-11."
      }
    }
  ],
  "валковий": [
  ...
  "виправний": [
    ...
    },
    {
      ...
      "soviet_colonization_context": {
        "source": "СУМ-11 (1970–1980)",
        "definition": "ВИПРАВНИ́Й, а́, е́. Стос до виправлення чого-небудь. Виправні (регуляційні) споруди-набережні та різні інші поздовжні берегові укріплення.. // Признач. для перевиховання, виправлення кого-небудь. Виправна колонія.",
        "sovietization_risk": 1,
        "keywords": [
          "виправна колонія"
        ],
        "historical_note": "Зафіксовано в радянський період (СУМ-11) у двох значеннях: гідротехнічному (регуляційні споруди) та пенітенціарному (виправна колонія)."
      }
    }
  ],
  "випробуваний": [
  ...
  "дозвільний": [
    {
      ...
      "distinction_note": "Означає «вільний, не зайнятий працею; пов'язаний із проведенням дозвілля» (Леся Українка: «Бо не було дозвільної хвилини»). Не плутати з юридичним терміном «дозвільни́й» (дозвільний документ).",
      "meaning": {
        "definitions": [
  ...
  "жабник": [
    ...
    {
      "headword": "жабни́к",
      "short_label": "рослина (калюжниця болотяна / рід Filago / жовтець-пшінка)",
      "gloss": "botanical name for marsh marigold (Caltha palustris), cudweed (Filago L.), or lesser celandine",
      "pos": "noun",
      "cefr": "B2",
      "heritage_status": {
        "classification": "standard",
      ...
      "stress": {
        "form": "жабни́к",
        "source": "Грінченко (1907) / ВТС",
        "url": "https://slovnyk.me/dict/vts/жабник"
      },
      "morphology": {
        "pos": "іменник",
        "paradigm": {
      ...
      "distinction_note": "Ботанічна назва рослин: у народній традиції (Грінченко) — калюжниця (Caltha palustris) або частуха (Alisma plantago); у словниках (СУМ-11, ВТС) — рід Filago L. або жовтець-пшінка (з відомою лексикографічною контамінацією між Filago та родиною жовтцевих). Не плутати зі зневажливим прізвиськом «жа́бник».",
      "meaning": {
        "definitions": [
          "Народна назва вологолюбних рослин: калюжниці болотяної (Caltha palustris) чи частухи (Alisma plantago) за Словником Грінченка (1907).",
          "Ботанічна назва рослин роду жабник (Filago L., родина айстрових), або жовтецю-пшінки (родина жовтцевих) за СУМ-11 / ВТС."
        ],
        "source": "Грінченко (1907) / ВТС"
      },
      "soviet_colonization_context": {
        "source": "СУМ-11 (1970–1980)",
        "definition": "ЖАБНИ́К, у́, ч. (Filago L.). Багаторічна трав’яниста рослина родини жовтцевих, що росте на берегах річок, луках і цвіте жовтим цвітом; використовується в медицині як протицинготний засіб; жовтець-пшінка.",
        "sovietization_risk": 0,
        "keywords": [],
        "historical_note": "У Словнику Грінченка (1907–1909) «жабник» засвідчено для Caltha palustris (калюжниця болотяна, родина жовтцевих) та Alisma plantago (частуха), укладеному всупереч антиукраїнським імперським заборонам (Валуєвський циркуляр 1863 р., Емський указ 1876 р.). У радянському СУМ-11 виникла контамінація: зазначено латинську назву роду Filago L. (родина айстрових, переважно однорічні трави), але наведено опис багаторічника родини жовтцевих (жовтець-пшінка)."
      }
    }
  ],
  "жировий": [
  ...
  "загукати": [
    ...
    },
    {
      ...
      "distinction_note": "Означає «голосно крикнути, покликати когось голосним окриком» (Т. Шевченко: «Гуляй!» — загукали; Грінченко: «Феся загукала»). Не плутати з природним гулом «загу́кати».",
      "meaning": {
        "definitions": [
