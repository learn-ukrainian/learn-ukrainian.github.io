...
CURATED_HETERONYMS_BATCH_7: dict[str, list[dict[str, Any]]] = {
  ...
  "важниця": [
    {
      "headword": "ва́жниця",
      "short_label": "поважна особа (розм., ірон.) / важлива справа",
      "gloss": "person of importance, bigwig (colloq., iron.); important matter",
      "pos": "noun",
      "cefr": "B2",
      "heritage_status": {
        "classification": "standard",
      ...
      "distinction_note": "Розмовне або іронічне: поважна персона (Номис: «А що він за важниця!») або фразеологізм «яка́ ва́жниця!» (дрібниця, пусте). Не плутати з «важни́ця» (чумацький інструмент або ваги).",
      "meaning": {
        "definitions": [
    ...
    },
    {
      ...
      "distinction_note": "Історичний чумацький термін: підставка під вісь воза при змащуванні коліс, або прилад для зважування (ваги, терези: «зваж мене на праведній важниці»). Не плутати з «ва́жниця» (поважна особа, важлива справа).",
      "meaning": {
        "definitions": [
