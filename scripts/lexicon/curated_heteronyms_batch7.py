  ...
  "важниця": [
    {
      ...
      "distinction_note": "Розмовне або іронічне позначення поважної, значної особи (Номис, 1864: «А що він за важниця!»). Іменник істоти (знахідний множини: важни́ць). Не плутати з «ва́жниця» (важлива справа) та «важни́ця» (чумацький інструмент або ваги).",
      "meaning": {
        "definitions": [
    ...
    },
    {
      ...
      "distinction_note": "Важлива справа (переважно у звороті «яка́ ва́жниця!» — не важливо, дрібниця, пусте). Іменник неістоти (знахідний множини: важни́ці). Не плутати з «ва́жниця» (поважна особа) та «важни́ця» (підставка під віз / ваги).",
      "meaning": {
        "definitions": [
