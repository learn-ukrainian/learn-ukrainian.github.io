  ...
  "дозвільний": [
    {
      ...
      "distinction_note": "Означає «вільний, не зайнятий працею; пов'язаний із проведенням дозвілля» (Леся Українка: «дозвільна хвилина»). Не плутати з юридичним терміном «дозвільни́й» (дозвільний документ).",
      "meaning": {
        "definitions": [
