"""Batch heteronyms expansion dataset for #8039 (epic #4387).

Admitted high-frequency heteronyms attested in academic sources (СУМ-11, VESUM, СУМ-20).
"""
...
CURATED_HETERONYMS_BATCH: dict[str, list[dict[str, Any]]] = {
    "обід": [
        {
            "headword": "о́бід",
