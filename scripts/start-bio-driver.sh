...
# cold-start and bootstraps from .claude/bio-epic/CLAUDE-DRIVER-HANDOFF.md instead
# (gitignored local state — driver handoffs are out of git/PRs, user policy 2026-06-23).
