...
TRACKS = [
    ...
    (1,  "a1",             64,  "core",    []),
    (2,  "a2",             76,  "core",    [("a1", 0.80)]),
    (3,  "b1",            100,  "core",    [("a2", 0.80)]),
    (4,  "b2",             85,  "core",    [("b1", 0.80)]),
    (5,  "c1",            106,  "core",    [("b2", 0.80)]),
    (6,  "hist",          140,  "seminar", [("b1", 0.80)]),
    (7,  "bio",           176,  "seminar", [("b2", 0.80)]),
    (8,  "istorio",       136,  "seminar", [("hist", 0.80), ("c1", 0.30)]),
    (9,  "lit",           221,  "seminar", [("b2", 0.80)]),
    (10, "lit-essay",      59,  "seminar", [("lit", 0.80)]),
    (11, "lit-hist-fic",   20,  "seminar", [("lit", 0.80)]),
    (12, "lit-fantastika", 27,  "seminar", [("lit", 0.80)]),
    (13, "lit-war",        28,  "seminar", [("lit", 0.80)]),
    (14, "lit-humor",      14,  "seminar", [("lit", 0.80)]),
