...
ACTIVITY_TYPE_BY_COMPONENT = {
    ...
    "RitualSequencing": "ritual-sequencing",
    "VariantComparison": "variant-comparison",
    "MotifFormula": "motif-formula",
    "PerformanceActivity": "performance",
