...
4. **Start every section with a concrete example, a dialogue, or a direct statement.** Never use transitional filler ("Let us look at...", "In this section we will...", "Now let's explore..."). If your first sentence could appear in any language course about any topic, delete it and start with something specific to Ukrainian.
