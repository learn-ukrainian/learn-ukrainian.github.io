...
- **Вони слухають уважно.** (They listen attentively.)
...
- **Він зазвичай читає ввечері.** (He usually reads in the evening.)
...
- **Я ніколи не працюю в неділю.** (I never work on Sunday.)
...
- **Цей кухар готує дуже смачно!** (This chef cooks very deliciously!)
