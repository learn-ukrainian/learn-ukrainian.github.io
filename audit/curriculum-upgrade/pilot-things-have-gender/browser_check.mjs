...
// VERIFY_ROOT supports the pinned extracted fixture without writing product pages.
const fixtureRoot = process.env.VERIFY_ROOT || process.cwd();
const file = path.resolve(fixtureRoot, 'docs/poc/poc-lesson-split-things-have-gender.html');
const outDir = path.resolve(fixtureRoot, 'audit/curriculum-upgrade/pilot-things-have-gender/screens');
