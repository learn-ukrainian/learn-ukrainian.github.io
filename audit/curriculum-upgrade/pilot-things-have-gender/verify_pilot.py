...
Phase 1 adaptation: protected-tree checking covers the original module and
plans against origin/main; machinery/scripts/site edits are authorized in Phase 1.
Content baseline hashes and all lesson thresholds stay pinned. VERIFY_ROOT may
