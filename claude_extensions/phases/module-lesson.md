...
>
> - ❌ Activities (essays, quizzes, exercises) → Phase 5
> - ❌ Vocabulary tables → Phase 7
> - ❌ Practice recommendations → auto-generated by script
> - ✓ Main narrative/explanation
> - ✓ Examples within text
> - ✓ Engagement boxes
> - ✓ Primary source excerpts (for history modules)
>
> ### Vocabulary Usage
>
...
- **Читання:** Extended narrative (500+ words for history)
- **Первинні джерела:** Primary source excerpts with analysis
- **Аналіз/Обговорення:** Critical analysis section
- **Деколонізаційний погляд:** Ukraine-centric perspective (history only)
...
2. **No Russian interference:** Check vocabulary against Goroh, Словник.ua
...
✓ Immersion: {percentage}% (target: {level_target})
...
> **Чому це важливо?**
>
> Трипільська культура — це не просто археологічна знахідка. Це доказ того, що на території сучасної України існувала одна з найрозвиненіших цивілізацій Європи ще за тисячоліття до появи єгипетських пірамід.

## Вступ

Трипільська культура — це одна з найяскравіших сторінок прадавньої історії України... [500 words]

[!history-bite] Археологічна давність
Археологічні дослідження підтверджують, що поселення на місці сучасного Києва існувало ще в кам'яну добу — понад 20 000 років тому!

## Читання

Одним із найвражаючих досягнень Трипілля є створення протоміст... [2000 words]

_Приклад:_ «Трипільці будували двоповерхові будинки з глини.»

---

# Підсумок

Трипільська цивілізація демонструє глибокі корені української цивілізації... [200 words]
...
[!tip] Remember: В looks like B but sounds like V
