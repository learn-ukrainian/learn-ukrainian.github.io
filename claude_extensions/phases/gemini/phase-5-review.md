...
6. **Research notes** (if exists): `{RESEARCH_PATH}`
...
At module {MODULE_NUM}, students know ONLY modules 1-{PREV_MODULE}. Any grammar from later modules is scope creep.
...
Write your complete review to the output file specified in the task: **{OUTPUT_PATH}**
