...
- `starlight/src/content/docs/{level}/module-{num}.mdx` (deployment)
...
- For Core (A1-C2): `starlight/src/content/docs/{level}/module-{num}.mdx`
- For Tracks (hist, etc): `starlight/src/content/docs/{level}/{slug}.mdx`
...
✓ MDX generated: starlight/src/content/docs/{level}/{mdx_filename}
✓ Audit: ALL GATES ✅
...
✓ Skeleton vocabulary created
✓ MDX generated: starlight/src/content/docs/hist/trypillian-civilization.mdx
✓ Audit: ALL GATES ✅
...
✓ Skeleton vocabulary created
✓ MDX generated: starlight/src/content/docs/a1/module-01.mdx
✓ Audit: ALL GATES ✅
