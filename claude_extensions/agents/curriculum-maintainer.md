...
| hist, c1-bio, c1-hist, lit, oes, ruth | Seminar | 7 phases (Research → Assess → Enrich Plan → Meta → Content → YAML → Review) | `/review-content-v4` (14 dimensions) |
...
claude_extensions/commands/review-tiers/tier-3-seminar.md     # HIST, C1-BIO, C1-HIST, LIT
