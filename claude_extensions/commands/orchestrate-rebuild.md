...
/orchestrate-rebuild bio 5  # Build BIO module 5 from scratch
```
...
6. **HIST**, **BIO**, **ISTORIOHRAFIIA**, **LIT**, **OES**, **RUTH**
7. **LIT-\***, **B2-PRO**, **C1-PRO**
...
```
SEMINAR_TRACKS: hist, bio, istoriohrafiia, lit, oes, ruth → 6 phases (0-5)
