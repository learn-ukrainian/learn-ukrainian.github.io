...
Validate grammar in queue files generated by the audit system. This skill embeds the Ukrainian Grammar Validator rules to ensure consistent, accurate validation.
...
Save validated results to `queue/{module}.validated.yaml`:
