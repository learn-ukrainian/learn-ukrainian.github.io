...
|------|---------|--------|-----------------|
| Core grammar | M01-20 | 50-60% | Grammar theory (cases, aspect) |
| Applied grammar | M21-50 | 60-75% | Abstract concepts only |
| Consolidation | M51-70 | 75-90% | Vocabulary tables only |
