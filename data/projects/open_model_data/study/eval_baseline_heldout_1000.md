...
>
> **Evaluation Timestamp:** `2026-09-22T13:27:53.488767+00:00`
> **Overall Gate Verdict:** **❌ FAIL**
> **Total Evaluated Cases:** `1000` (`1000` format-valid, `0` format-errors)
...
| **Gate 2: Harmful-Edit Rate** | <= 1.0% (Clopper-Pearson 95%) | **52.67%** (Upper bound: **56.09%**, N=600) | ❌ FAIL |
| **Gate 3: Span Integrity Gate** | 100% (0 mutations outside span) | **0.00%** (1000 violations) | ❌ FAIL |
| **Gate 4: Citation Whitelist Gate** | 0% foreign hallucinations | **6** violations (rate: 0.60%) | ❌ FAIL |
