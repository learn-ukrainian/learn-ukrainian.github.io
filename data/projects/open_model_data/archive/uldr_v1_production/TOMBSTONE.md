...
- **Empirical Literature:**
  - Paniv, Yurii, et al. (2026). *"Data-Efficient Adaptation of Multilingual LLMs to Ukrainian"*, Proceedings of the Fifth Ukrainian Natural Language Processing Conference (UNLP 2026), pages 155–168, Lviv, Ukraine. Association for Computational Linguistics. [https://aclanthology.org/2026.unlp-1.14/](https://aclanthology.org/2026.unlp-1.14/). Presents a reproducible data-centric recipe adapting Gemma-3-12B to Ukrainian using vocabulary surgery, cross-lingual transfer of quality classifiers, and filtered pretraining/synthetic instruction tuning. Demonstrates strong performance across Ukrainian translation, summarization, and question-answering with 1.5x fewer tokens than the base model.
