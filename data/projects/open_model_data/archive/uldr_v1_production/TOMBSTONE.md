...
2. **Targeted Adaptation Context:** UNLP 2026 literature (*Paniv et al.*) establishes a three-stage adaptation recipe for Gemma-3-12B consisting of vocabulary adaptation, 30B tokens of filtered continued pre-training, and targeted instruction tuning. Separate from continued pre-training research, our educational project focuses its own data engineering on high-precision alignment and linguistic decolonization rather than unverified bulk synthetic generation.
...
- **Empirical Literature:**
  - Paniv, Yurii, et al. (2026). *"Data-Efficient Adaptation of Multilingual LLMs to Ukrainian"*, Proceedings of the Fifth Ukrainian Natural Language Processing Conference (UNLP 2026), pages 155–168, Lviv, Ukraine. Association for Computational Linguistics. [https://aclanthology.org/2026.unlp-1.14/](https://aclanthology.org/2026.unlp-1.14/). Presents a reproducible data-centric recipe adapting Gemma-3-12B to Ukrainian using vocabulary surgery, 30B tokens of filtered continued pretraining with cross-lingual transfer of quality classifiers, and instruction tuning. Demonstrates strong performance across Ukrainian translation, summarization, and question-answering with 1.5x fewer tokens than the base model.
- **Foundation Model Benchmarks:**
  - Google Gemma 4 (Hugging Face Open Ukrainian LLM Leaderboard, 2026): Modern foundation models demonstrate strong baseline native Ukrainian comprehension and generation, directing our project engineering focus toward human-grounded alignment, morphological precision, and decolonization defense rather than generic text generation.
