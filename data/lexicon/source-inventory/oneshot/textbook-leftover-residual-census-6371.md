...
| `vesum_db` | yes | `/home/ops/learn-ukrainian/.worktrees/dispatch/gemini/6371-enrich-textbook-leftovers/data/vesum.db` |
| `sources_db` | yes | `/home/ops/learn-ukrainian/.worktrees/dispatch/gemini/6371-enrich-textbook-leftovers/data/sources.db` |
...
- loaded: `True`
- source: `site/src/data/lexicon-manifest.json`
- unique keys: `28531`
- entry lemmas: `28531`
- json_sha256: `None`
...
- refused: `True`
- reason: no named teacher-P1 leftovers are missing from the Atlas catalog
- admitted this run: `[]`
