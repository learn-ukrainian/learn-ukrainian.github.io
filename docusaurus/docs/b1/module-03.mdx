...
<Quiz questions={[
  {
    question: `Коли граматика каже \"родовий відмінок використовується після 'без'\", що вона пояснює?`,
    options: [
      { text: `коли вживати родовий відмінок`, correct: true },
      { text: `що означає родовий відмінок`, correct: false },
      { text: `як утворити родовий відмінок`, correct: false },
      { text: `чому існує родовий відмінок`, correct: false }
    ]
  },  {
    question: `Якщо підручник пише \"доконаний вид означає завершену дію\", що він пояснює?`,
    options: [
      { text: `коли вживати доконаний вид`, correct: false },
      { text: `що означає доконаний вид`, correct: true },
      { text: `як утворити доконаний вид`, correct: false },
      { text: `де вживати доконаний вид`, correct: false }
    ]
  },  {
    question: `Інструкція \"порівняйте ці два речення\" просить вас зробити що?`,
    options: [
      { text: `порівняти речення`, correct: true },
      { text: `написати речення`, correct: false },
      { text: `прочитати речення`, correct: false },
      { text: `перекласти речення`, correct: false }
    ]
  },  {
    question: `Коли бачите \"зверніть увагу на закінчення\", що від вас очікують?`,
    options: [
      { text: `уважно подивитися на закінчення`, correct: true },
      { text: `змінити закінчення`, correct: false },
      { text: `видалити закінчення`, correct: false },
      { text: `додати закінчення`, correct: false }
    ]
  },  {
    question: `Слово \"наприклад\" у граматичному тексті підручника означає яку конструкцію?`,
    options: [
      { text: `for example`, correct: true },
      { text: `in contrast`, correct: false },
      { text: `therefore`, correct: false },
      { text: `however`, correct: false }
    ]
  },  {
    question: `Фраза \"на відміну від англійської\" у граматичному поясненні показує що?`,
    options: [
      { text: `контраст з англійською`, correct: true },
      { text: `схожість з англійською`, correct: false },
      { text: `переклад на англійську`, correct: false },
      { text: `походження з англійської`, correct: false }
    ]
  },  {
    question: `Коли підручник пише \"отже, це іменник\", що означає слово \"отже\"?`,
    options: [
      { text: `for example`, correct: false },
      { text: `however`, correct: false },
      { text: `therefore`, correct: true },
      { text: `similar to`, correct: false }
    ]
  },  {
    question: `Фраза \"подібно до російської\" у граматичному поясненні показує яке відношення?`,
    options: [
      { text: `контраст з російською`, correct: false },
      { text: `схожість з російською`, correct: true },
      { text: `переклад на російську`, correct: false },
      { text: `походження з російської`, correct: false }
    ]
  },  {
    question: `Слово \"тобто\" у граматичному тексті означає яку конструкцію англійською?`,
    options: [
      { text: `for example`, correct: false },
      { text: `that is, in other words`, correct: true },
      { text: `therefore`, correct: false },
      { text: `however`, correct: false }
    ]
  },  {
    question: `Фраза \"таким чином утворюється множина\" у підручнику означає що?`,
    options: [
      { text: `thus the plural is formed`, correct: true },
      { text: `the plural does not form`, correct: false },
      { text: `compare the plural`, correct: false },
      { text: `note the plural`, correct: false }
    ]
  },  {
    question: `Коли граматика пише \"виражає адресата\", вона пояснює що?`,
    options: [
      { text: `коли вживати форму`, correct: false },
      { text: `що форма означає`, correct: true },
      { text: `як утворити форму`, correct: false },
      { text: `де знайти форму`, correct: false }
    ]
  },  {
    question: `Інструкція \"вживається для опису\" у граматиці пояснює яку функцію?`,
    options: [
      { text: `коли використовувати форму`, correct: true },
      { text: `що означає форма`, correct: false },
      { text: `як написати форму`, correct: false },
      { text: `чому існує форма`, correct: false }
    ]
  },  {
    question: `Слово \"вказує на\" у граматичному тексті означає яку конструкцію?`,
    options: [
      { text: `is used`, correct: false },
      { text: `means`, correct: false },
      { text: `indicates`, correct: true },
      { text: `compares`, correct: false }
    ]
  },  {
    question: `Фраза \"показує зменшувальне значення\" у граматиці пояснює яку характеристику?`,
    options: [
      { text: `коли використовувати`, correct: false },
      { text: `яке значення має`, correct: true },
      { text: `як утворити`, correct: false },
      { text: `де знайти`, correct: false }
    ]
  }
]} />
...
<Quiz questions={[
  {
    question: `Найменша значуща частина слова, від якої утворюються інші слова — це що?`,
    options: [
      { text: `корінь`, correct: true },
      { text: `суфікс`, correct: false },
      { text: `префікс`, correct: false },
      { text: `закінчення`, correct: false }
    ]
  },  {
    question: `Частина слова, яка стоїть перед коренем і змінює значення — це що?`,
    options: [
      { text: `корінь`, correct: false },
      { text: `суфікс`, correct: false },
      { text: `префікс`, correct: true },
      { text: `закінчення`, correct: false }
    ]
  },  {
    question: `Частина слова, яка стоїть після кореня і утворює нові слова — це що?`,
    options: [
      { text: `корінь`, correct: false },
      { text: `суфікс`, correct: true },
      { text: `префікс`, correct: false },
      { text: `основа`, correct: false }
    ]
  },  {
    question: `Частина слова без закінчення у словотворенні — це яка частина?`,
    options: [
      { text: `корінь`, correct: false },
      { text: `суфікс`, correct: false },
      { text: `префікс`, correct: false },
      { text: `основа`, correct: true }
    ]
  },  {
    question: `Англійське граматичне слово \"root\" українською перекладається як що?`,
    options: [
      { text: `корінь`, correct: true },
      { text: `суфікс`, correct: false },
      { text: `префікс`, correct: false },
    ...
    question: `Англійське граматичне слово \"suffix\" українською перекладається як що?`,
    options: [
      { text: `корінь`, correct: false },
      { text: `суфікс`, correct: true },
      { text: `префікс`, correct: false },
    ...
    question: `Англійське граматичне слово \"prefix\" українською перекладається як що?`,
    options: [
      { text: `корінь`, correct: false },
      { text: `суфікс`, correct: false },
      { text: `префікс`, correct: true },
    ...
    question: `Коли граматика каже \"це виняток\", що вона означає?`,
    options: [
      { text: `це не підпорядковується правилу`, correct: true },
      { text: `це підпорядковується правилу`, correct: false },
      { text: `це нове правило`, correct: false },
      { text: `це старе правило`, correct: false }
    ]
  },  {
    question: `Коли граматика каже \"це правило\", що вона означає?`,
    options: [
      { text: `це виняток`, correct: false },
      { text: `це закономірність`, correct: true },
      { text: `це помилка`, correct: false },
      { text: `це питання`, correct: false }
    ]
  },  {
    question: `У дієслові \"написати\" яка частина слова є коренем?`,
    options: [
      { text: `на-`, correct: false },
      { text: `-пис-`, correct: true },
      { text: `-а-`, correct: false },
      { text: `-ти`, correct: false }
    ]
  },  {
    question: `У дієслові \"написати\" яка частина слова є префіксом?`,
    options: [
    ...
    question: `Англійське граматичне слово \"stem\" українською перекладається як що?`,
    options: [
      { text: `корінь`, correct: false },
      { text: `суфікс`, correct: false },
      { text: `префікс`, correct: false },
    ...
    question: `Слово \"форма\" у граматичному контексті означає яке поняття?`,
    options: [
    ...
    question: `Коли інструкція каже \"утворіть форму\", вона просить що?`,
    options: [
      { text: `create the form`, correct: true },
      { text: `find the form`, correct: false },
      { text: `delete the form`, correct: false },
      { text: `compare the form`, correct: false }
    ]
  }
]} />
...
<MatchUp pairs={[
  { left: `використовується`, right: `is used` },
  { left: `означає`, right: `means` },
  { left: `показує`, right: `shows` },
  { left: `виражає`, right: `expresses` },
  { left: `вказує на`, right: `indicates` },
  { left: `порівняйте`, right: `compare` },
  { left: `зверніть увагу`, right: `note, pay attention` },
  { left: `наприклад`, right: `for example` },
  { left: `отже`, right: `therefore` },
  { left: `таким чином`, right: `thus` }
]} />

### Словотвір і порівняння

<MatchUp pairs={[
  { left: `на відміну від`, right: `in contrast to` },
  { left: `подібно до`, right: `similar to` },
  { left: `правило`, right: `rule` },
  { left: `виняток`, right: `exception` },
  { left: `форма`, right: `form` },
  { left: `основа`, right: `stem` },
  { left: `корінь`, right: `root` },
  { left: `суфікс`, right: `suffix` },
  { left: `префікс`, right: `prefix` },
  { left: `значення`, right: `meaning` }
]} />
...
<FillIn items={[
  {
    sentence: `\"X ___ після прийменника\" означає \"is used\".`,
    answer: `використовується`,
    options: [`використовується`, `означає`, `показує`, `виражає`]
  },  {
    sentence: `\"X ___ завершену дію\" означає \"means\".`,
    answer: `означає`,
    options: [`використовується`, `означає`, `показує`, `виражає`]
  },  {
    sentence: `\"Цей суфікс ___ зменшення\" означає \"shows\".`,
    answer: `показує`,
    options: [`використовується`, `означає`, `показує`, `виражає`]
  },  {
    sentence: `\"Давальний відмінок ___ адресата\" означає \"expresses\".`,
    answer: `виражає`,
    options: [`використовується`, `означає`, `показує`, `виражає`]
  },  {
    sentence: `\"Закінчення ___ жіночий рід\" означає \"indicates\".`,
    answer: `вказує на`,
    options: [`вказує на`, `означає`, `показує`, `виражає`]
  },  {
    sentence: `\"___ ці два речення\" означає \"compare\".`,
    answer: `Порівняйте`,
    options: [`Порівняйте`, `Напишіть`, `Прочитайте`, `Знайдіть`]
  },  {
    sentence: `\"___ на закінчення\" означає \"pay attention\".`,
    answer: `Зверніть увагу`,
    options: [`Зверніть увагу`, `Порівняйте`, `Напишіть`, `Знайдіть`]
  },  {
    sentence: `\"___, це прислівник\" означає \"that is\".`,
    answer: `Тобто`,
    options: [`Тобто`, `Отже`, `Наприклад`, `Однак`]
  },  {
    sentence: `\"___ англійської\" означає \"in contrast to\".`,
    answer: `На відміну від`,
    options: [`На відміну від`, `Подібно до`, `Наприклад`, `Тобто`]
  },  {
    sentence: `\"___ російської\" означає \"similar to\".`,
    answer: `Подібно до`,
    options: [`На відміну від`, `Подібно до`, `Наприклад`, `Тобто`]
  },  {
    sentence: `\"___, це іменник\" означає \"therefore\".`,
    answer: `Отже`,
    options: [`Тобто`, `Отже`, `Наприклад`, `Однак`]
  },  {
    sentence: `\"___: книга → книги\" означає \"for example\".`,
    answer: `Наприклад`,
    options: [`Тобто`, `Отже`, `Наприклад`, `Однак`]
  },  {
    sentence: `\"___ утворюється множина\" означає \"thus\".`,
    answer: `Таким чином`,
    options: [`Таким чином`, `Тобто`, `Наприклад`, `Однак`]
  },  {
    sentence: `\"Ця форма ___ для опису\" означає \"is used\".`,
    answer: `вживається`,
...
<FillIn items={[
  {
    sentence: `Найменша частина слова — ___.`,
    answer: `корінь`,
    options: [`корінь`, `суфікс`, `префікс`, `основа`]
  },  {
    sentence: `Частина перед коренем — ___.`,
    answer: `префікс`,
    options: [`корінь`, `суфікс`, `префікс`, `основа`]
  },  {
    sentence: `Частина після кореня — ___.`,
    answer: `суфікс`,
    options: [`корінь`, `суфікс`, `префікс`, `основа`]
  },  {
    sentence: `Слово без закінчення — ___.`,
    answer: `основа`,
    options: [`корінь`, `суфікс`, `префікс`, `основа`]
  },  {
    sentence: `\"Root\" українською — ___.`,
    answer: `корінь`,
    options: [`корінь`, `суфікс`, `префікс`, `основа`]
  },  {
    sentence: `\"Suffix\" українською — ___.`,
    answer: `суфікс`,
    options: [`корінь`, `суфікс`, `префікс`, `основа`]
  },  {
    sentence: `\"Prefix\" українською — ___.`,
    answer: `префікс`,
    options: [`корінь`, `суфікс`, `префікс`, `основа`]
  },  {
    sentence: `\"Exception\" українською — ___.`,
    answer: `виняток`,
    options: [`правило`, `виняток`, `форма`, `основа`]
  },  {
    sentence: `\"Rule\" українською — ___.`,
    answer: `правило`,
    options: [`правило`, `виняток`, `форма`, `основа`]
  },  {
    sentence: `\"Form\" українською — ___.`,
    answer: `форма`,
    options: [`правило`, `виняток`, `форма`, `основа`]
  },  {
    sentence: `\"Stem\" українською — ___.`,
    answer: `основа`,
    options: [`корінь`, `суфікс`, `префікс`, `основа`]
  },  {
    sentence: `У слові \"прочитати\" ___ — \"про-\".`,
    answer: `префікс`,
    options: [`корінь`, `суфікс`, `префікс`, `основа`]
  },  {
    sentence: `У слові \"прочитати\" ___ — \"чит-\".`,
    answer: `корінь`,
    options: [`корінь`, `суфікс`, `префікс`, `основа`]
  },  {
    sentence: `Це не правило, а ___.`,
    answer: `виняток`,
...
<TrueFalse items={[
  {
    statement: `\"Використовується\" означає \"is used\".`,
    isTrue: true,
    explanation: `Правильно!`
  },  {
    statement: `\"Означає\" означає \"is used\".`,
    isTrue: false,
    explanation: `Неправильно! \"Означає\" = means.`
  },  {
    statement: `\"Порівняйте\" — це інструкція.`,
    isTrue: true,
    explanation: `Правильно! Compare.`
  },  {
    statement: `\"Наприклад\" означає \"therefore\".`,
    isTrue: false,
    explanation: `Неправильно! \"Наприклад\" = for example.`
  },  {
    statement: `\"Корінь\" означає \"root\".`,
    isTrue: true,
    explanation: `Правильно!`
  },  {
    statement: `\"Суфікс\" стоїть перед коренем.`,
    isTrue: false,
    explanation: `Неправильно! Суфікс — після, префікс — перед.`
  },  {
    statement: `\"На відміну від\" показує контраст.`,
    isTrue: true,
    explanation: `Правильно! In contrast to.`
  },  {
    statement: `\"Подібно до\" показує контраст.`,
    isTrue: false,
    explanation: `Неправильно! \"Подібно до\" = similar to.`
  },  {
    statement: `\"Виняток\" означає \"exception\".`,
    isTrue: true,
    explanation: `Правильно!`
  },  {
    statement: `\"Правило\" означає \"exception\".`,
    isTrue: false,
    explanation: `Неправильно! \"Правило\" = rule.`
  },  {
    statement: `\"Зверніть увагу\" означає \"pay attention\".`,
    isTrue: true,
    explanation: `Правильно!`
  },  {
    statement: `\"Тобто\" означає \"therefore\".`,
    isTrue: false,
    explanation: `Неправильно! \"Тобто\" = that is, \"отже\" = therefore.`
  },  {
    statement: `\"Основа\" означає \"stem\".`,
    isTrue: true,
    explanation: `Правильно!`
  },  {
    statement: `\"Префікс\" стоїть після кореня.`,
    isTrue: false,
    explanation: `Неправильно! Префікс — перед коренем.`
  }
]} />
...
<GroupSort groups={{
  "Пояснення значення": ["означає", "показує", "виражає", "вказує на"],
  "Пояснення вживання": ["використовується", "вживається"],
  "Інструкції": ["порівняйте", "зверніть увагу", "наприклад", "тобто"],
  "Частини слова": ["корінь", "суфікс", "префікс", "основа"]
}} />

### Порівняння і логіка

<GroupSort groups={{
  "Порівняння": ["на відміну від", "подібно до", "різниця", "відмінність"],
  "Логічні зв'язки": ["отже", "таким чином", "тобто", "наприклад"],
  "Правила і винятки": ["правило", "виняток", "закономірність"],
  "Значення слів": ["означає", "виражає", "показує"]
}} />

### Граматичні пояснення

<Unjumble items={[
  { jumbled: `використовується / родовий / після / відмінок / прийменника / без / для / позначення / відсутності / чогось`, answer: `Родовий відмінок використовується після прийменника без для позначення відсутності чогось.` },
  { jumbled: `доконаний / вид / означає / що / дія / завершена / і / має / результат`, answer: `Доконаний вид означає, що дія завершена і має результат.` },
  { jumbled: `порівняйте / ці / два / речення / і / зверніть / увагу / на / відмінності / у / закінченнях / слів`, answer: `Порівняйте ці два речення і зверніть увагу на відмінності у закінченнях слів.` },
  { jumbled: `корінь / найменша / є / значуща / частина / від / слова / якої / утворюються / інші / споріднені / слова`, answer: `Корінь є найменша значуща частина слова, від якої утворюються інші споріднені слова.` },
  { jumbled: `префікс / це / частина / слова / яка / стоїть / перед / коренем / і / змінює / значення / дієслова`, answer: `Префікс — це частина слова, яка стоїть перед коренем і змінює значення дієслова.` },
  { jumbled: `суфікс / стоїть / після / кореня / і / утворює / нові / слова`, answer: `Суфікс стоїть після кореня і утворює нові слова.` },
  { jumbled: `наприклад / слово / книга / у / родовому / відмінку / має / форму / книги / із / закінченням / и`, answer: `Наприклад, слово книга у родовому відмінку має форму книги із закінченням -и.` },
  { jumbled: `на / відміну / від / англійської / українська / мова / має / сім / відмінків / для / іменників`, answer: `На відміну від англійської, українська мова має сім відмінків для іменників.` },
  { jumbled: `подібно / до / інших / слов'янських / мов / українська / має / розвинену / систему / дієслівного / виду`, answer: `Подібно до інших слов'янських мов, українська має розвинену систему дієслівного виду.` },
  { jumbled: `тобто / прислівник / це / частина / мови / яка / описує / дію / або / прикметник / наприклад / швидко`, answer: `Тобто прислівник — це частина мови, яка описує дію або прикметник, наприклад швидко.` },
  { jumbled: `отже / це / іменник / жіночого / роду / бо / закінчується / на / а`, answer: `Отже, це іменник жіночого роду, бо закінчується на -а.` },
  { jumbled: `таким / чином / утворюється / множина / іменників / чоловічого / роду / додаванням / закінчення / и / або / і`, answer: `Таким чином утворюється множина іменників чоловічого роду додаванням закінчення -и або -і.` },
  { jumbled: `це / виняток / із / загального / правила / тому / потрібно / запам'ятати / цю / форму / окремо`, answer: `Це виняток із загального правила, тому потрібно запам'ятати цю форму окремо.` },
  { jumbled: `основа / слова / це / слово / без / закінчення / наприклад / книг`, answer: `Основа слова — це слово без закінчення, наприклад книг-.` }
]} />
...
<Select questions={[
  {
    question: `Які слова пояснюють \"коли вживати\"?`,
    options: [
      { text: `використовується`, correct: true },
      { text: `вживається`, correct: true },
      { text: `означає`, correct: false },
      { text: `показує`, correct: false }
    ]
  },  {
    question: `Які слова пояснюють \"що означає\"?`,
    options: [
      { text: `означає`, correct: true },
      { text: `показує`, correct: true },
      { text: `виражає`, correct: true },
      { text: `використовується`, correct: false }
    ]
  },  {
    question: `Які слова є інструкціями?`,
    options: [
      { text: `порівняйте`, correct: true },
      { text: `зверніть увагу`, correct: true },
      { text: `означає`, correct: false },
      { text: `використовується`, correct: false }
    ]
  },  {
    question: `Які слова означають частини слова?`,
    options: [
      { text: `корінь`, correct: true },
      { text: `суфікс`, correct: true },
      { text: `префікс`, correct: true },
      { text: `правило`, correct: false }
    ]
  },  {
    question: `Які слова показують порівняння?`,
    options: [
      { text: `на відміну від`, correct: true },
      { text: `подібно до`, correct: true },
      { text: `наприклад`, correct: false },
      { text: `тобто`, correct: false }
    ]
  },  {
    question: `Які слова є логічними зв'язками?`,
    options: [
      { text: `отже`, correct: true },
      { text: `тобто`, correct: true },
      { text: `таким чином`, correct: true },
      { text: `корінь`, correct: false }
    ]
  },  {
    question: `Які терміни пов'язані з правилами?`,
    options: [
      { text: `правило`, correct: true },
      { text: `виняток`, correct: true },
      { text: `закономірність`, correct: true },
      { text: `суфікс`, correct: false }
    ]
  },  {
    question: `Які слова означають \"means\"?`,
    options: [
      { text: `означає`, correct: true },
      { text: `використовується`, correct: false },
      { text: `порівняйте`, correct: false },
      { text: `наприклад`, correct: false }
    ]
  },  {
    question: `Які слова означають \"is used\"?`,
    options: [
      { text: `використовується`, correct: true },
      { text: `вживається`, correct: true },
      { text: `означає`, correct: false },
    ...
    question: `Які частини слова змінюють значення?`,
    options: [
      { text: `префікс`, correct: true },
      { text: `суфікс`, correct: true },
      { text: `закінчення`, correct: false },
    ...
    question: `Що означає \"indicates\"?`,
    options: [
      { text: `вказує на`, correct: true },
      { text: `означає`, correct: false },
      { text: `показує`, correct: false },
      { text: `виражає`, correct: false }
    ]
  },  {
    question: `Що означає \"expresses\"?`,
    options: [
      { text: `вказує на`, correct: false },
      { text: `означає`, correct: false },
      { text: `показує`, correct: false },
      { text: `виражає`, correct: true }
    ]
  },  {
    question: `Що означає \"for example\"?`,
    options: [
      { text: `наприклад`, correct: true },
      { text: `тобто`, correct: false },
      { text: `отже`, correct: false },
      { text: `таким чином`, correct: false }
    ]
  },  {
    question: `Що означає \"that is\"?`,
    options: [
      { text: `наприклад`, correct: false },
      { text: `тобто`, correct: true },
      { text: `отже`, correct: false },
...
<Translate questions={[
  {
    ...
    options: [
      { text: `порівняйте`, correct: true },
      { text: `напишіть`, correct: false },
      { text: `прочитайте`, correct: false },
      { text: `знайдіть`, correct: false }
    ]
  },  {
    ...
    source: `similar to`,
    options: [
      { text: `на відміну від`, correct: false },
      { text: `подібно до`, correct: true },
      { text: `наприклад`, correct: false },
      { text: `тобто`, correct: false }
    ]
