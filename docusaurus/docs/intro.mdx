...
|-------|-------------|---------|--------|
| **A1** | Beginner — Cyrillic alphabet, basic grammar, practical scenarios | 44 | ✅ Complete |
| **A2** | Elementary — All 7 cases, aspect intro, practical scenarios | 71 | 🔍 In QA (41/71) |
| **B1** | Intermediate — Aspect mastery, motion verbs, communication skills | 94 | 🔍 In QA (10/94) |
| **B2** | Upper-Intermediate — Passive voice, registers, professional basics | 95 | 🔍 In QA (6/95) |
| **C1** | Advanced — Stylistics, literature, complex grammar | 108 | 🔍 In QA (1/108) |
...
|-------|-------------|---------|--------|
| **B2-HIST** | History — Ukrainian history from origins to present | 140 | 🔍 In QA (10/140) |
| **C1-BIO** | Biographies — Notable Ukrainians through history | 172 | 🔍 In QA (4/172) |
| **C1-HIST** | Advanced History — Primary sources, imperial mechanisms, interethnic relations | 136 | 🔍 In QA (1/136) |
