...
|-------|-------------|---------|--------|
| **B2-HIST** | History — Ukrainian history from origins to present | 140 | 🔍 In QA |
| **C1-HIST** | Advanced History — Primary sources, imperial mechanisms, interethnic relations | 60 | 📋 Planned |
| **C1-BIO** | Biographies — Notable Ukrainians through history | 100 | 🔍 In QA |
...
| **LIT** | Literature — Ukrainian classics and literary analysis | 30 | 🔍 In QA |
