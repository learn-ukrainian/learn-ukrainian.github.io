...
| **B1** | Intermediate — Aspect mastery, motion verbs, communication skills | 94 | 🔍 In QA (9/94) |
...
|-------|-------------|---------|--------|
| **B2-HIST** | History — Ukrainian history from origins to present | 140 | 🔍 In QA (9/140) |
