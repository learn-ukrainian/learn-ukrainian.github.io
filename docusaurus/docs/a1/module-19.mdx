...
<Quiz questions={[
  {
    question: `How does a waiter ask accurately \"What would you like\"?`,
    options: [
      { text: `Що ви бажаєте?`, correct: true },
      { text: `Де ви бажаєте?`, correct: false },
      { text: `Як ви бажаєте?`, correct: false },
      { text: `Хто ви бажаєте?`, correct: false }
    ]
  },  {
    question: `How does a waiter ask accurately \"Are you ready to order\"?`,
    options: [
      { text: `Ви готові замовляти?`, correct: true },
      { text: `Ви готові платити?`, correct: false },
      { text: `Ви готові їсти?`, correct: false },
      { text: `Ви готові йти?`, correct: false }
    ]
  },  {
    question: `How do you accurately ask for the bill?`,
    options: [
      { text: `Рахунок, будь ласка.`, correct: true },
      { text: `Меню, будь ласка.`, correct: false },
      { text: `Сіль, будь ласка.`, correct: false },
      { text: `Де офіціант?`, correct: false }
    ]
  },  {
    question: `How do you ask for a table for two people?`,
    options: [
      { text: `Столик на двох, будь ласка.`, correct: true },
      { text: `Столик на одного, будь ласка.`, correct: false },
      { text: `Де столик?`, correct: false },
      { text: `Столик тут.`, correct: false }
    ]
  },  {
    question: `How do you accurately ask \"Can I have a menu\"?`,
    options: [
      { text: `Можна меню, будь ласка?`, correct: true },
      { text: `Де меню?`, correct: false },
      { text: `Маєте меню?`, correct: false },
      { text: `Я хочу меню.`, correct: false }
    ]
  },  {
    question: `How do you accurately ask for a napkin now?`,
    options: [
      { text: `Дайте серветку, будь ласка.`, correct: true },
      { text: `Де серветка?`, correct: false },
      { text: `Серветка тут.`, correct: false },
      { text: `Що це серветка?`, correct: false }
    ]
  },  {
    question: `How does the waiter or customer say \"Bon appetit\" in Ukraine?`,
    options: [
    ...
    question: `How can you say accurately the phrase \"The bill, please\"?`,
    options: [
      { text: `Можна рахунок, будь ласка?`, correct: true },
      { text: `Дайте рахунок.`, correct: false },
      { text: `Де рахунок?`, correct: false },
      { text: `Рахунок тут.`, correct: false }
    ]
  }
]} />
...
<GroupSort groups={{
  "Ordering (Замовлення)": ["Я буду каву.", "Мені, будь ласка, сік.", "Ви готові замовляти?", "Принесіть меню."],
  "Paying (Оплата)": ["Рахунок, будь ласка.", "Ви приймаєте картки?", "Можна платити готівкою?", "Де каса?"],
  "Etiquette (Етикет)": ["Смачного!", "Дякую.", "Будь ласка.", "Вибачте."]
}} />
...
<Quiz questions={[
  {
    question: `Correct sentence order for: \"Table for two, please.\"`,
    options: [
      { text: `Столик на двох, будь ласка`, correct: true },
      { text: `на Столик двох, будь ласка`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"I'll take coffee with milk.\"`,
    options: [
      { text: `Я візьму каву з молоком`, correct: true },
      { text: `візьму Я каву з молоком`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"What do you recommend?\"`,
    options: [
      { text: `Що порекомендуєте`, correct: true },
      { text: `порекомендуєте Що`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"Please bring more bread.\"`,
    options: [
      { text: `Принесіть, будь ласка, ще хліб`, correct: true },
      { text: `будь Принесіть, ласка, ще хліб`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"Check separately, please.\"`,
    options: [
      { text: `Рахунок окремо, будь ласка`, correct: true },
      { text: `окремо, Рахунок будь ласка`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"That's everything.\"`,
    options: [
      { text: `Це все`, correct: true },
      { text: `все Це`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"Thank you, it was...\"`,
    options: [
      { text: `Дякую, було дуже смачно`, correct: true },
      { text: `було Дякую, дуже смачно`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"That's enough.\"`,
    options: [
      { text: `Це достатньо`, correct: true },
      { text: `достатньо Це`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"Can I have a menu?\"`,
    options: [
      { text: `Можна меню`, correct: true },
      { text: `меню Можна`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"Anything else?\"`,
    options: [
      { text: `Ще щось`, correct: true },
      { text: `щось Ще`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"Please bring water.\"`,
    options: [
      { text: `Принесіть, будь ласка, воду`, correct: true },
      { text: `будь Принесіть, ласка, воду`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  }
]} />
