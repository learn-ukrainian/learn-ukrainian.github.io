...
<Quiz
  ...
  questions={JSON.parse(`[{"question": "Which letter makes the \\\"h\\\" sound in Ukrainian?", "options": [{"text": "Ґ", "correct": false}, {"text": "Г", "correct": true}, {"text": "Х", "correct": false}, {"text": "К", "correct": false}]}, {"question": "What does the letter Ї sound like?", "options": [{"text": "ya", "correct": false}, {"text": "ye", "correct": false}, {"text": "yi", "correct": true}, {"text": "yu", "correct": false}]}, {"question": "Which letter makes the \\\"shch\\\" sound in борщ?", "options": [{"text": "Ш", "correct": false}, {"text": "Ч", "correct": false}, {"text": "Щ", "correct": true}, {"text": "Ц", "correct": false}]}, {"question": "What is special about the letter Ь?", "options": [{"text": "It makes a \\\"y\\\" sound", "correct": false}, {"text": "It softens the consonant before it", "correct": true}, {"text": "It makes an \\\"e\\\" sound", "correct": false}, {"text": "It's silent and has no effect", "correct": false}]}, {"question": "Which letter makes the \\\"ts\\\" sound?", "options": [{"text": "С", "correct": false}, {"text": "З", "correct": false}, {"text": "Ц", "correct": true}, {"text": "Ч", "correct": false}]}, {"question": "What does Є sound like?", "options": [{"text": "ye", "correct": true}, {"text": "e", "correct": false}, {"text": "yi", "correct": false}, {"text": "ya", "correct": false}]}, {"question": "How do you pronounce Київ in Ukrainian?", "options": [{"text": "Keev", "correct": false}, {"text": "Kiev", "correct": false}, {"text": "Kyiv", "correct": true}, {"text": "Kee-iv", "correct": false}]}, {"question": "Which letter was lost in Russian but kept in Ukrainian?", "options": [{"text": "Г", "correct": false}, {"text": "Ґ", "correct": true}, {"text": "Щ", "correct": false}, {"text": "Є", "correct": false}]}, {"question": "What sound does Ж make?", "options": [{"text": "sh", "correct": false}, {"text": "zh", "correct": true}, {"text": "j", "correct": false}, {"text": "ch", "correct": false}]}, {"question": "In italic/cursive, which letter looks like Latin \\\"m\\\"?", "options": [{"text": "т", "correct": true}, {"text": "м", "correct": false}, {"text": "п", "correct": false}, {"text": "н", "correct": false}]}, {"question": "Which of these is a iotated vowel?", "options": [{"text": "А", "correct": false}, {"text": "Е", "correct": false}, {"text": "Ю", "correct": true}, {"text": "И", "correct": false}]}, {"question": "What does Я sound like?", "options": [{"text": "ye", "correct": false}, {"text": "ya", "correct": true}, {"text": "yi", "correct": false}, {"text": "y", "correct": false}]}]`)}
/>

<GroupSort
  title="Letter Categories"
  groups={JSON.parse(`{"Unique Seven (Unusual Consonants)": ["Г", "Ґ", "Ж", "Ш", "Щ", "Ч", "Ц"], "Iotated Vowels (Built-in Y Sound)": ["Є", "Ї", "Ю", "Я"], "Special Letters": ["Ь", "И", "Й"]}`)}
/>

<Anagram
  title="Build Ukrainian Words"
...
<MatchUp
  title="Ukrainian Cities"
  pairs={JSON.parse(`[{"left": "- Київ", "right": "Kyiv"}, {"left": "- Львів", "right": "Lviv"}, {"left": "- Одеса", "right": "Odesa"}, {"left": "- Харків", "right": "Kharkiv"}, {"left": "- Дніпро", "right": "Dnipro"}, {"left": "- Україна", "right": "Ukraine"}, {"left": "- Лондон", "right": "London"}, {"left": "- Європа", "right": "Europe"}]`)}
/>

<MatchUp
  title="Food Vocabulary"
  pairs={JSON.parse(`[{"left": "- борщ", "right": "borscht"}, {"left": "- йогурт", "right": "yogurt"}, {"left": "- желе", "right": "jelly"}, {"left": "- майонез", "right": "mayonnaise"}, {"left": "- шоколад", "right": "chocolate"}, {"left": "- цукор", "right": "sugar"}, {"left": "- буква", "right": "letter"}, {"left": "- слово", "right": "word"}]`)}
/>

<GroupSort
  title="Print vs Italic Confusion"
  groups={JSON.parse(`{"Looks Different in Italic (Trap Letters)": ["т", "п", "д", "и", "л", "г"], "Looks Similar in Italic": ["а", "б", "в", "е", "к", "м", "н", "о", "с", "ф", "х"]}`)}
/>
...
>
> **📖 Articles:**
> - [Ukrainian Alphabet: Full Guide with Examples and Pronunciation](https://www.ukrainianlessons.com/ukrainian-alphabet/) — Ukrainian Lessons
