...
<Quiz>
  <QuizQuestion
    question={`1. What case do you use after "немає"?`}
    options={[`Nominative`, `Genitive`, `Accusative`, `Locative`]}
    correctIndex={1}
    explanation={`немає always requires genitive case`}
  />
  <QuizQuestion
    question={`How do you say "I don't have time"?`}
    options={[`Я не маю час`, `У мене немає часу`, `Я немає час`, `У мене не час`]}
    correctIndex={1}
    explanation={`The pattern is: У + person + немає + noun-genitive`}
  />
  <QuizQuestion
    question={`What is the genitive form of "книга" (book)?`}
    options={[`книга`, `книги`, `книзі`, `книгою`]}
    correctIndex={1}
    explanation={`Feminine -а becomes -и in genitive`}
  />
  <QuizQuestion
    question={`Which word means "without"?`}
    options={[`з`, `без`, `до`, `від`]}
    correctIndex={1}
    explanation={`без + genitive = without`}
  />
  <QuizQuestion
    question={`What is the genitive form of "стіл" (table)?`}
    options={[`стіл`, `столу`, `столі`, `столом`]}
    correctIndex={1}
    explanation={`Masculine consonant + -у in genitive`}
  />
  <QuizQuestion
    question={`How do you say "No problem"?`}
    options={[`Не проблема`, `Немає проблем`, `Без проблема`, `У проблеми немає`]}
    correctIndex={1}
    explanation={`The idiomatic phrase is "Немає проблем!"`}
  />
  <QuizQuestion
    question={`What is the genitive form of "вікно" (window)?`}
    options={[`вікно`, `вікна`, `вікні`, `вікном`]}
    correctIndex={1}
    explanation={`Neuter -о becomes -а in genitive`}
  />
  <QuizQuestion
    question={`Which pattern is correct for "She doesn't have money"?`}
    options={[`Вона не має гроші`, `У неї немає грошей`, `Вона немає гроші`, `У вона немає грошей`]}
    correctIndex={1}
    explanation={`Pattern: У + neї + немає + genitive`}
  />
  <QuizQuestion
    question={`What does "У вас немає часу?" mean?`}
    options={[`Do you have time?`, `You don't have time?`, `I don't have time`, `Time doesn't have you`]}
    correctIndex={1}
    explanation={`У вас = "by you" (formal/plural)`}
  />
  <QuizQuestion
    question={`Which preposition requires genitive case?`}
    options={[`в`, `на`, `без`, `з (with)`]}
    correctIndex={2}
    explanation={`без (without) always takes genitive`}
  />
  <QuizQuestion
    question={`What is the genitive form of "ідея" (idea)?`}
    options={[`ідея`, `ідеї`, `ідеї`, `ідеєю`]}
    correctIndex={1}
    explanation={`Feminine -я becomes -ї in genitive`}
  />
  <QuizQuestion
    question={`How do you say "coffee without sugar"?`}
    options={[`кава не цукор`, `кава без цукру`, `кава з цукор`, `кава немає цукру`]}
    correctIndex={1}
    explanation={`Pattern: noun + без + genitive`}
  />
</Quiz>
...
<Unjumble>
  <UnjumbleQuestion
    words={`немає / У / часу / мене`}
    answer={`У мене немає часу.`}
  />
  <UnjumbleQuestion
    words={`кави / Тут / немає`}
    answer={`Тут немає кави.`}
  />
  <UnjumbleQuestion
    words={`немає / У / неї / грошей`}
    answer={`У неї немає грошей.`}
  />
  <UnjumbleQuestion
    words={`будь ласка / цукру / Без`}
  ...
  />
  <UnjumbleQuestion
    words={`нас / вибору / У / немає`}
    answer={`У нас немає вибору.`}
  />
  <UnjumbleQuestion
    words={`можливості / немає / У / тебе`}
    answer={`У тебе немає можливості?`}
  />
  <UnjumbleQuestion
    words={`допомоги / важко / Без / це`}
    answer={`Без допомоги це важко.`}
  />
  <UnjumbleQuestion
    words={`різниці / Тут / немає`}
    answer={`Тут немає різниці.`}
  />
  <UnjumbleQuestion
    words={`терпіння / немає / вас / У`}
    answer={`У вас немає терпіння?`}
  />
  <UnjumbleQuestion
    words={`знання / У / них / немає`}
    answer={`У них немає знання.`}
  />
  <UnjumbleQuestion
    words={`немає / мене / У / досвіду`}
...
<FillIn>
  <FillInQuestion
    sentence={`1. У мене є час. → У мене ___ ___.`}
    answer={`немає часу`}
