...
<MatchUp pairs={[
  ...
  { left: `мій / моя / моє`, right: `my` },
  { left: `твій / твоя / твоє`, right: `your (informal)` },
  { left: `його`, right: `his / its` },
  { left: `її`, right: `her` },
  { left: `наш / наша / наше`, right: `our` },
  { left: `ваш / ваша / ваше`, right: `your (formal/plural)` },
  { left: `їхній / їхня / їхнє`, right: `their` },
  { left: `чий / чия / чиє`, right: `whose` }
]} />

### Gender Agreement

<GroupSort groups={{
  "Masculine (Мій/Твій)": ["мій паспорт", "твій квиток", "наш стіл", "ваш офіс"],
  "Feminine (Моя/Твоя)": ["моя книга", "твоя сумка", "наша валіза", "ваша кава"],
  "Neuter (Моє/Твоє)": ["моє вікно", "твоє море", "наше місто", "ваше ім'я"]
}} />
...
<Quiz questions={[
  {
    question: `Це ___ книга. (my — feminine)`,
    options: [
    ...
    options: [
      { text: `твій`, correct: true },
      { text: `твоя`, correct: false },
      { text: `твоє`, correct: false },
      { text: `твої`, correct: false }
    ]
  },  {
    ...
    options: [
      ...
      { text: `наше`, correct: true },
      { text: `наші`, correct: false }
    ]
  },  {
    ...
    options: [
      ...
      { text: `їхнє`, correct: false },
      { text: `їхні`, correct: true }
    ]
  },  {
    question: `Де ___ батьки? (your formal/plural)`,
    options: [
      { text: `ваш`, correct: false },
      { text: `ваша`, correct: false },
      { text: `ваше`, correct: false },
      { text: `ваші`, correct: true }
    ]
  },  {
...
<Quiz questions={[
  {
    question: `Correct sentence order for: \"This is my book.\"`,
    options: [
      { text: `Це моя книга`, correct: true },
      { text: `моя Це книга`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"Where is your phone?\"`,
    options: [
      { text: `Де твій телефон`, correct: true },
      { text: `твій Де телефон`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"Our window is big.\"`,
    options: [
      { text: `Наше вікно велике`, correct: true },
      { text: `вікно Наше велике`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"This is his car.\"`,
    options: [
      { text: `Це його машина`, correct: true },
      { text: `його Це машина`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"Her sister is a student.\"`,
    options: [
      { text: `Її сестра студентка`, correct: true },
      { text: `сестра Її студентка`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"Their friends are here.\"`,
    options: [
      { text: `Їхні друзі тут`, correct: true },
      { text: `друзі Їхні тут`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"Where are your parents?\"`,
    options: [
      { text: `Де ваші батьки`, correct: true },
      { text: `ваші Де батьки`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"Wait — this is...\"`,
    options: [
      { text: `Чий це наш дім`, correct: true },
      { text: `це Чий наш дім`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"My work is interesting.\"`,
    options: [
      { text: `Моя робота цікава`, correct: true },
      { text: `робота Моя цікава`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"This is his life.\"`,
    options: [
      { text: `Це його життя`, correct: true },
      { text: `його Це життя`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"Your city is beautiful.\"`,
    options: [
      { text: `Твоє місто гарне`, correct: true },
      { text: `місто Твоє гарне`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"Wait — another trick!...\"`,
    options: [
      { text: `Чиї це їхні речі`, correct: true },
      { text: `це Чиї їхні речі`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"My table is there.\"`,
    options: [
      { text: `Мій стіл там`, correct: true },
      { text: `стіл Мій там`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"Our room is clean.\"`,
    options: [
      { text: `Наша кімната чиста`, correct: true },
      { text: `кімната Наша чиста`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"This is your word.\"`,
    options: [
      { text: `Це ваше слово`, correct: true },
      { text: `ваше Це слово`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  }
]} />
...
<GroupSort groups={{
  "Змінні (Change by Gender)": ["мій / моя / моє", "твій / твоя / твоє", "наш / наша / наше", "ваш / ваша / ваше", "їхній / їхня / їхнє", "чий / чия / чиє", "цей / ця / це"],
  "Інваріантні (Never Change)": ["його (his)", "її (her)", "їх (their)", "Марка (Mark's)", "Анни (Anna's)"]
}} />
...
<Quiz questions={[
  {
    question: `What is the traditional word for \"family\"?`,
    options: [
      { text: `родина`, correct: true },
      { text: `сім’я`, correct: false },
      { text: `група`, correct: false },
      { text: `люди`, correct: false }
    ]
  },  {
    question: `Which pronoun refers to \"our house\"?`,
    options: [
      { text: `наш`, correct: true },
      { text: `ваш`, correct: false },
      { text: `твій`, correct: false },
    ...
    options: [
      { text: `його книга`, correct: true },
      { text: `її книга`, correct: false },
      { text: `їхня книга`, correct: false },
      { text: `твоя книга`, correct: false }
    ]
  },  {
    question: `How do you say \"her phone\"?`,
    options: [
      { text: `її телефон`, correct: true },
      { text: `його телефон`, correct: false },
      { text: `наш телефон`, correct: false },
      { text: `твій телефон`, correct: false }
    ]
  },  {
    question: `Which word is used for \"whose\"?`,
    options: [
      { text: `чий`, correct: true },
      { text: `який`, correct: false },
      { text: `де`, correct: false },
      { text: `хто`, correct: false }
    ]
  },  {
    question: `What is the meaning of \"родина\"?`,
    options: [
    ...
    question: `Which possessive never changes gender?`,
    options: [
      { text: `його`, correct: true },
      { text: `наш`, correct: false },
      { text: `мій`, correct: false },
    ...
    question: `Is \"тато\" masculine or feminine?`,
    options: [
    ...
    question: `How do you say \"their luggage\"?`,
    options: [
      { text: `їхня валіза`, correct: true },
      { text: `наша валіза`, correct: false },
      { text: `ваша валіза`, correct: false },
      { text: `твій валіза`, correct: false }
    ]
  },  {
    question: `What's the formal \"your\"?`,
    options: [
      { text: `ваш`, correct: true },
      { text: `твій`, correct: false },
      { text: `свій`, correct: false },
      { text: `наш`, correct: false }
    ]
  },  {
    question: `What is accurately the meaning of \"Моя мама\"?`,
    options: [
      { text: `my mother`, correct: true },
      { text: `your mother`, correct: false },
      { text: `her mother`, correct: false },
      { text: `his mother`, correct: false }
    ]
  },  {
    question: `What is accurately the meaning of \"Наше місто\"?`,
    options: [
      { text: `our city`, correct: true },
      { text: `your city`, correct: false },
      { text: `their city`, correct: false },
      { text: `my city`, correct: false }
    ]
  }
]} />
## 📚 Vocabulary
