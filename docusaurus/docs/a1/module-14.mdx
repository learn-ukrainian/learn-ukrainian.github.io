...
<GroupSort groups={{
  "Masculine": ["мій телефон", "твій брат", "наш будинок", "ваш стіл", "їхній друг", "його батько"],
  "Feminine": ["моя книга", "твоя сестра", "наша мама", "ваша сумка", "їхня кімната", "її робота"],
  "Neuter": ["моє вікно", "твоє місто", "наше життя", "ваше слово", "їхнє село", "його ім'я"],
  "Plural": ["мої друзі", "твої речі", "наші батьки", "ваші книги", "їхні діти", "її слова"]
}} />
...
<Unjumble items={[
  { jumbled: `книга / Це / моя`, answer: `Це моя книга.` },
  { jumbled: `телефон / твій / Де`, answer: `Де твій телефон?` },
  { jumbled: `вікно / Наше / велике`, answer: `Наше вікно велике.` },
  { jumbled: `машина / Це / його`, answer: `Це його машина.` },
  { jumbled: `студентка / сестра / Її`, answer: `Її сестра студентка.` },
  { jumbled: `друзі / Їхні / тут`, answer: `Їхні друзі тут.` },
  { jumbled: `батьки / ваші / Де`, answer: `Де ваші батьки?` },
  { jumbled: `дім / наш / Чий / це`, answer: `Чий це наш дім?` },
  { jumbled: `цікава / Моя / робота`, answer: `Моя робота цікава.` },
  { jumbled: `життя / його / Це`, answer: `Це його життя.` },
  { jumbled: `гарне / Твоє / місто`, answer: `Твоє місто гарне.` },
  { jumbled: `речі / це / Чиї / їхні`, answer: `Чиї це їхні речі?` },
  { jumbled: `там / стіл / Мій`, answer: `Мій стіл там.` },
  { jumbled: `чиста / Наша / кімната`, answer: `Наша кімната чиста.` },
  { jumbled: `слово / ваше / Це`, answer: `Це ваше слово.` }
]} />

### Інваріантні vs Змінні

<GroupSort groups={{
  "Змінні (Change)": ["мій", "твій", "наш", "ваш", "їхній", "моя", "твоє", "наші", "їхня"],
  "Інваріантні (Never Change)": ["його", "її"]
}} />
...
<Quiz questions={[
  {
    question: `Which possessive is used for informal \"your\" with friends?`,
    options: [
      { text: `ваш`, correct: false },
      { text: `твій`, correct: true },
      { text: `його`, correct: false },
      { text: `наш`, correct: false }
    ]
  },  {
    ...
    options: [
      { text: `наша Україна`, correct: true },
      { text: `наш Україна`, correct: false },
      { text: `наше Україна`, correct: false },
      { text: `наші Україна`, correct: false }
    ]
  },  {
    question: `Which form of \"my\" goes with neuter nouns?`,
    options: [
      { text: `мій`, correct: false },
      { text: `моя`, correct: false },
      { text: `моє`, correct: true },
      { text: `мої`, correct: false }
    ]
  },  {
    ...
    options: [
      ...
      { text: `наш`, correct: false },
      { text: `їхній`, correct: true }
    ]
  },  {
    question: `Which is correct: \"Це **його** сестра\" or \"Це **його** сестри\"?`,
    options: [
      { text: `Це його сестра`, correct: true },
      { text: `Це його сестри`, correct: false },
      { text: `Both are correct`, correct: false },
      { text: `Neither is correct`, correct: false }
    ]
  },  {
    question: `How do you ask \"Whose phone is this?\" in Ukrainian?`,
    options: [
      { text: `Що це телефон?`, correct: false },
      { text: `Хто це телефон?`, correct: false },
      { text: `Чий це телефон?`, correct: true },
      { text: `Який це телефон?`, correct: false }
    ]
  },  {
    question: `Which is the feminine form of \"their\"?`,
    options: [
      { text: `їхній`, correct: false },
      { text: `їхня`, correct: true },
      { text: `їхнє`, correct: false },
      { text: `їхні`, correct: false }
    ]
  },  {
    question: `In Ukrainian folk songs, \"наша Україна\" expresses:`,
    options: [
      { text: `Personal ownership`, correct: false },
      { text: `Foreign possession`, correct: false },
      { text: `Collective national identity`, correct: true },
      { text: `Individual property`, correct: false }
    ]
  },  {
    question: `Which possessive changes to agree with the noun?`,
    options: [
      { text: `мій`, correct: true },
      { text: `його`, correct: false },
      { text: `її`, correct: false },
