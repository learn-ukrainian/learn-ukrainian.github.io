...
<MatchUp pairs={JSON.parse(`[{"left": "А а", "right": "a (father)"}, {"left": "Е е", "right": "e (pet)"}, {"left": "І і", "right": "ee (meet)"}, {"left": "О о", "right": "o (more)"}, {"left": "К к", "right": "k (skate)"}, {"left": "М м", "right": "m (map)"}, {"left": "Т т", "right": "t (stop)"}, {"left": "мама", "right": "mom"}]`)} />
