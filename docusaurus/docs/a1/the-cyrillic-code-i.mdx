...
<MatchUp pairs={JSON.parse(`[{"left": "В в", "right": "v (vehicle)"}, {"left": "Н н", "right": "n (hen)"}, {"left": "Р р", "right": "r (trilled)"}, {"left": "С с", "right": "s (snake)"}, {"left": "У у", "right": "oo (moon)"}, {"left": "Х х", "right": "kh (loch)"}, {"left": "Б б", "right": "b (bank)"}, {"left": "Д д", "right": "d (door)"}]`)} />
