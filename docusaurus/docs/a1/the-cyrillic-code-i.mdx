...
<MatchUp pairs={JSON.parse(`[{"left": "А а", "right": "a (father)"}, {"left": "Е е", "right": "e (pet)"}, {"left": "І і", "right": "ee (meet)"}, {"left": "О о", "right": "o (more)"}, {"left": "К к", "right": "k (skate)"}, {"left": "М м", "right": "m (map)"}, {"left": "Т т", "right": "t (stop)"}, {"left": "Ф ф", "right": "f (photo)"}]`)} />

### Нові літери та хибні друзі: Звуки

<MatchUp pairs={JSON.parse(`[{"left": "В в", "right": "v (vehicle)"}, {"left": "Н н", "right": "n (hen)"}, {"left": "Р р", "right": "r (trilled)"}, {"left": "С с", "right": "s (snake)"}, {"left": "У у", "right": "oo (moon)"}, {"left": "Х х", "right": "kh (loch)"}, {"left": "Б б", "right": "b (bank)"}, {"left": "Д д", "right": "d (door)"}, {"left": "З з", "right": "z (zebra)"}, {"left": "Л л", "right": "l (look)"}]`)} />
