...
<FillIn>
  <FillInQuestion
    sentence={`1. Скільки ___ хліб? (How much is bread?)`}
    answer={`коштує`}
...
<Quiz>
  <QuizQuestion
    question={`1. You want to ask the price of cheese. What do you say?`}
    options={[`Скільки є сир?`, `Скільки коштує сир?`, `Який сир?`, `Чому сир?`]}
    correctIndex={1}
    explanation={`"Скільки коштує?" = "How much does it cost?"`}
  />
  <QuizQuestion
    question={`How do you order coffee in accusative case?`}
    options={[`Я хочу кава.`, `Я хочу каву.`, `Я хочу кави.`, `Я хочу кавою.`]}
    correctIndex={1}
    explanation={`Feminine -а becomes -у in accusative: кава → каву`}
  />
  <QuizQuestion
    question={`What does "офіціант" mean?`}
    options={[`office`, `waiter`, `official`, `restaurant`]}
    correctIndex={1}
    explanation={`офіціант = waiter (masculine)`}
  />
  <QuizQuestion
    question={`You want to ask for the bill. What do you say?`}
    options={[`Меню, будь ласка.`, `Вода, будь ласка.`, `Рахунок, будь ласка.`, `Гроші, будь ласка.`]}
    correctIndex={2}
    explanation={`Рахунок = bill/check`}
  />
  <QuizQuestion
    question={`Which word means "cheap"?`}
    options={[`дорого`, `дешево`, `ціна`, `знижка`]}
    correctIndex={1}
    explanation={`дешево = cheap (adverb)`}
  />
  <QuizQuestion
    question={`How do you say "a glass of water" using genitive?`}
    options={[`Склянка вода`, `Склянку воду`, `Склянку води`, `Склянка води`]}
    correctIndex={2}
    explanation={`Genitive for quantities: вода → води`}
  />
  <QuizQuestion
    question={`Where do you pay at a supermarket?`}
    options={[`магазин`, `пакет`, `каса`, `супермаркет`]}
    correctIndex={2}
    explanation={`каса = checkout/cashier`}
  />
  <QuizQuestion
    question={`What does "відчинено" mean?`}
    options={[`closed`, `open`, `expensive`, `cheap`]}
    correctIndex={1}
    explanation={`відчинено = open (adverb)`}
  />
  <QuizQuestion
    question={`Which is NOT a beverage?`}
    options={[`кава`, `чай`, `сік`, `хліб`]}
    correctIndex={3}
    explanation={`хліб = bread (not a drink)`}
  />
  <QuizQuestion
    question={`You're buying groceries. What do you say?`}
    options={[`Я читаю хліб.`, `Я купую хліб.`, `Я пишу хліб.`, `Я бачу хліб.`]}
    correctIndex={1}
    explanation={`купувати = to buy`}
  />
  <QuizQuestion
    question={`Which word means "tasty"?`}
    options={[`страва`, `смачний`, `меню`, `закуска`]}
    correctIndex={1}
    explanation={`смачний = tasty (adjective)`}
  />
  <QuizQuestion
    question={`How do you say "I'll take bread, please"?`}
    options={[`Я хочу хліб, будь ласка.`, `Я візьму хліб, будь ласка.`, `Я читаю хліб, будь ласка.`, `Скільки коштує хліб?`]}
    correctIndex={1}
    explanation={`"Я візьму..." = "I'll take..."`}
  />
</Quiz>
...
<Unjumble>
  ...
  />
  <UnjumbleQuestion
    words={`коштує / Скільки / хліб`}
    answer={`Скільки коштує хліб?`}
  />
  <UnjumbleQuestion
    words={`візьму / Я / будь ласка / сир`}
    answer={`Я візьму сир, будь ласка.`}
  />
  <UnjumbleQuestion
    words={`води / Склянку / будь ласка`}
    answer={`Склянку води, будь ласка.`}
  />
  <UnjumbleQuestion
    words={`купуємо / Ми / овочі / та / м'ясо`}
    answer={`Ми купуємо овочі та м'ясо.`}
  />
  <UnjumbleQuestion
    words={`є / меню / У / десерт`}
    answer={`У меню є десерт?`}
  />
  <UnjumbleQuestion
    words={`Рахунок / будь ласка`}
    answer={`Рахунок, будь ласка.`}
  />
  <UnjumbleQuestion
    words={`дуже / Борщ / смачний`}
    answer={`Борщ дуже смачний.`}
  />
  <UnjumbleQuestion
    words={`шукаю / Я / зубну / пасту`}
    answer={`Я шукаю зубну пасту.`}
  />
  <UnjumbleQuestion
    words={`магазин / де / Вибачте`}
    answer={`Вибачте, де магазин?`}
  />
  <UnjumbleQuestion
    words={`візьму / Я / суп / та / салат`}
    answer={`Я візьму суп та салат.`}
  />
  <UnjumbleQuestion
    words={`відчинено / Магазин / о / восьмій`}
...
<FillIn>
  <FillInQuestion
    sentence={`1. — Що ти будеш ___? (What will you order?)`}
    answer={`замовляти`}
