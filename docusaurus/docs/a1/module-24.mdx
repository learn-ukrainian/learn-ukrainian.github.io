...
**Grammar:**
- 📖 [500+ Ukrainian Verbs](https://www.ukrainianlessons.com/verbs/) — Including modal verbs
- 🎙️ [Ukrainian Lessons Podcast](https://www.ukrainianlessons.com/podcast/) — Audio lessons

**Practice:**
- 📝 [Verb Conjugation](https://www.ukrainianlessons.com/ukrainian-tenses/) — Tense overview
- 🎧 [Speak Ukrainian YouTube](https://www.youtube.com/@SpeakUkrainian) — Video lessons

**Review previous modules** if you're struggling with могти vs вміти.
:::
