...
| можна | /ˈmɔʒnɑ/ | may/allowed | adv |  |  |
| треба | /ˈtrɛbɑ/ | need/must | adv |  |  |
| змога | /ˈzmɔɦɑ/ | ability | noun | ж |  |
| змозі | /ˈzmɔzi/ | in ability (loc) | noun | ж |  |