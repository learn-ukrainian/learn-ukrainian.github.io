...
:::info
**Real World: Ukrainian Post Office**
...
<Quiz>
  <QuizQuestion
    question={`1. What is the accusative form of "книга"?`}
  ...
  <QuizQuestion
    ...
    correctIndex={0}
    explanation={`Masculine inanimate stays the same`}
  />
  <QuizQuestion
    question={`Which verb requires accusative case?`}
    options={[`бачити (to see)`, `бути (to be)`, `працювати (to work)`, `спати (to sleep)`]}
    correctIndex={0}
    explanation={`бачити needs an object: Я бачу книгу`}
  />
  <QuizQuestion
    question={`What is the accusative form of "вікно"?`}
    options={[`вікна`, `вікні`, `вікно`, `вікном`]}
    correctIndex={2}
    explanation={`Neuter stays the same`}
  />
  <QuizQuestion
  ...
  <QuizQuestion
    ...
    options={[`моря`, `морю`, `море`, `морі`]}
    correctIndex={2}
    explanation={`Neuter -е stays the same`}
  />
  <QuizQuestion
  ...
  <QuizQuestion
    ...
    options={[`вікна`, `вікно`, `вікні`, `вікном`]}
    correctIndex={1}
    explanation={`Neuter stays the same`}
  />
</Quiz>
...
*Fill in the blank with the correct verb form and accusative noun.*


<FillIn>
  <FillInQuestion
    sentence={`1. Я ___ (to see) автобус.`}
    answer={`бачу`}
...
<Unjumble>
  <UnjumbleQuestion
    words={`бачу / Я / автобус`}
    answer={`Я бачу автобус.`}
  />
  <UnjumbleQuestion
    words={`газету / читає / Вона`}
    answer={`Вона читає газету.`}
  />
  <UnjumbleQuestion
    words={`маєш / паспорт / Ти / ?`}
    answer={`Ти маєш паспорт?`}
  />
  <UnjumbleQuestion
    words={`валізу / беремо / Ми`}
    answer={`Ми беремо валізу.`}
  />
  <UnjumbleQuestion
    words={`вікно / Він / відкриває`}
    answer={`Він відкриває вікно.`}
  />
  <UnjumbleQuestion
    words={`дають / подарунок / Вони`}
    answer={`Вони дають подарунок.`}
  />
  <UnjumbleQuestion
    words={`показую / квиток / Я`}
  ...
  />
  <UnjumbleQuestion
    words={`закриває / двері / Вона`}
    answer={`Вона закриває двері.`}
  />
  <UnjumbleQuestion
    words={`несемо / сумку / Ми`}
    answer={`Ми несемо сумку.`}
  />
  <UnjumbleQuestion
    words={`журнал / Я / цікавий / читаю`}
    answer={`Я читаю цікавий журнал.`}
  />
  <UnjumbleQuestion
    words={`посилку / відправляємо / Ми / сьогодні`}
...
<Unjumble>
  <UnjumbleQuestion
    words={`читаю / Я / цікаву / газету / щоранку`}
    answer={`Я читаю цікаву газету щоранку.`}
  />
  <UnjumbleQuestion
    words={`валізу / Вона / бере / велику / і / сумку`}
    answer={`Вона бере велику валізу і сумку.`}
  />
  <UnjumbleQuestion
    words={`паспорт / маєш / Ти / український / ?`}
    answer={`Ти маєш український паспорт?`}
  />
  <UnjumbleQuestion
    words={`сумку / беру / Я / велику / чорну`}
    answer={`Я беру велику чорну сумку.`}
  />
  <UnjumbleQuestion
    words={`вікно / Ми / відкриваємо / в / кімнаті`}
    answer={`Ми відкриваємо вікно в кімнаті.`}
  />
  <UnjumbleQuestion
    words={`валізу / Ми / несемо / важку / велику`}
    answer={`Ми несемо велику важку валізу.`}
  />
  <UnjumbleQuestion
    words={`газету / читає / українську / Вона / щодня`}
    answer={`Вона щодня читає українську газету.`}
  />
  <UnjumbleQuestion
    words={`посилку / Вона / відправляє / у / Київ`}
    answer={`Вона відправляє посилку у Київ.`}
  />
  <UnjumbleQuestion
    words={`Я / маю / квиток / новий / український`}
    answer={`Я маю новий український квиток.`}
  />
  <UnjumbleQuestion
    words={`коробку / відкриває / велику / Він / обережно`}
