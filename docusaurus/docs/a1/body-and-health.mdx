...
- **Горло** [ˈɦɔrlɔ] (throat) — neuter. This is a very common word in winter. *Collocation:* **полоскати горло** (to gargle).
...
*Usage Note:* Ukrainians distinguish sides simply: **права** [ˈpraʋa] **рука** (right hand) and **ліва** [ˈlʲiʋa] **рука** (left hand).
...
*(At me + hurts + [singular body part])*
