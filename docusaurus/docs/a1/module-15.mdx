...
<FillIn
  ...
  items={JSON.parse(`[{"sentence": "Іди ___, потім поверни направо. (straight)", "answer": "прямо", "options": ["прямо", "наліво", "направо", "назад"]}, {"sentence": "Аптека ___ банку, біля світлофора. (opposite)", "answer": "навпроти", "options": ["навпроти", "біля", "за", "перед"]}, {"sentence": "На перехресті поверніть ___. (to the left)", "answer": "наліво", "options": ["наліво", "направо", "прямо", "назад"]}, {"sentence": "Музей ___ парку. (near)", "answer": "біля", "options": ["біля", "навпроти", "між", "за"]}, {"sentence": "Це далеко? — Ні, ___. (close)", "answer": "близько", "options": ["близько", "далеко", "поруч", "туди"]}, {"sentence": "Станція метро ___ мостом. (behind)", "answer": "за", "options": ["за", "перед", "навпроти", "між"]}, {"sentence": "Я їду до університету ___. (by tram)", "answer": "на трамваї", "options": ["на трамваї", "на автобусі", "на машині", "пішки"]}, {"sentence": "Книгарня ___ кафе і банком. (between)", "answer": "між", "options": ["між", "біля", "за", "навпроти"]}, {"sentence": "Іди ___ вулиці Шевченка. (along)", "answer": "вздовж", "options": ["вздовж", "через", "до", "від"]}, {"sentence": "Театр ___ парку. (in front of)", "answer": "перед", "options": ["перед", "за", "біля", "навпроти"]}, {"sentence": "Поверніть ___ біля світлофора. (to the right)", "answer": "направо", "options": ["направо", "наліво", "прямо", "назад"]}, {"sentence": "Я ходжу на роботу ___. (on foot)", "answer": "пішки", "options": ["пішки", "на автобусі", "метро", "на машині"]}]`)}
/>
...
<FillIn
  ...
  items={JSON.parse(`[{"sentence": "Ми їдемо ___ до центру. (by bus)", "answer": "на автобусі", "options": ["на автобусі", "автобус", "в автобусі", "автобуса"]}, {"sentence": "Вона дістається на роботу ___. (by metro)", "answer": "метро", "options": ["метро", "на метро", "в метро", "метром"]}, {"sentence": "Я їжджу ___ щодня. (by bicycle)", "answer": "на велосипеді", "options": ["на велосипеді", "велосипед", "велосипедом", "у велосипеді"]}, {"sentence": "Вони приїхали ___. (by car)", "answer": "на машині", "options": ["на машині", "машина", "машину", "машиною"]}, {"sentence": "Ти їдеш ___? (by tram)", "answer": "на трамваї", "options": ["на трамваї", "трамвай", "трамваєм", "у трамваї"]}, {"sentence": "Я вже йду ___. (on foot)", "answer": "пішки", "options": ["пішки", "ногами", "на ногах", "пішком"]}, {"sentence": "Вони дістаються ___ до університету. (by taxi)", "answer": "на таксі", "options": ["на таксі", "таксі", "таксієм", "в таксі"]}, {"sentence": "Ми їдемо ___ на роботу. (by bus)", "answer": "на автобусі", "options": ["на автобусі", "автобусом", "автобус", "в автобусі"]}]`)}
/>
