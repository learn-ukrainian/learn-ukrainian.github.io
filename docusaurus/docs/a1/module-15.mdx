...
<FillIn
  ...
  isUkrainian={false}
  items={JSON.parse(`[{"sentence": "Іди ___, потім поверни направо. (straight)", "answer": "прямо", "options": ["прямо", "наліво", "направо", "назад"]}, {"sentence": "Аптека ___ банку, біля світлофора. (opposite)", "answer": "навпроти", "options": ["навпроти", "біля", "за", "перед"]}, {"sentence": "На перехресті поверніть ___.", "answer": "наліво", "options": ["наліво", "направо", "прямо", "назад"]}, {"sentence": "Музей ___ парку. (near)", "answer": "біля", "options": ["біля", "навпроти", "між", "за"]}, {"sentence": "Це далеко? — Ні, ___. (close)", "answer": "близько", "options": ["близько", "далеко", "поруч", "туди"]}, {"sentence": "Станція метро ___ мостом. (behind)", "answer": "за", "options": ["за", "перед", "навпроти", "між"]}, {"sentence": "Я їду до університету ___.", "answer": "на трамваї", "options": ["на трамваї", "на автобусі", "на машині", "пішки"]}, {"sentence": "Книгарня ___ кафе і банком. (between)", "answer": "між", "options": ["між", "біля", "за", "навпроти"]}, {"sentence": "Іди ___ вулиці Шевченка. (along)", "answer": "вздовж", "options": ["вздовж", "через", "до", "від"]}, {"sentence": "Театр ___ парку.", "answer": "перед", "options": ["перед", "за", "біля", "навпроти"]}, {"sentence": "Поверніть ___ біля світлофора.", "answer": "направо", "options": ["направо", "наліво", "прямо", "назад"]}, {"sentence": "Я ходжу на роботу ___.", "answer": "пішки", "options": ["пішки", "на автобусі", "метро", "на машині"]}]`)}
/>
