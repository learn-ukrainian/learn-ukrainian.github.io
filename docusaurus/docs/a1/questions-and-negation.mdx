...
<!-- SCOPE
Covers: Asking yes/no questions (particle 'чи'), question words (хто, що, де, etc.), basic negation (particle 'не'), intonation patterns.
Not covered:
  - Genitive case negation (немає) → a1-11
  - Complex questions (which/chi) → a1-14
Related: a1-06-living-verb-1, a1-19-at-the-cafe
-->
...
**Важливо знати:**
Using **чи** makes your speech sound polite, clear, and complete. It is excellent for talking to strangers, older people, or in formal situations. It removes any ambiguity because the sentence creates a question structure immediately.
...
**Важливо знати:**
Be careful with **так**. In other contexts, it can mean "so" (as in "so much"). But as an answer, it always means "Yes".
...
**Path 1: The Formal Road**
Add **Чи** at the front.
Result: **Чи ти знаєш?**
*Tone:* Polite, inquisitive, clear structure.

**Path 2: The Casual Road**
Keep the words. Spike the pitch at the end.
Result: **Ти знаєш?** ↗
*Tone:* Friendly, direct, quick.

Both are perfect Ukrainian. The choice depends on who you are talking to.

**Try it yourself:**
Take the statement **Це кава**.
*   **Formal:** Чи це кава?
*   **Casual:** Це кава? ↗
...
Imagine drawing a line with your finger while you speak.
...
**Waiter:** **Так.** (Yes.)
**You:** **Скільки це коштує?** (How much does it cost?)
**Waiter:** **Це недорого.** (It is inexpensive.)
...
**You:** **Хто це?** (Who is this?)
**Oksana:** **Це мій брат.** (This is my brother.)
**You:** **Де він?** (Where is he?)
**Oksana:** **Він там.** (He is over there.)
**You:** **Що він робить?** (What is he doing?)
**Oksana:** **Він читає.** (He is reading.)
...
<MatchUp pairs={JSON.parse(`[{"left": "Як справи?", "right": "Добре, дякую."}, {"left": "Хто це?", "right": "Це мій друг."}, {"left": "Що ти робиш?", "right": "Я читаю."}, {"left": "Де ти?", "right": "Я вдома."}, {"left": "Чи ти хочеш кави?", "right": "Так, хочу."}, {"left": "Чи це кіт?", "right": "Ні, це собака."}, {"left": "Коли ми йдемо?", "right": "Вранці."}, {"left": "Чому ти тут?", "right": "Я працюю."}]`)} />

### Розшифруйте слова

<Anagram items={JSON.parse(`[{"scrambled": "т а м", "answer": "там", "hint": ""}, {"scrambled": "х т о", "answer": "хто", "hint": ""}, {"scrambled": "к а в а", "answer": "кава", "hint": ""}, {"scrambled": "с л о в о", "answer": "слово", "hint": ""}, {"scrambled": "ч о м у", "answer": "чому", "hint": ""}, {"scrambled": "к о л и", "answer": "коли", "hint": ""}, {"scrambled": "с і к", "answer": "сік", "hint": ""}, {"scrambled": "м а м а", "answer": "мама", "hint": ""}]`)} />

### Ввічливі запитання

<FillIn items={JSON.parse(`[{"sentence": "___ ви лікар?", "answer": "Чи", "options": ["Чи", "Не", "Ні", "Так"]}, {"sentence": "___ це ваш телефон?", "answer": "Чи", "options": ["Чи", "Не", "Ні", "Так"]}, {"sentence": "___ ми можемо увійти?", "answer": "Чи", "options": ["Чи", "Не", "Ні", "Так"]}, {"sentence": "___ ти любиш каву?", "answer": "Чи", "options": ["Чи", "Не", "Ні", "Так"]}, {"sentence": "___ це далеко?", "answer": "Чи", "options": ["Чи", "Не", "Ні", "Так"]}, {"sentence": "___ ви розумієте?", "answer": "Чи", "options": ["Чи", "Не", "Ні", "Так"]}, {"sentence": "___ це правда?", "answer": "Чи", "options": ["Чи", "Не", "Ні", "Так"]}, {"sentence": "___ ви тут?", "answer": "Чи", "options": ["Чи", "Не", "Ні", "Так"]}]`)} />