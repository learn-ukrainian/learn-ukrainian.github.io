...
<GroupSort groups={JSON.parse(`{"Хто? (Who?)": ["мама", "брат", "лікар", "студент", "кіт", "собака"], "Що? (What?)": ["стіл", "книга", "кава", "телефон", "любов", "сік"]}`)} />
...
<Anagram items={JSON.parse(`[{"scrambled": "т а м", "answer": "там", "hint": ""}, {"scrambled": "х т о", "answer": "хто", "hint": ""}, {"scrambled": "к а в а", "answer": "кава", "hint": ""}, {"scrambled": "ч а с т о", "answer": "часто", "hint": ""}, {"scrambled": "ч о м у", "answer": "чому", "hint": ""}, {"scrambled": "к о л и", "answer": "коли", "hint": ""}, {"scrambled": "с і к", "answer": "сік", "hint": ""}, {"scrambled": "м а м а", "answer": "мама", "hint": ""}]`)} />
