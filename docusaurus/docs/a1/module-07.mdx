...
*Arrange the letters to form question words.*
...
<Anagram>
  ...
  />
  <AnagramQuestion
    scrambled={`п и т а н н я`}
    answer={`питання`}
  />
  <AnagramQuestion
    scrambled={`в і д п о в і д ь`}
    answer={`відповідь`}
  />
  <AnagramQuestion
...
*Arrange the letters to form frequency words and adverbs.*
...
<Anagram>
  ...
  />
  <AnagramQuestion
    scrambled={`с ь о г о д н і`}
    answer={`сьогодні`}
  />
  <AnagramQuestion
    scrambled={`з а в т р а`}
    answer={`завтра`}
  />
  <AnagramQuestion
    scrambled={`в ч о р а`}
...
<Unjumble>
  ...
  />
  <UnjumbleQuestion
    words={`ніколи / п'ю / каву / Я / не`}
    answer={`Я ніколи не п'ю каву.`}
  />
  <UnjumbleQuestion
    words={`Він / не / говорить / українською`}
  ...
  />
  <UnjumbleQuestion
    words={`їмо / ніколи / м'ясо / Ми / не`}
    answer={`Ми ніколи не їмо м'ясо.`}
  />
  <UnjumbleQuestion
    words={`не / Вони / слухають / музику`}
    answer={`Вони не слухають музику.`}
  />
  <UnjumbleQuestion
    words={`працюю / не / Я / сьогодні`}
