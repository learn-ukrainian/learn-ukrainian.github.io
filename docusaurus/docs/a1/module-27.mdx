...
:::info
Кольори світу (Colors of the World)
...
:::info
Поєднання кольорів (Color Combinations)
...
З'єднайте колір з предметом одягу.
...
## fill-in: Узгодження кольорів (Color Agreement)

> Виберіть правильний колір.

1. У мене ___ сорочка.
   > [!answer] біла
...
## fill-in: Опис одягу (Describing Outfits)

> Виберіть правильне слово.

1. У мене нова ___ куртка.
   > [!answer] чорна
   > [!options] чорна | чорний | чорне | чорні

2. Я люблю ___ кольори.
   > [!answer] яскраві
...
## true-false: Color Rules

Is this true or false?

- [x] "Біла" is the feminine form of "white".
- [ ] "Синій" is the neuter form.
  > Incorrect! it's masculine

- [x] "Штани" is always plural in Ukrainian.
- [ ] "Пальто" is masculine.
  > Incorrect! it's neuter

- [x] "Блакитний" means light blue.
- [ ] "Чорне" is masculine.
  > Incorrect! it's neuter

- [x] "Джинси" is always plural.
- [ ] "Біле" is feminine.
  > Incorrect! it's neuter

- [x] Colors are adjectives and must agree with nouns.
- [ ] "Сукня" is neuter.
  > Incorrect! it's feminine

- [x] "Світлий" means "light" (as in bright).
