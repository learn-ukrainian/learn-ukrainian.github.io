...
<Quiz questions={[
  {
    question: `Identify the correct word order for the sentence: \"What is this?\"`,
    options: [
      { text: `Що це`, correct: true },
      { text: `це Що`, correct: false },
      { text: `це Що`, correct: false }
    ]
  },  {
    question: `Identify the correct word order for the sentence: \"This is a book.\"`,
    options: [
      { text: `Це книга`, correct: true },
      { text: `книга Це`, correct: false },
      { text: `книга Це`, correct: false }
    ]
  },  {
    question: `Identify the correct word order for the sentence: \"This is a big window.\"`,
    options: [
      { text: `Це велике вікно`, correct: true },
      { text: `велике Це вікно`, correct: false },
      { text: `вікно Це велике`, correct: false }
    ]
  },  {
    question: `Identify the correct word order for the sentence: \"This is a new table.\"`,
    options: [
      { text: `Це новий стіл`, correct: true },
      { text: `новий Це стіл`, correct: false },
      { text: `стіл Це новий`, correct: false }
    ]
  },  {
    question: `Identify the correct word order for the sentence: \"This is a small room.\"`,
    options: [
      { text: `Це маленька кімната`, correct: true },
      { text: `маленька Це кімната`, correct: false },
      { text: `кімната Це маленька`, correct: false }
    ]
  },  {
    question: `Identify the correct word order for the sentence: \"This is a beautiful city.\"`,
    options: [
      { text: `Це красиве місто`, correct: true },
      { text: `красиве Це місто`, correct: false },
      { text: `місто Це красиве`, correct: false }
    ]
  },  {
    ...
    question: `Identify the correct word order for the sentence: \"This is cold water.\"`,
    options: [
      { text: `Це холодна вода`, correct: true },
      { text: `холодна Це вода`, correct: false },
      { text: `вода Це холодна`, correct: false }
    ]
  }
]} />
## 📚 Vocabulary
