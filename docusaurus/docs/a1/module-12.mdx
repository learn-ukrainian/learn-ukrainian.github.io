...
<Quiz questions={[
  {
    ...
    question: `Correct sentence order for: \"She knows this...\"`,
    options: [
      { text: `Вона знає цього студента у групі`, correct: true },
      { text: `знає Вона цього студента у групі`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
