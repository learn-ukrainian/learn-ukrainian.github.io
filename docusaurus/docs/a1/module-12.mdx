...
<Quiz questions={[
  {
    ...
    question: `Correct sentence order for: \"She knows the new...\"`,
    options: [
      { text: `Вона знає нового студента у групі`, correct: true },
      { text: `знає Вона нового студента у групі`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
