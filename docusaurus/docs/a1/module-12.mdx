...
<MatchUp pairs={[
  ...
  { left: `мама`, right: `mother` },
  { left: `тато`, right: `father` },
  { left: `брат`, right: `brother` },
  { left: `сестра`, right: `sister` },
  { left: `син`, right: `son` },
  { left: `донька`, right: `daughter` },
...
<GroupSort groups={{
  "Animate (Who? - Хто?)": ["хлопчик", "дівчинка", "студент", "вчитель", "батько", "мати"],
  "Inanimate (What? - Що?)": ["стіл", "книга", "вікно", "паспорт", "квиток", "поїзд"]
}} />
...
<Quiz questions={[
  {
    question: `Which form is correct for \"I see a female friend\"?`,
    options: [
    ...
    question: `Which form is correct for \"I see a brother\"?`,
    options: [
      { text: `брат`, correct: false },
      { text: `брата`, correct: true },
      { text: `брату`, correct: false },
      { text: `братом`, correct: false }
    ]
  },  {
    question: `Which form is correct for \"I see a mother\"?`,
    options: [
      { text: `мама`, correct: false },
      { text: `маму`, correct: true },
      { text: `мами`, correct: false },
      { text: `мамі`, correct: false }
    ]
  },  {
    question: `Which form is correct for \"I see a father\"?`,
    options: [
      { text: `тато`, correct: false },
      { text: `тата`, correct: true },
      { text: `тату`, correct: false },
      { text: `тата (again)`, correct: false }
    ]
  },  {
    question: `Which form is correct for \"I see an uncle\"?`,
    options: [
      { text: `дядько`, correct: false },
      { text: `дядька`, correct: true },
      { text: `дядьку`, correct: false },
      { text: `дядьком`, correct: false }
    ]
  },  {
    question: `Which form is correct for \"I see a teacher\"?`,
    options: [
      { text: `вчитель`, correct: false },
      { text: `вчителя`, correct: true },
      { text: `вчителю`, correct: false },
      { text: `вчителем`, correct: false }
    ]
  },  {
    question: `Which form is correct for \"I see a sister\"?`,
    options: [
      { text: `сестра`, correct: false },
      { text: `сестру`, correct: true },
      { text: `сестри`, correct: false },
      { text: `сестрі`, correct: false }
    ]
  },  {
    question: `Which form is correct for \"I see a son\"?`,
    options: [
      { text: `син`, correct: false },
      { text: `сина`, correct: true },
      { text: `сину`, correct: false },
      { text: `сином`, correct: false }
    ]
  },  {
    question: `Which form is correct for \"I see a daughter\"?`,
    options: [
      { text: `донька`, correct: false },
      { text: `доньку`, correct: true },
      { text: `доньки`, correct: false },
      { text: `доньці`, correct: false }
    ]
  },  {
    question: `Which form is correct for \"I see a grandfather\"?`,
    options: [
      { text: `дідусь`, correct: false },
      { text: `дідуся`, correct: true },
      { text: `дідусю`, correct: false },
      { text: `дідусем`, correct: false }
    ]
  },  {
    question: `Which form is correct for \"I see a grandmother\"?`,
    options: [
      { text: `бабуся`, correct: false },
      { text: `бабусю`, correct: true },
      { text: `бабусі`, correct: false },
      { text: `бабусьою`, correct: false }
    ]
  },  {
    question: `Which form is correct for \"I see a friend\" (male)?`,
    options: [
      { text: `друг`, correct: false },
      { text: `друга`, correct: true },
      { text: `другу`, correct: false },
      { text: `другом`, correct: false }
    ]
  }
]} />
...
<Quiz questions={[
  {
    ...
    question: `Correct sentence order for: \"She knows my friend well.\"`,
    options: [
      { text: `Вона добре знає мого друга`, correct: true },
      { text: `добре Вона знає мого друга`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"We're waiting for the...\"`,
    options: [
      { text: `Ми чекаємо лікаря у лікарні`, correct: true },
      { text: `чекаємо Ми лікаря у лікарні`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"Do you see the...\"`,
    options: [
      { text: `Ти бачиш офіціанта там`, correct: true },
      { text: `бачиш Ти офіціанта там`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"He loves his teacher.\"`,
    options: [
      { text: `Він любить свою вчительку`, correct: true },
      { text: `любить Він свою вчительку`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"I'm looking for our driver.\"`,
    options: [
      { text: `Я шукаю нашого водія`, correct: true },
      { text: `шукаю Я нашого водія`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"We know this director.\"`,
    options: [
      { text: `Ми знаємо цього директора`, correct: true },
      { text: `знаємо Ми цього директора`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"She sees the neighbor...\"`,
    options: [
      { text: `Вона бачить сусіда кожного ранку`, correct: true },
      { text: `бачить Вона сусіда кожного ранку`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"Are you waiting for...\"`,
    options: [
      { text: `Ти чекаєш свою подругу`, correct: true },
      { text: `чекаєш Ти свою подругу`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"I love my colleague.\"`,
    options: [
      { text: `Я люблю мого колегу`, correct: true },
      { text: `люблю Я мого колегу`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"We see the passenger...\"`,
    options: [
      { text: `Ми бачимо пасажира біля метро`, correct: true },
      { text: `бачимо Ми пасажира біля метро`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"He knows this student...\"`,
    options: [
      { text: `Він знає цю студентку з школи`, correct: true },
      { text: `знає Він цю студентку з школи`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  }
]} />
...
<Quiz questions={[
  {
    question: `Correct sentence order for: \"I see my friend...\"`,
    options: [
      { text: `Я бачу мого друга та його подругу`, correct: true },
      { text: `бачу Я мого друга та його подругу`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"We're waiting for our...\"`,
    options: [
      { text: `Ми чекаємо нашого вчителя біля університету`, correct: true },
      { text: `чекаємо Ми нашого вчителя біля університету`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"She knows all the...\"`,
    options: [
      { text: `Вона знає всіх студентів у групі`, correct: true },
      { text: `знає Вона всіх студентів у групі`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"Do you see that...\"`,
    options: [
      { text: `Ти бачиш того лікаря там`, correct: true },
      { text: `бачиш Ти того лікаря там`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"He really loves his neighbor.\"`,
    options: [
      { text: `Він дуже любить свою сусідку`, correct: true },
      { text: `дуже Він любить свою сусідку`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"I'm looking for our...\"`,
    options: [
      { text: `Я шукаю нашого директора і менеджера`, correct: true },
      { text: `шукаю Я нашого директора і менеджера`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"We know this driver well.\"`,
    options: [
      { text: `Ми добре знаємо цього водія`, correct: true },
      { text: `добре Ми знаємо цього водія`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  },  {
    question: `Correct sentence order for: \"She sees the waiter...\"`,
    options: [
      { text: `Вона бачить офіціанта та офіціантку`, correct: true },
      { text: `бачить Вона офіціанта та офіціантку`, correct: false },
      { text: `Incorrect order for this sentence`, correct: false }
    ]
  }
]} />
