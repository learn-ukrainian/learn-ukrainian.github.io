...
<GroupSort groups={{
  ...
  "Моє покоління (My Generation)": ["брат", "сестра", "чоловік", "дружина"],
  "Молодше покоління (Younger Generation)": ["син", "дочка", "онук", "онучка"]
}} />
...
<Unjumble items={[
  ...
  { jumbled: `вже / дуже / одружений / він / довго`, answer: `Він вже дуже довго одружений` },
