...
:::note
Викликати швидку (Calling an Ambulance)
...
<Quiz>
  <QuizQuestion
    question={`1. You feel sick. What do you say?`}
    options={[`Я хворий.`, `Я здоровий.`, `Я добре.`, `Дякую.`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`You have a headache. What do you say?`}
    options={[`У мене болить голова.`, `У мене болять голова.`, `Мені болить голова.`, `Я болить голова.`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`You need to find a pharmacy. What are you looking for?`}
    options={[`Аптека`, `Лікарня`, `Лікар`, `Швидка`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`You need to call emergency services in Ukraine. What number?`}
    options={[`103`, `911`, `112`, `999`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`You have a fever. What do you say?`}
    options={[`У мене температура.`, `У мене болить температура.`, `Мені температура.`, `Я температура.`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`Where do you go to buy medicine?`}
    options={[`В аптеку.`, `В лікарню.`, `До лікаря.`, `На швидку.`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`You have a cough. How do you say it?`}
    options={[`У мене кашель.`, `Мені кашель.`, `Я кашель.`, `У мене болить кашель.`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`What does "швидка допомога" mean?`}
    options={[`Ambulance`, `Pharmacy`, `Hospital`, `Doctor`]}
    correctIndex={0}
    explanation={``}
  />
</Quiz>
...
<Unjumble>
  ...
  />
  <UnjumbleQuestion
    words={`температура / у мене / висока`}
    answer={`У мене висока температура.`}
  />
  <UnjumbleQuestion
    words={`болять / зуби / у мене`}
    answer={`У мене болять зуби.`}
  />
  <UnjumbleQuestion
    words={`застуда / у мене`}
    answer={`У мене застуда.`}
  />
  <UnjumbleQuestion
    words={`допомогу / швидку / викличте`}
    answer={`Викличте швидку допомогу!`}
  />
  <UnjumbleQuestion
    words={`лікар / потрібен`}
    answer={`Потрібен лікар.`}
  />
  <UnjumbleQuestion
    words={`аптеку / йду / я / в`}
    answer={`Я йду в аптеку.`}
  />
  <UnjumbleQuestion
    words={`болить / горло / у неї`}
    answer={`У неї болить горло.`}
  />
  <UnjumbleQuestion
    words={`таблетки / ось / ваші`}
