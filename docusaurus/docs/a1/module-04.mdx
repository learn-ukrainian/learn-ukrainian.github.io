...
<GroupSort groups={{
  "Use Ти (Informal)": ["Talking to your younger brother", "Talking to your classmate", "Talking to your pet dog", "Talking to a child", "Talking to God (in prayer)", "Talking to yourself in a mirror"],
  "Use Ви (Formal)": ["Talking to your professor", "Talking to a stranger on the street", "Talking to your friend's grandmother", "Talking to a doctor you just met", "Talking to the President", "Talking to a cashier in a shop"]
}} />
