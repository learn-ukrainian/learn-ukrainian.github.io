...
<FillIn items={[
  {
    sentence: `___ студент. (I am a student)`,
    answer: `Я`,
...
<GroupSort groups={{
  "Use Ти (Informal)": ["Talking to your younger brother", "Talking to your classmate", "Talking to your pet dog", "Talking to a child"],
  "Use Ви (Formal)": ["Talking to your professor", "Talking to a stranger on the street", "Talking to your friend's grandmother", "Talking to a doctor you just met"]
}} />
...
<Quiz questions={[
  {
    question: `What is the feminine form of \"українець\"?`,
    options: [
      { text: `українець`, correct: false },
      { text: `українка`, correct: true },
      { text: `україна`, correct: false },
      { text: `україниця`, correct: false }
    ]
  },  {
    question: `What is the feminine form of \"американець\"?`,
    options: [
      { text: `америка`, correct: false },
      { text: `американиця`, correct: false },
      { text: `американка`, correct: true },
      { text: `американець`, correct: false }
    ]
  },  {
    question: `What is the feminine form of \"англієць\"?`,
    options: [
      { text: `англійка`, correct: true },
      { text: `англійця`, correct: false },
      { text: `англія`, correct: false },
      { text: `англієць`, correct: false }
    ]
  },  {
    question: `What is the feminine form of \"канадець\"?`,
    options: [
      { text: `канада`, correct: false },
      { text: `канадка`, correct: true },
      { text: `канадиця`, correct: false },
      { text: `канадець`, correct: false }
    ]
  },  {
    question: `What is the feminine form of \"студент\"?`,
    options: [
      { text: `студент`, correct: false },
      { text: `студентиня`, correct: false },
      { text: `студентка`, correct: true },
    ...
    options: [
      ...
      { text: `професорка`, correct: true },
      { text: `професориха`, correct: false },
      { text: `професора`, correct: false }
    ]
  },  {
    question: `What is the feminine form of \"лікар\"?`,
    options: [
      { text: `лікар`, correct: false },
      { text: `лікарка`, correct: true },
      { text: `лікариня`, correct: false },
      { text: `лікаря`, correct: false }
    ]
  },  {
    question: `What is the feminine form of \"друг\"?`,
    options: [
      { text: `дружка`, correct: false },
      { text: `подруга`, correct: true },
    ...
    options: [
      ...
      { text: `-ка`, correct: true },
      { text: `-иня`, correct: false },
      { text: `-иця`, correct: false }
    ]
  },  {
...
<Anagram items={[
  { scrambled: `в і н`, answer: `він`, hint: `` },
  { scrambled: `в о н а`, answer: `вона`, hint: `` },
  { scrambled: `в о н о`, answer: `воно`, hint: `` },
  { scrambled: `в о н и`, answer: `вони`, hint: `` },
  { scrambled: `д р у г`, answer: `друг`, hint: `` },
  { scrambled: `л і к а р`, answer: `лікар`, hint: `` },
  { scrambled: `с т у д е н т`, answer: `студент`, hint: `` },
  { scrambled: `у ч и т е л ь`, answer: `учитель`, hint: `` },
  { scrambled: `х л о п е ц ь`, answer: `хлопець`, hint: `` },
  { scrambled: `д і в ч и н а`, answer: `дівчина`, hint: `` },
  { scrambled: `л ю д и н а`, answer: `людина`, hint: `` },
  { scrambled: `п о д р у г а`, answer: `подруга`, hint: `` }
]} />
