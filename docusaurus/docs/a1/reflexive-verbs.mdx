...
<GroupSort groups={JSON.parse(`{"Дія на предмет (Transitive)": ["Я мию авто", "Я одягаю сина", "Я готую вечерю", "Я зустрічаю гостей", "Я веселю друзів", "Я зупиняю таксі"], "Дія на себе (Reflexive)": ["Я миюся вранці", "Я одягаюся швидко", "Я готуюсь до екзамену", "Ми зустрічаємося у кафе", "Я веселюся на святах", "Автобус зупиняється тут"]}`)} />
