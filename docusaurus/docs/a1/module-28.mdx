...
:::tip
Шкала частотності (Frequency Scale)
...
<FillIn>
  <FillInQuestion
    sentence={`1. Вона співає дуже ___.`}
    answer={`гарно`}
...
<FillIn>
  <FillInQuestion
    sentence={`1. Я ___ снідаю о сьомій.`}
    answer={`завжди`}
...
<Quiz>
  <QuizQuestion
    ...
    options={[`добрий`, `добре`, `добро`, `добра`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
  ...
  <QuizQuestion
    ...
    options={[`швидка`, `швидко`, `швидкий`, `швидке`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`Вона біжить ___. (fast)`}
    options={[`швидко`, `швидка`, `швидкий`, `швидке`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`У неї ___ голос. (quiet)`}
    options={[`тихий`, `тихо`, `тиха`, `тихе`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
  ...
  <QuizQuestion
    ...
    options={[`весела`, `весело`, `веселий`, `веселе`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
...
<Quiz>
  ...
  <QuizQuestion
    question={`Рідко`}
    options={[`Rarely`, `Always`, `Often`, `Never`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
  ...
  <QuizQuestion
    question={`Дуже`}
    options={[`Very`, `Sometimes`, `Never`, `Rarely`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`Трохи`}
    options={[`A little`, `Very much`, `Never`, `Always`]}
    correctIndex={0}
    explanation={``}
  />
</Quiz>
...
<Unjumble>
  <UnjumbleQuestion
    words={`швидко / бігає / він`}
    answer={`Він швидко бігає.`}
  />
  <UnjumbleQuestion
    words={`добре / вона / співає`}
    answer={`Вона добре співає.`}
  />
  <UnjumbleQuestion
    words={`читаю / я / повільно`}
    answer={`Я читаю повільно.`}
  />
  <UnjumbleQuestion
    words={`часто / ми / гуляємо`}
    answer={`Ми часто гуляємо.`}
  />
  <UnjumbleQuestion
    words={`завжди / снідаю / я / вранці`}
    answer={`Я завжди снідаю вранці.`}
  />
  <UnjumbleQuestion
    words={`не / він / курить / ніколи`}
    answer={`Він ніколи не курить.`}
  />
  <UnjumbleQuestion
    words={`голосно / діти / грають`}
    answer={`Діти голосно грають.`}
  />
  <UnjumbleQuestion
    words={`тихо / вона / говорить`}
    answer={`Вона тихо говорить.`}
  />
  <UnjumbleQuestion
    words={`добре / справи / як`}
    answer={`Як справи? Добре.`}
  />
  <UnjumbleQuestion
    words={`іноді / ми / піцу / їмо`}
    answer={`Ми іноді їмо піцу.`}
  />
  <UnjumbleQuestion
    words={`рідко / телевізор / дивлюсь / я`}
    answer={`Я рідко дивлюсь телевізор.`}
  />
  <UnjumbleQuestion
    words={`весело / вони / танцюють`}
