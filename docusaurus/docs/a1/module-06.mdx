...
<Quiz>
  <QuizQuestion
    question={`1. Which form means "I read"?`}
    options={[`читаю`, `читаю`, `читаєш`, `читають`]}
    correctIndex={1}
    explanation={`я читаю = I read`}
  />
  <QuizQuestion
    question={`What does "ти пишеш" mean?`}
    options={[`I write`, `you write`, `he writes`, `they write`]}
    correctIndex={1}
    explanation={`ти пишеш = you write (informal singular)`}
  />
  <QuizQuestion
    question={`Which ending means "we"?`}
    options={[`-ю`, `-єш`, `-є`, `-ємо`]}
    correctIndex={3}
    explanation={`-ємо is the "we" ending (ми читаємо)`}
  />
  <QuizQuestion
    question={`What is the infinitive of "працюю"?`}
    options={[`працюти`, `працювати`, `працюєти`, `працю`]}
    correctIndex={1}
    explanation={`працювати → працюю (to work → I work)`}
  />
  <QuizQuestion
    question={`Which verb means "to rest"?`}
    options={[`працювати`, `гуляти`, `відпочивати`, `чекати`]}
    correctIndex={2}
    explanation={`відпочивати = to rest`}
  />
  <QuizQuestion
    question={`"Вони читають" means:`}
    options={[`I read`, `you read`, `we read`, `they read`]}
    correctIndex={3}
    explanation={`вони читають = they read`}
  />
  <QuizQuestion
    question={`Which form is used for "він" (he)?`}
    options={[`читаю`, `читаєш`, `читає`, `читають`]}
    correctIndex={2}
    explanation={`він читає = he reads`}
  />
  <QuizQuestion
    question={`What does "ми граємо" mean?`}
    options={[`I play`, `you play`, `we play`, `they play`]}
    correctIndex={2}
    explanation={`ми граємо = we play`}
  />
  <QuizQuestion
    question={`Which verb means "to sing"?`}
    options={[`грати`, `співати`, `танцювати`, `малювати`]}
    correctIndex={1}
    explanation={`співати = to sing`}
  />
  <QuizQuestion
    question={`"Ви знаєте" means:`}
    options={[`I know`, `you know (informal)`, `you know (formal/plural)`, `they know`]}
    correctIndex={2}
    explanation={`ви знаєте = you know (formal or plural)`}
  />
  <QuizQuestion
    question={`Which ending is used for "ти" (you, informal)?`}
    options={[`-ю`, `-єш`, `-є`, `-ють`]}
    correctIndex={1}
    explanation={`-єш is the "you" ending (ти читаєш)`}
  />
  <QuizQuestion
    question={`What is the stem of "писати"?`}
    options={[`писа-`, `пиш-`, `пис-`, `писат-`]}
    correctIndex={1}
    explanation={`писати → пиш- (due to consonant alternation)`}
  />
</Quiz>
...
<Anagram>
  ...
  />
  <AnagramQuestion
    scrambled={`д у м а т и`}
    answer={`думати`}
  />
  <AnagramQuestion
    scrambled={`г у л я т и`}
    answer={`гуляти`}
  />
  <AnagramQuestion
    scrambled={`м а л ю в а т и`}
    answer={`малювати`}
  />
  <AnagramQuestion
...
<Anagram>
  ...
  />
  <AnagramQuestion
    scrambled={`п р а ц ю є`}
    answer={`працює`}
  />
  <AnagramQuestion
    scrambled={`г р а є м о`}
    answer={`граємо`}
  />
  <AnagramQuestion
    scrambled={`с п і в а є т е`}
    answer={`співаєте`}
  />
  <AnagramQuestion
    scrambled={`д у м а ю т ь`}
    answer={`думають`}
  />
  <AnagramQuestion
    scrambled={`г у л я ю`}
  ...
  />
  <AnagramQuestion
    scrambled={`р о з у м і є`}
    answer={`розуміє`}
  />
  <AnagramQuestion
    scrambled={`с л у х а є м о`}
    answer={`слухаємо`}
  />
  <AnagramQuestion
    scrambled={`ч е к а є т е`}
    answer={`чекаєте`}
  />
  <AnagramQuestion
    scrambled={`с н і д а ю т ь`}
    answer={`снідають`}
  />
</Anagram>
...
<Unjumble>
  ...
  />
  <UnjumbleQuestion
    words={`граємо / Ми / футбол`}
    answer={`Ми граємо футбол.`}
  />
  <UnjumbleQuestion
    words={`слухаєте / Ви / музику`}
    answer={`Ви слухаєте музику.`}
  />
  <UnjumbleQuestion
    words={`думають / Вони / багато`}
    answer={`Вони думають багато.`}
  />
  <UnjumbleQuestion
    words={`пишеш / Ти / листа`}
    answer={`Ти пишеш листа.`}
  />
  <UnjumbleQuestion
    words={`співає / Вона / пісню`}
