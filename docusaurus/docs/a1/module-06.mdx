...
<Quiz questions={[
  {
    ...
    question: `Which verb ending implies the pronouns \"we\"?`,
    options: [
    ...
    question: `What does the phrase \"Вони читають\" mean?`,
    options: [
    ...
    question: `What is the meaning of \"Ви знаєте\"?`,
    options: [
...
<GroupSort groups={{
  "1st Person (I/We)": ["я читаю", "ми читаємо", "я знаю", "ми знаємо"],
  "2nd Person (You)": ["ти читаєш", "ви читаєте", "ти знаєш", "ви знаєте"],
  "3rd Person (He/She)": ["він читає", "вона читає", "він знає", "вона знає"]
}} />
...
<FillIn items={[
  {
    ...
    sentence: `Скажіть, що вони роблять? Вони ___ про Україну.`,
    answer: `думають`,
    ...
    sentence: `Скажіть, що ми робимо? Ми ___ о дванадцятій.`,
    answer: `обідаємо`,
