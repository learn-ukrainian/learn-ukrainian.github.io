...
<MatchUp pairs={JSON.parse(`[{"left": "1", "right": "один"}, {"left": "2", "right": "два"}, {"left": "3", "right": "три"}, {"left": "4", "right": "чотири"}, {"left": "5", "right": "п’ять"}, {"left": "6", "right": "шість"}, {"left": "7", "right": "сім"}, {"left": "8", "right": "вісім"}]`)} />

### Хто що робив?

<MatchUp pairs={JSON.parse(`[{"left": "Він", "right": "читав"}, {"left": "Вона", "right": "читала"}, {"left": "Воно", "right": "читало"}, {"left": "Вони", "right": "читали"}, {"left": "Я (чоловік)", "right": "був"}, {"left": "Я (жінка)", "right": "була"}, {"left": "Ми", "right": "були"}, {"left": "Брат", "right": "хотів"}]`)} />
...
<MatchUp pairs={JSON.parse(`[{"left": "Називний (Nominative)", "right": "Хто? Що? (Subject)"}, {"left": "Знахідний (Accusative)", "right": "Куди? (Direction)"}, {"left": "Місцевий (Locative)", "right": "Де? (Location)"}, {"left": "Родовий (Genitive)", "right": "Кого? Чого? (Absence)"}, {"left": "Я бачу...", "right": "сестру (Accusative)"}, {"left": "Я гуляю...", "right": "в парку (Locative)"}, {"left": "У мене немає...", "right": "часу (Genitive)"}, {"left": "Це...", "right": "мій дім (Nominative)"}]`)} />