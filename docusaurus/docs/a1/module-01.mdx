...
<MatchUp
  title="True Friends"
  pairs={JSON.parse(`[{"left": "А", "right": "A"}, {"left": "Е", "right": "E"}, {"left": "І", "right": "I"}, {"left": "О", "right": "O"}, {"left": "К", "right": "K"}, {"left": "М", "right": "M"}, {"left": "Т", "right": "T"}, {"left": "а", "right": "a"}, {"left": "е", "right": "e"}, {"left": "і", "right": "i"}, {"left": "о", "right": "o"}, {"left": "к", "right": "k"}]`)}
/>

### False Friends Sound

<MatchUp
  title="False Friends Sound"
  pairs={JSON.parse(`[{"left": "Ukrainian Letter", "right": "Sound"}, {"left": "В", "right": "/v/ as in van"}, {"left": "Н", "right": "/n/ as in no"}, {"left": "Р", "right": "/r/ as in red"}, {"left": "С", "right": "/s/ as in sun"}, {"left": "У", "right": "/u/ as in moon"}, {"left": "Х", "right": "/x/ as in loch"}, {"left": "в", "right": "/v/"}, {"left": "н", "right": "/n/"}, {"left": "р", "right": "/r/"}, {"left": "с", "right": "/s/"}, {"left": "у", "right": "/u/"}, {"left": "х", "right": "/x/"}]`)}
/>
...
<GroupSort
  title="Letter Types"
  groups={JSON.parse(`{"True Friends": ["А", "О", "Е", "І", "К", "М"], "False Friends": ["В", "Н", "Р", "С", "У", "Х"], "New Letters": ["Б", "Д", "З", "Л", "П", "Ф"]}`)}
/>
...
<Anagram
  ...
  items={JSON.parse(`[{"scrambled": "к а в а", "answer": "кава", "hint": "coffee"}, {"scrambled": "б а н к", "answer": "банк", "hint": "bank"}, {"scrambled": "п а р к", "answer": "парк", "hint": "park"}, {"scrambled": "с у п", "answer": "суп", "hint": "soup"}, {"scrambled": "б а р", "answer": "бар", "hint": "bar"}, {"scrambled": "м е т р о", "answer": "метро", "hint": "metro"}, {"scrambled": "р а д і о", "answer": "радіо", "hint": "radio"}, {"scrambled": "ф о т о", "answer": "фото", "hint": "photo"}, {"scrambled": "п і ц а", "answer": "піца", "hint": "pizza"}, {"scrambled": "с а л а т", "answer": "салат", "hint": "salad"}, {"scrambled": "т а к с і", "answer": "таксі", "hint": "taxi"}, {"scrambled": "м у з и к а", "answer": "музика", "hint": "music"}]`)}
/>
...
<Anagram
  ...
  items={JSON.parse(`[{"scrambled": "о п е р а", "answer": "опера", "hint": "opera"}, {"scrambled": "б а л е т", "answer": "балет", "hint": "ballet"}, {"scrambled": "а к т о р", "answer": "актор", "hint": "actor"}, {"scrambled": "п а с п о р т", "answer": "паспорт", "hint": "passport"}, {"scrambled": "в і з а", "answer": "віза", "hint": "visa"}, {"scrambled": "к а р т а", "answer": "карта", "hint": "card/map"}, {"scrambled": "к о м е т а", "answer": "комета", "hint": "comet"}, {"scrambled": "р а к е т а", "answer": "ракета", "hint": "rocket"}, {"scrambled": "к а к а о", "answer": "какао", "hint": "cocoa"}, {"scrambled": "і н т е р н е т", "answer": "інтернет", "hint": "internet"}, {"scrambled": "с т у д е н т", "answer": "студент", "hint": "student"}, {"scrambled": "т у р и с т", "answer": "турист", "hint": "tourist"}]`)}
/>
