...
**Grammar:**
- 📖 [Telling Time in Ukrainian](https://www.ukrainianlessons.com/grammar-time/) — Котра година?
- 🎙️ [Ukrainian Lessons Podcast](https://www.ukrainianlessons.com/podcast/) — Audio lessons

**Practice:**
- 📝 [Numbers Guide](https://www.ukrainianlessons.com/numbers/) — Numbers for time
- 🎧 [Speak Ukrainian YouTube](https://www.youtube.com/@SpeakUkrainian) — Video lessons

**Review previous modules** if you're struggling with time expressions.
:::
