...
<MatchUp pairs={JSON.parse(`[{"left": "допомога", "right": "help"}, {"left": "швидка", "right": "ambulance"}, {"left": "поліція", "right": "police"}, {"left": "пожежна", "right": "fire service"}, {"left": "небезпека", "right": "danger"}, {"left": "аварія", "right": "accident"}, {"left": "лікарня", "right": "hospital"}, {"left": "документи", "right": "documents"}, {"left": "загубити", "right": "to lose"}, {"left": "вкрасти", "right": "to steal"}, {"left": "травма", "right": "injury"}, {"left": "адреса", "right": "address"}]`)} />
...
<GroupSort groups={JSON.parse(`{"Екстрені служби": ["поліція", "швидка", "пожежна", "лікарня"], "Проблеми та інциденти": ["аварія", "травма", "небезпека", "ДТП"], "Дії та процеси": ["викликати", "загубити", "вкрасти", "допомогти"]}`)} />

### Знайдіть пару: Фрази та їх значення

<MatchUp pairs={JSON.parse(`[{"left": "Допоможіть, будь ласка!", "right": "Help me, please!"}, {"left": "Я загубив документи.", "right": "I lost my documents."}, {"left": "У мене вкрали гаманець.", "right": "My wallet was stolen."}, {"left": "Тут сталася аварія.", "right": "An accident happened here."}, {"left": "Людині потрібна швидка.", "right": "The person needs an ambulance."}, {"left": "Я свідок ДТП.", "right": "I am a witness to the accident."}, {"left": "Скажіть точну адресу.", "right": "Tell the exact address."}, {"left": "Я хочу подати заяву.", "right": "I want to submit a statement."}]`)} />
...
<GroupSort groups={JSON.parse(`{"Дієслова (Що робити?)": ["загубити", "вкрасти", "викликати", "допомогти", "дзвонити", "шукати"], "Іменники (Що? Хто?)": ["свідок", "заява", "документи", "адреса", "небезпека", "травма"]}`)} />
