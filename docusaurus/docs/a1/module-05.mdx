...
<Quiz questions={JSON.parse(`[{"question": "___ телефон (this phone, masculine)", "options": [{"text": "цей", "correct": true}, {"text": "ця", "correct": false}, {"text": "це", "correct": false}, {"text": "ці", "correct": false}], "explanation": "Телефон is masculine, so use цей."}, {"question": "___ чашка (this cup, feminine)", "options": [{"text": "цей", "correct": false}, {"text": "ця", "correct": true}, {"text": "це", "correct": false}, {"text": "ці", "correct": false}], "explanation": "Чашка is feminine, so use ця."}, {"question": "___ вікно (this window, neuter)", "options": [{"text": "цей", "correct": false}, {"text": "ця", "correct": false}, {"text": "це", "correct": true}, {"text": "ці", "correct": false}], "explanation": "Вікно is neuter, so use це."}, {"question": "___ ключі (these keys, plural)", "options": [{"text": "цей", "correct": false}, {"text": "ця", "correct": false}, {"text": "це", "correct": false}, {"text": "ці", "correct": true}], "explanation": "Plural objects use ці."}, {"question": "___ диван (that couch, masculine)", "options": [{"text": "той", "correct": true}, {"text": "та", "correct": false}, {"text": "те", "correct": false}, {"text": "ті", "correct": false}], "explanation": "Диван is masculine, so use той."}, {"question": "___ шафа (that wardrobe, feminine)", "options": [{"text": "той", "correct": false}, {"text": "та", "correct": true}, {"text": "те", "correct": false}, {"text": "ті", "correct": false}], "explanation": "Шафа is feminine, so use та."}, {"question": "___ крісло (that armchair, neuter)", "options": [{"text": "той", "correct": false}, {"text": "та", "correct": false}, {"text": "те", "correct": true}, {"text": "ті", "correct": false}], "explanation": "Крісло is neuter, so use те."}, {"question": "___ двері (those doors, plural)", "options": [{"text": "той", "correct": false}, {"text": "та", "correct": false}, {"text": "те", "correct": false}, {"text": "ті", "correct": true}], "explanation": "Plural objects use ті."}, {"question": "___ лампа (this lamp, feminine)", "options": [{"text": "цей", "correct": false}, {"text": "ця", "correct": true}, {"text": "це", "correct": false}, {"text": "ці", "correct": false}], "explanation": "Лампа is feminine, so use ця."}, {"question": "___ пилосос (that vacuum cleaner, masculine)", "options": [{"text": "той", "correct": true}, {"text": "та", "correct": false}, {"text": "те", "correct": false}, {"text": "ті", "correct": false}], "explanation": "Пилосос is masculine, so use той."}, {"question": "___ дзеркало (this mirror, neuter)", "options": [{"text": "цей", "correct": false}, {"text": "ця", "correct": false}, {"text": "це", "correct": true}, {"text": "ці", "correct": false}], "explanation": "Дзеркало is neuter, so use це."}, {"question": "___ картини (those paintings, plural)", "options": [{"text": "той", "correct": false}, {"text": "та", "correct": false}, {"text": "те", "correct": false}, {"text": "ті", "correct": true}], "explanation": "Plural objects use ті."}]`)} />
