...
<Quiz questions={[
  {
    question: `To which class does **говорити** belong?`,
    options: [
    ...
    question: `To which class does **читати** belong?`,
    options: [
    ...
    question: `To which class does **любити** belong?`,
    options: [
      { text: `Class II (-ити)`, correct: true },
      { text: `Class I (-ати)`, correct: false },
      { text: `Irregular`, correct: false },
    ...
    question: `To which class does **працювати** belong?`,
    options: [
      { text: `Class II (-ити)`, correct: false },
      { text: `Class I (-ати)`, correct: true },
      { text: `Irregular`, correct: false },
    ...
    question: `To which class does **бачити** belong?`,
    options: [
      { text: `Class II (-ити)`, correct: true },
      { text: `Class I (-ати)`, correct: false },
      { text: `Irregular`, correct: false },
    ...
    question: `To which class does **знати** belong?`,
    options: [
      { text: `Class II (-ити)`, correct: false },
      { text: `Class I (-ати)`, correct: true },
      { text: `Irregular`, correct: false },
    ...
    question: `To which class does **ходити** belong?`,
    options: [
      { text: `Class II (-ити)`, correct: true },
      { text: `Class I (-ати)`, correct: false },
      { text: `Irregular`, correct: false },
    ...
    question: `To which class does **писати** belong?`,
    options: [
      { text: `Class II (-ити)`, correct: false },
      { text: `Class I (-ати)`, correct: true },
      { text: `Irregular`, correct: false },
    ...
    question: `To which class does **робити** belong?`,
    options: [
      { text: `Class II (-ити)`, correct: true },
      { text: `Class I (-ати)`, correct: false },
      { text: `Irregular`, correct: false },
    ...
    question: `To which class does **дякувати** belong?`,
    options: [
      { text: `Class II (-ити)`, correct: false },
      { text: `Class I (-ати)`, correct: true },
      { text: `Irregular`, correct: false },
    ...
    question: `To which class does **спати** belong?`,
    options: [
      { text: `Class II (-ити)`, correct: true },
      { text: `Class I (-ати)`, correct: false },
      { text: `Irregular`, correct: false },
    ...
    question: `To which class does **вчити** belong?`,
    options: [
      { text: `Class II (-ити)`, correct: true },
      { text: `Class I (-ати)`, correct: false },
      { text: `Irregular`, correct: false },
...
<GroupSort groups={{
  "Class I (-ати)": ["читати", "писати", "працювати", "знати"],
  "Class II (-ити)": ["говорити", "робити", "бачити", "любити", "ходити"],
...
<Quiz questions={[
  {
    question: `Я впевнено ___ українською мовою.`,
    options: [
      { text: `розмовляю`, correct: true },
      { text: `розмовляєш`, correct: false },
      { text: `розмовляє`, correct: false },
      { text: `розмовляють`, correct: false }
    ]
  },  {
    question: `Скажіть, чи ти часто ___ музику?`,
    options: [
      { text: `слухаю`, correct: false },
      { text: `слухаєш`, correct: true },
      { text: `слухає`, correct: false },
      { text: `слухають`, correct: false }
    ]
  },  {
    question: `Ми зазвичай ___ вдома ввечері.`,
    options: [
      { text: `вечеряю`, correct: false },
      { text: `вечеряєш`, correct: false },
      { text: `вечеряє`, correct: false },
      { text: `вечеряємо`, correct: true }
    ]
  },  {
    question: `Вона зараз швидко ___ листа.`,
    options: [
      { text: `пишеш`, correct: false },
      { text: `пише`, correct: true },
      { text: `пишуть`, correct: false },
      { text: `писати`, correct: false }
    ]
  },  {
    question: `Ви добре ___ це слово?`,
    options: [
      { text: `знати`, correct: false },
      { text: `знаємо`, correct: false },
      { text: `знаєте`, correct: true },
      { text: `знають`, correct: false }
    ]
  },  {
    question: `Я дуже ___ свою роботу.`,
    options: [
      { text: `люблю`, correct: true },
      { text: `любиш`, correct: false },
      { text: `любить`, correct: false },
      { text: `люблять`, correct: false }
    ]
  },  {
    question: `Чи ти часто ідеш ___ в університет?`,
    options: [
      { text: `ходиш`, correct: true },
      { text: `ходжу`, correct: false },
      { text: `ходимо`, correct: false },
      { text: `ходять`, correct: false }
    ]
  },  {
    question: `Він зараз не ___ спати.`,
    options: [
      { text: `хотіти`, correct: false },
      { text: `хочеш`, correct: false },
      { text: `хоче`, correct: true },
      { text: `хочуть`, correct: false }
    ]
  },  {
    question: `Чи ти зараз виконуєш ___ вправу вдома?`,
    options: [
      { text: `робиш`, correct: false },
      { text: `робиш`, correct: true },
      { text: `робить`, correct: false },
      { text: `роблять`, correct: false }
    ]
  },  {
    question: `Що вона зараз робить? Вона ___ біля вікна.`,
    options: [
      { text: `стояти`, correct: false },
      { text: `стоїш`, correct: false },
      { text: `стоїть`, correct: true },
      { text: `стоять`, correct: false }
    ]
  },  {
    question: `Що ці люди роблять? Вони ___ обід.`,
    options: [
      { text: `готувати`, correct: false },
      { text: `готуєш`, correct: false },
      { text: `готує`, correct: false },
      { text: `готують`, correct: true }
    ]
  },  {
    question: `Що вони роблять? Вони ___.`,
    options: [
      { text: `бачити`, correct: false },
      { text: `бачиш`, correct: false },
      { text: `бачить`, correct: false },
      { text: `бачать`, correct: true }
    ]
  }
]} />
## 📚 Vocabulary
