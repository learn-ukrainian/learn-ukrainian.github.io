...
<!-- SCOPE
Covers: Buying train/bus tickets, asking for schedules, platform navigation, carriage types, cultural aspects of Ukrainian trains.
Not covered:
  - Complex Genitive case theory (deep dive) → a2-genitive
  - International travel specificities
Related: a1-17 (Numbers), a1-40 (Taking Transport)
-->
...
<MatchUp pairs={JSON.parse(`[{"left": "відправлення", "right": "прибуття"}, {"left": "нижнє місце", "right": "верхнє місце"}, {"left": "туди", "right": "назад"}, {"left": "запитання", "right": "відповідь"}, {"left": "купе", "right": "плацкарт"}, {"left": "пасажир", "right": "провідник"}, {"left": "швидкий", "right": "повільний"}, {"left": "день", "right": "ніч"}]`)} />
...
<GroupSort groups={JSON.parse(`{"Купе (Coupe)": ["закриті двері", "чотири місця", "більше приватності", "дорожчий квиток", "тиша", "комфорт"], "Плацкарт (Platskart)": ["відкритий коридор", "дешевший квиток", "багато людей", "спільний простір", "шум", "низька ціна"]}`)} />
...
| вокзал |  | railway terminal | noun | ч |  |
| автостанція |  | bus station | noun | ж |  |
| платформа |  | platform | noun | ж |  |
| вагон |  | carriage | noun | ч |  |
| місце |  | seat/bunk | noun | с |  |
| купе |  | coupe (compartment) | noun | с |  |
| плацкарт |  | open dormitory car | noun | ч |  |
| каса |  | ticket office | noun | ж |  |
| розклад |  | schedule | noun | ч |  |
| відправлення |  | departure | noun | с |  |
| прибуття |  | arrival | noun | с |  |
| провідник |  | conductor | noun | ч |  |
| підстаканник |  | metal cup holder | noun | ч |  |
| постіль |  | bed linen | noun | ж |  |
| до |  | to | preposition |  |  |
