...
Хтось тут [___:7]!`}
  blanks={[{ index: 0, answer: `сказала`, options: [`сказала`] }, { index: 1, answer: `чи`, options: [`чи`] }, { index: 2, answer: `відповіла`, options: [`відповіла`] }, { index: 3, answer: `що`, options: [`що`] }, { index: 4, answer: `стверджує`, options: [`стверджує`] }, { index: 5, answer: `похвалив`, options: [`похвалив`] }, { index: 6, answer: `бреше`, options: [`бреше`] }]}
/>
