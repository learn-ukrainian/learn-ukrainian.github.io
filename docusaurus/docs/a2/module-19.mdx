...
:::tip
> Ukrainians often use superlatives warmly about family and friends: "Моя мама найкраща!" (My mom is the best!)
:::
...
<FillIn>
  <FillInQuestion
    sentence={`1. Це ___ книга. (добрий)`}
    answer={`найкраща`}
...
<Quiz>
  <QuizQuestion
    question={`1. How do you form superlatives in Ukrainian?`}
    options={[`най- + comparative`, `більш + adjective`, `-ший + adjective`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`What's the superlative of "кращий"?`}
    options={[`найкращий`, `кращіший`, `добрійший`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`What's the superlative of "більший"?`}
    options={[`найбільший`, `більшіший`, `найвеликий`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Найгірший" means:`}
    options={[`worst`, `better`, `bad`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Найдорожчий" means:`}
    options={[`most expensive`, `cheapest`, `expensive`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`Which is an intensifier?`}
    options={[`дуже — very`, `ніж — than`, `за — for`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Надзвичайно" means:`}
    options={[`extraordinarily`, `badly`, `quickly`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`Superlatives agree in:`}
    options={[`gender, number, case`, `only gender`, `nothing`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
  ...
  <QuizQuestion
    ...
    options={[`completely regular (always най-)`, `highly irregular`, `only for some adjectives`]}
    correctIndex={0}
    explanation={``}
  />
</Quiz>
...
<Unjumble>
  ...
  />
  <UnjumbleQuestion
    words={`він / найстаріший / студент`}
    answer={`Він найстаріший студент.`}
  />
  <UnjumbleQuestion
    words={`Україна / найбільша / країна / в / Європі`}
    answer={`Україна — найбільша країна в Європі.`}
  />
  <UnjumbleQuestion
    words={`це / найгірший / день`}
    answer={`Це найгірший день.`}
  />
  <UnjumbleQuestion
    words={`вона / найрозумніша / людина`}
    answer={`Вона найрозумніша людина.`}
  />
  <UnjumbleQuestion
    words={`Дніпро / найдовша / річка`}
    answer={`Дніпро — найдовша річка.`}
  />
  <UnjumbleQuestion
    words={`цей / фільм / дуже / цікавий`}
    answer={`Цей фільм дуже цікавий.`}
  />
  <UnjumbleQuestion
    words={`він / найкращий / друг`}
    answer={`Він найкращий друг.`}
  />
  <UnjumbleQuestion
    words={`моя / мама / найкраща`}
    answer={`Моя мама найкраща!`}
  />
  <UnjumbleQuestion
    words={`це / найдорожчий / телефон`}
    answer={`Це найдорожчий телефон.`}
  />
  <UnjumbleQuestion
    words={`вона / надзвичайно / талановита`}
    answer={`Вона надзвичайно талановита.`}
  />
  <UnjumbleQuestion
    words={`Говерла / найвища / гора`}
...
<DialogueReorder>
  ...
  {
    "speaker": "",
    "line": "Який твій найкращий фільм?"
  },
  {
    "speaker": "",
    "line": "Мій найкращий фільм — \"Тіні забутих предків.\""
  },
  {
    "speaker": "",
    "line": "Чому?"
  ...
  {
    "speaker": "",
    "line": "Тому що він надзвичайно гарний і важливий для української культури."
  },
  {
    "speaker": "",
    "line": "А найгірший?"
  ...
  {
    "speaker": "",
    "line": "Не хочу говорити про найгірше!"
  },
  {
    "speaker": "",
    "line": "Яка найвища гора в Україні?"
  },
  {
    "speaker": "",
    "line": "Говерла."
  ...
  {
    "speaker": "",
    "line": "Україна — велика країна?"
  },
  {
    "speaker": "",
    "line": "Так, найбільша в Європі!"
  }
]} />
</DialogueReorder>
...
<MarkTheWords>
  <MarkTheWordsActivity
    text={`Це найкраща книга! Він найстаріший студент. Україна — найбільша країна. Дніпро — найдовша річка. Говерла — найвища гора. Це найгірший день. Вона дуже талановита. Він найрозумніший. Це найдорожчий телефон.`}
    correctWords={[`найкраща`, `найстаріший`, `найбільша`, `найдовша`, `найвища`, `найгірший`, `найрозумніший`, `найдорожчий`]}
  />
</MarkTheWords>
...
<Translate>
  <TranslateItem
    ...
    answer={`Це найкраща книга.`}
    options={[`Це найкраща книга.`, `Це краща книга.`, `Це добра книга.`]}
    explanation={``}
  />
  <TranslateItem
    source={`He is the oldest student.`}
    answer={`Він найстаріший студент.`}
    options={[`Він найстаріший студент.`, `Він старіший студент.`, `Він старий студент.`]}
    explanation={``}
  />
  <TranslateItem
    source={`Ukraine is the biggest country in Europe.`}
    answer={`Україна — найбільша країна в Європі.`}
    options={[`Україна — найбільша країна в Європі.`, `Україна — більша країна в Європі.`, `Україна — велика країна в Європі.`]}
    explanation={``}
  />
  <TranslateItem
    source={`This is the worst day.`}
    answer={`Це найгірший день.`}
    options={[`Це найгірший день.`, `Це гірший день.`, `Це поганий день.`]}
    explanation={``}
  />
  <TranslateItem
    source={`The Dnipro is the longest river.`}
    answer={`Дніпро — найдовша річка.`}
    options={[`Дніпро — найдовша річка.`, `Дніпро — довша річка.`, `Дніпро — довга річка.`]}
    explanation={``}
  />
  <TranslateItem
    source={`She is the smartest person.`}
    answer={`Вона найрозумніша людина.`}
    options={[`Вона найрозумніша людина.`, `Вона розумніша людина.`, `Вона розумна людина.`]}
    explanation={``}
  />
  <TranslateItem
    source={`This is very interesting.`}
    answer={`Це дуже цікаво.`}
    options={[`Це дуже цікаво.`, `Це найцікавіше.`, `Це цікаве.`]}
    explanation={``}
  />
  <TranslateItem
    source={`This is extraordinarily beautiful.`}
    answer={`Це надзвичайно гарно.`}
    options={[`Це надзвичайно гарно.`, `Це гарніше.`, `Це гарно.`]}
    explanation={``}
  />
  <TranslateItem
    source={`My mom is the best!`}
    answer={`Моя мама найкраща!`}
    options={[`Моя мама найкраща!`, `Моя мама краща!`, `Моя мама добра!`]}
    explanation={``}
  />
  <TranslateItem
    source={`This is the most expensive phone.`}
    answer={`Це найдорожчий телефон.`}
    options={[`Це найдорожчий телефон.`, `Це дорожчий телефон.`, `Це дорогий телефон.`]}
    explanation={``}
  />
  <TranslateItem
    source={`He is the fastest athlete.`}
    answer={`Він найшвидший спортсмен.`}
    options={[`Він найшвидший спортсмен.`, `Він швидший спортсмен.`, `Він швидкий спортсмен.`]}
    explanation={``}
  />
  <TranslateItem
    source={`This is the cheapest option.`}
    answer={`Це найдешевший варіант.`}
    options={[`Це найдешевший варіант.`, `Це дешевший варіант.`, `Це дешевий варіант.`]}
    explanation={``}
  />
</Translate>
