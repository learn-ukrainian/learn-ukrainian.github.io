...
Я скажу: \"До [___:8] [Hint: see you]!\"`}
  blanks={[{ index: 0, answer: `побачення`, options: [`побачення`] }, { index: 1, answer: `входу`, options: [`входу`] }, { index: 2, answer: `вигляд`, options: [`вигляд`] }, { index: 3, answer: `передбачення`, options: [`передбачення`] }, { index: 4, answer: `похід`, options: [`похід`] }, { index: 5, answer: `вигляд`, options: [`вигляд`] }, { index: 6, answer: `вихід`, options: [`вихід`] }, { index: 7, answer: `побачення`, options: [`побачення`] }]}
/>
