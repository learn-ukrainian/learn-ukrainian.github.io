...
:::note
Cultural Insight: The Post Office
...
<FillIn>
  <FillInQuestion
    sentence={`1. Де [___] у метро? [Hint: Entrance]`}
    answer={`вхід`}
...
<Unjumble>
  <UnjumbleQuestion
    words={`потрібен / Мені / підпис / ваш`}
    answer={`Мені потрібен ваш підпис.`}
  />
  <UnjumbleQuestion
    words={`зробив / Я / опис / товару`}
    answer={`Я зробив опис товару.`}
  />
  <UnjumbleQuestion
    words={`читає / Письменник / книгу / свою`}
    answer={`Письменник читає свою книгу.`}
  />
  <UnjumbleQuestion
    words={`гарний / У / вигляд / нього`}
    answer={`У нього гарний вигляд.`}
  />
  <UnjumbleQuestion
    words={`тут / Де / перехід`}
    answer={`Де тут перехід?`}
  />
  <UnjumbleQuestion
    words={`читання / Це / урок`}
...
<Quiz>
  <QuizQuestion
    question={`1. If "Вхід" is Entrance, what is "Вихід"?`}
    options={[`Exit`, `Crossing`, `Signature`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`What does "Підпис" literally mean?`}
    options={[`Under-write`, `Over-write`, `Re-write`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
  ...
  <QuizQuestion
    ...
    options={[`Foot (Пішки)`, `Car (Машина)`, `Horse (Кінь)`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"До побачення" includes the root meaning:`}
    options={[`Seeing`, `Writing`, `Walking`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Погляд" usually relates to:`}
    options={[`Opinion / Glance`, `Walking style`, `Handwriting`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`Which word describes a person?`}
    options={[`Письменник`, `Письмо`, `Напис`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Читання" is the process of:`}
    options={[`Reading`, `Writing`, `Walking`]}
    correctIndex={0}
    explanation={``}
  />
</Quiz>
...
<FillIn>
  <FillInQuestion
    sentence={`1. Ваш [___] на документі. [Hint: Signature]`}
    answer={`підпис`}
...
<ErrorCorrection>
  <ErrorCorrectionItem
    sentence={`1. Де тут **випис**? (Intended: Exit)`}
    error={`випис`}
    answer={`вихід`}
    options={[`вихід`, `випис`]}
...
<FillIn>
  <FillInQuestion
    sentence={`1. [___]хід. [Hint: Entrance (In)]`}
    answer={`В`}
    options={[`В`, `Ви`, `Пере`]}
  />
  <FillInQuestion
