...
:::note
Cultural Note: Possession in Slavic Languages
...
<FillIn>
  <FillInQuestion
    sentence={`1. Він читає [___] книгу. (his own book)`}
    answer={`свою`}
    options={[`свою`, `його`]}
  />
  <FillInQuestion
...
<Quiz>
  <QuizQuestion
    question={`1. "Свій" refers back to:`}
    options={[`The subject of the sentence`, `Any person mentioned`, `Only third person`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Він любить його маму" means:`}
    options={[`He loves someone else's mom`, `He loves his own mom`, `He loves my mom`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`When can you use мій instead of свій?`}
    options={[`When the subject is "я"`, `Always`, `Never`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Вона миє свої руки" means:`}
    options={[`She washes her own hands`, `She washes his hands`, `She washes your hands`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`Which declines: свій or його?`}
    options={[`Only свій`, `Only його`, `Both`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Свого" is which case?`}
    options={[`Genitive`, `Dative`, `Instrumental`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Ми любимо свою країну" means:`}
    options={[`We love our country`, `We love their country`, `We love his country`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`The subject is "Марія". Which is correct for "her book"?`}
    options={[`свою книгу`, `її книгу`, `мою книгу`]}
    correctIndex={0}
    explanation={``}
  />
</Quiz>
...
<Unjumble>
  <UnjumbleQuestion
    words={`свою / Він / книгу / читає`}
    answer={`Він читає свою книгу.`}
  />
  <UnjumbleQuestion
    words={`маму / свою / Вона / любить`}
    answer={`Вона любить свою маму.`}
  />
  <UnjumbleQuestion
    words={`у / живуть / своєму / Вони / домі`}
    answer={`Вони живуть у своєму домі.`}
  />
  <UnjumbleQuestion
    words={`сумку / взяла / свою / Марія`}
    answer={`Марія взяла свою сумку.`}
  />
  <UnjumbleQuestion
    words={`зі / говорить / своїм / Він / братом`}
    answer={`Він говорить зі своїм братом.`}
  />
  <UnjumbleQuestion
    words={`про / думаю / своє / Я / майбутнє`}
    answer={`Я думаю про своє майбутнє.`}
  />
  <UnjumbleQuestion
    words={`своїй / у / спить / Вона / кімнаті`}
    answer={`Вона спить у своїй кімнаті.`}
  />
  <UnjumbleQuestion
    words={`своїх / Ми / любимо / батьків`}
...
<ErrorCorrection>
  <ErrorCorrectionItem
    sentence={`1. Він любить **його** маму. (Intended: his own mom)`}
    error={`його`}
    answer={`свою`}
    options={[`свою`, `його`]}
...
<FillIn>
  <FillInQuestion
    sentence={`1. Петро надів [___] костюм. (his own)`}
    answer={`свій`}
    options={[`свій`, `його`]}
  />
  <FillInQuestion
