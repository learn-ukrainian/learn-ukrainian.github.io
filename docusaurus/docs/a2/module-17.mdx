...
<ErrorCorrection>
  ...
  />
  <ErrorCorrectionItem
    sentence={`Вона взяла свою сумку Марії.`}
    errorWord={`свою`}
    correctForm={`її`}
    options={[`її`, `свою`]}
  ...
  />
  <ErrorCorrectionItem
    sentence={`Вони говорять про їхню роботу.`}
    errorWord={`їхню`}
    correctForm={`свою`}
    options={[`свою`, `їхню`]}
  ...
  />
  <ErrorCorrectionItem
    sentence={`Марія любить своєї мами.`}
    errorWord={`своєї`}
    correctForm={`свою`}
    options={[`свою`, `своєї`]}
  ...
  />
  <ErrorCorrectionItem
    sentence={`Петро бачив свою сестру Оксани.`}
    errorWord={`свою`}
    correctForm={`її`}
    options={[`її`, `свою`]}
