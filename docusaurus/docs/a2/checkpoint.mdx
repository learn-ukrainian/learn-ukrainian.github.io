...
<MatchUp pairs={JSON.parse(`[{"left": "у мене болить голова", "right": "my head hurts"}, {"left": "маю червоне горло", "right": "I have a sore throat"}, {"left": "у нього висока температура", "right": "he has a high fever"}, {"left": "приймати ліки", "right": "to take medicine"}, {"left": "мати сильну застуду", "right": "to have a bad cold"}, {"left": "піти до лікаря", "right": "to go to the doctor"}, {"left": "пити чай з медом", "right": "to drink tea with honey"}, {"left": "народна медицина", "right": "traditional medicine"}]`)} />
...
<GroupSort groups={JSON.parse(`{"Тіло людини": ["голова", "горло", "живіт", "рука"], "Лікарня та аптека": ["ліки", "таблетки", "лікар", "сироп"], "Народна медицина": ["калина", "малина", "мед", "чай"]}`)} />
