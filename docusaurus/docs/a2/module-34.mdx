...
Я пішов туди, [___:7] насолодитися атмосферою.`}
  blanks={[{ index: 0, answer: `Коли`, options: [`Коли`] }, { index: 1, answer: `яке`, options: [`яке`] }, { index: 2, answer: `тому що`, options: [`тому що`] }, { index: 3, answer: `Але`, options: [`Але`] }, { index: 4, answer: `де`, options: [`де`] }, { index: 5, answer: `що`, options: [`що`] }, { index: 6, answer: `щоб`, options: [`щоб`] }]}
/>
