...
:::tip
Pronunciation Tip: The Apostrophe
...
:::warning
Myth: "Ukrainian is just a rural dialect."
...
<FillIn>
  <FillInQuestion
    sentence={`1. Я хочу ___ в магазин купити води. (Drop by - foot)`}
    answer={`зайти`}
...
<Quiz>
  <QuizQuestion
    question={`1. You are inside a room. You want to leave. You...`}
    options={[`Виходите`, `Входите`, `Підходите`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`You see a friend across the street. To meet him, you must...`}
    options={[`Перейти вулицю`, `Обійти вулицю`, `Зайти вулицю`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`The train is at the platform. It is ready to start the journey. It...`}
    options={[`Відправляється / Від'їжджає`, `Приїжджає`, `Під'їжджає`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`You want to give flowers to Mom. You...`}
    options={[`Приносите квіти`, `Виносите квіти`, `Переносите квіти`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Зайти" implies the visit is...`}
    options={[`Short/Brief`, `Permanent`, `Dangerous`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Чумаки" traveled to get...`}
    options={[`Salt`, `Gold`, `Coffee`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`If you "Проїхали" your stop, you went...`}
    options={[`Too far (Past it)`, `Not far enough`, `Exactly there`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Обйти" helps you avoid...`}
    options={[`An obstacle`, `A door`, `A friend`]}
    correctIndex={0}
    explanation={``}
  />
</Quiz>
...
<Unjumble>
  <UnjumbleQuestion
    words={`магазин / в / зайшов / він`}
    answer={`Він зайшов в магазин.`}
  />
  <UnjumbleQuestion
    words={`з / вийшла / вона / дому`}
    answer={`Вона вийшла з дому.`}
  />
  <UnjumbleQuestion
    words={`до / підійти / вікна`}
    answer={`Підійти до вікна.`}
  />
  <UnjumbleQuestion
    words={`ми / міст / переїхали`}
    answer={`Ми переїхали міст.`}
  />
  <UnjumbleQuestion
    words={`додому / я / прийшов`}
    answer={`Я прийшов додому.`}
  />
  <UnjumbleQuestion
    words={`автобус / від / від'їхав / зупинки`}
...
<MarkTheWords>
  <MarkTheWordsActivity
    text={`Турист вийшов(motion) з готелю. Він побачив(perception) карту. Він перейшов(motion) площу. Потім він зайшов(motion) у музей. Там він слухав(perception) гіда. Ввечері він повернувся(motion) назад. Він їв(action) вечерю і спав(state).`}
...
<DialogueReorder>
  ...
  {
    "speaker": "",
    "line": "Перепрошую, як пройти до опери?"
  },
  {
    "speaker": "",
    "line": "Добрий день. Це недалеко."
  },
  {
    "speaker": "",
    "line": "Мені треба переходити вулицю?"
  },
  {
    "speaker": "",
    "line": "Ні, не треба. Просто вийдіть з метро і йдіть прямо."
  },
  {
    "speaker": "",
    "line": "А потім?"
  ...
  {
    "speaker": "",
    "line": "Потім обійдіть пам'ятник Тарасу Шевченку."
  },
  {
    "speaker": "",
    "line": "І я побачу оперу?"
  },
  {
    "speaker": "",
    "line": "Так, ви відразу її побачите."
  }
]} />
</DialogueReorder>
...
<ErrorCorrection>
  <ErrorCorrectionItem
    sentence={`1. Я **вийшов** в кімнату. (Logic: Exit into?)`}
    error={`вийшов`}
