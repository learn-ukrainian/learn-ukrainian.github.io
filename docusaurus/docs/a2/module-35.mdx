...
Мама рада, що я [___:8]їхав.`}
  blanks={[{ index: 0, answer: `ви`, options: [`ви`] }, { index: 1, answer: `при`, options: [`при`] }, { index: 2, answer: `за`, options: [`за`] }, { index: 3, answer: `від`, options: [`від`] }, { index: 4, answer: `при`, options: [`при`] }, { index: 5, answer: `зу`, options: [`зу`] }, { index: 6, answer: `їд`, options: [`їд`] }, { index: 7, answer: `при`, options: [`при`] }]}
/>
