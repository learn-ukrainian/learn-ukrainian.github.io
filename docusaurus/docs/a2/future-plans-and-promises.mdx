...
<!-- SCOPE
Covers: Formation of simple future (perfective) and compound future (imperfective); distinguishing process vs result in the future tense; expressing plans and making promises.
Not covered:
  - Verb conjugation patterns in present tense (prerequisite)
Related: a2-12, a2-13, a2-15, a2-16
-->
...
<GroupSort groups={JSON.parse(`{"Процес (буду + інфінітив)": ["буду робити", "буду читати", "буду чекати", "буду писати", "буду гуляти", "буду відпочивати"], "Результат (доконаний вид)": ["зроблю", "прочитаю", "прийду", "напишу", "знайду", "закінчу"]}`)} />
...
<MatchUp pairs={JSON.parse(`[{"left": "Я буду робити", "right": "Я зроблю"}, {"left": "Я буду писати", "right": "Я напишу"}, {"left": "Я буду читати", "right": "Я прочитаю"}, {"left": "Я буду йти", "right": "Я піду"}, {"left": "Я буду шукати", "right": "Я знайду"}, {"left": "Я буду казати", "right": "Я скажу"}, {"left": "Я буду починати", "right": "Я почну"}, {"left": "Я буду закінчувати", "right": "Я закінчу"}, {"left": "Я буду давати", "right": "Я дам"}, {"left": "Я буду дивитися", "right": "Я побачу"}]`)} />
