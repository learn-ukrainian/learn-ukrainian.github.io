...
— [___:6], кожен має свою думку.`}
  blanks={[{ index: 0, answer: `На мою`, options: [`На мою`, `В мою`] }, { index: 1, answer: `згодна`, options: [`згодна`, `не згодна`] }, { index: 2, answer: `Мабуть`, options: [`Мабуть`, `Не`] }, { index: 3, answer: `Не зовсім`, options: [`Не зовсім`, `Так`] }, { index: 4, answer: `маєте`, options: [`маєте`, `не маєте`] }, { index: 5, answer: `Добре`, options: [`Добре`, `Погано`] }]}
/>
