...
:::warning[Grammar Note: Case with "На думку"]
...
:::warning[Myth: "Everyone thinks the same"]
...
<MatchUp pairs={[
  ...
  { left: `Я вважаю, що`, right: `I consider that` },
  { left: `На мою думку`, right: `In my opinion` },
  { left: `На мій погляд`, right: `From my view` },
  { left: `Я згоден`, right: `I agree` },
  { left: `Ви праві`, right: `You are right` },
  { left: `Навряд чи`, right: `Hardly / I doubt it` },
  { left: `Я не впевнений`, right: `I am not sure` }
]} />
...
<FillIn items={[
  {
    sentence: `Я [___:1], що це місто дуже красиве. (think)`,
    answer: `думаю`,
    options: [`думаю`, `бачу`, `сплю`, `їм`]
  },  {
    sentence: `На [___:2] думку, квитки занадто дорогі. (my)`,
    answer: `мою`,
    options: [`мою`, `мій`, `моє`, `мої`]
  },  {
    sentence: `Мені [___:3], що сьогодні буде дощ. (seems)`,
    answer: `здається`,
    options: [`здається`, `подобається`, `хочеться`, `пишеться`]
  },  {
    sentence: `Я цілком [___:4] з вашою пропозицією. (agree - masc)`,
    answer: `згоден`,
    options: [`згоден`, `згодна`, `згодні`, `згодне`]
  },  {
    sentence: `Ви [___:5], це рішення найкраще. (right)`,
    answer: `праві`,
    options: [`праві`, `ліві`, `старі`, `малі`]
  },  {
    sentence: `[___:6] чи ми встигнемо на поїзд. (hardly)`,
    answer: `Навряд`,
    options: [`Навряд`, `Майже`, `Зовсім`, `Дуже`]
  },  {
    sentence: `Я вважаю, [___:7] треба більше працювати. (that)`,
    answer: `що`,
    options: [`що`, `чи`, `як`, `де`]
  },  {
    sentence: `Я не [___:8], що це правильна відповідь. (sure - masc)`,
    answer: `впевнений`,
...
<Quiz questions={[
  {
    question: `Як саме найчастіше починають висловлювати свою власну думку в українській мові, щоб це звучало нейтрально та зрозуміло?`,
    options: [
      { text: `Зазвичай використовують популярну та просту фразу \"Я думаю, що...\"`, correct: true },
      { text: `Використовують дуже гучний і довгий крик на початку кожної розмови`, correct: false },
      { text: `Використовують лише складні математичні формули для обґрунтування слів`, correct: false },
      { text: `Використовують повне мовчання протягом трьох хвилин перед кожним реченням`, correct: false }
    ]
  },  {
    question: `Який саме граматичний відмінок потрібно обов'язково використовувати після конструкції \"На думку...\", щоб вказати на власника ідеї?`,
    options: [
      { text: `Для позначення власника думки використовують Родовий відмінок (кого? чого?)`, correct: true },
      { text: `Для позначення власника думки використовують лише Орудний відмінок`, correct: false },
      { text: `Для позначення власника думки використовують Кличний відмінок для звертання`, correct: false },
      { text: `Для позначення власника думки використовують Майбутній час дієслова`, correct: false }
    ]
  },  {
    question: `Що саме ви маєте на увазі, коли кажете своєму співрозмовнику \"Ви абсолютно праві\" під час дискусії?`,
    options: [
      { text: `Ви висловлюєте свою повну та рішучу згоду з думкою або позицією людини`, correct: true },
      { text: `Ви вказуєте людині, що їй треба йти тільки праворуч на наступному перехресті`, correct: false },
      { text: `Ви критикуєте людину за її дуже погану та стару поведінку минулого тижня`, correct: false },
      { text: `Ви просите людину швидко принести вам склянку холодної чистої води`, correct: false }
    ]
  },  {
    question: `Який саме емоційний відтінок значення вносить у розмову українська корисна фраза сумніву \"Навряд чи\"?`,
    options: [
      { text: `Ця фраза виражає сильний сумнів або велику непевність у певному факті`, correct: true },
      { text: `Ця фраза виражає повну та абсолютну впевненість у щасливому майбутньому`, correct: false },
      { text: `Ця фраза вказує на те, що зараз на вулиці йде дуже сильний холодний дощ`, correct: false },
      { text: `Ця фраза означає, що ви хочете терміново купити собі новий теплий одяг`, correct: false }
    ]
  },  {
    question: `Чи потрібно зазвичай змінювати час дієслова в реченні, коли ви просто звітуєте про свою власну думку?`,
    options: [
      { text: `Ні, час дієслова зазвичай залишається таким самим, як він звучить у самій думці`, correct: true },
      { text: `Так, ми завжди маємо змінювати абсолютно всі часи дієслів на минулий час`, correct: false },
      { text: `Так, ми маємо використовувати тільки форми майбутнього часу для всіх думок`, correct: false },
      { text: `Так, час дієслова змінюється тільки якщо ми дуже голосно кричимо на друга`, correct: false }
    ]
  },  {
    question: `Що саме ви хочете передати близькому другу, коли вживаєте вступну фразу \"Мені здається\"?`,
    options: [
      { text: `Ви висловлюєте свою думку обережно, як власне суб'єктивне враження чи відчуття`, correct: true },
      { text: `Ви висловлюєте дуже точний та перевірений часом науковий факт із підручника`, correct: false },
      { text: `Ви просите друга негайно зачинити всі вікна в цьому великому старому домі`, correct: false },
      { text: `Ви кажете другу, що ви вже дуже хочете швидко піти додому і відпочити`, correct: false }
    ]
  },  {
    question: `Яка форма прикметника \"Згоден\" (Agree) є граматично правильною для жінки, яка висловлює свою згоду?`,
    options: [
      { text: `Для жінки правильною є форма прикметника або стану \"Я згодна\" з закінченням -а`, correct: true },
      { text: `Для жінки правильною є форма прикметника або стану \"Я згоден\" з нульовим закінченням`, correct: false },
      { text: `Для жінки правильною є форма прикметника або стану \"Я згодне\" з закінченням -е`, correct: false },
      { text: `Для жінки правильною є форма іменника \"Згода\" в називному відмінку однини`, correct: false }
    ]
  },  {
    question: `У якій саме життєвій ситуації найбільш доречно вживати офіційне дієслово \"Я вважаю, що...\"?`,
    options: [
      { text: `Коли ви висловлюєте серйозну, зважену та добре аргументовану власну позицію`, correct: true },
      { text: `Коли ви просто розповідаєте друзям новий смішний анекдот про старого рибалку`, correct: false },
      { text: `Коли ви просите продавця в магазині продати вам трохи свіжого білого хліба`, correct: false },
      { text: `Коли ви шукаєте правильну дорогу до центрального парку в новому місті`, correct: false }
    ]
  },  {
    question: `Як правильно та природно сказати \"I think so too\" українською мовою в щоденній розмові?`,
    options: [
      { text: `Найкраще сказати фразу \"Я теж так думаю\" своєму другу або колезі`, correct: true },
      { text: `Найкраще сказати фразу \"Я теж так дивлюся\" своєму другу або колезі`, correct: false },
      { text: `Найкраще сказати фразу \"Я теж так сплю\" своєму другу або колезі`, correct: false },
      { text: `Найкраще сказати фразу \"Я теж так їм\" своєму другу або колезі`, correct: false }
    ]
  },  {
    question: `Що саме ви хочете повідомити, коли кажете \"Ви помиляєтеся\" під час гарячої суперечки на роботі?`,
    options: [
      { text: `Ви ввічливо вказуєте людині на те, що вона каже якусь неправду або помиляється`, correct: true },
      { text: `Ви кажете людині, що вона дуже гарно та модно сьогодні одягнена для зустрічі`, correct: false },
      { text: `Ви просите людину принести вам нову цікаву книгу про історію вашої країни`, correct: false },
      { text: `Ви кажете людині, що зараз саме час для дуже смачного обіду в ресторані`, correct: false }
    ]
  },  {
    question: `Чи можна часто починати власну думку зі слова \"Можливо...\" для пом'якшення загального тону?`,
    options: [
      { text: `Так, це чудовий спосіб зробити власну заяву менш категоричною та агресивною`, correct: true },
      { text: `Ні, в українській мові категорично не можна вживати це слово на початку`, correct: false },
      { text: `Так, але тільки якщо ви розмовляєте з дуже маленькими дітьми на вулиці`, correct: false },
      { text: `Ні, це слово використовується виключно в підручниках з дуже вищої математики`, correct: false }
    ]
  },  {
    question: `Яке слово найкраще перекладає термін \"opinion\" у фіксованій конструкції \"на мою думку\"?`,
    options: [
      { text: `Це українське слово \"думка\", що вказує на процес особистого мислення`, correct: true },
      { text: `Це українське слово \"голова\", що вказує на частину тіла будь-якої людини`, correct: false },
      { text: `Це українське слово \"книга\", що вказує на друковане джерело нових знань`, correct: false },
      { text: `Це українське слово \"слово\", що вказує на окрему одиницю людського мовлення`, correct: false }
    ]
  }
]} />
...
<TrueFalse items={[
  {
    ...
    statement: `False`,
    isTrue: true,
    explanation: `Women say \"Я згодна\".`
  },  {
    statement: `True`,
    isTrue: true,
    explanation: ``
    ...
    statement: `False`,
    isTrue: true,
    explanation: `It expresses doubt.`
  },  {
    statement: `True`,
    isTrue: true,
    explanation: ``
    ...
    statement: `False`,
    isTrue: false,
    explanation: `It adds perspective to the sentence.`
  },  {
    statement: `True`,
    isTrue: false,
    explanation: ``
    ...
    statement: `False`,
    isTrue: true,
    explanation: `Usually keep the original tense.`
  },  {
    statement: `True`,
    isTrue: true,
    explanation: ``
    ...
    statement: `False`,
    isTrue: true,
    explanation: `It means \"You are right\".`
  },  {
    statement: `True`,
    isTrue: true,
    explanation: ``
    ...
    statement: `False`,
    isTrue: false,
    explanation: `This is a cultural trait.`
  }
]} />
...
<GroupSort groups={{
  "Agreement (Згода)": ["Я згоден", "Я згодна", "Ви праві", "Це точно!", "Я теж так думаю", "Звичайно!", "Безумовно!", "Очевидно!"],
  "Disagreement (Незгода)": ["Я не згоден", "Я не згодна", "Навряд чи", "Ви помиляєтеся", "Я так не думаю", "Це неправда", "Це не так", "Мені важко сказати"]
}} />

### Opinion Sentences (Concept: Syntax Integrity)

<Unjumble items={[
  { jumbled: `я / думаю / що / сучасна / українська / мова / є / дуже / милозвучна / і / справді / красива`, answer: `Я думаю, що сучасна українська мова є дуже милозвучна і справді красива` },
  { jumbled: `на / мою / думку / цей / зовсім / новий / фільм / справді / вартий / вашої / особливої / уваги`, answer: `На мою думку, цей зовсім новий фільм справді вартий вашої особливої уваги` },
  { jumbled: `він / твердо / стверджує / що / це / складне / рішення / є / єдино / правильним / для / нас`, answer: `Він твердо стверджує, що це складне рішення є єдино правильним для нас` },
  { jumbled: `лікар / вважає / що / цей / пацієнт / повинен / трохи / більше / відпочивати / та / багато / спати`, answer: `Лікар вважає, що цей пацієнт повинен трохи більше відпочивати та багато спати` },
  { jumbled: `я / цілком / згоден / що / нам / треба / швидше / це / зробити`, answer: `Я цілком згоден, що нам треба швидше це зробити` },
  { jumbled: `вона / навряд / чи / погодиться / на / таку / дуже / дивну / і / ризиковану / нову / пропозицію`, answer: `Вона навряд чи погодиться на таку дуже дивну і ризиковану нову пропозицію` }
]} />
...
<ErrorCorrection>
  ...
  />
  <ErrorCorrectionItem
    sentence={`На **мій** думку, це добре.`}
    errorWord={`мій`}
    correctForm={`мою`}
    options={[`мою`, `мій`]}
  ...
  />
  <ErrorCorrectionItem
    sentence={`Я **думати**, що він прийде.`}
    errorWord={`думати`}
    correctForm={`думаю`}
  ...
  />
  <ErrorCorrectionItem
    sentence={`Це **навряд**, що він знає.`}
    errorWord={`навряд`}
    correctForm={`навряд чи`}
    options={[`навряд чи`, `навряд`]}
    explanation={`Use the full particle навряд чи.`}
  />
  <ErrorCorrectionItem
    sentence={`Я вважаю, **чи** він правий.`}
    errorWord={`чи`}
    correctForm={`що`}
    options={[`що`, `чи`]}
  ...
  />
  <ErrorCorrectionItem
    sentence={`Ви **помилка**, це не так.`}
    errorWord={`помилка`}
    correctForm={`помиляєтеся`}
...
<Cloze
  passage={`Complete the conversation about the new project.
...
**Анна:** [___:12] так! Давайте почнемо роботу.`}
  blanks={[{ index: 0, answer: `На`, options: [`На`, `У`] }, { index: 1, answer: `згоден`, options: [`згоден`, `бачу`] }, { index: 2, answer: `здається`, options: [`здається`, `подобається`] }, { index: 3, answer: `вважає`, options: [`вважає`, `знає`] }, { index: 4, answer: `Навряд`, options: [`Навряд`, `Майже`] }, { index: 5, answer: `помиляєтеся`, options: [`помиляєтеся`, `праві`] }, { index: 6, answer: `думаю`, options: [`думаю`, `сплю`] }, { index: 7, answer: `згодна`, options: [`згодна`, `згоден`] }, { index: 8, answer: `вважаю`, options: [`вважаю`, `пишу`] }, { index: 9, answer: `теж`, options: [`теж`, `зовсім`] }, { index: 10, answer: `можливо`, options: [`можливо`, `навряд`] }, { index: 11, answer: `Саме`, options: [`Саме`, `Хоча`] }]}
/>

### Discussing Views (Concept: Narrative Coherence)

<DialogueReorder lines={[
  { text: `Як тобі цей ресторан?`, order: 1 },
  { text: `Я думаю, що їжа тут дуже смачна.`, order: 2 },
  { text: `А я не згоден. Мій стейк був сухий.`, order: 3 },
  { text: `Справді? На мою думку, він виглядав добре.`, order: 4 },
  { text: `Вигляд — це ще не все. Я вважаю, що сервіс теж повільний.`, order: 5 },
  { text: `Ви праві, офіціанта ми чекали довго.`, order: 6 },
  { text: `Я більше сюди не прийду.`, order: 7 },
  { text: `А я теж так думаю тепер.`, order: 8 },
  { text: `Може, підемо в інше місце завтра?`, order: 9 },
  { text: `Навряд чи я захочу їсти в цьому районі знову.`, order: 10 },
  { text: `Ви дуже критичні сьогодні!`, order: 11 },
  { text: `Можливо, але я просто чесний.`, order: 12 }
]} />
...
<MarkTheWordsActivity
  text={`Identify the opinion-marking phrases in the text.
...
Я думаю, що це добре. На мою думку, це важливо. Мені здається, ви помиляєтеся. Я вважаю, що час іти. Я не певний у цьому. Ви праві! Навряд чи це допоможе. Я згоден з вами. Я теж так думаю.`}
  correctWords={[`думаю`, `мою думку`, `здається`, `вважаю`, `певний`, `праві`, `чи`, `згоден`, `теж`]}
/>
</MarkTheWords>
...
<Translate questions={[
  {
    source: `I think that she is right.`,
    options: [
      { text: `Я думаю, що вона права.`, correct: true },
      { text: `Я думаю, чи вона права.`, correct: false }
    ]
  },  {
    source: `In my opinion, it is too late.`,
    options: [
      { text: `На мою думку, вже занадто пізно.`, correct: true },
      { text: `На мою думку, вже занадто скоро.`, correct: false }
    ]
  },  {
    source: `I completely agree with you.`,
    options: [
      { text: `Я цілком згоден з вами.`, correct: true },
      { text: `Я цілком не певний з вами.`, correct: false }
    ]
  },  {
    source: `It seems to me that it works.`,
    options: [
      { text: `Мені здається, що це працює.`, correct: true },
      { text: `Мені здається, що це спить.`, correct: false }
    ]
  },  {
    source: `I doubt that it is true.`,
    options: [
      { text: `Навряд чи це правда.`, correct: true },
      { text: `Це точно правда.`, correct: false }
    ]
  },  {
    source: `What do you think about this?`,
    options: [
      { text: `Що ви про це думаєте?`, correct: true },
      { text: `Де ви про це думаєте?`, correct: false }
    ]
  },  {
    source: `You are mistaken about this.`,
    options: [
      { text: `Ви помиляєтеся щодо цього.`, correct: true },
      { text: `Ви праві щодо цього.`, correct: false }
    ]
  },  {
    source: `I am not sure about the plan.`,
    options: [
      { text: `Я не знаю точно щодо плану.`, correct: true },
      { text: `Я згоден щодо плану.`, correct: false }
    ]
  },  {
    source: `Probably we should stay.`,
    options: [
      { text: `Напевно, нам треба залишитися.`, correct: true },
      { text: `Напевно, нам треба піти.`, correct: false }
    ]
  },  {
    source: `Maybe you have a point.`,
    options: [
      { text: `Можливо, ви маєте рацію.`, correct: true },
      { text: `Можливо, ви маєте книгу.`, correct: false }
    ]
  },  {
    source: `She considers this important.`,
    options: [
      { text: `Вона вважає це важливим.`, correct: true },
      { text: `Вона думає це важливим.`, correct: false }
    ]
  },  {
    source: `I think so too.`,
    options: [
      { text: `Я теж так думаю.`, correct: true },
      { text: `Я теж так бачу.`, correct: false }
    ]
  }
]} />
## 📚 Vocabulary
