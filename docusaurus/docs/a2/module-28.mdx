...
— [___:6], кожен має свою думку.`}
  blanks={[{ answer: `На мою`, options: [`На мою`] }, { answer: `згодна`, options: [`згодна`] }, { answer: `Мабуть`, options: [`Мабуть`] }, { answer: `Не зовсім`, options: [`Не зовсім`] }, { answer: `маєте`, options: [`маєте`] }, { answer: `Добре`, options: [`Добре`] }]}
/>
