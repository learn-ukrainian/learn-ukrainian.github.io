...
<FillIn>
  <FillInQuestion
    sentence={`1. Людина, яка слухає. Це [___]. [Hint: Listener]`}
    answer={`слухач`}
...
<Unjumble>
  <UnjumbleQuestion
    words={`гарна / Це / дуже / думка`}
    answer={`Це дуже гарна думка.`}
  />
  <UnjumbleQuestion
    words={`українську / Ми / мову / вивчаємо`}
    answer={`Ми вивчаємо українську мову.`}
  />
  <UnjumbleQuestion
    words={`уважно / Слухачі / професора / слухають`}
    answer={`Слухачі уважно слухають професора.`}
  />
  <UnjumbleQuestion
    words={`зробив / Я / замовлення / вже`}
    answer={`Я вже зробив замовлення.`}
  />
  <UnjumbleQuestion
    words={`була / серйозна / Це / розмова`}
    answer={`Це була серйозна розмова.`}
  />
  <UnjumbleQuestion
    words={`має / Він / талант / письменницький`}
...
<Quiz>
  <QuizQuestion
    question={`1. "Мовчати" means:`}
    options={[`To be silent`, `To speak loud`, `To sing`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
  ...
  <QuizQuestion
    ...
    options={[`Person (Doer)`, `Process`, `Quality`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Переклад" (Translation) literally means:`}
    options={[`Cross-lay`, `In-write`, `Out-speak`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`Adjective from "Наука":`}
    options={[`Науковий`, `Наукний`, `Наукач`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
  ...
  <QuizQuestion
    ...
    options={[`To invent`, `To forget`, `To sleep`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Ukrainian language" is:`}
    options={[`Українська мова`, `Український мова`, `Українське мова`]}
    correctIndex={0}
    explanation={``}
  />
</Quiz>
...
<ErrorCorrection>
  <ErrorCorrectionItem
    sentence={`1. Я **слухаю** книгу. (Intended: Read)`}
    error={`слухаю`}
    answer={`читаю`}
