...
<FillIn items={[
  {
    sentence: `Людина, яка слухає. Це [___].`,
    answer: `слухач`,
    options: [`слухач`, `мовець`, `письменник`]
  },  {
    sentence: `Процес обміну словами. Це [___].`,
    answer: `розмова`,
    options: [`розмова`, `промова`, `замовлення`]
  },  {
    sentence: `Те, що ми думаємо. Це [___].`,
    answer: `думка`,
    options: [`думка`, `слух`, `мова`]
  },  {
    sentence: `Офіційний виступ. Це [___].`,
    answer: `промова`,
    options: [`промова`, `розмова`, `мовчання`]
  },  {
    sentence: `Те, що ми робимо в ресторані. Це [___].`,
    answer: `замовлення`,
    options: [`замовлення`, `промова`, `слух`]
  },  {
    sentence: `Перекласти текст іншою мовою. Це [___].`,
    answer: `переклад`,
    options: [`переклад`, `перехід`, `перерва`]
  },  {
    sentence: `Коли ти не говориш. Це [___].`,
    answer: `мовчання`,
    options: [`мовчання`, `розмова`, `крик`]
  },  {
    sentence: `Результат творчості. Це [___].`,
    answer: `твір`,
...
<Unjumble items={[
  { jumbled: `гарна / Це / дуже / думка / про / майбутнє / проект`, answer: `Це дуже гарна думка про майбутнє проект` },
  { jumbled: `українську / Ми / мову / вивчаємо / щодня / з / радістю / в / школі`, answer: `Ми вивчаємо українську мову щодня з радістю в школі` },
  { jumbled: `уважно / Слухачі / професора / слухають / під / час / цікавої / промови`, answer: `Слухачі уважно слухають професора під час цікавої промови` },
  { jumbled: `зробив / Я / замовлення / вже / в / цьому / новому / ресторані`, answer: `Я вже зробив замовлення в цьому новому ресторані` },
  { jumbled: `була / серйозна / Це / розмова / між / двома / добрими / друзями`, answer: `Це була серйозна розмова між двома добрими друзями` },
  { jumbled: `має / Він / талант / письменницький / і / пише / чудові / книги`, answer: `Він має письменницький талант і пише чудові книги` }
]} />
...
<Quiz questions={[
  {
    question: `What is the literal meaning of the verb \"Мовчати\"?`,
    options: [
      { text: `To be silent (keep quiet)`, correct: true },
      { text: `To speak loud (shout)`, correct: false },
      { text: `To sing (make music)`, correct: false },
      { text: `To whisper (speak softly)`, correct: false }
    ]
  },  {
    question: `The Ukrainian word \"Замовлення\" (Order) contains which specific root component?`,
    options: [
      { text: `МОВ`, correct: true },
      { text: `ДУМ`, correct: false },
      { text: `ХІД`, correct: false },
      { text: `РОБ`, correct: false }
    ]
  },  {
    question: `The suffix \"-ач\" in \"Слухач\" indicates what meaning?`,
    options: [
      { text: `Person who does the action (Agent)`, correct: true },
      { text: `The process of doing action`, correct: false },
      { text: `The quality of the object`, correct: false },
      { text: `The location of the action`, correct: false }
    ]
  },  {
    question: `What is the literal logic of \"Переклад\" (Translation)?`,
    options: [
      { text: `Cross-lay (Laying meaning across)`, correct: true },
      { text: `In-write`, correct: false },
      { text: `Out-speak`, correct: false },
      { text: `Re-read`, correct: false }
    ]
  },  {
    question: `Which adjective is correctly derived from \"Наука\" (Science)?`,
    options: [
      { text: `Науковий`, correct: true },
      { text: `Наукний`, correct: false },
      { text: `Наукач`, correct: false },
      { text: `Наукський`, correct: false }
    ]
  },  {
    question: `Can you explain why the words \"Вхід\" and \"Вихід\" are typically paired together?`,
    options: [
      { text: `They are opposites`, correct: true },
      { text: `They are synonyms`, correct: false },
      { text: `They are unrelated words`, correct: false },
      { text: `They are different spellings of one word`, correct: false }
    ]
  },  {
    question: `Can you identify the correct meaning of the Ukrainian verb \"Придумати\"?`,
    options: [
