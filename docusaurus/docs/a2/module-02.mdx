...
<Cloze
  ...
  blanks={[{ index: 0, answer: `Собі`, options: [`Кому`, `Собі`, `Тобі`] }, { index: 1, answer: `собі`, options: [`собі`, `мені`, `тобі`] }, { index: 2, answer: `подобається`, options: [`подобається`, `подобаєтесь`, `подобатися`] }, { index: 3, answer: `подобається`, options: [`подобається`, `подобаюсь`, `подобаємось`] }, { index: 4, answer: `принесу`, options: [`принесу`, `приношу`, `приносити`] }]}
/>
