...
<TrueFalse
  ...
  items={JSON.parse(`[{"statement": "Prepositions in Ukrainian require specific grammatical cases.", "isTrue": true, "explanation": "Correct! Every Ukrainian preposition is linked to one or more cases."}, {"statement": "\\\"В школу\\\" and \\\"в школі\\\" mean exactly the same thing.", "isTrue": false, "explanation": "False! \\\"В школу\\\" (accusative) means motion TO school; \\\"в школі\\\" (locative) means location AT school."}, {"statement": "\\\"Без\\\" always takes the genitive case.", "isTrue": true, "explanation": "Yes! \\\"Без цукру\\\" (without sugar) uses genitive."}, {"statement": "\\\"Над\\\" always takes the instrumental case.", "isTrue": true, "explanation": "Correct! \\\"Над столом\\\" (above the table) uses instrumental."}, {"statement": "\\\"На\\\" only takes accusative case.", "isTrue": false, "explanation": "False! \\\"На\\\" takes accusative for motion, locative for location."}, {"statement": "\\\"До\\\" takes genitive case.", "isTrue": true, "explanation": "Yes! \\\"До школи\\\" (to school) uses genitive."}, {"statement": "\\\"З\\\" always means \\\"from.\\\"", "isTrue": false, "explanation": "\\\"З\\\" can mean \\\"from\\\" with genitive OR \\\"with\\\" with instrumental."}, {"statement": "Motion uses accusative with в/у, на, під, за.", "isTrue": true, "explanation": "Correct! These two-way prepositions use accusative for motion."}, {"statement": "\\\"В\\\" and \\\"у\\\" have the same meaning.", "isTrue": true, "explanation": "Yes! They differ only in when you use them for euphony."}, {"statement": "\\\"Перед\\\" takes locative case.", "isTrue": false, "explanation": "\\\"Перед\\\" takes instrumental: \\\"перед дверима.\\\""}, {"statement": "\\\"Між\\\" means \\\"between\\\" and takes instrumental.", "isTrue": true, "explanation": "Correct! \\\"Між нами\\\" (between us)."}, {"statement": "Location after \\\"під\\\" uses instrumental, not locative.", "isTrue": true, "explanation": "Yes! \\\"Під столом\\\" (under the table) uses instrumental."}]`)}
/>
...
<Unjumble
  ...
  items={JSON.parse(`[{"jumbled": "", "answer": "Я йду до школи щодня о восьмій годині"}, {"jumbled": "", "answer": "Кава без цукру і молока будь ласка мені"}, {"jumbled": "", "answer": "Лампа над столом світить яскраво увечері у кімнаті"}, {"jumbled": "", "answer": "Він гуляє з друзями у парку після роботи"}, {"jumbled": "", "answer": "Подарунок для мами лежить на столі у коробці"}, {"jumbled": "", "answer": "Ми йдемо через парк і потім до магазину"}, {"jumbled": "", "answer": "Вони говорять про мене і моїх друзів часто"}, {"jumbled": "", "answer": "Кіт спить під столом бо там тепло завжди"}, {"jumbled": "", "answer": "Стояти перед дверима і чекати на друга довго"}, {"jumbled": "", "answer": "Бути за будинком і не бачити вулиці звідти"}, {"jumbled": "", "answer": "Лист від брата прийшов вчора з Німеччини поштою"}, {"jumbled": "", "answer": "Після роботи ми йдемо до кафе на каву"}]`)}
/>
...
<DialogueReorder
  ...
  lines={JSON.parse(`[{"text": "Вибачте, як дійти до пошти?", "order": 1, "speaker": ""}, {"text": "Йдіть через парк.", "order": 2, "speaker": ""}, {"text": "Дякую!", "order": 3, "speaker": ""}, {"text": "Потім поверніть за будинок.", "order": 4, "speaker": ""}, {"text": "Пошта буде перед вами.", "order": 5, "speaker": ""}, {"text": "Будь ласка!", "order": 6, "speaker": ""}, {"text": "--", "order": 7, "speaker": ""}, {"text": "Де знаходиться банк?", "order": 8, "speaker": ""}, {"text": "Він між аптекою і магазином.", "order": 9, "speaker": ""}, {"text": "Далеко від станції метро?", "order": 10, "speaker": ""}, {"text": "Ні, біля станції.", "order": 11, "speaker": ""}, {"text": "Добре, дякую!", "order": 12, "speaker": ""}, {"text": "Немає за що!", "order": 13, "speaker": ""}]`)}
/>
