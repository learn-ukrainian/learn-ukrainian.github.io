...
<Quiz questions={[
  {
    question: `Я йду в школу. What case is \"школу\"?`,
    options: [
...
<Unjumble items={[
  ...
  { jumbled: `він / гуляє / з / друзями`, answer: `Він гуляє з друзями` },
  { jumbled: `подарунок / для / мами`, answer: `Подарунок для мами` },
  { jumbled: `ми / йдемо / через / парк`, answer: `Ми йдемо через парк` },
  { jumbled: `вони / говорять / про / мене`, answer: `Вони говорять про мене` },
  { jumbled: `кіт / спить / під / столом`, answer: `Кіт спить під столом` },
  { jumbled: `стояти / перед / дверима`, answer: `Стояти перед дверима` },
  { jumbled: `бути / за / будинком`, answer: `Бути за будинком` },
  { jumbled: `лист / від / брата`, answer: `Лист від брата` },
  { jumbled: `після / роботи`, answer: `Після роботи` }
]} />
...
<Cloze
  passage={`Марія живе [___:1] Києві. Вранці вона йде [___:2] роботи. Вона працює [___:3] великому офісі. [___:4] роботи вона йде [___:5] магазину.`}
  blanks={[{ index: 0, answer: `в/у + Loc`, options: [`в/у + Loc`, `на + Acc`, `до + Gen`] }, { index: 1, answer: `на + Loc`, options: [`на + Loc`, `в + Acc`, `до + Gen`] }, { index: 2, answer: `над + Instr`, options: [`над + Instr`, `під + Instr`, `перед + Instr`] }, { index: 3, answer: `під + Instr`, options: [`під + Instr`, `над + Instr`, `за + Instr`] }, { index: 4, answer: `до + Gen`, options: [`до + Gen`, `на + Acc`, `в + Acc`] }]}
/>
