...
<Cloze passage={"Марія живе {в/у + Loc|на + Acc|до + Gen} Києві. Вранці вона йде {на + Loc|в + Acc|до + Gen} роботи. Вона працює {над + Instr|під + Instr|перед + Instr} великому офісі. {під + Instr|над + Instr|за + Instr} роботи вона йде {перед + Instr|за + Instr|між + Instr} магазину. Магазин знаходиться {на + Loc|під + Instr|над + Instr} станції метро.\n---\nВін живе {в/у + Loc|на + Acc|до + Gen} центрі міста. Його квартира {на + Loc|в + Acc|до + Gen} третьому поверсі. Лампа висить {над + Instr|під + Instr|перед + Instr} столом. Кіт спить {під + Instr|над + Instr|за + Instr} ліжком. Стіл стоїть {перед + Instr|за + Instr|між + Instr} вікном. Книги лежать {на + Loc|під + Instr|над + Instr} столі."} blanks={JSON.parse(`[]`)} />

### Asking for Directions

<Cloze passage={"— {Вибачте, як дійти до пошти?|Дякую!|Йдіть через парк.}\n— {Йдіть через парк.|Добре, дякую!|Будь ласка!}\n— {Дякую!|Вибачте, як дійти до пошти?|Де знаходиться банк?}\n— {Потім поверніть за будинок.|Будь ласка!|Добре, дякую!}\n— {Пошта буде перед вами.|Він між аптекою і магазином.|Ні, біля станції.}\n— {Будь ласка!|Дякую!|Далеко від станції метро?}\n— {--|Дякую!|Немає за що!}\n— {Де знаходиться банк?|Будь ласка!|Потім поверніть за будинок.}\n— {Він між аптекою і магазином.|Будь ласка!|Дякую!}\n— {Далеко від станції метро?|Дякую!|Йдіть через парк.}\n— {Ні, біля станції.|Пошта буде перед вами.|Немає за що!}\n— {Добре, дякую!|Будь ласка!|Де знаходиться банк?}\n— {Немає за що!|Далеко від станції метро?|Він між аптекою і магазином.}\n"} blanks={JSON.parse(`[]`)} />

### Find Preposition + Case

<MarkTheWords>
  <MarkTheWordsActivity instruction="" text="Click on preposition + noun combinations.
...
---
Лист *від друга*. Подарунок *для сестри*. Кава *без цукру*. Розмова *про майбутнє*." correctWords={JSON.parse(`["до", "школи", "в", "класі", "на", "столі", "під", "зошитом", "біля", "парку", "з", "собакою", "перед", "телевізором", "до", "магазину", "від", "друга", "для", "сестри", "без", "цукру", "про", "майбутнє"]`)} />
</MarkTheWords>
