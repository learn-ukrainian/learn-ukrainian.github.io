...
<Cloze
  ...
  passage={`Марія живе ___ Києві. Вранці вона йде ___ роботи. Вона працює ___ великому офісі. ___ роботи вона йде ___ магазину. Магазин знаходиться ___ станції метро.
---
Він живе ___ центрі міста. Його квартира ___ третьому поверсі. Лампа висить ___ столом. Кіт спить ___ ліжком. Стіл стоїть ___ вікном. Книги лежать ___ столі.`}
  blanks={JSON.parse(`[{"answer": "в/у + Loc", "options": ["в/у + Loc", "на + Acc", "до + Gen"]}, {"answer": "на + Loc", "options": ["на + Loc", "в + Acc", "до + Gen"]}, {"answer": "над + Instr", "options": ["над + Instr", "під + Instr", "перед + Instr"]}, {"answer": "під + Instr", "options": ["під + Instr", "над + Instr", "за + Instr"]}, {"answer": "перед + Instr", "options": ["перед + Instr", "за + Instr", "між + Instr"]}, {"answer": "на + Loc", "options": ["на + Loc", "під + Instr", "над + Instr"]}, {"answer": "в/у + Loc", "options": ["в/у + Loc", "на + Acc", "до + Gen"]}, {"answer": "на + Loc", "options": ["на + Loc", "в + Acc", "до + Gen"]}, {"answer": "над + Instr", "options": ["над + Instr", "під + Instr", "перед + Instr"]}, {"answer": "під + Instr", "options": ["під + Instr", "над + Instr", "за + Instr"]}, {"answer": "перед + Instr", "options": ["перед + Instr", "за + Instr", "між + Instr"]}, {"answer": "на + Loc", "options": ["на + Loc", "під + Instr", "над + Instr"]}]`)}
/>
...
— ___
`}
  blanks={JSON.parse(`[{"answer": "Вибачте, як дійти до пошти?", "options": ["Вибачте, як дійти до пошти?", "Дякую!", "Йдіть через парк."]}, {"answer": "Йдіть через парк.", "options": ["Йдіть через парк.", "Добре, дякую!", "Будь ласка!"]}, {"answer": "Дякую!", "options": ["Дякую!", "Вибачте, як дійти до пошти?", "Де знаходиться банк?"]}, {"answer": "Потім поверніть за будинок.", "options": ["Потім поверніть за будинок.", "Будь ласка!", "Добре, дякую!"]}, {"answer": "Пошта буде перед вами.", "options": ["Пошта буде перед вами.", "Він між аптекою і магазином.", "Ні, біля станції."]}, {"answer": "Будь ласка!", "options": ["Будь ласка!", "Дякую!", "Далеко від станції метро?"]}, {"answer": "--", "options": ["--", "Дякую!", "Немає за що!"]}, {"answer": "Де знаходиться банк?", "options": ["Де знаходиться банк?", "Будь ласка!", "Потім поверніть за будинок."]}, {"answer": "Він між аптекою і магазином.", "options": ["Він між аптекою і магазином.", "Будь ласка!", "Дякую!"]}, {"answer": "Далеко від станції метро?", "options": ["Далеко від станції метро?", "Дякую!", "Йдіть через парк."]}, {"answer": "Ні, біля станції.", "options": ["Ні, біля станції.", "Пошта буде перед вами.", "Немає за що!"]}, {"answer": "Добре, дякую!", "options": ["Добре, дякую!", "Будь ласка!", "Де знаходиться банк?"]}, {"answer": "Немає за що!", "options": ["Немає за що!", "Далеко від станції метро?", "Він між аптекою і магазином."]}]`)}
/>
...
<HighlightMorphemes>
  ...
  instruction={`Click on preposition + noun combinations.`}
    text={`Він іде до школи. Потім він буде в класі. Книги лежать на столі. Олівець під зошитом.
---
...
Лист від друга. Подарунок для сестри. Кава без цукру. Розмова про майбутнє.`}
    morphemes={[
    { word: `до школи`, morpheme: `до школи`, type: `whole` },
    { word: `в класі`, morpheme: `в класі`, type: `whole` },
    { word: `на столі`, morpheme: `на столі`, type: `whole` },
    { word: `під зошитом`, morpheme: `під зошитом`, type: `whole` },
    { word: `біля парку`, morpheme: `біля парку`, type: `whole` },
    { word: `з собакою`, morpheme: `з собакою`, type: `whole` },
    { word: `перед телевізором`, morpheme: `перед телевізором`, type: `whole` },
    { word: `до магазину`, morpheme: `до магазину`, type: `whole` },
    { word: `від друга`, morpheme: `від друга`, type: `whole` },
    { word: `для сестри`, morpheme: `для сестри`, type: `whole` },
    { word: `без цукру`, morpheme: `без цукру`, type: `whole` },
    { word: `про майбутнє`, morpheme: `про майбутнє`, type: `whole` }
  ]}
  />
</HighlightMorphemes>
