...
<Quiz questions={[
  {
    question: `In the sentence \"Я йду в школу,\" which grammatical case is the word \"школу\" in?`,
    options: [
      { text: `Accusative (motion)`, correct: true },
      { text: `Locative (location)`, correct: false },
      { text: `Genitive`, correct: false },
      { text: `Instrumental`, correct: false }
    ]
  },  {
    question: `In the sentence \"Він у школі,\" which grammatical case is the word \"школі\" in?`,
    options: [
      { text: `Locative (location)`, correct: true },
      { text: `Accusative (motion)`, correct: false },
      { text: `Instrumental`, correct: false },
      { text: `Genitive`, correct: false }
    ]
  },  {
    question: `When someone places a book on a table, as in \"Вона кладе книгу на стіл,\" which case is \"стіл\"?`,
    options: [
      { text: `Accusative (motion)`, correct: true },
      { text: `Locative (location)`, correct: false },
      { text: `Genitive`, correct: false },
    ...
    question: `When a book is already lying on a table, as in \"Книга лежить на столі,\" which case is \"столі\"?`,
    options: [
      { text: `Locative (location)`, correct: true },
      { text: `Accusative (motion)`, correct: false },
      { text: `Instrumental`, correct: false },
    ...
    question: `When a cat runs under a table, as in \"Кіт біжить під стіл,\" which case is \"стіл\"?`,
    options: [
      { text: `Accusative (motion)`, correct: true },
      { text: `Instrumental (location)`, correct: false },
      { text: `Genitive`, correct: false },
      { text: `Locative`, correct: false }
    ]
  },  {
    question: `When a cat is sleeping under a table already, as in \"Кіт спить під столом,\" which case is \"столом\"?`,
    options: [
      { text: `Instrumental (location)`, correct: true },
      { text: `Accusative (motion)`, correct: false },
      { text: `Locative`, correct: false },
      { text: `Genitive`, correct: false }
    ]
  },  {
    question: `When someone goes behind a building for motion, as in \"Вони йдуть за будинок,\" which case is used?`,
    options: [
      { text: `Accusative (motion)`, correct: true },
      { text: `Instrumental (location)`, correct: false },
      { text: `Genitive`, correct: false },
    ...
    question: `When someone is standing behind a building expressing location, as in \"Вони стоять за будинком,\" which case?`,
    options: [
      { text: `Instrumental (location)`, correct: true },
      { text: `Accusative (motion)`, correct: false },
      { text: `Locative`, correct: false },
    ...
    question: `In Ukrainian grammar, which preposition always requires the Genitive case regardless of context?`,
    options: [
    ...
    question: `In Ukrainian grammar, which preposition always requires the Instrumental case regardless of context?`,
    options: [
      { text: `між`, correct: true },
      { text: `до`, correct: false },
      { text: `через`, correct: false },
      { text: `про`, correct: false }
    ]
  },  {
    question: `In Ukrainian, the preposition \"про\" (about) always requires which grammatical case to follow it?`,
    options: [
    ...
    question: `In Ukrainian, the preposition \"для\" (for) always requires which grammatical case to follow it?`,
    options: [
...
<GroupSort groups={{
  "Genitive": ["з = from", "до", "від", "для", "без", "біля"],
  "Accusative": ["про", "через"],
  "Instrumental": ["з = with", "над", "перед", "між"]
}} />

### Preposition Sentences

<Unjumble items={[
  { jumbled: `я / йду / до / школи / щодня / о / восьмій / годині`, answer: `Я йду до школи щодня о восьмій годині` },
  { jumbled: `кава / без / цукру / і / молока / будь / ласка / мені`, answer: `Кава без цукру і молока будь ласка мені` },
  { jumbled: `лампа / над / столом / світить / яскраво / увечері / у / кімнаті`, answer: `Лампа над столом світить яскраво увечері у кімнаті` },
  { jumbled: `він / гуляє / з / друзями / у / парку / після / роботи`, answer: `Він гуляє з друзями у парку після роботи` },
  { jumbled: `подарунок / для / мами / лежить / на / столі / у / коробці`, answer: `Подарунок для мами лежить на столі у коробці` },
  { jumbled: `ми / йдемо / через / парк / і / потім / до / магазину`, answer: `Ми йдемо через парк і потім до магазину` },
  { jumbled: `вони / говорять / про / мене / і / моїх / друзів / часто`, answer: `Вони говорять про мене і моїх друзів часто` },
  { jumbled: `кіт / спить / під / столом / бо / там / тепло / завжди`, answer: `Кіт спить під столом бо там тепло завжди` },
  { jumbled: `стояти / перед / дверима / і / чекати / на / друга / довго`, answer: `Стояти перед дверима і чекати на друга довго` },
  { jumbled: `бути / за / будинком / і / не / бачити / вулиці / звідти`, answer: `Бути за будинком і не бачити вулиці звідти` },
  { jumbled: `лист / від / брата / прийшов / вчора / з / Німеччини / поштою`, answer: `Лист від брата прийшов вчора з Німеччини поштою` },
  { jumbled: `після / роботи / ми / йдемо / до / кафе / на / каву`, answer: `Після роботи ми йдемо до кафе на каву` }
]} />
...
<Cloze
  ...
  blanks={[{ index: 0, answer: `в/у + Loc`, options: [`в/у + Loc`, `на + Acc`, `до + Gen`] }, { index: 1, answer: `на + Loc`, options: [`на + Loc`, `в + Acc`, `до + Gen`] }, { index: 2, answer: `над + Instr`, options: [`над + Instr`, `під + Instr`, `перед + Instr`] }, { index: 3, answer: `під + Instr`, options: [`під + Instr`, `над + Instr`, `за + Instr`] }, { index: 4, answer: `перед + Instr`, options: [`перед + Instr`, `за + Instr`, `між + Instr`] }, { index: 5, answer: `на + Loc`, options: [`на + Loc`, `під + Instr`, `над + Instr`] }]}
/>

### Asking for Directions

<DialogueReorder lines={[
  { text: `Вибачте, як дійти до пошти?`, order: 1 },
  { text: `Йдіть через парк.`, order: 2 },
  { text: `Дякую!`, order: 3 },
  { text: `Потім поверніть за будинок.`, order: 4 },
  { text: `Пошта буде перед вами.`, order: 5 },
  { text: `Будь ласка!`, order: 6 },
  { text: `Де знаходиться банк?`, order: 7 },
  { text: `Він між аптекою і магазином.`, order: 8 },
  { text: `Далеко від станції метро?`, order: 9 },
  { text: `Ні, біля станції.`, order: 10 },
  { text: `Добре, дякую!`, order: 11 },
  { text: `Немає за що!`, order: 12 }
]} />
...
Він іде до школи. Потім він буде в класі. Книги лежать на столі. Олівець під зошитом.`}
  correctWords={[`до школи`, `в класі`, `на столі`, `під зошитом`]}
/>
<MarkTheWordsActivity
  text={`Вона живе біля парку. Гуляє з собакою. Сидить перед телевізором. Після роботи йде до магазину.`}
  correctWords={[`біля парку`, `з собакою`, `перед телевізором`, `до магазину`]}
/>
<MarkTheWordsActivity
  text={`Лист від друга. Подарунок для сестри. Кава без цукру. Розмова про майбутнє.`}
  correctWords={[`від друга`, `для сестри`, `без цукру`, `про майбутнє`]}
/>
</MarkTheWords>
...
<Translate questions={[
  {
    ...
    options: [
      ...
      { text: `Я йду в школу.`, correct: false },
      { text: `Я йду на школу.`, correct: false },
      { text: `Кава без цукру.`, correct: true },
      { text: `Кава з цукру.`, correct: false },
      { text: `Кава від цукру.`, correct: false },
      { text: `Лист від мами.`, correct: true },
      { text: `Лист для мами.`, correct: false },
      { text: `Лист до мами.`, correct: false },
      { text: `Лампа над столом.`, correct: true },
      { text: `Лампа під столом.`, correct: false },
      { text: `Лампа на столі.`, correct: false },
      { text: `Він гуляє з друзями.`, correct: true },
      { text: `Він гуляє до друзів.`, correct: false },
      { text: `Він гуляє від друзів.`, correct: false },
      { text: `Вони говорять про мене.`, correct: true },
      { text: `Вони говорять для мене.`, correct: false },
      { text: `Вони говорять до мене.`, correct: false },
      { text: `Кіт під столом.`, correct: true },
      { text: `Кіт під столі.`, correct: false },
      { text: `Кіт під стіл.`, correct: false },
      { text: `Стояти перед дверима.`, correct: true },
      { text: `Стояти за дверима.`, correct: false },
      { text: `Стояти між дверима.`, correct: false },
      { text: `Після роботи.`, correct: true },
      { text: `До роботи.`, correct: false },
      { text: `Для роботи.`, correct: false },
      { text: `Подарунок для тебе.`, correct: true },
      { text: `Подарунок від тебе.`, correct: false },
      { text: `Подарунок до тебе.`, correct: false },
      { text: `Між нами.`, correct: true },
      { text: `За нами.`, correct: false },
      { text: `Перед нами.`, correct: false },
      { text: `Ми йдемо через парк.`, correct: true },
      { text: `Ми йдемо про парк.`, correct: false },
      { text: `Ми йдемо на парк.`, correct: false }
    ]
  }
]} />
## 📚 Vocabulary
