...
<Cloze passage={"Я {читав|прочитав} книгу дві години. (читав | прочитав) Вона {написала|писала} листа вчора. (писала | написала) Він {намалював|малював} картину. (малював | намалював) — it's finished and hanging on the wall\n\nМи {читаємо|прочитаємо} щодня. (читаємо | прочитаємо) Вона завжди {говорить|скаже} правду. (говорить | скаже) Я вже {прочитав|читав} цю книгу. (читав | прочитав)\n\nЩо ти {робив|зробив} увечері? (робив | зробив) Я {зробив|робив} домашнє завдання! (робив | зробив) — just finished Він довго {говорив|сказав}. (говорив | сказав)\n\nВін {сказав|говорив} \"ні.\" (говорив | сказав) Ми {їхали|приїхали} три години. (їхали | приїхали) Ми нарешті {приїхали|їхали}! (їхали | приїхали)"} blanks={JSON.parse(`[]`)} />
...
<ErrorCorrection>
  <ErrorCorrectionItem sentence="Я ___ книгу три години." errorWord="completed action — but duration = imperfective" correctForm="читав" options={JSON.parse(`["читав", "прочитав"]`)} explanation="Duration (три години) requires imperfective even if context seems &quot;completed.&quot;" />
  <ErrorCorrectionItem sentence="Вона ___ листа." errorWord="just finished" correctForm="написала" options={JSON.parse(`["писала", "написала"]`)} explanation="Just finished = completed result → perfective." />
  <ErrorCorrectionItem sentence="Ми ___ кожен день. (habit)" errorWord="habit" correctForm="читаємо" options={JSON.parse(`["читаємо", "прочитаємо"]`)} explanation="Habitual action → imperfective." />
  <ErrorCorrectionItem sentence="Він ___ &quot;привіт.&quot;" errorWord="single utterance" correctForm="сказав" options={JSON.parse(`["говорив", "сказав"]`)} explanation="Single completed speech act → perfective." />
  <ErrorCorrectionItem sentence="Я ___ її вчора!" errorWord="first time seeing" correctForm="побачив" options={JSON.parse(`["бачив", "побачив"]`)} explanation="Single event with result → perfective." />
  <ErrorCorrectionItem sentence="Вона ___ довго." errorWord="duration emphasis" correctForm="говорила" options={JSON.parse(`["говорила", "сказала"]`)} explanation="Duration → imperfective." />
  <ErrorCorrectionItem sentence="Ти вже ___ домашнє завдання?" errorWord="asking about completion" correctForm="зробив" options={JSON.parse(`["робив", "зробив"]`)} explanation="Question about completed result → perfective." />
  <ErrorCorrectionItem sentence="Я ___ цілий вечір. (whole evening = duration)" errorWord="whole evening" correctForm="працював" options={JSON.parse(`["працював", "попрацював"]`)} explanation="Duration marker (цілий вечір) → imperfective." />
</ErrorCorrection>

### Complete the Story

<Cloze passage={"Учора я {встав|встати|вставати} цілий день. Спочатку я {випив|пити|випити} статтю для роботи. Потім я {з'їв|їсти|з'їсти} кілька листів. Увечері я нарешті {пішов|іти|піти} книгу, яку {працював|працювати|попрацювати} цілий місяць.\n---\nСьогодні вранці я {встав|встати|вставати}. Я {випив|пити|випити} каву і {з'їв|їсти|з'їсти} сніданок. Потім я {пішов|іти|піти} до роботи. На роботі я {працював|працювати|попрацювати} цілий день. Увечері я {прийшов|йти|прийти} додому і {приготував|готувати|приготувати} смачну вечерю."} blanks={JSON.parse(`[]`)} />

### Aspect in Conversation

<Cloze passage={"— {Що ти робив учора?|Скоро напишу!|Ти прочитав її?}\n— {Я читав книгу.|Ні, ще читаю.|Коли закінчиш?}\n— {Ти прочитав її?|Думаю, завтра закінчу.|Що ти робив учора?}\n— {Ні, ще читаю.|Що ти робив учора?|Ти написав листа?}\n— {А коли прочитаєш?|Що ти робив учора?|Ні, ще читаю.}\n— {Думаю, завтра закінчу.|--|Довго ти вже пишеш?}\n— {--|Ні, ще читаю.|Скоро напишу!}\n— {Ти написав листа?|А коли прочитаєш?|Думаю, завтра закінчу.}\n— {Ні, ще пишу.|Коли закінчиш?|Скоро напишу!}\n— {Довго ти вже пишеш?|Ні, ще читаю.|Коли закінчиш?}\n— {Дві години.|Скоро напишу!|Думаю, завтра закінчу.}\n— {Коли закінчиш?|--|А коли прочитаєш?}\n— {Скоро напишу!|--|А коли прочитаєш?}\n"} blanks={JSON.parse(`[]`)} />
