...
<!-- SCOPE
Covers: perfective past tense formation, grammatical agreement, process vs. result distinction, narrative sequencing in the past tense
Not covered:
  - detailed morphology of imperfective verb conjugation
Related: a2-12, a2-14, a2-15, a2-26
-->
...
1. Запитайте себе: «Я просто робив це, чи завершив?» (Ask yourself: 'Was I just doing it, or did I finish it?')
2. Якщо ви просто витрачали час і не хочете говорити про результат: (If you just spent time and don't want to talk about the result:)
   - Дія: Вибирайте недоконаний вид. (Action: Choose the imperfective aspect.)
   - **Example:** **Я писав листа.** (I was writing a letter.)
3. Якщо дія завершена: (If the action is completed:)
...
**Олена:** Привіт, Іване! Як пройшов твій день? (Hi Ivan! How did your day go?) Ти нарешті знайшов той старий і дуже важливий документ? (Did you finally find that old and very important document?)
**Іван:** Привіт, Олено! (Hi Olena!) Так, це була дуже довга і складна історія. (Yes, it was a very long and complex story.) Спочатку я прийшов до нашого архіву дуже рано, о восьмій ранку. (First, I arrived at our archive very early, at eight in the morning.) Потім я довго шукав потрібну папку на полицях. (Then I looked for the necessary folder on the shelves for a long time.)
**Олена:** І ти знайшов її швидко? (And did you find it quickly?)
**Іван:** Ні, не дуже швидко. (No, not very quickly.) Але потім, нарешті, я знайшов її! (But then, finally, I found it!) Але потім я побачив нову проблему. (But then I saw a new problem.) Текст був дуже старий, і я нічого не міг прочитати. (The text was very old, and I could not read anything.) Я зовсім не зрозумів першу сторінку. (I did not understand the first page at all.)
**Олена:** Ого! (Wow!) І що ти зробив потім? (And what did you do then?) Як ти вирішив цю проблему? (How did you solve this problem?)
**Іван:** Потім я взяв спеціальний історичний словник і дуже повільно прочитав кожне слово. (Then I took a special historical dictionary and very slowly read every word.) Це був складний процес. (It was a complex process.) Але нарешті я зрозумів увесь текст! (But finally I understood the whole text!)
**Олена:** Чудово! Це великий успіх. (Wonderful! This is a great success.) Ти вже написав звіт про цей документ? (Have you already written a report about this document?)
**Іван:** Так, звичайно. (Yes, of course.) Спочатку я обережно зробив копію документа, а потім написав детальний звіт для нашого директора. (First I carefully made a copy of the document, and then I wrote a detailed report for our director.) Нарешті я здав усі матеріали і пішов додому відпочивати. (Finally I handed in all the materials and went home to rest.)
**Олена:** Ти молодець! (Good job!) Добре попрацював. (You worked well.)
...
**Уникнення подвійного минулого часу:** (Avoiding the Double Past Tense:)
...
**Виправлення зсуву виду:** (Fixing Aspect Drift:)
Коли ви успішно дочитали книгу, не використовуйте дієслово недоконаного виду. (When you have successfully finished reading a book, do not use the imperfective verb.) Якщо ви хочете сказати комусь, що ви успішно дочитали книгу, не використовуйте дієслово недоконаного виду. (If you want to tell someone you successfully finished reading a book, do not use the imperfective verb.) Не робіть цього тільки тому, що англійською це звичайний минулий час. (Do not do it just because it feels like a simple past tense in English.) Запитайте себе: «Я закінчив це?» Так. (Ask yourself: "Did I finish it?" Yes.)
...
**Історія: Робочий день куратора (The Curator's Workday)**
Сьогодні був дуже продуктивний день у нашому музеї. (Today was a very productive day in our museum.) Спочатку я прийшов на роботу о дев'ятій годині. (First, I arrived at work at nine o'clock.) Потім я пішов до головного залу і побачив, що одна картина висить криво. (Then I went to the main hall and saw that one painting was hanging crookedly.) Я швидко знайшов інструменти і зробив усе правильно. (I quickly found tools and did everything correctly.)
...
**Перевірте себе:**
1. Який суфікс потрібен для жіночого роду в минулому часі?
2. Чому неправильно казати «я був зробив» українською мовою?
3. Який вид ви виберете для цього речення: "I was writing a letter"?
4. Перекладіть: "First he arrived. Then he found the document."
5. Чого нас вчить приказка «Кінець — справі вінець»?

## 🎯 Activities

### Розподіліть за групами: Рід і число

<GroupSort groups={JSON.parse(`{"Чоловічий рід (-в)": ["зробив", "сказав", "написав", "пішов", "знайшов"], "Жіночий рід (-ла)": ["зробила", "сказала", "написала", "пішла", "знайшла"], "Середній рід (-ло)": ["спрацювало", "зникло", "пройшло", "зійшло", "сталося"], "Множина (-ли)": ["зробили", "сказали", "написали", "пішли", "знайшли"]}`)} />

### Знайдіть пару: Процес і результат

<MatchUp pairs={JSON.parse(`[{"left": "робити", "right": "зробити"}, {"left": "писати", "right": "написати"}, {"left": "читати", "right": "прочитати"}, {"left": "йти", "right": "піти"}, {"left": "розуміти", "right": "зрозуміти"}, {"left": "шукати", "right": "знайти"}, {"left": "казати", "right": "сказати"}, {"left": "бачити", "right": "побачити"}]`)} />

### Оберіть правильне закінчення

<FillIn items={JSON.parse(`[{"sentence": "Вчора мій брат ________ додому дуже пізно.", "answer": "пішов", "options": ["пішов", "пішла", "пішли", "пішло"]}, {"sentence": "Марія ________ цікаву книгу про історію.", "answer": "прочитала", "options": ["прочитала", "прочитав", "прочитали", "прочитало"]}, {"sentence": "Студенти нарешті ________ це складне правило.", "answer": "зрозуміли", "options": ["зрозуміли", "зрозумів", "зрозуміла", "зрозуміло"]}, {"sentence": "Сонце ________ сьогодні дуже рано.", "answer": "зійшло", "options": ["зійшло", "зійшов", "зійшла", "зійшли"]}, {"sentence": "Архіваріус ________ важливий історичний документ.", "answer": "знайшов", "options": ["знайшов", "знайшла", "знайшли", "знайшло"]}, {"sentence": "Моя колега ________ правду про цю ситуацію.", "answer": "сказала", "options": ["сказала", "сказав", "сказали", "сказало"]}, {"sentence": "Ми ________ правильний вибір.", "answer": "зробили", "options": ["зробили", "зробив", "зробила", "зробило"]}, {"sentence": "Правило ________ ідеально.", "answer": "спрацювало", "options": ["спрацювало", "спрацював", "спрацювала", "спрацювали"]}]`)} />

### Виправте подвійне минуле

<ErrorCorrection>
  <ErrorCorrectionItem sentence="Я був зробив цю роботу ще вчора." errorWord="був зробив" correctForm="зробив" options={JSON.parse(`["зробив", "робив", "буду робити", "зробили"]`)} explanation="Для завершеної дії достатньо форми 'зробив'. Дієслово 'бути' не потрібне." />
  <ErrorCorrectionItem sentence="Вона була написала звіт до кінця дня." errorWord="була написала" correctForm="написала" options={JSON.parse(`["написала", "написали", "писала", "буде писати"]`)} explanation="Допоміжне дієслово не використовується. Правильно: вона написала." />
  <ErrorCorrectionItem sentence="Студенти були зрозуміли нову тему." errorWord="були зрозуміли" correctForm="зрозуміли" options={JSON.parse(`["зрозуміли", "розуміли", "зрозумів", "будуть розуміти"]`)} explanation="Слово 'зрозуміли' вже означає результат у минулому." />
  <ErrorCorrectionItem sentence="Директор був сказав правду на зустрічі." errorWord="був сказав" correctForm="сказав" options={JSON.parse(`["сказав", "казав", "сказали", "сказала"]`)} explanation="Форма 'сказав' є самостійною і завершеною." />
  <ErrorCorrectionItem sentence="Ми були знайшли старий лист у столі." errorWord="були знайшли" correctForm="знайшли" options={JSON.parse(`["знайшли", "шукали", "знайдемо", "знайшла"]`)} explanation="Зайве слово 'були'. Правильно просто 'знайшли'." />
  <ErrorCorrectionItem sentence="Він був пішов додому раніше." errorWord="був пішов" correctForm="пішов" options={JSON.parse(`["пішов", "йшов", "пішли", "пішла"]`)} explanation="Допоміжне слово не потрібне. Правильно: він пішов." />
</ErrorCorrection>

### Процес чи результат?

<Quiz questions={JSON.parse(`[{"question": "Вчора весь вечір я ______ цікаву статтю, але не закінчив.", "options": [{"text": "читав", "correct": true}, {"text": "прочитав", "correct": false}, {"text": "був читав", "correct": false}, {"text": "прочитали", "correct": false}], "explanation": "Дія не завершена, це був процес. Тому використовуємо недоконаний вид."}, {"question": "Сьогодні вранці я нарешті ______ цю статтю.", "options": [{"text": "прочитав", "correct": true}, {"text": "читав", "correct": false}, {"text": "був прочитав", "correct": false}, {"text": "читаю", "correct": false}], "explanation": "Є результат — дія завершена."}, {"question": "Що ти ______ вчора о п'ятій годині?", "options": [{"text": "робив", "correct": true}, {"text": "зробив", "correct": false}, {"text": "був робив", "correct": false}, {"text": "зробили", "correct": false}], "explanation": "Питання про процес у конкретний момент часу."}, {"question": "Ти вже ______ домашнє завдання?", "options": [{"text": "зробив", "correct": true}, {"text": "робив", "correct": false}, {"text": "був зробив", "correct": false}, {"text": "робиш", "correct": false}], "explanation": "Питання про результат — чи є готове завдання."}, {"question": "Ми довго ______ правильний документ в архіві.", "options": [{"text": "шукали", "correct": true}, {"text": "знайшли", "correct": false}, {"text": "були шукали", "correct": false}, {"text": "знайдемо", "correct": false}], "explanation": "Слово 'довго' вказує на тривалий процес пошуку."}, {"question": "І раптом ми ______ той самий документ!", "options": [{"text": "знайшли", "correct": true}, {"text": "шукали", "correct": false}, {"text": "були знайшли", "correct": false}, {"text": "шукають", "correct": false}], "explanation": "Раптова зміна і успішний результат пошуку."}, {"question": "Вона ______ мені цю історію дві години.", "options": [{"text": "розповідала", "correct": true}, {"text": "сказала", "correct": false}, {"text": "була казала", "correct": false}, {"text": "скаже", "correct": false}], "explanation": "Процес говоріння тривав дві години."}, {"question": "Вона ______ лише одне слово і пішла.", "options": [{"text": "сказала", "correct": true}, {"text": "розповідала", "correct": false}, {"text": "казала", "correct": false}, {"text": "розповіла", "correct": false}], "explanation": "Одноразова, завершена дія."}]`)} />

### Побудуйте розповідь

<Unjumble items={JSON.parse(`[{"jumbled": "Спочатку / до / я / прийшов / архіву", "answer": "Спочатку я прийшов до архіву"}, {"jumbled": "Потім / стару / я / книгу / відкрив", "answer": "Потім я відкрив стару книгу"}, {"jumbled": "я / уважно / текст / прочитав / Потім", "answer": "Потім я уважно прочитав текст"}, {"jumbled": "я / в / знайшов / тексті / помилку / Потім", "answer": "Потім я знайшов помилку в тексті"}, {"jumbled": "я / правильний / зробив / висновок / Нарешті", "answer": "Нарешті я зробив правильний висновок"}, {"jumbled": "ми / роботу / закінчили / Нарешті / успішно", "answer": "Нарешті ми успішно закінчили роботу"}]`)} />

### Слова-маркери у розповіді

<FillIn items={JSON.parse(`[{"sentence": "________ ми зустрілися біля музею, бо це був початок нашого плану.", "answer": "Спочатку", "options": ["Спочатку", "Потім", "Нарешті", "Завжди"]}, {"sentence": "Ми подивилися одну виставку. ________ ми пішли в інший зал.", "answer": "Потім", "options": ["Потім", "Спочатку", "Нарешті", "Ніколи"]}, {"sentence": "Ми гуляли дуже довго і ________ побачили головну картину.", "answer": "нарешті", "options": ["нарешті", "спочатку", "потім", "часто"]}, {"sentence": "________ я не зрозумів ідею, але пізніше все стало ясно.", "answer": "Спочатку", "options": ["Спочатку", "Потім", "Нарешті", "Знову"]}, {"sentence": "Гість прийшов, а ________ почав розповідати цікаву історію.", "answer": "потім", "options": ["потім", "спочатку", "нарешті", "довго"]}, {"sentence": "Після багатьох годин роботи ми ________ знайшли потрібний документ.", "answer": "нарешті", "options": ["нарешті", "спочатку", "потім", "ще"]}, {"sentence": "Щоб зробити каву, ________ потрібно взяти чашку.", "answer": "спочатку", "options": ["спочатку", "потім", "нарешті", "вже"]}, {"sentence": "Він додав воду, а ________ випив напій.", "answer": "потім", "options": ["потім", "спочатку", "нарешті", "зараз"]}]`)} />

### Знайдіть завершені дії

<MarkTheWords>
  <MarkTheWordsActivity instruction="Знайдіть і позначте всі дієслова доконаного виду (результат) у тексті." text="Вчора був складний день. Спочатку я прийшов на роботу дуже рано. Я довго читав старі листи. Потім я знайшов один цікавий факт. Я зрозумів, що це важливо. Я зробив каву. Нарешті я написав звіт і пішов додому." correctWords={JSON.parse(`["прийшов", "знайшов", "зрозумів", "зробив", "написав", "пішов"]`)} />
</MarkTheWords>

### Виправте русизми та помилки вибору виду

<ErrorCorrection>
  <ErrorCorrectionItem sentence="Вона казала мені цю новину вчора ввечері, і я дуже здивувався." errorWord="казала" correctForm="сказала" options={JSON.parse(`["сказала", "розповідала", "була казала", "каже"]`)} explanation="Передача новини — це завершена дія (результат). Потрібно використовувати доконаний вид." />
  <ErrorCorrectionItem sentence="Я кушав яблуко і пішов на роботу." errorWord="кушав" correctForm="з'їв" options={JSON.parse(`["з'їв", "їв", "з'їла", "їм"]`)} explanation="'Кушати' — це русизм, до того ж тут потрібен результат: з'їв." />
  <ErrorCorrectionItem sentence="Ми робили вибір і купили ці квитки." errorWord="робили" correctForm="зробили" options={JSON.parse(`["зробили", "робили", "зробив", "були зробили"]`)} explanation="Вибір — це остаточне рішення. Слід казати 'зробили вибір'." />
  <ErrorCorrectionItem sentence="Після довгої дискусії я нарешті розумів це правило." errorWord="розумів" correctForm="зрозумів" options={JSON.parse(`["зрозумів", "зрозуміла", "був розумів", "знаю"]`)} explanation="Для результату (осяяння, розуміння) використовуємо доконаний вид 'зрозумів'." />
  <ErrorCorrectionItem sentence="Студент брав участь у конференції та отримав диплом." errorWord="брав" correctForm="взяв" options={JSON.parse(`["взяв", "брав", "візьме", "бере"]`)} explanation="Як разова завершена подія краще звучить 'взяв участь'." />
  <ErrorCorrectionItem sentence="Я шукав свої ключі, і раптом я їх шукав у кишені!" errorWord="шукав" correctForm="знайшов" options={JSON.parse(`["знайшов", "шукав", "знайшли", "був знайшов"]`)} explanation="Результат процесу пошуку — це дія 'знайшов'." />
</ErrorCorrection>

### Точність висловлювання

<Quiz questions={JSON.parse(`[{"question": "Ви хочете сказати, що успішно закінчили писати звіт. Яке речення правильне?", "options": [{"text": "Я написав звіт.", "correct": true}, {"text": "Я писав звіт.", "correct": false}, {"text": "Я був написав звіт.", "correct": false}, {"text": "Я пишу звіт.", "correct": false}], "explanation": "Для підтвердження готового результату потрібен доконаний вид."}, {"question": "Як сказати, що ваша сестра успішно дісталася додому?", "options": [{"text": "Вона прийшла додому.", "correct": true}, {"text": "Вона йшла додому.", "correct": false}, {"text": "Вона прийшов додому.", "correct": false}, {"text": "Вона була прийшла.", "correct": false}], "explanation": "Дієслово має узгоджуватися з жіночим родом і передавати результат."}, {"question": "Ви знайшли цікавий факт. Як повідомити про це колегам?", "options": [{"text": "Я знайшов цікавий факт.", "correct": true}, {"text": "Я шукав цікавий факт.", "correct": false}, {"text": "Я робив цікавий факт.", "correct": false}, {"text": "Я був знайшов факт.", "correct": false}], "explanation": "Знаходження — це результат пошуку."}, {"question": "Сонце з'явилося на небі. Як про це сказати?", "options": [{"text": "Сонце зійшло.", "correct": true}, {"text": "Сонце зійшов.", "correct": false}, {"text": "Сонце сходило.", "correct": false}, {"text": "Сонце зійшла.", "correct": false}], "explanation": "Слово 'сонце' — середнього роду, тому закінчення -ло."}, {"question": "Ви хочете почати розповідь про свій ранок. Яке слово краще використати?", "options": [{"text": "Спочатку", "correct": true}, {"text": "Нарешті", "correct": false}, {"text": "Потім", "correct": false}, {"text": "Завжди", "correct": false}], "explanation": "Маркер 'спочатку' вказує на першу дію у послідовності."}, {"question": "Що сказати, коли довгий і важкий проєкт успішно закінчився?", "options": [{"text": "Нарешті ми закінчили роботу.", "correct": true}, {"text": "Спочатку ми закінчили роботу.", "correct": false}, {"text": "Ми були закінчили роботу.", "correct": false}, {"text": "Ми закінчували роботу.", "correct": false}], "explanation": "Маркер 'нарешті' підкреслює фінальний успішний результат."}, {"question": "Як правильно повідомити, що ви зробили помилку в документі?", "options": [{"text": "Я зробив помилку.", "correct": true}, {"text": "Я робив помилку.", "correct": false}, {"text": "Я був зробив помилку.", "correct": false}, {"text": "Я роблю помилку.", "correct": false}], "explanation": "Помилка тут — результат дії, потрібен доконаний вид."}, {"question": "Як сказати, що багато людей покинули кімнату?", "options": [{"text": "Люди пішли геть.", "correct": true}, {"text": "Люди пішов геть.", "correct": false}, {"text": "Люди йшли геть.", "correct": false}, {"text": "Люди були пішли.", "correct": false}], "explanation": "Для множини використовуємо закінчення -ли."}]`)} />

### Дієслова для архіву

<GroupSort groups={JSON.parse(`{"Рух (Motion)": ["пішов", "прийшов", "приїхав", "вийшов", "увійшов"], "Робота з інформацією (Information)": ["сказав", "написав", "прочитав", "зрозумів", "запам'ятав"], "Пошук та результат (Finding/Result)": ["знайшов", "загубив", "побачив", "зробив", "закінчив"]}`)} />

### Формуємо ідеальні речення

<Unjumble items={JSON.parse(`[{"jumbled": "він / правду / сказав / директору / Нарешті", "answer": "Нарешті він сказав правду директору"}, {"jumbled": "час / Я / роботи / для / знайшов / цієї", "answer": "Я знайшов час для цієї роботи"}, {"jumbled": "Разом / ми / зробили / правильний / вибір", "answer": "Разом ми зробили правильний вибір"}, {"jumbled": "Вчора / документ / вона / прочитала / важливий", "answer": "Вчора вона прочитала важливий документ"}, {"jumbled": "Архіваріус / на / проблему / відповідь / дав", "answer": "Архіваріус дав відповідь на проблему"}, {"jumbled": "Всі / текст / студенти / написали / успішно", "answer": "Всі студенти успішно написали текст"}]`)} />
