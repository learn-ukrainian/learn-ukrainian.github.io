...
<!-- SCOPE
Covers: Comparative adjectives (synthetic and analytic forms), irregular comparatives, consonant alternations, structures with ніж and за.
Not covered:
  - Superlative adjectives (the best, the tallest) → a2-19
Related: a2-17, a2-19, a2-20, a2-24
-->
...
<GroupSort groups={JSON.parse(`{"Регулярні (суфікс -іш-)": ["тепліший", "новіший", "холодніший", "смачніший"], "Винятки та зміни приголосних": ["кращий", "більший", "дорожчий", "ближчий"]}`)} />
