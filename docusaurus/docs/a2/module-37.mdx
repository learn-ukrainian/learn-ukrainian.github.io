...
:::warning
Myth: "Ukrainian vocabulary is small."
...
<FillIn>
  <FillInQuestion
    sentence={`1. Я хочу ___ цей текст. [Hint: Rewrite "писати"]`}
    answer={`переписати`}
...
<FillIn>
  <FillInQuestion
    sentence={`1. Цей текст поганий. Треба його ___. [Hint: Rewrite]`}
    answer={`переписати`}
    options={[`переписати`, `дописати`, `записати`]}
  />
  <FillInQuestion
...
<Quiz>
  <QuizQuestion
    question={`1. "Доробити" means to:`}
    options={[`Finish doing`, `Redo`, `Do a little`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Почитати" means to:`}
    options={[`Read a little bit`, `Finish reading`, `Reread`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Підписати" implies putting your name:`}
    options={[`Under the text`, `Over the text`, `Inside the text`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Переробити" implies the first attempt was:`}
    options={[`Bad or wrong`, `Perfect`, `Non-existent`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Наробити" usually implies:`}
    options={[`A large quantity`, `A small quantity`, `A specific quality`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Відкрити" relates to which preposition logic?`}
    options={[`Від: Away`, `До: To`, `В: In`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Здати" (to betray) literally means:`}
    options={[`To give up/away`, `To give in`, `To give under`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Наїстися" means:`}
    options={[`To eat until full`, `To eat a little`, `To start eating`]}
    correctIndex={0}
    explanation={``}
  />
</Quiz>
...
<ErrorCorrection>
  <ErrorCorrectionItem
    sentence={`1. Я хочу **переписати** це яблуко. (Context: eat finishes it)`}
    error={`переписати`}
    answer={`доїсти`}
...
<Unjumble>
  <UnjumbleQuestion
    words={`документ / він / підписав`}
    answer={`Він підписав документ.`}
  />
  <UnjumbleQuestion
    words={`звіт / ми / переробили`}
    answer={`Ми переробили звіт.`}
  />
  <UnjumbleQuestion
    words={`двері / секретар / відкрив`}
    answer={`Секретар відкрив двері.`}
  />
  <UnjumbleQuestion
    words={`картку / банк / видав`}
    answer={`Банк видав картку.`}
  />
  <UnjumbleQuestion
    words={`книгу / я / дочитав`}
    answer={`Я дочитав книгу.`}
  />
  <UnjumbleQuestion
    words={`інтернет / ми / під'єднали`}
