...
Студент [___:8]дихнув з полегшенням.`}
  blanks={[{ index: 0, answer: `увій`, options: [`увій`, `зай`] }, { index: 1, answer: `ви`, options: [`ви`] }, { index: 2, answer: `по`, options: [`по`] }, { index: 3, answer: `пере`, options: [`пере`] }, { index: 4, answer: `до`, options: [`до`] }, { index: 5, answer: `з`, options: [`з`] }, { index: 6, answer: `пере`, options: [`пере`] }, { index: 7, answer: `зіт`, options: [`зіт`] }]}
/>
