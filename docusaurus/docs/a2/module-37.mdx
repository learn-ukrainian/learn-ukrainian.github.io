...
<FillIn items={[
  {
    sentence: `Цей текст поганий. Треба його ___.`,
    answer: `переписати`,
    options: [`переписати`, `дописати`, `записати`]
  },  {
    sentence: `Я не ___ книгу, вона нудна.`,
    answer: `дочитав`,
    options: [`дочитав`, `перечитав`, `почитав`]
  },  {
    sentence: `Будь ласка, ___ двері. Холодно.`,
    answer: `закрий`,
    options: [`закрий`, `відкрий`, `розкрий`]
  },  {
    sentence: `Я хочу ___ твій номер телефону.`,
    answer: `записати`,
    options: [`записати`, `підписати`, `написати`]
  },  {
    sentence: `Де тут можна ___ документи?`,
    answer: `підписати`,
    options: [`підписати`, `описати`, `виписати`]
  },  {
    sentence: `Мама попросила ___ посуд.`,
    answer: `перемити`,
    options: [`перемити`, `домити`, `замити`]
  },  {
    sentence: `Треба ___ роботу до вечора.`,
    answer: `доробити`,
    options: [`доробити`, `переробити`, `зробити`]
  },  {
    sentence: `Він ___ двері ключем.`,
    answer: `відкрив`,
...
<Quiz questions={[
  {
    question: `Яке значення має дієслово \"доробити\" в українській мові?`,
    options: [
      { text: `Finish doing (завершити дію)`, correct: true },
      { text: `Redo (переробити знову)`, correct: false },
      { text: `Do a little (трохи зробити)`, correct: false },
      { text: `Start doing (почати робити)`, correct: false }
    ]
  },  {
    question: `Що означає дієслово \"почитати\" з префіксом \"по-\" в контексті?`,
    options: [
      { text: `Read a little bit (трохи почитати)`, correct: true },
      { text: `Finish reading (дочитати до кінця)`, correct: false },
      { text: `Reread (перечитати знову)`, correct: false },
      { text: `Start reading (почати читати)`, correct: false }
    ]
  },  {
    question: `Де саме ви ставите свій підпис коли \"підписуєте\" документ?`,
    options: [
      { text: `Under the text (під текстом)`, correct: true },
      { text: `Over the text (над текстом)`, correct: false },
      { text: `Inside the text (всередині тексту)`, correct: false },
      { text: `Next to the text (поруч з текстом)`, correct: false }
    ]
  },  {
    question: `Якою була перша спроба якщо ви вирішили щось \"переробити\"?`,
    options: [
      { text: `Bad or wrong (погана або неправильна)`, correct: true },
      { text: `Perfect (ідеальна і бездоганна)`, correct: false },
      { text: `Non-existent (її не було взагалі)`, correct: false },
      { text: `Good enough (достатньо хороша)`, correct: false }
    ]
  },  {
    question: `Яку кількість зазвичай означає дієслово \"наробити\" з префіксом \"на-\"?`,
    options: [
      { text: `A large quantity (велика кількість)`, correct: true },
      { text: `A small quantity (мала кількість)`, correct: false },
      { text: `A specific quality (певна якість)`, correct: false },
      { text: `Medium amount (середня кількість)`, correct: false }
    ]
  },  {
    question: `З якою логікою прийменника пов'язане дієслово \"відкрити\" в українській?`,
    options: [
      { text: `Від: Away (віддалення, відкриття)`, correct: true },
      { text: `До: To (наближення до мети)`, correct: false },
      { text: `В: In (входження всередину)`, correct: false },
      { text: `На: On (розміщення на поверхні)`, correct: false }
    ]
  },  {
    question: `Яке буквальне значення має дієслово \"здати\" в контексті зради?`,
    options: [
      { text: `To give up/away (віддати геть)`, correct: true },
      { text: `To give in (піддатися тиску)`, correct: false },
      { text: `To give under (віддати під щось)`, correct: false },
      { text: `To give back (повернути назад)`, correct: false }
    ]
  },  {
    question: `Що означає дієслово \"наїстися\" з префіксом \"на-\" для їжі?`,
    options: [
      { text: `To eat until full (наїстися досхочу)`, correct: true },
      { text: `To eat a little (трохи поїсти)`, correct: false },
      { text: `To start eating (почати їсти)`, correct: false },
      { text: `To eat again (поїсти знову)`, correct: false }
    ]
  }
]} />
...
Вони були дуже раді і вирішили [___:12]святкувати його успіх.`}
  blanks={[{ index: 0, answer: `увій`, options: [`увій`, `зай`] }, { index: 1, answer: `ви`, options: [`ви`] }, { index: 2, answer: `по`, options: [`по`] }, { index: 3, answer: `пере`, options: [`пере`] }, { index: 4, answer: `до`, options: [`до`] }, { index: 5, answer: `з`, options: [`з`] }, { index: 6, answer: `пере`, options: [`пере`] }, { index: 7, answer: `зіт`, options: [`зіт`] }, { index: 8, answer: `ви`, options: [`ви`] }, { index: 9, answer: `по`, options: [`по`] }, { index: 10, answer: `роз`, options: [`роз`] }, { index: 11, answer: `від`, options: [`від`] }]}
/>
...
<Unjumble items={[
  { jumbled: `документ / він / підписав / вчора / ввечері / в / офісі / дуже / швидко`, answer: `Він підписав документ вчора ввечері в офісі дуже швидко` },
  { jumbled: `звіт / ми / переробили / сьогодні / вранці / бо / він / був / поганий`, answer: `Ми переробили звіт сьогодні вранці бо він був поганий` },
  { jumbled: `двері / секретар / відкрив / ключем / коли / прийшов / на / роботу / рано`, answer: `Секретар відкрив двері ключем коли прийшов на роботу рано` },
  { jumbled: `картку / банк / видав / мені / нову / після / того / як / я / подав / заяву`, answer: `Банк видав мені нову картку після того як я подав заяву` },
  { jumbled: `книгу / я / дочитав / нарешті / вчора / ввечері / після / довгого / часу / читання`, answer: `Я дочитав книгу нарешті вчора ввечері після довгого часу читання` },
  { jumbled: `інтернет / ми / під'єднали / сьогодні / вранці / в / новому / офісі / успішно`, answer: `Ми під'єднали інтернет сьогодні вранці в новому офісі успішно` }
]} />
## 📚 Vocabulary
