...
<FillIn>
  <FillInQuestion
    sentence={`1. читати → прочитати: ___`}
    answer={`про- prefix`}
...
<Quiz>
  <QuizQuestion
    question={`1. Which prefix means "through/completion"?`}
    options={[`про-`, `на-`, `по-`]}
    correctIndex={0}
    explanation={``}
  />
  ...
  <QuizQuestion
    ...
    options={[`Suppletive pairs (different roots)`, `Prefixed pairs`, `Suffixed pairs`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`What's the perfective of "давати"?`}
    options={[`дати (remove -ва-)`, `давив`, `подавати`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`What's the perfective of "вчити"?`}
    options={[`вивчити (ви- prefix)`, `провчити`, `вчивати`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`Prefix "з-" becomes "с-" before:`}
    options={[`Voiceless consonants`, `Vowels`, `All consonants`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Показувати" is:`}
    options={[`Imperfective (-ува-)`, `Perfective`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`Adding different prefixes to одне verb creates:`}
    options={[`Different verbs with different meanings`, `The same verb with same meaning`, `Only aspect change`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Ви-" often means:`}
    options={[`Out, mastery, completion`, `In, beginning`, `Under`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`Number of suppletive pairs is:`}
    options={[`Small, must memorize`, `Large`, `Zero`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`When you see a prefixed verb, assume:`}
    options={[`It's probably perfective`, `It's probably imperfective`, `You can't tell`]}
    correctIndex={0}
    explanation={``}
  />
</Quiz>
...
<Unjumble>
  <UnjumbleQuestion
    words={`про / читати / = / прочитати`}
    answer={`Про- + читати = прочитати.`}
  />
  <UnjumbleQuestion
    words={`на / писати / = / написати`}
    answer={`На- + писати = написати.`}
  />
  <UnjumbleQuestion
    words={`з / робити / = / зробити`}
    answer={`З- + робити = зробити.`}
  />
  <UnjumbleQuestion
    words={`давати / мінус / -ва- / = / дати`}
    answer={`Давати мінус -ва- = дати.`}
  />
  <UnjumbleQuestion
    words={`говорити / сказати / різні / корені`}
    answer={`Говорити і сказати — різні корені.`}
  />
  <UnjumbleQuestion
    words={`по / бачити / = / побачити`}
    answer={`По- + бачити = побачити.`}
  />
  <UnjumbleQuestion
    words={`ви / вчити / = / вивчити`}
    answer={`Ви- + вчити = вивчити.`}
  />
  <UnjumbleQuestion
    words={`вставати / встати / -ва- / видалення`}
    answer={`Вставати → встати: -ва- видалення.`}
  />
  <UnjumbleQuestion
    words={`брати / взяти / суплетивна / пара`}
    answer={`Брати/взяти — суплетивна пара.`}
  />
  <UnjumbleQuestion
    words={`з'їсти / їсти / з- / префікс`}
    answer={`Їсти + з- префікс = з'їсти.`}
  />
  <UnjumbleQuestion
    words={`відпочивати / відпочити / -ва-`}
    answer={`Відпочивати → відпочити: -ва- removal.`}
  />
  <UnjumbleQuestion
    words={`показувати / показати / -ува-`}
...
<DialogueReorder>
  ...
  {
    "speaker": "",
    "line": "Як утворити доконаний вид від \"читати\"?"
  },
  {
    "speaker": "",
    "line": "Додай префікс \"про-\" і отримаєш \"прочитати.\""
  },
  {
    "speaker": "",
    "line": "А від \"давати\"?"
  ...
  {
    "speaker": "",
    "line": "Тут інакше — видали суфікс \"-ва-\" і отримаєш \"дати.\""
  },
  {
    "speaker": "",
    "line": "А \"говорити\"?"
  ...
  {
    "speaker": "",
    "line": "Це суплетивна пара — доконаний вид \"сказати\" має інший корінь!"
  },
  {
    "speaker": "",
    "line": "Чому \"написати\" і \"переписати\" різні?"
  },
  {
    "speaker": "",
    "line": "Бо різні префікси додають різні значення."
  },
  {
    "speaker": "",
    "line": "Яке значення \"пере-\"?"
  },
  {
    "speaker": "",
    "line": "\"Пере-\" означає \"знову\" або \"через.\""
  },
  {
    "speaker": "",
    "line": "Отже, \"переписати\" — написати знову?"
  },
  {
    "speaker": "",
    "line": "Так, точно!"
...
<MarkTheWords>
  <MarkTheWordsActivity
    text={`Я прочитав книгу. Потім я написав рецензію. Він сказав правду. Вона довго говорила. Ми вивчили урок. Вона встала рано. Він давав книгу, а потім дав. Вони побачили море! Він почув шум. Я взяв книгу і пішов.`}
    correctWords={[`прочитав`, `написав`, `сказав`, `вивчили`, `встала`, `дав`, `побачили`, `почув`, `взяв`, `пішов`]}
  />
</MarkTheWords>
...
<Translate>
  ...
  />
  <TranslateItem
    source={`She gave the book. (completed)`}
    answer={`Вона дала книгу.`}
    options={[`Вона дала книгу.`, `Вона давала книгу.`]}
    explanation={``}
  />
  <TranslateItem
    source={`He said the truth.`}
    answer={`Він сказав правду.`}
    options={[`Він сказав правду.`, `Він говорив правду.`]}
    explanation={``}
  />
  <TranslateItem
    source={`I learned the lesson. (mastered)`}
    answer={`Я вивчив урок.`}
    options={[`Я вивчив урок.`, `Я вчив урок.`]}
    explanation={``}
  />
  <TranslateItem
    source={`She stood up.`}
    answer={`Вона встала.`}
    options={[`Вона встала.`, `Вона вставала.`]}
    explanation={``}
  />
  <TranslateItem
    source={`He took the book.`}
    answer={`Він узяв книгу.`}
    options={[`Він узяв книгу.`, `Він брав книгу.`]}
    explanation={``}
  />
  <TranslateItem
    source={`We saw the sea!`}
    answer={`Ми побачили море!`}
    options={[`Ми побачили море!`, `Ми бачили море!`]}
    explanation={``}
  />
  <TranslateItem
    source={`She rested. (completed)`}
    answer={`Вона відпочила.`}
    options={[`Вона відпочила.`, `Вона відпочивала.`]}
    explanation={``}
  />
  <TranslateItem
    source={`He showed the photo.`}
    answer={`Він показав фото.`}
    options={[`Він показав фото.`, `Він показував фото.`]}
    explanation={``}
  />
  <TranslateItem
    source={`They heard the news.`}
    answer={`Вони почули новини.`}
    options={[`Вони почули новини.`, `Вони чули новини.`]}
    explanation={``}
  />
  <TranslateItem
    source={`I ate it all.`}
    answer={`Я з'їв усе.`}
    options={[`Я з'їв усе.`, `Я їв усе.`]}
    explanation={``}
  />
  <TranslateItem
    source={`She drank the coffee.`}
    answer={`Вона випила каву.`}
    options={[`Вона випила каву.`, `Вона пила каву.`]}
    explanation={``}
  />
</Translate>
