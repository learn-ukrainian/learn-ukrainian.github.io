...
<GroupSort groups={JSON.parse(`{"Рух всередину (В-)": ["входити", "увійти", "в'їжджати", "в'їхати", "вхід"], "Рух назовні (Ви-)": ["виходити", "вийти", "виїжджати", "виїхати", "вихід"]}`)} />

### Знайдіть граматичну пару

<MatchUp pairs={JSON.parse(`[{"left": "входити", "right": "увійти (результат)"}, {"left": "виходити", "right": "вийти (результат)"}, {"left": "в'їжджати", "right": "в'їхати (результат)"}, {"left": "виїжджати", "right": "виїхати (результат)"}, {"left": "вхід", "right": "місце, де ми заходимо"}, {"left": "вихід", "right": "місце, де ми залишаємо приміщення"}, {"left": "входити в моду", "right": "ставати популярним"}, {"left": "виходити заміж", "right": "ставати дружиною"}]`)} />
