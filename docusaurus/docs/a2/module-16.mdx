...
<Quiz questions={[
  {
    ...
    question: `\"Я **читав**, коли ти подзвонив.\"`,
    options: [
      { text: `Доконаний`, correct: false },
      { text: `Недоконаний`, correct: true }
    ]
  },  {
    question: `\"Я **читаю** щодня.\"`,
    options: [
      { text: `Доконаний`, correct: false },
      { text: `Недоконаний`, correct: true }
    ]
  },  {
    question: `\"Вона **написала** листа.\"`,
    options: [
      { text: `Доконаний`, correct: true },
      { text: `Недоконаний`, correct: false }
    ]
  },  {
    question: `\"Ми **зробимо** це завтра.\"`,
    options: [
      { text: `Доконаний`, correct: true },
      { text: `Недоконаний`, correct: false }
    ]
  },  {
    question: `\"Я **буду читати** ввечері.\"`,
    options: [
      { text: `Доконаний`, correct: false },
      { text: `Недоконаний`, correct: true }
    ]
  },  {
    question: `\"Ти **закінчив**?\"`,
    options: [
      { text: `Доконаний`, correct: true },
      { text: `Недоконаний`, correct: false }
    ]
  },  {
    question: `\"Він **вчиться** щодня.\"`,
    options: [
      { text: `Доконаний`, correct: false },
      { text: `Недоконаний`, correct: true }
    ]
