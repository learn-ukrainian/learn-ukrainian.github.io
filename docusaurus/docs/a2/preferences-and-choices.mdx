...
<!-- SCOPE
Covers: Expressing likes, dislikes, and preferences using Dative experiencer constructions and comparatives.
Not covered:
  - Unreal Conditionals with "б/би" (full theory) → module a2-22
Related: a2-22, a2-24
-->
...
<GroupSort groups={JSON.parse(`{"З дієсловом ПОДОБАЄТЬСЯ (Давальний)": ["мені", "тобі", "йому", "їй", "нам", "вам", "їм", "студентові"], "З дієсловом ЛЮБИТЬ або ЛЮБЛЮ (Називний)": ["я", "ти", "він", "вона", "ми", "ви", "вони", "студент"]}`)} />
