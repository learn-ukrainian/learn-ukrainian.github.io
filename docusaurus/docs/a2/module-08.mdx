...
<GroupSort groups={{
  "Genitive (Кого? Чого?)": ["для", "без", "від", "після", "крім", "замість", "до"],
  "Accusative (Кого? Що?)": ["через", "про", "на"],
  "Instrumental (Ким? Чим?)": ["з", "над"],
...
<FillIn items={[
  {
    sentence: `Кава [___] цукру, будь ласка.`,
    answer: `без`,
    options: [`без`, `для`, `з`]
  },  {
    sentence: `Це подарунок [___] тебе.`,
    answer: `для`,
    options: [`для`, `від`, `про`]
  },  {
    sentence: `Ми говорили [___] тебе.`,
    answer: `про`,
    options: [`про`, `через`, `для`]
  },  {
    sentence: `[___] дощ я залишився вдома.`,
    answer: `Через`,
    ...
    sentence: `Кава [___] молоком.`,
    answer: `з`,
    options: [`з`, `без`, `для`]
  },  {
    sentence: `Зустрінемось [___] третій.`,
    answer: `о`,
    options: [`о`, `після`, `для`]
  },  {
    sentence: `Всі прийшли, [___] Олега.`,
    answer: `крім`,
...
<Quiz questions={[
  {
    question: `In Ukrainian grammar, which grammatical case does the preposition \"для\" (for) always require?`,
    options: [
    ...
    question: `When someone says \"Через дощ ми залишилися вдома,\" what does \"через\" express here?`,
    options: [
      { text: `Because of rain`, correct: true },
      { text: `Through the rain`, correct: false },
      { text: `About rain`, correct: false },
      { text: `Without rain`, correct: false }
    ]
  },  {
    question: `When you receive \"Лист від мами,\" what does the preposition \"від\" indicate in this context?`,
    options: [
      { text: `From mom (source)`, correct: true },
      { text: `For mom (benefit)`, correct: false },
      { text: `With mom (accompaniment)`, correct: false },
      { text: `About mom (topic)`, correct: false }
    ]
  },  {
    question: `When expressing the topic of a conversation in Ukrainian, which preposition correctly means \"about\"?`,
    options: [
    ...
    question: `When ordering \"Кава без цукру\" at a café, what does \"без\" express in this phrase?`,
    options: [
      { text: `Without sugar`, correct: true },
      { text: `With sugar`, correct: false },
      { text: `For sugar`, correct: false },
      { text: `Instead of sugar`, correct: false }
    ]
  },  {
    question: `When arranging to meet \"О третій годині,\" what does the preposition \"о\" indicate here?`,
    options: [
      { text: `Time (at 3 o'clock)`, correct: true },
      { text: `Place (at the third)`, correct: false },
      { text: `Person (about the third)`, correct: false },
      { text: `Duration (for 3 hours)`, correct: false }
    ]
  },  {
    question: `When someone orders \"Чай замість кави,\" what does the preposition \"замість\" express here?`,
    options: [
      { text: `Instead of tea`, correct: true },
      { text: `About tea`, correct: false },
      { text: `Without tea`, correct: false },
      { text: `After tea`, correct: false }
    ]
  },  {
    question: `In Ukrainian, which preposition always requires the Instrumental case to follow it?`,
    options: [
      { text: `з`, correct: true },
      { text: `для`, correct: false },
      { text: `про`, correct: false },
      { text: `без`, correct: false }
    ]
  }
]} />
...
<Unjumble items={[
  { jumbled: `цукру / Кава / без / і / молока / будь / ласка / мені`, answer: `Кава без цукру і молока будь ласка мені` },
  { jumbled: `тебе / Це / для / я / купив / подарунок / у / магазині`, answer: `Це подарунок для тебе я купив у магазині` },
  { jumbled: `мами / Лист / від / прийшов / вчора / з / села / нашого`, answer: `Лист від мами прийшов вчора з нашого села` },
  { jumbled: `дощ / залишився / Через / я / вдома / і / читав / книгу`, answer: `Через дощ я залишився вдома і читав книгу` },
  { jumbled: `про / говорили / Ми / тебе / і / твою / нову / роботу`, answer: `Ми говорили про тебе і твою нову роботу` },
  { jumbled: `молоком / Кава / з / і / цукром / будь / ласка / мені`, answer: `Кава з молоком і цукром будь ласка мені` },
  { jumbled: `третій / о / Зустрінемось / годині / біля / входу / в / метро`, answer: `Зустрінемось о третій годині біля входу в метро` },
  { jumbled: `кави / Чай / замість / будь / ласка / і / з / лимоном`, answer: `Чай замість кави будь ласка і з лимоном` }
]} />
