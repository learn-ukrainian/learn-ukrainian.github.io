...
<FillIn>
  <FillInQuestion
    sentence={`1. У мене ___ голова. (Hurts sing.)`}
    answer={`болить`}
...
<Quiz>
  <QuizQuestion
    question={`1. If you have "нежить", you have:`}
    options={[`A runny nose`, `A broken leg`, `A headache`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"У мене болить живіт" means:`}
    options={[`My stomach hurts`, `My life hurts`, `I am hungry`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`Where do you buy medicine?`}
    options={[`В аптеці`, `В лікарні (Usually receive treatment, buy in pharmacy)`, `В бібліотеці`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`What is 36.6?`}
    options={[`Normal temperature`, `High fever`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Видужуйте" means:`}
    options={[`Get well soon`, `Good bye`, `Pay here`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Хворіти" implies:`}
    options={[`To be ill (process)`, `To hurt (pain)`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`Can you say "Я болю голову"?`}
    options={[`No, incorrect.`, `Yes, correct.`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Що вас турбує?" involves which grammar case for "you"?`}
    options={[`Accusative (вас)`, `Dative (вам)`]}
    correctIndex={0}
    explanation={``}
  />
</Quiz>
...
<Unjumble>
  <UnjumbleQuestion
    words={`що / турбує / вас / сьогодні`}
    answer={`Що вас турбує сьогодні?`}
  />
  <UnjumbleQuestion
    words={`у / болить / мене / дуже / голова`}
    answer={`У мене дуже болить голова.`}
  />
  <UnjumbleQuestion
    words={`таблетку / прийміть / цю / їжі / після`}
    answer={`Прийміть цю таблетку після їжі.`}
  />
  <UnjumbleQuestion
    words={`лікаря / мені / викликати / треба`}
    answer={`Мені треба викликати лікаря.`}
  />
  <UnjumbleQuestion
    words={`купив / я / в / ліки / аптеці`}
    answer={`Я купив ліки в аптеці.`}
  />
  <UnjumbleQuestion
    words={`бажаю / вам / здоров'я / міцного`}
...
<DialogueReorder>
  ...
  {
    "speaker": "",
    "line": "Мій чоловік впав. У нього болить серце."
  },
  {
    "speaker": "",
    "line": "Де ви знаходитесь?"
  },
  {
    "speaker": "",
    "line": "Вулиця Шевченка, 10."
  },
  {
    "speaker": "",
    "line": "Скільки йому років?"
  },
  {
    "speaker": "",
    "line": "П'ятдесят."
...
<MarkTheWords>
  <MarkTheWordsActivity
    text={`У мене температура і кашель. Я йду до лікаря. Мені треба купити ліки. Моє здоров'я важливе. Аптека за рогом. Я люблю спорт(incorrect). Це мій кіт(incorrect). Сонце світить(incorrect).`}
    correctWords={[`температура`, `кашель`, `лікаря`, `ліки`, `здоров'я`, `Аптека`, `спорт`, `мій кіт`, `світить`]}
  />
</MarkTheWords>
...
<ErrorCorrection>
  <ErrorCorrectionItem
    sentence={`1. Я **болю** голова. (Grammar)`}
    error={`Я болю`}
...
<Translate>
  <TranslateItem
    source={`1. My head hurts.`}
    answer={`У мене болить голова.`}
    options={[`У мене болить голова.`, `Я болю голову.`]}
    explanation={``}
  />
  <TranslateItem
    source={`I have a fever.`}
    answer={`У мене температура.`}
    options={[`У мене температура.`, `Я є температура.`]}
    explanation={``}
  />
  <TranslateItem
    source={`I need a doctor.`}
    answer={`Мені потрібен лікар.`}
    options={[`Мені потрібен лікар.`, `Я треба лікар.`]}
    explanation={``}
  />
  <TranslateItem
    source={`Where is the pharmacy?`}
    answer={`Де аптека?`}
    options={[`Де аптека?`, `Де лікар?`]}
    explanation={``}
  />
  <TranslateItem
    source={`Get well soon!`}
    answer={`Видужуйте!`}
    options={[`Видужуйте!`, `Хворійте!`]}
    explanation={``}
  />
  <TranslateItem
    source={`I am sick.`}
    answer={`Я хворий / Я хворію.`}
    options={[`Я хворий / Я хворію.`, `У мене хворий.`]}
    explanation={``}
  />
</Translate>
