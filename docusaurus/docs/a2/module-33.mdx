...
<Quiz questions={[
  {
    question: `Якщо у вас є \"нежить\" то що це означає в українській мові для симптомів?`,
    options: [
      { text: `A runny nose (нежить це нежить)`, correct: true },
      { text: `A broken leg (зламана нога)`, correct: false },
      { text: `A headache (головний біль)`, correct: false },
      { text: `A fever (температура)`, correct: false }
    ]
  },  {
    question: `Що означає фраза \"у мене болить живіт\" в українській мові правильно?`,
    options: [
      { text: `My stomach hurts (мій живіт болить)`, correct: true },
      { text: `My life hurts (моє життя болить)`, correct: false },
      { text: `I am hungry (я голодний)`, correct: false },
      { text: `I am tired (я втомлений)`, correct: false }
    ]
  },  {
    question: `Де можна купити ліки в Україні зазвичай для лікування?`,
    options: [
      { text: `В аптеці (в аптеці)`, correct: true },
      { text: `В лікарні (в лікарні)`, correct: false },
      { text: `В бібліотеці (в бібліотеці)`, correct: false },
      { text: `В магазині (в магазині)`, correct: false }
    ]
  },  {
    question: `Яка нормальна температура тіла в Україні згідно з медичними стандартами?`,
    options: [
      { text: `Normal temperature (36.6°C нормальна)`, correct: true },
      { text: `High fever (38.0°C висока)`, correct: false },
      { text: `Low temperature (35.0°C низька)`, correct: false },
      { text: `Critical (40.0°C критична)`, correct: false }
    ]
  },  {
    question: `Що означає слово \"видужуйте\" в українській мові для побажання?`,
    options: [
      { text: `Get well soon (одужуйте швидко)`, correct: true },
      { text: `Good bye (до побачення)`, correct: false },
      { text: `Pay here (платіть тут)`, correct: false },
      { text: `Thank you (дякую)`, correct: false }
    ]
  },  {
    question: `Що означає дієслово \"хворіти\" в українській мові для стану здоров'я?`,
    options: [
      { text: `To be ill process (бути хворим процес)`, correct: true },
      { text: `To hurt pain (боліти біль)`, correct: false },
      { text: `To heal (лікувати)`, correct: false },
      { text: `To recover (одужувати)`, correct: false }
    ]
  },  {
    question: `Чи можна сказати \"я болю голову\" в українській мові правильно граматично?`,
    options: [
      { text: `No incorrect (ні неправильно)`, correct: true },
      { text: `Yes correct (так правильно)`, correct: false },
      { text: `Sometimes (іноді)`, correct: false },
      { text: `Only formal (тільки офіційно)`, correct: false }
    ]
  },  {
    question: `Який відмінок використовується в питанні \"що вас турбує\" для слова \"вас\"?`,
    options: [
...
<Unjumble items={[
  { jumbled: `що / вас / турбує / сьогодні / дуже / зранку / вже`, answer: `Що вас турбує сьогодні дуже зранку вже` },
  { jumbled: `у / мене / дуже / болить / голова / сильно / зараз / вже`, answer: `У мене дуже болить голова сильно зараз вже` },
  { jumbled: `цю / таблетку / прийміть / після / їжі / завжди / тричі / на / день`, answer: `Прийміть цю таблетку після їжі завжди тричі на день` },
  { jumbled: `мені / лікаря / викликати / треба / зараз / дуже / швидко / будь / ласка`, answer: `Мені треба викликати лікаря зараз дуже швидко будь ласка` },
  { jumbled: `я / ліки / купив / в / аптеці / вчора / ввечері / пізно`, answer: `Я купив ліки в аптеці вчора ввечері пізно` },
  { jumbled: `вам / бажаю / міцного / здоров'я / завжди / від / щирого / серця`, answer: `Бажаю вам міцного здоров'я завжди від щирого серця` }
]} />
