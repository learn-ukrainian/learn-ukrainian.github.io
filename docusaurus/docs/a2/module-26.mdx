...
Тепер я працюю багато, [___:6] я щасливий.`}
  blanks={[{ index: 0, answer: `тому що`, options: [`тому що`] }, { index: 1, answer: `Хоча`, options: [`Хоча`] }, { index: 2, answer: `зате`, options: [`зате`] }, { index: 3, answer: `Незважаючи на те що`, options: [`Незважаючи на те що`] }, { index: 4, answer: `завдяки`, options: [`завдяки`] }, { index: 5, answer: `проте`, options: [`проте`] }]}
/>
