...
<Quiz questions={[
  {
    ...
    options: [
      { text: `Abstract nouns`, correct: true },
    ...
    options: [
      { text: `Walk/go`, correct: true },
      { text: `Write`, correct: false },
      { text: `See`, correct: false }
    ]
  },  {
    question: `Root \"пис-\" means:`,
    options: [
    ...
    question: `\"Перехід\" is formed from:`,
    options: [
    ...
    question: `\"Український\" uses suffix:`,
    options: [
...
<Unjumble items={[
  { jumbled: `вхід = в- (у) + хід (ходити)`, answer: `вхід = вхід` },
  { jumbled: `вихід = ви- (з) + хід (ходити)`, answer: `вихід = вихід` },
  { jumbled: `читання = чита- (читати) + -ння (дія)`, answer: `читання = читання` },
  { jumbled: `читач = чита- (читати) + -ач (особа)`, answer: `читач = читач` },
  { jumbled: `важливість = важлив- (важливий) + -ість (якість)`, answer: `важливість = важливість` },
  { jumbled: `український = Україн- (Україна) + -ський (прикметник)`, answer: `український = український` }
]} />
