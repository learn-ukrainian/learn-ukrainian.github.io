...
Це життя, про [___:7] я мріяв.`}
  blanks={[{ index: 0, answer: `який`, options: [`який`] }, { index: 1, answer: `який`, options: [`який`] }, { index: 2, answer: `у якій`, options: [`у якій`] }, { index: 3, answer: `де`, options: [`де`] }, { index: 4, answer: `який`, options: [`який`] }, { index: 5, answer: `які`, options: [`які`] }, { index: 6, answer: `яке`, options: [`яке`] }]}
/>
