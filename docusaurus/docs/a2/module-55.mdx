...
<Quiz questions={[
  {
    ...
    question: `\"Працювати лікарем\" uses:`,
    options: [
    ...
    question: `\"У мене болить голова\" — голова is:`,
    options: [
    ...
    question: `\"Заплатити карткою\" — карткою is:`,
    options: [
...
Я вже купив [___:7] на поїзд.`}
  blanks={[{ index: 0, answer: `прокидаюся`, options: [`прокидаюся`, `засинаю`, `сплю`] }, { index: 1, answer: `снідаю`, options: [`снідаю`, `вечеряю`, `сплю`] }, { index: 2, answer: `менеджером`, options: [`менеджером`, `менеджер`, `менеджера`] }, { index: 3, answer: `голова`, options: [`голова`, `голову`, `голові`] }, { index: 4, answer: `лікаря`, options: [`лікаря`, `лікарем`, `лікар`] }, { index: 5, answer: `подорож`, options: [`подорож`, `роботу`, `аптеку`] }, { index: 6, answer: `квитки`, options: [`квитки`, `квиток`, `квитку`] }]}
/>
...
<Unjumble items={[
  { jumbled: `прокидаюся | я | Вранці | о | 7:00`, answer: `Вранці я прокидаюся о 7:00` },
  { jumbled: `програмістом | Він | працює`, answer: `Він працює програмістом` },
  { jumbled: `голова | У | болить | мене`, answer: `У мене болить голова` },
  { jumbled: `карткою | Можна | заплатити`, answer: `Можна заплатити карткою` },
  { jumbled: `університеті | вчиться | в | Вона`, answer: `Вона вчиться в університеті` },
  { jumbled: `де | аптека | тут | Де`, answer: `Де тут аптека` }
]} />
