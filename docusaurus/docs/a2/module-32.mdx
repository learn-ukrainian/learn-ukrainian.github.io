...
<ErrorCorrection>
  ...
  />
  <ErrorCorrectionItem
    sentence={`Подзвони мені після вийти.`}
    errorWord={`після`}
  ...
  />
  <ErrorCorrectionItem
    sentence={`Я чекав, як тільки вона прийшла.`}
    errorWord={`як тільки`}
    correctForm={`поки`}
  ...
  />
  <ErrorCorrectionItem
    sentence={`Поки я прийшов, вона вже пішла.`}
    errorWord={`Поки`}
    correctForm={`Коли`}
    options={[`Коли`, `Поки`]}
  ...
  />
  <ErrorCorrectionItem
    sentence={`Тим часом я їв, вона пила.`}
    errorWord={`Тим часом`}
