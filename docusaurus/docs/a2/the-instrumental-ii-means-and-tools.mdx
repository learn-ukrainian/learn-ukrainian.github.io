...
<!-- SCOPE
Covers: Instrumental case without prepositions for means, tools, and transport modes.
Not covered:
  - Professions in Instrumental → a2-06
Related: a2-04, a2-07
-->
...
<GroupSort groups={JSON.parse(`{"Закінчення -ом": ["автобус", "літак", "тролейбус", "поїзд"], "Закінчення -ем / -єм": ["трамвай", "автомобіль"], "Незмінювані": ["метро", "таксі"]}`)} />
