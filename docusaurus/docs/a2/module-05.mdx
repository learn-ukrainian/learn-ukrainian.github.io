...
:::tip
Метро і Таксі — Indeclinable Nouns
...
:::info
Ножиці — Plural Only (Pluralia Tantum)
...
:::tip
Телефоном vs. По телефону — Both Are Correct
...
:::info
У бібліотеці в Одесі — Library Etiquette
...
:::tip
Маршрутка — The Ukrainian Minibus
...
:::info
Подорож до Карпат — Travel Story
...
<FillIn>
  <FillInQuestion
    sentence={`1. Ми їдемо в аеропорт ___.`}
    answer={`таксі`}
...
<Quiz>
  <QuizQuestion
    question={`1. Як сказати "by bus"?`}
    options={[`з автобусом`, `автобусом`, `на автобус`]}
    correctIndex={1}
    explanation={``}
  />
  <QuizQuestion
    question={`Яке речення правильне?`}
    options={[`Я пишу ручкою.`, `Я пишу з ручкою.`, `Я пишу ручка.`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`Коли використовуємо орудний БЕЗ прийменника?`}
    options={[`Для засобу пересування та інструментів`, `Для супроводу (з ким?)`, `Для місця (де?)`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`Як сказати "with a knife"?`}
    options={[`ножем`, `з ножем`, `ножа`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`Яке речення правильне?`}
    options={[`Він говорить тихим голосом.`, `Він говорить з тихим голосом.`, `Він говорить тихий голос.`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`Як сказати "by train"?`}
    options={[`поїздом`, `з поїздом`, `на поїзд`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Метро" в орудному відмінку...`}
    options={[`не змінюється`, `стає "метром"`, `стає "метрою"`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`Як сказати "with eyes"?`}
    options={[`очима`, `очами`, `з очами`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`Яке речення правильне?`}
    options={[`Вона ріже хліб ножем.`, `Вона ріже хліб з ножем.`, `Вона ріже хліб ніж.`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`Як сказати "by email"?`}
    options={[`електронною поштою`, `з електронною поштою`, `електронна пошта`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Ножиці" в орудному відмінку...`}
    options={[`ножицями`, `ножицею`, `ножицям`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`Як сказати "in a whisper"?`}
    options={[`пошепки`, `з пошепки`, `пошепкою`]}
    correctIndex={0}
    explanation={``}
  />
</Quiz>
...
<Unjumble>
  <UnjumbleQuestion
    words={`вона / їде / до / центру / трамваєм`}
    answer={`Вона їде до центру трамваєм.`}
  />
  <UnjumbleQuestion
    words={`вона / пише / листа / ручкою`}
    answer={`Вона пише листа ручкою.`}
  />
  <UnjumbleQuestion
    words={`він / ріже / хліб / ножем`}
    answer={`Він ріже хліб ножем.`}
  />
  <UnjumbleQuestion
    words={`ми / їмо / суп / ложкою`}
    answer={`Ми їмо суп ложкою.`}
  />
  <UnjumbleQuestion
    words={`вона / летить / до / Парижа / літаком`}
    answer={`Вона летить до Парижа літаком.`}
  />
  <UnjumbleQuestion
    words={`він / говорить / тихим / голосом`}
...
<ErrorCorrection>
  <ErrorCorrectionItem
    sentence={`1. Я їду на роботу з автобусом.`}
    error={`з автобусом`}
    answer={`автобусом`}
...
<Cloze>
  <ClozePassage
    text={`Вранці я йду на зупинку і їду [___:1] на роботу. На роботі працюю [___:2] цілий день. Пишу листи [___:3] і надсилаю їх [___:4]. Увечері їду додому [___:5] — це швидше.`}
    blanks={[
  {
    "index": 0,
    "options": [
...
<DialogueReorder>
  ...
  {
    "speaker": "",
    "line": "Добрий день! Як дістатися до центру?"
  },
  {
    "speaker": "",
    "line": "Автобусом швидше, але метро зручніше."
  },
  {
    "speaker": "",
    "line": "Можна їхати автобусом або метро."
  },
  {
    "speaker": "",
    "line": "А що швидше?"
  ...
  {
    "speaker": "",
    "line": "Тоді поїду метро. Дякую!"
  },
  {
    "speaker": "",
    "line": "Звичайно. Дай мені ніж."
  },
  {
    "speaker": "",
    "line": "Ось. Тепер ріжу ножем."
  },
  {
    "speaker": "",
    "line": "Чим ти ріжеш помідори?"
  },
  {
    "speaker": "",
    "line": "Можеш нарізати сир ножем?"
  },
  {
    "speaker": "",
    "line": "Ручкою! Жартую. Ножем, звичайно."
  },
  {
    "speaker": "",
    "line": "Готово! Тепер можемо їсти!"
  }
]} />
</DialogueReorder>
...
<MarkTheWords>
  <MarkTheWordsActivity
    text={`Я їду на роботу автобусом. Вона пише листа ручкою. Ми живемо з батьками. Він ріже хліб ножем. Кава з молоком смачна. Вона летить літаком до Парижа. Він розмовляє з другом. Я працюю комп'ютером. Діти грають з котом. Вона махає рукою. Ми їмо суп ложкою. Він гуляє з собакою. Вона говорить тихим голосом. Я їду поїздом. Він живе з братом.`}
    correctWords={[`автобусом`, `ручкою`, `ножем`, `літаком`, `комп'ютером`, `рукою`, `ложкою`, `голосом`, `поїздом`]}
  />
</MarkTheWords>
...
<Translate>
  <TranslateItem
    ...
    answer={`Вони їдуть до Львова поїздом.`}
    options={[`Вони їдуть до Львова з поїздом.`, `Вони їдуть до Львова поїздом.`, `Вони їдуть до Львова поїзд.`]}
    explanation={``}
  />
  <TranslateItem
    source={`She writes with a pen.`}
    answer={`Вона пише ручкою.`}
    options={[`Вона пише з ручкою.`, `Вона пише ручкою.`, `Вона пише ручка.`]}
    explanation={``}
  />
  <TranslateItem
    source={`He cuts bread with a knife.`}
    answer={`Він ріже хліб ножем.`}
    options={[`Він ріже хліб ножем.`, `Він ріже хліб з ножем.`, `Він ріже хліб ніж.`]}
    explanation={``}
  />
  <TranslateItem
    source={`We eat soup with a spoon.`}
    answer={`Ми їмо суп ложкою.`}
    options={[`Ми їмо суп ложкою.`, `Ми їмо суп з ложкою.`, `Ми їмо суп ложка.`]}
    explanation={``}
  />
  <TranslateItem
    source={`She flies to Paris by plane.`}
    answer={`Вона летить до Парижа літаком.`}
    options={[`Вона летить до Парижа літаком.`, `Вона летить до Парижа з літаком.`, `Вона летить до Парижа літак.`]}
    explanation={``}
  />
  <TranslateItem
    source={`He speaks in a quiet voice.`}
    answer={`Він говорить тихим голосом.`}
    options={[`Він говорить тихим голосом.`, `Він говорить з тихим голосом.`, `Він говорить тихий голос.`]}
    explanation={``}
  />
  <TranslateItem
    source={`I work with a computer every day.`}
    answer={`Я працюю комп'ютером щодня.`}
    options={[`Я працюю комп'ютером щодня.`, `Я працюю з комп'ютером щодня.`, `Я працюю комп'ютер щодня.`]}
    explanation={``}
  />
  <TranslateItem
    source={`Children draw with a pencil.`}
    answer={`Діти малюють олівцем.`}
    options={[`Діти малюють олівцем.`, `Діти малюють з олівцем.`, `Діти малюють олівець.`]}
    explanation={``}
  />
  <TranslateItem
    source={`She waves with her hand.`}
    answer={`Вона махає рукою.`}
    options={[`Вона махає рукою.`, `Вона махає з рукою.`, `Вона махає рука.`]}
    explanation={``}
  />
  <TranslateItem
    source={`We go downtown by tram.`}
    answer={`Ми їдемо в центр трамваєм.`}
    options={[`Ми їдемо в центр трамваєм.`, `Ми їдемо в центр з трамваєм.`, `Ми їдемо в центр трамвай.`]}
    explanation={``}
  />
  <TranslateItem
    source={`I send documents by email.`}
    answer={`Я надсилаю документи електронною поштою.`}
    options={[`Я надсилаю документи електронною поштою.`, `Я надсилаю документи з електронною поштою.`, `Я надсилаю документи електронна пошта.`]}
    explanation={``}
  />
  <TranslateItem
    source={`She nods with her head.`}
    answer={`Вона киває головою.`}
    options={[`Вона киває головою.`, `Вона киває з головою.`, `Вона киває голова.`]}
    explanation={``}
  />
</Translate>
