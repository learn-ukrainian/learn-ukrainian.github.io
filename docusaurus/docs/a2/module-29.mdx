...
Я [___:6], що зустріну друга. Це [___:7], що ми друзі.`}
  blanks={[{ index: 0, answer: `сумно`, options: [`сумно`] }, { index: 1, answer: `боявся`, options: [`боявся`] }, { index: 2, answer: `почуваюся`, options: [`почуваюся`] }, { index: 3, answer: `весело`, options: [`весело`] }, { index: 4, answer: `обожнюю`, options: [`обожнюю`] }, { index: 5, answer: `сподіваюся`, options: [`сподіваюся`] }, { index: 6, answer: `добре`, options: [`добре`] }]}
/>
