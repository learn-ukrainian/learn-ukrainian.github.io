...
*Choose the correct verb form for each context.*


<FillIn>
  <FillInQuestion
    sentence={`1. Він ___ книгу вчора. (finished reading)`}
    answer={`прочитав`}
...
<Quiz>
  <QuizQuestion
    question={`1. "Я прочитав книгу" focuses on:`}
    options={[`Completed result`, `Ongoing process`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Я читав книгу" focuses on:`}
    options={[`Process`, `Completed result`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`Which word signals perfective past?`}
    options={[`вже — already`, `довго (for a long time)`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
  ...
  <QuizQuestion
    ...
    options={[`The same for both aspects`, `Different for each aspect`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
  ...
  <QuizQuestion
    ...
    options={[`Imperfective (asking about activities)`, `Perfective`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Ти зробив це?" uses:`}
    options={[`Perfective (asking about completion)`, `Imperfective`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Піти" past masculine:`}
    options={[`пішов`, `пів`, `пишов`]}
    correctIndex={0}
    explanation={``}
  />
  <QuizQuestion
    question={`"Прийти" past masculine:`}
    options={[`прийшов`, `прийв`, `прив`]}
    correctIndex={0}
    explanation={``}
  />
</Quiz>
...
<Unjumble>
  ...
  />
  <UnjumbleQuestion
    words={`вона / писала / три / години`}
    answer={`Вона писала три години.`}
  />
  <UnjumbleQuestion
    words={`я / вже / зробив / це`}
  ...
  />
  <UnjumbleQuestion
    words={`він / сказав / правду`}
    answer={`Він сказав правду.`}
  />
  <UnjumbleQuestion
    words={`вона / довго / говорила`}
    answer={`Вона довго говорила.`}
  />
  <UnjumbleQuestion
    words={`ти / прочитав / статтю`}
    answer={`Ти прочитав статтю?`}
  />
  <UnjumbleQuestion
    words={`він / пішов / додому`}
    answer={`Він пішов додому.`}
  />
  <UnjumbleQuestion
    words={`вона / побачила / море`}
    answer={`Вона побачила море.`}
  />
  <UnjumbleQuestion
    words={`ми / закінчили / роботу`}
    answer={`Ми закінчили роботу.`}
  />
  <UnjumbleQuestion
    words={`він / раптом / почув / шум`}
...
*Select the correct aspect for each context.*


<ErrorCorrection>
  <ErrorCorrectionItem
    sentence={`1. Він ___ книгу весь вечір. (duration)`}
    error={`duration`}
    answer={`читав`}
    options={[`читав`, `прочитав`]}
...
<DialogueReorder>
  ...
  {
    "speaker": "",
    "line": "Я працював цілий день."
  },
  {
    "speaker": "",
    "line": "Ти закінчив проект?"
  },
  {
    "speaker": "",
    "line": "Так, нарешті закінчив!"
  },
  {
    "speaker": "",
    "line": "А що робила Оля?"
  },
  {
    "speaker": "",
    "line": "Вона теж працювала, але не закінчила."
  },
  {
    "speaker": "",
    "line": "Ти прочитав книгу?"
  },
  {
    "speaker": "",
    "line": "Ні, я читав, але не закінчив."
  },
  {
    "speaker": "",
    "line": "Скільки часу ти читав?"
  },
  {
    "speaker": "",
    "line": "Дві години."
  ...
  {
    "speaker": "",
    "line": "А коли закінчиш?"
  },
  {
    "speaker": "",
    "line": "Думаю, сьогодні прочитаю."
  }
]} />
</DialogueReorder>
...
<MarkTheWords>
  <MarkTheWordsActivity
    text={`Учора я прочитав книгу. Потім я написав листа. Я довго писав, але нарешті закінчив. Вона сказала правду. Ми почули шум. Він взяв книгу і пішов. Він працював цілий день. Потім він закінчив і пішов додому. Вдома він відпочив.`}
    correctWords={[`прочитав`, `написав`, `закінчив`, `сказала`, `почули`, `взяв`, `пішов`, `закінчив`, `пішов`, `відпочив`]}
  />
</MarkTheWords>
...
<Translate>
  <TranslateItem
    ...
    answer={`Він прочитав книгу.`}
    options={[`Він прочитав книгу.`, `Він читав книгу.`]}
    explanation={``}
  />
  <TranslateItem
  ...
  />
  <TranslateItem
    source={`I already did this!`}
    answer={`Я вже зробив це!`}
    options={[`Я вже зробив це!`, `Я вже робив це!`]}
    explanation={``}
  />
  <TranslateItem
    source={`We finally arrived.`}
    answer={`Ми нарешті приїхали.`}
  ...
  <TranslateItem
    ...
    options={[`Він сказав "так."`, `Він говорив "так."`]}
    explanation={``}
  />
  <TranslateItem
    source={`She was speaking loudly.`}
    answer={`Вона голосно говорила.`}
    options={[`Вона голосно говорила.`, `Вона голосно сказала.`]}
    explanation={``}
  />
  <TranslateItem
    source={`They saw the movie.`}
    answer={`Вони побачили фільм.`}
    options={[`Вони побачили фільм.`, `Вони бачили фільм.`]}
    explanation={``}
  />
  <TranslateItem
    source={`I was working all day.`}
    answer={`Я працював цілий день.`}
    options={[`Я працював цілий день.`, `Я попрацював цілий день.`]}
    explanation={``}
  />
  <TranslateItem
    source={`He took the book and left.`}
    answer={`Він взяв книгу і пішов.`}
    options={[`Він взяв книгу і пішов.`, `Він брав книгу і йшов.`]}
    explanation={``}
  />
  <TranslateItem
    source={`She heard the news.`}
    answer={`Вона почула новини.`}
    options={[`Вона почула новини.`, `Вона чула новини.`]}
    explanation={``}
  />
  <TranslateItem
    source={`What were you doing yesterday?`}
    answer={`Що ти робив учора?`}
    options={[`Що ти робив учора?`, `Що ти зробив учора?`]}
    explanation={``}
  />
  <TranslateItem
    source={`Did you finish? (asking about completion)`}
    answer={`Ти закінчив?`}
    options={[`Ти закінчив?`, `Ти закінчував?`]}
    explanation={``}
  />
</Translate>
