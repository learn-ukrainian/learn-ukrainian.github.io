...
- **Orchestrator seats (fleet-comms stream #5512 / #4707)** — any of these may own a cold-start /
  ...
  | --- | --- | --- | --- |
  | **claude** | `claude-opus-5-5` @ high (operator 2026-09-22; launcher pins `claude-opus-5-5[1m]`) | **`gpt-6-astra` @ xhigh** | Escalation is CROSS-FAMILY: Claude is a target, not an escalator. Fable 5.1 stays the advisor / authority seat and is summoned for judgment, not seated as driver (see § Orchestration operating pattern). Other formal-review lanes may explicitly select Fable at the sealed participant's fixed `high` effort, or select Astra at the Codex ACP provider default — pick by CodexBar headroom |
...
| **codex** Astra (1–4 drivers) | novel/hard impl; Astra bounded with scope ceiling | **throttle mechanical when near_cap / paused**; return-at resumes rotation; shed to Cursor Auto / Flash / AGY / k3-256k / GLM |
...
| Code & infrastructure review | Kimi K3 · GLM-5.3 · Astra | Historical Terra review arcs on #5896/#5925/#5926/#5931 (defect-finding record) |
