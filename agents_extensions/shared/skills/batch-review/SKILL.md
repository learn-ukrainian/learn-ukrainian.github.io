---
name: batch-review
description: Review prompt engineering and content across a module range using parallel reviewers; aggregate shared findings.
...
Follow the analysis framework from the prompt-review skill prompt (in `agents_extensions/shared/skills/prompt-review/prompt-review-prompt.md`). Produce the full prompt-review report.
...
Follow the content review prompt (in `agents_extensions/shared/skills/content-review/content-review-prompt.md`). Use RAG tools for linguistic verification:
...
| Missing context injection | YES | `agents_extensions/shared/phases/gemini/*.md` templates |
| Immersion variety issues | YES | `agents_extensions/shared/phases/gemini/beginner-content.md` |
