...
> **⚠️ READ FIRST: `agents_extensions/shared/NON-NEGOTIABLE-RULES.md`**
>
...
Read: `agents_extensions/shared/stages/stage-4-review-fix.md`
...
**Reference:** See Section 9 in `agents_extensions/shared/stages/stage-4-review-fix.md` for detailed criteria.
