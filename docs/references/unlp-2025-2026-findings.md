...
| [How Far Can Prompting Go for Minimal-Edit Ukrainian GEC?](https://aclanthology.org/2026.unlp-1.13/) (Karpo & Chernodub) | 2026 | Gemini 3.1-Pro F0.5=69.22 ≈ 90% of fine-tuned SOTA; **minimal-edit prompts IN UKRAINIAN beat English prompts**. | eval-harness #4913 | Planned as a Ukrainian-language, minimal-edit prompt-design constraint for a later reviewer/fixer change. | Documented; deferred until a dedicated eval-harness #4913 child implementation issue and a resolvable reviewer-prompt consumer exist (#4913 is the stream epic, not a child). |
