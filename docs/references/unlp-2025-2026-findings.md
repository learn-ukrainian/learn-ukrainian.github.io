...
| [Automated CEFR-Level Assignment for Ukrainian Texts](https://aclanthology.org/2026.unlp-1.18/) (Kanishcheva) | 2026 | Textbook-derived A1–B2 difficulty classifier; explicit-linguistic-feature RF (F1 .576) beats XLM-R and GPT-5.5 — deterministic features win. | core-quality #4274; implementation #4952 | Phase 1 deterministic, interpretable, advisory feature extraction. | Phase 1 merged in #4952 (advisory, uncalibrated `scripts/audit/text_difficulty.py`); calibration and gating deferred. |
| [Gold-Standard Benchmark for Ukrainian Proficiency in LLMs](https://aclanthology.org/2026.unlp-1.12/) (Galeshchuk) | 2026 | Linguist-built grammar/orthography benchmark; LLM ceiling 59.6% — hard evidence for verify-against-VESUM doctrine; complementary axis to our tool-grounded factuality. | Active stream owner to be assigned (#4913 closed) | Adopted as evidence for grammar/orthography evaluation and VESUM verification. | Reference retained; implementation needs a new stream-owned issue. |
| [How Far Can Prompting Go for Minimal-Edit Ukrainian GEC?](https://aclanthology.org/2026.unlp-1.13/) (Karpo & Chernodub) | 2026 | Gemini 3.1-Pro F0.5=69.22 ≈ 90% of fine-tuned SOTA; **minimal-edit prompts IN UKRAINIAN beat English prompts**. | Active stream owner to be assigned (#4913 closed) | Planned as a Ukrainian-language, minimal-edit prompt-design constraint for a later reviewer/fixer change. | Documented; deferred until a dedicated issue under an active stream and a resolvable reviewer-prompt consumer exist. |
...
| [OmniGEC](https://aclanthology.org/2025.unlp-1.17/) (Kovalchuk) | 2025 | Silver multilingual GEC data incl. Ukrainian. | Active stream owner to be assigned (#4913 closed) | Positioning/reference only. | Deferred pending a separately scoped, user-approved contribution/outreach issue. |
...
| [UAlign](https://aclanthology.org/2025.unlp-1.4/) (Kravchenko) | 2025 | Public UA/EN parallel alignment benchmark (moral/ethical); UA-vs-EN alignment gap measured. | Active stream owner to be assigned (#4913 closed) | Not adopted for current corpus use; retained as an evaluation-adjacency reference. | Deferred after sensitive-content and fit review. |
