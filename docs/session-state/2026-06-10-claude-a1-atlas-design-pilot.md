...
5. ⏳ Word Atlas redesign to POC (B) — `docs/poc/word-atlas/README.md`, 14 sections, teal/yellow
...
5. **Word Atlas redesign (B)** to `docs/poc/word-atlas/README.md` + enrichment (Goroh/Wiktionary etymology).
...
- **POC design files:** `docs/poc/poc-lesson-design.html` (A1 lessons, blue/yellow, full component CSS read this session), `docs/poc/word-atlas/README.md` (Word Atlas, teal/yellow, 14 sections), `poc-folk-lesson-design.html`, `poc-lit-lesson-design.html`, `poc-site-design.html`.
