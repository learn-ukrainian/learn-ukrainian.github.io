...
**Critique:** `full-rebuild-b2-hist` has the excellent "Sensory Historian" persona. This should be universal, especially for C1-BIO and LIT.
**Recommendation:**
