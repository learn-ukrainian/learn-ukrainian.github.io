...
| open-model-data | #6321 (successor to closed #6164 and #6056) | Build evidence-bearing prepared Ukrainian data products on the completed Foundry engine. Community usefulness is primary; adoption is secondary evidence, not a gate. Every shipped artifact names a concrete consumer decision/use case. Current truth: 1,028 admitted Wikipedia CPT rows, zero eligible correction/preference/filter rows, and 739,503 protected or unresolved silver records. The invalid Gemma run authorizes no retry. |
...
| open-model-data | ACTIVE | Close completed Phase 2 #6327, then execute #6333: an evidence-graded clean-Ukrainian correction/protection pack under epic #6321. | Every released case has an evidence-attributed correction/protection/unresolved disposition and traceable lexical, corpus, and source evidence; valid historical, dialectal, regional, quoted, and contact-language forms remain protected or unresolved; only qualified-human adjudication can support gold/authoritative labels. |
