...
| open-model-data | ACTIVE | Close Phase 2 #6327 after its complete 189,150-row rights-gated complement receipt, then execute the authoritative clean-Ukrainian correction/protection phase under successor epic #6321. | Every released correction/protection case carries traceable lexical, corpus, and source evidence; valid historical, dialectal, regional, quoted, and contact-language forms remain protected or unresolved; model proposals are never reported as human gold. |
