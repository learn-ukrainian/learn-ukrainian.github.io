...
| 22 | Position 1 pilot: pack, word store, plan, plan review, measurement, canary, lessons, recap, review, LU QA sweep (#8425) | §5 of this file (the runbook) | 01–16 (07a, 07b), 20, 21, 24 | driver + language lanes; LU QA observer after the Pages GO | `/a1/sounds-letters-and-hello/` built, gates green, module verdict APPROVE, settle items counted, LU QA sweep triaged |
