...
**D3 — Two blocks go beyond the Standard's B1, each with its evidence.**
...
| The passive system; impersonal sentences; diminutives as a system; text-structuring parentheticals (`по-перше`) as a system | **not in B1** — B2 owns them | — | B2 `:3414`, `:3466`, `:3478` |
