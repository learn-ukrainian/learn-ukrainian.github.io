...
> **Status (2026-07-22):** Implementation sub-issue **[#5608](https://github.com/learn-ukrainian/learn-ukrainian.github.io/issues/5608)** active. Delivered **[PR #5610](https://github.com/learn-ukrainian/learn-ukrainian.github.io/pull/5610)** (`compile_evalset.py` & `taxonomy.yaml`) and **[PR #5612](https://github.com/learn-ukrainian/learn-ukrainian.github.io/pull/5612)** (`vps_dialect_ingest_standalone.py` & dialect catalog doc). VPS host `46.225.212.209` verified & deployed. Publication target: **UNLP 2027**.
