...
additive `0.1.1` freeze, including the SHA-256 hashes of all 44 artifacts
...
Both commands use immutable writers: an existing byte-identical result is
accepted, while any different output is rejected.
