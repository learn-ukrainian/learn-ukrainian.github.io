...
* **Phase 3 (PR #7925, #8004, #8025):**
  ...
  - Pilot assembly: 6,000 SFT + 3,000 DPO packaged and released on Hugging Face (since withdrawn and made private on 2026-09-25) as exploratory pilot canary v0.1 at [`krisztiankoos/uldr-v0.1-pilot`](https://huggingface.co/datasets/krisztiankoos/uldr-v0.1-pilot) (Production release v1.0 scheduled for Phase 5.5).
