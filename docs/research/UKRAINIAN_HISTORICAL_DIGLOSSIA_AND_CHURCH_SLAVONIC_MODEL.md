...
* **Total Database Records (Entire Population):** **4,157** records (complete current public API of the University of Gothenburg Saint Sophia Portal, `https://saintsophia.dh.gu.se/`, matching [`data/historical_language_corpus_denominator.yaml`](../../registry/historical_language_corpus_denominator.yaml)).
