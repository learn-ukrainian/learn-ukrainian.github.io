...
правозахисному русі має самостійний документальний контур. Музейна довідка ХПГ
описує його як учасника дисидентського руху, пов’язаного з поширенням самвидаву,
літературною критикою і київським середовищем шістдесятників [ХПГ]. Це не
...
року він повернувся до Києва [НБУВ]. Музейна довідка ХПГ окремо повідомляє,
що в січні 1978 року в лікарні зони ВС-389/35 брудним шприцом йому занесли
хворобу Боткіна [ХПГ]. Це атрибутоване джерельне свідчення про конкретний
механізм зараження, а не незалежний судово-медичний висновок про всі хвороби.
Разом джерела дозволяють назвати інституційний характер шкоди — арешт, вирок,
табір, заслання й наслідки для здоров’я — без приписування кожного епізоду
одній неназваній посадовій особі.
...
вийшла 1990 року за даними НБУВ. Музейна довідка ХПГ реєструє «У мене —
тільки слово» (1994), а в записі «З живучого племені Дон Кіхотів» (2008)
називає Надію Світличну співавторкою; Михайлина Коцюбинська й Олексій
Неживий указані упорядниками [ХПГ].
...
саме цей факт [ХПГ]. Вона не дає права без додаткового документа визначати
