...
Бібліотечна довідка називає першим опублікованим оповіданням «В сутінки»
(1961), але не вказує мови цієї публікації [ЧЛ-1]. Тому пакет не перекладає
назву російською, не вигадує російськомовного дебюту й не будує з нього
легенди про подальше мовне «навернення». Для твердження про мову потрібне
конкретне видання або інше пряме джерело.
