...
Лавра формулює прямо: 1923 року директором став, за висловом сторінки, неосвічений чекіст, який розгорнув проти Щербаківського кампанію, безпідставно звинувачуючи його в некомпетентності [Лавра]. ЕСУ називає інших дійових осіб поіменно: цькування з боку директора музею А. Вінницького та агента НКВС А. Онищука [ЕСУ].
...
- ЕСУ: цькування з боку Вінницького й Онищука довело Щербаківського до самогубства, що мало значний громадський резонанс [ЕСУ].
...
- **Родинні зв'язки:** підтверджено. ЕСУ прямо подає в статті рядок «Брат В. Щербаківського» з внутрішнім покликанням на його статтю [ЕСУ]. Попередній стан досьє стверджував, що це твердження не підтверджене перевіреними джерелами; пряме перечитування статті 2026-07-17 показало, що таке відхилення було **хибним** — джерело встановлює зв'язок прямим текстом. Факт приймаємо з атрибуцією до ЕСУ.
...
- [x] Родинний зв'язок із Вадимом Щербаківським прийнято за прямим текстом ЕСУ; попереднє хибне відхилення виправлено.
- [x] Передсмертної записки без первинного локатора не наведено в жодному файлі пакета.
- [x] Оцінок «доведений до відчаю» й «публічний акт опору» від себе не зроблено: подано лише те, що атрибутують самі джерела.
