...
Далі починається межа джерела. Про внутрішнє життя інституту, добір кадрів чи долі інших його працівників ухвалені сторінки не подають нічого. Тому досьє не переказує адміністративних конфліктів установи й не твердить, що «репресія била по установі»: це були відомості з тому «Реабілітовані історією», який вилучено з набору (див. §6). Мовчання джерела фіксуємо як мовчання, а не заповнюємо переказом.
...
- **Жодне твердження від вилучення не постраждало.** Засновництво й директорство Українського науково-дослідного інституту географії і картографії від 1927 року подає ЕСУ прямим текстом — окреме, вільно читане джерело [ЕСУ]. Разом із PDF вилучено тільки те, що трималося на ньому одному: адміністративний конфлікт в інституті та теза про репресію проти установи. Розбіжність 21 проти 23 березня збережено — вона тримається на ЕСУ й ХОУНБ.
