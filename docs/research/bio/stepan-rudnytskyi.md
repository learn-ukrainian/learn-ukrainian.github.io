...
- **Доступність тому «Реабілітовані історією» (v2).** Незалежний рецензент повідомив, що ухвалений PDF повертає HTTP 403, і на цій підставі не зміг перевірити інституційні твердження. Пряме повторне завантаження 2026-07-17 цього не підтвердило: файл повертає **HTTP 200**, 18 155 539 байт, PDF 1.4, 672 сторінки, з видобувним текстовим шаром — і то навіть із типовим `User-Agent` curl, без браузерних заголовків. Той самий результат зафіксовано при складанні пакета («all 13 adopted URLs HTTP 200»). Отже, 403 — властивість доступу рецензента, а не документа, і підстав вилучати залежні твердження немає.
- **Інституційні твердження мають незалежно читане джерело.** Засновництво й директорство Українського науково-дослідного інституту географії і картографії від 1927 року подає ЕСУ прямим текстом — окреме, вільно доступне джерело [ЕСУ]. Том «Реабілітовані історією» це підтверджує незалежно (с. 109): серед обвинувачених у справі М. Іваничука були Ірина Величко та Павло Осовський — «колишні працівники Українського науково-дослідного інституту географії та картографії, який до арешту в березні 1933-го очолював С. Л. Рудницький» [РІ]. Жодне інституційне твердження не спирається лише на недоступне джерело.
...
- [РІ] «Реабілітовані історією. Харківська область. Книга друга», НАН України, Інститут національної пам'яті, СБУ, Київ—Харків, 2014 — https://www.reabit.org.ua/files/store/Kharkiv_2.pdf — українською; 672 сторінки; згадки на с. 106 та 109 (ключове речення про інститут — с. 109). Доступність перевірено прямим завантаженням 2026-07-17: HTTP 200, 18 155 539 байт, PDF 1.4, 672 сторінки, текстовий шар придатний до вилучення (не скан).
