...
орієнтовно 1918, 126 сторінок [S3]. ЕІУ пов'язує збірку з 1918 роком [S1],
тоді як каталог точного примірника зберігає [1918?]. Це різні джерельні ролі:
контекст збірки не дає права стирати бібліографічний знак питання у записі
конкретного видання.
