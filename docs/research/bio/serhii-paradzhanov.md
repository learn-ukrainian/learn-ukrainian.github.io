...
- **Посмертні відзнаки:** Народний артист УРСР (1990, посмертно) та Державна
  премія України імені Тараса Шевченка (1991, посмертно) [S1].
...
- **Пам'ять після смерті.** Народний артист УРСР (1990, посмертно) та Державна
  премія України імені Тараса Шевченка (1991, посмертно), а також пам'ятники
  й фестивалі засвідчують рецепцію [S1], але не виправляють втрачений через
  цензуру та ув'язнення робочий час.
