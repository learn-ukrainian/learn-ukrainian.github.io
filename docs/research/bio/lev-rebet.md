...
вільному університеті. ЕІУ подає захист докторської дисертації 1949 року, доцентуру
від 1952 року й професуру державного права УВУ від 1954 року [S1]. Прийнятий набір
не містить джерела на 1947 рік, тому попередню «розбіжність 1947 проти 1949»
вилучено: вона спиралася на неназваний опис. Рік 1954 стосується професорського
звання, а не захисту, і не переноситься на дисертацію. Назва «Держава і нація»
підтверджена як тема дисертації [S2], але не як окремо видана книжка; без
бібліографічного запису її не слід включати до переліку монографій.
...
окремо. Пізнішу книжку ЕІУ датує 1964 роком у Мюнхені, але друкує її назву у двох
формах у межах однієї статті: перелік праць подає «Світло і тіні ОУН», а перелік
літератури — «Світла і тіні ОУН» [S1]. Каталог не оголошує жодну з форм хибною й
не приписує авторові варіант, якого джерело не друкує; для цитування треба назвати
конкретне видання й сторінку. Рік 1964 підтверджено обома переліками [S1].
...
агент радянської державної безпеки. СЗРУ описує систематичне збирання інформації
через закордонну агентуру, попередній план викрадення в Мюнхені та вбивство
спеціальним засобом з отруйною речовиною після невдалих спроб [S2]. Та сама
публікація прямо зазначає, що подробиць проведення операції в справі, яка
зберігається в архіві СЗРУ, немає, бо ці матеріали залишилися в Москві. Тому
досьє не реконструює перебігу операції за цим джерелом. Пізніше втеча
Сташинського на Захід, його свідчення й суд встановили обставини. У цьому досьє
відповідальність формулюється як документоване державне вбивство радянською
спецслужбою, а не безособова «загадкова смерть».
...
- [S2] СЗРУ. «Лев Ребет. Ідеолог існування незалежної України в сім'ї європейських народів», 24 червня 2022 року. Живий домен повертає 403, читається архівний знімок від 27 серпня 2025 року. <https://web.archive.org/web/20250827020552/https://szru.gov.ua/history/stories/lev-rebet-ideoloh-isnuvannya-nezalezhnoi-ukrainy-v-simi-ievropeiskykh-narodiv->
