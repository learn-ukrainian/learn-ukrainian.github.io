# Софія Іванівна Яблонська — Research Dossier

**Slug:** `sofiia-yablonska`
**Block:** +77 expansion — Ukrainian theater / visual culture additions
**Tier:** 2
**Issue:** #2535 / BIO +77 readiness gate; BIO #367
**Researcher:** Codex orchestrator (GPT-5)
**Completed:** 2026-07-01

**Source acronym legend:** IEU = Internet Encyclopedia of Ukraine; IFU =
French Institute in Ukraine; SYF = Sofia Yablonska Foundation; UCF = Ukrainian
Cultural Foundation; LH = Local History; UA House = Ukrainian House.
...
- **Full name (UA, canonical):** Софія Іванівна Яблонська.
...
- `curriculum/l2-uk-en/plans/lit-fantastika/vynnychenko-solar-machine-revisit.yaml`
- `docs/research/bio/milena-rudnytska.md`
- `curriculum/l2-uk-en/plans/bio/milena-rudnytska.yaml`
- `docs/research/bio/olha-kobylianska.md`
- `curriculum/l2-uk-en/plans/bio/olha-kobylianska.yaml`
- `docs/research/bio/dokiia-humenna.md`
- `curriculum/l2-uk-en/plans/bio/dokiia-humenna.yaml`
- `docs/research/bio/iryna-vilde.md`
- `docs/research/bio/lesya-ukrainka.md`
- `curriculum/l2-uk-en/plans/bio/lesya-ukrainka.yaml`

**Existing travel / essay / culture links (VERIFIED `test -e` on 2026-07-01):**

- `curriculum/l2-uk-en/plans/c2/podoroz-dozvillya-kultura.yaml`
- `curriculum/l2-uk-en/plans/lit-essay/zabuzhko-longest-journey.yaml`
...
- **Titles:** Keep Ukrainian titles with transliteration/English gloss only
  ...
  `Дві ваги — дві міри`; `Книга про батька`.
...
- Internet Encyclopedia of Ukraine. "Yablonska, Sofiia."
  ...
  Accessed 2026-07-01.
- French Institute in Ukraine. "Софія Яблонська."
  https://institutfrancais-ukraine.com/mediatheque/personnes/sophie_jablonska.
  Accessed 2026-07-01.
- Sofia Yablonska Foundation. "Sofia Yablonska Foundation."
