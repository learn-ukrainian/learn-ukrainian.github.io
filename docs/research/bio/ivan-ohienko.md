...
- **Full name (UA, canonical):** Іван Іванович Огієнко (церковне ім'я — митрополит Іларіон)
- **Pseudonyms / aliases:** Митрополит Іларіон, Ilarion, Ivan Ohiienko; (Russian-imperial transliterations: Иван Иванович Огиенко, Ivan Ogienko - forbidden in body text)
- **Born:** 14 January (2 January O.S.) 1882 | Брусилів | Радомишльський повіт, Київська губернія, Російська імперія (нині Житомирська область)
- **Died:** 29 March 1972 | Winnipeg | Manitoba, Canada | natural causes
- **Family / education key facts:** Born into a poor peasant family. Lost his father early. Educated at the Kyiv military-paramedic school, then graduated from the historical-philological faculty of Kyiv University (St. Volodymyr) in 1909 under the mentorship of Volodymyr Peretts.

Cite: [T1: ЕСУ — Огієнко Іван Іванович]; [T1: IEU — Ohiienko, Ivan]; [T1: ЕІУ — Огієнко Іван Іванович].

## 2. Oppression mechanism

- **What happened:** Forced into emigration following the Bolshevik occupation of the Ukrainian National Republic (UNR), followed by decades of Soviet state censorship that completely banned his scholarly and theological works in Ukraine.
- **When (specific dates):** Emigrated in November 1920 (after the fall of Kamianets-Podilskyi); lifelong exile until his death in 1972.
- **By whom (specific Russian/Soviet/RF agency):** Bolshevik forces (military occupation); later the Soviet censorship apparatus (Glavlit/KGB).
- **Document references:** N/A for physical arrest, as he escaped before capture. His name was placed on the index of forbidden authors in the USSR.
...
- `1925` — *Історія українського друкарства*, monograph, Lviv.
- `1933–1939` — *Рідна мова*, linguistic journal, Warsaw. (Edited and published by Ohienko, promoting language purity).
...
**Quote 1:**
> «Мова — душа кожної національності, її святощі, її найцінніший скарб... Звичайно, не сама по собі мова, а мова як певний орган.»
**Source:** *Історія української літературної мови* (1950).
...
- **Register:** High academic, ecclesiastical (theological), and prescriptive standard Ukrainian.
- **CEFR readiness for full reading:** C1 for his linguistic treatises; B2 for general cultural essays.
...
- **Existing LIT modules (VERIFIED present via `test -e`):**
  - None strictly existing for Ohienko.
...
- **Candidate cross-track connections:**
  - `plans/bio/ivan-ohienko.yaml` (Exists in BIO).
  - Ties to the history of the UNR (Minister of Education).
  - Ties to the history of the Ukrainian Orthodox Church (autocephaly).
- **Potential LIT additions:**
  - A module on diaspora linguistics and Bible translations.

## 8. Naming-canonical

- **Slug:** `ivan-ohienko`
- **EN canonical (BGN/PCGN 2010):** Ivan Ohiienko
- **UA canonical (with patronymic if attested):** Іван Іванович Огієнко
- **Aliases (track these for `aliases:` YAML field):** Митрополит Іларіон, Ilarion, Ivan Ohienko, Ivan Ohiienko
- **Forbidden forms:** Иван Огиенко, Ivan Ogienko, Metropolitan Hilarion (Russian framing).

## 9. Image candidates

- **Best PD/CC portrait:** Wikimedia Commons category "Ivan Ohienko" (various PD photos from the UNR era, pre-1923).
- **Backup candidates:** Commemorative 2 Hryvnia coin (2007) by National Bank of Ukraine.
- **Era-appropriate context:** Title page of the first edition of *Українська культура* (1918) or a page from his Bible translation.

## 10. Sources used

**Tier 1 (authoritative):**
- Енциклопедія Сучасної України. "Огієнко Іван Іванович." https://esu.com.ua/article-74636. Accessed 2026-06-04.
- Encyclopedia of Ukraine. "Ohiienko, Ivan." https://www.encyclopediaofukraine.com/display.asp?linkpath=pages\O\H\OhiienkoIvan.htm. Accessed 2026-06-04.
- Енциклопедія історії України. "Огієнко Іван Іванович."
...
- [x] Holodomor referenced as Holodomor (N/A here)
- [x] Crimea/2014/2022 events framed as Russian aggression (N/A here)
