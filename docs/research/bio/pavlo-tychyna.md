...
сторінки [S3]. Назва «Сонячні кларнети» є дрейфом назви. Той самий каталог
зберігає дату першого видання як [1918?]; квадратні дужки й знак питання не
можна перетворювати на впевнену дату. УІНП не використовуємо для датування
книжкового видання [S1, S3].
