...
сторінки [S3]. УІНП у біографічному матеріалі вживає форму «Сонячні кларнети»
[S1], а точний каталог — «Соняшні кларнети» [S3]; кожну форму прив'язуємо до
її джерельної ролі. Анотація каталогу подає 1918 рік першого видання без
квадратних дужок і знака питання [S3], тоді як ЦДАМЛМ датує першу збірку 1919
роком [S2]. Цю розбіжність не розв'язуємо; каталогізований примірник є другим
виданням 1920 року. УІНП не використовуємо для датування книжкового видання.
...
«Соняшні» є частиною документа [S3], тоді як УІНП у біографічному матеріалі
вживає форму «Сонячні» [S1]. Пакет зберігає джерельну специфіку: для точного
видання подає каталожне «Соняшні», не оголошуючи біографічну форму окремою
назвою видання. Так само рік 1920 стосується другого видання, а не першої
появи збірки.
