...
сторінки [S3]. Назва «Сонячні кларнети» є дрейфом назви. УІНП датує першу
друковану збірку 1919 роком, тоді як каталожний опис НБУВ пов'язує назву з
1918 роком; цю розбіжність треба позначати окремо від другого видання 1920 року
[S1, S3].
...
видавництво, 1935, 55 і 1 сторінка [S4]. УІНП датує твір 1933 роком, згадує
публікацію в газеті «Правда» без точного дня та називає книжку 1934 роком.
Отже, пакет розрізняє твір, газетну публікацію й каталожне видання та відкрито
позначає розбіжність 1934/1935 [S1, S4].
...
- Розділено твір 1933 року, газетну публікацію без підтвердженого дня та розбіжність 1934/1935 щодо книжки.
...
Четверта перевірка — документ «Партія веде». УІНП називає твір 1933 року й
книжку 1934 року, а НБУВ каталогізує видання 1935 року [S1, S4]. Учень може
порівняти дати й типи публікації, але не додає непідтверджений точний день і не
...
«Соняшних кларнетів» він позначає 1919 рік у УІНП, 1918 рік у каталожному описі
НБУВ і друге видання 1920 року; для «Партія веде» — твір 1933 року, книжку 1934
року в УІНП та каталожне видання 1935 року в НБУВ [S1, S3, S4]. Джерельні
розбіжності не можна розв'язувати вигаданою точною датою.
