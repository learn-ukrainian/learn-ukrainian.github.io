...
- Твердження, ніби статей «54-1a і 54-11 КК УРСР» у прийнятих джерелах немає,
  **спростовано**: сторінка Синоду [S4] дослівно наводить постанову — «притягнути
  ...
  (Кримінального Кодексу) УРСР» — і пояснює, що ці статті інкримінують «агітацію
  або пропаганду, проведену з метою підриву чи ослаблення Радянської влади».
  Точні позначення — **54-1«а»** і **54-II** (римська двійка), а не «54-11»;
  саме їх і слід уживати з атрибуцією до S4.
...
остаточній назві та в даті перейменування 1931 року; заснування часопису й сама
організаційна послідовність — ні. Жодне з прийнятих джерел не подає дати
заснування газети «Правда» [S4] (наклад 25 тисяч примірників проти 1,5 тисячі в
«Нової Зорі» [S4]); дата, що раніше фігурувала в плані модуля, джерелами не
підтверджена і вилучена, а не замінена новим джерелом.
...
Чотири українськомовних читання — [S1], [S2], [S3], [S4] — мають точну
