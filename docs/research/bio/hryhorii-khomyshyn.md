...
- Твердження, ніби статей «54-1a і 54-11 КК УРСР» у прийнятих джерелах немає,
  **спростовано**: сторінка Синоду [S4] дослівно наводить постанову — «притягнути
  ХОМИШИНА Григорія Лукича в якості звинуваченого по ст. ст. 54–1»а» і 54-II КК
  (Кримінального Кодексу) УРСР», і сама постанова пояснює це як звинувачення в
  «агітації або пропаганді, проведеній з метою підриву чи ослаблення Радянської
  влади» [S4]. Друге позначення джерело передає як **54-II** — це, найімовірніше,
  артефакт транскрипції самого документа, а не точно встановлена стаття, тому
  вживати його слід лише як цитату S4, а не як «римську двійку». Кримінальний
  кодекс УРСР 1927 року розрізняв статтю 54-1«а» (зрада), 54-10 (антирадянська
  агітація) і 54-11 (організаційна діяльність) як окремі за змістом норми;
  постанова не дає підстав ототожнювати рендеринг «54-II» з якоюсь конкретною з
  них.
...
явищах наростаючої серцевої слабкості, від старечої дряхлості і аліментарної
дистрофії» [S4]; синодальна довідка [S4] уточнює й годину смерті. Архівна
публікація [S3] відтворює той самий фрагмент акта як «елементарної дистрофії» —
це вторинна помилка транскрипції, а не окрема медична формула.
...
Формулу акта варто читати точно. «Стареча дряхлість» і «аліментарна дистрофія» —
...
українських читання мігровано на strict-v2 з link-only та збіжним `evidence_url`.
...
похідних матеріалах слід вважати вилученою, а не замінену новим джерелом.
