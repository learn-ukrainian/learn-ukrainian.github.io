...
graph TD
    ...
    %% Phase B2.3: Skills & Checkpoint (M71-84, renumbered from old M132-145)
    subgraph B2_3 [Phase B2.3: Skills M71-84]
        M71[M71 Medicine] --> M77[M77 Academic]
        M77 --> M84[M84 Checkpoint: Register Synthesis]
    end

    %% Phase B2.4: Communication Skills (M85-94, NEW)
    subgraph B2_4 [Phase B2.4: Communication M85-94]
        M85[M85 Prof Email] --> M90[M90 News Analysis]
        M90 --> M94[M94 B2 Final Exam]
    end
