...
5. **Context Collapse**: Managing the deep historical context required for Seminar Tracks (B2-HIST, C1-BIO, LIT) in large batches can lead to context exhaustion, necessitating strict batch limits (1-2 modules).
