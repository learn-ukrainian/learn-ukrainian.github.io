...
- **Orchestration**: Deciding build priority, dispatching batch builds, managing the `build_module_v3.py` pipeline, and coordinating work across sessions via GitHub issues and memory graph.
