...
tags: ["grammar", "gender", "declension", "noun-patterns"]
grammar: ["noun-gender-m-f-n", "declension-families-4"]
objectives:
  - "Learner can identify the gender of Ukrainian nouns by their ending"
  - "Learner can categorize nouns into the 4 declension families"
  - "Learner can recognize gender patterns: consonant (m), -а/-я (f), -о/-е (n)"
vocabulary_count: 36
---
...
2. What gender is "вікно"?
   - [ ] Masculine
   - [x] Neuter
   - [ ] Feminine
   - [ ] No gender
   > Nouns ending in -о are neuter.

3. What gender is "стіл"?
   - [x] Masculine
   - [ ] Feminine
   - [ ] Neuter
   - [ ] Unknown
   > Nouns ending in a consonant are typically masculine.

4. Which family does "ніч" belong to?
   - [ ] Family 1
   - [ ] Family 2
   - [x] Family 3
   - [ ] Family 4
   > Feminine nouns ending in consonants are Family 3.

5. Which ending is typical for neuter nouns?
   - [ ] -а
   - [ ] consonant
   - [x] -о or -е
   - [ ] -і
...
6. How many declension families exist in Ukrainian?
   - [ ] 2
   - [ ] 3
   - [x] 4
   - [ ] 5
   > There are 4 declension families.

7. What gender is "море"?
   - [ ] Masculine
   - [ ] Feminine
   - [x] Neuter
   - [ ] Plural
   > "Море" ends in -е, so it's neuter.

8. Which noun is masculine?
   - [x] хліб
   - [ ] вода
   - [ ] вікно
   - [ ] кімната
   > "Хліб" ends in a consonant, so it's masculine.

9. Which noun is feminine?
   - [ ] стіл
   - [x] школа
   - [ ] місто
   - [ ] море
   > "Школа" ends in -а, so it's feminine.

10. Can you predict gender from the ending 95% of the time?
    - [x] Yes
    - [ ] No
    - [ ] Only for feminines
    - [ ] Only for neuters
    > Ukrainian gender is highly predictable from endings!

11. What is Family 4 known for?
    - [ ] Consonant endings
    - [ ] -а/-я feminines
    - [x] Neuter nouns with stem changes
    - [ ] Plural forms
    > Family 4 neuters gain suffixes like -ат-, -ят-, -ен-.

12. Which word is neuter?
    - [ ] дім
    - [ ] кімната
    - [x] яблуко
    - [ ] магазин
    > "Яблуко" ends in -о, so it's neuter.
...
2. ___ ends in -а, so it's feminine.
   > [!answer] Кімната
   > [!options] Кімната | Стіл | Вікно | Море

3. ___ is a neuter noun ending in -о.
   > [!answer] Вікно
   > [!options] Вікно | Стіл | Книга | Двері

4. ___ is masculine because it ends in a consonant.
   > [!answer] Хліб
   > [!options] Хліб | Вода | Молоко | Школа

5. ___ is feminine and ends in -я.
   > [!answer] Земля
   > [!options] Земля | Море | Дім | Стіл

6. ___ is neuter and means "sea".
   > [!answer] Море
   > [!options] Море | Річка | Вода | Дім

7. ___ is masculine and means "house".
   > [!answer] Дім
   > [!options] Дім | Кімната | Вікно | Вода

8. ___ is feminine and means "water".
   > [!answer] Вода
   > [!options] Вода | Молоко | Сік | Чай

9. ___ is neuter and means "milk".
   > [!answer] Молоко
   > [!options] Молоко | Вода | Сік | Чай

10. ___ is masculine and means "juice".
    > [!answer] Сік
    > [!options] Сік | Вода | Молоко | Вино

11. ___ is neuter and means "apple".
    > [!answer] Яблуко
    > [!options] Яблуко | Апельсин | Картопля | Помідор

12. ___ is feminine and means "potato".
    > [!answer] Картопля
    > [!options] Картопля | Апельсин | Огірок | Яблуко

## true-false: Gender Rules

- [x] Masculine nouns typically end in a consonant.
  > Correct! Examples: стіл, хліб, дім.

- [x] Feminine nouns typically end in -а or -я.
  > Correct! Examples: книга, земля, кімната.

- [x] Neuter nouns typically end in -о or -е.
  > Correct! Examples: вікно, місто, море.

- [ ] All feminine nouns end in -а or -я.
  > Incorrect! Family 3 feminines end in consonants: ніч, любов.

- [x] There are 4 declension families in Ukrainian.
  > Correct! Families 1, 2, 3, and 4.

- [ ] Gender is random in Ukrainian.
  > Incorrect! Gender is predictable from word endings 95% of the time.

- [x] Gender affects adjective endings.
  > Correct! Adjectives must agree with noun gender.

- [x] Gender affects case endings.
  > Correct! Masculine, feminine, and neuter have different case patterns.

- [ ] "Двері" has a gender.
  > Incorrect! "Двері" is plural only and has no singular gender.

- [x] Family 2 includes both masculine and neuter nouns.
  > Correct! Masculine consonant endings + neuter -о/-е.

- [ ] You must memorize gender for every noun.
  > Incorrect! You can predict gender from the ending pattern.

- [x] "Ім'я" is a special neuter noun (Family 4).
