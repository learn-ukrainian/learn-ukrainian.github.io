...
if [ -n "${SESSION_EPIC:-}" ]; then
  ...
  case "${SESSION_EPIC}" in
    atlas)
      ...
      echo "          docs/runbooks/grok-session-canary.md  (end on <8/10; score auto-hydrates on PASS)"
      ;;
    harness|infra)
