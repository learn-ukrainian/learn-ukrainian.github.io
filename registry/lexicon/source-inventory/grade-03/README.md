...
Same two-stage pipeline as grade 1/2 (`registry/lexicon/source-inventory/grade-01/README.md`,
`registry/lexicon/source-inventory/grade-02/README.md`), scripts unchanged:
